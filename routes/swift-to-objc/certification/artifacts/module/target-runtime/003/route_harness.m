...
int main() {
    @autoreleasepool {
        double actual_0 = clampNumber(-10.5, 0.0, 100.0);
        ...
        double actual_1 = clampNumber(55.25, 0.0, 100.0);
        ...
        double actual_2 = clampNumber(101.5, 0.0, 100.0);
        ...
        double actual_3 = clampNumber(-0.0, -1.0, 1.0);
        ...
        double actual_4 = clampNumber(0.0, -0.0, 1.0);
