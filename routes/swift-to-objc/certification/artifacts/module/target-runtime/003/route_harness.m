...
int main() {
    @autoreleasepool {
        double actual_0 = elmos_fn_381c27419f9e5857(-10.5, 0.0, 100.0);
        ...
        double actual_1 = elmos_fn_381c27419f9e5857(55.25, 0.0, 100.0);
        double expected_1 = 55.25;
        ...
        double actual_2 = elmos_fn_381c27419f9e5857(101.5, 0.0, 100.0);
        double expected_2 = 100.0;
        ...
        double actual_3 = elmos_fn_381c27419f9e5857(-0.0, -1.0, 1.0);
        ...
        double actual_4 = elmos_fn_381c27419f9e5857(0.0, -0.0, 1.0);
        double expected_4 = 0.0;
