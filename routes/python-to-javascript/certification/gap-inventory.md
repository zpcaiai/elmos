# python-to-javascript remaining obligations
...
- Keep unsafe integers, non-finite numbers, string semantics, async, I/O, imports, dynamic evaluation, reflection, shared state, and undeclared calls blocked.
