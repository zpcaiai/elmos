...
int main() {
    @autoreleasepool {
        long long actual_0 = elmos_fn_7642c58cf6d3de2a(20, 10);
        long long expected_0 = 10;
        if (actual_0 != expected_0) return 1;
        printf("ELMOS_OBSERVATION\t0\ti64-dec\t%lld\n", actual_0);
        long long actual_1 = elmos_fn_7642c58cf6d3de2a(-2, 10);
        long long expected_1 = 0;
        if (actual_1 != expected_1) return 2;
        printf("ELMOS_OBSERVATION\t1\ti64-dec\t%lld\n", actual_1);
        long long actual_2 = elmos_fn_7642c58cf6d3de2a(7, 10);
        long long expected_2 = 7;
