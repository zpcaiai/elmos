...
int main() {
    const auto actual_0 = elmos_fn_7ff2b56737bdd9f9(100.0, 20.0);
    const auto expected_0 = 120.0;
    if (!elmos_harness_same_fp64(actual_0, expected_0)) return 1;
    std::cout << "ELMOS_OBSERVATION\t0\tfp64-hex\t" << elmos_harness_fp64(actual_0) << "\n";
    const auto actual_1 = elmos_fn_7ff2b56737bdd9f9(-1.0, 5.0);
    ...
    const auto actual_2 = elmos_fn_7ff2b56737bdd9f9(7.0, -2.0);
    const auto expected_2 = 5.0;
