...
int main() {
    const auto actual_0 = elmos_fn_5e4824290b856dde(20.0, 7.0);
    const auto expected_0 = 13.0;
    if (!elmos_harness_same_fp64(actual_0, expected_0)) return 1;
    std::cout << "ELMOS_OBSERVATION\t0\tfp64-hex\t" << elmos_harness_fp64(actual_0) << "\n";
    const auto actual_1 = elmos_fn_5e4824290b856dde(3.0, 8.0);
    ...
    const auto actual_2 = elmos_fn_5e4824290b856dde(4.0, 4.0);
    const auto expected_2 = 0.0;
