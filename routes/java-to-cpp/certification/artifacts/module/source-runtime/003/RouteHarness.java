public final class RouteHarness {
    public static void main(String[] args) {
        var actual0 = EquivalenceModule.clampNumber(-10.5d, 0.0d, 100.0d);
        var expected0 = 0.0d;
        ...
        var actual1 = EquivalenceModule.clampNumber(55.25d, 0.0d, 100.0d);
        ...
        var actual2 = EquivalenceModule.clampNumber(101.5d, 0.0d, 100.0d);
        ...
        var actual3 = EquivalenceModule.clampNumber(-0.0d, -1.0d, 1.0d);
        var expected3 = -0.0d;
        ...
        var actual4 = EquivalenceModule.clampNumber(0.0d, -0.0d, 1.0d);
        var expected4 = 0.0d;
