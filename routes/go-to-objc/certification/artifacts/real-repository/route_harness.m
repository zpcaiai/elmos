...
int main() {
    @autoreleasepool {
        long long actual_0 = elmos_fn_c558e587446ddf05(20, 7);
        long long expected_0 = 13;
        if (actual_0 != expected_0) return 1;
        printf("ELMOS_OBSERVATION\t0\ti64-dec\t%lld\n", actual_0);
        long long actual_1 = elmos_fn_c558e587446ddf05(3, 8);
        long long expected_1 = 0;
        if (actual_1 != expected_1) return 2;
        printf("ELMOS_OBSERVATION\t1\ti64-dec\t%lld\n", actual_1);
        long long actual_2 = elmos_fn_c558e587446ddf05(4, 4);
