...
int main() {
    @autoreleasepool {
        double actual_0 = elmos_fn_05bd7c892305ba1a(100.0, 20.0);
        double expected_0 = 120.0;
        ...
        double actual_1 = elmos_fn_05bd7c892305ba1a(-1.0, 5.0);
        ...
        double actual_2 = elmos_fn_05bd7c892305ba1a(7.0, -2.0);
        double expected_2 = 5.0;
