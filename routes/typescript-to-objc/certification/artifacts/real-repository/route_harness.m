...
int main() {
    @autoreleasepool {
        double actual_0 = elmos_fn_0812ae9e421338d2(20.0, 7.0);
        double expected_0 = 13.0;
        ...
        double actual_1 = elmos_fn_0812ae9e421338d2(3.0, 8.0);
        ...
        double actual_2 = elmos_fn_0812ae9e421338d2(4.0, 4.0);
        double expected_2 = 0.0;
