...
Run `scripts/batch29/run_vb6_cross_host_campaign.py` in prepare, execute-windows, and verify phases. A local cross-host pass cannot replace independent verification or external certification.
