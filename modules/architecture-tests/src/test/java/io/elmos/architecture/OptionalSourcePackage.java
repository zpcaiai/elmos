 ...
 * installed distribution is validated separately where a tracked
 * {@code docs/*}{@code /installed-manifest.json} exists. That validation never substitutes for
 * byte-level validation of an absent source bundle.
 *
    ...
    static Path required(Path root, String relativePath) {
        ...
        assumeTrue(
                ...
                "SOURCE_PACKAGE_ABSENT=" + relativePath
                        ...
                        + " normal source checkout; bundle-bound assertions skipped, installed"
                        + " distributions are validated separately where tracked");
        return resolved;
    }
}
