-- ELMOS V56: runtime support for the self-service authentication service.
--
-- V55 defined the identity aggregates. V56 adds the four things the running
-- service needs and V55 deliberately left open:
--
