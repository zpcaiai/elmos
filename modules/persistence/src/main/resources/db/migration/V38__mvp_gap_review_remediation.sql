-- ELMOS Product Batch 32: independent MVP gap review and remediation.
-- Records are evidence-bound and append-only. This schema does not execute external actions.

CREATE SCHEMA IF NOT EXISTS mvp_gap_review;

DO $$
DECLARE
    target_schema text := 'mvp_gap_review';
    table_name text;
