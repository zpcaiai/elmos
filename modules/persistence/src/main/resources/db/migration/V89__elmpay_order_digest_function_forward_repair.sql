-- Forward-only repair for the ELMPay directory trigger functions. V84 is
-- already present in the production Flyway ledger and therefore remains
-- byte-immutable; this migration applies the schema-qualified encode lookup.
