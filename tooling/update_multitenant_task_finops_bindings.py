...
IMPLEMENTED = {
    ...
    "ELMOS-MTF-001-T10", "ELMOS-MTF-001-T12",
    ...
    "ELMOS-MTF-006-T04", "ELMOS-MTF-006-T05",
    "ELMOS-MTF-007-T02", "ELMOS-MTF-007-T03", "ELMOS-MTF-007-T04",
    "ELMOS-MTF-007-T05", "ELMOS-MTF-007-T06",
...
FILES_BY_SKILL = {
    ...
    "ELMOS-MTF-002": [
        ...
        "modules/persistence/src/main/resources/db/migration/V73__account_task_control_and_finops_runtime.sql",
    ],
    "ELMOS-MTF-003": [
...
def render() -> dict:
    ...
    for source, current in zip(tasks, source_results, strict=True):
        ...
        if task_id in IMPLEMENTED:
            ...
            state = "PARTIAL"
            paths = FILES_BY_SKILL[skill_id]
            blockers = [PARTIAL_BLOCKERS[skill_id]]
        else:
            state = "NOT_STARTED"
            paths = []
