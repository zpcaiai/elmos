#!/usr/bin/env python3
"""Install the pinned ETGB v2.0 Skill interfaces without executing package code.

The archive and extracted source are untrusted declarative inputs. This importer
...
PACKAGE_NAME = "elmos-etgb-full-product-assurance-skills-package-v2.0.0"
...
DOC_ROOT = ROOT / "docs/etgb-full-product-skills"
...
def _interface(skill: dict) -> str:
    ...
    short_description = "Run ETGB full product assurance with evidence controls"
