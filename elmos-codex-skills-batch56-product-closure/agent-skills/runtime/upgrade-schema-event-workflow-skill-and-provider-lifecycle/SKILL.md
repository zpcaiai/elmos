---
name: upgrade-schema-event-workflow-skill-and-provider-lifecycle
description: Implement product self-upgrade across database, event, workflow, policy, Skill, provider and tenant configuration versions with rollback and compatibility controls.
---
