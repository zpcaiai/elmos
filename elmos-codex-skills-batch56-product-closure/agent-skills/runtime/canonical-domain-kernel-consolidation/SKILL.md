...
description: Define, migrate and govern the canonical ELMOS shared kernel for tenant, organization, identity, party, provider, workflow, execution, artifact, evidence, policy, approval, risk, case and audit.
---
