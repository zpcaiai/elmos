---
name: certification-lab-golden-corpus-holdout-chaos-and-runtime-evidence
description: Build the certification lab with golden repositories, holdout corpora, provider sandboxes, performance workloads, chaos environments, upgrade/rollback tests and immutable evidence.
---
