---
name: product-experience-role-workspaces-and-onboarding
description: Create role-based workspaces, product navigation, onboarding, demo data, explainability, evidence rooms and decision-focused user experience.
---
