...
autonomous-qa-self-healing-skills:
	PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=engines/autonomous-qa-engine/src $(UV) run --quiet --with pyyaml==6.0.2 --with jsonschema==4.25.1 python tooling/qualify_autonomous_qa_runtime.py --check
	...
	PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=engines/autonomous-qa-engine/src $(UV) run --quiet --with pyyaml==6.0.2 --with jsonschema==4.25.1 python -m unittest discover -s engines/autonomous-qa-engine/tests -p 'test_*.py'
