; formal_input_digest: sha256:c840563653f3abe4b6d2c170ecb3c942c75a9af519af95c21a991e6fe23d40c7
; formal-input-sha256: sha256:c840563653f3abe4b6d2c170ecb3c942c75a9af519af95c21a991e6fe23d40c7
...
(assert
 (let ((?x218 (ubv_to_int source_value)))
 (let ((?x78 (ite (bvslt source_value (_ bv0 64)) (- ?x218 18446744073709551616) ?x218)))
 (and (>= ?x78 (- 9007199254740991)) (<= ?x78 9007199254740991)))))
(assert
 (let ((?x200 (ubv_to_int source_upper)))
 (let ((?x102 (ite (bvslt source_upper (_ bv0 64)) (- ?x200 18446744073709551616) ?x200)))
