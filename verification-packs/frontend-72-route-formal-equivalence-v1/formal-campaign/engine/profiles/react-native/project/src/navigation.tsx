...
const linking: LinkingOptions<RootStackParamList> = { prefixes: ["formal-reactnative://"], config: { screens: Object.fromEntries(ELMOS_ROUTES.map((route, index) => [generatedScreenName(index), route.path.replace(/^\//, "") || "home"])) } };
