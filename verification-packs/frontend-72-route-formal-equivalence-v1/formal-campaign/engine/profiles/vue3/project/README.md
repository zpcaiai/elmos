...
This project was generated from typed UI Interaction IR for the directional route `angular@22.0.8 -> vue3`.
...
- Vue Router declaration compatibility sets exactOptionalPropertyTypes=false; preserve optional-versus-undefined API semantics with explicit domain tests.
