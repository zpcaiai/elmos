...
This project was generated from typed UI Interaction IR for the directional route `angular@22.0.8 -> harmony-arkui`.
...
- Verify lifecycle, background/foreground, process death, offline replay, secure storage, permissions, signing, upgrade, rollback, and real-device behavior.
