#!/usr/bin/env python3
"""Disabled fail-closed entrypoint: synthetic Batch 1-37 production evidence materialization."""
        ...
        json.dumps(
            {
                ...
                "reason": "synthetic Batch 1-37 production evidence materialization is prohibited inside the repository after ELMOS-CERT-KEY-2026-09-13-01",
