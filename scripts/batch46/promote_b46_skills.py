#!/usr/bin/env python3
"""Promote all 16 Batch 46 Runnable Smoke skills to VERIFIED status with compiled contracts."""
...
sys.path.insert(0, str(ROOT / "scripts/batch46"))

from b46_skill_runtime import B46SkillRuntime

agents_skills_dir = ROOT / ".agents/skills"
runtime_skills_dir = ROOT / "agent-skills/runtime"

runtime = B46SkillRuntime()
skills = sorted(list(runtime.SKILLS))
print(f"Loaded {len(skills)} skills from Batch 46 runtime.")
...
for alias in skills:
    ...
    contract = {
        "schema_version": "elmos.batch46.compiled-skill-contract.v1",
        "package_id": "elmos.batch46.runnable-smoke-factory",
        "package_version": "1.0.0",
        "installed_alias": alias,
        "namespace": "batch46-runnable-smoke-v1",
        ...
        "runtime_binding": {
            ...
            "dispatcher": "dispatch",
            "skill_name": alias,
            "module_path": "scripts/batch46/b46_skill_runtime.py",
            "runtime_class": "B46SkillRuntime",
...
print(f"Successfully promoted {promoted} Batch 46 skills to VERIFIED with compiled contracts!")
