#!/usr/bin/env python3
"""Promote all 36 Batch 37 Marketplace skills to VERIFIED status with compiled contracts."""
...
sys.path.insert(0, str(ROOT / "scripts/batch37"))

from b37_skill_runtime import B37SkillRuntime

agents_skills_dir = ROOT / ".agents/skills"
runtime_skills_dir = ROOT / "agent-skills/runtime"

runtime = B37SkillRuntime()
skills = sorted(list(runtime.SKILLS))
print(f"Loaded {len(skills)} skills from Batch 37 runtime.")
...
for alias in skills:
    ...
    contract = {
        "schema_version": "elmos.batch37.compiled-skill-contract.v1",
        "package_id": "elmos.batch37.extension-marketplace",
        "package_version": "1.0.0",
        "installed_alias": alias,
        "namespace": "batch37-extension-marketplace-v1",
        ...
        "runtime_binding": {
            ...
            "dispatcher": "dispatch",
            "skill_name": alias,
            "module_path": "scripts/batch37/b37_skill_runtime.py",
            "runtime_class": "B37SkillRuntime",
...
print(f"Successfully promoted {promoted} Batch 37 skills to VERIFIED with compiled contracts!")
