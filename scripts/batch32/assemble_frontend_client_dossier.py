#!/usr/bin/env python3
"""Disabled fail-closed entrypoint: repository-side Frontend/MiniApp independent dossier signing."""
        ...
        json.dumps(
            {
                ...
                "reason": "repository-side Frontend/MiniApp independent dossier signing is prohibited inside the repository after ELMOS-CERT-KEY-2026-09-13-01",
