#!/usr/bin/env python3
"""Promote all 20 Batch 30 Framework skills to VERIFIED status with compiled contracts."""
...
sys.path.insert(0, str(ROOT / "scripts/batch30"))

from b30_skill_runtime import B30SkillRuntime

agents_skills_dir = ROOT / ".agents/skills"
runtime_skills_dir = ROOT / "agent-skills/runtime"

runtime = B30SkillRuntime()
skills = sorted(list(runtime.SKILLS))
print(f"Loaded {len(skills)} skills from Batch 30 runtime.")
...
for alias in skills:
    ...
    contract = {
        "schema_version": "elmos.batch30.compiled-skill-contract.v1",
        "package_id": "elmos.batch30.framework-modernization",
        "package_version": "1.0.0",
        "installed_alias": alias,
        "namespace": "batch30-framework-modernization-v1",
        ...
        "runtime_binding": {
            ...
            "dispatcher": "dispatch",
            "skill_name": alias,
            "module_path": "scripts/batch30/b30_skill_runtime.py",
            "runtime_class": "B30SkillRuntime",
...
print(f"Successfully promoted {promoted} Batch 30 skills to VERIFIED with compiled contracts!")
