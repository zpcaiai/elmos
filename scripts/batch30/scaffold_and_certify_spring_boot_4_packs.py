#!/usr/bin/env python3
"""Scaffold seven Spring modernization framework packs to Spring Boot 4.1.0:
- spring-boot-1-5-to-4-1-0 (1.5.22.RELEASE / Java 8 / Maven 3.9.11)
- spring-boot-2-0-2-6-to-4-1-0 (2.3.12.RELEASE / Java 11 / Maven 3.9.11)
- spring-boot-2-7-18-to-4-1-0 (2.7.18 / Java 17 / Maven 3.9.11)
- spring-boot-3-0-3-4-to-4-1-0 (3.4.1 / Java 17 / Maven 3.9.11)
- spring-boot-3-5-to-4-1-0 (3.5.3 / Java 21 / Maven 3.9.11)
- spring-boot-2-x-gradle-to-4-1-0 (2.7.18 / Java 17 / Gradle 8.14.3)
- spring-framework-5-3-mvc-to-boot-4-1-0 (Spring MVC 5.3.39 / Java 11 / Maven 3.9.11)

Generates exact contracts, corpora, policies, and a non-certifying campaign plan.
External evidence and independent certification are deliberately separate operations.
"""
...
PACK_SPECS = [
    {
        "pack_key": "spring-boot-1-5-to-4-1-0",
        "campaign_id": "spring-boot-1.5-to-4.1.0-p0-p11",
        ...
        "build_tool": "maven",
        "mode": "upgrade",
        "recipe_filename": "spring-to-boot-4.1.0.yml",
        "recipe_class": "io.elmos.openrewrite.SpringBoot1_5ToBoot4_1_0Java21",
        "evidence_json": "boot-1.5-maven-to-boot-4.1.0-java-21.json",
    },
    {
        "pack_key": "spring-boot-2-0-2-6-to-4-1-0",
        "campaign_id": "spring-boot-2.0-2.6-to-4.1.0-p0-p11",
        "source_framework": "spring-boot",
        ...
        "mode": "upgrade",
        "recipe_filename": "spring-to-boot-4.1.0.yml",
        "recipe_class": "io.elmos.openrewrite.SpringBoot2_0To2_6ToBoot4_1_0Java21",
        "evidence_json": "boot-2.0-2.6-maven-to-boot-4.1.0-java-21.json",
    },
    {
        "pack_key": "spring-boot-2-7-18-to-4-1-0",
        "campaign_id": "spring-boot-2.7-18-to-4.1.0-p0-p11",
        "source_framework": "spring-boot",
        "source_version": "2.7.18",
        "source_java": "17",
        "source_servlet": "4.0.1",
        "source_container": "9.0.83",
        "build_tool": "maven",
        "mode": "upgrade",
        "recipe_filename": "spring-to-boot-4.1.0.yml",
        "recipe_class": "io.elmos.openrewrite.SpringBoot2_7ToBoot4_1_0Java21",
        "evidence_json": "boot-2.7-maven-to-boot-4.1.0-java-21.json",
    },
    {
        "pack_key": "spring-boot-3-0-3-4-to-4-1-0",
        "campaign_id": "spring-boot-3.0-3.4-to-4.1.0-p0-p11",
        "source_framework": "spring-boot",
        ...
        "mode": "upgrade",
        "recipe_filename": "spring-to-boot-4.1.0.yml",
        "recipe_class": "io.elmos.openrewrite.SpringBoot3_0To3_4ToBoot4_1_0Java21",
        "evidence_json": "boot-3.0-3.4-maven-to-boot-4.1.0-java-21.json",
    },
    {
        "pack_key": "spring-boot-3-5-to-4-1-0",
        "campaign_id": "spring-boot-3.5-to-4.1.0-p0-p11",
        "source_framework": "spring-boot",
        "source_version": "3.5.3",
        "source_java": "21",
        "source_servlet": "6.0",
        "source_container": "10.1.42",
        "build_tool": "maven",
        "mode": "upgrade",
        "recipe_filename": "spring-to-boot-4.1.0.yml",
        "recipe_class": "io.elmos.openrewrite.SpringBoot3_5ToBoot4_1_0Java21",
        "evidence_json": "boot-3.5-maven-to-boot-4.1.0-java-21.json",
    },
    {
        "pack_key": "spring-boot-2-x-gradle-to-4-1-0",
        "campaign_id": "spring-boot-2-x-gradle-to-4.1.0-p0-p11",
        "source_framework": "spring-boot",
        "source_version": "2.7.18",
        "source_java": "17",
        "source_servlet": "4.0.1",
        ...
        "mode": "upgrade",
        "recipe_filename": "spring-to-boot-4.1.0.yml",
        "recipe_class": "io.elmos.openrewrite.SpringBoot2xGradleToBoot4_1_0Java21",
        "evidence_json": "boot-2.x-gradle-to-boot-4.1.0-java-21.json",
    },
    {
        "pack_key": "spring-framework-5-3-mvc-to-boot-4-1-0",
        "campaign_id": "spring-framework-5.3-mvc-to-boot-4.1.0-p0-p11",
        "source_framework": "spring-framework-mvc",
        "source_version": "5.3.39",
        "source_java": "11",
        "source_servlet": "4.0.1",
        "source_container": "9.0.120",
        "build_tool": "maven",
        "mode": "modernization",
        "recipe_filename": "spring-framework-mvc-to-boot-4.1.0.yml",
        "recipe_class": "io.elmos.openrewrite.SpringFrameworkMvcToSpringBoot4_1_0Java21",
        "evidence_json": "spring-mvc-3.2-7.0-maven-to-boot-4.1.0-java-21.json",
    },
]
...
def scaffold_and_certify_pack(spec: dict[str, Any]) -> None:
    ...
    # Copy binary artifacts from template pack, renaming executed-spring-boot-3.5.3.jar to executed-spring-boot-4.1.0.jar
    ...
    for item in src_artifacts.iterdir():
        ...
        elif item.name == "executed-spring-boot-3.5.3.jar":
            shutil.copy2(item, dst_artifacts / "executed-spring-boot-4.1.0.jar")
        else:
    ...
    if build_tool == "gradle":
        ...
        toolchain_digests = [
            "gradle:8.14.3-eclipse-temurin-21@sha256:59ad3b66d7ad1a2beffcbfe38865e92c2069e2b17ec1e9dbb1abceba8395f13d"
        ]
    else:
        build_commands = [
    ...
    target_profile = {
        ...
        "providers": {
            ...
            "dependency_injection": {"provider": "spring-framework", "version": "7.0.8"},
    ...
    # 4. Version matrix
    source_framework = spec.get("source_framework", "spring-boot")
    if build_tool == "gradle":
        build_id = "gradle-8.14.3"
    else:
        build_id = "maven-3.9.11"
    ...
    if source_framework == "spring-boot":
        source_tuple["spring_boot"] = spec["source_version"]
    else:
        source_tuple["spring_framework"] = spec["source_version"]
    ...
    (pack_dir / "adapters" / "runtime-adapter.json").write_text(json.dumps({
        "implementation": "OPENREWRITE_MAVEN_PLUGIN_AND_SPRING_BOOT_4_TRANSFORMER" if build_tool == "maven" else "OPENREWRITE_GRADLE_PLUGIN_AND_SPRING_BOOT_4_TRANSFORMER",
        "pack_key": pack_key,
        "schema_version": 1,
    }, indent=2) + "\n", encoding="utf-8")
    ...
    ref_data = json.loads(ref_evidence_src.read_text(encoding="utf-8"))
    ref_data["pack_key"] = pack_key
    ref_data["execution_status"] = "PASSED_LOCAL"
    ref_data["certification_status"] = "NOT_CERTIFIED"
    (pack_dir / "certification" / "local-reference-evidence.json").write_text(json.dumps(ref_data, indent=2) + "\n", encoding="utf-8")

    # 11. Local execution exact tuple and qualification policy
    target_artifact_path = pack_dir / "certification" / "local-execution" / "2026-09-08" / "artifacts" / "executed-spring-boot-4.1.0.jar"
    ...
    exact_tuple = {
        ...
        "source": {
            ...
            "java": spec["source_java"],
            "maven": "3.9.11",
            "packaging": "war" if source_framework == "spring-framework-mvc" else "executable-jar",
        ...
        "target": {
            ...
            "spring_framework_version": "7.0.8",
        },
        "toolchain": {
    ...
    campaign = {
        ...
        "tuple_binding": {
            ...
            "target_artifact": {
                ...
                "path": "certification/local-execution/2026-09-08/artifacts/executed-spring-boot-4.1.0.jar",
    ...
    if build_tool == "gradle":
        build_tools_list = ["gradle-8.14.3"]
    else:
        build_tools_list = ["maven-3.9.11"]
    ...
    print(
        f"Pack {pack_key} scaffolded as experimental / NOT_CERTIFIED; "
        "use execute_spring_certification_campaign.py with externally mounted "
        "evidence and trust material for promotion."
    )
...
def main() -> int:
    ...
    print("\nAll 7 Spring Boot 4.1.0 packs scaffolded; certification remains external and NOT_RUN.")
    return 0
