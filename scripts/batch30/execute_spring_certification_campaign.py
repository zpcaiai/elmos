#!/usr/bin/env python3
"""Disabled fail-closed entrypoint: repository-side multi-role certification campaign signing."""
        ...
        json.dumps(
            {
                ...
                "reason": "repository-side multi-role certification campaign signing is prohibited inside the repository after ELMOS-CERT-KEY-2026-09-13-01",
