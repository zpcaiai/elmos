#!/usr/bin/env python3
"""Disabled fail-closed entrypoint: repository-side Spring Boot 4 independent dossier signing."""
        ...
        json.dumps(
            {
                ...
                "reason": "repository-side Spring Boot 4 independent dossier signing is prohibited inside the repository after ELMOS-CERT-KEY-2026-09-13-01",
