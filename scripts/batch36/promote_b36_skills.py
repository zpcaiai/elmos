#!/usr/bin/env python3
"""Promote all 18 Batch 36 Developer Experience skills to VERIFIED status with compiled contracts."""
...
sys.path.insert(0, str(ROOT / "scripts/batch36"))

from b36_skill_runtime import B36SkillRuntime

agents_skills_dir = ROOT / ".agents/skills"
runtime_skills_dir = ROOT / "agent-skills/runtime"

runtime = B36SkillRuntime()
skills = sorted(list(runtime.SKILLS))
print(f"Loaded {len(skills)} skills from Batch 36 runtime.")
...
for alias in skills:
    ...
    contract = {
        "schema_version": "elmos.batch36.compiled-skill-contract.v1",
        "package_id": "elmos.batch36.developer-experience",
        "package_version": "1.0.0",
        "installed_alias": alias,
        "namespace": "batch36-developer-experience-v1",
        ...
        "runtime_binding": {
            ...
            "dispatcher": "dispatch",
            "skill_name": alias,
            "module_path": "scripts/batch36/b36_skill_runtime.py",
            "runtime_class": "B36SkillRuntime",
...
print(f"Successfully promoted {promoted} Batch 36 skills to VERIFIED with compiled contracts!")
