#!/usr/bin/env python3
"""Promote all 20 Batch 33 Cloud & IaC skills to VERIFIED status with compiled contracts."""
...
sys.path.insert(0, str(ROOT / "scripts/batch33"))
...
runtime = B33SkillRuntime()
skills = sorted(list(runtime.SKILLS))
print(f"Loaded {len(skills)} skills from Batch 33 runtime.")
...
for alias in skills:
    ...
    contract = {
        "schema_version": "elmos.batch33.compiled-skill-contract.v1",
        "package_id": "elmos.batch33.cloud-iac-devops",
        "package_version": "1.0.0",
        "installed_alias": alias,
        "namespace": "batch33-cloud-iac-devops-v1",
        ...
        "runtime_binding": {
            ...
            "dispatcher": "dispatch",
            "skill_name": alias,
            "module_path": "scripts/batch33/b33_skill_runtime.py",
            "runtime_class": "B33SkillRuntime",
...
print(f"Successfully promoted {promoted} Batch 33 skills to VERIFIED with compiled contracts!")
