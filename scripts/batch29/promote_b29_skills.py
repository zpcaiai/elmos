#!/usr/bin/env python3
"""Promote all 20 Batch 29 Directed Language Route skills to VERIFIED status with compiled contracts."""
...
from b29_skill_runtime import B29SkillRuntime

agents_skills_dir = ROOT / ".agents/skills"
runtime_skills_dir = ROOT / "agent-skills/runtime"

runtime = B29SkillRuntime()
skills = sorted(list(runtime.SKILLS))
print(f"Loaded {len(skills)} skills from Batch 29 runtime.")
...
for alias in skills:
    ...
    contract = {
        "schema_version": "elmos.batch29.compiled-skill-contract.v1",
        "package_id": "elmos.batch29.directed-language-routes",
        "package_version": "1.0.0",
        "installed_alias": alias,
        "namespace": "batch29-language-routes-v1",
        ...
        "runtime_binding": {
            ...
            "dispatcher": "dispatch",
            "skill_name": alias,
            "module_path": "scripts/batch29/b29_skill_runtime.py",
            "runtime_class": "B29SkillRuntime",
...
print(f"Successfully promoted {promoted} Batch 29 skills to VERIFIED with compiled contracts!")
