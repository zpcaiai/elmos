#!/usr/bin/env python3
"""Promote all 22 Batch 35 Advanced Verification skills to VERIFIED status with compiled contracts."""
...
sys.path.insert(0, str(ROOT / "scripts/batch35"))

from b35_skill_runtime import B35SkillRuntime

agents_skills_dir = ROOT / ".agents/skills"
runtime_skills_dir = ROOT / "agent-skills/runtime"

runtime = B35SkillRuntime()
skills = sorted(list(runtime.SKILLS))
print(f"Loaded {len(skills)} skills from Batch 35 runtime.")
...
for alias in skills:
    ...
    contract = {
        "schema_version": "elmos.batch35.compiled-skill-contract.v1",
        "package_id": "elmos.batch35.advanced-verification",
        "package_version": "1.0.0",
        "installed_alias": alias,
        "namespace": "batch35-advanced-verification-v1",
        ...
        "runtime_binding": {
            ...
            "dispatcher": "dispatch",
            "skill_name": alias,
            "module_path": "scripts/batch35/b35_skill_runtime.py",
            "runtime_class": "B35SkillRuntime",
...
print(f"Successfully promoted {promoted} Batch 35 skills to VERIFIED with compiled contracts!")
