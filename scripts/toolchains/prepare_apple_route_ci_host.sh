...
readonly EXPECTED_HOST_PROFILE_PREVIOUS="20260831.0337.3:26.6.2:25G83"
readonly EXPECTED_HOST_PROFILE_CURRENT="20260907.0351.1:26.6.2:25G83"
...
case "${HOST_PROFILE}" in
  "${EXPECTED_HOST_PROFILE_LEGACY}"|\
  "${EXPECTED_HOST_PROFILE_PREVIOUS}"|\
  "${EXPECTED_HOST_PROFILE_CURRENT}") ;;
  *)
