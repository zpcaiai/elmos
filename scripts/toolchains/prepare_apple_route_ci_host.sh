...
readonly EXPECTED_HOST_PROFILE_LATEST="20260907.0351.1:26.6.2:25G83"
...
case "${HOST_PROFILE}" in
  "${EXPECTED_HOST_PROFILE_LEGACY}"|"${EXPECTED_HOST_PROFILE_CURRENT}"|"${EXPECTED_HOST_PROFILE_LATEST}") ;;
  *)
