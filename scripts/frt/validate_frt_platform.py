...
REQUIRED_SURFACES = {
    ...
    "apps/web-console/app/api/frt/runs/_route.ts",
    "apps/web-console/app/api/frt/runs/[runId]/_route.ts",
    "apps/web-console/app/api/frt/runs/[runId]/audit/_route.ts",
    "apps/web-console/app/api/frt/runs/[runId]/[operation]/_route.ts",
