...
def main() -> int:
    ...
    result_without_digest = {
        ...
        "external_engineering_status": "PASSED_LOCAL_ENGINEERING_SIMULATION_FOR_557_OF_557_WITH_2785_HANDLER_INVOCATIONS_AND_15_RELEASE_DRILLS; PRODUCTION_ELIGIBLE_FALSE",
