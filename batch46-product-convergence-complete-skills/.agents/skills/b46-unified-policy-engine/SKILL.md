---
name: b46-unified-policy-engine
description: 统一源码外传、工具权限、模型Context、Runner、Extension、审批、驻留和预算决策。
---

# Skill 1502：统一Policy Engine
...
统一源码外传、工具权限、模型Context、Runner、Extension、审批、驻留和预算决策。
...
- Unknown与缺失属性默认Deny；Agent、Runner、Extension和管理员不能自批或绕过；Decision必须可解释。
