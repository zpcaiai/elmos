---
name: b46-reference-architecture-blueprint
description: 固化Customer Experience、Control Plane Kernel、Execution Plane和Extension Layer边界及数据流。
---

# Skill 1527：ELMOS统一Reference Architecture
...
固化Customer Experience、Control Plane Kernel、Execution Plane和Extension Layer边界及数据流。
...
- Reference Architecture必须定义边界、数据流、信任边界、扩展点、部署拓扑和演进原则。
