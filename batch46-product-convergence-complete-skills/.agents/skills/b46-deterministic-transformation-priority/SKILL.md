---
name: b46-deterministic-transformation-priority
description: 强制Static Rule→Certified Recipe→Compatibility Runtime→Bounded Agent→Human→Block策略。
---

# Skill 1518：确定性转换优先与Agent边界
...
强制Static Rule→Certified Recipe→Compatibility Runtime→Bounded Agent→Human→Block策略。
...
- 确定性机制优先；Agent不得改Policy、Golden、测试或自批；未知P0必须Block。
...
- `policies/transformation-priority/`
