---
name: b46-control-plane-modular-monolith
description: 实现Tenant、Project、Repository、Workflow、Migration、Artifact、Evidence、Policy、Runner、Validation和Certification模块。
---

# Skill 1516：Control Plane模块化单体参考实现
...
实现Tenant、Project、Repository、Workflow、Migration、Artifact、Evidence、Policy、Runner、Validation和Certification模块。
...
- 先模块化单体；只有团队、负载或安全边界证据充分才拆服务；禁止无必要的分布式复杂度。
