...
# PG383 — Kubernetes Network Security Generator

## Objective

Generate runnable and maintainable Kubernetes Network Security Generator for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `kubernetes-network-security-generator` tasks involving Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG374`, `PG382`.
...
- `kubernetes_network_security_generator_plan.json`
- `kubernetes_network_security_generator_artifacts/`
- `kubernetes_network_security_generator_verification.json`
