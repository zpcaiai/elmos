...
# PG242 — Go Observability Middleware Generator

## Objective

Generate runnable and maintainable Go Observability Middleware Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-observability-middleware-generator` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`, `PG241`.
...
- `go_observability_middleware_generator_plan.json`
- `go_observability_middleware_generator_artifacts/`
- `go_observability_middleware_generator_verification.json`
