---
name: b74-shell-process-pipeline-orchestrator
description: "Use when ELMOS must coordinate and control Shell Process Pipeline Orchestrator for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Shell Process Pipeline Orchestrator, Batch 74, Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests."
metadata:
  id: PG325
  batch: 74
  version: 1.0.0
...
# PG325 — Shell Process Pipeline Orchestrator

## Objective

Coordinate and control Shell Process Pipeline Orchestrator for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `shell-process-pipeline-orchestrator` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`, `PG324`.
...
- `shell_process_pipeline_orchestrator_plan.json`
- `shell_process_pipeline_orchestrator_artifacts/`
- `shell_process_pipeline_orchestrator_verification.json`
