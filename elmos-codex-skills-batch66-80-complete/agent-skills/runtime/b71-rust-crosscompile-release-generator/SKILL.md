---
name: b71-rust-crosscompile-release-generator
description: "Use when ELMOS must generate runnable and maintainable Rust Crosscompile Release Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Rust Crosscompile Release Generator, Batch 71, Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases."
metadata:
  id: PG295
  batch: 71
  version: 1.0.0
...
# PG295 — Rust Crosscompile Release Generator

## Objective

Generate runnable and maintainable Rust Crosscompile Release Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `rust-crosscompile-release-generator` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`, `PG294`.
...
- `rust_crosscompile_release_generator_plan.json`
- `rust_crosscompile_release_generator_artifacts/`
- `rust_crosscompile_release_generator_verification.json`
