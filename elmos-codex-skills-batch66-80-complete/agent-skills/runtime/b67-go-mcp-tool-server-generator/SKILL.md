---
name: b67-go-mcp-tool-server-generator
description: "Use when ELMOS must generate runnable and maintainable Go MCP Tool Server Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Go MCP Tool Server Generator, Batch 67, Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation."
metadata:
  id: PG244
  batch: 67
  version: 1.0.0
...
# PG244 — Go MCP Tool Server Generator

## Objective

Generate runnable and maintainable Go MCP Tool Server Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-mcp-tool-server-generator` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`, `PG243`.
...
- `go_mcp_tool_server_generator_plan.json`
- `go_mcp_tool_server_generator_artifacts/`
- `go_mcp_tool_server_generator_verification.json`
