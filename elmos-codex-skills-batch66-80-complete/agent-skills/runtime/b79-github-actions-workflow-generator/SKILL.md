---
name: b79-github-actions-workflow-generator
description: "Use when ELMOS must generate runnable and maintainable GitHub Actions Workflow Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: GitHub Actions Workflow Generator, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG392
  batch: 79
  version: 1.0.0
...
# PG392 — GitHub Actions Workflow Generator

## Objective

Generate runnable and maintainable GitHub Actions Workflow Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `github-actions-workflow-generator` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG391`.
...
- `github_actions_workflow_generator_plan.json`
- `github_actions_workflow_generator_artifacts/`
- `github_actions_workflow_generator_verification.json`
