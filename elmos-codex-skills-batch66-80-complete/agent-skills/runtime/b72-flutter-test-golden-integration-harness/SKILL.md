...
# PG306 — Flutter Test Golden Integration Harness
...
Use for `flutter-test-golden-integration-harness` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG305`.
...
- `flutter_test_golden_integration_harness_plan.json`
- `flutter_test_golden_integration_harness_artifacts/`
- `flutter_test_golden_integration_harness_verification.json`
