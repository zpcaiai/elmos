...
# PG229 — Vue Nuxt App Generator

## Objective

Generate runnable and maintainable Vue Nuxt App Generator for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `vue-nuxt-app-generator` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG228`.
...
- `vue_nuxt_app_generator_plan.json`
- `vue_nuxt_app_generator_artifacts/`
- `vue_nuxt_app_generator_verification.json`
