...
# PG232 — TypeScript Contract Client Generator

## Objective

Generate runnable and maintainable TypeScript Contract Client Generator for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `typescript-contract-client-generator` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG231`.
...
- `typescript_contract_client_generator_plan.json`
- `typescript_contract_client_generator_artifacts/`
- `typescript_contract_client_generator_verification.json`
