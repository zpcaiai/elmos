...
# PG274 — Modern C++ Library Service Generator

## Objective

Generate runnable and maintainable Modern C++ Library Service Generator for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `modern-cpp-library-service-generator` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG273`.
...
- `modern_cpp_library_service_generator_plan.json`
- `modern_cpp_library_service_generator_artifacts/`
- `modern_cpp_library_service_generator_verification.json`
