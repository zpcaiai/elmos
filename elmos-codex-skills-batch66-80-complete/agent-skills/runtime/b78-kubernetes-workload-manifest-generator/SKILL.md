---
name: b78-kubernetes-workload-manifest-generator
description: "Use when ELMOS must generate runnable and maintainable Kubernetes Workload Manifest Generator for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Kubernetes Workload Manifest Generator, Batch 78, Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification."
metadata:
  id: PG381
  batch: 78
  version: 1.0.0
...
# PG381 — Kubernetes Workload Manifest Generator

## Objective

Generate runnable and maintainable Kubernetes Workload Manifest Generator for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `kubernetes-workload-manifest-generator` tasks involving Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG374`, `PG380`.
...
- `kubernetes_workload_manifest_generator_plan.json`
- `kubernetes_workload_manifest_generator_artifacts/`
- `kubernetes_workload_manifest_generator_verification.json`
