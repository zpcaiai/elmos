---
name: b74-powershell-module-command-generator
description: "Use when ELMOS must generate runnable and maintainable Powershell Module Command Generator for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Powershell Module Command Generator, Batch 74, Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests."
metadata:
  id: PG329
  batch: 74
  version: 1.0.0
...
# PG329 — Powershell Module Command Generator

## Objective

Generate runnable and maintainable Powershell Module Command Generator for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `powershell-module-command-generator` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`, `PG328`.
...
- `powershell_module_command_generator_plan.json`
- `powershell_module_command_generator_artifacts/`
- `powershell_module_command_generator_verification.json`
