...
# PG226 — NestJS Fastify API Generator

## Objective

Generate runnable and maintainable NestJS Fastify API Generator for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `nestjs-fastify-api-generator` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG225`.
...
- `nestjs_fastify_api_generator_plan.json`
- `nestjs_fastify_api_generator_artifacts/`
- `nestjs_fastify_api_generator_verification.json`
