---
name: b68-kotlin-project-profile-detector
description: "Use when ELMOS must inspect and model Kotlin Project Profile Detector for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Kotlin Project Profile Detector, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG247
  batch: 68
  version: 1.0.0
...
# PG247 — Kotlin Project Profile Detector

## Objective

Inspect and model Kotlin Project Profile Detector for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `kotlin-project-profile-detector` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`.
...
- `kotlin_project_profile_detector.json`
- `kotlin_project_profile_detector_artifacts/`
- `kotlin_project_profile_detector_verification.json`
