---
name: b68-android-compose-application-generator
description: "Use when ELMOS must generate runnable and maintainable Android Compose Application Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Android Compose Application Generator, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG255
  batch: 68
  version: 1.0.0
...
# PG255 — Android Compose Application Generator

## Objective

Generate runnable and maintainable Android Compose Application Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `android-compose-application-generator` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG254`.
...
- `android_compose_application_generator_plan.json`
- `android_compose_application_generator_artifacts/`
- `android_compose_application_generator_verification.json`
