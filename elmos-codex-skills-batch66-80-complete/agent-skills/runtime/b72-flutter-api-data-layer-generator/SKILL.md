---
name: b72-flutter-api-data-layer-generator
description: "Use when ELMOS must generate runnable and maintainable Flutter API Data Layer Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Flutter API Data Layer Generator, Batch 72, Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging."
metadata:
  id: PG301
  batch: 72
  version: 1.0.0
...
# PG301 — Flutter API Data Layer Generator

## Objective

Generate runnable and maintainable Flutter API Data Layer Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `flutter-api-data-layer-generator` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG300`.
...
- `flutter_api_data_layer_generator_plan.json`
- `flutter_api_data_layer_generator_artifacts/`
- `flutter_api_data_layer_generator_verification.json`
