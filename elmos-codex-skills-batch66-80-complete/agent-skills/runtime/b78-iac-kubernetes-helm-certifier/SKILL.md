---
name: b78-iac-kubernetes-helm-certifier
description: "Use when ELMOS must execute and independently verify IaC Kubernetes Helm Certifier for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: IaC Kubernetes Helm Certifier, Batch 78, Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification."
metadata:
  id: PG390
  batch: 78
  version: 1.0.0
...
# PG390 — IaC Kubernetes Helm Certifier

## Objective

Execute and independently verify IaC Kubernetes Helm Certifier for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `iac-kubernetes-helm-certifier` tasks involving Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG374`, `PG389`.
...
- `iac_kubernetes_helm_certifier_plan.json`
- `iac_kubernetes_helm_certifier_artifacts/`
- `iac_kubernetes_helm_certifier_verification.json`
...
- Lint and render every supported values profile.
- Test upgrade, hooks, CRDs, immutable fields, and rollback.
- Use values schema and stable resource naming.
