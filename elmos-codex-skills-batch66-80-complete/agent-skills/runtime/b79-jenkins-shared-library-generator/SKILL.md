---
name: b79-jenkins-shared-library-generator
description: "Use when ELMOS must generate runnable and maintainable Jenkins Shared Library Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Jenkins Shared Library Generator, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG401
  batch: 79
  version: 1.0.0
...
# PG401 — Jenkins Shared Library Generator

## Objective

Generate runnable and maintainable Jenkins Shared Library Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `jenkins-shared-library-generator` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG400`.
...
- `jenkins_shared_library_generator_plan.json`
- `jenkins_shared_library_generator_artifacts/`
- `jenkins_shared_library_generator_verification.json`
