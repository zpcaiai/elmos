---
name: b67-go-concurrency-context-safety
description: "Use when ELMOS must enforce and test Go Concurrency Context Safety for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Go Concurrency Context Safety, Batch 67, Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation."
metadata:
  id: PG241
  batch: 67
  version: 1.0.0
...
# PG241 — Go Concurrency Context Safety

## Objective

Enforce and test Go Concurrency Context Safety for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-concurrency-context-safety` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`, `PG240`.
...
- `go_concurrency_context_safety_plan.json`
- `go_concurrency_context_safety_artifacts/`
- `go_concurrency_context_safety_verification.json`
