---
name: b67-go-repository-profile-detector
description: "Use when ELMOS must inspect and model Go Repository Profile Detector for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Go Repository Profile Detector, Batch 67, Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation."
metadata:
  id: PG235
  batch: 67
  version: 1.0.0
...
# PG235 — Go Repository Profile Detector

## Objective

Inspect and model Go Repository Profile Detector for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-repository-profile-detector` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`.
...
- `go_repository_profile_detector.json`
- `go_repository_profile_detector_artifacts/`
- `go_repository_profile_detector_verification.json`
