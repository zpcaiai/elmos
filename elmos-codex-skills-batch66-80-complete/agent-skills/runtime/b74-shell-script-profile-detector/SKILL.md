...
# PG321 — Shell Script Profile Detector

## Objective

Inspect and model Shell Script Profile Detector for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `shell-script-profile-detector` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`.
...
- `shell_script_profile_detector.json`
- `shell_script_profile_detector_artifacts/`
- `shell_script_profile_detector_verification.json`
