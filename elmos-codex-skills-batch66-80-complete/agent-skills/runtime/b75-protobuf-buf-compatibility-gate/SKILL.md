---
name: b75-protobuf-buf-compatibility-gate
description: "Use when ELMOS must enforce and test Protocol Buffers Buf Compatibility Gate for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Protocol Buffers Buf Compatibility Gate, Batch 75, SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility."
metadata:
  id: PG347
  batch: 75
  version: 1.0.0
...
# PG347 — Protocol Buffers Buf Compatibility Gate

## Objective

Enforce and test Protocol Buffers Buf Compatibility Gate for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `protobuf-buf-compatibility-gate` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG346`.
...
- `protobuf_buf_compatibility_gate_plan.json`
- `protobuf_buf_compatibility_gate_artifacts/`
- `protobuf_buf_compatibility_gate_verification.json`
...
- Run wire/source/package compatibility checks.
