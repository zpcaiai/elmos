---
name: b72-flutter-offline-sync-generator
description: "Use when ELMOS must generate runnable and maintainable Flutter Offline Sync Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Flutter Offline Sync Generator, Batch 72, Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging."
metadata:
  id: PG302
  batch: 72
  version: 1.0.0
...
# PG302 — Flutter Offline Sync Generator

## Objective

Generate runnable and maintainable Flutter Offline Sync Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `flutter-offline-sync-generator` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG301`.
...
- `flutter_offline_sync_generator_plan.json`
- `flutter_offline_sync_generator_artifacts/`
- `flutter_offline_sync_generator_verification.json`
