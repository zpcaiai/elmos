...
# PG305 — Flutter Accessibility Localization
...
Use for `flutter-accessibility-localization` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG304`.
...
- `flutter_accessibility_localization_plan.json`
- `flutter_accessibility_localization_artifacts/`
- `flutter_accessibility_localization_verification.json`
