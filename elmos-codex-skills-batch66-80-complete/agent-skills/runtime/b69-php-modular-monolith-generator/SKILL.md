...
# PG263 — Php Modular Monolith Generator

## Objective

Generate runnable and maintainable Php Modular Monolith Generator for PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `php-modular-monolith-generator` tasks involving PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG258`, `PG262`.
...
- `php_modular_monolith_generator_plan.json`
- `php_modular_monolith_generator_artifacts/`
- `php_modular_monolith_generator_verification.json`
