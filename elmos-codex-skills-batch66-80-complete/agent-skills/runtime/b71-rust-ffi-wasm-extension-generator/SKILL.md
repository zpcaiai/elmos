...
# PG291 — Rust FFI WASM Extension Generator

## Objective

Generate runnable and maintainable Rust FFI WASM Extension Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `rust-ffi-wasm-extension-generator` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`, `PG290`.
...
- `rust_ffi_wasm_extension_generator_plan.json`
- `rust_ffi_wasm_extension_generator_artifacts/`
- `rust_ffi_wasm_extension_generator_verification.json`
