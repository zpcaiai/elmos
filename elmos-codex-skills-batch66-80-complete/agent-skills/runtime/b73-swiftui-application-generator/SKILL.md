---
name: b73-swiftui-application-generator
description: "Use when ELMOS must generate runnable and maintainable SwiftUI Application Generator for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: SwiftUI Application Generator, Batch 73, Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing."
metadata:
  id: PG311
  batch: 73
  version: 1.0.0
...
# PG311 — SwiftUI Application Generator

## Objective

Generate runnable and maintainable SwiftUI Application Generator for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `swiftui-application-generator` tasks involving Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG308`, `PG310`.
...
- `swiftui_application_generator_plan.json`
- `swiftui_application_generator_artifacts/`
- `swiftui_application_generator_verification.json`
