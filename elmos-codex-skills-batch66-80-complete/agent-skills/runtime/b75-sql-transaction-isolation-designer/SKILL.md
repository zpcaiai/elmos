...
# PG338 — SQL Transaction Isolation Designer

## Objective

Coordinate and control SQL Transaction Isolation Designer for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `sql-transaction-isolation-designer` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG337`.
...
- `sql_transaction_isolation_designer_plan.json`
- `sql_transaction_isolation_designer_artifacts/`
- `sql_transaction_isolation_designer_verification.json`
...
- Test rollback, retries, isolation, and concurrency anomalies.
- Keep retry scopes idempotent.
- Bound locks and transaction duration.
- Use parameterized SQL and explicit dialect/version constraints.
- Test null, ordering, time, JSON, locking, and pagination semantics.
- Never treat generated SQL as safe without execution evidence.
