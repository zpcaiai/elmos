...
# PG341 — SQL Security RLS Policy Generator

## Objective

Enforce and test SQL Security RLS Policy Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `sql-security-rls-policy-generator` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG340`.
...
- `sql_security_rls_policy_generator_plan.json`
- `sql_security_rls_policy_generator_artifacts/`
- `sql_security_rls_policy_generator_verification.json`
...
- Secret values may never appear in generated source or logs.
- Include negative authorization and injection tests.
