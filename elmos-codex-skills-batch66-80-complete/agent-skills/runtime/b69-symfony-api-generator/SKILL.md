...
# PG262 — Symfony API Generator

## Objective

Generate runnable and maintainable Symfony API Generator for PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `symfony-api-generator` tasks involving PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG258`, `PG261`.
...
- `symfony_api_generator_plan.json`
- `symfony_api_generator_artifacts/`
- `symfony_api_generator_verification.json`
