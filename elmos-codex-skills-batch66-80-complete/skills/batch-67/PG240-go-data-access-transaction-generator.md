---
name: b67-go-data-access-transaction-generator
description: "Use when ELMOS must generate runnable and maintainable Go Data Access Transaction Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Go Data Access Transaction Generator, Batch 67, Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation."
metadata:
  id: PG240
  batch: 67
  version: 1.0.0
...
# PG240 — Go Data Access Transaction Generator

## Objective

Generate runnable and maintainable Go Data Access Transaction Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-data-access-transaction-generator` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`, `PG239`.
...
- `go_data_access_transaction_generator_plan.json`
- `go_data_access_transaction_generator_artifacts/`
- `go_data_access_transaction_generator_verification.json`
