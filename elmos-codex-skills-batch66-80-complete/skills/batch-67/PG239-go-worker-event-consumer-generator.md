---
name: b67-go-worker-event-consumer-generator
description: "Use when ELMOS must generate runnable and maintainable Go Worker Event Consumer Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Go Worker Event Consumer Generator, Batch 67, Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation."
metadata:
  id: PG239
  batch: 67
  version: 1.0.0
...
# PG239 — Go Worker Event Consumer Generator

## Objective

Generate runnable and maintainable Go Worker Event Consumer Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-worker-event-consumer-generator` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`, `PG238`.
...
- `go_worker_event_consumer_generator_plan.json`
- `go_worker_event_consumer_generator_artifacts/`
- `go_worker_event_consumer_generator_verification.json`
