---
name: b76-portable-makefile-generator
description: "Use when ELMOS must generate runnable and maintainable Portable Makefile Generator for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Portable Makefile Generator, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG352
  batch: 76
  version: 1.0.0
...
# PG352 — Portable Makefile Generator

## Objective

Generate runnable and maintainable Portable Makefile Generator for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `portable-makefile-generator` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`, `PG351`.
...
- `portable_makefile_generator_plan.json`
- `portable_makefile_generator_artifacts/`
- `portable_makefile_generator_verification.json`
