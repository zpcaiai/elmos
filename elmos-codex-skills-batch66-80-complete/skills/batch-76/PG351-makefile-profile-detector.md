---
name: b76-makefile-profile-detector
description: "Use when ELMOS must inspect and model Makefile Profile Detector for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Makefile Profile Detector, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG351
  batch: 76
  version: 1.0.0
...
# PG351 — Makefile Profile Detector

## Objective

Inspect and model Makefile Profile Detector for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `makefile-profile-detector` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`.
...
- `makefile_profile_detector.json`
- `makefile_profile_detector_artifacts/`
- `makefile_profile_detector_verification.json`
