---
name: b76-cmake-presets-crossbuild-manager
description: "Use when ELMOS must coordinate and control CMake Presets Crossbuild Manager for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: CMake Presets Crossbuild Manager, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG358
  batch: 76
  version: 1.0.0
...
# PG358 — CMake Presets Crossbuild Manager

## Objective

Coordinate and control CMake Presets Crossbuild Manager for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `cmake-presets-crossbuild-manager` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`, `PG357`.
...
- `cmake_presets_crossbuild_manager_plan.json`
- `cmake_presets_crossbuild_manager_artifacts/`
- `cmake_presets_crossbuild_manager_verification.json`
