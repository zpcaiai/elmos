---
name: b76-nginx-reverse-proxy-generator
description: "Use when ELMOS must generate runnable and maintainable Nginx Reverse Proxy Generator for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Nginx Reverse Proxy Generator, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG360
  batch: 76
  version: 1.0.0
...
# PG360 — Nginx Reverse Proxy Generator

## Objective

Generate runnable and maintainable Nginx Reverse Proxy Generator for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `nginx-reverse-proxy-generator` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`, `PG359`.
...
- `nginx_reverse_proxy_generator_plan.json`
- `nginx_reverse_proxy_generator_artifacts/`
- `nginx_reverse_proxy_generator_verification.json`
