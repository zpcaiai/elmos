---
name: b69-composer-dependency-reproducer
description: "Use when ELMOS must reproduce deterministically Composer Dependency Reproducer for PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Composer Dependency Reproducer, Batch 69, PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment."
metadata:
  id: PG260
  batch: 69
  version: 1.0.0
  ...
  category: "PHP Laravel Symfony and CMS Project Pack"
---

# PG260 — Composer Dependency Reproducer

## Objective

Reproduce deterministically Composer Dependency Reproducer for PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `composer-dependency-reproducer` tasks involving PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment.
...
- Inspect source markers such as `composer.json`, `composer.lock`, `artisan`, `bin/console`, `public/index.php`, `wp-content/` and resolve effective includes, generated files, workspaces, modules, targets, and entrypoints.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG258`, `PG259`.
...
- `composer_dependency_reproducer_plan.json`
- `composer_dependency_reproducer_artifacts/`
- `composer_dependency_reproducer_verification.json`
...
- Preferred tools: `php`, `composer`, `phpunit/pest`, `phpstan/psalm`, `php-cs-fixer`, `rector`. Record alternate tools, versions, and rationale.
...
- Model services, networks, volumes, readiness, init tasks, and cleanup.
- Do not use depends_on as a substitute for application retries.
- Distinguish development convenience from production controls.
