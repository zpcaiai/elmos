...
# PG261 — Laravel Application Generator

## Objective

Generate runnable and maintainable Laravel Application Generator for PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `laravel-application-generator` tasks involving PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG258`, `PG260`.
...
- `laravel_application_generator_plan.json`
- `laravel_application_generator_artifacts/`
- `laravel_application_generator_verification.json`
