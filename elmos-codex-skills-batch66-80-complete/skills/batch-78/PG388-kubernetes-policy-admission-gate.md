---
name: b78-kubernetes-policy-admission-gate
description: "Use when ELMOS must enforce and test Kubernetes Policy Admission Gate for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Kubernetes Policy Admission Gate, Batch 78, Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification."
metadata:
  id: PG388
  batch: 78
  version: 1.0.0
...
# PG388 — Kubernetes Policy Admission Gate

## Objective

Enforce and test Kubernetes Policy Admission Gate for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `kubernetes-policy-admission-gate` tasks involving Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG374`, `PG387`.
...
- `kubernetes_policy_admission_gate_plan.json`
- `kubernetes_policy_admission_gate_artifacts/`
- `kubernetes_policy_admission_gate_verification.json`
