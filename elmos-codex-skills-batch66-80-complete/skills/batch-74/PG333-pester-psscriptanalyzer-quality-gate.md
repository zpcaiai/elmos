---
name: b74-pester-psscriptanalyzer-quality-gate
description: "Use when ELMOS must enforce and test Pester Psscriptanalyzer Quality Gate for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Pester Psscriptanalyzer Quality Gate, Batch 74, Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests."
metadata:
  id: PG333
  batch: 74
  version: 1.0.0
...
# PG333 — Pester Psscriptanalyzer Quality Gate

## Objective

Enforce and test Pester Psscriptanalyzer Quality Gate for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `pester-psscriptanalyzer-quality-gate` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`, `PG332`.
...
- `pester_psscriptanalyzer_quality_gate_plan.json`
- `pester_psscriptanalyzer_quality_gate_artifacts/`
- `pester_psscriptanalyzer_quality_gate_verification.json`
