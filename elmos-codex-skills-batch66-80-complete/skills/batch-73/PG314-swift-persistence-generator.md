---
name: b73-swift-persistence-generator
description: "Use when ELMOS must generate runnable and maintainable Swift Persistence Generator for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Swift Persistence Generator, Batch 73, Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing."
metadata:
  id: PG314
  batch: 73
  version: 1.0.0
...
# PG314 — Swift Persistence Generator

## Objective

Generate runnable and maintainable Swift Persistence Generator for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `swift-persistence-generator` tasks involving Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG308`, `PG313`.
...
- `swift_persistence_generator_plan.json`
- `swift_persistence_generator_artifacts/`
- `swift_persistence_generator_verification.json`
