...
# PG371 — Compose Development Environment
...
Use for `compose-development-environment` tasks involving Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG362`, `PG370`.
...
- `compose_development_environment_plan.json`
- `compose_development_environment_artifacts/`
- `compose_development_environment_verification.json`
