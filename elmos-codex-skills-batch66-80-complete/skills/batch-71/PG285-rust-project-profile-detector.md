...
# PG285 — Rust Project Profile Detector

## Objective

Inspect and model Rust Project Profile Detector for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `rust-project-profile-detector` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`.
...
- `rust_project_profile_detector.json`
- `rust_project_profile_detector_artifacts/`
- `rust_project_profile_detector_verification.json`
