---
name: b71-rust-unsafe-boundary-review
description: "Use when ELMOS must enforce and test Rust Unsafe Boundary Review for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Rust Unsafe Boundary Review, Batch 71, Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases."
metadata:
  id: PG292
  batch: 71
  version: 1.0.0
...
# PG292 — Rust Unsafe Boundary Review

## Objective

Enforce and test Rust Unsafe Boundary Review for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `rust-unsafe-boundary-review` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`, `PG291`.
...
- `rust_unsafe_boundary_review_plan.json`
- `rust_unsafe_boundary_review_artifacts/`
- `rust_unsafe_boundary_review_verification.json`
