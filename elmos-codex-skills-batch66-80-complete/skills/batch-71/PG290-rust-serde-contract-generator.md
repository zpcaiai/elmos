---
name: b71-rust-serde-contract-generator
description: "Use when ELMOS must generate runnable and maintainable Rust Serde Contract Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Rust Serde Contract Generator, Batch 71, Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases."
metadata:
  id: PG290
  batch: 71
  version: 1.0.0
...
# PG290 — Rust Serde Contract Generator

## Objective

Generate runnable and maintainable Rust Serde Contract Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `rust-serde-contract-generator` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`, `PG289`.
...
- `rust_serde_contract_generator_plan.json`
- `rust_serde_contract_generator_artifacts/`
- `rust_serde_contract_generator_verification.json`
