---
name: b66-node-build-run-repair-certifier
description: "Use when ELMOS must execute and independently verify Node Build Run Repair Certifier for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Node Build Run Repair Certifier, Batch 66, TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests."
metadata:
  id: PG234
  batch: 66
  version: 1.0.0
...
# PG234 — Node Build Run Repair Certifier

## Objective

Execute and independently verify Node Build Run Repair Certifier for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `node-build-run-repair-certifier` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG233`.
...
- `node_build_run_repair_certifier_plan.json`
- `node_build_run_repair_certifier_artifacts/`
- `node_build_run_repair_certifier_verification.json`
