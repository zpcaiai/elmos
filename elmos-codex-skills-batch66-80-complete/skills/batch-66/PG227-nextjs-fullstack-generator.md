...
# PG227 — Next.js Fullstack Generator

## Objective

Generate runnable and maintainable Next.js Fullstack Generator for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `nextjs-fullstack-generator` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG226`.
...
- `nextjs_fullstack_generator_plan.json`
- `nextjs_fullstack_generator_artifacts/`
- `nextjs_fullstack_generator_verification.json`
