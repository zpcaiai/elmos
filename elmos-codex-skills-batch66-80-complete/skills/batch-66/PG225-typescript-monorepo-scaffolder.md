...
# PG225 — TypeScript Monorepo Scaffolder

## Objective

Generate runnable and maintainable TypeScript Monorepo Scaffolder for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `typescript-monorepo-scaffolder` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG224`.
...
- `typescript_monorepo_scaffolder_plan.json`
- `typescript_monorepo_scaffolder_artifacts/`
- `typescript_monorepo_scaffolder_verification.json`
...
- Create explicit package/module boundaries.
- Reject cyclic build dependencies.
- Generate examples and test entrypoints.
