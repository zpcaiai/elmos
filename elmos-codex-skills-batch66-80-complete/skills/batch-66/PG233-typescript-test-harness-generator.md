...
# PG233 — TypeScript Test Harness Generator

## Objective

Generate runnable and maintainable TypeScript Test Harness Generator for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `typescript-test-harness-generator` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG232`.
...
- `typescript_test_harness_generator_plan.json`
- `typescript_test_harness_generator_artifacts/`
- `typescript_test_harness_generator_verification.json`
