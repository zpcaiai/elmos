...
# PG230 — Node Worker CLI Generator

## Objective

Generate runnable and maintainable Node Worker CLI Generator for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `node-worker-cli-generator` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG229`.
...
- `node_worker_cli_generator_plan.json`
- `node_worker_cli_generator_artifacts/`
- `node_worker_cli_generator_verification.json`
