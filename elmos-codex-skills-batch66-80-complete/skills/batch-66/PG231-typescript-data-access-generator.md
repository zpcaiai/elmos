...
# PG231 — TypeScript Data Access Generator

## Objective

Generate runnable and maintainable TypeScript Data Access Generator for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `typescript-data-access-generator` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG230`.
...
- `typescript_data_access_generator_plan.json`
- `typescript_data_access_generator_artifacts/`
- `typescript_data_access_generator_verification.json`
