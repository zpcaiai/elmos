...
metadata:
  ...
  category: "Dart and Flutter Multiplatform Project Pack"
---

# PG297 — Flutter Project Profile Detector

## Objective

Inspect and model Flutter Project Profile Detector for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `flutter-project-profile-detector` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
- Inspect source markers such as `pubspec.yaml`, `pubspec.lock`, `lib/`, `test/`, `integration_test/`, `android/`, `ios/` and resolve effective includes, generated files, workspaces, modules, targets, and entrypoints.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`.
...
- `flutter_project_profile_detector.json`
- `flutter_project_profile_detector_artifacts/`
- `flutter_project_profile_detector_verification.json`
...
- Preferred tools: `dart`, `flutter`, `build_runner`, `dart analyze`, `flutter test`, `integration_test`. Record alternate tools, versions, and rationale.
...
- Distinguish target, flavor, simulator, and real-device evidence.
- Test lifecycle, offline, accessibility, and platform plugin behavior.
- Do not embed signing material.
