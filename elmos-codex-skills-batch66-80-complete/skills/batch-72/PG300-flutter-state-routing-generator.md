---
name: b72-flutter-state-routing-generator
description: "Use when ELMOS must generate runnable and maintainable Flutter State Routing Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Flutter State Routing Generator, Batch 72, Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging."
metadata:
  id: PG300
  batch: 72
  version: 1.0.0
...
# PG300 — Flutter State Routing Generator

## Objective

Generate runnable and maintainable Flutter State Routing Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `flutter-state-routing-generator` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG299`.
...
- `flutter_state_routing_generator_plan.json`
- `flutter_state_routing_generator_artifacts/`
- `flutter_state_routing_generator_verification.json`
