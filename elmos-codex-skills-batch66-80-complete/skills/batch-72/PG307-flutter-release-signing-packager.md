---
name: b72-flutter-release-signing-packager
description: "Use when ELMOS must generate runnable and maintainable Flutter Release Signing Packager for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Flutter Release Signing Packager, Batch 72, Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging."
metadata:
  id: PG307
  batch: 72
  version: 1.0.0
...
# PG307 — Flutter Release Signing Packager

## Objective

Generate runnable and maintainable Flutter Release Signing Packager for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `flutter-release-signing-packager` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG306`.
...
- `flutter_release_signing_packager_plan.json`
- `flutter_release_signing_packager_artifacts/`
- `flutter_release_signing_packager_verification.json`
