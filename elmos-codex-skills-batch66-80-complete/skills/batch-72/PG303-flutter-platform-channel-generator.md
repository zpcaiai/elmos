---
name: b72-flutter-platform-channel-generator
description: "Use when ELMOS must generate runnable and maintainable Flutter Platform Channel Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Flutter Platform Channel Generator, Batch 72, Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging."
metadata:
  id: PG303
  batch: 72
  version: 1.0.0
...
# PG303 — Flutter Platform Channel Generator

## Objective

Generate runnable and maintainable Flutter Platform Channel Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `flutter-platform-channel-generator` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG302`.
...
- `flutter_platform_channel_generator_plan.json`
- `flutter_platform_channel_generator_artifacts/`
- `flutter_platform_channel_generator_verification.json`
