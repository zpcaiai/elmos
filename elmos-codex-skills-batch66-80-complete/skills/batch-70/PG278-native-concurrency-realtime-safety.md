---
name: b70-native-concurrency-realtime-safety
description: "Use when ELMOS must enforce and test Native Concurrency Realtime Safety for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Native Concurrency Realtime Safety, Batch 70, C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing."
metadata:
  id: PG278
  batch: 70
  version: 1.0.0
...
# PG278 — Native Concurrency Realtime Safety

## Objective

Enforce and test Native Concurrency Realtime Safety for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `native-concurrency-realtime-safety` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG277`.
...
- `native_concurrency_realtime_safety_plan.json`
- `native_concurrency_realtime_safety_artifacts/`
- `native_concurrency_realtime_safety_verification.json`
