...
# PG275 — C API Abi Contract Manager

## Objective

Coordinate and control C API Abi Contract Manager for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `c-api-abi-contract-manager` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG274`.
...
- `c_api_abi_contract_manager_plan.json`
- `c_api_abi_contract_manager_artifacts/`
- `c_api_abi_contract_manager_verification.json`
