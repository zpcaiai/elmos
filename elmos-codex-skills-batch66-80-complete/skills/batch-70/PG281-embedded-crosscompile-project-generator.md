...
# PG281 — Embedded Crosscompile Project Generator

## Objective

Generate runnable and maintainable Embedded Crosscompile Project Generator for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `embedded-crosscompile-project-generator` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG280`.
...
- `embedded_crosscompile_project_generator_plan.json`
- `embedded_crosscompile_project_generator_artifacts/`
- `embedded_crosscompile_project_generator_verification.json`
