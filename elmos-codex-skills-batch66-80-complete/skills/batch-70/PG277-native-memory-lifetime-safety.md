---
name: b70-native-memory-lifetime-safety
description: "Use when ELMOS must enforce and test Native Memory Lifetime Safety for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Native Memory Lifetime Safety, Batch 70, C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing."
metadata:
  id: PG277
  batch: 70
  version: 1.0.0
...
# PG277 — Native Memory Lifetime Safety

## Objective

Enforce and test Native Memory Lifetime Safety for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `native-memory-lifetime-safety` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG276`.
...
- `native_memory_lifetime_safety_plan.json`
- `native_memory_lifetime_safety_artifacts/`
- `native_memory_lifetime_safety_verification.json`
