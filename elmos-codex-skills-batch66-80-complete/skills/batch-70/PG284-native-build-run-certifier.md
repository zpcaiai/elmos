...
# PG284 — Native Build Run Certifier

## Objective

Execute and independently verify Native Build Run Certifier for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `native-build-run-certifier` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG283`.
...
- `native_build_run_certifier_plan.json`
- `native_build_run_certifier_artifacts/`
- `native_build_run_certifier_verification.json`
