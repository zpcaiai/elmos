...
# PG272 — Native Toolchain Compiler Matrix

## Objective

Implement and validate Native Toolchain Compiler Matrix for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `native-toolchain-compiler-matrix` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG271`.
...
- `native_toolchain_compiler_matrix_plan.json`
- `native_toolchain_compiler_matrix_artifacts/`
- `native_toolchain_compiler_matrix_verification.json`
