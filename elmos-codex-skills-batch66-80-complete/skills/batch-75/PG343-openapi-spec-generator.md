---
name: b75-openapi-spec-generator
description: "Use when ELMOS must generate runnable and maintainable OpenAPI Spec Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: OpenAPI Spec Generator, Batch 75, SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility."
metadata:
  id: PG343
  batch: 75
  version: 1.0.0
...
# PG343 — OpenAPI Spec Generator

## Objective

Generate runnable and maintainable OpenAPI Spec Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `openapi-spec-generator` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG342`.
...
- `openapi_spec_generator_plan.json`
- `openapi_spec_generator_artifacts/`
- `openapi_spec_generator_verification.json`
