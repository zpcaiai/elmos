...
# PG346 — Protocol Buffers Schema Generator

## Objective

Generate runnable and maintainable Protocol Buffers Schema Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `protobuf-schema-generator` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG345`.
...
- `protobuf_schema_generator_plan.json`
- `protobuf_schema_generator_artifacts/`
- `protobuf_schema_generator_verification.json`
