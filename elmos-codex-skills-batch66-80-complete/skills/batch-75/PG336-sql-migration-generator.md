---
name: b75-sql-migration-generator
description: "Use when ELMOS must generate runnable and maintainable SQL Migration Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: SQL Migration Generator, Batch 75, SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility."
metadata:
  id: PG336
  batch: 75
  version: 1.0.0
...
# PG336 — SQL Migration Generator

## Objective

Generate runnable and maintainable SQL Migration Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `sql-migration-generator` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG335`.
...
- `sql_migration_generator_plan.json`
- `sql_migration_generator_artifacts/`
- `sql_migration_generator_verification.json`
...
- Preserve data and compatibility baselines.
- Require explicit approval for destructive or breaking changes.
- Provide rollback or forward-fix evidence.
