---
name: b75-sql-query-generator
description: "Use when ELMOS must generate runnable and maintainable SQL Query Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: SQL Query Generator, Batch 75, SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility."
metadata:
  id: PG337
  batch: 75
  version: 1.0.0
...
# PG337 — SQL Query Generator

## Objective

Generate runnable and maintainable SQL Query Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `sql-query-generator` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG336`.
...
- `sql_query_generator_plan.json`
- `sql_query_generator_artifacts/`
- `sql_query_generator_verification.json`
