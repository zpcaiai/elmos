---
name: b79-cicd-cross-system-certifier
description: "Use when ELMOS must execute and independently verify CI/CD Cross System Certifier for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: CI/CD Cross System Certifier, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG405
  batch: 79
  version: 1.0.0
...
# PG405 — CI/CD Cross System Certifier

## Objective

Execute and independently verify CI/CD Cross System Certifier for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `cicd-cross-system-certifier` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG404`.
...
- `cicd_cross_system_certifier_plan.json`
- `cicd_cross_system_certifier_artifacts/`
- `cicd_cross_system_certifier_verification.json`
