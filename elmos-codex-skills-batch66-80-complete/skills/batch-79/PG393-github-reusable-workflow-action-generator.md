---
name: b79-github-reusable-workflow-action-generator
description: "Use when ELMOS must generate runnable and maintainable GitHub Reusable Workflow Action Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: GitHub Reusable Workflow Action Generator, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG393
  batch: 79
  version: 1.0.0
...
# PG393 — GitHub Reusable Workflow Action Generator

## Objective

Generate runnable and maintainable GitHub Reusable Workflow Action Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `github-reusable-workflow-action-generator` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG392`.
...
- `github_reusable_workflow_action_generator_plan.json`
- `github_reusable_workflow_action_generator_artifacts/`
- `github_reusable_workflow_action_generator_verification.json`
...
- Protect fork and pull-request trust boundaries.
