---
name: b79-jenkins-declarative-pipeline-generator
description: "Use when ELMOS must generate runnable and maintainable Jenkins Declarative Pipeline Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Jenkins Declarative Pipeline Generator, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG400
  batch: 79
  version: 1.0.0
...
# PG400 — Jenkins Declarative Pipeline Generator

## Objective

Generate runnable and maintainable Jenkins Declarative Pipeline Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `jenkins-declarative-pipeline-generator` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG399`.
...
- `jenkins_declarative_pipeline_generator_plan.json`
- `jenkins_declarative_pipeline_generator_artifacts/`
- `jenkins_declarative_pipeline_generator_verification.json`
