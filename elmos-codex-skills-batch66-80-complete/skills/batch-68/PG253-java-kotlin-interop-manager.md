---
name: b68-java-kotlin-interop-manager
description: "Use when ELMOS must coordinate and control Java Kotlin Interop Manager for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Java Kotlin Interop Manager, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG253
  batch: 68
  version: 1.0.0
...
# PG253 — Java Kotlin Interop Manager

## Objective

Coordinate and control Java Kotlin Interop Manager for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `java-kotlin-interop-manager` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG252`.
...
- `java_kotlin_interop_manager_plan.json`
- `java_kotlin_interop_manager_artifacts/`
- `java_kotlin_interop_manager_verification.json`
