---
name: b68-kotlin-data-access-generator
description: "Use when ELMOS must generate runnable and maintainable Kotlin Data Access Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Kotlin Data Access Generator, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG252
  batch: 68
  version: 1.0.0
...
# PG252 — Kotlin Data Access Generator

## Objective

Generate runnable and maintainable Kotlin Data Access Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `kotlin-data-access-generator` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG251`.
...
- `kotlin_data_access_generator_plan.json`
- `kotlin_data_access_generator_artifacts/`
- `kotlin_data_access_generator_verification.json`
