---
name: b68-gradle-kotlin-build-reproducer
description: "Use when ELMOS must reproduce deterministically Gradle Kotlin Build Reproducer for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Gradle Kotlin Build Reproducer, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG248
  batch: 68
  version: 1.0.0
...
# PG248 — Gradle Kotlin Build Reproducer

## Objective

Reproduce deterministically Gradle Kotlin Build Reproducer for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `gradle-kotlin-build-reproducer` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG247`.
...
- `gradle_kotlin_build_reproducer_plan.json`
- `gradle_kotlin_build_reproducer_artifacts/`
- `gradle_kotlin_build_reproducer_verification.json`
