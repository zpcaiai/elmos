"""Catalog, frontmatter, and 18-batch DAG tests for polyglot semantic compiler skills."""
...
def test_18_batch_dag_acyclicity(manifest_data):
    skills = manifest_data.get("skills", [])
    ...
    assert visited == len(skill_names), "Cycle detected in 18-batch polyglot skill DAG"
