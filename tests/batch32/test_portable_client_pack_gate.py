...
class PortableClientPackGateTest(unittest.TestCase):
    ...
    def test_ci_gates_only_declared_client_pack_manifests(self) -> None:
        ...
        self.assertIn('scripts/batch32/run_client_gate.py "$pack"', frontend_job)
        self.assertNotIn("make batch32-client-packs-portable-gate", frontend_job)
