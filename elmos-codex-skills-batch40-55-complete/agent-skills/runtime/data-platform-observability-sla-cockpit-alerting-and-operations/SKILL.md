---
name: data-platform-observability-sla-cockpit-alerting-and-operations
description: "Implement Batch 44A Enterprise Data Platform、Lakehouse与Data Products telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Data Source、Dataset、Table、Stream、Data Product、Pipeline、Contract、Storage、Compute与Serving."
---
...
Implement Batch 44A Enterprise Data Platform、Lakehouse与Data Products telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Data Source、Dataset、Table、Stream、Data Product、Pipeline、Contract、Storage、Compute与Serving.
...
5. Write unresolved domain assumptions to `docs/implementation/data-platform-observability-sla-cockpit-alerting-and-operations-baseline.md`.
...
```text
data_platform_observability_sla_cockpit_alerting_and_operations_manifest.json
data_platform_observability_sla_cockpit_alerting_and_operations_state.json
data_platform_observability_sla_cockpit_alerting_and_operations_decision.json
data_platform_observability_sla_cockpit_alerting_and_operations_reconciliation.json
data_platform_observability_sla_cockpit_alerting_and_operations_evidence.json
```
