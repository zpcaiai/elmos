---
name: it-asset-data-quality-dedup-reconciliation-and-certification
description: "Implement Batch 47C IT Asset、CMDB、Endpoint、Software与License Operations quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Asset、Configuration Item、Relationship、Endpoint、Software Installation、License、Warranty、Lifecycle与Discovery."
---

# It Asset Data Quality Dedup Reconciliation And Certification

## Objective

Implement Batch 47C IT Asset、CMDB、Endpoint、Software与License Operations quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Asset、Configuration Item、Relationship、Endpoint、Software Installation、License、Warranty、Lifecycle与Discovery.
...
5. Write unresolved domain assumptions to `docs/implementation/it-asset-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
it_asset_data_quality_dedup_reconciliation_and_certification_manifest.json
it_asset_data_quality_dedup_reconciliation_and_certification_state.json
it_asset_data_quality_dedup_reconciliation_and_certification_decision.json
it_asset_data_quality_dedup_reconciliation_and_certification_reconciliation.json
it_asset_data_quality_dedup_reconciliation_and_certification_evidence.json
```
