---
name: supply-planning-orchestrator
description: "Implement Batch 42C Demand、Supply Planning与S&OP Resilience end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Demand Forecast、Supply Plan、S&OP、Capacity、Constraint、Safety Stock、Allocation、Scenario与Supplier Continuity."
---
...
Implement Batch 42C Demand、Supply Planning与S&OP Resilience end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Demand Forecast、Supply Plan、S&OP、Capacity、Constraint、Safety Stock、Allocation、Scenario与Supplier Continuity.
...
5. Write unresolved domain assumptions to `docs/implementation/supply-planning-orchestrator-baseline.md`.
...
```text
supply_planning_orchestrator_manifest.json
supply_planning_orchestrator_state.json
supply_planning_orchestrator_decision.json
supply_planning_orchestrator_reconciliation.json
supply_planning_orchestrator_evidence.json
```
