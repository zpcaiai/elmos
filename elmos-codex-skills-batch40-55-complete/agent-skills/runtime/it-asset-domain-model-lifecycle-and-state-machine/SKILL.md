---
name: it-asset-domain-model-lifecycle-and-state-machine
description: "Implement Batch 47C IT Asset、CMDB、Endpoint、Software与License Operations canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Asset、Configuration Item、Relationship、Endpoint、Software Installation、License、Warranty、Lifecycle与Discovery."
---

# It Asset Domain Model Lifecycle And State Machine

## Objective

Implement Batch 47C IT Asset、CMDB、Endpoint、Software与License Operations canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Asset、Configuration Item、Relationship、Endpoint、Software Installation、License、Warranty、Lifecycle与Discovery.
...
5. Write unresolved domain assumptions to `docs/implementation/it-asset-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
it_asset_domain_model_lifecycle_and_state_machine_manifest.json
it_asset_domain_model_lifecycle_and_state_machine_state.json
it_asset_domain_model_lifecycle_and_state_machine_decision.json
it_asset_domain_model_lifecycle_and_state_machine_reconciliation.json
it_asset_domain_model_lifecycle_and_state_machine_evidence.json
```
