---
name: agentic-runtime-orchestrator
description: "Implement Batch 45B Agentic AI Runtime、Orchestration、Memory、Tools与Evals end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Agent、Workflow、Tool、Memory、Context、Plan、Execution、Guardrail、Evaluation与Human Handoff."
---
...
Implement Batch 45B Agentic AI Runtime、Orchestration、Memory、Tools与Evals end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Agent、Workflow、Tool、Memory、Context、Plan、Execution、Guardrail、Evaluation与Human Handoff.
...
5. Write unresolved domain assumptions to `docs/implementation/agentic-runtime-orchestrator-baseline.md`.
...
```text
agentic_runtime_orchestrator_manifest.json
agentic_runtime_orchestrator_state.json
agentic_runtime_orchestrator_decision.json
agentic_runtime_orchestrator_reconciliation.json
agentic_runtime_orchestrator_evidence.json
```
