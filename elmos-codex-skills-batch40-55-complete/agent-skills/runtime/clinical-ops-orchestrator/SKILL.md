---
name: clinical-ops-orchestrator
description: "Implement Batch 52A Clinical Operations、Patient Flow与Care Coordination end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Patient、Encounter、Appointment、Bed、Care Plan、Task、Referral、Observation、Discharge与Care Team."
---

# Clinical Ops Orchestrator

## Objective

Implement Batch 52A Clinical Operations、Patient Flow与Care Coordination end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Patient、Encounter、Appointment、Bed、Care Plan、Task、Referral、Observation、Discharge与Care Team.
...
5. Write unresolved domain assumptions to `docs/implementation/clinical-ops-orchestrator-baseline.md`.
...
```text
clinical_ops_orchestrator_manifest.json
clinical_ops_orchestrator_state.json
clinical_ops_orchestrator_decision.json
clinical_ops_orchestrator_reconciliation.json
clinical_ops_orchestrator_evidence.json
```
