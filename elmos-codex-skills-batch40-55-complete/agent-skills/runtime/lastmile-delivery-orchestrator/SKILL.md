---
name: lastmile-delivery-orchestrator
description: "Implement Batch 51B Warehouse、Last-mile、Delivery与Returns end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return."
---

# Lastmile Delivery Orchestrator

## Objective

Implement Batch 51B Warehouse、Last-mile、Delivery与Returns end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return.
...
5. Write unresolved domain assumptions to `docs/implementation/lastmile-delivery-orchestrator-baseline.md`.
...
```text
lastmile_delivery_orchestrator_manifest.json
lastmile_delivery_orchestrator_state.json
lastmile_delivery_orchestrator_decision.json
lastmile_delivery_orchestrator_reconciliation.json
lastmile_delivery_orchestrator_evidence.json
```
