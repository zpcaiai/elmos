---
name: cloud-runtime-orchestrator
description: "Implement Batch 49B Kubernetes、Serverless、Network、Storage与Multi-cloud Runtime end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Cluster、Namespace、Workload、Function、Network、Gateway、Storage、Secret、Runtime Profile与Placement."
---
...
Implement Batch 49B Kubernetes、Serverless、Network、Storage与Multi-cloud Runtime end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Cluster、Namespace、Workload、Function、Network、Gateway、Storage、Secret、Runtime Profile与Placement.
...
5. Write unresolved domain assumptions to `docs/implementation/cloud-runtime-orchestrator-baseline.md`.
...
```text
cloud_runtime_orchestrator_manifest.json
cloud_runtime_orchestrator_state.json
cloud_runtime_orchestrator_decision.json
cloud_runtime_orchestrator_reconciliation.json
cloud_runtime_orchestrator_evidence.json
```
