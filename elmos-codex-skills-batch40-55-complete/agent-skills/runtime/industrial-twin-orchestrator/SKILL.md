---
name: industrial-twin-orchestrator
description: "Implement Batch 50B Industrial IoT、Digital Twin、Predictive Maintenance与Robotics end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Asset、Sensor、Tag、Telemetry、Twin、State、Prediction、Maintenance、Robot Task与Simulation."
---

# Industrial Twin Orchestrator

## Objective

Implement Batch 50B Industrial IoT、Digital Twin、Predictive Maintenance与Robotics end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Asset、Sensor、Tag、Telemetry、Twin、State、Prediction、Maintenance、Robot Task与Simulation.
...
5. Write unresolved domain assumptions to `docs/implementation/industrial-twin-orchestrator-baseline.md`.
...
```text
industrial_twin_orchestrator_manifest.json
industrial_twin_orchestrator_state.json
industrial_twin_orchestrator_decision.json
industrial_twin_orchestrator_reconciliation.json
industrial_twin_orchestrator_evidence.json
```
