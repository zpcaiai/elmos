---
name: partner-channel-orchestrator
description: "Implement Batch 40C Partner、Channel与Sales Enablement Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Partner、Distributor、Reseller、Deal Registration、Channel Pipeline、MDF、Certification、Enablement、Incentive与Partner Governance."
---
...
Implement Batch 40C Partner、Channel与Sales Enablement Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Partner、Distributor、Reseller、Deal Registration、Channel Pipeline、MDF、Certification、Enablement、Incentive与Partner Governance.
...
5. Write unresolved domain assumptions to `docs/implementation/partner-channel-orchestrator-baseline.md`.
...
```text
partner_channel_orchestrator_manifest.json
partner_channel_orchestrator_state.json
partner_channel_orchestrator_decision.json
partner_channel_orchestrator_reconciliation.json
partner_channel_orchestrator_evidence.json
```
