---
name: core-hr-analytics-kpi-scoring-forecast-and-diagnostics
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-analytics-kpi-scoring-forecast-and-diagnostics-baseline.md`.
...
```text
core_hr_analytics_kpi_scoring_forecast_and_diagnostics_manifest.json
core_hr_analytics_kpi_scoring_forecast_and_diagnostics_state.json
core_hr_analytics_kpi_scoring_forecast_and_diagnostics_decision.json
core_hr_analytics_kpi_scoring_forecast_and_diagnostics_reconciliation.json
core_hr_analytics_kpi_scoring_forecast_and_diagnostics_evidence.json
```
