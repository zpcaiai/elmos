---
name: itsm-service-domain-model-lifecycle-and-state-machine
description: "Implement Batch 47A ITSM、Service Catalog、Request、Change与Problem canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Service、Offering、Catalog Item、Request、Incident、Problem、Change、Knowledge、SLA与Approval."
---

# ITSM Service Domain Model Lifecycle And State Machine

## Objective

Implement Batch 47A ITSM、Service Catalog、Request、Change与Problem canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Service、Offering、Catalog Item、Request、Incident、Problem、Change、Knowledge、SLA与Approval.
...
5. Write unresolved domain assumptions to `docs/implementation/itsm-service-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
itsm_service_domain_model_lifecycle_and_state_machine_manifest.json
itsm_service_domain_model_lifecycle_and_state_machine_state.json
itsm_service_domain_model_lifecycle_and_state_machine_decision.json
itsm_service_domain_model_lifecycle_and_state_machine_reconciliation.json
itsm_service_domain_model_lifecycle_and_state_machine_evidence.json
```
