...
version: 1.0.0
skill_id: ELMOS-POLY-223
layer: concurrency-verification
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-thread-scheduler-determinism-lab`."
  - "Use when a migration/certification DAG requires `concurrency-verification` capability."
outputs:
  - "semantic-assurance/elmos-thread-scheduler-determinism-lab/model.json"
  - "semantic-assurance/elmos-thread-scheduler-determinism-lab/evidence.json"
  - "semantic-assurance/elmos-thread-scheduler-determinism-lab/diagnostics.json"
---

# Thread Scheduler Determinism Lab

## Objective

Systematically explore permitted thread schedules, races, deadlocks and starvation-sensitive behavior across source and target runtimes.
