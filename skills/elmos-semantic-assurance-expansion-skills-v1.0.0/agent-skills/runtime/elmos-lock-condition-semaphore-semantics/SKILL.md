...
triggers:
  - "Use when implementing or executing `elmos-lock-condition-semaphore-semantics`."
  - "Use when a migration/certification DAG requires `concurrency-semantics` capability."
outputs:
  - "semantic-assurance/elmos-lock-condition-semaphore-semantics/model.json"
  - "semantic-assurance/elmos-lock-condition-semaphore-semantics/evidence.json"
  - "semantic-assurance/elmos-lock-condition-semaphore-semantics/diagnostics.json"
---

# Lock, Condition & Semaphore Semantics

## Objective

Preserve mutual exclusion, reentrancy, condition-variable wakeups, fairness assumptions and timeout behavior.
