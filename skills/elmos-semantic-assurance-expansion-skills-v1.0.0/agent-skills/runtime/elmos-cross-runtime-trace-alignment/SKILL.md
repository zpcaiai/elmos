---
name: elmos-cross-runtime-trace-alignment
description: "Align semantically corresponding calls/events/transactions across structurally different runtimes using stable semantic event identities."
version: 1.0.0
skill_id: ELMOS-POLY-237
...
triggers:
  - "Use when implementing or executing `elmos-cross-runtime-trace-alignment`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-cross-runtime-trace-alignment/model.json"
  - "semantic-assurance/elmos-cross-runtime-trace-alignment/evidence.json"
  - "semantic-assurance/elmos-cross-runtime-trace-alignment/diagnostics.json"
---

# Cross-Runtime Trace Alignment

## Objective

Align semantically corresponding calls/events/transactions across structurally different runtimes using stable semantic event identities.
...
- **causal ordering.**
- **span/symbol mapping.**
- **extra/missing event classification.**
...
- [ ] renamed/restructured call trace fixture.
- [ ] async causal trace fixture.
- [ ] missing business event blocker.
