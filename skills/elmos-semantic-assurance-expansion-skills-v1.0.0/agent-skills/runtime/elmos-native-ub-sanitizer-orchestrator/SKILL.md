---
name: elmos-native-ub-sanitizer-orchestrator
description: "Run sanitizer/interpreter profiles such as ASan/UBSan/TSan/Miri or route-equivalent tools and turn findings into conversion blockers/evidence."
version: 1.0.0
skill_id: ELMOS-POLY-231
...
triggers:
  - "Use when implementing or executing `elmos-native-ub-sanitizer-orchestrator`."
  - "Use when a migration/certification DAG requires `runtime-verification` capability."
outputs:
  - "semantic-assurance/elmos-native-ub-sanitizer-orchestrator/model.json"
  - "semantic-assurance/elmos-native-ub-sanitizer-orchestrator/evidence.json"
  - "semantic-assurance/elmos-native-ub-sanitizer-orchestrator/diagnostics.json"
---

# Native UB & Sanitizer Orchestrator

## Objective

Run sanitizer/interpreter profiles such as ASan/UBSan/TSan/Miri or route-equivalent tools and turn findings into conversion blockers/evidence.
...
- [ ] known ASan bug fixture.
- [ ] known UBSan bug fixture.
- [ ] Rust Miri unsafe fixture.
