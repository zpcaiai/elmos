...
triggers:
  - "Use when implementing or executing `elmos-behavior-equivalence-verdict-aggregator`."
  - "Use when a migration/certification DAG requires `quality-gate` capability."
outputs:
  - "semantic-assurance/elmos-behavior-equivalence-verdict-aggregator/model.json"
  - "semantic-assurance/elmos-behavior-equivalence-verdict-aggregator/evidence.json"
  - "semantic-assurance/elmos-behavior-equivalence-verdict-aggregator/diagnostics.json"
---

# Behavior Equivalence Verdict Aggregator

## Objective

Aggregate all behavioral, state, side-effect, performance and security oracles into scoped pass/fail/blocked/waived verdicts with evidence freshness checks.
...
- **oracle quorum.**
- **critical-obligation precedence.**
- **evidence freshness.**
- **waiver scoping.**
...
- [ ] one critical fail dominates.
- [ ] missing required oracle blocks.
