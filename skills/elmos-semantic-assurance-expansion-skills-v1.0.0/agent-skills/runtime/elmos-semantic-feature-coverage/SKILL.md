...
triggers:
  - "Use when implementing or executing `elmos-semantic-feature-coverage`."
  - "Use when a migration/certification DAG requires `corpus-metrics` capability."
outputs:
  - "semantic-assurance/elmos-semantic-feature-coverage/model.json"
  - "semantic-assurance/elmos-semantic-feature-coverage/evidence.json"
  - "semantic-assurance/elmos-semantic-feature-coverage/diagnostics.json"
---

# Semantic Feature Coverage Analyzer

## Objective

Measure route corpus coverage of type, control-flow, runtime, effect and behavior semantic obligations.
...
- [ ] critical semantic tag coverage.
- [ ] coverage by route.
- [ ] unsupported tag visible.
