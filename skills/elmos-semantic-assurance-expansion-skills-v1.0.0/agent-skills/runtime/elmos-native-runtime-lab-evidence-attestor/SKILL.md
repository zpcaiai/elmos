...
version: 1.0.0
skill_id: ELMOS-POLY-274
layer: runtime-lab-gate
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-native-runtime-lab-evidence-attestor`."
  - "Use when a migration/certification DAG requires `runtime-lab-gate` capability."
outputs:
  - "semantic-assurance/elmos-native-runtime-lab-evidence-attestor/model.json"
  - "semantic-assurance/elmos-native-runtime-lab-evidence-attestor/evidence.json"
  - "semantic-assurance/elmos-native-runtime-lab-evidence-attestor/diagnostics.json"
---

# Native Runtime Lab Evidence Attestor

## Objective

Bind runtime evidence to immutable image/VM, hardware, compiler, dependency, fixture, command and output identities and reject stale lab evidence.
...
- [ ] environment drift invalidates.
- [ ] missing native lab stays not-run.
