---
name: elmos-numeric-type-range-overflow
description: "Preserve integer widths, signedness, big integers, decimal types, overflow modes, shifts and conversion behavior."
version: 1.0.0
skill_id: ELMOS-POLY-188
...
triggers:
  - "Use when implementing or executing `elmos-numeric-type-range-overflow`."
  - "Use when a migration/certification DAG requires `type-semantics` capability."
outputs:
  - "semantic-assurance/elmos-numeric-type-range-overflow/model.json"
  - "semantic-assurance/elmos-numeric-type-range-overflow/evidence.json"
  - "semantic-assurance/elmos-numeric-type-range-overflow/diagnostics.json"
---

# Numeric Type, Range & Overflow Semantics

## Objective

Preserve integer widths, signedness, big integers, decimal types, overflow modes, shifts and conversion behavior.
...
- **checked/wrapping/trapping overflow.**
- **signedness.**
- **promotion/conversion.**
- **big integer and fixed precision.**
...
- [ ] shift-width fixture.
- [ ] checked vs wrapping counterexample.
