...
triggers:
  - "Use when implementing or executing `elmos-compiler-runtime-version-matrix`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-compiler-runtime-version-matrix/model.json"
  - "semantic-assurance/elmos-compiler-runtime-version-matrix/evidence.json"
  - "semantic-assurance/elmos-compiler-runtime-version-matrix/diagnostics.json"
---

# Compiler & Runtime Version Matrix

## Objective

Execute fixture suites across supported compiler/runtime versions and optimization modes to expose version-specific semantics.
...
- [ ] two-version matrix fixture.
- [ ] optimization-specific mismatch.
- [ ] unsupported version recorded.
