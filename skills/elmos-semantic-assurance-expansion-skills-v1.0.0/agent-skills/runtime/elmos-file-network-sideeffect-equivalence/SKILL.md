...
triggers:
  - "Use when implementing or executing `elmos-file-network-sideeffect-equivalence`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-file-network-sideeffect-equivalence/model.json"
  - "semantic-assurance/elmos-file-network-sideeffect-equivalence/evidence.json"
  - "semantic-assurance/elmos-file-network-sideeffect-equivalence/diagnostics.json"
---

# File & Network Side-Effect Equivalence

## Objective

Compare filesystem and network effects including paths, bytes, status codes, headers, retries and external call contracts.
