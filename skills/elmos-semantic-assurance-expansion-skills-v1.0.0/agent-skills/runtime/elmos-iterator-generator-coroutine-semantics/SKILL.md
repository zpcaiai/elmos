---
name: elmos-iterator-generator-coroutine-semantics
description: "Model suspension points, yielded values, cleanup, backpressure and resumption state across generator/coroutine constructs."
version: 1.0.0
skill_id: ELMOS-POLY-208
...
triggers:
  - "Use when implementing or executing `elmos-iterator-generator-coroutine-semantics`."
  - "Use when a migration/certification DAG requires `controlflow-semantics` capability."
outputs:
  - "semantic-assurance/elmos-iterator-generator-coroutine-semantics/model.json"
  - "semantic-assurance/elmos-iterator-generator-coroutine-semantics/evidence.json"
  - "semantic-assurance/elmos-iterator-generator-coroutine-semantics/diagnostics.json"
---

# Iterator, Generator & Coroutine Semantics

## Objective

Model suspension points, yielded values, cleanup, backpressure and resumption state across generator/coroutine constructs.
...
- [ ] Python generator close fixture.
- [ ] C# IEnumerable fixture.
- [ ] Kotlin sequence fixture.
