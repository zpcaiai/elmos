...
triggers:
  - "Use when implementing or executing `elmos-lossless-cst-builder`."
  - "Use when a migration/certification DAG requires `frontend-semantics` capability."
outputs:
  - "semantic-assurance/elmos-lossless-cst-builder/model.json"
  - "semantic-assurance/elmos-lossless-cst-builder/evidence.json"
  - "semantic-assurance/elmos-lossless-cst-builder/diagnostics.json"
---

# Lossless CST Builder

## Objective

Build a lossless concrete syntax tree that retains every token, trivia item, directive and source span required for safe round-trip transformations.
...
- [ ] parse-print-parse identity.
- [ ] comments/directives preservation.
- [ ] malformed-source recovery fixture.
