---
name: elmos-annotation-attribute-reflection-modeler
description: "Capture metadata-driven behavior including annotations, attributes, decorators, reflection, DI scanning and runtime discovery."
version: 1.0.0
skill_id: ELMOS-POLY-182
layer: reflection-semantics
risk: critical
readiness: not-run
dependencies:
  - "elmos-symbol-table-builder"
triggers:
  - "Use when implementing or executing `elmos-annotation-attribute-reflection-modeler`."
  - "Use when a migration/certification DAG requires `reflection-semantics` capability."
outputs:
  - "semantic-assurance/elmos-annotation-attribute-reflection-modeler/model.json"
  - "semantic-assurance/elmos-annotation-attribute-reflection-modeler/evidence.json"
  - "semantic-assurance/elmos-annotation-attribute-reflection-modeler/diagnostics.json"
---

# Annotation, Attribute & Reflection Modeler

## Objective

Capture metadata-driven behavior including annotations, attributes, decorators, reflection, DI scanning and runtime discovery.
...
- **metadata retention.**
- **runtime reflection queries.**
- **DI/component scanning.**
- **decorator/metaclass effects.**
...
- [ ] Spring/.NET reflection fixture.
- [ ] Python decorator fixture.
- [ ] metadata retention mismatch blocker.
