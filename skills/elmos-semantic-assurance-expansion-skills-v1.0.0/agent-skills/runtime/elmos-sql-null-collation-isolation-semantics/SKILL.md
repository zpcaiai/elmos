...
version: 1.0.0
skill_id: ELMOS-POLY-230
layer: data-semantics
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-sql-null-collation-isolation-semantics`."
  - "Use when a migration/certification DAG requires `data-semantics` capability."
outputs:
  - "semantic-assurance/elmos-sql-null-collation-isolation-semantics/model.json"
  - "semantic-assurance/elmos-sql-null-collation-isolation-semantics/evidence.json"
  - "semantic-assurance/elmos-sql-null-collation-isolation-semantics/diagnostics.json"
---

# SQL NULL, Collation & Isolation Semantics

## Objective

Capture three-valued logic, collation, locking/isolation, identity/sequence and vendor procedural differences during language/data migration.
...
- [ ] NULL predicate fixture.
- [ ] write-skew fixture.
- [ ] sequence/identity fixture.
