...
triggers:
  - "Use when implementing or executing `elmos-decimal-money-arithmetic-semantics`."
  - "Use when a migration/certification DAG requires `numeric-semantics` capability."
outputs:
  - "semantic-assurance/elmos-decimal-money-arithmetic-semantics/model.json"
  - "semantic-assurance/elmos-decimal-money-arithmetic-semantics/evidence.json"
  - "semantic-assurance/elmos-decimal-money-arithmetic-semantics/diagnostics.json"
---

# Decimal & Money Arithmetic Semantics

## Objective

Preserve decimal scale, rounding, packed/zoned decimal, currency precision and monetary comparison rules.
...
- [ ] COMP-3 fixture.
- [ ] Java BigDecimal↔C# decimal fixture.
- [ ] rounding boundary fixture.
