...
triggers:
  - "Use when implementing or executing `elmos-property-based-cross-language-tester`."
  - "Use when a migration/certification DAG requires `fuzzing` capability."
outputs:
  - "semantic-assurance/elmos-property-based-cross-language-tester/model.json"
  - "semantic-assurance/elmos-property-based-cross-language-tester/evidence.json"
  - "semantic-assurance/elmos-property-based-cross-language-tester/diagnostics.json"
---

# Property-Based Cross-Language Tester

## Objective

Generate values/state sequences from contracts and assert language-independent properties across source and target implementations.
...
- **generators from types/contracts.**
- **stateful properties.**
- **shrinking.**
- **distribution checks.**
