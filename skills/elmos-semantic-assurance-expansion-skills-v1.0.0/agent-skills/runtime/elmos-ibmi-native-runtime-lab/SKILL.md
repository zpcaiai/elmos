...
triggers:
  - "Use when implementing or executing `elmos-ibmi-native-runtime-lab`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-ibmi-native-runtime-lab/model.json"
  - "semantic-assurance/elmos-ibmi-native-runtime-lab/evidence.json"
  - "semantic-assurance/elmos-ibmi-native-runtime-lab/diagnostics.json"
---

# IBM i Native Runtime Lab

## Objective

Define controlled IBM i execution for RPG/CL/DDS/DB2 for i including library lists, job state, commitment control and object authority.
...
- **ILE RPG/CL.**
- **library list/job state.**
- **DDS display/database.**
- **commitment control.**
