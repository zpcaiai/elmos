...
version: 1.0.0
skill_id: ELMOS-POLY-202
layer: memory-semantics
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-alias-points-to-analysis`."
  - "Use when a migration/certification DAG requires `memory-semantics` capability."
outputs:
  - "semantic-assurance/elmos-alias-points-to-analysis/model.json"
  - "semantic-assurance/elmos-alias-points-to-analysis/evidence.json"
  - "semantic-assurance/elmos-alias-points-to-analysis/diagnostics.json"
---

# Alias & Points-To Analyzer

## Objective

Approximate and refine heap aliasing, pointer targets and shared mutable state so transformations do not duplicate or detach state accidentally.
...
- [ ] C pointer alias fixture.
- [ ] Java object alias fixture.
- [ ] unknown alias escalates.
