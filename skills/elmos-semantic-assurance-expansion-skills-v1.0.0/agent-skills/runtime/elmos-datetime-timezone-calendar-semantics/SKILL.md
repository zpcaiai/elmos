...
triggers:
  - "Use when implementing or executing `elmos-datetime-timezone-calendar-semantics`."
  - "Use when a migration/certification DAG requires `temporal-semantics` capability."
outputs:
  - "semantic-assurance/elmos-datetime-timezone-calendar-semantics/model.json"
  - "semantic-assurance/elmos-datetime-timezone-calendar-semantics/evidence.json"
  - "semantic-assurance/elmos-datetime-timezone-calendar-semantics/diagnostics.json"
---

# Date, Time, Timezone & Calendar Semantics

## Objective

Preserve instant/local date/time, timezone database, DST ambiguity, calendar rules, epoch ranges and serialization.
