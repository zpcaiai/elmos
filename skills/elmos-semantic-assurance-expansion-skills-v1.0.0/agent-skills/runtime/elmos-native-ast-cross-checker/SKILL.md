...
triggers:
  - "Use when implementing or executing `elmos-native-ast-cross-checker`."
  - "Use when a migration/certification DAG requires `frontend-semantics` capability."
outputs:
  - "semantic-assurance/elmos-native-ast-cross-checker/model.json"
  - "semantic-assurance/elmos-native-ast-cross-checker/evidence.json"
  - "semantic-assurance/elmos-native-ast-cross-checker/diagnostics.json"
---

# Native AST Cross-Checker

## Objective

Cross-check ELMOS CST/AST extraction against native compiler or language-service frontends to detect parser drift and semantic frontend mismatches.
...
- **native compiler AST/PSI/Roslyn/JDT/FIR/analyzer parity.**
- **symbol shape parity.**
- **compiler diagnostic parity.**
- **fallback parser disagreement.**
...
- [ ] dual-parser agreement fixture.
- [ ] intentional parser disagreement fixture.
- [ ] native frontend unavailable stays not-run.
