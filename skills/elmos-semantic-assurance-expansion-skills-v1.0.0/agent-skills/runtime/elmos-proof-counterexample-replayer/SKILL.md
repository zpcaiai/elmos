...
triggers:
  - "Use when implementing or executing `elmos-proof-counterexample-replayer`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-proof-counterexample-replayer/model.json"
  - "semantic-assurance/elmos-proof-counterexample-replayer/evidence.json"
  - "semantic-assurance/elmos-proof-counterexample-replayer/diagnostics.json"
---

# Proof Counterexample Replayer

## Objective

Convert solver/model-checker/refinement counterexamples into executable regression tests in source and target environments when possible.
...
- [ ] SMT model replay.
- [ ] non-replayable assumption classified.
- [ ] counterexample enters bug corpus.
