---
name: elmos-comments-directives-trivia-provenance
description: "Carry comments, pragmas, directives, suppression annotations and non-code source material through conversion with explicit semantic relevance classification."
version: 1.0.0
skill_id: ELMOS-POLY-177
...
triggers:
  - "Use when implementing or executing `elmos-comments-directives-trivia-provenance`."
  - "Use when a migration/certification DAG requires `frontend-semantics` capability."
outputs:
  - "semantic-assurance/elmos-comments-directives-trivia-provenance/model.json"
  - "semantic-assurance/elmos-comments-directives-trivia-provenance/evidence.json"
  - "semantic-assurance/elmos-comments-directives-trivia-provenance/diagnostics.json"
---

# Comments, Directives & Trivia Provenance

## Objective

Carry comments, pragmas, directives, suppression annotations and non-code source material through conversion with explicit semantic relevance classification.
...
- [ ] pragma preservation fixture.
- [ ] suppression cannot silently migrate if unsupported.
- [ ] business comment provenance test.
