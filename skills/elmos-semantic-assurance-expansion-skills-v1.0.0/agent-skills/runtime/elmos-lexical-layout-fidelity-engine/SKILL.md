...
triggers:
  - "Use when implementing or executing `elmos-lexical-layout-fidelity-engine`."
  - "Use when a migration/certification DAG requires `frontend-semantics` capability."
outputs:
  - "semantic-assurance/elmos-lexical-layout-fidelity-engine/model.json"
  - "semantic-assurance/elmos-lexical-layout-fidelity-engine/evidence.json"
  - "semantic-assurance/elmos-lexical-layout-fidelity-engine/diagnostics.json"
---

# Lexical & Layout Fidelity Engine

## Objective

Preserve lexical tokens, fixed/free-form layout rules, whitespace-significant syntax, continuation columns and source encodings that carry meaning.
...
- **fixed-format COBOL/RPG/Fortran columns.**
- **Python indentation.**
- **line continuations.**
- **BOM/codepage/line endings.**
...
- [ ] fixed/free-form equivalence fixture.
- [ ] indentation-sensitive negative fixture.
- [ ] EBCDIC/UTF source-coordinate fixture.
