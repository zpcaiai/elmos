...
triggers:
  - "Use when implementing or executing `elmos-certification-corpus-readiness-gate`."
  - "Use when a migration/certification DAG requires `quality-gate` capability."
outputs:
  - "semantic-assurance/elmos-certification-corpus-readiness-gate/model.json"
  - "semantic-assurance/elmos-certification-corpus-readiness-gate/evidence.json"
  - "semantic-assurance/elmos-certification-corpus-readiness-gate/diagnostics.json"
---

# Certification Corpus Readiness Gate

## Objective

Require sufficient syntax, semantic, dialect, adversarial, regression and scale coverage before a route can enter E4/E5 certification.
...
- [ ] missing critical fixture blocks.
