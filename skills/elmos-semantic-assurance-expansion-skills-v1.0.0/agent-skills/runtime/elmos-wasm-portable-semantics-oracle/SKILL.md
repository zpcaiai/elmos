...
triggers:
  - "Use when implementing or executing `elmos-wasm-portable-semantics-oracle`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-wasm-portable-semantics-oracle/model.json"
  - "semantic-assurance/elmos-wasm-portable-semantics-oracle/evidence.json"
  - "semantic-assurance/elmos-wasm-portable-semantics-oracle/diagnostics.json"
---

# WebAssembly Portable Semantics Oracle

## Objective

Use WebAssembly’s specified validation/execution semantics and reference tests as an optional portable low-level oracle for suitable cross-language kernels.
...
- [ ] Wasm reference test fixture.
- [ ] host side effect excluded.
- [ ] source/target Wasm comparison.
