---
name: elmos-refinement-range-contract-semantics
description: "Represent Ada/SPARK subtypes, ranges, invariants, pre/postconditions and other refinement constraints as executable/provable obligations."
version: 1.0.0
skill_id: ELMOS-POLY-193
layer: contract-semantics
risk: critical
readiness: not-run
dependencies:
  - "elmos-canonical-type-algebra"
triggers:
  - "Use when implementing or executing `elmos-refinement-range-contract-semantics`."
  - "Use when a migration/certification DAG requires `contract-semantics` capability."
outputs:
  - "semantic-assurance/elmos-refinement-range-contract-semantics/model.json"
  - "semantic-assurance/elmos-refinement-range-contract-semantics/evidence.json"
  - "semantic-assurance/elmos-refinement-range-contract-semantics/diagnostics.json"
---

# Refinement, Range & Contract Semantics

## Objective

Represent Ada/SPARK subtypes, ranges, invariants, pre/postconditions and other refinement constraints as executable/provable obligations.
...
- [ ] Ada range violation fixture.
- [ ] SPARK precondition fixture.
- [ ] target runtime guard synthesis.
