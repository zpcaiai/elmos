---
name: elmos-object-layout-vtable-semantics
description: "Model native object layout, inheritance offsets, vtables, RTTI and COM-style interfaces where binary interoperability matters."
version: 1.0.0
skill_id: ELMOS-POLY-219
layer: abi-semantics
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-object-layout-vtable-semantics`."
  - "Use when a migration/certification DAG requires `abi-semantics` capability."
outputs:
  - "semantic-assurance/elmos-object-layout-vtable-semantics/model.json"
  - "semantic-assurance/elmos-object-layout-vtable-semantics/evidence.json"
  - "semantic-assurance/elmos-object-layout-vtable-semantics/diagnostics.json"
---

# Object Layout & VTable Semantics

## Objective

Model native object layout, inheritance offsets, vtables, RTTI and COM-style interfaces where binary interoperability matters.
...
- [ ] multiple inheritance layout fixture.
- [ ] COM vtable fixture.
- [ ] binary consumer fixture.
