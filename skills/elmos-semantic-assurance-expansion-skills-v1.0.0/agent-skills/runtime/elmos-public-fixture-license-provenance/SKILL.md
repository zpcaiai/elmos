...
triggers:
  - "Use when implementing or executing `elmos-public-fixture-license-provenance`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-public-fixture-license-provenance/model.json"
  - "semantic-assurance/elmos-public-fixture-license-provenance/evidence.json"
  - "semantic-assurance/elmos-public-fixture-license-provenance/diagnostics.json"
---

# Public Fixture License & Provenance

## Objective

Track repository origin, commit, license, redistribution constraints and transformations for public/open-source certification fixtures.
