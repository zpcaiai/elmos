...
triggers:
  - "Use when implementing or executing `elmos-flaky-nondeterminism-classifier`."
  - "Use when a migration/certification DAG requires `fuzzing` capability."
outputs:
  - "semantic-assurance/elmos-flaky-nondeterminism-classifier/model.json"
  - "semantic-assurance/elmos-flaky-nondeterminism-classifier/evidence.json"
  - "semantic-assurance/elmos-flaky-nondeterminism-classifier/diagnostics.json"
---

# Flaky & Nondeterminism Classifier

## Objective

Separate true semantic mismatches from scheduler, timing, network, hash-order and environment noise using replay and statistical evidence.
...
- **repeatability.**
- **schedule/environment correlation.**
- **statistical flake rate.**
- **quarantine policy.**
...
- [ ] deterministic bug fixture.
- [ ] scheduler flake fixture.
- [ ] network-noise fixture.
