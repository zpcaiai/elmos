---
name: elmos-mobile-native-runtime-lab
description: "Run Swift/Objective-C/Kotlin/Java/Flutter/React-derived mobile workloads across simulator/device profiles with lifecycle and platform-channel evidence."
version: 1.0.0
skill_id: ELMOS-POLY-271
layer: runtime-lab
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-mobile-native-runtime-lab`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-mobile-native-runtime-lab/model.json"
  - "semantic-assurance/elmos-mobile-native-runtime-lab/evidence.json"
  - "semantic-assurance/elmos-mobile-native-runtime-lab/diagnostics.json"
---

# Mobile & Apple/Android Runtime Lab

## Objective

Run Swift/Objective-C/Kotlin/Java/Flutter/React-derived mobile workloads across simulator/device profiles with lifecycle and platform-channel evidence.
