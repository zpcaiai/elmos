---
name: elmos-golden-route-repository-fixtures
description: "Build small/medium/large repository fixtures for every high-value Golden Route with source-native builds, tests and expected evidence."
version: 1.0.0
skill_id: ELMOS-POLY-257
layer: corpus
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-golden-route-repository-fixtures`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-golden-route-repository-fixtures/model.json"
  - "semantic-assurance/elmos-golden-route-repository-fixtures/evidence.json"
  - "semantic-assurance/elmos-golden-route-repository-fixtures/diagnostics.json"
---

# Golden Route Repository Fixtures

## Objective

Build small/medium/large repository fixtures for every high-value Golden Route with source-native builds, tests and expected evidence.
...
- [ ] small route fixture.
- [ ] medium multi-module fixture.
- [ ] large corpus descriptor with reproducible subset.
