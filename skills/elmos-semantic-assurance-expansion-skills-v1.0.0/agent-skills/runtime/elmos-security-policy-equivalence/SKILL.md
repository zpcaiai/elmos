---
name: elmos-security-policy-equivalence
description: "Verify authentication, authorization, input handling, cryptographic policy and security-relevant defaults remain at least as strong after conversion."
version: 1.0.0
skill_id: ELMOS-POLY-245
...
triggers:
  - "Use when implementing or executing `elmos-security-policy-equivalence`."
  - "Use when a migration/certification DAG requires `nonfunctional-equivalence` capability."
outputs:
  - "semantic-assurance/elmos-security-policy-equivalence/model.json"
  - "semantic-assurance/elmos-security-policy-equivalence/evidence.json"
  - "semantic-assurance/elmos-security-policy-equivalence/diagnostics.json"
---
...
Verify authentication, authorization, input handling, cryptographic policy and security-relevant defaults remain at least as strong after conversion.
...
- [ ] role matrix fixture.
- [ ] path traversal validation fixture.
- [ ] weakened crypto blocker.
