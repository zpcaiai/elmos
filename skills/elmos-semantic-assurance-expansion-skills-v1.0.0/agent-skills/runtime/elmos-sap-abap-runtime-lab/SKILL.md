...
triggers:
  - "Use when implementing or executing `elmos-sap-abap-runtime-lab`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-sap-abap-runtime-lab/model.json"
  - "semantic-assurance/elmos-sap-abap-runtime-lab/evidence.json"
  - "semantic-assurance/elmos-sap-abap-runtime-lab/diagnostics.json"
---

# SAP ABAP Runtime Lab

## Objective

Define authorized SAP sandbox execution for ABAP/Open SQL/BAPI/RFC/IDoc/LUW behavior characterization without leaking customer systems.
