...
triggers:
  - "Use when implementing or executing `elmos-deterministic-replay-oracle`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-deterministic-replay-oracle/model.json"
  - "semantic-assurance/elmos-deterministic-replay-oracle/evidence.json"
  - "semantic-assurance/elmos-deterministic-replay-oracle/diagnostics.json"
---
...
Record and replay external nondeterministic inputs and schedules where possible to turn flaky differential failures into reproducible evidence.
...
- [ ] expired external response fixture.
- [ ] schedule seed replay.
