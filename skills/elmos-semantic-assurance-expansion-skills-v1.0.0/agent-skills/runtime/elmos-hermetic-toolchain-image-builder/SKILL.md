---
name: elmos-hermetic-toolchain-image-builder
description: "Build content-addressed toolchain/runtime images or VM descriptors with pinned compilers, SDKs, linkers, locale and OS dependencies."
version: 1.0.0
skill_id: ELMOS-POLY-263
layer: runtime-lab
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-hermetic-toolchain-image-builder`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-hermetic-toolchain-image-builder/model.json"
  - "semantic-assurance/elmos-hermetic-toolchain-image-builder/evidence.json"
  - "semantic-assurance/elmos-hermetic-toolchain-image-builder/diagnostics.json"
---

# Hermetic Toolchain Image Builder

## Objective

Build content-addressed toolchain/runtime images or VM descriptors with pinned compilers, SDKs, linkers, locale and OS dependencies.
...
- [ ] rebuild image identity.
- [ ] dependency drift detection.
- [ ] offline build where supported.
