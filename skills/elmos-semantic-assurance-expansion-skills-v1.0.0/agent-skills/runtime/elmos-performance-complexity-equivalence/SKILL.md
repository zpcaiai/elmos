---
name: elmos-performance-complexity-equivalence
description: "Detect asymptotic regressions and material latency/throughput/resource changes under statistically valid route-specific budgets."
version: 1.0.0
skill_id: ELMOS-POLY-244
layer: nonfunctional-equivalence
risk: critical
readiness: not-run
dependencies:
  - "elmos-multi-oracle-differential-executor"
triggers:
  - "Use when implementing or executing `elmos-performance-complexity-equivalence`."
  - "Use when a migration/certification DAG requires `nonfunctional-equivalence` capability."
outputs:
  - "semantic-assurance/elmos-performance-complexity-equivalence/model.json"
  - "semantic-assurance/elmos-performance-complexity-equivalence/evidence.json"
  - "semantic-assurance/elmos-performance-complexity-equivalence/diagnostics.json"
---

# Performance & Complexity Equivalence

## Objective

Detect asymptotic regressions and material latency/throughput/resource changes under statistically valid route-specific budgets.
...
- [ ] O(n)→O(n²) regression fixture.
- [ ] JIT warmup protocol.
- [ ] noise/confidence interval fixture.
