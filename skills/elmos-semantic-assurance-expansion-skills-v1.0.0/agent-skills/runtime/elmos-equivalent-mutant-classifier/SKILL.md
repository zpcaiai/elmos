...
triggers:
  - "Use when implementing or executing `elmos-equivalent-mutant-classifier`."
  - "Use when a migration/certification DAG requires `test-strength` capability."
outputs:
  - "semantic-assurance/elmos-equivalent-mutant-classifier/model.json"
  - "semantic-assurance/elmos-equivalent-mutant-classifier/evidence.json"
  - "semantic-assurance/elmos-equivalent-mutant-classifier/diagnostics.json"
---

# Equivalent Mutant Classifier

## Objective

Distinguish surviving equivalent/no-op mutations from weak tests using static, differential and bounded proof evidence where feasible.
