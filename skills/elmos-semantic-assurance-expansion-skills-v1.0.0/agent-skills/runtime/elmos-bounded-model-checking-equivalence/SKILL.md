...
triggers:
  - "Use when implementing or executing `elmos-bounded-model-checking-equivalence`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-bounded-model-checking-equivalence/model.json"
  - "semantic-assurance/elmos-bounded-model-checking-equivalence/evidence.json"
  - "semantic-assurance/elmos-bounded-model-checking-equivalence/diagnostics.json"
---

# Bounded Model Checking Equivalence

## Objective

Check bounded loops/state machines/concurrency properties and source-target assertions with explicit bounds and counterexamples.
