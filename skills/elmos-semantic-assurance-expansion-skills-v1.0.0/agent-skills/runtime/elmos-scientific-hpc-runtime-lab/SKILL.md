---
name: elmos-scientific-hpc-runtime-lab
description: "Execute Fortran/C/C++ numerical routes with BLAS/LAPACK/MPI/OpenMP/vectorization and deterministic numeric comparison profiles."
version: 1.0.0
skill_id: ELMOS-POLY-270
layer: runtime-lab
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-scientific-hpc-runtime-lab`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-scientific-hpc-runtime-lab/model.json"
  - "semantic-assurance/elmos-scientific-hpc-runtime-lab/evidence.json"
  - "semantic-assurance/elmos-scientific-hpc-runtime-lab/diagnostics.json"
---

# Scientific & HPC Runtime Lab

## Objective

Execute Fortran/C/C++ numerical routes with BLAS/LAPACK/MPI/OpenMP/vectorization and deterministic numeric comparison profiles.
...
- [ ] matrix kernel fixture.
- [ ] MPI reduction tolerance.
- [ ] fast-math mismatch fixture.
