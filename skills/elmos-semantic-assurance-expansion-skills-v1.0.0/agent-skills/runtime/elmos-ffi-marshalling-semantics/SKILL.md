...
triggers:
  - "Use when implementing or executing `elmos-ffi-marshalling-semantics`."
  - "Use when a migration/certification DAG requires `abi-semantics` capability."
outputs:
  - "semantic-assurance/elmos-ffi-marshalling-semantics/model.json"
  - "semantic-assurance/elmos-ffi-marshalling-semantics/evidence.json"
  - "semantic-assurance/elmos-ffi-marshalling-semantics/diagnostics.json"
---

# FFI & Marshalling Semantics

## Objective

Generate and verify foreign-function bridges, marshalling, ownership transfer, callbacks and error boundaries between source and target runtimes.
...
- [ ] JNI/PInvoke-like fixture.
- [ ] C string ownership fixture.
- [ ] callback GC lifetime fixture.
