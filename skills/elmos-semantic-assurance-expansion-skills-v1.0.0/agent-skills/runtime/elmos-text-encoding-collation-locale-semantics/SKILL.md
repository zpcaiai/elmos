...
version: 1.0.0
skill_id: ELMOS-POLY-228
layer: text-semantics
risk: critical
readiness: not-run
dependencies:
  - "elmos-string-char-codepoint-semantics"
triggers:
  - "Use when implementing or executing `elmos-text-encoding-collation-locale-semantics`."
  - "Use when a migration/certification DAG requires `text-semantics` capability."
outputs:
  - "semantic-assurance/elmos-text-encoding-collation-locale-semantics/model.json"
  - "semantic-assurance/elmos-text-encoding-collation-locale-semantics/evidence.json"
  - "semantic-assurance/elmos-text-encoding-collation-locale-semantics/diagnostics.json"
---

# Text Encoding, Collation & Locale Semantics

## Objective

Preserve EBCDIC/ASCII/Unicode conversions, locale-sensitive casing, collation, normalization and database/string comparison behavior.
...
- [ ] Turkish-I fixture.
- [ ] EBCDIC packed record fixture.
- [ ] DB collation fixture.
