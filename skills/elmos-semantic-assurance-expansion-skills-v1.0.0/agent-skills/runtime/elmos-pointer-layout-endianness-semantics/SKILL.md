---
name: elmos-pointer-layout-endianness-semantics
description: "Preserve pointer arithmetic, provenance-sensitive operations, alignment, padding, bitfields and byte order for native/record migrations."
version: 1.0.0
skill_id: ELMOS-POLY-216
...
triggers:
  - "Use when implementing or executing `elmos-pointer-layout-endianness-semantics`."
  - "Use when a migration/certification DAG requires `runtime-semantics` capability."
outputs:
  - "semantic-assurance/elmos-pointer-layout-endianness-semantics/model.json"
  - "semantic-assurance/elmos-pointer-layout-endianness-semantics/evidence.json"
  - "semantic-assurance/elmos-pointer-layout-endianness-semantics/diagnostics.json"
---

# Pointer, Layout & Endianness Semantics

## Objective

Preserve pointer arithmetic, provenance-sensitive operations, alignment, padding, bitfields and byte order for native/record migrations.
...
- **pointer arithmetic/provenance.**
- **alignment/padding.**
- **endianness.**
- **bitfields/packed structs.**
...
- [ ] packed struct fixture.
- [ ] big/little endian fixture.
- [ ] pointer one-past fixture.
