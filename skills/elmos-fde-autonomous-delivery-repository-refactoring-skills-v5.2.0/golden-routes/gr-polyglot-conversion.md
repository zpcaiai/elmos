        # Repository-level cross-language/framework conversion

        ## Purpose

        Behaviorally constrained conversion without treating transpilation as completion.

        ## Scope

        source semantics → conversion plan → generated target → native differential verification
