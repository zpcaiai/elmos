        # Incident to verified remediation

        ## Purpose

        A safe incident response with preserved evidence, verified fix and durable prevention.

        ## Scope

        triage → containment → evidence → root cause → repair → regression → postmortem
