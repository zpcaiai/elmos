        # Customer discovery to approved pilot

        ## Purpose

        An approved, bounded, measurable pilot without hidden access or evidence assumptions.

        ## Scope

        stakeholders → workflow → baseline → opportunity → SOW → acceptance → access readiness
