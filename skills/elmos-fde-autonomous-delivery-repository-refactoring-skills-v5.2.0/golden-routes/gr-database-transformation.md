        # Schema, routine and data transformation

        ## Purpose

        Permission-, routine-, data- and reconciliation-aware database migration evidence.

        ## Scope

        inventory → semantic mapping → expand/migrate/contract → reconcile → rollback rehearsal
