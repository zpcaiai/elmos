# Runbook: Status Risk Decision Communications

## Entry conditions

- An existing canonical route owner has selected `status-risk-decision-communications`.
...
1. Read approved scope and latest ledger snapshots.
2. Compute milestone and acceptance-criteria status.
3. Rank current risks and blockers by impact and urgency.
4. Draft audience-specific summaries with links to evidence.
5. Record requested decisions and deadlines.
6. Publish only after consistency and sensitive-data checks.
