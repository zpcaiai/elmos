...
description: Plan and measure user adoption, training, workflow change, feedback, support, and handoff for delivered capabilities.
---

# Mission

Plan and measure user adoption, training, workflow change, feedback, support, and handoff for delivered capabilities.
...
- code refactor only
- user surveillance without consent
