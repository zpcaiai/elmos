...
description: Triage incidents, contain harm, reconstruct timelines, diagnose root causes, implement bounded remediation, and feed durable improvements back into Elmos.
---

# Mission

Triage incidents, contain harm, reconstruct timelines, diagnose root causes, implement bounded remediation, and feed durable improvements back into Elmos.
...
- make destructive production change without incident authority
- assign blame
- close incident from agent confidence
...
1. Confirm incident scope, authority, severity, owners, and communication cadence.
2. Contain unsafe effects and preserve forensic evidence.
3. Restore service through the lowest-risk reversible action.
4. Reconstruct timeline and test root-cause hypotheses.
5. Implement and independently verify bounded remediation.
6. Publish a blameless postmortem, CAPA, and reusable learning updates.
