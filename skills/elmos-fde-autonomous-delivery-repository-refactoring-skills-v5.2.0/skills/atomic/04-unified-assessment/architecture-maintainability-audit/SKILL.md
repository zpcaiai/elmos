...
description: Audit boundaries, dependencies, modularity, maintainability, evolvability, code smells, ownership, and architecture drift across the repository.
---

# Mission

Audit boundaries, dependencies, modularity, maintainability, evolvability, code smells, ownership, and architecture drift across the repository.
...
- rewrite without business value
...
1. Recover current logical, deployment, data, and ownership architecture.
2. Evaluate dependency direction, module responsibilities, and public integration surfaces.
3. Combine structural metrics with history, incidents, runtime, and business criticality.
4. Identify root causes and architecture drift.
5. Define conservative, balanced, and strategic remediation options.
6. Create findings and candidate fitness functions.
