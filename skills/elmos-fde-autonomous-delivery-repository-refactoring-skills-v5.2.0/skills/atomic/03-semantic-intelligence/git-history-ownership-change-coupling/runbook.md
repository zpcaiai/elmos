# Runbook: Git History Ownership Change Coupling

## Entry conditions

- An existing canonical route owner has selected `git-history-ownership-change-coupling`.
...
1. Assess history completeness and branch topology.
2. Normalize commits, renames, generated changes, and bot activity.
3. Compute churn, co-change, defect, revert, and ownership signals.
4. Correlate with architecture and issue findings.
5. Validate material hotspots against current behavior.
6. Publish risk-oriented ownership and coupling views.
