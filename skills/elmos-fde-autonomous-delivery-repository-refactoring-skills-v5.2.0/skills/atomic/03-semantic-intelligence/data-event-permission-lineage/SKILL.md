---
name: data-event-permission-lineage
description: Trace data, events, identity, tenant context, authorization decisions, and side effects across application and infrastructure boundaries.
---

# Mission

Trace data, events, identity, tenant context, authorization decisions, and side effects across application and infrastructure boundaries.
...
- assume framework annotations guarantee authorization
- ignore batch and offline paths
...
1. Identify critical data classes, events, identities, tenants, and effects.
2. Build static lineage across code, queries, schemas, configs, and infrastructure.
3. Overlay runtime traces and observed policy decisions.
4. Locate missing, transformed, or ambiguous context propagation.
5. Generate risk paths and candidate controls.
6. Publish lineage graphs and verification obligations.
