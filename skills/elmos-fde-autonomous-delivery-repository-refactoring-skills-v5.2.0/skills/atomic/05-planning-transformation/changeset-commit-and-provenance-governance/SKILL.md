...
description: Govern atomic ChangeSets, commits, patches, provenance, review boundaries, side effects, and reversible integration.
---

# Mission

Govern atomic ChangeSets, commits, patches, provenance, review boundaries, side effects, and reversible integration.
...
1. Open an isolated workspace bound to the approved step and RevisionSet.
2. Declare expected files, generated artifacts, commands, and side effects.
3. Execute changes and capture all tool results before commit.
4. Compare actual deltas with scope and run required checks.
5. Request independent review and required human approval.
6. Commit atomically and append immutable provenance and rollback data.
