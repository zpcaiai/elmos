---
name: runtime-observation-and-traffic-capture
description: Capture authorized traces, metrics, logs, profiles, traffic, state transitions, and side effects for repository understanding and verification.
---

# Mission

Capture authorized traces, metrics, logs, profiles, traffic, state transitions, and side effects for repository understanding and verification.
...
- store raw secrets or personal data
- treat sampled traffic as exhaustive
