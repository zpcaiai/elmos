# Runbook: External Dependency Stub And Service Virtualization

## Entry conditions

- An existing canonical route owner has selected `external-dependency-stub-and-service-virtualization`.
