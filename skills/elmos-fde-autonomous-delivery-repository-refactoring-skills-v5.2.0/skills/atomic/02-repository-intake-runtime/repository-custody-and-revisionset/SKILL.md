---
name: repository-custody-and-revisionset
description: Acquire repositories and related artifacts with chain of custody, immutable RevisionSet identity, authorization, and reproducible provenance.
---

# Mission

Acquire repositories and related artifacts with chain of custody, immutable RevisionSet identity, authorization, and reproducible provenance.
...
- scan an unapproved repository
- reuse a stale checkout
- modify source during intake
...
1. Resolve authorization and data classification for every source.
2. Acquire repositories, submodules, LFS objects, archives, and supplied binaries without mutation.
3. Record commit identities, refs, shallow-history limits, and missing objects.
4. Generate content hashes and custody events.
5. Assemble and seal the RevisionSet.
6. Create isolated read-only and writable workspace references.
