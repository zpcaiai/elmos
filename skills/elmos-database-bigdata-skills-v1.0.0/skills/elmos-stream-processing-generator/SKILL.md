...
description: 生成 Flink、Kafka Streams、Spark Structured Streaming 或 Beam 的状态化实时处理工程。
version: 1.0.0
group: bigdata-core
dependencies: ["elmos-bigdata-pattern-selector", "elmos-cdc-event-backbone", "elmos-database-schema-physical-design"]
triggers: ["秒级或亚秒实时", "CEP/画像/实时指标/告警", "状态化流处理"]
outputs: ["pipelines/stream/", "state-and-watermark-design.md", "stream-tests/", "checkpoint-policy.json"]
---
