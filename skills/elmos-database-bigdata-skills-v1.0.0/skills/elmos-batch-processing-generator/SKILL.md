...
description: 生成可增量、可回填、可测试的 Spark/Flink Batch/Beam/dbt 批处理工程。
version: 1.0.0
group: bigdata-core
dependencies: ["elmos-bigdata-pattern-selector", "elmos-ingestion-connector-planner", "elmos-database-schema-physical-design"]
triggers: ["离线数仓或历史重算", "生成批处理代码", "替换遗留 MapReduce"]
outputs: ["pipelines/batch/", "batch-dag.json", "incremental-strategy.md", "batch-tests/"]
---
