...
description: 验证峰值、倾斜、背压、长尾、扩缩容、组件故障和灾难恢复下的平台行为。
version: 1.0.0
group: bigdata-core
dependencies: ["elmos-database-benchmark-harness", "elmos-database-cost-capacity-planner", "elmos-bigdata-infra-deployment", "elmos-bigdata-test-validation"]
triggers: ["性能容量验收", "生产前压力", "容错恢复验证"]
outputs: ["performance-tests/", "chaos-scenarios.json", "capacity-envelope.json", "performance-report.md"]
---
