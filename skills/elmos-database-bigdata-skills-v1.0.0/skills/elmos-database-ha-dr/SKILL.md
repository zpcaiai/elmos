...
description: 生成 HA 拓扑、备份、PITR、跨区域灾备、恢复演练与完整性验证。
version: 1.0.0
group: database-intelligence
dependencies: ["elmos-polyglot-persistence-planner"]
triggers: ["生产设计", "存在 RPO/RTO", "备份恢复或跨区容灾"]
outputs: ["ha-dr-topology.md", "backup-policy.json", "restore-runbook.md", "dr-test-plan.json"]
---
