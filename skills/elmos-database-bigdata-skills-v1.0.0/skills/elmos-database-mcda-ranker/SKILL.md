...
description: 对可行候选做多准则决策、Pareto 分析、复杂度惩罚和不确定性敏感性分析。
version: 1.0.0
group: database-intelligence
dependencies: ["elmos-database-constraint-filter"]
triggers: ["多个可行候选", "需要解释推荐", "调整性能/成本/运维偏好"]
outputs: ["candidate-ranking.json", "pareto-frontier.json", "sensitivity-report.md"]
---
