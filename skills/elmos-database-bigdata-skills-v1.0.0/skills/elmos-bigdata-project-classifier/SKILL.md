...
description: 从生命周期、架构模式、业务场景、存储范式和组织模型多维识别项目类型。
version: 1.0.0
group: bigdata-core
dependencies: ["elmos-data-requirement-intake", "elmos-workload-profiler"]
triggers: ["生成大数据项目", "需求未指定技术", "判断批流湖仓类型"]
outputs: ["bigdata-project-classification.json", "scenario-map.md", "capability-needs.json"]
---
