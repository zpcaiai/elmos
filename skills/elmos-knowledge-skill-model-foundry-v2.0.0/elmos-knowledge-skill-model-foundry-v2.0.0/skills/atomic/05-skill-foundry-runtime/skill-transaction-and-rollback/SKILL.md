...
description: Use this skill when Elmos must perform skill transaction and rollback as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
为有副作用 Skill 建立幂等键、补偿事务、检查点和回滚演练。
