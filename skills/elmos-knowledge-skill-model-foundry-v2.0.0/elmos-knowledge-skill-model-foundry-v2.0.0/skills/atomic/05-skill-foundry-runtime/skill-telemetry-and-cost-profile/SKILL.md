---
name: skill-telemetry-and-cost-profile
description: Use this skill when Elmos must perform skill telemetry and cost profile as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# skill-telemetry-and-cost-profile

## 能力目标

持续记录触发、成功、失败、成本、模型组合和客户价值。
