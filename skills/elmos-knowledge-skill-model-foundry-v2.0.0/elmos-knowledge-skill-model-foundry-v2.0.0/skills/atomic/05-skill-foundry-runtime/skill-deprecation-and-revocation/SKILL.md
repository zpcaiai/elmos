---
name: skill-deprecation-and-revocation
description: Use this skill when Elmos must perform skill deprecation and revocation as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# skill-deprecation-and-revocation

## 能力目标

在缺陷、安全事件或依赖失效时阻止新调用并迁移现有任务。
