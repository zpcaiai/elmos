---
name: commit-history-to-skill-miner
description: Use this skill when Elmos must perform commit history to skill miner as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# commit-history-to-skill-miner

## 能力目标

从重复提交、修复和评审意见中发现可自动化工程模式。
