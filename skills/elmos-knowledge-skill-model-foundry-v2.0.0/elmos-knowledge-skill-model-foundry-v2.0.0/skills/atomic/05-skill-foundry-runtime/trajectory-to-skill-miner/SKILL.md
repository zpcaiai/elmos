...
description: Use this skill when Elmos must perform trajectory to skill miner as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
