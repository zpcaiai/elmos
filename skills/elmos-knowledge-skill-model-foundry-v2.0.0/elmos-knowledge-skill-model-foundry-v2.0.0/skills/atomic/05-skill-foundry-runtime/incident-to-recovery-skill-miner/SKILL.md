---
name: incident-to-recovery-skill-miner
description: Use this skill when Elmos must perform incident to recovery skill miner as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# incident-to-recovery-skill-miner

## 能力目标

从故障与恢复记录生成诊断、止损、修复和复盘 Skill。
