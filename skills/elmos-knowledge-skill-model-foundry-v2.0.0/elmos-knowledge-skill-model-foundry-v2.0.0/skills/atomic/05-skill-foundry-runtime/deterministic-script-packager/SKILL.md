---
name: deterministic-script-packager
description: Use this skill when Elmos must perform deterministic script packager as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# deterministic-script-packager

## 能力目标

把高精度步骤固化为幂等、可测试、稳定接口的脚本资源。
