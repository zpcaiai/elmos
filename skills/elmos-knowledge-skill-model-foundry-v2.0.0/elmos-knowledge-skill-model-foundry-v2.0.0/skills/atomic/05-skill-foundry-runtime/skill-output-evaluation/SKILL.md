...
description: Use this skill when Elmos must perform skill output evaluation as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
