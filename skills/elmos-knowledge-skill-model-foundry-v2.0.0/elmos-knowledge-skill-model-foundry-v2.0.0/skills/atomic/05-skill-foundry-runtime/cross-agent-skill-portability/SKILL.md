---
name: cross-agent-skill-portability
description: Use this skill when Elmos must perform cross agent skill portability as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
验证 Skill 在 Codex、Claude Code、兼容 Agent 和 Elmos Runtime 的可移植性。
