---
name: hyperparameter-and-mixture-search
description: Use this skill when Elmos must perform hyperparameter and mixture search as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# hyperparameter-and-mixture-search

## 能力目标

在预算约束下优化学习率、Rank、数据混合、长度和训练策略。
