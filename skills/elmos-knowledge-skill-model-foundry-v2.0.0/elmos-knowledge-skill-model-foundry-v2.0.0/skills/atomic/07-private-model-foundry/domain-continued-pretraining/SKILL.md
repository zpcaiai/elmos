...
description: Use this skill when Elmos must perform domain continued pretraining as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
