---
name: semantic-transformer-model-training
description: Use this skill when Elmos must perform semantic transformer model training as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# semantic-transformer-model-training

## 能力目标

训练基于 Semantic IR 的代码生成、迁移、重构和跨语言变换能力。
