---
name: execution-guided-repair-model
description: Use this skill when Elmos must perform execution guided repair model as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# execution-guided-repair-model

## 能力目标

训练利用编译、测试、日志和差分反馈进行最小修复的模型。
