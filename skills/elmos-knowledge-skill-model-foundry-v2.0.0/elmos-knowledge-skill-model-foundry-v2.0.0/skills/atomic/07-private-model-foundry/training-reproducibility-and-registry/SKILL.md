---
name: training-reproducibility-and-registry
description: Use this skill when Elmos must perform training reproducibility and registry as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# training-reproducibility-and-registry

## 能力目标

记录代码、数据、容器、随机种子、依赖、硬件、指标与模型血缘。
