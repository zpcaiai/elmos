---
name: quantization-and-accuracy-guard
description: Use this skill when Elmos must perform quantization and accuracy guard as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# quantization-and-accuracy-guard

## 能力目标

执行量化、校准和硬件适配，同时用业务评测阻止精度暗降。
