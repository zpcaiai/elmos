---
name: speculative-draft-model-training
description: Use this skill when Elmos must perform speculative draft model training as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# speculative-draft-model-training

## 能力目标

训练低成本草稿模型并验证其与目标模型的接受率和端到端收益。
