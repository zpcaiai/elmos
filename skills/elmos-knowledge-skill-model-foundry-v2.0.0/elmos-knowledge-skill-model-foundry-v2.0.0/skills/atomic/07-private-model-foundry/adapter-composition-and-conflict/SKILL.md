---
name: adapter-composition-and-conflict
description: Use this skill when Elmos must perform adapter composition and conflict as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# adapter-composition-and-conflict

## 能力目标

评估多 Adapter 组合、路由、加权、合并和能力冲突。
