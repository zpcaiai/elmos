---
name: distributed-training-checkpointing
description: Use this skill when Elmos must perform distributed training checkpointing as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
支持 DDP/FSDP/ZeRO、并行保存、拓扑变化恢复和训练断点续跑。
