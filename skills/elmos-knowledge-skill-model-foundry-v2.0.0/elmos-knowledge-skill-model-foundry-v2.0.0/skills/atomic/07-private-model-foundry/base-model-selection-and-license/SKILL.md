---
name: base-model-selection-and-license
description: Use this skill when Elmos must perform base model selection and license as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# base-model-selection-and-license

## 能力目标

根据代码能力、上下文、工具使用、许可证、硬件和私有部署需求选择基座。
