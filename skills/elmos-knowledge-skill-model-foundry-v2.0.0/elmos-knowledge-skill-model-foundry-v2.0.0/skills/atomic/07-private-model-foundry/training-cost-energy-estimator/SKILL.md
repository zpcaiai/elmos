---
name: training-cost-energy-estimator
description: Use this skill when Elmos must perform training cost energy estimator as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# training-cost-energy-estimator

## 能力目标

预测并核算 GPU 时、Token、存储、网络、能耗和单能力边际成本。
