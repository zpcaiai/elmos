---
name: tokenizer-adaptation-and-migration
description: Use this skill when Elmos must perform tokenizer adaptation and migration as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# tokenizer-adaptation-and-migration

## 能力目标

受控扩展词表并处理 Embedding 初始化、兼容、Checkpoint 迁移和回归。
