---
name: supervised-finetuning-orchestrator
description: Use this skill when Elmos must perform supervised finetuning orchestrator as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# supervised-finetuning-orchestrator

## 能力目标

执行 SFT 数据验证、模板锁定、分布式训练、Checkpoint 与离线评测。
