---
name: repository-planner-model-training
description: Use this skill when Elmos must perform repository planner model training as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# repository-planner-model-training

## 能力目标

训练仓库理解、任务拆解、影响范围、检查点和执行 DAG 能力。
