---
name: code-embedding-model-training
description: Use this skill when Elmos must perform code embedding model training as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
训练面向符号、错误、API、SQL 和跨语言语义的 Embedding 模型。
