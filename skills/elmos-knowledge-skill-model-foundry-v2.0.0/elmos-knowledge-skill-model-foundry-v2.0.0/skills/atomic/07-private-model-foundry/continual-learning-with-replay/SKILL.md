---
name: continual-learning-with-replay
description: Use this skill when Elmos must perform continual learning with replay as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
