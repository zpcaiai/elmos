...
description: Use this skill when Elmos must perform subscription and project pricing as part of the 13-commercial-multitenant-platform production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
