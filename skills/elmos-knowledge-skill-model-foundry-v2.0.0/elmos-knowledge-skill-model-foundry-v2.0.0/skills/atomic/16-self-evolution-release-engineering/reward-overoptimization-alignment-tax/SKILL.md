...
description: Use this skill when Elmos must perform reward overoptimization alignment tax as part of the 16-self-evolution-release-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
