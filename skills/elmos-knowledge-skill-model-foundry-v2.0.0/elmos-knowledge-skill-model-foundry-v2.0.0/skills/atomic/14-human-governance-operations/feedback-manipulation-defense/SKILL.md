---
name: feedback-manipulation-defense
description: Use this skill when Elmos must perform feedback manipulation defense as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# feedback-manipulation-defense

## 能力目标

检测恶意评分、刷样本、利益冲突和低质量反馈进入训练。
