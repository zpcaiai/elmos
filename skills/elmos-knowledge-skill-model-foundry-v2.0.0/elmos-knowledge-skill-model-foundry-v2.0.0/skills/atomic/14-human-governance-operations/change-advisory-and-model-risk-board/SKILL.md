---
name: change-advisory-and-model-risk-board
description: Use this skill when Elmos must perform change advisory and model risk board as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# change-advisory-and-model-risk-board

## 能力目标

对高风险模型、训练和生产变更执行跨职能评审。
