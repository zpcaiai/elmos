---
name: incident-command-and-communications
description: Use this skill when Elmos must perform incident command and communications as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
