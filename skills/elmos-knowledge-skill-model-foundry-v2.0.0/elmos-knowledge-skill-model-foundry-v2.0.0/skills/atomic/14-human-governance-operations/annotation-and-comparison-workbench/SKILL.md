---
name: annotation-and-comparison-workbench
description: Use this skill when Elmos must perform annotation and comparison workbench as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# annotation-and-comparison-workbench

## 能力目标

支持轨迹、补丁、证据、偏好对和失败类型的高效标注。
