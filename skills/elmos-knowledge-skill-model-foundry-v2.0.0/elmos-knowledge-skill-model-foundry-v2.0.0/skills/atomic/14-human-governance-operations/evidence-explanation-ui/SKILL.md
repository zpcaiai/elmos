---
name: evidence-explanation-ui
description: Use this skill when Elmos must perform evidence explanation ui as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
