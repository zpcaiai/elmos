---
name: escalation-sla-reversibility-transparency
description: Use this skill when Elmos must perform escalation sla reversibility transparency as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# escalation-sla-reversibility-transparency

## 能力目标

定义升级时限、人工接管、撤销路径和对用户透明的信息。
