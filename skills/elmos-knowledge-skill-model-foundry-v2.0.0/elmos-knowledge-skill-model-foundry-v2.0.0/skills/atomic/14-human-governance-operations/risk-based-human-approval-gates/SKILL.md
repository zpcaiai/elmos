---
name: risk-based-human-approval-gates
description: Use this skill when Elmos must perform risk based human approval gates as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
