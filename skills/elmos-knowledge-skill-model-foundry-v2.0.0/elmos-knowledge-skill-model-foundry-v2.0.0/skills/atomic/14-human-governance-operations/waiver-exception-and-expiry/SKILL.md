---
name: waiver-exception-and-expiry
description: Use this skill when Elmos must perform waiver exception and expiry as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# waiver-exception-and-expiry

## 能力目标

允许受控例外，但必须包含理由、补偿控制、期限和复审。
