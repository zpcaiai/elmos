---
name: human-feedback-capture-and-lineage
description: Use this skill when Elmos must perform human feedback capture and lineage as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# human-feedback-capture-and-lineage

## 能力目标

记录反馈来源、范围、版本、意图、置信度和后续使用。
