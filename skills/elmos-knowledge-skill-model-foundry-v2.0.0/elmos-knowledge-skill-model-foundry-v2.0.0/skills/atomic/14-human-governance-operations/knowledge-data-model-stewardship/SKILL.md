---
name: knowledge-data-model-stewardship
description: Use this skill when Elmos must perform knowledge data model stewardship as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# knowledge-data-model-stewardship

## 能力目标

建立知识 Steward、数据 Owner、模型 Owner 和 Skill Maintainer 制度。
