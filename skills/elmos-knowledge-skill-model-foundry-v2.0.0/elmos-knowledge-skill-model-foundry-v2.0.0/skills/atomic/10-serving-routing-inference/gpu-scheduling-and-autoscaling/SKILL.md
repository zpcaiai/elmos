---
name: gpu-scheduling-and-autoscaling
description: Use this skill when Elmos must perform gpu scheduling and autoscaling as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
根据模型、上下文、Adapter、显存、队列和 SLA 调度 GPU。
