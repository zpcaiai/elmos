...
description: Use this skill when Elmos must perform usage metering and slo as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
