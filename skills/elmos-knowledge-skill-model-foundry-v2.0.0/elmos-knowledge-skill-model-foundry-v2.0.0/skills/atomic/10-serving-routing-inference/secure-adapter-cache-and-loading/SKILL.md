---
name: secure-adapter-cache-and-loading
description: Use this skill when Elmos must perform secure adapter cache and loading as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# secure-adapter-cache-and-loading

## 能力目标

验证签名、来源、租户和哈希后加载 Adapter，并隔离缓存。
