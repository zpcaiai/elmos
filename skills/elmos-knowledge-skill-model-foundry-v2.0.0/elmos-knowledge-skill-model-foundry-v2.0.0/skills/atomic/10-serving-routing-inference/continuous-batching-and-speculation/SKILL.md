---
name: continuous-batching-and-speculation
description: Use this skill when Elmos must perform continuous batching and speculation as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# continuous-batching-and-speculation

## 能力目标

优化批处理、Prefill、Decode 和投机解码，并用质量门保护。
