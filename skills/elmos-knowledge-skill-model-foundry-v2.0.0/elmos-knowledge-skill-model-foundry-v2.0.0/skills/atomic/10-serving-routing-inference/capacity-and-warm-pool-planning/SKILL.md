---
name: capacity-and-warm-pool-planning
description: Use this skill when Elmos must perform capacity and warm pool planning as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# capacity-and-warm-pool-planning

## 能力目标

预测峰值、冷启动和 Adapter 热度，维护合理 Warm Pool。
