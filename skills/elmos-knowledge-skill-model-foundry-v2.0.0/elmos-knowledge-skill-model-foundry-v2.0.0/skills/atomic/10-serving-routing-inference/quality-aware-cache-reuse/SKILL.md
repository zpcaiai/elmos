---
name: quality-aware-cache-reuse
description: Use this skill when Elmos must perform quality aware cache reuse as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# quality-aware-cache-reuse

## 能力目标

仅在任务语义、权限、版本和证据相容时复用响应或中间结果。
