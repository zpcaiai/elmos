---
name: model-at-rest-and-in-use-protection
description: Use this skill when Elmos must perform model at rest and in use protection as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# model-at-rest-and-in-use-protection

## 能力目标

保护模型、Adapter、KV Cache、Prompt 和中间产物的存储与传输。
