---
name: deadline-timeout-propagation
description: Use this skill when Elmos must perform deadline timeout propagation as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
