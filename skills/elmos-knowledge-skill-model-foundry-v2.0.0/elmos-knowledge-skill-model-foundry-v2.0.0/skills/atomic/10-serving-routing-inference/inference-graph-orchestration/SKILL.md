---
name: inference-graph-orchestration
description: Use this skill when Elmos must perform inference graph orchestration as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
支持 Router、Sequence、Ensemble、Verifier 和 Fallback 的推理图。
