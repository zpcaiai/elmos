---
name: airgapped-and-private-serving
description: Use this skill when Elmos must perform airgapped and private serving as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# airgapped-and-private-serving

## 能力目标

支持离线镜像、私有 Registry、无外网依赖、更新包和本地审计。
