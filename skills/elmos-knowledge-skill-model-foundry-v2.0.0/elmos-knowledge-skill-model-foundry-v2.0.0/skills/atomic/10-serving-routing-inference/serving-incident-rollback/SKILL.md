---
name: serving-incident-rollback
description: Use this skill when Elmos must perform serving incident rollback as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# serving-incident-rollback

## 能力目标

在泄漏、回归、成本异常或模型失效时自动隔离并恢复已知良好组合。
