---
name: prefix-kv-cache-and-isolation
description: Use this skill when Elmos must perform prefix kv cache and isolation as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# prefix-kv-cache-and-isolation

## 能力目标

利用 Prefix/KV Cache 降低成本，同时防止租户和权限上下文串用。
