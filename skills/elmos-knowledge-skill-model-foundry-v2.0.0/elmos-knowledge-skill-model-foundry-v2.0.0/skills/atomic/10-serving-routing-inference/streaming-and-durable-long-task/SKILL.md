---
name: streaming-and-durable-long-task
description: Use this skill when Elmos must perform streaming and durable long task as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# streaming-and-durable-long-task

## 能力目标

支持流式反馈、异步节点、检查点、暂停、恢复、取消和断电恢复。
