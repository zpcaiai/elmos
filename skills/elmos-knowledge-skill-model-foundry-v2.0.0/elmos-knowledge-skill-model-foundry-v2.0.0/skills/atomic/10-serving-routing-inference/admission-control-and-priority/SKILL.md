---
name: admission-control-and-priority
description: Use this skill when Elmos must perform admission control and priority as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
按并发上限、账户余额、任务优先级、GPU 和截止时间控制入场。
