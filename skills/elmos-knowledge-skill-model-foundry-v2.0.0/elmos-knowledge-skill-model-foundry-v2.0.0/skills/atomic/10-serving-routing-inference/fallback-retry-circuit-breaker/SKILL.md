---
name: fallback-retry-circuit-breaker
description: Use this skill when Elmos must perform fallback retry circuit breaker as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
