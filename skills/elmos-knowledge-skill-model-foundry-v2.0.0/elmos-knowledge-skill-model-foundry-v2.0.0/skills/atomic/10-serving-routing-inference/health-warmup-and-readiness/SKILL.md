---
name: health-warmup-and-readiness
description: Use this skill when Elmos must perform health warmup and readiness as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
验证权重、Tokenizer、Adapter、依赖、显存和基准请求后才进入流量。
