---
name: serving-compatibility-gateway
description: Use this skill when Elmos must perform serving compatibility gateway as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# serving-compatibility-gateway

## 能力目标

在 API、Tokenizer、模板、工具 Schema 和 Adapter 变更时执行兼容转换。
