---
name: multi-model-skill-aware-router
description: Use this skill when Elmos must perform multi model skill aware router as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# multi-model-skill-aware-router

## 能力目标

根据任务、Skill、语言、风险、上下文和历史表现选择模型组合。
