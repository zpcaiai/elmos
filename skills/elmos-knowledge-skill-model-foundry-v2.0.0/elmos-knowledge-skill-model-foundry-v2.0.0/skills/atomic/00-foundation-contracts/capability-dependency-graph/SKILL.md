...
description: Use this skill when Elmos must perform capability dependency graph as part of the 00-foundation-contracts production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
