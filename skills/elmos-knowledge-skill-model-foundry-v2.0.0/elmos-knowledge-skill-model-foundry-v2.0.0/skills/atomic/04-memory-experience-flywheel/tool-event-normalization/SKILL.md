---
name: tool-event-normalization
description: Use this skill when Elmos must perform tool event normalization as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
统一不同模型和 Agent 框架的工具请求、结果、错误和权限决策格式。
