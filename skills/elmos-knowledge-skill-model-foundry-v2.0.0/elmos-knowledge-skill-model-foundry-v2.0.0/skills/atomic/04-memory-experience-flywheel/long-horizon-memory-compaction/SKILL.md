---
name: long-horizon-memory-compaction
description: Use this skill when Elmos must perform long horizon memory compaction as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# long-horizon-memory-compaction

## 能力目标

分层压缩长任务历史，保留决策、未决风险、工具结果哈希和恢复锚点。
