---
name: experience-clustering-and-dedupe
description: Use this skill when Elmos must perform experience clustering and dedupe as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# experience-clustering-and-dedupe

## 能力目标

按任务、语言、框架、失败和修复模式聚类并去除近重复经历。
