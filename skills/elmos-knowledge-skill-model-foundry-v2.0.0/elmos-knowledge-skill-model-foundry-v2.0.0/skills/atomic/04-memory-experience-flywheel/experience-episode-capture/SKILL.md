---
name: experience-episode-capture
description: Use this skill when Elmos must perform experience episode capture as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
形成标准 Episode，绑定仓库快照、知识、Skill、模型、环境和最终验收。
