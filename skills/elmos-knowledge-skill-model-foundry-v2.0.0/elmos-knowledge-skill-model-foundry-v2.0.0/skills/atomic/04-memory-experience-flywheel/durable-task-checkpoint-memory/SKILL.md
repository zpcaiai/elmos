---
name: durable-task-checkpoint-memory
description: Use this skill when Elmos must perform durable task checkpoint memory as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# durable-task-checkpoint-memory

## 能力目标

在暂停、断电、网络中断和进程迁移后恢复任务状态与副作用边界。
