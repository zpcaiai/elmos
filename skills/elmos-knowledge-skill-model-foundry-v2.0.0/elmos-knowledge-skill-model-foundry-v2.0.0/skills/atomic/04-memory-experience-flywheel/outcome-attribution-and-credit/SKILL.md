---
name: outcome-attribution-and-credit
description: Use this skill when Elmos must perform outcome attribution and credit as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# outcome-attribution-and-credit

## 能力目标

把最终成功或失败归因到检索、Skill、计划、工具、模型和验证步骤。
