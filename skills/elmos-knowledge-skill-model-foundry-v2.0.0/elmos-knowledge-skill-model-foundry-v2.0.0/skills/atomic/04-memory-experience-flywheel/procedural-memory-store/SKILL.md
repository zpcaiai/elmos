...
description: Use this skill when Elmos must perform procedural memory store as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
