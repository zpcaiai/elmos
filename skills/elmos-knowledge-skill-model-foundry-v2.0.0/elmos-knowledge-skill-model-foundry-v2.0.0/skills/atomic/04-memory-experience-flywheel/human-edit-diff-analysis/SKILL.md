---
name: human-edit-diff-analysis
description: Use this skill when Elmos must perform human edit diff analysis as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# human-edit-diff-analysis

## 能力目标

区分人工对模型结果的修错、偏好调整、补需求和无关格式修改。
