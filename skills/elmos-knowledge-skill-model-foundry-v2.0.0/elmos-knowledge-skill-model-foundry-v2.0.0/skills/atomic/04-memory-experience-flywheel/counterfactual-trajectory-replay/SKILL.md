---
name: counterfactual-trajectory-replay
description: Use this skill when Elmos must perform counterfactual trajectory replay as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
