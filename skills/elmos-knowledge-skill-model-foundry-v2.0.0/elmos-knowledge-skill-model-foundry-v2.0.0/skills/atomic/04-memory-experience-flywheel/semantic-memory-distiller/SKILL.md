---
name: semantic-memory-distiller
description: Use this skill when Elmos must perform semantic memory distiller as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# semantic-memory-distiller

## 能力目标

从多次经历中提炼稳定事实、规则和模式，并保留来源覆盖范围。
