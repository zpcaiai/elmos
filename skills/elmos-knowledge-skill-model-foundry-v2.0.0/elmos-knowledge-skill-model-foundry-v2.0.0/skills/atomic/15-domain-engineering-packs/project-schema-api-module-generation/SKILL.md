---
name: project-schema-api-module-generation
description: Use this skill when Elmos must perform project schema api module generation as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# project-schema-api-module-generation

## 能力目标

联合生成数据库、API、事件、模块、代码和契约测试。
