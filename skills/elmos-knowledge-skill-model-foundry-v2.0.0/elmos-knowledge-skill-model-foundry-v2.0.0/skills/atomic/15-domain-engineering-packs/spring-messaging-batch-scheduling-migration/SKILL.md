---
name: spring-messaging-batch-scheduling-migration
description: Use this skill when Elmos must perform spring messaging batch scheduling migration as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# spring-messaging-batch-scheduling-migration

## 能力目标

迁移消息、定时、批处理、重试、幂等和死信行为。
