---
name: sql-type-function-operator-mapping
description: Use this skill when Elmos must perform sql type function operator mapping as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# sql-type-function-operator-mapping

## 能力目标

映射类型、隐式转换、函数、运算符、Collation、时区和 Null。
