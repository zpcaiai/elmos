---
name: spring-view-template-migration
description: Use this skill when Elmos must perform spring view template migration as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# spring-view-template-migration

## 能力目标

迁移 JSP、Taglib、Tiles、Freemarker 和视图解析及前后端契约。
