---
name: cross-language-control-error-equivalence
description: Use this skill when Elmos must perform cross language control error equivalence as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# cross-language-control-error-equivalence

## 能力目标

保持控制流、异常、资源释放、取消和错误传播。
