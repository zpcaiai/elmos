---
name: spring-session-state-migration
description: Use this skill when Elmos must perform spring session state migration as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# spring-session-state-migration

## 能力目标

保持 Session、Cookie、Flash、并发访问、失效和序列化行为。
