---
name: spring-shadow-differential-golden-route
description: Use this skill when Elmos must perform spring shadow differential golden route as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# spring-shadow-differential-golden-route

## 能力目标

通过影子流量、差分、回滚和真实大型仓库形成可付费 Golden Route。
