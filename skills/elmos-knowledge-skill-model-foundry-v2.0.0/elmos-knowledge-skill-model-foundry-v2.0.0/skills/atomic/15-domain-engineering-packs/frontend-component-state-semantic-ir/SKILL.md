...
description: Use this skill when Elmos must perform frontend component state semantic ir as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
