---
name: domain-proof-and-certification-pack
description: Use this skill when Elmos must perform domain proof and certification pack as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# domain-proof-and-certification-pack

## 能力目标

为每条业务线维护专用不变量、反例、证据模板和 E0-E5 门。
