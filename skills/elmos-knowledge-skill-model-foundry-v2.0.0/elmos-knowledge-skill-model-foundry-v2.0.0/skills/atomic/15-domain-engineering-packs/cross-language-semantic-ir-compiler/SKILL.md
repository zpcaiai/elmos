---
name: cross-language-semantic-ir-compiler
description: Use this skill when Elmos must perform cross language semantic ir compiler as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# cross-language-semantic-ir-compiler

## 能力目标

把源语言解析为统一语义并按目标语言约束重新生成。
