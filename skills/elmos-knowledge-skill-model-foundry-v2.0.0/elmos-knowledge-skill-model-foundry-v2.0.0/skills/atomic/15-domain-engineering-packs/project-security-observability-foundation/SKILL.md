---
name: project-security-observability-foundation
description: Use this skill when Elmos must perform project security observability foundation as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# project-security-observability-foundation

## 能力目标

默认生成身份、权限、审计、秘密、Trace、Metric 和健康检查。
