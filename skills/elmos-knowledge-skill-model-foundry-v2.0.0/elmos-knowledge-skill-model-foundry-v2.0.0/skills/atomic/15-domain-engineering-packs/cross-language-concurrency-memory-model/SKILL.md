---
name: cross-language-concurrency-memory-model
description: Use this skill when Elmos must perform cross language concurrency memory model as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# cross-language-concurrency-memory-model

## 能力目标

映射线程、协程、Actor、锁、原子性、所有权和内存可见性。
