---
name: spring-route-request-binding-migration
description: Use this skill when Elmos must perform spring route request binding migration as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# spring-route-request-binding-migration

## 能力目标

迁移路由、HTTP 方法、参数绑定、上传、编码、Locale 和响应语义。
