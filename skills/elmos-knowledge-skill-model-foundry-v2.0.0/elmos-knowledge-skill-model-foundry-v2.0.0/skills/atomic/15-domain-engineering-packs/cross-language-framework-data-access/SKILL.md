---
name: cross-language-framework-data-access
description: Use this skill when Elmos must perform cross language framework data access as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# cross-language-framework-data-access

## 能力目标

映射 Web、DI、ORM、缓存、消息、事务和配置框架。
