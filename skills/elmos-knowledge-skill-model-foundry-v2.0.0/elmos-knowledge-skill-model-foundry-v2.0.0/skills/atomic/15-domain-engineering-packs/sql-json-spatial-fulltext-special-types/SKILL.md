---
name: sql-json-spatial-fulltext-special-types
description: Use this skill when Elmos must perform sql json spatial fulltext special types as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# sql-json-spatial-fulltext-special-types

## 能力目标

转换 JSON、数组、空间、全文、XML 和厂商专有类型。
