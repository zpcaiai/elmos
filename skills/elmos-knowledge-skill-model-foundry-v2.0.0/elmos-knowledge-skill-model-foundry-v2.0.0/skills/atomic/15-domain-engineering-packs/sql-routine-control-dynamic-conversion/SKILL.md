---
name: sql-routine-control-dynamic-conversion
description: Use this skill when Elmos must perform sql routine control dynamic conversion as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# sql-routine-control-dynamic-conversion

## 能力目标

转换过程、函数、包、游标、控制流、动态 SQL 和临时对象。
