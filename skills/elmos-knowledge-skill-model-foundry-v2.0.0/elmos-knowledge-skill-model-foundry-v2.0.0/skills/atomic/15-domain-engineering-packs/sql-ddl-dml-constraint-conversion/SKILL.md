---
name: sql-ddl-dml-constraint-conversion
description: Use this skill when Elmos must perform sql ddl dml constraint conversion as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# sql-ddl-dml-constraint-conversion

## 能力目标

转换表、索引、约束、分区、序列、Identity、MERGE 和 Upsert。
