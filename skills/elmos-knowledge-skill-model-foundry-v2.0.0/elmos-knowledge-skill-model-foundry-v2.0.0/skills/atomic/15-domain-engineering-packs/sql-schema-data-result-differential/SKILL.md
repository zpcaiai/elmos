---
name: sql-schema-data-result-differential
description: Use this skill when Elmos must perform sql schema data result differential as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# sql-schema-data-result-differential

## 能力目标

比较 Schema、数据、结果集、顺序、精度、副作用和错误。
