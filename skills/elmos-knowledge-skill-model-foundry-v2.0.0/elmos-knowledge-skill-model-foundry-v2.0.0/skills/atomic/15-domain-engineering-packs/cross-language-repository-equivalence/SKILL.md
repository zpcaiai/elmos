---
name: cross-language-repository-equivalence
description: Use this skill when Elmos must perform cross language repository equivalence as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# cross-language-repository-equivalence

## 能力目标

通过可执行测试、差分、性能和语义覆盖认证整库转换。
