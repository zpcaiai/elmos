---
name: cross-language-type-and-nullability-mapping
description: Use this skill when Elmos must perform cross language type and nullability mapping as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# cross-language-type-and-nullability-mapping

## 能力目标

处理数值、泛型、集合、Null、枚举、时间和领域值类型。
