---
name: project-test-deploy-doc-certification
description: Use this skill when Elmos must perform project test deploy doc certification as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# project-test-deploy-doc-certification

## 能力目标

生成测试、CI/CD、IaC、Runbook、架构文档和生产认证材料。
