---
name: sql-plan-performance-certification
description: Use this skill when Elmos must perform sql plan performance certification as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# sql-plan-performance-certification

## 能力目标

比较执行计划、索引、统计、锁和性能，阻止语义正确但不可用的转换。
