---
name: spring-transaction-persistence-migration
description: Use this skill when Elmos must perform spring transaction persistence migration as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# spring-transaction-persistence-migration

## 能力目标

迁移 JDBC、Hibernate、MyBatis、事务传播、锁和 Lazy 语义。
