...
description: Use this skill when Elmos must perform sensitive content capture policy as part of the 12-observability-lineage-finops production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
