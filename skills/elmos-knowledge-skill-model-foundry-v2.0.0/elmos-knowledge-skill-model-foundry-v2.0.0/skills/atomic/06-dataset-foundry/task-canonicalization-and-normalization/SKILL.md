---
name: task-canonicalization-and-normalization
description: Use this skill when Elmos must perform task canonicalization and normalization as part of the 06-dataset-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
