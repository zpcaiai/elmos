...
description: Use this skill when Elmos must perform dataset revocation unlearning index as part of the 06-dataset-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
记录样本到 Checkpoint/Adapter 的影响范围，支持撤回、删除和选择性重训。
