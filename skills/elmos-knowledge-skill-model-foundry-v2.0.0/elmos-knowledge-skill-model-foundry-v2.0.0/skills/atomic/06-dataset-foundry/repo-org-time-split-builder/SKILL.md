...
description: Use this skill when Elmos must perform repo org time split builder as part of the 06-dataset-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
