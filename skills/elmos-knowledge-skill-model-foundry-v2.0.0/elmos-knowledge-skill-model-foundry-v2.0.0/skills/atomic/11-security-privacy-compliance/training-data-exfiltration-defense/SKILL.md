---
name: training-data-exfiltration-defense
description: Use this skill when Elmos must perform training data exfiltration defense as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# training-data-exfiltration-defense

## 能力目标

阻止 Prompt、日志、Trace、Adapter 和输出泄露训练或客户数据。
