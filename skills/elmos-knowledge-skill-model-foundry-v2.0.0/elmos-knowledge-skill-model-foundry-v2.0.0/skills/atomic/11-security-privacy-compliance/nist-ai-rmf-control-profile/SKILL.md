---
name: nist-ai-rmf-control-profile
description: Use this skill when Elmos must perform nist ai rmf control profile as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# nist-ai-rmf-control-profile

## 能力目标

将 Govern、Map、Measure、Manage 映射到 Elmos 控制与证据。
