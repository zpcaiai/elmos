---
name: ai-ml-bom-and-model-provenance
description: Use this skill when Elmos must perform ai ml bom and model provenance as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# ai-ml-bom-and-model-provenance

## 能力目标

记录模型、数据集、训练方法、框架、Adapter 和部署依赖。
