---
name: consent-purpose-and-secondary-use
description: Use this skill when Elmos must perform consent purpose and secondary use as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# consent-purpose-and-secondary-use

## 能力目标

验证收集目的、训练用途、跨租户聚合和二次使用是否获得授权。
