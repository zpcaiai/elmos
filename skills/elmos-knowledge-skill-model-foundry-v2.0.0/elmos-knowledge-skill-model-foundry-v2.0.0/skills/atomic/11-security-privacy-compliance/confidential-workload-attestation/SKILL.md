---
name: confidential-workload-attestation
description: Use this skill when Elmos must perform confidential workload attestation as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# confidential-workload-attestation

## 能力目标

在需要时验证训练和推理环境、镜像和硬件可信状态。
