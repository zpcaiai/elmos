...
description: Use this skill when Elmos must perform least privilege tool authorization as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
按任务、Environment、Attachment 和 Skill 精确授予工具与参数权限。
