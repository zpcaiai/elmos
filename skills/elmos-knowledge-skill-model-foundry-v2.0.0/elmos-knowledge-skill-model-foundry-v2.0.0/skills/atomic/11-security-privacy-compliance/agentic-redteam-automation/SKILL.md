---
name: agentic-redteam-automation
description: Use this skill when Elmos must perform agentic redteam automation as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# agentic-redteam-automation

## 能力目标

覆盖目标劫持、工具滥用、权限滥用、记忆污染、级联失败和 Rogue Agent。
