---
name: zero-trust-user-workload-identity
description: Use this skill when Elmos must perform zero trust user workload identity as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# zero-trust-user-workload-identity

## 能力目标

对用户、Agent、服务、工具、训练作业和部署实例实施可验证身份。
