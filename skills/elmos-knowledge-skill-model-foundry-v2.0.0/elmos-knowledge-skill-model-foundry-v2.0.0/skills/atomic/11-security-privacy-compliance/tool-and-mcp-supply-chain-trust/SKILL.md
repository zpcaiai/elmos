---
name: tool-and-mcp-supply-chain-trust
description: Use this skill when Elmos must perform tool and mcp supply chain trust as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# tool-and-mcp-supply-chain-trust

## 能力目标

校验第三方 Tool/MCP 的来源、权限、更新、依赖和返回内容。
