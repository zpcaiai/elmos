...
description: Use this skill when Elmos must perform privacy preserving federated learning as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
为联邦 Adapter 学习增加安全聚合、更新裁剪和异常客户端检测。
