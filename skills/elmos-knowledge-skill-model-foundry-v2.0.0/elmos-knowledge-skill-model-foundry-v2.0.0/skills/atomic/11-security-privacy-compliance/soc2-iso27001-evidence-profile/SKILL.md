---
name: soc2-iso27001-evidence-profile
description: Use this skill when Elmos must perform soc2 iso27001 evidence profile as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# soc2-iso27001-evidence-profile

## 能力目标

复用身份、变更、访问、备份、监控和事件证据支持企业审计。
