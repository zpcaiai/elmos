---
name: secret-broker-kms-and-key-isolation
description: Use this skill when Elmos must perform secret broker kms and key isolation as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# secret-broker-kms-and-key-isolation

## 能力目标

不向模型暴露长期密钥，按租户和任务签发短期凭据并轮换。
