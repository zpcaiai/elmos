---
name: model-extraction-membership-audit
description: Use this skill when Elmos must perform model extraction membership audit as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# model-extraction-membership-audit

## 能力目标

评估模型抽取、成员推断和训练数据记忆风险。
