---
name: human-approval-and-breakglass
description: Use this skill when Elmos must perform human approval and breakglass as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# human-approval-and-breakglass

## 能力目标

对高风险操作执行审批、双人复核、时限授权和事后审计。
