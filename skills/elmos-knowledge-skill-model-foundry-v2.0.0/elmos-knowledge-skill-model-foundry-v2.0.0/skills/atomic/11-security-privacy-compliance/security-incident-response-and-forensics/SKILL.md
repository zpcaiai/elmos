---
name: security-incident-response-and-forensics
description: Use this skill when Elmos must perform security incident response and forensics as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
检测、隔离、回滚、保全证据、通知和复盘 AI/Agent 安全事件。
