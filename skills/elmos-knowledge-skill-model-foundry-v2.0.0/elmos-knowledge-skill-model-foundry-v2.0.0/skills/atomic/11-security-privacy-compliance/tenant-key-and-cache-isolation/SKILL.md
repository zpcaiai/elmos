---
name: tenant-key-and-cache-isolation
description: Use this skill when Elmos must perform tenant key and cache isolation as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# tenant-key-and-cache-isolation

## 能力目标

确保对象、向量、缓存、Adapter、Checkpoint 和备份按租户隔离。
