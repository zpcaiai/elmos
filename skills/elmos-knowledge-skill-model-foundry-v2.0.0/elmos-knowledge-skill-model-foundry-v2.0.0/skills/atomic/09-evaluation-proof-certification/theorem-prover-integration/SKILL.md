---
name: theorem-prover-integration
description: Use this skill when Elmos must perform theorem prover integration as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
为关键算法和转换规则生成 Lean/Coq/Isabelle 等证明接口与证据。
