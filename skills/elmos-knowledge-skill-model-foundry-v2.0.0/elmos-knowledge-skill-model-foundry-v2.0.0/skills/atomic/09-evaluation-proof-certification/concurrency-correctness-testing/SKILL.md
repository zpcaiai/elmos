---
name: concurrency-correctness-testing
description: Use this skill when Elmos must perform concurrency correctness testing as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
