---
name: knowledge-retrieval-quality-metrics
description: Use this skill when Elmos must perform knowledge retrieval quality metrics as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
测量 Recall@K、MRR、引用准确率、版本正确率和有用上下文比例。
