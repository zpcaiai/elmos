---
name: e0-e5-certification-engine
description: Use this skill when Elmos must perform e0 e5 certification engine as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# e0-e5-certification-engine

## 能力目标

把来源、单测、集成、影子、金丝雀和长期运行证据映射为 E0-E5。
