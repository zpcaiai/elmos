---
name: cost-latency-and-soak-evaluation
description: Use this skill when Elmos must perform cost latency and soak evaluation as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# cost-latency-and-soak-evaluation

## 能力目标

评估长任务 Wall-clock、Token、工具成本、并发、稳定性和资源泄漏。
