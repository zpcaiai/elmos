---
name: skill-activation-quality-metrics
description: Use this skill when Elmos must perform skill activation quality metrics as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# skill-activation-quality-metrics

## 能力目标

测量触发 Precision、Recall、误触发成本和关键漏触发。
