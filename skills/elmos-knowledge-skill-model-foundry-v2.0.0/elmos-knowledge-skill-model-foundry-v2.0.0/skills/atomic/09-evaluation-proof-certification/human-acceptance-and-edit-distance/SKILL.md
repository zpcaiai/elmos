---
name: human-acceptance-and-edit-distance
description: Use this skill when Elmos must perform human acceptance and edit distance as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# human-acceptance-and-edit-distance

## 能力目标

量化专家接受率、人工改动原因、复核时间和信任边界。
