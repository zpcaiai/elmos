---
name: evidence-aggregation-and-completeness
description: Use this skill when Elmos must perform evidence aggregation and completeness as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
聚合所有检查、日志、哈希、审批和未决风险，验证 Evidence Contract。
