---
name: transaction-and-data-equivalence
description: Use this skill when Elmos must perform transaction and data equivalence as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# transaction-and-data-equivalence

## 能力目标

验证事务边界、隔离、锁、回滚、幂等和最终数据一致性。
