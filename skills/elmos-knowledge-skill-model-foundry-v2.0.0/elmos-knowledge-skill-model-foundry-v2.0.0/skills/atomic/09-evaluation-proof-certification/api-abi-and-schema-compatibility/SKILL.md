---
name: api-abi-and-schema-compatibility
description: Use this skill when Elmos must perform api abi and schema compatibility as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# api-abi-and-schema-compatibility

## 能力目标

验证 API、ABI、消息、序列化、数据库 Schema 和迁移兼容性。
