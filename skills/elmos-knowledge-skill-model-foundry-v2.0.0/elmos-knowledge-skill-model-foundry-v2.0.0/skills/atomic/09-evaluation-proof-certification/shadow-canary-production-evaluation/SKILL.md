---
name: shadow-canary-production-evaluation
description: Use this skill when Elmos must perform shadow canary production evaluation as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# shadow-canary-production-evaluation

## 能力目标

在影子和金丝雀流量中对比质量、成本、失败和回滚信号。
