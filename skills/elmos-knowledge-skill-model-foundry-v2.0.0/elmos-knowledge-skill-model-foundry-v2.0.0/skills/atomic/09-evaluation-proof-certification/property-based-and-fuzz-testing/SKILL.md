...
description: Use this skill when Elmos must perform property based and fuzz testing as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
