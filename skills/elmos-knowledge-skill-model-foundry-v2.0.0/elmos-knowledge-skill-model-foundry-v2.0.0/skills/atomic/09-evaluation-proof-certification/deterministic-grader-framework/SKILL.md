---
name: deterministic-grader-framework
description: Use this skill when Elmos must perform deterministic grader framework as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# deterministic-grader-framework

## 能力目标

优先使用 Schema、编译、测试、静态分析、差分和策略规则评分。
