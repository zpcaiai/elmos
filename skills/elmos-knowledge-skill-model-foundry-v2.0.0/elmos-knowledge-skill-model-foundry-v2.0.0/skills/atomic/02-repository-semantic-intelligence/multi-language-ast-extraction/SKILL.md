...
description: Use this skill when Elmos must perform multi language ast extraction as part of the 02-repository-semantic-intelligence production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
