---
name: query-decomposition-and-rewrite
description: Use this skill when Elmos must perform query decomposition and rewrite as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
