---
name: lost-in-middle-mitigation
description: Use this skill when Elmos must perform lost in middle mitigation as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
通过分段、重排、重复锚点和检索式回读降低长上下文中间信息丢失。
