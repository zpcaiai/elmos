---
name: hybrid-code-knowledge-retrieval
description: Use this skill when Elmos must perform hybrid code knowledge retrieval as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# hybrid-code-knowledge-retrieval

## 能力目标

融合关键词、向量、符号、类型和图关系检索代码与知识。
