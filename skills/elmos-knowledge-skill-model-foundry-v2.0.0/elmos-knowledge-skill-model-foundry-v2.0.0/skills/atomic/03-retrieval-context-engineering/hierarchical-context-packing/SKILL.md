---
name: hierarchical-context-packing
description: Use this skill when Elmos must perform hierarchical context packing as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# hierarchical-context-packing

## 能力目标

按架构摘要、文件摘要、符号和必要源码分层组织上下文。
