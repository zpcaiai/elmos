---
name: stale-and-conflict-arbitration
description: Use this skill when Elmos must perform stale and conflict arbitration as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# stale-and-conflict-arbitration

## 能力目标

识别过期或冲突上下文，按权威度、时间和运行证据裁决。
