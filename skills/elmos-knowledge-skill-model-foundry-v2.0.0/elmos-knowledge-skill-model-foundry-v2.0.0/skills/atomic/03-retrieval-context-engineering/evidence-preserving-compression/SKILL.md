---
name: evidence-preserving-compression
description: Use this skill when Elmos must perform evidence preserving compression as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
