---
name: task-specific-reranking
description: Use this skill when Elmos must perform task specific reranking as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
按任务类型训练并应用代码、文档、错误和 Skill 专用重排器。
