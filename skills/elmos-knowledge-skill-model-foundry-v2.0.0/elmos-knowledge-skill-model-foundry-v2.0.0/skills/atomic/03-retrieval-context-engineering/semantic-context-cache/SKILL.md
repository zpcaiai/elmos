---
name: semantic-context-cache
description: Use this skill when Elmos must perform semantic context cache as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
