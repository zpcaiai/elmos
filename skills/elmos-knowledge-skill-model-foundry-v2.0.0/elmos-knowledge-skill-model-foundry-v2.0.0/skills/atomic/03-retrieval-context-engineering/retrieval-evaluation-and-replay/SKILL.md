---
name: retrieval-evaluation-and-replay
description: Use this skill when Elmos must perform retrieval evaluation and replay as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# retrieval-evaluation-and-replay

## 能力目标

离线重放检索过程并计算 Recall、MRR、引用准确率和有用上下文比。
