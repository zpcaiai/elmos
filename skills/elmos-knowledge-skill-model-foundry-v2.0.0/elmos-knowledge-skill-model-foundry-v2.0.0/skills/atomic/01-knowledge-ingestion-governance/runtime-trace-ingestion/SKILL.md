...
description: Use this skill when Elmos must perform runtime trace ingestion as part of the 01-knowledge-ingestion-governance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
