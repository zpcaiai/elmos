...
description: Use this skill when Elmos must perform data residency aware routing as part of the 01-knowledge-ingestion-governance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
