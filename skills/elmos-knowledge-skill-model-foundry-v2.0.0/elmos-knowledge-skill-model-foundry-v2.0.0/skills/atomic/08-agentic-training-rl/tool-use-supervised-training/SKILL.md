---
name: tool-use-supervised-training
description: Use this skill when Elmos must perform tool use supervised training as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# tool-use-supervised-training

## 能力目标

训练何时读取、搜索、编辑、编译、测试、查询和请求审批。
