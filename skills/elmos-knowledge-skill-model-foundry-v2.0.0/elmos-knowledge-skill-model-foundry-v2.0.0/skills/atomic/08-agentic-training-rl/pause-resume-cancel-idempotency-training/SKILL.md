---
name: pause-resume-cancel-idempotency-training
description: Use this skill when Elmos must perform pause resume cancel idempotency training as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# pause-resume-cancel-idempotency-training

## 能力目标

让 Agent 在中断和重复请求下保持状态一致、无重复副作用。
...
- 必须门：environment-reproducible, reward-non-gameable, terminal-state-verified, safety-constraints；
