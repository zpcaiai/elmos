---
name: tool-selection-and-argument-policy
description: Use this skill when Elmos must perform tool selection and argument policy as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
分别优化工具选择与参数生成，并以 Schema 和权限进行动作约束。
