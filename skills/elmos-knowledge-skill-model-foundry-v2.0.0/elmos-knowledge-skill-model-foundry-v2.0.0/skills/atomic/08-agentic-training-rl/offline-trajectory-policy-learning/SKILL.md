---
name: offline-trajectory-policy-learning
description: Use this skill when Elmos must perform offline trajectory policy learning as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# offline-trajectory-policy-learning

## 能力目标

从已验证历史轨迹学习，避免直接在生产环境探索。
