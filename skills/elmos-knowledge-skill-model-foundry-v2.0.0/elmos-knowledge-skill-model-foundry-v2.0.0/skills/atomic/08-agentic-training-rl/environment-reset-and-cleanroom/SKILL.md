---
name: environment-reset-and-cleanroom
description: Use this skill when Elmos must perform environment reset and cleanroom as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# environment-reset-and-cleanroom

## 能力目标

确保每次 Rollout 从已知状态开始，并检测跨任务状态和答案泄漏。
