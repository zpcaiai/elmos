---
name: shadow-online-learning
description: Use this skill when Elmos must perform shadow online learning as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# shadow-online-learning

## 能力目标

在影子环境收集新分布经验，完成离线认证后再更新生产策略。
