---
name: reward-hacking-and-shortcut-detection
description: Use this skill when Elmos must perform reward hacking and shortcut detection as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
识别删除测试、硬编码答案、扩大权限、绕过验证和污染环境等投机行为。
