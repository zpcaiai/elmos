---
name: multi-objective-reward-contract
description: Use this skill when Elmos must perform multi objective reward contract as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# multi-objective-reward-contract

## 能力目标

组合功能、等价、安全、证据、维护性、最小改动、时间和成本奖励。
