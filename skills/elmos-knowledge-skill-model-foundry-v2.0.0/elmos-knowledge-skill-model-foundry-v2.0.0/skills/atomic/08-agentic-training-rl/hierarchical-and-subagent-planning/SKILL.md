---
name: hierarchical-and-subagent-planning
description: Use this skill when Elmos must perform hierarchical and subagent planning as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# hierarchical-and-subagent-planning

## 能力目标

训练任务分层、子 Agent 委派、结果汇总、冲突处理和预算分配。
