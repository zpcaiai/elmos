---
name: cost-aware-agent-policy
description: Use this skill when Elmos must perform cost aware agent policy as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
把 Token、工具、GPU 和 Wall-clock 预算纳入动作价值与终止决策。
