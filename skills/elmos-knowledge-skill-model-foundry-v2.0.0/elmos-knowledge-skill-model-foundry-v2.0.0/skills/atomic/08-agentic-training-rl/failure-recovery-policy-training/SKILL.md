---
name: failure-recovery-policy-training
description: Use this skill when Elmos must perform failure recovery policy training as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# failure-recovery-policy-training

## 能力目标

训练诊断、回退、缩小范围、修复环境和替代路径选择。
