---
name: task-mutation-and-adversarial-env
description: Use this skill when Elmos must perform task mutation and adversarial env as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# task-mutation-and-adversarial-env

## 能力目标

变异需求、依赖、配置、数据和故障，训练鲁棒性和泛化。
