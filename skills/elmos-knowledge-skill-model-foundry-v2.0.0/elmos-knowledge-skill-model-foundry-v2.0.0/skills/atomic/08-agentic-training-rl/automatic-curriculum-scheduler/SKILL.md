---
name: automatic-curriculum-scheduler
description: Use this skill when Elmos must perform automatic curriculum scheduler as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# automatic-curriculum-scheduler

## 能力目标

按成功率、失败模式、仓库规模和能力依赖动态提升难度。
