---
name: environment-and-answer-leakage-audit
description: Use this skill when Elmos must perform environment and answer leakage audit as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# environment-and-answer-leakage-audit

## 能力目标

检测测试答案、未来提交、缓存、共享工作区和网络造成的评测泄漏。
