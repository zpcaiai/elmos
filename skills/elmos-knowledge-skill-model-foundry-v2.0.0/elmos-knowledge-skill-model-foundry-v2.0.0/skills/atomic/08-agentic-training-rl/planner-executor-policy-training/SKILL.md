---
name: planner-executor-policy-training
description: Use this skill when Elmos must perform planner executor policy training as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# planner-executor-policy-training

## 能力目标

训练计划模型与执行模型分工、重规划条件和证据交接。
