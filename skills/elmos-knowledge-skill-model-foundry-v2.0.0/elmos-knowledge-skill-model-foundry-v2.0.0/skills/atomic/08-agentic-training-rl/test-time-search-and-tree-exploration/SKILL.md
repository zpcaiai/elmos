---
name: test-time-search-and-tree-exploration
description: Use this skill when Elmos must perform test time search and tree exploration as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# test-time-search-and-tree-exploration

## 能力目标

受预算控制地执行分支搜索、回溯和候选修复。
