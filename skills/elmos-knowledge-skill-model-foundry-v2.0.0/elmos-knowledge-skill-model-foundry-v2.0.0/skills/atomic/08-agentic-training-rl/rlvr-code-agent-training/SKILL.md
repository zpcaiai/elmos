---
name: rlvr-code-agent-training
description: Use this skill when Elmos must perform rlvr code agent training as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# rlvr-code-agent-training

## 能力目标

使用可执行测试、差分和证明信号进行可验证奖励强化学习。
