---
name: best-of-n-verifier-selection
description: Use this skill when Elmos must perform best of n verifier selection as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
