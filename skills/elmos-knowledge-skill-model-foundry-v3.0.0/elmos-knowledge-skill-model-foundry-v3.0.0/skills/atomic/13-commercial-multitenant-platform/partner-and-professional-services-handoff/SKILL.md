---
name: partner-and-professional-services-handoff
description: Use this skill when Elmos must perform partner and professional services handoff as part of the 13-commercial-multitenant-platform
...
compatibility: Elmos v3 harness; Commercial Control Plane; policy and evidence services required.
metadata:
  version: 3.0.0
  pack: 13-commercial-multitenant-platform
  priority: P1
  exposure: atomic-registry-only
  business-line: commercial-platform
allowed-tools: tenant.manage entitlement.check wallet.reserve billing.reconcile support.export
---
# partner-and-professional-services-handoff

## 能力目标

把项目规则、知识、Skill、验收和运营责任标准化交接。
...
- 必须门：tenant-isolated, usage-reconciled, contract-respected, supportable；
...
- 业务线：`commercial-platform`；包：`13-commercial-multitenant-platform`。
