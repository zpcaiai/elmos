...
description: Use this skill when Elmos must perform artifact normalization as part of the 01-knowledge-ingestion-governance
...
将不同格式统一为 Artifact IR，保留原始字节、字符位置、页码和源映射。
