---
name: multimodal-artifact-ingestion
description: Use this skill when Elmos must perform multimodal artifact ingestion as part of the 01-knowledge-ingestion-governance
...
解析架构图、流程图、UI 截图、日志截图、音视频说明和代码演示。
