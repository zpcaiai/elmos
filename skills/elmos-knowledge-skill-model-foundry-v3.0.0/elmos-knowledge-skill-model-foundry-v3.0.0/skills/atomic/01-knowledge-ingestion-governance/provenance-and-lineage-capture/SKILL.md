---
name: provenance-and-lineage-capture
description: Use this skill when Elmos must perform provenance and lineage capture as part of the 01-knowledge-ingestion-governance
...
记录来源 URI、提交、作者、解析器、转换步骤、父子对象和派生链。
