...
description: Use this skill when Elmos must perform skill description optimizer as part of the 05-skill-foundry-runtime production
...
使用应触发与不应触发样本优化 description，控制漏触发和误触发。
