---
name: proof-carrying-skill
description: Use this skill when Elmos must perform proof carrying skill as part of the 05-skill-foundry-runtime production
...
要求 Skill 输出可机器验证的证明义务、测试结果、未决风险和回滚信息。
