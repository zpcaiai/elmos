---
name: contract-migration-manager
description: Use this skill when Elmos must perform contract migration manager as part of the 00-foundation-contracts production
...
在契约 Schema 升级时完成向前兼容、双写、迁移验证和安全回滚。
