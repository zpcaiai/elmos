...
description: Use this skill when Elmos must perform capability dependency graph as part of the 00-foundation-contracts production
...
建立能力依赖图并计算循环依赖、爆炸半径、升级影响和最小发布闭包。
