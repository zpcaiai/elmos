...
description: Use this skill when Elmos must perform architecture decision record as part of the 00-foundation-contracts production
...
把关键架构选择、假设、替代方案和退出条件沉淀为可检索 ADR。
