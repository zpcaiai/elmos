---
name: dataset-contract-and-schema
description: Use this skill when Elmos must perform dataset contract and schema as part of the 06-dataset-foundry production
...
定义任务、上下文、轨迹、补丁、证据、奖励、权限和血缘的标准训练样本结构。
