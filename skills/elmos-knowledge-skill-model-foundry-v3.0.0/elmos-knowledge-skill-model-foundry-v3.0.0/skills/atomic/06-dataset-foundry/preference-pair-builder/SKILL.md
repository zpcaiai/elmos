...
description: Use this skill when Elmos must perform preference pair builder as part of the 06-dataset-foundry production workflow,
...
从人工接受、回滚、修复差异和验证证据生成 chosen/rejected 样本对。
