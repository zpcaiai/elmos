...
description: Use this skill when Elmos must perform repo org time split builder as part of the 06-dataset-foundry production
...
按仓库、组织、时间、家族和 Fork 分组切分，避免相似提交跨训练与测试。
