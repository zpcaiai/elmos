...
description: Use this skill when Elmos must perform dataset lineage and provenance as part of the 06-dataset-foundry production
...
记录每个样本来自哪些对象、任务、模型、Skill、人工修改和转换步骤。
