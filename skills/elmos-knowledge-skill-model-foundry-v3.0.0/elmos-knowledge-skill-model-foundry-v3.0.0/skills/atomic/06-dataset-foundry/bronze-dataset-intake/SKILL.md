---
name: bronze-dataset-intake
description: Use this skill when Elmos must perform bronze dataset intake as part of the 06-dataset-foundry production workflow,
...
---
# bronze-dataset-intake

## 能力目标

保存原始轨迹和产物但禁止训练，确保可追溯和可重新处理。
