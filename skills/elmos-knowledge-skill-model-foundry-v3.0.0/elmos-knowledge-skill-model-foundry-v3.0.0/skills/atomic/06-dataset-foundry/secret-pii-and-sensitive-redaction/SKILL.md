---
name: secret-pii-and-sensitive-redaction
description: Use this skill when Elmos must perform secret pii and sensitive redaction as part of the 06-dataset-foundry production
...
metadata:
  ...
  business-line: dataset-foundry
allowed-tools: dataset.build lineage.emit pii.redact license.check eval.freeze
---
# secret-pii-and-sensitive-redaction

## 能力目标

对代码、日志、Prompt、工具结果和补丁执行可验证脱敏并保留替换映射权限。
...
- 业务线：`dataset-foundry`；包：`06-dataset-foundry`。
