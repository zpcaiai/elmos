---
name: sft-dataset-builder
description: Use this skill when Elmos must perform sft dataset builder as part of the 06-dataset-foundry production workflow,
...
构建包含任务、上下文、计划、工具、补丁和验证结果的监督微调数据。
