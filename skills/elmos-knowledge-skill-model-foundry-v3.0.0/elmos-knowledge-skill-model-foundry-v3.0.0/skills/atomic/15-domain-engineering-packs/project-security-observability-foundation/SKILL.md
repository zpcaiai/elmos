...
description: Use this skill when Elmos must perform project security observability foundation as part of the 15-domain-engineering-packs
...
- 业务线：`project-generation`；包：`15-domain-engineering-packs`。
