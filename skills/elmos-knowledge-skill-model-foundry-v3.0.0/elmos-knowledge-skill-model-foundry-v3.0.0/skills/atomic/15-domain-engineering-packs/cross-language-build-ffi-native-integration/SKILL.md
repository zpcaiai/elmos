...
description: Use this skill when Elmos must perform cross language build ffi native integration as part of the 15-domain-engineering-packs
...
- 业务线：`cross-language-conversion`；包：`15-domain-engineering-packs`。
