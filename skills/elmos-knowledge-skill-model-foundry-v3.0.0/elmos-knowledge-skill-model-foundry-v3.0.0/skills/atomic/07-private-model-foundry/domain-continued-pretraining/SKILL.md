---
name: domain-continued-pretraining
description: Use this skill when Elmos must perform domain continued pretraining as part of the 07-private-model-foundry production
...
对稳定、授权、规模足够的领域语料执行 CPT，并监测能力迁移和遗忘。
