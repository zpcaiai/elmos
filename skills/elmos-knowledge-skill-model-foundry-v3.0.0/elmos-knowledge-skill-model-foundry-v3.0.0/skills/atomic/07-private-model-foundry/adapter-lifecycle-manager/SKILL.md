---
name: adapter-lifecycle-manager
description: Use this skill when Elmos must perform adapter lifecycle manager as part of the 07-private-model-foundry production
...
管理 Adapter 训练、依赖、缓存、权限、升级、回滚、撤销和租户归属。
