---
name: bandit-budget-allocation
description: Use this skill when Elmos must perform bandit budget allocation as part of the 16-self-evolution-release-engineering
...
在有限 GPU、Token 和专家时间下分配实验与数据标注预算。
