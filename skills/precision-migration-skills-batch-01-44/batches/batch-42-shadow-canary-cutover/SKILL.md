---
name: batch-42-shadow-canary-cutover
description: 在生产真实输入下通过影子、事件回放、双写验证、灰度、Strangler 和自动回滚安全替换旧系统。
---
...
- 当任务涉及 **production-shadow-run** 时，调用 `skills/production-shadow-run/SKILL.md`。
- 当任务涉及 **live-event-replay** 时，调用 `skills/live-event-replay/SKILL.md`。
- 当任务涉及 **side-effect-suppression** 时，调用 `skills/side-effect-suppression/SKILL.md`。
- 当任务涉及 **dual-write-validation** 时，调用 `skills/dual-write-validation/SKILL.md`。
- 当任务涉及 **canary-traffic-planner** 时，调用 `skills/canary-traffic-planner/SKILL.md`。
- 当任务涉及 **progressive-cutover** 时，调用 `skills/progressive-cutover/SKILL.md`。
- 当任务涉及 **automatic-rollback** 时，调用 `skills/automatic-rollback/SKILL.md`。
- 当任务涉及 **migration-wave-planner** 时，调用 `skills/migration-wave-planner/SKILL.md`。
- 当任务涉及 **strangler-routing** 时，调用 `skills/strangler-routing/SKILL.md`。
- 当任务涉及 **post-cutover-monitoring** 时，调用 `skills/post-cutover-monitoring/SKILL.md`。
