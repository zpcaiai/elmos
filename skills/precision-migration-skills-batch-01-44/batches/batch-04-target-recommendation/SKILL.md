---
name: batch-04-target-recommendation
description: 判断用户指定目标是否真正适合实际应用，并比较目标语言、框架、部署形态和迁移策略的长期收益与风险。
---
...
- 当任务涉及 **target-language-suitability-analysis** 时，调用 `skills/target-language-suitability-analysis/SKILL.md`。
- 当任务涉及 **target-framework-selector** 时，调用 `skills/target-framework-selector/SKILL.md`。
- 当任务涉及 **target-platform-benefit-analysis** 时，调用 `skills/target-platform-benefit-analysis/SKILL.md`。
- 当任务涉及 **migration-alternative-generator** 时，调用 `skills/migration-alternative-generator/SKILL.md`。
- 当任务涉及 **architecture-migration-strategy** 时，调用 `skills/architecture-migration-strategy/SKILL.md`。
- 当任务涉及 **do-not-convert-advisor** 时，调用 `skills/do-not-convert-advisor/SKILL.md`。
- 当任务涉及 **team-capability-fit-analysis** 时，调用 `skills/team-capability-fit-analysis/SKILL.md`。
- 当任务涉及 **migration-business-case** 时，调用 `skills/migration-business-case/SKILL.md`。
