---
name: batch-35-formal-analysis-toolchain
description: 组合 SMT、关系验证、符号/合流执行、抽象解释、TLA+、Alloy 与运行证据，形成分层形式验证体系。
---
...
- 当任务涉及 **smt-translation-validator** 时，调用 `skills/smt-translation-validator/SKILL.md`。
- 当任务涉及 **relational-verification** 时，调用 `skills/relational-verification/SKILL.md`。
- 当任务涉及 **symbolic-execution** 时，调用 `skills/symbolic-execution/SKILL.md`。
- 当任务涉及 **concolic-differential-execution** 时，调用 `skills/concolic-differential-execution/SKILL.md`。
- 当任务涉及 **abstract-interpretation** 时，调用 `skills/abstract-interpretation/SKILL.md`。
- 当任务涉及 **tla-state-machine-generator** 时，调用 `skills/tla-state-machine-generator/SKILL.md`。
- 当任务涉及 **model-checking-runner** 时，调用 `skills/model-checking-runner/SKILL.md`。
- 当任务涉及 **alloy-architecture-validator** 时，调用 `skills/alloy-architecture-validator/SKILL.md`。
- 当任务涉及 **proof-counterexample-to-test** 时，调用 `skills/proof-counterexample-to-test/SKILL.md`。
- 当任务涉及 **formal-runtime-evidence-merger** 时，调用 `skills/formal-runtime-evidence-merger/SKILL.md`。
