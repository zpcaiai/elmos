---
name: model-checking-runner
description: 运行状态空间探索、对称约简、边界配置和反例提取。
---
...
1. 固定语义与定理陈述
2. 执行本 Skill 的核心职责：运行状态空间探索、对称约简、边界配置和反例提取。
3. 生成或编码证明义务
4. 调用Lean/SMT/模型检查
5. 最小化反例并回写测试
6. 由可信内核/求解器签发结果
