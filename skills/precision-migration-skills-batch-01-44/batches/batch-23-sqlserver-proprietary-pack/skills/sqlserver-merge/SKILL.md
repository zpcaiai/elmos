...
description: 迁移 MERGE，并评估并发、重复匹配和目标平台安全替代。
---
...
1. 盘点对象与专有能力
2. 执行本 Skill 的核心职责：迁移 MERGE，并评估并发、重复匹配和目标平台安全替代。
