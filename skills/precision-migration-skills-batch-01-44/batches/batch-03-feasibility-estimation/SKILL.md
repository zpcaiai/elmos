---
name: batch-03-feasibility-estimation
description: 基于项目特征、方向包成熟度、测试资产和代表切片试点，给出有区间、有置信度、可校准的转换预测。
---
...
- 当任务涉及 **conversion-feasibility-estimator** 时，调用 `skills/conversion-feasibility-estimator/SKILL.md`。
- 当任务涉及 **conversion-success-range-estimator** 时，调用 `skills/conversion-success-range-estimator/SKILL.md`。
- 当任务涉及 **estimate-confidence-calibrator** 时，调用 `skills/estimate-confidence-calibrator/SKILL.md`。
- 当任务涉及 **conversion-duration-estimator** 时，调用 `skills/conversion-duration-estimator/SKILL.md`。
- 当任务涉及 **conversion-cost-estimator** 时，调用 `skills/conversion-cost-estimator/SKILL.md`。
- 当任务涉及 **iteration-count-planner** 时，调用 `skills/iteration-count-planner/SKILL.md`。
- 当任务涉及 **manual-effort-estimator** 时，调用 `skills/manual-effort-estimator/SKILL.md`。
- 当任务涉及 **conversion-risk-register** 时，调用 `skills/conversion-risk-register/SKILL.md`。
