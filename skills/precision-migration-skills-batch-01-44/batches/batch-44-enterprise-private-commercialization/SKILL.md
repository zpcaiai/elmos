---
name: batch-44-enterprise-private-commercialization
description: 支持企业内网、完全离线、多租户、SSO、审计、授权、白标、SLA 和客户私有规则包的商业交付。
---
...
- 当任务涉及 **private-deployment-planner** 时，调用 `skills/private-deployment-planner/SKILL.md`。
- 当任务涉及 **air-gapped-installation** 时，调用 `skills/air-gapped-installation/SKILL.md`。
- 当任务涉及 **offline-toolchain-registry** 时，调用 `skills/offline-toolchain-registry/SKILL.md`。
- 当任务涉及 **private-model-gateway** 时，调用 `skills/private-model-gateway/SKILL.md`。
- 当任务涉及 **multi-tenant-isolation** 时，调用 `skills/multi-tenant-isolation/SKILL.md`。
- 当任务涉及 **rbac-and-sso** 时，调用 `skills/rbac-and-sso/SKILL.md`。
- 当任务涉及 **audit-and-compliance** 时，调用 `skills/audit-and-compliance/SKILL.md`。
- 当任务涉及 **license-and-entitlement** 时，调用 `skills/license-and-entitlement/SKILL.md`。
- 当任务涉及 **white-label-partner-mode** 时，调用 `skills/white-label-partner-mode/SKILL.md`。
- 当任务涉及 **enterprise-reporting** 时，调用 `skills/enterprise-reporting/SKILL.md`。
- 当任务涉及 **sla-and-support-readiness** 时，调用 `skills/sla-and-support-readiness/SKILL.md`。
- 当任务涉及 **customer-private-rule-pack** 时，调用 `skills/customer-private-rule-pack/SKILL.md`。
