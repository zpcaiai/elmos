...
## Inspirations
- SQL optimizers
- database EXPLAIN facilities

## Activation conditions
- Activate when the task requires: compare execution plans and representative workload performance; generate index/query fixes when semantics match but performance regresses.
