---
name: schema-metadata-discovery
version: 1.0.0
priority: P0
...
## Objective
Reverse engineer schemas, keys, constraints, indexes, routines, privileges and relationships into a normalized model.

## Inspirations
- SchemaCrawler

## Activation conditions
- Activate when the task requires: reverse engineer schemas, keys, constraints, indexes, routines, privileges and relationships into a normalized model.
