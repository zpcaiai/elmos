...
- Activate when the task requires: represent schema, SQL, routines, transaction semantics, constraints and query behavior in a database Semantic IR for target-aware migration.
