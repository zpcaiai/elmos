...
## Objective
Run source/target databases in shadow/CDC mode and continuously compare data and query results before cutover.
...
- Activate when the task requires: run source/target databases in shadow/CDC mode and continuously compare data and query results before cutover.
