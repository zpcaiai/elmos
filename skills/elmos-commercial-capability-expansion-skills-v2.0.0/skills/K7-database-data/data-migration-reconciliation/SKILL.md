...
- Activate when the task requires: validate row counts, keys, aggregates, referential integrity, sampling hashes and business invariants after data migration.
