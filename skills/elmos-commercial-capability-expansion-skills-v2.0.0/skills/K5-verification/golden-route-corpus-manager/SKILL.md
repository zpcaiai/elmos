...
## Inspirations
- OSS-Fuzz corpus discipline
- benchmark suites

## Activation conditions
- Activate when the task requires: maintain real open/commercial fixtures, expected outputs, adversarial mutations and E0-E5 evidence for each high-value migration route.
