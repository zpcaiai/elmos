...
- Activate when the task requires: generate and continuously run coverage-guided fuzz targets with sanitizer support, crash deduplication and regression corpus promotion.
