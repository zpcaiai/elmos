...
- Activate when the task requires: infer invariants and generators from schemas, types, code and runtime samples, then shrink counterexamples into durable regression tests.
