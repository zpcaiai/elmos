...
- Activate when the task requires: validate generated/modernized UIs on real browser engines and retain DOM/network/console/screenshot traces for failures.
