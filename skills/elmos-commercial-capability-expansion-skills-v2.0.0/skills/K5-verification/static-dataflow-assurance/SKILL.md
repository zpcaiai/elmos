...
- Activate when the task requires: run semantic static analysis, taint/data-flow checks and interprocedural defect detection on changed code and critical paths.
