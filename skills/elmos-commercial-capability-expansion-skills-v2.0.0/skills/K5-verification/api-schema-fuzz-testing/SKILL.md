...
## Objective
Generate adversarial and stateful tests directly from OpenAPI/GraphQL schemas and retain minimized failing examples.

## Inspirations
- Schemathesis

## Activation conditions
- Activate when the task requires: generate adversarial and stateful tests directly from OpenAPI/GraphQL schemas and retain minimized failing examples.
