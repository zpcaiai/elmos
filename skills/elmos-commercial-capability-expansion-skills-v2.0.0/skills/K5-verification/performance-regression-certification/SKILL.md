...
- Activate when the task requires: compare latency, throughput, memory, CPU, allocations, startup and query plans under controlled workloads with explicit budgets.
