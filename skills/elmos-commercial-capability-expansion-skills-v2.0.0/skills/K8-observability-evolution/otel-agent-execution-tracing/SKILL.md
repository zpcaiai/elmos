...
- Activate when the task requires: emit language-neutral traces/metrics/logs for agents, tools, builds, tests, DB/RPC calls and transformation phases with stable semantic attributes.
