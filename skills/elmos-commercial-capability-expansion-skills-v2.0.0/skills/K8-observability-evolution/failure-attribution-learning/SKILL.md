...
- Activate when the task requires: attribute failures to planning, context, rule, skill, model, tool, environment, dependency or verification gaps and propose bounded fixes.
