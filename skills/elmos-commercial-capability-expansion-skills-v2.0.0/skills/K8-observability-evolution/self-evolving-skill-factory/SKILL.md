...
## Inspirations
- AgentEvolver
- Youtu-Agent patterns

## Activation conditions
- Activate when the task requires: mine production trajectories into candidate rules/skills/tests, evaluate offline, canary safely and promote only evidence-backed improvements.
