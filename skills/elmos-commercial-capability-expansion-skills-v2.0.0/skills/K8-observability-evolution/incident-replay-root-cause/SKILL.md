...
- Activate when the task requires: reconstruct failed long tasks from checkpoints, traces, tool results and environment snapshots; identify first causal divergence and repair path.
