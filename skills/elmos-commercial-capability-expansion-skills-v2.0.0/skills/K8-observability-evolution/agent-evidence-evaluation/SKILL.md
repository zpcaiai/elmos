...
- Activate when the task requires: evaluate trajectories, responses, retrieval, tool use and outcomes against versioned datasets and production-grade evaluators.
