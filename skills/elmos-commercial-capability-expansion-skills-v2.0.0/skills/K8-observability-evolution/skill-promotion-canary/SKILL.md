...
- Activate when the task requires: promote new skill/rule/model versions through offline replay, shadow, canary and rollback stages with statistically meaningful comparisons.
