...
- Activate when the task requires: expose repository ownership, readiness, certification status, documentation, migration debt and operational health in a developer portal.
