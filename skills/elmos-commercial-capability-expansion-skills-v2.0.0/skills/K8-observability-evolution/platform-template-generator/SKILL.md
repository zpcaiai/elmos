...
- Activate when the task requires: standardize new project/service generation with organization-approved templates, docs, ownership metadata, CI and certification defaults.
