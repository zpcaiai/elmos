...
## Objective
Use compiler APIs and typed ASTs for transformations where symbol/type correctness dominates textual convenience.
...
- Activate when the task requires: use compiler APIs and typed ASTs for transformations where symbol/type correctness dominates textual convenience.
