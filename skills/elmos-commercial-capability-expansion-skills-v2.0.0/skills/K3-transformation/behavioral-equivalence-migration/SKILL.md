---
name: behavioral-equivalence-migration
version: 1.0.0
priority: P0
...
## Objective
Preserve externally observable behavior while allowing implementation changes, with explicit equivalence contracts and differential evidence.
...
- Activate when the task requires: preserve externally observable behavior while allowing implementation changes, with explicit equivalence contracts and differential evidence.
