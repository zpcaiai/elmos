...
- Activate when the task requires: record why every rule/edit was selected, the source evidence used, assumptions made, validation results and rollback mapping.
