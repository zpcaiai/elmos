...
- Activate when the task requires: convert build definitions and dependency semantics across Maven/Gradle/Bazel/Pants/Buck2/CMake/npm ecosystems with reproducible validation.
