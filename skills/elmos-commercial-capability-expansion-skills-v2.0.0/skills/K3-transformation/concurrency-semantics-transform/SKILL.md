...
- Activate when the task requires: translate locks, atomics, async, actors, threads, memory ordering and cancellation without silently changing concurrency semantics.
