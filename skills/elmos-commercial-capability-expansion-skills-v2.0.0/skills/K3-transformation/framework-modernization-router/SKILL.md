...
- Activate when the task requires: plan and execute staged legacy-framework modernization with adapters, strangler phases, compatibility shims and rollback points.
