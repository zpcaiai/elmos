...
- Activate when the task requires: lift source/framework/database constructs into Semantic IR and lower them to target languages/frameworks with explicit loss and assumption tracking.
