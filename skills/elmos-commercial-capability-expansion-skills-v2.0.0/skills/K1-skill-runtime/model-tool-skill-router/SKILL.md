...
## Objective
Select the lowest-risk/highest-value model, tool, rewrite engine and skill combination using capability, cost, latency and proof requirements.
...
- Activate when the task requires: select the lowest-risk/highest-value model, tool, rewrite engine and skill combination using capability, cost, latency and proof requirements.
