...
- Activate when the task requires: pin skill version, source revision, dependencies, model/tool compatibility and evidence so every run is reproducible and auditable.
