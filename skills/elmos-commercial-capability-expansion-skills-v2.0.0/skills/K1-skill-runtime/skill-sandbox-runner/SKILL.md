...
- Activate when the task requires: execute skill scripts only in policy-constrained sandboxes with CPU/memory/time/network/filesystem/secret limits and complete audit evidence.
