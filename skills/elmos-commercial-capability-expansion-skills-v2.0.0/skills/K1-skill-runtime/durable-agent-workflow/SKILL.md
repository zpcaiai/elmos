...
## Objective
Represent repository transformations as durable workflows with retry, idempotency, pause/resume/cancel, checkpoints and recovery after process failure.

## Inspirations
- Temporal

## Activation conditions
- Activate when the task requires: represent repository transformations as durable workflows with retry, idempotency, pause/resume/cancel, checkpoints and recovery after process failure.
...
## Workflow
1. Resolve task and trust context.
2. Discover compatible skills and enforce policy filters.
3. Load the minimum required instructions/resources.
4. Execute tools/scripts through controlled runners.
5. Persist version/provenance/evidence and update the task state.
