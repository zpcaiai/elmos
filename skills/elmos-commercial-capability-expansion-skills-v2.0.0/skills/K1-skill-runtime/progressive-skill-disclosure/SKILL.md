...
- Activate when the task requires: advertise only compact metadata, load full instructions/resources/scripts on demand, and enforce context-budget-aware unloading.
