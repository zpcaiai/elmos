...
## Inspirations
- Cedar
- SpiceDB-style relationship authorization

## Activation conditions
- Activate when the task requires: enforce principal-action-resource-context authorization for tenant/repo/branch/environment/secret/tool access with schema validation.
