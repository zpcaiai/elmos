...
- Activate when the task requires: broker secret access, redact logs, prevent credential exfiltration, restrict network destinations and produce access evidence.
