...
## Objective
Score change risk from semantic blast radius, criticality, historical failures, runtime hot paths, security boundaries and proof coverage.
...
- Activate when the task requires: score change risk from semantic blast radius, criticality, historical failures, runtime hot paths, security boundaries and proof coverage.
