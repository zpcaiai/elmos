...
- Activate when the task requires: extract dependency and target graphs from Maven/Gradle/Bazel/Pants/Buck2/npm/pnpm/Cargo/Go/.NET/CMake and normalize them into Build IR.
