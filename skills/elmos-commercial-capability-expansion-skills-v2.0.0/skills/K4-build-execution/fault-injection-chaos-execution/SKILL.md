...
- Activate when the task requires: inject latency, process death, network faults, DB failover, duplicate messages and partial outages to validate migration resilience.
