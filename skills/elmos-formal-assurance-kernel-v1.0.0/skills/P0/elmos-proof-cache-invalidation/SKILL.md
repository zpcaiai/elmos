...
> Skill ID: `elmos-proof-cache-invalidation`  
> Priority: **P0**  
> Domain: `core`  
...
- Merkle dependency graph
- selective invalidation

## 6. 必须保持的性质

- cache key 必须包含 formula/semantics/assumptions/engine/options/bound/source/target 哈希
- 证据过期不得命中
- 跨租户缓存只允许去敏且策略批准的公共对象
- 失败和未知结果按短 TTL 缓存
