# Language Semantic Profile

> Skill ID: `elmos-language-semantic-profile`  
> Priority: **P0**  
...
- formal language profiles
- feature capability lattice
- closed-world declarations

## 6. 必须保持的性质

- 所有源码特性必须落入 VERIFIED/BOUNDED/MONITORED/UNSUPPORTED
- Profile 版本进入证据哈希
- 未定义行为必须证明不可达或拒绝
- 目标语义能力不得静默弱化
