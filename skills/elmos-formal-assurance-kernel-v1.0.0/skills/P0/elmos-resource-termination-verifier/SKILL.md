...
> Skill ID: `elmos-resource-termination-verifier`  
> Priority: **P0**  
...
- 用户或 Golden Route 要求对 `project-generation` 产物提供形式化保证。
...
- amortized resource contracts
- bounded loops

## 6. 必须保持的性质

- agent_steps 不超过预算
- repair_attempts 不超过上限
- 递归/循环存在递减度量
- 预留 token/credit 不超过账户限制
