...
- 用户或 Golden Route 要求对 `core` 产物提供形式化保证。
...
- LTL/CTL property fragments
- source-location preserving IR

## 6. 必须保持的性质

- 规格节点必须有稳定 ID、语义版本和来源映射
- 禁止未声明自由变量
- 每个动态边界必须被假设、拒绝或运行时监控覆盖
- 序列化后语义哈希稳定
