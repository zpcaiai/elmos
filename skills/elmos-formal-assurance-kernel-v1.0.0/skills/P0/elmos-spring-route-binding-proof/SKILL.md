...
> Skill ID: `elmos-spring-route-binding-proof`  
> Priority: **P0**  
...
- 用户或 Golden Route 要求对 `spring-modernization` 产物提供形式化保证。
...
- SMT overlap detection
- relational binding verification
- Alloy structure analysis

## 6. 必须保持的性质

- 旧路由全部 mapped/removed/unsupported 分类
- 目标路由无意外冲突
- 优先级与 dispatch 语义保持
- 同一原始请求绑定为等价领域输入
