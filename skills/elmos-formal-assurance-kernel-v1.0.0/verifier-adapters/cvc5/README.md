# cvc5 SMT Solver Adapter

This adapter is an **integration contract**, not a bundled copy of cvc5 SMT Solver. Production enablement requires:
...
Evidence trust: `SOLVER_TRUSTED`. Declared properties: SMT, BITVECTOR, FLOATING_POINT, STRINGS, SETS, PROOFS.
