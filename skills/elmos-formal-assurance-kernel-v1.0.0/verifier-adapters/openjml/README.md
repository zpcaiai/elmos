...
This adapter is an **integration contract**, not a bundled copy of OpenJML. Production enablement requires:
...
Evidence trust: `SOLVER_TRUSTED`. Declared properties: JAVA_JML_ESC, RUNTIME_ASSERTION_CHECKING, CONTRACTS.
