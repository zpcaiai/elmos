...
This adapter is an **integration contract**, not a bundled copy of Frama-C WP. Production enablement requires:
...
Evidence trust: `SOLVER_TRUSTED`. Declared properties: C_ACSL, WEAKEST_PRECONDITION, VALUE_ANALYSIS.
