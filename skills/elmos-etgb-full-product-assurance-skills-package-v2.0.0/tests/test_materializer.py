...
def test_materialized_case_count_and_smokes() -> None:
    ...
    assert summary["total_cases"] >= 75_000
    ...
    assert {c["business_line"] for c in smoke_cases()} == {
        ...
        "identity-access-tenant", "platform-control-plane", "ai-runtime-model-routing",
        "rag-memory-knowledge", "project-intelligence", "billing-entitlements",
        "payment-finance", "online-ide-debug"
    }
