...
description: Verify IDE, CLI, PR, local preview, navigation, repair, review, offline and privacy workflows with real developers.
---

# Skill 1484: b45-developer-experience-certification

## Use this skill when

- Implementing or reviewing **Developer-experience certification** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Developer-experience certification**.
