---
name: b38-airgapped-edition
description: Operate without public network access using signed offline bundles, mirrored dependencies, local identity, offline licensing and delayed evidence export.
---

# Skill 1333: b38-airgapped-edition

## Use this skill when

- Implementing or reviewing **Air-gapped edition** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Air-gapped edition**.
