---
name: b43-public-api-compatibility
description: Detect and govern source, binary, wire, semantic, authorization and operational API compatibility.
---

# Skill 1437: b43-public-api-compatibility

## Use this skill when

- Implementing or reviewing **Public API compatibility** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Public API compatibility**.
