---
name: b39-service-catalog-sli-slo
description: Define owned services, user journeys, indicators, objectives, windows, exclusions, dependencies and alerting policies.
---

# Skill 1348: b39-service-catalog-sli-slo

## Use this skill when

- Implementing or reviewing **Service catalog, SLI and SLO** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Service catalog, SLI and SLO**.
