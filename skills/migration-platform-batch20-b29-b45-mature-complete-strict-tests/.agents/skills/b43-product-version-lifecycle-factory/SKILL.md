---
name: b43-product-version-lifecycle-factory
description: Orchestrate versioning, compatibility, channels, support, deprecation, upgrades, backports and lifecycle evidence.
---

# Skill 1435: b43-product-version-lifecycle-factory

## Use this skill when

- Implementing or reviewing **Product version and lifecycle factory** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Product version and lifecycle factory**.
