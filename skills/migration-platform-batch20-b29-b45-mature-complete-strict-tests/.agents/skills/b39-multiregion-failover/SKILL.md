---
name: b39-multiregion-failover
description: Detect regional failure, route safely, preserve state and verify failback while honoring residency and consistency rules.
---

# Skill 1354: b39-multiregion-failover

## Use this skill when

- Implementing or reviewing **Multi-region failover** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Multi-region failover**.
