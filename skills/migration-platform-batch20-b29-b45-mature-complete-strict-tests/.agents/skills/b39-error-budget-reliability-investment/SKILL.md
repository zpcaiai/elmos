---
name: b39-error-budget-reliability-investment
description: Calculate error budgets and convert burn into release, capacity, resilience and engineering investment decisions.
---

# Skill 1349: b39-error-budget-reliability-investment

## Use this skill when

- Implementing or reviewing **Error budget and reliability investment** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Error budget and reliability investment**.
