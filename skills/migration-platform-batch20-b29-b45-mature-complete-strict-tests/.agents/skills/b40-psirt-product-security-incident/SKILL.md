---
name: b40-psirt-product-security-incident
description: Operate coordinated intake, embargo, investigation, remediation, disclosure and customer notification.
---

# Skill 1388: b40-psirt-product-security-incident

## Use this skill when

- Implementing or reviewing **PSIRT and product-security incident** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **PSIRT and product-security incident**.
