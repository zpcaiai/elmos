---
name: b39-customer-status-incident-communication
description: Publish accurate scoped status, timelines, workarounds, resolution and post-incident communication without exposing tenant data.
---

# Skill 1359: b39-customer-status-incident-communication

## Use this skill when

- Implementing or reviewing **Customer status and incident communication** within Batch 39: 全球SRE与平台运营.
...
- Runbooks and recovery claims must be executed in a bounded environment; documents alone are not evidence.
- Every critical alert, service, incident and recovery action requires an accountable owner.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Customer status and incident communication**.
