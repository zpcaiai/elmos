---
name: b41-project-code-rule-patch-evidence-relationships
description: Link source artifacts, semantic decisions, recipes, patches, tests, approvals, releases and outcomes with stable identifiers.
---

# Skill 1395: b41-project-code-rule-patch-evidence-relationships

## Use this skill when

- Implementing or reviewing **Project, code, rule, patch and evidence relationships** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Project, code, rule, patch and evidence relationships**.
