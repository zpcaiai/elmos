---
name: b42-language-framework-specialist-agent
description: Diagnose and propose route-specific semantic or framework changes under capability and context limits.
---

# Skill 1417: b42-language-framework-specialist-agent

## Use this skill when

- Implementing or reviewing **Language and framework specialist agent** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Language and framework specialist agent**.
