---
name: b43-support-lifecycle-eol-policy
description: Publish support windows, maintenance obligations, security coverage, migration options and end-of-life responsibilities.
---

# Skill 1445: b43-support-lifecycle-eol-policy

## Use this skill when

- Implementing or reviewing **Support lifecycle and EOL policy** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Support lifecycle and EOL policy**.
