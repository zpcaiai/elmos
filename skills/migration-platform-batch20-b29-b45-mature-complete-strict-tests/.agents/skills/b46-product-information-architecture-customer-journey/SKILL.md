---
name: b46-product-information-architecture-customer-journey
description: 将内部Batch/Skill隐藏在Assess、Plan、Migrate、Validate、Release、Operate、Retire客户旅程后。
---

# Skill 1513：产品信息架构与客户任务流
...
将内部Batch/Skill隐藏在Assess、Plan、Migrate、Validate、Release、Operate、Retire客户旅程后。
...
- 客户界面围绕任务而非Batch；所有页面有角色、任务、状态、下一步和证据入口。
