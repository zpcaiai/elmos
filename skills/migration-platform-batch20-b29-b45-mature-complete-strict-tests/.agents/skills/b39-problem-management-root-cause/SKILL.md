---
name: b39-problem-management-root-cause
description: Turn repeated incidents into causal analysis, permanent corrective actions, ownership, verification and knowledge assets.
---

# Skill 1357: b39-problem-management-root-cause

## Use this skill when

- Implementing or reviewing **Problem management and root-cause closure** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Problem management and root-cause closure**.
