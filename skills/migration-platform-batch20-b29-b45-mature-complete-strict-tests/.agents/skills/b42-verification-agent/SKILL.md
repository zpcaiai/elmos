---
name: b42-verification-agent
description: Select and run independent checks, challenge claims and reject insufficient or self-produced evidence.
---

# Skill 1418: b42-verification-agent

## Use this skill when

- Implementing or reviewing **Verification agent** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Verification agent**.
