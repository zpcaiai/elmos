---
name: b38-zero-downtime-rolling-upgrade
description: Execute progressive mixed-version upgrades with readiness checks, traffic draining, data compatibility and automatic halt conditions.
---

# Skill 1344: b38-zero-downtime-rolling-upgrade

## Use this skill when

- Implementing or reviewing **Zero-downtime rolling upgrade** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Zero-downtime rolling upgrade**.
