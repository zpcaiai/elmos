...
description: Build, verify, import, apply and revoke complete offline update bundles with manifests, signatures, SBOM and provenance.
---

# Skill 1343: b38-offline-signed-update-bundle

## Use this skill when

- Implementing or reviewing **Offline signed update bundle** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Offline signed update bundle**.
