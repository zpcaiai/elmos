...
description: Deploy platform services inside a customer-owned VPC while preserving outbound control, workload identity, private connectivity and shared responsibility.
---

# Skill 1330: b38-customer-vpc-edition

## Use this skill when

- Implementing or reviewing **Customer VPC edition** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Customer VPC edition**.
