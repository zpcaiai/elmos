---
name: b41-recipe-mapping-recommendation
description: Recommend certified recipes and mappings using compatibility, context, confidence, evidence and safe abstention.
---

# Skill 1398: b41-recipe-mapping-recommendation

## Use this skill when

- Implementing or reviewing **Recipe and mapping recommendation** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Recipe and mapping recommendation**.
