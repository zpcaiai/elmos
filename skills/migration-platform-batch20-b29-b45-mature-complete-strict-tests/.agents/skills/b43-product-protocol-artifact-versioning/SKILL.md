---
name: b43-product-protocol-artifact-versioning
description: Define independent semantic versions and compatibility rules for product, protocol, schema, artifact and edition.
---

# Skill 1436: b43-product-protocol-artifact-versioning

## Use this skill when

- Implementing or reviewing **Product, protocol and artifact versioning** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Product, protocol and artifact versioning**.
