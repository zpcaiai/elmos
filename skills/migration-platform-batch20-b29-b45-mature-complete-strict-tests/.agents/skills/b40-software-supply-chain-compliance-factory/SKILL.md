---
name: b40-software-supply-chain-compliance-factory
description: Orchestrate secure development, scanning, component identity, signing, provenance, vulnerability response and compliance evidence.
---

# Skill 1369: b40-software-supply-chain-compliance-factory

## Use this skill when

- Implementing or reviewing **Software supply-chain and compliance factory** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Software supply-chain and compliance factory**.
