---
name: b41-migration-knowledge-flywheel-factory
description: Orchestrate knowledge ingestion, ontology, recommendations, prediction, privacy, curation and product feedback.
---

# Skill 1393: b41-migration-knowledge-flywheel-factory

## Use this skill when

- Implementing or reviewing **Migration knowledge-flywheel factory** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Migration knowledge-flywheel factory**.
