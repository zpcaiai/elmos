---
name: b38-workflow-version-coexistence-recovery
description: Keep long-running workflows recoverable across deployment upgrades using version pinning, migration, replay and compensation.
---

# Skill 1340: b38-workflow-version-coexistence-recovery

## Use this skill when

- Implementing or reviewing **Workflow version coexistence and recovery** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Workflow version coexistence and recovery**.
