---
name: b45-semantic-behavior-correctness-certification
description: Combine semantic obligations, tests, differential execution, invariants and residual risk into correctness claims.
---

# Skill 1479: b45-semantic-behavior-correctness-certification

## Use this skill when

- Implementing or reviewing **Semantic and behavioral correctness certification** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Semantic and behavioral correctness certification**.
