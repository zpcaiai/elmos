---
name: b39-chaos-resilience-fault-injection
description: Run bounded failure experiments against dependencies, workers, networks and regions with hypotheses and abort conditions.
---

# Skill 1363: b39-chaos-resilience-fault-injection

## Use this skill when

- Implementing or reviewing **Chaos, resilience and fault injection** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Chaos, resilience and fault injection**.
