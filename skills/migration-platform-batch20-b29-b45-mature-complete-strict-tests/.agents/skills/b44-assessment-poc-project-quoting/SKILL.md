---
name: b44-assessment-poc-project-quoting
description: Produce scope, assumptions, probability-weighted effort, contingency, exclusions and approval for commercial proposals.
---

# Skill 1466: b44-assessment-poc-project-quoting

## Use this skill when

- Implementing or reviewing **Assessment, POC and project quoting** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Assessment, POC and project quoting**.
