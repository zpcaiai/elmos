---
name: b41-knowledge-freshness-decay-versioning
description: Expire or downgrade knowledge as tools, frameworks, policies and evidence change.
---

# Skill 1406: b41-knowledge-freshness-decay-versioning

## Use this skill when

- Implementing or reviewing **Knowledge freshness, decay and versioning** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Knowledge freshness, decay and versioning**.
