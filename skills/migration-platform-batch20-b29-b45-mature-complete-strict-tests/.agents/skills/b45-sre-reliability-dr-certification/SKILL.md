---
name: b45-sre-reliability-dr-certification
description: Verify service ownership, SLO, capacity, incident, backup, restore, failover and support operations.
---

# Skill 1482: b45-sre-reliability-dr-certification

## Use this skill when

- Implementing or reviewing **SRE, reliability and DR certification** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **SRE, reliability and DR certification**.
