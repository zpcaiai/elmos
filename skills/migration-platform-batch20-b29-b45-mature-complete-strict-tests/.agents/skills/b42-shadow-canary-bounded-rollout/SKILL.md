---
name: b42-shadow-canary-bounded-rollout
description: Introduce agents using shadow, suggestion-only, approval-required and limited-autonomy stages with rollback.
---

# Skill 1428: b42-shadow-canary-bounded-rollout

## Use this skill when

- Implementing or reviewing **Shadow, canary and bounded rollout** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Shadow, canary and bounded rollout**.
