---
name: b42-automatic-recipe-candidate-generation
description: Convert repeated repairs into isolated candidate recipes that require sanitization, tests, holdout and approval.
---

# Skill 1431: b42-automatic-recipe-candidate-generation

## Use this skill when

- Implementing or reviewing **Automatic recipe-candidate generation** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Automatic recipe-candidate generation**.
