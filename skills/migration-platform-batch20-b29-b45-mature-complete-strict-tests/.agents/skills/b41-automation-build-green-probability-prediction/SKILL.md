---
name: b41-automation-build-green-probability-prediction
description: Estimate automation and Build Green probability by route, pattern and repository while preventing target leakage.
---

# Skill 1401: b41-automation-build-green-probability-prediction

## Use this skill when

- Implementing or reviewing **Automation and build-green probability prediction** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Automation and build-green probability prediction**.
