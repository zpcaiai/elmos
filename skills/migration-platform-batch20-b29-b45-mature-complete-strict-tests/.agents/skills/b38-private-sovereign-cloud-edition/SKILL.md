...
description: Support private or sovereign infrastructure with residency, local trust, approved services, operator segregation and regulatory boundaries.
---

# Skill 1332: b38-private-sovereign-cloud-edition

## Use this skill when

- Implementing or reviewing **Private and sovereign cloud edition** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Private and sovereign cloud edition**.
