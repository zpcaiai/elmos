---
name: b40-ai-ml-bom-model-provenance
description: Record model, provider, weights, adapters, prompts, evaluations, licenses and deployment identity for AI-assisted workflows.
---

# Skill 1386: b40-ai-ml-bom-model-provenance

## Use this skill when

- Implementing or reviewing **AI/ML BOM and model provenance** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **AI/ML BOM and model provenance**.
