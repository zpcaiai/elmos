---
name: b40-threat-modeling
description: Model assets, trust boundaries, threats, abuse cases, mitigations, residual risks and verification for platform and generated systems.
---

# Skill 1371: b40-threat-modeling

## Use this skill when

- Implementing or reviewing **Threat modeling** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Threat modeling**.
