---
name: b42-agent-team-topology-responsibility
description: Define agent roles, capabilities, inputs, outputs, accountability, handoffs and prohibited self-approval.
---

# Skill 1414: b42-agent-team-topology-responsibility

## Use this skill when

- Implementing or reviewing **Agent-team topology and responsibility** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Agent-team topology and responsibility**.
