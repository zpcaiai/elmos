---
name: b43-full-version-compatibility-test-matrix
description: Continuously test all supported product, runner, SDK, schema, extension and database combinations.
---

# Skill 1452: b43-full-version-compatibility-test-matrix

## Use this skill when

- Implementing or reviewing **Full-version compatibility test matrix** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Full-version compatibility test matrix**.
