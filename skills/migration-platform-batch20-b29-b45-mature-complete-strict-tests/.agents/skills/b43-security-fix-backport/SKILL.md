---
name: b43-security-fix-backport
description: Select, implement, validate and release minimal security fixes to supported branches without feature drift.
---

# Skill 1451: b43-security-fix-backport

## Use this skill when

- Implementing or reviewing **Security-fix backport** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Security-fix backport**.
