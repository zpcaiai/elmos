---
name: b45-language-framework-route-breadth-certification
description: Certify only explicitly tested language, framework, version and provider combinations with published limits.
---

# Skill 1478: b45-language-framework-route-breadth-certification

## Use this skill when

- Implementing or reviewing **Language and framework route-breadth certification** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Language and framework route-breadth certification**.
