---
name: b43-recipe-pack-extension-compatibility
description: Resolve product, SDK, ABI, schema and dependency compatibility for installed migration assets.
---

# Skill 1442: b43-recipe-pack-extension-compatibility

## Use this skill when

- Implementing or reviewing **Recipe, pack and extension compatibility** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Recipe, pack and extension compatibility**.
