---
name: b41-pattern-antipattern-extraction
description: Extract recurring migration patterns and failures with support counts, counterexamples, scope and confidence.
---

# Skill 1397: b41-pattern-antipattern-extraction

## Use this skill when

- Implementing or reviewing **Pattern and anti-pattern extraction** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Pattern and anti-pattern extraction**.
