...
description: Package, install, operate, upgrade and diagnose a customer-operated edition with explicit prerequisites and support bundles.
---

# Skill 1331: b38-self-hosted-edition

## Use this skill when

- Implementing or reviewing **Self-hosted edition** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Self-hosted edition**.
