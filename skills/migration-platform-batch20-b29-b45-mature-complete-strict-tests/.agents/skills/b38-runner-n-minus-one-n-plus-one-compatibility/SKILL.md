---
name: b38-runner-n-minus-one-n-plus-one-compatibility
description: Verify runner and control-plane mixed versions, feature negotiation, lease safety and rollback across N-1, N and N+1.
---

# Skill 1339: b38-runner-n-minus-one-n-plus-one-compatibility

## Use this skill when

- Implementing or reviewing **Runner N-1 N N+1 compatibility** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Runner N-1 N N+1 compatibility**.
