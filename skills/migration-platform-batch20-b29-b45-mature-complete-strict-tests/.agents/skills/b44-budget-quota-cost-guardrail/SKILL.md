---
name: b44-budget-quota-cost-guardrail
description: Enforce tenant and workflow budgets, anomaly stops and approvals without corrupting active migrations.
---

# Skill 1468: b44-budget-quota-cost-guardrail

## Use this skill when

- Implementing or reviewing **Budget, quota and cost guardrail** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Budget, quota and cost guardrail**.
