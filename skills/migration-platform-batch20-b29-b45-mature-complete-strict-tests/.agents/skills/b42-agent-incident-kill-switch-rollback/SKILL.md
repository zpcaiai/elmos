---
name: b42-agent-incident-kill-switch-rollback
description: Detect harmful behavior, revoke tools/models, stop workflows, roll back changes and preserve forensic evidence.
---

# Skill 1430: b42-agent-incident-kill-switch-rollback

## Use this skill when

- Implementing or reviewing **Agent incident, kill switch and rollback** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Agent incident, kill switch and rollback**.
