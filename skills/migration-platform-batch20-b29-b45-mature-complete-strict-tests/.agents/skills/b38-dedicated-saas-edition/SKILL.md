...
description: Implement provider-operated dedicated environments with per-customer isolation, lifecycle, observability, backup, support and cost ownership.
---

# Skill 1329: b38-dedicated-saas-edition

## Use this skill when

- Implementing or reviewing **Dedicated SaaS edition** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Dedicated SaaS edition**.
