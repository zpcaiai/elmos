---
name: b35-query-data-equivalence
description: Implement query transformation and data-pipeline equivalence checks using bounded datasets relational properties canonical results and execution-plan evidence.
---
...
## Skill 1279: b35-query-data-equivalence

## Use this skill when

- Queries or data transformations changed language, database, ORM, or execution engine.

## Domain-specific risks and invariants

- Matching row counts can hide ordering, null, precision, or relationship errors.

## Workflow

1. Parse queries and transformations into typed canonical forms.
2. Generate bounded valid/adversarial datasets respecting constraints.
3. Run source and target with exact collation, timezone, precision, and isolation.
4. Compare detailed ordered/unordered results, errors, side effects, and plans.
5. Use relational properties and metamorphic transformations.
6. Minimize differing datasets and preserve plans.
...
- Verify SQL, ORM, ETL, aggregation, ordering, null, collation, precision, window, and incremental semantics.
...
- Query specs, generated datasets, source-target results, plan comparisons, data differences, and regression cases.
