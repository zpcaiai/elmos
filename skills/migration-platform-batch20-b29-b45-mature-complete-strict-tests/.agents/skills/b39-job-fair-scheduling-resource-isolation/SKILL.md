---
name: b39-job-fair-scheduling-resource-isolation
description: Enforce fair scheduling, quotas, priority, starvation prevention and noisy-neighbor isolation for migration workloads.
---

# Skill 1352: b39-job-fair-scheduling-resource-isolation

## Use this skill when

- Implementing or reviewing **Job fairness and resource isolation** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Job fairness and resource isolation**.
