...
description: Provide active-active routing, replicated state, conflict policy, regional failover and tested recovery without cross-tenant or residency violations.
---

# Skill 1335: b38-multiregion-active-active-edition

## Use this skill when

- Implementing or reviewing **Multi-region active-active edition** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Multi-region active-active edition**.
