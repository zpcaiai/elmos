---
name: b45-mature-product-certification-factory
description: Orchestrate independent evidence, design partners, risk acceptance and release decisions across every maturity dimension.
---

# Skill 1475: b45-mature-product-certification-factory

## Use this skill when

- Implementing or reviewing **Mature-product certification factory** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Mature-product certification factory**.
