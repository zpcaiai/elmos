...
description: Assess installed versions, extensions, data, customizations, resources, blockers, rollback and support readiness.
---

# Skill 1447: b43-customer-upgrade-readiness

## Use this skill when

- Implementing or reviewing **Customer upgrade readiness** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Customer upgrade readiness**.
