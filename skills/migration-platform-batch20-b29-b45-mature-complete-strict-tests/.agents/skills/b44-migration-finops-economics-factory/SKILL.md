---
name: b44-migration-finops-economics-factory
description: Orchestrate trusted usage, cost allocation, unit economics, pricing, margin, forecasting, billing and customer value.
---

# Skill 1455: b44-migration-finops-economics-factory

## Use this skill when

- Implementing or reviewing **Migration FinOps and economics factory** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Migration FinOps and economics factory**.
