---
name: b43-deprecation-removal-process
description: Identify use, notify owners, provide replacement, measure adoption and block removal until exit criteria pass.
---

# Skill 1446: b43-deprecation-removal-process

## Use this skill when

- Implementing or reviewing **Deprecation and removal process** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Deprecation and removal process**.
