---
name: b35-metamorphic-testing
description: Implement metamorphic relations and transformations for workloads where exact expected outputs are unavailable but stable business relationships must hold across source and target systems.
---
...
## Skill 1268: b35-metamorphic-testing

## Use this skill when

- Exact expected outputs are unavailable but stable relations are known.

## Domain-specific risks and invariants

- A false metamorphic relation can certify wrong behavior.

## Workflow

1. Identify business-approved input transformations and expected output relations.
2. Specify preconditions, transformation, relation, non-applicable cases, and oracle.
3. Generate transformed source and target runs with fixed state.
4. Compare relation satisfaction, not only direct output equality.
5. Shrink failing transformation pairs.
6. Require domain-owner approval for critical relations.
...
- Define approved input transformations and expected output relations for APIs, calculations, queries, workflows, files, and state machines.
...
- Metamorphic relation specs, transformed cases, relation results, minimal failures, and evidence.
