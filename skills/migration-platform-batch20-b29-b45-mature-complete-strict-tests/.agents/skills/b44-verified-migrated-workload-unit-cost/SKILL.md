---
name: b44-verified-migrated-workload-unit-cost
description: Calculate cost per Build Green, behavior-verified, accepted workload with quality and rework included.
---

# Skill 1459: b44-verified-migrated-workload-unit-cost

## Use this skill when

- Implementing or reviewing **Verified Migrated Workload unit cost** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Verified Migrated Workload unit cost**.
