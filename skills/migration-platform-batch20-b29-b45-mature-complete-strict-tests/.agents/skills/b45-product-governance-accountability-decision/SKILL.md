---
name: b45-product-governance-accountability-decision
description: Define accountable executives, product, engineering, security, operations, finance and customer decision rights.
---

# Skill 1492: b45-product-governance-accountability-decision

## Use this skill when

- Implementing or reviewing **Product governance, accountability and decision** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Product governance, accountability and decision**.
