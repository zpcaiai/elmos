---
name: b40-security-architecture-review
description: Review identity, authorization, tenancy, data flow, cryptography, execution, supply chain and operational design before release.
---

# Skill 1372: b40-security-architecture-review

## Use this skill when

- Implementing or reviewing **Security architecture review** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Security architecture review**.
