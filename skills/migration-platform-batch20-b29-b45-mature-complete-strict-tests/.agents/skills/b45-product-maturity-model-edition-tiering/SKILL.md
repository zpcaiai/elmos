---
name: b45-product-maturity-model-edition-tiering
description: Define objective maturity levels and edition claims with required capabilities, evidence, support and prohibited marketing claims.
---

# Skill 1476: b45-product-maturity-model-edition-tiering

## Use this skill when

- Implementing or reviewing **Product maturity model and edition tiering** within Batch 45: 成熟产品综合认证.
...
- Agents cannot become the accountable approver, expand their own tool permissions or use generated prose as authoritative evidence.
- Unknown, policy-denied or budget-exhausted actions must stop safely and escalate.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Product maturity model and edition tiering**.
