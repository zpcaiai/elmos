---
name: b43-lts-stable-preview-experimental-channels
description: Define promotion, support, telemetry, opt-in, rollback and evidence rules for release channels.
---

# Skill 1444: b43-lts-stable-preview-experimental-channels

## Use this skill when

- Implementing or reviewing **LTS, stable, preview and experimental channels** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **LTS, stable, preview and experimental channels**.
