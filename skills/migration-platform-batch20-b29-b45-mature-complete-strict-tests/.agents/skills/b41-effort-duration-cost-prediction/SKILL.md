---
name: b41-effort-duration-cost-prediction
description: Forecast engineering effort, queue time, runtime and cost using actual outcomes and uncertainty intervals.
---

# Skill 1402: b41-effort-duration-cost-prediction

## Use this skill when

- Implementing or reviewing **Effort, duration and cost prediction** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Effort, duration and cost prediction**.
