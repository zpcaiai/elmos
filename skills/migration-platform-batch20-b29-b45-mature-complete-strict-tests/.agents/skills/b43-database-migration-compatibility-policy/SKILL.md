---
name: b43-database-migration-compatibility-policy
description: Govern schema migrations, mixed application versions, backfill, rollback and irreversible changes.
---

# Skill 1443: b43-database-migration-compatibility-policy

## Use this skill when

- Implementing or reviewing **Database migration compatibility policy** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Database migration compatibility policy**.
