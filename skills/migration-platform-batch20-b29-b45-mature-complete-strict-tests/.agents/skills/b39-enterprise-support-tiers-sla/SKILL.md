---
name: b39-enterprise-support-tiers-sla
description: Implement support tiers, intake, severity, routing, entitlement, response/resolution targets and escalation boundaries.
---

# Skill 1360: b39-enterprise-support-tiers-sla

## Use this skill when

- Implementing or reviewing **Enterprise support tiers and SLA** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Enterprise support tiers and SLA**.
