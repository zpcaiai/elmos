---
name: b40-secure-code-review-sensitive-change
description: Require specialist review and separation of duties for security, policy, signing, billing and tenant-boundary changes.
---

# Skill 1373: b40-secure-code-review-sensitive-change

## Use this skill when

- Implementing or reviewing **Secure code review and sensitive change approval** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Secure code review and sensitive change approval**.
