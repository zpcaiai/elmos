---
name: b40-artifact-container-signing
description: Sign, verify, rotate and revoke artifacts and images with protected identities and transparency evidence.
---

# Skill 1382: b40-artifact-container-signing

## Use this skill when

- Implementing or reviewing **Artifact and container signing** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Artifact and container signing**.
