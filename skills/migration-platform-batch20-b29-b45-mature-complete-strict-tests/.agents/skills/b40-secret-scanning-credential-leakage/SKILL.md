---
name: b40-secret-scanning-credential-leakage
description: Prevent, detect, revoke and investigate source, artifact, log, prompt and configuration credential leakage.
---

# Skill 1377: b40-secret-scanning-credential-leakage

## Use this skill when

- Implementing or reviewing **Secret scanning and credential leakage** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Secret scanning and credential leakage**.
