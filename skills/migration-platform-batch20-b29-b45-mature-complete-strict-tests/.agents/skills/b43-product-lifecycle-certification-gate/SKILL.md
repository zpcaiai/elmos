---
name: b43-product-lifecycle-certification-gate
description: Certify a release line only when compatibility, upgrade, rollback, support and documentation evidence are complete.
---

# Skill 1454: b43-product-lifecycle-certification-gate

## Use this skill when

- Implementing or reviewing **Product-lifecycle certification gate** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Product-lifecycle certification gate**.
