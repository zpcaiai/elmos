---
name: b40-runner-update-supply-chain-security
description: Secure runner images, enrollment, updates, mirrors, rollback and revocation against substitution and downgrade attacks.
---

# Skill 1385: b40-runner-update-supply-chain-security

## Use this skill when

- Implementing or reviewing **Runner and update supply-chain security** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Runner and update supply-chain security**.
