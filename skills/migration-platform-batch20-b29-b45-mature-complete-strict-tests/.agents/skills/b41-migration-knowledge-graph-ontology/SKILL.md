---
name: b41-migration-knowledge-graph-ontology
description: Define versioned entities, relations, constraints and ownership for code, contracts, rules, evidence, projects and outcomes.
---

# Skill 1394: b41-migration-knowledge-graph-ontology

## Use this skill when

- Implementing or reviewing **Migration knowledge-graph ontology** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Migration knowledge-graph ontology**.
