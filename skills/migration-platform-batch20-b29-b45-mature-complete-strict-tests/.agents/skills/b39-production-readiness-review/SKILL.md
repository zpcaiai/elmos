---
name: b39-production-readiness-review
description: Gate new services and major changes on ownership, SLO, capacity, security, observability, support and recovery evidence.
---

# Skill 1364: b39-production-readiness-review

## Use this skill when

- Implementing or reviewing **Production readiness review** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Production readiness review**.
