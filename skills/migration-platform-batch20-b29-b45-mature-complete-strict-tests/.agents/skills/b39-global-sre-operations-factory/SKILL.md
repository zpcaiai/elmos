---
name: b39-global-sre-operations-factory
description: Orchestrate service catalog, SLOs, on-call, incident response, capacity, DR, support and operational evidence across editions and regions.
---

# Skill 1347: b39-global-sre-operations-factory

## Use this skill when

- Implementing or reviewing **Global SRE and operations factory** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Global SRE and operations factory**.
