---
name: b42-human-approval-takeover
description: Provide review, pause, edit, cancel, override, takeover and accountable approval for high-impact actions.
---

# Skill 1421: b42-human-approval-takeover

## Use this skill when

- Implementing or reviewing **Human approval and takeover** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Human approval and takeover**.
