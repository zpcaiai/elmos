...
description: Upgrade transformation packs and extensions with compatibility tests, configuration/state migration, canary and rollback.
---

# Skill 1342: b38-recipe-pack-extension-upgrade

## Use this skill when

- Implementing or reviewing **Recipe, pack and extension upgrade** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Recipe, pack and extension upgrade**.
