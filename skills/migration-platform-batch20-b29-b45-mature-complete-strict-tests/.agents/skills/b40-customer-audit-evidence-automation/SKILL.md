---
name: b40-customer-audit-evidence-automation
description: Generate scoped, fresh and access-controlled evidence packages for questionnaires, audits and assurance requests.
---

# Skill 1390: b40-customer-audit-evidence-automation

## Use this skill when

- Implementing or reviewing **Customer audit evidence automation** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Customer audit evidence automation**.
