---
name: b41-diagnostic-root-cause-recommendation
description: Rank root causes and repair loci from diagnostics, source maps, history and validated outcomes.
---

# Skill 1404: b41-diagnostic-root-cause-recommendation

## Use this skill when

- Implementing or reviewing **Diagnostic root-cause recommendation** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Diagnostic root-cause recommendation**.
