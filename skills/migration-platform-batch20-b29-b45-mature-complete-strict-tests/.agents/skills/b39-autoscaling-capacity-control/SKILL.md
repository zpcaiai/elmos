---
name: b39-autoscaling-capacity-control
description: Forecast and scale control-plane, runner, storage and database capacity with safe ceilings and overload shedding.
---

# Skill 1353: b39-autoscaling-capacity-control

## Use this skill when

- Implementing or reviewing **Autoscaling and capacity control** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Autoscaling and capacity control**.
