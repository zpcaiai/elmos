---
name: b39-operational-evidence-customer-report
description: Generate reviewable service, incident, capacity, security, recovery and SLA reports for customers and auditors.
---

# Skill 1367: b39-operational-evidence-customer-report

## Use this skill when

- Implementing or reviewing **Operational evidence and customer report** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Operational evidence and customer report**.
