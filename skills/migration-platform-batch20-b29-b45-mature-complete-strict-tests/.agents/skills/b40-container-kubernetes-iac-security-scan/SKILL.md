---
name: b40-container-kubernetes-iac-security-scan
description: Validate images, manifests, policies and infrastructure configuration before promotion and against live drift.
---

# Skill 1378: b40-container-kubernetes-iac-security-scan

## Use this skill when

- Implementing or reviewing **Container, Kubernetes and IaC security scanning** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Container, Kubernetes and IaC security scanning**.
