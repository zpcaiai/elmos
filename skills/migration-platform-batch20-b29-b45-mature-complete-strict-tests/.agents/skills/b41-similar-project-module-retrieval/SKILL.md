---
name: b41-similar-project-module-retrieval
description: Retrieve comparable modules and projects without leaking customer-private code or misleading on superficial similarity.
---

# Skill 1399: b41-similar-project-module-retrieval

## Use this skill when

- Implementing or reviewing **Similar project and module retrieval** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Similar project and module retrieval**.
