---
name: b42-agent-autonomy-level-promotion-demotion
description: Promote or demote autonomy from evidence, risk and drift rather than manual optimism.
---

# Skill 1432: b42-agent-autonomy-level-promotion-demotion

## Use this skill when

- Implementing or reviewing **Agent autonomy-level promotion and demotion** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Agent autonomy-level promotion and demotion**.
