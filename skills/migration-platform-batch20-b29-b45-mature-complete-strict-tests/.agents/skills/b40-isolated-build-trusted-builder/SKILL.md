---
name: b40-isolated-build-trusted-builder
description: Run hermetic or isolated builds on attested builders with controlled inputs, network and secrets.
---

# Skill 1384: b40-isolated-build-trusted-builder

## Use this skill when

- Implementing or reviewing **Isolated build and trusted builder** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Isolated build and trusted builder**.
