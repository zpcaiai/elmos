---
name: b41-knowledge-flywheel-certification-gate
description: Certify recommendations and learning only when provenance, isolation, calibration, holdout and curation evidence pass.
---

# Skill 1412: b41-knowledge-flywheel-certification-gate

## Use this skill when

- Implementing or reviewing **Knowledge-flywheel certification gate** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Knowledge-flywheel certification gate**.
