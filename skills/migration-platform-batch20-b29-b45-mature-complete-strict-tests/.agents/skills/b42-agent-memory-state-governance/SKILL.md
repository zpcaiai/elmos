---
name: b42-agent-memory-state-governance
description: Separate ephemeral, workflow, project and long-term memory with retention, isolation, correction and deletion.
---

# Skill 1424: b42-agent-memory-state-governance

## Use this skill when

- Implementing or reviewing **Agent memory and state governance** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Agent memory and state governance**.
