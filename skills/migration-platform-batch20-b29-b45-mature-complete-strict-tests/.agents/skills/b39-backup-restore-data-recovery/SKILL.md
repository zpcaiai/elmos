---
name: b39-backup-restore-data-recovery
description: Create immutable backups, validate restore, manage keys and prove RPO/RTO for control, metadata, artifacts and evidence.
---

# Skill 1355: b39-backup-restore-data-recovery

## Use this skill when

- Implementing or reviewing **Backup, restore and data recovery** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Backup, restore and data recovery**.
