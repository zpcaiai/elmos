---
name: b44-human-review-expert-cost
description: Capture actual review, escalation, conflict resolution, support and domain-expert effort.
---

# Skill 1463: b44-human-review-expert-cost

## Use this skill when

- Implementing or reviewing **Human review and expert cost** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Human review and expert cost**.
