---
name: b45-hyperscale-performance-certification
description: Verify million-line, thousand-repository, multi-tenant and regional workloads against SLO and cost targets.
---

# Skill 1480: b45-hyperscale-performance-certification

## Use this skill when

- Implementing or reviewing **Hyperscale and performance certification** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Hyperscale and performance certification**.
