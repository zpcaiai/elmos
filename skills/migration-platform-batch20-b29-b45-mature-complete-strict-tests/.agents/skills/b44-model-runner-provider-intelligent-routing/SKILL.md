---
name: b44-model-runner-provider-intelligent-routing
description: Select resources by capability, policy, SLO, locality and expected total cost rather than unit price alone.
---

# Skill 1470: b44-model-runner-provider-intelligent-routing

## Use this skill when

- Implementing or reviewing **Model, runner and provider intelligent routing** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Model, runner and provider intelligent routing**.
