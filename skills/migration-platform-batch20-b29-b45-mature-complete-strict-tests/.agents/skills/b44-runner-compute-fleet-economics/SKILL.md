---
name: b44-runner-compute-fleet-economics
description: Optimize fleet mix, utilization, queue time, reserved capacity, regions and isolation without lowering gates.
---

# Skill 1460: b44-runner-compute-fleet-economics

## Use this skill when

- Implementing or reviewing **Runner compute and fleet economics** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Runner compute and fleet economics**.
