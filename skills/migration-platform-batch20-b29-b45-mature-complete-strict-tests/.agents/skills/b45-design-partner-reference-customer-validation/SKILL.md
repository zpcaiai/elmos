---
name: b45-design-partner-reference-customer-validation
description: Require independent real-customer journeys, acceptance, production evidence and permission for reference claims.
---

# Skill 1489: b45-design-partner-reference-customer-validation

## Use this skill when

- Implementing or reviewing **Design-partner and reference-customer validation** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Design-partner and reference-customer validation**.
