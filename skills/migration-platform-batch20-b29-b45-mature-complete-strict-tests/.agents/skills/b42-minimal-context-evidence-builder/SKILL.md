---
name: b42-minimal-context-evidence-builder
description: Assemble the smallest sufficient context and trusted evidence while protecting tenant data and preventing prompt injection.
---

# Skill 1423: b42-minimal-context-evidence-builder

## Use this skill when

- Implementing or reviewing **Minimal context and evidence builder** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Minimal context and evidence builder**.
