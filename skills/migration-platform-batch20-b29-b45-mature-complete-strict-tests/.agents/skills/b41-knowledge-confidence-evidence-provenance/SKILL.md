---
name: b41-knowledge-confidence-evidence-provenance
description: Attach source, owner, freshness, confidence, scope, lineage and validation status to every reusable knowledge item.
---

# Skill 1405: b41-knowledge-confidence-evidence-provenance

## Use this skill when

- Implementing or reviewing **Knowledge confidence, evidence and provenance** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Knowledge confidence, evidence and provenance**.
