---
name: b40-sbom-component-identity
description: Generate stable component identities and complete SBOMs for source, binary, container, extension and model artifacts.
---

# Skill 1379: b40-sbom-component-identity

## Use this skill when

- Implementing or reviewing **SBOM and component identity** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **SBOM and component identity**.
