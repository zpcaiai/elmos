...
description: Orchestrate all deployment editions, topology contracts, mixed-version compatibility, upgrade, rollback, offline update and certification evidence.
---

# Skill 1325: b38-enterprise-deployment-upgrade-factory

## Use this skill when

- Implementing or reviewing **Enterprise deployment and upgrade factory** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Enterprise deployment and upgrade factory**.
