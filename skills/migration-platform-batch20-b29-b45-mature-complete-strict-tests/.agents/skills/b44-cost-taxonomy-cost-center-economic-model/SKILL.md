---
name: b44-cost-taxonomy-cost-center-economic-model
description: Define direct, shared, fixed, variable, capitalized and service costs by tenant, project, route, edition and workload.
---

# Skill 1456: b44-cost-taxonomy-cost-center-economic-model

## Use this skill when

- Implementing or reviewing **Cost taxonomy, cost center and economic model** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Cost taxonomy, cost center and economic model**.
