---
name: b42-mature-agent-migration-factory
description: Orchestrate planner, deterministic executor, specialists, verifier, policy, supervisor and human control as one governed system.
---

# Skill 1413: b42-mature-agent-migration-factory

## Use this skill when

- Implementing or reviewing **Mature agent migration factory** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Mature agent migration factory**.
