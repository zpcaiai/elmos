---
name: b43-feature-flag-progressive-enablement
description: Introduce behavior by tenant, cohort, edition and version with ownership, expiry, telemetry and rollback.
---

# Skill 1449: b43-feature-flag-progressive-enablement

## Use this skill when

- Implementing or reviewing **Feature flag and progressive enablement** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Feature flag and progressive enablement**.
