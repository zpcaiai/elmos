---
name: b38-edge-plant-restricted-network-edition
description: Run in plants or constrained networks with intermittent connectivity, bounded local autonomy, hardware/resource profiles and safe synchronization.
---

# Skill 1334: b38-edge-plant-restricted-network-edition

## Use this skill when

- Implementing or reviewing **Edge plant and restricted-network edition** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Edge plant and restricted-network edition**.
