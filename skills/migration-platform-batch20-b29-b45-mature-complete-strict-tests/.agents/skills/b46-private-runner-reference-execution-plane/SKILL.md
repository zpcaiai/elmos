---
name: b46-private-runner-reference-execution-plane
description: 实现安全Enrollment、Attestation、短期身份、Lease、Sandbox、Egress、Secret、Build/Test、Evidence和Cleanup。
---

# Skill 1517：Private Runner参考执行面
...
实现安全Enrollment、Attestation、短期身份、Lease、Sandbox、Egress、Secret、Build/Test、Evidence和Cleanup。
...
- Source默认留在客户网络；Runner使用短期身份、临时Workspace、默认拒绝Egress和可验证清理。
...
- `runners/private-runner/`
- `services/control-plane/runner-control/`
- `contracts/runner/`
