---
name: b43-psp-uir-schema-compatibility
description: Evolve semantic contracts with readers, writers, migrations, validation and lossless round-trip tests.
---

# Skill 1441: b43-psp-uir-schema-compatibility

## Use this skill when

- Implementing or reviewing **PSP and UIR schema compatibility** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **PSP and UIR schema compatibility**.
