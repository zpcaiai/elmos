---
name: b39-customer-sla-service-credit
description: Measure contractual availability, exclusions, credits, approval and financial reconciliation from trusted service data.
---

# Skill 1365: b39-customer-sla-service-credit

## Use this skill when

- Implementing or reviewing **Customer SLA and service credit** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Customer SLA and service credit**.
