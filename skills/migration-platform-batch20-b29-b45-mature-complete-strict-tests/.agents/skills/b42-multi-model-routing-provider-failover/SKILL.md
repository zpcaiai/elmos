---
name: b42-multi-model-routing-provider-failover
description: Route requests by capability, policy, residency, cost and risk with tested failover and output normalization.
---

# Skill 1425: b42-multi-model-routing-provider-failover

## Use this skill when

- Implementing or reviewing **Multi-model routing and provider failover** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Multi-model routing and provider failover**.
