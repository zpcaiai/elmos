---
name: b39-periodic-restore-dr-exercise
description: Schedule and execute restore, regional failover and business-continuity exercises with evidence and remediation.
---

# Skill 1366: b39-periodic-restore-dr-exercise

## Use this skill when

- Implementing or reviewing **Periodic restore and DR exercise** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Periodic restore and DR exercise**.
