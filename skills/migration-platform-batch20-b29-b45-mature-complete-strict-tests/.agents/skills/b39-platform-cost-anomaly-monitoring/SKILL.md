---
name: b39-platform-cost-anomaly-monitoring
description: Detect abnormal runner, model, storage, network and observability spend and correlate it with tenants and releases.
---

# Skill 1362: b39-platform-cost-anomaly-monitoring

## Use this skill when

- Implementing or reviewing **Platform cost and anomaly monitoring** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Platform cost and anomaly monitoring**.
