---
name: b44-customer-roi-tco-value-model
description: Estimate customer migration value, avoided cost, risk reduction and time-to-value with transparent assumptions.
---

# Skill 1472: b44-customer-roi-tco-value-model

## Use this skill when

- Implementing or reviewing **Customer ROI, TCO and value model** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Customer ROI, TCO and value model**.
