---
name: b43-sdk-compatibility
description: Maintain supported SDK versions, generated clients, behavior contracts, migration tools and deprecation windows.
---

# Skill 1439: b43-sdk-compatibility

## Use this skill when

- Implementing or reviewing **SDK compatibility** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **SDK compatibility**.
