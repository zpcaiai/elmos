---
name: b35-oracle-governance-conflict-resolution
description: Govern oracle identity trust independence precedence disagreement adjudication versioning and approval for advanced migration verification.
---
...
## Skill 1282: b35-oracle-governance-conflict-resolution

## Use this skill when

- Multiple verification methods or stakeholders disagree about expected behavior.

## Domain-specific risks and invariants

- Golden, source behavior, tests, business rules, solver, and LLM judgments may conflict.

## Workflow

1. Register every oracle with owner, type, independence, scope, trust, version, and evidence.
2. Detect disagreements and circular dependencies.
3. Apply documented precedence by claim type and risk.
4. Require business/security/data adjudication for critical conflicts.
5. Version decisions and rerun affected verification.
6. Audit all oracle changes and prohibit target-driven rebaseline.
...
- Prevent test, model, source behavior, business rule, solver, and LLM judgments from silently contradicting or overwriting one another.
...
- Oracle registry, conflict records, adjudication decisions, owner approvals, confidence, and audit evidence.
