---
name: b42-mature-agent-certification-gate
description: Certify agent autonomy only when evaluations, security, policy, canary, incident and human-control evidence pass.
---

# Skill 1434: b42-mature-agent-certification-gate

## Use this skill when

- Implementing or reviewing **Mature-agent certification gate** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Mature-agent certification gate**.
