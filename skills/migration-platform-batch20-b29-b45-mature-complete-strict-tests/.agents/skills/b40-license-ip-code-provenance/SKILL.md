---
name: b40-license-ip-code-provenance
description: Track code origin, license obligations, generated code, training inputs and customer-specific assets without contamination.
---

# Skill 1381: b40-license-ip-code-provenance

## Use this skill when

- Implementing or reviewing **License, IP and code provenance** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **License, IP and code provenance**.
