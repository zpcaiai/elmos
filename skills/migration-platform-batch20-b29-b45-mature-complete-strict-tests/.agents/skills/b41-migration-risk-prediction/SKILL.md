---
name: b41-migration-risk-prediction
description: Predict semantic, framework, data, security, delivery and operational risk with calibrated uncertainty and explanations.
---

# Skill 1400: b41-migration-risk-prediction

## Use this skill when

- Implementing or reviewing **Migration risk prediction** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Migration risk prediction**.
