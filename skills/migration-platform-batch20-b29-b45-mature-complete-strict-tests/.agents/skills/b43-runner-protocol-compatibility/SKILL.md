---
name: b43-runner-protocol-compatibility
description: Negotiate runner capabilities and preserve job, lease, artifact and policy safety across versions.
---

# Skill 1440: b43-runner-protocol-compatibility

## Use this skill when

- Implementing or reviewing **Runner protocol compatibility** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Runner protocol compatibility**.
