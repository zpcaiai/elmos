---
name: b41-migration-run-knowledge-ingestion
description: Ingest immutable run events and evidence using idempotent pipelines, quality checks, lineage and tenant policy.
---

# Skill 1396: b41-migration-run-knowledge-ingestion

## Use this skill when

- Implementing or reviewing **Migration-run knowledge ingestion** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Migration-run knowledge ingestion**.
