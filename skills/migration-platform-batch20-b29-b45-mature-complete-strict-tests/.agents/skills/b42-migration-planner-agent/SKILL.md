---
name: b42-migration-planner-agent
description: Produce bounded, evidence-linked plans with dependencies, risk, budget, stop conditions and human approvals.
---

# Skill 1415: b42-migration-planner-agent

## Use this skill when

- Implementing or reviewing **Migration planner agent** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Migration planner agent**.
