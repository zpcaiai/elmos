---
name: b44-model-token-provider-agent-economics
description: Measure model calls, reviews, failures and routing economics by capability and outcome.
---

# Skill 1461: b44-model-token-provider-agent-economics

## Use this skill when

- Implementing or reviewing **Model, token, provider and agent economics** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Model, token, provider and agent economics**.
