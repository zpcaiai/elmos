---
name: b43-automated-upgrade-migration-tooling
description: Provide idempotent preflight, transforms, dry run, backups, execution, validation and rollback.
---

# Skill 1448: b43-automated-upgrade-migration-tooling

## Use this skill when

- Implementing or reviewing **Automated upgrade and migration tooling** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Automated upgrade and migration tooling**.
