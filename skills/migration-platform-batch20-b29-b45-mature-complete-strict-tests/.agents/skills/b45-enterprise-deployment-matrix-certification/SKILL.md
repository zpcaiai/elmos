---
name: b45-enterprise-deployment-matrix-certification
description: Verify each claimed SaaS, dedicated, VPC, self-hosted, sovereign, air-gap and multi-region edition independently.
---

# Skill 1485: b45-enterprise-deployment-matrix-certification

## Use this skill when

- Implementing or reviewing **Enterprise deployment-matrix certification** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Enterprise deployment-matrix certification**.
