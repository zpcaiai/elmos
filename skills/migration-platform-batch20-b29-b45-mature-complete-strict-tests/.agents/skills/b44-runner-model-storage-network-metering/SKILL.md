---
name: b44-runner-model-storage-network-metering
description: Collect idempotent platform-authoritative usage with source, unit, price version and evidence.
---

# Skill 1457: b44-runner-model-storage-network-metering

## Use this skill when

- Implementing or reviewing **Runner, model, storage and network metering** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Runner, model, storage and network metering**.
