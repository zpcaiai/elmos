---
name: b44-cost-allocation-showback-chargeback
description: Allocate shared and direct costs using explainable rules, reconciliation and dispute handling.
---

# Skill 1458: b44-cost-allocation-showback-chargeback

## Use this skill when

- Implementing or reviewing **Cost allocation, showback and chargeback** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Cost allocation, showback and chargeback**.
