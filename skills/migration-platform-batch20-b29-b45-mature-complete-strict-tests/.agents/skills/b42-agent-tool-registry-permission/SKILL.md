---
name: b42-agent-tool-registry-permission
description: Register typed tools with least privilege, scope, side effects, idempotency, approval and runtime enforcement.
---

# Skill 1422: b42-agent-tool-registry-permission

## Use this skill when

- Implementing or reviewing **Agent tool registry and permission** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Agent tool registry and permission**.
