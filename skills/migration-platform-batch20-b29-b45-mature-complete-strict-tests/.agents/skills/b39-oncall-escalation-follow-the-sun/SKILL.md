---
name: b39-oncall-escalation-follow-the-sun
description: Operate staffed rotations, skill-aware escalation, handoff, access readiness and fatigue controls across time zones.
---

# Skill 1358: b39-oncall-escalation-follow-the-sun

## Use this skill when

- Implementing or reviewing **On-call, escalation and follow-the-sun** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **On-call, escalation and follow-the-sun**.
