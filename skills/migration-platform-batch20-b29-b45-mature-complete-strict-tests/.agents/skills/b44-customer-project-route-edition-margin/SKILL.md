---
name: b44-customer-project-route-edition-margin
description: Calculate gross and contribution margin using recognized revenue and fully reconciled costs.
---

# Skill 1467: b44-customer-project-route-edition-margin

## Use this skill when

- Implementing or reviewing **Customer, project, route and edition margin** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Customer, project, route and edition margin**.
