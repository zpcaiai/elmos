---
name: b40-slsa-provenance-build-attestation
description: Produce verifiable build provenance tied to source, builder, dependencies, parameters, outputs and policy.
---

# Skill 1383: b40-slsa-provenance-build-attestation

## Use this skill when

- Implementing or reviewing **SLSA provenance and build attestation** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **SLSA provenance and build attestation**.
