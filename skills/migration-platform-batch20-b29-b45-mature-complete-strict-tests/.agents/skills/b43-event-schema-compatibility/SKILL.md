---
name: b43-event-schema-compatibility
description: Validate producers, consumers, keys, ordering, defaults and replay across event-schema versions.
---

# Skill 1438: b43-event-schema-compatibility

## Use this skill when

- Implementing or reviewing **Event and schema compatibility** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Event and schema compatibility**.
