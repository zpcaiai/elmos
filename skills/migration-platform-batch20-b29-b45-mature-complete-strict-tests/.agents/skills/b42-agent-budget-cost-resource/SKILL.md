---
name: b42-agent-budget-cost-resource
description: Enforce tokens, calls, runtime, tools, files, patches and monetary budgets with graceful stop behavior.
---

# Skill 1426: b42-agent-budget-cost-resource

## Use this skill when

- Implementing or reviewing **Agent budget, cost and resource control** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Agent budget, cost and resource control**.
