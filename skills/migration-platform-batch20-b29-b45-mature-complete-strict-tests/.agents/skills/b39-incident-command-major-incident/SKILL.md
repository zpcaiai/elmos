---
name: b39-incident-command-major-incident
description: Provide severity, roles, war-room workflow, containment, communication, evidence preservation and recovery criteria.
---

# Skill 1356: b39-incident-command-major-incident

## Use this skill when

- Implementing or reviewing **Incident command and major incident response** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Incident command and major incident response**.
