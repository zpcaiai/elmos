---
name: b42-supervisor-coordination-agent
description: Coordinate tasks, state, retries, conflicts, escalation and completion without bypassing specialist or policy gates.
---

# Skill 1420: b42-supervisor-coordination-agent

## Use this skill when

- Implementing or reviewing **Supervisor and coordination agent** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Supervisor and coordination agent**.
