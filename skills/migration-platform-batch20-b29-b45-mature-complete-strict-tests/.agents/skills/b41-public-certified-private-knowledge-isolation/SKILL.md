---
name: b41-public-certified-private-knowledge-isolation
description: Separate public knowledge, platform-certified assets and tenant-private knowledge with enforced access and promotion.
---

# Skill 1407: b41-public-certified-private-knowledge-isolation

## Use this skill when

- Implementing or reviewing **Public, certified and private knowledge isolation** within Batch 41: 迁移知识图谱与智能飞轮.
...
- Customer-private knowledge must remain tenant-scoped and cannot be promoted without sanitization, evidence and approval.
- Predictions require untouched holdout, calibration, drift detection and safe abstention.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Public, certified and private knowledge isolation**.
