...
description: Implement online schema evolution, backfill, compatibility windows, contraction gates and rollback-safe database upgrades.
---

# Skill 1341: b38-database-expand-contract-upgrade

## Use this skill when

- Implementing or reviewing **Database expand-contract upgrade** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Database expand-contract upgrade**.
