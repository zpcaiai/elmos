---
name: b41-knowledge-asset-marketplace-sharing
description: Package, certify, share, revoke and license reusable knowledge assets without exposing private evidence.
---

# Skill 1411: b41-knowledge-asset-marketplace-sharing

## Use this skill when

- Implementing or reviewing **Knowledge-asset marketplace and sharing** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Knowledge-asset marketplace and sharing**.
