---
name: b42-agent-red-team-adversarial-eval
description: Test prompt injection, tool abuse, data exfiltration, evidence forgery, collusion and resource exhaustion.
---

# Skill 1429: b42-agent-red-team-adversarial-eval

## Use this skill when

- Implementing or reviewing **Agent red-team and adversarial evaluation** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Agent red-team and adversarial evaluation**.
