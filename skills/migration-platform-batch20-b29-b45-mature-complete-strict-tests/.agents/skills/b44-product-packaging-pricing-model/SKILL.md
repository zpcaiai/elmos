---
name: b44-product-packaging-pricing-model
description: Design edition, route, workload, subscription and service pricing with value, cost and risk boundaries.
---

# Skill 1465: b44-product-packaging-pricing-model

## Use this skill when

- Implementing or reviewing **Product packaging and pricing model** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Product packaging and pricing model**.
