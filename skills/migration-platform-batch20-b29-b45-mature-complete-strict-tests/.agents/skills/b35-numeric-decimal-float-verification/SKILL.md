---
name: b35-numeric-decimal-float-verification
description: Implement high-precision numeric verification for integer overflow decimal scale rounding floating-point error intervals units and deterministic cross-runtime comparison.
---
...
## Skill 1280: b35-numeric-decimal-float-verification

## Use this skill when

- Cross-runtime calculations require exact or bounded numerical guarantees.

## Domain-specific risks and invariants

- Float tolerances can be widened until defects disappear.

## Workflow

1. Define numeric domains, units, precision, scale, rounding, overflow, exceptional values, and approved error envelopes.
2. Use high-precision or rational reference oracles where possible.
3. Generate boundary, random, cancellation, accumulation, and conversion cases.
4. Compare source and target under exact runtime modes.
5. Analyze worst-case error and unstable regions.
6. Require owner-approved tolerances before execution.
...
- Protect money, tax, interest, energy, geometry, statistics, time, counters, and scientific calculations.
...
- Numeric contracts, boundary generators, high-precision oracle results, error envelopes, counterexamples, and approved tolerances.
