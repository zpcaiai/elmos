---
name: b44-economics-maturity-certification-gate
description: Certify unit economics, pricing and billing only from reconciled usage, costs, revenue and customer-value evidence.
---

# Skill 1474: b44-economics-maturity-certification-gate

## Use this skill when

- Implementing or reviewing **Economics-maturity certification gate** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Economics-maturity certification gate**.
