---
name: b39-global-operations-certification-gate
description: Certify SRE and support readiness only when SLO, failover, restore, incident and customer evidence meet strict thresholds.
---

# Skill 1368: b39-global-operations-certification-gate

## Use this skill when

- Implementing or reviewing **Global operations certification gate** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Global operations certification gate**.
