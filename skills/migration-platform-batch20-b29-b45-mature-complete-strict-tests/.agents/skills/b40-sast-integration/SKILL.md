---
name: b40-sast-integration
description: Run language-aware static analysis, deduplicate findings, enforce severity policy and preserve traceable suppressions.
---

# Skill 1374: b40-sast-integration

## Use this skill when

- Implementing or reviewing **SAST integration** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **SAST integration**.
