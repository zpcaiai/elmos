---
name: b40-dast-iast-integration
description: Test deployed applications and runtime data flows for exploitable security defects using bounded authenticated scenarios.
---

# Skill 1375: b40-dast-iast-integration

## Use this skill when

- Implementing or reviewing **DAST and IAST integration** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **DAST and IAST integration**.
