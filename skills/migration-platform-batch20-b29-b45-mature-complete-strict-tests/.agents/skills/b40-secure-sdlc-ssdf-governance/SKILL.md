---
name: b40-secure-sdlc-ssdf-governance
description: Map secure-development practices to repositories, pipelines, roles, controls, evidence and exceptions.
---

# Skill 1370: b40-secure-sdlc-ssdf-governance

## Use this skill when

- Implementing or reviewing **Secure SDLC and SSDF governance** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Secure SDLC and SSDF governance**.
