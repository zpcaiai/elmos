---
name: b41-human-curation-domain-expert-governance
description: Provide review queues, adjudication, ownership, conflict resolution and rollback for high-impact knowledge.
---

# Skill 1410: b41-human-curation-domain-expert-governance

## Use this skill when

- Implementing or reviewing **Human curation and domain-expert governance** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Human curation and domain-expert governance**.
