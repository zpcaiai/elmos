---
name: b44-cost-scenario-rolling-forecast
description: Forecast volume, mix, price, capacity, support and uncertainty with actual-to-forecast feedback.
---

# Skill 1471: b44-cost-scenario-rolling-forecast

## Use this skill when

- Implementing or reviewing **Cost scenario and rolling forecast** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Cost scenario and rolling forecast**.
