---
name: b44-usage-billing-financial-reconciliation
description: Reconcile usage, entitlement, price, invoice, credit, tax, payout and ledger totals end to end.
---

# Skill 1473: b44-usage-billing-financial-reconciliation

## Use this skill when

- Implementing or reviewing **Usage, billing and financial reconciliation** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Usage, billing and financial reconciliation**.
