---
name: b39-tenant-project-migration-health
description: Compute explainable health from workflow progress, runner state, evidence freshness, SLOs, security and customer impact.
---

# Skill 1351: b39-tenant-project-migration-health

## Use this skill when

- Implementing or reviewing **Tenant, project and migration health** within Batch 39: 全球SRE与平台运营.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Tenant, project and migration health**.
