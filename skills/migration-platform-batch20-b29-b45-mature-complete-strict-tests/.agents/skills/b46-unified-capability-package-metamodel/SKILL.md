---
name: b46-unified-capability-package-metamodel
description: 将Route、Framework、Database、Client、Cloud、Verification、Extension等Pack统一为一个版本化父模型。
---

# Skill 1498：统一Capability Package元模型
...
将Route、Framework、Database、Client、Cloud、Verification、Extension等Pack统一为一个版本化父模型。
...
- 所有Pack必须有稳定ID、SemVer、状态、四类Owner、兼容、依赖、Policy、Evidence、认证和经济性；禁止领域Pack绕过父模型。
...
- `contracts/product-kernel/capability-package.schema.json`
- `services/control-plane/capabilities/`
- `db/migrations/capability_registry/`
