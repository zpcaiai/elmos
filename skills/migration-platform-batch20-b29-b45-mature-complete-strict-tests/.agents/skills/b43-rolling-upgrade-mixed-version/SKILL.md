---
name: b43-rolling-upgrade-mixed-version
description: Verify mixed-version service, runner, workflow and database behavior during rolling upgrades.
---

# Skill 1450: b43-rolling-upgrade-mixed-version

## Use this skill when

- Implementing or reviewing **Rolling upgrade and mixed-version operation** within Batch 43: 产品版本、兼容与LTS生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Rolling upgrade and mixed-version operation**.
