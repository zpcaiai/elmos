---
name: b38-tenant-cross-edition-migration
description: Move a tenant between SaaS, dedicated, VPC, self-hosted or sovereign editions with data integrity, downtime targets, rollback and audit.
---

# Skill 1337: b38-tenant-cross-edition-migration

## Use this skill when

- Implementing or reviewing **Tenant cross-edition migration** within Batch 38: 企业部署矩阵与升级生命周期.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Tenant cross-edition migration**.
