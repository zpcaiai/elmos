---
name: b42-policy-enforcement-agent
description: Evaluate tool, data, model, budget and approval policy with fail-closed decisions that execution agents cannot modify.
---

# Skill 1419: b42-policy-enforcement-agent

## Use this skill when

- Implementing or reviewing **Policy-enforcement agent** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Policy-enforcement agent**.
