---
name: b41-target-technology-stack-recommendation
description: Recommend target stacks from constraints, capability, operations, cost and organizational readiness rather than popularity.
---

# Skill 1403: b41-target-technology-stack-recommendation

## Use this skill when

- Implementing or reviewing **Target technology-stack recommendation** within Batch 41: 迁移知识图谱与智能飞轮.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Target technology-stack recommendation**.
