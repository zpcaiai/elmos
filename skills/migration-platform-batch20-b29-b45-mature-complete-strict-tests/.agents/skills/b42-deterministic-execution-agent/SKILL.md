---
name: b42-deterministic-execution-agent
description: Execute approved recipes and tools exactly, idempotently and with complete provenance rather than improvising code.
---

# Skill 1416: b42-deterministic-execution-agent

## Use this skill when

- Implementing or reviewing **Deterministic execution agent** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Deterministic execution agent**.
