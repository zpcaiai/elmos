---
name: b42-agent-eval-benchmark
description: Evaluate final outcomes, trajectories, tool use, policy compliance, cost and robustness on development and holdout corpora.
---

# Skill 1427: b42-agent-eval-benchmark

## Use this skill when

- Implementing or reviewing **Agent evaluation and benchmark** within Batch 42: 成熟Agent迁移工厂.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Agent evaluation and benchmark**.
