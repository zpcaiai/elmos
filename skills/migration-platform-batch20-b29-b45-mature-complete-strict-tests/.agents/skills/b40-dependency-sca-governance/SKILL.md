---
name: b40-dependency-sca-governance
description: Inventory dependencies, assess vulnerabilities, licenses and reachability, and enforce upgrade or exception workflows.
---

# Skill 1376: b40-dependency-sca-governance

## Use this skill when

- Implementing or reviewing **Dependency and SCA governance** within Batch 40: 安全供应链与合规认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Dependency and SCA governance**.
