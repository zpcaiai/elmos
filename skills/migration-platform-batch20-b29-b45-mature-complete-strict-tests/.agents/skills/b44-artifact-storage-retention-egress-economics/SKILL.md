---
name: b44-artifact-storage-retention-egress-economics
description: Optimize artifact lifecycle, replication, compression and transfer while preserving legal and recovery requirements.
---

# Skill 1462: b44-artifact-storage-retention-egress-economics

## Use this skill when

- Implementing or reviewing **Artifact storage, retention and egress economics** within Batch 44: FinOps与迁移经济优化.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **Artifact storage, retention and egress economics**.
