---
name: b45-sdk-marketplace-ecosystem-certification
description: Verify extension development, security, publication, operation, billing, support, revocation and EOL.
---

# Skill 1486: b45-sdk-marketplace-ecosystem-certification

## Use this skill when

- Implementing or reviewing **SDK, marketplace and ecosystem certification** within Batch 45: 成熟产品综合认证.
...
2. Define the typed contract, state machine, ownership, policy decisions, failure modes, compatibility boundaries and lifecycle for **SDK, marketplace and ecosystem certification**.
