...
def complete_core(pack):
 ...
 for d in ['corpus/negative','corpus/holdout','corpus/representative-extensions']:(pack/d/'sample.txt').write_text('evidence\n')
...
def complete_closure(pack):
 for d in ['corpus/closure-holdout','corpus/representative-lifecycle']:(pack/d/'sample.txt').write_text('evidence\n')
