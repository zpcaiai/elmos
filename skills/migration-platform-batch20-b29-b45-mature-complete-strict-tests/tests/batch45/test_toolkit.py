...
class Toolkit(unittest.TestCase):
 ...
 def test_positive_gate(self):
  with tempfile.TemporaryDirectory() as td:
   ...
   metrics={k:1.0 for k in ['functional_depth_pass_rate', 'certified_route_claim_accuracy', 'semantic_behavior_pass_rate', 'scale_slo_pass_rate', 'security_governance_pass_rate', 'sre_dr_pass_rate', 'maintainability_pass_rate', 'developer_experience_pass_rate', 'deployment_matrix_pass_rate', 'ecosystem_pass_rate', 'economics_pass_rate', 'customer_outcome_pass_rate', 'evidence_trace_coverage']}; zero={k:0 for k in ['critical_open_product_risks', 'unsupported_marketing_claims', 'unknown_p0_correctness', 'critical_security_findings', 'unrecovered_dr_failures', 'unaccepted_customer_p0_differences', 'nonzero_financial_reconciliation_difference', 'conflicted_independent_reviews', 'expired_mandatory_evidence', 'test_integrity_violations']}
