...
description: 把产品知识、架构、计划、证据和运行规则变成版本化、可检索、可验证的仓库资产。
license: Proprietary
...
把产品知识、架构、计划、证据和运行规则变成版本化、可检索、可验证的仓库资产。
...
1. 扫描现有文档树和所有权
2. 生成短 AGENTS.md 地图与渐进披露索引
3. 定义 authoritative source 与派生文档
4. 加入新鲜度/死链/重复冲突检查
5. 把缺口写入执行计划
...
- [ ] AGENTS 地图足够短且全部链接可解析
- [ ] 不存在互相冲突的 authoritative 文档
