...
description: 为 DeepSeek Harness、OpenCode、OpenHarness、Codex、Claude 和本地运行时提供统一适配合同。
license: Proprietary
...
为 DeepSeek Harness、OpenCode、OpenHarness、Codex、Claude 和本地运行时提供统一适配合同。
...
1. 读取目标 Harness 能力描述
2. 映射到 Elmos capability vocabulary
3. 实现启动/事件/取消/状态/错误转换
4. 声明不支持能力
5. 运行 conformance suite
6. 发布带 Pin 的 Adapter
