...
| 指标 | 目标 | 说明 |
| --- | --- | --- |
| Task plan generation | P95 < 10 min | 不含超大型仓库扫描 |
| Deterministic rule reproducibility | 100% | 同输入/版本/配置同输出 |
| Generated artifact traceability | 100% | 关联 requirement/capability/rule/source map |
| Unsupported semantics visibility | 100% | 禁止静默遗漏 |
| Migration rollback readiness | 100% for reversible tier | 切换前必须演练 |
