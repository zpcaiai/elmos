...
description: 检测模型、Harness、规则、框架和依赖变化引起的质量退化。
license: Proprietary
...
检测模型、Harness、规则、框架和依赖变化引起的质量退化。
...
1. 订阅版本/结果变化
2. 选择受影响 benchmark shards
3. 运行对比
4. 计算 significance/impact
5. 定位责任组件
6. 触发 rollback/降级
