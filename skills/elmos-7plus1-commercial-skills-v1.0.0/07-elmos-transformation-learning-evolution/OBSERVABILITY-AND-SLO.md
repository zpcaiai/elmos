...
| 指标 | 目标 | 说明 |
| --- | --- | --- |
| Knowledge query latency | P95 < 200ms | 热索引 |
| Trusted rule evidence coverage | 100% | 所有 trusted/certified |
| Regression detection freshness | <24h after relevant change | 核心矩阵 |
| Tenant data deletion acknowledgment | <24h | 删除流程目标 |
| Knowledge conflict resolution | P95 < 7d | 高风险冲突 <24h |
| Bad rule escape rate | 目标接近 0 | certified 规则导致 Critical regression |
