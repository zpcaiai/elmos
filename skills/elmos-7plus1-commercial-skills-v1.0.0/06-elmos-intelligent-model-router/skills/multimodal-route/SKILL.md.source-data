...
description: 为 UI 截图、视频、DOM/state 和设计比较选择可靠模型。
license: Proprietary
...
为 UI 截图、视频、DOM/state 和设计比较选择可靠模型。
...
1. 识别 image/video/file modalities
2. 检查分辨率/时长/上下文限制
3. 选择模型与 sampling policy
4. 执行双模型或 deterministic precheck
5. 把结论交给 P05

## 产出

- multimodal route trace
