...
description: 计算多轮模型、缓存、工具、并发和重试的真实/预测成本与系统墙钟时间。
license: Proprietary
...
计算多轮模型、缓存、工具、并发和重试的真实/预测成本与系统墙钟时间。
...
1. 聚合每个 model call usage
2. 计入 cached/reasoning/output
3. 计入工具/排队/重试时间
4. 基于 DAG/并发做 ETA 分布
5. 实时更新预算与剩余量
