...
description: 建模 API、数据库、消息、缓存、定时任务、权限、配置和基础设施。
license: Proprietary
...
建模 API、数据库、消息、缓存、定时任务、权限、配置和基础设施。
...
1. 解析 OpenAPI/routes/RPC
2. 解析 schema/migration/query
3. 解析 producer/consumer 与 ACK/retry
4. 解析 cache/key/TTL
5. 解析 scheduler/auth/config/infra
6. 连接到业务符号
