...
description: 管理父子 Agent 的持久会话、消息、报告和中断。
license: Proprietary
...
1. 创建 child lineage
2. 分配 tool/depth/cost limits
3. 投递 initial/follow-up FIFO
4. 接收 report/settlement notice
5. 支持 interrupt/cold resume
6. child-first drain
