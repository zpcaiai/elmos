...
description: 统一 GitHub/Linear/Jira/GitLab/内部队列的 Issue 状态、标签、链接和评论。
license: Proprietary
...
统一 GitHub/Linear/Jira/GitLab/内部队列的 Issue 状态、标签、链接和评论。
...
1. 读取 WORKFLOW tracker 配置
2. 获取候选并分页
3. 规范化状态/ID/labels
4. 过滤不可调度项
5. 隔离凭据
6. 运行 adapter contract tests
