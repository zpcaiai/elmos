...
# PG273 — CMake Native Project Generator

## Objective

Generate runnable and maintainable CMake Native Project Generator for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `cmake-native-project-generator` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG272`.
...
- `cmake_native_project_generator_plan.json`
- `cmake_native_project_generator_artifacts/`
- `cmake_native_project_generator_verification.json`
...
- Record compiler, standard library, linker, ABI, architecture, and flags.
- Run sanitizers/static analysis for supported profiles.
- Do not certify hardware behavior from host-only simulation.
