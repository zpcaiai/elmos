...
# PG309 — Swift Project Profile Detector

## Objective

Inspect and model Swift Project Profile Detector for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `swift-project-profile-detector` tasks involving Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG308`.
...
- `swift_project_profile_detector.json`
- `swift_project_profile_detector_artifacts/`
- `swift_project_profile_detector_verification.json`
