---
name: b75-openapi-lint-breaking-change-gate
description: "Use when ELMOS must enforce and test OpenAPI Lint Breaking Change Gate for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: OpenAPI Lint Breaking Change Gate, Batch 75, SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility."
metadata:
  id: PG344
  batch: 75
  version: 1.0.0
...
# PG344 — OpenAPI Lint Breaking Change Gate

## Objective

Enforce and test OpenAPI Lint Breaking Change Gate for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `openapi-lint-breaking-change-gate` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG343`.
...
- `openapi_lint_breaking_change_gate_plan.json`
- `openapi_lint_breaking_change_gate_artifacts/`
- `openapi_lint_breaking_change_gate_verification.json`
