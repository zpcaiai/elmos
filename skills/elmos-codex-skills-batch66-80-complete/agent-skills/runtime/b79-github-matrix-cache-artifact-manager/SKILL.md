---
name: b79-github-matrix-cache-artifact-manager
description: "Use when ELMOS must coordinate and control GitHub Matrix Cache Artifact Manager for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: GitHub Matrix Cache Artifact Manager, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG395
  batch: 79
  version: 1.0.0
...
# PG395 — GitHub Matrix Cache Artifact Manager

## Objective

Coordinate and control GitHub Matrix Cache Artifact Manager for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `github-matrix-cache-artifact-manager` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG394`.
...
- `github_matrix_cache_artifact_manager_plan.json`
- `github_matrix_cache_artifact_manager_artifacts/`
- `github_matrix_cache_artifact_manager_verification.json`
