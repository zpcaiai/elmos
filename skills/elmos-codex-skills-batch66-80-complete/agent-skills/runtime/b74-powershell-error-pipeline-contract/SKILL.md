...
# PG330 — Powershell Error Pipeline Contract

## Objective

Implement and validate Powershell Error Pipeline Contract for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `powershell-error-pipeline-contract` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`, `PG329`.
...
- `powershell_error_pipeline_contract_plan.json`
- `powershell_error_pipeline_contract_artifacts/`
- `powershell_error_pipeline_contract_verification.json`
