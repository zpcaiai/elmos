---
name: b73-swift-concurrency-safety
description: "Use when ELMOS must enforce and test Swift Concurrency Safety for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Swift Concurrency Safety, Batch 73, Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing."
metadata:
  id: PG315
  batch: 73
  version: 1.0.0
...
# PG315 — Swift Concurrency Safety

## Objective

Enforce and test Swift Concurrency Safety for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `swift-concurrency-safety` tasks involving Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG308`, `PG314`.
...
- `swift_concurrency_safety_plan.json`
- `swift_concurrency_safety_artifacts/`
- `swift_concurrency_safety_verification.json`
