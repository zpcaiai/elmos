---
name: b79-gitlab-environment-release-manager
description: "Use when ELMOS must coordinate and control GitLab Environment Release Manager for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: GitLab Environment Release Manager, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG399
  batch: 79
  version: 1.0.0
...
# PG399 — GitLab Environment Release Manager

## Objective

Coordinate and control GitLab Environment Release Manager for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `gitlab-environment-release-manager` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG398`.
...
- `gitlab_environment_release_manager_plan.json`
- `gitlab_environment_release_manager_artifacts/`
- `gitlab_environment_release_manager_verification.json`
...
- Record provenance, signatures, symbols, and rollback metadata.
- Never embed signing credentials.
