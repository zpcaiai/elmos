---
name: b75-graphql-security-cost-gate
description: "Use when ELMOS must enforce and test GraphQL Security Cost Gate for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: GraphQL Security Cost Gate, Batch 75, SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility."
metadata:
  id: PG349
  batch: 75
  version: 1.0.0
...
# PG349 — GraphQL Security Cost Gate

## Objective

Enforce and test GraphQL Security Cost Gate for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `graphql-security-cost-gate` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG348`.
...
- `graphql_security_cost_gate_plan.json`
- `graphql_security_cost_gate_artifacts/`
- `graphql_security_cost_gate_verification.json`
...
- Enforce resolver authorization, query cost, depth, batching, and error redaction.
- Test nullability against runtime behavior.
- Detect N+1 access paths.
