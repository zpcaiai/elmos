---
name: b68-ktor-service-generator
description: "Use when ELMOS must generate runnable and maintainable Ktor Service Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Ktor Service Generator, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG250
  batch: 68
  version: 1.0.0
...
# PG250 — Ktor Service Generator

## Objective

Generate runnable and maintainable Ktor Service Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `ktor-service-generator` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG249`.
...
- `ktor_service_generator_plan.json`
- `ktor_service_generator_artifacts/`
- `ktor_service_generator_verification.json`
