---
name: b76-cmake-dependency-package-manager
description: "Use when ELMOS must coordinate and control CMake Dependency Package Manager for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: CMake Dependency Package Manager, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG357
  batch: 76
  version: 1.0.0
...
# PG357 — CMake Dependency Package Manager

## Objective

Coordinate and control CMake Dependency Package Manager for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `cmake-dependency-package-manager` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`, `PG356`.
...
- `cmake_dependency_package_manager_plan.json`
- `cmake_dependency_package_manager_artifacts/`
- `cmake_dependency_package_manager_verification.json`
