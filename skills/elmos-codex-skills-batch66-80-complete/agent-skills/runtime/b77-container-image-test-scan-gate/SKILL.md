---
name: b77-container-image-test-scan-gate
description: "Use when ELMOS must enforce and test Container Image Test Scan Gate for Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Container Image Test Scan Gate, Batch 77, Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification."
metadata:
  id: PG373
  batch: 77
  version: 1.0.0
...
# PG373 — Container Image Test Scan Gate

## Objective

Enforce and test Container Image Test Scan Gate for Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `container-image-test-scan-gate` tasks involving Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG362`, `PG372`.
...
- `container_image_test_scan_gate_plan.json`
- `container_image_test_scan_gate_artifacts/`
- `container_image_test_scan_gate_verification.json`
