...
# PG245 — Go Test Fuzz Race Generator

## Objective

Generate runnable and maintainable Go Test Fuzz Race Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-test-fuzz-race-generator` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`, `PG244`.
...
- `go_test_fuzz_race_generator_plan.json`
- `go_test_fuzz_race_generator_artifacts/`
- `go_test_fuzz_race_generator_verification.json`
