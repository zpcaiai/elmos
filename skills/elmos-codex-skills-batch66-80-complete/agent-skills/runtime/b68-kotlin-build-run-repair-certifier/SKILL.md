---
name: b68-kotlin-build-run-repair-certifier
description: "Use when ELMOS must execute and independently verify Kotlin Build Run Repair Certifier for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Kotlin Build Run Repair Certifier, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG258
  batch: 68
  version: 1.0.0
...
# PG258 — Kotlin Build Run Repair Certifier

## Objective

Execute and independently verify Kotlin Build Run Repair Certifier for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `kotlin-build-run-repair-certifier` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG257`.
...
- `kotlin_build_run_repair_certifier_plan.json`
- `kotlin_build_run_repair_certifier_artifacts/`
- `kotlin_build_run_repair_certifier_verification.json`
