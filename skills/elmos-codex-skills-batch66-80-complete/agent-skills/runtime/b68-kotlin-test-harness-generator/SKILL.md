---
name: b68-kotlin-test-harness-generator
description: "Use when ELMOS must generate runnable and maintainable Kotlin Test Harness Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Kotlin Test Harness Generator, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG257
  batch: 68
  version: 1.0.0
...
# PG257 — Kotlin Test Harness Generator

## Objective

Generate runnable and maintainable Kotlin Test Harness Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `kotlin-test-harness-generator` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG256`.
...
- `kotlin_test_harness_generator_plan.json`
- `kotlin_test_harness_generator_artifacts/`
- `kotlin_test_harness_generator_verification.json`
