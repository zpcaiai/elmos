---
name: b80-project-migration-compatibility-gate
description: "Use when ELMOS must enforce and test Project Migration Compatibility Gate for cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Project Migration Compatibility Gate, Batch 80, cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification."
metadata:
  id: PG416
  batch: 80
  version: 1.0.0
...
# PG416 — Project Migration Compatibility Gate

## Objective

Enforce and test Project Migration Compatibility Gate for cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `project-migration-compatibility-gate` tasks involving cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG405`, `PG415`.
...
- `project_migration_compatibility_gate_plan.json`
- `project_migration_compatibility_gate_artifacts/`
- `project_migration_compatibility_gate_verification.json`
