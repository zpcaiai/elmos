...
# PG271 — Native Project Profile Detector

## Objective

Inspect and model Native Project Profile Detector for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `native-project-profile-detector` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`.
...
- `native_project_profile_detector.json`
- `native_project_profile_detector_artifacts/`
- `native_project_profile_detector_verification.json`
