---
name: b77-compose-readiness-dependency-manager
description: "Use when ELMOS must coordinate and control Compose Readiness Dependency Manager for Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Compose Readiness Dependency Manager, Batch 77, Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification."
metadata:
  id: PG370
  batch: 77
  version: 1.0.0
  ...
  category: "Dockerfile and Docker Compose Project Pack"
---

# PG370 — Compose Readiness Dependency Manager

## Objective

Coordinate and control Compose Readiness Dependency Manager for Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `compose-readiness-dependency-manager` tasks involving Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification.
...
- Inspect source markers such as `Dockerfile*`, `.dockerignore`, `compose*.yaml`, `docker-compose*.yml` and resolve effective includes, generated files, workspaces, modules, targets, and entrypoints.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG362`, `PG369`.
...
- `compose_readiness_dependency_manager_plan.json`
- `compose_readiness_dependency_manager_artifacts/`
- `compose_readiness_dependency_manager_verification.json`
...
- Preferred tools: `docker/podman`, `buildx/buildah`, `compose`, `hadolint`, `trivy/grype`, `syft`, `cosign`. Record alternate tools, versions, and rationale.
