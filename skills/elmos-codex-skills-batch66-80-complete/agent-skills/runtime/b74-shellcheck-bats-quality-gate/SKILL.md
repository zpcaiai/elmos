---
name: b74-shellcheck-bats-quality-gate
description: "Use when ELMOS must enforce and test Shellcheck Bats Quality Gate for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Shellcheck Bats Quality Gate, Batch 74, Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests."
metadata:
  id: PG327
  batch: 74
  version: 1.0.0
...
# PG327 — Shellcheck Bats Quality Gate

## Objective

Enforce and test Shellcheck Bats Quality Gate for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `shellcheck-bats-quality-gate` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`, `PG326`.
...
- `shellcheck_bats_quality_gate_plan.json`
- `shellcheck_bats_quality_gate_artifacts/`
- `shellcheck_bats_quality_gate_verification.json`
