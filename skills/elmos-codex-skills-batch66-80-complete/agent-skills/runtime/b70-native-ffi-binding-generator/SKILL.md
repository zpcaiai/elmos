...
# PG276 — Native FFI Binding Generator

## Objective

Generate runnable and maintainable Native FFI Binding Generator for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `native-ffi-binding-generator` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG275`.
...
- `native_ffi_binding_generator_plan.json`
- `native_ffi_binding_generator_artifacts/`
- `native_ffi_binding_generator_verification.json`
