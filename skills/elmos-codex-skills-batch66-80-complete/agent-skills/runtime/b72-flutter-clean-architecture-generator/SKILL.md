---
name: b72-flutter-clean-architecture-generator
description: "Use when ELMOS must generate runnable and maintainable Flutter Clean Architecture Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Flutter Clean Architecture Generator, Batch 72, Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging."
metadata:
  id: PG299
  batch: 72
  version: 1.0.0
...
# PG299 — Flutter Clean Architecture Generator

## Objective

Generate runnable and maintainable Flutter Clean Architecture Generator for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `flutter-clean-architecture-generator` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG298`.
...
- `flutter_clean_architecture_generator_plan.json`
- `flutter_clean_architecture_generator_artifacts/`
- `flutter_clean_architecture_generator_verification.json`
