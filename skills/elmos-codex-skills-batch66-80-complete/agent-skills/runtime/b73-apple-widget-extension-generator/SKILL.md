---
name: b73-apple-widget-extension-generator
description: "Use when ELMOS must generate runnable and maintainable Apple Widget Extension Generator for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Apple Widget Extension Generator, Batch 73, Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing."
metadata:
  id: PG317
  batch: 73
  version: 1.0.0
...
# PG317 — Apple Widget Extension Generator

## Objective

Generate runnable and maintainable Apple Widget Extension Generator for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `apple-widget-extension-generator` tasks involving Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG308`, `PG316`.
...
- `apple_widget_extension_generator_plan.json`
- `apple_widget_extension_generator_artifacts/`
- `apple_widget_extension_generator_verification.json`
