---
name: b80-software-supply-chain-provenance-orchestrator
description: "Use when ELMOS must coordinate and control Software Supply Chain Provenance Orchestrator for cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Software Supply Chain Provenance Orchestrator, Batch 80, cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification."
metadata:
  id: PG411
  batch: 80
  version: 1.0.0
...
# PG411 — Software Supply Chain Provenance Orchestrator

## Objective

Coordinate and control Software Supply Chain Provenance Orchestrator for cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `software-supply-chain-provenance-orchestrator` tasks involving cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG405`, `PG410`.
...
- `software_supply_chain_provenance_orchestrator_plan.json`
- `software_supply_chain_provenance_orchestrator_artifacts/`
- `software_supply_chain_provenance_orchestrator_verification.json`
