...
# PG374 — Container Build Run Certifier
...
Use for `container-build-run-certifier` tasks involving Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG362`, `PG373`.
...
- `container_build_run_certifier_plan.json`
- `container_build_run_certifier_artifacts/`
- `container_build_run_certifier_verification.json`
