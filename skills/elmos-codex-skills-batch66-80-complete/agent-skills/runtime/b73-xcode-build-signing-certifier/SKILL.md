---
name: b73-xcode-build-signing-certifier
description: "Use when ELMOS must execute and independently verify Xcode Build Signing Certifier for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Xcode Build Signing Certifier, Batch 73, Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing."
metadata:
  id: PG320
  batch: 73
  version: 1.0.0
...
# PG320 — Xcode Build Signing Certifier

## Objective

Execute and independently verify Xcode Build Signing Certifier for Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `xcode-build-signing-certifier` tasks involving Swift, SwiftUI, Xcode, SwiftPM, state, networking, persistence, concurrency, Objective-C interoperability, widgets, accessibility, XCTest, and signing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG308`, `PG319`.
...
- `xcode_build_signing_certifier_plan.json`
- `xcode_build_signing_certifier_artifacts/`
- `xcode_build_signing_certifier_verification.json`
