...
# PG289 — Rust Async Worker Generator

## Objective

Generate runnable and maintainable Rust Async Worker Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `rust-async-worker-generator` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`, `PG288`.
...
- `rust_async_worker_generator_plan.json`
- `rust_async_worker_generator_artifacts/`
- `rust_async_worker_generator_verification.json`
