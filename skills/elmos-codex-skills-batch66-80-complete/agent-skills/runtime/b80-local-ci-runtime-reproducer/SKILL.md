---
name: b80-local-ci-runtime-reproducer
description: "Use when ELMOS must reproduce deterministically Local Ci Runtime Reproducer for cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Local Ci Runtime Reproducer, Batch 80, cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification."
metadata:
  id: PG412
  batch: 80
  version: 1.0.0
...
# PG412 — Local Ci Runtime Reproducer

## Objective

Reproduce deterministically Local Ci Runtime Reproducer for cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `local-ci-runtime-reproducer` tasks involving cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG405`, `PG411`.
...
- `local_ci_runtime_reproducer_plan.json`
- `local_ci_runtime_reproducer_artifacts/`
- `local_ci_runtime_reproducer_verification.json`
