---
name: b79-gitlab-child-pipeline-component-generator
description: "Use when ELMOS must generate runnable and maintainable GitLab Child Pipeline Component Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: GitLab Child Pipeline Component Generator, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG397
  batch: 79
  version: 1.0.0
...
# PG397 — GitLab Child Pipeline Component Generator

## Objective

Generate runnable and maintainable GitLab Child Pipeline Component Generator for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `gitlab-child-pipeline-component-generator` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG396`.
...
- `gitlab_child_pipeline_component_generator_plan.json`
- `gitlab_child_pipeline_component_generator_artifacts/`
- `gitlab_child_pipeline_component_generator_verification.json`
