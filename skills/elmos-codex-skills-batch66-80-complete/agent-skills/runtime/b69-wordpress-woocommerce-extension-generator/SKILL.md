...
# PG266 — Wordpress Woocommerce Extension Generator

## Objective

Generate runnable and maintainable Wordpress Woocommerce Extension Generator for PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `wordpress-woocommerce-extension-generator` tasks involving PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG258`, `PG265`.
...
- `wordpress_woocommerce_extension_generator_plan.json`
- `wordpress_woocommerce_extension_generator_artifacts/`
- `wordpress_woocommerce_extension_generator_verification.json`
