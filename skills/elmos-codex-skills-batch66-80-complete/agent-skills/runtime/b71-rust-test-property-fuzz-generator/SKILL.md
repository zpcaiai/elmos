---
name: b71-rust-test-property-fuzz-generator
description: "Use when ELMOS must generate runnable and maintainable Rust Test Property Fuzz Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Rust Test Property Fuzz Generator, Batch 71, Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases."
metadata:
  id: PG294
  batch: 71
  version: 1.0.0
...
# PG294 — Rust Test Property Fuzz Generator

## Objective

Generate runnable and maintainable Rust Test Property Fuzz Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `rust-test-property-fuzz-generator` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`, `PG293`.
...
- `rust_test_property_fuzz_generator_plan.json`
- `rust_test_property_fuzz_generator_artifacts/`
- `rust_test_property_fuzz_generator_verification.json`
