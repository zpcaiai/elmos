---
name: b76-cmake-target-graph-generator
description: "Use when ELMOS must generate runnable and maintainable CMake Target Graph Generator for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: CMake Target Graph Generator, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG356
  batch: 76
  version: 1.0.0
...
# PG356 — CMake Target Graph Generator

## Objective

Generate runnable and maintainable CMake Target Graph Generator for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `cmake-target-graph-generator` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`, `PG355`.
...
- `cmake_target_graph_generator_plan.json`
- `cmake_target_graph_generator_artifacts/`
- `cmake_target_graph_generator_verification.json`
