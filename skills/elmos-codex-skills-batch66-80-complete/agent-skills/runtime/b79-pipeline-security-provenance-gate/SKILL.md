---
name: b79-pipeline-security-provenance-gate
description: "Use when ELMOS must enforce and test Pipeline Security Provenance Gate for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Pipeline Security Provenance Gate, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG404
  batch: 79
  version: 1.0.0
...
# PG404 — Pipeline Security Provenance Gate

## Objective

Enforce and test Pipeline Security Provenance Gate for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `pipeline-security-provenance-gate` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG403`.
...
- `pipeline_security_provenance_gate_plan.json`
- `pipeline_security_provenance_gate_artifacts/`
- `pipeline_security_provenance_gate_verification.json`
