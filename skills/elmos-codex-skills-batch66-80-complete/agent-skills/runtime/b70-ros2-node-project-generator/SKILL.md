...
# PG279 — ROS 2 Node Project Generator

## Objective

Generate runnable and maintainable ROS 2 Node Project Generator for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `ros2-node-project-generator` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG278`.
...
- `ros2_node_project_generator_plan.json`
- `ros2_node_project_generator_artifacts/`
- `ros2_node_project_generator_verification.json`
