---
name: b72-flutter-build-run-certifier
description: "Use when ELMOS must execute and independently verify Flutter Build Run Certifier for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Flutter Build Run Certifier, Batch 72, Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging."
metadata:
  id: PG308
  batch: 72
  version: 1.0.0
...
# PG308 — Flutter Build Run Certifier
...
Use for `flutter-build-run-certifier` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG307`.
...
- `flutter_build_run_certifier_plan.json`
- `flutter_build_run_certifier_artifacts/`
- `flutter_build_run_certifier_verification.json`
