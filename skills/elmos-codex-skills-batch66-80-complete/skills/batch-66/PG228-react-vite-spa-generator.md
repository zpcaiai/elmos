...
# PG228 — React Vite Spa Generator

## Objective

Generate runnable and maintainable React Vite Spa Generator for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `react-vite-spa-generator` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG227`.
...
- `react_vite_spa_generator_plan.json`
- `react_vite_spa_generator_artifacts/`
- `react_vite_spa_generator_verification.json`
