---
name: b66-node-runtime-lockfile-reproducer
description: "Use when ELMOS must reproduce deterministically Node Runtime Lockfile Reproducer for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Node Runtime Lockfile Reproducer, Batch 66, TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests."
metadata:
  id: PG224
  batch: 66
  version: 1.0.0
...
# PG224 — Node Runtime Lockfile Reproducer

## Objective

Reproduce deterministically Node Runtime Lockfile Reproducer for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `node-runtime-lockfile-reproducer` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`, `PG223`.
...
- `node_runtime_lockfile_reproducer_plan.json`
- `node_runtime_lockfile_reproducer_artifacts/`
- `node_runtime_lockfile_reproducer_verification.json`
