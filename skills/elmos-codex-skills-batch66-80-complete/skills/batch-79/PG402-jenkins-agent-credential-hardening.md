---
name: b79-jenkins-agent-credential-hardening
description: "Use when ELMOS must enforce and test Jenkins Agent Credential Hardening for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Jenkins Agent Credential Hardening, Batch 79, GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification."
metadata:
  id: PG402
  batch: 79
  version: 1.0.0
...
# PG402 — Jenkins Agent Credential Hardening

## Objective

Enforce and test Jenkins Agent Credential Hardening for GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `jenkins-agent-credential-hardening` tasks involving GitHub Actions, GitLab CI, Jenkins pipelines, reusable components, runners, permissions, OIDC, caches, environments, releases, provenance, and cross-system certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG390`, `PG401`.
...
- `jenkins_agent_credential_hardening_plan.json`
- `jenkins_agent_credential_hardening_artifacts/`
- `jenkins_agent_credential_hardening_verification.json`
...
- Scope credentials and avoid Groovy interpolation of secrets.
- Test post-cleanup and shared-library compatibility.
