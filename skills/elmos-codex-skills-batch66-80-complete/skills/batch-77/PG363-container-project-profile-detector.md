...
# PG363 — Container Project Profile Detector
...
Use for `container-project-profile-detector` tasks involving Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG362`.
...
- `container_project_profile_detector.json`
- `container_project_profile_detector_artifacts/`
- `container_project_profile_detector_verification.json`
