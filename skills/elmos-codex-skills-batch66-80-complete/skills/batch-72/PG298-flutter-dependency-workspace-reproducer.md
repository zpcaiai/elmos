---
name: b72-flutter-dependency-workspace-reproducer
description: "Use when ELMOS must reproduce deterministically Flutter Dependency Workspace Reproducer for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Flutter Dependency Workspace Reproducer, Batch 72, Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging."
metadata:
  id: PG298
  batch: 72
  version: 1.0.0
...
# PG298 — Flutter Dependency Workspace Reproducer

## Objective

Reproduce deterministically Flutter Dependency Workspace Reproducer for Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `flutter-dependency-workspace-reproducer` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG297`.
...
- `flutter_dependency_workspace_reproducer_plan.json`
- `flutter_dependency_workspace_reproducer_artifacts/`
- `flutter_dependency_workspace_reproducer_verification.json`
