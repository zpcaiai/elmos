---
name: b71-cargo-workspace-dependency-reproducer
description: "Use when ELMOS must reproduce deterministically Cargo Workspace Dependency Reproducer for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Cargo Workspace Dependency Reproducer, Batch 71, Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases."
metadata:
  id: PG286
  batch: 71
  version: 1.0.0
...
# PG286 — Cargo Workspace Dependency Reproducer

## Objective

Reproduce deterministically Cargo Workspace Dependency Reproducer for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `cargo-workspace-dependency-reproducer` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`, `PG285`.
...
- `cargo_workspace_dependency_reproducer_plan.json`
- `cargo_workspace_dependency_reproducer_artifacts/`
- `cargo_workspace_dependency_reproducer_verification.json`
