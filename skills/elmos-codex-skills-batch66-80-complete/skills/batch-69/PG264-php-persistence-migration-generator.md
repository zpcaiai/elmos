...
# PG264 — Php Persistence Migration Generator

## Objective

Generate runnable and maintainable Php Persistence Migration Generator for PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `php-persistence-migration-generator` tasks involving PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG258`, `PG263`.
...
- `php_persistence_migration_generator_plan.json`
- `php_persistence_migration_generator_artifacts/`
- `php_persistence_migration_generator_verification.json`
...
- Record PHP extensions and web/CLI entrypoints.
- Use Composer lock and static analysis.
- Test authorization, serialization exposure, queues, and migrations.
