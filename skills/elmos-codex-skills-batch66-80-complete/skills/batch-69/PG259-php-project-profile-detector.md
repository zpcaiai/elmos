...
# PG259 — Php Project Profile Detector

## Objective

Inspect and model Php Project Profile Detector for PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `php-project-profile-detector` tasks involving PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG258`.
...
- `php_project_profile_detector.json`
- `php_project_profile_detector_artifacts/`
- `php_project_profile_detector_verification.json`
