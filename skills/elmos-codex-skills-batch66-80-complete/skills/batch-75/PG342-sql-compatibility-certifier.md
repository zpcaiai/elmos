...
# PG342 — SQL Compatibility Certifier

## Objective

Execute and independently verify SQL Compatibility Certifier for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `sql-compatibility-certifier` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG341`.
...
- `sql_compatibility_certifier_plan.json`
- `sql_compatibility_certifier_artifacts/`
- `sql_compatibility_certifier_verification.json`
