---
name: b67-go-http-grpc-service-generator
description: "Use when ELMOS must generate runnable and maintainable Go HTTP gRPC Service Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Go HTTP gRPC Service Generator, Batch 67, Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation."
metadata:
  id: PG237
  batch: 67
  version: 1.0.0
...
# PG237 — Go HTTP gRPC Service Generator

## Objective

Generate runnable and maintainable Go HTTP gRPC Service Generator for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-http-grpc-service-generator` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`, `PG236`.
...
- `go_http_grpc_service_generator_plan.json`
- `go_http_grpc_service_generator_artifacts/`
- `go_http_grpc_service_generator_verification.json`
