---
name: b67-go-build-crosscompile-certifier
description: "Use when ELMOS must execute and independently verify Go Build Crosscompile Certifier for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Go Build Crosscompile Certifier, Batch 67, Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation."
metadata:
  id: PG246
  batch: 67
  version: 1.0.0
...
# PG246 — Go Build Crosscompile Certifier

## Objective

Execute and independently verify Go Build Crosscompile Certifier for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-build-crosscompile-certifier` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`, `PG245`.
...
- `go_build_crosscompile_certifier_plan.json`
- `go_build_crosscompile_certifier_artifacts/`
- `go_build_crosscompile_certifier_verification.json`
