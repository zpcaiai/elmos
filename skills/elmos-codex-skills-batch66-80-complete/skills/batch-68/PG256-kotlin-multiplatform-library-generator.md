---
name: b68-kotlin-multiplatform-library-generator
description: "Use when ELMOS must generate runnable and maintainable Kotlin Multiplatform Library Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Kotlin Multiplatform Library Generator, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG256
  batch: 68
  version: 1.0.0
...
# PG256 — Kotlin Multiplatform Library Generator

## Objective

Generate runnable and maintainable Kotlin Multiplatform Library Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `kotlin-multiplatform-library-generator` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG255`.
...
- `kotlin_multiplatform_library_generator_plan.json`
- `kotlin_multiplatform_library_generator_artifacts/`
- `kotlin_multiplatform_library_generator_verification.json`
