---
name: b68-spring-kotlin-service-generator
description: "Use when ELMOS must generate runnable and maintainable Spring Kotlin Service Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Spring Kotlin Service Generator, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG249
  batch: 68
  version: 1.0.0
...
# PG249 — Spring Kotlin Service Generator

## Objective

Generate runnable and maintainable Spring Kotlin Service Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `spring-kotlin-service-generator` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG248`.
...
- `spring_kotlin_service_generator_plan.json`
- `spring_kotlin_service_generator_artifacts/`
- `spring_kotlin_service_generator_verification.json`
