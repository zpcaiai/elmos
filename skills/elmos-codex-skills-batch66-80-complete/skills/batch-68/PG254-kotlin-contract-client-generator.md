---
name: b68-kotlin-contract-client-generator
description: "Use when ELMOS must generate runnable and maintainable Kotlin Contract Client Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Kotlin Contract Client Generator, Batch 68, Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform."
metadata:
  id: PG254
  batch: 68
  version: 1.0.0
...
# PG254 — Kotlin Contract Client Generator

## Objective

Generate runnable and maintainable Kotlin Contract Client Generator for Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `kotlin-contract-client-generator` tasks involving Kotlin JVM, Spring, Ktor, coroutines, data access, Java interoperability, Android Compose, and Kotlin Multiplatform.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG246`, `PG253`.
...
- `kotlin_contract_client_generator_plan.json`
- `kotlin_contract_client_generator_artifacts/`
- `kotlin_contract_client_generator_verification.json`
