---
name: b78-terraform-module-scaffolder
description: "Use when ELMOS must generate runnable and maintainable Terraform Module Scaffolder for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Terraform Module Scaffolder, Batch 78, Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification."
metadata:
  id: PG376
  batch: 78
  version: 1.0.0
...
# PG376 — Terraform Module Scaffolder

## Objective

Generate runnable and maintainable Terraform Module Scaffolder for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `terraform-module-scaffolder` tasks involving Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG374`, `PG375`.
...
- `terraform_module_scaffolder_plan.json`
- `terraform_module_scaffolder_artifacts/`
- `terraform_module_scaffolder_verification.json`
...
- Pin providers and protect state with locking/encryption where supported.
- Require plan and policy review before apply.
- Deny unattended destructive apply.
