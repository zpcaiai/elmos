---
name: b78-terraform-plan-policy-cost-gate
description: "Use when ELMOS must enforce and test Terraform Plan Policy Cost Gate for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Terraform Plan Policy Cost Gate, Batch 78, Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification."
metadata:
  id: PG378
  batch: 78
  version: 1.0.0
...
# PG378 — Terraform Plan Policy Cost Gate

## Objective

Enforce and test Terraform Plan Policy Cost Gate for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `terraform-plan-policy-cost-gate` tasks involving Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG374`, `PG377`.
...
- `terraform_plan_policy_cost_gate_plan.json`
- `terraform_plan_policy_cost_gate_artifacts/`
- `terraform_plan_policy_cost_gate_verification.json`
