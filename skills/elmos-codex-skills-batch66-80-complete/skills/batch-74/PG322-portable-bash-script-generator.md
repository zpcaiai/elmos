---
name: b74-portable-bash-script-generator
description: "Use when ELMOS must generate runnable and maintainable Portable Bash Script Generator for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Portable Bash Script Generator, Batch 74, Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests."
metadata:
  id: PG322
  batch: 74
  version: 1.0.0
...
# PG322 — Portable Bash Script Generator

## Objective

Generate runnable and maintainable Portable Bash Script Generator for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `portable-bash-script-generator` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`, `PG321`.
...
- `portable_bash_script_generator_plan.json`
- `portable_bash_script_generator_artifacts/`
- `portable_bash_script_generator_verification.json`
