...
# PG331 — Powershell Remoting Crossplatform

## Objective

Implement and validate Powershell Remoting Crossplatform for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `powershell-remoting-crossplatform` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`, `PG330`.
...
- `powershell_remoting_crossplatform_plan.json`
- `powershell_remoting_crossplatform_artifacts/`
- `powershell_remoting_crossplatform_verification.json`
