---
name: b46-customer-handoff-maintenance-acceptance
description: 自动生成架构、开发、部署、Runbook、Known Difference和技术债，并验证目标团队独立操作。
---

# Skill 1515：客户交接与目标团队维护验收
...
自动生成架构、开发、部署、Runbook、Known Difference和技术债，并验证目标团队独立操作。
...
- 目标团队必须独立Build、运行、修改、发布、处置故障和升级依赖；失败阻止最终验收。
