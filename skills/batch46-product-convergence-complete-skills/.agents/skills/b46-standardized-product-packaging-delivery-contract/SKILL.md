---
name: b46-standardized-product-packaging-delivery-contract
description: 定义Assessment、POC、Migration Factory、Enterprise Platform、Managed Migration的输入输出、验收、价格和责任。
---

# Skill 1524：标准化产品套餐与交付合同
...
定义Assessment、POC、Migration Factory、Enterprise Platform、Managed Migration的输入输出、验收、价格和责任。
...
- 产品套餐必须清楚列出输入、输出、范围、支持路线、人工服务、验收、周期、价格和不包含项。
...
- `product/packages/`
- `contracts/commercial/delivery-package.schema.json`
