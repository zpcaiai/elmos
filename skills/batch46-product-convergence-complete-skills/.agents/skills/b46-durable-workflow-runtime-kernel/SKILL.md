---
name: b46-durable-workflow-runtime-kernel
description: 提供版本化Workflow、Step、Lease、Retry、Checkpoint、Compensation、Human Task、Budget和Cancellation内核。
---

# Skill 1501：统一Durable Workflow Runtime
...
提供版本化Workflow、Step、Lease、Retry、Checkpoint、Compensation、Human Task、Budget和Cancellation内核。
...
- Step必须幂等；所有外部副作用有Idempotency Key；Workflow定义版本化；长任务升级后可恢复。
...
- `services/control-plane/workflows/`
- `contracts/workflow/`
