---
name: b46-product-convergence-complete-certification-gate
description: 拒绝缺少统一内核、真实Runner、完整Reference Route、两家客户、接管和盈利交付证据的认证。
---

# Skill 1536：Batch 46 Complete最终认证门禁
...
拒绝缺少统一内核、真实Runner、完整Reference Route、两家客户、接管和盈利交付证据的认证。
...
- 统一内核、Reference Route、Runner、两家客户、Handoff和盈利交付任一缺失即不得certified。
...
- `certification/reference-product/final/`
