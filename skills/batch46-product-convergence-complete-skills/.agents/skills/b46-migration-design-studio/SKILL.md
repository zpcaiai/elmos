---
name: b46-migration-design-studio
description: 提供源目标架构、模块/API/数据库映射、Wave、风险、成本和Cutover可视化设计。
---

# Skill 1514：Migration Design Studio
...
提供源目标架构、模块/API/数据库映射、Wave、风险、成本和Cutover可视化设计。
...
- 设计决策必须版本化并生成ADR；手工调整映射要进入后续执行与影响分析。
...
- `apps/web/src/features/migration-studio/`
