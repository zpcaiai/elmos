---
name: b46-core-extension-boundary-plugin-kernel
description: 冻结稳定Core Kernel，将语言、框架、数据库、Cloud、Comparator、Recipe和Agent Specialist放入受控扩展层。
---

# Skill 1506：产品内核与扩展边界
...
冻结稳定Core Kernel，将语言、框架、数据库、Cloud、Comparator、Recipe和Agent Specialist放入受控扩展层。
...
- Core只保留稳定平台职责；领域转换必须经SDK/Pack；扩展不得依赖非公开内部类。
...
- `docs/architecture/core-extension-boundary.md`
- `sdk/`
- `extensions/`
