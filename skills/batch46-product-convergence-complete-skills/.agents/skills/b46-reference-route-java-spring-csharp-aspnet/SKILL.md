---
name: b46-reference-route-java-spring-csharp-aspnet
description: 完成首条从真实仓库到生产Canary、Cutover、Hypercare和Handoff的完整迁移路线。
---

# Skill 1519：Java/Spring到C#/ASP.NET Core Reference Route
...
完成首条从真实仓库到生产Canary、Cutover、Hypercare和Handoff的完整迁移路线。
...
- Reference Route必须真实调用源目标工具链，达到Build/Behavior/Security/Maintainability/Production/Handoff Green。
...
- `routes/java-spring-to-csharp-aspnet/`
- `reference-apps/`
- `tests/reference-route/`
