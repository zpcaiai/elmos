---
name: b46-pack-lifecycle-version-certification
description: 统一draft到revoked生命周期、兼容、续证、EOL和撤销传播。
---

# Skill 1505：统一Pack生命周期、版本与认证
...
统一draft到revoked生命周期、兼容、续证、EOL和撤销传播。
...
- certified状态绑定精确Artifact和Evidence；过期、撤销、EOL必须影响消费者；不能手改状态。
...
- `services/control-plane/certification/`
- `contracts/lifecycle/`
