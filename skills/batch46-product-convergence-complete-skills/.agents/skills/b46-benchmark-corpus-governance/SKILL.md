---
name: b46-benchmark-corpus-governance
description: 隔离Synthetic、Open-source、Internal Holdout、Customer-private Corpus并防止训练和Golden污染。
---

# Skill 1511：统一Benchmark Corpus治理
...
隔离Synthetic、Open-source、Internal Holdout、Customer-private Corpus并防止训练和Golden污染。
...
- Development不能进入Holdout；客户A数据不能训练客户B资产；目标输出不能自动改Golden。
