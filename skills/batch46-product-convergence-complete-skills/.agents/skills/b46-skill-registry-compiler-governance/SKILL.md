---
name: b46-skill-registry-compiler-governance
description: 治理Skill版本、Owner、触发器、依赖、工具、输入输出、风险、测试、弃用和冲突。
---

# Skill 1508：Skill Registry与Skill Compiler
...
治理Skill版本、Owner、触发器、依赖、工具、输入输出、风险、测试、弃用和冲突。
...
- Skill必须有Owner、版本、触发器、前置、工具、输入输出、风险、测试、停止条件和弃用替代。
