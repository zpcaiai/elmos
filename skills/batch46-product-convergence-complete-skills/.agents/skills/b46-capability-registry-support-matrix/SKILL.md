---
name: b46-capability-registry-support-matrix
description: 集中发布能力状态、精确支持范围、Owner、限制、证据、成本和EOL。
---

# Skill 1504：Capability Registry与支持矩阵
...
集中发布能力状态、精确支持范围、Owner、限制、证据、成本和EOL。
...
- 客户可见支持状态只能来自认证Evidence；detected-only不得显示为supported；限制与Owner必须公开。
...
- `services/control-plane/capabilities/registry/`
