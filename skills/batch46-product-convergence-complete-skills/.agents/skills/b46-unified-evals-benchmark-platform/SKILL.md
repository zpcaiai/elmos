---
name: b46-unified-evals-benchmark-platform
description: 统一Route、Framework、Recipe、Runner、Agent、Extension和客户私有Evals、回归与Promotion Gate。
---

# Skill 1521：统一Evals与Benchmark平台
...
统一Route、Framework、Recipe、Runner、Agent、Extension和客户私有Evals、回归与Promotion Gate。
...
- 所有Eval有Dataset、Scenario、Metric、Threshold、Run、Comparison和Promotion Gate；结果可重放。
