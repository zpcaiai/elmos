---
name: b46-product-edition-scope-rationalization
description: 早期仅保留SaaS、Enterprise Private Runner、Self-hosted/Air-gap，按真实订单扩Edition。
---

# Skill 1523：产品Edition范围收敛
...
早期仅保留SaaS、Enterprise Private Runner、Self-hosted/Air-gap，按真实订单扩Edition。
...
- Edition扩展需真实订单与能力证明；早期测试矩阵必须可承担。
