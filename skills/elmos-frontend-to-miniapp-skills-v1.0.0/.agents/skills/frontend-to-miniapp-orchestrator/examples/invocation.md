...
```text
$frontend-to-miniapp-orchestrator 读取 runs/demo/conversion-request.json，执行任务 MAPP-001, MAPP-002。
...
```text
/frontend-to-miniapp-orchestrator runs/demo/conversion-request.json
```
