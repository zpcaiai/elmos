# miniapp-style-layout-converter — 执行契约
...
```json
{
  "artifact_id": "miniapp-style-layout-converter:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "miniapp-style-layout-converter",
  "task_id": "MAPP-019",
  "status": "passed"
}
```
...
```json
{
  "skill": "miniapp-style-layout-converter",
  "task_ids": ["MAPP-019", "MAPP-020"],
  "status": "passed",
  "artifacts": [],
  "gate_results": [],
  "next_skills": []
