...
```text
$miniapp-differential-testing 读取 runs/demo/conversion-request.json，执行任务 MAPP-031, MAPP-032。
...
```text
/miniapp-differential-testing runs/demo/conversion-request.json
```
