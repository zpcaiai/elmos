# miniapp-ci-build-release — 执行契约

## 调用边界

- 阶段：`delivery`
- 任务 ID：MAPP-037, MAPP-038
- 上游技能：miniapp-auto-repair-loop, miniapp-privacy-permission-auditor
...
```json
{
  "artifact_id": "miniapp-ci-build-release:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "miniapp-ci-build-release",
  "task_id": "MAPP-037",
  "status": "passed"
}
```
...
```json
{
  "skill": "miniapp-ci-build-release",
  "task_ids": ["MAPP-037", "MAPP-038"],
  "status": "passed",
  "artifacts": [],
  "gate_results": [],
  "next_skills": []
