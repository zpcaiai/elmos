# miniapp-third-party-dependency-migrator — 执行契约

## 调用边界

- 阶段：`planning`
- 任务 ID：MAPP-021, MAPP-022
- 上游技能：miniapp-source-framework-detector, miniapp-capability-registry
...
```json
{
  "artifact_id": "miniapp-third-party-dependency-migrator:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "miniapp-third-party-dependency-migrator",
  "task_id": "MAPP-021",
  "status": "passed"
}
```
