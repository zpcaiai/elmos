# miniapp-semantic-ir — 执行契约

## 调用边界

- 阶段：`ir`
- 任务 ID：MAPP-011, MAPP-012
- 上游技能：vue-to-miniapp-analyzer, react-to-miniapp-analyzer, flutter-widget-semantic-reconstructor
...
```json
{
  "artifact_id": "miniapp-semantic-ir:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "miniapp-semantic-ir",
  "task_id": "MAPP-011",
  "status": "passed"
}
```
