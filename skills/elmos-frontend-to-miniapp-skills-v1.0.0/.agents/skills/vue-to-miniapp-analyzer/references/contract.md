...
```json
{
  "artifact_id": "vue-to-miniapp-analyzer:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "vue-to-miniapp-analyzer",
  "task_id": "MAPP-005",
  "status": "passed"
}
```
...
```json
{
  "skill": "vue-to-miniapp-analyzer",
  "task_ids": ["MAPP-005", "MAPP-006"],
  "status": "passed",
  "artifacts": [],
  "gate_results": [],
  "next_skills": []
