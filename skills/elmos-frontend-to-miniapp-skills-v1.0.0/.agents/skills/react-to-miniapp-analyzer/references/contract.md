# react-to-miniapp-analyzer — 执行契约

## 调用边界

- 阶段：`source-analysis`
- 任务 ID：MAPP-007, MAPP-008
- 上游技能：miniapp-source-framework-detector
...
```json
{
  "artifact_id": "react-to-miniapp-analyzer:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "react-to-miniapp-analyzer",
  "task_id": "MAPP-007",
  "status": "passed"
}
```
...
```json
{
  "skill": "react-to-miniapp-analyzer",
  "task_ids": ["MAPP-007", "MAPP-008"],
  "status": "passed",
  "artifacts": [],
  "gate_results": [],
  "next_skills": []
