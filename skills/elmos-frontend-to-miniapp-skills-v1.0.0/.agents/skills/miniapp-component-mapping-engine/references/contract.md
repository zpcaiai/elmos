# miniapp-component-mapping-engine — 执行契约

## 调用边界

- 阶段：`planning`
- 任务 ID：MAPP-015, MAPP-016
- 上游技能：miniapp-semantic-ir, miniapp-capability-registry
...
```json
{
  "artifact_id": "miniapp-component-mapping-engine:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "miniapp-component-mapping-engine",
  "task_id": "MAPP-015",
  "status": "passed"
}
```
...
```json
{
  "skill": "miniapp-component-mapping-engine",
  "task_ids": ["MAPP-015", "MAPP-016"],
  "status": "passed",
  "artifacts": [],
  "gate_results": [],
  "next_skills": []
