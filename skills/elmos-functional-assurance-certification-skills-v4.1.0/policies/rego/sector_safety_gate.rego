package elmos.certification.sector_safety_gate
...
# Policy intent: sector safety claim requires applicable profile, hazard analysis, fallback and independent evidence.
