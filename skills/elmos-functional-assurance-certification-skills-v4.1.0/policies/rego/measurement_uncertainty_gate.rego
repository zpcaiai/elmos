package elmos.certification.measurement_uncertainty_gate
...
# Policy intent: critical conformity decision requires declared uncertainty and policy-approved decision rule.
