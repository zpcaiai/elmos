package elmos.ai_factory.v4.certificate_admission
import rego.v1
...
# Intent: deny deployment when certificate scope, artifact digest, environment, policy or freshness does not match.
