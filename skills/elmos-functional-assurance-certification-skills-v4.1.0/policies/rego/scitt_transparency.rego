package elmos.ai_factory.v4.scitt_transparency
import rego.v1
...
# Intent: deny transparency success when statement, receipt, signer, tenant disclosure or revocation is unresolved.
