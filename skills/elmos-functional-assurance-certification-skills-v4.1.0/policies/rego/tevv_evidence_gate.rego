package elmos.certification.tevv_evidence_gate
...
# Policy intent: TEVV claim requires representative scenario, valid metric, uncertainty and independent review.
