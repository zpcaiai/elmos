package elmos.certification.accreditation_scope_gate
...
# Policy intent: certificate body and laboratory competence must cover the exact claimed technical scope.
