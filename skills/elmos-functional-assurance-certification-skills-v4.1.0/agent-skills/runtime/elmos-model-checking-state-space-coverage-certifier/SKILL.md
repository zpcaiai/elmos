---
name: elmos-model-checking-state-space-coverage-certifier
description: Implement and independently certify model checking state-space coverage certifier, including declare state variables, bounds, fairness, symmetry and reduction assumptions, report explored state space, counterexamples and unsearched regions and separate bounded model checking from unbounded proof.
version: 4.0.0
...
# Model Checking State-Space Coverage Certifier
...
- `ModelCheckingStateSpaceCoverageCertifierProfile`
- `ModelCheckingStateSpaceCoverageCertifierRun`
- `ModelCheckingStateSpaceCoverageCertifierFinding`
- `ModelCheckingStateSpaceCoverageCertifierDecision`
- `ModelCheckingStateSpaceCoverageCertifierEvidence`

Required semantic capabilities:

- declare state variables, bounds, fairness, symmetry and reduction assumptions
- report explored state space, counterexamples and unsearched regions
- separate bounded model checking from unbounded proof
...
- `artifacts/elmos-model-checking-state-space-coverage-certifier/profile.yaml`
- `artifacts/elmos-model-checking-state-space-coverage-certifier/plan.json`
- `artifacts/elmos-model-checking-state-space-coverage-certifier/result.json`
- `artifacts/elmos-model-checking-state-space-coverage-certifier/evidence/`
- `artifacts/elmos-model-checking-state-space-coverage-certifier/assurance-case.json`
...
- **state bound excludes real failure** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **partial-order reduction is unsound for effect ordering** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **liveness property lacks fairness assumption** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: declare state variables, bounds, fairness, symmetry and reduction assumptions
- native scenario: report explored state space, counterexamples and unsearched regions
- native scenario: separate bounded model checking from unbounded proof
