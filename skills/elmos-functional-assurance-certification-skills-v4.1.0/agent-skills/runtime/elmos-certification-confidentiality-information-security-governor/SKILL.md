...
# Certification Confidentiality and Information Security Governor
...
- `CertificationConfidentialityAndInformationSecurityGovernorProfile`
- `CertificationConfidentialityAndInformationSecurityGovernorRun`
- `CertificationConfidentialityAndInformationSecurityGovernorFinding`
- `CertificationConfidentialityAndInformationSecurityGovernorDecision`
- `CertificationConfidentialityAndInformationSecurityGovernorEvidence`

Required semantic capabilities:

- classify applicant, test, vulnerability, appeal and personnel information
- enforce need-to-know, secure transfer, clean-room use and disclosure authorization
- balance confidentiality with public certificate and incident obligations
...
- `elmos-outsourced-certification-activity-control-governor`

### External Package Dependencies

- `elmos-zero-trust-service-identity-policy-compiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-certification-confidentiality-information-security-governor/profile.yaml`
- `artifacts/elmos-certification-confidentiality-information-security-governor/plan.json`
- `artifacts/elmos-certification-confidentiality-information-security-governor/result.json`
- `artifacts/elmos-certification-confidentiality-information-security-governor/evidence/`
- `artifacts/elmos-certification-confidentiality-information-security-governor/assurance-case.json`
...
- **competitor data leaks through benchmark corpus** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **vulnerability detail is published prematurely** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **confidentiality blocks regulator disclosure** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify applicant, test, vulnerability, appeal and personnel information
- native scenario: enforce need-to-know, secure transfer, clean-room use and disclosure authorization
- native scenario: balance confidentiality with public certificate and incident obligations
