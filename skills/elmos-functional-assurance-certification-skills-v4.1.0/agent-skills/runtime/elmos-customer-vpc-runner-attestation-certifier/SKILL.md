---
name: elmos-customer-vpc-runner-attestation-certifier
description: Certify customer-hosted runners for identity, isolation, data residency, network, secrets, toolchain, evidence delivery and recovery without requiring source exfiltration.
version: 4.0.0
...
# Customer VPC Runner Attestation Certifier
...
- Enroll workload identity and trust domain
- Attest software/configuration and sandbox controls
- Verify source/data residency and egress policy
- Stream signed evidence without raw sensitive content
- Rotate, suspend and revoke runner certificates
...
- `elmos-agent-workload-delegated-identity-controller` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `customer-runner-certificate.json`
- `runner-attestation-bundle/`
- `runner-policy-profile.yaml`
- `runner-revocation-record.json`
...
- **customer runner impersonation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence fabricated locally** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **egress tunnel** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared runner tenant bleed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **attestation unavailable but work continues** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- network deny
- secret broker
- source remains in VPC
- signed evidence upload
- runner drift suspension
