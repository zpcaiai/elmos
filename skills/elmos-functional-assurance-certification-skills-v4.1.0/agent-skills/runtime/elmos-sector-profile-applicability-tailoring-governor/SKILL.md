---
name: elmos-sector-profile-applicability-tailoring-governor
description: Implement and independently certify sector assurance profile applicability and tailoring governor, including determine applicable sector standards, regulators, product classification and lifecycle stage, tailor controls only with documented rationale and compensating evidence and manage conflicts, precedence, effective dates and external expert approval.
version: 4.0.0
...
# Sector Assurance Profile Applicability and Tailoring Governor
...
- `SectorAssuranceProfileApplicabilityAndTailoringGovernorProfile`
- `SectorAssuranceProfileApplicabilityAndTailoringGovernorRun`
- `SectorAssuranceProfileApplicabilityAndTailoringGovernorFinding`
- `SectorAssuranceProfileApplicabilityAndTailoringGovernorDecision`
- `SectorAssuranceProfileApplicabilityAndTailoringGovernorEvidence`

Required semantic capabilities:

- determine applicable sector standards, regulators, product classification and lifecycle stage
- tailor controls only with documented rationale and compensating evidence
- manage conflicts, precedence, effective dates and external expert approval
...
- `elmos-conformity-assessment-scheme-architecture-compiler`

### External Package Dependencies

- `elmos-ai-compliance-profile-compiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-sector-profile-applicability-tailoring-governor/profile.yaml`
- `artifacts/elmos-sector-profile-applicability-tailoring-governor/plan.json`
- `artifacts/elmos-sector-profile-applicability-tailoring-governor/result.json`
- `artifacts/elmos-sector-profile-applicability-tailoring-governor/evidence/`
- `artifacts/elmos-sector-profile-applicability-tailoring-governor/assurance-case.json`
...
- **organization selects easiest sector profile** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tailoring removes mandatory obligation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **outdated standard remains active after transition** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: determine applicable sector standards, regulators, product classification and lifecycle stage
- native scenario: tailor controls only with documented rationale and compensating evidence
- native scenario: manage conflicts, precedence, effective dates and external expert approval
