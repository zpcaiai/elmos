---
name: elmos-ai-golden-route-continuous-agent-certification
description: Certify the loop from privacy-filtered production traces to versioned evals, calibrated judges, behavior fingerprints,
  shadow rollout and recertification.
version: 4.0.0
...
# Golden Route: Continuous Agent Certification
...
- **Kernel authorities used:** K2, K4, K6, K7, K8
...
- `GoldenRouteContinuousAgentCertificationRun`
- `GoldenRouteContinuousAgentCertificationDecision`

Required semantic capabilities:

- Trace-to-counterexample curation
- Dataset and judge governance
- Provider fingerprint baseline
- No-side-effect shadow and canary
- Drift invalidation and rollback
...
- `elmos-ai-online-shadow-eval-controller` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
- `elmos-ai-eval-dataset-governor` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `golden-routes/continuous-cert/evidence/`
- `continuous-certificate.json`
- `drift-timeline.jsonl`
...
- **production data misuse** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **judge becomes oracle** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **drift ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shadow side effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **certificate not revoked** — must have a preventive control, a detective signal, a negative fixture and a response action.
