...
# RATS, EAT and CoRIM Attestation Appraisal Controller
...
- `RATSEATAndCoRIMAttestationAppraisalControllerProfile`
- `RATSEATAndCoRIMAttestationAppraisalControllerRun`
- `RATSEATAndCoRIMAttestationAppraisalControllerFinding`
- `RATSEATAndCoRIMAttestationAppraisalControllerDecision`
- `RATSEATAndCoRIMAttestationAppraisalControllerEvidence`

Required semantic capabilities:

- normalize attestation evidence, endorsements and reference values into appraisal claims
- verify freshness, key binding, verifier identity and appraisal policy
- emit attestation result with explicit trustworthiness scope and uncertainty
...
- `elmos-hardware-root-of-trust-measured-boot-verifier`

## Primary Outputs

- `artifacts/elmos-rats-eat-corim-attestation-appraisal-controller/profile.yaml`
- `artifacts/elmos-rats-eat-corim-attestation-appraisal-controller/plan.json`
- `artifacts/elmos-rats-eat-corim-attestation-appraisal-controller/result.json`
- `artifacts/elmos-rats-eat-corim-attestation-appraisal-controller/evidence/`
- `artifacts/elmos-rats-eat-corim-attestation-appraisal-controller/assurance-case.json`
...
- **evidence transformation changes semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **endorsement issuer is untrusted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **attestation result is reused outside freshness window** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: normalize attestation evidence, endorsements and reference values into appraisal claims
- native scenario: verify freshness, key binding, verifier identity and appraisal policy
- native scenario: emit attestation result with explicit trustworthiness scope and uncertainty
