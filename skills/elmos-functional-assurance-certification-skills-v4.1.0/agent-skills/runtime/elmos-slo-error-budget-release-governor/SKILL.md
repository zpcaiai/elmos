---
name: elmos-slo-error-budget-release-governor
description: Govern release and promotion decisions using service-level objectives, error budgets, quality/cost objectives, burn rates and customer commitments.
version: 4.0.0
...
# SLO and Error Budget Release Governor
...
- Compile measurable SLI/SLO and windows
- Track fast/slow burn and data completeness
- Separate external dependency and internal responsibility
- Block risky release when budget policy requires
- Record authorized exception and customer impact
...
- `release-reliability-decision.json`
...
- **SLI excludes failures** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **error budget reset manipulated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **missing data treated healthy** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider outage always excluded** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **waiver bypasses customer SLA** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- availability SLO
- latency SLO
- correctness/grounding SLO
- cost budget
- fast burn block
- missing telemetry block
