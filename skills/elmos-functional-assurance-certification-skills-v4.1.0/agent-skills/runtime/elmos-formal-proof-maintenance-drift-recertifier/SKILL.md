...
# Formal Proof Maintenance and Drift Recertifier
...
- `FormalProofMaintenanceAndDriftRecertifierProfile`
- `FormalProofMaintenanceAndDriftRecertifierRun`
- `FormalProofMaintenanceAndDriftRecertifierFinding`
- `FormalProofMaintenanceAndDriftRecertifierDecision`
- `FormalProofMaintenanceAndDriftRecertifierEvidence`

Required semantic capabilities:

- compute proof dependency graph for code, model, library, solver and assumption changes
- reuse only unaffected proof nodes with exact validity evidence
- schedule incremental replay and full periodic clean-room verification
...
- `artifacts/elmos-formal-proof-maintenance-drift-recertifier/profile.yaml`
- `artifacts/elmos-formal-proof-maintenance-drift-recertifier/plan.json`
- `artifacts/elmos-formal-proof-maintenance-drift-recertifier/result.json`
- `artifacts/elmos-formal-proof-maintenance-drift-recertifier/evidence/`
- `artifacts/elmos-formal-proof-maintenance-drift-recertifier/assurance-case.json`
...
- **stale proof reused after semantic library change** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dependency graph misses generated artifact** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **proof replay success hides changed requirement** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compute proof dependency graph for code, model, library, solver and assumption changes
- native scenario: reuse only unaffected proof nodes with exact validity evidence
- native scenario: schedule incremental replay and full periodic clean-room verification
