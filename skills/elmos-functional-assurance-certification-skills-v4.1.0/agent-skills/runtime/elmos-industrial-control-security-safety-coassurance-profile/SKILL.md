...
# Industrial Control Security-Safety Co-Assurance Profile
...
- `IndustrialControlSecuritySafetyCoAssuranceProfileProfile`
- `IndustrialControlSecuritySafetyCoAssuranceProfileRun`
- `IndustrialControlSecuritySafetyCoAssuranceProfileFinding`
- `IndustrialControlSecuritySafetyCoAssuranceProfileDecision`
- `IndustrialControlSecuritySafetyCoAssuranceProfileEvidence`

Required semantic capabilities:

- combine functional safety lifecycle with industrial cybersecurity zones, conduits and security levels
- analyze safety-security control conflicts and common-cause failures
- verify patching, remote access, incident response and safe operation
...
- `elmos-safety-integrity-level-assurance-profile-compiler`
...
- `artifacts/elmos-industrial-control-security-safety-coassurance-profile/profile.yaml`
- `artifacts/elmos-industrial-control-security-safety-coassurance-profile/plan.json`
- `artifacts/elmos-industrial-control-security-safety-coassurance-profile/result.json`
- `artifacts/elmos-industrial-control-security-safety-coassurance-profile/evidence/`
- `artifacts/elmos-industrial-control-security-safety-coassurance-profile/assurance-case.json`
...
- **security isolation blocks emergency safety action** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **legacy protocol trust assumption remains** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **patch deferral has no compensating control** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: combine functional safety lifecycle with industrial cybersecurity zones, conduits and security levels
- native scenario: analyze safety-security control conflicts and common-cause failures
- native scenario: verify patching, remote access, incident response and safe operation
