...
# Verifiable Credential Assurance Certificate Emitter
...
- `VerifiableCredentialAssuranceCertificateEmitterProfile`
- `VerifiableCredentialAssuranceCertificateEmitterRun`
- `VerifiableCredentialAssuranceCertificateEmitterFinding`
- `VerifiableCredentialAssuranceCertificateEmitterDecision`
- `VerifiableCredentialAssuranceCertificateEmitterEvidence`

Required semantic capabilities:

- emit standards-compatible verifiable certificate credentials with selective disclosure where appropriate
- bind holder, subject, issuer, evidence and status mechanisms
- verify presentation nonce, audience, purpose and anti-replay
...
- `artifacts/elmos-verifiable-credential-assurance-certificate-emitter/profile.yaml`
- `artifacts/elmos-verifiable-credential-assurance-certificate-emitter/plan.json`
- `artifacts/elmos-verifiable-credential-assurance-certificate-emitter/result.json`
- `artifacts/elmos-verifiable-credential-assurance-certificate-emitter/evidence/`
- `artifacts/elmos-verifiable-credential-assurance-certificate-emitter/assurance-case.json`
...
- **holder can present certificate for another deployment** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **selective disclosure removes limitation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **credential proof suite is unsupported by verifier** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: emit standards-compatible verifiable certificate credentials with selective disclosure where appropriate
- native scenario: bind holder, subject, issuer, evidence and status mechanisms
- native scenario: verify presentation nonce, audience, purpose and anti-replay
