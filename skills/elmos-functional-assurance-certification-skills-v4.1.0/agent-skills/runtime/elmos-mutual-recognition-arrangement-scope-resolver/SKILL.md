...
# Mutual Recognition Arrangement Scope Resolver
...
- `MutualRecognitionArrangementScopeResolverProfile`
- `MutualRecognitionArrangementScopeResolverRun`
- `MutualRecognitionArrangementScopeResolverFinding`
- `MutualRecognitionArrangementScopeResolverDecision`
- `MutualRecognitionArrangementScopeResolverEvidence`

Required semantic capabilities:

- resolve signatory, arrangement level, standard, sector, geography and effective date
- verify issuer accreditation and certificate fall within recognized scope
- emit accepted, conditional, unrecognized or regulator-review result
...
- `elmos-cross-scheme-claim-mapping-equivalence-verifier`

## Primary Outputs

- `artifacts/elmos-mutual-recognition-arrangement-scope-resolver/profile.yaml`
- `artifacts/elmos-mutual-recognition-arrangement-scope-resolver/plan.json`
- `artifacts/elmos-mutual-recognition-arrangement-scope-resolver/result.json`
- `artifacts/elmos-mutual-recognition-arrangement-scope-resolver/evidence/`
- `artifacts/elmos-mutual-recognition-arrangement-scope-resolver/assurance-case.json`
...
- **signatory status is current but scope is wrong** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **recognition applies to test report not product certificate** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **transition between organizations breaks chain** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: resolve signatory, arrangement level, standard, sector, geography and effective date
- native scenario: verify issuer accreditation and certificate fall within recognized scope
- native scenario: emit accepted, conditional, unrecognized or regulator-review result
