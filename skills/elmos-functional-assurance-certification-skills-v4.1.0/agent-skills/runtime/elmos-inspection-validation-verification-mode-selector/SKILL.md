---
name: elmos-inspection-validation-verification-mode-selector
description: Implement and independently certify inspection, validation and verification mode selector, including distinguish inspection of present state from validation of intended future use and verification of historical claims, select first-, second- or third-party mode with explicit independence class and compile method-specific evidence and sampling obligations.
version: 4.0.0
...
# Inspection, Validation and Verification Mode Selector
...
- `InspectionValidationAndVerificationModeSelectorProfile`
- `InspectionValidationAndVerificationModeSelectorRun`
- `InspectionValidationAndVerificationModeSelectorFinding`
- `InspectionValidationAndVerificationModeSelectorDecision`
- `InspectionValidationAndVerificationModeSelectorEvidence`

Required semantic capabilities:

- distinguish inspection of present state from validation of intended future use and verification of historical claims
- select first-, second- or third-party mode with explicit independence class
- compile method-specific evidence and sampling obligations
...
- `artifacts/elmos-inspection-validation-verification-mode-selector/profile.yaml`
- `artifacts/elmos-inspection-validation-verification-mode-selector/plan.json`
- `artifacts/elmos-inspection-validation-verification-mode-selector/result.json`
- `artifacts/elmos-inspection-validation-verification-mode-selector/evidence/`
- `artifacts/elmos-inspection-validation-verification-mode-selector/assurance-case.json`
...
- **future-use claim is incorrectly verified using historical evidence only** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **inspection result is generalized beyond inspected instance** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **party relationship is hidden from the certificate** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: distinguish inspection of present state from validation of intended future use and verification of historical claims
- native scenario: select first-, second- or third-party mode with explicit independence class
- native scenario: compile method-specific evidence and sampling obligations
