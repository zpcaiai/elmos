---
name: elmos-certification-key-ceremony-hsm-controller
description: Operate signer key generation, quorum activation, rotation, backup, compromise response and audit for independent K8 certificates.
version: 4.0.0
...
# Certification Key Ceremony and HSM Controller
...
- `CertificationKeyCeremonyAndHSMControllerProfile`
- `CertificationKeyCeremonyAndHSMControllerPlan`
- `CertificationKeyCeremonyAndHSMControllerRun`
- `CertificationKeyCeremonyAndHSMControllerDecision`

Required semantic capabilities:

- define HSM/KMS key ceremony and roles
- require quorum and witnessed actions
- rotate keys with certificate continuity
- publish trust roots and revocation
- exercise compromise and disaster recovery
...
- `artifacts/elmos-certification-key-ceremony-hsm-controller/profile.yaml`
- `artifacts/elmos-certification-key-ceremony-hsm-controller/plan.json`
- `artifacts/elmos-certification-key-ceremony-hsm-controller/result.json`
- `artifacts/elmos-certification-key-ceremony-hsm-controller/evidence/`
...
- **single operator controls key** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **backup key unencrypted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **test key signs production certificate** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rotation breaks verifier trust** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ceremony evidence incomplete** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define HSM/KMS key ceremony and roles
- native scenario: require quorum and witnessed actions
- native scenario: rotate keys with certificate continuity
- native scenario: publish trust roots and revocation
- native scenario: exercise compromise and disaster recovery
