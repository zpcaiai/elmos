---
name: elmos-nonconformity-corrective-action-capa-controller
description: Implement and independently certify nonconformity and corrective action capa controller, including classify finding severity, scope and certificate impact, require containment, correction, root cause, corrective action and due dates and verify objective closure evidence and propagate systemic fixes.
version: 4.0.0
...
# Nonconformity and Corrective Action CAPA Controller

## Objective

Implement and independently certify nonconformity and corrective action capa controller, including classify finding severity, scope and certificate impact, require containment, correction, root cause, corrective action and due dates and verify objective closure evidence and propagate systemic fixes.
...
- `NonconformityAndCorrectiveActionCAPAControllerProfile`
- `NonconformityAndCorrectiveActionCAPAControllerRun`
- `NonconformityAndCorrectiveActionCAPAControllerFinding`
- `NonconformityAndCorrectiveActionCAPAControllerDecision`
- `NonconformityAndCorrectiveActionCAPAControllerEvidence`

Required semantic capabilities:

- classify finding severity, scope and certificate impact
- require containment, correction, root cause, corrective action and due dates
- verify objective closure evidence and propagate systemic fixes
...
- `elmos-audit-evidence-sufficiency-appropriateness-verifier`
- `elmos-incident-postmortem-recertification-controller`

## Primary Outputs

- `artifacts/elmos-nonconformity-corrective-action-capa-controller/profile.yaml`
- `artifacts/elmos-nonconformity-corrective-action-capa-controller/plan.json`
- `artifacts/elmos-nonconformity-corrective-action-capa-controller/result.json`
- `artifacts/elmos-nonconformity-corrective-action-capa-controller/evidence/`
- `artifacts/elmos-nonconformity-corrective-action-capa-controller/assurance-case.json`
...
- **symptom correction closes systemic issue** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **minor label hides critical effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **overdue CAPA does not affect certificate** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify finding severity, scope and certificate impact
- native scenario: require containment, correction, root cause, corrective action and due dates
- native scenario: verify objective closure evidence and propagate systemic fixes
