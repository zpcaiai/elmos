---
name: elmos-method-sensitivity-specificity-detection-limit-certifier
description: Implement and independently certify method sensitivity, specificity and detection-limit certifier, including measure sensitivity, specificity, false alarm, missed detection and minimum detectable effect, characterize saturation, ceiling, floor and resolution limits and establish method applicability under noise and adversarial conditions.
version: 4.0.0
...
# Method Sensitivity, Specificity and Detection-Limit Certifier
...
- `MethodSensitivitySpecificityAndDetectionLimitCertifierProfile`
- `MethodSensitivitySpecificityAndDetectionLimitCertifierRun`
- `MethodSensitivitySpecificityAndDetectionLimitCertifierFinding`
- `MethodSensitivitySpecificityAndDetectionLimitCertifierDecision`
- `MethodSensitivitySpecificityAndDetectionLimitCertifierEvidence`

Required semantic capabilities:

- measure sensitivity, specificity, false alarm, missed detection and minimum detectable effect
- characterize saturation, ceiling, floor and resolution limits
- establish method applicability under noise and adversarial conditions
...
- `elmos-test-method-validation-verification-controller`

## Primary Outputs

- `artifacts/elmos-method-sensitivity-specificity-detection-limit-certifier/profile.yaml`
- `artifacts/elmos-method-sensitivity-specificity-detection-limit-certifier/plan.json`
- `artifacts/elmos-method-sensitivity-specificity-detection-limit-certifier/result.json`
- `artifacts/elmos-method-sensitivity-specificity-detection-limit-certifier/evidence/`
- `artifacts/elmos-method-sensitivity-specificity-detection-limit-certifier/assurance-case.json`
...
- **test cannot detect practically important regression** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **high specificity hides low sensitivity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **detection limit is inferred from one fixture** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: measure sensitivity, specificity, false alarm, missed detection and minimum detectable effect
- native scenario: characterize saturation, ceiling, floor and resolution limits
- native scenario: establish method applicability under noise and adversarial conditions
