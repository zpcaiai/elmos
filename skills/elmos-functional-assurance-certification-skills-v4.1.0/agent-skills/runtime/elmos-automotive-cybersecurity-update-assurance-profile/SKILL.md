...
# Automotive Cybersecurity and Software Update Assurance Profile
...
- `AutomotiveCybersecurityAndSoftwareUpdateAssuranceProfileProfile`
- `AutomotiveCybersecurityAndSoftwareUpdateAssuranceProfileRun`
- `AutomotiveCybersecurityAndSoftwareUpdateAssuranceProfileFinding`
- `AutomotiveCybersecurityAndSoftwareUpdateAssuranceProfileDecision`
- `AutomotiveCybersecurityAndSoftwareUpdateAssuranceProfileEvidence`

Required semantic capabilities:

- compile vehicle cybersecurity management, threat analysis and risk assessment
- verify secure update, rollback, campaign monitoring and regulatory evidence
- integrate safety-security co-assurance for connected AI functions
...
- `elmos-automotive-functional-safety-sotif-profile`

### External Package Dependencies

- `elmos-software-update-trust-root-governor` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-automotive-cybersecurity-update-assurance-profile/profile.yaml`
- `artifacts/elmos-automotive-cybersecurity-update-assurance-profile/plan.json`
- `artifacts/elmos-automotive-cybersecurity-update-assurance-profile/result.json`
- `artifacts/elmos-automotive-cybersecurity-update-assurance-profile/evidence/`
- `artifacts/elmos-automotive-cybersecurity-update-assurance-profile/assurance-case.json`
...
- **security patch breaks safety timing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **update campaign cannot reach fleet** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **backend compromise is outside vehicle threat model** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile vehicle cybersecurity management, threat analysis and risk assessment
- native scenario: verify secure update, rollback, campaign monitoring and regulatory evidence
- native scenario: integrate safety-security co-assurance for connected AI functions
