...
# Accreditation Scope and Competence Matrix Compiler
...
- `AccreditationScopeAndCompetenceMatrixCompilerProfile`
- `AccreditationScopeAndCompetenceMatrixCompilerRun`
- `AccreditationScopeAndCompetenceMatrixCompilerFinding`
- `AccreditationScopeAndCompetenceMatrixCompilerDecision`
- `AccreditationScopeAndCompetenceMatrixCompilerEvidence`

Required semantic capabilities:

- compile exact technical fields, methods, products, versions and assurance levels into accreditation scope
- map personnel competence, facilities, tools and witness evidence to each scope cell
- block certificate issuance outside demonstrated competence
...
- `artifacts/elmos-accreditation-scope-competence-matrix-compiler/profile.yaml`
- `artifacts/elmos-accreditation-scope-competence-matrix-compiler/plan.json`
- `artifacts/elmos-accreditation-scope-competence-matrix-compiler/result.json`
- `artifacts/elmos-accreditation-scope-competence-matrix-compiler/evidence/`
- `artifacts/elmos-accreditation-scope-competence-matrix-compiler/assurance-case.json`
...
- **generic accreditation language hides unsupported technical scope** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **competence evidence expires without invalidating authorization** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **subcontracted activity exceeds accredited scope** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile exact technical fields, methods, products, versions and assurance levels into accreditation scope
- native scenario: map personnel competence, facilities, tools and witness evidence to each scope cell
- native scenario: block certificate issuance outside demonstrated competence
