---
name: elmos-proof-checker-diversity-cross-validation-governor
description: Implement and independently certify proof checker diversity and cross-validation governor, including cross-check critical claims with independent encodings, solvers, checkers or runtime oracles, measure common-mode dependencies and TCB overlap and require disagreement investigation before certification.
version: 4.0.0
...
# Proof Checker Diversity and Cross-Validation Governor

## Objective

Implement and independently certify proof checker diversity and cross-validation governor, including cross-check critical claims with independent encodings, solvers, checkers or runtime oracles, measure common-mode dependencies and TCB overlap and require disagreement investigation before certification.
...
- `ProofCheckerDiversityAndCrossValidationGovernorProfile`
- `ProofCheckerDiversityAndCrossValidationGovernorRun`
- `ProofCheckerDiversityAndCrossValidationGovernorFinding`
- `ProofCheckerDiversityAndCrossValidationGovernorDecision`
- `ProofCheckerDiversityAndCrossValidationGovernorEvidence`

Required semantic capabilities:

- cross-check critical claims with independent encodings, solvers, checkers or runtime oracles
- measure common-mode dependencies and TCB overlap
- require disagreement investigation before certification
...
- `artifacts/elmos-proof-checker-diversity-cross-validation-governor/profile.yaml`
- `artifacts/elmos-proof-checker-diversity-cross-validation-governor/plan.json`
- `artifacts/elmos-proof-checker-diversity-cross-validation-governor/result.json`
- `artifacts/elmos-proof-checker-diversity-cross-validation-governor/evidence/`
- `artifacts/elmos-proof-checker-diversity-cross-validation-governor/assurance-case.json`
...
- **two tools share same parser bug** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **translation to second encoding changes claim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **majority vote masks one authoritative refutation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: cross-check critical claims with independent encodings, solvers, checkers or runtime oracles
- native scenario: measure common-mode dependencies and TCB overlap
- native scenario: require disagreement investigation before certification
