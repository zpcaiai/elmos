---
name: elmos-cryptographic-module-validation-readiness-governor
description: Implement and independently certify cryptographic module validation readiness governor, including define cryptographic module boundary, approved services, roles, states, self-tests and operational environments, collect design, entropy, key management and algorithm evidence and separate readiness package from actual accredited module validation.
version: 4.0.0
...
# Cryptographic Module Validation Readiness Governor
...
- `CryptographicModuleValidationReadinessGovernorProfile`
- `CryptographicModuleValidationReadinessGovernorRun`
- `CryptographicModuleValidationReadinessGovernorFinding`
- `CryptographicModuleValidationReadinessGovernorDecision`
- `CryptographicModuleValidationReadinessGovernorEvidence`

Required semantic capabilities:

- define cryptographic module boundary, approved services, roles, states, self-tests and operational environments
- collect design, entropy, key management and algorithm evidence
- separate readiness package from actual accredited module validation
...
- `elmos-security-evaluation-methodology-work-unit-compiler`

## Primary Outputs

- `artifacts/elmos-cryptographic-module-validation-readiness-governor/profile.yaml`
- `artifacts/elmos-cryptographic-module-validation-readiness-governor/plan.json`
- `artifacts/elmos-cryptographic-module-validation-readiness-governor/result.json`
- `artifacts/elmos-cryptographic-module-validation-readiness-governor/evidence/`
- `artifacts/elmos-cryptographic-module-validation-readiness-governor/assurance-case.json`
...
- **module boundary omits calling application** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **non-approved mode can enter approved service** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **entropy source evidence is absent** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define cryptographic module boundary, approved services, roles, states, self-tests and operational environments
- native scenario: collect design, entropy, key management and algorithm evidence
- native scenario: separate readiness package from actual accredited module validation
