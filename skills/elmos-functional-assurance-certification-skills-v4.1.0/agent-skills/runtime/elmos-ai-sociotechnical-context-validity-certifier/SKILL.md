---
name: elmos-ai-sociotechnical-context-validity-certifier
description: Implement and independently certify sociotechnical context validity certifier, including verify deployment context, workflow, incentives, institutions and human behavior match evaluation assumptions, test external validity across sites, cultures, languages and organizational practices and bound certificate to contexts with demonstrated transfer evidence.
version: 4.0.0
...
# Sociotechnical Context Validity Certifier

## Objective

Implement and independently certify sociotechnical context validity certifier, including verify deployment context, workflow, incentives, institutions and human behavior match evaluation assumptions, test external validity across sites, cultures, languages and organizational practices and bound certificate to contexts with demonstrated transfer evidence.
...
- `SociotechnicalContextValidityCertifierProfile`
- `SociotechnicalContextValidityCertifierRun`
- `SociotechnicalContextValidityCertifierFinding`
- `SociotechnicalContextValidityCertifierDecision`
- `SociotechnicalContextValidityCertifierEvidence`

Required semantic capabilities:

- verify deployment context, workflow, incentives, institutions and human behavior match evaluation assumptions
- test external validity across sites, cultures, languages and organizational practices
- bound certificate to contexts with demonstrated transfer evidence
...
- `elmos-ai-impact-harm-benefit-distribution-assessor`
- `elmos-ai-tevv-athlon-scenario-orchestrator`

## Primary Outputs

- `artifacts/elmos-ai-sociotechnical-context-validity-certifier/profile.yaml`
- `artifacts/elmos-ai-sociotechnical-context-validity-certifier/plan.json`
- `artifacts/elmos-ai-sociotechnical-context-validity-certifier/result.json`
- `artifacts/elmos-ai-sociotechnical-context-validity-certifier/evidence/`
- `artifacts/elmos-ai-sociotechnical-context-validity-certifier/assurance-case.json`
...
- **lab performance does not transfer to field workflow** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **local policy changes decision meaning** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cultural or language variation invalidates interaction metric** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: verify deployment context, workflow, incentives, institutions and human behavior match evaluation assumptions
- native scenario: test external validity across sites, cultures, languages and organizational practices
- native scenario: bound certificate to contexts with demonstrated transfer evidence
