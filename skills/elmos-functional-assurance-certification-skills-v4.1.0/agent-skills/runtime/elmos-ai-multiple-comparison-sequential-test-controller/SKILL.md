...
# Multiple-Comparison and Sequential Test Controller
...
- `MultipleComparisonAndSequentialTestControllerProfile`
- `MultipleComparisonAndSequentialTestControllerRun`
- `MultipleComparisonAndSequentialTestControllerFinding`
- `MultipleComparisonAndSequentialTestControllerDecision`
- `MultipleComparisonAndSequentialTestControllerEvidence`

Required semantic capabilities:

- control family-wise error or false discovery across many metrics and subgroups
- support alpha spending, sequential monitoring and predeclared stopping
- distinguish exploratory findings from confirmatory certification evidence
...
- `elmos-ai-evaluation-power-sample-size-planner`

## Primary Outputs

- `artifacts/elmos-ai-multiple-comparison-sequential-test-controller/profile.yaml`
- `artifacts/elmos-ai-multiple-comparison-sequential-test-controller/plan.json`
- `artifacts/elmos-ai-multiple-comparison-sequential-test-controller/result.json`
- `artifacts/elmos-ai-multiple-comparison-sequential-test-controller/evidence/`
- `artifacts/elmos-ai-multiple-comparison-sequential-test-controller/assurance-case.json`
...
- **metric shopping yields one significant result** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **repeated peeking is uncorrected** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **exploratory analysis is presented as confirmatory** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: control family-wise error or false discovery across many metrics and subgroups
- native scenario: support alpha spending, sequential monitoring and predeclared stopping
- native scenario: distinguish exploratory findings from confirmatory certification evidence
