---
name: elmos-i18n-l10n-conformance-verifier
description: Verify Unicode, locale, language, timezone, calendar, plural, number, currency, collation, bidirectional text and translated UX across generated projects.
version: 4.0.0
...
# Internationalization and Localization Conformance Verifier
...
- **Kernel authorities used:** K2, K3, K6
...
- `InternationalizationAndLocalizationConformanceVerifierRun`
- `InternationalizationAndLocalizationConformanceVerifierDecision`
- `EvidenceArtifact`
- `ProofResult`

Required semantic capabilities:

- Separate locale-neutral storage from presentation
- Test Unicode normalization and grapheme boundaries
- Verify timezone/DST and calendar transitions
- Validate plural, gender, number and currency formatting
- Exercise right-to-left layout, text expansion and fallback
...
- `elmos-ai-interaction-channel-compiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `i18n-conformance-report.json`
- `locale-fixtures/`
...
- **mojibake** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **server locale changes logic** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **timezone double conversion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **translation string injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **PII exposed to translation provider** — must have a preventive control, a detective signal, a negative fixture and a response action.
