...
# AI Evaluation Measurement Model Compiler
...
- `AIEvaluationMeasurementModelCompilerProfile`
- `AIEvaluationMeasurementModelCompilerRun`
- `AIEvaluationMeasurementModelCompilerFinding`
- `AIEvaluationMeasurementModelCompilerDecision`
- `AIEvaluationMeasurementModelCompilerEvidence`

Required semantic capabilities:

- construct mathematical or simulation measurement models linking inputs to AI evaluation results
- identify correlated uncertainty components and model inadequacy
- validate model residuals, sensitivity and domain of applicability
...
- `artifacts/elmos-ai-evaluation-measurement-model-compiler/profile.yaml`
- `artifacts/elmos-ai-evaluation-measurement-model-compiler/plan.json`
- `artifacts/elmos-ai-evaluation-measurement-model-compiler/result.json`
- `artifacts/elmos-ai-evaluation-measurement-model-compiler/evidence/`
- `artifacts/elmos-ai-evaluation-measurement-model-compiler/assurance-case.json`
...
- **nonlinear model is approximated beyond valid range** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **correlated components are double-counted as independent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **model inadequacy is omitted from uncertainty** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: construct mathematical or simulation measurement models linking inputs to AI evaluation results
- native scenario: identify correlated uncertainty components and model inadequacy
- native scenario: validate model residuals, sensitivity and domain of applicability
