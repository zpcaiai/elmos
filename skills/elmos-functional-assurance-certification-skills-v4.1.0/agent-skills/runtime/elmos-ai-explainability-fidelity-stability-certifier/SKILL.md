---
name: elmos-ai-explainability-fidelity-stability-certifier
description: Implement and independently certify explainability fidelity and stability certifier, including measure explanation fidelity to model or system decision process, test stability, sensitivity, completeness and audience comprehension and verify explanation supports contestability and does not disclose unsafe information.
version: 4.0.0
...
# Explainability Fidelity and Stability Certifier
...
- `ExplainabilityFidelityAndStabilityCertifierProfile`
- `ExplainabilityFidelityAndStabilityCertifierRun`
- `ExplainabilityFidelityAndStabilityCertifierFinding`
- `ExplainabilityFidelityAndStabilityCertifierDecision`
- `ExplainabilityFidelityAndStabilityCertifierEvidence`

Required semantic capabilities:

- measure explanation fidelity to model or system decision process
- test stability, sensitivity, completeness and audience comprehension
- verify explanation supports contestability and does not disclose unsafe information
...
- `elmos-ai-quality-characteristic-measurement-compiler`

### External Package Dependencies

- `elmos-ai-regulated-decision-explainability-packager` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-ai-explainability-fidelity-stability-certifier/profile.yaml`
- `artifacts/elmos-ai-explainability-fidelity-stability-certifier/plan.json`
- `artifacts/elmos-ai-explainability-fidelity-stability-certifier/result.json`
- `artifacts/elmos-ai-explainability-fidelity-stability-certifier/evidence/`
- `artifacts/elmos-ai-explainability-fidelity-stability-certifier/assurance-case.json`
...
- **plausible narrative is mistaken for faithful explanation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **small input perturbation produces contradictory explanation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **explanation leaks sensitive features or security controls** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: measure explanation fidelity to model or system decision process
- native scenario: test stability, sensitivity, completeness and audience comprehension
- native scenario: verify explanation supports contestability and does not disclose unsafe information
