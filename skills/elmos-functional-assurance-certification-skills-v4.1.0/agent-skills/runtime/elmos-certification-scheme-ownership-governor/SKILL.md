---
name: elmos-certification-scheme-ownership-governor
description: Implement and independently certify certification scheme ownership and governance controller, including establish scheme constitution, governance board, change control and stakeholder representation, separate commercial ownership from technical certification decisions and publish normative criteria, interpretations, transition periods and version history.
version: 4.0.0
...
# Certification Scheme Ownership and Governance Controller

## Objective

Implement and independently certify certification scheme ownership and governance controller, including establish scheme constitution, governance board, change control and stakeholder representation, separate commercial ownership from technical certification decisions and publish normative criteria, interpretations, transition periods and version history.
...
- `CertificationSchemeOwnershipAndGovernanceControllerProfile`
- `CertificationSchemeOwnershipAndGovernanceControllerRun`
- `CertificationSchemeOwnershipAndGovernanceControllerFinding`
- `CertificationSchemeOwnershipAndGovernanceControllerDecision`
- `CertificationSchemeOwnershipAndGovernanceControllerEvidence`

Required semantic capabilities:

- establish scheme constitution, governance board, change control and stakeholder representation
- separate commercial ownership from technical certification decisions
- publish normative criteria, interpretations, transition periods and version history
...
- `artifacts/elmos-certification-scheme-ownership-governor/profile.yaml`
- `artifacts/elmos-certification-scheme-ownership-governor/plan.json`
- `artifacts/elmos-certification-scheme-ownership-governor/result.json`
- `artifacts/elmos-certification-scheme-ownership-governor/evidence/`
- `artifacts/elmos-certification-scheme-ownership-governor/assurance-case.json`
...
- **scheme governance captured by one vendor** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **criteria change without transition or recertification** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **confidential interpretations create unequal treatment** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: establish scheme constitution, governance board, change control and stakeholder representation
- native scenario: separate commercial ownership from technical certification decisions
- native scenario: publish normative criteria, interpretations, transition periods and version history
