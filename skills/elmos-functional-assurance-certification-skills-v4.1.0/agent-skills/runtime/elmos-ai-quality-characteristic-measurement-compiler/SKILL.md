---
name: elmos-ai-quality-characteristic-measurement-compiler
description: Implement and independently certify ai quality characteristic measurement compiler, including map AI quality characteristics to measurable indicators, methods and evidence, define aggregation without hiding critical sub-characteristics and link quality requirements to acceptance and surveillance.
version: 4.0.0
...
# AI Quality Characteristic Measurement Compiler
...
- `AIQualityCharacteristicMeasurementCompilerProfile`
- `AIQualityCharacteristicMeasurementCompilerRun`
- `AIQualityCharacteristicMeasurementCompilerFinding`
- `AIQualityCharacteristicMeasurementCompilerDecision`
- `AIQualityCharacteristicMeasurementCompilerEvidence`

Required semantic capabilities:

- map AI quality characteristics to measurable indicators, methods and evidence
- define aggregation without hiding critical sub-characteristics
- link quality requirements to acceptance and surveillance
...
- `artifacts/elmos-ai-quality-characteristic-measurement-compiler/profile.yaml`
- `artifacts/elmos-ai-quality-characteristic-measurement-compiler/plan.json`
- `artifacts/elmos-ai-quality-characteristic-measurement-compiler/result.json`
- `artifacts/elmos-ai-quality-characteristic-measurement-compiler/evidence/`
- `artifacts/elmos-ai-quality-characteristic-measurement-compiler/assurance-case.json`
...
- **quality score averages away safety failure** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **metric lacks construct validity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **measure direction is inconsistent across teams** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: map AI quality characteristics to measurable indicators, methods and evidence
- native scenario: define aggregation without hiding critical sub-characteristics
- native scenario: link quality requirements to acceptance and surveillance
