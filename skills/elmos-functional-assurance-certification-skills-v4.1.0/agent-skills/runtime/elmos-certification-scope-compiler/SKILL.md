---
name: elmos-certification-scope-compiler
description: Compile precise system, route, deployment, tenant, jurisdiction, assurance, exclusions and validity envelopes before any production certification run.
version: 4.0.0
...
- Freeze subjects and exact RevisionSet
- Define claims, assurance levels and accepted evidence
- Declare exclusions and external dependencies
- Bind jurisdiction and customer constraints
- Prevent scope expansion after tests
...
- `certification-scope.yaml`
- `certification-boundary-map.json`
- `excluded-claims.json`
...
- **scope broadened after evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **exclusion hidden in summary** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer environment assumed equivalent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **jurisdiction omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **certificate subject ambiguous** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- route certificate scope
- deployment certificate scope
- multi-tenant scope
- jurisdiction profile
- scope change creates new request
- excluded claim visible
