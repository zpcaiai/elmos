...
# Financial Model Risk Validation Profile
...
- `FinancialModelRiskValidationProfileProfile`
- `FinancialModelRiskValidationProfileRun`
- `FinancialModelRiskValidationProfileFinding`
- `FinancialModelRiskValidationProfileDecision`
- `FinancialModelRiskValidationProfileEvidence`

Required semantic capabilities:

- compile independent model validation, conceptual soundness, outcomes analysis and ongoing monitoring
- govern model inventory, tiering, limitations, overrides and compensating controls
- test stress, backtesting, data lineage and change management
...
- `artifacts/elmos-financial-model-risk-validation-profile/profile.yaml`
- `artifacts/elmos-financial-model-risk-validation-profile/plan.json`
- `artifacts/elmos-financial-model-risk-validation-profile/result.json`
- `artifacts/elmos-financial-model-risk-validation-profile/evidence/`
- `artifacts/elmos-financial-model-risk-validation-profile/assurance-case.json`
...
- **model owner validates own model** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **override usage is not monitored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **performance metric ignores economic regime shift** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile independent model validation, conceptual soundness, outcomes analysis and ongoing monitoring
- native scenario: govern model inventory, tiering, limitations, overrides and compensating controls
- native scenario: test stress, backtesting, data lineage and change management
