---
name: elmos-common-criteria-protection-profile-mapper
description: Implement and independently certify common criteria protection profile mapper, including select applicable collaborative protection profiles and supporting documents, map claimed conformance, selections, assignments and refinements and identify unmet requirements and prohibited overclaim.
version: 4.0.0
...
# Common Criteria Protection Profile Mapper
...
- `CommonCriteriaProtectionProfileMapperProfile`
- `CommonCriteriaProtectionProfileMapperRun`
- `CommonCriteriaProtectionProfileMapperFinding`
- `CommonCriteriaProtectionProfileMapperDecision`
- `CommonCriteriaProtectionProfileMapperEvidence`

Required semantic capabilities:

- select applicable collaborative protection profiles and supporting documents
- map claimed conformance, selections, assignments and refinements
- identify unmet requirements and prohibited overclaim
...
- `artifacts/elmos-common-criteria-protection-profile-mapper/profile.yaml`
- `artifacts/elmos-common-criteria-protection-profile-mapper/plan.json`
- `artifacts/elmos-common-criteria-protection-profile-mapper/result.json`
- `artifacts/elmos-common-criteria-protection-profile-mapper/evidence/`
- `artifacts/elmos-common-criteria-protection-profile-mapper/assurance-case.json`
...
- **outdated protection profile is used** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **package claims exact conformance with unresolved deviation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **supporting document work units are omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: select applicable collaborative protection profiles and supporting documents
- native scenario: map claimed conformance, selections, assignments and refinements
- native scenario: identify unmet requirements and prohibited overclaim
