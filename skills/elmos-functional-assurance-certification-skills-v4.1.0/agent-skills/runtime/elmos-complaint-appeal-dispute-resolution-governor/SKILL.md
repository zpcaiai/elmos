---
name: elmos-complaint-appeal-dispute-resolution-governor
description: Implement and independently certify complaint, appeal and dispute resolution governor, including register complaints and appeals with protected evidence and deadlines, assign independent reviewers not involved in original decision and track remedy, decision rationale, systemic corrective action and retaliation controls.
version: 4.0.0
...
# Complaint, Appeal and Dispute Resolution Governor

## Objective

Implement and independently certify complaint, appeal and dispute resolution governor, including register complaints and appeals with protected evidence and deadlines, assign independent reviewers not involved in original decision and track remedy, decision rationale, systemic corrective action and retaliation controls.
...
- `ComplaintAppealAndDisputeResolutionGovernorProfile`
- `ComplaintAppealAndDisputeResolutionGovernorRun`
- `ComplaintAppealAndDisputeResolutionGovernorFinding`
- `ComplaintAppealAndDisputeResolutionGovernorDecision`
- `ComplaintAppealAndDisputeResolutionGovernorEvidence`

Required semantic capabilities:

- register complaints and appeals with protected evidence and deadlines
- assign independent reviewers not involved in original decision
- track remedy, decision rationale, systemic corrective action and retaliation controls
...
- `elmos-certification-decision-independent-review-controller`

## Primary Outputs

- `artifacts/elmos-complaint-appeal-dispute-resolution-governor/profile.yaml`
- `artifacts/elmos-complaint-appeal-dispute-resolution-governor/plan.json`
- `artifacts/elmos-complaint-appeal-dispute-resolution-governor/result.json`
- `artifacts/elmos-complaint-appeal-dispute-resolution-governor/evidence/`
- `artifacts/elmos-complaint-appeal-dispute-resolution-governor/assurance-case.json`
...
- **appeal reviewer reports to original decision owner** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **complainant identity leaks to evaluated team** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **appeal overturns result without technical basis** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: register complaints and appeals with protected evidence and deadlines
- native scenario: assign independent reviewers not involved in original decision
- native scenario: track remedy, decision rationale, systemic corrective action and retaliation controls
