---
name: elmos-scitt-evidence-transparency-receipt-publisher
description: Publish signed evidence statements and verification receipts to an append-only transparency service while preserving tenant privacy, revocation and certificate lineage.
version: 4.0.0
...
# SCITT Evidence Transparency Receipt Publisher
...
- `SCITTEvidenceTransparencyReceiptPublisherProfile`
- `SCITTEvidenceTransparencyReceiptPublisherPlan`
- `SCITTEvidenceTransparencyReceiptPublisherRun`
- `SCITTEvidenceTransparencyReceiptPublisherDecision`

Required semantic capabilities:

- canonicalize signed evidence statements
- publish and verify transparency receipts
- bind receipts to Evidence Merkle roots and certificate scope
- support revocation and re-publication without history rewrite
- apply tenant disclosure and redaction policy
...
- `elmos-ai-artifact-provenance-packager` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-scitt-evidence-transparency-receipt-publisher/profile.yaml`
- `artifacts/elmos-scitt-evidence-transparency-receipt-publisher/plan.json`
- `artifacts/elmos-scitt-evidence-transparency-receipt-publisher/result.json`
- `artifacts/elmos-scitt-evidence-transparency-receipt-publisher/evidence/`
...
- **private evidence disclosed publicly** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **receipt detached from exact statement** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **log equivocation not detected** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **revoked signer remains trusted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **publication failure treated as certification success** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: canonicalize signed evidence statements
- native scenario: publish and verify transparency receipts
- native scenario: bind receipts to Evidence Merkle roots and certificate scope
- native scenario: support revocation and re-publication without history rewrite
- native scenario: apply tenant disclosure and redaction policy
