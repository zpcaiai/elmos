---
name: elmos-certification-policy-practice-authority
description: Define versioned certificate policies and certification practice statements for assurance levels, evidence classes, validity, revocation, audits and signer operations.
version: 4.0.0
...
# Certification Policy and Practice Authority
...
- Define claim/status semantics and assurance levels
- Specify required verifier independence and evidence
- Define signer, key, validity and revocation practices
- Control policy changes and grandfathering
- Publish customer-readable certificate limitations
...
- `certification-practice-statement.yaml`
- `assurance-level-catalog.json`
- `policy-change-impact.json`
...
- **policy changed after assessment** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **practice differs from published policy** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **assurance level inflation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **key ceremony not evidenced** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer report omits limitations** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- A1/A2/A3 evidence profile
- policy version binding
- signer practice compliance
- policy change recertification
- certificate limitation rendering
- revocation process test
