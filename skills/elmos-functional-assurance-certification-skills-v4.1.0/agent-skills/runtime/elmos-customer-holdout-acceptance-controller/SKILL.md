---
name: elmos-customer-holdout-acceptance-controller
description: Govern hidden customer scenarios, independent labels, contamination controls, execution, review and cryptographic acceptance for commercial Golden Routes.
version: 4.0.0
...
# Customer Holdout Acceptance Controller
...
- Separate holdout custody from implementers
- Hash and freeze scenarios before candidate release
- Run in approved customer-equivalent environment
- Capture authorized acceptance/rejection and conditions
- Prevent holdout reuse as development data
...
- `customer-holdout-manifest.json`
- `holdout-results.json`
- `customer-acceptance-record.json`
- `holdout-contamination-report.json`
...
- **holdout leaked to generator** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer approver identity spoofed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **failed case removed after run** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **acceptance covers different revision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive holdout exported** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- hidden functional scenario
- hidden security scenario
- hidden recovery scenario
- contamination detection
- authorized customer signoff
- conditional acceptance expiry
