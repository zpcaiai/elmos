---
name: elmos-hermetic-build-environment-attestation-controller
description: Attest builder image, kernel, toolchain, network policy, inputs, identity and isolation so clean-room results can be trusted beyond a build log.
version: 4.0.0
...
# Hermetic Build Environment Attestation Controller
...
- Measure builder image and toolchain
- Bind workload identity and execution epoch
- Verify network/filesystem isolation
- Compare evidence with approved reference values
- Reject stale or unverifiable attestation
...
- **attestation signed by untrusted verifier** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **measurement misses injected volume** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **reference values stale** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **attestation replay** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **builder can influence appraisal policy** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- known-good builder
- modified image rejected
- unauthorized network egress
- toolchain mismatch
- replayed attestation
- customer runner reference value
