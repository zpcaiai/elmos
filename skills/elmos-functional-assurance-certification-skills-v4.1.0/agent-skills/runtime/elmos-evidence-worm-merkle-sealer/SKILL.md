---
name: elmos-evidence-worm-merkle-sealer
description: Seal commands, inputs, artifacts, traces, proof results and approvals into immutable evidence bundles with chain of custody, Merkle roots, retention and legal hold.
version: 4.0.0
...
# Evidence WORM and Merkle Sealer
...
- Canonicalize and hash evidence objects
- Build claim-to-evidence graph and Merkle tree
- Write to WORM/content-addressed storage
- Record custody, access and redaction events
- Support retention, legal hold and verified export
...
- **evidence modified before seal** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hash excludes material metadata** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **custody log rewrite** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **redaction destroys proof meaning** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **WORM configuration not actually immutable** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- bundle seal/verify
- single-byte tamper rejection
- missing evidence node detection
- custody transfer
