---
name: elmos-operability-support-readiness-certifier
description: Certify ownership, on-call, alerts, runbooks, dashboards, diagnostic safety, support access, maintenance and incident communications before commercial launch.
version: 4.0.0
...
# Operability and Support Readiness Certifier
...
- Require named service and data owners
- Test alerts and runbooks through game days
- Verify safe diagnostics and break-glass access
- Define maintenance, status and customer communication
- Measure support escalation and incident response
...
- `elmos-ai-operator-console-generator` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `operability-certificate.json`
- `service-ownership-catalog.json`
- `runbook-test-results.json`
- `support-readiness-report.json`
...
- **orphan service** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **alert only tested synthetically** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **runbook stale** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **support has ambient production access** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer impact not communicated** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- alert fires on real fault
- runbook restores service
- on-call escalation
- break-glass audit
