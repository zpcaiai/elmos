...
# Post-Quantum Cryptographic Agility Controller
...
- `PostQuantumCryptographicAgilityControllerProfile`
- `PostQuantumCryptographicAgilityControllerRun`
- `PostQuantumCryptographicAgilityControllerFinding`
- `PostQuantumCryptographicAgilityControllerDecision`
- `PostQuantumCryptographicAgilityControllerEvidence`

Required semantic capabilities:

- inventory vulnerable public-key uses and long-lived evidence signatures
- plan ML-KEM, ML-DSA, SLH-DSA and future algorithm transition with crypto-agility
- test hybrid negotiation, downgrade resistance, archival verification and rollback
...
- `elmos-cryptographic-algorithm-test-vector-certifier`
...
- `artifacts/elmos-post-quantum-cryptographic-agility-controller/profile.yaml`
- `artifacts/elmos-post-quantum-cryptographic-agility-controller/plan.json`
- `artifacts/elmos-post-quantum-cryptographic-agility-controller/result.json`
- `artifacts/elmos-post-quantum-cryptographic-agility-controller/evidence/`
- `artifacts/elmos-post-quantum-cryptographic-agility-controller/assurance-case.json`
...
- **harvest-now-decrypt-later exposure is ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hybrid mode accepts classical-only downgrade** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **old certificate cannot be verified after transition** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: inventory vulnerable public-key uses and long-lived evidence signatures
- native scenario: plan ML-KEM, ML-DSA, SLH-DSA and future algorithm transition with crypto-agility
- native scenario: test hybrid negotiation, downgrade resistance, archival verification and rollback
