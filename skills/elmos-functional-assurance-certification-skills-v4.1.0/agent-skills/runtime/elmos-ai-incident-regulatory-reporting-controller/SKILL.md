---
name: elmos-ai-incident-regulatory-reporting-controller
description: Coordinate technical triage, legal/compliance review, deadlines, evidence, customer communication and regulator-ready reporting for AI incidents.
version: 4.0.0
...
# AI Incident Regulatory Reporting Controller
...
- `AIIncidentRegulatoryReportingControllerProfile`
- `AIIncidentRegulatoryReportingControllerPlan`
- `AIIncidentRegulatoryReportingControllerRun`
- `AIIncidentRegulatoryReportingControllerDecision`

Required semantic capabilities:

- classify incident across jurisdictions
- freeze evidence and timeline
- compute deadlines with human validation
- generate audience-specific draft reports
- track submission, correction and recertification
...
- `artifacts/elmos-ai-incident-regulatory-reporting-controller/profile.yaml`
- `artifacts/elmos-ai-incident-regulatory-reporting-controller/plan.json`
- `artifacts/elmos-ai-incident-regulatory-reporting-controller/result.json`
- `artifacts/elmos-ai-incident-regulatory-reporting-controller/evidence/`
...
- **deadline calculated from wrong trigger** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **report contains unverified root cause** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **jurisdiction omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer and regulator narratives conflict** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **legal privilege not respected** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify incident across jurisdictions
- native scenario: freeze evidence and timeline
- native scenario: compute deadlines with human validation
- native scenario: generate audience-specific draft reports
- native scenario: track submission, correction and recertification
