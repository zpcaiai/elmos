---
name: elmos-certification-transparency-log-notary
description: Publish append-only, privacy-safe certificate, revocation, signer and evidence-root events with inclusion and consistency proofs for independent verification.
version: 4.0.0
...
# Certification Transparency Log and Notary
...
- Append certificate and revocation commitments
- Provide inclusion and consistency proofs
- Minimize customer-sensitive metadata
- Cross-sign checkpoints or external timestamps
- Detect split-view and missing publication
...
- `transparency-log-entries.jsonl`
- `inclusion-proof-bundles/`
- `consistency-checkpoints.json`
- `notary-verification-report.json`
...
- **log operator omits revocation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **split-view log** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive tenant metadata exposed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **timestamp authority untrusted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **checkpoint rollback** — must have a preventive control, a detective signal, a negative fixture and a response action.
