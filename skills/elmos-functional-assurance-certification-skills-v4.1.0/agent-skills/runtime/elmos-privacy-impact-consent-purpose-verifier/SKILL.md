---
name: elmos-privacy-impact-consent-purpose-verifier
description: Compile and verify data purpose, legal/organizational basis, consent, minimization, retention, disclosure, provider use and data-subject control across AI workflows.
version: 4.0.0
...
# Privacy Impact, Consent and Purpose-Limitation Verifier
...
- `PrivacyImpactConsentAndPurposeLimitationVerifierRun`
- `PrivacyImpactConsentAndPurposeLimitationVerifierDecision`
- `EvidenceArtifact`
- `ProofResult`

Required semantic capabilities:

- Bind every data category and processing step to an approved purpose
- Verify collection and model/tool disclosure minimization
- Propagate consent, withdrawal and deletion to derived stores
- Test provider retention/training settings and cross-border routes
- Block secondary use and incompatible dataset promotion
...
- `elmos-ai-retention-erasure-verifier` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
...
- `privacy-impact-assessment.json`
- `purpose-data-flow-map.json`
- `consent-evidence.json`
- `privacy-control-results.json`
...
- **purpose creep** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **consent not propagated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider retains prompt** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deidentified data reidentified** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deletion misses derived artifact** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- consent withdrawal
- provider no-training setting
- derived memory deletion
- cross-border denial
- secondary-use rejection
