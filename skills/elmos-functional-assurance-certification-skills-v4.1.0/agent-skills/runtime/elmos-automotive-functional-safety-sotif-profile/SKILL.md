...
# Automotive Functional Safety and SOTIF Profile
...
- `AutomotiveFunctionalSafetyAndSOTIFProfileProfile`
- `AutomotiveFunctionalSafetyAndSOTIFProfileRun`
- `AutomotiveFunctionalSafetyAndSOTIFProfileFinding`
- `AutomotiveFunctionalSafetyAndSOTIFProfileDecision`
- `AutomotiveFunctionalSafetyAndSOTIFProfileEvidence`

Required semantic capabilities:

- compile item definition, HARA, safety goals, ASIL decomposition and safety case
- evaluate intended-functionality insufficiency, perception limits and triggering conditions
- link simulation, proving-ground, field monitoring and software update evidence
...
- `artifacts/elmos-automotive-functional-safety-sotif-profile/profile.yaml`
- `artifacts/elmos-automotive-functional-safety-sotif-profile/plan.json`
- `artifacts/elmos-automotive-functional-safety-sotif-profile/result.json`
- `artifacts/elmos-automotive-functional-safety-sotif-profile/evidence/`
- `artifacts/elmos-automotive-functional-safety-sotif-profile/assurance-case.json`
...
- **known unsafe scenario is outside test ODD** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ASIL decomposition lacks independence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **OTA update invalidates safety case** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile item definition, HARA, safety goals, ASIL decomposition and safety case
- native scenario: evaluate intended-functionality insufficiency, perception limits and triggering conditions
- native scenario: link simulation, proving-ground, field monitoring and software update evidence
