---
name: elmos-certification-transfer-suspension-withdrawal-controller
description: Implement and independently certify certificate transfer, suspension and withdrawal controller, including govern certificate transfer between bodies with evidence continuity, suspend affected scope while preserving unaffected claims and withdraw, expire and publicly update status with downstream notifications.
version: 4.0.0
...
# Certificate Transfer, Suspension and Withdrawal Controller

## Objective

Implement and independently certify certificate transfer, suspension and withdrawal controller, including govern certificate transfer between bodies with evidence continuity, suspend affected scope while preserving unaffected claims and withdraw, expire and publicly update status with downstream notifications.
...
- `CertificateTransferSuspensionAndWithdrawalControllerProfile`
- `CertificateTransferSuspensionAndWithdrawalControllerRun`
- `CertificateTransferSuspensionAndWithdrawalControllerFinding`
- `CertificateTransferSuspensionAndWithdrawalControllerDecision`
- `CertificateTransferSuspensionAndWithdrawalControllerEvidence`

Required semantic capabilities:

- govern certificate transfer between bodies with evidence continuity
- suspend affected scope while preserving unaffected claims
- withdraw, expire and publicly update status with downstream notifications
...
- `artifacts/elmos-certification-transfer-suspension-withdrawal-controller/profile.yaml`
- `artifacts/elmos-certification-transfer-suspension-withdrawal-controller/plan.json`
- `artifacts/elmos-certification-transfer-suspension-withdrawal-controller/result.json`
- `artifacts/elmos-certification-transfer-suspension-withdrawal-controller/evidence/`
- `artifacts/elmos-certification-transfer-suspension-withdrawal-controller/assurance-case.json`
...
- **certificate transfers without raw evidence review** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **suspension status is not propagated to relying parties** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **withdrawn certificate remains usable offline** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: govern certificate transfer between bodies with evidence continuity
- native scenario: suspend affected scope while preserving unaffected claims
- native scenario: withdraw, expire and publicly update status with downstream notifications
