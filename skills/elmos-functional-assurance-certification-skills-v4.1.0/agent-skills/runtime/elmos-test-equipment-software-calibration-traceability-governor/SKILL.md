---
name: elmos-test-equipment-software-calibration-traceability-governor
description: Implement and independently certify test equipment and software calibration traceability governor, including inventory physical equipment, clocks, GPUs, compilers, libraries, evaluators and reference services affecting results, maintain calibration or verification status and metrological traceability where applicable and block use of expired, tampered or unverified test assets.
version: 4.0.0
...
# Test Equipment and Software Calibration Traceability Governor
...
- `TestEquipmentAndSoftwareCalibrationTraceabilityGovernorProfile`
- `TestEquipmentAndSoftwareCalibrationTraceabilityGovernorRun`
- `TestEquipmentAndSoftwareCalibrationTraceabilityGovernorFinding`
- `TestEquipmentAndSoftwareCalibrationTraceabilityGovernorDecision`
- `TestEquipmentAndSoftwareCalibrationTraceabilityGovernorEvidence`

Required semantic capabilities:

- inventory physical equipment, clocks, GPUs, compilers, libraries, evaluators and reference services affecting results
- maintain calibration or verification status and metrological traceability where applicable
- block use of expired, tampered or unverified test assets
...
- `artifacts/elmos-test-equipment-software-calibration-traceability-governor/profile.yaml`
- `artifacts/elmos-test-equipment-software-calibration-traceability-governor/plan.json`
- `artifacts/elmos-test-equipment-software-calibration-traceability-governor/result.json`
- `artifacts/elmos-test-equipment-software-calibration-traceability-governor/evidence/`
- `artifacts/elmos-test-equipment-software-calibration-traceability-governor/assurance-case.json`
...
- **unqualified GPU kernel changes numeric result** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **system clock invalidates event ordering evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **test software version is not preserved** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: inventory physical equipment, clocks, GPUs, compilers, libraries, evaluators and reference services affecting results
- native scenario: maintain calibration or verification status and metrological traceability where applicable
- native scenario: block use of expired, tampered or unverified test assets
