---
name: elmos-ai-counterfactual-fairness-causal-stability-verifier
description: Implement and independently certify counterfactual fairness and causal stability verifier, including build causal assumptions and test counterfactual invariance where justified, distinguish legitimate mediators from prohibited proxies and stress causal stability across environments and policy changes.
version: 4.0.0
...
# Counterfactual Fairness and Causal Stability Verifier
...
- `CounterfactualFairnessAndCausalStabilityVerifierProfile`
- `CounterfactualFairnessAndCausalStabilityVerifierRun`
- `CounterfactualFairnessAndCausalStabilityVerifierFinding`
- `CounterfactualFairnessAndCausalStabilityVerifierDecision`
- `CounterfactualFairnessAndCausalStabilityVerifierEvidence`

Required semantic capabilities:

- build causal assumptions and test counterfactual invariance where justified
- distinguish legitimate mediators from prohibited proxies
- stress causal stability across environments and policy changes
...
- `artifacts/elmos-ai-counterfactual-fairness-causal-stability-verifier/profile.yaml`
- `artifacts/elmos-ai-counterfactual-fairness-causal-stability-verifier/plan.json`
- `artifacts/elmos-ai-counterfactual-fairness-causal-stability-verifier/result.json`
- `artifacts/elmos-ai-counterfactual-fairness-causal-stability-verifier/evidence/`
- `artifacts/elmos-ai-counterfactual-fairness-causal-stability-verifier/assurance-case.json`
...
- **causal graph is asserted without evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **proxy discrimination survives metric parity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **counterfactual intervention is physically impossible** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: build causal assumptions and test counterfactual invariance where justified
- native scenario: distinguish legitimate mediators from prohibited proxies
- native scenario: stress causal stability across environments and policy changes
