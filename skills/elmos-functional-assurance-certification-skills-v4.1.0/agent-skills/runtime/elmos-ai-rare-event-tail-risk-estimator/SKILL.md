...
# Rare-Event and Tail-Risk Estimator
...
- `RareEventAndTailRiskEstimatorProfile`
- `RareEventAndTailRiskEstimatorRun`
- `RareEventAndTailRiskEstimatorFinding`
- `RareEventAndTailRiskEstimatorDecision`
- `RareEventAndTailRiskEstimatorEvidence`

Required semantic capabilities:

- estimate low-frequency severe failures using importance sampling, stress testing and extreme-value methods
- bound uncertainty when zero failures are observed
- combine scenario likelihood and consequence for certification decisions
...
- `artifacts/elmos-ai-rare-event-tail-risk-estimator/profile.yaml`
- `artifacts/elmos-ai-rare-event-tail-risk-estimator/plan.json`
- `artifacts/elmos-ai-rare-event-tail-risk-estimator/result.json`
- `artifacts/elmos-ai-rare-event-tail-risk-estimator/evidence/`
- `artifacts/elmos-ai-rare-event-tail-risk-estimator/assurance-case.json`
...
- **zero observed failures is reported as zero risk** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **importance weights are unstable** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tail model extrapolates beyond evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: estimate low-frequency severe failures using importance sampling, stress testing and extreme-value methods
- native scenario: bound uncertainty when zero failures are observed
- native scenario: combine scenario likelihood and consequence for certification decisions
