package elmos.ai_factory.v4.database_authorization_equivalence
import rego.v1
...
# Intent: deny database cutover when least privilege, row/column policy, masking or privileged routine behavior diverges.
