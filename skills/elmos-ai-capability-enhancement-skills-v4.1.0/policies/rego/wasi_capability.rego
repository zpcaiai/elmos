package elmos.ai_factory.v4.wasi_capability
import rego.v1
...
# Intent: deny WASI execution when an undeclared host capability, path, network destination or secret is requested.
