package elmos.ai_factory.v4.model_artifact_provenance
import rego.v1
...
# Intent: deny model deployment when weight, tokenizer, adapter, conversion or license provenance is incomplete.
