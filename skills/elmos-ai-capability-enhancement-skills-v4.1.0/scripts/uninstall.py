...
def main():
    ...
    receipt_path=repo/".elmos/skillpacks/elmos-ai-capability-enhancement-skills/install-receipt.json"
    ...
    for base in [repo/".agents/skills",repo/".claude/skills",repo/".elmos/skillpacks/elmos-ai-capability-enhancement-skills"]:
        if base.exists():
