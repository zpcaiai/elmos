---
name: elmos-ai-system-model-card-generator
description: Generate evidence-backed system/model cards describing intended use, limits, evaluations, risks, data, oversight,
  deployment envelope and change history.
version: 4.0.0
...
# AI System and Model Card Generator
...
- `Approval`
- `ResidualRisk`
- `AISystemAndModelCardGeneratorRun`
- `AISystemAndModelCardGeneratorDecision`

Required semantic capabilities:

- Audience-specific disclosure
- Intended/prohibited use and limitations
- Evaluation and risk evidence links
- Data/model/prompt/tool inventory summary
- Version/change and recertification state
...
- `system-card.md`
- `model-card.md`
- `card-evidence-map.json`
- `disclosure-gap-ledger.json`
...
- **marketing overclaim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale evaluation reuse** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive system detail leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **missing limitation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unverifiable metric** — must have a preventive control, a detective signal, a negative fixture and a response action.
