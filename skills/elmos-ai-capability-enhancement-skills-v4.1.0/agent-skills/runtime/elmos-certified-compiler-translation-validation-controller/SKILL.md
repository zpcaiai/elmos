...
# Certified Compiler and Translation Validation Controller
...
- `CertifiedCompilerAndTranslationValidationControllerProfile`
- `CertifiedCompilerAndTranslationValidationControllerRun`
- `CertifiedCompilerAndTranslationValidationControllerFinding`
- `CertifiedCompilerAndTranslationValidationControllerDecision`
- `CertifiedCompilerAndTranslationValidationControllerEvidence`

Required semantic capabilities:

- prefer certified compiler or independently validate every concrete translation
- compare source and target semantics at IR, binary and runtime boundaries
- preserve proof lineage through optimization and code generation
...
- `elmos-compiler-frontend-conformance-certifier` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.
- `elmos-tcb-attack-surface-closure-certifier` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `artifacts/elmos-certified-compiler-translation-validation-controller/profile.yaml`
- `artifacts/elmos-certified-compiler-translation-validation-controller/plan.json`
- `artifacts/elmos-certified-compiler-translation-validation-controller/result.json`
- `artifacts/elmos-certified-compiler-translation-validation-controller/evidence/`
- `artifacts/elmos-certified-compiler-translation-validation-controller/assurance-case.json`
...
- **compiler correctness assumed from tests alone** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **optimization invalidates source-level proof** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **translation validator shares compiler bug** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: prefer certified compiler or independently validate every concrete translation
- native scenario: compare source and target semantics at IR, binary and runtime boundaries
- native scenario: preserve proof lineage through optimization and code generation
