---
name: elmos-ai-eval-dataset-governor
description: Govern versioned evaluation datasets from provenance and consent through deduplication, labels, holdout isolation,
  contamination detection, retention and release.
version: 4.0.0
...
# AI Evaluation Dataset Governor
...
- `Counterexample`
- `CoverageMap`
- `AIEvaluationDatasetGovernorRun`
- `AIEvaluationDatasetGovernorDecision`

Required semantic capabilities:

- Dataset source, consent and PII classification
- Deduplication and difficulty/coverage annotation
- Development/regression/hidden/red-team partitioning
- Contamination and leakage detection
- Version, retention, expiry and lineage governance
...
- `eval-dataset-manifest.json`
- `dataset-lineage.json`
- `contamination-report.json`
- `dataset-release-decision.json`
...
- **holdout leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **label poisoning** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **privacy violation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **benchmark contamination** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **silent dataset mutation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- holdout access denial
- PII redaction
- expired dataset block
