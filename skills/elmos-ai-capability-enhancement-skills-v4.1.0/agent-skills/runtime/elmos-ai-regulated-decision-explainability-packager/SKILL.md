---
name: elmos-ai-regulated-decision-explainability-packager
description: Package decision inputs, evidence, rules, model contribution, uncertainty, oversight and appeal artifacts for
...
# AI Regulated Decision Explainability Packager
...
- `Approval`
- `ResidualRisk`
- `AIRegulatedDecisionExplainabilityPackagerRun`
- `AIRegulatedDecisionExplainabilityPackagerDecision`

Required semantic capabilities:

- Decision context and data lineage
- Rule/model/tool contribution record
- Uncertainty and limitation disclosure
- Human oversight and approval trail
- Contestability, appeal and correction workflow
...
- `appeal-package.json`
- `explainability-gap-ledger.json`
...
- **post-hoc fabricated explanation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive feature leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **false causal claim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **appeal ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **decision/evidence mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
