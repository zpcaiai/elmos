---
name: elmos-release-test-budget-risk-optimizer
description: Select PR, nightly, release and certification suites under wall-clock and cost budgets while preserving mandatory critical obligations.
version: 4.0.0
...
# Release Test Budget and Risk Optimizer
...
- `ReleaseTestBudgetAndRiskOptimizerProfile`
- `ReleaseTestBudgetAndRiskOptimizerPlan`
- `ReleaseTestBudgetAndRiskOptimizerRun`
- `ReleaseTestBudgetAndRiskOptimizerDecision`

Required semantic capabilities:

- score change impact, criticality and evidence freshness
- reserve mandatory proof and security tests
- optimize covering array and historical regression set
- forecast wall-clock and resource cost
- explain excluded tests and residual risk
...
- `artifacts/elmos-release-test-budget-risk-optimizer/profile.yaml`
- `artifacts/elmos-release-test-budget-risk-optimizer/plan.json`
- `artifacts/elmos-release-test-budget-risk-optimizer/result.json`
- `artifacts/elmos-release-test-budget-risk-optimizer/evidence/`
...
- **cost pressure drops critical test** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **historical data biases new feature** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **selection model trained on escaped defects only** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **excluded test hidden from report** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ETA ignores queue capacity** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: score change impact, criticality and evidence freshness
- native scenario: reserve mandatory proof and security tests
- native scenario: optimize covering array and historical regression set
- native scenario: forecast wall-clock and resource cost
- native scenario: explain excluded tests and residual risk
