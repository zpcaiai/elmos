---
name: elmos-nondeterministic-statistical-reliability-verifier
description: Estimate success, failure, flake and quality distributions for agents and distributed systems using repeated trials, confidence bounds and sequential tests.
version: 4.0.0
...
# Nondeterministic Statistical Reliability Verifier
...
- `NondeterministicStatisticalReliabilityVerifierProfile`
- `NondeterministicStatisticalReliabilityVerifierPlan`
- `NondeterministicStatisticalReliabilityVerifierRun`
- `NondeterministicStatisticalReliabilityVerifierDecision`

Required semantic capabilities:

- define trial independence and seed strategy
- estimate confidence intervals and tail failure rates
- run sequential stopping with error control
- separate infrastructure flake from behavior variance
- block underpowered production claims
...
- `artifacts/elmos-nondeterministic-statistical-reliability-verifier/profile.yaml`
- `artifacts/elmos-nondeterministic-statistical-reliability-verifier/plan.json`
- `artifacts/elmos-nondeterministic-statistical-reliability-verifier/result.json`
- `artifacts/elmos-nondeterministic-statistical-reliability-verifier/evidence/`
...
- **retries counted as independent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **optional stopping inflates confidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rare catastrophic failure averaged away** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **seed leaks hidden test** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **LLM judge variance ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define trial independence and seed strategy
- native scenario: estimate confidence intervals and tail failure rates
- native scenario: run sequential stopping with error control
- native scenario: separate infrastructure flake from behavior variance
- native scenario: block underpowered production claims
