---
name: elmos-ai-model-provider-availability-resilience-controller
description: Control provider health, regional routing, retries, hedging, fallback, rate limits and circuit breakers while
  preserving capability and data-policy constraints.
version: 4.0.0
...
# AI Model Provider Availability and Resilience Controller
...
- **Kernel authorities used:** K4, K6, K7
...
- `Approval`
- `ResidualRisk`
- `AIModelProviderAvailabilityAndResilienceControllerRun`
- `AIModelProviderAvailabilityAndResilienceControllerDecision`

Required semantic capabilities:

- Provider health and rate-limit state
- Capability/policy-aware fallback
- Retry/hedge/circuit-breaker bounds
- Region and data-residency enforcement
- Recovery and brownout modes
...
- `provider-resilience-policy.yaml`
- `health-events.jsonl`
- `fallback-decisions.json`
- `resilience-test-report.json`
...
- **fallback violates residency** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **retry storm** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **weak model silent substitution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider health spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hedging duplicate charge** — must have a preventive control, a detective signal, a negative fixture and a response action.
