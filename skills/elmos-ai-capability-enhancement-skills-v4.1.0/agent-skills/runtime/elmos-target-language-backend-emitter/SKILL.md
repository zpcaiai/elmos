---
name: elmos-target-language-backend-emitter
description: Emit buildable target repositories from semantic IR using deterministic code generation, bounded synthesis and target-native package, error, concurrency and ownership conventions.
version: 4.0.0
...
# Target Language Backend Emitter
...
- Lower typed IR into target-native constructs
- Preserve source maps and symbol identity
- Separate deterministic generated and user-owned regions
- Generate build/package/test configuration
- Bound model edits to unresolved mappings
...
- `backend-emission-map.json`
- `generated-region-map.json`
- `backend-gap-ledger.json`
...
- **generated code compiles but changes semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **user code overwritten on regeneration** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **backend rule version drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsafe target idiom introduced** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dependency substitution without license/security review** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- minimal repository build
- target idiom conformance
- source map fidelity
- generated/user region merge
- concurrency/error lowering
- unsupported construct block
