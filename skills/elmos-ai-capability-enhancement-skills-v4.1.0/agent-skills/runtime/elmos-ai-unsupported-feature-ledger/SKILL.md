---
name: elmos-ai-unsupported-feature-ledger
description: Record every unsupported, partially represented, emulated, runtime-monitored or waived feature and block silent
  degradation.
version: 4.0.0
...
- **Kernel authorities used:** K3, K6, K8
...
- Compile governance into executable controls
- Bind decisions to evidence and human authority
- Track waivers, expiry and residual risk
- Prevent policy and completion self-certification
...
- `unsupported-feature-ledger.json`
- `waiver-requests/`
- `fallback-decisions.json`
- `certification-impact.json`
...
- **policy bypass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **waiver laundering** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rubber-stamp approval** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **false compliance claim** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- unknown policy
- revocation
- AiUnsupportedFeatureLedger representative end-to-end fixture
