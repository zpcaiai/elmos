---
name: elmos-performance-statistical-gate
description: Evaluate latency, throughput, resource, quality and cost regressions with representative workloads, confidence intervals, power analysis and sequential decisions.
version: 4.0.0
...
- Define workload and measurement protocol before execution
- Separate warmup, steady state and saturation
- Use confidence intervals and practical effect thresholds
- Control repeated/sequential testing error
- Report quality-cost-latency tradeoffs
...
- `performance-gate-result.json`
- `benchmark-samples.parquet`
...
- **benchmark cherry-picking** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **insufficient sample declared pass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **warm cache bias** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **multiple comparison false positive** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **statistical significance without practical significance** — must have a preventive control, a detective signal, a negative fixture and a response action.
