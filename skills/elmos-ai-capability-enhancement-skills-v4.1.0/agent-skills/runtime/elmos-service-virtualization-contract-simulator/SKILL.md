---
name: elmos-service-virtualization-contract-simulator
description: Generate deterministic simulators for unavailable services, brokers, tools and failure modes without letting mocks masquerade as native certification.
version: 4.0.0
...
# Service Virtualization and Contract Simulator
...
- `ServiceVirtualizationAndContractSimulatorProfile`
- `ServiceVirtualizationAndContractSimulatorPlan`
- `ServiceVirtualizationAndContractSimulatorRun`
- `ServiceVirtualizationAndContractSimulatorDecision`

Required semantic capabilities:

- derive simulator behavior from contracts and traces
- model latency, errors, retries and rate limits
- record simulation fidelity and omissions
- support deterministic seeds and replay
- mark evidence as simulated and require native follow-up
...
- `artifacts/elmos-service-virtualization-contract-simulator/profile.yaml`
- `artifacts/elmos-service-virtualization-contract-simulator/plan.json`
- `artifacts/elmos-service-virtualization-contract-simulator/result.json`
- `artifacts/elmos-service-virtualization-contract-simulator/evidence/`
...
- **simulator encodes desired result** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **failure distribution unrealistic** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **mock evidence promoted to native** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive production trace copied** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **simulator drift from provider** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: derive simulator behavior from contracts and traces
- native scenario: model latency, errors, retries and rate limits
- native scenario: record simulation fidelity and omissions
- native scenario: support deterministic seeds and replay
- native scenario: mark evidence as simulated and require native follow-up
