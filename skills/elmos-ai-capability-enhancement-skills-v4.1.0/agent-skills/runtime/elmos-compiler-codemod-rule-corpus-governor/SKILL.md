---
name: elmos-compiler-codemod-rule-corpus-governor
description: Curate deterministic rewrite rules, fixtures, semantic preservation contracts, provenance, coverage, conflict handling and promotion across language routes.
version: 4.0.0
...
# Compiler and Codemod Rule Corpus Governor
...
- `CompilerAndCodemodRuleCorpusGovernorProfile`
- `CompilerAndCodemodRuleCorpusGovernorPlan`
- `CompilerAndCodemodRuleCorpusGovernorRun`
- `CompilerAndCodemodRuleCorpusGovernorDecision`

Required semantic capabilities:

- version rules with pre/postconditions
- maintain positive, negative and conflict fixtures
- measure construct and repository coverage
- promote counterexample-derived rules under review
- revoke rules after compiler or runtime drift
...
- `artifacts/elmos-compiler-codemod-rule-corpus-governor/profile.yaml`
- `artifacts/elmos-compiler-codemod-rule-corpus-governor/plan.json`
- `artifacts/elmos-compiler-codemod-rule-corpus-governor/result.json`
- `artifacts/elmos-compiler-codemod-rule-corpus-governor/evidence/`
...
- **rule overmatches** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fixture contamination** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **preservation contract self-asserted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **conflicting recipes reorder effects** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unreviewed learned rule reaches production** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: version rules with pre/postconditions
- native scenario: maintain positive, negative and conflict fixtures
- native scenario: measure construct and repository coverage
- native scenario: promote counterexample-derived rules under review
- native scenario: revoke rules after compiler or runtime drift
