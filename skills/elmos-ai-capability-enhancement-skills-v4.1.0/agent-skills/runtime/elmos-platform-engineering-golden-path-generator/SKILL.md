---
name: elmos-platform-engineering-golden-path-generator
description: Generate self-service application and AI workload golden paths with templates, policies, scorecards, paved-road services and escape hatches.
version: 4.0.0
...
# Platform Engineering Golden Path Generator
...
- `PlatformEngineeringGoldenPathGeneratorProfile`
- `PlatformEngineeringGoldenPathGeneratorPlan`
- `PlatformEngineeringGoldenPathGeneratorRun`
- `PlatformEngineeringGoldenPathGeneratorDecision`

Required semantic capabilities:

- compile archetype to approved platform services
- generate repo, CI, observability and security defaults
- register ownership and service catalog metadata
- measure adoption and exception cost
- version and deprecate golden paths safely
...
- `artifacts/elmos-platform-engineering-golden-path-generator/profile.yaml`
- `artifacts/elmos-platform-engineering-golden-path-generator/plan.json`
- `artifacts/elmos-platform-engineering-golden-path-generator/result.json`
- `artifacts/elmos-platform-engineering-golden-path-generator/evidence/`
...
- **golden path becomes mandatory lock-in** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **escape hatch bypasses evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **template version drifts silently** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ownership metadata fake** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **scorecard rewards file presence** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile archetype to approved platform services
- native scenario: generate repo, CI, observability and security defaults
- native scenario: register ownership and service catalog metadata
- native scenario: measure adoption and exception cost
- native scenario: version and deprecate golden paths safely
