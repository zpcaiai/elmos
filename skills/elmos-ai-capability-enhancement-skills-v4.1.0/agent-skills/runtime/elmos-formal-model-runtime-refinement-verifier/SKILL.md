---
name: elmos-formal-model-runtime-refinement-verifier
description: Implement and independently certify formal model to runtime refinement verifier, including define abstraction relation between executable system and formal model, validate implementation traces refine allowed model behavior and monitor open-world boundaries and unmodeled side effects.
version: 4.0.0
...
# Formal Model to Runtime Refinement Verifier
...
- `FormalModelToRuntimeRefinementVerifierProfile`
- `FormalModelToRuntimeRefinementVerifierRun`
- `FormalModelToRuntimeRefinementVerifierFinding`
- `FormalModelToRuntimeRefinementVerifierDecision`
- `FormalModelToRuntimeRefinementVerifierEvidence`

Required semantic capabilities:

- define abstraction relation between executable system and formal model
- validate implementation traces refine allowed model behavior
- monitor open-world boundaries and unmodeled side effects
...
- `artifacts/elmos-formal-model-runtime-refinement-verifier/profile.yaml`
- `artifacts/elmos-formal-model-runtime-refinement-verifier/plan.json`
- `artifacts/elmos-formal-model-runtime-refinement-verifier/result.json`
- `artifacts/elmos-formal-model-runtime-refinement-verifier/evidence/`
- `artifacts/elmos-formal-model-runtime-refinement-verifier/assurance-case.json`
...
- **model proves property of behavior runtime never follows** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **abstraction omits security-relevant state** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **runtime instrumentation changes schedule** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define abstraction relation between executable system and formal model
- native scenario: validate implementation traces refine allowed model behavior
- native scenario: monitor open-world boundaries and unmodeled side effects
