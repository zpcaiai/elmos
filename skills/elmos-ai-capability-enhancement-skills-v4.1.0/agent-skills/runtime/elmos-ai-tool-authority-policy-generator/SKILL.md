---
name: elmos-ai-tool-authority-policy-generator
description: Generate environment-owned, attachment-owned and request-scoped tool authority policies with path/parameter constraints,
  approval gates and deny-by-default behavior.
version: 4.0.0
...
# AIToolAuthorityPolicyGenerator
...
- **Kernel authorities used:** K6, K7, K8
...
- `policies/generated-tool-authority/`
- `authority-snapshots/`
- `approval-workflows/`
- `policy-tests/`
...
- AiToolAuthorityPolicyGenerator representative end-to-end fixture
