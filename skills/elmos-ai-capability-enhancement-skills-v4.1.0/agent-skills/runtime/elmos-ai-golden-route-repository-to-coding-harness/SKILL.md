---
name: elmos-ai-golden-route-repository-to-coding-harness
description: Analyze a repository and generate repository-specific Pi, Harness, OpenCode/Codex/Claude/Gemini skills, authority
  policies, workflows and verification gates.
version: 4.0.0
...
# AIGoldenRouteRepositoryToCodingHarness
...
- **Kernel authorities used:** K1, K2, K3, K4, K5, K6, K7, K8
...
- Execute a repeatable end-to-end commercial route
- Use hidden holdouts and independent oracles
- Capture machine ETA, cost, rollback and customer acceptance
- Certify only exact route envelope
...
- `elmos-ai-e0-e5-certifier` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `golden-route/repository-to-coding-harness/`
- `repository-capability-pack/`
...
- **benchmark leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cherry-picked run** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer evidence fabrication** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unrepeatable manual step** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **envelope overclaim** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- AiGoldenRouteRepositoryToCodingHarness representative end-to-end fixture
