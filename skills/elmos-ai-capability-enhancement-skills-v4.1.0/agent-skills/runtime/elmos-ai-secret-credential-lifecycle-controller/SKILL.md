---
name: elmos-ai-secret-credential-lifecycle-controller
description: Broker short-lived model, tool, database and cloud credentials with least privilege, rotation, revocation, leak
  detection and incident integration.
version: 4.0.0
...
# AI Secret and Credential Lifecycle Controller
...
- `Approval`
- `ResidualRisk`
- `AISecretAndCredentialLifecycleControllerRun`
- `AISecretAndCredentialLifecycleControllerDecision`

Required semantic capabilities:

- Secret broker integration
- Request-scoped credential issuance
- Rotation and revocation lifecycle
- Output/log/trace leak prevention
- Incident-driven mass revocation
...
- `secret-access-events.jsonl`
- `rotation-evidence.json`
- `credential-revocation-report.json`
...
- **ambient secret** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **credential exfiltration** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale token after revoke** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-tenant secret cache** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **secret in generated project** — must have a preventive control, a detective signal, a negative fixture and a response action.
