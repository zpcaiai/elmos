---
name: elmos-a2a-v1-agent-card-trust-compiler
description: Compile, sign, verify, rotate and revoke A2A v1 Agent Cards that bind identity, capabilities, interfaces, tenant
...
# A2A v1 Agent Card Trust Compiler
...
- `Approval`
- `ResidualRisk`
- `A2AV1AgentCardTrustCompilerRun`
- `A2AV1AgentCardTrustCompilerDecision`

Required semantic capabilities:

- Canonical Agent Card generation
- Signature and issuer trust validation
- Protocol/interface version negotiation
- Tenant and trust-domain binding
- Expiry, rotation, revocation and evidence-root binding
...
- `agent-card.json`
- `agent-card.jws`
- `agent-card-trust-report.json`
- `agent-card-revocation.json`
...
- **stale card replay** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-tenant discovery leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
