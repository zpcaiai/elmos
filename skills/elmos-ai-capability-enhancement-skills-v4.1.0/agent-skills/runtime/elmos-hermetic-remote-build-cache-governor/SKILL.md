---
name: elmos-hermetic-remote-build-cache-governor
description: Govern remote execution and build caches with content addressing, toolchain/environment keys, tenant isolation, provenance and poisoning detection.
version: 4.0.0
...
# Hermetic Remote Build Cache Governor
...
- `HermeticRemoteBuildCacheGovernorProfile`
- `HermeticRemoteBuildCacheGovernorPlan`
- `HermeticRemoteBuildCacheGovernorRun`
- `HermeticRemoteBuildCacheGovernorDecision`

Required semantic capabilities:

- derive complete action cache keys
- attest remote workers and toolchains
- segregate tenant and trust domains
- verify downloaded outputs and provenance
- invalidate on environment or policy drift
...
- `artifacts/elmos-hermetic-remote-build-cache-governor/profile.yaml`
- `artifacts/elmos-hermetic-remote-build-cache-governor/plan.json`
- `artifacts/elmos-hermetic-remote-build-cache-governor/result.json`
- `artifacts/elmos-hermetic-remote-build-cache-governor/evidence/`
...
- **incomplete cache key** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-tenant artifact reuse** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **malicious remote worker** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cache hit bypasses required test** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **mutable toolchain hidden** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: derive complete action cache keys
- native scenario: attest remote workers and toolchains
- native scenario: segregate tenant and trust domains
- native scenario: verify downloaded outputs and provenance
- native scenario: invalidate on environment or policy drift
