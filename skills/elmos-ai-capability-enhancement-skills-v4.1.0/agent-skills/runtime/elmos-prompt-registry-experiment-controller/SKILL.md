---
name: elmos-prompt-registry-experiment-controller
description: Operate prompt registries, controlled experiments, review gates, canaries, rollback and evidence-based promotion
  without bypassing canonical Prompt Program IR.
version: 4.0.0
...
# Prompt Registry and Experiment Controller
...
- **Kernel authorities used:** K4, K6, K7, K8
...
- `DeploymentUnit`
- `ConformanceRun`
- `PromptRegistryAndExperimentControllerRun`
- `PromptRegistryAndExperimentControllerDecision`

Required semantic capabilities:

- Immutable prompt versions and aliases
- Experiment assignment and guardrails
- Offline and online paired evaluation
- Approval and staged promotion
- Rollback and evidence invalidation
...
- `prompt-promotion-decision.json`
...
- **prompt alias hijack** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **experiment contamination** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **metric cherry-picking** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsafe automatic promotion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback points missing** — must have a preventive control, a detective signal, a negative fixture and a response action.
