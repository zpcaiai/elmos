---
name: elmos-sql-dialect-lowering-engine
description: Lower DB-SIR into target DDL, DML and routines through deterministic rules, vendor profiles and bounded synthesis with reversible lineage.
version: 4.0.0
...
- **Kernel authorities used:** K3, K5, K6
...
- Apply typed dialect rules before text rewriting
- Preserve object and query lineage
- Generate compatibility functions only with explicit ownership
- Bound generative routine translation
- Refuse critical unsupported features
...
- `target-sql/`
- `sql-lowering-lineage.json`
- `sql-rule-evidence.json`
- `unlowered-sql-register.json`
...
- **regex translation corrupts SQL** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **compatibility shim changes transaction semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated routine security definer risk** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **identifier quoting collision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unlowered statement omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- trigger lowering
- compatibility shim
- round-trip formatting/source map
