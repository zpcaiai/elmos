---
name: elmos-ai-policy-as-code-compiler
description: Compile governance and security decisions into versioned Rego or equivalent policies with tests, simulation,
  staged rollout and explanation artifacts.
version: 4.0.0
...
- **Kernel authorities used:** K1, K5, K6, K7
...
- `Approval`
- `ResidualRisk`
- `AIPolicyAsCodeCompilerRun`
- `AIPolicyAsCodeCompilerDecision`

Required semantic capabilities:

- Typed policy input/output model
- Deterministic compilation to policy engine
- Positive/negative/unknown tests
- Shadow and staged policy rollout
- Decision explanation and rollback
...
- `generated-policies/`
- `policy-test-corpus/`
- `policy-decision-explanations.json`
- `policy-rollout-plan.yaml`
...
- **default allow** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **conflicting policy precedence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **untrusted input attribute** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsafe policy promotion** — must have a preventive control, a detective signal, a negative fixture and a response action.
