---
name: elmos-agent-client-protocol-acp-adapter-generator
description: Generate ACP v1 agents and clients for local/remote coding-agent integration with sessions, capabilities, tool-call updates, permissions and extensibility.
version: 4.0.0
...
# Agent Client Protocol ACP Adapter Generator
...
- `AgentClientProtocolACPAdapterGeneratorProfile`
- `AgentClientProtocolACPAdapterGeneratorPlan`
- `AgentClientProtocolACPAdapterGeneratorRun`
- `AgentClientProtocolACPAdapterGeneratorDecision`

Required semantic capabilities:

- compile ACP capability and transport profile
- generate JSON-RPC agent/client endpoints
- map sessions, plans, tool calls and permissions
- support stdio/remote transport and extensions
- run editor-agent interoperability tests
...
- `artifacts/elmos-agent-client-protocol-acp-adapter-generator/profile.yaml`
- `artifacts/elmos-agent-client-protocol-acp-adapter-generator/plan.json`
- `artifacts/elmos-agent-client-protocol-acp-adapter-generator/result.json`
- `artifacts/elmos-agent-client-protocol-acp-adapter-generator/evidence/`
...
- **client assumes unsupported extension** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tool update leaks secret** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **session resume attaches wrong workspace** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **permission prompt bypassed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **transport framing desynchronizes** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile ACP capability and transport profile
- native scenario: generate JSON-RPC agent/client endpoints
- native scenario: map sessions, plans, tool calls and permissions
- native scenario: support stdio/remote transport and extensions
- native scenario: run editor-agent interoperability tests
