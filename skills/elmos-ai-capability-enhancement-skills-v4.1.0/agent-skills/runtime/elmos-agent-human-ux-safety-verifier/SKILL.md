---
name: elmos-agent-human-ux-safety-verifier
description: Verify that agent interfaces communicate uncertainty, intent, side effects, approvals, reversibility and recovery
  without dark patterns or misleading automation.
version: 4.0.0
...
# Agent Human UX Safety Verifier
...
- `DeploymentUnit`
- `ConformanceRun`
- `AgentHumanUXSafetyVerifierRun`
- `AgentHumanUXSafetyVerifierDecision`

Required semantic capabilities:

- Action preview and consequence clarity
- Uncertainty and evidence display
- Consent/approval usability
- Cancellation/recovery feedback
- Accessibility and dark-pattern checks
...
- `ux-safety-scenarios.yaml`
- `human-factors-results.json`
- `consent-usability-report.json`
- `ux-release-gate.json`
...
- **misleading confirmation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hidden irreversible action** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **automation complacency** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **consent fatigue** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **inaccessible safety control** — must have a preventive control, a detective signal, a negative fixture and a response action.
