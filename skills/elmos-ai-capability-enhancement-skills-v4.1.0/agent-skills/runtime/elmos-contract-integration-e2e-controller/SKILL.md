---
name: elmos-contract-integration-e2e-controller
description: Generate and run provider/consumer, API, event, tool, MCP/A2A, database integration and end-to-end journey suites against real dependencies.
version: 4.0.0
...
# Contract, Integration and E2E Controller
...
- Compile tests from recovered contracts
- Provision real disposable dependencies
- Exercise positive, negative and idempotency paths
- Trace journeys across services and tools
- Bind failures to requirement and artifact lineage
...
- **mock differs from real dependency** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **consumer fixture stale** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **event eventually arrives after test ends** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **journey asserts only HTTP status** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **test tool has excess production authority** — must have a preventive control, a detective signal, a negative fixture and a response action.
