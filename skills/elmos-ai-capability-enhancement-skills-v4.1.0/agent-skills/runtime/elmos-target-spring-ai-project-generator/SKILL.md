---
name: elmos-target-spring-ai-project-generator
description: Generate enterprise Spring Boot AI services with ChatClient, Advisors, RAG, VectorStore, tools, MCP, memory,
  security, observability, Testcontainers and deployment assets.
version: 4.0.0
...
# TargetSpringAIProjectGenerator
...
- Generate Boot modules with ChatClient and Advisors
- Generate Tool Calling and MCP client/server
- Generate RAG, VectorStore and ChatMemory
- Generate Security, multitenancy and Actuator/OTel
- Run Maven/Gradle, Testcontainers and native startup checks
...
- **SpEL/template injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ToolCallback overpermission** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-tenant memory** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **actuator data leak** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dependency auto-configuration drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- Tool Calling
- MCP client/server
- VectorStore Testcontainers
- Spring Security tenant isolation
- SSE streaming
- Flyway rollback
- Actuator metrics
