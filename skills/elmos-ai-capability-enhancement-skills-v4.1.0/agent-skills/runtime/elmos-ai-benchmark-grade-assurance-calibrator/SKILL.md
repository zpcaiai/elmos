---
name: elmos-ai-benchmark-grade-assurance-calibrator
description: Implement and independently certify ai benchmark grade assurance calibrator, including grade benchmark difficulty, realism, contamination resistance and statistical confidence, calibrate assurance claims to context complexity and evidence diversity and prevent leaderboard rank from becoming universal certification.
version: 4.0.0
...
# AI Benchmark Grade Assurance Calibrator
...
- `AIBenchmarkGradeAssuranceCalibratorProfile`
- `AIBenchmarkGradeAssuranceCalibratorRun`
- `AIBenchmarkGradeAssuranceCalibratorFinding`
- `AIBenchmarkGradeAssuranceCalibratorDecision`
- `AIBenchmarkGradeAssuranceCalibratorEvidence`

Required semantic capabilities:

- grade benchmark difficulty, realism, contamination resistance and statistical confidence
- calibrate assurance claims to context complexity and evidence diversity
- prevent leaderboard rank from becoming universal certification
...
- `elmos-benchmark-integrity-large-repository-certifier` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.
- `elmos-ai-quality-characteristic-measurement-compiler` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `artifacts/elmos-ai-benchmark-grade-assurance-calibrator/profile.yaml`
- `artifacts/elmos-ai-benchmark-grade-assurance-calibrator/plan.json`
- `artifacts/elmos-ai-benchmark-grade-assurance-calibrator/result.json`
- `artifacts/elmos-ai-benchmark-grade-assurance-calibrator/evidence/`
- `artifacts/elmos-ai-benchmark-grade-assurance-calibrator/assurance-case.json`
...
- **benchmark is saturated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **public tasks leak into training** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **grade label implies stronger assurance than evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: grade benchmark difficulty, realism, contamination resistance and statistical confidence
- native scenario: calibrate assurance claims to context complexity and evidence diversity
- native scenario: prevent leaderboard rank from becoming universal certification
