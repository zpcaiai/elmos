---
name: elmos-deterministic-record-replay-model-tool-harness
description: Capture normalized model, tool, retrieval, clock, randomness and external observations for deterministic debugging and bounded regression replay.
version: 4.0.0
...
# Deterministic Model and Tool Record/Replay Harness
...
- `DeterministicModelAndToolRecordReplayHarnessProfile`
- `DeterministicModelAndToolRecordReplayHarnessPlan`
- `DeterministicModelAndToolRecordReplayHarnessRun`
- `DeterministicModelAndToolRecordReplayHarnessDecision`

Required semantic capabilities:

- record exact request/response envelopes and digests
- virtualize time, randomness and nondeterministic IDs
- replay tools with side effects suppressed or reconciled
- compare causal trace and terminal state
- redact/encrypt sensitive payloads by policy
...
- `artifacts/elmos-deterministic-record-replay-model-tool-harness/profile.yaml`
- `artifacts/elmos-deterministic-record-replay-model-tool-harness/plan.json`
- `artifacts/elmos-deterministic-record-replay-model-tool-harness/result.json`
- `artifacts/elmos-deterministic-record-replay-model-tool-harness/evidence/`
...
- **replay accidentally executes real effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **recording contains secrets** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider response terms prohibit retention** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **missing clock source causes divergence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **replay evidence mistaken for live conformance** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: record exact request/response envelopes and digests
- native scenario: virtualize time, randomness and nondeterministic IDs
- native scenario: replay tools with side effects suppressed or reconciled
- native scenario: compare causal trace and terminal state
- native scenario: redact/encrypt sensitive payloads by policy
