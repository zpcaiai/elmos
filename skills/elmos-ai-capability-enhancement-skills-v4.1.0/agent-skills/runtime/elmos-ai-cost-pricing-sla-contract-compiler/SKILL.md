---
name: elmos-ai-cost-pricing-sla-contract-compiler
description: Compile machine wall-clock, token, compute, storage, network, provider and support economics into enforceable
  quotes, budgets, SLAs and settlement evidence.
version: 4.0.0
...
# AI Cost, Pricing and SLA Contract Compiler
...
- `DeploymentUnit`
- `ConformanceRun`
- `AICostPricingAndSLAContractCompilerRun`
- `AICostPricingAndSLAContractCompilerDecision`

Required semantic capabilities:

- Machine-time versus human-review separation
- Provider/token/compute/storage/network accounting
- Quote uncertainty and contingency
- Runtime budget enforcement
- SLA breach and customer settlement evidence
...
- `cost-contract.json`
- `project-quote.json`
- `sla-budget-policy.yaml`
- `cost-settlement-report.json`
...
- **hidden cost markup** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **token accounting mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ETA presented as human days** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **budget overrun race** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider invoice divergence** — must have a preventive control, a detective signal, a negative fixture and a response action.
