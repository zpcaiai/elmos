---
name: elmos-formal-counterexample-to-regression-compiler
description: Translate solver and model-checker traces into deterministic unit, integration, concurrency and fault tests with exact assumptions.
version: 4.0.0
...
# Formal Counterexample-to-Regression Compiler
...
- `FormalCounterexampleToRegressionCompilerProfile`
- `FormalCounterexampleToRegressionCompilerPlan`
- `FormalCounterexampleToRegressionCompilerRun`
- `FormalCounterexampleToRegressionCompilerDecision`

Required semantic capabilities:

- parse verifier-specific counterexamples
- map symbolic values and schedules to fixtures
- preserve minimal causal sequence
- generate target-language and runtime tests
- verify the test fails before and passes after repair
...
- `artifacts/elmos-formal-counterexample-to-regression-compiler/profile.yaml`
- `artifacts/elmos-formal-counterexample-to-regression-compiler/plan.json`
- `artifacts/elmos-formal-counterexample-to-regression-compiler/result.json`
- `artifacts/elmos-formal-counterexample-to-regression-compiler/evidence/`
...
- **translation drops crucial assumption** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **test cannot reproduce schedule** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **counterexample normalized away** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **repair overfits one trace** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated test uses mock oracle** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: parse verifier-specific counterexamples
- native scenario: map symbolic values and schedules to fixtures
- native scenario: preserve minimal causal sequence
- native scenario: generate target-language and runtime tests
- native scenario: verify the test fails before and passes after repair
