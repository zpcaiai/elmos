---
name: elmos-mcp-a2a-acp-bridge-conformance-verifier
description: Verify bridges among tool, agent-to-agent and editor-agent protocols without authority, lifecycle, content or cancellation loss.
version: 4.0.0
...
# MCP, A2A and ACP Bridge Conformance Verifier
...
- `MCPA2AAndACPBridgeConformanceVerifierProfile`
- `MCPA2AAndACPBridgeConformanceVerifierPlan`
- `MCPA2AAndACPBridgeConformanceVerifierRun`
- `MCPA2AAndACPBridgeConformanceVerifierDecision`

Required semantic capabilities:

- map identity, session and task semantics
- translate content blocks and artifacts
- preserve cancellation, progress and approval
- verify extension/version negotiation
- run cross-protocol differential traces
...
- `artifacts/elmos-mcp-a2a-acp-bridge-conformance-verifier/profile.yaml`
- `artifacts/elmos-mcp-a2a-acp-bridge-conformance-verifier/plan.json`
- `artifacts/elmos-mcp-a2a-acp-bridge-conformance-verifier/result.json`
- `artifacts/elmos-mcp-a2a-acp-bridge-conformance-verifier/evidence/`
...
- **tool authority becomes agent authority** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cancellation not propagated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **artifact ownership lost** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **protocol error normalized away** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **bridge loops messages** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: map identity, session and task semantics
- native scenario: translate content blocks and artifacts
- native scenario: preserve cancellation, progress and approval
- native scenario: verify extension/version negotiation
- native scenario: run cross-protocol differential traces
