---
name: elmos-user-feedback-issue-to-eval-dataset-pipeline
description: Convert support, incidents, ratings and corrected outcomes into governed counterexamples and evaluation data with consent, deduplication and holdout protection.
version: 4.0.0
...
# User Feedback and Issue-to-Eval Dataset Pipeline
...
- `UserFeedbackAndIssueToEvalDatasetPipelineProfile`
- `UserFeedbackAndIssueToEvalDatasetPipelinePlan`
- `UserFeedbackAndIssueToEvalDatasetPipelineRun`
- `UserFeedbackAndIssueToEvalDatasetPipelineDecision`

Required semantic capabilities:

- ingest typed feedback and issue evidence
- classify validity, severity and ownership
- redact and deduplicate examples
- promote to regression/holdout under review
- link repair and recertification status
...
- `artifacts/elmos-user-feedback-issue-to-eval-dataset-pipeline/profile.yaml`
- `artifacts/elmos-user-feedback-issue-to-eval-dataset-pipeline/plan.json`
- `artifacts/elmos-user-feedback-issue-to-eval-dataset-pipeline/result.json`
- `artifacts/elmos-user-feedback-issue-to-eval-dataset-pipeline/evidence/`
...
- **user complaint assumed ground truth** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **PII enters dataset** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **same example in train and holdout** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **adversarial feedback poisons evaluator** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **closed ticket removes regression** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: ingest typed feedback and issue evidence
- native scenario: classify validity, severity and ownership
- native scenario: redact and deduplicate examples
- native scenario: promote to regression/holdout under review
- native scenario: link repair and recertification status
