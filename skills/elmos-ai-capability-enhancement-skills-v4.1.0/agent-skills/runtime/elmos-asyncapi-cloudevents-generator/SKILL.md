---
name: elmos-asyncapi-cloudevents-generator
description: Generate versioned AsyncAPI and CloudEvents-compatible contracts, bindings, examples, code stubs and conformance tests from Event Contract IR.
version: 4.0.0
...
# AsyncAPI and CloudEvents Generator
...
- `AsyncAPIAndCloudEventsGeneratorProfile`
- `AsyncAPIAndCloudEventsGeneratorPlan`
- `AsyncAPIAndCloudEventsGeneratorRun`
- `AsyncAPIAndCloudEventsGeneratorDecision`

Required semantic capabilities:

- emit AsyncAPI channels, operations and messages
- generate protocol bindings and CloudEvents envelopes
- produce producer/consumer stubs
- generate schema registry and compatibility tests
...
- `artifacts/elmos-asyncapi-cloudevents-generator/profile.yaml`
- `artifacts/elmos-asyncapi-cloudevents-generator/plan.json`
- `artifacts/elmos-asyncapi-cloudevents-generator/result.json`
- `artifacts/elmos-asyncapi-cloudevents-generator/evidence/`
...
- **binding contradicts broker configuration** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **event type collision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **example leaks production data** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated stub acknowledges too early** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **spec and runtime drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: emit AsyncAPI channels, operations and messages
- native scenario: generate protocol bindings and CloudEvents envelopes
- native scenario: produce producer/consumer stubs
- native scenario: generate schema registry and compatibility tests
- native scenario: validate documentation and examples
