---
name: elmos-domain-driven-architecture-synthesizer
description: Recover domains, bounded contexts, aggregates, policies and integration contracts, then generate explicit architecture candidates and trade-offs.
version: 4.0.0
...
# Domain-Driven Architecture Synthesizer
...
- `DomainDrivenArchitectureSynthesizerProfile`
- `DomainDrivenArchitectureSynthesizerPlan`
- `DomainDrivenArchitectureSynthesizerRun`
- `DomainDrivenArchitectureSynthesizerDecision`

Required semantic capabilities:

- mine domain language and capability ownership
- identify bounded contexts and invariants
- generate context maps and integration patterns
- compare modular monolith and service options
- bind decisions to requirements and evidence
...
- `artifacts/elmos-domain-driven-architecture-synthesizer/profile.yaml`
- `artifacts/elmos-domain-driven-architecture-synthesizer/plan.json`
- `artifacts/elmos-domain-driven-architecture-synthesizer/result.json`
- `artifacts/elmos-domain-driven-architecture-synthesizer/evidence/`
...
- **LLM invents domain boundary** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **database table mistaken for aggregate** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **organizational ownership ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **architecture chosen before constraints** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **trade-off evidence absent** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: mine domain language and capability ownership
- native scenario: identify bounded contexts and invariants
- native scenario: generate context maps and integration patterns
- native scenario: compare modular monolith and service options
- native scenario: bind decisions to requirements and evidence
