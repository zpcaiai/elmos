---
name: elmos-ai-source-project-importer
description: Inspect and import existing visual DSLs, agent SDK repositories, RAG systems, harness packages and deployment
  descriptors into evidence-backed AI-SIR.
version: 4.0.0
...
- Detect exact source framework and version
- Import source-native semantic objects
- Preserve opaque/unsupported material
- Bind import artifacts to source hashes
- Support round-trip and differential validation
...
- `recovered-ai-sir.json`
- `opaque-boundary-register.json`
- `import-confidence.json`
...
- **malicious project file** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **source version spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **silent opaque drop** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **path traversal** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **import side effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- known framework fixture
- mixed framework fixture
- opaque dependency
- AiSourceProjectImporter representative end-to-end fixture
