---
name: elmos-database-dialect-profile-registry
description: Govern exact database engine, version, compatibility mode, charset, collation, driver, extension and operational semantic profiles.
version: 4.0.0
...
# Database Dialect Profile Registry
...
- **Kernel authorities used:** K1, K2, K3, K6
...
- Fingerprint real engines and compatibility modes
- Model DDL/DML/routine/transaction capabilities
- Track charset, collation, extensions and driver
- Classify support and certified envelopes
- Invalidate evidence on parameter or engine drift
...
- `database-dialect-registry.yaml`
- `dialect-capability-matrix.json`
- `dialect-version-lock.json`
- `dialect-drift-events.jsonl`
...
- **engine version misdetected** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **compatibility mode conflated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **collation omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **driver changes semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **managed service hides parameter drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
