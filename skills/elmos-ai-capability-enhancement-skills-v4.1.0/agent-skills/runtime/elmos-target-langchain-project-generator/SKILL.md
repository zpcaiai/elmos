---
name: elmos-target-langchain-project-generator
description: Generate typed Python and TypeScript LangChain applications for model, tool, retriever, middleware and short-horizon
  agent composition with migration hooks to LangGraph.
version: 4.0.0
...
# TargetLangchainProjectGenerator
...
- Generate Python and TypeScript projects
- Generate models, tools, retrievers and middleware
- Generate structured output and streaming API
- Generate evals and observability
- Generate migration path to LangGraph for durable flows
...
- `targets/langchain/`
- `langchain-capability-report.json`
...
- **dynamic chain injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsafe tool executor** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **retriever ACL loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider package drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **short-task runtime used for durable side effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
