---
name: elmos-mcp-enterprise-authorization-controller
description: Generate and verify OAuth/OIDC, client registration, delegated consent, audience restriction, token exchange,
  revocation and enterprise-managed MCP authorization.
version: 4.0.0
...
# MCP Enterprise Authorization Controller
...
- `Approval`
- `ResidualRisk`
- `MCPEnterpriseAuthorizationControllerRun`
- `MCPEnterpriseAuthorizationControllerDecision`

Required semantic capabilities:

- OAuth/OIDC discovery and exact issuer binding
- Dynamic or managed client registration
- User delegation and resource indicators
- Scoped consent and token exchange
- Revocation, expiry and downstream audience enforcement
...
- `mcp-auth-profile.yaml`
- `consent-contracts/`
- `token-exchange-policy.rego`
...
- **confused deputy** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **token replay** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **audience confusion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **scope inflation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **malicious authorization server metadata** — must have a preventive control, a detective signal, a negative fixture and a response action.
