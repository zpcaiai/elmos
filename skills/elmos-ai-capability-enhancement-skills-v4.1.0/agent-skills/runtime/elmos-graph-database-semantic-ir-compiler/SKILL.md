---
name: elmos-graph-database-semantic-ir-compiler
description: Compile property graph, RDF, ontology, traversal, constraint and transaction semantics for Neo4j, Gremlin and SPARQL-class targets.
version: 4.0.0
...
# Graph Database Semantic IR Compiler
...
- `GraphDatabaseSemanticIRCompilerProfile`
- `GraphDatabaseSemanticIRCompilerPlan`
- `GraphDatabaseSemanticIRCompilerRun`
- `GraphDatabaseSemanticIRCompilerDecision`

Required semantic capabilities:

- model nodes, edges, labels, predicates and constraints
- compile Cypher/Gremlin/SPARQL query semantics
- represent path uniqueness and traversal bounds
- capture graph transaction and index behavior
- preserve ontology and provenance mappings
...
- `artifacts/elmos-graph-database-semantic-ir-compiler/profile.yaml`
- `artifacts/elmos-graph-database-semantic-ir-compiler/plan.json`
- `artifacts/elmos-graph-database-semantic-ir-compiler/result.json`
- `artifacts/elmos-graph-database-semantic-ir-compiler/evidence/`
...
- **path explosion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **edge direction lost** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **RDF blank-node identity changed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **constraint semantics weakened** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **query language feature silently approximated** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: model nodes, edges, labels, predicates and constraints
- native scenario: compile Cypher/Gremlin/SPARQL query semantics
- native scenario: represent path uniqueness and traversal bounds
- native scenario: capture graph transaction and index behavior
- native scenario: preserve ontology and provenance mappings
