---
name: elmos-api-first-contract-generation-controller
description: Generate OpenAPI, AsyncAPI, GraphQL and gRPC contracts, mock/simulator assets, server/client stubs and compatibility gates before implementation.
version: 4.0.0
...
# API-First Contract Generation Controller
...
- `APIFirstContractGenerationControllerProfile`
- `APIFirstContractGenerationControllerPlan`
- `APIFirstContractGenerationControllerRun`
- `APIFirstContractGenerationControllerDecision`

Required semantic capabilities:

- compile observable behavior into interface contracts
- generate examples, errors and security schemes
- produce server/client stubs with ownership regions
- register compatibility and review gates
...
- `artifacts/elmos-api-first-contract-generation-controller/profile.yaml`
- `artifacts/elmos-api-first-contract-generation-controller/plan.json`
- `artifacts/elmos-api-first-contract-generation-controller/result.json`
- `artifacts/elmos-api-first-contract-generation-controller/evidence/`
...
- **contract omits business invariant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated stub becomes implementation truth** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **security scheme not enforced** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **example treated as complete schema** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **contract changes without consumer impact** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile observable behavior into interface contracts
- native scenario: generate examples, errors and security schemes
- native scenario: produce server/client stubs with ownership regions
- native scenario: register compatibility and review gates
- native scenario: keep implementation and contract synchronized
