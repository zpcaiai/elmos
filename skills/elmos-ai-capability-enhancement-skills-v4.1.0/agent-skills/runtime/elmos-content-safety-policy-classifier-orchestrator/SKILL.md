---
name: elmos-content-safety-policy-classifier-orchestrator
description: Compose deterministic rules, provider classifiers, custom models and human escalation under versioned safety policy and measurable error trade-offs.
version: 4.0.0
...
# Content Safety Policy and Classifier Orchestrator
...
- `ContentSafetyPolicyAndClassifierOrchestratorProfile`
- `ContentSafetyPolicyAndClassifierOrchestratorPlan`
- `ContentSafetyPolicyAndClassifierOrchestratorRun`
- `ContentSafetyPolicyAndClassifierOrchestratorDecision`

Required semantic capabilities:

- compile taxonomy, thresholds and jurisdiction profile
- route multimodal content through classifier portfolio
- calibrate false positive/negative rates
- apply age/tenant/context policy
- audit appeals and classifier drift
...
- `artifacts/elmos-content-safety-policy-classifier-orchestrator/profile.yaml`
- `artifacts/elmos-content-safety-policy-classifier-orchestrator/plan.json`
- `artifacts/elmos-content-safety-policy-classifier-orchestrator/result.json`
- `artifacts/elmos-content-safety-policy-classifier-orchestrator/evidence/`
...
- **provider taxonomy mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **classifier confidence treated calibrated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **policy bypass via modality** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **protected speech overblocked** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **appeal data reused without consent** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile taxonomy, thresholds and jurisdiction profile
- native scenario: route multimodal content through classifier portfolio
- native scenario: calibrate false positive/negative rates
- native scenario: apply age/tenant/context policy
- native scenario: audit appeals and classifier drift
