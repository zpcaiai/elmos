---
name: elmos-model-provider-procurement-contract-evaluator
description: Evaluate provider SLA, data use, retention, residency, indemnity, deprecation, quota, pricing and exit terms against technical requirements.
version: 4.0.0
...
# Model Provider Procurement and Contract Evaluator
...
- `ModelProviderProcurementAndContractEvaluatorProfile`
- `ModelProviderProcurementAndContractEvaluatorPlan`
- `ModelProviderProcurementAndContractEvaluatorRun`
- `ModelProviderProcurementAndContractEvaluatorDecision`

Required semantic capabilities:

- compile technical and contractual requirement matrix
- map provider terms to controls and unresolved legal review
- model deprecation, outage and exit scenarios
- compare total cost and data exposure
- generate procurement evidence without legal conclusion
...
- `artifacts/elmos-model-provider-procurement-contract-evaluator/profile.yaml`
- `artifacts/elmos-model-provider-procurement-contract-evaluator/plan.json`
- `artifacts/elmos-model-provider-procurement-contract-evaluator/result.json`
- `artifacts/elmos-model-provider-procurement-contract-evaluator/evidence/`
...
- **marketing page treated as contract** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **regional endpoint assumed residency guarantee** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **price change omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **exit export unsupported** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **automatic evaluator gives legal approval** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile technical and contractual requirement matrix
- native scenario: map provider terms to controls and unresolved legal review
- native scenario: model deprecation, outage and exit scenarios
- native scenario: compare total cost and data exposure
- native scenario: generate procurement evidence without legal conclusion
