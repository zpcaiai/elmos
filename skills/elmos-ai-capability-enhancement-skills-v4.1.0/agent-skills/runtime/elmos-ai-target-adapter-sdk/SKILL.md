---
name: elmos-ai-target-adapter-sdk
description: Define the only supported extension seam for target detection, capability profiling, lowering, emission, import,
  conformance, upgrade and evidence capture.
version: 4.0.0
...
- Define stable detect/import/lower/emit/validate SPI
- Separate adapter capability from core authority
- Require native conformance and exact version pins
- Support adapter sandbox, upgrade and evidence invalidation
...
- **adapter authority confusion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **untrusted adapter execution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **capability overclaim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **version drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence forgery** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- missing capability
- drifted adapter
- AiTargetAdapterSdk representative end-to-end fixture
