---
name: elmos-model-license-usage-restriction-governor
description: Parse and enforce model, dataset, weight, API and output usage restrictions across generation, deployment, redistribution and customer delivery.
version: 4.0.0
...
# Model License and Usage Restriction Governor
...
- `ModelLicenseAndUsageRestrictionGovernorProfile`
- `ModelLicenseAndUsageRestrictionGovernorPlan`
- `ModelLicenseAndUsageRestrictionGovernorRun`
- `ModelLicenseAndUsageRestrictionGovernorDecision`

Required semantic capabilities:

- inventory model and data licenses
- compile commercial, redistribution and field-of-use constraints
- propagate obligations into deployment profiles
- block incompatible combination and export
- produce customer-facing usage evidence
...
- `elmos-open-source-license-ip-compliance-certifier` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `artifacts/elmos-model-license-usage-restriction-governor/profile.yaml`
- `artifacts/elmos-model-license-usage-restriction-governor/plan.json`
- `artifacts/elmos-model-license-usage-restriction-governor/result.json`
- `artifacts/elmos-model-license-usage-restriction-governor/evidence/`
...
- **model license omitted from BOM** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **API terms treated as OSS license** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **derived adapter redistribution prohibited** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **field-of-use restriction ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **license update not triggering review** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: inventory model and data licenses
- native scenario: compile commercial, redistribution and field-of-use constraints
- native scenario: propagate obligations into deployment profiles
- native scenario: block incompatible combination and export
- native scenario: produce customer-facing usage evidence
