---
name: elmos-proof-to-validation-dag-compiler
description: Compile Proof Obligation Graphs into dependency-aware validation DAGs with verifier independence, fixtures, resource budgets, retries and evidence gates.
version: 4.0.0
...
# Proof-to-Validation DAG Compiler
...
- **Kernel authorities used:** K1, K4, K6, K7
...
- Map each claim to accepted evidence classes
- Select independent verifier portfolios
- Order prerequisites and shared fixtures
- Allocate machine wall-clock and cost budgets
- Represent BLOCKED/UNKNOWN explicitly
...
- `validation-dag.json`
- `verifier-allocation.json`
- `validation-resource-plan.json`
- `validation-gate-map.json`
...
- **validation node dropped** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **same producer used as independent verifier** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **retry converts failure to pass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **budget pruning removes critical test** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **DAG cycle creates nontermination** — must have a preventive control, a detective signal, a negative fixture and a response action.
