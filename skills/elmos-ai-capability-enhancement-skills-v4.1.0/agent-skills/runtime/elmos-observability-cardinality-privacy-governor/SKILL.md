---
name: elmos-observability-cardinality-privacy-governor
description: Govern trace/metric/log schemas, sampling, cardinality, redaction, retention and tenant access for AI and polyglot systems.
version: 4.0.0
...
# Observability Cardinality and Privacy Governor
...
- `ObservabilityCardinalityAndPrivacyGovernorProfile`
- `ObservabilityCardinalityAndPrivacyGovernorPlan`
- `ObservabilityCardinalityAndPrivacyGovernorRun`
- `ObservabilityCardinalityAndPrivacyGovernorDecision`

Required semantic capabilities:

- compile versioned telemetry profile
- classify high-cardinality and sensitive attributes
- configure head/tail sampling and exemplars
- enforce tenant access and retention
- measure telemetry cost and blind spots
...
- `artifacts/elmos-observability-cardinality-privacy-governor/profile.yaml`
- `artifacts/elmos-observability-cardinality-privacy-governor/plan.json`
- `artifacts/elmos-observability-cardinality-privacy-governor/result.json`
- `artifacts/elmos-observability-cardinality-privacy-governor/evidence/`
...
- **prompt content captured by default** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cardinality exhausts backend** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sampling drops security incidents** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tenant trace accessible cross-scope** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **schema drift breaks dashboards** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile versioned telemetry profile
- native scenario: classify high-cardinality and sensitive attributes
- native scenario: configure head/tail sampling and exemplars
- native scenario: enforce tenant access and retention
- native scenario: measure telemetry cost and blind spots
