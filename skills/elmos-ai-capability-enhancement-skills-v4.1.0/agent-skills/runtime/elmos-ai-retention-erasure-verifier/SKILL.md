---
name: elmos-ai-retention-erasure-verifier
description: Enforce and verify retention, legal hold, export and deletion across prompts, traces, datasets, vector indexes,
  memories, caches, artifacts and backups.
version: 4.0.0
...
# AI Retention and Erasure Verifier
...
- `Approval`
- `ResidualRisk`
- `AIRetentionAndErasureVerifierRun`
- `AIRetentionAndErasureVerifierDecision`

Required semantic capabilities:

- Data-class-specific retention rules
- Legal hold precedence
- Distributed deletion orchestration
- Provider deletion verification
- Backup expiry and residual-copy proof
...
- `retention-plan.yaml`
- `erasure-job-journal.jsonl`
- `erasure-proof.json`
- `legal-hold-ledger.json`
...
- **partial erasure** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **legal hold bypass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider copy retained** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **identifier mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deletion evidence fabricated** — must have a preventive control, a detective signal, a negative fixture and a response action.
