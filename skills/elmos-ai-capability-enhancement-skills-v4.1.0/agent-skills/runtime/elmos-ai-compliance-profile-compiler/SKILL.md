---
name: elmos-ai-compliance-profile-compiler
description: Compile jurisdiction, industry and customer control profiles into executable policies, evidence requirements,
  human decisions and unresolved legal obligations.
version: 4.0.0
...
# AI Compliance Profile Compiler
...
- `Approval`
- `ResidualRisk`
- `AIComplianceProfileCompilerRun`
- `AIComplianceProfileCompilerDecision`

Required semantic capabilities:

- Control framework mapping
- Jurisdiction and deployment-context selection
- Policy/evidence/human-decision compilation
- Conflict and gap analysis
- No automatic legal-certification boundary
...
- `control-to-evidence-map.json`
- `legal-decision-ledger.json`
- `regional-deployment-restrictions.json`
...
- **wrong jurisdiction** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **control papering** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence laundering** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **policy conflict hidden** — must have a preventive control, a detective signal, a negative fixture and a response action.
