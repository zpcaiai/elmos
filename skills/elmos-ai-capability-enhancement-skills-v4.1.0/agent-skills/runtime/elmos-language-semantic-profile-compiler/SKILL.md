...
description: Compile exact-version language semantics for types, nullability, numeric behavior, Unicode, exceptions, concurrency, ownership, async, reflection, FFI and build/runtime boundaries.
version: 4.0.0
...
# Language Semantic Profile Compiler
...
- Fingerprint compiler and runtime rather than language name only
- Represent type, value, control, effect and concurrency semantics
- Capture implementation-defined and undefined behavior
- Bind build system and package ecosystem semantics
- Emit profile-specific proof obligations
...
- `language-semantic-profile.yaml`
- `language-semantics-lock.json`
- `language-gap-catalog.json`
...
- **compiler/runtime mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **implementation-defined behavior hidden** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **Unicode/time semantic loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **reflection boundary omission** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsafe or FFI boundary under-modeling** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- Java overflow/null profile
- Python dynamic dispatch profile
- TypeScript erased-type runtime profile
- C# async/exception profile
- Rust ownership/unsafe profile
- profile round-trip and source-map test
