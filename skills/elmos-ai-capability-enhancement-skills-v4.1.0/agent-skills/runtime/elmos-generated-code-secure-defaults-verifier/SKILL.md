---
name: elmos-generated-code-secure-defaults-verifier
description: Verify authentication, authorization, validation, cryptography, logging, headers, network and dependency defaults in every generated repository.
version: 4.0.0
...
# Generated Code Secure-Defaults Verifier
...
- `GeneratedCodeSecureDefaultsVerifierProfile`
- `GeneratedCodeSecureDefaultsVerifierPlan`
- `GeneratedCodeSecureDefaultsVerifierRun`
- `GeneratedCodeSecureDefaultsVerifierDecision`

Required semantic capabilities:

- compile framework-specific secure-default profile
- scan generated configuration and code paths
- run exploit-oriented negative tests
- verify production/development profile separation
- block insecure template or adapter versions
...
- `artifacts/elmos-generated-code-secure-defaults-verifier/profile.yaml`
- `artifacts/elmos-generated-code-secure-defaults-verifier/plan.json`
- `artifacts/elmos-generated-code-secure-defaults-verifier/result.json`
- `artifacts/elmos-generated-code-secure-defaults-verifier/evidence/`
...
- **development bypass ships to production** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **default credential generated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **TLS verification disabled** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **PII logged by scaffold** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **security header overwritten by proxy** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile framework-specific secure-default profile
- native scenario: scan generated configuration and code paths
- native scenario: run exploit-oriented negative tests
- native scenario: verify production/development profile separation
- native scenario: block insecure template or adapter versions
