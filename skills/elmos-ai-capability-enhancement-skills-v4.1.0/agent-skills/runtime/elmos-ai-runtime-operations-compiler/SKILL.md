---
name: elmos-ai-runtime-operations-compiler
description: Represent durable execution, scheduling, queueing, worker ownership, cancellation, backpressure, telemetry, cache,
  cost, ETA, rollback and operations requirements.
version: 4.0.0
...
- `runtime-operations-contract.json`
- `runtime-topology.json`
- `slo-budget.json`
- `recovery-obligations.json`
...
- AiRuntimeOperationsCompiler representative end-to-end fixture
