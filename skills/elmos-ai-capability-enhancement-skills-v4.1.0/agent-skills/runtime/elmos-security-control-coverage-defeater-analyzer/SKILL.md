---
name: elmos-security-control-coverage-defeater-analyzer
description: Map threats to preventive, detective, responsive and recovery controls, identify defeaters and prevent checkbox coverage claims.
version: 4.0.0
...
# Security Control Coverage and Defeater Analyzer
...
- `SecurityControlCoverageAndDefeaterAnalyzerProfile`
- `SecurityControlCoverageAndDefeaterAnalyzerPlan`
- `SecurityControlCoverageAndDefeaterAnalyzerRun`
- `SecurityControlCoverageAndDefeaterAnalyzerDecision`

Required semantic capabilities:

- build threat-control-evidence graph
- check independence and failure correlation
- identify assumptions and control bypasses
- measure negative-test and monitoring coverage
- propagate unresolved defeaters to certification
...
- `elmos-structured-assurance-case-compiler` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `artifacts/elmos-security-control-coverage-defeater-analyzer/profile.yaml`
- `artifacts/elmos-security-control-coverage-defeater-analyzer/plan.json`
- `artifacts/elmos-security-control-coverage-defeater-analyzer/result.json`
- `artifacts/elmos-security-control-coverage-defeater-analyzer/evidence/`
...
- **same control counted twice** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **policy existence treated as enforcement** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared failure domain ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **defeater not shown to customer** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **coverage score gamed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: build threat-control-evidence graph
- native scenario: check independence and failure correlation
- native scenario: identify assumptions and control bypasses
- native scenario: measure negative-test and monitoring coverage
- native scenario: propagate unresolved defeaters to certification
