---
name: elmos-database-extension-compatibility-governor
description: Inventory and govern database extensions, plugins, collations, procedural languages and managed-service restrictions during dialect selection and migration.
version: 4.0.0
...
# Database Extension Compatibility Governor
...
- `DatabaseExtensionCompatibilityGovernorProfile`
- `DatabaseExtensionCompatibilityGovernorPlan`
- `DatabaseExtensionCompatibilityGovernorRun`
- `DatabaseExtensionCompatibilityGovernorDecision`

Required semantic capabilities:

- fingerprint installed extension versions
- map extension semantics to target alternatives
- detect managed-service restrictions
- generate replacement or external-service adapters
- bind licensing and security evidence
...
- `artifacts/elmos-database-extension-compatibility-governor/profile.yaml`
- `artifacts/elmos-database-extension-compatibility-governor/plan.json`
- `artifacts/elmos-database-extension-compatibility-governor/result.json`
- `artifacts/elmos-database-extension-compatibility-governor/evidence/`
...
- **extension assumed available** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **version-specific behavior ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsafe extension gains superuser** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **license incompatible with target** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fallback loses transaction semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: fingerprint installed extension versions
- native scenario: map extension semantics to target alternatives
- native scenario: detect managed-service restrictions
- native scenario: generate replacement or external-service adapters
- native scenario: bind licensing and security evidence
