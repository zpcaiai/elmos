---
name: elmos-polyglot-upgrade-controller
description: Upgrade certified language/framework routes across compiler, runtime and dependency versions with impact analysis, incremental proof invalidation and reversible rollout.
version: 4.0.0
...
# Polyglot Route Upgrade Controller
...
- Detect semantic profile deltas between versions
- Plan dependency-aware upgrade waves
- Invalidate only affected proof/evidence
- Run old/new differential and compatibility suites
- Retain signed rollback artifacts and data path
...
- `polyglot-upgrade-plan.yaml`
- `upgrade-impact-graph.json`
- `upgrade-validation-results.json`
- `polyglot-rollback-plan.yaml`
...
- **version alias resolves unexpectedly** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **upgrade evidence reused without rerun** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **migration wave crosses incompatible boundary** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback artifact unavailable** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dependency transitive change missed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- canary upgrade
- rollback after failed differential
