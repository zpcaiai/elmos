---
name: elmos-api-event-contract-ir-compiler
description: Compile REST, GraphQL, gRPC, Webhook and event-driven interfaces into a unified contract IR including identity, ordering, effects, errors and compatibility.
version: 4.0.0
...
# API and Event Contract IR Compiler
...
- `APIAndEventContractIRCompilerProfile`
- `APIAndEventContractIRCompilerPlan`
- `APIAndEventContractIRCompilerRun`
- `APIAndEventContractIRCompilerDecision`

Required semantic capabilities:

- normalize request/response and streaming shapes
- model error and retry semantics
- represent authentication and authorization requirements
- capture side effects and idempotency
- derive producer/consumer compatibility obligations
...
- `artifacts/elmos-api-event-contract-ir-compiler/profile.yaml`
- `artifacts/elmos-api-event-contract-ir-compiler/plan.json`
- `artifacts/elmos-api-event-contract-ir-compiler/result.json`
- `artifacts/elmos-api-event-contract-ir-compiler/evidence/`
...
- **interface schema omits effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stream termination mismapped** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **error code semantics lost** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **auth requirement downgraded** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **consumer not discovered** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: normalize request/response and streaming shapes
- native scenario: model error and retry semantics
- native scenario: represent authentication and authorization requirements
- native scenario: capture side effects and idempotency
- native scenario: derive producer/consumer compatibility obligations
