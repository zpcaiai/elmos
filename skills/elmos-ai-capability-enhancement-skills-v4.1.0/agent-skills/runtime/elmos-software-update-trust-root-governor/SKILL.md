---
name: elmos-software-update-trust-root-governor
description: Secure Skill, adapter, policy, model-profile and runtime updates using threshold roles, delegated trust, rollback/freeze protection and signed metadata.
version: 4.0.0
...
# Software Update Trust Root Governor
...
- Manage root/targets/snapshot/timestamp style roles
- Use threshold signing and offline root procedures
- Delegate targets by ecosystem and risk
- Prevent rollback and freeze attacks
- Rotate/revoke keys with continuity evidence
...
- `update-root-metadata.json`
- `update-targets-metadata.json`
- `update-delegations.json`
...
- **repository compromise** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **single signing key compromise** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **freeze attack** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **delegation escapes path scope** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **root rotation bricks clients** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- rollback version rejected
- threshold signature
- delegated target scope
- root rotation
