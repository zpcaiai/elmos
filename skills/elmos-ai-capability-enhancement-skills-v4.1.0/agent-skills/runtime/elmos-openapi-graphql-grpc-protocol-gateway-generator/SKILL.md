---
name: elmos-openapi-graphql-grpc-protocol-gateway-generator
description: Generate governed gateways and adapters among REST/OpenAPI, GraphQL and gRPC while preserving auth, streaming, errors, deadlines and compatibility.
version: 4.0.0
...
# OpenAPI, GraphQL and gRPC Protocol Gateway Generator
...
- `OpenAPIGraphQLAndGRPCProtocolGatewayGeneratorProfile`
- `OpenAPIGraphQLAndGRPCProtocolGatewayGeneratorPlan`
- `OpenAPIGraphQLAndGRPCProtocolGatewayGeneratorRun`
- `OpenAPIGraphQLAndGRPCProtocolGatewayGeneratorDecision`

Required semantic capabilities:

- lower unified contract IR to gateway routes
- map deadlines, cancellation and streaming
- translate error and pagination models
- preserve authentication and field authorization
- generate differential conformance tests
...
- `artifacts/elmos-openapi-graphql-grpc-protocol-gateway-generator/profile.yaml`
- `artifacts/elmos-openapi-graphql-grpc-protocol-gateway-generator/plan.json`
- `artifacts/elmos-openapi-graphql-grpc-protocol-gateway-generator/result.json`
- `artifacts/elmos-openapi-graphql-grpc-protocol-gateway-generator/evidence/`
...
- **N+1 amplification** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stream converted to unbounded buffering** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **field auth bypassed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **HTTP status loses typed error** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **gateway retries unsafe mutation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: lower unified contract IR to gateway routes
- native scenario: map deadlines, cancellation and streaming
- native scenario: translate error and pagination models
- native scenario: preserve authentication and field authorization
- native scenario: generate differential conformance tests
