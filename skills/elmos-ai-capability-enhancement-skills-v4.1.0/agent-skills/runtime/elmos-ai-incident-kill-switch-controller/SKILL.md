---
name: elmos-ai-incident-kill-switch-controller
description: Execute tenant, agent, tool, provider, Skill, prompt, memory and credential shutdown while preserving evidence
  and reconciling active side effects.
version: 4.0.0
...
# AI Incident Kill Switch Controller
...
- `Approval`
- `ResidualRisk`
- `AIIncidentKillSwitchControllerRun`
- `AIIncidentKillSwitchControllerDecision`

Required semantic capabilities:

- Hierarchical kill-switch scopes
- Active run cancellation and fencing
- Tool/credential revocation
- Memory quarantine and evidence preservation
- Safe restart and recertification gate
...
- `incident-control-plan.yaml`
- `kill-switch-events.jsonl`
- `side-effect-settlement.json`
- `safe-restart-decision.json`
...
- **partial shutdown** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale worker continues** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence destruction** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **credential remains active** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsafe automatic restart** — must have a preventive control, a detective signal, a negative fixture and a response action.
