---
name: elmos-budget-aware-quality-slo-optimizer
description: Select model, test, retrieval, cache and infrastructure plans that maximize verified quality under hard cost, latency, risk and residency constraints.
version: 4.0.0
...
# Budget-Aware Quality and SLO Optimizer
...
- `BudgetAwareQualityAndSLOOptimizerProfile`
- `BudgetAwareQualityAndSLOOptimizerPlan`
- `BudgetAwareQualityAndSLOOptimizerRun`
- `BudgetAwareQualityAndSLOOptimizerDecision`

Required semantic capabilities:

- compile hard and soft objective envelope
- solve multi-objective plan with mandatory gates
- reserve uncertainty and incident budget
- shadow candidate plan and compare
- prevent optimization from weakening certification claims
...
- `artifacts/elmos-budget-aware-quality-slo-optimizer/profile.yaml`
- `artifacts/elmos-budget-aware-quality-slo-optimizer/plan.json`
- `artifacts/elmos-budget-aware-quality-slo-optimizer/result.json`
- `artifacts/elmos-budget-aware-quality-slo-optimizer/evidence/`
...
- **cost objective dominates safety** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **SLO averaged across tenants** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **uncertainty margin omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **optimizer changes test coverage secretly** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **residency treated soft** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile hard and soft objective envelope
- native scenario: solve multi-objective plan with mandatory gates
- native scenario: reserve uncertainty and incident budget
- native scenario: shadow candidate plan and compare
- native scenario: prevent optimization from weakening certification claims
