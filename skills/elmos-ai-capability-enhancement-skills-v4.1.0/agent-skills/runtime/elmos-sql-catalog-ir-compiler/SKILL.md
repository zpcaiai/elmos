---
name: elmos-sql-catalog-ir-compiler
description: Compile catalogs, schemas, tables, types, defaults, generated values, constraints, indexes, partitions, views, roles, grants and RLS into DB-SIR.
version: 4.0.0
...
- Parse vendor-native DDL and metadata
- Preserve object identity and dependency order
- Model generated/identity/sequence semantics
- Capture grants, roles and row security
- Record opaque extensions and unsupported constructs
...
- `sql-catalog-ir.json`
- `catalog-source-map.json`
- `catalog-diagnostics.json`
- `catalog-opaque-register.json`
...
- **DDL parser accepts wrong semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **object identity collision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **security grants omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated column expression changed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **opaque extension dropped** — must have a preventive control, a detective signal, a negative fixture and a response action.
