---
name: elmos-counterexample-to-rule-skill-promotion-controller
description: Turn verified recurring counterexamples into deterministic rules, tests, Skills or adapter improvements through isolated review, canary and rollback.
version: 4.0.0
...
# Counterexample-to-Rule and Skill Promotion Controller
...
- `CounterexampleToRuleAndSkillPromotionControllerProfile`
- `CounterexampleToRuleAndSkillPromotionControllerPlan`
- `CounterexampleToRuleAndSkillPromotionControllerRun`
- `CounterexampleToRuleAndSkillPromotionControllerDecision`

Required semantic capabilities:

- cluster recurring verified root causes
- choose rule/test/skill/adapter intervention
- generate bounded candidate and fixtures
- run holdout, adversarial and canary evaluation
- promote with signer, owner and rollback
...
- `artifacts/elmos-counterexample-to-rule-skill-promotion-controller/profile.yaml`
- `artifacts/elmos-counterexample-to-rule-skill-promotion-controller/plan.json`
- `artifacts/elmos-counterexample-to-rule-skill-promotion-controller/result.json`
- `artifacts/elmos-counterexample-to-rule-skill-promotion-controller/evidence/`
...
- **unverified anecdote becomes rule** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **candidate overfits visible corpus** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **self-improvement approves itself** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **promotion expands authority** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback artifact missing** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: cluster recurring verified root causes
- native scenario: choose rule/test/skill/adapter intervention
- native scenario: generate bounded candidate and fixtures
- native scenario: run holdout, adversarial and canary evaluation
- native scenario: promote with signer, owner and rollback
