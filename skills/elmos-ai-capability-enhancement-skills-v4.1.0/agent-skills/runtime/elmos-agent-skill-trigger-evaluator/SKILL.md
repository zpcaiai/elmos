---
name: elmos-agent-skill-trigger-evaluator
description: Measure whether a Skill activates for the right requests and improves task success without unacceptable false
  activation, latency or token overhead.
version: 4.0.0
...
- `Counterexample`
- `CoverageMap`
- `AgentSkillTriggerEvaluatorRun`
- `AgentSkillTriggerEvaluatorDecision`

Required semantic capabilities:

- Positive, negative and adversarial trigger set governance
- Precision/recall and confidence intervals
- No-skill baseline and ablation comparison
- Multi-skill conflict and precedence evaluation
- Version-to-version trigger regression
...
- `trigger-eval-dataset.jsonl`
- `trigger-confusion-matrix.json`
- `activation-lift-report.json`
- `trigger-release-decision.json`
...
- **evaluation contamination** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **overfitted trigger description** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hidden host routing bias** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **false activation side effects** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **missed safety skill activation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- multi-skill collision
- description ablation
- latency/token overhead budget
