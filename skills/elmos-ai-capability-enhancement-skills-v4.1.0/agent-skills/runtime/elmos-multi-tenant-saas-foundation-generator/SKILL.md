---
name: elmos-multi-tenant-saas-foundation-generator
description: Generate tenant identity, isolation, provisioning, quotas, data boundaries, audit, lifecycle and operational controls for commercial AI services.
version: 4.0.0
...
# Multi-Tenant SaaS Foundation Generator
...
- `MultiTenantSaaSFoundationGeneratorProfile`
- `MultiTenantSaaSFoundationGeneratorPlan`
- `MultiTenantSaaSFoundationGeneratorRun`
- `MultiTenantSaaSFoundationGeneratorDecision`

Required semantic capabilities:

- select pooled, siloed or hybrid tenancy
- generate tenant provisioning and offboarding
- enforce data/cache/vector/evidence isolation
- integrate quota, audit and support boundaries
- test noisy-neighbor and tenant deletion
...
- `artifacts/elmos-multi-tenant-saas-foundation-generator/profile.yaml`
- `artifacts/elmos-multi-tenant-saas-foundation-generator/plan.json`
- `artifacts/elmos-multi-tenant-saas-foundation-generator/result.json`
- `artifacts/elmos-multi-tenant-saas-foundation-generator/evidence/`
...
- **tenant ID trusted from client** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared cache leaks data** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **offboarding leaves backup** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **operator cross-tenant access unaudited** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **quota bypass via sub-agent** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: select pooled, siloed or hybrid tenancy
- native scenario: generate tenant provisioning and offboarding
- native scenario: enforce data/cache/vector/evidence isolation
- native scenario: integrate quota, audit and support boundaries
- native scenario: test noisy-neighbor and tenant deletion
