---
name: elmos-tool-discovery-description-quality-evaluator
description: Evaluate tool naming, descriptions, schemas, examples and annotations for correct selection, non-selection and safe argument formation.
version: 4.0.0
...
# Tool Discovery and Description Quality Evaluator
...
- `ToolDiscoveryAndDescriptionQualityEvaluatorProfile`
- `ToolDiscoveryAndDescriptionQualityEvaluatorPlan`
- `ToolDiscoveryAndDescriptionQualityEvaluatorRun`
- `ToolDiscoveryAndDescriptionQualityEvaluatorDecision`

Required semantic capabilities:

- build positive and nearby-negative intent corpus
- measure tool selection precision/recall
- check schema constraints and sensitive inputs
- evaluate side-effect annotations and descriptions
- optimize metadata under versioned experiments
...
- `artifacts/elmos-tool-discovery-description-quality-evaluator/profile.yaml`
- `artifacts/elmos-tool-discovery-description-quality-evaluator/plan.json`
- `artifacts/elmos-tool-discovery-description-quality-evaluator/result.json`
- `artifacts/elmos-tool-discovery-description-quality-evaluator/evidence/`
...
- **description overclaims capability** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tools collide semantically** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **negative corpus too easy** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **schema permits injection payload** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **metadata optimization hides destructive effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: build positive and nearby-negative intent corpus
- native scenario: measure tool selection precision/recall
- native scenario: check schema constraints and sensitive inputs
- native scenario: evaluate side-effect annotations and descriptions
- native scenario: optimize metadata under versioned experiments
