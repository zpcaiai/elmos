---
name: elmos-knowledge-graph-ontology-ir-compiler
description: Compile ontology, entities, relations, temporal validity, provenance, constraints and alignment into a framework-neutral Knowledge IR.
version: 4.0.0
...
# Knowledge Graph and Ontology IR Compiler
...
- `KnowledgeGraphAndOntologyIRCompilerProfile`
- `KnowledgeGraphAndOntologyIRCompilerPlan`
- `KnowledgeGraphAndOntologyIRCompilerRun`
- `KnowledgeGraphAndOntologyIRCompilerDecision`

Required semantic capabilities:

- model ontology and entity identity
- compile extraction and relation provenance
- represent temporal validity and contradiction
- align heterogeneous schemas
- emit graph validation and migration obligations
...
- `artifacts/elmos-knowledge-graph-ontology-ir-compiler/profile.yaml`
- `artifacts/elmos-knowledge-graph-ontology-ir-compiler/plan.json`
- `artifacts/elmos-knowledge-graph-ontology-ir-compiler/result.json`
- `artifacts/elmos-knowledge-graph-ontology-ir-compiler/evidence/`
...
- **entity resolution merges distinct people** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ontology mapping loses constraint** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **extraction provenance absent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **temporal fact treated timeless** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **graph cycle explodes reasoning** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: model ontology and entity identity
- native scenario: compile extraction and relation provenance
- native scenario: represent temporal validity and contradiction
- native scenario: align heterogeneous schemas
- native scenario: emit graph validation and migration obligations
