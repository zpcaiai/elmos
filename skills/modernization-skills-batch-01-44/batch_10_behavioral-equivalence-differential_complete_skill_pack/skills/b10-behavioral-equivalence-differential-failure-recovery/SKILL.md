---
name: b10-behavioral-equivalence-differential-failure-recovery
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Behavioral Equivalence, Golden Master and Differential Validation."
version: 1.0.0
batch: batch-10
risk: critical
