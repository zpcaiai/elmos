---
name: b10-behavioral-equivalence-differential-lifecycle-recertification
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Behavioral Equivalence, Golden Master and Differential Validation."
version: 1.0.0
batch: batch-10
risk: high
