---
name: b42-production-operations-readiness-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Production Observability, SLO, Incident, HA/DR and Operations Readiness."
version: 1.0.0
batch: batch-42
risk: critical
