---
name: b42-production-operations-readiness-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Production Observability, SLO, Incident, HA/DR and Operations Readiness."
version: 1.0.0
batch: batch-42
risk: high
...
本 Skill 属于 **Batch 42: Production Observability, SLO, Incident, HA/DR and Operations Readiness**。Batch 总目标：建立 Service Catalog、技术与业务 SLI/SLO、可观测覆盖、告警质量、Runbook、值班、Incident、HA/DR、容量、混沌和持续运营仪表盘。
...
- 对 Service Catalog 的正常路径产生可重放证据。
- 缺少 SLI/SLO 证据时必须降级或阻断。
