---
name: b42-production-operations-readiness-workflow-runtime
description: "在统一 Durable Workflow 和隔离 Runner 中执行任务，管理租约、检查点、副作用和补偿。 Scope: Production Observability, SLO, Incident, HA/DR and Operations Readiness."
version: 1.0.0
batch: batch-42
risk: critical
