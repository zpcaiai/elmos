---
name: b41-release-progressive-delivery-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Release Engineering, Progressive Delivery and Automated Rollback."
version: 1.0.0
batch: batch-41
risk: high
...
本 Skill 属于 **Batch 41: Release Engineering, Progressive Delivery and Automated Rollback**。Batch 总目标：把签名制品、CI 门禁、环境提升、Feature Flag、Canary、Blue/Green、渐进式交付、数据库切换和自动回滚汇聚为可审计发布列车。
...
- 对 Release Train 的正常路径产生可重放证据。
- 缺少 Changeset/Version 证据时必须降级或阻断。
