---
name: b41-release-progressive-delivery-discovery-inventory
description: "从源码、制品、运行、配置、文档和人工声明中发现资产，保存分母、来源和未知项。 Scope: Release Engineering, Progressive Delivery and Automated Rollback."
version: 1.0.0
batch: batch-41
risk: medium
