---
name: b41-release-progressive-delivery-lifecycle-recertification
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Release Engineering, Progressive Delivery and Automated Rollback."
version: 1.0.0
batch: batch-41
risk: high
