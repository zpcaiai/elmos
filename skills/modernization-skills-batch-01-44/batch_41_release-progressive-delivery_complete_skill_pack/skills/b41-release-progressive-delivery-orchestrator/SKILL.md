---
name: b41-release-progressive-delivery-orchestrator
description: "编排本 Batch 的所有能力、前置证书、状态机、暂停恢复取消、人工门禁和最终证书。 Scope: Release Engineering, Progressive Delivery and Automated Rollback."
version: 1.0.0
batch: batch-41
risk: critical
