---
name: b24-real-build-test-artifact-lab-failure-recovery
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Real Build, Test, Package and Artifact Execution Lab."
version: 1.0.0
batch: batch-24
risk: critical
