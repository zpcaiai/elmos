---
name: b24-real-build-test-artifact-lab-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Real Build, Test, Package and Artifact Execution Lab."
version: 1.0.0
batch: batch-24
risk: critical
