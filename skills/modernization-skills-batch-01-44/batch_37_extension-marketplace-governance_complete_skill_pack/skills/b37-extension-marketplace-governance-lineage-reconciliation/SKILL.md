---
name: b37-extension-marketplace-governance-lineage-reconciliation
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Extension SDK, Marketplace and Supply-Chain Governance."
version: 1.0.0
batch: batch-37
risk: high
