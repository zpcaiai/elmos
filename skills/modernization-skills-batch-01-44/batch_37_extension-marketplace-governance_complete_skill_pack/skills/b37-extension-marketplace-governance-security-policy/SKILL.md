---
name: b37-extension-marketplace-governance-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Extension SDK, Marketplace and Supply-Chain Governance."
version: 1.0.0
batch: batch-37
risk: critical
