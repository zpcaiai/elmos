---
name: b37-extension-marketplace-governance-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Extension SDK, Marketplace and Supply-Chain Governance."
version: 1.0.0
batch: batch-37
risk: high
...
本 Skill 属于 **Batch 37: Extension SDK, Marketplace and Supply-Chain Governance**。Batch 总目标：建立稳定 ABI/API、SDK、Extension Manifest、沙箱与权限、发布者身份、签名/SBOM/Provenance、认证、发布安装升级回滚撤销和商业治理。
...
- 对 Extension ABI/API 的正常路径产生可重放证据。
- 缺少 SDKs 证据时必须降级或阻断。
