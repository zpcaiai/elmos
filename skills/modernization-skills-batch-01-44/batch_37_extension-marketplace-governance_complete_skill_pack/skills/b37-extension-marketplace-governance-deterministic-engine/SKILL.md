---
name: b37-extension-marketplace-governance-deterministic-engine
description: "实现可重放、稳定排序、内容寻址、幂等和有界执行的确定性核心。 Scope: Extension SDK, Marketplace and Supply-Chain Governance."
version: 1.0.0
batch: batch-37
risk: critical
