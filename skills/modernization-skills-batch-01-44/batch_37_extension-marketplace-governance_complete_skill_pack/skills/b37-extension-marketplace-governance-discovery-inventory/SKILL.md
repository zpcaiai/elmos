---
name: b37-extension-marketplace-governance-discovery-inventory
description: "从源码、制品、运行、配置、文档和人工声明中发现资产，保存分母、来源和未知项。 Scope: Extension SDK, Marketplace and Supply-Chain Governance."
version: 1.0.0
batch: batch-37
risk: medium
