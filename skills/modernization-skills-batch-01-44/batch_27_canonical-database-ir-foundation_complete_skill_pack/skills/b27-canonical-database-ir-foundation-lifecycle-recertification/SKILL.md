---
name: b27-canonical-database-ir-foundation-lifecycle-recertification
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Canonical Database IR, Data Migration and Cutover Foundation."
version: 1.0.0
batch: batch-27
risk: high
