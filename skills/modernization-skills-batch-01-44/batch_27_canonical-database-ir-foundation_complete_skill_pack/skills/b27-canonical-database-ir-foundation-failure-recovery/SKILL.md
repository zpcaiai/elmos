---
name: b27-canonical-database-ir-foundation-failure-recovery
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Canonical Database IR, Data Migration and Cutover Foundation."
version: 1.0.0
batch: batch-27
risk: critical
