---
name: b27-canonical-database-ir-foundation-discovery-inventory
description: "从源码、制品、运行、配置、文档和人工声明中发现资产，保存分母、来源和未知项。 Scope: Canonical Database IR, Data Migration and Cutover Foundation."
version: 1.0.0
batch: batch-27
risk: medium
