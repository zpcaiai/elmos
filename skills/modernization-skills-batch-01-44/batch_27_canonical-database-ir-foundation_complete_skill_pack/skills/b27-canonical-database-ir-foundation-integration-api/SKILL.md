---
name: b27-canonical-database-ir-foundation-integration-api
description: "提供版本化 API、事件、Webhook、SDK 和导入导出，保证幂等、鉴权和兼容。 Scope: Canonical Database IR, Data Migration and Cutover Foundation."
version: 1.0.0
batch: batch-27
risk: high
