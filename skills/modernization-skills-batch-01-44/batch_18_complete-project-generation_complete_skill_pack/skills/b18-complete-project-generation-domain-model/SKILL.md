---
name: b18-complete-project-generation-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Complete Project Generation Standard."
version: 1.0.0
batch: batch-18
risk: high
...
本 Skill 属于 **Batch 18: Complete Project Generation Standard**。Batch 总目标：将目标代码扩展为可构建、可运行、可测试、可部署、可观测、可运维的完整项目，并通过 Complete Project Manifest 和 Completeness Score 防止只生成源码。
...
- 对 Complete Project Manifest 的正常路径产生可重放证据。
- 缺少 Repository Template Registry 证据时必须降级或阻断。
