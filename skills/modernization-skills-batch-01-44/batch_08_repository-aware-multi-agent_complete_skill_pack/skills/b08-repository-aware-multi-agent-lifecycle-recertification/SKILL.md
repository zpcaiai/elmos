---
name: b08-repository-aware-multi-agent-lifecycle-recertification
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Repository-Aware Multi-Agent, Context and RAG System."
version: 1.0.0
batch: batch-08
risk: high
