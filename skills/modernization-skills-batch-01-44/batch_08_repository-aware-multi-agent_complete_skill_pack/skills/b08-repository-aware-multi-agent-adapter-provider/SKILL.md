---
name: b08-repository-aware-multi-agent-adapter-provider
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Repository-Aware Multi-Agent, Context and RAG System."
version: 1.0.0
batch: batch-08
risk: high
