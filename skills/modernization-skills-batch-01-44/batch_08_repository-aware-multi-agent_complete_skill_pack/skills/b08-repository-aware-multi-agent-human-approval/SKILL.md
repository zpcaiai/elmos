---
name: b08-repository-aware-multi-agent-human-approval
description: "为高影响、不确定、不可逆和例外决策建立解释、审批、过期与责任边界。 Scope: Repository-Aware Multi-Agent, Context and RAG System."
version: 1.0.0
batch: batch-08
risk: high
