---
name: b08-repository-aware-multi-agent-orchestrator
description: "编排本 Batch 的所有能力、前置证书、状态机、暂停恢复取消、人工门禁和最终证书。 Scope: Repository-Aware Multi-Agent, Context and RAG System."
version: 1.0.0
batch: batch-08
risk: critical
