---
name: b29-multi-language-route-factory-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Multi-Language Route Certification Factory."
version: 1.0.0
batch: batch-29
risk: high
...
本 Skill 属于 **Batch 29: Multi-Language Route Certification Factory**。Batch 总目标：把语言方向包从实验能力提升为精确版本、真实工具链、代表性 Corpus、兼容运行时、经济性和证据绑定的生产级 Route Factory。
...
- 对 Route Prioritization 的正常路径产生可重放证据。
- 缺少 Language Support Matrix 证据时必须降级或阻断。
