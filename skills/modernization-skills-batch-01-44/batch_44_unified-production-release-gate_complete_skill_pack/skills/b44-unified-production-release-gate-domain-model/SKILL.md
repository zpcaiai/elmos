---
name: b44-unified-production-release-gate-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Unified Production Release Gate and Continuous Recertification."
version: 1.0.0
batch: batch-44
risk: high
...
本 Skill 属于 **Batch 44: Unified Production Release Gate and Continuous Recertification**。Batch 总目标：把需求、语义、代码、数据库、测试、性能、安全、韧性、运行指标、发布、回滚、客户支持和持续重新认证汇聚为唯一 Production Release Gate 与 Closure Certificate。
...
- 对 Production Readiness Checklist 的正常路径产生可重放证据。
- 缺少 Certificate Aggregation 证据时必须降级或阻断。
