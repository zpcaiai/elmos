---
name: b44-unified-production-release-gate-workflow-runtime
description: "在统一 Durable Workflow 和隔离 Runner 中执行任务，管理租约、检查点、副作用和补偿。 Scope: Unified Production Release Gate and Continuous Recertification."
version: 1.0.0
batch: batch-44
risk: critical
