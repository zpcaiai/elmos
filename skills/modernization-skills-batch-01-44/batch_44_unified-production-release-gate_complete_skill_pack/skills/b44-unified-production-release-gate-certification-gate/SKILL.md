---
name: b44-unified-production-release-gate-certification-gate
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Unified Production Release Gate and Continuous Recertification."
version: 1.0.0
batch: batch-44
risk: critical
