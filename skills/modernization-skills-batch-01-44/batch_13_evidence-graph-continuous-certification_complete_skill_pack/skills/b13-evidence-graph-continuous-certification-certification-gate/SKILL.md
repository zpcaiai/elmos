---
name: b13-evidence-graph-continuous-certification-certification-gate
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Evidence Graph, Independent Oracle and Continuous Certification."
version: 1.0.0
batch: batch-13
risk: critical
