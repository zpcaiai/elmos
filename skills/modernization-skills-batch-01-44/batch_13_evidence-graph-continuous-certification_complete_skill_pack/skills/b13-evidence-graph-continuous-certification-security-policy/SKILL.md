---
name: b13-evidence-graph-continuous-certification-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Evidence Graph, Independent Oracle and Continuous Certification."
version: 1.0.0
batch: batch-13
risk: critical
