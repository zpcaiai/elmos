---
name: b13-evidence-graph-continuous-certification-lineage-reconciliation
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Evidence Graph, Independent Oracle and Continuous Certification."
version: 1.0.0
batch: batch-13
risk: high
