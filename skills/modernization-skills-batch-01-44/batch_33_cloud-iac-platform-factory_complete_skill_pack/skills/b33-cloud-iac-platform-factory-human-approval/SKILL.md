---
name: b33-cloud-iac-platform-factory-human-approval
description: "为高影响、不确定、不可逆和例外决策建立解释、审批、过期与责任边界。 Scope: Cloud, IaC, Container and Platform Modernization Factory."
version: 1.0.0
batch: batch-33
risk: high
