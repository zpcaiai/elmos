---
name: b33-cloud-iac-platform-factory-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Cloud, IaC, Container and Platform Modernization Factory."
version: 1.0.0
batch: batch-33
risk: high
...
本 Skill 属于 **Batch 33: Cloud, IaC, Container and Platform Modernization Factory**。Batch 总目标：建立 Provider-neutral Cloud Architecture IR，并迁移 IaC、容器、Kubernetes、Helm、Serverless、Gateway、网络、身份、安全、CI/CD、可观测和成本恢复能力。
...
- 对 Cloud Estate Discovery 的正常路径产生可重放证据。
- 缺少 Provider-neutral Architecture IR 证据时必须降级或阻断。
