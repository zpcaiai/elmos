---
name: b17-migration-execution-os-workflow-runtime
description: "在统一 Durable Workflow 和隔离 Runner 中执行任务，管理租约、检查点、副作用和补偿。 Scope: Migration Execution Operating System."
version: 1.0.0
batch: batch-17
risk: critical
