---
name: b17-migration-execution-os-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Migration Execution Operating System."
version: 1.0.0
batch: batch-17
risk: high
...
本 Skill 属于 **Batch 17: Migration Execution Operating System**。Batch 总目标：提供统一 Durable Workflow、任务图、租约、检查点、暂停恢复取消、补偿、人工任务、模型与工具路由、预算和多仓库多波次执行内核。
...
- 对 Task Graph Runtime 的正常路径产生可重放证据。
- 缺少 Durable Event History 证据时必须降级或阻断。
