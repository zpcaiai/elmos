---
name: b21-real-repository-golden-workload-human-approval
description: "为高影响、不确定、不可逆和例外决策建立解释、审批、过期与责任边界。 Scope: Real Repository Slice and Golden Workload Factory."
version: 1.0.0
batch: batch-21
risk: high
