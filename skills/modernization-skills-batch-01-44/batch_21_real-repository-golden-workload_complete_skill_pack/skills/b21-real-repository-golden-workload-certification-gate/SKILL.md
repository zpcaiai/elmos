---
name: b21-real-repository-golden-workload-certification-gate
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Real Repository Slice and Golden Workload Factory."
version: 1.0.0
batch: batch-21
risk: critical
