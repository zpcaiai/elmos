---
name: b21-real-repository-golden-workload-workflow-runtime
description: "在统一 Durable Workflow 和隔离 Runner 中执行任务，管理租约、检查点、副作用和补偿。 Scope: Real Repository Slice and Golden Workload Factory."
version: 1.0.0
batch: batch-21
risk: critical
