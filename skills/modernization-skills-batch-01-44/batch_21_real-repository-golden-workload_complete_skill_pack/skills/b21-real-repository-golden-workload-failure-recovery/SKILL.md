---
name: b21-real-repository-golden-workload-failure-recovery
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Real Repository Slice and Golden Workload Factory."
version: 1.0.0
batch: batch-21
risk: critical
