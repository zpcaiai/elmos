---
name: b15-counterexample-guided-repair-deterministic-engine
description: "实现可重放、稳定排序、内容寻址、幂等和有界执行的确定性核心。 Scope: Counterexample-Guided Repair and Self-Evolving Validation."
version: 1.0.0
batch: batch-15
risk: critical
