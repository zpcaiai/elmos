---
name: b15-counterexample-guided-repair-lineage-reconciliation
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Counterexample-Guided Repair and Self-Evolving Validation."
version: 1.0.0
batch: batch-15
risk: high
