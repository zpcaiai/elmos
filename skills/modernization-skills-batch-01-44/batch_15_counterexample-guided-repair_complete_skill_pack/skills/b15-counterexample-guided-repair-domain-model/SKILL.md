---
name: b15-counterexample-guided-repair-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Counterexample-Guided Repair and Self-Evolving Validation."
version: 1.0.0
batch: batch-15
risk: high
...
本 Skill 属于 **Batch 15: Counterexample-Guided Repair and Self-Evolving Validation**。Batch 总目标：将测试失败、差分、模糊、模型检测和证明反例标准化、最小化并定位根因，生成受约束修复候选，并把重复成功模式沉淀为可认证规则。
...
- 对 Unified Counterexample IR 的正常路径产生可重放证据。
- 缺少 Reproduction 证据时必须降级或阻断。
