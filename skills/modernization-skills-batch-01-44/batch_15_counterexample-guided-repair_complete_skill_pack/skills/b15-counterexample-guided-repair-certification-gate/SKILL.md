---
name: b15-counterexample-guided-repair-certification-gate
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Counterexample-Guided Repair and Self-Evolving Validation."
version: 1.0.0
batch: batch-15
risk: critical
