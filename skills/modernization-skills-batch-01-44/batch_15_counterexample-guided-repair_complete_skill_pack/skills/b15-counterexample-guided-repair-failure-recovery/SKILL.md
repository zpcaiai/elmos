---
name: b15-counterexample-guided-repair-failure-recovery
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Counterexample-Guided Repair and Self-Evolving Validation."
version: 1.0.0
batch: batch-15
risk: critical
