---
name: b28-relational-database-12-routes-discovery-inventory
description: "从源码、制品、运行、配置、文档和人工声明中发现资产，保存分母、来源和未知项。 Scope: Oracle, SQL Server, MySQL and PostgreSQL 12 Directional Route Packs."
version: 1.0.0
batch: batch-28
risk: medium
