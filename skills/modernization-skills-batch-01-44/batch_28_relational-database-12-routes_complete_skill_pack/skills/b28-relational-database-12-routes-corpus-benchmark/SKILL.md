---
name: b28-relational-database-12-routes-corpus-benchmark
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Oracle, SQL Server, MySQL and PostgreSQL 12 Directional Route Packs."
version: 1.0.0
batch: batch-28
risk: high
