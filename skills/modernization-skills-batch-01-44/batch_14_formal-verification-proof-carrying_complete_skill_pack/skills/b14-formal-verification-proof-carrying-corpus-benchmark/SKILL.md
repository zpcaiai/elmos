---
name: b14-formal-verification-proof-carrying-corpus-benchmark
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Formal Verification and Proof-Carrying Migration."
version: 1.0.0
batch: batch-14
risk: high
