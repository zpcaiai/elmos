---
name: b14-formal-verification-proof-carrying-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Formal Verification and Proof-Carrying Migration."
version: 1.0.0
batch: batch-14
risk: high
...
本 Skill 属于 **Batch 14: Formal Verification and Proof-Carrying Migration**。Batch 总目标：把 Formal IR、SMT、符号执行、模型检测、精化关系和 Lean Kernel 验证接入迁移证据链，生成与精确代码和假设绑定的 Proof-Carrying Migration。
...
- 对 Formal IR 的正常路径产生可重放证据。
- 缺少 Operational/Trace/State-machine Semantics 证据时必须降级或阻断。
