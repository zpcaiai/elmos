---
name: b14-formal-verification-proof-carrying-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Formal Verification and Proof-Carrying Migration."
version: 1.0.0
batch: batch-14
risk: critical
