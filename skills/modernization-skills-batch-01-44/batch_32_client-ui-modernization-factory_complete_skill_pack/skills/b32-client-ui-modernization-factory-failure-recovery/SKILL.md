---
name: b32-client-ui-modernization-factory-failure-recovery
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Client, UI, Desktop and Mobile Modernization Factory."
version: 1.0.0
batch: batch-32
risk: critical
