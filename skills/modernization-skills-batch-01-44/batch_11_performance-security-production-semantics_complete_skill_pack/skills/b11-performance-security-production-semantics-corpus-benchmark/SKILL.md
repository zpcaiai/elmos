---
name: b11-performance-security-production-semantics-corpus-benchmark
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Performance, Security and Production Semantics Validation."
version: 1.0.0
batch: batch-11
risk: high
