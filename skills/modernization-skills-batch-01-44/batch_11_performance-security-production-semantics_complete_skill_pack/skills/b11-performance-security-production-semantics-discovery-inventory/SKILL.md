---
name: b11-performance-security-production-semantics-discovery-inventory
description: "从源码、制品、运行、配置、文档和人工声明中发现资产，保存分母、来源和未知项。 Scope: Performance, Security and Production Semantics Validation."
version: 1.0.0
batch: batch-11
risk: medium
