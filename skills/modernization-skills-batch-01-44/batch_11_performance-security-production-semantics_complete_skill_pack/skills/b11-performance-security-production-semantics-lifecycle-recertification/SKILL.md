---
name: b11-performance-security-production-semantics-lifecycle-recertification
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Performance, Security and Production Semantics Validation."
version: 1.0.0
batch: batch-11
risk: high
