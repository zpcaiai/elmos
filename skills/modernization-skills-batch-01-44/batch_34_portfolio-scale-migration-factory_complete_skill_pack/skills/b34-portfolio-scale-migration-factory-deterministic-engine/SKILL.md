---
name: b34-portfolio-scale-migration-factory-deterministic-engine
description: "实现可重放、稳定排序、内容寻址、幂等和有界执行的确定性核心。 Scope: Portfolio-Scale Multi-Repository Migration Factory."
version: 1.0.0
batch: batch-34
risk: critical
