---
name: b34-portfolio-scale-migration-factory-capability-planning
description: "建立能力矩阵、候选方案、约束、依赖、优先级、成本与执行计划。 Scope: Portfolio-Scale Multi-Repository Migration Factory."
version: 1.0.0
batch: batch-34
risk: high
