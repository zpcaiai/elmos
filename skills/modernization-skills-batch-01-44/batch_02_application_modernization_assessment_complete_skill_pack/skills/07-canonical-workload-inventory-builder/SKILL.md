---
name: b02-canonical-workload-inventory-builder
description: "建立 Source→Artifact→Deployment→Runtime 与业务系统层级的统一身份。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Canonical Workload Inventory Builder

## Objective

建立 Source→Artifact→Deployment→Runtime 与业务系统层级的统一身份。
...
- `workload-relationship-graph.json`
- `entity-resolution-decisions.json`
