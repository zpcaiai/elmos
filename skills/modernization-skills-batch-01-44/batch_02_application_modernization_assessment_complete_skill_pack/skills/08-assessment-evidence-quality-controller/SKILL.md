---
name: b02-assessment-evidence-quality-controller
description: "决定哪些 Finding、路线和证书结论具备足够证据。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Assessment Evidence Quality Controller

## Objective

决定哪些 Finding、路线和证书结论具备足够证据。

本 Skill 属于 **Batch 02: Batch 2：应用现代化自动评估**,承担运行时原型 `lineage-reconciliation` 的职责,并由
