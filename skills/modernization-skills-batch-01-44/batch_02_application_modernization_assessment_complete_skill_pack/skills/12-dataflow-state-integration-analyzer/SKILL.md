---
name: b02-dataflow-state-integration-analyzer
description: "建立应用与数据库联合迁移、差分验证和 Dual Run 所需的可观测面。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Dataflow State Integration Analyzer

## Objective

建立应用与数据库联合迁移、差分验证和 Dual Run 所需的可观测面。
...
- `side-effect-register.json`
- `future-equivalence-observable-surface.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
