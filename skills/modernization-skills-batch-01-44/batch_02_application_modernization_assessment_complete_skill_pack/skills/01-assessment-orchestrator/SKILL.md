---
name: b02-assessment-orchestrator
description: "保证发现、架构恢复、风险分析、路线候选、探针、预测和证书围绕同一 Snapshot 与证据链运行。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
保证发现、架构恢复、风险分析、路线候选、探针、预测和证书围绕同一 Snapshot 与证据链运行。

本 Skill 属于 **Batch 02: Batch 2：应用现代化自动评估**,承担运行时原型 `orchestrator` 的职责,并由
