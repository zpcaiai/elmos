---
name: b02-infrastructure-runtime-document-ingestion
description: "把代码以外的运行与组织证据纳入同一评估快照。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Infrastructure Runtime Document Ingestion

## Objective

把代码以外的运行与组织证据纳入同一评估快照。
...
- `document-runtime-conflicts.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
