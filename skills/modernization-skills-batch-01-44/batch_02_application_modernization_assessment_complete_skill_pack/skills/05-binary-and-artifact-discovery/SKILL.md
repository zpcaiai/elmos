---
name: b02-binary-and-artifact-discovery
description: "发现生产中存在但源码中缺失或版本不一致的组件。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Binary And Artifact Discovery

## Objective

发现生产中存在但源码中缺失或版本不一致的组件。
...
- `container-image-inventory.json`
- `source-binary-mapping.json`
