---
name: b02-runtime-topology-correlator
description: "识别静态与运行差异、Hot Path、采样限制和生产基线。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
