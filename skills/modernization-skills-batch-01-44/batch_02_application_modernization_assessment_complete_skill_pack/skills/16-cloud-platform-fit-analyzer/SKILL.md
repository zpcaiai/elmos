---
name: b02-cloud-platform-fit-analyzer
description: "防止先选云产品再反向制造需求，并量化 Lock-in 与退出成本。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Cloud Platform Fit Analyzer

## Objective

防止先选云产品再反向制造需求，并量化 Lock-in 与退出成本。
...
- `target-options.json`
- `platform-blockers.json`
- `portability-exit-cost.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
