---
name: b02-architecture-recovery-engine
description: "生成当前架构、Drift、迁移单元候选和假设登记。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Architecture Recovery Engine

## Objective

生成当前架构、Drift、迁移单元候选和假设登记。
...
- `migration-unit-candidates.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
