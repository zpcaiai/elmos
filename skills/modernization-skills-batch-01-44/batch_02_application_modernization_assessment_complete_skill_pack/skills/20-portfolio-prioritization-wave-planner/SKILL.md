---
name: b02-portfolio-prioritization-wave-planner
description: "让 Pilot、平台前置、共享数据库和高关键系统按依赖和学习价值排序。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Portfolio Prioritization Wave Planner

## Objective

让 Pilot、平台前置、共享数据库和高关键系统按依赖和学习价值排序。

本 Skill 属于 **Batch 02: Batch 2：应用现代化自动评估**,承担运行时原型 `capability-planning` 的职责,并由
...
- `critical-path.json`
- `capacity-plan.json`
- `wave-sensitivity-analysis.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
