---
name: b02-portfolio-intake-and-scope
description: "回答究竟评估哪些系统，并为覆盖率提供真实分母。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Portfolio Intake And Scope

## Objective

回答究竟评估哪些系统，并为覆盖率提供真实分母。
...
- `scope-boundary.json`
- `expected-asset-register.json`
- `exclusion-register.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
