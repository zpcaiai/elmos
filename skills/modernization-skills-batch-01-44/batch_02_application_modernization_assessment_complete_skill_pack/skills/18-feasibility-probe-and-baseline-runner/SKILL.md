---
name: b02-feasibility-probe-and-baseline-runner
description: "用真实工具链证据校准候选，而不把探针通过冒充生产迁移成功。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Feasibility Probe And Baseline Runner

## Objective

用真实工具链证据校准候选，而不把探针通过冒充生产迁移成功。
