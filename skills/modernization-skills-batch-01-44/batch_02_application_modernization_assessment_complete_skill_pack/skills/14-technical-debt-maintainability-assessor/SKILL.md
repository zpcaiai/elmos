---
name: b02-technical-debt-maintainability-assessor
description: "区分迁移前必须修复、迁移中处理和迁移后偿还的技术债。 Scope: Batch 2：应用现代化自动评估."
version: 1.0.0
batch: batch-02
...
# Technical Debt Maintainability Assessor

## Objective

区分迁移前必须修复、迁移中处理和迁移后偿还的技术债。
...
- `maintainability-scorecard.json`
- `debt-remediation-phases.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
