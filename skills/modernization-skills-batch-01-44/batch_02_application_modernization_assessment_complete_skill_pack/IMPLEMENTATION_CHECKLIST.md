# Batch 02 Implementation Checklist
...
- [ ] Unknown denominator 从不显示为 100%。
- [ ] Binary-only、Generated 和 Vendor Code 分开统计。
- [ ] Sandbox 阻断网络、Secret 和生产数据库。
- [ ] 预测按组织/仓库分组并执行 OOD 检测。
- [ ] Assessment Certificate 不会被描述为迁移成功证书。
