---
name: b43-legacy-coexistence-retirement-orchestrator
description: "编排本 Batch 的所有能力、前置证书、状态机、暂停恢复取消、人工门禁和最终证书。 Scope: Legacy Coexistence, Cutover, Hypercare and Continuous Modernization."
version: 1.0.0
batch: batch-43
risk: critical
