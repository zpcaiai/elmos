---
name: b43-legacy-coexistence-retirement-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Legacy Coexistence, Cutover, Hypercare and Continuous Modernization."
version: 1.0.0
batch: batch-43
risk: critical
