# BATCH21_COMPATIBILITY

本文件定义 Batch 21 → Batch 22（Semantic Recovery Hardening and Runtime-Enriched CSIR）的输入、输出、版本、证书、失效与回退协议。

## Inherited Foundation

Batch 22 必须继承 Batch 01–05：产品边界、评估快照、Canonical Semantic IR、Transformation Rule/Recipe、Target Project/Codegen、Source-target Provenance、Unknown Preservation 和 Conservative Certification。
