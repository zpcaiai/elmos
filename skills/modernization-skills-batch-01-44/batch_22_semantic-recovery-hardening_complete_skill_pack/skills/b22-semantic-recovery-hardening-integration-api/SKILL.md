---
name: b22-semantic-recovery-hardening-integration-api
description: "提供版本化 API、事件、Webhook、SDK 和导入导出，保证幂等、鉴权和兼容。 Scope: Semantic Recovery Hardening and Runtime-Enriched CSIR."
version: 1.0.0
batch: batch-22
risk: high
