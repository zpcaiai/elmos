---
name: b22-semantic-recovery-hardening-adapter-provider
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Semantic Recovery Hardening and Runtime-Enriched CSIR."
version: 1.0.0
batch: batch-22
risk: high
