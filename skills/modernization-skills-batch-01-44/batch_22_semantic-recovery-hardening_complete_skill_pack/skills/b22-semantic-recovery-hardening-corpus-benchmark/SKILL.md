---
name: b22-semantic-recovery-hardening-corpus-benchmark
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Semantic Recovery Hardening and Runtime-Enriched CSIR."
version: 1.0.0
batch: batch-22
risk: high
