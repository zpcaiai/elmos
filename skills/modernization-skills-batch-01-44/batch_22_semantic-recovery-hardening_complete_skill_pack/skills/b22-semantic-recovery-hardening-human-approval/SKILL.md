---
name: b22-semantic-recovery-hardening-human-approval
description: "为高影响、不确定、不可逆和例外决策建立解释、审批、过期与责任边界。 Scope: Semantic Recovery Hardening and Runtime-Enriched CSIR."
version: 1.0.0
batch: batch-22
risk: high
