---
name: b35-advanced-verification-factory-failure-recovery
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Advanced Verification, Fuzzing, Mutation and Formal Assurance Factory."
version: 1.0.0
batch: batch-35
risk: critical
