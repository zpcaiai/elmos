---
name: b35-advanced-verification-factory-adapter-provider
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Advanced Verification, Fuzzing, Mutation and Formal Assurance Factory."
version: 1.0.0
batch: batch-35
risk: high
