---
name: b12-benchmark-quality-economics-discovery-inventory
description: "从源码、制品、运行、配置、文档和人工声明中发现资产，保存分母、来源和未知项。 Scope: Benchmark, Quality Scoring and Migration Economics."
version: 1.0.0
batch: batch-12
risk: medium
