---
name: b12-benchmark-quality-economics-adapter-provider
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Benchmark, Quality Scoring and Migration Economics."
version: 1.0.0
batch: batch-12
risk: high
