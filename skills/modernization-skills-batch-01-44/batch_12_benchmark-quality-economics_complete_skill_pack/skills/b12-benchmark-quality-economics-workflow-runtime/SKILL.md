---
name: b12-benchmark-quality-economics-workflow-runtime
description: "在统一 Durable Workflow 和隔离 Runner 中执行任务，管理租约、检查点、副作用和补偿。 Scope: Benchmark, Quality Scoring and Migration Economics."
version: 1.0.0
batch: batch-12
risk: critical
