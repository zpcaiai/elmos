---
name: b36-developer-experience-integration-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Developer Experience, CLI, IDE and SCM Integration."
version: 1.0.0
batch: batch-36
risk: high
...
本 Skill 属于 **Batch 36: Developer Experience, CLI, IDE and SCM Integration**。Batch 总目标：把规划、预览、导航、诊断、审批、执行和证据接入 CLI、VS Code、Visual Studio、IntelliJ 和主要 SCM，同时支持离线与最小权限。
