---
name: b36-developer-experience-integration-adapter-provider
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Developer Experience, CLI, IDE and SCM Integration."
version: 1.0.0
batch: batch-36
risk: high
