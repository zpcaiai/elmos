---
name: b36-developer-experience-integration-human-approval
description: "为高影响、不确定、不可逆和例外决策建立解释、审批、过期与责任边界。 Scope: Developer Experience, CLI, IDE and SCM Integration."
version: 1.0.0
batch: batch-36
risk: high
