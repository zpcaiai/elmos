---
name: b36-developer-experience-integration-capability-planning
description: "建立能力矩阵、候选方案、约束、依赖、优先级、成本与执行计划。 Scope: Developer Experience, CLI, IDE and SCM Integration."
version: 1.0.0
batch: batch-36
risk: high
