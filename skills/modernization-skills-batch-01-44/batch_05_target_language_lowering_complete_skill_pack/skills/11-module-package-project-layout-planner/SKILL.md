---
name: b05-module-package-project-layout-planner
description: "Implement the capability-planning responsibility for Batch 05. Scope: Batch 5：Target Language Lowering、Framework Backend 与 Idiomatic Code Generation."
version: 1.0.0
batch: batch-05
...
# Module Package Project Layout Planner

## Objective

Implement the capability-planning responsibility for Batch 05.

本 Skill 属于 **Batch 05: Batch 5：Target Language Lowering、Framework Backend 与 Idiomatic Code Generation**,承担运行时原型 `capability-planning` 的职责,并由
