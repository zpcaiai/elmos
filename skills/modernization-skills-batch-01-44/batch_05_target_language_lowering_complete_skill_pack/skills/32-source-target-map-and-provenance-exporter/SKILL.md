---
name: b05-source-target-map-and-provenance-exporter
description: "Implement the lineage-reconciliation responsibility for Batch 05. Scope: Batch 5：Target Language Lowering、Framework Backend 与 Idiomatic Code Generation."
version: 1.0.0
batch: batch-05
...
# Source Target Map And Provenance Exporter

## Objective

Implement the lineage-reconciliation responsibility for Batch 05.

本 Skill 属于 **Batch 05: Batch 5：Target Language Lowering、Framework Backend 与 Idiomatic Code Generation**,承担运行时原型 `lineage-reconciliation` 的职责,并由
