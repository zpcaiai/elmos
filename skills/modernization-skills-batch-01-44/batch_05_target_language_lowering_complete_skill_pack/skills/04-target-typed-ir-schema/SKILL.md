---
name: b05-target-typed-ir-schema
description: "Implement the domain-model responsibility for Batch 05. Scope: Batch 5：Target Language Lowering、Framework Backend 与 Idiomatic Code Generation."
version: 1.0.0
batch: batch-05
...
# Target Typed Ir Schema

## Objective

Implement the domain-model responsibility for Batch 05.

本 Skill 属于 **Batch 05: Batch 5：Target Language Lowering、Framework Backend 与 Idiomatic Code Generation**,承担运行时原型 `domain-model` 的职责,并由
