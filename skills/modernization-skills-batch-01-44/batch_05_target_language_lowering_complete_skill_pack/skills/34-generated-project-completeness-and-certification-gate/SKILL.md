---
name: b05-generated-project-completeness-and-certification-gate
description: "Implement the certification-gate responsibility for Batch 05. Scope: Batch 5：Target Language Lowering、Framework Backend 与 Idiomatic Code Generation."
version: 1.0.0
batch: batch-05
archetype: certification-gate
risk: medium
status: implementation-ready
---

# Generated Project Completeness And Certification Gate

## Objective

Implement the certification-gate responsibility for Batch 05.

本 Skill 属于 **Batch 05: Batch 5：Target Language Lowering、Framework Backend 与 Idiomatic Code Generation**,承担运行时原型 `certification-gate` 的职责,并由
`scripts/modernization_b01_44` 中的同名执行路径实际驱动。

## Scope

- 运行时原型:`certification-gate`
