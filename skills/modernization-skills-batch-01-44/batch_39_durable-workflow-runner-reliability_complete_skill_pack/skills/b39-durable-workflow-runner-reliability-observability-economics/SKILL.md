---
name: b39-durable-workflow-runner-reliability-observability-economics
description: "采集日志、Trace、指标、分母、SLO、资源、成本、人工工时和商业可行性。 Scope: Durable Workflow, Runner Fleet and Provider Reliability."
version: 1.0.0
batch: batch-39
risk: medium
