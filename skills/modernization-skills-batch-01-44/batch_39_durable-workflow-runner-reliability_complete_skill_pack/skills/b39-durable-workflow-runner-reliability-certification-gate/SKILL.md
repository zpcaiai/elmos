---
name: b39-durable-workflow-runner-reliability-certification-gate
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Durable Workflow, Runner Fleet and Provider Reliability."
version: 1.0.0
batch: batch-39
risk: critical
