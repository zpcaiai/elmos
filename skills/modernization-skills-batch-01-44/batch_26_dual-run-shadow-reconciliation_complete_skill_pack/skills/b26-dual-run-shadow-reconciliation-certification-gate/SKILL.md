---
name: b26-dual-run-shadow-reconciliation-certification-gate
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Dual Run, Shadow Execution and State Reconciliation."
version: 1.0.0
batch: batch-26
risk: critical
