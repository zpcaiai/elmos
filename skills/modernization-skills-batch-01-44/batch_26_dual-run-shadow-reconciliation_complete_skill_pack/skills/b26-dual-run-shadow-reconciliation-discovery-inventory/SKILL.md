---
name: b26-dual-run-shadow-reconciliation-discovery-inventory
description: "从源码、制品、运行、配置、文档和人工声明中发现资产，保存分母、来源和未知项。 Scope: Dual Run, Shadow Execution and State Reconciliation."
version: 1.0.0
batch: batch-26
risk: medium
