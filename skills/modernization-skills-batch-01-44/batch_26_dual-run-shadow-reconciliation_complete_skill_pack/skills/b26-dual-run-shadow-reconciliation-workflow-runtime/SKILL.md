---
name: b26-dual-run-shadow-reconciliation-workflow-runtime
description: "在统一 Durable Workflow 和隔离 Runner 中执行任务，管理租约、检查点、副作用和补偿。 Scope: Dual Run, Shadow Execution and State Reconciliation."
version: 1.0.0
batch: batch-26
risk: critical
