---
name: b26-dual-run-shadow-reconciliation-integration-api
description: "提供版本化 API、事件、Webhook、SDK 和导入导出，保证幂等、鉴权和兼容。 Scope: Dual Run, Shadow Execution and State Reconciliation."
version: 1.0.0
batch: batch-26
risk: high
