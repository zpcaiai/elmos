---
name: b07-framework-contract-recipe-packs-adapter-provider
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Framework Contract Model and Framework Migration Recipe Packs."
version: 1.0.0
batch: batch-07
risk: high
