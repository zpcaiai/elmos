---
name: b07-framework-contract-recipe-packs-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Framework Contract Model and Framework Migration Recipe Packs."
version: 1.0.0
batch: batch-07
risk: high
...
本 Skill 属于 **Batch 07: Framework Contract Model and Framework Migration Recipe Packs**。Batch 总目标：把 Spring Boot、ASP.NET Core、FastAPI、Django、Flask、NestJS、Express 等框架的路由、DI、安全、ORM、配置和运行期语义转化为可认证的方向性 Framework Pack。
...
- 对 Framework Contract Model 的正常路径产生可重放证据。
- 缺少 精确源目标版本指纹 证据时必须降级或阻断。
