---
name: b03-generated-code-macro-and-metaprogramming-modeler
description: "决定后续转换应修改输入模板、生成器还是生成输出。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Generated Code Macro And Metaprogramming Modeler

## Objective

决定后续转换应修改输入模板、生成器还是生成输出。

本 Skill 属于 **Batch 03: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation**,承担运行时原型 `domain-model` 的职责,并由
...
- `generation-provenance-graph.json`
- `macro-expansion-map.json`
- `generated-source-register.json`
- `metaprogramming-unknowns.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
