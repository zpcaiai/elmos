---
name: b03-native-semantic-attribution-engine
description: "形成 Compiler-confirmed 与 Partial Semantic Facts，防止模型猜测污染。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Native Semantic Attribution Engine

## Objective

形成 Compiler-confirmed 与 Partial Semantic Facts，防止模型猜测污染。
...
- `native-semantic-ir/`
- `symbol-attribution.json`
- `type-attribution.json`
