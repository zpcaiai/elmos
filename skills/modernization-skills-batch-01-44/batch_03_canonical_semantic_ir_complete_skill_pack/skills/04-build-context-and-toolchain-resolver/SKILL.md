---
name: b03-build-context-and-toolchain-resolver
description: "让同一源码在不同 Profile、Target Framework、宏和依赖下拥有独立语义上下文。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Build Context And Toolchain Resolver

## Objective

让同一源码在不同 Profile、Target Framework、宏和依赖下拥有独立语义上下文。
