---
name: b03-symbol-identity-scope-and-linker
description: "提供稳定 SymbolId、LogicalSymbolId 和模糊引用模型。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Symbol Identity Scope And Linker

## Objective

提供稳定 SymbolId、LogicalSymbolId 和模糊引用模型。
...
- `cross-snapshot-symbol-map.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
