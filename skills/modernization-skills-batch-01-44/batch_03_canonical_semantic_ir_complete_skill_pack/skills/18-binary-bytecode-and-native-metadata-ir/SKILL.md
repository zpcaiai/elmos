---
name: b03-binary-bytecode-and-native-metadata-ir
description: "补足 Source Missing 和生产版本 Drift，同时保持授权与 Derived 标记。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Binary Bytecode And Native Metadata Ir

## Objective

补足 Source Missing 和生产版本 Drift，同时保持授权与 Derived 标记。
...
- `binary-ir/`
- `binary-source-map.json`
- `source-binary-drift.json`
- `opaque-binary-register.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
