---
name: b03-ir-query-diff-and-export-service
description: "让后续 Batch 通过稳定 API 消费 IR，而不是直接读取内部存储。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Ir Query Diff And Export Service

## Objective

让后续 Batch 通过稳定 API 消费 IR，而不是直接读取内部存储。
...
- `ir-query-api`
- `ir-diff-results.json`
- `controlled-export-bundles/`
- `query-audit-log.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
