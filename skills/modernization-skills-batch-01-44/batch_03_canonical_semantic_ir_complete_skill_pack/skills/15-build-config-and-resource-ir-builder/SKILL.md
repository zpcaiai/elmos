---
name: b03-build-config-and-resource-ir-builder
description: "让代码生成和框架迁移理解配置优先级、环境差异与资源所有权。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Build Config And Resource Ir Builder

## Objective

让代码生成和框架迁移理解配置优先级、环境差异与资源所有权。
