---
name: b03-frontend-adapter-sdk-and-registry
description: "统一 Compiler-backed、Lossless、Syntax 和 Token Fallback 前端，而不强制使用同一解析器。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Frontend Adapter Sdk And Registry

## Objective

统一 Compiler-backed、Lossless、Syntax 和 Token Fallback 前端，而不强制使用同一解析器。

本 Skill 属于 **Batch 03: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation**,承担运行时原型 `adapter-provider` 的职责,并由
