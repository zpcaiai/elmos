---
name: b03-native-lossless-syntax-ir-builder
description: "提供文本与语言原生结构的保真层，支持无操作 Round Trip 和最小范围重写。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Native Lossless Syntax Ir Builder

## Objective

提供文本与语言原生结构的保真层，支持无操作 Round Trip 和最小范围重写。
