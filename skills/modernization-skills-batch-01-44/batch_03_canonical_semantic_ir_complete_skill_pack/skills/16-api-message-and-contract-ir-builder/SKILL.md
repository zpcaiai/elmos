---
name: b03-api-message-and-contract-ir-builder
description: "建立实现与正式契约的统一 ContractIR 和 Drift。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Api Message And Contract Ir Builder

## Objective

建立实现与正式契约的统一 ContractIR 和 Drift。

本 Skill 属于 **Batch 03: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation**,承担运行时原型 `integration-api` 的职责,并由
...
- `api-ir.json`
- `message-contract-ir.json`
- `contract-implementation-map.json`
