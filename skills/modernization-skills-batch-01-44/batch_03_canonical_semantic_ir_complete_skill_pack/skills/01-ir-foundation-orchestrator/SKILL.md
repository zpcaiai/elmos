---
name: b03-ir-foundation-orchestrator
description: "为 Assessment Snapshot 生成唯一、可复现、可恢复的联邦式 IR Bundle。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Ir Foundation Orchestrator

## Objective

为 Assessment Snapshot 生成唯一、可复现、可恢复的联邦式 IR Bundle。

本 Skill 属于 **Batch 03: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation**,承担运行时原型 `orchestrator` 的职责,并由
