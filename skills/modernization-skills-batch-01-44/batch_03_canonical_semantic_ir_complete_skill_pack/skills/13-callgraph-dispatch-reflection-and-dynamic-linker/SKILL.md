---
name: b03-callgraph-dispatch-reflection-and-dynamic-linker
description: "建立 must、may、observed 和 unresolved 调用边。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Callgraph Dispatch Reflection And Dynamic Linker

## Objective

建立 must、may、observed 和 unresolved 调用边。
...
- `callgraph/`
- `dynamic-call-register.json`
- `reflection-candidates.json`
- `runtime-call-correlation.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
