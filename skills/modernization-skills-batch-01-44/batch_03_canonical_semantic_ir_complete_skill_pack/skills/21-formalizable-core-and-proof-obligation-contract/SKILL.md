---
name: b03-formalizable-core-and-proof-obligation-contract
description: "区分可形式化区域、边界假设、Unsupported Semantics 和已经完成的证明。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Formalizable Core And Proof Obligation Contract

## Objective

区分可形式化区域、边界假设、Unsupported Semantics 和已经完成的证明。
...
- `formal-boundary-assumptions.json`
- `unsupported-formal-semantics.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
