---
name: b03-frontend-conformance-and-ir-certification-gate
description: "通过 IR0–IR6 分资产认证，防止局部语义能力冒充全仓完整语义。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Frontend Conformance And Ir Certification Gate

## Objective

通过 IR0–IR6 分资产认证，防止局部语义能力冒充全仓完整语义。

本 Skill 属于 **Batch 03: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation**,承担运行时原型 `certification-gate` 的职责,并由
...
- `ir-certificate.json`
- `ir-certificate.sig`
- `unresolved-semantic-register.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
