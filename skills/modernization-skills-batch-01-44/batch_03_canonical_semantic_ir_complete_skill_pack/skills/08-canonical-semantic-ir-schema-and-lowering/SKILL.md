---
name: b03-canonical-semantic-ir-schema-and-lowering
description: "用共同语义支持跨语言比较，同时通过 Extension Capsule 保留专有语义。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Canonical Semantic Ir Schema And Lowering

## Objective

用共同语义支持跨语言比较，同时通过 Extension Capsule 保留专有语义。
...
- `lowering-decisions.json`
- `semantic-gap-register.json`
- `extension-capsules/`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
