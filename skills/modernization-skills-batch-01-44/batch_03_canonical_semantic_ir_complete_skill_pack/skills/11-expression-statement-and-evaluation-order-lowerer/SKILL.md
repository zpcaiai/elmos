---
name: b03-expression-statement-and-evaluation-order-lowerer
description: "确保跨语言转换不会因参数、操作数、闭包或 Await 顺序差异改变行为。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Expression Statement And Evaluation Order Lowerer

## Objective

确保跨语言转换不会因参数、操作数、闭包或 Await 顺序差异改变行为。
...
- `canonical-expression-ir.json`
- `canonical-statement-ir.json`
- `evaluation-order-facts.json`
- `desugaring-map.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
