---
name: b03-sql-and-database-procedural-ir-builder
description: "保留 Oracle、SQL Server、MySQL、PostgreSQL 的查询、事务、Routine 和专有语义。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Sql And Database Procedural Ir Builder

## Objective

保留 Oracle、SQL Server、MySQL、PostgreSQL 的查询、事务、Routine 和专有语义。

本 Skill 属于 **Batch 03: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation**,承担运行时原型 `deterministic-engine` 的职责,并由
...
- `sql-ir/`
- `database-object-link-map.json`
- `sql-read-write-sets.json`
- `dynamic-sql-holes.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
