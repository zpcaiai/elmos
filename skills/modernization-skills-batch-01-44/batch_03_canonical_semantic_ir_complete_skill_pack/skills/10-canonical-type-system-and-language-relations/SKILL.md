---
name: b03-canonical-type-system-and-language-relations
description: "避免构建一个错误的全局 Subtype Lattice。 Scope: Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation."
version: 1.0.0
batch: batch-03
...
# Canonical Type System And Language Relations

## Objective

避免构建一个错误的全局 Subtype Lattice。
...
- `type-index/`
- `language-type-relations.json`
- `type-mapping-candidates.json`
- `type-diagnostics.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
