# Batch 03 Complete Skill Pack

## Batch 3：统一源码摄取、解析前端与 Canonical Semantic IR Foundation

本压缩包是 Batch 03 的完整 Codex 实施规格，包含总纲、逐 Skill 规范、兼容协议、Schema、策略、示例、综合场景、静态校验工具和包内摘要。
...
- `SKILL_INDEX.md`：24 个 Skills 索引。
- `BATCH02_COMPATIBILITY.md`：上游 Batch 与本 Batch 的输入、版本、证书和失效兼容性。
...
```text
优先前端：Java、C#/.NET、JavaScript/TypeScript、Python、C/C++、Go、Rust、SQL
IR 认证等级：IR0 Source Captured → IR6 Formal Core Ready
权威序列化：Deterministic Protobuf；Human Debug：Canonical JSON
```
