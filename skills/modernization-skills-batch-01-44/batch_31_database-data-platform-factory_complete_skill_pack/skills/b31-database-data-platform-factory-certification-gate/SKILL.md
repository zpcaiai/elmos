---
name: b31-database-data-platform-factory-certification-gate
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Database and Data-Platform Modernization Factory."
version: 1.0.0
batch: batch-31
risk: critical
