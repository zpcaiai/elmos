---
name: b31-database-data-platform-factory-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Database and Data-Platform Modernization Factory."
version: 1.0.0
batch: batch-31
risk: critical
