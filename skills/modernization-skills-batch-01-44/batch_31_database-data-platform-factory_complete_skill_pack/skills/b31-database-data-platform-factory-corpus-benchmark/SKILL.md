---
name: b31-database-data-platform-factory-corpus-benchmark
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Database and Data-Platform Modernization Factory."
version: 1.0.0
batch: batch-31
risk: high
