---
name: b31-database-data-platform-factory-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Database and Data-Platform Modernization Factory."
version: 1.0.0
batch: batch-31
risk: high
...
本 Skill 属于 **Batch 31: Database and Data-Platform Modernization Factory**。Batch 总目标：把数据库引擎互转、ETL/ELT、数据质量、目录血缘、仓库湖仓和 ORM 联合迁移汇聚为可认证的数据平台现代化工厂。
...
- 对 Estate Discovery 的正常路径产生可重放证据。
- 缺少 Canonical DB IR 证据时必须降级或阻断。
