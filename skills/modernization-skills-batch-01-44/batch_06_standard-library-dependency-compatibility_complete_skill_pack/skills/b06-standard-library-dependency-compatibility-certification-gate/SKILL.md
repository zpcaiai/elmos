---
name: b06-standard-library-dependency-compatibility-certification-gate
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Standard Library, Dependency Mapping and Compatibility Runtime."
version: 1.0.0
batch: batch-06
risk: critical
