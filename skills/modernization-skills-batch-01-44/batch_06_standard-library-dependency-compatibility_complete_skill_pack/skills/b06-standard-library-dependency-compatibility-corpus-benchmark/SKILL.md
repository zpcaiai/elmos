---
name: b06-standard-library-dependency-compatibility-corpus-benchmark
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Standard Library, Dependency Mapping and Compatibility Runtime."
version: 1.0.0
batch: batch-06
risk: high
