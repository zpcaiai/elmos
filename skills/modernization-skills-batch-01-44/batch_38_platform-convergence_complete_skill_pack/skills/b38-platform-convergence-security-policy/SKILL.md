---
name: b38-platform-convergence-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Canonical CapabilityPackage, Dependency Graph and Platform Convergence."
version: 1.0.0
batch: batch-38
risk: critical
