---
name: b38-platform-convergence-corpus-benchmark
description: "建设正例、负例、边界、Holdout、代表性和对抗性 Corpus，并执行基准和回归。 Scope: Canonical CapabilityPackage, Dependency Graph and Platform Convergence."
version: 1.0.0
batch: batch-38
risk: high
