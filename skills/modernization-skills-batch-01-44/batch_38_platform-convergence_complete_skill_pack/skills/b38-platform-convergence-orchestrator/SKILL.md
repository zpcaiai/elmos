---
name: b38-platform-convergence-orchestrator
description: "编排本 Batch 的所有能力、前置证书、状态机、暂停恢复取消、人工门禁和最终证书。 Scope: Canonical CapabilityPackage, Dependency Graph and Platform Convergence."
version: 1.0.0
batch: batch-38
risk: critical
