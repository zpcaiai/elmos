# Codex Implementation Prompt — Batch 38

你正在目标仓库中实现 **Batch 38: Canonical CapabilityPackage, Dependency Graph and Platform Convergence**。
