---
name: b01-competitive-landscape-orchestrator
description: "把一次性竞品调研转化为可暂停恢复、可审计、可重复运行的竞争情报与产品定位系统。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Competitive Landscape Orchestrator

## Objective

把一次性竞品调研转化为可暂停恢复、可审计、可重复运行的竞争情报与产品定位系统。

本 Skill 属于 **Batch 01: Batch 1：竞争格局、产品定位与持续竞争情报**,承担运行时原型 `orchestrator` 的职责,并由
...
- `competitive-assessment-run.json`
