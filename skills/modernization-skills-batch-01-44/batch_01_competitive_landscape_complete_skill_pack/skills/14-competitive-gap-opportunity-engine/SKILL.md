---
name: b01-competitive-gap-opportunity-engine
description: "区分短期功能空白和难以复制的系统性能力，形成产品机会优先级。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Competitive Gap Opportunity Engine

## Objective

区分短期功能空白和难以复制的系统性能力，形成产品机会优先级。
...
- `opportunity-priority.json`
- `moat-hypothesis-register.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
