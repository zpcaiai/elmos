---
name: b01-battlecard-and-continuous-intelligence-gate
description: "让销售、产品和战略团队持续使用同一事实库，同时阻止过期或未经证实话术。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Battlecard And Continuous Intelligence Gate

## Objective

让销售、产品和战略团队持续使用同一事实库，同时阻止过期或未经证实话术。

本 Skill 属于 **Batch 01: Batch 1：竞争格局、产品定位与持续竞争情报**,承担运行时原型 `certification-gate` 的职责,并由
...
- `battlecards/`
- `continuous-intelligence-monitor.json`
- `prohibited-claims-register.json`
- `batch-01-certificate.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
