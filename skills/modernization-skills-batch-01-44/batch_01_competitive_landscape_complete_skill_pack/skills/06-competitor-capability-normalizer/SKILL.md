---
name: b01-competitor-capability-normalizer
description: "避免因为术语相似或厂商动词模糊而错误认定能力等价。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Competitor Capability Normalizer

## Objective

避免因为术语相似或厂商动词模糊而错误认定能力等价。
