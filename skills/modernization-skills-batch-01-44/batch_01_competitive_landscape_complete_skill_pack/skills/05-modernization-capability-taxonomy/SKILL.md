---
name: b01-modernization-capability-taxonomy
description: "把发现、评估、转换、验证、切换、治理和持续现代化拆成可比较、可证据化的能力单元。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Modernization Capability Taxonomy

## Objective

把发现、评估、转换、验证、切换、治理和持续现代化拆成可比较、可证据化的能力单元。

本 Skill 属于 **Batch 01: Batch 1：竞争格局、产品定位与持续竞争情报**,承担运行时原型 `domain-model` 的职责,并由
...
- `capability-dependency-graph.json`
- `capability-evidence-requirements.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
