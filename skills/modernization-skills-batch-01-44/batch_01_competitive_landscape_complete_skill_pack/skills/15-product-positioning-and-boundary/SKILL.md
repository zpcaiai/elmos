---
name: b01-product-positioning-and-boundary
description: "形成可验证的 Verified Modernization Execution OS 定位，明确服务谁、解决什么和不承诺什么。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
形成可验证的 Verified Modernization Execution OS 定位，明确服务谁、解决什么和不承诺什么。
...
- `reference-route-decision.yaml`
- `positioning-decision-record.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
