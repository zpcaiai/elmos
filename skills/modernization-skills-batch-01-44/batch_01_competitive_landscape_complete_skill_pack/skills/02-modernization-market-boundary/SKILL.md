---
name: b01-modernization-market-boundary
description: "建立统一市场边界，防止把云迁移、代码生成、咨询服务和完整现代化平台混为一谈。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Modernization Market Boundary

## Objective

建立统一市场边界，防止把云迁移、代码生成、咨询服务和完整现代化平台混为一谈。

本 Skill 属于 **Batch 01: Batch 1：竞争格局、产品定位与持续竞争情报**,承担运行时原型 `capability-planning` 的职责,并由
...
- `market-boundary.yaml`
- `competitor-classification-policy.yaml`
- `explicit-exclusion-register.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
