---
name: b01-competitive-claim-benchmark-verifier
description: "避免无基线、无样本、只算生成时间或删除失败测试后的误导性指标。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Competitive Claim Benchmark Verifier

## Objective

避免无基线、无样本、只算生成时间或删除失败测试后的误导性指标。

本 Skill 属于 **Batch 01: Batch 1：竞争格局、产品定位与持续竞争情报**,承担运行时原型 `corpus-benchmark` 的职责,并由
