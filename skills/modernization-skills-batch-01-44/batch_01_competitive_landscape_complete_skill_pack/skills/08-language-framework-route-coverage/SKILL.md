---
name: b01-language-framework-route-coverage
description: "建立精确 Directional Route Matrix，防止把版本升级、文件级转换和仓库级迁移混为一谈。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Language Framework Route Coverage

## Objective

建立精确 Directional Route Matrix，防止把版本升级、文件级转换和仓库级迁移混为一谈。
...
- `route-evidence-summary.json`
- `unsupported-route-register.yaml`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
