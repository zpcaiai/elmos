---
name: b01-commercial-economics-analyzer
description: "用 Cost per Verified Migrated Workload 而不是生成代码行数评价经济性。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
archetype: observability-economics
risk: high
status: implementation-ready
---

# Commercial Economics Analyzer

## Objective

用 Cost per Verified Migrated Workload 而不是生成代码行数评价经济性。

本 Skill 属于 **Batch 01: Batch 1：竞争格局、产品定位与持续竞争情报**,承担运行时原型 `observability-economics` 的职责,并由
`scripts/modernization_b01_44` 中的同名执行路径实际驱动。

## Scope

- 运行时原型:`observability-economics`
...
- `tco-scenarios.json`
- `cost-per-verified-workload.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
