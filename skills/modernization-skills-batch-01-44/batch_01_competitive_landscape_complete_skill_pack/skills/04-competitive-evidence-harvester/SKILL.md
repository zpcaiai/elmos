---
name: b01-competitive-evidence-harvester
description: "把营销描述拆分为可验证原子 Claim，并保存版本、范围、来源、摘要和过期时间。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Competitive Evidence Harvester

## Objective

把营销描述拆分为可验证原子 Claim，并保存版本、范围、来源、摘要和过期时间。

本 Skill 属于 **Batch 01: Batch 1：竞争格局、产品定位与持续竞争情报**,承担运行时原型 `lineage-reconciliation` 的职责,并由
...
- `capability-facts.json`
- `claim-evidence-graph.json`
- `evidence-conflict-register.json`
- `evidence-expiry-schedule.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
