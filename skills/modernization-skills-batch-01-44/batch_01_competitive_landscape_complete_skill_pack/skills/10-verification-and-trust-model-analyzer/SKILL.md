---
name: b01-verification-and-trust-model-analyzer
description: "区分语法、构建、测试、差分行为、Dual Run、客户验收和形式证明。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
# Verification And Trust Model Analyzer

## Objective

区分语法、构建、测试、差分行为、Dual Run、客户验收和形式证明。
...
- `trust-assessment.json`
- `oracle-independence-report.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
