---
name: b01-competitor-discovery-registry
description: "维护唯一竞争对象注册表，解决产品更名、收购、开源核心、托管平台和服务能力重复计数问题。 Scope: Batch 1：竞争格局、产品定位与持续竞争情报."
version: 1.0.0
batch: batch-01
...
维护唯一竞争对象注册表，解决产品更名、收购、开源核心、托管平台和服务能力重复计数问题。

本 Skill 属于 **Batch 01: Batch 1：竞争格局、产品定位与持续竞争情报**,承担运行时原型 `adapter-provider` 的职责,并由
...
- `product-relationship-graph.json`
