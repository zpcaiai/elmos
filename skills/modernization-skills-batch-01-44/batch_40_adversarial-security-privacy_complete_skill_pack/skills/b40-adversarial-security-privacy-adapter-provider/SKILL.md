---
name: b40-adversarial-security-privacy-adapter-provider
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Adversarial Security, Privacy and Supply-Chain Assurance."
version: 1.0.0
batch: batch-40
risk: high
