---
name: b40-adversarial-security-privacy-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Adversarial Security, Privacy and Supply-Chain Assurance."
version: 1.0.0
batch: batch-40
risk: high
