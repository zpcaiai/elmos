---
name: b40-adversarial-security-privacy-human-approval
description: "为高影响、不确定、不可逆和例外决策建立解释、审批、过期与责任边界。 Scope: Adversarial Security, Privacy and Supply-Chain Assurance."
version: 1.0.0
batch: batch-40
risk: high
