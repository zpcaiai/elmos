---
name: b20-skill-sdk-runtime-registry-orchestrator
description: "编排本 Batch 的所有能力、前置证书、状态机、暂停恢复取消、人工门禁和最终证书。 Scope: Skill SDK, Runtime, Registry and Marketplace Productization."
version: 1.0.0
batch: batch-20
risk: critical
