---
name: b20-skill-sdk-runtime-registry-integration-api
description: "提供版本化 API、事件、Webhook、SDK 和导入导出，保证幂等、鉴权和兼容。 Scope: Skill SDK, Runtime, Registry and Marketplace Productization."
version: 1.0.0
batch: batch-20
risk: high
