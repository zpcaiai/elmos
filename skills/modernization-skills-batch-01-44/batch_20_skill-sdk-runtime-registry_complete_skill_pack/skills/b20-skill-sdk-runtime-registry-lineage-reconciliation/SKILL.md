---
name: b20-skill-sdk-runtime-registry-lineage-reconciliation
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Skill SDK, Runtime, Registry and Marketplace Productization."
version: 1.0.0
batch: batch-20
risk: high
