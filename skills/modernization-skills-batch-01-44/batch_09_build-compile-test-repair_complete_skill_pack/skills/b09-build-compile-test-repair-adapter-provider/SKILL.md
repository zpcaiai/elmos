---
name: b09-build-compile-test-repair-adapter-provider
description: "通过签名适配器连接语言、框架、数据库、云、工具或外部 Provider，保留能力边界。 Scope: Build, Compile, Test Repair and Bounded Fix Loop."
version: 1.0.0
batch: batch-09
risk: high
