---
name: b09-build-compile-test-repair-lifecycle-recertification
description: "管理 draft、experimental、limited、certified、deprecated、retired、revoked 及证据过期传播。 Scope: Build, Compile, Test Repair and Bounded Fix Loop."
version: 1.0.0
batch: batch-09
risk: high
