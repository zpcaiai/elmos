---
name: b09-build-compile-test-repair-lineage-reconciliation
description: "连接输入、决策、变换、输出、验证和证书，处理差异、冲突、重放和对账。 Scope: Build, Compile, Test Repair and Bounded Fix Loop."
version: 1.0.0
batch: batch-09
risk: high
