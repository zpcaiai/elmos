---
name: b30-multi-framework-version-factory-workflow-runtime
description: "在统一 Durable Workflow 和隔离 Runner 中执行任务，管理租约、检查点、副作用和补偿。 Scope: Multi-Framework and Version Migration Factory."
version: 1.0.0
batch: batch-30
risk: critical
