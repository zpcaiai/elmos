---
name: b30-multi-framework-version-factory-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Multi-Framework and Version Migration Factory."
version: 1.0.0
batch: batch-30
risk: critical
