---
name: b30-multi-framework-version-factory-failure-recovery
description: "分类失败、隔离影响、保存证据、回滚到安全点、恢复运行并阻止假成功。 Scope: Multi-Framework and Version Migration Factory."
version: 1.0.0
batch: batch-30
risk: critical
