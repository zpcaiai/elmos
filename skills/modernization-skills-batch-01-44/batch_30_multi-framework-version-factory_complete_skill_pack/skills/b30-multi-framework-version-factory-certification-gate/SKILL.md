---
name: b30-multi-framework-version-factory-certification-gate
description: "只依据不可变证据签发最强可证明状态；缺证据、未知或阻断项必须降级或拒绝。 Scope: Multi-Framework and Version Migration Factory."
version: 1.0.0
batch: batch-30
risk: critical
