---
name: b30-multi-framework-version-factory-domain-model
description: "定义稳定 ID、版本化 Schema、状态、输入输出、Unknown 保留、摘要和兼容策略。 Scope: Multi-Framework and Version Migration Factory."
version: 1.0.0
batch: batch-30
risk: high
...
本 Skill 属于 **Batch 30: Multi-Framework and Version Migration Factory**。Batch 总目标：建立框架升级、跨框架迁移和共存工厂，覆盖 Java、.NET、Python、Node.js 主要服务框架及其精确版本和运行时契约。
...
- 对 Framework Factory 的正常路径产生可重放证据。
- 缺少 Framework Contract Model 证据时必须降级或阻断。
