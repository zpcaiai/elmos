---
name: b23-framework-modernization-execution-security-policy
description: "落实默认拒绝、最小权限、租户隔离、Secret、供应链、隐私和策略执行。 Scope: Framework Modernization Execution Packs."
version: 1.0.0
batch: batch-23
risk: critical
