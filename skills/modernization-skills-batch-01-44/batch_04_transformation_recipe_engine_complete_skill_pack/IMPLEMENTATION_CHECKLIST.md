...
- [ ] DSL 禁止 eval、Shell、无界循环和隐式网络。
- [ ] Last-write-wins 已从所有冲突路径禁止。
- [ ] Stale Analysis 不会被 Guard 或 Verifier 使用。
- [ ] Agent 无法修改测试、Golden、验证策略或直接提交。
- [ ] Rollback 可恢复精确 Workspace Digest。
