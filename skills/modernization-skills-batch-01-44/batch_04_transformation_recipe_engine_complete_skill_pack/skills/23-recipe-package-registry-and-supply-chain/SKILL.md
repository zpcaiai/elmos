---
name: b04-recipe-package-registry-and-supply-chain
description: "确保进入执行环境的规则包来源可信、权限最小且可撤销。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Recipe Package Registry And Supply Chain

## Objective

确保进入执行环境的规则包来源可信、权限最小且可撤销。
...
- `package-supply-chain-report.json`
- `package-certificates.json`
