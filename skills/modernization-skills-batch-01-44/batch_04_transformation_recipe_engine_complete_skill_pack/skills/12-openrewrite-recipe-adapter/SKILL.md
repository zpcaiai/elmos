---
name: b04-openrewrite-recipe-adapter
description: "把原生 OpenRewrite 结果转换为平台 PatchSet、Evidence、Journal 和 IR 失效。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Openrewrite Recipe Adapter

## Objective

把原生 OpenRewrite 结果转换为平台 PatchSet、Evidence、Journal 和 IR 失效。
...
- `openrewrite-adapter-result.json`
- `openrewrite-data-tables/`
- `translated-patch-set.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
