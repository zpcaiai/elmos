---
name: b04-transformation-rule-dsl
description: "让规则显式声明适用性、读写集、分析依赖、后置条件、验证和回滚。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
让规则显式声明适用性、读写集、分析依赖、后置条件、验证和回滚。
