---
name: b04-codemod-and-native-ast-adapter
description: "利用语言原生 AST 的生态优势，同时保持范围、类型和验证边界。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Codemod And Native Ast Adapter

## Objective

利用语言原生 AST 的生态优势，同时保持范围、类型和验证边界。
...
- `codemod-adapter-result.json`
- `codemod-patch-set.json`
