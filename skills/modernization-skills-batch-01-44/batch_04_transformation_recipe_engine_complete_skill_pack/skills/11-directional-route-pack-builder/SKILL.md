...
description: "把“Java→C#”细化为精确源目标版本、框架、运行时和工作负载路线。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Directional Route Pack Builder
