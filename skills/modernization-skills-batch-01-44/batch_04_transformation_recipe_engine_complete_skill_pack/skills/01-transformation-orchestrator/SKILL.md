---
name: b04-transformation-orchestrator
description: "把 Batch 3 IR Bundle 与方向性 Route Pack 转换为可重放、可验证、可回滚的 Signed Patch Bundle。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
把 Batch 3 IR Bundle 与方向性 Route Pack 转换为可重放、可验证、可回滚的 Signed Patch Bundle。

本 Skill 属于 **Batch 04: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine**,承担运行时原型 `orchestrator` 的职责,并由
