---
name: b04-semantic-matcher-query-and-binding
description: "生成稳定排序、可重放、可解释的 Match Set 与变量绑定。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Semantic Matcher Query And Binding

## Objective

生成稳定排序、可重放、可解释的 Match Set 与变量绑定。
