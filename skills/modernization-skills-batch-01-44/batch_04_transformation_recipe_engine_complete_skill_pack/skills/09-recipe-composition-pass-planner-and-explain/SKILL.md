---
name: b04-recipe-composition-pass-planner-and-explain
description: "根据 Requires/Provides、Read/Write、Preserves/Invalidates 和验证成本规划 Pass。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
archetype: capability-planning
risk: critical
status: implementation-ready
---

# Recipe Composition Pass Planner And Explain

## Objective

根据 Requires/Provides、Read/Write、Preserves/Invalidates 和验证成本规划 Pass。

本 Skill 属于 **Batch 04: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine**,承担运行时原型 `capability-planning` 的职责,并由
`scripts/modernization_b01_44` 中的同名执行路径实际驱动。

## Scope

- 运行时原型:`capability-planning`
