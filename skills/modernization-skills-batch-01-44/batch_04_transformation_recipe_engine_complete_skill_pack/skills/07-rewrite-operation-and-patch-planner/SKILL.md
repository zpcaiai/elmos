---
name: b04-rewrite-operation-and-patch-planner
description: "在写入前生成完整、可冲突分析、可回滚的 Patch Plan。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Rewrite Operation And Patch Planner

## Objective

在写入前生成完整、可冲突分析、可回滚的 Patch Plan。
...
- `patch-impact-report.json`
- `patch-approval-plan.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
