---
name: b04-semantic-mapping-ontology-and-registry
description: "明确 exact、conditional、wrapper、lossy、unsupported 和 unknown 关系。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Semantic Mapping Ontology And Registry

## Objective

明确 exact、conditional、wrapper、lossy、unsupported 和 unknown 关系。
...
- `mapping-conflict-register.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
