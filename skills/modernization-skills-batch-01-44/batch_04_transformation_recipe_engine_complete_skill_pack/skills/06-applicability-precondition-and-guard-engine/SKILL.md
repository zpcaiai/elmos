---
name: b04-applicability-precondition-and-guard-engine
description: "阻止版本、IR Level、动态语义、生成代码、许可证或业务风险不满足的规则。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Applicability Precondition And Guard Engine

## Objective

阻止版本、IR Level、动态语义、生成代码、许可证或业务风险不满足的规则。
...
- `applicable-match-set.json`
- `guard-review-queue.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
