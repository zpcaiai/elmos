---
name: b04-cross-file-symbol-api-and-graph-rewriter
description: "支持 Rename、Move、Signature Change、API Replacement 和 Adapter Introduction。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
archetype: integration-api
risk: critical
status: implementation-ready
---

# Cross File Symbol Api And Graph Rewriter

## Objective

支持 Rename、Move、Signature Change、API Replacement 和 Adapter Introduction。

本 Skill 属于 **Batch 04: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine**,承担运行时原型 `integration-api` 的职责,并由
`scripts/modernization_b01_44` 中的同名执行路径实际驱动。

## Scope

- 运行时原型:`integration-api`
...
- `cross-file-patch-set.json`
- `impact-radius.json`
- `dynamic-reference-risk.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
