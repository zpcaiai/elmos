---
name: b04-agent-repair-to-rule-distiller
description: "把重复局部修复沉淀为可测试、可审计的规则资产。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Agent Repair To Rule Distiller

## Objective

把重复局部修复沉淀为可测试、可审计的规则资产。
...
- `distilled-rule-candidates/`
- `distillation-corpus.json`
- `privacy-review.json`
