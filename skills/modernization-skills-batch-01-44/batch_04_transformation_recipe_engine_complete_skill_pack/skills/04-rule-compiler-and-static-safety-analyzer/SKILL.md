---
name: b04-rule-compiler-and-static-safety-analyzer
description: "在规则执行前拒绝不安全、不确定或无法界定影响范围的变换。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Rule Compiler And Static Safety Analyzer

## Objective

在规则执行前拒绝不安全、不确定或无法界定影响范围的变换。
...
- `compiled-rule-ir/`
- `rule-static-safety-report.json`
- `rule-permission-manifest.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
