---
name: b04-transformation-certification-gate
description: "通过 RC0–RC6 和 Correctness Class 清晰表达实际验证范围。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Transformation Certification Gate

## Objective

通过 RC0–RC6 和 Correctness Class 清晰表达实际验证范围。

本 Skill 属于 **Batch 04: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine**,承担运行时原型 `certification-gate` 的职责,并由
