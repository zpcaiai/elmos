---
name: b04-transformation-conflict-detector-and-resolver
description: "禁止 Last-write-wins，使用可交换性、优先级、Barrier 或人工选择。 Scope: Batch 4：跨语言语义映射、Transformation Rule DSL 与 Deterministic Recipe Engine."
version: 1.0.0
batch: batch-04
...
# Transformation Conflict Detector And Resolver

## Objective

禁止 Last-write-wins，使用可交换性、优先级、Barrier 或人工选择。
...
- `conflict-graph.json`
- `conflict-resolution-decisions.json`
- `EvidenceRefs`
- `KnownLimitations`
- `CompletionReport`
