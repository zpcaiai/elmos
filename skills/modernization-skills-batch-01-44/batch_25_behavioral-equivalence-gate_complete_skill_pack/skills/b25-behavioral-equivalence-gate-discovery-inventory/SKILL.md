---
name: b25-behavioral-equivalence-gate-discovery-inventory
description: "从源码、制品、运行、配置、文档和人工声明中发现资产，保存分母、来源和未知项。 Scope: Behavioral Equivalence Gate and Independent Oracle System."
version: 1.0.0
batch: batch-25
risk: medium
