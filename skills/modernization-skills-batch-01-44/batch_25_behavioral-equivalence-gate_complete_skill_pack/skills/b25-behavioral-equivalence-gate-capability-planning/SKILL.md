---
name: b25-behavioral-equivalence-gate-capability-planning
description: "建立能力矩阵、候选方案、约束、依赖、优先级、成本与执行计划。 Scope: Behavioral Equivalence Gate and Independent Oracle System."
version: 1.0.0
batch: batch-25
risk: high
