---
name: elmos-mainframe-native-runtime-lab
description: "Define controlled z/OS-style native execution for COBOL/PL/I/JCL/CICS/IMS/DB2 characterization and differential evidence."
version: 1.0.0
skill_id: ELMOS-POLY-266
layer: runtime-lab
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-mainframe-native-runtime-lab`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-mainframe-native-runtime-lab/model.json"
  - "semantic-assurance/elmos-mainframe-native-runtime-lab/evidence.json"
  - "semantic-assurance/elmos-mainframe-native-runtime-lab/diagnostics.json"
---

# Mainframe Native Runtime Lab

## Objective

Define controlled z/OS-style native execution for COBOL/PL/I/JCL/CICS/IMS/DB2 characterization and differential evidence.
...
- [ ] batch RC/restart fixture.
- [ ] CICS transaction fixture.
- [ ] dataset encoding fixture.
