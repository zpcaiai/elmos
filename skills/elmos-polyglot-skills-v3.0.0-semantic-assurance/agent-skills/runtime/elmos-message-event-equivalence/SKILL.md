...
triggers:
  - "Use when implementing or executing `elmos-message-event-equivalence`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-message-event-equivalence/model.json"
  - "semantic-assurance/elmos-message-event-equivalence/evidence.json"
  - "semantic-assurance/elmos-message-event-equivalence/diagnostics.json"
---

# Message & Event Equivalence

## Objective

Compare queues, topics, event envelopes, ordering, delivery semantics and deduplication outcomes.
...
- [ ] Kafka-like event fixture.
- [ ] retry duplicate fixture.
- [ ] ordering mismatch fixture.
