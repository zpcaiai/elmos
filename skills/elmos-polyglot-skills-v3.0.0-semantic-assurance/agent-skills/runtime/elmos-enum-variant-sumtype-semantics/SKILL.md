...
triggers:
  - "Use when implementing or executing `elmos-enum-variant-sumtype-semantics`."
  - "Use when a migration/certification DAG requires `type-semantics` capability."
outputs:
  - "semantic-assurance/elmos-enum-variant-sumtype-semantics/model.json"
  - "semantic-assurance/elmos-enum-variant-sumtype-semantics/evidence.json"
  - "semantic-assurance/elmos-enum-variant-sumtype-semantics/diagnostics.json"
---

# Enum, Variant & Sum-Type Semantics

## Objective

Translate enums, tagged unions, variants, discriminated unions and pattern matching while preserving exhaustiveness and representation.
...
- [ ] Rust enum↔Swift enum fixture.
- [ ] C enum ABI fixture.
- [ ] non-exhaustive target blocker.
