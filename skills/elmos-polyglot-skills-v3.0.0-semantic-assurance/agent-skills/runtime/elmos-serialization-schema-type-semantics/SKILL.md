...
version: 1.0.0
skill_id: ELMOS-POLY-196
layer: schema-semantics
risk: critical
readiness: not-run
dependencies:
  - "elmos-canonical-type-algebra"
triggers:
  - "Use when implementing or executing `elmos-serialization-schema-type-semantics`."
  - "Use when a migration/certification DAG requires `schema-semantics` capability."
outputs:
  - "semantic-assurance/elmos-serialization-schema-type-semantics/model.json"
  - "semantic-assurance/elmos-serialization-schema-type-semantics/evidence.json"
  - "semantic-assurance/elmos-serialization-schema-type-semantics/diagnostics.json"
---

# Serialization & Schema Type Semantics

## Objective

Tie in-memory types to JSON/XML/Protobuf/Avro/DB/wire schemas including defaults, unknown fields and evolution rules.
...
- [ ] JSON absent/null fixture.
- [ ] Protobuf unknown fields fixture.
- [ ] Jackson/.NET naming fixture.
