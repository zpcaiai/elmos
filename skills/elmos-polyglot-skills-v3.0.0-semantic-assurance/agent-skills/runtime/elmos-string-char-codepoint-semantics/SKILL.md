...
triggers:
  - "Use when implementing or executing `elmos-string-char-codepoint-semantics`."
  - "Use when a migration/certification DAG requires `type-semantics` capability."
outputs:
  - "semantic-assurance/elmos-string-char-codepoint-semantics/model.json"
  - "semantic-assurance/elmos-string-char-codepoint-semantics/evidence.json"
  - "semantic-assurance/elmos-string-char-codepoint-semantics/diagnostics.json"
---

# String, Character & Code Point Semantics

## Objective

Model byte strings, UTF encodings, code units, code points, graphemes and string indexing/comparison behavior.
...
- **UTF-8/16/32.**
- **code unit vs code point indexing.**
- **normalization.**
- **mutable/fixed strings.**
...
- [ ] surrogate pair fixture.
- [ ] combining character fixture.
- [ ] COBOL fixed CHAR padding fixture.
