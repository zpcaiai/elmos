...
triggers:
  - "Use when implementing or executing `elmos-os-arch-libc-matrix`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-os-arch-libc-matrix/model.json"
  - "semantic-assurance/elmos-os-arch-libc-matrix/evidence.json"
  - "semantic-assurance/elmos-os-arch-libc-matrix/diagnostics.json"
---

# OS, Architecture & libc Matrix

## Objective

Test platform-sensitive routes across OS, CPU architecture, endianness and libc/runtime implementations where semantics or ABI can differ.
...
- **Linux/Windows/macOS.**
- **x86_64/arm64/other required arch.**
- **glibc/musl/vendor libc.**
...
- [ ] ABI architecture fixture.
- [ ] unavailable platform remains not-run.
