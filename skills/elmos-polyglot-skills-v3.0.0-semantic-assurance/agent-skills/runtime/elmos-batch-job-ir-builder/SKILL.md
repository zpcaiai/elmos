---
name: elmos-batch-job-ir-builder
description: Model JCL, CL, schedulers, steps, datasets, temporary files, return-code
  branches, checkpoints, restartability and batch SLA semantics.
version: 1.0.0
skill_id: ELMOS-POLY-074
layer: ir
risk: critical
readiness: not-run
dependencies:
...
triggers:
- Use when implementing or executing `elmos-batch-job-ir-builder`.
...
# Batch Job Ir Builder

## Objective

Model JCL, CL, schedulers, steps, datasets, temporary files, return-code branches, checkpoints, restartability and batch SLA semantics.
