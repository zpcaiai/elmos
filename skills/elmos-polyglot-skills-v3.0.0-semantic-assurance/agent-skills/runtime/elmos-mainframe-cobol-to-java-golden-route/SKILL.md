---
name: elmos-mainframe-cobol-to-java-golden-route
description: 'Execute the reference route: COBOL/CICS/DB2/VSAM/JCL to Java/Spring
  Boot.'
version: 1.0.0
skill_id: ELMOS-POLY-131
...
triggers:
- Use when implementing or executing `elmos-mainframe-cobol-to-java-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-mainframe-cobol-to-java-golden-route/run.json
- routes/elmos-mainframe-cobol-to-java-golden-route/migration-plan.json
- routes/elmos-mainframe-cobol-to-java-golden-route/evidence/
---

# Mainframe Cobol To Java Golden Route

## Objective

Execute the reference route: COBOL/CICS/DB2/VSAM/JCL to Java/Spring Boot.
...
- Source: `cobol`
- Target: `java`
- Intent: COBOL/CICS/DB2/VSAM/JCL to Java/Spring Boot
