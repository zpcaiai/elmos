---
name: elmos-character-encoding-transcoder
description: Convert EBCDIC/code pages/Unicode and text-vs-binary records with reversible
  byte provenance and field-level validation.
version: 1.0.0
skill_id: ELMOS-POLY-107
...
triggers:
- Use when implementing or executing `elmos-character-encoding-transcoder`.
- Use when the migration DAG requires `data-transformation` capability.
outputs:
- transforms/elmos-character-encoding-transcoder/plan.json
- transforms/elmos-character-encoding-transcoder/semantic-loss.json
- transforms/elmos-character-encoding-transcoder/evidence.json
---
...
Convert EBCDIC/code pages/Unicode and text-vs-binary records with reversible byte provenance and field-level validation.
