---
name: elmos-rpg-in-place-modernization-route
description: 'Execute the reference route: Fixed-format RPG to free-form/modular/API-enabled
  RPG modernization.'
version: 1.0.0
skill_id: ELMOS-POLY-152
...
triggers:
- Use when implementing or executing `elmos-rpg-in-place-modernization-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-rpg-in-place-modernization-route/run.json
- routes/elmos-rpg-in-place-modernization-route/migration-plan.json
- routes/elmos-rpg-in-place-modernization-route/evidence/
---

# Rpg In Place Modernization Route

## Objective

Execute the reference route: Fixed-format RPG to free-form/modular/API-enabled RPG modernization.
...
- Source: `rpg`
- Target: `rpg`
- Intent: Fixed-format RPG to free-form/modular/API-enabled RPG modernization
