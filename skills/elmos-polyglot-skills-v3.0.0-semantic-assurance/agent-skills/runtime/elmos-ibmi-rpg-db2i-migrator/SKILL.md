---
name: elmos-ibmi-rpg-db2i-migrator
description: Transform RPG opcodes/indicators, DB2 for i record IO, DDS/SQL, CL integration
  and activation-group behavior into target services.
version: 1.0.0
skill_id: ELMOS-POLY-129
...
triggers:
- Use when implementing or executing `elmos-ibmi-rpg-db2i-migrator`.
- Use when the migration DAG requires `4gl-transformation` capability.
outputs:
- transforms/elmos-ibmi-rpg-db2i-migrator/plan.json
- transforms/elmos-ibmi-rpg-db2i-migrator/semantic-loss.json
- transforms/elmos-ibmi-rpg-db2i-migrator/evidence.json
---

# Ibmi Rpg Db2I Migrator

## Objective

Transform RPG opcodes/indicators, DB2 for i record IO, DDS/SQL, CL integration and activation-group behavior into target services.
