...
triggers:
  - "Use when implementing or executing `elmos-overload-dispatch-resolver`."
  - "Use when a migration/certification DAG requires `name-semantics` capability."
outputs:
  - "semantic-assurance/elmos-overload-dispatch-resolver/model.json"
  - "semantic-assurance/elmos-overload-dispatch-resolver/evidence.json"
  - "semantic-assurance/elmos-overload-dispatch-resolver/diagnostics.json"
---

# Overload & Dispatch Resolver

## Objective

Model overload resolution, multimethod dispatch, virtual dispatch and target-language call selection rather than translating call syntax literally.
...
- [ ] boxing/varargs resolution.
- [ ] virtual override behavior fixture.
