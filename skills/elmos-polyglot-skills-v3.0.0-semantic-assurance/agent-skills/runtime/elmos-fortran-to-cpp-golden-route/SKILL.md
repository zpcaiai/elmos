---
name: elmos-fortran-to-cpp-golden-route
description: 'Execute the reference route: Fortran numerical/HPC code to modern C++.'
version: 1.0.0
skill_id: ELMOS-POLY-148
...
triggers:
- Use when implementing or executing `elmos-fortran-to-cpp-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-fortran-to-cpp-golden-route/run.json
- routes/elmos-fortran-to-cpp-golden-route/migration-plan.json
- routes/elmos-fortran-to-cpp-golden-route/evidence/
---

# Fortran To Cpp Golden Route

## Objective

Execute the reference route: Fortran numerical/HPC code to modern C++.
...
- Source: `fortran`
- Target: `cpp`
- Intent: Fortran numerical/HPC code to modern C++
