---
name: elmos-integer-ub-language-lawyer
description: "Classify integer overflow, shifts, casts, uninitialized values and language-specific undefined/implementation-defined behavior before conversion."
version: 1.0.0
skill_id: ELMOS-POLY-224
layer: undefined-behavior
risk: critical
readiness: not-run
dependencies:
  - "elmos-numeric-type-range-overflow"
triggers:
  - "Use when implementing or executing `elmos-integer-ub-language-lawyer`."
  - "Use when a migration/certification DAG requires `undefined-behavior` capability."
outputs:
  - "semantic-assurance/elmos-integer-ub-language-lawyer/model.json"
  - "semantic-assurance/elmos-integer-ub-language-lawyer/evidence.json"
  - "semantic-assurance/elmos-integer-ub-language-lawyer/diagnostics.json"
---

# Integer & Undefined-Behavior Language Lawyer

## Objective

Classify integer overflow, shifts, casts, uninitialized values and language-specific undefined/implementation-defined behavior before conversion.
...
- **uninitialized/poison-like states.**
...
- [ ] C signed overflow fixture.
- [ ] Rust debug/release overflow fixture.
- [ ] shift edge fixture.
