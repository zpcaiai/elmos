---
name: elmos-legacy-production-certification-gate
description: Issue E0-E5-style readiness only from fresh executed evidence, with explicit
  blockers, waivers, rollback readiness and route-specific residual risk.
version: 1.0.0
skill_id: ELMOS-POLY-168
layer: certification
risk: critical
readiness: not-run
dependencies:
...
triggers:
- Use when implementing or executing `elmos-legacy-production-certification-gate`.
- Use when the migration DAG requires `certification` capability.
outputs:
- validation/elmos-legacy-production-certification-gate/result.json
- validation/elmos-legacy-production-certification-gate/evidence/
---

# Legacy Production Certification Gate

## Objective

Issue E0-E5-style readiness only from fresh executed evidence, with explicit blockers, waivers, rollback readiness and route-specific residual risk.
