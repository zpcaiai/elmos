---
name: elmos-ui-workflow-equivalence-validator
description: Replay terminal/desktop/web user journeys and compare navigation, field
  validation, authorization, errors and persistent effects.
version: 1.0.0
skill_id: ELMOS-POLY-158
layer: validation
risk: high
readiness: not-run
dependencies:
...
triggers:
- Use when implementing or executing `elmos-ui-workflow-equivalence-validator`.
- Use when the migration DAG requires `validation` capability.
outputs:
- validation/elmos-ui-workflow-equivalence-validator/result.json
- validation/elmos-ui-workflow-equivalence-validator/evidence/
---

# Ui Workflow Equivalence Validator

## Objective

Replay terminal/desktop/web user journeys and compare navigation, field validation, authorization, errors and persistent effects.
