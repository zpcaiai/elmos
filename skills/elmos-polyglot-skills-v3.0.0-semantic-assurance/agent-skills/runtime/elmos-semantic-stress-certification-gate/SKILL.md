...
triggers:
  - "Use when implementing or executing `elmos-semantic-stress-certification-gate`."
  - "Use when a migration/certification DAG requires `quality-gate` capability."
outputs:
  - "semantic-assurance/elmos-semantic-stress-certification-gate/model.json"
  - "semantic-assurance/elmos-semantic-stress-certification-gate/evidence.json"
  - "semantic-assurance/elmos-semantic-stress-certification-gate/diagnostics.json"
---

# Semantic Stress Certification Gate

## Objective

Require differential fuzzing, metamorphic/property testing, mutation strength and failure reduction thresholds appropriate to route risk before E4/E5.
...
- **fuzz duration/coverage.**
- **property pass distribution.**
- **mutation strength.**
...
- [ ] critical surviving mutant blocks.
- [ ] unreduced mismatch blocks.
- [ ] thresholds route-specific.
