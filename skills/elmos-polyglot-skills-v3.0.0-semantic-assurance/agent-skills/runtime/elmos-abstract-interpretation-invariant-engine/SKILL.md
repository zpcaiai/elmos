...
triggers:
  - "Use when implementing or executing `elmos-abstract-interpretation-invariant-engine`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-abstract-interpretation-invariant-engine/model.json"
  - "semantic-assurance/elmos-abstract-interpretation-invariant-engine/evidence.json"
  - "semantic-assurance/elmos-abstract-interpretation-invariant-engine/diagnostics.json"
---

# Abstract Interpretation & Invariant Engine

## Objective

Infer ranges, nullness, alias/effect facts and invariants that strengthen conversion safety and reduce proof/testing search space.
