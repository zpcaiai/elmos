---
name: elmos-dynamic-language-shape-inference
description: "Infer runtime object shapes, duck-typed protocols, monkey patches and dynamic call targets with confidence and observed evidence."
version: 1.0.0
skill_id: ELMOS-POLY-183
...
triggers:
  - "Use when implementing or executing `elmos-dynamic-language-shape-inference`."
  - "Use when a migration/certification DAG requires `dynamic-semantics` capability."
outputs:
  - "semantic-assurance/elmos-dynamic-language-shape-inference/model.json"
  - "semantic-assurance/elmos-dynamic-language-shape-inference/evidence.json"
  - "semantic-assurance/elmos-dynamic-language-shape-inference/diagnostics.json"
---

# Dynamic Language Shape Inference

## Objective

Infer runtime object shapes, duck-typed protocols, monkey patches and dynamic call targets with confidence and observed evidence.
...
- [ ] Python/PHP/JS dynamic shape fixture.
- [ ] monkey patch fixture.
- [ ] unobserved dynamic target remains unknown.
