...
triggers:
  - "Use when implementing or executing `elmos-smt-equivalence-prover`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-smt-equivalence-prover/model.json"
  - "semantic-assurance/elmos-smt-equivalence-prover/evidence.json"
  - "semantic-assurance/elmos-smt-equivalence-prover/diagnostics.json"
---
...
Encode bounded pure/finite semantic obligations into SMT and prove equivalence/refinement or return concrete counterexamples.
