---
name: elmos-scope-resolution-engine
description: "Resolve lexical, dynamic, imported, inherited and host-environment scopes and preserve binding identity through target generation."
version: 1.0.0
skill_id: ELMOS-POLY-179
...
triggers:
  - "Use when implementing or executing `elmos-scope-resolution-engine`."
  - "Use when a migration/certification DAG requires `name-semantics` capability."
outputs:
  - "semantic-assurance/elmos-scope-resolution-engine/model.json"
  - "semantic-assurance/elmos-scope-resolution-engine/evidence.json"
  - "semantic-assurance/elmos-scope-resolution-engine/diagnostics.json"
---

# Scope & Name Resolution Engine

## Objective

Resolve lexical, dynamic, imported, inherited and host-environment scopes and preserve binding identity through target generation.
...
- [ ] VB/PowerBuilder dynamic scope fixture.
