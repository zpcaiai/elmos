---
name: elmos-powerbuilder-datawindow-migrator
description: Decompose DataWindow SQL, binding, validation, update rules, presentation
  and events into explicit API/data/UI components.
version: 1.0.0
skill_id: ELMOS-POLY-125
...
triggers:
- Use when implementing or executing `elmos-powerbuilder-datawindow-migrator`.
- Use when the migration DAG requires `4gl-transformation` capability.
outputs:
- transforms/elmos-powerbuilder-datawindow-migrator/plan.json
- transforms/elmos-powerbuilder-datawindow-migrator/semantic-loss.json
- transforms/elmos-powerbuilder-datawindow-migrator/evidence.json
---

# Powerbuilder Datawindow Migrator

## Objective

Decompose DataWindow SQL, binding, validation, update rules, presentation and events into explicit API/data/UI components.
