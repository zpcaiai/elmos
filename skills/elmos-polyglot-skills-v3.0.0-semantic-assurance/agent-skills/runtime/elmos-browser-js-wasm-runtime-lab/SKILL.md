...
triggers:
  - "Use when implementing or executing `elmos-browser-js-wasm-runtime-lab`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-browser-js-wasm-runtime-lab/model.json"
  - "semantic-assurance/elmos-browser-js-wasm-runtime-lab/evidence.json"
  - "semantic-assurance/elmos-browser-js-wasm-runtime-lab/diagnostics.json"
---

# Browser, JavaScript & WebAssembly Runtime Lab

## Objective

Run ECMAScript/TypeScript/React/Wasm-related fixtures across major engines with conformance and portable-semantics checks.
...
- [ ] engine differential fixture.
- [ ] Wasm spec test subset.
- [ ] DOM timing normalization.
