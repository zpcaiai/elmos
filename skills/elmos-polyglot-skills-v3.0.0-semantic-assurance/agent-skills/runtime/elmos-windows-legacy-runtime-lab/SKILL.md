---
name: elmos-windows-legacy-runtime-lab
description: "Provide isolated Windows environments for VB6/COM/ActiveX/PowerBuilder/Delphi/FoxPro behavior capture and migration verification."
version: 1.0.0
skill_id: ELMOS-POLY-268
layer: runtime-lab
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-windows-legacy-runtime-lab`."
  - "Use when a migration/certification DAG requires `runtime-lab` capability."
outputs:
  - "semantic-assurance/elmos-windows-legacy-runtime-lab/model.json"
  - "semantic-assurance/elmos-windows-legacy-runtime-lab/evidence.json"
  - "semantic-assurance/elmos-windows-legacy-runtime-lab/diagnostics.json"
---

# Windows Legacy Runtime Lab

## Objective

Provide isolated Windows environments for VB6/COM/ActiveX/PowerBuilder/Delphi/FoxPro behavior capture and migration verification.
