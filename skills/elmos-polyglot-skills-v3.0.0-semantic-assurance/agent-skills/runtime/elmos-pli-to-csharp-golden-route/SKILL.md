---
name: elmos-pli-to-csharp-golden-route
description: 'Execute the reference route: PL/I mainframe applications to C#/ASP.NET
  Core.'
version: 1.0.0
skill_id: ELMOS-POLY-136
...
triggers:
- Use when implementing or executing `elmos-pli-to-csharp-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-pli-to-csharp-golden-route/run.json
- routes/elmos-pli-to-csharp-golden-route/migration-plan.json
- routes/elmos-pli-to-csharp-golden-route/evidence/
---

# Pli To Csharp Golden Route

## Objective

Execute the reference route: PL/I mainframe applications to C#/ASP.NET Core.
...
- Source: `pli`
- Target: `csharp`
- Intent: PL/I mainframe applications to C#/ASP.NET Core
