---
name: elmos-security-authority-equivalence-validator
description: Prove identities, roles, authorities, segregation-of-duties and denied
  operations are not broadened during migration.
version: 1.0.0
skill_id: ELMOS-POLY-166
layer: validation
risk: high
readiness: not-run
dependencies:
...
triggers:
- Use when implementing or executing `elmos-security-authority-equivalence-validator`.
- Use when the migration DAG requires `validation` capability.
outputs:
- validation/elmos-security-authority-equivalence-validator/result.json
- validation/elmos-security-authority-equivalence-validator/evidence/
---

# Security Authority Equivalence Validator

## Objective

Prove identities, roles, authorities, segregation-of-duties and denied operations are not broadened during migration.
