...
triggers:
  - "Use when implementing or executing `elmos-async-await-task-semantics`."
  - "Use when a migration/certification DAG requires `concurrency-semantics` capability."
outputs:
  - "semantic-assurance/elmos-async-await-task-semantics/model.json"
  - "semantic-assurance/elmos-async-await-task-semantics/evidence.json"
  - "semantic-assurance/elmos-async-await-task-semantics/diagnostics.json"
---

# Async/Await & Task Semantics

## Objective

Preserve scheduling, cancellation, continuation context, structured concurrency and error propagation across async runtimes.
...
- [ ] ConfigureAwait/event-loop fixture.
- [ ] Kotlin coroutine scope fixture.
