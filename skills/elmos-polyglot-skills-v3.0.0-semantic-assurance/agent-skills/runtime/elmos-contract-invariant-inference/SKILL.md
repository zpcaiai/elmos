...
triggers:
  - "Use when implementing or executing `elmos-contract-invariant-inference`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-contract-invariant-inference/model.json"
  - "semantic-assurance/elmos-contract-invariant-inference/evidence.json"
  - "semantic-assurance/elmos-contract-invariant-inference/diagnostics.json"
---
...
Infer candidate preconditions, postconditions and invariants from code, traces and tests while distinguishing inferred hypotheses from proven contracts.
...
- [ ] inferred not treated as proven.
- [ ] counterexample invalidates hypothesis.
