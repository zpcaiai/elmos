---
name: elmos-vbscript-to-csharp-golden-route
description: 'Execute the reference route: VBScript/Classic ASP automation and web
  code to modern .NET.'
version: 1.0.0
skill_id: ELMOS-POLY-138
layer: route-execution
risk: critical
readiness: not-run
dependencies:
- elmos-legacy-p0-orchestrator
- elmos-adapter-vbscript
...
triggers:
- Use when implementing or executing `elmos-vbscript-to-csharp-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-vbscript-to-csharp-golden-route/run.json
- routes/elmos-vbscript-to-csharp-golden-route/migration-plan.json
- routes/elmos-vbscript-to-csharp-golden-route/evidence/
---

# Vbscript To Csharp Golden Route

## Objective

Execute the reference route: VBScript/Classic ASP automation and web code to modern .NET.
...
- Source: `vbscript`
- Target: `csharp`
- Intent: VBScript/Classic ASP automation and web code to modern .NET
