---
name: elmos-preprocessor-macro-expansion-modeler
description: "Model preprocessing, include/copy expansion, macros, conditional compilation and generated-source boundaries while retaining source-to-expanded provenance."
version: 1.0.0
skill_id: ELMOS-POLY-171
...
triggers:
  - "Use when implementing or executing `elmos-preprocessor-macro-expansion-modeler`."
  - "Use when a migration/certification DAG requires `frontend-semantics` capability."
outputs:
  - "semantic-assurance/elmos-preprocessor-macro-expansion-modeler/model.json"
  - "semantic-assurance/elmos-preprocessor-macro-expansion-modeler/evidence.json"
  - "semantic-assurance/elmos-preprocessor-macro-expansion-modeler/diagnostics.json"
---

# Preprocessor & Macro Expansion Modeler

## Objective

Model preprocessing, include/copy expansion, macros, conditional compilation and generated-source boundaries while retaining source-to-expanded provenance.
...
- **macro hygiene and expansion coordinates.**
...
- [ ] nested macro/include fixture.
- [ ] conditional compilation matrix.
- [ ] round-trip source provenance across expansion.
