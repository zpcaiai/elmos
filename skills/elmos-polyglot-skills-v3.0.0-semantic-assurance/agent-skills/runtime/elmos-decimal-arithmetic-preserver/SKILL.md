---
name: elmos-decimal-arithmetic-preserver
description: Preserve packed/zoned/fixed decimal precision, rounding, overflow, scale,
  currency and financial arithmetic across target numeric models.
version: 1.0.0
skill_id: ELMOS-POLY-108
layer: semantic-transformation
risk: high
readiness: not-run
dependencies:
- elmos-semantic-loss-risk-estimator
triggers:
- Use when implementing or executing `elmos-decimal-arithmetic-preserver`.
- Use when the migration DAG requires `semantic-transformation` capability.
outputs:
- transforms/elmos-decimal-arithmetic-preserver/plan.json
- transforms/elmos-decimal-arithmetic-preserver/semantic-loss.json
- transforms/elmos-decimal-arithmetic-preserver/evidence.json
---

# Decimal Arithmetic Preserver

## Objective

Preserve packed/zoned/fixed decimal precision, rounding, overflow, scale, currency and financial arithmetic across target numeric models.
