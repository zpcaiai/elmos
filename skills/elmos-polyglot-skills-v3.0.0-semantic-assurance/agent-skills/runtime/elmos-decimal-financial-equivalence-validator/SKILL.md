---
name: elmos-decimal-financial-equivalence-validator
description: Verify decimal precision, scale, rounding, overflow and monetary results
  using high-precision or source-runtime oracles.
version: 1.0.0
skill_id: ELMOS-POLY-155
layer: validation
risk: high
readiness: not-run
dependencies:
...
triggers:
- Use when implementing or executing `elmos-decimal-financial-equivalence-validator`.
- Use when the migration DAG requires `validation` capability.
outputs:
- validation/elmos-decimal-financial-equivalence-validator/result.json
- validation/elmos-decimal-financial-equivalence-validator/evidence/
---

# Decimal Financial Equivalence Validator

## Objective

Verify decimal precision, scale, rounding, overflow and monetary results using high-precision or source-runtime oracles.
