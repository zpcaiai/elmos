---
name: elmos-dialect-version-fixture-matrix
description: "Maintain representative fixtures across language editions, vendor compilers, compatibility modes and framework/runtime versions."
version: 1.0.0
skill_id: ELMOS-POLY-254
layer: corpus
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-dialect-version-fixture-matrix`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-dialect-version-fixture-matrix/model.json"
  - "semantic-assurance/elmos-dialect-version-fixture-matrix/evidence.json"
  - "semantic-assurance/elmos-dialect-version-fixture-matrix/diagnostics.json"
---

# Dialect & Version Fixture Matrix

## Objective

Maintain representative fixtures across language editions, vendor compilers, compatibility modes and framework/runtime versions.
...
- [ ] old/current version pair.
- [ ] vendor extension fixture.
- [ ] unsupported end-of-life mode classification.
