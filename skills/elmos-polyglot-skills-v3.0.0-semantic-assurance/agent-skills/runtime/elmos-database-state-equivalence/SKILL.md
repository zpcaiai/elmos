...
triggers:
  - "Use when implementing or executing `elmos-database-state-equivalence`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-database-state-equivalence/model.json"
  - "semantic-assurance/elmos-database-state-equivalence/evidence.json"
  - "semantic-assurance/elmos-database-state-equivalence/diagnostics.json"
---
...
Compare committed database state, constraints, keys, isolation outcomes and audit effects across source and target executions.
...
- [ ] generated key normalization.
- [ ] collation-sensitive query fixture.
