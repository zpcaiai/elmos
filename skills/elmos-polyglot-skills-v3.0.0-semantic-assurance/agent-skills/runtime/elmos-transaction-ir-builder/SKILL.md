---
name: elmos-transaction-ir-builder
description: Recover transaction boundaries, commit/backout, lock scope, update tasks,
  unit-of-work, retry and idempotency semantics across legacy runtimes.
version: 1.0.0
skill_id: ELMOS-POLY-073
layer: ir
risk: critical
readiness: not-run
dependencies:
...
triggers:
- Use when implementing or executing `elmos-transaction-ir-builder`.
...
Recover transaction boundaries, commit/backout, lock scope, update tasks, unit-of-work, retry and idempotency semantics across legacy runtimes.
