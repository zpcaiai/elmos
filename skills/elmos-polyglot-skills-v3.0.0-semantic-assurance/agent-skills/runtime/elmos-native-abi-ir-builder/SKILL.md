---
name: elmos-native-abi-ir-builder
description: Capture native ABI, calling conventions, packing, symbol export, COM
  interfaces, callbacks, FFI, binary structures and cross-language ownership.
version: 1.0.0
skill_id: ELMOS-POLY-081
layer: ir
risk: critical
readiness: not-run
dependencies:
...
triggers:
- Use when implementing or executing `elmos-native-abi-ir-builder`.
...
# Native Abi Ir Builder

## Objective

Capture native ABI, calling conventions, packing, symbol export, COM interfaces, callbacks, FFI, binary structures and cross-language ownership.
