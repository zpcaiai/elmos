---
name: elmos-com-activex-ole-migrator
description: Inventory and replace/wrap COM, ActiveX, OLE Automation, type libraries,
  apartment models and registration dependencies during Windows modernization.
version: 1.0.0
skill_id: ELMOS-POLY-123
layer: windows-transformation
risk: high
readiness: not-run
dependencies:
- elmos-semantic-loss-risk-estimator
triggers:
- Use when implementing or executing `elmos-com-activex-ole-migrator`.
- Use when the migration DAG requires `windows-transformation` capability.
outputs:
- transforms/elmos-com-activex-ole-migrator/plan.json
- transforms/elmos-com-activex-ole-migrator/semantic-loss.json
- transforms/elmos-com-activex-ole-migrator/evidence.json
---

# Com Activex Ole Migrator

## Objective

Inventory and replace/wrap COM, ActiveX, OLE Automation, type libraries, apartment models and registration dependencies during Windows modernization.
