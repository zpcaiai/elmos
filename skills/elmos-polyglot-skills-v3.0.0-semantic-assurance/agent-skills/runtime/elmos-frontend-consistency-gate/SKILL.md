...
triggers:
  - "Use when implementing or executing `elmos-frontend-consistency-gate`."
  - "Use when a migration/certification DAG requires `quality-gate` capability."
outputs:
  - "semantic-assurance/elmos-frontend-consistency-gate/model.json"
  - "semantic-assurance/elmos-frontend-consistency-gate/evidence.json"
  - "semantic-assurance/elmos-frontend-consistency-gate/diagnostics.json"
---

# Frontend Fidelity & Consistency Gate

## Objective

Block transformation when grammar, CST, native AST, symbol or source-roundtrip evidence disagrees beyond declared tolerances.
...
- [ ] all frontend evidence same snapshot.
- [ ] parser disagreement blocks.
- [ ] coverage denominator test.
