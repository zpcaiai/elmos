...
triggers:
  - "Use when implementing or executing `elmos-formal-assurance-gate`."
  - "Use when a migration/certification DAG requires `quality-gate` capability."
outputs:
  - "semantic-assurance/elmos-formal-assurance-gate/model.json"
  - "semantic-assurance/elmos-formal-assurance-gate/evidence.json"
  - "semantic-assurance/elmos-formal-assurance-gate/diagnostics.json"
---

# Formal Assurance Gate

## Objective

Aggregate proof/refinement/model-checking evidence where required and combine it with runtime evidence without overclaiming unproved portions.
...
- **runtime+formal evidence composition.**
...
- [ ] unknown never pass.
- [ ] proof scope narrower than route reported.
- [ ] critical proof obligation closure.
