---
name: elmos-floating-point-equivalence-controller
description: Define route-specific floating-point tolerances, reproducibility modes,
  reduction-order controls and high-precision oracle comparisons.
version: 1.0.0
skill_id: ELMOS-POLY-121
layer: numerical-transformation
risk: high
readiness: not-run
dependencies:
- elmos-semantic-loss-risk-estimator
triggers:
- Use when implementing or executing `elmos-floating-point-equivalence-controller`.
- Use when the migration DAG requires `numerical-transformation` capability.
outputs:
- transforms/elmos-floating-point-equivalence-controller/plan.json
- transforms/elmos-floating-point-equivalence-controller/semantic-loss.json
- transforms/elmos-floating-point-equivalence-controller/evidence.json
---

# Floating Point Equivalence Controller

## Objective

Define route-specific floating-point tolerances, reproducibility modes, reduction-order controls and high-precision oracle comparisons.
