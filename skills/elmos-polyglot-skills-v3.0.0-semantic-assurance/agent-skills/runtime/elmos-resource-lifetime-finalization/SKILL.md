...
version: 1.0.0
skill_id: ELMOS-POLY-206
layer: resource-semantics
risk: critical
readiness: not-run
dependencies:
  - "elmos-exception-unwind-equivalence"
triggers:
  - "Use when implementing or executing `elmos-resource-lifetime-finalization`."
  - "Use when a migration/certification DAG requires `resource-semantics` capability."
outputs:
  - "semantic-assurance/elmos-resource-lifetime-finalization/model.json"
  - "semantic-assurance/elmos-resource-lifetime-finalization/evidence.json"
  - "semantic-assurance/elmos-resource-lifetime-finalization/diagnostics.json"
---

# Resource Lifetime & Finalization Semantics

## Objective

Preserve RAII, try-with-resources, using/defer, GC finalizers and explicit close semantics with failure-path validation.
...
- [ ] file/socket close fixture.
- [ ] RAII destructor fixture.
- [ ] finalizer-only anti-pattern blocker.
