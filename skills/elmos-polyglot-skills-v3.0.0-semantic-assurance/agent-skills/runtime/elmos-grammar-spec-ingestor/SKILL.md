---
name: elmos-grammar-spec-ingestor
description: "Ingest normative grammars, vendor dialect grammars and parser artifacts into a versioned grammar model with provenance and ambiguity records."
version: 1.0.0
skill_id: ELMOS-POLY-169
...
triggers:
  - "Use when implementing or executing `elmos-grammar-spec-ingestor`."
  - "Use when a migration/certification DAG requires `frontend-semantics` capability."
outputs:
  - "semantic-assurance/elmos-grammar-spec-ingestor/model.json"
  - "semantic-assurance/elmos-grammar-spec-ingestor/evidence.json"
  - "semantic-assurance/elmos-grammar-spec-ingestor/diagnostics.json"
---

# Grammar Specification Ingestor

## Objective

Ingest normative grammars, vendor dialect grammars and parser artifacts into a versioned grammar model with provenance and ambiguity records.
...
- **normative grammar production identity.**
- **vendor extensions and dialect gates.**
...
- [ ] grammar version pinning fixture.
- [ ] conflicting dialect grammar fixture.
- [ ] unsupported production must block or record loss.
