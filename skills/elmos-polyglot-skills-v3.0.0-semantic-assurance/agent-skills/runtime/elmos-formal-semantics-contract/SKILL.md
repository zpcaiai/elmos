...
triggers:
  - "Use when implementing or executing `elmos-formal-semantics-contract`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-formal-semantics-contract/model.json"
  - "semantic-assurance/elmos-formal-semantics-contract/evidence.json"
  - "semantic-assurance/elmos-formal-semantics-contract/diagnostics.json"
---

# Formal Semantics Contract

## Objective

Define the source/target semantic relation, observable behavior domain, undefined behavior assumptions and proof scope before applying formal methods.
...
- [ ] well-scoped theorem fixture.
- [ ] unbounded external effect rejected.
- [ ] UB precondition explicit.
