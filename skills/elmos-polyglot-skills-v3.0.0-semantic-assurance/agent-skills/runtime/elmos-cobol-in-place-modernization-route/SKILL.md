---
name: elmos-cobol-in-place-modernization-route
description: 'Execute the reference route: COBOL dialect/source modernization before
  or instead of replatforming.'
version: 1.0.0
skill_id: ELMOS-POLY-151
...
triggers:
- Use when implementing or executing `elmos-cobol-in-place-modernization-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-cobol-in-place-modernization-route/run.json
- routes/elmos-cobol-in-place-modernization-route/migration-plan.json
- routes/elmos-cobol-in-place-modernization-route/evidence/
---

# Cobol In Place Modernization Route

## Objective

Execute the reference route: COBOL dialect/source modernization before or instead of replatforming.
...
- Source: `cobol`
- Target: `cobol`
- Intent: COBOL dialect/source modernization before or instead of replatforming
