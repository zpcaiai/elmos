---
name: elmos-natural-adabas-to-java-golden-route
description: 'Execute the reference route: Natural/Adabas to Java/Spring and modern
  database.'
version: 1.0.0
skill_id: ELMOS-POLY-142
layer: route-execution
risk: critical
readiness: not-run
dependencies:
- elmos-legacy-p0-orchestrator
- elmos-adapter-natural
- elmos-adapter-java
...
triggers:
- Use when implementing or executing `elmos-natural-adabas-to-java-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-natural-adabas-to-java-golden-route/run.json
- routes/elmos-natural-adabas-to-java-golden-route/migration-plan.json
- routes/elmos-natural-adabas-to-java-golden-route/evidence/
---

# Natural Adabas To Java Golden Route

## Objective

Execute the reference route: Natural/Adabas to Java/Spring and modern database.
...
- Source: `natural`
- Target: `java`
- Intent: Natural/Adabas to Java/Spring and modern database
