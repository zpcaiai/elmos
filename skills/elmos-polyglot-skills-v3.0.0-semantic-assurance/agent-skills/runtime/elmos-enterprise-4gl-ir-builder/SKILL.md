---
name: elmos-enterprise-4gl-ir-builder
description: Model DataWindow, ABAP internal tables/Open SQL, Natural database loops,
  ABL buffers/temp-tables, FoxPro work areas and other 4GL high-level behaviors.
version: 1.0.0
skill_id: ELMOS-POLY-080
layer: ir
risk: critical
readiness: not-run
dependencies:
...
triggers:
- Use when implementing or executing `elmos-enterprise-4gl-ir-builder`.
- Use when the migration DAG requires `ir` capability.
outputs:
- enterprise-4gl-ir.json
- 4gl-semantic-loss.json
---

# Enterprise 4Gl Ir Builder

## Objective

Model DataWindow, ABAP internal tables/Open SQL, Natural database loops, ABL buffers/temp-tables, FoxPro work areas and other 4GL high-level behaviors.
