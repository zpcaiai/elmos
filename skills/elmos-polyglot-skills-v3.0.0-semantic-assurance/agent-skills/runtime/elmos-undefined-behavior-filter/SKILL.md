...
triggers:
  - "Use when implementing or executing `elmos-undefined-behavior-filter`."
  - "Use when a migration/certification DAG requires `fuzzing` capability."
outputs:
  - "semantic-assurance/elmos-undefined-behavior-filter/model.json"
  - "semantic-assurance/elmos-undefined-behavior-filter/evidence.json"
  - "semantic-assurance/elmos-undefined-behavior-filter/diagnostics.json"
---
...
Exclude or explicitly model source cases whose behavior is undefined/unspecified before treating runtime disagreement as converter failure.
...
- [ ] UB seed quarantined.
- [ ] implementation-defined seed tagged.
- [ ] defined seed preserved.
