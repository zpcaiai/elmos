---
name: elmos-powerbuilder-to-csharp-react-golden-route
description: 'Execute the reference route: PowerBuilder/DataWindow to ASP.NET Core
  plus React-compatible API/UI model.'
version: 1.0.0
skill_id: ELMOS-POLY-139
layer: route-execution
risk: critical
readiness: not-run
dependencies:
- elmos-legacy-p0-orchestrator
- elmos-adapter-powerscript
...
triggers:
- Use when implementing or executing `elmos-powerbuilder-to-csharp-react-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-powerbuilder-to-csharp-react-golden-route/run.json
- routes/elmos-powerbuilder-to-csharp-react-golden-route/migration-plan.json
- routes/elmos-powerbuilder-to-csharp-react-golden-route/evidence/
---

# Powerbuilder To Csharp React Golden Route

## Objective

Execute the reference route: PowerBuilder/DataWindow to ASP.NET Core plus React-compatible API/UI model.
...
- Source: `powerscript`
- Target: `csharp`
- Intent: PowerBuilder/DataWindow to ASP.NET Core plus React-compatible API/UI model
