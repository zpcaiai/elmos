---
name: elmos-xbase-dbf-index-migrator
description: Transform xBase/FoxPro work areas, DBF/CDX indexes, SET state, macros,
  forms and reports into explicit services/data/UI modules.
version: 1.0.0
skill_id: ELMOS-POLY-130
...
triggers:
- Use when implementing or executing `elmos-xbase-dbf-index-migrator`.
- Use when the migration DAG requires `4gl-transformation` capability.
outputs:
- transforms/elmos-xbase-dbf-index-migrator/plan.json
- transforms/elmos-xbase-dbf-index-migrator/semantic-loss.json
- transforms/elmos-xbase-dbf-index-migrator/evidence.json
---

# Xbase Dbf Index Migrator

## Objective

Transform xBase/FoxPro work areas, DBF/CDX indexes, SET state, macros, forms and reports into explicit services/data/UI modules.
