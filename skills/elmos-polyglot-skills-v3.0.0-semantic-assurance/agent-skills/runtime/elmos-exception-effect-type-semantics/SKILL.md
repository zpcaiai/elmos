...
triggers:
  - "Use when implementing or executing `elmos-exception-effect-type-semantics`."
  - "Use when a migration/certification DAG requires `effect-semantics` capability."
outputs:
  - "semantic-assurance/elmos-exception-effect-type-semantics/model.json"
  - "semantic-assurance/elmos-exception-effect-type-semantics/evidence.json"
  - "semantic-assurance/elmos-exception-effect-type-semantics/diagnostics.json"
---

# Exception & Effect Type Semantics

## Objective

Represent checked/unchecked exceptions, Result/error unions, non-local exits and typed effects as part of callable contracts.
...
- [ ] Java checked exception→Rust Result fixture.
- [ ] Swift throws fixture.
- [ ] PHP dynamic exception fixture.
