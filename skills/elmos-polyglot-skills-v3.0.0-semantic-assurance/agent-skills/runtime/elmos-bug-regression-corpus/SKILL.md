---
name: elmos-bug-regression-corpus
description: "Promote every confirmed semantic mismatch, compiler bug and production incident into a minimized permanent regression fixture."
version: 1.0.0
skill_id: ELMOS-POLY-259
layer: corpus
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-bug-regression-corpus`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-bug-regression-corpus/model.json"
  - "semantic-assurance/elmos-bug-regression-corpus/evidence.json"
  - "semantic-assurance/elmos-bug-regression-corpus/diagnostics.json"
---

# Bug & Counterexample Regression Corpus

## Objective

Promote every confirmed semantic mismatch, compiler bug and production incident into a minimized permanent regression fixture.
...
- [ ] counterexample ingestion.
- [ ] duplicate bug linking.
- [ ] fixed bug cannot regress.
