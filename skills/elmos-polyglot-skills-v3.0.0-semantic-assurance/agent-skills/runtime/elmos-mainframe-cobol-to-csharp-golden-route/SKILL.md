---
name: elmos-mainframe-cobol-to-csharp-golden-route
description: 'Execute the reference route: COBOL/CICS/DB2/VSAM/JCL to C#/ASP.NET Core.'
version: 1.0.0
skill_id: ELMOS-POLY-132
...
triggers:
- Use when implementing or executing `elmos-mainframe-cobol-to-csharp-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-mainframe-cobol-to-csharp-golden-route/run.json
- routes/elmos-mainframe-cobol-to-csharp-golden-route/migration-plan.json
- routes/elmos-mainframe-cobol-to-csharp-golden-route/evidence/
---

# Mainframe Cobol To Csharp Golden Route

## Objective

Execute the reference route: COBOL/CICS/DB2/VSAM/JCL to C#/ASP.NET Core.
...
- Source: `cobol`
- Target: `csharp`
- Intent: COBOL/CICS/DB2/VSAM/JCL to C#/ASP.NET Core
