...
triggers:
  - "Use when implementing or executing `elmos-fixture-minimizer-deduplicator`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-fixture-minimizer-deduplicator/model.json"
  - "semantic-assurance/elmos-fixture-minimizer-deduplicator/evidence.json"
  - "semantic-assurance/elmos-fixture-minimizer-deduplicator/diagnostics.json"
---

# Fixture Minimizer & Deduplicator

## Objective

Reduce failing fixtures while preserving the failure oracle and deduplicate semantically equivalent corpus items to control certification cost.
...
- [ ] reducer preserves oracle.
- [ ] coverage-aware dedupe.
