---
name: elmos-adversarial-edge-case-corpus
description: "Curate boundary and pathological programs that stress parsing, typing, UB, concurrency, numeric, encoding and reflection semantics."
version: 1.0.0
skill_id: ELMOS-POLY-255
layer: corpus
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-adversarial-edge-case-corpus`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-adversarial-edge-case-corpus/model.json"
  - "semantic-assurance/elmos-adversarial-edge-case-corpus/evidence.json"
  - "semantic-assurance/elmos-adversarial-edge-case-corpus/diagnostics.json"
---
...
Curate boundary and pathological programs that stress parsing, typing, UB, concurrency, numeric, encoding and reflection semantics.
...
- [ ] known counterexample retained.
- [ ] edge cases tagged to obligation.
- [ ] no unsafe fixture auto-executed.
