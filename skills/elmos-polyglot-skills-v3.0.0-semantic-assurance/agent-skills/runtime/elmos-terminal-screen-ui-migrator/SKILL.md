---
name: elmos-terminal-screen-ui-migrator
description: Convert BMS/MFS/DDS/Dynpro/Natural maps and terminal workflows to web/API
  UI while preserving navigation, validation and accessibility semantics.
version: 1.0.0
skill_id: ELMOS-POLY-114
...
triggers:
- Use when implementing or executing `elmos-terminal-screen-ui-migrator`.
- Use when the migration DAG requires `ui-transformation` capability.
outputs:
- transforms/elmos-terminal-screen-ui-migrator/plan.json
- transforms/elmos-terminal-screen-ui-migrator/semantic-loss.json
- transforms/elmos-terminal-screen-ui-migrator/evidence.json
---

# Terminal Screen Ui Migrator

## Objective

Convert BMS/MFS/DDS/Dynpro/Natural maps and terminal workflows to web/API UI while preserving navigation, validation and accessibility semantics.
