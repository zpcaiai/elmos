---
name: elmos-embedded-sql-routine-migrator
description: Extract and convert embedded SQL, cursors, stored procedures, triggers,
  SQL dialects and host-variable semantics into approved target data access.
version: 1.0.0
skill_id: ELMOS-POLY-111
...
triggers:
- Use when implementing or executing `elmos-embedded-sql-routine-migrator`.
- Use when the migration DAG requires `database-transformation` capability.
outputs:
- transforms/elmos-embedded-sql-routine-migrator/plan.json
- transforms/elmos-embedded-sql-routine-migrator/semantic-loss.json
- transforms/elmos-embedded-sql-routine-migrator/evidence.json
---

# Embedded Sql Routine Migrator

## Objective

Extract and convert embedded SQL, cursors, stored procedures, triggers, SQL dialects and host-variable semantics into approved target data access.
