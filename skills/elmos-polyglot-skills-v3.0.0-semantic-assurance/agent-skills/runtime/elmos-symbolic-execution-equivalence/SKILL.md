...
triggers:
  - "Use when implementing or executing `elmos-symbolic-execution-equivalence`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-symbolic-execution-equivalence/model.json"
  - "semantic-assurance/elmos-symbolic-execution-equivalence/evidence.json"
  - "semantic-assurance/elmos-symbolic-execution-equivalence/diagnostics.json"
---
...
Symbolically execute source/target paths for selected modules and compare path conditions, outputs and side effects under bounded models.
...
- [ ] branching function fixture.
- [ ] heap mutation fixture.
