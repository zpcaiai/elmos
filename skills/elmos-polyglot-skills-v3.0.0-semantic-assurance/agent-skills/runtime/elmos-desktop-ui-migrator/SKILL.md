---
name: elmos-desktop-ui-migrator
description: Transform VB6/Delphi/VFP desktop forms, event lifecycles, controls and
  resources to approved C#/web targets with workflow characterization.
version: 1.0.0
skill_id: ELMOS-POLY-124
...
triggers:
- Use when implementing or executing `elmos-desktop-ui-migrator`.
- Use when the migration DAG requires `ui-transformation` capability.
outputs:
- transforms/elmos-desktop-ui-migrator/plan.json
- transforms/elmos-desktop-ui-migrator/semantic-loss.json
- transforms/elmos-desktop-ui-migrator/evidence.json
---
...
Transform VB6/Delphi/VFP desktop forms, event lifecycles, controls and resources to approved C#/web targets with workflow characterization.
