---
name: elmos-mainframe-security-migrator
description: Translate RACF/ACF2/Top Secret/Natural/SAP/IBM i authority concepts to
  explicit IAM/RBAC/ABAC mappings without privilege broadening.
version: 1.0.0
skill_id: ELMOS-POLY-117
layer: security-transformation
risk: high
readiness: not-run
dependencies:
- elmos-semantic-loss-risk-estimator
triggers:
- Use when implementing or executing `elmos-mainframe-security-migrator`.
- Use when the migration DAG requires `security-transformation` capability.
outputs:
- transforms/elmos-mainframe-security-migrator/plan.json
- transforms/elmos-mainframe-security-migrator/semantic-loss.json
- transforms/elmos-mainframe-security-migrator/evidence.json
---

# Mainframe Security Migrator

## Objective

Translate RACF/ACF2/Top Secret/Natural/SAP/IBM i authority concepts to explicit IAM/RBAC/ABAC mappings without privilege broadening.
