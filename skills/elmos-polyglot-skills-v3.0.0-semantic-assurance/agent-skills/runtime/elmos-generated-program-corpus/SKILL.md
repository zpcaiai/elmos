...
triggers:
  - "Use when implementing or executing `elmos-generated-program-corpus`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-generated-program-corpus/model.json"
  - "semantic-assurance/elmos-generated-program-corpus/evidence.json"
  - "semantic-assurance/elmos-generated-program-corpus/diagnostics.json"
---
...
Generate semantically valid random programs and structured inputs to explore compiler/converter behavior beyond hand-authored fixtures.
...
- [ ] seed replay.
- [ ] no-UB generator profile.
- [ ] targeted feature distribution.
