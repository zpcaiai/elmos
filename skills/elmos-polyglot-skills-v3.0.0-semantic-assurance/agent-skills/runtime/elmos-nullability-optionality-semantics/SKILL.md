...
triggers:
  - "Use when implementing or executing `elmos-nullability-optionality-semantics`."
  - "Use when a migration/certification DAG requires `type-semantics` capability."
outputs:
  - "semantic-assurance/elmos-nullability-optionality-semantics/model.json"
  - "semantic-assurance/elmos-nullability-optionality-semantics/evidence.json"
  - "semantic-assurance/elmos-nullability-optionality-semantics/diagnostics.json"
---
...
Model null, undefined, optional, nullable reference/value types and null-propagation behavior explicitly.
...
- [ ] JS null/undefined fixture.
- [ ] Kotlin platform type fixture.
- [ ] C# nullable value fixture.
