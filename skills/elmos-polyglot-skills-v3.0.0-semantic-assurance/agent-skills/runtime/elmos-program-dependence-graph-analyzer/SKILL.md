---
name: elmos-program-dependence-graph-analyzer
description: "Construct control/data dependence graphs for slicing, business-rule extraction and semantic comparison across structurally different implementations."
version: 1.0.0
skill_id: ELMOS-POLY-201
layer: dataflow-semantics
risk: critical
readiness: not-run
dependencies:
  - "elmos-ssa-dataflow-lowering"
triggers:
  - "Use when implementing or executing `elmos-program-dependence-graph-analyzer`."
  - "Use when a migration/certification DAG requires `dataflow-semantics` capability."
outputs:
  - "semantic-assurance/elmos-program-dependence-graph-analyzer/model.json"
  - "semantic-assurance/elmos-program-dependence-graph-analyzer/evidence.json"
  - "semantic-assurance/elmos-program-dependence-graph-analyzer/diagnostics.json"
---

# Program Dependence Graph Analyzer

## Objective

Construct control/data dependence graphs for slicing, business-rule extraction and semantic comparison across structurally different implementations.
...
- [ ] slice-to-output fixture.
- [ ] dead-code exclusion.
- [ ] cross-language PDG alignment.
