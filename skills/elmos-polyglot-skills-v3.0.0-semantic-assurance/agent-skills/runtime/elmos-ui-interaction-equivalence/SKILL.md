---
name: elmos-ui-interaction-equivalence
description: "Compare user-visible workflows, navigation, form validation, accessibility-critical state and UI-triggered side effects across frameworks."
version: 1.0.0
skill_id: ELMOS-POLY-243
...
triggers:
  - "Use when implementing or executing `elmos-ui-interaction-equivalence`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-ui-interaction-equivalence/model.json"
  - "semantic-assurance/elmos-ui-interaction-equivalence/evidence.json"
  - "semantic-assurance/elmos-ui-interaction-equivalence/diagnostics.json"
---

# UI Interaction & State Equivalence

## Objective

Compare user-visible workflows, navigation, form validation, accessibility-critical state and UI-triggered side effects across frameworks.
...
- **navigation.**
- **validation.**
- **accessibility/user-visible output.**
...
- [ ] React↔Flutter workflow fixture.
- [ ] focus/validation fixture.
