...
triggers:
  - "Use when implementing or executing `elmos-metaprogramming-runtime-codegen-semantics`."
  - "Use when a migration/certification DAG requires `dynamic-semantics` capability."
outputs:
  - "semantic-assurance/elmos-metaprogramming-runtime-codegen-semantics/model.json"
  - "semantic-assurance/elmos-metaprogramming-runtime-codegen-semantics/evidence.json"
  - "semantic-assurance/elmos-metaprogramming-runtime-codegen-semantics/diagnostics.json"
---

# Metaprogramming & Runtime Codegen Semantics

## Objective

Model eval, macros, generated bytecode/source, expression trees and metaprogramming boundaries that cannot be assumed statically.
...
- [ ] JS eval fixture.
- [ ] C# expression tree fixture.
- [ ] Ruby/PHP-like runtime code fixture.
