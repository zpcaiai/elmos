---
name: elmos-binary-record-wire-layout-semantics
description: "Preserve fixed records, copybooks, packed fields, alignment, endian, protocol framing and exact byte-level interchange contracts."
version: 1.0.0
skill_id: ELMOS-POLY-229
layer: wire-semantics
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-binary-record-wire-layout-semantics`."
  - "Use when a migration/certification DAG requires `wire-semantics` capability."
outputs:
  - "semantic-assurance/elmos-binary-record-wire-layout-semantics/model.json"
  - "semantic-assurance/elmos-binary-record-wire-layout-semantics/evidence.json"
  - "semantic-assurance/elmos-binary-record-wire-layout-semantics/diagnostics.json"
---

# Binary Record & Wire Layout Semantics

## Objective

Preserve fixed records, copybooks, packed fields, alignment, endian, protocol framing and exact byte-level interchange contracts.
...
- [ ] COBOL copybook golden bytes.
- [ ] C packed protocol fixture.
