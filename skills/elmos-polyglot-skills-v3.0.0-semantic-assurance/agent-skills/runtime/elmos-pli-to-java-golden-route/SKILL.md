---
name: elmos-pli-to-java-golden-route
description: 'Execute the reference route: PL/I mainframe applications to Java/Spring.'
version: 1.0.0
skill_id: ELMOS-POLY-135
...
triggers:
- Use when implementing or executing `elmos-pli-to-java-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-pli-to-java-golden-route/run.json
- routes/elmos-pli-to-java-golden-route/migration-plan.json
- routes/elmos-pli-to-java-golden-route/evidence/
---

# Pli To Java Golden Route

## Objective

Execute the reference route: PL/I mainframe applications to Java/Spring.
...
- Source: `pli`
- Target: `java`
- Intent: PL/I mainframe applications to Java/Spring
