---
name: elmos-vb6-to-csharp-golden-route
description: 'Execute the reference route: VB6/COM desktop applications to C# with
  staged UI and COM replacement.'
version: 1.0.0
skill_id: ELMOS-POLY-137
...
triggers:
- Use when implementing or executing `elmos-vb6-to-csharp-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-vb6-to-csharp-golden-route/run.json
- routes/elmos-vb6-to-csharp-golden-route/migration-plan.json
- routes/elmos-vb6-to-csharp-golden-route/evidence/
---

# Vb6 To Csharp Golden Route

## Objective

Execute the reference route: VB6/COM desktop applications to C# with staged UI and COM replacement.
...
- Source: `vb6`
- Target: `csharp`
- Intent: VB6/COM desktop applications to C# with staged UI and COM replacement
