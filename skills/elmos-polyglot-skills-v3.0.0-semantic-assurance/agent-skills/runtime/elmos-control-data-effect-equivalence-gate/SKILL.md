...
triggers:
  - "Use when implementing or executing `elmos-control-data-effect-equivalence-gate`."
  - "Use when a migration/certification DAG requires `quality-gate` capability."
outputs:
  - "semantic-assurance/elmos-control-data-effect-equivalence-gate/model.json"
  - "semantic-assurance/elmos-control-data-effect-equivalence-gate/evidence.json"
  - "semantic-assurance/elmos-control-data-effect-equivalence-gate/diagnostics.json"
---

# Control/Data/Effect Equivalence Gate

## Objective

Require closed obligations for CFG, data dependencies, aliasing, effects, errors, resources, async and nondeterminism before behavioral certification.
...
- [ ] cross-language structurally-different equivalent fixture.
- [ ] effect mismatch blocker.
- [ ] unknown dynamic behavior blocker.
