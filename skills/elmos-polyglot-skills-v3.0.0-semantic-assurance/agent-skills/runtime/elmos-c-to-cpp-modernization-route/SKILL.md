---
name: elmos-c-to-cpp-modernization-route
description: 'Execute the reference route: C to modern C++ with ABI and ownership
  preservation.'
version: 1.0.0
skill_id: ELMOS-POLY-145
...
triggers:
- Use when implementing or executing `elmos-c-to-cpp-modernization-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-c-to-cpp-modernization-route/run.json
- routes/elmos-c-to-cpp-modernization-route/migration-plan.json
- routes/elmos-c-to-cpp-modernization-route/evidence/
---

# C To Cpp Modernization Route

## Objective

Execute the reference route: C to modern C++ with ABI and ownership preservation.
...
- Source: `c`
- Target: `cpp`
- Intent: C to modern C++ with ABI and ownership preservation
