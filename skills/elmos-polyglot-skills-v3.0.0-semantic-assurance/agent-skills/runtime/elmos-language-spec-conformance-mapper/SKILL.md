...
triggers:
  - "Use when implementing or executing `elmos-language-spec-conformance-mapper`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-language-spec-conformance-mapper/model.json"
  - "semantic-assurance/elmos-language-spec-conformance-mapper/evidence.json"
  - "semantic-assurance/elmos-language-spec-conformance-mapper/diagnostics.json"
---

# Language Spec Conformance Mapper

## Objective

Map normative language/runtime specification clauses and official conformance tests to ELMOS semantic features and route obligations.
...
- **spec clause IDs.**
- **official test IDs.**
- **semantic feature tags.**
- **edition/vendor applicability.**
...
- [ ] ECMAScript/Test262-style mapping fixture.
- [ ] Wasm spec test mapping fixture.
- [ ] versioned clause mapping.
