---
name: elmos-openedge-abl-migrator
description: Transform ABL buffers, temp-tables, procedures/classes, handles, transactions
  and PASOE integration to explicit modern service/data layers.
version: 1.0.0
skill_id: ELMOS-POLY-128
...
triggers:
- Use when implementing or executing `elmos-openedge-abl-migrator`.
- Use when the migration DAG requires `4gl-transformation` capability.
outputs:
- transforms/elmos-openedge-abl-migrator/plan.json
- transforms/elmos-openedge-abl-migrator/semantic-loss.json
- transforms/elmos-openedge-abl-migrator/evidence.json
---

# Openedge Abl Migrator

## Objective

Transform ABL buffers, temp-tables, procedures/classes, handles, transactions and PASOE integration to explicit modern service/data layers.
