---
name: elmos-io-environment-observable-semantics
description: "Normalize observable console, file, environment, process and network interactions for source-target comparison."
version: 1.0.0
skill_id: ELMOS-POLY-212
layer: observable-semantics
risk: critical
readiness: not-run
dependencies:
  - "elmos-side-effect-footprint-model"
triggers:
  - "Use when implementing or executing `elmos-io-environment-observable-semantics`."
  - "Use when a migration/certification DAG requires `observable-semantics` capability."
outputs:
  - "semantic-assurance/elmos-io-environment-observable-semantics/model.json"
  - "semantic-assurance/elmos-io-environment-observable-semantics/evidence.json"
  - "semantic-assurance/elmos-io-environment-observable-semantics/diagnostics.json"
---

# I/O, Filesystem & Environment Observable Semantics

## Objective

Normalize observable console, file, environment, process and network interactions for source-target comparison.
...
- [ ] exit-code fixture.
- [ ] path case/line-ending fixture.
- [ ] HTTP header/order tolerance fixture.
