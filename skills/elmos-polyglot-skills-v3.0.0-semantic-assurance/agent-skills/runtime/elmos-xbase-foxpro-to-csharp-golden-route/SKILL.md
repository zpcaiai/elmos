---
name: elmos-xbase-foxpro-to-csharp-golden-route
description: 'Execute the reference route: FoxPro/xBase DBF/forms/reports to C#/ASP.NET
  or desktop target.'
version: 1.0.0
skill_id: ELMOS-POLY-150
...
triggers:
- Use when implementing or executing `elmos-xbase-foxpro-to-csharp-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-xbase-foxpro-to-csharp-golden-route/run.json
- routes/elmos-xbase-foxpro-to-csharp-golden-route/migration-plan.json
- routes/elmos-xbase-foxpro-to-csharp-golden-route/evidence/
---

# Xbase Foxpro To Csharp Golden Route

## Objective

Execute the reference route: FoxPro/xBase DBF/forms/reports to C#/ASP.NET or desktop target.
...
- Source: `xbase`
- Target: `csharp`
- Intent: FoxPro/xBase DBF/forms/reports to C#/ASP.NET or desktop target
