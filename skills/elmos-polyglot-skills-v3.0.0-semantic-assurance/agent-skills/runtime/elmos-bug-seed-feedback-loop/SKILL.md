...
triggers:
  - "Use when implementing or executing `elmos-bug-seed-feedback-loop`."
  - "Use when a migration/certification DAG requires `continuous-improvement` capability."
outputs:
  - "semantic-assurance/elmos-bug-seed-feedback-loop/model.json"
  - "semantic-assurance/elmos-bug-seed-feedback-loop/evidence.json"
  - "semantic-assurance/elmos-bug-seed-feedback-loop/diagnostics.json"
---

# Bug Seed & Learning Feedback Loop

## Objective

Feed confirmed minimized failures into route rules, fixture corpora, mutation operators and risk models with provenance and regression guarantees.
...
- [ ] bug→fixture→rule link.
- [ ] fixed regression run.
- [ ] no model-only hidden learning claim.
