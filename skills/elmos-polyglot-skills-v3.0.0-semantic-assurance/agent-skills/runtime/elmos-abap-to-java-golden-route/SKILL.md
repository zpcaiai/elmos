---
name: elmos-abap-to-java-golden-route
description: 'Execute the reference route: ABAP business logic/integration to Java/Spring
  with SAP coexistence.'
version: 1.0.0
skill_id: ELMOS-POLY-141
...
triggers:
- Use when implementing or executing `elmos-abap-to-java-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-abap-to-java-golden-route/run.json
- routes/elmos-abap-to-java-golden-route/migration-plan.json
- routes/elmos-abap-to-java-golden-route/evidence/
---

# Abap To Java Golden Route

## Objective

Execute the reference route: ABAP business logic/integration to Java/Spring with SAP coexistence.
...
- Source: `abap`
- Target: `java`
- Intent: ABAP business logic/integration to Java/Spring with SAP coexistence
