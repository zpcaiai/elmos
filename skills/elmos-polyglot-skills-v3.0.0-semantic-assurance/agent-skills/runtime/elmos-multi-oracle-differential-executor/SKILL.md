---
name: elmos-multi-oracle-differential-executor
description: "Execute source and target under matched inputs/environments and compare multiple independent observables instead of stdout-only diffs."
version: 1.0.0
skill_id: ELMOS-POLY-236
...
triggers:
  - "Use when implementing or executing `elmos-multi-oracle-differential-executor`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-multi-oracle-differential-executor/model.json"
  - "semantic-assurance/elmos-multi-oracle-differential-executor/evidence.json"
  - "semantic-assurance/elmos-multi-oracle-differential-executor/diagnostics.json"
---
...
Execute source and target under matched inputs/environments and compare multiple independent observables instead of stdout-only diffs.
...
- [ ] matched environment fixture.
- [ ] one-oracle disagreement fixture.
- [ ] source runtime unavailable classification.
