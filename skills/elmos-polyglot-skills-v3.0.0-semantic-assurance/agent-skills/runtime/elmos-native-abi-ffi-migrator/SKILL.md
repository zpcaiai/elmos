---
name: elmos-native-abi-ffi-migrator
description: Preserve ABI/FFI/COM/native calling conventions, symbol contracts, callback
  lifetime and binary layout through wrappers or generated bindings.
version: 1.0.0
skill_id: ELMOS-POLY-119
...
triggers:
- Use when implementing or executing `elmos-native-abi-ffi-migrator`.
- Use when the migration DAG requires `systems-transformation` capability.
outputs:
- transforms/elmos-native-abi-ffi-migrator/plan.json
- transforms/elmos-native-abi-ffi-migrator/semantic-loss.json
- transforms/elmos-native-abi-ffi-migrator/evidence.json
---

# Native Abi Ffi Migrator

## Objective

Preserve ABI/FFI/COM/native calling conventions, symbol contracts, callback lifetime and binary layout through wrappers or generated bindings.
