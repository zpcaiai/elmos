...
triggers:
  - "Use when implementing or executing `elmos-metamorphic-transformation-tester`."
  - "Use when a migration/certification DAG requires `fuzzing` capability."
outputs:
  - "semantic-assurance/elmos-metamorphic-transformation-tester/model.json"
  - "semantic-assurance/elmos-metamorphic-transformation-tester/evidence.json"
  - "semantic-assurance/elmos-metamorphic-transformation-tester/diagnostics.json"
---

# Metamorphic Transformation Tester

## Objective

Apply semantics-preserving source transformations and require conversion/output relations to remain stable without needing a perfect oracle.
...
- **alpha-renaming.**
- **dead-code insertion.**
- **equivalent expression transforms.**
- **statement reordering when legal.**
...
- [ ] alpha-renaming metamorphism.
- [ ] dead-code metamorphism.
- [ ] invalid metamorphism rejected.
