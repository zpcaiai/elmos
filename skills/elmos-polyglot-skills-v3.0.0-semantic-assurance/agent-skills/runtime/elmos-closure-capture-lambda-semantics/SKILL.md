...
triggers:
  - "Use when implementing or executing `elmos-closure-capture-lambda-semantics`."
  - "Use when a migration/certification DAG requires `call-semantics` capability."
outputs:
  - "semantic-assurance/elmos-closure-capture-lambda-semantics/model.json"
  - "semantic-assurance/elmos-closure-capture-lambda-semantics/evidence.json"
  - "semantic-assurance/elmos-closure-capture-lambda-semantics/diagnostics.json"
---

# Closure Capture & Lambda Semantics

## Objective

Preserve capture-by-value/reference, receiver capture, mutable closures and escaping lifetime behavior.
...
- [ ] loop-variable capture fixture.
- [ ] C++ ref capture fixture.
- [ ] Swift escaping closure fixture.
