...
triggers:
  - "Use when implementing or executing `elmos-grammar-based-semantic-fuzzer`."
  - "Use when a migration/certification DAG requires `fuzzing` capability."
outputs:
  - "semantic-assurance/elmos-grammar-based-semantic-fuzzer/model.json"
  - "semantic-assurance/elmos-grammar-based-semantic-fuzzer/evidence.json"
  - "semantic-assurance/elmos-grammar-based-semantic-fuzzer/diagnostics.json"
---

# Grammar-Based Semantic Fuzzer

## Objective

Generate/mutate syntactically valid programs and inputs from grammar plus semantic constraints to stress parser and converter edges.
...
- [ ] valid syntax generation rate.
- [ ] target feature seed.
- [ ] crash minimization handoff.
