---
name: elmos-ibmi-rpg-to-csharp-golden-route
description: 'Execute the reference route: RPG/RPGLE/CL/DDS/DB2 for i to C#/ASP.NET
  Core.'
version: 1.0.0
skill_id: ELMOS-POLY-134
...
triggers:
- Use when implementing or executing `elmos-ibmi-rpg-to-csharp-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-ibmi-rpg-to-csharp-golden-route/run.json
- routes/elmos-ibmi-rpg-to-csharp-golden-route/migration-plan.json
- routes/elmos-ibmi-rpg-to-csharp-golden-route/evidence/
---

# Ibmi Rpg To Csharp Golden Route

## Objective

Execute the reference route: RPG/RPGLE/CL/DDS/DB2 for i to C#/ASP.NET Core.
...
- Source: `rpg`
- Target: `csharp`
- Intent: RPG/RPGLE/CL/DDS/DB2 for i to C#/ASP.NET Core
