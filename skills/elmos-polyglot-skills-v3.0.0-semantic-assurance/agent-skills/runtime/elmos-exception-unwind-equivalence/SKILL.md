---
name: elmos-exception-unwind-equivalence
description: "Preserve exception matching, stack unwinding, finally/defer/destructor behavior, retry boundaries and error translation."
version: 1.0.0
skill_id: ELMOS-POLY-205
...
triggers:
  - "Use when implementing or executing `elmos-exception-unwind-equivalence`."
  - "Use when a migration/certification DAG requires `effect-semantics` capability."
outputs:
  - "semantic-assurance/elmos-exception-unwind-equivalence/model.json"
  - "semantic-assurance/elmos-exception-unwind-equivalence/evidence.json"
  - "semantic-assurance/elmos-exception-unwind-equivalence/diagnostics.json"
---

# Exception & Unwind Equivalence

## Objective

Preserve exception matching, stack unwinding, finally/defer/destructor behavior, retry boundaries and error translation.
...
- [ ] nested try/finally fixture.
- [ ] Rust panic/drop fixture.
- [ ] C# filter fixture.
