...
triggers:
  - "Use when implementing or executing `elmos-input-domain-partitioner`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-input-domain-partitioner/model.json"
  - "semantic-assurance/elmos-input-domain-partitioner/evidence.json"
  - "semantic-assurance/elmos-input-domain-partitioner/diagnostics.json"
---
...
Partition valid, invalid, boundary, adversarial and environment-dependent inputs from source contracts and traces to drive complete equivalence tests.
...
- [ ] numeric boundary partition.
- [ ] schema invalid partition.
- [ ] state-machine sequence partition.
