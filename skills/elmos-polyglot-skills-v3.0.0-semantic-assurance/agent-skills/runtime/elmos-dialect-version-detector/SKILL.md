...
triggers:
  - "Use when implementing or executing `elmos-dialect-version-detector`."
  - "Use when a migration/certification DAG requires `frontend-semantics` capability."
outputs:
  - "semantic-assurance/elmos-dialect-version-detector/model.json"
  - "semantic-assurance/elmos-dialect-version-detector/evidence.json"
  - "semantic-assurance/elmos-dialect-version-detector/diagnostics.json"
---

# Dialect & Version Detector

## Objective

Infer language dialect, standard edition, compiler mode and vendor extensions per module instead of assuming one repository-wide syntax.
...
- **per-file/module dialect.**
- **compiler flags and compatibility modes.**
- **feature introduction/removal windows.**
- **mixed-dialect repositories.**
...
- [ ] mixed Java/JDK or C/C++ standard fixture.
- [ ] COBOL/RPG vendor dialect fixture.
- [ ] ambiguous version emits confidence and blocker.
