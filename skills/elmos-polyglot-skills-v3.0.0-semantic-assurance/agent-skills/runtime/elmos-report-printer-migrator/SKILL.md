---
name: elmos-report-printer-migrator
description: Convert printer files, VFP/PowerBuilder/legacy reports and spool workflows
  to report services/PDF/export pipelines with layout regression tests.
version: 1.0.0
skill_id: ELMOS-POLY-115
...
triggers:
- Use when implementing or executing `elmos-report-printer-migrator`.
- Use when the migration DAG requires `ui-transformation` capability.
outputs:
- transforms/elmos-report-printer-migrator/plan.json
- transforms/elmos-report-printer-migrator/semantic-loss.json
- transforms/elmos-report-printer-migrator/evidence.json
---

# Report Printer Migrator

## Objective

Convert printer files, VFP/PowerBuilder/legacy reports and spool workflows to report services/PDF/export pipelines with layout regression tests.
