---
name: elmos-actor-channel-mailbox-semantics
description: "Represent actor/channel ordering, buffering, supervision, mailbox behavior and failure propagation for distributed/concurrent conversions."
version: 1.0.0
skill_id: ELMOS-POLY-222
layer: concurrency-semantics
risk: critical
readiness: not-run
dependencies:
  - "elmos-cross-language-memory-model"
triggers:
  - "Use when implementing or executing `elmos-actor-channel-mailbox-semantics`."
  - "Use when a migration/certification DAG requires `concurrency-semantics` capability."
outputs:
  - "semantic-assurance/elmos-actor-channel-mailbox-semantics/model.json"
  - "semantic-assurance/elmos-actor-channel-mailbox-semantics/evidence.json"
  - "semantic-assurance/elmos-actor-channel-mailbox-semantics/diagnostics.json"
---

# Actor, Channel & Mailbox Semantics

## Objective

Represent actor/channel ordering, buffering, supervision, mailbox behavior and failure propagation for distributed/concurrent conversions.
...
- [ ] Go channel fixture.
- [ ] actor mailbox fixture.
- [ ] backpressure mismatch fixture.
