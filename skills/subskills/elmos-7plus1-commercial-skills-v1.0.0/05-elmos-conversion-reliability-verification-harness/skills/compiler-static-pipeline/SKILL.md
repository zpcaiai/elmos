...
description: 运行 build、lint、typecheck、static/security/architecture checks。
license: Proprietary
...
运行 build、lint、typecheck、static/security/architecture checks。
...
- [ ] required target 全部 build
- [ ] 无未处理 Critical diagnostics
