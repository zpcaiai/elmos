...
description: 生成可审计、可签名、可交付的质量证据和生产认证。
license: Proprietary
...
1. 索引 evidence artifacts
2. 校验 hash/freshness/provenance
3. 按 E-level 检查必需项
4. 汇总 residual risk/waivers
5. 签发 certificate/report
6. 支持审计导出
