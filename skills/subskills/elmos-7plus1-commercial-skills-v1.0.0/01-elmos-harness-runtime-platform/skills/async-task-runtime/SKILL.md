...
description: 支持长时间编译、测试、部署、人工审批和外部系统任务的异步完成。
license: Proprietary
...
支持长时间编译、测试、部署、人工审批和外部系统任务的异步完成。
...
1. 确定 sync/background/deferred lifecycle
2. 创建稳定 task id
3. 发布 pending 与进度
4. 支持 status/log/transcript/steer/cancel
5. 跨进程 settle
6. 恢复父任务
