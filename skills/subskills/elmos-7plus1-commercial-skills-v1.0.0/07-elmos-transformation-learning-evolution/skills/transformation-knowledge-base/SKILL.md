...
description: 沉淀可复用的语言、框架、API、类型、事务、并发、异常、安全、数据与消息转换知识。
license: Proprietary
...
沉淀可复用的语言、框架、API、类型、事务、并发、异常、安全、数据与消息转换知识。
...
1. 抽取 validated transform
2. 规范化 source/target pattern
3. 记录 invariants/applicability/versions
4. 关联 tests/evidence
5. 去重与冲突检查
6. 按 scope 发布
