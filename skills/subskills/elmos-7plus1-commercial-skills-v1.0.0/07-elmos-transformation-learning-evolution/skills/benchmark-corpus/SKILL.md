...
description: 维护可复现的项目生成、跨语言、框架现代化和前端转换基准。
license: Proprietary
...
1. 定义 case 输入/expected capabilities
2. 固定 source/target/tool versions
3. 准备 deterministic environment
4. 定义 metrics/gates
5. 划分 public/private/holdout
6. 版本化发布
