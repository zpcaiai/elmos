...
description: 根据失败签名、上下文和适用条件选择历史修复候选。
license: Proprietary
...
1. 编码 failure/context
2. 检索近邻与规则
3. 过滤 language/framework/version/scope
4. 按历史成功和副作用排序
5. 生成 top-k+confidence
6. 将结果交给 Repair Agent
