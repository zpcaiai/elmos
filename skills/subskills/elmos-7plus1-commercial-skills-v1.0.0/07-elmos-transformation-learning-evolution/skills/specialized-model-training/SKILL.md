...
description: 训练 Semantic Mapper、Gap Detector、Rule Selector、Repair Ranker、Verification Planner 等小模型。
license: Proprietary
...
训练 Semantic Mapper、Gap Detector、Rule Selector、Repair Ranker、Verification Planner 等小模型。
...
4. 离线 benchmark
5. shadow/canary
6. 监控 drift 与 rollback

## 产出

- specialized model package
- model card
- eval report
