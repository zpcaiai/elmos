...
description: 转换 Schema、ORM、SQL、事务、消息、缓存、文件、RPC、批处理与调度。
license: Proprietary
...
转换 Schema、ORM、SQL、事务、消息、缓存、文件、RPC、批处理与调度。
...
1. 抽取数据/消息不变量
2. 选择目标机制
3. 生成 schema/migration/adapter
4. 保持精度/事务/ACK/retry/idempotency
5. 生成对账与故障测试
