...
description: 把外部 benchmark 作为带来源的先验，并验证模型当前可路由。
license: Proprietary
...
把外部 benchmark 作为带来源的先验，并验证模型当前可路由。
...
1. 获取 benchmark/source/as_of
2. 解析 model id/family
3. 检查当前 model catalog
4. 检查 endpoint health/access
5. 标记可行动/仅家族证据/不可用
6. 输出 prior
