...
| 指标 | 目标 | 说明 |
| --- | --- | --- |
| Package resolution availability | 99.99% | 按请求成功解析兼容依赖图 |
| Workflow compile latency | P95 < 2s | 不含大型仓库扫描 |
| Control-plane API availability | 99.95% | 企业版目标 |
| Configuration rollback | < 60s | 自动回到 last-known-good |
| Release evidence traceability | 100% | 每个 release artifact 可追溯到证据与源版本 |
