...
- 控制面/执行面/数据面分离；生产 Agent 仅获得工作所需的最小短期令牌。
- 工作流 Hook 必须声明 side-effect class、超时、网络/路径权限和回滚函数。
- 上游依赖必须生成 SBOM、许可证清单、漏洞扫描和来源 Pin。
- 租户管理员、项目管理员、审计员、开发者、审批者分权，关键策略采用双人审批。
