...
status: proposed
summary: authoritative OpenAPI document, examples, security/error schemas, implementation comparison and compatibility report
depends_on: ["PG039", "PG040", "PG041", "PG081", "PG094", "PG106"]
capabilities:
  - workspace:read
...
# PG115 — Openapi Generator

## 1. Objective

Implement authoritative OpenAPI document, examples, security/error schemas, implementation comparison and compatibility report as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- authoritative OpenAPI document, examples, security/error schemas, implementation comparison and compatibility report.
...
3. Map stable semantic symbols and generation units to authoritative OpenAPI document, examples, security/error schemas, implementation comparison and compatibility report.
...
- Consume certified outputs from PG039, PG040, PG041, PG081, PG094, PG106.
...
- The generated result implements only the approved responsibility: authoritative OpenAPI document, examples, security/error schemas, implementation comparison and compatibility report.
