---
id: PG123
name: mock-stub-service-virtualization
version: 1.0.0
batch: 56
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: contract-valid HTTP/gRPC/event/webhook stubs, stateful scenarios, deterministic fixtures and fault injection
depends_on: ["PG115", "PG116", "PG117", "PG120"]
capabilities:
  - workspace:read
...
# PG123 — Mock Stub Service Virtualization

## 1. Objective

Implement contract-valid HTTP/gRPC/event/webhook stubs, stateful scenarios, deterministic fixtures and fault injection as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- contract-valid HTTP/gRPC/event/webhook stubs, stateful scenarios, deterministic fixtures and fault injection.
...
3. Map stable semantic symbols and generation units to contract-valid HTTP/gRPC/event/webhook stubs, stateful scenarios, deterministic fixtures and fault injection.
...
6. Generate fault profiles, contract validation report from acceptance criteria and failure scenarios.
...
- Consume certified outputs from PG115, PG116, PG117, PG120.
...
- The generated result implements only the approved responsibility: contract-valid HTTP/gRPC/event/webhook stubs, stateful scenarios, deterministic fixtures and fault injection.
