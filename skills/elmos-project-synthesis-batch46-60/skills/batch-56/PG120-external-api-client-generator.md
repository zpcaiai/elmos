---
id: PG120
name: external-api-client-generator
version: 1.0.0
batch: 56
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: typed external clients with auth references, pagination, rate limits, timeout, retry, circuit breaking and fixtures
depends_on: ["PG048", "PG049", "PG050", "PG064"]
capabilities:
  - workspace:read
...
# PG120 — External Api Client Generator

## 1. Objective

Implement typed external clients with auth references, pagination, rate limits, timeout, retry, circuit breaking and fixtures as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- typed external clients with auth references, pagination, rate limits, timeout, retry, circuit breaking and fixtures.
...
- `typed_client_sources`
- `auth/config_references`
- `resilience_policy`
- `contract_fixtures/tests`
...
3. Map stable semantic symbols and generation units to typed external clients with auth references, pagination, rate limits, timeout, retry, circuit breaking and fixtures.
...
6. Generate resilience policy, contract fixtures/tests from acceptance criteria and failure scenarios.
...
- Consume certified outputs from PG048, PG049, PG050, PG064.
...
- The generated result implements only the approved responsibility: typed external clients with auth references, pagination, rate limits, timeout, retry, circuit breaking and fixtures.
