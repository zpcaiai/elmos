---
id: PG124
name: integration-contract-registry-publisher
version: 1.0.0
batch: 56
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: governed integration registry with owner, version, visibility, consumers/providers, lifecycle and compatibility evidence
depends_on: ["PG115", "PG116", "PG117", "PG119", "PG120"]
capabilities:
  - workspace:read
...
# PG124 — Integration Contract Registry Publisher

## 1. Objective

Implement governed integration registry with owner, version, visibility, consumers/providers, lifecycle and compatibility evidence as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- governed integration registry with owner, version, visibility, consumers/providers, lifecycle and compatibility evidence.
...
- `registry_entries`
- `version/lifecycle_metadata`
- `consumer-provider_graph`
...
3. Map stable semantic symbols and generation units to governed integration registry with owner, version, visibility, consumers/providers, lifecycle and compatibility evidence.
...
6. Generate consumer-provider graph, compatibility evidence from acceptance criteria and failure scenarios.
...
- Consume certified outputs from PG115, PG116, PG117, PG119, PG120.
...
- The generated result implements only the approved responsibility: governed integration registry with owner, version, visibility, consumers/providers, lifecycle and compatibility evidence.
