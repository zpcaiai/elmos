---
id: PG113
name: relational-schema-generator
version: 1.0.0
batch: 56
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: database-neutral relational schema, ownership, keys, constraints, indexes and tenant boundaries
depends_on: ["PG035", "PG039", "PG047", "PG064"]
capabilities:
  - workspace:read
...
# PG113 — Relational Schema Generator

## 1. Objective

Implement database-neutral relational schema, ownership, keys, constraints, indexes and tenant boundaries as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- database-neutral relational schema, ownership, keys, constraints, indexes and tenant boundaries.
...
3. Map stable semantic symbols and generation units to database-neutral relational schema, ownership, keys, constraints, indexes and tenant boundaries.
...
6. Generate compatibility report, contract tests from acceptance criteria and failure scenarios.
...
- Consume certified outputs from PG035, PG039, PG047, PG064.
...
- The generated result implements only the approved responsibility: database-neutral relational schema, ownership, keys, constraints, indexes and tenant boundaries.
