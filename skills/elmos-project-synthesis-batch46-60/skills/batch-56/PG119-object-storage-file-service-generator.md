---
id: PG119
name: object-storage-file-service-generator
version: 1.0.0
batch: 56
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: object-storage adapters, secure upload/download, metadata, checksum, scanning, quarantine and lifecycle
depends_on: ["PG039", "PG050", "PG064"]
capabilities:
  - workspace:read
...
# PG119 — Object Storage File Service Generator

## 1. Objective

Implement object-storage adapters, secure upload/download, metadata, checksum, scanning, quarantine and lifecycle as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- object-storage adapters, secure upload/download, metadata, checksum, scanning, quarantine and lifecycle.
...
3. Map stable semantic symbols and generation units to object-storage adapters, secure upload/download, metadata, checksum, scanning, quarantine and lifecycle.
...
6. Generate secure transfer contracts, storage security tests from acceptance criteria and failure scenarios.
...
- Consume certified outputs from PG039, PG050, PG064.
...
- The generated result implements only the approved responsibility: object-storage adapters, secure upload/download, metadata, checksum, scanning, quarantine and lifecycle.
