---
id: PG087
name: java-test-fixture-generator
version: 1.0.0
batch: 53
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: JUnit/Testcontainers fixtures and requirement-traced unit, integration, security, messaging and architecture tests
depends_on: ["PG028", "PG042", "PG078", "PG081", "PG082", "PG083", "PG084", "PG085"]
capabilities:
  - workspace:read
...
# PG087 — Java Test Fixture Generator

## 1. Objective

Implement JUnit/Testcontainers fixtures and requirement-traced unit, integration, security, messaging and architecture tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- JUnit/Testcontainers fixtures and requirement-traced unit, integration, security, messaging and architecture tests.
...
3. Map stable semantic symbols and generation units to JUnit/Testcontainers fixtures and requirement-traced unit, integration, security, messaging and architecture tests.
...
6. Generate fixtures/factories, traceability coverage report from acceptance criteria and failure scenarios.
...
- Consume certified outputs from PG028, PG042, PG078, PG081, PG082, PG083, PG084, PG085.
...
- The generated result implements only the approved responsibility: JUnit/Testcontainers fixtures and requirement-traced unit, integration, security, messaging and architecture tests.
...
- Tests originate from acceptance criteria and negative scenarios rather than only mirroring generated implementation.
