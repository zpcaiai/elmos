---
id: PG083
name: java-jpa-jdbc-persistence-generator
version: 1.0.0
batch: 53
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: JPA, Spring Data JDBC or JDBC persistence adapters, mappings, locking and target-database tests
depends_on: ["PG035", "PG047", "PG067", "PG077", "PG113"]
capabilities:
  - workspace:read
...
# PG083 — Java Jpa Jdbc Persistence Generator

## 1. Objective

Implement JPA, Spring Data JDBC or JDBC persistence adapters, mappings, locking and target-database tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- JPA, Spring Data JDBC or JDBC persistence adapters, mappings, locking and target-database tests.
...
- `target-database_integration_tests`
...
3. Map stable semantic symbols and generation units to JPA, Spring Data JDBC or JDBC persistence adapters, mappings, locking and target-database tests.
...
6. Generate mapping configuration, target-database integration tests from acceptance criteria and failure scenarios.
...
- Target-database integration tests.
...
- Consume certified outputs from PG035, PG047, PG067, PG077, PG113.
...
- The generated result implements only the approved responsibility: JPA, Spring Data JDBC or JDBC persistence adapters, mappings, locking and target-database tests.
