---
id: PG112
name: dotnet-container-deployment-generator
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: non-root .NET images, publish mode, Compose/Kubernetes, probes and trimming/AOT compatibility policy
depends_on: ["PG053", "PG062", "PG070", "PG110"]
capabilities:
  - workspace:read
...
# PG112 — Dotnet Container Deployment Generator

## 1. Objective

Implement non-root .NET images, publish mode, Compose/Kubernetes, probes and trimming/AOT compatibility policy as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- non-root .NET images, publish mode, Compose/Kubernetes, probes and trimming/AOT compatibility policy.
...
3. Map stable semantic symbols and generation units to non-root .NET images, publish mode, Compose/Kubernetes, probes and trimming/AOT compatibility policy.
...
- Consume certified outputs from PG053, PG062, PG070, PG110.
...
- The generated result implements only the approved responsibility: non-root .NET images, publish mode, Compose/Kubernetes, probes and trimming/AOT compatibility policy.
