---
id: PG106
name: dotnet-minimal-api-controller-generator
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: ASP.NET controllers/minimal APIs, DTOs, validation, ProblemDetails, auth and OpenAPI alignment
depends_on: ["PG039", "PG040", "PG041", "PG101"]
capabilities:
  - workspace:read
...
# PG106 — Dotnet Minimal Api Controller Generator

## 1. Objective

Implement ASP.NET controllers/minimal APIs, DTOs, validation, ProblemDetails, auth and OpenAPI alignment as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- ASP.NET controllers/minimal APIs, DTOs, validation, ProblemDetails, auth and OpenAPI alignment.
...
3. Map stable semantic symbols and generation units to ASP.NET controllers/minimal APIs, DTOs, validation, ProblemDetails, auth and OpenAPI alignment.
...
- Consume certified outputs from PG039, PG040, PG041, PG101.
...
- The generated result implements only the approved responsibility: ASP.NET controllers/minimal APIs, DTOs, validation, ProblemDetails, auth and OpenAPI alignment.
