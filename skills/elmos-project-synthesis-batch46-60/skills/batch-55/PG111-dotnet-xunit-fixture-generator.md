---
id: PG111
name: dotnet-xunit-fixture-generator
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: xUnit fixtures, WebApplicationFactory, Testcontainers and traced unit/integration/architecture/security tests
depends_on: ["PG028", "PG042", "PG104", "PG105", "PG106", "PG107", "PG108", "PG109"]
capabilities:
  - workspace:read
...
# PG111 — Dotnet Xunit Fixture Generator

## 1. Objective

Implement xUnit fixtures, WebApplicationFactory, Testcontainers and traced unit/integration/architecture/security tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- xUnit fixtures, WebApplicationFactory, Testcontainers and traced unit/integration/architecture/security tests.
...
3. Map stable semantic symbols and generation units to xUnit fixtures, WebApplicationFactory, Testcontainers and traced unit/integration/architecture/security tests.
...
- Consume certified outputs from PG028, PG042, PG104, PG105, PG106, PG107, PG108, PG109.
...
- The generated result implements only the approved responsibility: xUnit fixtures, WebApplicationFactory, Testcontainers and traced unit/integration/architecture/security tests.
