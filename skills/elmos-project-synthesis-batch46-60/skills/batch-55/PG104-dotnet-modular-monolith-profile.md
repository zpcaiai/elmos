---
id: PG104
name: dotnet-modular-monolith-profile
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: enforceable .NET project/assembly module boundaries, contracts and architecture tests
depends_on: ["PG045", "PG054", "PG064", "PG101"]
capabilities:
  - workspace:read
...
# PG104 — Dotnet Modular Monolith Profile

## 1. Objective

Implement enforceable .NET project/assembly module boundaries, contracts and architecture tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- enforceable .NET project/assembly module boundaries, contracts and architecture tests.
...
3. Map stable semantic symbols and generation units to enforceable .NET project/assembly module boundaries, contracts and architecture tests.
...
- Consume certified outputs from PG045, PG054, PG064, PG101.
...
- The generated result implements only the approved responsibility: enforceable .NET project/assembly module boundaries, contracts and architecture tests.
