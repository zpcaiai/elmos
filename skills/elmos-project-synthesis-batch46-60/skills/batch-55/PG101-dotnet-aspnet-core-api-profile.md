---
id: PG101
name: dotnet-aspnet-core-api-profile
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: certified ASP.NET Core API profile with hosting, contracts, security, observability, tests and deployment
...
# PG101 — Dotnet Aspnet Core Api Profile

## 1. Objective

Implement certified ASP.NET Core API profile with hosting, contracts, security, observability, tests and deployment as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- certified ASP.NET Core API profile with hosting, contracts, security, observability, tests and deployment.
...
3. Map stable semantic symbols and generation units to certified ASP.NET Core API profile with hosting, contracts, security, observability, tests and deployment.
...
- The generated result implements only the approved responsibility: certified ASP.NET Core API profile with hosting, contracts, security, observability, tests and deployment.
