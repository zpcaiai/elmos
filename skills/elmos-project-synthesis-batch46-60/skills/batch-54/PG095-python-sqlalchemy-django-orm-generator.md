---
id: PG095
name: python-sqlalchemy-django-orm-generator
version: 1.0.0
batch: 54
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: SQLAlchemy/Django ORM persistence, session/transaction boundaries, mappings and target-database tests
depends_on: ["PG035", "PG047", "PG089", "PG090", "PG113"]
capabilities:
  - workspace:read
...
# PG095 — Python Sqlalchemy Django Orm Generator

## 1. Objective

Implement SQLAlchemy/Django ORM persistence, session/transaction boundaries, mappings and target-database tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- SQLAlchemy/Django ORM persistence, session/transaction boundaries, mappings and target-database tests.
...
3. Map stable semantic symbols and generation units to SQLAlchemy/Django ORM persistence, session/transaction boundaries, mappings and target-database tests.
...
- Consume certified outputs from PG035, PG047, PG089, PG090, PG113.
...
- The generated result implements only the approved responsibility: SQLAlchemy/Django ORM persistence, session/transaction boundaries, mappings and target-database tests.
