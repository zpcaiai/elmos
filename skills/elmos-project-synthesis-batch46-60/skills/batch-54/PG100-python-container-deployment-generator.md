---
id: PG100
name: python-container-deployment-generator
version: 1.0.0
batch: 54
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: non-root Python production container, process model, Compose, Kubernetes, probes and locked install
depends_on: ["PG053", "PG062", "PG070", "PG098"]
capabilities:
  - workspace:read
...
# PG100 — Python Container Deployment Generator

## 1. Objective

Implement non-root Python production container, process model, Compose, Kubernetes, probes and locked install as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- non-root Python production container, process model, Compose, Kubernetes, probes and locked install.
...
3. Map stable semantic symbols and generation units to non-root Python production container, process model, Compose, Kubernetes, probes and locked install.
...
- Consume certified outputs from PG053, PG062, PG070, PG098.
...
- The generated result implements only the approved responsibility: non-root Python production container, process model, Compose, Kubernetes, probes and locked install.
