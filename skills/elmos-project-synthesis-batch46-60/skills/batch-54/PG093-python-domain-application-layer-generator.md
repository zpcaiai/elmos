---
id: PG093
name: python-domain-application-layer-generator
version: 1.0.0
batch: 54
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: typed framework-independent Python domain/application layers, protocols, invariants and tests
depends_on: ["PG035", "PG037", "PG067", "PG072", "PG089"]
capabilities:
  - workspace:read
...
# PG093 — Python Domain Application Layer Generator

## 1. Objective

Implement typed framework-independent Python domain/application layers, protocols, invariants and tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- typed framework-independent Python domain/application layers, protocols, invariants and tests.
...
3. Map stable semantic symbols and generation units to typed framework-independent Python domain/application layers, protocols, invariants and tests.
...
- Consume certified outputs from PG035, PG037, PG067, PG072, PG089.
...
- The generated result implements only the approved responsibility: typed framework-independent Python domain/application layers, protocols, invariants and tests.
