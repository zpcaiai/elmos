---
id: PG092
name: python-data-ai-service-profile
version: 1.0.0
batch: 54
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: data, inference, RAG and agent backend profile with model/prompt/tool versioning, safety and eval hooks
depends_on: ["PG050", "PG057", "PG064"]
capabilities:
  - workspace:read
...
# PG092 — Python Data Ai Service Profile

## 1. Objective

Implement data, inference, RAG and agent backend profile with model/prompt/tool versioning, safety and eval hooks as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- data, inference, RAG and agent backend profile with model/prompt/tool versioning, safety and eval hooks.
...
3. Map stable semantic symbols and generation units to data, inference, RAG and agent backend profile with model/prompt/tool versioning, safety and eval hooks.
...
- Consume certified outputs from PG050, PG057, PG064.
...
- The generated result implements only the approved responsibility: data, inference, RAG and agent backend profile with model/prompt/tool versioning, safety and eval hooks.
