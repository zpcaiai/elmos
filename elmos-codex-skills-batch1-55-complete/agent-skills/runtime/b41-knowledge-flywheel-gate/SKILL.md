---
name: b41-knowledge-flywheel-gate
description: "Implement and verify Batch 41 Skill 1412 for knowledge flywheel gate. Use when work requires Batch 41知识飞轮质量门禁, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-knowledge-flywheel-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 41知识飞轮质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-knowledge-flywheel-gate`
