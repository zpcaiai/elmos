---
name: invoice-document-en16931-peppol-credit-note-delivery-an-071e632b
description: "Implement legal invoice documents, numbering, EN 16931 and Peppol profiles, local CIUS, credit/debit notes, delivery, responses, acceptance, migration and document evidence."
---
...
Implement legal invoice documents, numbering, EN 16931 and Peppol profiles, local CIUS, credit/debit notes, delivery, responses, acceptance, migration and document evidence.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/invoice-document-en16931-peppol-credit-note-delivery-and-acceptance-baseline.md`.
...
```text
invoice_document_en16931_peppol_credit_note_delivery_and_acceptance_manifest.json
invoice_document_en16931_peppol_credit_note_delivery_and_acceptance_decision.json
invoice_document_en16931_peppol_credit_note_delivery_and_acceptance_reconciliation.json
invoice_document_en16931_peppol_credit_note_delivery_and_acceptance_evidence.json
```
...
```text
issuedInvoiceIsImmutable
creditNoteReferencesOriginalInvoice
deliveryDoesNotEqualAcceptance
creditOverrideRequiresApprovalAndExpiry
writeoffPreservesReceivable
creditScoreIsNotSoleDecision
