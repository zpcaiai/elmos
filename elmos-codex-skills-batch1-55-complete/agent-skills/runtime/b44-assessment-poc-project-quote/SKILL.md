---
name: b44-assessment-poc-project-quote
description: "Implement and verify Batch 44 Skill 1466 for assessment poc project quote. Use when work requires Assessment、POC和正式项目报价, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Assessment、POC和正式项目报价
...
## Skill 1466: Assessment、POC和正式项目报价
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-assessment-poc-project-quote`.
...
4. Implement the smallest production-shaped capability that exercises `Assessment、POC和正式项目报价` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-assessment-poc-project-quote`
