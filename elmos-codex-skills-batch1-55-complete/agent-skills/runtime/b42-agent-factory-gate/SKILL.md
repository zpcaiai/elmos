---
name: b42-agent-factory-gate
description: "Implement and verify Batch 42 Skill 1434 for agent factory gate. Use when work requires Batch 42成熟Agent工厂质量门禁, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Batch 42成熟Agent工厂质量门禁
...
## Skill 1434: Batch 42成熟Agent工厂质量门禁
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b42-agent-factory-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 42成熟Agent工厂质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b42-agent-factory-gate`
