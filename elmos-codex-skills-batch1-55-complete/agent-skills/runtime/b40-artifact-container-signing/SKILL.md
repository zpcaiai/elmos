...
description: "Implement and verify Batch 40 Skill 1382 for artifact container signing. Use when work requires Artifact和Container签名, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Artifact和Container签名
...
## Skill 1382: Artifact和Container签名
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-artifact-container-signing`.
...
4. Implement the smallest production-shaped capability that exercises `Artifact和Container签名` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-artifact-container-signing`
