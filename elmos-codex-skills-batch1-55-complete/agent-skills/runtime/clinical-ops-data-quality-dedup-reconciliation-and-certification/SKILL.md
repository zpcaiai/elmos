---
name: clinical-ops-data-quality-dedup-reconciliation-and-certification
description: "Implement Batch 52A Clinical Operations、Patient Flow与Care Coordination quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Patient、Encounter、Appointment、Bed、Care Plan、Task、Referral、Observation、Discharge与Care Team."
---

# Clinical Ops Data Quality Dedup Reconciliation And Certification

## Objective

Implement Batch 52A Clinical Operations、Patient Flow与Care Coordination quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Patient、Encounter、Appointment、Bed、Care Plan、Task、Referral、Observation、Discharge与Care Team.
...
5. Write unresolved domain assumptions to `docs/implementation/clinical-ops-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
clinical_ops_data_quality_dedup_reconciliation_and_certification_manifest.json
clinical_ops_data_quality_dedup_reconciliation_and_certification_state.json
clinical_ops_data_quality_dedup_reconciliation_and_certification_decision.json
clinical_ops_data_quality_dedup_reconciliation_and_certification_reconciliation.json
clinical_ops_data_quality_dedup_reconciliation_and_certification_evidence.json
```
