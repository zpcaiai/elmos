---
name: data-platform-data-quality-dedup-reconciliation-and-cer-8cbba335
description: "Implement Batch 44A Enterprise Data Platform、Lakehouse与Data Products quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Data Source、Dataset、Table、Stream、Data Product、Pipeline、Contract、Storage、Compute与Serving."
---
...
Implement Batch 44A Enterprise Data Platform、Lakehouse与Data Products quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Data Source、Dataset、Table、Stream、Data Product、Pipeline、Contract、Storage、Compute与Serving.
...
5. Write unresolved domain assumptions to `docs/implementation/data-platform-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
data_platform_data_quality_dedup_reconciliation_and_certification_manifest.json
data_platform_data_quality_dedup_reconciliation_and_certification_state.json
data_platform_data_quality_dedup_reconciliation_and_certification_decision.json
data_platform_data_quality_dedup_reconciliation_and_certification_reconciliation.json
data_platform_data_quality_dedup_reconciliation_and_certification_evidence.json
```
