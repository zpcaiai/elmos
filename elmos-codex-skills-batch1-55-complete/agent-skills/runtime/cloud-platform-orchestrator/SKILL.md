---
name: cloud-platform-orchestrator
description: "Implement Batch 49A Cloud Platform Engineering、Landing Zones与Developer Platform end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Cloud Account、Subscription、Landing Zone、Project、Environment、Template、Policy、Developer Portal与Golden Path."
---
...
Implement Batch 49A Cloud Platform Engineering、Landing Zones与Developer Platform end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Cloud Account、Subscription、Landing Zone、Project、Environment、Template、Policy、Developer Portal与Golden Path.
...
5. Write unresolved domain assumptions to `docs/implementation/cloud-platform-orchestrator-baseline.md`.
...
```text
cloud_platform_orchestrator_manifest.json
cloud_platform_orchestrator_state.json
cloud_platform_orchestrator_decision.json
cloud_platform_orchestrator_reconciliation.json
cloud_platform_orchestrator_evidence.json
```
