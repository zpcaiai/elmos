---
name: b40-runner-update-supply-chain
description: "Implement and verify Batch 40 Skill 1385 for runner update supply chain. Use when work requires Runner和Update供应链安全, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-runner-update-supply-chain`.
...
4. Implement the smallest production-shaped capability that exercises `Runner和Update供应链安全` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-runner-update-supply-chain`
