---
name: lastmile-delivery-workflow-orchestration-assignment-esc-ef06048e
description: "Implement Batch 51B Warehouse、Last-mile、Delivery与Returns workflow orchestration, queues, ownership, assignments, escalation, retries, compensation and recovery, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return."
---

# Lastmile Delivery Workflow Orchestration Assignment Escalation And Recovery

## Objective

Implement Batch 51B Warehouse、Last-mile、Delivery与Returns workflow orchestration, queues, ownership, assignments, escalation, retries, compensation and recovery, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return.
...
5. Write unresolved domain assumptions to `docs/implementation/lastmile-delivery-workflow-orchestration-assignment-escalation-and-recovery-baseline.md`.
...
```text
lastmile_delivery_workflow_orchestration_assignment_escalation_and_recovery_manifest.json
lastmile_delivery_workflow_orchestration_assignment_escalation_and_recovery_state.json
lastmile_delivery_workflow_orchestration_assignment_escalation_and_recovery_decision.json
lastmile_delivery_workflow_orchestration_assignment_escalation_and_recovery_reconciliation.json
lastmile_delivery_workflow_orchestration_assignment_escalation_and_recovery_evidence.json
```
