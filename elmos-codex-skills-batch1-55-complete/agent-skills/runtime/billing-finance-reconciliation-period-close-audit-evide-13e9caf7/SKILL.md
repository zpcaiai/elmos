---
name: billing-finance-reconciliation-period-close-audit-evide-13e9caf7
description: "Implement reconciliations from usage to GL, period-close checklists, subledger certification, variance explanations, audit evidence, disclosures and financial reporting."
---
...
Implement reconciliations from usage to GL, period-close checklists, subledger certification, variance explanations, audit evidence, disclosures and financial reporting.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/billing-finance-reconciliation-period-close-audit-evidence-and-reporting-baseline.md`.
...
```text
billing_finance_reconciliation_period_close_audit_evidence_and_reporting_manifest.json
billing_finance_reconciliation_period_close_audit_evidence_and_reporting_decision.json
billing_finance_reconciliation_period_close_audit_evidence_and_reporting_reconciliation.json
billing_finance_reconciliation_period_close_audit_evidence_and_reporting_evidence.json
```
...
```text
usageToGlChainReconciles
unknownDifferenceBlocksClose
restatementCreatesNewSnapshot
