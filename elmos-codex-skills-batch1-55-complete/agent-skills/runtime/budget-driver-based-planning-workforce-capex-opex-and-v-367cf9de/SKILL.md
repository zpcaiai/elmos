---
name: budget-driver-based-planning-workforce-capex-opex-and-v-367cf9de
description: "Implement annual and multi-year budgets, operating drivers, workforce, capacity, capex, opex, cash, approvals, locks and version control."
---
...
Implement annual and multi-year budgets, operating drivers, workforce, capacity, capex, opex, cash, approvals, locks and version control.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/budget-driver-based-planning-workforce-capex-opex-and-version-control-baseline.md`.
...
```text
budget_driver_based_planning_workforce_capex_opex_and_version_control_manifest.json
budget_driver_based_planning_workforce_capex_opex_and_version_control_decision.json
budget_driver_based_planning_workforce_capex_opex_and_version_control_reconciliation.json
budget_driver_based_planning_workforce_capex_opex_and_version_control_evidence.json
```
...
```text
approvedBudgetIsImmutable
budgetPreservesDrivers
reopenRequiresApproval
