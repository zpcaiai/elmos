---
name: bi-semantic-workflow-orchestration-assignment-escalatio-5eadcef7
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence workflow orchestration, queues, ownership, assignments, escalation, retries, compensation and recovery, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence workflow orchestration, queues, ownership, assignments, escalation, retries, compensation and recovery, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-workflow-orchestration-assignment-escalation-and-recovery-baseline.md`.
...
```text
bi_semantic_workflow_orchestration_assignment_escalation_and_recovery_manifest.json
bi_semantic_workflow_orchestration_assignment_escalation_and_recovery_state.json
bi_semantic_workflow_orchestration_assignment_escalation_and_recovery_decision.json
bi_semantic_workflow_orchestration_assignment_escalation_and_recovery_reconciliation.json
bi_semantic_workflow_orchestration_assignment_escalation_and_recovery_evidence.json
```
