---
name: checkpointable-task-download-build-test-agent-and-uploa-cda1a0f8
description: "Implement task-specific resume providers for Git/LFS/dependency downloads, phased builds, test shards, OpenRewrite, agents, reports, uploads, and side-effect reconciliation."
---
...
Implement task-specific resume providers for Git/LFS/dependency downloads, phased builds, test shards, OpenRewrite, agents, reports, uploads, and side-effect reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/checkpointable-task-download-build-test-agent-and-upload-resume-providers-baseline.md`.
...
```text
checkpointable_task_download_build_test_agent_and_upload_resume_providers_manifest.json
checkpointable_task_download_build_test_agent_and_upload_resume_providers_decision.json
checkpointable_task_download_build_test_agent_and_upload_resume_providers_evidence.json
```
