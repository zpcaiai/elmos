---
name: rego-cedar-cel-policy-authoring-lint-test-simulation-an-26eee7a6
description: "Implement Rego, Cedar and CEL authoring, schemas, lint, compilation, unit/mutation tests, coverage, simulations, impact comparisons, and partial evaluation."
---
...
Implement Rego, Cedar and CEL authoring, schemas, lint, compilation, unit/mutation tests, coverage, simulations, impact comparisons, and partial evaluation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/rego-cedar-cel-policy-authoring-lint-test-simulation-and-partial-evaluation-baseline.md`.
...
```text
rego_cedar_cel_policy_authoring_lint_test_simulation_and_partial_evaluation_manifest.json
rego_cedar_cel_policy_authoring_lint_test_simulation_and_partial_evaluation_decision.json
rego_cedar_cel_policy_authoring_lint_test_simulation_and_partial_evaluation_evidence.json
```
