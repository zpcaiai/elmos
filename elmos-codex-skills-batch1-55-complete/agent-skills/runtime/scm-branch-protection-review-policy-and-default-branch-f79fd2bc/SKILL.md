---
name: scm-branch-protection-review-policy-and-default-branch-f79fd2bc
description: "Normalize default branches, protected branches, approval requirements, review policies, merge strategies, status checks, and governance differences."
---
...
Normalize default branches, protected branches, approval requirements, review policies, merge strategies, status checks, and governance differences.

This Skill belongs to **Batch 35B** and must extend the approved ELMOS domain rather than create parallel Tenant, Identity, Artifact, Policy, Workflow, Audit, Contract or Finding aggregates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/scm-branch-protection-review-policy-and-default-branch-normalization-baseline.md`.
...
```text
scm_branch_protection_review_policy_and_default_branch_normalization_manifest.json
scm_branch_protection_review_policy_and_default_branch_normalization_decision.json
scm_branch_protection_review_policy_and_default_branch_normalization_evidence.json
```
