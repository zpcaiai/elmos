---
name: talent-development-security-privacy-quality-performance-0ece1829
description: "Implement Batch 43B Talent Acquisition、Learning、Performance与Succession security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Candidate、Requisition、Interview、Offer、Learning、Skill、Goal、Review、Talent Pool与Succession."
---
...
Implement Batch 43B Talent Acquisition、Learning、Performance与Succession security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Candidate、Requisition、Interview、Offer、Learning、Skill、Goal、Review、Talent Pool与Succession.
...
Implement the domain model, lifecycle, APIs, events, workflows, policy controls, provider adapters, evidence, analytics, operations and release gates required for **Batch 43B: Talent Acquisition、Learning、Performance与Succession**.

Theme:

```text
Candidate、Requisition、Interview、Offer、Learning、Skill、Goal、Review、Talent Pool与Succession
```
...
5. Write unresolved domain assumptions to `docs/implementation/talent-development-security-privacy-quality-performance-chaos-and-release-gates-baseline.md`.

## Required Capabilities

- Implement Candidate、Requisition、Interview、Offer、Learning、Skill、Goal、Review、Talent Pool与Succession without weakening earlier identity, evidence, policy, finance, privacy or tenant-isolation controls.
...
```text
recruit→select→offer→onboard→learn→perform→develop→succession
```
...
```text
talent_development_security_privacy_quality_performance_chaos_and_release_gates_manifest.json
talent_development_security_privacy_quality_performance_chaos_and_release_gates_state.json
talent_development_security_privacy_quality_performance_chaos_and_release_gates_decision.json
talent_development_security_privacy_quality_performance_chaos_and_release_gates_reconciliation.json
talent_development_security_privacy_quality_performance_chaos_and_release_gates_evidence.json
```
...
- Candidate Consent受控
- Interview Evidence与Decision分离
- 培训完成不等于能力
- 绩效评价可申诉
- Succession建议需Human Review
...
```text
candidateIdentityIsStable
candidateLifecycleIsVersioned
jobRequisitionIdentityIsStable
jobRequisitionLifecycleIsVersioned
interviewIdentityIsStable
interviewLifecycleIsVersioned
offerIdentityIsStable
offerLifecycleIsVersioned
