---
name: b39-oncall-follow-the-sun
description: "Implement and verify Batch 39 Skill 1358 for oncall follow the sun. Use when work requires On-call、Escalation和Follow-the-sun, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# On-call、Escalation和Follow-the-sun
...
## Skill 1358: On-call、Escalation和Follow-the-sun
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-oncall-follow-the-sun`.
...
4. Implement the smallest production-shaped capability that exercises `On-call、Escalation和Follow-the-sun` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-oncall-follow-the-sun`
