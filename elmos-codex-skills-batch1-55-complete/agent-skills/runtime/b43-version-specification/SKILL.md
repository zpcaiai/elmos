---
name: b43-version-specification
description: "Implement and verify Batch 43 Skill 1436 for version specification. Use when work requires 产品、协议和Artifact版本规范, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-version-specification`.
...
4. Implement the smallest production-shaped capability that exercises `产品、协议和Artifact版本规范` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-version-specification`
