---
name: marketing-growth-data-quality-dedup-reconciliation-and-312b5bfa
description: "Implement Batch 40B Marketing、Growth与Customer Engagement quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Campaign、Audience、Journey、Attribution、Experiment、Content、Lifecycle Messaging、Consent Activation与Marketing Operations."
---
...
Implement Batch 40B Marketing、Growth与Customer Engagement quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Campaign、Audience、Journey、Attribution、Experiment、Content、Lifecycle Messaging、Consent Activation与Marketing Operations.
...
5. Write unresolved domain assumptions to `docs/implementation/marketing-growth-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
marketing_growth_data_quality_dedup_reconciliation_and_certification_manifest.json
marketing_growth_data_quality_dedup_reconciliation_and_certification_state.json
marketing_growth_data_quality_dedup_reconciliation_and_certification_decision.json
marketing_growth_data_quality_dedup_reconciliation_and_certification_reconciliation.json
marketing_growth_data_quality_dedup_reconciliation_and_certification_evidence.json
```
