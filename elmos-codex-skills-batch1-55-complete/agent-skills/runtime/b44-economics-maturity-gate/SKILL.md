---
name: b44-economics-maturity-gate
description: "Implement and verify Batch 44 Skill 1474 for economics maturity gate. Use when work requires Batch 44经济性成熟门禁, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-economics-maturity-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 44经济性成熟门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-economics-maturity-gate`
