---
name: b38-customer-vpc-edition
description: "Implement and verify Batch 38 Skill 1330 for customer vpc edition. Use when work requires Customer VPC Edition, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Customer VPC Edition
...
## Skill 1330: Customer VPC Edition
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-customer-vpc-edition`.
...
4. Implement the smallest production-shaped capability that exercises `Customer VPC Edition` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-customer-vpc-edition`
