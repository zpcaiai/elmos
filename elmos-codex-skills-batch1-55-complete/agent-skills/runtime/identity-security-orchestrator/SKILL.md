---
name: identity-security-orchestrator
description: "Implement Batch 48B Identity Security、PAM、Secrets、PKI与Zero Trust end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Identity、Privileged Account、Secret、Certificate、Key、Session、Access Request、Device Trust与Policy."
---

# Identity Security Orchestrator

## Objective

Implement Batch 48B Identity Security、PAM、Secrets、PKI与Zero Trust end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Identity、Privileged Account、Secret、Certificate、Key、Session、Access Request、Device Trust与Policy.
...
5. Write unresolved domain assumptions to `docs/implementation/identity-security-orchestrator-baseline.md`.
...
```text
identity_security_orchestrator_manifest.json
identity_security_orchestrator_state.json
identity_security_orchestrator_decision.json
identity_security_orchestrator_reconciliation.json
identity_security_orchestrator_evidence.json
```
