---
name: b39-enterprise-support-sla
description: "Implement and verify Batch 39 Skill 1360 for enterprise support sla. Use when work requires 企业支持分层和SLA, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-enterprise-support-sla`.
...
4. Implement the smallest production-shaped capability that exercises `企业支持分层和SLA` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-enterprise-support-sla`
