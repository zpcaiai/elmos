---
name: agentic-runtime-analytics-kpi-scoring-forecast-and-diagnostics
description: "Implement Batch 45B Agentic AI Runtime、Orchestration、Memory、Tools与Evals semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Agent、Workflow、Tool、Memory、Context、Plan、Execution、Guardrail、Evaluation与Human Handoff."
---
...
Implement Batch 45B Agentic AI Runtime、Orchestration、Memory、Tools与Evals semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Agent、Workflow、Tool、Memory、Context、Plan、Execution、Guardrail、Evaluation与Human Handoff.
...
5. Write unresolved domain assumptions to `docs/implementation/agentic-runtime-analytics-kpi-scoring-forecast-and-diagnostics-baseline.md`.
...
```text
agentic_runtime_analytics_kpi_scoring_forecast_and_diagnostics_manifest.json
agentic_runtime_analytics_kpi_scoring_forecast_and_diagnostics_state.json
agentic_runtime_analytics_kpi_scoring_forecast_and_diagnostics_decision.json
agentic_runtime_analytics_kpi_scoring_forecast_and_diagnostics_reconciliation.json
agentic_runtime_analytics_kpi_scoring_forecast_and_diagnostics_evidence.json
```
