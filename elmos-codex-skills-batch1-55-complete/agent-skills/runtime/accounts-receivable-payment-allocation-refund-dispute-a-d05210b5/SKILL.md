---
name: accounts-receivable-payment-allocation-refund-dispute-a-d05210b5
description: "Implement receivables, payments, allocations, refunds, chargebacks, disputes, unapplied cash, dunning, promises to pay, statements and reconciliation."
---
...
Implement receivables, payments, allocations, refunds, chargebacks, disputes, unapplied cash, dunning, promises to pay, statements and reconciliation.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/accounts-receivable-payment-allocation-refund-dispute-and-dunning-baseline.md`.
...
```text
accounts_receivable_payment_allocation_refund_dispute_and_dunning_manifest.json
accounts_receivable_payment_allocation_refund_dispute_and_dunning_decision.json
accounts_receivable_payment_allocation_refund_dispute_and_dunning_reconciliation.json
accounts_receivable_payment_allocation_refund_dispute_and_dunning_evidence.json
```
...
```text
paymentDoesNotModifyInvoice
allocationPreservesPayment
unappliedCashIsNotRevenue
paymentIntentIsImmutable
unknownResultDoesNotBlindlyRetry
oneIntentCannotDuplicateSettlement
refundCannotExceedAvailableAmount
refundAndChargebackRemainDistinct
