---
name: b14-composite-migration-planning-dependency-waves-co-se-f1b04e74
description: "Implement security privacy and tenant isolation for Batch 14: Composite Migration Planning、Dependency Waves与Coexistence Governance."
---
...
Apply this Skill to **Batch 14: Composite Migration Planning、Dependency Waves与Coexistence Governance**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `14`
- Domain: `Composite Migration Planning、Dependency Waves与Coexistence Governance`
...
2. Resolve Batch 14 dependencies and verify prerequisite gates.
...
- dependency waves preserve coexistence contracts.
- dual write/read has reconciliation.
- migration sequencing is evidence-backed.
