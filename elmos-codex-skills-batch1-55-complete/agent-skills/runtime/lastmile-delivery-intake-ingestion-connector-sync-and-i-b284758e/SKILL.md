---
name: lastmile-delivery-intake-ingestion-connector-sync-and-i-b284758e
description: "Implement Batch 51B Warehouse、Last-mile、Delivery与Returns intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return."
---

# Lastmile Delivery Intake Ingestion Connector Sync And Idempotency

## Objective

Implement Batch 51B Warehouse、Last-mile、Delivery与Returns intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return.
...
5. Write unresolved domain assumptions to `docs/implementation/lastmile-delivery-intake-ingestion-connector-sync-and-idempotency-baseline.md`.
...
```text
lastmile_delivery_intake_ingestion_connector_sync_and_idempotency_manifest.json
lastmile_delivery_intake_ingestion_connector_sync_and_idempotency_state.json
lastmile_delivery_intake_ingestion_connector_sync_and_idempotency_decision.json
lastmile_delivery_intake_ingestion_connector_sync_and_idempotency_reconciliation.json
lastmile_delivery_intake_ingestion_connector_sync_and_idempotency_evidence.json
```
