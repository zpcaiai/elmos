---
name: bank-statement-iso20022-camt-bai2-ingestion-and-reconciliation
description: "Implement bank-statement ingestion for ISO 20022 camt, BAI2, MT940 and APIs, immutable entries, balance validation, normalization, cash matching and bank reconciliation."
---
...
Implement bank-statement ingestion for ISO 20022 camt, BAI2, MT940 and APIs, immutable entries, balance validation, normalization, cash matching and bank reconciliation.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/bank-statement-iso20022-camt-bai2-ingestion-and-reconciliation-baseline.md`.
...
```text
bank_statement_iso20022_camt_bai2_ingestion_and_reconciliation_manifest.json
bank_statement_iso20022_camt_bai2_ingestion_and_reconciliation_decision.json
bank_statement_iso20022_camt_bai2_ingestion_and_reconciliation_reconciliation.json
bank_statement_iso20022_camt_bai2_ingestion_and_reconciliation_evidence.json
```
...
statementIsImmutable
openingMovementClosingBalancesReconcile
bookingAndValueDateRemainDistinct
