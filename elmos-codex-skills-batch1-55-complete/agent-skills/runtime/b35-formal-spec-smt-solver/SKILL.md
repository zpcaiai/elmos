---
name: b35-formal-spec-smt-solver
description: "Integrate formal specifications SMT solvers proof obligations models assumptions timeouts certificates and concrete replay without treating unknown as proven."
---
...
## Skill 1281: b35-formal-spec-smt-solver

## Use this skill when

- Critical properties benefit from SMT or formal proof obligations.

## Domain-specific risks and invariants

- Solver unknown or modeling mistakes can be misreported as proof.

## Workflow

1. Write a versioned formal specification with assumptions and property IDs.
2. Translate bounded implementation semantics to solver inputs.
3. Lock solver binary, theory, options, timeout, and resource budget.
4. Validate SAT models and UNSAT claims with proof/certificate support where available.
5. Replay countermodels concretely.
6. Record unknown, timeout, unsupported, inconsistent assumptions, and vacuity separately.
...
- Encode bounded critical properties, verify solver results, retain exact inputs, and translate countermodels into tests.
...
- Formal specs, solver manifests, proof records, models/countermodels, validation logs, and replay artifacts.
