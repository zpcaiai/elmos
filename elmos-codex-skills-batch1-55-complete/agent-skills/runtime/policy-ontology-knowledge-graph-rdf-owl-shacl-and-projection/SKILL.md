---
name: policy-ontology-knowledge-graph-rdf-owl-shacl-and-projection
description: "Implement a rebuildable policy ontology and knowledge graph with RDF/OWL-compatible concepts, stable SHACL validation, provenance, assertion/inference separation, and lineage."
---
...
Implement a rebuildable policy ontology and knowledge graph with RDF/OWL-compatible concepts, stable SHACL validation, provenance, assertion/inference separation, and lineage.
...
4. Record unresolved provider/version assumptions in `docs/implementation/policy-ontology-knowledge-graph-rdf-owl-shacl-and-projection-baseline.md`.
...
```text
policy_ontology_knowledge_graph_rdf_owl_shacl_and_projection_manifest.json
policy_ontology_knowledge_graph_rdf_owl_shacl_and_projection_decision.json
policy_ontology_knowledge_graph_rdf_owl_shacl_and_projection_evidence.json
```
