---
name: workload-authorization-policy-tool-permission-and-purpo-cb49fedd
description: "Implement workload authorization for tools, arguments, resources, networks, credentials, side effects, purpose binding, budgets, and continuous re-evaluation."
---
...
Implement workload authorization for tools, arguments, resources, networks, credentials, side effects, purpose binding, budgets, and continuous re-evaluation.

This Skill belongs to **Batch 34C** and must extend the approved ELMOS domain rather than create parallel Tenant, Identity, Artifact, Policy, Workflow, Audit, Contract or Finding aggregates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/workload-authorization-policy-tool-permission-and-purpose-binding-baseline.md`.
...
```text
workload_authorization_policy_tool_permission_and_purpose_binding_manifest.json
workload_authorization_policy_tool_permission_and_purpose_binding_decision.json
workload_authorization_policy_tool_permission_and_purpose_binding_evidence.json
```
