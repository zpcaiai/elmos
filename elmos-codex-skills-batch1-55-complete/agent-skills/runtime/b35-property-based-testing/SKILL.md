---
name: b35-property-based-testing
description: "Implement property-based generators shrinking invariants coverage controls and reproducible source-target checks for migrated code data APIs and workflows."
---
...
## Skill 1267: b35-property-based-testing

## Use this skill when

- A migrated component has broad input domains or hidden boundary cases.

## Domain-specific risks and invariants

- Invalid generators can test meaningless states.
- Poor shrinkers create irreducible failures.

## Workflow

1. Derive domains from schemas, types, constraints, contracts, examples, source tests, and domain rules.
2. Implement valid, invalid, boundary, correlated, and state-aware generators.
3. Define deterministic properties and oracle references.
4. Implement shrinkers preserving validity and the failing property.
5. Persist seeds and replay commands.
6. Run development, negative, holdout, and representative properties; promote minimal failures to regression.
...
- Build typed generators and properties from contracts, domain constraints, schemas, source tests, and observed valid/invalid boundaries.
...
- Property specifications, generators, shrinkers, seeds, run results, counterexamples, and regression fixtures.
