---
name: b45-security-data-certification
description: "Implement and verify Batch 45 Skill 1481 for security data certification. Use when work requires 安全和数据治理认证, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-security-data-certification`.
...
4. Implement the smallest production-shaped capability that exercises `安全和数据治理认证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-security-data-certification`
