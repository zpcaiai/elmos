---
name: b09-build-compile-test-repair-bounded-fix-loop-security-ebdaa54d
description: "Implement security privacy and tenant isolation for Batch 9: Build、Compile、Test Repair与Bounded Fix Loop."
---
...
Apply this Skill to **Batch 9: Build、Compile、Test Repair与Bounded Fix Loop**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `9`
- Domain: `Build、Compile、Test Repair与Bounded Fix Loop`
...
2. Resolve Batch 9 dependencies and verify prerequisite gates.
...
- repair loops are bounded and reversible.
- each patch links to diagnostics.
- build success cannot hide test regressions.
