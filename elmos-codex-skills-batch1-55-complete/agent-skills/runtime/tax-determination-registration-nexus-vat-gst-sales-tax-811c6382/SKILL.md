---
name: tax-determination-registration-nexus-vat-gst-sales-tax-811c6382
description: "Implement jurisdiction-aware tax determination, registrations, nexus, place of supply, VAT/GST/sales tax, exemptions, reverse charge, withholding, tax evidence, provider adapters and versioned rules."
---
...
Implement jurisdiction-aware tax determination, registrations, nexus, place of supply, VAT/GST/sales tax, exemptions, reverse charge, withholding, tax evidence, provider adapters and versioned rules.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/tax-determination-registration-nexus-vat-gst-sales-tax-withholding-and-einvoicing-baseline.md`.
...
```text
tax_determination_registration_nexus_vat_gst_sales_tax_withholding_and_einvoicing_manifest.json
tax_determination_registration_nexus_vat_gst_sales_tax_withholding_and_einvoicing_decision.json
tax_determination_registration_nexus_vat_gst_sales_tax_withholding_and_einvoicing_reconciliation.json
tax_determination_registration_nexus_vat_gst_sales_tax_withholding_and_einvoicing_evidence.json
```
...
```text
taxRuleUsesEffectiveDate
expiredExemptionDoesNotApply
taxCalculationIsNotAuthorityAcceptance
