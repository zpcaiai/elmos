---
name: lastmile-delivery-policy-authorization-approval-segrega-bbe90785
description: "Implement Batch 51B Warehouse、Last-mile、Delivery与Returns policy controls, authorization, approvals, segregation of duties, delegations, exceptions and expiry, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return."
---

# Lastmile Delivery Policy Authorization Approval Segregation And Exception

## Objective

Implement Batch 51B Warehouse、Last-mile、Delivery与Returns policy controls, authorization, approvals, segregation of duties, delegations, exceptions and expiry, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return.
...
5. Write unresolved domain assumptions to `docs/implementation/lastmile-delivery-policy-authorization-approval-segregation-and-exception-baseline.md`.
...
```text
lastmile_delivery_policy_authorization_approval_segregation_and_exception_manifest.json
lastmile_delivery_policy_authorization_approval_segregation_and_exception_state.json
lastmile_delivery_policy_authorization_approval_segregation_and_exception_decision.json
lastmile_delivery_policy_authorization_approval_segregation_and_exception_reconciliation.json
lastmile_delivery_policy_authorization_approval_segregation_and_exception_evidence.json
```
