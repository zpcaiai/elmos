---
name: b44-artifact-retention-egress-economics
description: "Implement and verify Batch 44 Skill 1462 for artifact retention egress economics. Use when work requires Artifact存储、Retention和Egress经济性, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Artifact存储、Retention和Egress经济性
...
## Skill 1462: Artifact存储、Retention和Egress经济性
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-artifact-retention-egress-economics`.
...
4. Implement the smallest production-shaped capability that exercises `Artifact存储、Retention和Egress经济性` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-artifact-retention-egress-economics`
