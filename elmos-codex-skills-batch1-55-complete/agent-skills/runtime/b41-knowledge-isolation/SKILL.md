---
name: b41-knowledge-isolation
description: "Implement and verify Batch 41 Skill 1407 for knowledge isolation. Use when work requires 公共、认证和客户私有知识隔离, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-knowledge-isolation`.
...
4. Implement the smallest production-shaped capability that exercises `公共、认证和客户私有知识隔离` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-knowledge-isolation`
