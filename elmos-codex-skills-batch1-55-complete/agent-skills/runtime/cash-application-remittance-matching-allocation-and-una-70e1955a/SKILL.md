---
name: cash-application-remittance-matching-allocation-and-una-70e1955a
description: "Implement cash-application rules, remittance parsing, candidate matching, confidence, allocations, unapplied cash, deductions, short pays and reconciliation."
---
...
Implement cash-application rules, remittance parsing, candidate matching, confidence, allocations, unapplied cash, deductions, short pays and reconciliation.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/cash-application-remittance-matching-allocation-and-unapplied-cash-baseline.md`.
...
```text
cash_application_remittance_matching_allocation_and_unapplied_cash_manifest.json
cash_application_remittance_matching_allocation_and_unapplied_cash_decision.json
cash_application_remittance_matching_allocation_and_unapplied_cash_reconciliation.json
cash_application_remittance_matching_allocation_and_unapplied_cash_evidence.json
```
