---
name: b02-polyglot-semantic-adapters-ast-cst-symbol-type-r-se-f8fb308e
description: "Implement security privacy and tenant isolation for Batch 2: Polyglot Semantic Adapters、AST/CST、Symbol与Type Recovery."
---
...
Apply this Skill to **Batch 2: Polyglot Semantic Adapters、AST/CST、Symbol与Type Recovery**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `2`
- Domain: `Polyglot Semantic Adapters、AST/CST、Symbol与Type Recovery`
...
2. Resolve Batch 2 dependencies and verify prerequisite gates.
...
- source locations remain traceable.
- unresolved symbols and types remain explicit.
- parsing fallback cannot silently claim semantic certainty.
