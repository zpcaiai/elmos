---
name: policy-information-point-context-fact-resolver-trust-fr-97e6c78f
description: "Implement PIP facts, trust, freshness, source precedence, conflicts, immutable context snapshots, safe external-data providers, caching, batching, and privacy."
---
...
Implement PIP facts, trust, freshness, source precedence, conflicts, immutable context snapshots, safe external-data providers, caching, batching, and privacy.
...
4. Record unresolved provider/version assumptions in `docs/implementation/policy-information-point-context-fact-resolver-trust-freshness-and-external-data-baseline.md`.
...
```text
policy_information_point_context_fact_resolver_trust_freshness_and_external_data_manifest.json
policy_information_point_context_fact_resolver_trust_freshness_and_external_data_decision.json
policy_information_point_context_fact_resolver_trust_freshness_and_external_data_evidence.json
```
