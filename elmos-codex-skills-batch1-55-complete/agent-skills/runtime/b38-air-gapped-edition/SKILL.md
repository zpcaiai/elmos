---
name: b38-air-gapped-edition
description: "Implement and verify Batch 38 Skill 1333 for air gapped edition. Use when work requires Air-gapped Edition, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-air-gapped-edition`.
...
4. Implement the smallest production-shaped capability that exercises `Air-gapped Edition` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-air-gapped-edition`
