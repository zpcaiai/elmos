---
name: sparse-checkout-partial-clone-filter-and-worktree-mater-510b75ba
description: "Implement sparse checkout, partial clone filters, promisor objects, lazy hydration, path policy, offline limitations, and deterministic materialization."
---
...
Implement sparse checkout, partial clone filters, promisor objects, lazy hydration, path policy, offline limitations, and deterministic materialization.
...
4. Record unresolved provider/version assumptions in `docs/implementation/sparse-checkout-partial-clone-filter-and-worktree-materialization-baseline.md`.
...
```text
sparse_checkout_partial_clone_filter_and_worktree_materialization_manifest.json
sparse_checkout_partial_clone_filter_and_worktree_materialization_decision.json
sparse_checkout_partial_clone_filter_and_worktree_materialization_evidence.json
```
