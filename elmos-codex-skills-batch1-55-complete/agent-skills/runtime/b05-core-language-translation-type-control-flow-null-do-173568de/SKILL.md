---
name: b05-core-language-translation-type-control-flow-null-do-173568de
description: "Implement domain model and contracts for Batch 5: Core Language Translation、Type／Control-flow／Null Semantics."
---

# Objective

Define versioned domain entities, value objects, schemas, identifiers and compatibility contracts.
...
- Role: `domain-model-and-contracts`
...
4. Build the smallest end-to-end vertical slice for `domain-model-and-contracts`.
