---
name: b05-core-language-translation-type-control-flow-null-pe-2017ec06
description: "Implement performance capacity and cost for Batch 5: Core Language Translation、Type／Control-flow／Null Semantics."
---

# Objective

Measure performance, capacity, resource ceilings, cost budgets and regression thresholds.
...
- Role: `performance-capacity-and-cost`
...
4. Build the smallest end-to-end vertical slice for `performance-capacity-and-cost`.
