---
name: integration-platform-observability-sla-cockpit-alerting-455c6f2c
description: "Implement Batch 46A API、iPaaS、Event Streaming与Integration Platform telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering API、Connector、Event、Topic、Schema、Route、Transformation、Subscription、Gateway与Integration Flow."
---

# Integration Platform Observability SLA Cockpit Alerting And Operations

## Objective

Implement Batch 46A API、iPaaS、Event Streaming与Integration Platform telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering API、Connector、Event、Topic、Schema、Route、Transformation、Subscription、Gateway与Integration Flow.
...
5. Write unresolved domain assumptions to `docs/implementation/integration-platform-observability-sla-cockpit-alerting-and-operations-baseline.md`.
...
```text
integration_platform_observability_sla_cockpit_alerting_and_operations_manifest.json
integration_platform_observability_sla_cockpit_alerting_and_operations_state.json
integration_platform_observability_sla_cockpit_alerting_and_operations_decision.json
integration_platform_observability_sla_cockpit_alerting_and_operations_reconciliation.json
integration_platform_observability_sla_cockpit_alerting_and_operations_evidence.json
```
