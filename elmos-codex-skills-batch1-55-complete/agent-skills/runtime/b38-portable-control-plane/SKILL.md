---
name: b38-portable-control-plane
description: "Implement and verify Batch 38 Skill 1327 for portable control plane. Use when work requires Control Plane可移植架构, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-portable-control-plane`.
...
4. Implement the smallest production-shaped capability that exercises `Control Plane可移植架构` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-portable-control-plane`
