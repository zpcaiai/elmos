---
name: b35-validation-profile-oracle-composition
description: "Define risk-tiered verification profiles and compose independent deterministic statistical symbolic model and human oracles without allowing one weak oracle to overrule critical evidence."
---
...
## Skill 1266: b35-validation-profile-oracle-composition

## Use this skill when

- A workload needs an exact risk-tiered verification plan and oracle composition.

## Domain-specific risks and invariants

- Using every technique everywhere wastes resources.
- A weak oracle can silently approve a critical regression.

## Workflow

1. Inventory business claims, P0/P1 requirements, failure modes, observability, current tests, and unsupported areas.
2. Classify claims by impact, reversibility, determinism, and regulatory relevance.
3. Select independent oracle types and technique combinations for every critical claim.
4. Define budgets, coverage targets, statistical parameters, timeouts, stop conditions, and required owner approvals.
5. Add negative tests proving that one oracle cannot override stronger evidence.
6. Version the profile and bind it to exact artifacts and environments.
...
- Create exact P0/P1 verification obligations, required techniques, budgets, stop conditions, and oracle precedence for a workload.
...
- A versioned validation profile, oracle composition, evidence requirements, exclusions, and negative tests.
