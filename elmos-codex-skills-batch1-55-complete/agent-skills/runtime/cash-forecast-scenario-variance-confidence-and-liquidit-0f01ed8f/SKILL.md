---
name: cash-forecast-scenario-variance-confidence-and-liquidit-0f01ed8f
description: "Implement short-, medium- and long-term cash forecasts, scenarios, source confidence, liquidity planning, variance and forecast governance."
---
...
Implement short-, medium- and long-term cash forecasts, scenarios, source confidence, liquidity planning, variance and forecast governance.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/cash-forecast-scenario-variance-confidence-and-liquidity-planning-baseline.md`.
...
```text
cash_forecast_scenario_variance_confidence_and_liquidity_planning_manifest.json
cash_forecast_scenario_variance_confidence_and_liquidity_planning_decision.json
cash_forecast_scenario_variance_confidence_and_liquidity_planning_reconciliation.json
cash_forecast_scenario_variance_confidence_and_liquidity_planning_evidence.json
```
