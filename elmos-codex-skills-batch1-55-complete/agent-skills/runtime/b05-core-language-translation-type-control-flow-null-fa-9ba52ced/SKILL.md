---
name: b05-core-language-translation-type-control-flow-null-fa-9ba52ced
description: "Implement failure recovery and rollback for Batch 5: Core Language Translation、Type／Control-flow／Null Semantics."
---

# Objective

Handle partial failure, unknown results, rollback, compensation, restore and disaster scenarios.
...
- Role: `failure-recovery-and-rollback`
...
4. Build the smallest end-to-end vertical slice for `failure-recovery-and-rollback`.
