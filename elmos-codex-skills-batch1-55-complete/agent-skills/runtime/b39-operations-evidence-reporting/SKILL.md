---
name: b39-operations-evidence-reporting
description: "Implement and verify Batch 39 Skill 1367 for operations evidence reporting. Use when work requires 运营Evidence和客户报告, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-operations-evidence-reporting`.
...
4. Implement the smallest production-shaped capability that exercises `运营Evidence和客户报告` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-operations-evidence-reporting`
