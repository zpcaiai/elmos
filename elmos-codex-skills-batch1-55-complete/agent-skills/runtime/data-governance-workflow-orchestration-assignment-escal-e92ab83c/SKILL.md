---
name: data-governance-workflow-orchestration-assignment-escal-e92ab83c
description: "Implement Batch 44C Data Governance、MDM、Quality、Privacy与Lineage workflow orchestration, queues, ownership, assignments, escalation, retries, compensation and recovery, covering Catalog、Business Glossary、Master Data、Quality Rule、Lineage、Classification、Privacy、Stewardship与Data Issue."
---
...
Implement Batch 44C Data Governance、MDM、Quality、Privacy与Lineage workflow orchestration, queues, ownership, assignments, escalation, retries, compensation and recovery, covering Catalog、Business Glossary、Master Data、Quality Rule、Lineage、Classification、Privacy、Stewardship与Data Issue.
...
5. Write unresolved domain assumptions to `docs/implementation/data-governance-workflow-orchestration-assignment-escalation-and-recovery-baseline.md`.
...
```text
data_governance_workflow_orchestration_assignment_escalation_and_recovery_manifest.json
data_governance_workflow_orchestration_assignment_escalation_and_recovery_state.json
data_governance_workflow_orchestration_assignment_escalation_and_recovery_decision.json
data_governance_workflow_orchestration_assignment_escalation_and_recovery_reconciliation.json
data_governance_workflow_orchestration_assignment_escalation_and_recovery_evidence.json
```
