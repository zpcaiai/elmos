---
name: offline-chaos-security-recovery-tests-and-release-gates
description: "Implement disconnect, queue, storage, partial transfer, expiry, split-brain, HA, cache and scale fault tests with machine-readable release evidence."
---
...
Implement disconnect, queue, storage, partial transfer, expiry, split-brain, HA, cache and scale fault tests with machine-readable release evidence.
...
4. Record unresolved provider/version assumptions in `docs/implementation/offline-chaos-security-recovery-tests-and-release-gates-baseline.md`.
...
```text
offline_chaos_security_recovery_tests_and_release_gates_manifest.json
offline_chaos_security_recovery_tests_and_release_gates_decision.json
offline_chaos_security_recovery_tests_and_release_gates_evidence.json
```
