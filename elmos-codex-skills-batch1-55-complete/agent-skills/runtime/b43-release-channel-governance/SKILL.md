---
name: b43-release-channel-governance
description: "Implement and verify Batch 43 Skill 1444 for release channel governance. Use when work requires LTS、Stable、Preview和Experimental Channel, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# LTS、Stable、Preview和Experimental Channel
...
## Skill 1444: LTS、Stable、Preview和Experimental Channel
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-release-channel-governance`.
...
4. Implement the smallest production-shaped capability that exercises `LTS、Stable、Preview和Experimental Channel` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-release-channel-governance`
