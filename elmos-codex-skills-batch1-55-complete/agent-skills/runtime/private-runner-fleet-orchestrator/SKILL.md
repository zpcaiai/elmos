---
name: private-runner-fleet-orchestrator
description: "Implement the complete private runner fleet: pools, capabilities, trust, versions, capacity, scheduling, assignments, leases, drain, autoscaling, upgrade, observability, and gates."
---
...
Implement the complete private runner fleet: pools, capabilities, trust, versions, capacity, scheduling, assignments, leases, drain, autoscaling, upgrade, observability, and gates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/private-runner-fleet-orchestrator-baseline.md`.
...
```text
private_runner_fleet_orchestrator_manifest.json
private_runner_fleet_orchestrator_decision.json
private_runner_fleet_orchestrator_evidence.json
```
