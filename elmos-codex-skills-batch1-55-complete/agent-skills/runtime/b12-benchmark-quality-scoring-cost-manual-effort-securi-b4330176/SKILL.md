---
name: b12-benchmark-quality-scoring-cost-manual-effort-securi-b4330176
description: "Implement security privacy and tenant isolation for Batch 12: Benchmark、Quality Scoring、Cost与Manual Effort."
---
...
Apply this Skill to **Batch 12: Benchmark、Quality Scoring、Cost与Manual Effort**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `12`
- Domain: `Benchmark、Quality Scoring、Cost与Manual Effort`
...
2. Resolve Batch 12 dependencies and verify prerequisite gates.
...
- cost and manual effort are included.
- benchmarks cannot use only training or public examples.
