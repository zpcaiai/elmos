---
name: malicious-repository-build-wrapper-hook-archive-and-tool-policy
description: "Implement staged untrusted repository handling, Git hardening, Maven/Gradle wrapper validation, plugin/test/agent boundaries, cache overlays, archives, and malicious fixtures."
---
...
Implement staged untrusted repository handling, Git hardening, Maven/Gradle wrapper validation, plugin/test/agent boundaries, cache overlays, archives, and malicious fixtures.
...
4. Record unresolved provider/version assumptions in `docs/implementation/malicious-repository-build-wrapper-hook-archive-and-tool-policy-baseline.md`.
...
```text
malicious_repository_build_wrapper_hook_archive_and_tool_policy_manifest.json
malicious_repository_build_wrapper_hook_archive_and_tool_policy_decision.json
malicious_repository_build_wrapper_hook_archive_and_tool_policy_evidence.json
```
