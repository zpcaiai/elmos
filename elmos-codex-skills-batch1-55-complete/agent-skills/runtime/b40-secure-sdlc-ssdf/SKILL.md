---
name: b40-secure-sdlc-ssdf
description: "Implement and verify Batch 40 Skill 1370 for secure sdlc ssdf. Use when work requires Secure SDLC和SSDF治理, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-secure-sdlc-ssdf`.
...
4. Implement the smallest production-shaped capability that exercises `Secure SDLC和SSDF治理` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-secure-sdlc-ssdf`
