---
name: b44-human-expert-cost
description: "Implement and verify Batch 44 Skill 1463 for human expert cost. Use when work requires 人工Review和专家处理成本, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-human-expert-cost`.
...
4. Implement the smallest production-shaped capability that exercises `人工Review和专家处理成本` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-human-expert-cost`
