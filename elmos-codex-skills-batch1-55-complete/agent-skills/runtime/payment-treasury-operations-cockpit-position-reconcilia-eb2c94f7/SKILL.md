---
name: payment-treasury-operations-cockpit-position-reconcilia-eb2c94f7
description: "Implement payment and treasury operational dashboards, cash positions, unknown payments, reconciliation, fraud, liquidity, forecasts, limits, SLA, cases and actions."
---
...
Implement payment and treasury operational dashboards, cash positions, unknown payments, reconciliation, fraud, liquidity, forecasts, limits, SLA, cases and actions.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/payment-treasury-operations-cockpit-position-reconciliation-fraud-and-sla-baseline.md`.
...
```text
payment_treasury_operations_cockpit_position_reconciliation_fraud_and_sla_manifest.json
payment_treasury_operations_cockpit_position_reconciliation_fraud_and_sla_decision.json
payment_treasury_operations_cockpit_position_reconciliation_fraud_and_sla_reconciliation.json
payment_treasury_operations_cockpit_position_reconciliation_fraud_and_sla_evidence.json
```
...
restrictedCashIsNotAvailableLiquidity
sweepRequiresMandate
