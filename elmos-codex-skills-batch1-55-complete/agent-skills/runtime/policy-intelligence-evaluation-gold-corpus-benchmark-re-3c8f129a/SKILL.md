---
name: policy-intelligence-evaluation-gold-corpus-benchmark-re-3c8f129a
description: "Implement gold corpora, extraction/formalization/conflict/Copilot/regulatory evaluations, reviewer agreement, citations/abstention metrics, red teams, model/prompt governance, drift, and release decisions."
---
...
Implement gold corpora, extraction/formalization/conflict/Copilot/regulatory evaluations, reviewer agreement, citations/abstention metrics, red teams, model/prompt governance, drift, and release decisions.

This Skill belongs to **Batch 38B** and must extend the approved ELMOS domain rather than create parallel Tenant, Identity, Artifact, Policy, Workflow, Audit, Contract or Finding aggregates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/policy-intelligence-evaluation-gold-corpus-benchmark-red-team-and-model-governance-baseline.md`.
...
```text
policy_intelligence_evaluation_gold_corpus_benchmark_red_team_and_model_governance_manifest.json
policy_intelligence_evaluation_gold_corpus_benchmark_red_team_and_model_governance_decision.json
policy_intelligence_evaluation_gold_corpus_benchmark_red_team_and_model_governance_evidence.json
```
...
- Preserve authoritative sources, exact clauses, policy versions and reviewer decisions.
- AI outputs and mined rules are candidates only.
- Fail closed on missing context, semantic loss, unknown obligations and unsupported enforcement.
- Every exception, regulatory action and governance decision is scoped, expiring and audited.
