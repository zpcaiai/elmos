...
description: "Implement and verify Batch 39 Skill 1348 for service catalog sli slo. Use when work requires Service Catalog、SLI和SLO体系, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Service Catalog、SLI和SLO体系
...
## Skill 1348: Service Catalog、SLI和SLO体系
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-service-catalog-sli-slo`.
...
4. Implement the smallest production-shaped capability that exercises `Service Catalog、SLI和SLO体系` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-service-catalog-sli-slo`
