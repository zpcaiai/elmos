---
name: b20-migration-platform-foundation-and-repository-exe-se-ba91fbdb
description: "Implement security privacy and tenant isolation for Batch 20: Migration Platform Foundation and Repository Execution Scaffold."
---
...
Apply this Skill to **Batch 20: Migration Platform Foundation and Repository Execution Scaffold**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `20`
- Domain: `Migration Platform Foundation and Repository Execution Scaffold`
...
2. Resolve Batch 20 dependencies and verify prerequisite gates.
...
- foundation APIs and events are versioned.
- runner work is isolated and auditable.
