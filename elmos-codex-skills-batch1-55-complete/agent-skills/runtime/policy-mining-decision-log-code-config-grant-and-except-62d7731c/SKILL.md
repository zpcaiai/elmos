---
name: policy-mining-decision-log-code-config-grant-and-except-62d7731c
description: "Implement privacy-aware policy mining from decisions, guards, IAM grants, RBAC, configuration, exceptions, tickets and runtime observations into reviewed candidates and drift findings."
---
...
Implement privacy-aware policy mining from decisions, guards, IAM grants, RBAC, configuration, exceptions, tickets and runtime observations into reviewed candidates and drift findings.
...
4. Record unresolved provider/version assumptions in `docs/implementation/policy-mining-decision-log-code-config-grant-and-exception-discovery-baseline.md`.
...
```text
policy_mining_decision_log_code_config_grant_and_exception_discovery_manifest.json
policy_mining_decision_log_code_config_grant_and_exception_discovery_decision.json
policy_mining_decision_log_code_config_grant_and_exception_discovery_evidence.json
```
