---
name: b39-customer-status-communication
description: "Implement and verify Batch 39 Skill 1359 for customer status communication. Use when work requires 客户状态页和Incident Communication, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 客户状态页和Incident Communication
...
## Skill 1359: 客户状态页和Incident Communication
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-customer-status-communication`.
...
4. Implement the smallest production-shaped capability that exercises `客户状态页和Incident Communication` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-customer-status-communication`
