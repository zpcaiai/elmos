---
name: b35-data-money-conservation-invariants
description: "Implement deterministic data money quantity balance uniqueness referential and conservation invariants across migrated transactions pipelines and reconciliations."
---
...
## Skill 1275: b35-data-money-conservation-invariants

## Use this skill when

- Money, inventory, balances, allocation, counts, or referential integrity are P0.

## Domain-specific risks and invariants

- Aggregate equality can hide record-level corruption.

## Workflow

1. Define exact arithmetic, conservation, uniqueness, relationship, audit, and no-side-effect invariants with owner approval.
2. Build deterministic canonical queries and observation contracts.
3. Generate boundary and adversarial transactions.
4. Run source-target, rollback, retry, duplicate, concurrency, and partial-failure checks.
5. Reconcile detail before aggregate.
6. Block any unresolved critical violation.
...
- Protect financial amounts, inventory, counts, allocations, relationships, audit trails, and no-side-effect denial paths.
...
- Invariant specs, exact arithmetic checks, reconciliation queries, violation evidence, and signed owner decisions.
