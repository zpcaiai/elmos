---
name: cohort-retention-grr-nrr-survival-and-customer-lifecycl-90b618c9
description: "Implement fixed cohorts, logo and revenue retention, GRR, NRR, survival, censoring, lifecycle stages and cohort drill-down."
---
...
Implement fixed cohorts, logo and revenue retention, GRR, NRR, survival, censoring, lifecycle stages and cohort drill-down.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/cohort-retention-grr-nrr-survival-and-customer-lifecycle-analytics-baseline.md`.
...
```text
cohort_retention_grr_nrr_survival_and_customer_lifecycle_analytics_manifest.json
cohort_retention_grr_nrr_survival_and_customer_lifecycle_analytics_decision.json
cohort_retention_grr_nrr_survival_and_customer_lifecycle_analytics_reconciliation.json
cohort_retention_grr_nrr_survival_and_customer_lifecycle_analytics_evidence.json
```
...
```text
historicalCohortMembershipIsStable
grrExcludesExpansion
missingDataIsNotChurn
