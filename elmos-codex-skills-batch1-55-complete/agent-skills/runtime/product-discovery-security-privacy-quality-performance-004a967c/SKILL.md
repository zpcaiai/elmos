---
name: product-discovery-security-privacy-quality-performance-004a967c
description: "Implement Batch 41B Product Discovery、Feedback与Research Operations security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Idea、Feedback、Interview、Research、Problem、Hypothesis、Requirement、Prototype、Evidence与Discovery Decision."
---
...
Implement Batch 41B Product Discovery、Feedback与Research Operations security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Idea、Feedback、Interview、Research、Problem、Hypothesis、Requirement、Prototype、Evidence与Discovery Decision.
...
Implement the domain model, lifecycle, APIs, events, workflows, policy controls, provider adapters, evidence, analytics, operations and release gates required for **Batch 41B: Product Discovery、Feedback与Research Operations**.

Theme:

```text
Idea、Feedback、Interview、Research、Problem、Hypothesis、Requirement、Prototype、Evidence与Discovery Decision
```
...
5. Write unresolved domain assumptions to `docs/implementation/product-discovery-security-privacy-quality-performance-chaos-and-release-gates-baseline.md`.

## Required Capabilities

- Implement Idea、Feedback、Interview、Research、Problem、Hypothesis、Requirement、Prototype、Evidence与Discovery Decision without weakening earlier identity, evidence, policy, finance, privacy or tenant-isolation controls.
...
```text
capture→classify→research→synthesize→hypothesize→prototype→validate→decide
```
...
```text
product_discovery_security_privacy_quality_performance_chaos_and_release_gates_manifest.json
product_discovery_security_privacy_quality_performance_chaos_and_release_gates_state.json
product_discovery_security_privacy_quality_performance_chaos_and_release_gates_decision.json
product_discovery_security_privacy_quality_performance_chaos_and_release_gates_reconciliation.json
product_discovery_security_privacy_quality_performance_chaos_and_release_gates_evidence.json
```
...
```text
feedbackIdentityIsStable
feedbackLifecycleIsVersioned
researchStudyIdentityIsStable
researchStudyLifecycleIsVersioned
problemIdentityIsStable
problemLifecycleIsVersioned
hypothesisIdentityIsStable
hypothesisLifecycleIsVersioned
