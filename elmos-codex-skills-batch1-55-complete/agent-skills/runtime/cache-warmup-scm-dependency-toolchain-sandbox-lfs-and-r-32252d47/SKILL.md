---
name: cache-warmup-scm-dependency-toolchain-sandbox-lfs-and-r-32252d47
description: "Implement authorized cache warming for Git, LFS, dependencies, toolchains, sandbox artifacts, recipes, policy and offline packages with staging, verification, readiness, and eviction."
---
...
Implement authorized cache warming for Git, LFS, dependencies, toolchains, sandbox artifacts, recipes, policy and offline packages with staging, verification, readiness, and eviction.
...
4. Record unresolved provider/version assumptions in `docs/implementation/cache-warmup-scm-dependency-toolchain-sandbox-lfs-and-recipe-prefetch-baseline.md`.
...
```text
cache_warmup_scm_dependency_toolchain_sandbox_lfs_and_recipe_prefetch_manifest.json
cache_warmup_scm_dependency_toolchain_sandbox_lfs_and_recipe_prefetch_decision.json
cache_warmup_scm_dependency_toolchain_sandbox_lfs_and_recipe_prefetch_evidence.json
```
