---
name: b06-standard-library-dependency-mapping-compatibilit-se-065f6c8e
description: "Implement security privacy and tenant isolation for Batch 6: Standard Library、Dependency Mapping与Compatibility Runtime."
---
...
Apply this Skill to **Batch 6: Standard Library、Dependency Mapping与Compatibility Runtime**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `6`
- Domain: `Standard Library、Dependency Mapping与Compatibility Runtime`
...
2. Resolve Batch 6 dependencies and verify prerequisite gates.
...
- dependency replacements are versioned and justified.
- compatibility runtime use is explicit.
- license and vulnerability constraints are visible.
