---
name: jit-access-approval-break-glass-and-privileged-access
description: "Implement just-in-time access, approval workflows, time-bound grants, privileged access, break-glass controls, emergency review, and automatic revocation."
---
...
Implement just-in-time access, approval workflows, time-bound grants, privileged access, break-glass controls, emergency review, and automatic revocation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/jit-access-approval-break-glass-and-privileged-access-baseline.md`.
...
```text
jit_access_approval_break_glass_and_privileged_access_manifest.json
jit_access_approval_break_glass_and_privileged_access_decision.json
jit_access_approval_break_glass_and_privileged_access_evidence.json
```
