...
description: "Implement and verify Batch 45 Skill 1487 for economics profitability certification. Use when work requires 经济性和盈利能力认证, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-economics-profitability-certification`.
...
4. Implement the smallest production-shaped capability that exercises `经济性和盈利能力认证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-economics-profitability-certification`
