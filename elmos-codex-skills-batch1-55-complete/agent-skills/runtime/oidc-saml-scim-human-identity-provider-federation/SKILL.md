---
name: oidc-saml-scim-human-identity-provider-federation
description: "Implement human identity federation through OIDC, SAML, SCIM, enterprise directories, domain discovery, account linking, issuer trust, and provider lifecycle."
---
...
Implement human identity federation through OIDC, SAML, SCIM, enterprise directories, domain discovery, account linking, issuer trust, and provider lifecycle.
...
4. Record unresolved provider/version assumptions in `docs/implementation/oidc-saml-scim-human-identity-provider-federation-baseline.md`.
...
```text
oidc_saml_scim_human_identity_provider_federation_manifest.json
oidc_saml_scim_human_identity_provider_federation_decision.json
oidc_saml_scim_human_identity_provider_federation_evidence.json
```
