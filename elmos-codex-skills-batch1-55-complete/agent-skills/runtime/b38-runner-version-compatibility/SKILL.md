---
name: b38-runner-version-compatibility
description: "Implement and verify Batch 38 Skill 1339 for runner version compatibility. Use when work requires Runner N-1/N/N+1兼容, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-runner-version-compatibility`.
...
4. Implement the smallest production-shaped capability that exercises `Runner N-1/N/N+1兼容` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-runner-version-compatibility`
