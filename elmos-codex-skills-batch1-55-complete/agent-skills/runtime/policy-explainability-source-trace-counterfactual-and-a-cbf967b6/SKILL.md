---
name: policy-explainability-source-trace-counterfactual-and-a-cbf967b6
description: "Implement audience-safe policy explanations, exact source traces, determining rules, facts, missing/stale context, exceptions, errors, and secure counterfactual candidates."
---
...
Implement audience-safe policy explanations, exact source traces, determining rules, facts, missing/stale context, exceptions, errors, and secure counterfactual candidates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/policy-explainability-source-trace-counterfactual-and-audience-views-baseline.md`.
...
```text
policy_explainability_source_trace_counterfactual_and_audience_views_manifest.json
policy_explainability_source_trace_counterfactual_and_audience_views_decision.json
policy_explainability_source_trace_counterfactual_and_audience_views_evidence.json
```
