---
name: b35-verification-coverage-confidence
description: "Measure multidimensional verification coverage evidence quality statistical confidence residual uncertainty and unsupported scope without collapsing maturity into one percentage."
---
...
## Skill 1283: b35-verification-coverage-confidence

## Use this skill when

- A release decision needs honest coverage and uncertainty evidence.

## Domain-specific risks and invariants

- One aggregate percentage can hide unverified critical behavior.

## Workflow

1. Map claims to requirements, properties, paths, states, transitions, inputs, mutants, schedules, contracts, and evidence.
2. Compute coverage by risk tier and technique.
3. Estimate statistical lower bounds only where assumptions are satisfied.
4. Identify blind spots, correlated evidence, stale evidence, and unsupported scope.
5. Publish residual uncertainty without averaging away P0 gaps.
6. Use coverage deficits to drive additional verification.
...
- Compute requirement, property, path, transition, mutation, input, state, concurrency, contract, and evidence coverage.
...
- Coverage reports, lower bounds, blind spots, confidence intervals, residual unknowns, and release recommendations.
