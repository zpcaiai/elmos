---
name: regulatory-reporting-taxonomy-xbrl-filing-validation-an-f813bbe9
description: "Implement regulatory reporting, taxonomy and filing-rule versions, source facts, adjustments, XBRL/iXBRL/XML/JSON/CSV packages, validation, certification, submission, receipts, corrections, and reconciliation."
---
...
Implement regulatory reporting, taxonomy and filing-rule versions, source facts, adjustments, XBRL/iXBRL/XML/JSON/CSV packages, validation, certification, submission, receipts, corrections, and reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/regulatory-reporting-taxonomy-xbrl-filing-validation-and-acknowledgement-baseline.md`.
...
```text
regulatory_reporting_taxonomy_xbrl_filing_validation_and_acknowledgement_manifest.json
regulatory_reporting_taxonomy_xbrl_filing_validation_and_acknowledgement_decision.json
regulatory_reporting_taxonomy_xbrl_filing_validation_and_acknowledgement_evidence.json
```
