---
name: opportunity-product-stakeholder-stage-activity-competit-a1a58331
description: "Implement opportunities, product lines, stakeholders, buying committees, stage histories, activities, competitors, close plans, win/loss decisions and contract reconciliation."
---
...
Implement opportunities, product lines, stakeholders, buying committees, stage histories, activities, competitors, close plans, win/loss decisions and contract reconciliation.
...
5. Write unresolved domain assumptions to `docs/implementation/opportunity-product-stakeholder-stage-activity-competitor-and-close-management-baseline.md`.
...
```text
opportunity_product_stakeholder_stage_activity_competitor_and_close_management_manifest.json
opportunity_product_stakeholder_stage_activity_competitor_and_close_management_state.json
opportunity_product_stakeholder_stage_activity_competitor_and_close_management_decision.json
opportunity_product_stakeholder_stage_activity_competitor_and_close_management_reconciliation.json
opportunity_product_stakeholder_stage_activity_competitor_and_close_management_evidence.json
```
...
opportunityProductStakeholderStageActivityCompetitorAndCloseManagementPreservesSourceLineage
