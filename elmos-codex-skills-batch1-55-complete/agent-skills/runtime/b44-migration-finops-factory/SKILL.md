---
name: b44-migration-finops-factory
description: "Implement and verify Batch 44 Skill 1455 for migration finops factory. Use when work requires 迁移FinOps和经济性总编排, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-migration-finops-factory`.
...
4. Implement the smallest production-shaped capability that exercises `迁移FinOps和经济性总编排` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-migration-finops-factory`
