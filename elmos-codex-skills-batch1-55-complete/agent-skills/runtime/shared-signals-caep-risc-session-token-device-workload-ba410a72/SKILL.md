---
name: shared-signals-caep-risc-session-token-device-workload-ba410a72
description: "Implement OpenID Shared Signals, CAEP/RISC receivers, SET validation, subjects, replay protection, fact updates, session/token/device/workload re-evaluation, and actions."
---
...
Implement OpenID Shared Signals, CAEP/RISC receivers, SET validation, subjects, replay protection, fact updates, session/token/device/workload re-evaluation, and actions.
...
4. Record unresolved provider/version assumptions in `docs/implementation/shared-signals-caep-risc-session-token-device-workload-and-risk-reevaluation-baseline.md`.
...
```text
shared_signals_caep_risc_session_token_device_workload_and_risk_reevaluation_manifest.json
shared_signals_caep_risc_session_token_device_workload_and_risk_reevaluation_decision.json
shared_signals_caep_risc_session_token_device_workload_and_risk_reevaluation_evidence.json
```
