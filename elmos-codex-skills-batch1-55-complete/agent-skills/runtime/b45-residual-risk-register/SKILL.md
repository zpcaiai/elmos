---
name: b45-residual-risk-register
description: "Implement and verify Batch 45 Skill 1493 for residual risk register. Use when work requires 综合风险Register和Residual Risk, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 综合风险Register和Residual Risk
...
## Skill 1493: 综合风险Register和Residual Risk
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-residual-risk-register`.
...
4. Implement the smallest production-shaped capability that exercises `综合风险Register和Residual Risk` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-residual-risk-register`
