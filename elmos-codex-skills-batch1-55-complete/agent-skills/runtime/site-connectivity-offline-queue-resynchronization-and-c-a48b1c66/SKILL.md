---
name: site-connectivity-offline-queue-resynchronization-and-c-a48b1c66
description: "Implement connectivity states, planned/unplanned offline operation, reconnect handshakes, epochs, inventory/watermarks, replay, assignment reconciliation, clock uncertainty, and conflicts."
---
...
Implement connectivity states, planned/unplanned offline operation, reconnect handshakes, epochs, inventory/watermarks, replay, assignment reconciliation, clock uncertainty, and conflicts.

This Skill belongs to **Batch 36C** and must extend the approved ELMOS domain rather than create parallel Tenant, Identity, Artifact, Policy, Workflow, Audit, Contract or Finding aggregates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/site-connectivity-offline-queue-resynchronization-and-conflict-resolution-baseline.md`.
...
```text
site_connectivity_offline_queue_resynchronization_and_conflict_resolution_manifest.json
site_connectivity_offline_queue_resynchronization_and_conflict_resolution_decision.json
site_connectivity_offline_queue_resynchronization_and_conflict_resolution_evidence.json
```
