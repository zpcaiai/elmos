---
name: b17-security-compliance-zero-trust-supply-chain-cont-se-fbc7b4fb
description: "Implement security privacy and tenant isolation for Batch 17: Security、Compliance、Zero Trust、Supply Chain与Continuous Authorization."
---
...
Apply this Skill to **Batch 17: Security、Compliance、Zero Trust、Supply Chain与Continuous Authorization**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `17`
- Domain: `Security、Compliance、Zero Trust、Supply Chain与Continuous Authorization`
...
2. Resolve Batch 17 dependencies and verify prerequisite gates.
...
- supply-chain evidence is verified.
