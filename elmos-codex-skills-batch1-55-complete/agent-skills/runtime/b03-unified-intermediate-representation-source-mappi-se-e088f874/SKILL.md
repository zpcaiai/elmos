---
name: b03-unified-intermediate-representation-source-mappi-se-e088f874
description: "Implement security privacy and tenant isolation for Batch 3: Unified Intermediate Representation与Source Mapping."
---
...
Apply this Skill to **Batch 3: Unified Intermediate Representation与Source Mapping**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `3`
- Domain: `Unified Intermediate Representation与Source Mapping`
...
2. Resolve Batch 3 dependencies and verify prerequisite gates.
...
- IR nodes have stable identity and source maps.
- unknown semantics remain obligations.
