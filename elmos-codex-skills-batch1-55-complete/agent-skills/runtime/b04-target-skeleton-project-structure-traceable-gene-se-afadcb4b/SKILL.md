---
name: b04-target-skeleton-project-structure-traceable-gene-se-afadcb4b
description: "Implement security privacy and tenant isolation for Batch 4: Target Skeleton、Project Structure与Traceable Generation."
---
...
Apply this Skill to **Batch 4: Target Skeleton、Project Structure与Traceable Generation**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `4`
- Domain: `Target Skeleton、Project Structure与Traceable Generation`
...
2. Resolve Batch 4 dependencies and verify prerequisite gates.
...
- generated targets remain traceable to source and IR.
- skeleton generation is idempotent.
- no placeholder is counted as implementation.
