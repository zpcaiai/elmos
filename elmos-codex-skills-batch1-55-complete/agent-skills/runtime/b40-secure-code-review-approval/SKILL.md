---
name: b40-secure-code-review-approval
description: "Implement and verify Batch 40 Skill 1373 for secure code review approval. Use when work requires Secure Code Review和敏感变更审批, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Secure Code Review和敏感变更审批
...
## Skill 1373: Secure Code Review和敏感变更审批
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-secure-code-review-approval`.
...
4. Implement the smallest production-shaped capability that exercises `Secure Code Review和敏感变更审批` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-secure-code-review-approval`
