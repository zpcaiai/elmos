---
name: b43-product-lifecycle-factory
description: "Implement and verify Batch 43 Skill 1435 for product lifecycle factory. Use when work requires 产品版本和生命周期总编排, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-product-lifecycle-factory`.
...
4. Implement the smallest production-shaped capability that exercises `产品版本和生命周期总编排` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-product-lifecycle-factory`
