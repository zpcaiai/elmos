---
name: b45-ecosystem-certification
description: "Implement and verify Batch 45 Skill 1486 for ecosystem certification. Use when work requires SDK、Marketplace和生态认证, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# SDK、Marketplace和生态认证
...
## Skill 1486: SDK、Marketplace和生态认证
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-ecosystem-certification`.
...
4. Implement the smallest production-shaped capability that exercises `SDK、Marketplace和生态认证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-ecosystem-certification`
