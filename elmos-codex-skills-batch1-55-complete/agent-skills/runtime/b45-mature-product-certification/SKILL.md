---
name: b45-mature-product-certification
description: "Implement and verify Batch 45 Skill 1475 for mature product certification. Use when work requires 成熟产品综合认证总编排, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-mature-product-certification`.
...
4. Implement the smallest production-shaped capability that exercises `成熟产品综合认证总编排` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-mature-product-certification`
