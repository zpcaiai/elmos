---
name: b35-security-authorization-properties
description: "Implement security property verification for authentication authorization tenancy noninterference information flow abuse cases and denied-action side effects."
---
...
## Skill 1276: b35-security-authorization-properties

## Use this skill when

- Authentication, authorization, tenancy, or information flow must be proven against adversarial cases.

## Domain-specific risks and invariants

- Route-only tests miss service, data, cache, message, and job authorization.

## Workflow

1. Build principal-resource-action-context matrices from policies and contracts.
2. Generate allow, deny, anonymous, expired, cross-tenant, escalation, confused-deputy, and indirect side-effect cases.
3. Verify response, data, message, cache, audit, and external-call noninterference.
4. Use static policy analysis plus real runtime tests.
5. Add mutation operators for missing or weakened checks.
6. Require zero critical violations.
...
- Generate and execute principal-resource-action-context matrices, adversarial sequences, and cross-tenant isolation properties.
...
- Security property specs, authorization matrices, negative cases, information-flow findings, and zero-tolerance gate evidence.
