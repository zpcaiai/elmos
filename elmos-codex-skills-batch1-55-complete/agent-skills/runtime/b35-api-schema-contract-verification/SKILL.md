---
name: b35-api-schema-contract-verification
description: "Verify API event schema serialization compatibility consumer obligations negative cases and version evolution across source target and coexistence windows."
---
...
## Skill 1274: b35-api-schema-contract-verification

## Use this skill when

- Public APIs, events, schemas, and generated clients must remain compatible.

## Domain-specific risks and invariants

- Schema compatibility can pass while runtime semantics fail.

## Workflow

1. Inventory exact contract versions, producers, consumers, clients, error schemas, defaults, and security.
2. Run static compatibility checks.
3. Generate positive and negative consumer/provider tests.
4. Execute real source and target implementations and generated clients.
5. Verify version evolution and coexistence windows.
6. Block unowned consumers or unknown breaking changes.
...
- Check OpenAPI, AsyncAPI, JSON Schema, Protobuf, database contracts, error contracts, and generated clients using real implementations.
...
- Contract registry entries, compatibility matrices, producer/consumer results, negative tests, and breaking-change reports.
