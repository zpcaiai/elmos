---
name: talent-development-orchestrator
description: "Implement Batch 43B Talent Acquisition、Learning、Performance与Succession end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Candidate、Requisition、Interview、Offer、Learning、Skill、Goal、Review、Talent Pool与Succession."
---
...
Implement Batch 43B Talent Acquisition、Learning、Performance与Succession end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Candidate、Requisition、Interview、Offer、Learning、Skill、Goal、Review、Talent Pool与Succession.
...
5. Write unresolved domain assumptions to `docs/implementation/talent-development-orchestrator-baseline.md`.
...
```text
talent_development_orchestrator_manifest.json
talent_development_orchestrator_state.json
talent_development_orchestrator_decision.json
talent_development_orchestrator_reconciliation.json
talent_development_orchestrator_evidence.json
```
