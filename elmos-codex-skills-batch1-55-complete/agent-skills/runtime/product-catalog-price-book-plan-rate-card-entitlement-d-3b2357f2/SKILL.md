---
name: product-catalog-price-book-plan-rate-card-entitlement-d-3b2357f2
description: "Implement versioned products, SKUs, features, plans, price books, rate cards, tiers, entitlements, discounts, promotions, floors, approvals and effective dating."
---
...
Implement versioned products, SKUs, features, plans, price books, rate cards, tiers, entitlements, discounts, promotions, floors, approvals and effective dating.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/product-catalog-price-book-plan-rate-card-entitlement-discount-and-promotion-baseline.md`.
...
```text
product_catalog_price_book_plan_rate_card_entitlement_discount_and_promotion_manifest.json
product_catalog_price_book_plan_rate_card_entitlement_discount_and_promotion_decision.json
product_catalog_price_book_plan_rate_card_entitlement_discount_and_promotion_reconciliation.json
product_catalog_price_book_plan_rate_card_entitlement_discount_and_promotion_evidence.json
```
...
```text
activePriceVersionIsImmutable
quoteBindsExactPriceSnapshot
taxIsNotDiscount
