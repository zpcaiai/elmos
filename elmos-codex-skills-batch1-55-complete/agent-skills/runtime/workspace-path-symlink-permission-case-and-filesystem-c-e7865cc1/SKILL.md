---
name: workspace-path-symlink-permission-case-and-filesystem-c-e7865cc1
description: "Implement path, symlink, hardlink, permission, executable-bit, case sensitivity, line-ending, Unicode, long-path, and filesystem compatibility controls."
---
...
Implement path, symlink, hardlink, permission, executable-bit, case sensitivity, line-ending, Unicode, long-path, and filesystem compatibility controls.

This Skill belongs to **Batch 35C** and must extend the approved ELMOS domain rather than create parallel Tenant, Identity, Artifact, Policy, Workflow, Audit, Contract or Finding aggregates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/workspace-path-symlink-permission-case-and-filesystem-compatibility-baseline.md`.
...
```text
workspace_path_symlink_permission_case_and_filesystem_compatibility_manifest.json
workspace_path_symlink_permission_case_and_filesystem_compatibility_decision.json
workspace_path_symlink_permission_case_and_filesystem_compatibility_evidence.json
```
