---
name: marketing-growth-security-privacy-quality-performance-c-8ca94736
description: "Implement Batch 40B Marketing、Growth与Customer Engagement security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Campaign、Audience、Journey、Attribution、Experiment、Content、Lifecycle Messaging、Consent Activation与Marketing Operations."
---
...
Implement Batch 40B Marketing、Growth与Customer Engagement security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Campaign、Audience、Journey、Attribution、Experiment、Content、Lifecycle Messaging、Consent Activation与Marketing Operations.
...
Implement the domain model, lifecycle, APIs, events, workflows, policy controls, provider adapters, evidence, analytics, operations and release gates required for **Batch 40B: Marketing、Growth与Customer Engagement**.

Theme:

```text
Campaign、Audience、Journey、Attribution、Experiment、Content、Lifecycle Messaging、Consent Activation与Marketing Operations
```
...
5. Write unresolved domain assumptions to `docs/implementation/marketing-growth-security-privacy-quality-performance-chaos-and-release-gates-baseline.md`.

## Required Capabilities

- Implement Campaign、Audience、Journey、Attribution、Experiment、Content、Lifecycle Messaging、Consent Activation与Marketing Operations without weakening earlier identity, evidence, policy, finance, privacy or tenant-isolation controls.
...
```text
audience→consent→campaign→journey→interaction→conversion→attribution→learning
```
...
```text
marketing_growth_security_privacy_quality_performance_chaos_and_release_gates_manifest.json
marketing_growth_security_privacy_quality_performance_chaos_and_release_gates_state.json
marketing_growth_security_privacy_quality_performance_chaos_and_release_gates_decision.json
marketing_growth_security_privacy_quality_performance_chaos_and_release_gates_reconciliation.json
marketing_growth_security_privacy_quality_performance_chaos_and_release_gates_evidence.json
```
...
- Audience Membership有As-of
- Attribution不等于因果
- Outbound必须校验Consent
- Experiment Assignment稳定
- Marketing Automation不能修改合同价格
...
```text
campaignIdentityIsStable
campaignLifecycleIsVersioned
audienceIdentityIsStable
audienceLifecycleIsVersioned
segmentIdentityIsStable
segmentLifecycleIsVersioned
journeyIdentityIsStable
journeyLifecycleIsVersioned
