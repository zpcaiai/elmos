---
name: b28-manifest-driven-enterprise-platform-domain-28-secur-41ad6125
description: "Implement security privacy and tenant isolation for Batch 28: Manifest-driven Enterprise Platform Domain 28."
---
...
Apply this Skill to **Batch 28: Manifest-driven Enterprise Platform Domain 28**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `28`
- Domain: `Manifest-driven Enterprise Platform Domain 28`
...
2. Resolve Batch 28 dependencies and verify prerequisite gates.
...
- load and verify the installed Batch manifest before implementation.
- preserve source evidence and unknown states.
- do not claim production completion without executed release evidence.
