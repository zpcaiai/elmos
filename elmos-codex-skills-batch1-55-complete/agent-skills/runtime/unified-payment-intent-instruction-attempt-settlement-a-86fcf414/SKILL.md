...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/unified-payment-intent-instruction-attempt-settlement-and-cash-movement-domain-baseline.md`.
