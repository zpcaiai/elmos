---
name: core-hr-intake-ingestion-connector-sync-and-idempotency
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-intake-ingestion-connector-sync-and-idempotency-baseline.md`.
...
```text
core_hr_intake_ingestion_connector_sync_and_idempotency_manifest.json
core_hr_intake_ingestion_connector_sync_and_idempotency_state.json
core_hr_intake_ingestion_connector_sync_and_idempotency_decision.json
core_hr_intake_ingestion_connector_sync_and_idempotency_reconciliation.json
core_hr_intake_ingestion_connector_sync_and_idempotency_evidence.json
```
