---
name: governance-operations-cockpit-sla-calendar-risk-board-a-901c8f2d
description: "Implement governance operations dashboards for obligations, cross-border conflicts, calendar risk, owners, filings, notifications, training, board actions, examinations, cases, records, SLOs, forecasts, and reports."
---
...
Implement governance operations dashboards for obligations, cross-border conflicts, calendar risk, owners, filings, notifications, training, board actions, examinations, cases, records, SLOs, forecasts, and reports.

This Skill belongs to **Batch 38C** and must extend the approved ELMOS domain rather than create parallel Tenant, Identity, Artifact, Policy, Workflow, Audit, Contract or Finding aggregates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/governance-operations-cockpit-sla-calendar-risk-board-and-regulator-reporting-baseline.md`.
...
```text
governance_operations_cockpit_sla_calendar_risk_board_and_regulator_reporting_manifest.json
governance_operations_cockpit_sla_calendar_risk_board_and_regulator_reporting_decision.json
governance_operations_cockpit_sla_calendar_risk_board_and_regulator_reporting_evidence.json
```
