---
name: user-membership-role-permission-and-resource-authorization
description: "Implement users, memberships, roles, permissions, policy bindings, resource authorization, field-level permissions, default deny, and decision evidence."
---
...
Implement users, memberships, roles, permissions, policy bindings, resource authorization, field-level permissions, default deny, and decision evidence.
...
4. Record unresolved provider/version assumptions in `docs/implementation/user-membership-role-permission-and-resource-authorization-baseline.md`.
...
```text
user_membership_role_permission_and_resource_authorization_manifest.json
user_membership_role_permission_and_resource_authorization_decision.json
user_membership_role_permission_and_resource_authorization_evidence.json
```
