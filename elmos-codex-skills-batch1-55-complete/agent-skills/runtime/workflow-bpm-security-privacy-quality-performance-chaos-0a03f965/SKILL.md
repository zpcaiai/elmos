---
name: workflow-bpm-security-privacy-quality-performance-chaos-0a03f965
description: "Implement Batch 46B Workflow、BPM、Case与Low-code Automation security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work."
---

# Workflow BPM Security Privacy Quality Performance Chaos And Release Gates

## Objective

Implement Batch 46B Workflow、BPM、Case与Low-code Automation security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work.
...
Implement the domain model, lifecycle, APIs, events, workflows, policy controls, provider adapters, evidence, analytics, operations and release gates required for **Batch 46B: Workflow、BPM、Case与Low-code Automation**.

Theme:

```text
Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work
```
...
5. Write unresolved domain assumptions to `docs/implementation/workflow-bpm-security-privacy-quality-performance-chaos-and-release-gates-baseline.md`.

## Required Capabilities

- Implement Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work without weakening earlier identity, evidence, policy, finance, privacy or tenant-isolation controls.
...
```text
model→validate→deploy→execute→escalate→compensate→audit→improve
```
...
```text
workflow_bpm_security_privacy_quality_performance_chaos_and_release_gates_manifest.json
workflow_bpm_security_privacy_quality_performance_chaos_and_release_gates_state.json
workflow_bpm_security_privacy_quality_performance_chaos_and_release_gates_decision.json
workflow_bpm_security_privacy_quality_performance_chaos_and_release_gates_reconciliation.json
workflow_bpm_security_privacy_quality_performance_chaos_and_release_gates_evidence.json
```
...
```text
processIdentityIsStable
processLifecycleIsVersioned
taskIdentityIsStable
taskLifecycleIsVersioned
caseIdentityIsStable
caseLifecycleIsVersioned
formIdentityIsStable
formLifecycleIsVersioned
