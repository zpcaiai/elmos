---
name: github-webhook-polling-event-dedup-and-reconciliation
description: "Implement signed webhook ingestion, polling, watermarks, backfill, deduplication, ordering, missed-event detection, and reconciliation."
---
...
Implement signed webhook ingestion, polling, watermarks, backfill, deduplication, ordering, missed-event detection, and reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-webhook-polling-event-dedup-and-reconciliation-baseline.md`.
...
```text
github_webhook_polling_event_dedup_and_reconciliation_manifest.json
github_webhook_polling_event_dedup_and_reconciliation_decision.json
github_webhook_polling_event_dedup_and_reconciliation_evidence.json
```
