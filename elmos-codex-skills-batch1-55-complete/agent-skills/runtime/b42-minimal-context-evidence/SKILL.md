---
name: b42-minimal-context-evidence
description: "Implement and verify Batch 42 Skill 1423 for minimal context evidence. Use when work requires 最小Context和Evidence构建, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 最小Context和Evidence构建
...
## Skill 1423: 最小Context和Evidence构建
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b42-minimal-context-evidence`.
...
4. Implement the smallest production-shaped capability that exercises `最小Context和Evidence构建` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b42-minimal-context-evidence`
