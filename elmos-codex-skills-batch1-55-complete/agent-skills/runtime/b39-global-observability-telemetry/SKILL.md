---
name: b39-global-observability-telemetry
description: "Implement and verify Batch 39 Skill 1350 for global observability telemetry. Use when work requires 全局Metrics、Logs、Traces和业务Telemetry, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 全局Metrics、Logs、Traces和业务Telemetry
...
## Skill 1350: 全局Metrics、Logs、Traces和业务Telemetry
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-global-observability-telemetry`.
...
4. Implement the smallest production-shaped capability that exercises `全局Metrics、Logs、Traces和业务Telemetry` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-global-observability-telemetry`
