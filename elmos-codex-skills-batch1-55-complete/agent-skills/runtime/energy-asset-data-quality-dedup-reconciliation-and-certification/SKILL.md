---
name: energy-asset-data-quality-dedup-reconciliation-and-certification
description: "Implement Batch 53C Energy Asset、Field Service、Reliability与Sustainability quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Asset、Inspection、Work Order、Crew、Permit、Outage、Reliability Metric、Emission、Maintenance与Safety Case."
---

# Energy Asset Data Quality Dedup Reconciliation And Certification

## Objective

Implement Batch 53C Energy Asset、Field Service、Reliability与Sustainability quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Asset、Inspection、Work Order、Crew、Permit、Outage、Reliability Metric、Emission、Maintenance与Safety Case.
...
5. Write unresolved domain assumptions to `docs/implementation/energy-asset-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
energy_asset_data_quality_dedup_reconciliation_and_certification_manifest.json
energy_asset_data_quality_dedup_reconciliation_and_certification_state.json
energy_asset_data_quality_dedup_reconciliation_and_certification_decision.json
energy_asset_data_quality_dedup_reconciliation_and_certification_reconciliation.json
energy_asset_data_quality_dedup_reconciliation_and_certification_evidence.json
```
