---
name: regulator-portal-correspondence-submission-provider-and-a21d7de9
description: "Implement provider-neutral regulatory delivery adapters for APIs, XBRL collectors, SFTP, secure email, assisted portals and manual delivery with credentials, receipts, human handoff, and reconciliation."
---
...
Implement provider-neutral regulatory delivery adapters for APIs, XBRL collectors, SFTP, secure email, assisted portals and manual delivery with credentials, receipts, human handoff, and reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/regulator-portal-correspondence-submission-provider-and-delivery-adapters-baseline.md`.
...
```text
regulator_portal_correspondence_submission_provider_and_delivery_adapters_manifest.json
regulator_portal_correspondence_submission_provider_and_delivery_adapters_decision.json
regulator_portal_correspondence_submission_provider_and_delivery_adapters_evidence.json
```
