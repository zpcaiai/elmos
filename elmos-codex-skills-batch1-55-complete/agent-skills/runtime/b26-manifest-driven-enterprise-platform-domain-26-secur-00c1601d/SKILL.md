---
name: b26-manifest-driven-enterprise-platform-domain-26-secur-00c1601d
description: "Implement security privacy and tenant isolation for Batch 26: Manifest-driven Enterprise Platform Domain 26."
---
...
Apply this Skill to **Batch 26: Manifest-driven Enterprise Platform Domain 26**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `26`
- Domain: `Manifest-driven Enterprise Platform Domain 26`
...
2. Resolve Batch 26 dependencies and verify prerequisite gates.
