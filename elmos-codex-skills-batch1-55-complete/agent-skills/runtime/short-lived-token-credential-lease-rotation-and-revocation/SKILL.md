---
name: short-lived-token-credential-lease-rotation-and-revocation
description: "Implement short-lived tokens and credential leases with purpose binding, TTL, renewal, use tracking, rotation, revocation, and zeroization evidence."
---
...
Implement short-lived tokens and credential leases with purpose binding, TTL, renewal, use tracking, rotation, revocation, and zeroization evidence.
...
4. Record unresolved provider/version assumptions in `docs/implementation/short-lived-token-credential-lease-rotation-and-revocation-baseline.md`.
...
```text
short_lived_token_credential_lease_rotation_and_revocation_manifest.json
short_lived_token_credential_lease_rotation_and_revocation_decision.json
short_lived_token_credential_lease_rotation_and_revocation_evidence.json
```
