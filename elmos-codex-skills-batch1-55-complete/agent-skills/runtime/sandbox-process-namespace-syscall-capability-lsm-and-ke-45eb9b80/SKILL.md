---
name: sandbox-process-namespace-syscall-capability-lsm-and-ke-45eb9b80
description: "Implement process supervision, namespaces, UID/GID, capability drop, no_new_privs, seccomp, AppArmor, SELinux, Landlock, signals, and core-dump controls."
---
...
Implement process supervision, namespaces, UID/GID, capability drop, no_new_privs, seccomp, AppArmor, SELinux, Landlock, signals, and core-dump controls.
...
4. Record unresolved provider/version assumptions in `docs/implementation/sandbox-process-namespace-syscall-capability-lsm-and-kernel-surface-baseline.md`.
...
```text
sandbox_process_namespace_syscall_capability_lsm_and_kernel_surface_manifest.json
sandbox_process_namespace_syscall_capability_lsm_and_kernel_surface_decision.json
sandbox_process_namespace_syscall_capability_lsm_and_kernel_surface_evidence.json
```
