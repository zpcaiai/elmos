---
name: b08-repository-aware-agent-context-rag-human-escalat-se-474231d5
description: "Implement security privacy and tenant isolation for Batch 8: Repository-aware Agent、Context、RAG与Human Escalation."
---
...
Apply this Skill to **Batch 8: Repository-aware Agent、Context、RAG与Human Escalation**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `8`
- Domain: `Repository-aware Agent、Context、RAG与Human Escalation`
...
2. Resolve Batch 8 dependencies and verify prerequisite gates.
...
- agent loops, token cost and side effects are bounded.
