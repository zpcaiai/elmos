---
name: responsible-ai-security-privacy-quality-performance-cha-99d7e985
description: "Implement Batch 45C Responsible AI、Safety、Governance与Compliance security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval."
---
...
Implement Batch 45C Responsible AI、Safety、Governance与Compliance security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval.
...
Implement the domain model, lifecycle, APIs, events, workflows, policy controls, provider adapters, evidence, analytics, operations and release gates required for **Batch 45C: Responsible AI、Safety、Governance与Compliance**.

Theme:

```text
AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval
```
...
5. Write unresolved domain assumptions to `docs/implementation/responsible-ai-security-privacy-quality-performance-chaos-and-release-gates-baseline.md`.

## Required Capabilities

- Implement AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval without weakening earlier identity, evidence, policy, finance, privacy or tenant-isolation controls.
...
```text
register→classify→assess→test→approve→monitor→incident→reassess
```
...
```text
responsible_ai_security_privacy_quality_performance_chaos_and_release_gates_manifest.json
responsible_ai_security_privacy_quality_performance_chaos_and_release_gates_state.json
responsible_ai_security_privacy_quality_performance_chaos_and_release_gates_decision.json
responsible_ai_security_privacy_quality_performance_chaos_and_release_gates_reconciliation.json
responsible_ai_security_privacy_quality_performance_chaos_and_release_gates_evidence.json
```
...
```text
aiUseCaseIdentityIsStable
aiUseCaseLifecycleIsVersioned
riskAssessmentIdentityIsStable
riskAssessmentLifecycleIsVersioned
modelCardIdentityIsStable
modelCardLifecycleIsVersioned
datasetCardIdentityIsStable
datasetCardLifecycleIsVersioned
