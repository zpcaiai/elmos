---
name: manufacturing-mes-orchestrator
description: "Implement Batch 50A Manufacturing MES、Production Planning与Shop-floor Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Material、BOM、Routing、Work Order、Operation、Machine、Operator、Production Event、Downtime与Output."
---

# Manufacturing MES Orchestrator

## Objective

Implement Batch 50A Manufacturing MES、Production Planning与Shop-floor Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Material、BOM、Routing、Work Order、Operation、Machine、Operator、Production Event、Downtime与Output.
...
5. Write unresolved domain assumptions to `docs/implementation/manufacturing-mes-orchestrator-baseline.md`.
...
```text
manufacturing_mes_orchestrator_manifest.json
manufacturing_mes_orchestrator_state.json
manufacturing_mes_orchestrator_decision.json
manufacturing_mes_orchestrator_reconciliation.json
manufacturing_mes_orchestrator_evidence.json
```
