---
name: bi-semantic-automation-copilot-recommendation-and-human-review
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-automation-copilot-recommendation-and-human-review-baseline.md`.
...
```text
bi_semantic_automation_copilot_recommendation_and_human_review_manifest.json
bi_semantic_automation_copilot_recommendation_and_human_review_state.json
bi_semantic_automation_copilot_recommendation_and_human_review_decision.json
bi_semantic_automation_copilot_recommendation_and_human_review_reconciliation.json
bi_semantic_automation_copilot_recommendation_and_human_review_evidence.json
```
