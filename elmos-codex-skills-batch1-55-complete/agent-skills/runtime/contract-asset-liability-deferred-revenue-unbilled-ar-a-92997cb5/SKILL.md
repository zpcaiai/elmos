---
name: contract-asset-liability-deferred-revenue-unbilled-ar-a-92997cb5
description: "Implement billing and revenue subledgers, contract assets and liabilities, deferred revenue, unbilled AR, journal rules, accounting periods, posting and GL export."
---
...
Implement billing and revenue subledgers, contract assets and liabilities, deferred revenue, unbilled AR, journal rules, accounting periods, posting and GL export.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/contract-asset-liability-deferred-revenue-unbilled-ar-and-financial-subledger-baseline.md`.
...
```text
contract_asset_liability_deferred_revenue_unbilled_ar_and_financial_subledger_manifest.json
contract_asset_liability_deferred_revenue_unbilled_ar_and_financial_subledger_decision.json
contract_asset_liability_deferred_revenue_unbilled_ar_and_financial_subledger_reconciliation.json
contract_asset_liability_deferred_revenue_unbilled_ar_and_financial_subledger_evidence.json
```
...
```text
signedContractIsImmutable
amendmentPreservesOriginalContract
backdatedChangeRequiresImpactReview
invoiceDateDoesNotDriveRevenueAlone
allocationUsesRelativeSsp
postedRevenueIsNotOverwritten
journalEntryBalances
postedJournalCannotBeDeleted
