---
name: revenue-bridge-new-expansion-contraction-churn-reactiva-2ff9845b
description: "Implement deterministic recurring-revenue bridges, movement classification, precedence, contract migrations, FX separation, reconciliation and drill-down."
---
...
Implement deterministic recurring-revenue bridges, movement classification, precedence, contract migrations, FX separation, reconciliation and drill-down.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/revenue-bridge-new-expansion-contraction-churn-reactivation-and-fx-waterfall-baseline.md`.
...
```text
revenue_bridge_new_expansion_contraction_churn_reactivation_and_fx_waterfall_manifest.json
revenue_bridge_new_expansion_contraction_churn_reactivation_and_fx_waterfall_decision.json
revenue_bridge_new_expansion_contraction_churn_reactivation_and_fx_waterfall_reconciliation.json
revenue_bridge_new_expansion_contraction_churn_reactivation_and_fx_waterfall_evidence.json
```
