...
description: "Implement and verify Batch 39 Skill 1347 for global sre operations factory. Use when work requires 全球SRE和平台运营总编排, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-global-sre-operations-factory`.
...
4. Implement the smallest production-shaped capability that exercises `全球SRE和平台运营总编排` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-global-sre-operations-factory`
