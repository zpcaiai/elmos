---
name: b35-coverage-guided-fuzzing
description: "Implement coverage-guided structured fuzzing with grammar schema corpus minimization sanitizer integration crash triage and deterministic replay for migration boundaries."
---
...
## Skill 1270: b35-coverage-guided-fuzzing

## Use this skill when

- Parsers, APIs, serializers, generated code, protocols, or native boundaries need adversarial input exploration.

## Domain-specific risks and invariants

- Fuzzing can leak customer data or exhaust shared environments.
- Crash deduplication can hide distinct root causes.

## Workflow

1. Choose structured targets, harness boundaries, sanitizers, coverage signals, seed corpora, dictionaries, and resource limits.
2. Generate or adapt grammar/schema-aware harnesses.
3. Run isolated coverage-guided campaigns with deterministic environment manifests.
4. Classify crash, hang, OOM, timeout, sanitizer, and business-invariant failures.
5. Minimize and replay findings on source and target.
6. Add repaired cases to regression and untouched holdout campaigns.
...
- Fuzz parsers, adapters, APIs, serializers, generated code, protocol handlers, file formats, and native boundaries under strict resource and data policies.
...
- Fuzz campaign definitions, seed corpus, dictionaries, crashes, hangs, coverage deltas, minimized reproducers, and fixes.
