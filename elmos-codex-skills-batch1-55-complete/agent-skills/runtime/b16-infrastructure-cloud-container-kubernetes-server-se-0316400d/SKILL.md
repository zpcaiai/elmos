---
name: b16-infrastructure-cloud-container-kubernetes-server-se-0316400d
description: "Implement security privacy and tenant isolation for Batch 16: Infrastructure、Cloud、Container、Kubernetes、Serverless与FinOps."
---
...
Apply this Skill to **Batch 16: Infrastructure、Cloud、Container、Kubernetes、Serverless与FinOps**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `16`
- Domain: `Infrastructure、Cloud、Container、Kubernetes、Serverless与FinOps`
...
2. Resolve Batch 16 dependencies and verify prerequisite gates.
...
- Kubernetes is not the universal default.
- IaC changes are plan-first.
- backup success does not equal restore validation.
