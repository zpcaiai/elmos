---
name: b05-core-language-translation-type-control-flow-null-wo-ec7b7771
description: "Implement workflow and state machine for Batch 5: Core Language Translation、Type／Control-flow／Null Semantics."
---

# Objective

Implement lifecycle states, legal transitions, terminal states, retries and compensation rules.
...
- Role: `workflow-and-state-machine`
...
4. Build the smallest end-to-end vertical slice for `workflow-and-state-machine`.
