---
name: workflow-bpm-automation-copilot-recommendation-and-human-review
description: "Implement Batch 46B Workflow、BPM、Case与Low-code Automation typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work."
---

# Workflow BPM Automation Copilot Recommendation And Human Review

## Objective

Implement Batch 46B Workflow、BPM、Case与Low-code Automation typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work.
...
5. Write unresolved domain assumptions to `docs/implementation/workflow-bpm-automation-copilot-recommendation-and-human-review-baseline.md`.
...
```text
workflow_bpm_automation_copilot_recommendation_and_human_review_manifest.json
workflow_bpm_automation_copilot_recommendation_and_human_review_state.json
workflow_bpm_automation_copilot_recommendation_and_human_review_decision.json
workflow_bpm_automation_copilot_recommendation_and_human_review_reconciliation.json
workflow_bpm_automation_copilot_recommendation_and_human_review_evidence.json
```
