---
name: bi-semantic-provider-adapters-versioning-compatibility-fc064daa
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence provider adapters, capability discovery, API and schema versions, compatibility, migration and deprecation, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence provider adapters, capability discovery, API and schema versions, compatibility, migration and deprecation, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-provider-adapters-versioning-compatibility-and-migration-baseline.md`.
...
```text
bi_semantic_provider_adapters_versioning_compatibility_and_migration_manifest.json
bi_semantic_provider_adapters_versioning_compatibility_and_migration_state.json
bi_semantic_provider_adapters_versioning_compatibility_and_migration_decision.json
bi_semantic_provider_adapters_versioning_compatibility_and_migration_reconciliation.json
bi_semantic_provider_adapters_versioning_compatibility_and_migration_evidence.json
```
