---
name: customer-crm-revenue-operations-orchestrator
description: "Implement Batch 40A end to end: customer identity, consent, leads, opportunities, pipeline, territory, quota, forecasts, customer success, renewals, support, Customer 360, RevOps automation, provider connectors and release gates."
---
...
Implement Batch 40A end to end: customer identity, consent, leads, opportunities, pipeline, territory, quota, forecasts, customer success, renewals, support, Customer 360, RevOps automation, provider connectors and release gates.
...
5. Write unresolved domain assumptions to `docs/implementation/customer-crm-revenue-operations-orchestrator-baseline.md`.
...
```text
customer_crm_revenue_operations_orchestrator_manifest.json
customer_crm_revenue_operations_orchestrator_state.json
customer_crm_revenue_operations_orchestrator_decision.json
customer_crm_revenue_operations_orchestrator_reconciliation.json
customer_crm_revenue_operations_orchestrator_evidence.json
```
...
customerCrmRevenueOperationsOrchestratorPreservesSourceLineage
