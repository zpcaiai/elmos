---
name: deployment-gate-artifact-provenance-sbom-test-risk-and-c45b1ad8
description: "Implement digest-bound deployment gates using provenance, signatures, SBOM, vulnerabilities, tests, performance, freshness, exceptions, environment, target, and post-deploy verification."
---
...
Implement digest-bound deployment gates using provenance, signatures, SBOM, vulnerabilities, tests, performance, freshness, exceptions, environment, target, and post-deploy verification.
...
4. Record unresolved provider/version assumptions in `docs/implementation/deployment-gate-artifact-provenance-sbom-test-risk-and-environment-admission-baseline.md`.
...
```text
deployment_gate_artifact_provenance_sbom_test_risk_and_environment_admission_manifest.json
deployment_gate_artifact_provenance_sbom_test_risk_and_environment_admission_decision.json
deployment_gate_artifact_provenance_sbom_test_risk_and_environment_admission_evidence.json
```
