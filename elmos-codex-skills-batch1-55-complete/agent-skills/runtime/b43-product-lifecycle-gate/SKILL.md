---
name: b43-product-lifecycle-gate
description: "Implement and verify Batch 43 Skill 1454 for product lifecycle gate. Use when work requires Batch 43产品生命周期质量门禁, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-product-lifecycle-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 43产品生命周期质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-product-lifecycle-gate`
