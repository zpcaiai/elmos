---
name: b24-manifest-driven-enterprise-platform-domain-24-secur-5d7a5e34
description: "Implement security privacy and tenant isolation for Batch 24: Manifest-driven Enterprise Platform Domain 24."
---
...
Apply this Skill to **Batch 24: Manifest-driven Enterprise Platform Domain 24**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `24`
- Domain: `Manifest-driven Enterprise Platform Domain 24`
...
2. Resolve Batch 24 dependencies and verify prerequisite gates.
