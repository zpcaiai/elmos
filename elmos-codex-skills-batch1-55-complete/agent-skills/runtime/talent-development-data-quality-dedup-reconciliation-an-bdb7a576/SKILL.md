---
name: talent-development-data-quality-dedup-reconciliation-an-bdb7a576
description: "Implement Batch 43B Talent Acquisition、Learning、Performance与Succession quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Candidate、Requisition、Interview、Offer、Learning、Skill、Goal、Review、Talent Pool与Succession."
---
...
Implement Batch 43B Talent Acquisition、Learning、Performance与Succession quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Candidate、Requisition、Interview、Offer、Learning、Skill、Goal、Review、Talent Pool与Succession.
...
5. Write unresolved domain assumptions to `docs/implementation/talent-development-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
talent_development_data_quality_dedup_reconciliation_and_certification_manifest.json
talent_development_data_quality_dedup_reconciliation_and_certification_state.json
talent_development_data_quality_dedup_reconciliation_and_certification_decision.json
talent_development_data_quality_dedup_reconciliation_and_certification_reconciliation.json
talent_development_data_quality_dedup_reconciliation_and_certification_evidence.json
```
