---
name: repository-workspace-orchestrator
description: "Implement advanced repository workspace creation, immutable snapshot inputs, materialization, caching, multi-repository composition, cleanup, and evidence."
---
...
Implement advanced repository workspace creation, immutable snapshot inputs, materialization, caching, multi-repository composition, cleanup, and evidence.
...
4. Record unresolved provider/version assumptions in `docs/implementation/repository-workspace-orchestrator-baseline.md`.
...
```text
repository_workspace_orchestrator_manifest.json
repository_workspace_orchestrator_decision.json
repository_workspace_orchestrator_evidence.json
```
