---
name: payment-routing-orchestration-fee-sla-retry-idempotency-04d13478
description: "Implement explainable payment routing, provider scoring, fees, FX, risk, limits, SLA, retry classification, idempotency, circuit breakers and duplicate-safe failover."
---
...
Implement explainable payment routing, provider scoring, fees, FX, risk, limits, SLA, retry classification, idempotency, circuit breakers and duplicate-safe failover.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/payment-routing-orchestration-fee-sla-retry-idempotency-and-failover-baseline.md`.
...
```text
payment_routing_orchestration_fee_sla_retry_idempotency_and_failover_manifest.json
payment_routing_orchestration_fee_sla_retry_idempotency_and_failover_decision.json
payment_routing_orchestration_fee_sla_retry_idempotency_and_failover_reconciliation.json
payment_routing_orchestration_fee_sla_retry_idempotency_and_failover_evidence.json
```
...
routingIsExplainable
submittedUnknownBlocksBlindFailover
providerTokenCompatibilityIsChecked
