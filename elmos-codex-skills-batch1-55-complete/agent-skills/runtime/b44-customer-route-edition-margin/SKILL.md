---
name: b44-customer-route-edition-margin
description: "Implement and verify Batch 44 Skill 1467 for customer route edition margin. Use when work requires 客户、项目、路线和Edition毛利, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-customer-route-edition-margin`.
...
4. Implement the smallest production-shaped capability that exercises `客户、项目、路线和Edition毛利` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-customer-route-edition-margin`
