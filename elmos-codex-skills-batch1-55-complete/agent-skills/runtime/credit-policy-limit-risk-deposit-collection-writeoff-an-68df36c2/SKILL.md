---
name: credit-policy-limit-risk-deposit-collection-writeoff-an-68df36c2
description: "Implement customer credit profiles, limits, risk signals, guarantees, deposits, overrides, collection cases, legal escalation, write-offs and bad-debt accounting."
---
...
Implement customer credit profiles, limits, risk signals, guarantees, deposits, overrides, collection cases, legal escalation, write-offs and bad-debt accounting.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/credit-policy-limit-risk-deposit-collection-writeoff-and-bad-debt-baseline.md`.
...
```text
credit_policy_limit_risk_deposit_collection_writeoff_and_bad_debt_manifest.json
credit_policy_limit_risk_deposit_collection_writeoff_and_bad_debt_decision.json
credit_policy_limit_risk_deposit_collection_writeoff_and_bad_debt_reconciliation.json
credit_policy_limit_risk_deposit_collection_writeoff_and_bad_debt_evidence.json
```
