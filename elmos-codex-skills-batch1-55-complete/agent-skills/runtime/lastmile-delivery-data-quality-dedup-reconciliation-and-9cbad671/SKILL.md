---
name: lastmile-delivery-data-quality-dedup-reconciliation-and-9cbad671
description: "Implement Batch 51B Warehouse、Last-mile、Delivery与Returns quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return."
---

# Lastmile Delivery Data Quality Dedup Reconciliation And Certification

## Objective

Implement Batch 51B Warehouse、Last-mile、Delivery与Returns quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return.
...
5. Write unresolved domain assumptions to `docs/implementation/lastmile-delivery-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
lastmile_delivery_data_quality_dedup_reconciliation_and_certification_manifest.json
lastmile_delivery_data_quality_dedup_reconciliation_and_certification_state.json
lastmile_delivery_data_quality_dedup_reconciliation_and_certification_decision.json
lastmile_delivery_data_quality_dedup_reconciliation_and_certification_reconciliation.json
lastmile_delivery_data_quality_dedup_reconciliation_and_certification_evidence.json
```
