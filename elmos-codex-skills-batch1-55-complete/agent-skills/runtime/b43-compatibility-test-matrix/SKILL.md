---
name: b43-compatibility-test-matrix
description: "Implement and verify Batch 43 Skill 1452 for compatibility test matrix. Use when work requires 全版本Compatibility Test Matrix, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 全版本Compatibility Test Matrix
...
## Skill 1452: 全版本Compatibility Test Matrix
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-compatibility-test-matrix`.
...
4. Implement the smallest production-shaped capability that exercises `全版本Compatibility Test Matrix` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-compatibility-test-matrix`
