---
name: focus-cost-ingestion-shared-cost-allocation-showback-ch-e447c8d0
description: "Implement FOCUS and vendor-cost ingestion, direct assignment, shared pools, allocation drivers, showback, chargeback, unit costs and reconciliation."
---
...
Implement FOCUS and vendor-cost ingestion, direct assignment, shared pools, allocation drivers, showback, chargeback, unit costs and reconciliation.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/focus-cost-ingestion-shared-cost-allocation-showback-chargeback-and-unit-cost-baseline.md`.
...
```text
focus_cost_ingestion_shared_cost_allocation_showback_chargeback_and_unit_cost_manifest.json
focus_cost_ingestion_shared_cost_allocation_showback_chargeback_and_unit_cost_decision.json
focus_cost_ingestion_shared_cost_allocation_showback_chargeback_and_unit_cost_reconciliation.json
focus_cost_ingestion_shared_cost_allocation_showback_chargeback_and_unit_cost_evidence.json
```
