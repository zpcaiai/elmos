---
name: global-trade-orchestrator
description: "Implement Batch 51C Global Trade、Customs、Freight Forwarding与Logistics Finance end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Shipment、Booking、Container、Bill of Lading、Customs Entry、Tariff、Trade Document、Duty、Freight Invoice与Exception."
---
...
Implement Batch 51C Global Trade、Customs、Freight Forwarding与Logistics Finance end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Shipment、Booking、Container、Bill of Lading、Customs Entry、Tariff、Trade Document、Duty、Freight Invoice与Exception.
...
5. Write unresolved domain assumptions to `docs/implementation/global-trade-orchestrator-baseline.md`.
...
```text
global_trade_orchestrator_manifest.json
global_trade_orchestrator_state.json
global_trade_orchestrator_decision.json
global_trade_orchestrator_reconciliation.json
global_trade_orchestrator_evidence.json
```
