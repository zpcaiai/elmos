---
name: task-checkpoint-model-heartbeat-resume-and-compatibility
description: "Implement explicit task checkpoints, progress heartbeats, side-effect fences, artifact-backed state, Temporal bridge, compatibility, resume plans, supersession, and recovery."
---
...
Implement explicit task checkpoints, progress heartbeats, side-effect fences, artifact-backed state, Temporal bridge, compatibility, resume plans, supersession, and recovery.
...
4. Record unresolved provider/version assumptions in `docs/implementation/task-checkpoint-model-heartbeat-resume-and-compatibility-baseline.md`.
...
```text
task_checkpoint_model_heartbeat_resume_and_compatibility_manifest.json
task_checkpoint_model_heartbeat_resume_and_compatibility_decision.json
task_checkpoint_model_heartbeat_resume_and_compatibility_evidence.json
```
