---
name: b05-core-language-translation-type-control-flow-null-co-c284295a
description: "Implement conformance security and chaos tests for Batch 5: Core Language Translation、Type／Control-flow／Null Semantics."
---

# Objective

Implement unit, contract, property, negative, security, concurrency, chaos and recovery tests.
...
- Role: `conformance-security-and-chaos-tests`
...
4. Build the smallest end-to-end vertical slice for `conformance-security-and-chaos-tests`.
