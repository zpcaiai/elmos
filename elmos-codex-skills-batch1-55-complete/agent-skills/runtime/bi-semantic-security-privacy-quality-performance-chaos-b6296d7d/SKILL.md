---
name: bi-semantic-security-privacy-quality-performance-chaos-b6296d7d
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
Implement the domain model, lifecycle, APIs, events, workflows, policy controls, provider adapters, evidence, analytics, operations and release gates required for **Batch 44B: BI、Semantic Metrics与Decision Intelligence**.

Theme:

```text
Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics
```
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-security-privacy-quality-performance-chaos-and-release-gates-baseline.md`.

## Required Capabilities

- Implement Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics without weakening earlier identity, evidence, policy, finance, privacy or tenant-isolation controls.
...
```text
model→define metric→query→visualize→review→decide→monitor→restate
```
...
```text
bi_semantic_security_privacy_quality_performance_chaos_and_release_gates_manifest.json
bi_semantic_security_privacy_quality_performance_chaos_and_release_gates_state.json
bi_semantic_security_privacy_quality_performance_chaos_and_release_gates_decision.json
bi_semantic_security_privacy_quality_performance_chaos_and_release_gates_reconciliation.json
bi_semantic_security_privacy_quality_performance_chaos_and_release_gates_evidence.json
```
...
- Metric有Grain与Denominator
- Dashboard不成为Source of Truth
- Self-service受RLS约束
- Narrative有Source
- Restatement保留历史
...
```text
semanticModelIdentityIsStable
semanticModelLifecycleIsVersioned
metricIdentityIsStable
metricLifecycleIsVersioned
dimensionIdentityIsStable
dimensionLifecycleIsVersioned
dashboardIdentityIsStable
dashboardLifecycleIsVersioned
