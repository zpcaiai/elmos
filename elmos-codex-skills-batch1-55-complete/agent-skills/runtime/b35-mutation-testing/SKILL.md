---
name: b35-mutation-testing
description: "Implement mutation operators, test-strength measurement, equivalent-mutant governance, targeted campaigns, and surviving-critical-mutant escalation for migrated artifacts."
---
...
## Skill 1269: b35-mutation-testing

## Use this skill when

- The team must measure whether migrated tests can detect meaningful defects.

## Domain-specific risks and invariants

- Equivalent mutants can distort scores.
- Unsafe mutants can modify production state.

## Workflow

1. Define language, framework, schema, security, transaction, and domain-specific mutation operators.
2. Map operators to risk tier and protected regions.
3. Run mutants in isolated immutable workspaces using impacted tests first and required full regression.
4. Classify killed, survived, timeout, invalid, and equivalent mutants with evidence.
5. Escalate surviving critical mutants and improve tests or specifications.
6. Run untouched holdout mutants before certification.
...
- Measure whether source, migrated, contract, and behavioral tests detect meaningful defects rather than merely execute code.
...
- Mutation campaign manifests, operator sets, killed/survived/equivalent decisions, mutation scores, and critical survivor reports.
