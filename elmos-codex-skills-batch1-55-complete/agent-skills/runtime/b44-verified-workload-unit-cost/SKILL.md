---
name: b44-verified-workload-unit-cost
description: "Implement and verify Batch 44 Skill 1459 for verified workload unit cost. Use when work requires Verified Migrated Workload单位成本, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Verified Migrated Workload单位成本
...
## Skill 1459: Verified Migrated Workload单位成本
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-verified-workload-unit-cost`.
...
4. Implement the smallest production-shaped capability that exercises `Verified Migrated Workload单位成本` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-verified-workload-unit-cost`
