---
name: agentic-runtime-data-quality-dedup-reconciliation-and-c-91968e69
description: "Implement Batch 45B Agentic AI Runtime、Orchestration、Memory、Tools与Evals quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Agent、Workflow、Tool、Memory、Context、Plan、Execution、Guardrail、Evaluation与Human Handoff."
---
...
Implement Batch 45B Agentic AI Runtime、Orchestration、Memory、Tools与Evals quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Agent、Workflow、Tool、Memory、Context、Plan、Execution、Guardrail、Evaluation与Human Handoff.
...
5. Write unresolved domain assumptions to `docs/implementation/agentic-runtime-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
agentic_runtime_data_quality_dedup_reconciliation_and_certification_manifest.json
agentic_runtime_data_quality_dedup_reconciliation_and_certification_state.json
agentic_runtime_data_quality_dedup_reconciliation_and_certification_decision.json
agentic_runtime_data_quality_dedup_reconciliation_and_certification_reconciliation.json
agentic_runtime_data_quality_dedup_reconciliation_and_certification_evidence.json
```
