---
name: policy-copilot-grounded-rag-drafting-formalization-and-f86dba58
description: "Implement a grounded Policy Copilot for cited Q&A, drafting, IR/rule/test proposals, conflict/regulatory review, abstention, prompt-injection defence, provenance, and human approval."
---
...
Implement a grounded Policy Copilot for cited Q&A, drafting, IR/rule/test proposals, conflict/regulatory review, abstention, prompt-injection defence, provenance, and human approval.
...
4. Record unresolved provider/version assumptions in `docs/implementation/policy-copilot-grounded-rag-drafting-formalization-and-review-assistant-baseline.md`.
...
```text
policy_copilot_grounded_rag_drafting_formalization_and_review_assistant_manifest.json
policy_copilot_grounded_rag_drafting_formalization_and_review_assistant_decision.json
policy_copilot_grounded_rag_drafting_formalization_and_review_assistant_evidence.json
```
