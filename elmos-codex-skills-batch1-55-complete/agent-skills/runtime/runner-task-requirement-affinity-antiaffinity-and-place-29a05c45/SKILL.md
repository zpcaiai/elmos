---
name: runner-task-requirement-affinity-antiaffinity-and-place-29a05c45
description: "Implement task requirements, hard constraints, affinity, anti-affinity, residency, security, locality, preferences, and explainable placement policy."
---
...
Implement task requirements, hard constraints, affinity, anti-affinity, residency, security, locality, preferences, and explainable placement policy.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-task-requirement-affinity-antiaffinity-and-placement-policy-baseline.md`.
...
```text
runner_task_requirement_affinity_antiaffinity_and_placement_policy_manifest.json
runner_task_requirement_affinity_antiaffinity_and_placement_policy_decision.json
runner_task_requirement_affinity_antiaffinity_and_placement_policy_evidence.json
```
