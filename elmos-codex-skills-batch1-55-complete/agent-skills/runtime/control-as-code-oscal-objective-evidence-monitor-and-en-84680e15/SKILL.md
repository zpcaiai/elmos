---
name: control-as-code-oscal-objective-evidence-monitor-and-en-84680e15
description: "Implement Control-as-Code definitions, OSCAL links, objectives, applicability, evidence, policy/monitor/gate/remediation bindings, assessments, POA&M, and effectiveness."
---
...
Implement Control-as-Code definitions, OSCAL links, objectives, applicability, evidence, policy/monitor/gate/remediation bindings, assessments, POA&M, and effectiveness.
...
4. Record unresolved provider/version assumptions in `docs/implementation/control-as-code-oscal-objective-evidence-monitor-and-enforcement-binding-baseline.md`.
...
```text
control_as_code_oscal_objective_evidence_monitor_and_enforcement_binding_manifest.json
control_as_code_oscal_objective_evidence_monitor_and_enforcement_binding_decision.json
control_as_code_oscal_objective_evidence_monitor_and_enforcement_binding_evidence.json
```
