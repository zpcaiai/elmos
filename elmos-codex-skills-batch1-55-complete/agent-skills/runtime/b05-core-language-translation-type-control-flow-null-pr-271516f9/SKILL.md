---
name: b05-core-language-translation-type-control-flow-null-pr-271516f9
description: "Implement provider and tool adapters for Batch 5: Core Language Translation、Type／Control-flow／Null Semantics."
---

# Objective

Implement provider-neutral adapters, capability discovery, version pinning and DTO isolation.
...
- Role: `provider-and-tool-adapters`
...
4. Build the smallest end-to-end vertical slice for `provider-and-tool-adapters`.
