---
name: payroll-workforce-domain-model-lifecycle-and-state-machine
description: "Implement Batch 43C Payroll、Benefits、Time、Attendance与Workforce Planning canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Time Entry、Schedule、Leave、Payroll Input、Payroll Run、Benefit、Deduction、Tax、Position Plan与Labor Cost."
---
...
Implement Batch 43C Payroll、Benefits、Time、Attendance与Workforce Planning canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Time Entry、Schedule、Leave、Payroll Input、Payroll Run、Benefit、Deduction、Tax、Position Plan与Labor Cost.
...
5. Write unresolved domain assumptions to `docs/implementation/payroll-workforce-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
payroll_workforce_domain_model_lifecycle_and_state_machine_manifest.json
payroll_workforce_domain_model_lifecycle_and_state_machine_state.json
payroll_workforce_domain_model_lifecycle_and_state_machine_decision.json
payroll_workforce_domain_model_lifecycle_and_state_machine_reconciliation.json
payroll_workforce_domain_model_lifecycle_and_state_machine_evidence.json
```
