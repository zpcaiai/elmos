---
name: b05-core-language-translation-type-control-flow-null-ca-828eb58b
description: "Implement capability matrix and planning for Batch 5: Core Language Translation、Type／Control-flow／Null Semantics."
---

# Objective

Build the capability matrix, gap analysis, implementation waves and stop conditions.
...
- Role: `capability-matrix-and-planning`
...
4. Build the smallest end-to-end vertical slice for `capability-matrix-and-planning`.
