---
name: kubernetes-cel-gatekeeper-kyverno-image-and-workload-ad-80ecc0cb
description: "Implement Kubernetes admission profiles using native CEL, Gatekeeper and Kyverno-compatible adapters, image verification, mutation governance, audit, rollout, and version discovery."
---
...
Implement Kubernetes admission profiles using native CEL, Gatekeeper and Kyverno-compatible adapters, image verification, mutation governance, audit, rollout, and version discovery.
...
4. Record unresolved provider/version assumptions in `docs/implementation/kubernetes-cel-gatekeeper-kyverno-image-and-workload-admission-policy-baseline.md`.
...
```text
kubernetes_cel_gatekeeper_kyverno_image_and_workload_admission_policy_manifest.json
kubernetes_cel_gatekeeper_kyverno_image_and_workload_admission_policy_decision.json
kubernetes_cel_gatekeeper_kyverno_image_and_workload_admission_policy_evidence.json
```
