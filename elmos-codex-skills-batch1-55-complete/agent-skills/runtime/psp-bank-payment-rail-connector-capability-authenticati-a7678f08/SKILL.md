---
name: psp-bank-payment-rail-connector-capability-authenticati-a7678f08
description: "Implement provider-neutral PSP, bank and payment-rail connectors with capability discovery, authentication, versions, webhooks, polling, files, ISO 20022 and reconciliation."
---
...
Implement provider-neutral PSP, bank and payment-rail connectors with capability discovery, authentication, versions, webhooks, polling, files, ISO 20022 and reconciliation.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/psp-bank-payment-rail-connector-capability-authentication-and-lifecycle-baseline.md`.
...
```text
psp_bank_payment_rail_connector_capability_authentication_and_lifecycle_manifest.json
psp_bank_payment_rail_connector_capability_authentication_and_lifecycle_decision.json
psp_bank_payment_rail_connector_capability_authentication_and_lifecycle_reconciliation.json
psp_bank_payment_rail_connector_capability_authentication_and_lifecycle_evidence.json
```
