---
name: pricing-analytics-packaging-discount-waterfall-elastici-96176e3c
description: "Implement price realization, discount waterfalls, packaging analysis, elasticity estimates, willingness-to-pay studies, experiments and governed recommendations."
---
...
Implement price realization, discount waterfalls, packaging analysis, elasticity estimates, willingness-to-pay studies, experiments and governed recommendations.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/pricing-analytics-packaging-discount-waterfall-elasticity-and-experiment-baseline.md`.
...
```text
pricing_analytics_packaging_discount_waterfall_elasticity_and_experiment_manifest.json
pricing_analytics_packaging_discount_waterfall_elasticity_and_experiment_decision.json
pricing_analytics_packaging_discount_waterfall_elasticity_and_experiment_reconciliation.json
pricing_analytics_packaging_discount_waterfall_elasticity_and_experiment_evidence.json
```
...
```text
analyticsCannotActivatePrice
taxIsExcludedFromDiscountWaterfall
experimentRespectsExistingContract
