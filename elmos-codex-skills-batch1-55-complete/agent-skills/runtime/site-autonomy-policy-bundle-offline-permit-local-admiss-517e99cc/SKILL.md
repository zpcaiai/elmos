---
name: site-autonomy-policy-bundle-offline-permit-local-admiss-517e99cc
description: "Implement signed offline policy bundles and permits, local admission, task/side-effect restrictions, expiry, local operator controls, emergency revocation, and safe stop."
---
...
Implement signed offline policy bundles and permits, local admission, task/side-effect restrictions, expiry, local operator controls, emergency revocation, and safe stop.
...
4. Record unresolved provider/version assumptions in `docs/implementation/site-autonomy-policy-bundle-offline-permit-local-admission-and-safe-stop-baseline.md`.
...
```text
site_autonomy_policy_bundle_offline_permit_local_admission_and_safe_stop_manifest.json
site_autonomy_policy_bundle_offline_permit_local_admission_and_safe_stop_decision.json
site_autonomy_policy_bundle_offline_permit_local_admission_and_safe_stop_evidence.json
```
