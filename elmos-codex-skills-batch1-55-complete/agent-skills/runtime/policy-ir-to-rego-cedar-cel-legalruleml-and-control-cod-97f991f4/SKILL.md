---
name: policy-ir-to-rego-cedar-cel-legalruleml-and-control-cod-97f991f4
description: "Implement deterministic source-mapped compilers from Policy IR to Rego, Cedar, Kubernetes CEL, LegalRuleML and Control-as-Code with semantic-loss reports and tests."
---
...
Implement deterministic source-mapped compilers from Policy IR to Rego, Cedar, Kubernetes CEL, LegalRuleML and Control-as-Code with semantic-loss reports and tests.
...
4. Record unresolved provider/version assumptions in `docs/implementation/policy-ir-to-rego-cedar-cel-legalruleml-and-control-code-compiler-baseline.md`.
...
```text
policy_ir_to_rego_cedar_cel_legalruleml_and_control_code_compiler_manifest.json
policy_ir_to_rego_cedar_cel_legalruleml_and_control_code_compiler_decision.json
policy_ir_to_rego_cedar_cel_legalruleml_and_control_code_compiler_evidence.json
```
