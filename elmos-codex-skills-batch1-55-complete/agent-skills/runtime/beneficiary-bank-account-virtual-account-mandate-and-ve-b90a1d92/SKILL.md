---
name: beneficiary-bank-account-virtual-account-mandate-and-ve-b90a1d92
description: "Implement beneficiaries, bank accounts, virtual accounts, direct-debit mandates, ownership evidence, Verification of Payee, risk reviews and lifecycle controls."
---
...
Implement beneficiaries, bank accounts, virtual accounts, direct-debit mandates, ownership evidence, Verification of Payee, risk reviews and lifecycle controls.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/beneficiary-bank-account-virtual-account-mandate-and-verification-of-payee-baseline.md`.
...
```text
beneficiary_bank_account_virtual_account_mandate_and_verification_of_payee_manifest.json
beneficiary_bank_account_virtual_account_mandate_and_verification_of_payee_decision.json
beneficiary_bank_account_virtual_account_mandate_and_verification_of_payee_reconciliation.json
beneficiary_bank_account_virtual_account_mandate_and_verification_of_payee_evidence.json
```
...
```text
beneficiaryChangeTriggersReview
vopNoMatchRequiresDecision
virtualAccountBindsSettlementAccount
