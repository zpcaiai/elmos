---
name: itsm-service-data-quality-dedup-reconciliation-and-certification
description: "Implement Batch 47A ITSM、Service Catalog、Request、Change与Problem quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Service、Offering、Catalog Item、Request、Incident、Problem、Change、Knowledge、SLA与Approval."
---

# ITSM Service Data Quality Dedup Reconciliation And Certification

## Objective

Implement Batch 47A ITSM、Service Catalog、Request、Change与Problem quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Service、Offering、Catalog Item、Request、Incident、Problem、Change、Knowledge、SLA与Approval.
...
5. Write unresolved domain assumptions to `docs/implementation/itsm-service-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
itsm_service_data_quality_dedup_reconciliation_and_certification_manifest.json
itsm_service_data_quality_dedup_reconciliation_and_certification_state.json
itsm_service_data_quality_dedup_reconciliation_and_certification_decision.json
itsm_service_data_quality_dedup_reconciliation_and_certification_reconciliation.json
itsm_service_data_quality_dedup_reconciliation_and_certification_evidence.json
```
