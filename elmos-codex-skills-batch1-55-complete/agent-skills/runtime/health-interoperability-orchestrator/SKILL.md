---
name: health-interoperability-orchestrator
description: "Implement Batch 52B Healthcare Interoperability、FHIR、DICOM与Terminology end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering FHIR Resource、Profile、Bundle、Subscription、DICOM Object、Study、Terminology、Code System、Consent与Exchange."
---

# Health Interoperability Orchestrator

## Objective

Implement Batch 52B Healthcare Interoperability、FHIR、DICOM与Terminology end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering FHIR Resource、Profile、Bundle、Subscription、DICOM Object、Study、Terminology、Code System、Consent与Exchange.
...
5. Write unresolved domain assumptions to `docs/implementation/health-interoperability-orchestrator-baseline.md`.
...
```text
health_interoperability_orchestrator_manifest.json
health_interoperability_orchestrator_state.json
health_interoperability_orchestrator_decision.json
health_interoperability_orchestrator_reconciliation.json
health_interoperability_orchestrator_evidence.json
```
...
orchestratorPreservesSourceLineage
