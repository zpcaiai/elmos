---
name: clinical-ops-automation-copilot-recommendation-and-human-review
description: "Implement Batch 52A Clinical Operations、Patient Flow与Care Coordination typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Patient、Encounter、Appointment、Bed、Care Plan、Task、Referral、Observation、Discharge与Care Team."
---

# Clinical Ops Automation Copilot Recommendation And Human Review

## Objective

Implement Batch 52A Clinical Operations、Patient Flow与Care Coordination typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Patient、Encounter、Appointment、Bed、Care Plan、Task、Referral、Observation、Discharge与Care Team.
...
5. Write unresolved domain assumptions to `docs/implementation/clinical-ops-automation-copilot-recommendation-and-human-review-baseline.md`.
...
```text
clinical_ops_automation_copilot_recommendation_and_human_review_manifest.json
clinical_ops_automation_copilot_recommendation_and_human_review_state.json
clinical_ops_automation_copilot_recommendation_and_human_review_decision.json
clinical_ops_automation_copilot_recommendation_and_human_review_reconciliation.json
clinical_ops_automation_copilot_recommendation_and_human_review_evidence.json
```
