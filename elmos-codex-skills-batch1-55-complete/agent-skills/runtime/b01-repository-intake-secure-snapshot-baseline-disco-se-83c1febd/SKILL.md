---
name: b01-repository-intake-secure-snapshot-baseline-disco-se-83c1febd
description: "Implement security privacy and tenant isolation for Batch 1: Repository Intake、Secure Snapshot与Baseline Discovery."
---
...
Apply this Skill to **Batch 1: Repository Intake、Secure Snapshot与Baseline Discovery**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `1`
- Domain: `Repository Intake、Secure Snapshot与Baseline Discovery`
...
2. Resolve Batch 1 dependencies and verify prerequisite gates.
...
- do not execute repository code during intake.
- snapshot binds an exact commit and content digest.
- credentials never enter logs or artifacts.
