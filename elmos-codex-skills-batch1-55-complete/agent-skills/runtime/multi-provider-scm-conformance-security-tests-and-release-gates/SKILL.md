---
name: multi-provider-scm-conformance-security-tests-and-release-gates
description: "Implement provider TCK, real-cloud/self-managed fixtures, webhook/security attacks, version matrices, tenant isolation, chaos, and release gates."
---
...
Implement provider TCK, real-cloud/self-managed fixtures, webhook/security attacks, version matrices, tenant isolation, chaos, and release gates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/multi-provider-scm-conformance-security-tests-and-release-gates-baseline.md`.
...
```text
multi_provider_scm_conformance_security_tests_and_release_gates_manifest.json
multi_provider_scm_conformance_security_tests_and_release_gates_decision.json
multi_provider_scm_conformance_security_tests_and_release_gates_evidence.json
```
