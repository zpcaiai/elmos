---
name: b41-similar-project-retrieval
description: "Implement and verify Batch 41 Skill 1399 for similar project retrieval. Use when work requires 相似项目和相似模块检索, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-similar-project-retrieval`.
...
4. Implement the smallest production-shaped capability that exercises `相似项目和相似模块检索` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-similar-project-retrieval`
