---
name: b05-core-language-translation-type-control-flow-null-re-feb01b8b
description: "Implement release certification gate for Batch 5: Core Language Translation、Type／Control-flow／Null Semantics."
---

# Objective

Run the conservative release gate and reject unsupported completion or certification claims.
...
- Role: `release-certification-gate`
...
4. Build the smallest end-to-end vertical slice for `release-certification-gate`.
