---
name: core-hr-planning-capacity-scenario-optimization-and-allocation
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle plans, capacity, scenarios, constraints, allocation, optimization candidates and approval boundaries, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle plans, capacity, scenarios, constraints, allocation, optimization candidates and approval boundaries, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-planning-capacity-scenario-optimization-and-allocation-baseline.md`.
...
```text
core_hr_planning_capacity_scenario_optimization_and_allocation_manifest.json
core_hr_planning_capacity_scenario_optimization_and_allocation_state.json
core_hr_planning_capacity_scenario_optimization_and_allocation_decision.json
core_hr_planning_capacity_scenario_optimization_and_allocation_reconciliation.json
core_hr_planning_capacity_scenario_optimization_and_allocation_evidence.json
```
