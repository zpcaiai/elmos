---
name: bi-semantic-observability-sla-cockpit-alerting-and-operations
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-observability-sla-cockpit-alerting-and-operations-baseline.md`.
...
```text
bi_semantic_observability_sla_cockpit_alerting_and_operations_manifest.json
bi_semantic_observability_sla_cockpit_alerting_and_operations_state.json
bi_semantic_observability_sla_cockpit_alerting_and_operations_decision.json
bi_semantic_observability_sla_cockpit_alerting_and_operations_reconciliation.json
bi_semantic_observability_sla_cockpit_alerting_and_operations_evidence.json
```
