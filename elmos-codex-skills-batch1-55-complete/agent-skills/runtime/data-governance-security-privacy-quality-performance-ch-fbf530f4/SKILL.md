---
name: data-governance-security-privacy-quality-performance-ch-fbf530f4
description: "Implement Batch 44C Data Governance、MDM、Quality、Privacy与Lineage security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Catalog、Business Glossary、Master Data、Quality Rule、Lineage、Classification、Privacy、Stewardship与Data Issue."
---
...
Implement Batch 44C Data Governance、MDM、Quality、Privacy与Lineage security, privacy, quality, performance, chaos, negative tests, release evidence and mandatory gates, covering Catalog、Business Glossary、Master Data、Quality Rule、Lineage、Classification、Privacy、Stewardship与Data Issue.
...
Implement the domain model, lifecycle, APIs, events, workflows, policy controls, provider adapters, evidence, analytics, operations and release gates required for **Batch 44C: Data Governance、MDM、Quality、Privacy与Lineage**.

Theme:

```text
Catalog、Business Glossary、Master Data、Quality Rule、Lineage、Classification、Privacy、Stewardship与Data Issue
```
...
5. Write unresolved domain assumptions to `docs/implementation/data-governance-security-privacy-quality-performance-chaos-and-release-gates-baseline.md`.

## Required Capabilities

- Implement Catalog、Business Glossary、Master Data、Quality Rule、Lineage、Classification、Privacy、Stewardship与Data Issue without weakening earlier identity, evidence, policy, finance, privacy or tenant-isolation controls.
...
```text
discover→catalog→classify→steward→validate→resolve→certify→retain
```
...
```text
data_governance_security_privacy_quality_performance_chaos_and_release_gates_manifest.json
data_governance_security_privacy_quality_performance_chaos_and_release_gates_state.json
data_governance_security_privacy_quality_performance_chaos_and_release_gates_decision.json
data_governance_security_privacy_quality_performance_chaos_and_release_gates_reconciliation.json
data_governance_security_privacy_quality_performance_chaos_and_release_gates_evidence.json
```
...
```text
catalogAssetIdentityIsStable
catalogAssetLifecycleIsVersioned
businessTermIdentityIsStable
businessTermLifecycleIsVersioned
masterRecordIdentityIsStable
masterRecordLifecycleIsVersioned
qualityRuleIdentityIsStable
qualityRuleLifecycleIsVersioned
