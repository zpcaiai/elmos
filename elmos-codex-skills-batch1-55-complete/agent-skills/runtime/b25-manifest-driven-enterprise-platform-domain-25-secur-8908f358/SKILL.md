---
name: b25-manifest-driven-enterprise-platform-domain-25-secur-8908f358
description: "Implement security privacy and tenant isolation for Batch 25: Manifest-driven Enterprise Platform Domain 25."
---
...
Apply this Skill to **Batch 25: Manifest-driven Enterprise Platform Domain 25**. Treat the installed Batch manifest and repository evidence as authoritative; this normalized Skill must not invent unsupported provider, regulatory or runtime capabilities.

# Scope

- Batch: `25`
- Domain: `Manifest-driven Enterprise Platform Domain 25`
...
2. Resolve Batch 25 dependencies and verify prerequisite gates.
