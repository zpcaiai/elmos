---
name: b40-security-supply-chain-gate
description: "Implement and verify Batch 40 Skill 1392 for security supply chain gate. Use when work requires Batch 40安全供应链质量门禁, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-security-supply-chain-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 40安全供应链质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-security-supply-chain-gate`
