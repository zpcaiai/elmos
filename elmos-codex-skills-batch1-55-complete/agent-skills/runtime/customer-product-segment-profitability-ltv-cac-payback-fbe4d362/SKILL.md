---
name: customer-product-segment-profitability-ltv-cac-payback-fbe4d362
description: "Implement customer, product and segment profitability, cost-to-serve, allocated margin, LTV, CAC, payback, account hierarchies and drill-down."
---
...
Implement customer, product and segment profitability, cost-to-serve, allocated margin, LTV, CAC, payback, account hierarchies and drill-down.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/customer-product-segment-profitability-ltv-cac-payback-and-cost-to-serve-baseline.md`.
...
```text
customer_product_segment_profitability_ltv_cac_payback_and_cost_to_serve_manifest.json
customer_product_segment_profitability_ltv_cac_payback_and_cost_to_serve_decision.json
customer_product_segment_profitability_ltv_cac_payback_and_cost_to_serve_reconciliation.json
customer_product_segment_profitability_ltv_cac_payback_and_cost_to_serve_evidence.json
```
...
```text
allocationTotalReconcilesSource
driverIsVersioned
unitCostRequiresDenominator
directAndAllocatedCostsRemainDistinct
ltvUsesMarginNotRevenueOnly
negativeMarginCustomerRemainsVisible
