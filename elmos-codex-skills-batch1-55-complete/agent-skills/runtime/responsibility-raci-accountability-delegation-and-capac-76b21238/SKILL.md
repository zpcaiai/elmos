---
name: responsibility-raci-accountability-delegation-and-capac-76b21238
description: "Implement accountable/responsible/consulted/informed roles, natural-person accountability, delegation, acceptance, expiry, backup coverage, segregation of duties, capacity, and org-change reconciliation."
---
...
Implement accountable/responsible/consulted/informed roles, natural-person accountability, delegation, acceptance, expiry, backup coverage, segregation of duties, capacity, and org-change reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/responsibility-raci-accountability-delegation-and-capacity-governance-baseline.md`.
...
```text
responsibility_raci_accountability_delegation_and_capacity_governance_manifest.json
responsibility_raci_accountability_delegation_and_capacity_governance_decision.json
responsibility_raci_accountability_delegation_and_capacity_governance_evidence.json
```
