---
name: core-hr-master-data-identity-hierarchy-and-effective-dating
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle master data, identifiers, hierarchies, classifications, ownership and temporal lineage, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle master data, identifiers, hierarchies, classifications, ownership and temporal lineage, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-master-data-identity-hierarchy-and-effective-dating-baseline.md`.
...
```text
core_hr_master_data_identity_hierarchy_and_effective_dating_manifest.json
core_hr_master_data_identity_hierarchy_and_effective_dating_state.json
core_hr_master_data_identity_hierarchy_and_effective_dating_decision.json
core_hr_master_data_identity_hierarchy_and_effective_dating_reconciliation.json
core_hr_master_data_identity_hierarchy_and_effective_dating_evidence.json
```
