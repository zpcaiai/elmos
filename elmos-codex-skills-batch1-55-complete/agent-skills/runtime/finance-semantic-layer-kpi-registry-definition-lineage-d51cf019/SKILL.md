---
name: finance-semantic-layer-kpi-registry-definition-lineage-d51cf019
description: "Implement versioned finance metrics, grains, measures, dimensions, accounting classifications, currency bases, snapshots, lineage, certification and restatements."
---
...
Implement versioned finance metrics, grains, measures, dimensions, accounting classifications, currency bases, snapshots, lineage, certification and restatements.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/finance-semantic-layer-kpi-registry-definition-lineage-and-restatement-baseline.md`.
...
```text
finance_semantic_layer_kpi_registry_definition_lineage_and_restatement_manifest.json
finance_semantic_layer_kpi_registry_definition_lineage_and_restatement_decision.json
finance_semantic_layer_kpi_registry_definition_lineage_and_restatement_reconciliation.json
finance_semantic_layer_kpi_registry_definition_lineage_and_restatement_evidence.json
```
...
restatementPreservesPriorSnapshot
