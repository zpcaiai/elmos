---
name: b38-offline-signed-update-bundle
description: "Implement and verify Batch 38 Skill 1343 for offline signed update bundle. Use when work requires 离线签名Update Bundle, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-offline-signed-update-bundle`.
...
4. Implement the smallest production-shaped capability that exercises `离线签名Update Bundle` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-offline-signed-update-bundle`
