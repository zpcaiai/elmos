---
name: revenue-recognition-ifrs15-asc606-performance-obligatio-223bb13a
description: "Implement versioned IFRS 15 and ASC 606 accounting policies, revenue contracts, performance obligations, transaction price, variable consideration, SSP, allocation, satisfaction and revenue schedules."
---
...
Implement versioned IFRS 15 and ASC 606 accounting policies, revenue contracts, performance obligations, transaction price, variable consideration, SSP, allocation, satisfaction and revenue schedules.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/revenue-recognition-ifrs15-asc606-performance-obligation-allocation-and-schedule-baseline.md`.
...
```text
revenue_recognition_ifrs15_asc606_performance_obligation_allocation_and_schedule_manifest.json
revenue_recognition_ifrs15_asc606_performance_obligation_allocation_and_schedule_decision.json
revenue_recognition_ifrs15_asc606_performance_obligation_allocation_and_schedule_reconciliation.json
revenue_recognition_ifrs15_asc606_performance_obligation_allocation_and_schedule_evidence.json
```
