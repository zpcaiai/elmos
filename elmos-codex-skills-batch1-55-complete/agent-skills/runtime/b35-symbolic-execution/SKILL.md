---
name: b35-symbolic-execution
description: "Integrate bounded symbolic execution and path exploration for critical migrated methods with explicit assumptions solver limits unsupported constructs and concrete witness replay."
---
...
## Skill 1271: b35-symbolic-execution

## Use this skill when

- Critical methods require bounded path reasoning or concrete witnesses.

## Domain-specific risks and invariants

- Path explosion and unsupported runtime behavior can produce misleading claims.

## Workflow

1. Select bounded methods and properties with explicit assumptions.
2. Translate supported UIR or target code into symbolic constraints.
3. Configure exact solver, theory, bounds, loop unrolling, heap model, timeout, and unknown policy.
4. Validate symbolic witnesses concretely on real runtime.
5. Record proven, disproven, unknown, timeout, and unsupported separately.
6. Promote countermodels to deterministic tests.
...
- Prove or refute bounded path properties for calculations, validation, authorization, state transitions, and error handling.
...
- Symbolic obligations, path conditions, solver queries, proof statuses, witnesses, unknowns, and replay tests.
