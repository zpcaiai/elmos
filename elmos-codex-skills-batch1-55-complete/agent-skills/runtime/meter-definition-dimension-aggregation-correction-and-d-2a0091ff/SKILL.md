---
name: meter-definition-dimension-aggregation-correction-and-d-2a0091ff
description: "Implement versioned meters, units, dimensions, aggregation windows, late data, estimates, corrections, completeness, anomaly detection and certified usage aggregates."
---
...
Implement versioned meters, units, dimensions, aggregation windows, late data, estimates, corrections, completeness, anomaly detection and certified usage aggregates.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/meter-definition-dimension-aggregation-correction-and-data-quality-baseline.md`.
...
```text
meter_definition_dimension_aggregation_correction_and_data_quality_manifest.json
meter_definition_dimension_aggregation_correction_and_data_quality_decision.json
meter_definition_dimension_aggregation_correction_and_data_quality_reconciliation.json
meter_definition_dimension_aggregation_correction_and_data_quality_evidence.json
```
