---
name: policy-as-code-repository-bundle-signing-distribution-a-684a7580
description: "Implement Policy-as-Code repositories, reviews, signed bundles, manifests, distribution, atomic activation, last-known-good, offline cache, revocation, and rollback."
---
...
Implement Policy-as-Code repositories, reviews, signed bundles, manifests, distribution, atomic activation, last-known-good, offline cache, revocation, and rollback.
...
4. Record unresolved provider/version assumptions in `docs/implementation/policy-as-code-repository-bundle-signing-distribution-and-offline-cache-baseline.md`.
...
```text
policy_as_code_repository_bundle_signing_distribution_and_offline_cache_manifest.json
policy_as_code_repository_bundle_signing_distribution_and_offline_cache_decision.json
policy_as_code_repository_bundle_signing_distribution_and_offline_cache_evidence.json
```
