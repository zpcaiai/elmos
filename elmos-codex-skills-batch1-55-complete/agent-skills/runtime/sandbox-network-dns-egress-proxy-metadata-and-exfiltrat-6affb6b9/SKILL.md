---
name: sandbox-network-dns-egress-proxy-metadata-and-exfiltrat-6affb6b9
description: "Implement default-deny networking, DNS and redirect validation, proxy/CONNECT controls, metadata/private-network blocking, quotas, evidence, and exfiltration findings."
---
...
Implement default-deny networking, DNS and redirect validation, proxy/CONNECT controls, metadata/private-network blocking, quotas, evidence, and exfiltration findings.

This Skill belongs to **Batch 36B** and must extend the approved ELMOS domain rather than create parallel Tenant, Identity, Artifact, Policy, Workflow, Audit, Contract or Finding aggregates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/sandbox-network-dns-egress-proxy-metadata-and-exfiltration-control-baseline.md`.
...
```text
sandbox_network_dns_egress_proxy_metadata_and_exfiltration_control_manifest.json
sandbox_network_dns_egress_proxy_metadata_and_exfiltration_control_decision.json
sandbox_network_dns_egress_proxy_metadata_and_exfiltration_control_evidence.json
```
