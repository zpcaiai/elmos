...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/finance-planning-workflow-owner-review-approval-lock-and-collaboration-baseline.md`.
