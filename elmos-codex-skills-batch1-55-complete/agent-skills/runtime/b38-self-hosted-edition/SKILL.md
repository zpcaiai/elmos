---
name: b38-self-hosted-edition
description: "Implement and verify Batch 38 Skill 1331 for self hosted edition. Use when work requires Self-hosted Edition, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
## Skill 1331: Self-hosted Edition
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-self-hosted-edition`.
...
4. Implement the smallest production-shaped capability that exercises `Self-hosted Edition` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-self-hosted-edition`
