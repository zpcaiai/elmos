---
name: bitbucket-cloud-workspace-repository-scm-connector
description: "Implement Bitbucket Cloud workspaces, repositories, branches, pull requests, webhooks, OAuth/app-password compatibility, and rate-limit handling."
---
...
Implement Bitbucket Cloud workspaces, repositories, branches, pull requests, webhooks, OAuth/app-password compatibility, and rate-limit handling.
...
4. Record unresolved provider/version assumptions in `docs/implementation/bitbucket-cloud-workspace-repository-scm-connector-baseline.md`.
...
```text
bitbucket_cloud_workspace_repository_scm_connector_manifest.json
bitbucket_cloud_workspace_repository_scm_connector_decision.json
bitbucket_cloud_workspace_repository_scm_connector_evidence.json
```
