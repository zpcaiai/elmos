---
name: b44-showback-chargeback
description: "Implement and verify Batch 44 Skill 1458 for showback chargeback. Use when work requires \u6210\u672c\u5206\u644a\u3001Showback\u548cChargeback, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 成本分摊、Showback和Chargeback
...
## Skill 1458: 成本分摊、Showback和Chargeback
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-showback-chargeback`.
...
4. Implement the smallest production-shaped capability that exercises `成本分摊、Showback和Chargeback` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-showback-chargeback`
