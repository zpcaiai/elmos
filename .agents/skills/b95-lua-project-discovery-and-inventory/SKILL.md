---
name: b95-lua-project-discovery-and-inventory
description: "Use when ELMOS must run lua project discovery and inventory for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG391"
  source_name: "lua-project-discovery-and-inventory"
  source_sha256: "sha256:bbec21c325f3f7a952c2807adc333b2d05080cc56ce926bea576ca3478013f8f"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG391 — Lua Project Discovery And Inventory

## 1. Objective

Discover and inventory lua project discovery and inventory within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Lua Project Discovery And Inventory using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-project-discovery-and-inventory.
