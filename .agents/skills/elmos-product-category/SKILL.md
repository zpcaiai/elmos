---
name: elmos-product-category
description: 将 Elmos 定义为 AI 原生仓库现代化、转换、验证与交付操作系统，而非普通 Coding Agent。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-001
  source_name: elmos-product-category
  source_path: skills/elmos-product-category/SKILL.md
  source_sha256: sha256:23732bc037d4ae34410ea1f24e79a5f52a29adfcfdf578dcd4fb9bfbf7a25907
  source_contract_sha256: sha256:6c8d5c8b095adbe84c2d687a3f0cc4ed19e03d6bc6096f7deee2b919299082bf
...
将 Elmos 定义为 AI 原生仓库现代化、转换、验证与交付操作系统，而非普通 Coding Agent。

## Scope and capabilities

- 客户购买结果与责任边界
- 完整仓库交付单位
- Completion Proof 作为产品核心
- 当前能力与目标能力分离
...
- [ ] 定义 `elmos-product-category` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `elmos-product-category` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：product-category.yaml, value-proposition.md, claim-boundaries.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：product-category.yaml, value-proposition.md, claim-boundaries.json。
...
- Machine contract: `references/contract.json` (`sha256:6c8d5c8b095adbe84c2d687a3f0cc4ed19e03d6bc6096f7deee2b919299082bf`).
