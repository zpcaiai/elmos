...
triggers:
  - "Use when implementing or executing `elmos-symbol-table-builder`."
  - "Use when a migration/certification DAG requires `name-semantics` capability."
outputs:
  - "semantic-assurance/elmos-symbol-table-builder/model.json"
  - "semantic-assurance/elmos-symbol-table-builder/evidence.json"
  - "semantic-assurance/elmos-symbol-table-builder/diagnostics.json"
---

# Canonical Symbol Table Builder

## Objective

Construct a cross-language canonical symbol table covering declarations, imports, modules, packages, namespaces and external symbols.
...
- [ ] shadowing fixture.
- [ ] multi-module duplicate names.
- [ ] external unresolved symbol blocker.
