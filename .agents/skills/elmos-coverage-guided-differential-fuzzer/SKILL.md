...
triggers:
  - "Use when implementing or executing `elmos-coverage-guided-differential-fuzzer`."
  - "Use when a migration/certification DAG requires `fuzzing` capability."
outputs:
  - "semantic-assurance/elmos-coverage-guided-differential-fuzzer/model.json"
  - "semantic-assurance/elmos-coverage-guided-differential-fuzzer/evidence.json"
  - "semantic-assurance/elmos-coverage-guided-differential-fuzzer/diagnostics.json"
---
...
Use source/target coverage and behavioral disagreement as guidance to discover semantic conversion mismatches.
...
- [ ] known mismatch discovered.
- [ ] coverage increases corpus.
- [ ] same behavior no false fail.
