---
name: b40-customer-audit-evidence
description: "Implement and verify Batch 40 Skill 1390 for customer audit evidence. Use when work requires \u5ba2\u6237\u5ba1\u8ba1\u548c\u8bc1\u636e\u81ea\u52a8\u5316, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-customer-audit-evidence`.
...
4. Implement the smallest production-shaped capability that exercises `客户审计和证据自动化` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-customer-audit-evidence`
