---
name: b93-delphi-form-to-modern-ui-generator
description: "Use when ELMOS must run delphi form to modern ui generator for Batch 93 Delphi / Object Pascal Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG374"
  source_name: "delphi-form-to-modern-ui-generator"
  source_sha256: "sha256:03e465065a56dd02c481a40fb561c4b13a415d887a29bdb956d1358e7b0b8248"
  batch: 93
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 93 Language Pack / source PG374 — Delphi Form To Modern UI Generator

## 1. Objective

Generate delphi form to modern ui generator within the Delphi / Object Pascal Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Delphi Form To Modern UI Generator using the approved windows-industrial-legacy semantic contracts and toolchain versions.
...
- A representative valid delphi-object-pascal input produces all declared outputs for delphi-form-to-modern-ui-generator.
