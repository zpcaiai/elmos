---
name: b87-access-database-application-modernizer
description: "Use when ELMOS must run access database application modernizer for Batch 87 VB6 / VBA / VB.NET / Office Automation Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG304"
  source_name: "access-database-application-modernizer"
  source_sha256: "sha256:e397c1da8629782dd91f8886b979941983e8d0f54947e76048ea5a0a942b26c2"
  batch: 87
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 87 Language Pack / source PG304 — Access Database Application Modernizer

## 1. Objective

Modernize access database application modernizer within the VB6 / VBA / VB.NET / Office Automation Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Access Database Application Modernizer using the approved windows-legacy semantic contracts and toolchain versions.
...
- A representative valid vb-office input produces all declared outputs for access-database-application-modernizer.
