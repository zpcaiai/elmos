---
name: b84-plcopen-xml-import-export-adapter
description: "Use when ELMOS must run plcopen xml import export adapter for Batch 84 IEC 61131-3 PLC Languages Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG265"
  source_name: "plcopen-xml-import-export-adapter"
  source_sha256: "sha256:2b1ce9e3f0135a401be6ba4d362ba81b849948b386aafba7af4e292c664a9781"
  batch: 84
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 84 Language Pack / source PG265 — Plcopen Xml Import Export Adapter
