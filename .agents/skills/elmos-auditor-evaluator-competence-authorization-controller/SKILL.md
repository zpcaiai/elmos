---
name: elmos-auditor-evaluator-competence-authorization-controller
description: Implement and independently certify auditor and evaluator competence authorization controller, including define knowledge, skills, experience, examination, witnessed performance and maintenance requirements, authorize personnel by role, technology, sector and assurance level and monitor performance, calibration, conflicts and continuing professional development.
version: 4.0.0
...
# Auditor and Evaluator Competence Authorization Controller

## Objective

Implement and independently certify auditor and evaluator competence authorization controller, including define knowledge, skills, experience, examination, witnessed performance and maintenance requirements, authorize personnel by role, technology, sector and assurance level and monitor performance, calibration, conflicts and continuing professional development.
...
- `AuditorAndEvaluatorCompetenceAuthorizationControllerProfile`
- `AuditorAndEvaluatorCompetenceAuthorizationControllerRun`
- `AuditorAndEvaluatorCompetenceAuthorizationControllerFinding`
- `AuditorAndEvaluatorCompetenceAuthorizationControllerDecision`
- `AuditorAndEvaluatorCompetenceAuthorizationControllerEvidence`

Required semantic capabilities:

- define knowledge, skills, experience, examination, witnessed performance and maintenance requirements
- authorize personnel by role, technology, sector and assurance level
- monitor performance, calibration, conflicts and continuing professional development
...
- `elmos-accreditation-scope-competence-matrix-compiler`
- `elmos-certification-audit-program-governor`

## Primary Outputs

- `artifacts/elmos-auditor-evaluator-competence-authorization-controller/profile.yaml`
- `artifacts/elmos-auditor-evaluator-competence-authorization-controller/plan.json`
- `artifacts/elmos-auditor-evaluator-competence-authorization-controller/result.json`
- `artifacts/elmos-auditor-evaluator-competence-authorization-controller/evidence/`
- `artifacts/elmos-auditor-evaluator-competence-authorization-controller/assurance-case.json`
...
- **general auditor evaluates formal proof without competence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **authorization never expires** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **witness evaluator has same blind spot** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define knowledge, skills, experience, examination, witnessed performance and maintenance requirements
- native scenario: authorize personnel by role, technology, sector and assurance level
- native scenario: monitor performance, calibration, conflicts and continuing professional development
