---
name: elmos-modular-monolith-microservice-boundary-analyzer
description: Evaluate coupling, change cadence, data ownership, latency, transaction and team boundaries before extracting or merging services.
version: 4.0.0
...
# Modular Monolith and Microservice Boundary Analyzer
...
- `ModularMonolithAndMicroserviceBoundaryAnalyzerProfile`
- `ModularMonolithAndMicroserviceBoundaryAnalyzerPlan`
- `ModularMonolithAndMicroserviceBoundaryAnalyzerRun`
- `ModularMonolithAndMicroserviceBoundaryAnalyzerDecision`

Required semantic capabilities:

- build static/runtime coupling graph
- measure co-change and operational dependency
- map transaction and data ownership
- simulate extraction/merge impact
- produce reversible strangler plan
...
- `artifacts/elmos-modular-monolith-microservice-boundary-analyzer/profile.yaml`
- `artifacts/elmos-modular-monolith-microservice-boundary-analyzer/plan.json`
- `artifacts/elmos-modular-monolith-microservice-boundary-analyzer/result.json`
- `artifacts/elmos-modular-monolith-microservice-boundary-analyzer/evidence/`
...
- **service count treated as maturity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **runtime coupling missing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared database ownership unresolved** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **network latency ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **extraction cannot rollback** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: build static/runtime coupling graph
- native scenario: measure co-change and operational dependency
- native scenario: map transaction and data ownership
- native scenario: simulate extraction/merge impact
- native scenario: produce reversible strangler plan
