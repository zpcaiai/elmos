...
description: "Invoke the bounded repository handler for elmos-knowledge-quality-auditor while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P07:knowledge-quality-auditor"
  source_name: "elmos-knowledge-quality-auditor"
  installed_name: "elmos-knowledge-quality-auditor"
  source_logical_path: "07-elmos-transformation-learning-evolution/skills/knowledge-quality-auditor/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/07-elmos-transformation-learning-evolution/skills/knowledge-quality-auditor/SKILL.md.source-data"
  source_materialized_path: "07-elmos-transformation-learning-evolution/skills/knowledge-quality-auditor/SKILL.md.source-data"
  source_sha256: "sha256:f3440b5dad4f11fd83e0e7d6a96ce16c60ad2caf129e7d5620d4c27fa8bff0fb"
...
# elmos-knowledge-quality-auditor
...
- This is a deterministic repository wrapper for `07-elmos-transformation-learning-evolution/skills/knowledge-quality-auditor/SKILL.md` at `sha256:f3440b5dad4f11fd83e0e7d6a96ce16c60ad2caf129e7d5620d4c27fa8bff0fb`.
- Its immutable source/runtime identity is `elmos-knowledge-quality-auditor`; its active installed identity is `elmos-knowledge-quality-auditor`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-knowledge-quality-auditor --request <file>
```
