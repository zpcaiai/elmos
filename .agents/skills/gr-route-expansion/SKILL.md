---
name: gr-route-expansion
description: Spring 达到 L3 后，按市场、复用、许可和验证能力扩展 Java→C#、Python、前端/小程序等路线。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-096
  source_name: gr-route-expansion
  source_path: skills/gr-route-expansion/SKILL.md
  source_sha256: sha256:5d03d64fae81879f7f5f0910b85fcf44f7adf379a460d169b4029aa8914390b4
  source_contract_sha256: sha256:003c978ca4ebff88cdcfcefdf05eff749a36912a450f35aa31b4fbddc301e662
...
# Route Expansion Portfolio

## Objective

Spring 达到 L3 后，按市场、复用、许可和验证能力扩展 Java→C#、Python、前端/小程序等路线。
...
- [ ] 定义 `gr-route-expansion` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-route-expansion` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：route-roadmap.json, investment-decisions.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：route-roadmap.json, investment-decisions.json。
...
- Machine contract: `references/contract.json` (`sha256:003c978ca4ebff88cdcfcefdf05eff749a36912a450f35aa31b4fbddc301e662`).
