---
name: chinadb-45-target-gbase8c
description: "Use when ELMOS must follow the ChinaDB commercial database-migration specification for GBase 8c Target Adapter. Keep exact directed route and version semantics, require real evidence, and fail closed on unsupported behavior."
metadata:
  source_package: "chinadb-commercial-migration-skills"
  source_version: "1.0.0"
  source_directory: "45-target-gbase8c"
  source_path: "skills/45-target-gbase8c/SKILL.md"
  source_sha256: "sha256:e271c1fb78a0ee21d1dcf55516ddbcdb80b61449a7914abb44f8774e0ebe3f92"
...
- Provenance is pinned to `chinadb-commercial-migration-skills` version `1.0.0`, source Skill `45-target-gbase8c`, and the SHA-256 digest in frontmatter.
