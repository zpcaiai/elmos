---
name: structured-task-and-question-tools
description: Todo、问题、审批和用户选择使用结构化协议。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: FOUNDATION-08-structured-task-and-question-tools
  source_name: structured-task-and-question-tools
  source_path: skills/structured-task-and-question-tools/SKILL.md
  source_sha256: sha256:fede481808670c718ddc7ce7d6177a82ee3af215e2f6425fbe5dafb0b24d8608
  source_contract_sha256: sha256:e78115ef1d0823959c9a47af3d85a465846ed7d62e838c57b5b34d27a885f08f
...
# Structured Task & Question Tools

## Goal

Todo、问题、审批和用户选择使用结构化协议。

## Use when

在 Elmos 需要实现或升级 **Structured Task & Question Tools** 相关能力时使用；它不是仅供解释的提示词，而是实现、测试与验收契约。

## Capabilities to implement

- 任务有状态/owner/dependency/evidence，而非纯 Markdown checkbox
- 问题可提供候选选项和自定义输入
- 回答持久化并绑定决策节点
- 子 Agent 默认无权修改主任务列表，除非显式委派
...
- [ ] 定义 `structured-task-and-question-tools` 的 public interface、input/output/error schemas。
- [ ] 建立 `structured-task-and-question-tools` 的 capability/feature flags 与版本字段。
...
- [ ] 至少覆盖并验收：任务有状态/owner/dependency/evidence，而非纯 Markdown checkbox；以及 问题可提供候选选项和自定义输入。
...
- Machine contract: `references/contract.json` (`sha256:e78115ef1d0823959c9a47af3d85a465846ed7d62e838c57b5b34d27a885f08f`).
