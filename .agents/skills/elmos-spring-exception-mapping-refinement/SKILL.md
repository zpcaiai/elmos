---
name: "elmos-spring-exception-mapping-refinement"
description: "证明异常类型到 HTTP 状态、错误码、响应体、日志等级和事务回滚决策的映射保持。 Use when the task needs the exact Spring Exception Mapping Refinement Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-spring-exception-mapping-refinement/SKILL.md"
  source_sha256: "sha256:47132233a53a7d09d0be8fc41ffe7019cf5e185c713ad5a1518ab99e6938a3f8"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "spring-modernization"
  runtime_handler_id: "execute_elmos_spring_exception_mapping_refinement"
...
---
# Spring Exception Mapping Refinement

## Repository integration boundary

- Exact Skill identity: `elmos-spring-exception-mapping-refinement`; exact allowlisted runtime handler: `execute_elmos_spring_exception_mapping_refinement`.
- Source identity: `skills/P0/elmos-spring-exception-mapping-refinement/SKILL.md` at `sha256:47132233a53a7d09d0be8fc41ffe7019cf5e185c713ad5a1518ab99e6938a3f8` from `elmos-formal-assurance-kernel-v1.0.0`.
...
证明异常类型到 HTTP 状态、错误码、响应体、日志等级和事务回滚决策的映射保持。
...
3. Use the repository-owned `execute_elmos_spring_exception_mapping_refinement` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["sum-type equivalence","decision-table completeness","SMT relation checks"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-spring-exception-mapping-refinement/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
