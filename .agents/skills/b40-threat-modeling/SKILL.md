...
description: "Implement and verify Batch 40 Skill 1371 for threat modeling. Use when work requires Threat Modeling, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-threat-modeling`.
...
4. Implement the smallest production-shaped capability that exercises `Threat Modeling` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-threat-modeling`
