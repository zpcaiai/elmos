---
name: b87-vb6-project-discovery-and-inventory
description: "Use when ELMOS must run vb6 project discovery and inventory for Batch 87 VB6 / VBA / VB.NET / Office Automation Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG295"
  source_name: "vb6-project-discovery-and-inventory"
  source_sha256: "sha256:cad892dfeb825a8efe741be1d6d30a81e3f93c1af25041d160795596bf43b665"
  batch: 87
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 87 Language Pack / source PG295 — Vb6 Project Discovery And Inventory

## 1. Objective

Discover and inventory vb6 project discovery and inventory within the VB6 / VBA / VB.NET / Office Automation Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Vb6 Project Discovery And Inventory using the approved windows-legacy semantic contracts and toolchain versions.
...
- A representative valid vb-office input produces all declared outputs for vb6-project-discovery-and-inventory.
