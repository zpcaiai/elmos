---
name: elmos-adversarial-model-tool-memory-redteam-orchestrator
description: Coordinate multi-stage attacks across prompts, retrieval, memory, tools, protocols, identity and side effects with reproducible campaigns.
version: 4.0.0
...
# Adversarial Model, Tool and Memory Red-Team Orchestrator
...
- `AdversarialModelToolAndMemoryRedTeamOrchestratorProfile`
- `AdversarialModelToolAndMemoryRedTeamOrchestratorPlan`
- `AdversarialModelToolAndMemoryRedTeamOrchestratorRun`
- `AdversarialModelToolAndMemoryRedTeamOrchestratorDecision`

Required semantic capabilities:

- compose direct and indirect injection chains
- attack tool schemas and delegation boundaries
- poison memory and retrieval over time
- exercise cross-agent and cross-protocol escalation
- measure detection, containment and recovery
...
- `artifacts/elmos-adversarial-model-tool-memory-redteam-orchestrator/profile.yaml`
- `artifacts/elmos-adversarial-model-tool-memory-redteam-orchestrator/plan.json`
- `artifacts/elmos-adversarial-model-tool-memory-redteam-orchestrator/result.json`
- `artifacts/elmos-adversarial-model-tool-memory-redteam-orchestrator/evidence/`
...
- **red-team payload escapes test tenant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **campaign omits chained attacks** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **detector trained on same corpus** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsafe artifact distributed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **success judged only by LLM** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compose direct and indirect injection chains
- native scenario: attack tool schemas and delegation boundaries
- native scenario: poison memory and retrieval over time
- native scenario: exercise cross-agent and cross-protocol escalation
- native scenario: measure detection, containment and recovery
