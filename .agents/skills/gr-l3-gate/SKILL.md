---
name: gr-l3-gate
description: 综合 3 个独立付费客户、20 unseen、规模门、Proof、恢复、重复性与毛利信号。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-079
  source_name: gr-l3-gate
  source_path: skills/gr-l3-gate/SKILL.md
  source_sha256: sha256:99a141ec9be506dab37e72685482191d3b3987204ea1f289db0cc3fe5b22fb1e
  source_contract_sha256: sha256:4f4211ec6957da11c53d42b7090533fd0c4ec09190f3da0a195108327a011640
...
# Commercial L3 Exit Gate

## Objective

综合 3 个独立付费客户、20 unseen、规模门、Proof、恢复、重复性与毛利信号。
...
- [ ] 定义 `gr-l3-gate` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-l3-gate` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：l3-gate-result.json, promotion-decision.md。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：l3-gate-result.json, promotion-decision.md。
- [ ] 所有 mandatory tests 和 security gates 通过，且无 critical unknown。

## Dependencies

- `gr-clean-room`
- `gr-failure-denominator`
...
- Machine contract: `references/contract.json` (`sha256:4f4211ec6957da11c53d42b7090533fd0c4ec09190f3da0a195108327a011640`).
