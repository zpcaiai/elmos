---
name: redteam-blueteam-learning-loop
description: Use this skill when Elmos must perform redteam blueteam learning loop as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# redteam-blueteam-learning-loop

## 能力目标

将攻击发现、修复、验证和新测试纳入持续改进。
