---
name: b95-lua-resty-http-cache-gateway-generator
description: "Use when ELMOS must run lua resty http cache gateway generator for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG397"
  source_name: "lua-resty-http-cache-gateway-generator"
  source_sha256: "sha256:2f35e17dccd37470978441fd0bf2c74b2cca28975ee66250dada7e3ddf3f309e"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG397 — Lua Resty Http Cache Gateway Generator

## 1. Objective

Generate lua resty http cache gateway generator within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Lua Resty Http Cache Gateway Generator using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-resty-http-cache-gateway-generator.
