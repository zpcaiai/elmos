---
name: elmos-rust-to-ada-spark-assurance-route
description: 'Execute the reference route: Rust to Ada/SPARK where stronger contract/proof
  regimes are required.'
version: 1.0.0
skill_id: ELMOS-POLY-147
...
triggers:
- Use when implementing or executing `elmos-rust-to-ada-spark-assurance-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-rust-to-ada-spark-assurance-route/run.json
- routes/elmos-rust-to-ada-spark-assurance-route/migration-plan.json
- routes/elmos-rust-to-ada-spark-assurance-route/evidence/
---

# Rust To Ada Spark Assurance Route

## Objective

Execute the reference route: Rust to Ada/SPARK where stronger contract/proof regimes are required.
...
- Source: `rust`
- Target: `ada-spark`
- Intent: Rust to Ada/SPARK where stronger contract/proof regimes are required
