---
name: b38-platform-version-compatibility
description: "Implement and verify Batch 38 Skill 1338 for platform version compatibility. Use when work requires \u5e73\u53f0\u7248\u672c\u517c\u5bb9\u77e9\u9635, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-platform-version-compatibility`.
...
4. Implement the smallest production-shaped capability that exercises `平台版本兼容矩阵` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-platform-version-compatibility`
