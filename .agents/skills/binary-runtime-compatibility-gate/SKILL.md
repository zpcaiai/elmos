---
name: binary-runtime-compatibility-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Binary and Runtime Compatibility Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T104"
  source_name: "binary-runtime-compatibility-gate"
  source_sha256: "sha256:1a31eb88fd8395fbd2e99284fffe3c753bb2361fe9b2b72d12f419f703abef97"
...
# T104 — Binary and Runtime Compatibility Gate

## 1. Objective

Check ABI, package, runtime, VM, firmware, schema and supported-version compatibility.
...
- `CASE-0471` [HIGH] Binary and Runtime Compatibility Gate: Representative path
- `CASE-0472` [HIGH] Binary and Runtime Compatibility Gate: Boundary path
- `CASE-0473` [HIGH] Binary and Runtime Compatibility Gate: Invalid or hostile input
- `CASE-0474` [HIGH] Binary and Runtime Compatibility Gate: Injected dependency failure
- `CASE-0475` [CRITICAL] Binary and Runtime Compatibility Gate: Security or safety violation
- `CASE-0476` [HIGH] Binary and Runtime Compatibility Gate: Replay and idempotency
- `CASE-0477` [HIGH] Binary and Runtime Compatibility Gate: Version or environment drift
- `CASE-0478` [MEDIUM] Binary and Runtime Compatibility Gate: Moderate scale
- `CASE-0479` [CRITICAL] Binary and Runtime Compatibility Gate: Evidence tamper
- `CASE-0480` [HIGH] Binary and Runtime Compatibility Gate: Recovery and final evidence
