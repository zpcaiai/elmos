...
# Certificate Portability and Transfer Controller
...
- `CertificatePortabilityAndTransferControllerProfile`
- `CertificatePortabilityAndTransferControllerRun`
- `CertificatePortabilityAndTransferControllerFinding`
- `CertificatePortabilityAndTransferControllerDecision`
- `CertificatePortabilityAndTransferControllerEvidence`

Required semantic capabilities:

- package evidence, audit trail, status and scope for transfer without issuer lock-in
- verify receiving body competence and acceptance of prior work
- preserve original issuer responsibility and transfer decision lineage
...
- `elmos-certification-transfer-suspension-withdrawal-controller`
- `elmos-machine-verifiable-certificate-profile-compiler`

## Primary Outputs

- `artifacts/elmos-certificate-portability-transfer-controller/profile.yaml`
- `artifacts/elmos-certificate-portability-transfer-controller/plan.json`
- `artifacts/elmos-certificate-portability-transfer-controller/result.json`
- `artifacts/elmos-certificate-portability-transfer-controller/evidence/`
- `artifacts/elmos-certificate-portability-transfer-controller/assurance-case.json`
...
- **transfer strips unfavorable finding** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **new issuer cannot reproduce evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **both issuers appear simultaneously responsible** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: package evidence, audit trail, status and scope for transfer without issuer lock-in
- native scenario: verify receiving body competence and acceptance of prior work
- native scenario: preserve original issuer responsibility and transfer decision lineage
