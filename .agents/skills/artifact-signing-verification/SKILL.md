...
description: "Repository-owned bounded wrapper for artifact-signing-verification; external evidence remains NOT_RUN."
---
...
Sign outputs and attestations and verify signatures before promotion or deployment.
...
4. Submit `artifact-signing-verification` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `cdbee5818b15205e8c56da627d6952d43abaff90bda206ce5813eee50ac04007`
