...
description: "Invoke the bounded repository handler for elmos-retry-stall-doomloop-controller while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P04:retry-stall-doomloop-controller"
  source_name: "elmos-retry-stall-doomloop-controller"
  installed_name: "elmos-retry-stall-doomloop-controller"
  source_logical_path: "04-elmos-agent-orchestration-software-factory/skills/retry-stall-doomloop-controller/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/04-elmos-agent-orchestration-software-factory/skills/retry-stall-doomloop-controller/SKILL.md.source-data"
  source_materialized_path: "04-elmos-agent-orchestration-software-factory/skills/retry-stall-doomloop-controller/SKILL.md.source-data"
  source_sha256: "sha256:378830fc61370355ce028841172c9bddc404d1b708fccb409fbf16526d435c0f"
...
# elmos-retry-stall-doomloop-controller
...
- This is a deterministic repository wrapper for `04-elmos-agent-orchestration-software-factory/skills/retry-stall-doomloop-controller/SKILL.md` at `sha256:378830fc61370355ce028841172c9bddc404d1b708fccb409fbf16526d435c0f`.
- Its immutable source/runtime identity is `elmos-retry-stall-doomloop-controller`; its active installed identity is `elmos-retry-stall-doomloop-controller`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-retry-stall-doomloop-controller --request <file>
```
