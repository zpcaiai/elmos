---
name: b40-container-kubernetes-iac-scanning
description: "Implement and verify Batch 40 Skill 1378 for container kubernetes iac scanning. Use when work requires Container\u3001Kubernetes\u548cIaC\u5b89\u5168\u626b\u63cf, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Container、Kubernetes和IaC安全扫描
...
## Skill 1378: Container、Kubernetes和IaC安全扫描
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-container-kubernetes-iac-scanning`.
...
4. Implement the smallest production-shaped capability that exercises `Container、Kubernetes和IaC安全扫描` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-container-kubernetes-iac-scanning`
