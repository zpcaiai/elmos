---
name: "elmos-multi-objective-router"
description: "Invoke the bounded repository handler for elmos-multi-objective-router while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P06:multi-objective-router"
  source_name: "elmos-multi-objective-router"
  installed_name: "elmos-multi-objective-router"
  source_logical_path: "06-elmos-intelligent-model-router/skills/multi-objective-router/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/06-elmos-intelligent-model-router/skills/multi-objective-router/SKILL.md.source-data"
  source_materialized_path: "06-elmos-intelligent-model-router/skills/multi-objective-router/SKILL.md.source-data"
  source_sha256: "sha256:be2ce6c405143e418624bdea1f67e76fc54500d862313fa3ee35ff21624e55dc"
...
- This is a deterministic repository wrapper for `06-elmos-intelligent-model-router/skills/multi-objective-router/SKILL.md` at `sha256:be2ce6c405143e418624bdea1f67e76fc54500d862313fa3ee35ff21624e55dc`.
- Its immutable source/runtime identity is `elmos-multi-objective-router`; its active installed identity is `elmos-multi-objective-router`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-multi-objective-router --request <file>
```
