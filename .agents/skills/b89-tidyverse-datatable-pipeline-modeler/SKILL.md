---
name: b89-tidyverse-datatable-pipeline-modeler
description: "Use when ELMOS must run tidyverse datatable pipeline modeler for Batch 89 R / Quarto / Shiny / renv Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG322"
  source_name: "tidyverse-datatable-pipeline-modeler"
  source_sha256: "sha256:aada71891069a62f5c4e01bac61dbb4c9b60c287555f8df4d5f0d1f5db1ec058"
  batch: 89
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 89 Language Pack / source PG322 — Tidyverse Datatable Pipeline Modeler

## 1. Objective

Model tidyverse datatable pipeline modeler within the R / Quarto / Shiny / renv Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Tidyverse Datatable Pipeline Modeler using the approved data-science semantic contracts and toolchain versions.
...
- A representative valid r-data-science input produces all declared outputs for tidyverse-datatable-pipeline-modeler.
