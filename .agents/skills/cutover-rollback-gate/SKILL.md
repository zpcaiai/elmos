---
name: cutover-rollback-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Cutover and Rollback Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T113"
  source_name: "cutover-rollback-gate"
  source_sha256: "sha256:3dc6f6111a91f5f168175425a54e6182f28b50abc05dd6d0d8c41ca7c8140590"
...
# T113 — Cutover and Rollback Gate

## 1. Objective

Test parallel run, canary/cutover, forward recovery, rollback boundaries and decommission safeguards.
...
- `CASE-0561` [HIGH] Cutover and Rollback Gate: Representative path
- `CASE-0562` [HIGH] Cutover and Rollback Gate: Boundary path
- `CASE-0563` [HIGH] Cutover and Rollback Gate: Invalid or hostile input
- `CASE-0564` [HIGH] Cutover and Rollback Gate: Injected dependency failure
- `CASE-0565` [CRITICAL] Cutover and Rollback Gate: Security or safety violation
- `CASE-0566` [HIGH] Cutover and Rollback Gate: Replay and idempotency
- `CASE-0567` [HIGH] Cutover and Rollback Gate: Version or environment drift
- `CASE-0568` [MEDIUM] Cutover and Rollback Gate: Moderate scale
- `CASE-0569` [CRITICAL] Cutover and Rollback Gate: Evidence tamper
- `CASE-0570` [HIGH] Cutover and Rollback Gate: Recovery and final evidence
