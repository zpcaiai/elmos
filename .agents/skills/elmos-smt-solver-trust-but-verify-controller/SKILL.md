---
name: elmos-smt-solver-trust-but-verify-controller
description: Implement and independently certify smt solver trust-but-verify controller, including capture SMT-LIB problem, logic, options, proof or unsat core and solver digest, replay critical unsat claims with proof checker or diverse solver and detect unknown, timeout, inconsistent and nonstandard-theory results.
version: 4.0.0
...
# SMT Solver Trust-but-Verify Controller
...
- `SMTSolverTrustButVerifyControllerProfile`
- `SMTSolverTrustButVerifyControllerRun`
- `SMTSolverTrustButVerifyControllerFinding`
- `SMTSolverTrustButVerifyControllerDecision`
- `SMTSolverTrustButVerifyControllerEvidence`

Required semantic capabilities:

- capture SMT-LIB problem, logic, options, proof or unsat core and solver digest
- replay critical unsat claims with proof checker or diverse solver
- detect unknown, timeout, inconsistent and nonstandard-theory results
...
- `elmos-proof-checker-diversity-cross-validation-governor` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `artifacts/elmos-smt-solver-trust-but-verify-controller/profile.yaml`
- `artifacts/elmos-smt-solver-trust-but-verify-controller/plan.json`
- `artifacts/elmos-smt-solver-trust-but-verify-controller/result.json`
- `artifacts/elmos-smt-solver-trust-but-verify-controller/evidence/`
- `artifacts/elmos-smt-solver-trust-but-verify-controller/assurance-case.json`
...
- **unsat result has no checkable proof** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **solver-specific undefined behavior affects claim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unknown is coerced to unsat** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: capture SMT-LIB problem, logic, options, proof or unsat core and solver digest
- native scenario: replay critical unsat claims with proof checker or diverse solver
- native scenario: detect unknown, timeout, inconsistent and nonstandard-theory results
