---
name: "elmos-ddl-constraint-preservation"
description: "证明 PK、FK、UNIQUE、CHECK、NOT NULL、DEFAULT、生成列和索引语义在目标方言中得到等价或更强保障。 Use when the task needs the exact DDL Constraint Preservation Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-ddl-constraint-preservation/SKILL.md"
  source_sha256: "sha256:762c12464a2dcfdaf0799aa3f5fb06edc92ef1e16b2db683a9f2ac5358fa81fa"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "sql-conversion"
  runtime_handler_id: "execute_elmos_ddl_constraint_preservation"
...
- Exact Skill identity: `elmos-ddl-constraint-preservation`; exact allowlisted runtime handler: `execute_elmos_ddl_constraint_preservation`.
- Source identity: `skills/P0/elmos-ddl-constraint-preservation/SKILL.md` at `sha256:762c12464a2dcfdaf0799aa3f5fb06edc92ef1e16b2db683a9f2ac5358fa81fa` from `elmos-formal-assurance-kernel-v1.0.0`.
...
证明 PK、FK、UNIQUE、CHECK、NOT NULL、DEFAULT、生成列和索引语义在目标方言中得到等价或更强保障。
...
3. Use the repository-owned `execute_elmos_ddl_constraint_preservation` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["constraint implication","relational model finding","schema refinement"]`
- Direct dependencies: `["elmos-proof-obligation-planner","elmos-sql-semantic-ir","elmos-schema-losslessness-proof"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-ddl-constraint-preservation/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
