---
name: metamorphic-equivalence-testing
description: "Repository-owned bounded wrapper for metamorphic-equivalence-testing; external evidence remains NOT_RUN."
---
...
Generate transformations of inputs whose output relations must remain invariant to expose silent semantic divergence.
...
4. Submit `metamorphic-equivalence-testing` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `4494944aee3e17d317dd361440f5d3a93cbfa0a0f3d121962e372cce68204bff`
