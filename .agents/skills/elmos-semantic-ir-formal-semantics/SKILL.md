---
name: "elmos-semantic-ir-formal-semantics"
description: "为表达式、控制流、Heap、异常、异步、线程、I/O 和外部效应定义可执行的小步/大步语义。 Use when the task needs the exact Semantic IR Formal Semantics Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-semantic-ir-formal-semantics/SKILL.md"
  source_sha256: "sha256:3e496e5f39e41218d9510bf8e9e709183c3b63bf1e7d25831efea0580835eb6e"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "cross-language"
  runtime_handler_id: "execute_elmos_semantic_ir_formal_semantics"
...
---
# Semantic IR Formal Semantics

## Repository integration boundary

- Exact Skill identity: `elmos-semantic-ir-formal-semantics`; exact allowlisted runtime handler: `execute_elmos_semantic_ir_formal_semantics`.
- Source identity: `skills/P0/elmos-semantic-ir-formal-semantics/SKILL.md` at `sha256:3e496e5f39e41218d9510bf8e9e709183c3b63bf1e7d25831efea0580835eb6e` from `elmos-formal-assurance-kernel-v1.0.0`.
...
为表达式、控制流、Heap、异常、异步、线程、I/O 和外部效应定义可执行的小步/大步语义。
...
3. Use the repository-owned `execute_elmos_semantic_ir_formal_semantics` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["operational semantics","effect traces","typed transition systems","K/Lean definitions"]`
- Direct dependencies: `["elmos-formal-spec-ir","elmos-trusted-computing-base-registry","elmos-language-semantic-profile"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-semantic-ir-formal-semantics/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
