---
name: elmos-ai-supply-chain-performance-resilience-certifier
description: Verify SBOM, provenance, dependency policy, image integrity, latency, throughput, resource bounds, load shedding,
  provider outage, worker loss and disaster recovery.
version: 4.0.0
...
# AISupplyChainPerformanceResilienceCertifier
...
- Negotiate exact target profile
- Emit complete native project and extension artifacts
- Run native import/build/start/load tests
- Generate deployment, operations and evidence hooks
- Preserve unsupported features in a ledger
...
- `elmos-ai-deployment-pack-generator` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
...
- `nonfunctional-certification.json`
- `sbom/`
- `performance-results/`
- `resilience-results/`
...
- **incomplete scaffold claimed complete** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dependency substitution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **secret in generated config** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsupported feature dropped** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **mock-only certification** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- counterexample
- unknown verifier
- AiSupplyChainPerformanceResilienceCertifier representative end-to-end fixture
- crash recovery preserves single-writer semantics
- upstream or contract drift invalidates stale evidence
- undeclared authority is denied
- resource and wall-clock budget is measured
- minimal native project
