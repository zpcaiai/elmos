---
name: elmos-target-dify-project-generator
description: Generate and import/export Dify Chatflow, Workflow, Agent, knowledge-pipeline and plugin projects with deterministic
  layout, dependency manifests and unsupported-node accounting.
version: 4.0.0
...
- Generate Chatflow, Workflow and Agent DSL
- Generate model/tool/data-source plugins
- Preserve deterministic node IDs and visual layout
- Import/export with unsupported-node ledger
- Run exact-version Dify import and invocation smoke tests
...
- **DSL expression injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **plugin privilege escalation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **secret serialized in DSL** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **knowledge ACL loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **visual node identity drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- Chatflow import/export round trip
- Workflow branch/iteration/parallel nodes
- Agent tool binding
- knowledge pipeline incremental update
- model/tool/data-source plugin load
- secret redaction
- unsupported node preservation
- upgrade and import rollback
