---
name: chinadb-44-target-gbase8s
description: "Use when ELMOS must follow the ChinaDB commercial database-migration specification for GBase 8s Target Adapter. Keep exact directed route and version semantics, require real evidence, and fail closed on unsupported behavior."
metadata:
  source_package: "chinadb-commercial-migration-skills"
  source_version: "1.0.0"
  source_directory: "44-target-gbase8s"
  source_path: "skills/44-target-gbase8s/SKILL.md"
  source_sha256: "sha256:48fcf1449099ae8aa1cf57e7f75ab91344d6525610058067153a32d0ccf3e095"
...
- Provenance is pinned to `chinadb-commercial-migration-skills` version `1.0.0`, source Skill `44-target-gbase8s`, and the SHA-256 digest in frontmatter.
