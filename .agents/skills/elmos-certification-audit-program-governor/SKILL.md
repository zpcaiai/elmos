---
name: elmos-certification-audit-program-governor
description: Implement and independently certify certification audit program governor, including plan initial, surveillance, recertification, special and remote audits over certification cycle, allocate objectives, scope, criteria, methods, resources and independent teams and use risk and prior performance without reducing mandatory coverage.
version: 4.0.0
...
# Certification Audit Program Governor

## Objective

Implement and independently certify certification audit program governor, including plan initial, surveillance, recertification, special and remote audits over certification cycle, allocate objectives, scope, criteria, methods, resources and independent teams and use risk and prior performance without reducing mandatory coverage.
...
- `CertificationAuditProgramGovernorProfile`
- `CertificationAuditProgramGovernorRun`
- `CertificationAuditProgramGovernorFinding`
- `CertificationAuditProgramGovernorDecision`
- `CertificationAuditProgramGovernorEvidence`

Required semantic capabilities:

- plan initial, surveillance, recertification, special and remote audits over certification cycle
- allocate objectives, scope, criteria, methods, resources and independent teams
- use risk and prior performance without reducing mandatory coverage
...
- `artifacts/elmos-certification-audit-program-governor/profile.yaml`
- `artifacts/elmos-certification-audit-program-governor/plan.json`
- `artifacts/elmos-certification-audit-program-governor/result.json`
- `artifacts/elmos-certification-audit-program-governor/evidence/`
- `artifacts/elmos-certification-audit-program-governor/assurance-case.json`
...
- **audit program optimizes cost at expense of critical scope** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **same auditor remains indefinitely without review** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **remote audit cannot observe decisive control** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: plan initial, surveillance, recertification, special and remote audits over certification cycle
- native scenario: allocate objectives, scope, criteria, methods, resources and independent teams
- native scenario: use risk and prior performance without reducing mandatory coverage
