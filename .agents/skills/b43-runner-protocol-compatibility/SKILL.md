...
description: "Implement and verify Batch 43 Skill 1440 for runner protocol compatibility. Use when work requires Runner Protocol\u517c\u5bb9\u6cbb\u7406, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
## Skill 1440: Runner Protocol兼容治理
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-runner-protocol-compatibility`.
...
4. Implement the smallest production-shaped capability that exercises `Runner Protocol兼容治理` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-runner-protocol-compatibility`
