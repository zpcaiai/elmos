---
name: elmos-numerical-kernel-migrator
description: Transform Fortran/C numerical kernels to C++/Rust/Python-native stacks
  while preserving vectorization, libraries, memory order and computational complexity.
version: 1.0.0
skill_id: ELMOS-POLY-120
...
triggers:
- Use when implementing or executing `elmos-numerical-kernel-migrator`.
- Use when the migration DAG requires `numerical-transformation` capability.
outputs:
- transforms/elmos-numerical-kernel-migrator/plan.json
- transforms/elmos-numerical-kernel-migrator/semantic-loss.json
- transforms/elmos-numerical-kernel-migrator/evidence.json
---

# Numerical Kernel Migrator

## Objective

Transform Fortran/C numerical kernels to C++/Rust/Python-native stacks while preserving vectorization, libraries, memory order and computational complexity.
