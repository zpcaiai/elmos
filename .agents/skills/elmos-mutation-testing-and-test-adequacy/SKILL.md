---
name: mutation-testing-and-test-adequacy
description: Use this skill when Elmos must perform mutation testing and test adequacy as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
