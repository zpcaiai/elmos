---
name: elmos-ai-multitenant-control-plane-generator
description: Generate tenant, project, goal, run, quota, concurrency, identity, RLS, audit and operator APIs for safely hosting
  generated AI solutions.
version: 4.0.0
...
# AIMultitenantControlPlaneGenerator
...
- duplicate delivery
- pause resume cancel
- AiMultitenantControlPlaneGenerator representative end-to-end fixture
