---
name: b35-verification-certification-gate
description: Run the conservative Batch 35 advanced verification certification gate and emit certified limited experimental or blocked status from exact profiles oracles properties metamorphic mutation fuzz symbolic model state contract data security concurrency numeric solver coverage counterexamples assurance holdout and evidence.
---
...
## Skill 1286: b35-verification-certification-gate

## Use this skill when

- A verification pack requests certified, limited, experimental, or blocked status.

## Domain-specific risks and invariants

- Formal or statistical terminology can create false confidence without exact evidence.

## Workflow

1. Validate pack, profile, oracle, property, relation, campaign, model, proof, counterexample, assurance, holdout, and evidence contracts.
2. Verify every evidence reference exists and matches immutable digests.
3. Apply metric thresholds and zero-tolerance fields.
4. Check for oracle conflicts, unknown solver results, unreplayed failures, surviving critical mutants, security violations, and unsupported P0 claims.
5. Write gate result and report.
6. Refuse certification unless every required claim is supported.
...
- Evaluate one exact verification pack and prevent unsupported or fabricated formal-correctness claims.
...
- Gate result, human-readable report, strongest defensible certification status, failures, and remaining obligations.
