---
name: "elmos-formal-release-gate"
description: "依据风险、证明状态、覆盖率、假设、豁免、证据新鲜度和商业认证等级作出 fail-closed 发布决策。 Use when the task needs the exact Formal Release Gate Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-formal-release-gate/SKILL.md"
  source_sha256: "sha256:b2483b3e23215c7d446eac4568b5202c6c0942d8667395038cdfcfafda6800c6"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "platform"
  runtime_handler_id: "execute_elmos_formal_release_gate"
...
- Exact Skill identity: `elmos-formal-release-gate`; exact allowlisted runtime handler: `execute_elmos_formal_release_gate`.
- Source identity: `skills/P0/elmos-formal-release-gate/SKILL.md` at `sha256:b2483b3e23215c7d446eac4568b5202c6c0942d8667395038cdfcfafda6800c6` from `elmos-formal-assurance-kernel-v1.0.0`.
...
依据风险、证明状态、覆盖率、假设、豁免、证据新鲜度和商业认证等级作出 fail-closed 发布决策。
...
3. Use the repository-owned `execute_elmos_formal_release_gate` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["policy-as-code","evidence aggregation","separation of duties"]`
- Direct dependencies: `["elmos-proof-status-policy","elmos-formal-assurance-orchestrator","elmos-proof-artifact-store"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-formal-release-gate/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
