---
name: elmos-internal-audit-management-review-compiler
description: Implement and independently certify internal audit and management review compiler, including plan independent internal audits of certification and laboratory processes, compile management review inputs for performance, impartiality, resources, risks and improvement and track decisions, owners, deadlines and effectiveness evidence.
version: 4.0.0
...
# Internal Audit and Management Review Compiler

## Objective

Implement and independently certify internal audit and management review compiler, including plan independent internal audits of certification and laboratory processes, compile management review inputs for performance, impartiality, resources, risks and improvement and track decisions, owners, deadlines and effectiveness evidence.
...
- `InternalAuditAndManagementReviewCompilerProfile`
- `InternalAuditAndManagementReviewCompilerRun`
- `InternalAuditAndManagementReviewCompilerFinding`
- `InternalAuditAndManagementReviewCompilerDecision`
- `InternalAuditAndManagementReviewCompilerEvidence`

Required semantic capabilities:

- plan independent internal audits of certification and laboratory processes
- compile management review inputs for performance, impartiality, resources, risks and improvement
- track decisions, owners, deadlines and effectiveness evidence
...
- `elmos-root-cause-effectiveness-verification-governor`

## Primary Outputs

- `artifacts/elmos-internal-audit-management-review-compiler/profile.yaml`
- `artifacts/elmos-internal-audit-management-review-compiler/plan.json`
- `artifacts/elmos-internal-audit-management-review-compiler/result.json`
- `artifacts/elmos-internal-audit-management-review-compiler/evidence/`
- `artifacts/elmos-internal-audit-management-review-compiler/assurance-case.json`
...
- **internal audit team audits own work** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **management review receives only positive metrics** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **resource shortfall is accepted without action** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: plan independent internal audits of certification and laboratory processes
- native scenario: compile management review inputs for performance, impartiality, resources, risks and improvement
- native scenario: track decisions, owners, deadlines and effectiveness evidence
