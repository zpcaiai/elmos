---
name: b40-supply-chain-compliance-factory
description: "Implement and verify Batch 40 Skill 1369 for supply chain compliance factory. Use when work requires \u8f6f\u4ef6\u4f9b\u5e94\u94fe\u548c\u5408\u89c4\u603b\u7f16\u6392, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-supply-chain-compliance-factory`.
...
4. Implement the smallest production-shaped capability that exercises `软件供应链和合规总编排` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-supply-chain-compliance-factory`
