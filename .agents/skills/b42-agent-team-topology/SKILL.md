---
name: b42-agent-team-topology
description: "Implement and verify Batch 42 Skill 1414 for agent team topology. Use when work requires Agent Team Topology\u548c\u804c\u8d23\u8bbe\u8ba1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Agent Team Topology和职责设计
...
## Skill 1414: Agent Team Topology和职责设计
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b42-agent-team-topology`.
...
4. Implement the smallest production-shaped capability that exercises `Agent Team Topology和职责设计` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b42-agent-team-topology`
