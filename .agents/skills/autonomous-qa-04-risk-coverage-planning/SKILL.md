---
name: "autonomous-qa-04-risk-coverage-planning"
description: "Run 04-risk-coverage-planning through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "04-risk-coverage-planning"
  source_sha256: "sha256:6d0cb90bf8c73207a2963d3f585babfdcb8e787a1287073d9c365c176f3f96e6"
  source_dependencies: "03-requirement-traceability-graph"
  ...
  runtime_skill_key: "04-risk-coverage-planning"
  runtime_handler: "execute_04_risk_coverage_planning"
  runtime_phase: "planning"
  runtime_mutating: "false"
  runtime_operation: "elmos_autonomous_qa.context_skills.plan_risk_coverage"
...
1. Accept only a structured request for the exact Skill key `04-risk-coverage-planning`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_04_risk_coverage_planning` and operation `elmos_autonomous_qa.context_skills.plan_risk_coverage`.
...
- Immutable source: `skills/04-risk-coverage-planning/SKILL.md` at `sha256:6d0cb90bf8c73207a2963d3f585babfdcb8e787a1287073d9c365c176f3f96e6`.
