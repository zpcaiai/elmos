...
description: "Implement and verify Batch 45 Skill 1482 for sre reliability dr certification. Use when work requires SRE\u3001\u53ef\u9760\u6027\u548cDR\u8ba4\u8bc1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-sre-reliability-dr-certification`.
...
4. Implement the smallest production-shaped capability that exercises `SRE、可靠性和DR认证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-sre-reliability-dr-certification`
