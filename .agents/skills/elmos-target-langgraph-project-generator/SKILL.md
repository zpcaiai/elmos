---
name: elmos-target-langgraph-project-generator
description: Generate typed graph applications with state schemas, subgraphs, checkpointers, stores, interrupts, durable execution,
  streaming, human gates and liveness validation.
version: 4.0.0
...
# TargetLanggraphProjectGenerator
...
- Generate typed StateGraph and subgraphs
- Configure checkpointer and long-term Store
- Compile interrupts and human approvals
- Wrap side effects with idempotency/reconciliation
- Verify liveness and parallel state reducers
...
- **checkpoint deserialization gadget** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **state namespace bleed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **infinite graph loop** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **duplicate side effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **interrupt approval mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
