---
name: b46-descope-defer-portfolio-governance
description: 冻结不应近期全面实现的多路线、全Marketplace、复杂自治Agent、全云组合和全行业Pack。
---
...
冻结不应近期全面实现的多路线、全Marketplace、复杂自治Agent、全云组合和全行业Pack。
...
- 延后能力仍保留设计和重新进入条件，但不得占用Reference Product关键路径资源。
...
- `product/portfolio/deferred-capabilities.json`
