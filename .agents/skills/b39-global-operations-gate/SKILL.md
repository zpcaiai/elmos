---
name: b39-global-operations-gate
description: "Implement and verify Batch 39 Skill 1368 for global operations gate. Use when work requires Batch 39\u5168\u7403\u8fd0\u8425\u8d28\u91cf\u95e8\u7981, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-global-operations-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 39全球运营质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-global-operations-gate`
