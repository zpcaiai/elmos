...
description: "Invoke the bounded repository handler for elmos-migration-controller while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P03:migration-controller"
  source_name: "elmos-migration-controller"
  installed_name: "elmos-migration-controller"
  source_logical_path: "03-elmos-project-generation-transformation-engine/skills/migration-controller/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/03-elmos-project-generation-transformation-engine/skills/migration-controller/SKILL.md.source-data"
  source_materialized_path: "03-elmos-project-generation-transformation-engine/skills/migration-controller/SKILL.md.source-data"
  source_sha256: "sha256:0cafb53827062b961162fb0df9cc2cec79418bbb7b97e70a40aff9d0cfcfa9a3"
...
- This is a deterministic repository wrapper for `03-elmos-project-generation-transformation-engine/skills/migration-controller/SKILL.md` at `sha256:0cafb53827062b961162fb0df9cc2cec79418bbb7b97e70a40aff9d0cfcfa9a3`.
- Its immutable source/runtime identity is `elmos-migration-controller`; its active installed identity is `elmos-migration-controller`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-migration-controller --request <file>
```
