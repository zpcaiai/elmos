---
name: b93-thread-memory-lifetime-analyzer
description: "Use when ELMOS must run thread memory lifetime analyzer for Batch 93 Delphi / Object Pascal Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG375"
  source_name: "thread-memory-lifetime-analyzer"
  source_sha256: "sha256:ff8167cac7ec460766ea0a1ae333e96d525abb18565a0219e544e35e069b4bc6"
  batch: 93
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 93 Language Pack / source PG375 — Thread Memory Lifetime Analyzer

## 1. Objective

Analyze thread memory lifetime analyzer within the Delphi / Object Pascal Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Thread Memory Lifetime Analyzer using the approved windows-industrial-legacy semantic contracts and toolchain versions.
...
- A representative valid delphi-object-pascal input produces all declared outputs for thread-memory-lifetime-analyzer.
