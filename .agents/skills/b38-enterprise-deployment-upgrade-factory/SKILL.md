---
name: b38-enterprise-deployment-upgrade-factory
description: "Implement and verify Batch 38 Skill 1325 for enterprise deployment upgrade factory. Use when work requires \u4f01\u4e1a\u90e8\u7f72\u548c\u5347\u7ea7\u603b\u7f16\u6392, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-enterprise-deployment-upgrade-factory`.
...
4. Implement the smallest production-shaped capability that exercises `企业部署和升级总编排` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-enterprise-deployment-upgrade-factory`
