---
name: "autonomous-qa-18-environment-orchestration"
description: "Run 18-environment-orchestration through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "18-environment-orchestration"
  source_sha256: "sha256:53a5b29046dde5025215633baccc4c77a701943d00a7f596aab2729aeb549e1c"
...
1. Accept only a structured request for the exact Skill key `18-environment-orchestration`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_18_environment_orchestration` and operation `elmos_autonomous_qa.context_skills.plan_environment_orchestration`.
...
- Immutable source: `skills/18-environment-orchestration/SKILL.md` at `sha256:53a5b29046dde5025215633baccc4c77a701943d00a7f596aab2729aeb549e1c`.
