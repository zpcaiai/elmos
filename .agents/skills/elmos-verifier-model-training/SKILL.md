---
name: verifier-model-training
description: Use this skill when Elmos must perform verifier model training as part of the 07-private-model-foundry production
...
训练补丁风险、行为等价、测试缺口、幻觉 API 和上线可接受性判断。
