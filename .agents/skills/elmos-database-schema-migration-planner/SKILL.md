---
name: elmos-database-schema-migration-planner
description: Plan expand/contract, online DDL, dependency order, backfill, validation, compatibility windows and reversible schema migrations.
version: 4.0.0
...
# Database Schema Migration Planner
...
- Generate dependency-safe migration DAG
- Classify blocking versus online operations
- Plan expand/contract and backfill waves
- Bind application compatibility windows
- Produce rollback or compensating plan
...
- **table lock outage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **destructive DDL without backup** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **backfill not idempotent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **old app incompatible during rollout** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback loses new writes** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- additive migration
- destructive migration block
- online index/build
- large backfill resume
- application dual-version window
