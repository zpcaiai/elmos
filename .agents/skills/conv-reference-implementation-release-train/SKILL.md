...
metadata:
  ...
  source_sha256: sha256:0918787825b55785dd7719956b755b8deb7d4f9ca5b26566e116a5adbc58bd41
  normalized_namespace: product-convergence-overlay
  source_batch_label: package-local-batch46-product-convergence
---

# Skill 1530：Reference Implementation Release Train
...
管理内核、Runner、Reference Route、Evals、Design Partner和Handoff的同一发布列车。
...
- 同一Release Train冻结内核、Runner、Route、Evals、Corpus、Policy和Evidence版本。
...
- `release-trains/reference-product/`
- `ci/reference-product/`
