---
name: b44-runner-fleet-economics
description: "Implement and verify Batch 44 Skill 1460 for runner fleet economics. Use when work requires Runner\u8ba1\u7b97\u548cFleet\u7ecf\u6d4e\u6027, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-runner-fleet-economics`.
...
4. Implement the smallest production-shaped capability that exercises `Runner计算和Fleet经济性` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-runner-fleet-economics`
