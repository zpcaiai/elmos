---
name: elmos-architecture-decision-record-governor
description: Create, link, supersede and validate ADRs against requirements, evidence, implementation and operational outcomes.
version: 4.0.0
...
# Architecture Decision Record Governor
...
- `ArchitectureDecisionRecordGovernorProfile`
- `ArchitectureDecisionRecordGovernorPlan`
- `ArchitectureDecisionRecordGovernorRun`
- `ArchitectureDecisionRecordGovernorDecision`

Required semantic capabilities:

- generate decision context and alternatives
- link claims to evidence and assumptions
- track implementation and supersession
- detect code/config divergence from decision
- measure outcome and trigger review
...
- `artifacts/elmos-architecture-decision-record-governor/profile.yaml`
- `artifacts/elmos-architecture-decision-record-governor/plan.json`
- `artifacts/elmos-architecture-decision-record-governor/result.json`
- `artifacts/elmos-architecture-decision-record-governor/evidence/`
...
- **ADR generated after decision to justify it** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **alternative omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **decision owner missing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **superseded ADR still enforced** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence link stale** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: generate decision context and alternatives
- native scenario: link claims to evidence and assumptions
- native scenario: track implementation and supersession
- native scenario: detect code/config divergence from decision
- native scenario: measure outcome and trigger review
