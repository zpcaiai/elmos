# miniapp-commerce-social-adapter — 执行契约

## 调用边界

- 阶段：`cross-cutting`
- 任务 ID：MAPP-027, MAPP-028
- 上游技能：miniapp-capability-registry
...
```json
{
  "artifact_id": "miniapp-commerce-social-adapter:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "miniapp-commerce-social-adapter",
  "task_id": "MAPP-027",
  "status": "passed"
}
```
...
```json
{
  "skill": "miniapp-commerce-social-adapter",
  "task_ids": ["MAPP-027", "MAPP-028"],
  "status": "passed",
  "artifacts": [],
  "gate_results": [],
  "next_skills": []
