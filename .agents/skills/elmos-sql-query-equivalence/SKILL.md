---
name: "elmos-sql-query-equivalence"
description: "在 PK/FK/UNIQUE/CHECK/NOT NULL 等约束下证明源、目标查询的 Bag、Set 或有序结果等价。 Use when the task needs the exact SQL Query Equivalence Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-sql-query-equivalence/SKILL.md"
  source_sha256: "sha256:ec815c157efc97a1ab4f58d15cd7d20c28f563acfcadbb358d379b7fc344294e"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "sql-conversion"
  runtime_handler_id: "execute_elmos_sql_query_equivalence"
...
- Exact Skill identity: `elmos-sql-query-equivalence`; exact allowlisted runtime handler: `execute_elmos_sql_query_equivalence`.
- Source identity: `skills/P0/elmos-sql-query-equivalence/SKILL.md` at `sha256:ec815c157efc97a1ab4f58d15cd7d20c28f563acfcadbb358d379b7fc344294e` from `elmos-formal-assurance-kernel-v1.0.0`.
...
在 PK/FK/UNIQUE/CHECK/NOT NULL 等约束下证明源、目标查询的 Bag、Set 或有序结果等价。
...
3. Use the repository-owned `execute_elmos_sql_query_equivalence` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["unbounded query equivalence","SMT-based bounded checking","relational algebra rewrites","counterexample database synthesis"]`
- Direct dependencies: `["elmos-observable-behavior-contract","elmos-proof-obligation-planner","elmos-verifier-portfolio-router","elmos-sql-semantic-ir"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-sql-query-equivalence/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
