---
name: "elmos-repository-refinement-composer"
description: "用 Assume–Guarantee 把函数、模块、服务和 API 层证明组合为仓库级可观察行为精化结论。 Use when the task needs the exact Repository Refinement Composer Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-repository-refinement-composer/SKILL.md"
  source_sha256: "sha256:2e36fb17add39d46faddcc34a31a629890db1617831f6491c4023580654ed6da"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "cross-language"
  runtime_handler_id: "execute_elmos_repository_refinement_composer"
...
---
# Repository Refinement Composer

## Repository integration boundary

- Exact Skill identity: `elmos-repository-refinement-composer`; exact allowlisted runtime handler: `execute_elmos_repository_refinement_composer`.
- Source identity: `skills/P0/elmos-repository-refinement-composer/SKILL.md` at `sha256:2e36fb17add39d46faddcc34a31a629890db1617831f6491c4023580654ed6da` from `elmos-formal-assurance-kernel-v1.0.0`.
...
用 Assume–Guarantee 把函数、模块、服务和 API 层证明组合为仓库级可观察行为精化结论。
...
3. Use the repository-owned `execute_elmos_repository_refinement_composer` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["assume-guarantee reasoning","interface contracts","compositional refinement","dependency SCC handling"]`
- Direct dependencies: `["elmos-rule-preservation-prover","elmos-cross-language-product-program","elmos-formal-assurance-orchestrator"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-repository-refinement-composer/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
