---
name: "elmos-spring-data-migration-refinement"
description: "证明实体、ORM 映射、Schema 变更和批量数据迁移保持键、约束、值域、关系与可逆性要求。 Use when the task needs the exact Spring Data Migration Refinement Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P1/elmos-spring-data-migration-refinement/SKILL.md"
  source_sha256: "sha256:b1689478ddd8a34eeaf5adffc264da343362b5b948270237e37c7a727ad508cf"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P1"
  domain: "spring-modernization"
  runtime_handler_id: "execute_elmos_spring_data_migration_refinement"
...
---
# Spring Data Migration Refinement

## Repository integration boundary

- Exact Skill identity: `elmos-spring-data-migration-refinement`; exact allowlisted runtime handler: `execute_elmos_spring_data_migration_refinement`.
- Source identity: `skills/P1/elmos-spring-data-migration-refinement/SKILL.md` at `sha256:b1689478ddd8a34eeaf5adffc264da343362b5b948270237e37c7a727ad508cf` from `elmos-formal-assurance-kernel-v1.0.0`.
...
证明实体、ORM 映射、Schema 变更和批量数据迁移保持键、约束、值域、关系与可逆性要求。
...
3. Use the repository-owned `execute_elmos_spring_data_migration_refinement` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["schema refinement","lossless mappings","round-trip laws","relational invariants"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P1/elmos-spring-data-migration-refinement/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
