---
name: spring-assessment-report
description: 生成可付费 Assessment、风险、路线、ETA、成本与 Pilot 建议。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-032
  source_name: spring-assessment-report
  source_path: skills/spring-assessment-report/SKILL.md
  source_sha256: sha256:9656bcee36337ddd363a515005ec38070c79b6a35888299dfb4912e0632fe472
  source_contract_sha256: sha256:4cc77e055e7a237f22ff71b9ab1d3fc9bbc3c11a307a7026c5d542e6920d7b71
...
生成可付费 Assessment、风险、路线、ETA、成本与 Pilot 建议。

## Scope and capabilities

- Executive+technical 报告
- 固定价适用性
- Go/No-go
- 未决事项
- 报价输入/SOW 输入
...
- [ ] 定义 `spring-assessment-report` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-assessment-report` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：assessment-report.md, go-no-go.json, quote-input.json。
...
- [ ] 历史失败与迁移回归边界冻结
- [ ] 报价、ETA、假设和风险进入 SOW
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：assessment-report.md, go-no-go.json, quote-input.json。
...
- Machine contract: `references/contract.json` (`sha256:4cc77e055e7a237f22ff71b9ab1d3fc9bbc3c11a307a7026c5d542e6920d7b71`).
