---
name: "elmos-proof-artifact-store"
description: "以不可变内容寻址方式保存公式、模型、日志、证书、反例、覆盖率、签名和重放环境。 Use when the task needs the exact Proof Artifact Store Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-proof-artifact-store/SKILL.md"
  source_sha256: "sha256:bc5297d9ddafc29b8e0c116f2b2121dbd8b9fd188d7dcecc75140abe2ccc37a5"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "platform"
  runtime_handler_id: "execute_elmos_proof_artifact_store"
...
- Exact Skill identity: `elmos-proof-artifact-store`; exact allowlisted runtime handler: `execute_elmos_proof_artifact_store`.
- Source identity: `skills/P0/elmos-proof-artifact-store/SKILL.md` at `sha256:bc5297d9ddafc29b8e0c116f2b2121dbd8b9fd188d7dcecc75140abe2ccc37a5` from `elmos-formal-assurance-kernel-v1.0.0`.
...
以不可变内容寻址方式保存公式、模型、日志、证书、反例、覆盖率、签名和重放环境。
...
3. Use the repository-owned `execute_elmos_proof_artifact_store` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["content-addressed storage","append-only metadata","envelope encryption","retention policies"]`
- Direct dependencies: `["elmos-proof-status-policy","elmos-trusted-computing-base-registry","elmos-proof-cache-invalidation","elmos-formal-assurance-orchestrator"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-proof-artifact-store/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
