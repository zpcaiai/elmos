...
metadata:
  ...
  repository_handler_id: "handle_elmos_database_benchmark_harness"
...
- Source group: `database-intelligence`. Dependencies: `["elmos-workload-profiler", "elmos-database-capability-registry"]`. Triggers: `["候选差距小", "关键能力缺证据", "生产容量验证"]`. Declared outputs: `["benchmark-plan.json", "benchmark-results.json", "benchmark-report.md"]`. Stable task IDs: `["BENCH-001", "BENCH-002", "BENCH-003", "BENCH-004", "BENCH-005", "BENCH-006", "BENCH-007", "BENCH-008", "BENCH-009", "BENCH-010", "BENCH-011", "BENCH-012"]`.
- This normalized Skill is installed and invocable. The repository binds `handle_elmos_database_benchmark_harness` in `engines/database-bigdata-engine/src/elmos_database_bigdata/handlers/database_intelligence.py` as a bounded plan-skeleton entry point; the reviewed code declares no database, provider, network, deployment, benchmark, mutation, or certification operation.
