---
name: b45-maturity-model-editions
description: "Implement and verify Batch 45 Skill 1476 for maturity model editions. Use when work requires \u4ea7\u54c1\u6210\u719f\u5ea6\u6a21\u578b\u548cEdition\u5206\u7ea7, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-maturity-model-editions`.
...
4. Implement the smallest production-shaped capability that exercises `产品成熟度模型和Edition分级` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-maturity-model-editions`
