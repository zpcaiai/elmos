---
name: elmos-sql-semantic-gap-analyzer
description: Identify dialect differences in NULL/empty string, numeric precision, time, Unicode, collation, coercion, locking, transaction DDL, sequence visibility and procedural behavior.
version: 4.0.0
...
- Diff source and target DB semantic profiles
- Classify compile-time, runtime, data and operational gaps
- Generate dual-execution properties
- Require data remediation for non-representable values
- Bind gaps to cutover and rollback conditions
...
- `sql-semantic-gaps.json`
- `database-gap-obligations.json`
- `database-allowed-delta.yaml`
- `gap-mitigation-plan.json`
...
- **data-dependent gap missed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **collation tested on ASCII only** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **transaction gap treated as syntax** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **production parameter differs from test** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsupported routine silently stubbed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- collation/case/trailing spaces
- locking/isolation
- transactional DDL and sequence
