...
## Inspirations
- DB runtime differential testing

## Activation conditions
- Activate when the task requires: verify isolation, locking, retries, autocommit, savepoints and error behavior across source/target database engines.
