---
name: database-security-policy-migration
description: "Repository-owned bounded wrapper for database-security-policy-migration; external evidence remains NOT_RUN."
---
...
Migrate users, roles, grants, row-level policies, masking and encryption semantics with least-privilege verification.
...
4. Submit `database-security-policy-migration` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `64c05cae957b01b3ac9d9ac69e58f41cd737f305be62178c5bb014b8e3fb385e`
