---
name: elmos-peer-assessment-witness-audit-controller
description: Implement and independently certify peer assessment and witness audit controller, including plan peer assessments, office reviews and witnessed evaluations, evaluate evaluator consistency, competence and application of scheme rules and record findings, corrective action and recognition decisions.
version: 4.0.0
...
# Peer Assessment and Witness Audit Controller
...
- `PeerAssessmentAndWitnessAuditControllerProfile`
- `PeerAssessmentAndWitnessAuditControllerRun`
- `PeerAssessmentAndWitnessAuditControllerFinding`
- `PeerAssessmentAndWitnessAuditControllerDecision`
- `PeerAssessmentAndWitnessAuditControllerEvidence`

Required semantic capabilities:

- plan peer assessments, office reviews and witnessed evaluations
- evaluate evaluator consistency, competence and application of scheme rules
- record findings, corrective action and recognition decisions
...
- `artifacts/elmos-peer-assessment-witness-audit-controller/profile.yaml`
- `artifacts/elmos-peer-assessment-witness-audit-controller/plan.json`
- `artifacts/elmos-peer-assessment-witness-audit-controller/result.json`
- `artifacts/elmos-peer-assessment-witness-audit-controller/evidence/`
- `artifacts/elmos-peer-assessment-witness-audit-controller/assurance-case.json`
...
- **witness sample excludes difficult cases** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **peer assessor lacks domain competence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **observed performance differs from routine operation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: plan peer assessments, office reviews and witnessed evaluations
- native scenario: evaluate evaluator consistency, competence and application of scheme rules
- native scenario: record findings, corrective action and recognition decisions
