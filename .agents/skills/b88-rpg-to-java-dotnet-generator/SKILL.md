---
name: b88-rpg-to-java-dotnet-generator
description: "Use when ELMOS must run rpg to java dotnet generator for Batch 88 IBM i RPG / CL / DDS / DB2 for i Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG314"
  source_name: "rpg-to-java-dotnet-generator"
  source_sha256: "sha256:70e9c38192ec951854bd08421811aa96c687ac7dd5e6751438a7941859d398a0"
  batch: 88
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 88 Language Pack / source PG314 — Rpg To Java Dotnet Generator

## 1. Objective

Generate rpg to java dotnet generator within the IBM i RPG / CL / DDS / DB2 for i Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Rpg To Java Dotnet Generator using the approved enterprise-ibmi semantic contracts and toolchain versions.
...
- A representative valid ibmi-rpg input produces all declared outputs for rpg-to-java-dotnet-generator.
