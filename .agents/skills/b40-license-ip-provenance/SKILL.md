---
name: b40-license-ip-provenance
description: "Implement and verify Batch 40 Skill 1381 for license ip provenance. Use when work requires License\u3001IP\u548c\u4ee3\u7801\u6765\u6e90\u6cbb\u7406, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-license-ip-provenance`.
...
4. Implement the smallest production-shaped capability that exercises `License、IP和代码来源治理` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-license-ip-provenance`
