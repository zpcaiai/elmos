...
- Source group: `database-intelligence`. Dependencies: `[]`. Triggers: `["需要选择数据库", "需要设计数据平台", "收到数据项目需求或现有系统资料"]`. Declared outputs: `["workload-requirements.json", "source-inventory.json", "assumptions-and-gaps.md"]`.
