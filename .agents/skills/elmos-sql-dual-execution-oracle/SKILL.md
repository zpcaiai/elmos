...
description: Run source and target SQL against real engines with equivalent fixtures and compare results, errors, state, trigger effects and transaction outcomes.
version: 4.0.0
...
- Provision exact real database engines
- Execute source/target under controlled fixtures
- Compare typed result sets and errors
- Compare post-state, triggers and audit effects
- Minimize data-dependent counterexamples
...
- `sql-dual-execution-results.json`
- `database-observation-traces/`
- `sql-mismatch-clusters.json`
- `sql-counterexamples/`
...
- **test engine differs from production** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **result comparator ignores collation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared faulty expected data** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **target side effect not rolled back** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **query order normalized incorrectly** — must have a preventive control, a detective signal, a negative fixture and a response action.
