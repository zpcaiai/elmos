...
metadata:
  ...
  source_sha256: sha256:fd6991e74b36dbfd008a5f75a24bf58b93dc8b443d91fe1a1bf0592f24435c0a
  normalized_namespace: product-convergence-overlay
  source_batch_label: package-local-batch46-product-convergence
---

# Skill 1528：产品收敛P0–P3路线图
...
将统一内核、Reference Product、生产接管、规模生态分为有Gate的阶段计划。
...
- P0–P3每阶段有入口、退出、Owner、预算、风险和证据；后阶段不得绕过前阶段。
...
- `product/roadmap/convergence.json`
- `apps/web/src/features/convergence-dashboard/`
