---
name: b38-zero-downtime-upgrade
description: "Implement and verify Batch 38 Skill 1344 for zero downtime upgrade. Use when work requires Zero-downtime\u5347\u7ea7\u548c\u6eda\u52a8\u53d1\u5e03, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Zero-downtime升级和滚动发布
...
## Skill 1344: Zero-downtime升级和滚动发布
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-zero-downtime-upgrade`.
...
4. Implement the smallest production-shaped capability that exercises `Zero-downtime升级和滚动发布` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-zero-downtime-upgrade`
