---
name: scanning-recipe-accumulator
description: 先全仓扫描和聚合事实，再生成/修改文件。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: FOUNDATION-02-scanning-recipe-accumulator
  source_name: scanning-recipe-accumulator
  source_path: skills/scanning-recipe-accumulator/SKILL.md
  source_sha256: sha256:691f184b5a20ce899addc1e186566a4b430c39aed69fa56e1823d843622be213
  source_contract_sha256: sha256:e1c8fb143f37f1a8b35cf34aa09994b2d8b7409bed757212c5807071d5c48358
...
在 Elmos 需要实现或升级 **Scanning Recipe Accumulator** 相关能力时使用；它不是仅供解释的提示词，而是实现、测试与验收契约。

## Capabilities to implement

- scan 阶段只收集事实与异常
- Accumulator 可汇总跨文件符号、依赖和框架使用
- generate/edit 读取同一聚合状态
- 支持跨模块迁移需要的全局视图
...
- [ ] 定义 `scanning-recipe-accumulator` 的 public interface、input/output/error schemas。
- [ ] 建立 `scanning-recipe-accumulator` 的 capability/feature flags 与版本字段。
...
- [ ] 至少覆盖并验收：scan 阶段只收集事实与异常；以及 Accumulator 可汇总跨文件符号、依赖和框架使用。
...
- Machine contract: `references/contract.json` (`sha256:e1c8fb143f37f1a8b35cf34aa09994b2d8b7409bed757212c5807071d5c48358`).
