...
description: "Invoke the bounded repository handler for elmos-fallback-circuitbreaker-hedging while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P06:fallback-circuitbreaker-hedging"
  source_name: "elmos-fallback-circuitbreaker-hedging"
  installed_name: "elmos-fallback-circuitbreaker-hedging"
  source_logical_path: "06-elmos-intelligent-model-router/skills/fallback-circuitbreaker-hedging/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/06-elmos-intelligent-model-router/skills/fallback-circuitbreaker-hedging/SKILL.md.source-data"
  source_materialized_path: "06-elmos-intelligent-model-router/skills/fallback-circuitbreaker-hedging/SKILL.md.source-data"
  source_sha256: "sha256:48fea31c462bd50ddcf3e27fdf4c136afe7ed3f3d48996f79a7e3726de5920dd"
...
# elmos-fallback-circuitbreaker-hedging
...
- This is a deterministic repository wrapper for `06-elmos-intelligent-model-router/skills/fallback-circuitbreaker-hedging/SKILL.md` at `sha256:48fea31c462bd50ddcf3e27fdf4c136afe7ed3f3d48996f79a7e3726de5920dd`.
- Its immutable source/runtime identity is `elmos-fallback-circuitbreaker-hedging`; its active installed identity is `elmos-fallback-circuitbreaker-hedging`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-fallback-circuitbreaker-hedging --request <file>
```
