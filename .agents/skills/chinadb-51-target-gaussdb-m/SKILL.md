---
name: chinadb-51-target-gaussdb-m
description: "Use when ELMOS must follow the ChinaDB commercial database-migration specification for GaussDB M-Compatible Target Adapter. Keep exact directed route and version semantics, require real evidence, and fail closed on unsupported behavior."
metadata:
  source_package: "chinadb-commercial-migration-skills"
  source_version: "1.0.0"
  source_directory: "51-target-gaussdb-m"
  source_path: "skills/51-target-gaussdb-m/SKILL.md"
  source_sha256: "sha256:996f9a944a454788b3346bdb3efc635f412b4704e1c62bc33a44a73b2aa9eaf3"
  normalized_namespace: "chinadb-commercial-migration-v1"
  implementation_state: "SPEC_ONLY"
  external_evidence_status: "NOT_RUN"
  production_certification: "NOT_CERTIFIED"
---
# GaussDB M-Compatible Target Adapter

- **Skill ID:** `51-target-gaussdb-m`
- **Version:** `1.0.0`
...
Implement the production target adapter for **GaussDB**. Route mode: **M-compatible target, exact version**. The adapter owns target rendering, type/function/procedural capability mapping, catalog apply/introspection, error mapping, plan capture and operational hooks.

**Native leverage:** GaussDB publishes M-compatible behavior configuration; migration tooling may be combined with the platform.
...
- adapters/target/51-gaussdb-m/capabilities.py
- adapters/target/51-gaussdb-m/types.py
- adapters/target/51-gaussdb-m/ddl.py
- adapters/target/51-gaussdb-m/sql.py
- adapters/target/51-gaussdb-m/procedural.py
- adapters/target/51-gaussdb-m/errors.py
- adapters/target/51-gaussdb-m/plans.py
- adapters/target/51-gaussdb-m/operations.py
...
3. Capture compatibility GUC/behavior parameters as route configuration and certification fingerprint.
4. Map MySQL sql_mode, unsigned/enum/set/zero-date semantics explicitly.
5. Test generated keys, autocommit, locking and error mapping.
6. Treat parameter changes as evidence-invalidating configuration changes.
...
- MySQL unsigned boundaries
- zero date/sql_mode
- auto increment
- on duplicate
- charset/collation
- compatibility parameter fingerprint change
...
- Provenance is pinned to `chinadb-commercial-migration-skills` version `1.0.0`, source Skill `51-target-gaussdb-m`, and the SHA-256 digest in frontmatter.
