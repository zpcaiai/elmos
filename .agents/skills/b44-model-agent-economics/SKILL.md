---
name: b44-model-agent-economics
description: "Implement and verify Batch 44 Skill 1461 for model agent economics. Use when work requires \u6a21\u578bToken\u3001Provider\u548cAgent\u7ecf\u6d4e\u6027, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 模型Token、Provider和Agent经济性
...
## Skill 1461: 模型Token、Provider和Agent经济性
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-model-agent-economics`.
...
4. Implement the smallest production-shaped capability that exercises `模型Token、Provider和Agent经济性` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-model-agent-economics`
