---
name: b89-quarto-rmarkdown-report-generator
description: "Use when ELMOS must run quarto rmarkdown report generator for Batch 89 R / Quarto / Shiny / renv Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG324"
  source_name: "quarto-rmarkdown-report-generator"
  source_sha256: "sha256:d63976f0fad13f62ec872b7fa426e8d242f123ea7c26d6739cdc87d660a63b35"
  batch: 89
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 89 Language Pack / source PG324 — Quarto Rmarkdown Report Generator

## 1. Objective

Generate quarto rmarkdown report generator within the R / Quarto / Shiny / renv Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Quarto Rmarkdown Report Generator using the approved data-science semantic contracts and toolchain versions.
...
- A representative valid r-data-science input produces all declared outputs for quarto-rmarkdown-report-generator.
