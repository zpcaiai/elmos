...
description: Compile measurable product, service, data and AI quality characteristics into requirements, metrics, evaluation modules and release evidence.
version: 4.0.0
...
# AI Quality Model and Evaluation Compiler
...
- **Kernel authorities used:** K1, K3, K6, K8
...
- Select applicable software and AI quality characteristics
- Define operational measures and thresholds
- Connect probabilistic quality to statistical evidence
- Evaluate functional suitability, reliability, security, maintainability and interaction quality
- Report tradeoffs and bounded context of use
...
- `elmos-ai-assurance-contract-compiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
...
- `ai-quality-model.yaml`
- `quality-measure-catalog.json`
- `quality-evaluation-plan.json`
- `quality-evaluation-results.json`
...
- **quality model used as unchecked checklist** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **metric has no decision threshold** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **aggregate score hides critical failure** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **probabilistic result shown deterministic** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evaluation context differs from production** — must have a preventive control, a detective signal, a negative fixture and a response action.
