---
name: elmos-ai-tenant-memory-isolation-verifier
description: Prove isolation of session, user, organization, episodic, semantic and procedural memory across storage, cache,
  retrieval and trace boundaries.
version: 4.0.0
...
# AI Tenant Memory Isolation Verifier
...
- `Approval`
- `ResidualRisk`
- `AITenantMemoryIsolationVerifierRun`
- `AITenantMemoryIsolationVerifierDecision`

Required semantic capabilities:

- Memory scope and namespace model
- RLS/ACL/cache partition verification
- Cross-agent sharing consent
- Export/delete and lifecycle isolation
- Adversarial tenant crossover campaign
...
- `memory-isolation-model.json`
- `tenant-isolation-tests.json`
- `memory-leak-counterexamples.json`
- `memory-isolation-certificate.json`
...
- **tenant memory bleed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared embedding namespace** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **trace reveals memory** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **consent-free sharing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **identifier collision** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- cache isolation
- export/delete
- cross-tenant adversarial query
