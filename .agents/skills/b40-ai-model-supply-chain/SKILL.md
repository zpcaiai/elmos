---
name: b40-ai-model-supply-chain
description: "Implement and verify Batch 40 Skill 1386 for ai model supply chain. Use when work requires AI/ML-BOM\u3001\u6a21\u578b\u6765\u6e90\u548c\u6a21\u578b\u4f9b\u5e94\u94fe, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# AI/ML-BOM、模型来源和模型供应链
...
## Skill 1386: AI/ML-BOM、模型来源和模型供应链
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-ai-model-supply-chain`.
...
4. Implement the smallest production-shaped capability that exercises `AI/ML-BOM、模型来源和模型供应链` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-ai-model-supply-chain`
