---
name: b45-mature-product-final-gate
description: "Implement and verify Batch 45 Skill 1496 for mature product final gate. Use when work requires Batch 45\u6210\u719f\u4ea7\u54c1\u6700\u7ec8\u8d28\u91cf\u95e8\u7981, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-mature-product-final-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 45成熟产品最终质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-mature-product-final-gate`
