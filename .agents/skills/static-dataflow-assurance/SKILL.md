---
name: static-dataflow-assurance
description: "Repository-owned bounded wrapper for static-dataflow-assurance; external evidence remains NOT_RUN."
---
...
Run semantic static analysis, taint/data-flow checks and interprocedural defect detection on changed code and critical paths.
...
4. Submit `static-dataflow-assurance` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `7927e13e7d0b753c4d80c0d86b405922d7e039e99565522a19899799c625a3a8`
