---
name: elmos-accessibility-conformance-certifier
description: Generate and independently verify WCAG 2.2 AA-oriented accessibility evidence for web, generated UI, operator consoles and agent-created interactive components.
version: 4.0.0
...
# Accessibility Conformance Certifier
...
- **Kernel authorities used:** K1, K5, K6, K8
...
- `AccessibilityConformanceCertifierRun`
- `AccessibilityConformanceCertifierDecision`
- `EvidenceArtifact`
- `ProofResult`

Required semantic capabilities:

- Run automated semantic, contrast, focus and name/role/value tests
- Exercise keyboard, screen reader, zoom, timing and error flows
- Test dynamic and streamed agent UI updates
- Require qualified manual review for criteria not automatable
- Bind exceptions to user impact, remediation and expiry
...
- `elmos-mcp-apps-a2ui-generator` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `accessibility-conformance-report.json`
- `accessibility-test-results/`
- `manual-review-checklist.json`
...
- **automated scanner claimed full conformance** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hidden component not tested** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **focus stolen by agent update** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **status message inaccessible** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **exception has no remediation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- focus after streaming update
- contrast and zoom
- timeout and reauthentication
