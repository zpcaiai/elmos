---
name: tool-call-schema-and-policy-check
description: Use this skill when Elmos must perform tool call schema and policy check as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
