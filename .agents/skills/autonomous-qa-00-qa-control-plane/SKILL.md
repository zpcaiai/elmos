---
name: "autonomous-qa-00-qa-control-plane"
description: "Run 00-qa-control-plane through its exact repository-owned Autonomous QA handler."
metadata:
  ...
  source_sha256: "sha256:72fe0e567586375feabff9b936003d4410608015c67ba630a1b299db98a5e100"
  source_dependencies: ""
  ...
  runtime_skill_key: "00-qa-control-plane"
  runtime_handler: "execute_00_qa_control_plane"
  runtime_phase: "control"
  runtime_mutating: "true"
  runtime_operation: "elmos_autonomous_qa.trusted_services.control_plane_operation_contract"
...
1. Accept only a structured request for the exact Skill key `00-qa-control-plane`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_00_qa_control_plane` and operation `elmos_autonomous_qa.trusted_services.control_plane_operation_contract`.
...
- Immutable source: `skills/00-qa-control-plane/SKILL.md` at `sha256:72fe0e567586375feabff9b936003d4410608015c67ba630a1b299db98a5e100`.
