---
name: skill-marketplace-certification
description: 将 Skill/Recipe/Agent/Tool Bundle 纳入统一目录、版本、依赖、权限和认证体系。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: FOUNDATION-10-skill-marketplace-certification
  source_name: skill-marketplace-certification
  source_path: skills/skill-marketplace-certification/SKILL.md
  source_sha256: sha256:2bf043009d2d281cac333957fe9ef116afde05c16c1e547e31e2e2988e13e870
  source_contract_sha256: sha256:23d758a4f4396b277553b42e02d078fc2cfd92aadec2bb73752c3dde8c1a3103
...
# Skill Marketplace Certification

## Goal

将 Skill/Recipe/Agent/Tool Bundle 纳入统一目录、版本、依赖、权限和认证体系。

## Use when

在 Elmos 需要实现或升级 **Skill Marketplace Certification** 相关能力时使用；它不是仅供解释的提示词，而是实现、测试与验收契约。

## Capabilities to implement

- 目录支持 ecosystem/category/version/team/compatibility
- bundle lazy resolve，依赖和权限声明机器可读
- 认证覆盖 schema、测试、性能、安全、license、适用性
- 生产 Agent 默认只看到通过认证且权限允许的 Skill
...
- [ ] 定义 `skill-marketplace-certification` 的 public interface、input/output/error schemas。
- [ ] 建立 `skill-marketplace-certification` 的 capability/feature flags 与版本字段。
...
- [ ] 至少覆盖并验收：目录支持 ecosystem/category/version/team/compatibility；以及 bundle lazy resolve，依赖和权限声明机器可读。
...
- Machine contract: `references/contract.json` (`sha256:23d758a4f4396b277553b42e02d078fc2cfd92aadec2bb73752c3dde8c1a3103`).
