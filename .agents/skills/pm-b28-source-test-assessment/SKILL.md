...
- Invoke this repository Skill as `$pm-b28-source-test-assessment`.
- Immutable source identity: `batch-28-source-test-assessment` in `precision-migration-b01-44` (B28).
- Runtime adapter: `differential-test-and-repair`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b28-source-test-assessment`.
...
- 当任务涉及 **source-test-inventory** 时，调用 `../pm-b28-source-test-inventory/SKILL.md`。
- 当任务涉及 **test-coverage-normalizer** 时，调用 `../pm-b28-test-coverage-normalizer/SKILL.md`。
- 当任务涉及 **assertion-quality-analyzer** 时，调用 `../pm-b28-assertion-quality-analyzer/SKILL.md`。
- 当任务涉及 **skipped-and-flaky-test-detector** 时，调用 `../pm-b28-skipped-and-flaky-test-detector/SKILL.md`。
- 当任务涉及 **test-oracle-classifier** 时，调用 `../pm-b28-test-oracle-classifier/SKILL.md`。
- 当任务涉及 **test-mutation-strength-assessment** 时，调用 `../pm-b28-test-mutation-strength-assessment/SKILL.md`。
- 当任务涉及 **missing-test-gap-analysis** 时，调用 `../pm-b28-missing-test-gap-analysis/SKILL.md`。
- 当任务涉及 **test-migration-feasibility** 时，调用 `../pm-b28-test-migration-feasibility/SKILL.md`。
