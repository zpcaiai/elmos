...
# CONV-017：统一Benchmark Corpus治理

## Objective

治理Synthetic、Open-source、Internal Holdout和Customer-private四类Corpus并防止污染。
...
1. 注册Corpus来源、License、用途和访问边界。
2. 隔离Development与Holdout。
3. 建立客户私有数据不可跨租户规则。
4. 对模型/Recipe训练记录数据血缘。
5. 发布版本化Benchmark结果。
