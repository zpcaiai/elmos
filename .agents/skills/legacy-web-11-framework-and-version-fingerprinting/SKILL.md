---
name: legacy-web-11-framework-and-version-fingerprinting
description: "Repository-owned exact runtime interface for 框架与版本指纹; bounded semantic analysis and evidence generation for Java legacy web modernization."
metadata:
  source_package: elmos.java-legacy-web.repository-modernization
  source_version: 1.0.0
  source_id: 11-framework-and-version-fingerprinting
  source_digest: sha256:acdb7dbdf32dda910eff733f32c11fded224e0a75dae67c82eac8f1f15653d68
  phase: repository-forensics
  runtime_state: CODE_COMPLETE_LOCAL
  capability_state: LOCAL_EXECUTED
  operation_code: FRAMEWORK_INVENTORY_RECOVERED
  runtime_handler_id: legacy-web-handler:11-framework-and-version-fingerprinting
---
