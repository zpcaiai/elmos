---
name: affected-test-selection
description: "Repository-owned bounded wrapper for affected-test-selection; external evidence remains NOT_RUN."
---
...
Map changed symbols and targets to the minimal high-confidence unit/integration/contract/E2E certification set.
...
4. Submit `affected-test-selection` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `bc20a317e4cd135246706d7d1cf31a7b195d7bfac66d86dbfbf9ffdc9cef5bc4`
