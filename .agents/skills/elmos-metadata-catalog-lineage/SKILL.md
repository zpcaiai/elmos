...
- Source group: `bigdata-core`. Dependencies: `["elmos-data-modeling-semantic-layer"]`. Triggers: `["数据治理/可发现", "多引擎多管道", "影响分析与审计"]`. Declared outputs: `["metadata-platform/", "lineage-policy.json", "ownership-map.json", "catalog-seed/"]`.
