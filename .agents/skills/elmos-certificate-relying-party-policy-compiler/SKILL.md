...
# Certificate Relying-Party Policy Compiler
...
- `CertificateRelyingPartyPolicyCompilerProfile`
- `CertificateRelyingPartyPolicyCompilerRun`
- `CertificateRelyingPartyPolicyCompilerFinding`
- `CertificateRelyingPartyPolicyCompilerDecision`
- `CertificateRelyingPartyPolicyCompilerEvidence`

Required semantic capabilities:

- compile acceptable issuers, schemes, assurance levels, freshness, scope and exceptions for deployment decisions
- evaluate certificate against intended action and risk
- record reliance decision, unresolved claims and fallback
...
- `artifacts/elmos-certificate-relying-party-policy-compiler/profile.yaml`
- `artifacts/elmos-certificate-relying-party-policy-compiler/plan.json`
- `artifacts/elmos-certificate-relying-party-policy-compiler/result.json`
- `artifacts/elmos-certificate-relying-party-policy-compiler/evidence/`
- `artifacts/elmos-certificate-relying-party-policy-compiler/assurance-case.json`
...
- **any valid signature is treated as sufficient** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **certificate for test environment authorizes production** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **relying party ignores critical limitation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile acceptable issuers, schemes, assurance levels, freshness, scope and exceptions for deployment decisions
- native scenario: evaluate certificate against intended action and risk
- native scenario: record reliance decision, unresolved claims and fallback
