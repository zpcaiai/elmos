---
name: elmos-secretless-broker-breakglass-controller
description: Issue short-lived scoped credentials, eliminate static secrets, and govern audited emergency access with dual control and automatic expiry.
version: 4.0.0
...
# Secretless Broker and Break-Glass Controller
...
- `SecretlessBrokerAndBreakGlassControllerProfile`
- `SecretlessBrokerAndBreakGlassControllerPlan`
- `SecretlessBrokerAndBreakGlassControllerRun`
- `SecretlessBrokerAndBreakGlassControllerDecision`

Required semantic capabilities:

- broker workload-bound credentials
- enforce purpose, path and parameter scope
- rotate and revoke automatically
- implement dual-control break-glass
- reconcile and review every emergency action
...
- `artifacts/elmos-secretless-broker-breakglass-controller/profile.yaml`
- `artifacts/elmos-secretless-broker-breakglass-controller/plan.json`
- `artifacts/elmos-secretless-broker-breakglass-controller/result.json`
- `artifacts/elmos-secretless-broker-breakglass-controller/evidence/`
...
- **credential written to workspace** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **break-glass never expires** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **scope expands on refresh** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **audit trail editable** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **emergency account becomes routine** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: broker workload-bound credentials
- native scenario: enforce purpose, path and parameter scope
- native scenario: rotate and revoke automatically
- native scenario: implement dual-control break-glass
- native scenario: reconcile and review every emergency action
