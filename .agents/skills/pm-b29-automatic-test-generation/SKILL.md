...
- Invoke this repository Skill as `$pm-b29-automatic-test-generation`.
- Immutable source identity: `batch-29-automatic-test-generation` in `precision-migration-b01-44` (B29).
- Runtime adapter: `differential-test-and-repair`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b29-automatic-test-generation`.
...
- 当任务涉及 **openapi-contract-test-generator** 时，调用 `../pm-b29-openapi-contract-test-generator/SKILL.md`。
- 当任务涉及 **controller-route-test-generator** 时，调用 `../pm-b29-controller-route-test-generator/SKILL.md`。
- 当任务涉及 **graphql-test-generator** 时，调用 `../pm-b29-graphql-test-generator/SKILL.md`。
- 当任务涉及 **protobuf-api-test-generator** 时，调用 `../pm-b29-protobuf-api-test-generator/SKILL.md`。
- 当任务涉及 **dto-validation-test-generator** 时，调用 `../pm-b29-dto-validation-test-generator/SKILL.md`。
- 当任务涉及 **database-state-test-generator** 时，调用 `../pm-b29-database-state-test-generator/SKILL.md`。
- 当任务涉及 **side-effect-test-generator** 时，调用 `../pm-b29-side-effect-test-generator/SKILL.md`。
- 当任务涉及 **business-invariant-test-generator** 时，调用 `../pm-b29-business-invariant-test-generator/SKILL.md`。
- 当任务涉及 **user-journey-test-generator** 时，调用 `../pm-b29-user-journey-test-generator/SKILL.md`。
- 当任务涉及 **production-trace-test-generator** 时，调用 `../pm-b29-production-trace-test-generator/SKILL.md`。
- 当任务涉及 **property-test-generator** 时，调用 `../pm-b29-property-test-generator/SKILL.md`。
- 当任务涉及 **fuzz-test-generator** 时，调用 `../pm-b29-fuzz-test-generator/SKILL.md`。
- 当任务涉及 **mutation-test-generator** 时，调用 `../pm-b29-mutation-test-generator/SKILL.md`。
- 当任务涉及 **concurrency-test-generator** 时，调用 `../pm-b29-concurrency-test-generator/SKILL.md`。
