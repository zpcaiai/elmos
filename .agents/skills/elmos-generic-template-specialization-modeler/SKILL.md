---
name: elmos-generic-template-specialization-modeler
description: "Represent Java/C# generics, C++ templates, Rust generics/traits, Swift protocols and specialization/monomorphization consequences."
version: 1.0.0
skill_id: ELMOS-POLY-181
...
triggers:
  - "Use when implementing or executing `elmos-generic-template-specialization-modeler`."
  - "Use when a migration/certification DAG requires `name-semantics` capability."
outputs:
  - "semantic-assurance/elmos-generic-template-specialization-modeler/model.json"
  - "semantic-assurance/elmos-generic-template-specialization-modeler/evidence.json"
  - "semantic-assurance/elmos-generic-template-specialization-modeler/diagnostics.json"
---

# Generic, Template & Specialization Modeler

## Objective

Represent Java/C# generics, C++ templates, Rust generics/traits, Swift protocols and specialization/monomorphization consequences.
...
- [ ] erasure reflection fixture.
- [ ] C++ specialization fixture.
- [ ] Rust trait bound fixture.
