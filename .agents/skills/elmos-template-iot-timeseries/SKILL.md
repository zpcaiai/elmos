...
metadata:
  ...
  repository_handler_id: "handle_elmos_template_iot_timeseries"
...
- Source group: `bigdata-templates`. Dependencies: `["elmos-bigdata-project-orchestrator"]`. Triggers: `["IoT/工业/传感器", "时序分析", "实时告警/设备监控"]`. Declared outputs: `["template-plan.json", "generated-project/"]`. Stable task IDs: `["TPLIOT-001", "TPLIOT-002", "TPLIOT-003", "TPLIOT-004", "TPLIOT-005", "TPLIOT-006", "TPLIOT-007", "TPLIOT-008", "TPLIOT-009", "TPLIOT-010", "TPLIOT-011", "TPLIOT-012"]`.
- This normalized Skill is installed and invocable. The repository binds `handle_elmos_template_iot_timeseries` in `engines/database-bigdata-engine/src/elmos_database_bigdata/handlers/templates.py` as a bounded plan-skeleton entry point; the reviewed code declares no database, provider, network, deployment, benchmark, mutation, or certification operation.
