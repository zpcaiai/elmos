...
description: Use this skill when Elmos must perform telemetry loss and integrity monitor as part of the 12-observability-lineage-finops production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
