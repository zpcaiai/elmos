---
name: elmos-api-consumer-driven-contract-verifier
description: Generate and execute provider/consumer contracts for APIs, tools and events, including version negotiation, errors, auth and deployment compatibility.
version: 4.0.0
...
# API Consumer-Driven Contract Verifier
...
- `APIConsumerDrivenContractVerifierProfile`
- `APIConsumerDrivenContractVerifierPlan`
- `APIConsumerDrivenContractVerifierRun`
- `APIConsumerDrivenContractVerifierDecision`

Required semantic capabilities:

- mine real consumer expectations
- publish versioned contract artifacts
- verify provider against all active consumers
- test mixed-version deployment and rollback
- detect orphaned and shadow consumers
...
- `artifacts/elmos-api-consumer-driven-contract-verifier/profile.yaml`
- `artifacts/elmos-api-consumer-driven-contract-verifier/plan.json`
- `artifacts/elmos-api-consumer-driven-contract-verifier/result.json`
- `artifacts/elmos-api-consumer-driven-contract-verifier/evidence/`
...
- **consumer pact stale** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated test asserts implementation detail** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unknown consumer omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **auth context simplified** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider self-publishes passing result** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: mine real consumer expectations
- native scenario: publish versioned contract artifacts
- native scenario: verify provider against all active consumers
- native scenario: test mixed-version deployment and rollback
- native scenario: detect orphaned and shadow consumers
