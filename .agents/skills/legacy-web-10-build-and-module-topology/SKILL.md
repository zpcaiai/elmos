---
name: legacy-web-10-build-and-module-topology
description: "Repository-owned exact runtime interface for 构建与模块拓扑恢复; bounded semantic analysis and evidence generation for Java legacy web modernization."
metadata:
  source_package: elmos.java-legacy-web.repository-modernization
  source_version: 1.0.0
  source_id: 10-build-and-module-topology
  source_digest: sha256:8efa25a10c31a8ca36fecdc9becc66921631e0aa0a8a84787409a30d2d79a383
  phase: repository-forensics
  runtime_state: CODE_COMPLETE_LOCAL
  capability_state: LOCAL_EXECUTED
  operation_code: BUILD_TOPOLOGY_RECOVERED
  runtime_handler_id: legacy-web-handler:10-build-and-module-topology
---
