---
name: "elmos-dml-state-equivalence"
description: "证明 INSERT/UPDATE/DELETE/MERGE/UPSERT 转换后的受影响行、最终数据库状态、返回值和冲突处理等价。 Use when the task needs the exact DML State Equivalence Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-dml-state-equivalence/SKILL.md"
  source_sha256: "sha256:a674838de1f7379eb1cd267100df652d20ef578e7a6b52924200dcc608da069d"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "sql-conversion"
  runtime_handler_id: "execute_elmos_dml_state_equivalence"
...
- Exact Skill identity: `elmos-dml-state-equivalence`; exact allowlisted runtime handler: `execute_elmos_dml_state_equivalence`.
- Source identity: `skills/P0/elmos-dml-state-equivalence/SKILL.md` at `sha256:a674838de1f7379eb1cd267100df652d20ef578e7a6b52924200dcc608da069d` from `elmos-formal-assurance-kernel-v1.0.0`.
...
证明 INSERT/UPDATE/DELETE/MERGE/UPSERT 转换后的受影响行、最终数据库状态、返回值和冲突处理等价。
...
3. Use the repository-owned `execute_elmos_dml_state_equivalence` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["state relational verification","affected-row equivalence","conflict semantics"]`
- Direct dependencies: `["elmos-observable-behavior-contract","elmos-proof-obligation-planner","elmos-sql-semantic-ir","elmos-sql-query-equivalence"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-dml-state-equivalence/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
