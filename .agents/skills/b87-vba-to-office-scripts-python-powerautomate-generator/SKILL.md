---
name: b87-vba-to-office-scripts-python-powerautomate-generator
description: "Use when ELMOS must run vba to office scripts python powerautomate generator for Batch 87 VB6 / VBA / VB.NET / Office Automation Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG303"
  source_name: "vba-to-office-scripts-python-powerautomate-generator"
  source_sha256: "sha256:3d54ae41922567a8d3a339648cb3863571f365abeecb5a88801fbb9e693d82d9"
  batch: 87
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 87 Language Pack / source PG303 — Vba To Office Scripts Python Powerautomate Generator

## 1. Objective

Generate vba to office scripts python powerautomate generator within the VB6 / VBA / VB.NET / Office Automation Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Vba To Office Scripts Python Powerautomate Generator using the approved windows-legacy semantic contracts and toolchain versions.
...
- A representative valid vb-office input produces all declared outputs for vba-to-office-scripts-python-powerautomate-generator.
