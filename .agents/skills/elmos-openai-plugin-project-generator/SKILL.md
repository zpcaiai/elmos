---
name: elmos-openai-plugin-project-generator
description: Generate a complete OpenAI Plugin project containing Skills, remote MCP server, optional MCP Apps UI, authentication,
  evaluations, packaging and submission evidence.
version: 4.0.0
...
# OpenAI Plugin Project Generator
...
- `DeploymentUnit`
- `ConformanceRun`
- `OpenAIPluginProjectGeneratorRun`
- `OpenAIPluginProjectGeneratorDecision`

Required semantic capabilities:

- Plugin manifest and directory generation
- Skill and MCP capability composition
- Optional app UI resource generation
- OAuth and secretless deployment contract
- Complete-plugin evaluation and negative submission tests
...
- **malicious Skill bundled in plugin** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **MCP confused deputy** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **OAuth scope inflation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **UI content injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **publisher identity spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- OAuth denial and consent
- optional UI sandbox
- complete-plugin eval
- upgrade rollback
