...
description: "Run the exact ELMOS Batch 81-95 slightly-strict Identity and Authorization Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T101"
  source_name: "identity-authorization-gate"
  source_sha256: "sha256:537f4dd7e8beffc1cc4df5602cb73001e1ebe18971af08ac95d6b126909fab48"
...
# T101 — Identity and Authorization Gate

## 1. Objective

Enforce platform-native identities, least privilege, tenant/resource scope and negative authorization.
...
- `CASE-0441` [HIGH] Identity and Authorization Gate: Representative path
- `CASE-0442` [HIGH] Identity and Authorization Gate: Boundary path
- `CASE-0443` [HIGH] Identity and Authorization Gate: Invalid or hostile input
- `CASE-0444` [HIGH] Identity and Authorization Gate: Injected dependency failure
- `CASE-0445` [CRITICAL] Identity and Authorization Gate: Security or safety violation
- `CASE-0446` [HIGH] Identity and Authorization Gate: Replay and idempotency
- `CASE-0447` [HIGH] Identity and Authorization Gate: Version or environment drift
- `CASE-0448` [MEDIUM] Identity and Authorization Gate: Moderate scale
- `CASE-0449` [CRITICAL] Identity and Authorization Gate: Evidence tamper
- `CASE-0450` [HIGH] Identity and Authorization Gate: Recovery and final evidence
