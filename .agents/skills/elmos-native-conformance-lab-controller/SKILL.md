---
name: elmos-native-conformance-lab-controller
description: Operate independent exact-version labs for frameworks, protocols, languages, databases and cloud runtimes with repeatable fixtures and authoritative native commands.
version: 4.0.0
...
# Native Conformance Lab Controller
...
- Provision exact native runtimes and dependencies
- Attest lab configuration and runner identity
- Run minimal, representative, negative, upgrade and recovery fixtures
- Keep lab isolated from generator control
- Retain replayable command/evidence bundle
...
- `lab-environment-lock.json`
- `native-conformance-results.json`
- `lab-fixture-catalog.json`
- `lab-attestation.json`
...
- **mock labeled native** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **runner image tag mutable** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generator modifies lab assertion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **lab secret leaks to candidate** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fixture passes only with undocumented config** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- framework native import/start
- protocol interoperability
- real database execution
- cloud runtime smoke
- upgrade/rollback fixture
- lab rebuild reproducibility
