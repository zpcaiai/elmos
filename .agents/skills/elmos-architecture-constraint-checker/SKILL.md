---
name: "elmos-architecture-constraint-checker"
description: "验证生成项目的分层、模块依赖、租户字段、数据访问、Secret、Outbox、幂等和适配器边界。 Use when the task needs the exact Architecture Constraint Checker Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-architecture-constraint-checker/SKILL.md"
  source_sha256: "sha256:d0838edc6177347bafbd32c5e83381ae60b99b4456594691a58f4927d9a92686"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "project-generation"
  runtime_handler_id: "execute_elmos_architecture_constraint_checker"
...
- Exact Skill identity: `elmos-architecture-constraint-checker`; exact allowlisted runtime handler: `execute_elmos_architecture_constraint_checker`.
- Source identity: `skills/P0/elmos-architecture-constraint-checker/SKILL.md` at `sha256:d0838edc6177347bafbd32c5e83381ae60b99b4456594691a58f4927d9a92686` from `elmos-formal-assurance-kernel-v1.0.0`.
...
验证生成项目的分层、模块依赖、租户字段、数据访问、Secret、Outbox、幂等和适配器边界。
...
3. Use the repository-owned `execute_elmos_architecture_constraint_checker` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["graph constraints","relational logic","policy-as-code","architecture fitness functions"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-architecture-constraint-checker/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
