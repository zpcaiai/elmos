---
name: elmos-compiler-frontend-conformance-certifier
description: Certify compiler-native, lossless and runtime-assisted source frontends against language conformance corpora before their facts may become semantic authority.
version: 4.0.0
...
# Compiler Frontend Conformance Certifier
...
- Run compiler-native parse/type/symbol/control/effect probes
- Compare frontend results with authoritative compiler diagnostics
- Measure supported construct and dynamic-boundary coverage
- Quarantine fallback AST/text-only claims
- Version and revoke frontend certificates
...
- `elmos-ai-generated-project-conformance-validator` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `frontend-conformance-report.json`
- `construct-coverage-map.json`
- `frontend-counterexamples/`
- `frontend-certified-envelope.yaml`
...
- **text parser promoted as semantic authority** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **diagnostic normalization hides mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated source identity loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **compiler plugin code execution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **frontend certificate applied after compiler drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- valid construct corpus
- invalid program diagnostic parity
- macro/generated source lineage
- reflection/dynamic loading detection
- incremental invalidation correctness
- compiler upgrade regression
