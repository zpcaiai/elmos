---
name: elmos-ui-visual-regression-journey-certifier
description: Certify generated web, desktop and agent UI through visual diffs, semantic journeys, responsive layouts, accessibility and cross-browser behavior.
version: 4.0.0
...
# UI Visual Regression and Journey Certifier
...
- `UIVisualRegressionAndJourneyCertifierProfile`
- `UIVisualRegressionAndJourneyCertifierPlan`
- `UIVisualRegressionAndJourneyCertifierRun`
- `UIVisualRegressionAndJourneyCertifierDecision`

Required semantic capabilities:

- derive journeys from observable contracts
- capture stable visual baselines and masks
- verify responsive and theme variants
- combine DOM/accessibility and screenshot oracles
- test error, recovery and approval UX
...
- `elmos-contract-integration-e2e-controller` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-ui-visual-regression-journey-certifier/profile.yaml`
- `artifacts/elmos-ui-visual-regression-journey-certifier/plan.json`
- `artifacts/elmos-ui-visual-regression-journey-certifier/result.json`
- `artifacts/elmos-ui-visual-regression-journey-certifier/evidence/`
...
- **dynamic content overmasked** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **pixel pass hides broken interaction** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **baseline accepted without review** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **visual artifact leaks PII** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **browser matrix insufficient** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: derive journeys from observable contracts
- native scenario: capture stable visual baselines and masks
- native scenario: verify responsive and theme variants
- native scenario: combine DOM/accessibility and screenshot oracles
- native scenario: test error, recovery and approval UX
