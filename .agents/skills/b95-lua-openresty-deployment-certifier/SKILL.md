---
name: b95-lua-openresty-deployment-certifier
description: "Use when ELMOS must run lua openresty deployment certifier for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG402"
  source_name: "lua-openresty-deployment-certifier"
  source_sha256: "sha256:991c763a7f06e251936c256b023aee624a76d5561e00cbd9600ee55fc59fe8ec"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG402 — Lua Openresty Deployment Certifier

## 1. Objective

Certify lua openresty deployment certifier within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Lua Openresty Deployment Certifier using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-openresty-deployment-certifier.
