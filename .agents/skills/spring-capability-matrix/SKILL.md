---
name: spring-capability-matrix
description: 把 MVC、Security、Data、Batch、Integration、Cloud、Actuator 等能力映射到精确迁移与验证状态。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-013
  source_name: spring-capability-matrix
  source_path: skills/spring-capability-matrix/SKILL.md
  source_sha256: sha256:af540f457e74b39632ca88c8d6483954d7522d1c3549e37c1ad047365d07b668
  source_contract_sha256: sha256:3a96d575763c65485236609bd32a6ebb1c3019cb0a8fc8580714075e6a5d7991
...
# Spring Capability Matrix

## Objective

把 MVC、Security、Data、Batch、Integration、Cloud、Actuator 等能力映射到精确迁移与验证状态。

## Scope and capabilities

- source/target capability
- breaking change
- Recipe/Agent/Verifier 分配
- preserved/transformed/retained/unsupported/unknown
- 版本化矩阵
...
- [ ] 定义 `spring-capability-matrix` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-capability-matrix` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：framework-capability-matrix.json, gap-register.json, verification-plan.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：framework-capability-matrix.json, gap-register.json, verification-plan.json。
- [ ] 所有 mandatory tests 和 security gates 通过，且无 critical unknown。

## Dependencies

- `spring-source-profile`
...
- Machine contract: `references/contract.json` (`sha256:3a96d575763c65485236609bd32a6ebb1c3019cb0a8fc8580714075e6a5d7991`).
