---
name: gr-capacity
description: 对租户、项目、阶段、模型、Sandbox、DB 和外部 Provider 实施公平准入、限流和熔断。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-091
  source_name: gr-capacity
  source_path: skills/gr-capacity/SKILL.md
  source_sha256: sha256:01be9271bc66e72a6bb1fd2c81615f41621b9ac08b0cc609d291c9f0eda00445
  source_contract_sha256: sha256:f83e9b8e175e8137009b8c14a11410cf0c3d3e831d5c6b888b9edffbc34826ff
...
对租户、项目、阶段、模型、Sandbox、DB 和外部 Provider 实施公平准入、限流和熔断。
...
- [ ] 定义 `gr-capacity` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-capacity` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：admission-events, capacity-plan.json, queue-metrics.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：admission-events, capacity-plan.json, queue-metrics.json。
...
- Machine contract: `references/contract.json` (`sha256:f83e9b8e175e8137009b8c14a11410cf0c3d3e831d5c6b888b9edffbc34826ff`).
