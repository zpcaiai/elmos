---
name: elmos-certifier-independence-competence-governor
description: Enforce separation of duties, conflict-of-interest controls, assessor competence, witnessed reviews, rotation and audit trails for certification decisions.
version: 4.0.0
...
# Certifier Independence and Competence Governor
...
- **Kernel authorities used:** K1, K7, K8
...
- Separate generator, verifier, approver and signer roles
- Match competence to technology/risk scope
- Detect organizational and task conflicts
- Require witnessed/dual review for high assurance
- Rotate and revoke assessor authority
...
- `certifier-roster.json`
- `competence-matrix.json`
- `conflict-decisions.json`
- `review-assignment-evidence.json`
...
- **same agent creates and certifies** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **competence asserted without evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hidden reporting-line conflict** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared credentials** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **signer authority persists after role removal** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- insufficient competence blocks
- self-review denied
- conflict declaration
- dual review
- revoked certifier cannot sign
