---
name: b44-cache-incremental-cost-optimization
description: "Implement and verify Batch 44 Skill 1469 for cache incremental cost optimization. Use when work requires \u7f13\u5b58\u3001\u589e\u91cf\u5206\u6790\u548c\u8ba1\u7b97\u6210\u672c\u4f18\u5316, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-cache-incremental-cost-optimization`.
...
4. Implement the smallest production-shaped capability that exercises `缓存、增量分析和计算成本优化` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-cache-incremental-cost-optimization`
