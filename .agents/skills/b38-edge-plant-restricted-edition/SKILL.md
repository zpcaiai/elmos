---
name: b38-edge-plant-restricted-edition
description: "Implement and verify Batch 38 Skill 1334 for edge plant restricted edition. Use when work requires Edge\u3001Plant\u548c\u53d7\u9650\u7f51\u7edcEdition, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Edge、Plant和受限网络Edition
...
## Skill 1334: Edge、Plant和受限网络Edition
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-edge-plant-restricted-edition`.
...
4. Implement the smallest production-shaped capability that exercises `Edge、Plant和受限网络Edition` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-edge-plant-restricted-edition`
