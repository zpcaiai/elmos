---
name: b43-database-migration-compatibility
description: "Implement and verify Batch 43 Skill 1443 for database migration compatibility. Use when work requires \u6570\u636e\u5e93Migration\u517c\u5bb9\u653f\u7b56, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-database-migration-compatibility`.
...
4. Implement the smallest production-shaped capability that exercises `数据库Migration兼容政策` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-database-migration-compatibility`
