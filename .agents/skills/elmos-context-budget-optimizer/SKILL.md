...
description: Use this skill when Elmos must perform context budget optimizer as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
在 Token、延迟和成本约束下最大化有用证据覆盖和相互依赖完整性。
