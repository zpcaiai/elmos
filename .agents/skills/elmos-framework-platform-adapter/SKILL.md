...
description: "Invoke the bounded repository handler for elmos-framework-platform-adapter while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P03:framework-platform-adapter"
  source_name: "elmos-framework-platform-adapter"
  installed_name: "elmos-framework-platform-adapter"
  source_logical_path: "03-elmos-project-generation-transformation-engine/skills/framework-platform-adapter/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/03-elmos-project-generation-transformation-engine/skills/framework-platform-adapter/SKILL.md.source-data"
  source_materialized_path: "03-elmos-project-generation-transformation-engine/skills/framework-platform-adapter/SKILL.md.source-data"
  source_sha256: "sha256:976f934f7e3ba314c75b2172216521911587ed8c0ae4dcbf795121e237ff5578"
...
# elmos-framework-platform-adapter
...
- This is a deterministic repository wrapper for `03-elmos-project-generation-transformation-engine/skills/framework-platform-adapter/SKILL.md` at `sha256:976f934f7e3ba314c75b2172216521911587ed8c0ae4dcbf795121e237ff5578`.
- Its immutable source/runtime identity is `elmos-framework-platform-adapter`; its active installed identity is `elmos-framework-platform-adapter`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-framework-platform-adapter --request <file>
```
