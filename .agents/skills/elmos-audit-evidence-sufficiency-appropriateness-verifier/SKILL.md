---
name: elmos-audit-evidence-sufficiency-appropriateness-verifier
description: Implement and independently certify audit evidence sufficiency and appropriateness verifier, including assess relevance, reliability, completeness, independence and corroboration of audit evidence, distinguish inquiry, observation, inspection, re-performance and external confirmation and block conclusion where evidence cannot support scope.
version: 4.0.0
...
# Audit Evidence Sufficiency and Appropriateness Verifier

## Objective

Implement and independently certify audit evidence sufficiency and appropriateness verifier, including assess relevance, reliability, completeness, independence and corroboration of audit evidence, distinguish inquiry, observation, inspection, re-performance and external confirmation and block conclusion where evidence cannot support scope.
...
- **Kernel authorities used:** K1, K2, K6, K8
...
- `AuditEvidenceSufficiencyAndAppropriatenessVerifierProfile`
- `AuditEvidenceSufficiencyAndAppropriatenessVerifierRun`
- `AuditEvidenceSufficiencyAndAppropriatenessVerifierFinding`
- `AuditEvidenceSufficiencyAndAppropriatenessVerifierDecision`
- `AuditEvidenceSufficiencyAndAppropriatenessVerifierEvidence`

Required semantic capabilities:

- assess relevance, reliability, completeness, independence and corroboration of audit evidence
- distinguish inquiry, observation, inspection, re-performance and external confirmation
- block conclusion where evidence cannot support scope
...
- `elmos-audit-duration-sampling-risk-planner`
- `elmos-assurance-case-confidence-quantifier`

## Primary Outputs

- `artifacts/elmos-audit-evidence-sufficiency-appropriateness-verifier/profile.yaml`
- `artifacts/elmos-audit-evidence-sufficiency-appropriateness-verifier/plan.json`
- `artifacts/elmos-audit-evidence-sufficiency-appropriateness-verifier/result.json`
- `artifacts/elmos-audit-evidence-sufficiency-appropriateness-verifier/evidence/`
- `artifacts/elmos-audit-evidence-sufficiency-appropriateness-verifier/assurance-case.json`
...
- **management assertion is treated as objective evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **screenshots replace re-performance** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **negative evidence is ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: assess relevance, reliability, completeness, independence and corroboration of audit evidence
- native scenario: distinguish inquiry, observation, inspection, re-performance and external confirmation
- native scenario: block conclusion where evidence cannot support scope
