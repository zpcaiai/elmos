...
description: "Invoke the bounded repository handler for elmos-agent-orchestration-software-factory while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_key: "P04"
  source_name: "elmos-agent-orchestration-software-factory"
  installed_name: "elmos-agent-orchestration-software-factory"
  source_logical_path: "04-elmos-agent-orchestration-software-factory/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/04-elmos-agent-orchestration-software-factory/SKILL.md.source-data"
  source_materialized_path: "04-elmos-agent-orchestration-software-factory/SKILL.md.source-data"
  source_sha256: "sha256:5919add7f0a0fc213e00b6b25ebdf4eb9f55a0829aed3b8c21e158b01b0ab50f"
...
- This is a deterministic repository wrapper for `04-elmos-agent-orchestration-software-factory/SKILL.md` at `sha256:5919add7f0a0fc213e00b6b25ebdf4eb9f55a0829aed3b8c21e158b01b0ab50f`.
- Its immutable source/runtime identity is `elmos-agent-orchestration-software-factory`; its active installed identity is `elmos-agent-orchestration-software-factory`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-agent-orchestration-software-factory --request <file>
```
