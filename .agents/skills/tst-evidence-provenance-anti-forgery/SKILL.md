---
name: tst-evidence-provenance-anti-forgery
description: "Tamper, stale evidence, wrong commit, wrong digest, self-approval, baseline mutation and certification-forgery tests."
---

# Test Skill T049: 证据、Provenance与防伪测试
