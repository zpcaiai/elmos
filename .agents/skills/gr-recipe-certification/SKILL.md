---
name: gr-recipe-certification
description: 用跨仓 positive/negative/holdout、幂等、安全、性能与许可 Gate 认证 Recipe。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-094
  source_name: gr-recipe-certification
  source_path: skills/gr-recipe-certification/SKILL.md
  source_sha256: sha256:1bf06f76c957cdbda87f1680bc7c6ec098977e34ee4aaad832f53dabbcedd20e
  source_contract_sha256: sha256:ba6d2b99e3ae31cddf7970e5489860334a018d9fb3918783bbfc9e1de3b9b3e8
...
# Recipe Candidate Certification

## Objective

用跨仓 positive/negative/holdout、幂等、安全、性能与许可 Gate 认证 Recipe。

## Scope and capabilities

- Candidate/staging/certified/revoked
- No production permission by default
...
- recipe-cert-report.json
- certified-recipe-package
...
- [ ] 定义 `gr-recipe-certification` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-recipe-certification` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：recipe-cert-report.json, certified-recipe-package。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：recipe-cert-report.json, certified-recipe-package。
...
- Machine contract: `references/contract.json` (`sha256:ba6d2b99e3ae31cddf7970e5489860334a018d9fb3918783bbfc9e1de3b9b3e8`).
