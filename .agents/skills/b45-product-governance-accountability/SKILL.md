---
name: b45-product-governance-accountability
description: "Implement and verify Batch 45 Skill 1492 for product governance accountability. Use when work requires \u4ea7\u54c1\u6cbb\u7406\u3001\u8d23\u4efb\u548c\u51b3\u7b56\u4f53\u7cfb, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-product-governance-accountability`.
...
4. Implement the smallest production-shaped capability that exercises `产品治理、责任和决策体系` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-product-governance-accountability`
