---
name: "autonomous-qa-12-accessibility-compatibility-testing"
description: "Run 12-accessibility-compatibility-testing through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "12-accessibility-compatibility-testing"
  source_sha256: "sha256:ac67a837f2f60314a3ad77b008b2b61b2bbe23df380d48ba10481f9b9a226ed8"
  ...
  runtime_skill_key: "12-accessibility-compatibility-testing"
  runtime_handler: "execute_12_accessibility_compatibility_testing"
  runtime_phase: "generation"
  runtime_mutating: "false"
  runtime_operation: "elmos_autonomous_qa.generators.plan_accessibility_compatibility_tests"
...
1. Accept only a structured request for the exact Skill key `12-accessibility-compatibility-testing`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_12_accessibility_compatibility_testing` and operation `elmos_autonomous_qa.generators.plan_accessibility_compatibility_tests`.
...
- Immutable source: `skills/12-accessibility-compatibility-testing/SKILL.md` at `sha256:ac67a837f2f60314a3ad77b008b2b61b2bbe23df380d48ba10481f9b9a226ed8`.
