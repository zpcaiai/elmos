---
name: b42-agent-budget-resource-limits
description: "Implement and verify Batch 42 Skill 1426 for agent budget resource limits. Use when work requires Agent\u9884\u7b97\u3001\u6210\u672c\u548c\u8d44\u6e90\u9650\u5236, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b42-agent-budget-resource-limits`.
...
4. Implement the smallest production-shaped capability that exercises `Agent预算、成本和资源限制` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b42-agent-budget-resource-limits`
