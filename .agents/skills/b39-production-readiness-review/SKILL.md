...
description: "Implement and verify Batch 39 Skill 1364 for production readiness review. Use when work requires Production Readiness Review, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
## Skill 1364: Production Readiness Review
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-production-readiness-review`.
...
4. Implement the smallest production-shaped capability that exercises `Production Readiness Review` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-production-readiness-review`
