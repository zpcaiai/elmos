...
# Certificate Trust Registry Federation Controller
...
- `CertificateTrustRegistryFederationControllerProfile`
- `CertificateTrustRegistryFederationControllerRun`
- `CertificateTrustRegistryFederationControllerFinding`
- `CertificateTrustRegistryFederationControllerDecision`
- `CertificateTrustRegistryFederationControllerEvidence`

Required semantic capabilities:

- federate issuers, schemes, accreditation scopes, trust anchors and status endpoints
- resolve authoritative registry and conflict across jurisdictions
- support signed registry snapshots, delegation and rollback
...
- `elmos-verifiable-credential-assurance-certificate-emitter`
- `elmos-global-recognition-scope-resolver`

## Primary Outputs

- `artifacts/elmos-certificate-trust-registry-federation-controller/profile.yaml`
- `artifacts/elmos-certificate-trust-registry-federation-controller/plan.json`
- `artifacts/elmos-certificate-trust-registry-federation-controller/result.json`
- `artifacts/elmos-certificate-trust-registry-federation-controller/evidence/`
- `artifacts/elmos-certificate-trust-registry-federation-controller/assurance-case.json`
...
- **malicious registry adds unauthorized issuer** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **federation conflict silently chooses weakest rule** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale trust snapshot accepts withdrawn body** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: federate issuers, schemes, accreditation scopes, trust anchors and status endpoints
- native scenario: resolve authoritative registry and conflict across jurisdictions
- native scenario: support signed registry snapshots, delegation and rollback
