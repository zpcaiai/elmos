---
name: elmos-verification-tool-validation-corpus-governor
description: Implement and independently certify verification tool validation corpus governor, including maintain positive, negative, boundary, mutant and known-bug corpus for each verifier, measure detection, false positive, unsupported and crash behavior and version corpus independently from tool and prevent training contamination.
version: 4.0.0
...
# Verification Tool Validation Corpus Governor
...
- `VerificationToolValidationCorpusGovernorProfile`
- `VerificationToolValidationCorpusGovernorRun`
- `VerificationToolValidationCorpusGovernorFinding`
- `VerificationToolValidationCorpusGovernorDecision`
- `VerificationToolValidationCorpusGovernorEvidence`

Required semantic capabilities:

- maintain positive, negative, boundary, mutant and known-bug corpus for each verifier
- measure detection, false positive, unsupported and crash behavior
- version corpus independently from tool and prevent training contamination
...
- `elmos-counterexample-regression-promoter` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-verification-tool-validation-corpus-governor/profile.yaml`
- `artifacts/elmos-verification-tool-validation-corpus-governor/plan.json`
- `artifacts/elmos-verification-tool-validation-corpus-governor/result.json`
- `artifacts/elmos-verification-tool-validation-corpus-governor/evidence/`
- `artifacts/elmos-verification-tool-validation-corpus-governor/assurance-case.json`
...
- **verifier is tested only on expected passes** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **corpus is generated by same implementation under test** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **known failure is removed from regression suite** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: maintain positive, negative, boundary, mutant and known-bug corpus for each verifier
- native scenario: measure detection, false positive, unsupported and crash behavior
- native scenario: version corpus independently from tool and prevent training contamination
