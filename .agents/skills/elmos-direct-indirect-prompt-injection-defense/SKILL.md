...
description: Use this skill when Elmos must perform direct indirect prompt injection defense as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
