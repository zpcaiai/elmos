---
name: b38-tenant-edition-migration
description: "Implement and verify Batch 38 Skill 1337 for tenant edition migration. Use when work requires Tenant\u8de8Edition\u8fc1\u79fb, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-tenant-edition-migration`.
...
4. Implement the smallest production-shaped capability that exercises `Tenant跨Edition迁移` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-tenant-edition-migration`
