...
description: "Use this repository-owned Multi-Language Project Generation Domain Pack wrapper for exact project-generation proof-driven harness work with fail-closed evidence boundaries."
---
...
- Registry identity: `ELMOS-V3-011`
- Kind/owner: `domain-pack` / `project-generation`
- Source member: `skills/P0/elmos-domain-multi-language-project-generation/SKILL.md`
- Source member SHA-256: `c6d0cadd30847cdfc58e68d240d455fd850bd009893a2c4674020b6c229854d5`
