---
name: elmos-sensitive-data-masking-tokenization-certifier
description: Generate and verify deterministic/non-deterministic masking, tokenization, format preservation, referential integrity and re-identification controls across environments.
version: 4.0.0
...
# Sensitive Data Masking and Tokenization Certifier
...
- `SensitiveDataMaskingAndTokenizationCertifierProfile`
- `SensitiveDataMaskingAndTokenizationCertifierPlan`
- `SensitiveDataMaskingAndTokenizationCertifierRun`
- `SensitiveDataMaskingAndTokenizationCertifierDecision`

Required semantic capabilities:

- discover and classify sensitive fields
- select masking/tokenization by purpose
- preserve joins and test realism where authorized
- verify key rotation and vault isolation
- measure re-identification and leakage risk
...
- `artifacts/elmos-sensitive-data-masking-tokenization-certifier/profile.yaml`
- `artifacts/elmos-sensitive-data-masking-tokenization-certifier/plan.json`
- `artifacts/elmos-sensitive-data-masking-tokenization-certifier/result.json`
- `artifacts/elmos-sensitive-data-masking-tokenization-certifier/evidence/`
...
- **mask reversible without authorization** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **same token crosses tenant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **referential integrity broken** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **production secret used in test** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rare-value leakage remains** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: discover and classify sensitive fields
- native scenario: select masking/tokenization by purpose
- native scenario: preserve joins and test realism where authorized
- native scenario: verify key rotation and vault isolation
- native scenario: measure re-identification and leakage risk
