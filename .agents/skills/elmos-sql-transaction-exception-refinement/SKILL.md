---
name: "elmos-sql-transaction-exception-refinement"
description: "验证 savepoint、隔离级别、锁、超时、错误码、原子性和回滚行为跨数据库方言保持允许的精化。 Use when the task needs the exact SQL Transaction and Exception Refinement Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P1/elmos-sql-transaction-exception-refinement/SKILL.md"
  source_sha256: "sha256:ed91eff51b558969416b5ba435dc449c76035f36e994893c8d479c67b5a15a26"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P1"
  domain: "sql-conversion"
  runtime_handler_id: "execute_elmos_sql_transaction_exception_refinement"
...
---
# SQL Transaction and Exception Refinement

## Repository integration boundary

- Exact Skill identity: `elmos-sql-transaction-exception-refinement`; exact allowlisted runtime handler: `execute_elmos_sql_transaction_exception_refinement`.
- Source identity: `skills/P1/elmos-sql-transaction-exception-refinement/SKILL.md` at `sha256:ed91eff51b558969416b5ba435dc449c76035f36e994893c8d479c67b5a15a26` from `elmos-formal-assurance-kernel-v1.0.0`.
...
验证 savepoint、隔离级别、锁、超时、错误码、原子性和回滚行为跨数据库方言保持允许的精化。
...
3. Use the repository-owned `execute_elmos_sql_transaction_exception_refinement` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["transaction state machines","trace refinement","isolation anomaly analysis"]`
- Direct dependencies: `["elmos-observable-behavior-contract","elmos-proof-obligation-planner","elmos-sql-semantic-ir","elmos-routine-contract-verifier"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P1/elmos-sql-transaction-exception-refinement/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
