...
description: "Invoke the bounded repository handler for elmos-upstream-change-monitor while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P00:upstream-change-monitor"
  source_name: "elmos-upstream-change-monitor"
  installed_name: "elmos-upstream-change-monitor"
  source_logical_path: "00-elmos-software-factory-master/skills/upstream-change-monitor/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/00-elmos-software-factory-master/skills/upstream-change-monitor/SKILL.md.source-data"
  source_materialized_path: "00-elmos-software-factory-master/skills/upstream-change-monitor/SKILL.md.source-data"
  source_sha256: "sha256:dd657a5b690890d2e86bf0a968dc2050c126c58460000d31f103216ce385d38b"
...
- This is a deterministic repository wrapper for `00-elmos-software-factory-master/skills/upstream-change-monitor/SKILL.md` at `sha256:dd657a5b690890d2e86bf0a968dc2050c126c58460000d31f103216ce385d38b`.
- Its immutable source/runtime identity is `elmos-upstream-change-monitor`; its active installed identity is `elmos-upstream-change-monitor`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-upstream-change-monitor --request <file>
```
