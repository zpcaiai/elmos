---
name: elmos-incident-postmortem-recertification-controller
description: Convert production incidents into evidence-preserving timelines, root-cause claims, corrective actions, regression assets and mandatory certificate impact decisions.
version: 4.0.0
...
# Incident Postmortem and Recertification Controller
...
- **Kernel authorities used:** K1, K4, K6, K8
...
- Build causal timeline with confidence and counterevidence
- Assign corrective/preventive actions and owners
- Promote incident counterexamples
- Suspend/revoke/recertify affected claims
...
- `incident-recertification-decision.json`
...
- **blameless process used to avoid accountability** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **timeline edited after review** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **proximate cause mistaken for root cause** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fix accepted without regression** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **certificate impact omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
