---
name: concurrency-restart-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Concurrency and Restart Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T100"
  source_name: "concurrency-restart-gate"
  source_sha256: "sha256:55d35b175422fe2a4e1c1f88c13ca6cb3de785813e16ffe4f0ff10978fb7ae51"
...
# T100 — Concurrency and Restart Gate

## 1. Objective

Exercise task/process/thread/actor scheduling, restart, cancellation, duplicate delivery and backpressure.
...
- `CASE-0431` [HIGH] Concurrency and Restart Gate: Representative path
- `CASE-0432` [HIGH] Concurrency and Restart Gate: Boundary path
- `CASE-0433` [HIGH] Concurrency and Restart Gate: Invalid or hostile input
- `CASE-0434` [HIGH] Concurrency and Restart Gate: Injected dependency failure
- `CASE-0435` [CRITICAL] Concurrency and Restart Gate: Security or safety violation
- `CASE-0436` [HIGH] Concurrency and Restart Gate: Replay and idempotency
- `CASE-0437` [HIGH] Concurrency and Restart Gate: Version or environment drift
- `CASE-0438` [MEDIUM] Concurrency and Restart Gate: Moderate scale
- `CASE-0439` [CRITICAL] Concurrency and Restart Gate: Evidence tamper
- `CASE-0440` [HIGH] Concurrency and Restart Gate: Recovery and final evidence
