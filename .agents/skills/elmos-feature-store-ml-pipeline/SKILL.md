...
metadata:
  ...
  repository_handler_id: "handle_elmos_feature_store_ml_pipeline"
...
- Source group: `bigdata-core`. Dependencies: `["elmos-data-modeling-semantic-layer", "elmos-orchestration-backfill-replay"]`. Triggers: `["推荐/风控/预测/ML", "离在线特征一致", "训练与推理数据管道"]`. Declared outputs: `["feature-platform/", "feature-definitions/", "training-datasets/", "ml-data-tests/"]`. Stable task IDs: `["FEAST-001", "FEAST-002", "FEAST-003", "FEAST-004", "FEAST-005", "FEAST-006", "FEAST-007", "FEAST-008", "FEAST-009", "FEAST-010", "FEAST-011", "FEAST-012"]`.
- This normalized Skill is installed and invocable. The repository binds `handle_elmos_feature_store_ml_pipeline` in `engines/database-bigdata-engine/src/elmos_database_bigdata/handlers/bigdata_core.py` as a bounded plan-skeleton entry point; the reviewed code declares no database, provider, network, deployment, benchmark, mutation, or certification operation.
