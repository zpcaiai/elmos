---
name: elmos-canonical-type-algebra
description: "Normalize primitive, nominal, structural, algebraic, callable, reference and opaque types into a target-independent algebra with provenance."
version: 1.0.0
skill_id: ELMOS-POLY-185
...
triggers:
  - "Use when implementing or executing `elmos-canonical-type-algebra`."
  - "Use when a migration/certification DAG requires `type-semantics` capability."
outputs:
  - "semantic-assurance/elmos-canonical-type-algebra/model.json"
  - "semantic-assurance/elmos-canonical-type-algebra/evidence.json"
  - "semantic-assurance/elmos-canonical-type-algebra/diagnostics.json"
---
...
Normalize primitive, nominal, structural, algebraic, callable, reference and opaque types into a target-independent algebra with provenance.
...
- **primitive widths/ranges.**
- **nominal vs structural identity.**
- **sum/product/callable types.**
- **opaque/vendor types.**
...
- [ ] cross-language primitive matrix.
- [ ] recursive type fixture.
- [ ] unknown vendor type blocker.
