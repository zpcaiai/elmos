...
- Activate when the task requires: run old/new implementations on identical scenarios and compare outputs, state transitions, side effects and temporal behavior.
