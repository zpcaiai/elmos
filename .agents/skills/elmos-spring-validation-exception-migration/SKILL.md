---
name: spring-validation-exception-migration
description: Use this skill when Elmos must perform spring validation exception migration as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# spring-validation-exception-migration

## 能力目标

迁移校验、错误码、消息、异常映射、状态码和事务回滚规则。
