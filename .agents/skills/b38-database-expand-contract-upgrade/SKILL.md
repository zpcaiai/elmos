---
name: b38-database-expand-contract-upgrade
description: "Implement and verify Batch 38 Skill 1341 for database expand contract upgrade. Use when work requires \u6570\u636e\u5e93Expand\u2013Contract\u5347\u7ea7, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 数据库Expand–Contract升级
...
## Skill 1341: 数据库Expand–Contract升级
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-database-expand-contract-upgrade`.
...
4. Implement the smallest production-shaped capability that exercises `数据库Expand–Contract升级` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-database-expand-contract-upgrade`
