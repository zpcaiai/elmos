...
- Activate when the task requires: optimize model/tool/parallelism/cache decisions against quality gates, wall-clock ETA, token/credit cost and infrastructure cost.
