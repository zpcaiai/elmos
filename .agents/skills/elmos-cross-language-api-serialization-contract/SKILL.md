---
name: cross-language-api-serialization-contract
description: Use this skill when Elmos must perform cross language api serialization contract as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# cross-language-api-serialization-contract

## 能力目标

保持 API、RPC、Schema、序列化、精度和兼容性。
