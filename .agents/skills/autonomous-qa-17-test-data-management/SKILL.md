...
metadata:
  ...
  source_id: "17-test-data-management"
  source_sha256: "sha256:5b90064f7e8ff4e02b029463fe6d10b150d8d0033b75d8489722e09efe8f8675"
  ...
  runtime_skill_key: "17-test-data-management"
  runtime_handler: "execute_17_test_data_management"
...
1. Accept only a structured request for the exact Skill key `17-test-data-management`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_17_test_data_management` and operation `elmos_autonomous_qa.context_skills.prepare_test_data`.
...
- Immutable source: `skills/17-test-data-management/SKILL.md` at `sha256:5b90064f7e8ff4e02b029463fe6d10b150d8d0033b75d8489722e09efe8f8675`.
