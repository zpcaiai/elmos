---
name: elmos-property-metamorphic-mutation-fuzz-controller
description: Discover deep semantic defects through generated properties, metamorphic relations, mutation testing and coverage-guided fuzzing with minimized counterexamples.
version: 4.0.0
...
# Property, Metamorphic, Mutation and Fuzz Controller
...
- Derive properties from contracts and invariants
- Generate domain-specific metamorphic transformations
- Measure test sensitivity with semantic mutants
- Run bounded coverage-guided fuzzing
- Shrink failures into stable regression cases
...
- **invalid property produces false alarm** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **mutation set rewards superficial tests** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fuzzer escapes sandbox** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **corpus contains secrets** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **nondeterministic counterexample cannot replay** — must have a preventive control, a detective signal, a negative fixture and a response action.
