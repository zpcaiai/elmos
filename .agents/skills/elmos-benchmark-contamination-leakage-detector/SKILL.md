---
name: elmos-benchmark-contamination-leakage-detector
description: Detect public, training, repository, prompt and evaluator contamination in hidden benchmarks and customer holdouts.
version: 4.0.0
...
# Benchmark Contamination and Leakage Detector
...
- `BenchmarkContaminationAndLeakageDetectorProfile`
- `BenchmarkContaminationAndLeakageDetectorPlan`
- `BenchmarkContaminationAndLeakageDetectorRun`
- `BenchmarkContaminationAndLeakageDetectorDecision`

Required semantic capabilities:

- fingerprint benchmark content and provenance
- scan source, prompts, caches and training artifacts
- hold out variants and canary items
- detect memorization and suspicious similarity
- quarantine contaminated scores and recertify
...
- `artifacts/elmos-benchmark-contamination-leakage-detector/profile.yaml`
- `artifacts/elmos-benchmark-contamination-leakage-detector/plan.json`
- `artifacts/elmos-benchmark-contamination-leakage-detector/result.json`
- `artifacts/elmos-benchmark-contamination-leakage-detector/evidence/`
...
- **benchmark published through logs** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **model trained on hidden set** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **near-duplicate evades hash** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evaluator has answer key** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **contamination finding suppressed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: fingerprint benchmark content and provenance
- native scenario: scan source, prompts, caches and training artifacts
- native scenario: hold out variants and canary items
- native scenario: detect memorization and suspicious similarity
- native scenario: quarantine contaminated scores and recertify
