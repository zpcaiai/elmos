---
name: elmos-data-quality-contract-anomaly-verifier
description: Define and enforce completeness, freshness, validity, uniqueness, distribution, drift and business-invariant contracts for operational, RAG and evaluation data.
version: 4.0.0
...
# Data Quality Contract and Anomaly Verifier
...
- `DataQualityContractAndAnomalyVerifierProfile`
- `DataQualityContractAndAnomalyVerifierPlan`
- `DataQualityContractAndAnomalyVerifierRun`
- `DataQualityContractAndAnomalyVerifierDecision`

Required semantic capabilities:

- compile declarative quality contracts
- run batch and streaming checks
- detect distribution and semantic drift
- attribute anomalies to upstream lineage
- block affected model, retrieval and migration claims
...
- `artifacts/elmos-data-quality-contract-anomaly-verifier/profile.yaml`
- `artifacts/elmos-data-quality-contract-anomaly-verifier/plan.json`
- `artifacts/elmos-data-quality-contract-anomaly-verifier/result.json`
- `artifacts/elmos-data-quality-contract-anomaly-verifier/evidence/`
...
- **threshold tuned to hide failure** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **quality metric computed on stale sample** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **PII exposed in profiling** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **upstream anomaly blamed on model** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **warning promoted to pass** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile declarative quality contracts
- native scenario: run batch and streaming checks
- native scenario: detect distribution and semantic drift
- native scenario: attribute anomalies to upstream lineage
- native scenario: block affected model, retrieval and migration claims
