---
name: batch-90-sas-modernization-slightly-strict-certification
description: "Run the exact ELMOS Batch 81-95 slightly-strict SAS Estate Modernization Certification tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T090"
  source_name: "batch-90-sas-modernization-slightly-strict-certification"
  source_sha256: "sha256:b28344c1656ffd01f958056520a30f7ff45584b51feef47a5e4354b6d5b7be28"
  source_kind: "batch"
  source_batch: "90"
...
# T090 — SAS Estate Modernization Certification

## 1. Objective

Slightly strict certification for Batch 90 SAS Estate Modernization Certification.
...
- `CASE-0235` [CRITICAL] Direct verification: PG331 sas estate discovery and inventory
- `CASE-0236` [HIGH] Direct verification: PG332 sas data step parser and semantic model
- `CASE-0237` [HIGH] Direct verification: PG333 sas macro expansion analyzer
- `CASE-0238` [MEDIUM] Direct verification: PG334 proc sql query modeler
- `CASE-0239` [CRITICAL] Direct verification: PG335 sas format informat catalog
- `CASE-0240` [HIGH] Direct verification: PG336 sas job workflow modeler
- `CASE-0241` [HIGH] Direct verification: PG337 sas to python r sql generator
- `CASE-0242` [MEDIUM] Direct verification: PG338 sas cas viya integration adapter
- `CASE-0243` [CRITICAL] Direct verification: PG339 statistical numerical equivalence verifier
- `CASE-0244` [HIGH] Direct verification: PG340 sas data lineage security mapper
- `CASE-0245` [HIGH] Direct verification: PG341 sas parallel run validation
- `CASE-0246` [MEDIUM] Direct verification: PG342 sas modernization certifier
- `CASE-0247` [CRITICAL] Exercise nested macro quoting, indirect references, generated code and symbol-table scope
- `CASE-0248` [HIGH] Verify RETAIN, FIRST
- `CASE-0249` [HIGH] Validate custom formats/informats, SAS dates, datetime, special missing values and locale
- `CASE-0250` [CRITICAL] Compare PROC SQL missing/null semantics, remerging, ordering and implicit conversions
- `CASE-0251` [HIGH] Compare single-node SAS and CAS/Viya partitioned execution for deterministic aggregation
- `CASE-0252` [CRITICAL] Run stratified and edge-case samples through source and target, including statistical reconciliation
- `CASE-0253` [HIGH] Representative certified success path
- `CASE-0254` [HIGH] Boundary and moderate scale
- `CASE-0255` [HIGH] Invalid and conflicting input
- `CASE-0256` [HIGH] Dependency failure and recovery
- `CASE-0257` [CRITICAL] Security and isolation
- `CASE-0258` [HIGH] Replay and idempotency
- `CASE-0259` [HIGH] Toolchain and version drift
- `CASE-0260` [CRITICAL] Evidence tamper and anti-fraud
