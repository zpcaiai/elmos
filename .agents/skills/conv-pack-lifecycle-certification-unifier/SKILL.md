...
# CONV-009：统一Pack生命周期与Certification

## Objective

统一所有Pack的draft到revoked生命周期、续证、EOL和撤销传播。
...
1. 定义统一状态和转换。
2. 映射旧状态。
3. 统一Certification、Expiry、Waiver和Revocation。
4. 实现产品升级/CVE/Policy变化触发续证。
5. 生成客户迁移和EOL通知。
