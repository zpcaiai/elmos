...
- Invoke this repository Skill as `$pm-b02-modernization-assessment`.
- Immutable source identity: `batch-02-modernization-assessment` in `precision-migration-b01-44` (B02).
- Runtime adapter: `assessment-and-target-planning`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b02-modernization-assessment`.
...
- 当任务涉及 **repository-modernization-assessment** 时，调用 `../pm-b02-repository-modernization-assessment/SKILL.md`。
- 当任务涉及 **application-architecture-recovery** 时，调用 `../pm-b02-application-architecture-recovery/SKILL.md`。
- 当任务涉及 **modernization-readiness-score** 时，调用 `../pm-b02-modernization-readiness-score/SKILL.md`。
- 当任务涉及 **modernization-blocker-discovery** 时，调用 `../pm-b02-modernization-blocker-discovery/SKILL.md`。
- 当任务涉及 **technical-debt-inventory** 时，调用 `../pm-b02-technical-debt-inventory/SKILL.md`。
- 当任务涉及 **modernization-option-comparator** 时，调用 `../pm-b02-modernization-option-comparator/SKILL.md`。
- 当任务涉及 **representative-slice-pilot** 时，调用 `../pm-b02-representative-slice-pilot/SKILL.md`。
- 当任务涉及 **assessment-report-generator** 时，调用 `../pm-b02-assessment-report-generator/SKILL.md`。
