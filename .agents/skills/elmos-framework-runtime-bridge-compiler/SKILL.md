---
name: elmos-framework-runtime-bridge-compiler
description: Compile framework lifecycle, dependency injection, routing, state, transaction, security, streaming and observability semantics across language targets.
version: 4.0.0
...
# Framework Runtime Bridge Compiler
...
- Model framework startup/shutdown and request lifecycle
- Map DI scope, middleware and exception boundaries
- Preserve transaction/security/session semantics
- Compile streaming and backpressure contracts
- Emit bridge adapters only where direct lowering is impossible
...
- `framework-runtime-bridge.yaml`
- `lifecycle-equivalence-map.json`
- `framework-adapter-code/`
- `framework-gap-ledger.json`
...
- **lifecycle hook omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **request scope becomes singleton** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **transaction boundary widening** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **security middleware reordered** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stream cancellation leaks resources** — must have a preventive control, a detective signal, a negative fixture and a response action.
