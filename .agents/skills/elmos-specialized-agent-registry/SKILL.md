...
description: "Invoke the bounded repository handler for elmos-specialized-agent-registry while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P04:specialized-agent-registry"
  source_name: "elmos-specialized-agent-registry"
  installed_name: "elmos-specialized-agent-registry"
  source_logical_path: "04-elmos-agent-orchestration-software-factory/skills/specialized-agent-registry/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/04-elmos-agent-orchestration-software-factory/skills/specialized-agent-registry/SKILL.md.source-data"
  source_materialized_path: "04-elmos-agent-orchestration-software-factory/skills/specialized-agent-registry/SKILL.md.source-data"
  source_sha256: "sha256:386ba7853576e2ad8b438fc51e7219e56f2be1344b65a93c73beccaae8c020e1"
...
# elmos-specialized-agent-registry
...
- This is a deterministic repository wrapper for `04-elmos-agent-orchestration-software-factory/skills/specialized-agent-registry/SKILL.md` at `sha256:386ba7853576e2ad8b438fc51e7219e56f2be1344b65a93c73beccaae8c020e1`.
- Its immutable source/runtime identity is `elmos-specialized-agent-registry`; its active installed identity is `elmos-specialized-agent-registry`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-specialized-agent-registry --request <file>
```
