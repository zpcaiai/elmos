...
## Inspirations
- QEMU/VM/container ecosystems
- OpenHarmony testing patterns

## Activation conditions
- Activate when the task requires: execute source and target systems on their real native runtimes/OS/architecture combinations for cross-language behavioral certification.
