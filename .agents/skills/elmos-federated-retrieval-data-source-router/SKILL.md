---
name: elmos-federated-retrieval-data-source-router
description: Route queries across private, remote, SQL, search, graph and vector sources under capability, authorization, freshness, latency and cost constraints.
version: 4.0.0
...
# Federated Retrieval and Data-Source Router
...
- `FederatedRetrievalAndDataSourceRouterProfile`
- `FederatedRetrievalAndDataSourceRouterPlan`
- `FederatedRetrievalAndDataSourceRouterRun`
- `FederatedRetrievalAndDataSourceRouterDecision`

Required semantic capabilities:

- compile source capability and authorization profiles
- decompose and route multi-source queries
- merge evidence with calibrated scores
- enforce residency and minimum disclosure
- fallback, timeout and partial-result semantics
...
- `artifacts/elmos-federated-retrieval-data-source-router/profile.yaml`
- `artifacts/elmos-federated-retrieval-data-source-router/plan.json`
- `artifacts/elmos-federated-retrieval-data-source-router/result.json`
- `artifacts/elmos-federated-retrieval-data-source-router/evidence/`
...
- **router sends sensitive query to external source** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **score fusion incomparable** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **partial result presented complete** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **source authority stale** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fanout creates economic DoS** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile source capability and authorization profiles
- native scenario: decompose and route multi-source queries
- native scenario: merge evidence with calibrated scores
- native scenario: enforce residency and minimum disclosure
- native scenario: fallback, timeout and partial-result semantics
