---
name: b46-meta-skill-layering-capability-resolver
description: 建立L0 Meta、L1 Orchestrator、L2 Implementation、L3 Test/Operations分层与解析入口。
---

# Skill 1507：Skill四层分级与Capability Resolver
...
建立L0 Meta、L1 Orchestrator、L2 Implementation、L3 Test/Operations分层与解析入口。
...
- Codex先解析L0，再选择L1，最后调用L2/L3；禁止数百Skill无层次平面触发。
...
- `skills/registry/`
- `services/control-plane/skill-resolver/`
