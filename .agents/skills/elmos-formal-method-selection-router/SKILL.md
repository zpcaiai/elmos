---
name: elmos-formal-method-selection-router
description: Select SMT, symbolic execution, model checking, proof assistant, abstract interpretation or runtime monitoring per obligation, language and assurance envelope.
version: 4.0.0
...
# Formal Method Selection Router
...
- `FormalMethodSelectionRouterProfile`
- `FormalMethodSelectionRouterPlan`
- `FormalMethodSelectionRouterRun`
- `FormalMethodSelectionRouterDecision`

Required semantic capabilities:

- classify safety, liveness, equivalence and quantitative claims
- estimate decidability, state space and TCB
- compose verifier portfolios
- record soundness/completeness and bounds
- fallback to monitoring without status inflation
...
- `artifacts/elmos-formal-method-selection-router/profile.yaml`
- `artifacts/elmos-formal-method-selection-router/plan.json`
- `artifacts/elmos-formal-method-selection-router/result.json`
- `artifacts/elmos-formal-method-selection-router/evidence/`
...
- **unsound tool selected for claim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **timeout reported as proof** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **model abstraction omits effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **LLM chooses favorable verifier** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **TCB not disclosed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify safety, liveness, equivalence and quantitative claims
- native scenario: estimate decidability, state space and TCB
- native scenario: compose verifier portfolios
- native scenario: record soundness/completeness and bounds
- native scenario: fallback to monitoring without status inflation
