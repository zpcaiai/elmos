---
name: elmos-risk-acceptance-residual-risk-governor
description: Govern explicit risk ownership, rationale, compensating controls, customer disclosure, expiry and certificate impact without converting acceptance into proof.
version: 4.0.0
...
# Risk Acceptance and Residual-Risk Governor
...
- `RiskAcceptanceAndResidualRiskGovernorProfile`
- `RiskAcceptanceAndResidualRiskGovernorPlan`
- `RiskAcceptanceAndResidualRiskGovernorRun`
- `RiskAcceptanceAndResidualRiskGovernorDecision`

Required semantic capabilities:

- record risk claim, likelihood, impact and evidence
- require authorized owner and independent review
- bind compensating controls and monitoring
- set expiry and renewal criteria
- display residual risk in certificate and customer dossier
...
- `artifacts/elmos-risk-acceptance-residual-risk-governor/profile.yaml`
- `artifacts/elmos-risk-acceptance-residual-risk-governor/plan.json`
- `artifacts/elmos-risk-acceptance-residual-risk-governor/result.json`
- `artifacts/elmos-risk-acceptance-residual-risk-governor/evidence/`
...
- **waiver renamed risk acceptance** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **owner lacks authority** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **risk accepted indefinitely** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **compensating control not monitored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer report hides residual risk** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: record risk claim, likelihood, impact and evidence
- native scenario: require authorized owner and independent review
- native scenario: bind compensating controls and monitoring
- native scenario: set expiry and renewal criteria
- native scenario: display residual risk in certificate and customer dossier
