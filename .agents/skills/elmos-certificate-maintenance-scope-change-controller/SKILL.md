---
name: elmos-certificate-maintenance-scope-change-controller
description: Implement and independently certify certificate maintenance and scope-change controller, including classify product, process, organization, model, data, provider and environment changes, determine maintenance, limited evaluation or full recertification path and update certificate scope, evidence, expiry and public status atomically.
version: 4.0.0
...
# Certificate Maintenance and Scope-Change Controller

## Objective

Implement and independently certify certificate maintenance and scope-change controller, including classify product, process, organization, model, data, provider and environment changes, determine maintenance, limited evaluation or full recertification path and update certificate scope, evidence, expiry and public status atomically.
...
- `CertificateMaintenanceAndScopeChangeControllerProfile`
- `CertificateMaintenanceAndScopeChangeControllerRun`
- `CertificateMaintenanceAndScopeChangeControllerFinding`
- `CertificateMaintenanceAndScopeChangeControllerDecision`
- `CertificateMaintenanceAndScopeChangeControllerEvidence`

Required semantic capabilities:

- classify product, process, organization, model, data, provider and environment changes
- determine maintenance, limited evaluation or full recertification path
- update certificate scope, evidence, expiry and public status atomically
...
- `elmos-post-market-surveillance-signal-detection-controller`
- `elmos-production-change-control-recertification-gate`

## Primary Outputs

- `artifacts/elmos-certificate-maintenance-scope-change-controller/profile.yaml`
- `artifacts/elmos-certificate-maintenance-scope-change-controller/plan.json`
- `artifacts/elmos-certificate-maintenance-scope-change-controller/result.json`
- `artifacts/elmos-certificate-maintenance-scope-change-controller/evidence/`
- `artifacts/elmos-certificate-maintenance-scope-change-controller/assurance-case.json`
...
- **material change is labeled maintenance** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **scope extension inherits unrelated evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **old certificate and new scope coexist ambiguously** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify product, process, organization, model, data, provider and environment changes
- native scenario: determine maintenance, limited evaluation or full recertification path
- native scenario: update certificate scope, evidence, expiry and public status atomically
