...
## Inspirations
- SLSA
- OpenHarmony-inspired gates

## Activation conditions
- Activate when the task requires: aggregate all proof artifacts into configurable E0-E5 production gates and fail closed when mandatory evidence is missing or stale.
