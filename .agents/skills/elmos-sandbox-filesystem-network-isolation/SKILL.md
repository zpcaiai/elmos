---
name: sandbox-filesystem-network-isolation
description: Use this skill when Elmos must perform sandbox filesystem network isolation as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
限制文件路径、系统调用、进程、设备、网络出口、DNS 和凭据。
