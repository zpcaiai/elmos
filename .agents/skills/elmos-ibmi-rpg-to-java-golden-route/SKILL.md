---
name: elmos-ibmi-rpg-to-java-golden-route
description: 'Execute the reference route: RPG/RPGLE/CL/DDS/DB2 for i to Java/Spring
  Boot.'
version: 1.0.0
skill_id: ELMOS-POLY-133
...
triggers:
- Use when implementing or executing `elmos-ibmi-rpg-to-java-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-ibmi-rpg-to-java-golden-route/run.json
- routes/elmos-ibmi-rpg-to-java-golden-route/migration-plan.json
- routes/elmos-ibmi-rpg-to-java-golden-route/evidence/
---

# Ibmi Rpg To Java Golden Route

## Objective

Execute the reference route: RPG/RPGLE/CL/DDS/DB2 for i to Java/Spring Boot.
...
- Source: `rpg`
- Target: `java`
- Intent: RPG/RPGLE/CL/DDS/DB2 for i to Java/Spring Boot
