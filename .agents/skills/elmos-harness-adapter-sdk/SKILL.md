---
name: "elmos-harness-adapter-sdk"
description: "Invoke the bounded repository handler for elmos-harness-adapter-sdk while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P01:harness-adapter-sdk"
  source_name: "elmos-harness-adapter-sdk"
  installed_name: "elmos-harness-adapter-sdk"
  source_logical_path: "01-elmos-harness-runtime-platform/skills/harness-adapter-sdk/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/01-elmos-harness-runtime-platform/skills/harness-adapter-sdk/SKILL.md.source-data"
  source_materialized_path: "01-elmos-harness-runtime-platform/skills/harness-adapter-sdk/SKILL.md.source-data"
  source_sha256: "sha256:2301b55d02591e418463dd9e1ace66a75e04e44b01be54c86f88a45da82580fe"
...
- This is a deterministic repository wrapper for `01-elmos-harness-runtime-platform/skills/harness-adapter-sdk/SKILL.md` at `sha256:2301b55d02591e418463dd9e1ace66a75e04e44b01be54c86f88a45da82580fe`.
- Its immutable source/runtime identity is `elmos-harness-adapter-sdk`; its active installed identity is `elmos-harness-adapter-sdk`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-harness-adapter-sdk --request <file>
```
