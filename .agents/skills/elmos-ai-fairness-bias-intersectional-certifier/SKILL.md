---
name: elmos-ai-fairness-bias-intersectional-certifier
description: Implement and independently certify fairness, bias and intersectional performance certifier, including define protected and affected groups with lawful purpose and stakeholder input, measure performance, allocation, representation and harm disparities with uncertainty and evaluate intersectional small groups and remediation trade-offs.
version: 4.0.0
...
# Fairness, Bias and Intersectional Performance Certifier
...
- `FairnessBiasAndIntersectionalPerformanceCertifierProfile`
- `FairnessBiasAndIntersectionalPerformanceCertifierRun`
- `FairnessBiasAndIntersectionalPerformanceCertifierFinding`
- `FairnessBiasAndIntersectionalPerformanceCertifierDecision`
- `FairnessBiasAndIntersectionalPerformanceCertifierEvidence`

Required semantic capabilities:

- define protected and affected groups with lawful purpose and stakeholder input
- measure performance, allocation, representation and harm disparities with uncertainty
- evaluate intersectional small groups and remediation trade-offs
...
- `elmos-sampling-plan-representativeness-certifier`
...
- `artifacts/elmos-ai-fairness-bias-intersectional-certifier/profile.yaml`
- `artifacts/elmos-ai-fairness-bias-intersectional-certifier/plan.json`
- `artifacts/elmos-ai-fairness-bias-intersectional-certifier/result.json`
- `artifacts/elmos-ai-fairness-bias-intersectional-certifier/evidence/`
- `artifacts/elmos-ai-fairness-bias-intersectional-certifier/assurance-case.json`
...
- **aggregate parity hides intersectional harm** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fairness metric chosen to favor deployment** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive attributes are inferred without governance** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define protected and affected groups with lawful purpose and stakeholder input
- native scenario: measure performance, allocation, representation and harm disparities with uncertainty
- native scenario: evaluate intersectional small groups and remediation trade-offs
