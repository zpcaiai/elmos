---
name: "elmos-rule-preservation-prover"
description: "对每条 Rule DSL 转换规则证明在适用前提下保持 Semantic IR 语义，并产出可独立检查证书。 Use when the task needs the exact Transformation Rule Preservation Prover Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-rule-preservation-prover/SKILL.md"
  source_sha256: "sha256:c33c5a2ae4ebe3ce9fa3fbb030cf7e79406f7bd3942bd25dde29c963f21a6e49"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "cross-language"
  runtime_handler_id: "execute_elmos_rule_preservation_prover"
...
---
# Transformation Rule Preservation Prover

## Repository integration boundary

- Exact Skill identity: `elmos-rule-preservation-prover`; exact allowlisted runtime handler: `execute_elmos_rule_preservation_prover`.
- Source identity: `skills/P0/elmos-rule-preservation-prover/SKILL.md` at `sha256:c33c5a2ae4ebe3ce9fa3fbb030cf7e79406f7bd3942bd25dde29c963f21a6e49` from `elmos-formal-assurance-kernel-v1.0.0`.
...
对每条 Rule DSL 转换规则证明在适用前提下保持 Semantic IR 语义，并产出可独立检查证书。
...
3. Use the repository-owned `execute_elmos_rule_preservation_prover` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["relational Hoare logic","induction on syntax","SMT discharge","kernel-checked lemmas"]`
- Direct dependencies: `["elmos-proof-obligation-planner","elmos-verifier-portfolio-router","elmos-semantic-ir-formal-semantics"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-rule-preservation-prover/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
