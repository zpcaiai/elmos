---
name: b93-delphi-com-windows-api-interop-analyzer
description: "Use when ELMOS must run delphi com windows api interop analyzer for Batch 93 Delphi / Object Pascal Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG372"
  source_name: "delphi-com-windows-api-interop-analyzer"
  source_sha256: "sha256:fbc71a0ca2b3cc20820a97fb35c705e8265b6c2d66c4b78633a829a53ae3f9a3"
  batch: 93
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 93 Language Pack / source PG372 — Delphi Com Windows API Interop Analyzer

## 1. Objective

Analyze delphi com windows api interop analyzer within the Delphi / Object Pascal Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Delphi Com Windows API Interop Analyzer using the approved windows-industrial-legacy semantic contracts and toolchain versions.
...
- A representative valid delphi-object-pascal input produces all declared outputs for delphi-com-windows-api-interop-analyzer.
