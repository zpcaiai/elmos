---
name: b90-sas-job-workflow-modeler
description: "Use when ELMOS must run sas job workflow modeler for Batch 90 SAS / Macro / PROC SQL / Viya Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG336"
  source_name: "sas-job-workflow-modeler"
  source_sha256: "sha256:cc68a9377abd218b17a95ac699e1ca40110ecb5b79163449583c15b816cf8ab6"
  batch: 90
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 90 Language Pack / source PG336 — Sas Job Workflow Modeler

## 1. Objective

Model sas job workflow modeler within the SAS / Macro / PROC SQL / Viya Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Sas Job Workflow Modeler using the approved enterprise-analytics semantic contracts and toolchain versions.
...
- A representative valid sas-modernization input produces all declared outputs for sas-job-workflow-modeler.
