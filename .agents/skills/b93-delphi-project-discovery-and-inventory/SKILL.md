---
name: b93-delphi-project-discovery-and-inventory
description: "Use when ELMOS must run delphi project discovery and inventory for Batch 93 Delphi / Object Pascal Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG367"
  source_name: "delphi-project-discovery-and-inventory"
  source_sha256: "sha256:bd05d43cc6a806de85ceee48d326fe549dd7cf933d212ed9e642b6a0c14688fe"
  batch: 93
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 93 Language Pack / source PG367 — Delphi Project Discovery And Inventory

## 1. Objective

Discover and inventory delphi project discovery and inventory within the Delphi / Object Pascal Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Delphi Project Discovery And Inventory using the approved windows-industrial-legacy semantic contracts and toolchain versions.
...
- A representative valid delphi-object-pascal input produces all declared outputs for delphi-project-discovery-and-inventory.
