...
description: "Repository-owned bounded wrapper for sql-dialect-transpiler; external evidence remains NOT_RUN."
---
...
4. Submit `sql-dialect-transpiler` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `556814570c4cf8bf29b7615cfd2a1803931e06f5dc627955182dccd6f4e9d77b`
