...
## Objective
Parse/normalize/transpile SQL dialects with explicit unsupported constructs and target-specific rewrite rules.
...
- Activate when the task requires: parse/normalize/transpile SQL dialects with explicit unsupported constructs and target-specific rewrite rules.
