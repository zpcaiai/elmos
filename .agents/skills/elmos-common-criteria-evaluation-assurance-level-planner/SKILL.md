---
name: elmos-common-criteria-evaluation-assurance-level-planner
description: Implement and independently certify common criteria evaluation assurance level planner, including choose assurance package based on threat, recognition and procurement needs, compile development, guidance, lifecycle, testing and vulnerability evidence plan and distinguish EAL or composed package from overall product safety certification.
version: 4.0.0
...
# Common Criteria Evaluation Assurance Level Planner
...
- `CommonCriteriaEvaluationAssuranceLevelPlannerProfile`
- `CommonCriteriaEvaluationAssuranceLevelPlannerRun`
- `CommonCriteriaEvaluationAssuranceLevelPlannerFinding`
- `CommonCriteriaEvaluationAssuranceLevelPlannerDecision`
- `CommonCriteriaEvaluationAssuranceLevelPlannerEvidence`

Required semantic capabilities:

- choose assurance package based on threat, recognition and procurement needs
- compile development, guidance, lifecycle, testing and vulnerability evidence plan
- distinguish EAL or composed package from overall product safety certification
...
- `elmos-common-criteria-security-target-compiler`
- `elmos-verifier-tool-qualification-classifier`

## Primary Outputs

- `artifacts/elmos-common-criteria-evaluation-assurance-level-planner/profile.yaml`
- `artifacts/elmos-common-criteria-evaluation-assurance-level-planner/plan.json`
- `artifacts/elmos-common-criteria-evaluation-assurance-level-planner/result.json`
- `artifacts/elmos-common-criteria-evaluation-assurance-level-planner/evidence/`
- `artifacts/elmos-common-criteria-evaluation-assurance-level-planner/assurance-case.json`
...
- **higher EAL is marketed as universal security** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **assurance components are selected inconsistently** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **recognition scope is misunderstood** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: choose assurance package based on threat, recognition and procurement needs
- native scenario: compile development, guidance, lifecycle, testing and vulnerability evidence plan
- native scenario: distinguish EAL or composed package from overall product safety certification
