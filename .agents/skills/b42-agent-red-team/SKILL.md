---
name: b42-agent-red-team
description: "Implement and verify Batch 42 Skill 1429 for agent red team. Use when work requires Agent Red Team\u548c\u5bf9\u6297\u8bc4\u6d4b, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
## Skill 1429: Agent Red Team和对抗评测
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b42-agent-red-team`.
...
4. Implement the smallest production-shaped capability that exercises `Agent Red Team和对抗评测` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b42-agent-red-team`
