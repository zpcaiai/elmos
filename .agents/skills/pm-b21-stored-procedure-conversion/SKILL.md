...
- Invoke this repository Skill as `$pm-b21-stored-procedure-conversion`.
- Immutable source identity: `batch-21-stored-procedure-conversion` in `precision-migration-b01-44` (B21).
- Runtime adapter: `database-and-data-route`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b21-stored-procedure-conversion`.
...
- 当任务涉及 **stored-procedure-parser** 时，调用 `../pm-b21-stored-procedure-parser/SKILL.md`。
- 当任务涉及 **procedure-cfg-builder** 时，调用 `../pm-b21-procedure-cfg-builder/SKILL.md`。
- 当任务涉及 **cursor-semantics-converter** 时，调用 `../pm-b21-cursor-semantics-converter/SKILL.md`。
- 当任务涉及 **dynamic-sql-converter** 时，调用 `../pm-b21-dynamic-sql-converter/SKILL.md`。
- 当任务涉及 **exception-handler-converter** 时，调用 `../pm-b21-exception-handler-converter/SKILL.md`。
- 当任务涉及 **transaction-boundary-converter** 时，调用 `../pm-b21-transaction-boundary-converter/SKILL.md`。
- 当任务涉及 **temporary-object-converter** 时，调用 `../pm-b21-temporary-object-converter/SKILL.md`。
- 当任务涉及 **package-state-converter** 时，调用 `../pm-b21-package-state-converter/SKILL.md`。
- 当任务涉及 **trigger-semantics-converter** 时，调用 `../pm-b21-trigger-semantics-converter/SKILL.md`。
- 当任务涉及 **scheduled-event-converter** 时，调用 `../pm-b21-scheduled-event-converter/SKILL.md`。
- 当任务涉及 **procedure-side-effect-analyzer** 时，调用 `../pm-b21-procedure-side-effect-analyzer/SKILL.md`。
- 当任务涉及 **procedure-symbolic-validator** 时，调用 `../pm-b21-procedure-symbolic-validator/SKILL.md`。
- 当任务涉及 **procedure-differential-test-generator** 时，调用 `../pm-b21-procedure-differential-test-generator/SKILL.md`。
- 当任务涉及 **procedure-performance-validator** 时，调用 `../pm-b21-procedure-performance-validator/SKILL.md`。
