---
name: b45-route-breadth-certification
description: "Implement and verify Batch 45 Skill 1478 for route breadth certification. Use when work requires \u8bed\u8a00\u548c\u6846\u67b6\u8def\u7ebf\u5e7f\u5ea6\u8ba4\u8bc1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-route-breadth-certification`.
...
4. Implement the smallest production-shaped capability that exercises `语言和框架路线广度认证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-route-breadth-certification`
