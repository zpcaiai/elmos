---
name: elmos-outsourced-certification-activity-control-governor
description: Implement and independently certify outsourced certification activity control governor, including qualify subcontract laboratories, auditors, experts and cloud services, retain certification-body responsibility, records and decision authority and monitor competence, impartiality, data residency and change.
version: 4.0.0
...
# Outsourced Certification Activity Control Governor

## Objective

Implement and independently certify outsourced certification activity control governor, including qualify subcontract laboratories, auditors, experts and cloud services, retain certification-body responsibility, records and decision authority and monitor competence, impartiality, data residency and change.
...
- `OutsourcedCertificationActivityControlGovernorProfile`
- `OutsourcedCertificationActivityControlGovernorRun`
- `OutsourcedCertificationActivityControlGovernorFinding`
- `OutsourcedCertificationActivityControlGovernorDecision`
- `OutsourcedCertificationActivityControlGovernorEvidence`

Required semantic capabilities:

- qualify subcontract laboratories, auditors, experts and cloud services
- retain certification-body responsibility, records and decision authority
- monitor competence, impartiality, data residency and change
...
- `elmos-certification-function-separation-controller`
- `elmos-auditor-evaluator-competence-authorization-controller`

## Primary Outputs

- `artifacts/elmos-outsourced-certification-activity-control-governor/profile.yaml`
- `artifacts/elmos-outsourced-certification-activity-control-governor/plan.json`
- `artifacts/elmos-outsourced-certification-activity-control-governor/result.json`
- `artifacts/elmos-outsourced-certification-activity-control-governor/evidence/`
- `artifacts/elmos-outsourced-certification-activity-control-governor/assurance-case.json`
...
- **subcontractor self-certifies its output** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **outsourced judge trains on customer data** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **contract prevents access to raw evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: qualify subcontract laboratories, auditors, experts and cloud services
- native scenario: retain certification-body responsibility, records and decision authority
- native scenario: monitor competence, impartiality, data residency and change
