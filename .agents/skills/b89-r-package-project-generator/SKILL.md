---
name: b89-r-package-project-generator
description: "Use when ELMOS must run r package project generator for Batch 89 R / Quarto / Shiny / renv Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG323"
  source_name: "r-package-project-generator"
  source_sha256: "sha256:7f42b79194068ab0489269eb6cfb0bac324d16b76e157684aead82a5a1db44b4"
  batch: 89
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 89 Language Pack / source PG323 — R Package Project Generator

## 1. Objective

Generate r package project generator within the R / Quarto / Shiny / renv Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for R Package Project Generator using the approved data-science semantic contracts and toolchain versions.
...
- A representative valid r-data-science input produces all declared outputs for r-package-project-generator.
