---
name: unsafe-interop-sandbox-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Unsafe Interop and Sandbox Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T102"
  source_name: "unsafe-interop-sandbox-gate"
  source_sha256: "sha256:8329a2b266f3124aaf76efab08420b13142121a9f0abe99deff2d62f2741cae6"
...
# T102 — Unsafe Interop and Sandbox Gate

## 1. Objective

Test native calls, FFI, COM, dynamic SQL, macro/runtime reflection and embedded scripting isolation.
...
- `CASE-0451` [HIGH] Unsafe Interop and Sandbox Gate: Representative path
- `CASE-0452` [HIGH] Unsafe Interop and Sandbox Gate: Boundary path
- `CASE-0453` [HIGH] Unsafe Interop and Sandbox Gate: Invalid or hostile input
- `CASE-0454` [HIGH] Unsafe Interop and Sandbox Gate: Injected dependency failure
- `CASE-0455` [CRITICAL] Unsafe Interop and Sandbox Gate: Security or safety violation
- `CASE-0456` [HIGH] Unsafe Interop and Sandbox Gate: Replay and idempotency
- `CASE-0457` [HIGH] Unsafe Interop and Sandbox Gate: Version or environment drift
- `CASE-0458` [MEDIUM] Unsafe Interop and Sandbox Gate: Moderate scale
- `CASE-0459` [CRITICAL] Unsafe Interop and Sandbox Gate: Evidence tamper
- `CASE-0460` [HIGH] Unsafe Interop and Sandbox Gate: Recovery and final evidence
