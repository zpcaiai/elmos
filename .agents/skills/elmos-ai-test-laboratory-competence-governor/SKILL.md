---
name: elmos-ai-test-laboratory-competence-governor
description: Implement and independently certify ai test laboratory competence governor, including establish laboratory management system, impartiality, personnel, facilities and method controls, authorize staff and automated evaluators by exact method and scope and monitor validity of results, equipment, software and environmental conditions.
version: 4.0.0
...
# AI Test Laboratory Competence Governor
...
- `AITestLaboratoryCompetenceGovernorProfile`
- `AITestLaboratoryCompetenceGovernorRun`
- `AITestLaboratoryCompetenceGovernorFinding`
- `AITestLaboratoryCompetenceGovernorDecision`
- `AITestLaboratoryCompetenceGovernorEvidence`

Required semantic capabilities:

- establish laboratory management system, impartiality, personnel, facilities and method controls
- authorize staff and automated evaluators by exact method and scope
- monitor validity of results, equipment, software and environmental conditions
...
- `artifacts/elmos-ai-test-laboratory-competence-governor/profile.yaml`
- `artifacts/elmos-ai-test-laboratory-competence-governor/plan.json`
- `artifacts/elmos-ai-test-laboratory-competence-governor/result.json`
- `artifacts/elmos-ai-test-laboratory-competence-governor/evidence/`
- `artifacts/elmos-ai-test-laboratory-competence-governor/assurance-case.json`
...
- **test laboratory is only a CI pipeline with no competence controls** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **model judge is authorized without calibration** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **facility or cloud environment drift invalidates repeatability** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: establish laboratory management system, impartiality, personnel, facilities and method controls
- native scenario: authorize staff and automated evaluators by exact method and scope
- native scenario: monitor validity of results, equipment, software and environmental conditions
