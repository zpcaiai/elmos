---
name: skill-activation-router
description: Use this skill when Elmos must perform skill activation router as part of the 05-skill-foundry-runtime production
...
根据用户意图、仓库事实、风险和能力置信度选择应加载的 Skill。
