---
name: elmos-cost-allocation-chargeback-showback-controller
description: Allocate model, compute, storage, network, database and support costs to tenant, project, route and feature with explainable reconciliation.
version: 4.0.0
...
# Cost Allocation, Chargeback and Showback Controller
...
- `CostAllocationChargebackAndShowbackControllerProfile`
- `CostAllocationChargebackAndShowbackControllerPlan`
- `CostAllocationChargebackAndShowbackControllerRun`
- `CostAllocationChargebackAndShowbackControllerDecision`

Required semantic capabilities:

- ingest provider and internal usage ledgers
- attribute shared and cached costs
- reconcile estimates with invoices
- generate showback/chargeback and anomaly alerts
- preserve pricing version and margin evidence
...
- `artifacts/elmos-cost-allocation-chargeback-showback-controller/profile.yaml`
- `artifacts/elmos-cost-allocation-chargeback-showback-controller/plan.json`
- `artifacts/elmos-cost-allocation-chargeback-showback-controller/result.json`
- `artifacts/elmos-cost-allocation-chargeback-showback-controller/evidence/`
...
- **transfer counted as consumption** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared cost allocation opaque** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider invoice double-counted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cache saving attributed to wrong tenant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **pricing change applied retroactively** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: ingest provider and internal usage ledgers
- native scenario: attribute shared and cached costs
- native scenario: reconcile estimates with invoices
- native scenario: generate showback/chargeback and anomaly alerts
- native scenario: preserve pricing version and margin evidence
