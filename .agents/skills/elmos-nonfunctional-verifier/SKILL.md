---
name: "elmos-nonfunctional-verifier"
description: "Invoke the bounded repository handler for elmos-nonfunctional-verifier while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P05:nonfunctional-verifier"
  source_name: "elmos-nonfunctional-verifier"
  installed_name: "elmos-nonfunctional-verifier"
  source_logical_path: "05-elmos-conversion-reliability-verification-harness/skills/nonfunctional-verifier/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/05-elmos-conversion-reliability-verification-harness/skills/nonfunctional-verifier/SKILL.md.source-data"
  source_materialized_path: "05-elmos-conversion-reliability-verification-harness/skills/nonfunctional-verifier/SKILL.md.source-data"
  source_sha256: "sha256:196f60d385d49f86d978054b2b3ce1548f4fdaa41d244fe547b6e0859d54cb2d"
...
- This is a deterministic repository wrapper for `05-elmos-conversion-reliability-verification-harness/skills/nonfunctional-verifier/SKILL.md` at `sha256:196f60d385d49f86d978054b2b3ce1548f4fdaa41d244fe547b6e0859d54cb2d`.
- Its immutable source/runtime identity is `elmos-nonfunctional-verifier`; its active installed identity is `elmos-nonfunctional-verifier`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-nonfunctional-verifier --request <file>
```
