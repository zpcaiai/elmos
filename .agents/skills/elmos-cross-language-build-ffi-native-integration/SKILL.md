---
name: cross-language-build-ffi-native-integration
description: Use this skill when Elmos must perform cross language build ffi native integration as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# cross-language-build-ffi-native-integration

## 能力目标

迁移依赖、构建、C ABI、Native 库、平台能力和发布。
