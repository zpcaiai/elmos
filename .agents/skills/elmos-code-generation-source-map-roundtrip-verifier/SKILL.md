---
name: elmos-code-generation-source-map-roundtrip-verifier
description: Verify source-to-IR-to-target lineage, symbol identity, comments, diagnostics, coverage and debugger mappings across regeneration and reverse import.
version: 4.0.0
...
# Code Generation Source-Map Round-Trip Verifier
...
- `CodeGenerationSourceMapRoundTripVerifierProfile`
- `CodeGenerationSourceMapRoundTripVerifierPlan`
- `CodeGenerationSourceMapRoundTripVerifierRun`
- `CodeGenerationSourceMapRoundTripVerifierDecision`

Required semantic capabilities:

- map every generated range to IR and source evidence
- round-trip symbols and stable generated identities
- preserve user-owned regions and comments
- translate diagnostics and coverage to source concepts
- detect stale or ambiguous mappings after merge
...
- `artifacts/elmos-code-generation-source-map-roundtrip-verifier/profile.yaml`
- `artifacts/elmos-code-generation-source-map-roundtrip-verifier/plan.json`
- `artifacts/elmos-code-generation-source-map-roundtrip-verifier/result.json`
- `artifacts/elmos-code-generation-source-map-roundtrip-verifier/evidence/`
...
- **source map points to wrong revision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated identity collision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **user region overwritten** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **diagnostic attribution forged** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **lineage broken by formatter or minifier** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: map every generated range to IR and source evidence
- native scenario: round-trip symbols and stable generated identities
- native scenario: preserve user-owned regions and comments
- native scenario: translate diagnostics and coverage to source concepts
- native scenario: detect stale or ambiguous mappings after merge
