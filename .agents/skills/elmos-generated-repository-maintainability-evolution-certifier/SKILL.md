---
name: elmos-generated-repository-maintainability-evolution-certifier
description: Certify generated repositories for analyzability, modularity, testability, changeability, ownership, documentation, upgradeability and bounded technical debt.
version: 4.0.0
...
# Generated Repository Maintainability and Evolution Certifier

## Objective

Certify generated repositories for analyzability, modularity, testability, changeability, ownership, documentation, upgradeability and bounded technical debt.
...
- **Kernel authorities used:** K2, K3, K6, K8
...
- `GeneratedRepositoryMaintainabilityAndEvolutionCertifierRun`
- `GeneratedRepositoryMaintainabilityAndEvolutionCertifierDecision`
- `EvidenceArtifact`
- `ProofResult`

Required semantic capabilities:

- Measure dependency cycles, coupling, complexity and module ownership
- Run architecture fitness functions and mutation effectiveness
- Verify generated/user-owned region and regeneration safety
- Exercise representative feature change and framework upgrade
- Track accepted technical debt with owner and expiry
...
- `elmos-polyglot-route-matrix-governor` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
- `elmos-ai-generated-project-upgrader` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `maintainability-report.json`
- `architecture-fitness-results.json`
- `technical-debt-ledger.json`
- `evolution-certificate.json`
...
- **generated code optimized only for first build** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dead abstractions inflate modularity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **docs diverge from code** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **upgrade requires full rewrite** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **technical debt hidden** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- representative change task
- regeneration preservation
- dependency upgrade
- mutation score
- technical debt expiry
