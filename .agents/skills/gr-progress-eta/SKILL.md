---
name: gr-progress-eta
description: 从 DAG、critical path、Gate、人工等待和阻塞计算可信进度与 ETA。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-071
  source_name: gr-progress-eta
  source_path: skills/gr-progress-eta/SKILL.md
  source_sha256: sha256:170ab2abe0ab5ae341c47aa0bc7b4372ebd7258a7e853363fc02a8d8216c854f
  source_contract_sha256: sha256:0fdff53aec48d111ee5d48f54917e7bcc57fc2294741b55dd8b6ebc7037ff63a
...
# Progress & Customer ETA

## Objective

从 DAG、critical path、Gate、人工等待和阻塞计算可信进度与 ETA。
...
- [ ] 定义 `gr-progress-eta` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-progress-eta` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：status-api.json, progress-events.json, customer-status.md。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：status-api.json, progress-events.json, customer-status.md。
...
- Machine contract: `references/contract.json` (`sha256:0fdff53aec48d111ee5d48f54917e7bcc57fc2294741b55dd8b6ebc7037ff63a`).
