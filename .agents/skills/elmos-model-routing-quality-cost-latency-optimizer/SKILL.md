---
name: elmos-model-routing-quality-cost-latency-optimizer
description: Optimize model/provider routing under quality, safety, latency, residency, quota and cost constraints with shadow evidence and bounded fallback.
version: 4.0.0
...
# Model Routing Quality, Cost and Latency Optimizer
...
- `ModelRoutingQualityCostAndLatencyOptimizerProfile`
- `ModelRoutingQualityCostAndLatencyOptimizerPlan`
- `ModelRoutingQualityCostAndLatencyOptimizerRun`
- `ModelRoutingQualityCostAndLatencyOptimizerDecision`

Required semantic capabilities:

- fit task-conditioned quality and latency models
- solve constrained route selection
- reserve safe fallback and circuit breakers
- evaluate paired shadow traffic
- retrain only from governed evidence
...
- `artifacts/elmos-model-routing-quality-cost-latency-optimizer/profile.yaml`
- `artifacts/elmos-model-routing-quality-cost-latency-optimizer/plan.json`
- `artifacts/elmos-model-routing-quality-cost-latency-optimizer/result.json`
- `artifacts/elmos-model-routing-quality-cost-latency-optimizer/evidence/`
...
- **cheap model routed to critical task** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **optimizer reward omits safety** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider quota stale** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **feedback loop amplifies bias** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shadow data violates purpose** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: fit task-conditioned quality and latency models
- native scenario: solve constrained route selection
- native scenario: reserve safe fallback and circuit breakers
- native scenario: evaluate paired shadow traffic
- native scenario: retrain only from governed evidence
