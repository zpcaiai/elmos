---
name: b46-verified-migrated-workload-value-metric
description: 以Build、P0测试、行为、安全、维护性和客户验收共同定义核心成功单位。
---

# Skill 1525：Verified Migrated Workload价值指标
...
以Build、P0测试、行为、安全、维护性和客户验收共同定义核心成功单位。
...
- 代码行数不是价值；Verified Workload只有六个Green全部满足并经客户接受才计数。
...
- `services/metrics/verified-workload/`
- `contracts/metrics/`
