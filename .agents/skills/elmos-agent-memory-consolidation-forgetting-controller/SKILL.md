---
name: elmos-agent-memory-consolidation-forgetting-controller
description: Consolidate episodic memory into semantic/procedural memory while preserving provenance, uncertainty, consent, retention and deliberate forgetting.
version: 4.0.0
...
# Agent Memory Consolidation and Forgetting Controller
...
- `AgentMemoryConsolidationAndForgettingControllerProfile`
- `AgentMemoryConsolidationAndForgettingControllerPlan`
- `AgentMemoryConsolidationAndForgettingControllerRun`
- `AgentMemoryConsolidationAndForgettingControllerDecision`

Required semantic capabilities:

- classify candidate memories by scope and purpose
- deduplicate and consolidate with provenance
- retain uncertainty and conflicting episodes
- apply retention, consent and deletion
- evaluate usefulness, bias and leakage before promotion
...
- `artifacts/elmos-agent-memory-consolidation-forgetting-controller/profile.yaml`
- `artifacts/elmos-agent-memory-consolidation-forgetting-controller/plan.json`
- `artifacts/elmos-agent-memory-consolidation-forgetting-controller/result.json`
- `artifacts/elmos-agent-memory-consolidation-forgetting-controller/evidence/`
...
- **hallucination consolidated as fact** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **private episode becomes organization memory** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **forgetting misses derived summary** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **procedural memory embeds unsafe action** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **memory promotion self-validates** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify candidate memories by scope and purpose
- native scenario: deduplicate and consolidate with provenance
- native scenario: retain uncertainty and conflicting episodes
- native scenario: apply retention, consent and deletion
- native scenario: evaluate usefulness, bias and leakage before promotion
