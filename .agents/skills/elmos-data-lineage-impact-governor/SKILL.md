---
name: elmos-data-lineage-impact-governor
description: Collect and verify dataset, column, model, prompt, retrieval and generated-artifact lineage so changes invalidate every affected route and certificate.
version: 4.0.0
...
# Data Lineage and Impact Governor
...
- `DataLineageAndImpactGovernorProfile`
- `DataLineageAndImpactGovernorPlan`
- `DataLineageAndImpactGovernorRun`
- `DataLineageAndImpactGovernorDecision`

Required semantic capabilities:

- ingest OpenLineage-compatible run and dataset events
- derive column and semantic lineage
- link data to models, prompts and outputs
- compute change impact and evidence invalidation
- export auditable lineage with confidence
...
- `artifacts/elmos-data-lineage-impact-governor/profile.yaml`
- `artifacts/elmos-data-lineage-impact-governor/plan.json`
- `artifacts/elmos-data-lineage-impact-governor/result.json`
- `artifacts/elmos-data-lineage-impact-governor/evidence/`
...
- **lineage event forged** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **column mapping incomplete** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **derived dataset ownership missing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale lineage suppresses recertification** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive lineage metadata overexposed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: ingest OpenLineage-compatible run and dataset events
- native scenario: derive column and semantic lineage
- native scenario: link data to models, prompts and outputs
- native scenario: compute change impact and evidence invalidation
- native scenario: export auditable lineage with confidence
