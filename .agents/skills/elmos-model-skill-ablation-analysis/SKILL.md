---
name: model-skill-ablation-analysis
description: Use this skill when Elmos must perform model skill ablation analysis as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# model-skill-ablation-analysis

## 能力目标

分离模型、Skill、检索、工具和训练改动对结果的贡献。
