---
name: elmos-incident-command-runbook-automation-generator
description: Generate role-based incident workflows, diagnostics, communications, mitigations, evidence preservation and recovery gates.
version: 4.0.0
...
# Incident Command and Runbook Automation Generator
...
- `IncidentCommandAndRunbookAutomationGeneratorProfile`
- `IncidentCommandAndRunbookAutomationGeneratorPlan`
- `IncidentCommandAndRunbookAutomationGeneratorRun`
- `IncidentCommandAndRunbookAutomationGeneratorDecision`

Required semantic capabilities:

- compile incident taxonomy and severity
- assign commander, operations and communications roles
- generate safe diagnostic and mitigation actions
- preserve evidence and customer timelines
- gate restart and postmortem recertification
...
- `elmos-security-incident-psirt-disclosure-controller` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `artifacts/elmos-incident-command-runbook-automation-generator/profile.yaml`
- `artifacts/elmos-incident-command-runbook-automation-generator/plan.json`
- `artifacts/elmos-incident-command-runbook-automation-generator/result.json`
- `artifacts/elmos-incident-command-runbook-automation-generator/evidence/`
...
- **automation executes destructive mitigation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **incident role conflict** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence overwritten** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer notification inconsistent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **service restarts before side effects reconcile** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile incident taxonomy and severity
- native scenario: assign commander, operations and communications roles
- native scenario: generate safe diagnostic and mitigation actions
- native scenario: preserve evidence and customer timelines
- native scenario: gate restart and postmortem recertification
