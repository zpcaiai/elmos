---
name: "elmos-specialized-model-training"
description: "Invoke the bounded repository handler for elmos-specialized-model-training while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P07:specialized-model-training"
  source_name: "elmos-specialized-model-training"
  installed_name: "elmos-specialized-model-training"
  source_logical_path: "07-elmos-transformation-learning-evolution/skills/specialized-model-training/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/07-elmos-transformation-learning-evolution/skills/specialized-model-training/SKILL.md.source-data"
  source_materialized_path: "07-elmos-transformation-learning-evolution/skills/specialized-model-training/SKILL.md.source-data"
  source_sha256: "sha256:1369cddbc61c9d9920466bb016359fba0464e1fdab74908b6fac817973e96e9c"
...
# elmos-specialized-model-training
...
- This is a deterministic repository wrapper for `07-elmos-transformation-learning-evolution/skills/specialized-model-training/SKILL.md` at `sha256:1369cddbc61c9d9920466bb016359fba0464e1fdab74908b6fac817973e96e9c`.
- Its immutable source/runtime identity is `elmos-specialized-model-training`; its active installed identity is `elmos-specialized-model-training`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-specialized-model-training --request <file>
```
