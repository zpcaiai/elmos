---
name: elmos-benchmark-integrity-large-repository-certifier
description: Certify repository-scale productivity and correctness on hidden, contamination-checked, representative repositories including >500k and >1M LOC cases.
version: 4.0.0
...
# Benchmark Integrity and Large Repository Certifier
...
- Freeze hidden benchmark repositories and licenses
- Check training/eval contamination and memorization signals
- Measure correctness, completion, time and cost
- Require repeated independent runs and failure disclosure
- Separate route-specific from broad marketing claims
...
- `elmos-test-matrix-covering-array-planner` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
- `elmos-performance-statistical-gate` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `large-repository-certificate.json`
- `benchmark-manifest.json`
- `contamination-report.json`
- `scale-performance-results.json`
...
- **benchmark repository cherry-picked** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **failed runs excluded** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **model previously trained on hidden patch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **LOC inflated with vendored code** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **human intervention hidden** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- 500k LOC repository
- 1M LOC repository
- multi-module/multi-language repo
- generated/vendor code handling
- hidden acceptance
- three repeated runs
- cost/ETA accuracy
