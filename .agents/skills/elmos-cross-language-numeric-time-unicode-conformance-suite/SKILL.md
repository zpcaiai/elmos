---
name: elmos-cross-language-numeric-time-unicode-conformance-suite
description: Generate and execute edge-case corpora for overflow, decimal, NaN, timezone, calendar, collation, normalization, grapheme and locale behavior across target languages.
version: 4.0.0
...
# Cross-Language Numeric, Time and Unicode Conformance Suite
...
- `CrossLanguageNumericTimeAndUnicodeConformanceSuiteProfile`
- `CrossLanguageNumericTimeAndUnicodeConformanceSuitePlan`
- `CrossLanguageNumericTimeAndUnicodeConformanceSuiteRun`
- `CrossLanguageNumericTimeAndUnicodeConformanceSuiteDecision`

Required semantic capabilities:

- integer overflow and narrowing corpus
- decimal and floating-point tolerance corpus
- DST, leap-second and timezone transition corpus
- Unicode normalization and grapheme corpus
- locale/collation and case-folding corpus
...
- `artifacts/elmos-cross-language-numeric-time-unicode-conformance-suite/profile.yaml`
- `artifacts/elmos-cross-language-numeric-time-unicode-conformance-suite/plan.json`
- `artifacts/elmos-cross-language-numeric-time-unicode-conformance-suite/result.json`
- `artifacts/elmos-cross-language-numeric-time-unicode-conformance-suite/evidence/`
...
- **timezone database drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **locale-dependent test masking** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **NaN comparison normalized incorrectly** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **Unicode security confusable omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **overflow accepted as intended delta** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: integer overflow and narrowing corpus
- native scenario: decimal and floating-point tolerance corpus
- native scenario: DST, leap-second and timezone transition corpus
- native scenario: Unicode normalization and grapheme corpus
- native scenario: locale/collation and case-folding corpus
