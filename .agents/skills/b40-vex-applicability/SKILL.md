---
name: b40-vex-applicability
description: "Implement and verify Batch 40 Skill 1380 for vex applicability. Use when work requires VEX\u548c\u6f0f\u6d1e\u9002\u7528\u6027, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-vex-applicability`.
...
4. Implement the smallest production-shaped capability that exercises `VEX和漏洞适用性` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-vex-applicability`
