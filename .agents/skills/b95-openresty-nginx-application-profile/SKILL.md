---
name: b95-openresty-nginx-application-profile
description: "Use when ELMOS must run openresty nginx application profile for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG393"
  source_name: "openresty-nginx-application-profile"
  source_sha256: "sha256:dce61e194c995c883a9c05950bf06282cb30e6eb4bdb706c1885ed12dc8ad5e0"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG393 — Openresty Nginx Application Profile

## 1. Objective

Define a certified profile for openresty nginx application profile within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Openresty Nginx Application Profile using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for openresty-nginx-application-profile.
