...
description: "Implement and verify Batch 39 Skill 1363 for chaos resilience fault injection. Use when work requires Chaos\u3001Resilience\u548cFault Injection, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Chaos、Resilience和Fault Injection
...
## Skill 1363: Chaos、Resilience和Fault Injection
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-chaos-resilience-fault-injection`.
...
4. Implement the smallest production-shaped capability that exercises `Chaos、Resilience和Fault Injection` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-chaos-resilience-fault-injection`
