---
name: platform-deployment-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Platform Deployment Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T112"
  source_name: "platform-deployment-gate"
  source_sha256: "sha256:40a40143e6210d6d3bb541140082a8d53e56061cfc644ac77a59a598f36297d7"
...
# T112 — Platform Deployment Gate

## 1. Objective

Validate packaging, configuration, health, rollout, operational telemetry and platform-specific deployment behavior.
...
- `CASE-0551` [HIGH] Platform Deployment Gate: Representative path
- `CASE-0552` [HIGH] Platform Deployment Gate: Boundary path
- `CASE-0553` [HIGH] Platform Deployment Gate: Invalid or hostile input
- `CASE-0554` [HIGH] Platform Deployment Gate: Injected dependency failure
- `CASE-0555` [CRITICAL] Platform Deployment Gate: Security or safety violation
- `CASE-0556` [HIGH] Platform Deployment Gate: Replay and idempotency
- `CASE-0557` [HIGH] Platform Deployment Gate: Version or environment drift
- `CASE-0558` [MEDIUM] Platform Deployment Gate: Moderate scale
- `CASE-0559` [CRITICAL] Platform Deployment Gate: Evidence tamper
- `CASE-0560` [HIGH] Platform Deployment Gate: Recovery and final evidence
