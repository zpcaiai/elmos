---
name: gr-cost-accounting
description: 核算 token/cache、Runner、存储、网络、第三方许可和人工触点。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-070
  source_name: gr-cost-accounting
  source_path: skills/gr-cost-accounting/SKILL.md
  source_sha256: sha256:33aa719366654a235a20822bc80c0781595f5528fe6696eb812d83e7272e3b36
  source_contract_sha256: sha256:5fde6aa161108bbdbb10e777e038663a6a1a30a2f4ed3dd5ecaba5bdf24e5d41
...
核算 token/cache、Runner、存储、网络、第三方许可和人工触点。
...
- [ ] 定义 `gr-cost-accounting` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-cost-accounting` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：cost-ledger.json, cost-attribution.json, margin-report.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：cost-ledger.json, cost-attribution.json, margin-report.json。
...
- Machine contract: `references/contract.json` (`sha256:5fde6aa161108bbdbb10e777e038663a6a1a30a2f4ed3dd5ecaba5bdf24e5d41`).
