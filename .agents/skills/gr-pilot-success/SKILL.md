---
name: gr-pilot-success
description: 综合 Proof、客户签署、重复性、确定性率、成本/毛利、人工比例和 Factory 转化。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-088
  source_name: gr-pilot-success
  source_path: skills/gr-pilot-success/SKILL.md
  source_sha256: sha256:48e8e2d0255cd1a9ebcdb13de675d109919874c3cf06dc78eea38379671e0c3a
  source_contract_sha256: sha256:3a44407dd11f3e10efffd3ccceb2b61cf539dc8d4802de19c0abefea856e9a16
...
# Paid Pilot Success Scorecard

## Objective

综合 Proof、客户签署、重复性、确定性率、成本/毛利、人工比例和 Factory 转化。

## Scope and capabilities

- Paid + signed acceptance
- Clean-room
- Human rescue cost
...
- [ ] 定义 `gr-pilot-success` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-pilot-success` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：pilot-success.json, postmortem.md, factory-proposal.md。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：pilot-success.json, postmortem.md, factory-proposal.md。
...
- Machine contract: `references/contract.json` (`sha256:3a44407dd11f3e10efffd3ccceb2b61cf539dc8d4802de19c0abefea856e9a16`).
