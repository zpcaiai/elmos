...
metadata:
  ...
  source_sha256: sha256:93a9a1c6eeb081a9ef0726e9c8f4529e488b37343e0f93d13b58f87a9dfb99df
  normalized_namespace: product-convergence-overlay
  source_batch_label: package-local-batch46-product-convergence
---

# Skill 1522：Recipe晋升与知识治理
...
将客户Patch经脱敏、Corpus、Negative、Holdout、安全审查后晋升为Certified Recipe。
...
- 客户Patch不能直接全局化；必须脱敏、验证、Holdout、安全Review、签名和版本化。
...
- `services/recipes/promotion/`
- `corpus/recipe-candidates/`
