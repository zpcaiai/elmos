...
- Invoke this repository Skill as `$pm-b18-frontend-direction-packs`.
- Immutable source identity: `batch-18-frontend-direction-packs` in `precision-migration-b01-44` (B18).
- Runtime adapter: `frontend-client-route`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b18-frontend-direction-packs`.
...
- 当任务涉及 **vue2-to-vue3-direction-pack** 时，调用 `../pm-b18-vue2-to-vue3-direction-pack/SKILL.md`。
- 当任务涉及 **vue2-to-react-direction-pack** 时，调用 `../pm-b18-vue2-to-react-direction-pack/SKILL.md`。
- 当任务涉及 **vue2-to-wechat-miniprogram-direction-pack** 时，调用 `../pm-b18-vue2-to-wechat-miniprogram-direction-pack/SKILL.md`。
- 当任务涉及 **vue2-to-arkui-direction-pack** 时，调用 `../pm-b18-vue2-to-arkui-direction-pack/SKILL.md`。
- 当任务涉及 **vue2-to-flutter-direction-pack** 时，调用 `../pm-b18-vue2-to-flutter-direction-pack/SKILL.md`。
- 当任务涉及 **vue3-to-vue2-direction-pack** 时，调用 `../pm-b18-vue3-to-vue2-direction-pack/SKILL.md`。
- 当任务涉及 **vue3-to-react-direction-pack** 时，调用 `../pm-b18-vue3-to-react-direction-pack/SKILL.md`。
- 当任务涉及 **vue3-to-wechat-miniprogram-direction-pack** 时，调用 `../pm-b18-vue3-to-wechat-miniprogram-direction-pack/SKILL.md`。
- 当任务涉及 **vue3-to-arkui-direction-pack** 时，调用 `../pm-b18-vue3-to-arkui-direction-pack/SKILL.md`。
- 当任务涉及 **vue3-to-flutter-direction-pack** 时，调用 `../pm-b18-vue3-to-flutter-direction-pack/SKILL.md`。
- 当任务涉及 **react-to-vue2-direction-pack** 时，调用 `../pm-b18-react-to-vue2-direction-pack/SKILL.md`。
- 当任务涉及 **react-to-vue3-direction-pack** 时，调用 `../pm-b18-react-to-vue3-direction-pack/SKILL.md`。
- 当任务涉及 **react-to-wechat-miniprogram-direction-pack** 时，调用 `../pm-b18-react-to-wechat-miniprogram-direction-pack/SKILL.md`。
- 当任务涉及 **react-to-arkui-direction-pack** 时，调用 `../pm-b18-react-to-arkui-direction-pack/SKILL.md`。
- 当任务涉及 **react-to-flutter-direction-pack** 时，调用 `../pm-b18-react-to-flutter-direction-pack/SKILL.md`。
- 当任务涉及 **wechat-miniprogram-to-vue2-direction-pack** 时，调用 `../pm-b18-wechat-miniprogram-to-vue2-direction-pack/SKILL.md`。
- 当任务涉及 **wechat-miniprogram-to-vue3-direction-pack** 时，调用 `../pm-b18-wechat-miniprogram-to-vue3-direction-pack/SKILL.md`。
- 当任务涉及 **wechat-miniprogram-to-react-direction-pack** 时，调用 `../pm-b18-wechat-miniprogram-to-react-direction-pack/SKILL.md`。
- 当任务涉及 **wechat-miniprogram-to-arkui-direction-pack** 时，调用 `../pm-b18-wechat-miniprogram-to-arkui-direction-pack/SKILL.md`。
- 当任务涉及 **wechat-miniprogram-to-flutter-direction-pack** 时，调用 `../pm-b18-wechat-miniprogram-to-flutter-direction-pack/SKILL.md`。
- 当任务涉及 **arkui-to-vue2-direction-pack** 时，调用 `../pm-b18-arkui-to-vue2-direction-pack/SKILL.md`。
- 当任务涉及 **arkui-to-vue3-direction-pack** 时，调用 `../pm-b18-arkui-to-vue3-direction-pack/SKILL.md`。
- 当任务涉及 **arkui-to-react-direction-pack** 时，调用 `../pm-b18-arkui-to-react-direction-pack/SKILL.md`。
- 当任务涉及 **arkui-to-wechat-miniprogram-direction-pack** 时，调用 `../pm-b18-arkui-to-wechat-miniprogram-direction-pack/SKILL.md`。
- 当任务涉及 **arkui-to-flutter-direction-pack** 时，调用 `../pm-b18-arkui-to-flutter-direction-pack/SKILL.md`。
- 当任务涉及 **flutter-to-vue2-direction-pack** 时，调用 `../pm-b18-flutter-to-vue2-direction-pack/SKILL.md`。
- 当任务涉及 **flutter-to-vue3-direction-pack** 时，调用 `../pm-b18-flutter-to-vue3-direction-pack/SKILL.md`。
- 当任务涉及 **flutter-to-react-direction-pack** 时，调用 `../pm-b18-flutter-to-react-direction-pack/SKILL.md`。
- 当任务涉及 **flutter-to-wechat-miniprogram-direction-pack** 时，调用 `../pm-b18-flutter-to-wechat-miniprogram-direction-pack/SKILL.md`。
- 当任务涉及 **flutter-to-arkui-direction-pack** 时，调用 `../pm-b18-flutter-to-arkui-direction-pack/SKILL.md`。
- 当任务涉及 **javascript-to-typescript-modernization-pack** 时，调用 `../pm-b18-javascript-to-typescript-modernization-pack/SKILL.md`。
- 当任务涉及 **react-class-to-hooks-modernization-pack** 时，调用 `../pm-b18-react-class-to-hooks-modernization-pack/SKILL.md`。
