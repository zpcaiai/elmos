---
name: "elmos-verified-core-generator"
description: "为金额、额度、权限、状态机、调度和转换算法生成 Dafny/JML/Lean 可验证核心及语言适配层。 Use when the task needs the exact Verified Core Generator Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P1/elmos-verified-core-generator/SKILL.md"
  source_sha256: "sha256:2e80f3dde2567de743b92a3782e4f237d61ac78ad0672a7f4247b662dbd4ace4"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P1"
  domain: "project-generation"
  runtime_handler_id: "execute_elmos_verified_core_generator"
...
---
# Verified Core Generator

## Repository integration boundary

- Exact Skill identity: `elmos-verified-core-generator`; exact allowlisted runtime handler: `execute_elmos_verified_core_generator`.
- Source identity: `skills/P1/elmos-verified-core-generator/SKILL.md` at `sha256:2e80f3dde2567de743b92a3782e4f237d61ac78ad0672a7f4247b662dbd4ace4` from `elmos-formal-assurance-kernel-v1.0.0`.
...
为金额、额度、权限、状态机、调度和转换算法生成 Dafny/JML/Lean 可验证核心及语言适配层。
...
3. Use the repository-owned `execute_elmos_verified_core_generator` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["correct-by-construction code","contract extraction","refinement wrappers","proof-aware code generation"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P1/elmos-verified-core-generator/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
