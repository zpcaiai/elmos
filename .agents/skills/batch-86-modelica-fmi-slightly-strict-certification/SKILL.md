---
name: batch-86-modelica-fmi-slightly-strict-certification
description: "Run the exact ELMOS Batch 81-95 slightly-strict Modelica FMI Digital Twin Certification tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T086"
  source_name: "batch-86-modelica-fmi-slightly-strict-certification"
  source_sha256: "sha256:188944e0bc7a96677e57b5471a0065324097f71698afe85858afe5adf86a0e8b"
  source_kind: "batch"
  source_batch: "86"
...
# T086 — Modelica FMI Digital Twin Certification

## 1. Objective

Slightly strict certification for Batch 86 Modelica FMI Digital Twin Certification.
...
- `CASE-0131` [CRITICAL] Direct verification: PG283 modelica library discovery and inventory
- `CASE-0132` [HIGH] Direct verification: PG284 modelica parser and equation graph
- `CASE-0133` [HIGH] Direct verification: PG285 physical component connector modeler
- `CASE-0134` [MEDIUM] Direct verification: PG286 unit dimension consistency verifier
- `CASE-0135` [CRITICAL] Direct verification: PG287 initial equation event solver analyzer
- `CASE-0136` [HIGH] Direct verification: PG288 modelica system model generator
- `CASE-0137` [HIGH] Direct verification: PG289 fmi fmu export import adapter
- `CASE-0138` [MEDIUM] Direct verification: PG290 co simulation orchestrator
- `CASE-0139` [CRITICAL] Direct verification: PG291 parameter estimation calibration engine
- `CASE-0140` [HIGH] Direct verification: PG292 simulation regression verifier
- `CASE-0141` [HIGH] Direct verification: PG293 telemetry model drift detector
- `CASE-0142` [MEDIUM] Direct verification: PG294 digital twin runtime certifier
- `CASE-0143` [CRITICAL] Reject underdetermined, overdetermined, structurally singular or causally invalid models
- `CASE-0144` [HIGH] Inject incompatible physical units and connector dimensions; compilation must fail with traceable diagnostics
- `CASE-0145` [HIGH] Exercise initial equations, state selection, zero crossings, event iteration and chattering limits
- `CASE-0146` [CRITICAL] Validate FMI causality, variability, state serialization and parameter mutability across import/export
- `CASE-0147` [HIGH] Sweep communication step sizes and master algorithms to expose unstable or divergent co-simulation
- `CASE-0148` [CRITICAL] Replay telemetry drift and prove calibration/version changes are detected, reviewed and reversible
- `CASE-0149` [HIGH] Representative certified success path
- `CASE-0150` [HIGH] Boundary and moderate scale
- `CASE-0151` [HIGH] Invalid and conflicting input
- `CASE-0152` [HIGH] Dependency failure and recovery
- `CASE-0153` [CRITICAL] Security and isolation
- `CASE-0154` [HIGH] Replay and idempotency
- `CASE-0155` [HIGH] Toolchain and version drift
- `CASE-0156` [CRITICAL] Evidence tamper and anti-fraud
