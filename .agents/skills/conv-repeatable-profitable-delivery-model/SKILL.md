...
验证标准Scope、人员结构、单位成本、报价、毛利、周期和风险准备金可复制。
...
- 交付模型必须证明单位成本、毛利、周期、返工、专家瓶颈和风险准备金可预测。
...
- `product/economics/reference-delivery/`
- `contracts/commercial/unit-economics.schema.json`
