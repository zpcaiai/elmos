...
- Invoke this repository Skill as `$pm-b39-complete-project-generation`.
- Immutable source identity: `batch-39-complete-project-generation` in `precision-migration-b01-44` (B39).
- Runtime adapter: `skill-and-project-synthesis`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b39-complete-project-generation`.
...
- 当任务涉及 **complete-project-manifest** 时，调用 `../pm-b39-complete-project-manifest/SKILL.md`。
- 当任务涉及 **repository-template-registry** 时，调用 `../pm-b39-repository-template-registry/SKILL.md`。
- 当任务涉及 **architecture-blueprint-generator** 时，调用 `../pm-b39-architecture-blueprint-generator/SKILL.md`。
- 当任务涉及 **frontend-generator** 时，调用 `../pm-b39-frontend-generator/SKILL.md`。
- 当任务涉及 **backend-generator** 时，调用 `../pm-b39-backend-generator/SKILL.md`。
- 当任务涉及 **admin-generator** 时，调用 `../pm-b39-admin-generator/SKILL.md`。
- 当任务涉及 **database-generator** 时，调用 `../pm-b39-database-generator/SKILL.md`。
- 当任务涉及 **worker-and-scheduler-generator** 时，调用 `../pm-b39-worker-and-scheduler-generator/SKILL.md`。
- 当任务涉及 **security-crosscutting-generator** 时，调用 `../pm-b39-security-crosscutting-generator/SKILL.md`。
- 当任务涉及 **observability-generator** 时，调用 `../pm-b39-observability-generator/SKILL.md`。
- 当任务涉及 **ci-cd-generator** 时，调用 `../pm-b39-ci-cd-generator/SKILL.md`。
- 当任务涉及 **deployment-generator** 时，调用 `../pm-b39-deployment-generator/SKILL.md`。
- 当任务涉及 **documentation-and-runbook-generator** 时，调用 `../pm-b39-documentation-and-runbook-generator/SKILL.md`。
- 当任务涉及 **project-completeness-score** 时，调用 `../pm-b39-project-completeness-score/SKILL.md`。
