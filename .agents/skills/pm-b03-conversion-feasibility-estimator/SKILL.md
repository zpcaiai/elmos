...
- Invoke this repository Skill as `$pm-b03-conversion-feasibility-estimator`.
- Immutable source identity: `conversion-feasibility-estimator` in `precision-migration-b01-44` (B03).
- Runtime adapter: `assessment-and-target-planning`; binding state: `UNAVAILABLE`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b03-conversion-feasibility-estimator`.
