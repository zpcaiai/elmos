...
## Objective
Correlate static code entities with traces, logs, metrics, DB calls, queues, RPCs and exceptions to reduce false semantic assumptions.

## Inspirations
- OpenTelemetry

## Activation conditions
- Activate when the task requires: correlate static code entities with traces, logs, metrics, DB calls, queues, RPCs and exceptions to reduce false semantic assumptions.
