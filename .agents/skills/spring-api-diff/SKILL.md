...
description: 比较 status、headers、body 语义、validation、error shape 和 OpenAPI。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-058
  source_name: spring-api-diff
  source_path: skills/spring-api-diff/SKILL.md
  source_sha256: sha256:1e46cf7b6a97116ee86a4eb6b280627398ee8a5a29a1f7839891325395fc3971
  source_contract_sha256: sha256:71b2d191068d22a0f1b9dce04e468f2419f7fa59d2692893608ce907f76aa807
...
比较 status、headers、body 语义、validation、error shape 和 OpenAPI。

## Scope and capabilities

- Normalization/tolerance DSL
...
- api-diff-results.json
- api-regressions.json
...
- [ ] 定义 `spring-api-diff` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-api-diff` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：api-diff-results.json, api-regressions.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：api-diff-results.json, api-regressions.json。
...
- Machine contract: `references/contract.json` (`sha256:71b2d191068d22a0f1b9dce04e468f2419f7fa59d2692893608ce907f76aa807`).
