---
name: b85-matlab-coder-embedded-code-generator
description: "Use when ELMOS must run matlab coder embedded code generator for Batch 85 MATLAB / Simulink / Stateflow Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG279"
  source_name: "matlab-coder-embedded-code-generator"
  source_sha256: "sha256:5e7cf394e8d9e08cc00c354be5ed382453967aeffa87c88ce3708dcc58fb5b55"
  batch: 85
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 85 Language Pack / source PG279 — Matlab Coder Embedded Code Generator

## 1. Objective

Generate matlab coder embedded code generator within the MATLAB / Simulink / Stateflow Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Matlab Coder Embedded Code Generator using the approved model-based-engineering semantic contracts and toolchain versions.
...
- A representative valid matlab-simulink input produces all declared outputs for matlab-coder-embedded-code-generator.
