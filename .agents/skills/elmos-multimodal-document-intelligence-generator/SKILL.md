---
name: elmos-multimodal-document-intelligence-generator
description: Generate document ingestion systems for text, layout, tables, figures, scans, audio and video with typed provenance
  and quality-aware retrieval artifacts.
version: 4.0.0
...
# Multimodal Document Intelligence Generator
...
- `DeploymentUnit`
- `ConformanceRun`
- `MultimodalDocumentIntelligenceGeneratorRun`
- `MultimodalDocumentIntelligenceGeneratorDecision`

Required semantic capabilities:

- Parser/OCR/model capability routing
- Layout/table/figure semantic graph
- Page/time-range source mapping
- Quality confidence and human review
- Multimodal embedding and citation
...
- **OCR prompt injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hidden layer mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **table cell shift** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **malicious media payload** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fabricated multimodal citation** — must have a preventive control, a detective signal, a negative fixture and a response action.
