---
name: "autonomous-qa-28-quality-gate-release-certification"
description: "Run 28-quality-gate-release-certification through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "28-quality-gate-release-certification"
  source_sha256: "sha256:a0a686fd495e75b85686dc4747264ff83e31fae442e6be72cf5297771c90e099"
  source_dependencies: "26-impact-analysis-regression"
  ...
  runtime_skill_key: "28-quality-gate-release-certification"
  runtime_handler: "execute_28_quality_gate_release_certification"
  runtime_phase: "gate"
  runtime_mutating: "false"
  runtime_operation: "elmos_autonomous_qa.gates.evaluate_quality_gate_contract"
...
1. Accept only a structured request for the exact Skill key `28-quality-gate-release-certification`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_28_quality_gate_release_certification` and operation `elmos_autonomous_qa.gates.evaluate_quality_gate_contract`.
...
- Immutable source: `skills/28-quality-gate-release-certification/SKILL.md` at `sha256:a0a686fd495e75b85686dc4747264ff83e31fae442e6be72cf5297771c90e099`.
- Exact runtime phase is `gate`; mutating declaration is `false`.
