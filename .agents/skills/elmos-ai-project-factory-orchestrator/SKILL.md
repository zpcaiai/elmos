---
name: elmos-ai-project-factory-orchestrator
description: Compile a business goal or existing AI repository into a governed, resumable, multi-target generation program
  with explicit proof obligations and release gates.
version: 4.0.0
...
- **Kernel authorities used:** K1, K4, K7, K8
...
- Bind every run to exact Goal and RevisionSet
- Compile durable control state and terminal semantics
- Enforce fail-closed gates and independent completion authority
- Expose pause/resume/cancel/replan with auditable events
...
- **goal/revision substitution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ghost completion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale worker write** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **status inflation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unauthorized control transition** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- AiProjectFactoryOrchestrator representative end-to-end fixture
