---
name: b44-resource-metering
description: "Implement and verify Batch 44 Skill 1457 for resource metering. Use when work requires Runner\u3001\u6a21\u578b\u3001\u5b58\u50a8\u548c\u7f51\u7edcMetering, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Runner、模型、存储和网络Metering
...
## Skill 1457: Runner、模型、存储和网络Metering
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b44-resource-metering`.
...
4. Implement the smallest production-shaped capability that exercises `Runner、模型、存储和网络Metering` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b44-resource-metering`
