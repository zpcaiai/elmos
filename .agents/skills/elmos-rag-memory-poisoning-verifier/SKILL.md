---
name: elmos-rag-memory-poisoning-verifier
description: Detect and contain malicious documents, cross-tenant contamination, memory poisoning, citation laundering, stale
  facts and deletion failures.
version: 4.0.0
...
# RAG and Memory Poisoning Verifier
...
- `Approval`
- `ResidualRisk`
- `RAGAndMemoryPoisoningVerifierRun`
- `RAGAndMemoryPoisoningVerifierDecision`

Required semantic capabilities:

- Indirect prompt injection corpus
- Tenant/ACL namespace isolation
- Memory write provenance and trust scoring
- Temporal conflict and stale-fact handling
- Deletion/tombstone and citation integrity verification
...
- `poisoning-campaign-results.json`
- `memory-quarantine-plan.json`
- `citation-integrity-report.json`
- `deletion-recall-proof.json`
...
- **persistent prompt injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **vector namespace bleed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **false authority memory** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **citation forgery** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deleted data resurrection** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- stale fact precedence
- citation laundering
- deletion recall zero
