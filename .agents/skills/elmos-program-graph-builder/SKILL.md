---
name: "elmos-program-graph-builder"
description: "Invoke the bounded repository handler for elmos-program-graph-builder while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P02:program-graph-builder"
  source_name: "elmos-program-graph-builder"
  installed_name: "elmos-program-graph-builder"
  source_logical_path: "02-elmos-repository-intelligence-semantic-ir/skills/program-graph-builder/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/02-elmos-repository-intelligence-semantic-ir/skills/program-graph-builder/SKILL.md.source-data"
  source_materialized_path: "02-elmos-repository-intelligence-semantic-ir/skills/program-graph-builder/SKILL.md.source-data"
  source_sha256: "sha256:279e36362674318ee93db8b0e18fcc8eb25a76da137ebe5323d32cc2c0d6e534"
...
- This is a deterministic repository wrapper for `02-elmos-repository-intelligence-semantic-ir/skills/program-graph-builder/SKILL.md` at `sha256:279e36362674318ee93db8b0e18fcc8eb25a76da137ebe5323d32cc2c0d6e534`.
- Its immutable source/runtime identity is `elmos-program-graph-builder`; its active installed identity is `elmos-program-graph-builder`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-program-graph-builder --request <file>
```
