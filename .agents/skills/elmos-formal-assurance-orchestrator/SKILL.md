---
name: "elmos-formal-assurance-orchestrator"
description: "执行证明 DAG，管理配额、并发、超时、暂停恢复、重试、证据提交和失败隔离，是形式化可信层的控制平面。 Use when the task needs the exact Formal Assurance Orchestrator Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-formal-assurance-orchestrator/SKILL.md"
  source_sha256: "sha256:e7fc782757aed8d6f6694f76f655edbe4a582c73d6fbc04a1fe1e7fa8bce4aa2"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "core"
  runtime_handler_id: "execute_elmos_formal_assurance_orchestrator"
  capability_state: "CODE_COMPLETE_LOCAL_RUNTIME"
  implementation_state: "PRODUCTION_CODE_COMPLETE"
  acceptance_criterion_count: "9"
  local_execution_evidence: "LOCAL_EXECUTED_SELF_ATTESTED"
  external_evidence_status: "NOT_RUN"
  certification_status: "NOT_CERTIFIED"
---
# Formal Assurance Orchestrator

## Repository integration boundary

- Exact Skill identity: `elmos-formal-assurance-orchestrator`; exact allowlisted runtime handler: `execute_elmos_formal_assurance_orchestrator`.
- Source identity: `skills/P0/elmos-formal-assurance-orchestrator/SKILL.md` at `sha256:e7fc782757aed8d6f6694f76f655edbe4a582c73d6fbc04a1fe1e7fa8bce4aa2` from `elmos-formal-assurance-kernel-v1.0.0`.
...
执行证明 DAG，管理配额、并发、超时、暂停恢复、重试、证据提交和失败隔离，是形式化可信层的控制平面。
...
3. Use the repository-owned `execute_elmos_formal_assurance_orchestrator` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["durable workflow","idempotent execution","lease/fencing","evidence commit protocol"]`
- Direct dependencies: `["elmos-proof-obligation-planner","elmos-proof-status-policy","elmos-verifier-portfolio-router","elmos-proof-cache-invalidation","elmos-formal-model-versioning"]`
- Source acceptance criteria: `9`; local controls are traceable, while external and independent acceptance evidence remains `NOT_RUN`.
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-formal-assurance-orchestrator/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
