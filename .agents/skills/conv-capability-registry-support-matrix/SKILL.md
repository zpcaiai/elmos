...
# CONV-008：统一Capability Registry与支持矩阵

## Objective

向产品、客户和Codex提供唯一可信的能力、版本、支持状态和限制来源。
...
- 所有Capability Pack
- Certification、Version和Owner数据

## Required outputs

- `capability-registry.schema.json`
- `product-convergence/capability-registry.json`
- Support查询API

## Workflow

1. 注册所有产品内核和Pack能力。
2. 统一certified/supported/conditional/experimental/detected-only/blocked。
3. 绑定精确版本与Evidence。
4. 实现搜索、过滤和依赖解析。
5. 向UI、CLI和报价系统提供同一事实。
