---
name: spring-assessment-sku
description: 将仓库 Profile、Baseline、Eligibility、风险、路线、ETA 和报价选项包装为固定范围付费产品。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-081
  source_name: spring-assessment-sku
  source_path: skills/spring-assessment-sku/SKILL.md
  source_sha256: sha256:626ce3b896f421d93145a47aa875ee20289f448eb9fcb90414e8fd1d043af71f
  source_contract_sha256: sha256:48ba455082f407fd5e88f977d4fafae029d472507fb2605e68eda4ab28638153
...
将仓库 Profile、Baseline、Eligibility、风险、路线、ETA 和报价选项包装为固定范围付费产品。
...
- [ ] 定义 `spring-assessment-sku` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-assessment-sku` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：assessment-package, pilot-quote.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：assessment-package, pilot-quote.json。
- [ ] 所有 mandatory tests 和 security gates 通过，且无 critical unknown。

## Dependencies

- `spring-assessment-report`
...
- Machine contract: `references/contract.json` (`sha256:48ba455082f407fd5e88f977d4fafae029d472507fb2605e68eda4ab28638153`).
