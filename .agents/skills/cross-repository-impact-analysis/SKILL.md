...
description: "Repository-owned bounded wrapper for cross-repository-impact-analysis; external evidence remains NOT_RUN."
---
...
Compute transitive blast radius across services, libraries, schemas, contracts, packages and repositories before applying changes.
...
4. Submit `cross-repository-impact-analysis` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `627dcc72b68ae11805ade56d22d98f13a5131732d29ae859622f104b686c72a1`
