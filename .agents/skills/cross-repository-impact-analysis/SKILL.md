...
- Activate when the task requires: compute transitive blast radius across services, libraries, schemas, contracts, packages and repositories before applying changes.
