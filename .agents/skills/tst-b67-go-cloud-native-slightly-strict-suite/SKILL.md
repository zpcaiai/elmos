---
name: tst-b67-go-cloud-native-slightly-strict-suite
description: "Run the slightly strict test suite for Batch 67: Go Cloud-Native, covering every source Skill with positive and negative executable cases."
metadata:
  id: TB67
...
---
    # TB67 — Batch 67 Go Cloud-Native 略严苛测试套件

    ## Objective

    对 Batch 67 的全部 12 个Source Skills执行可重放的正向、边界、负向、故障、安全和证据完整性验证。范围为：Go modules、HTTP/gRPC、CLI、Worker、并发、Operator、MCP 与交叉编译。
    ...
    |---|---|---|---|
    | PG235 | `b67-go-repository-profile-detector` | detector | `B67-PG235-RUN, B67-PG235-NEG` |
| PG236 | `b67-go-module-workspace-reproducer` | reproducer | `B67-PG236-RUN, B67-PG236-NEG` |
| PG237 | `b67-go-http-grpc-service-generator` | contract | `B67-PG237-RUN, B67-PG237-NEG` |
| PG238 | `b67-go-cli-generator` | generator | `B67-PG238-RUN, B67-PG238-NEG` |
| PG239 | `b67-go-worker-event-consumer-generator` | concurrency | `B67-PG239-RUN, B67-PG239-NEG` |
| PG240 | `b67-go-data-access-transaction-generator` | data | `B67-PG240-RUN, B67-PG240-NEG` |
| PG241 | `b67-go-concurrency-context-safety` | concurrency | `B67-PG241-RUN, B67-PG241-NEG` |
| PG242 | `b67-go-observability-middleware-generator` | native | `B67-PG242-RUN, B67-PG242-NEG` |
| PG243 | `b67-go-kubernetes-operator-generator` | iac | `B67-PG243-RUN, B67-PG243-NEG` |
| PG244 | `b67-go-mcp-tool-server-generator` | generator | `B67-PG244-RUN, B67-PG244-NEG` |
| PG245 | `b67-go-test-fuzz-race-generator` | concurrency | `B67-PG245-RUN, B67-PG245-NEG` |
| PG246 | `b67-go-build-crosscompile-certifier` | build | `B67-PG246-RUN, B67-PG246-NEG` |
