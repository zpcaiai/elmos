---
name: elmos-ai-model-routing-fallback-generator
description: Generate policy-driven model/provider routing, fallback, hedging, retry, rate-limit, structured-output and budget
  controls with data-handling constraints.
version: 4.0.0
...
# AIModelRoutingFallbackGenerator
...
- **Kernel authorities used:** K4, K5, K6, K7
...
- AiModelRoutingFallbackGenerator representative end-to-end fixture
