...
description: "Run the exact ELMOS Batch 81-95 slightly-strict Batch 81–95 Final Release Certification tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T120"
  source_name: "final-release-certification"
  source_sha256: "sha256:e4ef16dc3099afea8d1bd1b65f76e7dc86d6494762cbcd8c6f81865e2d67b898"
...
# T120 — Batch 81–95 Final Release Certification

## 1. Objective

Apply non-compensating release criteria across all batch and cross-platform gates.
...
- `CASE-0631` [HIGH] Batch 81–95 Final Release Certification: Representative path
- `CASE-0632` [HIGH] Batch 81–95 Final Release Certification: Boundary path
- `CASE-0633` [HIGH] Batch 81–95 Final Release Certification: Invalid or hostile input
- `CASE-0634` [HIGH] Batch 81–95 Final Release Certification: Injected dependency failure
- `CASE-0635` [CRITICAL] Batch 81–95 Final Release Certification: Security or safety violation
- `CASE-0636` [HIGH] Batch 81–95 Final Release Certification: Replay and idempotency
- `CASE-0637` [HIGH] Batch 81–95 Final Release Certification: Version or environment drift
- `CASE-0638` [MEDIUM] Batch 81–95 Final Release Certification: Moderate scale
- `CASE-0639` [CRITICAL] Batch 81–95 Final Release Certification: Evidence tamper
- `CASE-0640` [HIGH] Batch 81–95 Final Release Certification: Recovery and final evidence
