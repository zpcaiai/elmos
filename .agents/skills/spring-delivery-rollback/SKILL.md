---
name: spring-delivery-rollback
description: 定义 PR、镜像、Migration、Runbook、Evidence、回滚演练和客户接管。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-016
  source_name: spring-delivery-rollback
  source_path: skills/spring-delivery-rollback/SKILL.md
  source_sha256: sha256:aead6ca7b60ff8a7d24f8ce10cf1e4439c3fd4d3346818b9d1ba90cca027d93d
  source_contract_sha256: sha256:f380086a675fb839b6f7a84d609ca81f660bb5ac2e850a74143de6ff54cae714
...
# Delivery & Rollback Contract

## Objective

定义 PR、镜像、Migration、Runbook、Evidence、回滚演练和客户接管。

## Scope and capabilities

- 冻结交付 commit
- SBOM/manifest/hash/signature
- staging deployment
- rollback rehearsal
...
- [ ] 定义 `spring-delivery-rollback` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-delivery-rollback` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：delivery-bundle.zip, rollback-package, handoff-report.md。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：delivery-bundle.zip, rollback-package, handoff-report.md。
...
- Machine contract: `references/contract.json` (`sha256:f380086a675fb839b6f7a84d609ca81f660bb5ac2e850a74143de6ff54cae714`).
