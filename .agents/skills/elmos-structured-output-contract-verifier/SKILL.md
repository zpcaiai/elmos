---
name: elmos-structured-output-contract-verifier
description: Verify model and framework structured outputs against exact schemas, semantic constraints, evolution rules, repair
  bounds and adversarial malformed cases.
version: 4.0.0
...
# Structured Output Contract Verifier
...
- `DeploymentUnit`
- `ConformanceRun`
- `StructuredOutputContractVerifierRun`
- `StructuredOutputContractVerifierDecision`

Required semantic capabilities:

- JSON Schema and typed model validation
- Semantic cross-field invariants
- Strict versus repairable parse policy
- Schema evolution compatibility
- Malformed/adversarial output corpus
...
- `structured-output-results.json`
...
- **schema bypass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **repair hides semantic error** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **type confusion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **oversized payload** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **downstream injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
