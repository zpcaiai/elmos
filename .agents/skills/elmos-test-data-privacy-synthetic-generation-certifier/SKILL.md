---
name: elmos-test-data-privacy-synthetic-generation-certifier
description: Generate representative synthetic/subset data with privacy guarantees, referential integrity, rare-case coverage and measured fidelity.
version: 4.0.0
...
# Test Data Privacy and Synthetic Generation Certifier
...
- `TestDataPrivacyAndSyntheticGenerationCertifierProfile`
- `TestDataPrivacyAndSyntheticGenerationCertifierPlan`
- `TestDataPrivacyAndSyntheticGenerationCertifierRun`
- `TestDataPrivacyAndSyntheticGenerationCertifierDecision`

Required semantic capabilities:

- classify production data use constraints
- generate synthetic relational and event histories
- preserve key distributions and edge cases
- measure privacy attack and fidelity metrics
- version and expire data sets
...
- `elmos-test-fixture-data-factory` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-test-data-privacy-synthetic-generation-certifier/profile.yaml`
- `artifacts/elmos-test-data-privacy-synthetic-generation-certifier/plan.json`
- `artifacts/elmos-test-data-privacy-synthetic-generation-certifier/result.json`
- `artifacts/elmos-test-data-privacy-synthetic-generation-certifier/evidence/`
...
- **synthetic rows reproduce real individual** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rare group erased** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **referential integrity fabricated incorrectly** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generator trained on unauthorized data** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fidelity metric hides business invariant loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify production data use constraints
- native scenario: generate synthetic relational and event histories
- native scenario: preserve key distributions and edge cases
- native scenario: measure privacy attack and fidelity metrics
- native scenario: version and expire data sets
