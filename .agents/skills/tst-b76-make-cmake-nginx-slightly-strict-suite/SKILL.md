---
name: tst-b76-make-cmake-nginx-slightly-strict-suite
description: "Run the slightly strict test suite for Batch 76: Make CMake and Nginx, covering every source Skill with positive and negative executable cases."
metadata:
  id: TB76
...
---
    # TB76 — Batch 76 Make CMake and Nginx 略严苛测试套件

    ## Objective

    对 Batch 76 的全部 12 个Source Skills执行可重放的正向、边界、负向、故障、安全和证据完整性验证。范围为：Makefile、CMake、Nginx、反向代理、TLS、限流与可观测性。
    ...
    |---|---|---|---|
    | PG351 | `b76-makefile-profile-detector` | detector | `B76-PG351-RUN, B76-PG351-NEG` |
| PG352 | `b76-portable-makefile-generator` | build | `B76-PG352-RUN, B76-PG352-NEG` |
| PG353 | `b76-make-incremental-dependency-manager` | build | `B76-PG353-RUN, B76-PG353-NEG` |
| PG354 | `b76-make-test-release-orchestrator` | build | `B76-PG354-RUN, B76-PG354-NEG` |
| PG355 | `b76-cmake-profile-detector` | detector | `B76-PG355-RUN, B76-PG355-NEG` |
| PG356 | `b76-cmake-target-graph-generator` | build | `B76-PG356-RUN, B76-PG356-NEG` |
| PG357 | `b76-cmake-dependency-package-manager` | build | `B76-PG357-RUN, B76-PG357-NEG` |
| PG358 | `b76-cmake-presets-crossbuild-manager` | build | `B76-PG358-RUN, B76-PG358-NEG` |
| PG359 | `b76-nginx-topology-profile-detector` | detector | `B76-PG359-RUN, B76-PG359-NEG` |
| PG360 | `b76-nginx-reverse-proxy-generator` | proxy | `B76-PG360-RUN, B76-PG360-NEG` |
| PG361 | `b76-nginx-tls-security-rate-limit` | proxy | `B76-PG361-RUN, B76-PG361-NEG` |
| PG362 | `b76-build-proxy-configuration-certifier` | proxy | `B76-PG362-RUN, B76-PG362-NEG` |
