---
name: dense-partial-credit-reward
description: Use this skill when Elmos must perform dense partial credit reward as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# dense-partial-credit-reward

## 能力目标

使用测试子集、覆盖、编译进度和不变量满足度提供稠密奖励。
