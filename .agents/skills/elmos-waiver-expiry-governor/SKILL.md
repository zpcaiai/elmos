---
name: elmos-waiver-expiry-governor
description: Control exceptional waivers with explicit claim scope, rationale, compensating controls, owner, approvals, expiry and automatic certificate impact.
version: 4.0.0
...
- Require bounded claim and evidence-backed rationale
- Enforce role/dual approval by risk
- Bind compensating monitoring and remediation
- Set non-optional expiry and owner
- Revoke or narrow certificate on expiry
...
- `waiver-expiry-events.jsonl`
- `waiver-certificate-impact.json`
...
- **permanent blanket waiver** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **approver conflict of interest** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **waiver applied to wrong revision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **monitoring disabled** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **expiry silently extended** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- low-risk waiver
- critical waiver dual approval
- missing expiry rejected
- compensating control failure
- expiry revokes claim
- waiver transfer denied
