...
# AI Controllability, Override and Fail-Safe Certifier
...
- `AIControllabilityOverrideAndFailSafeCertifierProfile`
- `AIControllabilityOverrideAndFailSafeCertifierRun`
- `AIControllabilityOverrideAndFailSafeCertifierFinding`
- `AIControllabilityOverrideAndFailSafeCertifierDecision`
- `AIControllabilityOverrideAndFailSafeCertifierEvidence`

Required semantic capabilities:

- verify bounded autonomy, stop, pause, rollback, safe state and authority revocation
- test control under latency, partial failure and adversarial agent behavior
- measure time-to-intervention and residual side effects
...
- `elmos-ai-runaway-loop-economic-dos-guard` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-ai-controllability-override-fail-safe-certifier/profile.yaml`
- `artifacts/elmos-ai-controllability-override-fail-safe-certifier/plan.json`
- `artifacts/elmos-ai-controllability-override-fail-safe-certifier/result.json`
- `artifacts/elmos-ai-controllability-override-fail-safe-certifier/evidence/`
- `artifacts/elmos-ai-controllability-override-fail-safe-certifier/assurance-case.json`
...
- **kill switch depends on failed control plane** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **override is ignored by delegated subagent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **safe state still performs external writes** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: verify bounded autonomy, stop, pause, rollback, safe state and authority revocation
- native scenario: test control under latency, partial failure and adversarial agent behavior
- native scenario: measure time-to-intervention and residual side effects
