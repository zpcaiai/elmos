...
version: 1.0.0
skill_id: ELMOS-POLY-252
layer: corpus-metrics
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-grammar-feature-coverage`."
  - "Use when a migration/certification DAG requires `corpus-metrics` capability."
outputs:
  - "semantic-assurance/elmos-grammar-feature-coverage/model.json"
  - "semantic-assurance/elmos-grammar-feature-coverage/evidence.json"
  - "semantic-assurance/elmos-grammar-feature-coverage/diagnostics.json"
---

# Grammar Feature Coverage Analyzer

## Objective

Measure parser/converter coverage over grammar productions, dialect extensions and syntactic combinations rather than file count.
...
- [ ] coverage denominator stable.
- [ ] uncovered critical production listed.
- [ ] pairwise syntax combinations.
