---
name: elmos-open-source-license-ip-compliance-certifier
description: Certify software, model, dataset, prompt, generated asset and documentation licensing, attribution, redistribution and policy compatibility.
version: 4.0.0
...
# Open Source, Model, Data and IP Compliance Certifier
...
- Inventory software/model/data/content licenses
- Evaluate inbound/outbound compatibility
- Generate notices and source obligations
- Track generated-code provenance and customer restrictions
- Block unknown or prohibited licensing
...
- `license-inventory.spdx.json`
- `license-policy-results.json`
- `attribution-bundle/`
- `ip-residual-risk.json`
...
- **license metadata forged** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **transitive license omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **internal use assumption applied to SaaS** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **model output terms ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer code enters shared training corpus** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- copyleft distribution path
- model usage restriction
- dataset redistribution restriction
- generated asset attribution
