---
name: elmos-repository-semantic-intelligence
description: "Build bounded, provenance-bearing repository semantic models."
---
...
Use the exact repository-owned PDHI v1 `K1` boundary for the
...
2. Resolve this Skill through `SKILL_REGISTRY`; resolve capability operations
   only through `CAPABILITY_REGISTRY` and the exact owner `K1`.
...
- Registry identity: `PDHI-V1-002`
- Kind/owner: `kernel` / `K1`
- Source member: `10-semantic-intelligence/SKILL.md`
- Source member SHA-256: `sha256:7a12b4416213bdb594254afaf8b20617eac6d0287099835184294c90756662bc`
- Engine: `engines/proof-driven-harness-intelligence-engine/src/elmos_pdhi/semantic.py`
- Runtime: `elmos_pdhi.semantic.SemanticRuntime`
- Exact binding registry: `K1_OPERATION_SPECS`
- Source capability occurrences: `12`
