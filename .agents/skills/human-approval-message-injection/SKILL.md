---
name: human-approval-message-injection
version: 1.0.0
priority: P1
...
## Objective
Allow safe human intervention, approval, correction and policy escalation while a long-running agent session is active.

## Inspirations
- Microsoft Agent Framework

## Activation conditions
- Activate when the task requires: allow safe human intervention, approval, correction and policy escalation while a long-running agent session is active.
