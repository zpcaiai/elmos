---
name: repository-knowledge-precompute
description: 在 Agent 之前预计算仓库结构化知识，减少逐文件探索。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: FOUNDATION-05-repository-knowledge-precompute
  source_name: repository-knowledge-precompute
  source_path: skills/repository-knowledge-precompute/SKILL.md
  source_sha256: sha256:3012c0992d0e7cc75ce17915eae7c3a384b12dc2f29f479f7bf000a8aa6a0b92
  source_contract_sha256: sha256:edb7ca3e064111f1b26d8bab51d93dc4d0c843621a02e8ba95de9d45d5221b74
...
# Repository Knowledge Precompute

## Goal

在 Agent 之前预计算仓库结构化知识，减少逐文件探索。

## Use when

在 Elmos 需要实现或升级 **Repository Knowledge Precompute** 相关能力时使用；它不是仅供解释的提示词，而是实现、测试与验收契约。

## Capabilities to implement

- 生成 architecture/dependency/library/error/test/method 等索引
- 索引按 Git tree/文件 hash 增量更新
- Agent 优先查询结构化上下文，源码仅作按需下钻
- 所有预计算结果带生成器版本和 provenance
...
- [ ] 定义 `repository-knowledge-precompute` 的 public interface、input/output/error schemas。
- [ ] 建立 `repository-knowledge-precompute` 的 capability/feature flags 与版本字段。
...
- [ ] 至少覆盖并验收：生成 architecture/dependency/library/error/test/method 等索引；以及 索引按 Git tree/文件 hash 增量更新。
...
- Machine contract: `references/contract.json` (`sha256:edb7ca3e064111f1b26d8bab51d93dc4d0c843621a02e8ba95de9d45d5221b74`).
