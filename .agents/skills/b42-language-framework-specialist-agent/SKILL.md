...
description: "Implement and verify Batch 42 Skill 1417 for language framework specialist agent. Use when work requires Language\u548cFramework Specialist Agent, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Language和Framework Specialist Agent
...
## Skill 1417: Language和Framework Specialist Agent
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b42-language-framework-specialist-agent`.
...
4. Implement the smallest production-shaped capability that exercises `Language和Framework Specialist Agent` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b42-language-framework-specialist-agent`
