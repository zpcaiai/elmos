---
name: elmos-target-openai-agents-sdk-generator
description: Generate Python and TypeScript agent projects with tools, handoffs, guardrails, sessions, tracing, MCP, structured
  outputs and realtime integration contracts.
version: 4.0.0
...
# TargetOpenaiAgentsSdkGenerator
...
- Generate Python/TypeScript agent projects
- Generate tools, handoffs and guardrails
- Generate session and tracing adapters
- Generate MCP and structured outputs
- Generate realtime/voice route when selected
...
- **handoff authority expansion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **guardrail bypass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **session leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tool schema injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **trace sensitive data** — must have a preventive control, a detective signal, a negative fixture and a response action.
