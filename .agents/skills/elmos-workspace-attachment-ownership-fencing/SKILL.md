---
name: workspace-attachment-ownership-fencing
description: Use this skill when Elmos must perform workspace attachment ownership fencing as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
为远程 Executor、Workspace、挂载和产物建立所有权与 Fencing Token。
