---
name: b83-database-code-test-harness-generator
description: "Use when ELMOS must run database code test harness generator for Batch 83 PL/SQL / T-SQL / PL/pgSQL / SQL PL Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG256"
  source_name: "database-code-test-harness-generator"
  source_sha256: "sha256:be530c3d850fa7a75f1d17740a7d53a60c4de511c300c4f6abf00b26cadf7b9b"
  batch: 83
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 83 Language Pack / source PG256 — Database Code Test Harness Generator

## 1. Objective

Generate database code test harness generator within the PL/SQL / T-SQL / PL/pgSQL / SQL PL Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Database Code Test Harness Generator using the approved database-programming semantic contracts and toolchain versions.
...
- A representative valid database-procedural input produces all declared outputs for database-code-test-harness-generator.
