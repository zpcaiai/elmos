---
name: b41-target-stack-recommendation
description: "Implement and verify Batch 41 Skill 1403 for target stack recommendation. Use when work requires \u76ee\u6807\u6280\u672f\u6808\u63a8\u8350, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-target-stack-recommendation`.
...
4. Implement the smallest production-shaped capability that exercises `目标技术栈推荐` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-target-stack-recommendation`
