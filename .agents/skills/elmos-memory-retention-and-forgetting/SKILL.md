---
name: memory-retention-and-forgetting
description: Use this skill when Elmos must perform memory retention and forgetting as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
