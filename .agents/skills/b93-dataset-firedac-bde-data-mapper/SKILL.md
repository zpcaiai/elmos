---
name: b93-dataset-firedac-bde-data-mapper
description: "Use when ELMOS must run dataset firedac bde data mapper for Batch 93 Delphi / Object Pascal Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG371"
  source_name: "dataset-firedac-bde-data-mapper"
  source_sha256: "sha256:c977f1e27f5ba81b12b561a288806da4581071130cabe1069a1ecb84223baeaa"
  batch: 93
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 93 Language Pack / source PG371 — Dataset Firedac Bde Data Mapper

## 1. Objective

Map dataset firedac bde data mapper within the Delphi / Object Pascal Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Dataset Firedac Bde Data Mapper using the approved windows-industrial-legacy semantic contracts and toolchain versions.
...
- A representative valid delphi-object-pascal input produces all declared outputs for dataset-firedac-bde-data-mapper.
