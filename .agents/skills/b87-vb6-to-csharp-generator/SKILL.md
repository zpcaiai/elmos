---
name: b87-vb6-to-csharp-generator
description: "Use when ELMOS must run vb6 to csharp generator for Batch 87 VB6 / VBA / VB.NET / Office Automation Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG302"
  source_name: "vb6-to-csharp-generator"
  source_sha256: "sha256:c8e7b5c71fc655c0b318bd6cb31c94404b71e3cc254e4b3d5a4874eff06c04eb"
  batch: 87
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 87 Language Pack / source PG302 — Vb6 To Csharp Generator

## 1. Objective

Generate vb6 to csharp generator within the VB6 / VBA / VB.NET / Office Automation Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Vb6 To Csharp Generator using the approved windows-legacy semantic contracts and toolchain versions.
...
- A representative valid vb-office input produces all declared outputs for vb6-to-csharp-generator.
