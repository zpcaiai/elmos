---
name: elmos-mcp-2026-profile-compiler
description: Compile exact-version MCP 2026-07-28 capability profiles for stateless core, extensions, Tasks, routing, caching,
  authorization and deprecation behavior.
version: 4.0.0
...
- **Kernel authorities used:** K1, K3, K6, K7
...
- `DeploymentUnit`
- `ConformanceRun`
- `MCP2026ProfileCompilerRun`
- `MCP2026ProfileCompilerDecision`

Required semantic capabilities:

- Exact protocol-version negotiation
- Stateless core and extension separation
- Header routing and cache semantics
- Tasks and interactive extension declarations
- Deprecation and unsupported capability accounting
...
- `mcp-profile.yaml`
- `mcp-capability-lock.json`
- `mcp-extension-plan.json`
- `mcp-deprecation-ledger.json`
...
- **version downgrade** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **route header spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cache poisoning** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **extension namespace collision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deprecated insecure behavior** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- version negotiation
- stateless request replay
- header routing
- cache invalidation
- extension discovery
- deprecated capability block
