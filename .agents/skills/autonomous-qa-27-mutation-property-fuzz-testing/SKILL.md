...
metadata:
  ...
  source_id: "27-mutation-property-fuzz-testing"
  source_sha256: "sha256:8aab2689d7e635720972b2dee92404bffa7274f814b1d8c7cec3f56104ec014c"
  ...
  runtime_skill_key: "27-mutation-property-fuzz-testing"
  runtime_handler: "execute_27_mutation_property_fuzz_testing"
...
1. Accept only a structured request for the exact Skill key `27-mutation-property-fuzz-testing`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_27_mutation_property_fuzz_testing` and operation `elmos_autonomous_qa.advanced_skills.plan_advanced_testing`.
...
- Immutable source: `skills/27-mutation-property-fuzz-testing/SKILL.md` at `sha256:8aab2689d7e635720972b2dee92404bffa7274f814b1d8c7cec3f56104ec014c`.
