---
name: elmos-structured-assurance-case-compiler
description: Compile auditable claims, arguments, assumptions, contexts, defeaters and evidence into SACM/GSN-compatible assurance cases for engineering and independent review.
version: 4.0.0
...
# Structured Assurance Case Compiler
...
- Create structured top claim and decomposition
- Link assumptions/context to exact versions
- Require evidence for leaf claims
- Represent rebuttals, defeaters and residual uncertainty
- Export machine-readable and review visualization
...
- `assurance-case.json`
- `assurance-case.sacm.json`
- `assurance-case-graph.json`
- `unresolved-defeaters.json`
...
- **circular argument** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence cited outside scope** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **assumption hidden in prose** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **defeater deleted to pass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **same test counted multiple times as independent evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- complete claim tree
- missing leaf evidence blocks
- assumption version binding
- defeater remains visible
