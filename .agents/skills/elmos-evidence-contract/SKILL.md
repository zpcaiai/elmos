...
description: Use this skill when Elmos must perform evidence contract as part of the 00-foundation-contracts production workflow,
...
定义每项能力必须产生的编译、测试、差分、证明、安全和人工审批证据。
