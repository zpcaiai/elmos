---
name: elmos-lab-reproducibility-repeatability-certifier
description: Implement and independently certify laboratory repeatability and reproducibility certifier, including estimate within-run, between-run, between-operator and between-lab variance, separate stochastic model variance from test-system variance and set reproducibility acceptance and evidence-retention rules.
version: 4.0.0
...
# Laboratory Repeatability and Reproducibility Certifier
...
- `LaboratoryRepeatabilityAndReproducibilityCertifierProfile`
- `LaboratoryRepeatabilityAndReproducibilityCertifierRun`
- `LaboratoryRepeatabilityAndReproducibilityCertifierFinding`
- `LaboratoryRepeatabilityAndReproducibilityCertifierDecision`
- `LaboratoryRepeatabilityAndReproducibilityCertifierEvidence`

Required semantic capabilities:

- estimate within-run, between-run, between-operator and between-lab variance
- separate stochastic model variance from test-system variance
- set reproducibility acceptance and evidence-retention rules
...
- `elmos-interlaboratory-comparison-controller`
- `elmos-measurement-uncertainty-budget-engine`

## Primary Outputs

- `artifacts/elmos-lab-reproducibility-repeatability-certifier/profile.yaml`
- `artifacts/elmos-lab-reproducibility-repeatability-certifier/plan.json`
- `artifacts/elmos-lab-reproducibility-repeatability-certifier/result.json`
- `artifacts/elmos-lab-reproducibility-repeatability-certifier/evidence/`
- `artifacts/elmos-lab-reproducibility-repeatability-certifier/assurance-case.json`
...
- **retries cherry-pick favorable output** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **random seed control masks production variability** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **between-lab disagreement is normalized away** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: estimate within-run, between-run, between-operator and between-lab variance
- native scenario: separate stochastic model variance from test-system variance
- native scenario: set reproducibility acceptance and evidence-retention rules
