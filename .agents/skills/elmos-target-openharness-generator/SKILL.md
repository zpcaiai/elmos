---
name: elmos-target-openharness-generator
description: Generate provider, tool, skill, plugin, hook, permission, memory, session and multi-agent extensions against
  the OpenHarness adapter contract.
version: 4.0.0
...
- Generate inspectable Python harness components
- Generate permission and hook policies
- Generate memory/session backends
- Generate personal and multi-agent configurations
- Run resume, compaction and permission tests
...
- **hook bypass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **permission profile confusion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **memory leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **plugin code execution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **resume authority drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
