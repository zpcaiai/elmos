---
name: slsa-in-toto-provenance
description: "Repository-owned bounded wrapper for slsa-in-toto-provenance; external evidence remains NOT_RUN."
---
...
Emit verifiable provenance for source, build, transformation, test and packaging steps using standard attestation models.
...
4. Submit `slsa-in-toto-provenance` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `534c8e9ff923c3860c29ebf67b199861f5964cab529c0e66b276a64649dea4a6`
