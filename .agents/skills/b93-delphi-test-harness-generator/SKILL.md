---
name: b93-delphi-test-harness-generator
description: "Use when ELMOS must run delphi test harness generator for Batch 93 Delphi / Object Pascal Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG376"
  source_name: "delphi-test-harness-generator"
  source_sha256: "sha256:6df0c9edbe63dcd913d6d6fb6df5854c2fe922cb31cc64d2d180130606b6bb61"
  batch: 93
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 93 Language Pack / source PG376 — Delphi Test Harness Generator

## 1. Objective

Generate delphi test harness generator within the Delphi / Object Pascal Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Delphi Test Harness Generator using the approved windows-industrial-legacy semantic contracts and toolchain versions.
...
- A representative valid delphi-object-pascal input produces all declared outputs for delphi-test-harness-generator.
