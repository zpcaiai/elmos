---
name: personal-data-rights-operations
description: Use this skill when Elmos must perform personal data rights operations as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# personal-data-rights-operations

## 能力目标

支持访问、更正、导出、删除、限制处理和影响范围定位。
