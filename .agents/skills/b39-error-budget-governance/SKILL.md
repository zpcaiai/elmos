---
name: b39-error-budget-governance
description: "Implement and verify Batch 39 Skill 1349 for error budget governance. Use when work requires Error Budget\u548c\u53ef\u9760\u6027\u6295\u8d44\u6cbb\u7406, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Error Budget和可靠性投资治理
...
## Skill 1349: Error Budget和可靠性投资治理
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-error-budget-governance`.
...
4. Implement the smallest production-shaped capability that exercises `Error Budget和可靠性投资治理` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-error-budget-governance`
