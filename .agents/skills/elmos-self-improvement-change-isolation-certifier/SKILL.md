---
name: elmos-self-improvement-change-isolation-certifier
description: Certify that learned prompts, rules, Skills and adapters are isolated, reviewable, reversible and cannot alter their own verifier or completion authority.
version: 4.0.0
...
# Self-Improvement Change Isolation Certifier
...
- `SelfImprovementChangeIsolationCertifierProfile`
- `SelfImprovementChangeIsolationCertifierPlan`
- `SelfImprovementChangeIsolationCertifierRun`
- `SelfImprovementChangeIsolationCertifierDecision`

Required semantic capabilities:

- separate proposal, implementation, verification and certification roles
- freeze verifier and policy outside candidate scope
- test authority and sandbox boundaries
- verify rollback and evidence lineage
- block recursive self-modification of K8
...
- `elmos-counterexample-to-rule-skill-promotion-controller` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-self-improvement-change-isolation-certifier/profile.yaml`
- `artifacts/elmos-self-improvement-change-isolation-certifier/plan.json`
- `artifacts/elmos-self-improvement-change-isolation-certifier/result.json`
- `artifacts/elmos-self-improvement-change-isolation-certifier/evidence/`
...
- **candidate edits its tests** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **agent changes policy bundle** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **reviewer shares model state** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback excludes learned memory** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **self-certification** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: separate proposal, implementation, verification and certification roles
- native scenario: freeze verifier and policy outside candidate scope
- native scenario: test authority and sandbox boundaries
- native scenario: verify rollback and evidence lineage
- native scenario: block recursive self-modification of K8
