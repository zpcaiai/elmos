---
name: "elmos-package-dependency-governor"
description: "Invoke the bounded repository handler for elmos-package-dependency-governor while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P00:package-dependency-governor"
  source_name: "elmos-package-dependency-governor"
  installed_name: "elmos-package-dependency-governor"
  source_logical_path: "00-elmos-software-factory-master/skills/package-dependency-governor/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/00-elmos-software-factory-master/skills/package-dependency-governor/SKILL.md.source-data"
  source_materialized_path: "00-elmos-software-factory-master/skills/package-dependency-governor/SKILL.md.source-data"
  source_sha256: "sha256:fc8f7ddbc6ce525ebe2319a6ffbb83e9cd11d2bd10bbf0291cf65c80d61a12df"
...
# elmos-package-dependency-governor
...
- This is a deterministic repository wrapper for `00-elmos-software-factory-master/skills/package-dependency-governor/SKILL.md` at `sha256:fc8f7ddbc6ce525ebe2319a6ffbb83e9cd11d2bd10bbf0291cf65c80d61a12df`.
- Its immutable source/runtime identity is `elmos-package-dependency-governor`; its active installed identity is `elmos-package-dependency-governor`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-package-dependency-governor --request <file>
```
