---
name: elmos-localization-cultural-policy-adapter
description: Adapt generated language, UI, examples, safety and workflow policy to locale while preserving core semantics and avoiding unsupported cultural assumptions.
version: 4.0.0
...
# Localization and Cultural Policy Adapter
...
- `LocalizationAndCulturalPolicyAdapterProfile`
- `LocalizationAndCulturalPolicyAdapterPlan`
- `LocalizationAndCulturalPolicyAdapterRun`
- `LocalizationAndCulturalPolicyAdapterDecision`

Required semantic capabilities:

- compile locale, terminology and formatting profile
- adapt prompts, UI and examples
- verify bidirectional text and input methods
- apply jurisdictional content/consent differences
- test semantic parity and human review
...
- `artifacts/elmos-localization-cultural-policy-adapter/profile.yaml`
- `artifacts/elmos-localization-cultural-policy-adapter/plan.json`
- `artifacts/elmos-localization-cultural-policy-adapter/result.json`
- `artifacts/elmos-localization-cultural-policy-adapter/evidence/`
...
- **translation changes legal meaning** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **locale fallback leaks another tenant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cultural stereotype encoded** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **RTL layout hides approval risk** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **policy adaptation exceeds evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile locale, terminology and formatting profile
- native scenario: adapt prompts, UI and examples
- native scenario: verify bidirectional text and input methods
- native scenario: apply jurisdictional content/consent differences
- native scenario: test semantic parity and human review
