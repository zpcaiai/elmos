---
name: continuous-fuzz-certification
description: "Repository-owned bounded wrapper for continuous-fuzz-certification; external evidence remains NOT_RUN."
---
...
Generate and continuously run coverage-guided fuzz targets with sanitizer support, crash deduplication and regression corpus promotion.
...
4. Submit `continuous-fuzz-certification` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `9dd72aea3e361c52d29147bc3dded9fa4efb4810b8ce5faec50ac9f3948004bc`
