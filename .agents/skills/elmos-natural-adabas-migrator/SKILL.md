---
name: elmos-natural-adabas-migrator
description: Transform Natural programs/maps/DDMs and Adabas multivalue/periodic-group
  semantics into explicit application/data models.
version: 1.0.0
skill_id: ELMOS-POLY-127
...
triggers:
- Use when implementing or executing `elmos-natural-adabas-migrator`.
- Use when the migration DAG requires `4gl-transformation` capability.
outputs:
- transforms/elmos-natural-adabas-migrator/plan.json
- transforms/elmos-natural-adabas-migrator/semantic-loss.json
- transforms/elmos-natural-adabas-migrator/evidence.json
---

# Natural Adabas Migrator

## Objective

Transform Natural programs/maps/DDMs and Adabas multivalue/periodic-group semantics into explicit application/data models.
