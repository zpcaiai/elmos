...
description: "Implement and verify Batch 41 Skill 1400 for migration risk prediction. Use when work requires \u8fc1\u79fb\u98ce\u9669\u9884\u6d4b, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-migration-risk-prediction`.
...
4. Implement the smallest production-shaped capability that exercises `迁移风险预测` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-migration-risk-prediction`
