---
name: "elmos-liveness-fairness-verifier"
description: "检查生成系统在明确环境假设下不会永久卡住、饿死租户或无限重试。 Use when the task needs the exact Liveness and Fairness Verifier Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P1/elmos-liveness-fairness-verifier/SKILL.md"
  source_sha256: "sha256:19173b1a1a7402ce57b8c86301582c5987955f8c5ccaf99b6bd45a4122cb4327"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P1"
  domain: "project-generation"
  runtime_handler_id: "execute_elmos_liveness_fairness_verifier"
...
---
# Liveness and Fairness Verifier

## Repository integration boundary

- Exact Skill identity: `elmos-liveness-fairness-verifier`; exact allowlisted runtime handler: `execute_elmos_liveness_fairness_verifier`.
- Source identity: `skills/P1/elmos-liveness-fairness-verifier/SKILL.md` at `sha256:19173b1a1a7402ce57b8c86301582c5987955f8c5ccaf99b6bd45a4122cb4327` from `elmos-formal-assurance-kernel-v1.0.0`.
...
检查生成系统在明确环境假设下不会永久卡住、饿死租户或无限重试。
...
3. Use the repository-owned `execute_elmos_liveness_fairness_verifier` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["LTL liveness","weak/strong fairness","ranking arguments","temporal decomposition"]`
- Direct dependencies: `["elmos-proof-obligation-planner","elmos-verifier-portfolio-router","elmos-generated-workflow-model-checker"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P1/elmos-liveness-fairness-verifier/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
