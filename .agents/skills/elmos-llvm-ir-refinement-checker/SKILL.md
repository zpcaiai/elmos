...
triggers:
  - "Use when implementing or executing `elmos-llvm-ir-refinement-checker`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-llvm-ir-refinement-checker/model.json"
  - "semantic-assurance/elmos-llvm-ir-refinement-checker/evidence.json"
  - "semantic-assurance/elmos-llvm-ir-refinement-checker/diagnostics.json"
---

# LLVM IR Refinement Checker

## Objective

Lower suitable native-language fragments to LLVM IR and use refinement-style translation validation where source/target semantics can be represented safely.
...
- **LLVM lowering identity.**
- **UB/poison semantics.**
- **refinement not text equality.**
...
- [ ] correct optimization fixture.
- [ ] unsound transform counterexample.
- [ ] unsupported interprocedural scope blocked.
