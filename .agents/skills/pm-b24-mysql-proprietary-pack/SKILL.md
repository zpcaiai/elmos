...
- Invoke this repository Skill as `$pm-b24-mysql-proprietary-pack`.
- Immutable source identity: `batch-24-mysql-proprietary-pack` in `precision-migration-b01-44` (B24).
- Runtime adapter: `database-and-data-route`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b24-mysql-proprietary-pack`.
...
- 当任务涉及 **mysql-stored-procedure-and-function** 时，调用 `../pm-b24-mysql-stored-procedure-and-function/SKILL.md`。
- 当任务涉及 **mysql-trigger** 时，调用 `../pm-b24-mysql-trigger/SKILL.md`。
- 当任务涉及 **mysql-event-scheduler** 时，调用 `../pm-b24-mysql-event-scheduler/SKILL.md`。
- 当任务涉及 **mysql-auto-increment** 时，调用 `../pm-b24-mysql-auto-increment/SKILL.md`。
- 当任务涉及 **mysql-enum-and-set** 时，调用 `../pm-b24-mysql-enum-and-set/SKILL.md`。
- 当任务涉及 **mysql-generated-column** 时，调用 `../pm-b24-mysql-generated-column/SKILL.md`。
- 当任务涉及 **mysql-json** 时，调用 `../pm-b24-mysql-json/SKILL.md`。
- 当任务涉及 **mysql-spatial** 时，调用 `../pm-b24-mysql-spatial/SKILL.md`。
- 当任务涉及 **mysql-on-duplicate-key** 时，调用 `../pm-b24-mysql-on-duplicate-key/SKILL.md`。
- 当任务涉及 **mysql-character-set-and-collation** 时，调用 `../pm-b24-mysql-character-set-and-collation/SKILL.md`。
- 当任务涉及 **mysql-innodb-transaction-behavior** 时，调用 `../pm-b24-mysql-innodb-transaction-behavior/SKILL.md`。
- 当任务涉及 **mysql-implicit-type-conversion** 时，调用 `../pm-b24-mysql-implicit-type-conversion/SKILL.md`。
- 当任务涉及 **mysql-sql-mode** 时，调用 `../pm-b24-mysql-sql-mode/SKILL.md`。
- 当任务涉及 **mysql-partition** 时，调用 `../pm-b24-mysql-partition/SKILL.md`。
- 当任务涉及 **mysql-replication-and-binlog** 时，调用 `../pm-b24-mysql-replication-and-binlog/SKILL.md`。
