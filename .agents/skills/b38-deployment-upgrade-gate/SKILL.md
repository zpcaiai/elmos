---
name: b38-deployment-upgrade-gate
description: "Implement and verify Batch 38 Skill 1346 for deployment upgrade gate. Use when work requires Batch 38\u90e8\u7f72\u548c\u5347\u7ea7\u8d28\u91cf\u95e8\u7981, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-deployment-upgrade-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 38部署和升级质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-deployment-upgrade-gate`
