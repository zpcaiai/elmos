---
name: elmos-certification-mark-claim-usage-governor
description: Implement and independently certify certification mark and conformity claim usage governor, including bind marks and claims to exact certified scope, version, site and validity period, monitor public use, misuse, ambiguity and expired claims and generate withdrawal, correction and customer-notification workflows.
version: 4.0.0
...
# Certification Mark and Conformity Claim Usage Governor
...
- `CertificationMarkAndConformityClaimUsageGovernorProfile`
- `CertificationMarkAndConformityClaimUsageGovernorRun`
- `CertificationMarkAndConformityClaimUsageGovernorFinding`
- `CertificationMarkAndConformityClaimUsageGovernorDecision`
- `CertificationMarkAndConformityClaimUsageGovernorEvidence`

Required semantic capabilities:

- bind marks and claims to exact certified scope, version, site and validity period
- monitor public use, misuse, ambiguity and expired claims
- generate withdrawal, correction and customer-notification workflows
...
- `elmos-ai-content-provenance-labeling-controller` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-certification-mark-claim-usage-governor/profile.yaml`
- `artifacts/elmos-certification-mark-claim-usage-governor/plan.json`
- `artifacts/elmos-certification-mark-claim-usage-governor/result.json`
- `artifacts/elmos-certification-mark-claim-usage-governor/evidence/`
- `artifacts/elmos-certification-mark-claim-usage-governor/assurance-case.json`
...
- **mark implies certification of excluded features** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **expired certificate remains in marketing material** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **machine-generated claim omits limitations** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: bind marks and claims to exact certified scope, version, site and validity period
- native scenario: monitor public use, misuse, ambiguity and expired claims
- native scenario: generate withdrawal, correction and customer-notification workflows
