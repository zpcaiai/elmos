...
description: "Invoke the bounded repository handler for elmos-lsp-capability-seam while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P01:lsp-capability-seam"
  source_name: "elmos-lsp-capability-seam"
  installed_name: "elmos-lsp-capability-seam"
  source_logical_path: "01-elmos-harness-runtime-platform/skills/lsp-capability-seam/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/01-elmos-harness-runtime-platform/skills/lsp-capability-seam/SKILL.md.source-data"
  source_materialized_path: "01-elmos-harness-runtime-platform/skills/lsp-capability-seam/SKILL.md.source-data"
  source_sha256: "sha256:e8368461f72e74ef7d5d3129c7a4094de7942385b6c7ae204e55e129330f2392"
...
- This is a deterministic repository wrapper for `01-elmos-harness-runtime-platform/skills/lsp-capability-seam/SKILL.md` at `sha256:e8368461f72e74ef7d5d3129c7a4094de7942385b6c7ae204e55e129330f2392`.
- Its immutable source/runtime identity is `elmos-lsp-capability-seam`; its active installed identity is `elmos-lsp-capability-seam`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-lsp-capability-seam --request <file>
```
