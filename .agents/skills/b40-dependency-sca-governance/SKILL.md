...
description: "Implement and verify Batch 40 Skill 1376 for dependency sca governance. Use when work requires Dependency\u548cSCA\u6cbb\u7406, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-dependency-sca-governance`.
...
4. Implement the smallest production-shaped capability that exercises `Dependency和SCA治理` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-dependency-sca-governance`
