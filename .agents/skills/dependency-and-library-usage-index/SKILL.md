---
name: dependency-and-library-usage-index
description: 不仅知道装了什么依赖，还知道在哪里、怎样被实际使用。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: FOUNDATION-05-dependency-and-library-usage-index
  source_name: dependency-and-library-usage-index
  source_path: skills/dependency-and-library-usage-index/SKILL.md
  source_sha256: sha256:e4a9e4306f6bf489af3da7c72d8731ec34acf5c0a34a9726428b67a3db5d5c5a
  source_contract_sha256: sha256:b116ebf520735d554bb64ed007be2549978230c86a4c03c6e8bfb5907aada70f
...
# Dependency & Library Usage Index

## Goal

不仅知道装了什么依赖，还知道在哪里、怎样被实际使用。

## Use when

在 Elmos 需要实现或升级 **Dependency & Library Usage Index** 相关能力时使用；它不是仅供解释的提示词，而是实现、测试与验收契约。

## Capabilities to implement

- dependency list 与 symbol/API usage 关联
- 区分 declared-but-unused 与 transitive-used
- 支持按 library/version/feature 查询使用点
- 为升级 Recipe 计算 blast radius
...
- [ ] 定义 `dependency-and-library-usage-index` 的 public interface、input/output/error schemas。
- [ ] 建立 `dependency-and-library-usage-index` 的 capability/feature flags 与版本字段。
...
- [ ] 至少覆盖并验收：dependency list 与 symbol/API usage 关联；以及 区分 declared-but-unused 与 transitive-used。
...
- Machine contract: `references/contract.json` (`sha256:b116ebf520735d554bb64ed007be2549978230c86a4c03c6e8bfb5907aada70f`).
