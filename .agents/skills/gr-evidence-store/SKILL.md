---
name: gr-evidence-store
description: 保存日志、测试、Diff、Trace、图、SBOM、报告等不可变 CAS/Object references。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-067
  source_name: gr-evidence-store
  source_path: skills/gr-evidence-store/SKILL.md
  source_sha256: sha256:239125e123040d9f9580f68eaf821f733e3638d5f38e120e08c1a19be5649f74
  source_contract_sha256: sha256:906838ef6a55c76023800565b24a22ed74dda48e68ff05e1771cae11be3ec407
...
保存日志、测试、Diff、Trace、图、SBOM、报告等不可变 CAS/Object references。

## Scope and capabilities

- Hash/encryption
- Sensitivity/retention/legal hold
- Large artifact streaming
- Tamper detection
- Export/delete certificate
...
- [ ] 定义 `gr-evidence-store` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-evidence-store` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：evidence-manifest.json, artifact-uris, retention-status.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：evidence-manifest.json, artifact-uris, retention-status.json。
...
- Machine contract: `references/contract.json` (`sha256:906838ef6a55c76023800565b24a22ed74dda48e68ff05e1771cae11be3ec407`).
