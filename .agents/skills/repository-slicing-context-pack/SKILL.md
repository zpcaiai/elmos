...
- Activate when the task requires: generate minimal semantically closed context slices for an agent rather than loading whole repositories or arbitrary grep results.
