---
name: elmos-sql-routine-trigger-ir-compiler
description: Compile stored procedures, functions, packages, triggers, cursors, handlers, exceptions, dynamic SQL, session state and transaction control into Routine IR.
version: 4.0.0
...
# SQL Routine and Trigger IR Compiler
...
- Use vendor-native parsers or runtime metadata
- Model variables, cursors, exceptions and control flow
- Capture transaction/session side effects
- Link dynamic SQL and called routines
- Preserve trigger ordering and firing semantics
...
- `sql-routine-ir.json`
- `routine-call-graph.json`
- `trigger-effect-map.json`
- `routine-opaque-register.json`
...
- **trigger side effect omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **exception handler mapped incorrectly** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **autonomous transaction flattened** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **session state leaks** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dynamic SQL call graph incomplete** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- PL/pgSQL function
- trigger cascade
- cursor/handler/exception
- autonomous/session transaction
