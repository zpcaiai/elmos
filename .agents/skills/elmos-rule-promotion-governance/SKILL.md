---
name: "elmos-rule-promotion-governance"
description: "Invoke the bounded repository handler for elmos-rule-promotion-governance while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P07:rule-promotion-governance"
  source_name: "elmos-rule-promotion-governance"
  installed_name: "elmos-rule-promotion-governance"
  source_logical_path: "07-elmos-transformation-learning-evolution/skills/rule-promotion-governance/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/07-elmos-transformation-learning-evolution/skills/rule-promotion-governance/SKILL.md.source-data"
  source_materialized_path: "07-elmos-transformation-learning-evolution/skills/rule-promotion-governance/SKILL.md.source-data"
  source_sha256: "sha256:bfed8e2cbe2617d8fd2beebe6a8b152054166687480b2a8d5223fb6f4c5199df"
...
# elmos-rule-promotion-governance
...
- This is a deterministic repository wrapper for `07-elmos-transformation-learning-evolution/skills/rule-promotion-governance/SKILL.md` at `sha256:bfed8e2cbe2617d8fd2beebe6a8b152054166687480b2a8d5223fb6f4c5199df`.
- Its immutable source/runtime identity is `elmos-rule-promotion-governance`; its active installed identity is `elmos-rule-promotion-governance`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-rule-promotion-governance --request <file>
```
