---
name: b46-test-pyramid-real-system-classification
description: 定义L1–L7测试层次及哪些必须使用真实编译器、数据库、Cloud、Air-gap、客户或第三方。
---

# Skill 1510：统一测试金字塔与真实系统分类
...
定义L1–L7测试层次及哪些必须使用真实编译器、数据库、Cloud、Air-gap、客户或第三方。
...
- 明确Mock允许边界；真实编译器、数据库、Cloud、Air-gap、客户和第三方要求必须机器可读。
