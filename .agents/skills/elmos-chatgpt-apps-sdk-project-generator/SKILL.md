---
name: elmos-chatgpt-apps-sdk-project-generator
description: Generate MCP-backed ChatGPT plugin/app projects with tool plans, optional MCP Apps UI, CSP, authentication, submission metadata and review tests.
version: 4.0.0
...
# ChatGPT Apps SDK Project Generator
...
- `ChatGPTAppsSDKProjectGeneratorProfile`
- `ChatGPTAppsSDKProjectGeneratorPlan`
- `ChatGPTAppsSDKProjectGeneratorRun`
- `ChatGPTAppsSDKProjectGeneratorDecision`

Required semantic capabilities:

- classify tool-only/widget/submission archetype
- generate MCP server and UI resource contracts
- set accurate tool annotations and output schemas
- generate CSP/auth/deploy/submission artifacts
- run local and review-oriented conformance
...
- `artifacts/elmos-chatgpt-apps-sdk-project-generator/profile.yaml`
- `artifacts/elmos-chatgpt-apps-sdk-project-generator/plan.json`
- `artifacts/elmos-chatgpt-apps-sdk-project-generator/result.json`
- `artifacts/elmos-chatgpt-apps-sdk-project-generator/evidence/`
...
- **tool annotation contradicts side effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **CSP wildcard** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive input requested unnecessarily** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **UI depends on undocumented host API** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **submission evidence invented** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify tool-only/widget/submission archetype
- native scenario: generate MCP server and UI resource contracts
- native scenario: set accurate tool annotations and output schemas
- native scenario: generate CSP/auth/deploy/submission artifacts
- native scenario: run local and review-oriented conformance
