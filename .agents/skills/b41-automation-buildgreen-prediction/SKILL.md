---
name: b41-automation-buildgreen-prediction
description: "Implement and verify Batch 41 Skill 1401 for automation buildgreen prediction. Use when work requires \u81ea\u52a8\u5316\u7387\u548cBuild Green\u6982\u7387\u9884\u6d4b, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 自动化率和Build Green概率预测
...
## Skill 1401: 自动化率和Build Green概率预测
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-automation-buildgreen-prediction`.
...
4. Implement the smallest production-shaped capability that exercises `自动化率和Build Green概率预测` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-automation-buildgreen-prediction`
