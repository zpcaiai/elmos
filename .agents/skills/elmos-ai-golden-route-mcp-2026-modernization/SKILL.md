---
name: elmos-ai-golden-route-mcp-2026-modernization
description: Certify migration of a legacy MCP server to the 2026-07-28 profile with stateless core, Tasks, Apps/Skills extensions
...
# Golden Route: MCP 2026 Modernization
...
- `GoldenRouteMCP2026ModernizationRun`
- `GoldenRouteMCP2026ModernizationDecision`

Required semantic capabilities:

- Legacy protocol fingerprint
- Exact-version migration plan
- Tasks/UI/auth implementation
- Native protocol differential tests
- Canary, rollback and certification
...
- `golden-routes/mcp-2026/evidence/`
- `mcp-modernization-certificate.json`
- `protocol-differential-results.json`
- `rollback-package/`
...
- **protocol downgrade** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **task state loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **authorization regression** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **extension confusion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **false native conformance** — must have a preventive control, a detective signal, a negative fixture and a response action.
