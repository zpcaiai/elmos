...
# CONV-005：统一Durable Workflow Runtime

## Objective

让迁移、认证、升级、发布、退役共享同一套版本化、可恢复的工作流内核。
...
1. 定义Workflow、Step、Lease、Retry、Checkpoint、Compensation和Human Task。
2. 实现定义版本化与长任务恢复。
3. 统一幂等键和副作用账本。
4. 实现暂停、恢复、取消和人工接管。
5. 迁移至少三条跨Batch真实工作流。
