---
name: b94-beam-property-concurrency-fault-test-generator
description: "Use when ELMOS must run beam property concurrency fault test generator for Batch 94 Erlang / Elixir / Gleam BEAM Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG389"
  source_name: "beam-property-concurrency-fault-test-generator"
  source_sha256: "sha256:f9f27e96b2efc56e857c1632595f09974ba4e0753fd2b1d536d52a8763b85d72"
  batch: 94
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 94 Language Pack / source PG389 — Beam Property Concurrency Fault Test Generator

## 1. Objective

Generate beam property concurrency fault test generator within the Erlang / Elixir / Gleam BEAM Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Beam Property Concurrency Fault Test Generator using the approved fault-tolerant-runtime semantic contracts and toolchain versions.
...
- A representative valid beam-erlang-elixir-gleam input produces all declared outputs for beam-property-concurrency-fault-test-generator.
