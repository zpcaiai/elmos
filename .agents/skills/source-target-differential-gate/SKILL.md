---
name: source-target-differential-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Source-Target Differential Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T105"
  source_name: "source-target-differential-gate"
  source_sha256: "sha256:24ed816f791fcbd9b882446f556adea3f0ea999496abbf4cc2efc9459f3c089d"
...
# T105 — Source-Target Differential Gate

## 1. Objective

Run source and target against golden and generated cases, reconcile outputs and classify every difference.
...
- `CASE-0481` [HIGH] Source-Target Differential Gate: Representative path
- `CASE-0482` [HIGH] Source-Target Differential Gate: Boundary path
- `CASE-0483` [HIGH] Source-Target Differential Gate: Invalid or hostile input
- `CASE-0484` [HIGH] Source-Target Differential Gate: Injected dependency failure
- `CASE-0485` [CRITICAL] Source-Target Differential Gate: Security or safety violation
- `CASE-0486` [HIGH] Source-Target Differential Gate: Replay and idempotency
- `CASE-0487` [HIGH] Source-Target Differential Gate: Version or environment drift
- `CASE-0488` [MEDIUM] Source-Target Differential Gate: Moderate scale
- `CASE-0489` [CRITICAL] Source-Target Differential Gate: Evidence tamper
- `CASE-0490` [HIGH] Source-Target Differential Gate: Recovery and final evidence
