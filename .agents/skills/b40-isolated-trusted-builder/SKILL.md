---
name: b40-isolated-trusted-builder
description: "Implement and verify Batch 40 Skill 1384 for isolated trusted builder. Use when work requires \u9694\u79bb\u6784\u5efa\u548c\u53ef\u4fe1Builder, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b40-isolated-trusted-builder`.
...
4. Implement the smallest production-shaped capability that exercises `隔离构建和可信Builder` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b40-isolated-trusted-builder`
