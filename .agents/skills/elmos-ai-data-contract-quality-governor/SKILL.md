---
name: elmos-ai-data-contract-quality-governor
description: Define and enforce contracts for training, evaluation, retrieval, memory and tool data with freshness, completeness,
  distribution and ownership controls.
version: 4.0.0
...
# AI Data Contract and Quality Governor
...
- `Approval`
- `ResidualRisk`
- `AIDataContractAndQualityGovernorRun`
- `AIDataContractAndQualityGovernorDecision`

Required semantic capabilities:

- Typed schema and semantic constraints
- Freshness/completeness/uniqueness checks
- Distribution and segment monitoring
- Ownership and stewardship workflow
- Quarantine and downstream evidence invalidation
...
- `distribution-drift.json`
- `data-owner-approvals.json`
...
- **silent data corruption** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ownership ambiguity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **quality metric gaming** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **segment collapse** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **quarantine bypass** — must have a preventive control, a detective signal, a negative fixture and a response action.
