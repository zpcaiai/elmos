---
name: elmos-measurement-uncertainty-budget-engine
description: Implement and independently certify measurement uncertainty budget engine, including combine Type A and Type B uncertainty components with covariance, support analytic, bootstrap, Bayesian and Monte Carlo propagation and report standard, expanded and interval uncertainty with assumptions.
version: 4.0.0
...
# Measurement Uncertainty Budget Engine
...
- `MeasurementUncertaintyBudgetEngineProfile`
- `MeasurementUncertaintyBudgetEngineRun`
- `MeasurementUncertaintyBudgetEngineFinding`
- `MeasurementUncertaintyBudgetEngineDecision`
- `MeasurementUncertaintyBudgetEngineEvidence`

Required semantic capabilities:

- combine Type A and Type B uncertainty components with covariance
- support analytic, bootstrap, Bayesian and Monte Carlo propagation
- report standard, expanded and interval uncertainty with assumptions
...
- `elmos-ai-evaluation-measurement-model-compiler`
...
- `artifacts/elmos-measurement-uncertainty-budget-engine/profile.yaml`
- `artifacts/elmos-measurement-uncertainty-budget-engine/plan.json`
- `artifacts/elmos-measurement-uncertainty-budget-engine/result.json`
- `artifacts/elmos-measurement-uncertainty-budget-engine/evidence/`
- `artifacts/elmos-measurement-uncertainty-budget-engine/assurance-case.json`
...
- **sampling variance is the only uncertainty considered** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **model/provider drift is omitted from budget** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **coverage factor is selected to force conformity** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: combine Type A and Type B uncertainty components with covariance
- native scenario: support analytic, bootstrap, Bayesian and Monte Carlo propagation
- native scenario: report standard, expanded and interval uncertainty with assumptions
