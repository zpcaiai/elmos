...
# AI Impact, Harm and Benefit Distribution Assessor
...
- `AIImpactHarmAndBenefitDistributionAssessorProfile`
- `AIImpactHarmAndBenefitDistributionAssessorRun`
- `AIImpactHarmAndBenefitDistributionAssessorFinding`
- `AIImpactHarmAndBenefitDistributionAssessorDecision`
- `AIImpactHarmAndBenefitDistributionAssessorEvidence`

Required semantic capabilities:

- identify direct, indirect, cumulative and systemic impacts across lifecycle
- compare benefits and harms across individuals, groups, operators and society
- record foreseeable misuse, affected rights and mitigation ownership
...
- `artifacts/elmos-ai-impact-harm-benefit-distribution-assessor/profile.yaml`
- `artifacts/elmos-ai-impact-harm-benefit-distribution-assessor/plan.json`
- `artifacts/elmos-ai-impact-harm-benefit-distribution-assessor/result.json`
- `artifacts/elmos-ai-impact-harm-benefit-distribution-assessor/evidence/`
- `artifacts/elmos-ai-impact-harm-benefit-distribution-assessor/assurance-case.json`
...
- **average benefit conceals concentrated severe harm** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **only intended use is assessed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **affected stakeholders cannot challenge assumptions** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: identify direct, indirect, cumulative and systemic impacts across lifecycle
- native scenario: compare benefits and harms across individuals, groups, operators and society
- native scenario: record foreseeable misuse, affected rights and mitigation ownership
