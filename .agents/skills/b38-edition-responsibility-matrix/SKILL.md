---
name: b38-edition-responsibility-matrix
description: "Implement and verify Batch 38 Skill 1326 for edition responsibility matrix. Use when work requires Edition\u3001\u90e8\u7f72\u548c\u8d23\u4efb\u8fb9\u754c\u77e9\u9635, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-edition-responsibility-matrix`.
...
4. Implement the smallest production-shaped capability that exercises `Edition、部署和责任边界矩阵` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-edition-responsibility-matrix`
