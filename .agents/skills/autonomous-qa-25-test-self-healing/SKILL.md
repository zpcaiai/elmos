---
name: "autonomous-qa-25-test-self-healing"
description: "Run 25-test-self-healing through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "25-test-self-healing"
  source_sha256: "sha256:d25920d13281942e916c27be3d660007043fce34734b8cc7e984b235e1f6bf45"
  source_dependencies: "21-flaky-test-control,23-repair-planning"
  ...
  runtime_skill_key: "25-test-self-healing"
  runtime_handler: "execute_25_test_self_healing"
  runtime_phase: "repair"
  runtime_mutating: "true"
  runtime_operation: "external-plan:elmos_autonomous_qa.domain.validate_test_heal"
...
1. Accept only a structured request for the exact Skill key `25-test-self-healing`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_25_test_self_healing` and operation `external-plan:elmos_autonomous_qa.domain.validate_test_heal`.
...
- Immutable source: `skills/25-test-self-healing/SKILL.md` at `sha256:d25920d13281942e916c27be3d660007043fce34734b8cc7e984b235e1f6bf45`.
