---
name: b38-multitenant-saas-edition
description: "Implement and verify Batch 38 Skill 1328 for multitenant saas edition. Use when work requires Multi-tenant SaaS Edition, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
## Skill 1328: Multi-tenant SaaS Edition
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-multitenant-saas-edition`.
...
4. Implement the smallest production-shaped capability that exercises `Multi-tenant SaaS Edition` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-multitenant-saas-edition`
