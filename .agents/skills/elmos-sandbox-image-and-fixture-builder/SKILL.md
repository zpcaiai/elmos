---
name: sandbox-image-and-fixture-builder
description: Use this skill when Elmos must perform sandbox image and fixture builder as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# sandbox-image-and-fixture-builder

## 能力目标

构建固定工具链镜像、种子数据、外部服务模拟和网络策略。
