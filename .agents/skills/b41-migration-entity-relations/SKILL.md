---
name: b41-migration-entity-relations
description: "Implement and verify Batch 41 Skill 1395 for migration entity relations. Use when work requires \u9879\u76ee\u3001\u4ee3\u7801\u3001Rule\u3001Patch\u548cEvidence\u5b9e\u4f53\u5173\u7cfb, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 项目、代码、Rule、Patch和Evidence实体关系
...
## Skill 1395: 项目、代码、Rule、Patch和Evidence实体关系
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-migration-entity-relations`.
...
4. Implement the smallest production-shaped capability that exercises `项目、代码、Rule、Patch和Evidence实体关系` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-migration-entity-relations`
