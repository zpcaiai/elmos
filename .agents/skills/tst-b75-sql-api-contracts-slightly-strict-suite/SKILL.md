---
name: tst-b75-sql-api-contracts-slightly-strict-suite
description: "Run the slightly strict test suite for Batch 75: SQL and API Contract Languages, covering every source Skill with positive and negative executable cases."
metadata:
  id: TB75
...
---
    # TB75 — Batch 75 SQL and API Contract Languages 略严苛测试套件

    ## Objective

    对 Batch 75 的全部 16 个Source Skills执行可重放的正向、边界、负向、故障、安全和证据完整性验证。范围为：SQL、OpenAPI、Protocol Buffers、GraphQL Schema、兼容性与迁移。
    ...
    |---|---|---|---|
    | PG335 | `b75-sql-schema-dialect-detector` | detector | `B75-PG335-RUN, B75-PG335-NEG` |
| PG336 | `b75-sql-migration-generator` | data | `B75-PG336-RUN, B75-PG336-NEG` |
| PG337 | `b75-sql-query-generator` | data | `B75-PG337-RUN, B75-PG337-NEG` |
| PG338 | `b75-sql-transaction-isolation-designer` | data | `B75-PG338-RUN, B75-PG338-NEG` |
| PG339 | `b75-sql-seed-fixture-generator` | data | `B75-PG339-RUN, B75-PG339-NEG` |
| PG340 | `b75-sql-query-plan-performance-gate` | data | `B75-PG340-RUN, B75-PG340-NEG` |
| PG341 | `b75-sql-security-rls-policy-generator` | data | `B75-PG341-RUN, B75-PG341-NEG` |
| PG342 | `b75-sql-compatibility-certifier` | data | `B75-PG342-RUN, B75-PG342-NEG` |
| PG343 | `b75-openapi-spec-generator` | contract | `B75-PG343-RUN, B75-PG343-NEG` |
| PG344 | `b75-openapi-lint-breaking-change-gate` | contract | `B75-PG344-RUN, B75-PG344-NEG` |
| PG345 | `b75-openapi-codegen-contract-test` | contract | `B75-PG345-RUN, B75-PG345-NEG` |
| PG346 | `b75-protobuf-schema-generator` | contract | `B75-PG346-RUN, B75-PG346-NEG` |
| PG347 | `b75-protobuf-buf-compatibility-gate` | contract | `B75-PG347-RUN, B75-PG347-NEG` |
| PG348 | `b75-graphql-schema-resolver-generator` | contract | `B75-PG348-RUN, B75-PG348-NEG` |
| PG349 | `b75-graphql-security-cost-gate` | contract | `B75-PG349-RUN, B75-PG349-NEG` |
| PG350 | `b75-multi-contract-language-certifier` | contract | `B75-PG350-RUN, B75-PG350-NEG` |
