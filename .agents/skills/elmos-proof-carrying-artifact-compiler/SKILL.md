...
# Proof-Carrying Artifact Compiler
...
- `ProofCarryingArtifactCompilerProfile`
- `ProofCarryingArtifactCompilerRun`
- `ProofCarryingArtifactCompilerFinding`
- `ProofCarryingArtifactCompilerDecision`
- `ProofCarryingArtifactCompilerEvidence`

Required semantic capabilities:

- package artifact, specification, proof object, checker, assumptions and environment digest
- bind proof to exact executable or generated repository revision
- enable small independent checker validation without trusting producer
...
- `elmos-proof-assistant-lean-dafny-bridge` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-proof-carrying-artifact-compiler/profile.yaml`
- `artifacts/elmos-proof-carrying-artifact-compiler/plan.json`
- `artifacts/elmos-proof-carrying-artifact-compiler/result.json`
- `artifacts/elmos-proof-carrying-artifact-compiler/evidence/`
- `artifacts/elmos-proof-carrying-artifact-compiler/assurance-case.json`
...
- **proof refers to source not deployed binary** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **checker is larger than artifact TCB** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **assumption file is modified after proof** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: package artifact, specification, proof object, checker, assumptions and environment digest
- native scenario: bind proof to exact executable or generated repository revision
- native scenario: enable small independent checker validation without trusting producer
