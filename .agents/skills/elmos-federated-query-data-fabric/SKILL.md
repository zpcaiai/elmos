...
description: "Use for ELMOS database or Big Data work covered by elmos-federated-query-data-fabric. Source purpose: 为异构数据源生成联邦查询、元数据驱动集成、策略下推和自助访问。 Preserve exact data, tenant, runtime, and evidence boundaries; catalog entries and generated plans are not production proof."
metadata:
  source_package: "elmos-database-bigdata-skills"
  source_version: "1.0.0"
  source_path: "skills/elmos-database-bigdata-skills-v1.0.0/skills/elmos-federated-query-data-fabric/SKILL.md"
  source_sha256: "sha256:f6d547ed58262220ba13f0ffad1b0f3e43aabe105beb2ae72b0f3cbbec6bf571"
  ...
  repository_handler_id: "handle_elmos_federated_query_data_fabric"
...
- Provenance is pinned to `elmos-database-bigdata-skills` `1.0.0`, source `skills/elmos-database-bigdata-skills-v1.0.0/skills/elmos-federated-query-data-fabric/SKILL.md`, and `sha256:f6d547ed58262220ba13f0ffad1b0f3e43aabe105beb2ae72b0f3cbbec6bf571`.
- Source group: `bigdata-core`. Dependencies: `["elmos-bigdata-pattern-selector", "elmos-polyglot-persistence-planner", "elmos-database-capability-registry"]`. Triggers: `["数据不能集中", "跨源即席", "Data Fabric 或迁移过渡"]`. Declared outputs: `["federation-topology.md", "connector-catalog.json", "pushdown-policy.json", "fabric-services.md"]`. Stable task IDs: `["FED-001", "FED-002", "FED-003", "FED-004", "FED-005", "FED-006", "FED-007", "FED-008", "FED-009", "FED-010", "FED-011", "FED-012"]`.
- This normalized Skill is installed and invocable. The repository binds `handle_elmos_federated_query_data_fabric` in `engines/database-bigdata-engine/src/elmos_database_bigdata/handlers/bigdata_core.py` as a bounded plan-skeleton entry point; the reviewed code declares no database, provider, network, deployment, benchmark, mutation, or certification operation.
