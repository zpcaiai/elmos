---
name: b91-apex-parser-and-semantic-model
description: "Use when ELMOS must run apex parser and semantic model for Batch 91 Salesforce Apex / SOQL / LWC Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG344"
  source_name: "apex-parser-and-semantic-model"
  source_sha256: "sha256:b3f7033eed59ff436aed00187c86de90f06faad1b28deebe7ddd7185945a3742"
  batch: 91
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 91 Language Pack / source PG344 — Apex Parser And Semantic Model

## 1. Objective

Parse and semantically index apex parser and semantic model within the Salesforce Apex / SOQL / LWC Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Apex Parser And Semantic Model using the approved enterprise-crm-platform semantic contracts and toolchain versions.
...
- A representative valid salesforce input produces all declared outputs for apex-parser-and-semantic-model.
