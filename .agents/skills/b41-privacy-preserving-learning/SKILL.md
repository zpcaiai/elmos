---
name: b41-privacy-preserving-learning
description: "Implement and verify Batch 41 Skill 1408 for privacy preserving learning. Use when work requires \u9690\u79c1\u4fdd\u62a4\u805a\u5408\u548c\u8de8\u9879\u76ee\u5b66\u4e60, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-privacy-preserving-learning`.
...
4. Implement the smallest production-shaped capability that exercises `隐私保护聚合和跨项目学习` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-privacy-preserving-learning`
