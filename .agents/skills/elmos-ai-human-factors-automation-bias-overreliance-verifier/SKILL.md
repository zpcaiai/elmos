...
# Human Factors, Automation Bias and Overreliance Verifier
...
- `HumanFactorsAutomationBiasAndOverrelianceVerifierProfile`
- `HumanFactorsAutomationBiasAndOverrelianceVerifierRun`
- `HumanFactorsAutomationBiasAndOverrelianceVerifierFinding`
- `HumanFactorsAutomationBiasAndOverrelianceVerifierDecision`
- `HumanFactorsAutomationBiasAndOverrelianceVerifierEvidence`

Required semantic capabilities:

- evaluate operator workload, vigilance, trust calibration and intervention timing
- test automation bias, anchoring, complacency and skill degradation
- verify interface and procedure enable effective override, escalation and recovery
...
- `artifacts/elmos-ai-human-factors-automation-bias-overreliance-verifier/profile.yaml`
- `artifacts/elmos-ai-human-factors-automation-bias-overreliance-verifier/plan.json`
- `artifacts/elmos-ai-human-factors-automation-bias-overreliance-verifier/result.json`
- `artifacts/elmos-ai-human-factors-automation-bias-overreliance-verifier/evidence/`
- `artifacts/elmos-ai-human-factors-automation-bias-overreliance-verifier/assurance-case.json`
...
- **nominal approval step provides no meaningful time or evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **operator always follows AI under workload** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **frequent false alarms disable oversight** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: evaluate operator workload, vigilance, trust calibration and intervention timing
- native scenario: test automation bias, anchoring, complacency and skill degradation
- native scenario: verify interface and procedure enable effective override, escalation and recovery
