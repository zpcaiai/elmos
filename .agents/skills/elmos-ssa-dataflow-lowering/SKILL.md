...
triggers:
  - "Use when implementing or executing `elmos-ssa-dataflow-lowering`."
  - "Use when a migration/certification DAG requires `dataflow-semantics` capability."
outputs:
  - "semantic-assurance/elmos-ssa-dataflow-lowering/model.json"
  - "semantic-assurance/elmos-ssa-dataflow-lowering/evidence.json"
  - "semantic-assurance/elmos-ssa-dataflow-lowering/diagnostics.json"
---

# SSA & Dataflow Lowering

## Objective

Lower relevant code into SSA-like dataflow form to expose definitions, uses, phi merges and value transformations across languages.
...
- **def-use chains.**
- **phi merges.**
- **constant propagation boundaries.**
- **memory SSA references.**
...
- [ ] branch merge fixture.
- [ ] mutable local fixture.
- [ ] SSA provenance roundtrip.
