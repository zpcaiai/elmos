...
# Interlaboratory Comparison Controller
...
- `InterlaboratoryComparisonControllerProfile`
- `InterlaboratoryComparisonControllerRun`
- `InterlaboratoryComparisonControllerFinding`
- `InterlaboratoryComparisonControllerDecision`
- `InterlaboratoryComparisonControllerEvidence`

Required semantic capabilities:

- compare reproducibility across organizations, regions, toolchains and model providers
- compute robust consensus, En, z or task-appropriate performance statistics
- investigate method, environment and implementation causes of disagreement
...
- `elmos-proficiency-testing-scheme-generator`

## Primary Outputs

- `artifacts/elmos-interlaboratory-comparison-controller/profile.yaml`
- `artifacts/elmos-interlaboratory-comparison-controller/plan.json`
- `artifacts/elmos-interlaboratory-comparison-controller/result.json`
- `artifacts/elmos-interlaboratory-comparison-controller/evidence/`
- `artifacts/elmos-interlaboratory-comparison-controller/assurance-case.json`
...
- **common reference implementation creates correlated error** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **consensus is wrong because all labs share same bias** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **confidential results leak competitor performance** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compare reproducibility across organizations, regions, toolchains and model providers
- native scenario: compute robust consensus, En, z or task-appropriate performance statistics
- native scenario: investigate method, environment and implementation causes of disagreement
