---
name: elmos-ai-generated-project-upgrader
description: Upgrade generated projects when target frameworks, adapters, models or platform contracts drift, preserving user-owned
  changes through source lineage and three-way semantic merge.
version: 4.0.0
...
- **Kernel authorities used:** K2, K3, K5, K6
...
- `upgrade-plan.json`
- `change-impact.json`
- `semantic-merge-result.json`
- `recertification-plan.json`
...
- AiGeneratedProjectUpgrader representative end-to-end fixture
