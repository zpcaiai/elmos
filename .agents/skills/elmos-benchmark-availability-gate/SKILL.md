---
name: "elmos-benchmark-availability-gate"
description: "Invoke the bounded repository handler for elmos-benchmark-availability-gate while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P06:benchmark-availability-gate"
  source_name: "elmos-benchmark-availability-gate"
  installed_name: "elmos-benchmark-availability-gate"
  source_logical_path: "06-elmos-intelligent-model-router/skills/benchmark-availability-gate/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/06-elmos-intelligent-model-router/skills/benchmark-availability-gate/SKILL.md.source-data"
  source_materialized_path: "06-elmos-intelligent-model-router/skills/benchmark-availability-gate/SKILL.md.source-data"
  source_sha256: "sha256:964ef2e76ccf0d6a47e375ebf8e824ced79f655c11c854293a004316bf7ea451"
...
# elmos-benchmark-availability-gate
...
- This is a deterministic repository wrapper for `06-elmos-intelligent-model-router/skills/benchmark-availability-gate/SKILL.md` at `sha256:964ef2e76ccf0d6a47e375ebf8e824ced79f655c11c854293a004316bf7ea451`.
- Its immutable source/runtime identity is `elmos-benchmark-availability-gate`; its active installed identity is `elmos-benchmark-availability-gate`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-benchmark-availability-gate --request <file>
```
