---
name: safety-constrained-agent-learning
description: Use this skill when Elmos must perform safety constrained agent learning as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# safety-constrained-agent-learning

## 能力目标

把工具权限、审批、数据边界和禁止动作作为不可被奖励抵消的硬约束。
