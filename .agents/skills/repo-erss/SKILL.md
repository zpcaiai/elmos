---
name: repo-erss
description: 定义 S0＜20k、S1 20–100k、S2 100–300k、S3 300k–1M、S4 1–3M、S5＞3M MRLOC。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-019
  source_name: repo-erss
  source_path: skills/repo-erss/SKILL.md
  source_sha256: sha256:761d6a9c206cba7403c463a5256dcf5f6f298b0b44e0db075e3243cc0fafee21
  source_contract_sha256: sha256:a2b016732b19de6cae5ba6d651e10717a1952e2652a21df9203c490926d5b1a6
...
定义 S0<20k、S1 20–100k、S2 100–300k、S3 300k–1M、S4 1–3M、S5>3M MRLOC。

## Scope and capabilities

- 版本化阈值
- 内部与外部标签
- Provisional/Audited 状态
- Strong Large 附加条件
...
- [ ] 定义 `repo-erss` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `repo-erss` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：erss-classification.json, scale-policy-version。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：erss-classification.json, scale-policy-version。
...
- Machine contract: `references/contract.json` (`sha256:a2b016732b19de6cae5ba6d651e10717a1952e2652a21df9203c490926d5b1a6`).
