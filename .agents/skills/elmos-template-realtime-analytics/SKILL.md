...
- Source group: `bigdata-templates`. Dependencies: `["elmos-bigdata-project-orchestrator"]`. Triggers: `["实时大屏", "实时指标", "秒级分析/监控"]`. Declared outputs: `["template-plan.json", "generated-project/"]`.
