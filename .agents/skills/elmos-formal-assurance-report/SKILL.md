---
name: "elmos-formal-assurance-report"
description: "生成面向工程、审计、客户和管理层的答案优先报告，准确展示证明范围、边界、假设、反例和残余风险。 Use when the task needs the exact Formal Assurance Report Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-formal-assurance-report/SKILL.md"
  source_sha256: "sha256:04dedd945e3fe8b9e5ee9f059182cea6fb2eba56f56c3856888aa2687caa8d71"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "platform"
  runtime_handler_id: "execute_elmos_formal_assurance_report"
...
- Exact Skill identity: `elmos-formal-assurance-report`; exact allowlisted runtime handler: `execute_elmos_formal_assurance_report`.
- Source identity: `skills/P0/elmos-formal-assurance-report/SKILL.md` at `sha256:04dedd945e3fe8b9e5ee9f059182cea6fb2eba56f56c3856888aa2687caa8d71` from `elmos-formal-assurance-kernel-v1.0.0`.
...
生成面向工程、审计、客户和管理层的答案优先报告，准确展示证明范围、边界、假设、反例和残余风险。
...
3. Use the repository-owned `execute_elmos_formal_assurance_report` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["evidence-backed reporting","coverage stratification","machine-human consistency"]`
- Direct dependencies: `["elmos-proof-status-policy","elmos-proof-artifact-store","elmos-formal-release-gate"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-formal-assurance-report/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
