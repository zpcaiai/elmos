---
name: b95-lua-plugin-sandbox-capability-enforcer
description: "Use when ELMOS must run lua plugin sandbox capability enforcer for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG395"
  source_name: "lua-plugin-sandbox-capability-enforcer"
  source_sha256: "sha256:2c0399c3545f448c4fbd6d99747a34b9cb7fc15aa5e4efe1acb36bb724fbea1b"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG395 — Lua Plugin Sandbox Capability Enforcer

## 1. Objective

Enforce lua plugin sandbox capability enforcer within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
1. Resolve effective platform, tenant, workspace, project, and run-level policies before granting any capability.
2. Process the relevant artifacts for Lua Plugin Sandbox Capability Enforcer using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-plugin-sandbox-capability-enforcer.
