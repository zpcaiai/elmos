---
name: elmos-mcp-apps-a2ui-generator
description: Generate secure interactive agent interfaces for MCP Apps, A2UI and AG-UI from a common Interaction IR with capability
  negotiation and recoverable UI state.
version: 4.0.0
...
- `DeploymentUnit`
- `ConformanceRun`
- `MCPAppsAndA2UIGeneratorRun`
- `MCPAppsAndA2UIGeneratorDecision`

Required semantic capabilities:

- Declarative component allowlist
- Streaming UI state and action binding
- Host capability negotiation
- Approval-aware tool actions
- Accessibility, CSP and sandbox policy generation
...
- **XSS or script gadget** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **action parameter substitution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **UI state confusion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **clickjacking** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **host capability spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
