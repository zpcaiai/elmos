---
name: elmos-cross-scheme-claim-mapping-equivalence-verifier
...
# Cross-Scheme Claim Mapping and Equivalence Verifier
...
- `CrossSchemeClaimMappingAndEquivalenceVerifierProfile`
- `CrossSchemeClaimMappingAndEquivalenceVerifierRun`
- `CrossSchemeClaimMappingAndEquivalenceVerifierFinding`
- `CrossSchemeClaimMappingAndEquivalenceVerifierDecision`
- `CrossSchemeClaimMappingAndEquivalenceVerifierEvidence`

Required semantic capabilities:

- map claims, assurance levels, scopes and decision rules between certification schemes
- prove exact, stronger, weaker, overlapping or incomparable relationships
- prevent semantic loss during certificate translation
...
- `elmos-certificate-trust-registry-federation-controller`
- `elmos-assurance-case-confidence-quantifier`

## Primary Outputs

- `artifacts/elmos-cross-scheme-claim-mapping-equivalence-verifier/profile.yaml`
- `artifacts/elmos-cross-scheme-claim-mapping-equivalence-verifier/plan.json`
- `artifacts/elmos-cross-scheme-claim-mapping-equivalence-verifier/result.json`
- `artifacts/elmos-cross-scheme-claim-mapping-equivalence-verifier/evidence/`
- `artifacts/elmos-cross-scheme-claim-mapping-equivalence-verifier/assurance-case.json`
...
- **same label has different evidence threshold** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **partial overlap is marketed as equivalence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **waiver semantics disappear in mapping** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: map claims, assurance levels, scopes and decision rules between certification schemes
- native scenario: prove exact, stronger, weaker, overlapping or incomparable relationships
- native scenario: prevent semantic loss during certificate translation
