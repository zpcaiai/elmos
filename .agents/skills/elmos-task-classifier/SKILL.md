...
description: "Invoke the bounded repository handler for elmos-task-classifier while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P06:task-classifier"
  source_name: "elmos-task-classifier"
  installed_name: "elmos-task-classifier"
  source_logical_path: "06-elmos-intelligent-model-router/skills/task-classifier/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/06-elmos-intelligent-model-router/skills/task-classifier/SKILL.md.source-data"
  source_materialized_path: "06-elmos-intelligent-model-router/skills/task-classifier/SKILL.md.source-data"
  source_sha256: "sha256:fee222ffbf22fd3cc97de248dac6af36023b7294c9109cb6115f476a72e36d6a"
...
- This is a deterministic repository wrapper for `06-elmos-intelligent-model-router/skills/task-classifier/SKILL.md` at `sha256:fee222ffbf22fd3cc97de248dac6af36023b7294c9109cb6115f476a72e36d6a`.
- Its immutable source/runtime identity is `elmos-task-classifier`; its active installed identity is `elmos-task-classifier`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-task-classifier --request <file>
```
