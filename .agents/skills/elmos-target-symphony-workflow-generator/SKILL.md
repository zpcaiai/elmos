---
name: elmos-target-symphony-workflow-generator
description: Generate repository-versioned workflow policy, work-item adapters, isolated workspace contracts, retry/backoff,
  proof-of-work and handoff artifacts for coding orchestration.
version: 4.0.0
...
# TargetSymphonyWorkflowGenerator
...
- Generate versioned WORKFLOW policy
- Generate work-item adapters and isolated workspaces
- Generate reconciler/backoff/concurrency rules
- Generate proof-of-work and acceptance gates
- Run workspace loss and duplicate work recovery tests
...
- **work item double claim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **workspace cross-contamination** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **policy drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **proof-of-work spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **reconciler storm** — must have a preventive control, a detective signal, a negative fixture and a response action.
