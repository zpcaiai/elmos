---
name: b45-scale-performance-certification
description: "Implement and verify Batch 45 Skill 1480 for scale performance certification. Use when work requires \u8d85\u5927\u89c4\u6a21\u548c\u6027\u80fd\u8ba4\u8bc1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-scale-performance-certification`.
...
4. Implement the smallest production-shaped capability that exercises `超大规模和性能认证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-scale-performance-certification`
