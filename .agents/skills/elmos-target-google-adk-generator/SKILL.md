---
name: elmos-target-google-adk-generator
description: Generate Python, TypeScript, Java/Kotlin and Go ADK projects with agent teams, workflow agents, A2A, evaluation,
  sessions, artifacts and deployment profiles.
version: 4.0.0
...
- Generate supported-language ADK projects
- Generate sequential/parallel/loop workflows
- Generate tools, sessions and artifacts
- Generate A2A interfaces and deployment profile
- Generate ADK evaluation suites
...
- **workflow loop** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **artifact tenant leak** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **A2A card spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tool authority mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **language adapter divergence** — must have a preventive control, a detective signal, a negative fixture and a response action.
