...
triggers:
  - "Use when implementing or executing `elmos-time-randomness-nondeterminism-semantics`."
  - "Use when a migration/certification DAG requires `nondeterminism` capability."
outputs:
  - "semantic-assurance/elmos-time-randomness-nondeterminism-semantics/model.json"
  - "semantic-assurance/elmos-time-randomness-nondeterminism-semantics/evidence.json"
  - "semantic-assurance/elmos-time-randomness-nondeterminism-semantics/diagnostics.json"
---

# Time, Randomness & Nondeterminism Semantics

## Objective

Identify and control clocks, RNG, UUIDs, hash seeds, scheduler order and other nondeterministic inputs to enable fair differential execution.
...
- **seed capture.**
- **UUID/random streams.**
- **hash iteration/scheduler noise.**
...
- [ ] nondeterministic output classifier.
