---
name: b39-sla-service-credit-governance
description: "Implement and verify Batch 39 Skill 1365 for sla service credit governance. Use when work requires \u5ba2\u6237SLA\u548c\u670d\u52a1Credit\u6cbb\u7406, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b39-sla-service-credit-governance`.
...
4. Implement the smallest production-shaped capability that exercises `客户SLA和服务Credit治理` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b39-sla-service-credit-governance`
