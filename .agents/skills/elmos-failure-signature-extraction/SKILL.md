---
name: failure-signature-extraction
description: Use this skill when Elmos must perform failure signature extraction as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
