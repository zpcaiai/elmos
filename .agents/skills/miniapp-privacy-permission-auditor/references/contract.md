# miniapp-privacy-permission-auditor — 执行契约

## 调用边界

- 阶段：`validation`
- 任务 ID：MAPP-029, MAPP-030
- 上游技能：miniapp-capability-registry, miniapp-third-party-dependency-migrator, wechat-miniapp-codegen, alipay-miniapp-codegen, douyin-miniapp-codegen, xiaohongshu-miniapp-codegen
...
```json
{
  "artifact_id": "miniapp-privacy-permission-auditor:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "miniapp-privacy-permission-auditor",
  "task_id": "MAPP-029",
  "status": "passed"
}
```
