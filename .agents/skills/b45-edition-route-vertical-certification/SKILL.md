---
name: b45-edition-route-vertical-certification
description: "Implement and verify Batch 45 Skill 1495 for edition route vertical certification. Use when work requires Edition\u3001\u8def\u7ebf\u548c\u884c\u4e1a\u4ea7\u54c1\u8ba4\u8bc1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-edition-route-vertical-certification`.
...
4. Implement the smallest production-shaped capability that exercises `Edition、路线和行业产品认证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-edition-route-vertical-certification`
