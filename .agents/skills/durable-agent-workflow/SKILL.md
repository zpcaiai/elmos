...
description: "Repository-owned bounded wrapper for durable-agent-workflow; external evidence remains NOT_RUN."
---
...
4. Submit `durable-agent-workflow` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `8a83cdc73f7d0fb7119672628cc127c7c247631962bf99c9df57c7d72e06066d`
