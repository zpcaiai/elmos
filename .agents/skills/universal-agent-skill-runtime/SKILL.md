...
- Activate when the task requires: make Agent Skills first-class executable, versioned, discoverable assets with instructions, resources, scripts and policy metadata.
