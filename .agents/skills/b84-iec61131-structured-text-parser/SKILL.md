---
name: b84-iec61131-structured-text-parser
description: "Use when ELMOS must run iec61131 structured text parser for Batch 84 IEC 61131-3 PLC Languages Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG260"
  source_name: "iec61131-structured-text-parser"
  source_sha256: "sha256:7958a00eee8ff1632e354960650576a76bfb698ad5fd34840f2cd53c340da2ab"
  batch: 84
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 84 Language Pack / source PG260 — Iec61131 Structured Text Parser

## 1. Objective

Parse and semantically index iec61131 structured text parser within the IEC 61131-3 PLC Languages Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Iec61131 Structured Text Parser using the approved industrial-control semantic contracts and toolchain versions.
...
- A representative valid iec61131-plc input produces all declared outputs for iec61131-structured-text-parser.
