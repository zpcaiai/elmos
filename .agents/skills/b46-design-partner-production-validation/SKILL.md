---
name: b46-design-partner-production-validation
description: 要求两家独立客户完成P0切片、Canary、Rollback演练、Handoff和客户签字。
---

# Skill 1532：两家Design Partner生产验证
...
要求两家独立客户完成P0切片、Canary、Rollback演练、Handoff和客户签字。
...
- 两家客户必须完成真实生产Canary或等价授权生产验证，不得使用同一组织多个项目冒充。
...
- `design-partners/evidence/`
- `tests/design-partner/`
