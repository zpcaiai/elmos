---
name: elmos-rag-citation-provenance-chain-verifier
description: Verify every answer claim through chunk, document version, source system, ACL, transformation and retrieval lineage with tamper evidence.
version: 4.0.0
...
# RAG Citation Provenance Chain Verifier
...
- `RAGCitationProvenanceChainVerifierProfile`
- `RAGCitationProvenanceChainVerifierPlan`
- `RAGCitationProvenanceChainVerifierRun`
- `RAGCitationProvenanceChainVerifierDecision`

Required semantic capabilities:

- map claims to exact retrieved spans
- verify document version and source identity
- check ACL at query and evidence time
- detect citation laundering through summaries
- seal provenance chain and deletion impact
...
- `artifacts/elmos-rag-citation-provenance-chain-verifier/profile.yaml`
- `artifacts/elmos-rag-citation-provenance-chain-verifier/plan.json`
- `artifacts/elmos-rag-citation-provenance-chain-verifier/result.json`
- `artifacts/elmos-rag-citation-provenance-chain-verifier/evidence/`
...
- **citation points to irrelevant span** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **summary breaks source lineage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **source changed after answer** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ACL revoked but cached citation served** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence chain tampered** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: map claims to exact retrieved spans
- native scenario: verify document version and source identity
- native scenario: check ACL at query and evidence time
- native scenario: detect citation laundering through summaries
- native scenario: seal provenance chain and deletion impact
