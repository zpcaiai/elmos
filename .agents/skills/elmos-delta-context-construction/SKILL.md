---
name: delta-context-construction
description: Use this skill when Elmos must perform delta context construction as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# delta-context-construction

## 能力目标

只注入自上次检查点以来的语义变化，减少长任务重复上下文。
