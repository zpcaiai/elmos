...
triggers:
  - "Use when implementing or executing `elmos-cfg-equivalence-builder`."
  - "Use when a migration/certification DAG requires `controlflow-semantics` capability."
outputs:
  - "semantic-assurance/elmos-cfg-equivalence-builder/model.json"
  - "semantic-assurance/elmos-cfg-equivalence-builder/evidence.json"
  - "semantic-assurance/elmos-cfg-equivalence-builder/diagnostics.json"
---

# Control-Flow Graph Equivalence Builder

## Objective

Build normalized source/target CFGs and compare branch, loop, early-exit and exceptional control-flow structure.
...
- [ ] nested loop fixture.
- [ ] goto/label legacy fixture.
- [ ] short-circuit branch fixture.
