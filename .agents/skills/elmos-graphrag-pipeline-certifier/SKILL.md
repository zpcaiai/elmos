---
name: elmos-graphrag-pipeline-certifier
description: Certify graph construction, community/entity retrieval, path grounding, citations, updates, deletion and performance for GraphRAG implementations.
version: 4.0.0
...
- `GraphRAGPipelineCertifierProfile`
- `GraphRAGPipelineCertifierPlan`
- `GraphRAGPipelineCertifierRun`
- `GraphRAGPipelineCertifierDecision`

Required semantic capabilities:

- validate extraction and graph build quality
- measure graph retrieval recall and path precision
- verify claims to node/edge/source provenance
- test incremental update and deletion
- benchmark graph/vector/hybrid cost and latency
...
- `elmos-knowledge-graph-ontology-ir-compiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-graphrag-pipeline-certifier/profile.yaml`
- `artifacts/elmos-graphrag-pipeline-certifier/plan.json`
- `artifacts/elmos-graphrag-pipeline-certifier/result.json`
- `artifacts/elmos-graphrag-pipeline-certifier/evidence/`
...
- **graph hallucinated relation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **community summary stale** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **citation stops at generated node** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deletion leaves derived edge** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **benchmark corpus favors graph method** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: validate extraction and graph build quality
- native scenario: measure graph retrieval recall and path precision
- native scenario: verify claims to node/edge/source provenance
- native scenario: test incremental update and deletion
- native scenario: benchmark graph/vector/hybrid cost and latency
