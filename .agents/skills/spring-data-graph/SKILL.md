---
name: spring-data-graph
description: 连接 Entity、Repository、JPQL/HQL/native SQL、schema、Migration 和事务。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-037
  source_name: spring-data-graph
  source_path: skills/spring-data-graph/SKILL.md
  source_sha256: sha256:441417f91db2278c1d6c942e844da73ae5acc822ad27ec07e638f6cea2671501
  source_contract_sha256: sha256:05c35e809e6eb77e7538b3845ba7cdf2a5624f413b2b12bdd48be6f1b39180f1
...
# Data ORM Query Graph

## Objective

连接 Entity、Repository、JPQL/HQL/native SQL、schema、Migration 和事务。

## Scope and capabilities

- Mapping/converter/inheritance
- Query inventory
- Read/write set
- Flyway/Liquibase
- Null/timezone/locking 风险
...
- [ ] 定义 `spring-data-graph` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-data-graph` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：data-graph.json, query-inventory.json, schema-contract.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：data-graph.json, query-inventory.json, schema-contract.json。
...
- Machine contract: `references/contract.json` (`sha256:05c35e809e6eb77e7538b3845ba7cdf2a5624f413b2b12bdd48be6f1b39180f1`).
