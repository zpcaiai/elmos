---
name: elmos-ai-golden-route-portable-skill
description: Certify repository or runbook to portable Skill IR and host packages across Agent Skills, OpenAI Plugin, Codex,
  Claude Code, Pi and OpenClaw.
version: 4.0.0
...
# Golden Route: Portable Agent Skill
...
- `GoldenRoutePortableAgentSkillRun`
- `GoldenRoutePortableAgentSkillDecision`

Required semantic capabilities:

- Source capability recovery
- Skill IR compilation
- Multi-host emission
- Trigger and behavior differential evaluation
- Supply-chain and customer certification
...
- `golden-routes/portable-skill/evidence/`
- `portable-skill-certificate.json`
- `cross-host-traces/`
...
- **host-specific overclaim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **test set leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **self-certification** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsigned artifact** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale host evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- three repeated builds
- hidden trigger set
- cross-host trace equivalence
- malicious package negative
- upgrade/rollback
- customer acceptance
