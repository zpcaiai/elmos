...
description: "Implement and verify Batch 43 Skill 1442 for recipe pack extension compatibility. Use when work requires Recipe\u3001Pack\u548cExtension\u517c\u5bb9\u6cbb\u7406, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Recipe、Pack和Extension兼容治理
...
## Skill 1442: Recipe、Pack和Extension兼容治理
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-recipe-pack-extension-compatibility`.
...
4. Implement the smallest production-shaped capability that exercises `Recipe、Pack和Extension兼容治理` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-recipe-pack-extension-compatibility`
