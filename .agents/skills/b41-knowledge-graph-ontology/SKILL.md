---
name: b41-knowledge-graph-ontology
description: "Implement and verify Batch 41 Skill 1394 for knowledge graph ontology. Use when work requires Migration Knowledge Graph Ontology, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Migration Knowledge Graph Ontology
...
## Skill 1394: Migration Knowledge Graph Ontology
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-knowledge-graph-ontology`.
...
4. Implement the smallest production-shaped capability that exercises `Migration Knowledge Graph Ontology` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-knowledge-graph-ontology`
