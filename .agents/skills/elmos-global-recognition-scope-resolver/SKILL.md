---
name: elmos-global-recognition-scope-resolver
description: Implement and independently certify global accreditation and mutual recognition scope resolver, including resolve current global, regional and national recognition arrangements and exact scopes, distinguish accredited result acceptance from product-market authorization and emit jurisdiction-specific recognition limitations and transition handling.
version: 4.0.0
...
# Global Accreditation and Mutual Recognition Scope Resolver
...
- `GlobalAccreditationAndMutualRecognitionScopeResolverProfile`
- `GlobalAccreditationAndMutualRecognitionScopeResolverRun`
- `GlobalAccreditationAndMutualRecognitionScopeResolverFinding`
- `GlobalAccreditationAndMutualRecognitionScopeResolverDecision`
- `GlobalAccreditationAndMutualRecognitionScopeResolverEvidence`

Required semantic capabilities:

- resolve current global, regional and national recognition arrangements and exact scopes
- distinguish accredited result acceptance from product-market authorization
- emit jurisdiction-specific recognition limitations and transition handling
...
- `elmos-accreditation-evidence-readiness-exporter`

## Primary Outputs

- `artifacts/elmos-global-recognition-scope-resolver/profile.yaml`
- `artifacts/elmos-global-recognition-scope-resolver/plan.json`
- `artifacts/elmos-global-recognition-scope-resolver/result.json`
- `artifacts/elmos-global-recognition-scope-resolver/evidence/`
- `artifacts/elmos-global-recognition-scope-resolver/assurance-case.json`
...
- **recognition logo treated as universal market approval** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **obsolete IAF or ILAC status used after institutional transition** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **scope of signatory recognition is wider than accredited activity** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: resolve current global, regional and national recognition arrangements and exact scopes
- native scenario: distinguish accredited result acceptance from product-market authorization
- native scenario: emit jurisdiction-specific recognition limitations and transition handling
