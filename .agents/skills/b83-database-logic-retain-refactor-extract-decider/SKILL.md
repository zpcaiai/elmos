---
name: b83-database-logic-retain-refactor-extract-decider
description: "Use when ELMOS must run database logic retain refactor extract decider for Batch 83 PL/SQL / T-SQL / PL/pgSQL / SQL PL Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG254"
  source_name: "database-logic-retain-refactor-extract-decider"
  source_sha256: "sha256:43dd6911b17a763fe6cc62bfef040be63c925a8a179fb7733acfcd4cd6e6e8b1"
  batch: 83
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 83 Language Pack / source PG254 — Database Logic Retain Refactor Extract Decider

## 1. Objective

Generate database logic retain refactor extract decider within the PL/SQL / T-SQL / PL/pgSQL / SQL PL Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Database Logic Retain Refactor Extract Decider using the approved database-programming semantic contracts and toolchain versions.
...
- A representative valid database-procedural input produces all declared outputs for database-logic-retain-refactor-extract-decider.
