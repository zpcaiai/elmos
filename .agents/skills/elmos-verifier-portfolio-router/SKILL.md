---
name: "elmos-verifier-portfolio-router"
description: "根据逻辑片段、语言语义、并发特征、许可证、资源预算和证据强度选择单个或组合证明器。 Use when the task needs the exact Verifier Portfolio Router Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-verifier-portfolio-router/SKILL.md"
  source_sha256: "sha256:441e57f428843c3eed1a1399e81ffec39f1b18d5205f273a9ef75bc645ff6980"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "core"
  runtime_handler_id: "execute_elmos_verifier_portfolio_router"
...
---
# Verifier Portfolio Router

## Repository integration boundary

- Exact Skill identity: `elmos-verifier-portfolio-router`; exact allowlisted runtime handler: `execute_elmos_verifier_portfolio_router`.
- Source identity: `skills/P0/elmos-verifier-portfolio-router/SKILL.md` at `sha256:441e57f428843c3eed1a1399e81ffec39f1b18d5205f273a9ef75bc645ff6980` from `elmos-formal-assurance-kernel-v1.0.0`.
...
根据逻辑片段、语言语义、并发特征、许可证、资源预算和证据强度选择单个或组合证明器。
...
3. Use the repository-owned `execute_elmos_verifier_portfolio_router` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["capability matching","portfolio solving","cross-checking","timeout escalation"]`
- Direct dependencies: `["elmos-proof-obligation-planner","elmos-proof-status-policy","elmos-trusted-computing-base-registry"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-verifier-portfolio-router/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
