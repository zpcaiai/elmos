---
name: repo-mrloc
description: 区分 Gross、First-party、Production、Test、Config、Generated/Vendor 并计算 MRLOC。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-017
  source_name: repo-mrloc
  source_path: skills/repo-mrloc/SKILL.md
  source_sha256: sha256:f8e994c50e6dee47b70027de2dd829c65c27d41bef8e188cbf8235e798f50955
  source_contract_sha256: sha256:2644d98765d925bca4a759bedce2cae752ab266ca6abfa2120ee5b9f19a2ba97
...
# Migration-Relevant LOC

## Objective

区分 Gross、First-party、Production、Test、Config、Generated/Vendor 并计算 MRLOC。

## Scope and capabilities

- 代码/测试/配置/SQL/构建脚本纳入
- vendor/generated/build outputs/docs 排除
- 分类置信度与审计
- 独立重算
...
- [ ] 定义 `repo-mrloc` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `repo-mrloc` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：repository-profile.json, loc-by-category.csv, exclusion-evidence.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：repository-profile.json, loc-by-category.csv, exclusion-evidence.json。
...
- Machine contract: `references/contract.json` (`sha256:2644d98765d925bca4a759bedce2cae752ab266ca6abfa2120ee5b9f19a2ba97`).
