...
## Objective
Index definitions, references, implementations, symbols and types using compiler/LSP/SCIP-grade semantic information.
...
- Activate when the task requires: index definitions, references, implementations, symbols and types using compiler/LSP/SCIP-grade semantic information.
