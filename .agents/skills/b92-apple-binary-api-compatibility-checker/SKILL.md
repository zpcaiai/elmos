---
name: b92-apple-binary-api-compatibility-checker
description: "Use when ELMOS must run apple binary api compatibility checker for Batch 92 Objective-C to Swift Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG365"
  source_name: "apple-binary-api-compatibility-checker"
  source_sha256: "sha256:3df7a6ea147ec4e3505d4f3cd105588557b38eea7991a772fbf12199859b8e14"
  batch: 92
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 92 Language Pack / source PG365 — Apple Binary API Compatibility Checker

## 1. Objective

Verify apple binary api compatibility checker within the Objective-C to Swift Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Apple Binary API Compatibility Checker using the approved apple-legacy semantic contracts and toolchain versions.
...
- A representative valid objective-c-swift input produces all declared outputs for apple-binary-api-compatibility-checker.
