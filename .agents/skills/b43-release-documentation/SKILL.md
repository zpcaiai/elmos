---
name: b43-release-documentation
description: "Implement and verify Batch 43 Skill 1453 for release documentation. Use when work requires Changelog\u3001Release Note\u548cMigration Guide, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Changelog、Release Note和Migration Guide
...
## Skill 1453: Changelog、Release Note和Migration Guide
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-release-documentation`.
...
4. Implement the smallest production-shaped capability that exercises `Changelog、Release Note和Migration Guide` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-release-documentation`
