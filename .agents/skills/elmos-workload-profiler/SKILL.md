...
- Source group: `database-intelligence`. Dependencies: `["elmos-data-requirement-intake"]`. Triggers: `["存在样例数据或现有数据库", "选型需要证据", "需要容量或性能规划"]`. Declared outputs: `["data-profile.json", "query-profile.json", "skew-and-hotspot-report.md"]`.
