---
name: b38-multiregion-active-active-edition
description: "Implement and verify Batch 38 Skill 1335 for multiregion active active edition. Use when work requires Multi-region Active/Active Edition, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Multi-region Active/Active Edition
...
## Skill 1335: Multi-region Active/Active Edition
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-multiregion-active-active-edition`.
...
4. Implement the smallest production-shaped capability that exercises `Multi-region Active/Active Edition` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-multiregion-active-active-edition`
