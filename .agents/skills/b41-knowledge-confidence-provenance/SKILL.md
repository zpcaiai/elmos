---
name: b41-knowledge-confidence-provenance
description: "Implement and verify Batch 41 Skill 1405 for knowledge confidence provenance. Use when work requires \u77e5\u8bc6\u7f6e\u4fe1\u5ea6\u3001Evidence\u548cProvenance, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 知识置信度、Evidence和Provenance
...
## Skill 1405: 知识置信度、Evidence和Provenance
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-knowledge-confidence-provenance`.
...
4. Implement the smallest production-shaped capability that exercises `知识置信度、Evidence和Provenance` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-knowledge-confidence-provenance`
