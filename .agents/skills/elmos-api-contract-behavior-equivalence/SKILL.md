...
triggers:
  - "Use when implementing or executing `elmos-api-contract-behavior-equivalence`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-api-contract-behavior-equivalence/model.json"
  - "semantic-assurance/elmos-api-contract-behavior-equivalence/evidence.json"
  - "semantic-assurance/elmos-api-contract-behavior-equivalence/diagnostics.json"
---

# API Contract & Behavior Equivalence

## Objective

Verify status/error mapping, validation, pagination, authentication, compatibility and schema behavior at public APIs.
