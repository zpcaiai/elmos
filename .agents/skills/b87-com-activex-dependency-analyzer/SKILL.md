---
name: b87-com-activex-dependency-analyzer
description: "Use when ELMOS must run com activex dependency analyzer for Batch 87 VB6 / VBA / VB.NET / Office Automation Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG297"
  source_name: "com-activex-dependency-analyzer"
  source_sha256: "sha256:9c56c0f2ea4b21e868bc315f56aa94bd0f09b06cc8b86809beca15042bbfdfc9"
  batch: 87
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 87 Language Pack / source PG297 — Com Activex Dependency Analyzer

## 1. Objective

Analyze com activex dependency analyzer within the VB6 / VBA / VB.NET / Office Automation Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Com Activex Dependency Analyzer using the approved windows-legacy semantic contracts and toolchain versions.
...
- A representative valid vb-office input produces all declared outputs for com-activex-dependency-analyzer.
