---
name: b83-database-program-unit-discovery
description: "Use when ELMOS must run database program unit discovery for Batch 83 PL/SQL / T-SQL / PL/pgSQL / SQL PL Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG247"
  source_name: "database-program-unit-discovery"
  source_sha256: "sha256:b29a5e5cd71d0e129871d8f869f0422058e323dabf64db114e2f84f1278bf8e9"
  batch: 83
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 83 Language Pack / source PG247 — Database Program Unit Discovery

## 1. Objective

Discover and inventory database program unit discovery within the PL/SQL / T-SQL / PL/pgSQL / SQL PL Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Database Program Unit Discovery using the approved database-programming semantic contracts and toolchain versions.
...
- A representative valid database-procedural input produces all declared outputs for database-program-unit-discovery.
