---
name: b43-support-eol-policy
description: "Implement and verify Batch 43 Skill 1445 for support eol policy. Use when work requires \u652f\u6301\u5468\u671f\u548cEnd-of-Life\u653f\u7b56, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b43-support-eol-policy`.
...
4. Implement the smallest production-shaped capability that exercises `支持周期和End-of-Life政策` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b43-support-eol-policy`
