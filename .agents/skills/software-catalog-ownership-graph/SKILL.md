---
name: software-catalog-ownership-graph
description: "Repository-owned bounded wrapper for software-catalog-ownership-graph; external evidence remains NOT_RUN."
---
...
Track component ownership, lifecycle, documentation, interfaces, dependencies and operational metadata for enterprise-scale repositories.
...
4. Submit `software-catalog-ownership-graph` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `fa63a47ce8941ac12899af8272ff3f856f30a516c0917ffb01e00cb37c451cba`
