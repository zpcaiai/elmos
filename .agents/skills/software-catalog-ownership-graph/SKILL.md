...
- Activate when the task requires: track component ownership, lifecycle, documentation, interfaces, dependencies and operational metadata for enterprise-scale repositories.
