...
metadata:
  ...
  source_sha256: sha256:f6a72366638d77cbf6105588aeccec9b10cbdc11e205ab816f690eb0b321312e
  normalized_namespace: product-convergence-overlay
  source_batch_label: package-local-batch46-product-convergence
---

# Skill 1535：Reference Product综合验收评审
...
组织产品、架构、安全、数据、运维、商业和客户Owner评审全部收敛成果。
...
- 评审人必须独立于主要实现者；所有Waiver有Owner、期限和补救计划。
...
- `certification/reference-product/review/`
