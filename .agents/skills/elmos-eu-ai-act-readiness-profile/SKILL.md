---
name: eu-ai-act-readiness-profile
description: Use this skill when Elmos must perform eu ai act readiness profile as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# eu-ai-act-readiness-profile

## 能力目标

按产品角色和风险场景维护透明度、文档、监控和事件响应准备度。
