---
name: b35-assurance-case-residual-risk
description: Build structured assurance cases linking claims arguments evidence limitations assumptions residual risk owner acceptance and monitoring for migrated workloads.
---
...
## Skill 1285: b35-assurance-case-residual-risk

## Use this skill when

- A production or regulated migration needs decision-ready assurance rather than raw test logs.

## Domain-specific risks and invariants

- An assurance case can become persuasive prose disconnected from evidence.

## Workflow

1. Define claims, subclaims, arguments, contexts, assumptions, defeaters, evidence, limitations, and owners.
2. Link every claim to immutable verification evidence.
3. Identify unsupported or circular claims.
4. Record residual risks, compensating controls, monitoring, expiry, and acceptance authority.
5. Run independent review for P0 claims.
6. Generate human-readable and machine-readable assurance artifacts.
...
- Create decision-ready evidence for business engineering security data operations and regulated stakeholders.
...
- Assurance case graph, evidence links, unsupported claims, residual risks, monitoring obligations, and signed decisions.
