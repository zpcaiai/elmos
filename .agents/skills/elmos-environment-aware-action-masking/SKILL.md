---
name: environment-aware-action-masking
description: Use this skill when Elmos must perform environment aware action masking as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# environment-aware-action-masking

## 能力目标

根据权限、状态、风险和依赖动态屏蔽非法或无效动作。
