...
metadata:
  ...
  repository_handler_id: "handle_elmos_template_log_observability"
...
- Source group: `bigdata-templates`. Dependencies: `["elmos-bigdata-project-orchestrator"]`. Triggers: `["日志平台", "可观测性数据湖", "安全分析/SIEM"]`. Declared outputs: `["template-plan.json", "generated-project/"]`. Stable task IDs: `["TPLOBS-001", "TPLOBS-002", "TPLOBS-003", "TPLOBS-004", "TPLOBS-005", "TPLOBS-006", "TPLOBS-007", "TPLOBS-008", "TPLOBS-009", "TPLOBS-010", "TPLOBS-011", "TPLOBS-012"]`.
- This normalized Skill is installed and invocable. The repository binds `handle_elmos_template_log_observability` in `engines/database-bigdata-engine/src/elmos_database_bigdata/handlers/templates.py` as a bounded plan-skeleton entry point; the reviewed code declares no database, provider, network, deployment, benchmark, mutation, or certification operation.
