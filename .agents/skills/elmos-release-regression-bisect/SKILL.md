---
name: release-regression-bisect
description: Use this skill when Elmos must perform release regression bisect as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# release-regression-bisect

## 能力目标

在模型、Skill、知识、工具和策略组合中自动定位回归来源。
