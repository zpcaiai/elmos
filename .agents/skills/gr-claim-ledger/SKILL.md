---
name: gr-claim-ledger
description: 将每个完成、安全、性能和兼容性声明映射到精确 Evidence。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-068
  source_name: gr-claim-ledger
  source_path: skills/gr-claim-ledger/SKILL.md
  source_sha256: sha256:58e8e218e4994a87c373b93559ba10303ae98f9dd706536c0fb3dec68ded3080
  source_contract_sha256: sha256:45b8d97ffaa913e01a9453dc04e2b92aa091151e28713ced2f117fdc068fca86
...
将每个完成、安全、性能和兼容性声明映射到精确 Evidence。
...
- [ ] 定义 `gr-claim-ledger` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-claim-ledger` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：claim-ledger.json, traceability-matrix.json, stale-alerts。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：claim-ledger.json, traceability-matrix.json, stale-alerts。
...
- Machine contract: `references/contract.json` (`sha256:45b8d97ffaa913e01a9453dc04e2b92aa091151e28713ced2f117fdc068fca86`).
