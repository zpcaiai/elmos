---
name: elmos-backward-compatible-regeneration-merge-controller
description: Regenerate projects after requirement/template/framework changes using semantic three-way merge, user-region ownership and compatibility gates.
version: 4.0.0
...
# Backward-Compatible Regeneration and Merge Controller
...
- `BackwardCompatibleRegenerationAndMergeControllerProfile`
- `BackwardCompatibleRegenerationAndMergeControllerPlan`
- `BackwardCompatibleRegenerationAndMergeControllerRun`
- `BackwardCompatibleRegenerationAndMergeControllerDecision`

Required semantic capabilities:

- diff prior IR, target profile and generated tree
- classify generated, user and shared ownership
- perform semantic merge with conflict artifacts
- run compatibility and migration tests
- retain rollback revision and evidence
...
- `artifacts/elmos-backward-compatible-regeneration-merge-controller/profile.yaml`
- `artifacts/elmos-backward-compatible-regeneration-merge-controller/plan.json`
- `artifacts/elmos-backward-compatible-regeneration-merge-controller/result.json`
- `artifacts/elmos-backward-compatible-regeneration-merge-controller/evidence/`
...
- **user edit overwritten** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated region manually modified undetected** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **conflict auto-resolved semantically wrong** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **old migration deleted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback depends on unavailable template** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: diff prior IR, target profile and generated tree
- native scenario: classify generated, user and shared ownership
- native scenario: perform semantic merge with conflict artifacts
- native scenario: run compatibility and migration tests
- native scenario: retain rollback revision and evidence
