---
name: "elmos-language-semantic-profile"
description: "为每种源/目标语言定义 Elmos 可证明子集、数值模型、内存模型、异常、并发、I/O、反射和未定义行为边界。 Use when the task needs the exact Language Semantic Profile Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-language-semantic-profile/SKILL.md"
  source_sha256: "sha256:d2b8e1f530328377b03ddf33d28346a92edac6021aedd9c4a67dc653729fdff5"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "cross-language"
  runtime_handler_id: "execute_elmos_language_semantic_profile"
...
- Exact Skill identity: `elmos-language-semantic-profile`; exact allowlisted runtime handler: `execute_elmos_language_semantic_profile`.
- Source identity: `skills/P0/elmos-language-semantic-profile/SKILL.md` at `sha256:d2b8e1f530328377b03ddf33d28346a92edac6021aedd9c4a67dc653729fdff5` from `elmos-formal-assurance-kernel-v1.0.0`.
...
3. Use the repository-owned `execute_elmos_language_semantic_profile` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["formal language profiles","feature capability lattice","closed-world declarations"]`
- Direct dependencies: `["elmos-formal-spec-ir","elmos-assumption-ledger"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-language-semantic-profile/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
