---
name: elmos-certification-ethics-whistleblower-protection-governor
description: Implement and independently certify certification ethics and whistleblower protection governor, including define ethics code, reporting channels, anti-retaliation and investigation independence, protect evidence and reporter identity while ensuring due process and link substantiated ethics issues to competence, impartiality and certificate review.
version: 4.0.0
...
# Certification Ethics and Whistleblower Protection Governor
...
- `CertificationEthicsAndWhistleblowerProtectionGovernorProfile`
- `CertificationEthicsAndWhistleblowerProtectionGovernorRun`
- `CertificationEthicsAndWhistleblowerProtectionGovernorFinding`
- `CertificationEthicsAndWhistleblowerProtectionGovernorDecision`
- `CertificationEthicsAndWhistleblowerProtectionGovernorEvidence`

Required semantic capabilities:

- define ethics code, reporting channels, anti-retaliation and investigation independence
- protect evidence and reporter identity while ensuring due process
- link substantiated ethics issues to competence, impartiality and certificate review
...
- `elmos-conformity-assessment-impartiality-risk-governor`
- `elmos-complaint-appeal-dispute-resolution-governor`

## Primary Outputs

- `artifacts/elmos-certification-ethics-whistleblower-protection-governor/profile.yaml`
- `artifacts/elmos-certification-ethics-whistleblower-protection-governor/plan.json`
- `artifacts/elmos-certification-ethics-whistleblower-protection-governor/result.json`
- `artifacts/elmos-certification-ethics-whistleblower-protection-governor/evidence/`
- `artifacts/elmos-certification-ethics-whistleblower-protection-governor/assurance-case.json`
...
- **retaliation suppresses adverse evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **anonymous report is discarded automatically** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ethics investigation is controlled by implicated manager** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define ethics code, reporting channels, anti-retaliation and investigation independence
- native scenario: protect evidence and reporter identity while ensuring due process
- native scenario: link substantiated ethics issues to competence, impartiality and certificate review
