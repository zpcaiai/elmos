---
name: gr-pilot-selection
description: 选择有升级预算、测试、代表复杂度、技术 champion 和可控 staging 的首批客户。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-087
  source_name: gr-pilot-selection
  source_path: skills/gr-pilot-selection/SKILL.md
  source_sha256: sha256:bad98e4dc405e9f4ff873dbfaa99c3f89436d25ca095e9212e3a89b988db2ab0
  source_contract_sha256: sha256:8dc71a5c674a076d9ddee50cde122e5e4633ebebdd5c4ad3750fa169b15da3c1
...
# Paid Pilot Selection

## Objective

选择有升级预算、测试、代表复杂度、技术 champion 和可控 staging 的首批客户。
...
- Maven/Spring fit
- Budget/owner
- Data access/security feasibility
- 3+ independent customer diversity
...
- pilot-selection-scorecard.json
...
- [ ] 定义 `gr-pilot-selection` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-pilot-selection` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：pilot-selection-scorecard.json, selected-cohort.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：pilot-selection-scorecard.json, selected-cohort.json。
...
- Machine contract: `references/contract.json` (`sha256:8dc71a5c674a076d9ddee50cde122e5e4633ebebdd5c4ad3750fa169b15da3c1`).
