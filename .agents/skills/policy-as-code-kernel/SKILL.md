...
- Activate when the task requires: centralize model/tool/file/network/build/deploy/data/approval decisions in auditable policy-as-code rather than scattered application conditionals.
