---
name: skill-efficiency-evaluation
description: Use this skill when Elmos must perform skill efficiency evaluation as part of the 05-skill-foundry-runtime production
...
衡量 Token、工具次数、重试、Wall-clock、缓存和成本效率。
