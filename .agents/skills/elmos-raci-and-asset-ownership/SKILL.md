---
name: raci-and-asset-ownership
description: Use this skill when Elmos must perform raci and asset ownership as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# raci-and-asset-ownership

## 能力目标

为知识、Skill、数据集、模型、策略、发布和事件明确 RACI。
