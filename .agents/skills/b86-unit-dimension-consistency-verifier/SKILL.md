---
name: b86-unit-dimension-consistency-verifier
description: "Use when ELMOS must run unit dimension consistency verifier for Batch 86 Modelica / FMI / FMU Digital Twin Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG286"
  source_name: "unit-dimension-consistency-verifier"
  source_sha256: "sha256:e4489fdbc0d0450696d6d6762cd6e1fce4b0934989985f824f0e559903784f98"
  batch: 86
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 86 Language Pack / source PG286 — Unit Dimension Consistency Verifier

## 1. Objective

Verify unit dimension consistency verifier within the Modelica / FMI / FMU Digital Twin Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Unit Dimension Consistency Verifier using the approved physical-modeling semantic contracts and toolchain versions.
...
- A representative valid modelica-fmi input produces all declared outputs for unit-dimension-consistency-verifier.
