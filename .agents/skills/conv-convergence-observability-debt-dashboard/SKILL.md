...
metadata:
  ...
  source_sha256: sha256:3bd566386c8112e5562578f4888a828c6ecf97ddf7abdfcecd3962d9fd68ab91
  normalized_namespace: product-convergence-overlay
  source_batch_label: package-local-batch46-product-convergence
---

# Skill 1531：产品收敛可观测性与重复债务驾驶舱
...
监控平行内核、重复Skill、未映射Pack、过期Evidence、手工Patch和Convergence Debt。
...
- 必须量化重复Skill、平行Kernel、未映射Pack、过期Evidence、客户Patch和手工步骤。
...
- `services/observability/convergence/`
- `apps/web/src/features/convergence-debt/`
