---
name: compile-test-and-runtime-verification
description: Use this skill when Elmos must perform compile test and runtime verification as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# compile-test-and-runtime-verification

## 能力目标

执行构建、单测、集成、端到端、契约、部署和真实运行检查。
