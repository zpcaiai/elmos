---
name: elmos-zero-trust-service-identity-policy-compiler
description: Compile workload identity, mTLS, audience, delegation, authorization and rotation policies for agents, tools, services and customer runners.
version: 4.0.0
...
# Zero-Trust Service Identity Policy Compiler
...
- `ZeroTrustServiceIdentityPolicyCompilerProfile`
- `ZeroTrustServiceIdentityPolicyCompilerPlan`
- `ZeroTrustServiceIdentityPolicyCompilerRun`
- `ZeroTrustServiceIdentityPolicyCompilerDecision`

Required semantic capabilities:

- map human, agent, workload and service identities
- issue least-privilege audience-bound credentials
- generate mTLS and authorization policy
- rotate and revoke without downtime
- verify cross-tenant and confused-deputy resistance
...
- `artifacts/elmos-zero-trust-service-identity-policy-compiler/profile.yaml`
- `artifacts/elmos-zero-trust-service-identity-policy-compiler/plan.json`
- `artifacts/elmos-zero-trust-service-identity-policy-compiler/result.json`
- `artifacts/elmos-zero-trust-service-identity-policy-compiler/evidence/`
...
- **shared workload identity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **token audience too broad** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **certificate rotation breaks recovery** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **delegation expands scope** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **identity metadata spoofed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: map human, agent, workload and service identities
- native scenario: issue least-privilege audience-bound credentials
- native scenario: generate mTLS and authorization policy
- native scenario: rotate and revoke without downtime
- native scenario: verify cross-tenant and confused-deputy resistance
