---
name: "autonomous-qa-15-security-abuse-testing"
description: "Run 15-security-abuse-testing through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "15-security-abuse-testing"
  source_sha256: "sha256:a74f48e5bd50faa9c35afa1ba838b5643b965eb8601c5bee4efb8aae20631d60"
  ...
  runtime_skill_key: "15-security-abuse-testing"
  runtime_handler: "execute_15_security_abuse_testing"
  runtime_phase: "generation"
  runtime_mutating: "false"
  runtime_operation: "elmos_autonomous_qa.generators.plan_security_abuse_tests"
...
1. Accept only a structured request for the exact Skill key `15-security-abuse-testing`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_15_security_abuse_testing` and operation `elmos_autonomous_qa.generators.plan_security_abuse_tests`.
...
- Immutable source: `skills/15-security-abuse-testing/SKILL.md` at `sha256:a74f48e5bd50faa9c35afa1ba838b5643b965eb8601c5bee4efb8aae20631d60`.
