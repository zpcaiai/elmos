---
name: elmos-post-market-surveillance-signal-detection-controller
description: Implement and independently certify post-market surveillance and signal detection controller, including ingest incidents, complaints, drift, vulnerabilities, usage, audit and field performance signals, detect trend, cluster, severity and emerging-risk thresholds and trigger investigation, corrective action, scope restriction, suspension or recertification.
version: 4.0.0
...
# Post-Market Surveillance and Signal Detection Controller

## Objective

Implement and independently certify post-market surveillance and signal detection controller, including ingest incidents, complaints, drift, vulnerabilities, usage, audit and field performance signals, detect trend, cluster, severity and emerging-risk thresholds and trigger investigation, corrective action, scope restriction, suspension or recertification.
...
- `PostMarketSurveillanceAndSignalDetectionControllerProfile`
- `PostMarketSurveillanceAndSignalDetectionControllerRun`
- `PostMarketSurveillanceAndSignalDetectionControllerFinding`
- `PostMarketSurveillanceAndSignalDetectionControllerDecision`
- `PostMarketSurveillanceAndSignalDetectionControllerEvidence`

Required semantic capabilities:

- ingest incidents, complaints, drift, vulnerabilities, usage, audit and field performance signals
- detect trend, cluster, severity and emerging-risk thresholds
- trigger investigation, corrective action, scope restriction, suspension or recertification
...
- `elmos-certification-scheme-surveillance-planner`
- `elmos-runtime-policy-continuous-compliance-monitor`

## Primary Outputs

- `artifacts/elmos-post-market-surveillance-signal-detection-controller/profile.yaml`
- `artifacts/elmos-post-market-surveillance-signal-detection-controller/plan.json`
- `artifacts/elmos-post-market-surveillance-signal-detection-controller/result.json`
- `artifacts/elmos-post-market-surveillance-signal-detection-controller/evidence/`
- `artifacts/elmos-post-market-surveillance-signal-detection-controller/assurance-case.json`
...
- **weak signals remain siloed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider incident is not linked to certificates** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **signal threshold is tuned to avoid action** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: ingest incidents, complaints, drift, vulnerabilities, usage, audit and field performance signals
- native scenario: detect trend, cluster, severity and emerging-risk thresholds
- native scenario: trigger investigation, corrective action, scope restriction, suspension or recertification
