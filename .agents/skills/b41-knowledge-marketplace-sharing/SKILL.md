---
name: b41-knowledge-marketplace-sharing
description: "Implement and verify Batch 41 Skill 1411 for knowledge marketplace sharing. Use when work requires \u77e5\u8bc6\u8d44\u4ea7Marketplace\u548c\u5171\u4eab\u673a\u5236, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 知识资产Marketplace和共享机制
...
## Skill 1411: 知识资产Marketplace和共享机制
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b41-knowledge-marketplace-sharing`.
...
4. Implement the smallest production-shaped capability that exercises `知识资产Marketplace和共享机制` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b41-knowledge-marketplace-sharing`
