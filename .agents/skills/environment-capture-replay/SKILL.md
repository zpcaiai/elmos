...
description: "Repository-owned bounded wrapper for environment-capture-replay; external evidence remains NOT_RUN."
---
...
4. Submit `environment-capture-replay` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `da712826099b338cefb6890445193b2f256f5e09b47c5a52076793997c75a2ac`
