...
description: "Supervise typed agents through scoped workspaces, leases, and fences."
---
...
Use the exact repository-owned PDHI v1 `K4` boundary for the
...
2. Resolve this Skill through `SKILL_REGISTRY`; resolve capability operations
   only through `CAPABILITY_REGISTRY` and the exact owner `K4`.
...
- Registry identity: `PDHI-V1-005`
- Kind/owner: `kernel` / `K4`
- Source member: `40-agentic-execution/SKILL.md`
- Source member SHA-256: `sha256:544711137337211a6bf038039674498ece456da44681560b58d4cce7296d23ba`
- Engine: `engines/proof-driven-harness-intelligence-engine/src/elmos_pdhi/agent_runtime.py`
- Runtime: `elmos_pdhi.agent_runtime.AgentSupervisor`
- Exact binding registry: `K4_OPERATION_BINDINGS`
- Source capability occurrences: `30`
