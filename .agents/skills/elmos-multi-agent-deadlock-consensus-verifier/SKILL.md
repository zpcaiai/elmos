---
name: elmos-multi-agent-deadlock-consensus-verifier
description: Verify multi-agent workflows for deadlock, livelock, split-brain, contradictory decisions, duplicate work and
  bounded consensus behavior.
version: 4.0.0
...
# Multi-Agent Deadlock and Consensus Verifier
...
- `DeploymentUnit`
- `ConformanceRun`
- `MultiAgentDeadlockAndConsensusVerifierRun`
- `MultiAgentDeadlockAndConsensusVerifierDecision`

Required semantic capabilities:

- Wait-for and dependency graph analysis
- State-machine liveness/model checking
- Conflict resolution and quorum semantics
- Duplicate work and side-effect detection
...
- `multi-agent-model.json`
- `liveness-results.json`
- `consensus-counterexamples.json`
- `coordination-certificate.json`
...
- **mutual wait** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **endless critique loop** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **false consensus** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **duplicate side effects** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **coordinator split-brain** — must have a preventive control, a detective signal, a negative fixture and a response action.
