---
name: elmos-sql-query-ir-compiler
description: Compile DML and query semantics including joins, CTEs, windows, aggregates, merge/upsert, returning, JSON, temporal, geospatial and ordering into typed Query IR.
version: 4.0.0
...
- Use parser plus catalog-aware validation
- Infer types, nullability and coercions
- Represent relational algebra and effects
- Preserve ordering and cardinality assumptions
- Capture dynamic SQL boundaries
...
- `sql-query-ir.json`
- `query-type-map.json`
- `query-source-map.json`
- `query-unsupported-register.json`
...
- **implicit cast changed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ordering assumed without ORDER BY** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **NULL three-valued logic lost** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **JSON null conflated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dynamic SQL injection hidden** — must have a preventive control, a detective signal, a negative fixture and a response action.
