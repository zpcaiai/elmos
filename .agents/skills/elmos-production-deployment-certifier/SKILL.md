---
name: elmos-production-deployment-certifier
description: Certify exact images, manifests, policies, secrets, data migrations, probes, scaling, telemetry and rollback in a production-equivalent or approved production environment.
version: 4.0.0
...
# Production Deployment Certifier
...
- Bind to artifact and configuration digests
- Verify admission, identity, network and secret policies
- Run startup/readiness/liveness and scaling probes
- Execute migrations and rollback drill
- Verify telemetry and operational ownership
...
- `operational-gate-results.json`
- `deployment-residual-risk.json`
...
- **different image deployed than certified** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **configuration drift after gate** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **readiness probe always true** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **migration job not included** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback depends on unavailable artifact** — must have a preventive control, a detective signal, a negative fixture and a response action.
