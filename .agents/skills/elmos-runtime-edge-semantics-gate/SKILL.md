...
triggers:
  - "Use when implementing or executing `elmos-runtime-edge-semantics-gate`."
  - "Use when a migration/certification DAG requires `quality-gate` capability."
outputs:
  - "semantic-assurance/elmos-runtime-edge-semantics-gate/model.json"
  - "semantic-assurance/elmos-runtime-edge-semantics-gate/evidence.json"
  - "semantic-assurance/elmos-runtime-edge-semantics-gate/diagnostics.json"
---

# Runtime Edge Semantics Gate

## Objective

Aggregate memory, ABI, concurrency, numeric, temporal, encoding, wire, SQL and UB obligations before behavioral equivalence can pass.
...
- [ ] critical runtime obligation blocks.
- [ ] approved non-applicable obligation.
- [ ] same-snapshot evidence aggregation.
