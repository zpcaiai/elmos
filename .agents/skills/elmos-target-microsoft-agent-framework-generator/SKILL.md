---
name: elmos-target-microsoft-agent-framework-generator
description: Generate .NET and Python projects with typed agents, sessions, graph workflows, human-in-the-loop, telemetry
  and migration assets from AutoGen or Semantic Kernel.
version: 4.0.0
...
# TargetMicrosoftAgentFrameworkGenerator
...
- Generate .NET/Python agent projects
- Generate typed graph workflows and sessions
- Generate human-in-the-loop and long-running tasks
- Generate middleware and telemetry
- Generate AutoGen/Semantic Kernel migration adapters
...
- `targets/microsoft-agent-framework/`
- `workflow-contracts/`
- `migration-maps/`
...
- **compat layer semantic loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **session cross-tenant leak** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **workflow duplicate effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **middleware bypass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **version migration overclaim** — must have a preventive control, a detective signal, a negative fixture and a response action.
