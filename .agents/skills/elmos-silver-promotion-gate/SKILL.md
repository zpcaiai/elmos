---
name: silver-promotion-gate
description: Use this skill when Elmos must perform silver promotion gate as part of the 06-dataset-foundry production workflow,
...
要求基础编译、测试、来源和权限检查通过后进入可限制使用的数据层。
