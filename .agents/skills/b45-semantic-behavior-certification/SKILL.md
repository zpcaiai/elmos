---
name: b45-semantic-behavior-certification
description: "Implement and verify Batch 45 Skill 1479 for semantic behavior certification. Use when work requires \u8bed\u4e49\u548c\u884c\u4e3a\u6b63\u786e\u6027\u8ba4\u8bc1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-semantic-behavior-certification`.
...
4. Implement the smallest production-shaped capability that exercises `语义和行为正确性认证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-semantic-behavior-certification`
