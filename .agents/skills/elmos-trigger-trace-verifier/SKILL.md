---
name: "elmos-trigger-trace-verifier"
description: "证明 Trigger 触发条件、顺序、递归、写集合和异常传播在方言转换后保持。 Use when the task needs the exact Trigger Trace Verifier Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-trigger-trace-verifier/SKILL.md"
  source_sha256: "sha256:d68af40c33f9ea06e7be21ca1599a636b1a5e75d40b22c9193161f752a177ce8"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "sql-conversion"
  runtime_handler_id: "execute_elmos_trigger_trace_verifier"
...
---
# Trigger Trace Verifier

## Repository integration boundary

- Exact Skill identity: `elmos-trigger-trace-verifier`; exact allowlisted runtime handler: `execute_elmos_trigger_trace_verifier`.
- Source identity: `skills/P0/elmos-trigger-trace-verifier/SKILL.md` at `sha256:d68af40c33f9ea06e7be21ca1599a636b1a5e75d40b22c9193161f752a177ce8` from `elmos-formal-assurance-kernel-v1.0.0`.
...
证明 Trigger 触发条件、顺序、递归、写集合和异常传播在方言转换后保持。
...
3. Use the repository-owned `execute_elmos_trigger_trace_verifier` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["trace refinement","termination analysis","dependency graph model checking"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-trigger-trace-verifier/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
