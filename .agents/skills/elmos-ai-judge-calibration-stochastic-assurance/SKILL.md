---
name: elmos-ai-judge-calibration-stochastic-assurance
description: Calibrate LLM judges against authoritative labels, quantify uncertainty and bias, and prevent probabilistic judgments
  from becoming unbounded completion evidence.
version: 4.0.0
...
# AI Judge Calibration and Stochastic Assurance
...
- **Kernel authorities used:** K4, K6, K8
...
- `Counterexample`
- `CoverageMap`
- `AIJudgeCalibrationAndStochasticAssuranceRun`
- `AIJudgeCalibrationAndStochasticAssuranceDecision`

Required semantic capabilities:

- Human-label calibration and adjudication
- Multi-judge agreement and bias analysis
- Bootstrap confidence intervals and sequential tests
- Order/style/self-preference probes
- Abstention and code-oracle precedence
...
- `judge-bias-report.json`
- `stochastic-confidence.json`
- `judge-use-policy.json`
...
- **judge collusion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **self-certification** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **prompt leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **systematic demographic bias** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **confidence inflation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- accuracy and Brier calibration
