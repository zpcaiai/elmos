---
name: automated-process-supervision
description: Use this skill when Elmos must perform automated process supervision as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
