...
triggers:
  - "Use when implementing or executing `elmos-semantic-golden-master-capture`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-semantic-golden-master-capture/model.json"
  - "semantic-assurance/elmos-semantic-golden-master-capture/evidence.json"
  - "semantic-assurance/elmos-semantic-golden-master-capture/diagnostics.json"
---

# Semantic Golden Master Capture

## Objective

Capture source outputs, traces and state snapshots with normalization and provenance as replayable baseline evidence.
