---
name: b42-multiagent-consensus-arbitration
description: "Implement and verify Batch 42 Skill 1433 for multiagent consensus arbitration. Use when work requires \u591aAgent\u51b2\u7a81\u3001Consensus\u548cHuman Arbitration, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 多Agent冲突、Consensus和Human Arbitration
...
## Skill 1433: 多Agent冲突、Consensus和Human Arbitration
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b42-multiagent-consensus-arbitration`.
...
4. Implement the smallest production-shaped capability that exercises `多Agent冲突、Consensus和Human Arbitration` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b42-multiagent-consensus-arbitration`
