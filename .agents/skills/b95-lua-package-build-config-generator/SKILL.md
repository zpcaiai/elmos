---
name: b95-lua-package-build-config-generator
description: "Use when ELMOS must run lua package build config generator for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG399"
  source_name: "lua-package-build-config-generator"
  source_sha256: "sha256:125b616b12614cbfd5a178d5d250a5c66472b7b6c2528ef5374c6cbfaed7d25e"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG399 — Lua Package Build Config Generator

## 1. Objective

Generate lua package build config generator within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Lua Package Build Config Generator using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-package-build-config-generator.
