---
name: skill-sandbox-executor
description: Use this skill when Elmos must perform skill sandbox executor as part of the 05-skill-foundry-runtime production
...
在受限环境中执行脚本与工具，施加文件、网络、CPU、内存和时间限制。
