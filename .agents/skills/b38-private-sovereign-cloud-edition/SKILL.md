---
name: b38-private-sovereign-cloud-edition
description: "Implement and verify Batch 38 Skill 1332 for private sovereign cloud edition. Use when work requires Private\u548cSovereign Cloud Edition, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Private和Sovereign Cloud Edition
...
## Skill 1332: Private和Sovereign Cloud Edition
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b38-private-sovereign-cloud-edition`.
...
4. Implement the smallest production-shaped capability that exercises `Private和Sovereign Cloud Edition` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b38-private-sovereign-cloud-edition`
