---
name: b45-design-partner-reference-validation
description: "Implement and verify Batch 45 Skill 1489 for design partner reference validation. Use when work requires Design Partner\u548cReference Customer\u9a8c\u8bc1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Design Partner和Reference Customer验证
...
## Skill 1489: Design Partner和Reference Customer验证
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b45-design-partner-reference-validation`.
...
4. Implement the smallest production-shaped capability that exercises `Design Partner和Reference Customer验证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b45-design-partner-reference-validation`
