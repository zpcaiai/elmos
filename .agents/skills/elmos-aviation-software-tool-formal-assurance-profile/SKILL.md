...
# Aviation Software, Tool and Formal Assurance Profile
...
- `AviationSoftwareToolAndFormalAssuranceProfileProfile`
- `AviationSoftwareToolAndFormalAssuranceProfileRun`
- `AviationSoftwareToolAndFormalAssuranceProfileFinding`
- `AviationSoftwareToolAndFormalAssuranceProfileDecision`
- `AviationSoftwareToolAndFormalAssuranceProfileEvidence`

Required semantic capabilities:

- compile development assurance level, objectives, independence and traceability
- qualify development/verification tools according to certification credit
- integrate model-based and formal methods evidence with executable object code verification
...
- `elmos-verifier-tool-qualification-classifier`

### External Package Dependencies

- `elmos-formal-model-runtime-refinement-verifier` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-aviation-software-tool-formal-assurance-profile/profile.yaml`
- `artifacts/elmos-aviation-software-tool-formal-assurance-profile/plan.json`
- `artifacts/elmos-aviation-software-tool-formal-assurance-profile/result.json`
- `artifacts/elmos-aviation-software-tool-formal-assurance-profile/evidence/`
- `artifacts/elmos-aviation-software-tool-formal-assurance-profile/assurance-case.json`
...
- **qualified tool used outside operational requirements** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **formal proof omits target compiler behavior** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **object code is not traceable to source requirement** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile development assurance level, objectives, independence and traceability
- native scenario: qualify development/verification tools according to certification credit
- native scenario: integrate model-based and formal methods evidence with executable object code verification
