...
description: Use this skill when Elmos must perform curriculum and mixture optimizer as part of the 06-dataset-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
