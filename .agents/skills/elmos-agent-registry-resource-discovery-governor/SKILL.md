---
name: elmos-agent-registry-resource-discovery-governor
description: Discover, verify, policy-filter, pin and continuously monitor agents, Skills, tools, MCP servers, models and
  related agentic resources.
version: 4.0.0
...
# Agent Registry and Resource Discovery Governor
...
- **Kernel authorities used:** K2, K3, K6, K7
...
- `Approval`
- `ResidualRisk`
- `AgentRegistryAndResourceDiscoveryGovernorRun`
- `AgentRegistryAndResourceDiscoveryGovernorDecision`

Required semantic capabilities:

- Multi-registry discovery federation
- Publisher and signature verification
- Policy and residency filtering
- Exact version and digest locking
- Freshness, revocation and drift monitoring
...
- `discovery-trust-decisions.json`
- `resource-version-lock.json`
- `resource-drift-events.jsonl`
...
- **registry poisoning** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **typosquatting** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale metadata** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **capability spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shadow registry bypass** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- trusted discovery
- untrusted publisher block
- duplicate identity conflict
- revoked resource removal
- registry outage fallback
