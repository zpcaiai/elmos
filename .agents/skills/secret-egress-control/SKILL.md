---
name: secret-egress-control
description: "Repository-owned bounded wrapper for secret-egress-control; external evidence remains NOT_RUN."
---
...
Broker secret access, redact logs, prevent credential exfiltration, restrict network destinations and produce access evidence.
...
4. Submit `secret-egress-control` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `7da083d8898067f7b9cd2809fbcd6bff4243013d40e44ae15ce82181789fcef2`
