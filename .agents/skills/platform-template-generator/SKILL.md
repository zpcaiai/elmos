...
description: "Repository-owned bounded wrapper for platform-template-generator; external evidence remains NOT_RUN."
---
...
Standardize new project/service generation with organization-approved templates, docs, ownership metadata, CI and certification defaults.
...
4. Submit `platform-template-generator` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `29d1113dec09bd690ae36ee72c285b127ab0b2780e7e283831d41dbc7d57c114`
