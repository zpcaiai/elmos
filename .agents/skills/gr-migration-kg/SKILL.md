---
name: gr-migration-kg
description: 沉淀版本、框架、API、风险、Recipe、Patch、失败、验证和成功率。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-095
  source_name: gr-migration-kg
  source_path: skills/gr-migration-kg/SKILL.md
  source_sha256: sha256:f9e15bcb5558cb3755a65b454f3abb877d30d86b53d0df853baf90d36a28e6eb
  source_contract_sha256: sha256:43e581551f22a7642a0081924af1aa005e4c21291f257d33f1fc4ca4af384b77
...
沉淀版本、框架、API、风险、Recipe、Patch、失败、验证和成功率。

## Scope and capabilities

- Temporal facts
- Provenance/confidence
- Tenant-private/global separation
...
- [ ] 定义 `gr-migration-kg` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-migration-kg` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：migration-kg, route-recommendations.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：migration-kg, route-recommendations.json。
- [ ] 所有 mandatory tests 和 security gates 通过，且无 critical unknown。

## Dependencies

- `gr-recipe-certification`
- `gr-claim-ledger`
...
- Machine contract: `references/contract.json` (`sha256:43e581551f22a7642a0081924af1aa005e4c21291f257d33f1fc4ca4af384b77`).
