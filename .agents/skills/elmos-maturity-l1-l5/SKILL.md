---
name: elmos-maturity-l1-l5
description: 用不可伪造 Evidence 区分架构、原型、付费 Pilot、成熟产品与行业领导者。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-004
  source_name: elmos-maturity-l1-l5
  source_path: skills/elmos-maturity-l1-l5/SKILL.md
  source_sha256: sha256:f7353d91bfba7ec6f7f445eb19943e4237bad4e8af0bfd032b95bdf424f32cea
  source_contract_sha256: sha256:8a99f835163759c3c4be8f22468ba350e4288cfbd8696c3caf1759408f4a2298
...
# Commercial Maturity L1–L5

## Objective

用不可伪造 Evidence 区分架构、原型、付费 Pilot、成熟产品与行业领导者。
...
- [ ] 定义 `elmos-maturity-l1-l5` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `elmos-maturity-l1-l5` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：maturity-assessment.json, promotion-gaps.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：maturity-assessment.json, promotion-gaps.json。
...
- Machine contract: `references/contract.json` (`sha256:8a99f835163759c3c4be8f22468ba350e4288cfbd8696c3caf1759408f4a2298`).
