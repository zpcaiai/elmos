---
id: PG109
name: dotnet-messaging-background-service-generator
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: message producers/consumers and BackgroundService generation with cancellation, outbox and idempotency
depends_on: ["PG048", "PG049", "PG103", "PG117", "PG122"]
capabilities:
  - workspace:read
...
# PG109 — Dotnet Messaging Background Service Generator

## 1. Objective

Implement message producers/consumers and BackgroundService generation with cancellation, outbox and idempotency as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- message producers/consumers and BackgroundService generation with cancellation, outbox and idempotency.
...
3. Map stable semantic symbols and generation units to message producers/consumers and BackgroundService generation with cancellation, outbox and idempotency.
...
- Consume certified outputs from PG048, PG049, PG103, PG117, PG122.
...
- The generated result implements only the approved responsibility: message producers/consumers and BackgroundService generation with cancellation, outbox and idempotency.
