---
id: PG103
name: dotnet-worker-console-profile
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: Generic Host worker, console, batch and scheduler lifecycle with cancellation, checkpoint and exit semantics
...
# PG103 — Dotnet Worker Console Profile

## 1. Objective

Implement Generic Host worker, console, batch and scheduler lifecycle with cancellation, checkpoint and exit semantics as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- Generic Host worker, console, batch and scheduler lifecycle with cancellation, checkpoint and exit semantics.
...
3. Map stable semantic symbols and generation units to Generic Host worker, console, batch and scheduler lifecycle with cancellation, checkpoint and exit semantics.
...
- The generated result implements only the approved responsibility: Generic Host worker, console, batch and scheduler lifecycle with cancellation, checkpoint and exit semantics.
