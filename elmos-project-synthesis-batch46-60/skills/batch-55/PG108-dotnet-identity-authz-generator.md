---
id: PG108
name: dotnet-identity-authz-generator
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: ASP.NET authentication, claims/tenant mapping, fallback authorization, data protection and security tests
depends_on: ["PG041", "PG050", "PG062", "PG101"]
capabilities:
  - workspace:read
...
# PG108 — Dotnet Identity Authz Generator

## 1. Objective

Implement ASP.NET authentication, claims/tenant mapping, fallback authorization, data protection and security tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- ASP.NET authentication, claims/tenant mapping, fallback authorization, data protection and security tests.
...
3. Map stable semantic symbols and generation units to ASP.NET authentication, claims/tenant mapping, fallback authorization, data protection and security tests.
...
- Consume certified outputs from PG041, PG050, PG062, PG101.
...
- The generated result implements only the approved responsibility: ASP.NET authentication, claims/tenant mapping, fallback authorization, data protection and security tests.
