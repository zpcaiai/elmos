---
id: PG107
name: dotnet-ef-core-persistence-generator
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: EF Core contexts, mappings, repositories, query filters, concurrency and real database tests
depends_on: ["PG035", "PG047", "PG101", "PG113"]
capabilities:
  - workspace:read
...
# PG107 — Dotnet Ef Core Persistence Generator

## 1. Objective

Implement EF Core contexts, mappings, repositories, query filters, concurrency and real database tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- EF Core contexts, mappings, repositories, query filters, concurrency and real database tests.
...
3. Map stable semantic symbols and generation units to EF Core contexts, mappings, repositories, query filters, concurrency and real database tests.
...
- Consume certified outputs from PG035, PG047, PG101, PG113.
...
- The generated result implements only the approved responsibility: EF Core contexts, mappings, repositories, query filters, concurrency and real database tests.
