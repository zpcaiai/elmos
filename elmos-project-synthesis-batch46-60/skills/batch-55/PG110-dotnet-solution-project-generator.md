---
id: PG110
name: dotnet-solution-project-generator
version: 1.0.0
batch: 55
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: solution/project files, central package management, nullable/analyzer policy, locked restore and publish configuration
depends_on: ["PG058", "PG061", "PG063", "PG101"]
capabilities:
  - workspace:read
...
# PG110 — Dotnet Solution Project Generator

## 1. Objective

Implement solution/project files, central package management, nullable/analyzer policy, locked restore and publish configuration as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- solution/project files, central package management, nullable/analyzer policy, locked restore and publish configuration.
...
3. Map stable semantic symbols and generation units to solution/project files, central package management, nullable/analyzer policy, locked restore and publish configuration.
...
- Consume certified outputs from PG058, PG061, PG063, PG101.
...
- The generated result implements only the approved responsibility: solution/project files, central package management, nullable/analyzer policy, locked restore and publish configuration.
