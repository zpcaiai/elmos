---
id: PG096
name: python-auth-permission-generator
version: 1.0.0
batch: 54
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: FastAPI/Django identity, tenant scope, object permissions and fail-closed security configuration
depends_on: ["PG041", "PG050", "PG062", "PG089", "PG090"]
capabilities:
  - workspace:read
...
# PG096 — Python Auth Permission Generator

## 1. Objective

Implement FastAPI/Django identity, tenant scope, object permissions and fail-closed security configuration as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- FastAPI/Django identity, tenant scope, object permissions and fail-closed security configuration.
...
3. Map stable semantic symbols and generation units to FastAPI/Django identity, tenant scope, object permissions and fail-closed security configuration.
...
- Consume certified outputs from PG041, PG050, PG062, PG089, PG090.
...
- The generated result implements only the approved responsibility: FastAPI/Django identity, tenant scope, object permissions and fail-closed security configuration.
