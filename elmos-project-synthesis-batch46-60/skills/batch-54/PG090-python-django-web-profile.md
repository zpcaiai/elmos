---
id: PG090
name: python-django-web-profile
version: 1.0.0
batch: 54
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: Django web/admin profile with bounded apps, settings layering, migrations, auth and extension points
depends_on: ["PG056", "PG057", "PG058", "PG064"]
capabilities:
  - workspace:read
...
# PG090 — Python Django Web Profile

## 1. Objective

Implement Django web/admin profile with bounded apps, settings layering, migrations, auth and extension points as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- Django web/admin profile with bounded apps, settings layering, migrations, auth and extension points.
...
3. Map stable semantic symbols and generation units to Django web/admin profile with bounded apps, settings layering, migrations, auth and extension points.
...
- Consume certified outputs from PG056, PG057, PG058, PG064.
...
- The generated result implements only the approved responsibility: Django web/admin profile with bounded apps, settings layering, migrations, auth and extension points.
