---
id: PG098
name: python-packaging-lockfile-generator
version: 1.0.0
batch: 54
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: pyproject, dependency groups, lock strategy, package scripts, formatter, linter and type-checker setup
depends_on: ["PG058", "PG061", "PG063", "PG089"]
capabilities:
  - workspace:read
...
# PG098 — Python Packaging Lockfile Generator

## 1. Objective

Implement pyproject, dependency groups, lock strategy, package scripts, formatter, linter and type-checker setup as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- pyproject, dependency groups, lock strategy, package scripts, formatter, linter and type-checker setup.
...
3. Map stable semantic symbols and generation units to pyproject, dependency groups, lock strategy, package scripts, formatter, linter and type-checker setup.
...
- Consume certified outputs from PG058, PG061, PG063, PG089.
...
- The generated result implements only the approved responsibility: pyproject, dependency groups, lock strategy, package scripts, formatter, linter and type-checker setup.
