...
status: proposed
summary: Plans repository roots, applications, modules, libraries, tests, docs, deployment assets, and generated areas.
depends_on: ["PG045", "PG055", "PG056"]
capabilities:
  - workspace:read
...
# PG059 — Repository Layout Planner

## 1. Objective

Create a repository layout aligned with architecture, build graph, and regeneration boundaries.
...
- Validate and process organization_repository_policy.
- Produce and validate repository_layout.
- Produce and validate module_path_map.
- Produce and validate generated_area_map.
- Produce and validate repository_rules.
...
- `organization_repository_policy`
...
1. Choose monorepo, multi-project, or multi-repository organization.
2. Map applications, modules, libraries, tests, docs, operations, and deployment assets.
3. Separate managed, protected, imported, derived, and user-owned areas.
4. Define dependency direction, import boundaries, and shared-code policy.
5. Validate paths against build tools, operating systems, CI, packaging, and source-control limits.
...
- PATH_COLLISION — emit structured diagnostics and stop unsafe continuation.
- CYCLIC_LAYOUT — emit structured diagnostics and stop unsafe continuation.
- GENERATED_USER_OWNED_OVERLAP — emit structured diagnostics and stop unsafe continuation.
- TOOL_INCOMPATIBLE_LAYOUT — emit structured diagnostics and stop unsafe continuation.
...
- Valid inputs produce every declared output for `repository-layout-planner`.
...
- Reject or escalate `path_collision` without inventing success.
- Reject or escalate `cyclic_layout` without inventing success.
- Reject or escalate `generated_user_owned_overlap` without inventing success.
- Reject or escalate `tool_incompatible_layout` without inventing success.
...
- Every module has a stable repository path.
- Generated and user-owned areas do not overlap ambiguously.
- The layout supports selected build, test, deployment, and incremental-generation strategies.
