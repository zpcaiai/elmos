---
id: PG116
name: grpc-protobuf-generator
version: 1.0.0
batch: 56
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: Protobuf/gRPC contracts, stable field numbering, deadlines, streaming semantics, stubs and compatibility tests
depends_on: ["PG039", "PG048", "PG064"]
capabilities:
  - workspace:read
...
# PG116 — Grpc Protobuf Generator

## 1. Objective

Implement Protobuf/gRPC contracts, stable field numbering, deadlines, streaming semantics, stubs and compatibility tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- Protobuf/gRPC contracts, stable field numbering, deadlines, streaming semantics, stubs and compatibility tests.
...
3. Map stable semantic symbols and generation units to Protobuf/gRPC contracts, stable field numbering, deadlines, streaming semantics, stubs and compatibility tests.
...
- Consume certified outputs from PG039, PG048, PG064.
...
- The generated result implements only the approved responsibility: Protobuf/gRPC contracts, stable field numbering, deadlines, streaming semantics, stubs and compatibility tests.
