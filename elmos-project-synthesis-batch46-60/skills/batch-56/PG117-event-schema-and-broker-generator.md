---
id: PG117
name: event-schema-and-broker-generator
version: 1.0.0
batch: 56
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: versioned event wire schemas, topic/queue topology, routing, headers, retention and contract tests
depends_on: ["PG037", "PG039", "PG048"]
capabilities:
  - workspace:read
...
# PG117 — Event Schema And Broker Generator

## 1. Objective

Implement versioned event wire schemas, topic/queue topology, routing, headers, retention and contract tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- versioned event wire schemas, topic/queue topology, routing, headers, retention and contract tests.
...
3. Map stable semantic symbols and generation units to versioned event wire schemas, topic/queue topology, routing, headers, retention and contract tests.
...
6. Generate verification artifacts, evidence records from acceptance criteria and failure scenarios.
...
- Consume certified outputs from PG037, PG039, PG048.
...
- The generated result implements only the approved responsibility: versioned event wire schemas, topic/queue topology, routing, headers, retention and contract tests.
