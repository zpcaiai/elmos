---
id: PG079
name: java-microservice-profile
version: 1.0.0
batch: 53
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: evidence-backed independently deployable Spring Boot services with owned data and contract tests
depends_on: ["PG045", "PG048", "PG053", "PG064", "PG077"]
capabilities:
  - workspace:read
...
# PG079 — Java Microservice Profile

## 1. Objective

Implement evidence-backed independently deployable Spring Boot services with owned data and contract tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- evidence-backed independently deployable Spring Boot services with owned data and contract tests.
...
3. Map stable semantic symbols and generation units to evidence-backed independently deployable Spring Boot services with owned data and contract tests.
...
- Consume certified outputs from PG045, PG048, PG053, PG064, PG077.
...
- The generated result implements only the approved responsibility: evidence-backed independently deployable Spring Boot services with owned data and contract tests.
