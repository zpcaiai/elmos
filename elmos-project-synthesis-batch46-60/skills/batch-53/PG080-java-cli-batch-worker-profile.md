---
id: PG080
name: java-cli-batch-worker-profile
version: 1.0.0
batch: 53
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: Java CLI, batch, scheduled and worker lifecycle, checkpoint, retry and exit contracts
depends_on: ["PG038", "PG053", "PG057", "PG064"]
capabilities:
  - workspace:read
...
# PG080 — Java Cli Batch Worker Profile

## 1. Objective

Implement Java CLI, batch, scheduled and worker lifecycle, checkpoint, retry and exit contracts as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- Java CLI, batch, scheduled and worker lifecycle, checkpoint, retry and exit contracts.
...
3. Map stable semantic symbols and generation units to Java CLI, batch, scheduled and worker lifecycle, checkpoint, retry and exit contracts.
...
- Consume certified outputs from PG038, PG053, PG057, PG064.
...
- The generated result implements only the approved responsibility: Java CLI, batch, scheduled and worker lifecycle, checkpoint, retry and exit contracts.
