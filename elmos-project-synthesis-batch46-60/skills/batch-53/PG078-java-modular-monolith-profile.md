---
id: PG078
name: java-modular-monolith-profile
version: 1.0.0
batch: 53
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: enforceable Java modular-monolith boundaries, public module APIs and architecture tests
depends_on: ["PG045", "PG054", "PG064", "PG077"]
capabilities:
  - workspace:read
...
# PG078 — Java Modular Monolith Profile

## 1. Objective

Implement enforceable Java modular-monolith boundaries, public module APIs and architecture tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- enforceable Java modular-monolith boundaries, public module APIs and architecture tests.
...
3. Map stable semantic symbols and generation units to enforceable Java modular-monolith boundaries, public module APIs and architecture tests.
...
- Consume certified outputs from PG045, PG054, PG064, PG077.
...
- The generated result implements only the approved responsibility: enforceable Java modular-monolith boundaries, public module APIs and architecture tests.
