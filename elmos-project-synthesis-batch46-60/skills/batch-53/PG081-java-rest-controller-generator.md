---
id: PG081
name: java-rest-controller-generator
version: 1.0.0
batch: 53
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: Spring REST controllers, DTOs, validation, standardized errors, authorization and OpenAPI alignment
depends_on: ["PG040", "PG041", "PG067", "PG077"]
capabilities:
  - workspace:read
...
# PG081 — Java Rest Controller Generator

## 1. Objective

Implement Spring REST controllers, DTOs, validation, standardized errors, authorization and OpenAPI alignment as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- Spring REST controllers, DTOs, validation, standardized errors, authorization and OpenAPI alignment.
...
3. Map stable semantic symbols and generation units to Spring REST controllers, DTOs, validation, standardized errors, authorization and OpenAPI alignment.
...
6. Generate validation and error mapping, endpoint tests from acceptance criteria and failure scenarios.
...
- Consume certified outputs from PG040, PG041, PG067, PG077.
...
- The generated result implements only the approved responsibility: Spring REST controllers, DTOs, validation, standardized errors, authorization and OpenAPI alignment.
