---
id: PG085
name: java-messaging-scheduler-generator
version: 1.0.0
batch: 53
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: Kafka/RabbitMQ/scheduler adapters with versioned schemas, idempotency, outbox, retries and dead-letter behavior
depends_on: ["PG048", "PG049", "PG077", "PG117", "PG122"]
capabilities:
  - workspace:read
...
# PG085 — Java Messaging Scheduler Generator

## 1. Objective

Implement Kafka/RabbitMQ/scheduler adapters with versioned schemas, idempotency, outbox, retries and dead-letter behavior as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- Kafka/RabbitMQ/scheduler adapters with versioned schemas, idempotency, outbox, retries and dead-letter behavior.
...
- Java package/module boundaries.
- pinned Java/Spring/build versions.
- JUnit/Testcontainers-compatible verification.
...
2. Resolve the supported Java Project Pack capability profile and reject unsupported or unapproved behavior.
3. Map stable semantic symbols and generation units to Kafka/RabbitMQ/scheduler adapters with versioned schemas, idempotency, outbox, retries and dead-letter behavior.
...
6. Generate idempotency and retry components, broker integration tests from acceptance criteria and failure scenarios.
...
- Delivery policy.
- Idempotency and retry components.
...
- Consume certified outputs from PG048, PG049, PG077, PG117, PG122.
...
- The generated result implements only the approved responsibility: Kafka/RabbitMQ/scheduler adapters with versioned schemas, idempotency, outbox, retries and dead-letter behavior.
