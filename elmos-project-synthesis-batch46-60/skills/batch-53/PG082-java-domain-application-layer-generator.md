---
id: PG082
name: java-domain-application-layer-generator
version: 1.0.0
batch: 53
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: framework-independent Java domain and application layers with aggregates, handlers, ports and invariant tests
depends_on: ["PG035", "PG037", "PG067", "PG072", "PG077"]
capabilities:
  - workspace:read
...
# PG082 — Java Domain Application Layer Generator

## 1. Objective

Implement framework-independent Java domain and application layers with aggregates, handlers, ports and invariant tests as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- framework-independent Java domain and application layers with aggregates, handlers, ports and invariant tests.
...
3. Map stable semantic symbols and generation units to framework-independent Java domain and application layers with aggregates, handlers, ports and invariant tests.
...
- Consume certified outputs from PG035, PG037, PG067, PG072, PG077.
...
- The generated result implements only the approved responsibility: framework-independent Java domain and application layers with aggregates, handlers, ports and invariant tests.
