---
id: PG086
name: java-maven-gradle-build-generator
version: 1.0.0
batch: 53
engine: elmos.project-synthesis
schema: elmos.project-synthesis.v1
status: proposed
summary: reproducible Maven/Gradle wrapper builds, dependency management, test tasks, analysis and packaging
depends_on: ["PG058", "PG061", "PG063", "PG077"]
capabilities:
  - workspace:read
...
# PG086 — Java Maven Gradle Build Generator

## 1. Objective

Implement reproducible Maven/Gradle wrapper builds, dependency management, test tasks, analysis and packaging as a governed ELMOS Project Synthesis capability.

## 2. Scope

### In scope
- reproducible Maven/Gradle wrapper builds, dependency management, test tasks, analysis and packaging.
...
- `build_metadata`
- `version/dependency_locks`
- `quality_tool_configuration`
- `clean-build_validation_report`
...
3. Map stable semantic symbols and generation units to reproducible Maven/Gradle wrapper builds, dependency management, test tasks, analysis and packaging.
...
6. Generate quality tool configuration, clean-build validation report from acceptance criteria and failure scenarios.
...
- `UNREPRODUCIBLE_BUILD` — emit structured evidence and stop unsafe continuation.
- `UNPINNED_TOOL_OR_DEPENDENCY` — emit structured evidence and stop unsafe continuation.
...
- Build metadata.
- Version/dependency locks.
- Quality tool configuration.
- Clean-build validation report.
...
- Consume certified outputs from PG058, PG061, PG063, PG077.
...
- Reject `unreproducible_build` without inventing success.
- Reject `unpinned_tool_or_dependency` without inventing success.

## 17. Acceptance Criteria

- The generated result implements only the approved responsibility: reproducible Maven/Gradle wrapper builds, dependency management, test tasks, analysis and packaging.
