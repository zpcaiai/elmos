...
export async function GET() {
  return NextResponse.json<SpringModernizationCapabilityResponse>({
    ...
    recognizedSources: [
      ...
      { id: "spring-boot-legacy", label: "旧版 Spring Boot", detail: "Boot 1.5.22/Java 8、2.3.12/Java 11、2.7.18/Java 17、3.4.1/Java 17 的精确 Maven 点有 PASSED_LOCAL；Boot 3.5.16/Java 21 与其余精确元组仍为 NOT_RUN，Gradle 真实执行证据仍为 NOT_RUN", status: "REVIEW" },
    ],
    researchPack: {
