...
const ELMOS_INTERACTION_REDUCER = function observeBoundedFrontendInteraction(model: typeof ELMOS_FRONTEND_INTERACTION, scenarioValue: (typeof ELMOS_INTERACTION_SCENARIOS)[number]) {
...
export function elmosObserveInteraction(scenario: (typeof ELMOS_INTERACTION_SCENARIOS)[number]) { return ELMOS_INTERACTION_REDUCER(ELMOS_FRONTEND_INTERACTION, scenario); }
