...
- 运行 `make mature-product-skills` 可复现 17 批仓库级迁移包验证，运行 `make batch27-34-skills` 验证新增的双轨 Runtime Skills。实现与现场 `NOT_RUN` 边界见 `docs/product-batches27-34/README.md`、`docs/batch34/VALIDATION.md` 和 `docs/mature-product-batches-29-45-verification.md`。
