# ELMOS Project Intelligence Engine

This repository-owned, standard-library Python engine supplies bounded code-level handlers for all 50 exact Skills in `elmos-project-intelligence-skills` v1.1.0.
...
- a strict allowlist mapping every canonical Skill to a unique capability function;
- bounded, symlink-safe repository snapshots that never execute repository content;
- tenant/project/run-scoped SQLite state, idempotency, append-only events, artifacts, evidence, and checkpoints;
