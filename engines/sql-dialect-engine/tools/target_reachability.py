...
def main() -> int:
    ...
    out = {
        ...
        "translationPolicy": {
            "typeMigration": {
                "jsonBinary": args.policy_json_binary,
                "array": args.policy_array,
                "unboundedDecimal": args.policy_unbounded_decimal,
                "unboundedVarchar": args.policy_unbounded_varchar,
                "unsignedBigint": args.policy_unsigned_bigint,
            },
            "allowTriggerShim": args.allow_trigger_shim,
            "allowAlterColumn": args.allow_alter_column,
            "allowIndexShim": args.allow_index_shim,
            "allowIfNotExistsShim": args.allow_if_not_exists_shim,
            "allowSchemaShim": args.allow_schema_shim,
            "allowRlsShim": args.allow_rls_shim,
            "allowPrivilegeShim": args.allow_privilege_shim,
            "allowCommentShim": args.allow_comment_shim,
            "allowIndexExpressionShim": args.allow_index_expression_shim,
            "allowRoutineShim": args.allow_routine_shim,
            "allowMysqlTextPrefix": args.allow_mysql_text_prefix,
            "allowCheckShim": args.allow_check_shim,
            "allowMysqlTextDefault": args.allow_mysql_text_default,
            "allowReservedWordShim": args.allow_reserved_word_shim,
        },
