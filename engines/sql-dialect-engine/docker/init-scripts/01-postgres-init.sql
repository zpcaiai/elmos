-- PostgreSQL 16 Source Initialization for CDC
...
(1, 'alice_zhang', 'alice@example.com', '+8613800000001', 'Developer from Beijing', TRUE, 'ACTIVE', '2026-01-01 10:00:00+08', '2026-01-01 10:00:00+08'),
(2, 'bob_li', 'bob@example.com', '+8613800000002', 'DBA from Shanghai', TRUE, 'ACTIVE', '2026-01-02 11:30:00+08', '2026-01-02 11:30:00+08'),
(3, 'charlie_wang', 'charlie@example.com', '+8613800000003', 'Architect from Shenzhen', FALSE, 'INACTIVE', '2026-01-03 15:20:00+08', '2026-01-03 15:20:00+08'),
(4, 'david_liu', 'david@example.com', '+8613800000004', 'Engineer from Chengdu', TRUE, 'ACTIVE', '2026-01-04 09:15:00+08', '2026-01-04 09:15:00+08'),
(5, 'eva_chen', 'eva@example.com', '+8613800000005', 'Designer from Hangzhou', TRUE, 'ACTIVE', '2026-01-05 14:40:00+08', '2026-01-05 14:40:00+08')
