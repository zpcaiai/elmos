"""Pinned, inert capability identities transcribed from the source catalog.

This module contains data only. It does not import or execute any source ZIP
member and confers no runtime authority.
"""

from __future__ import annotations

SOURCE_KERNEL_LABELS: dict[str, str] = {'K1': 'K1 Semantic Intelligence',
 'K2': 'K2 Transactional Transformation',
 'K3': 'K3 Runtime Proof',
 'K4': 'K4 Agentic Execution',
 'K5': 'K5 Assurance',
 'K6': 'K6 Policy & Invariants',
 'K7': 'K7 Skill Evolution',
 'K8': 'K8 Harness Intelligence',
 'K9': 'K9 Production Control Plane'}

SOURCE_CAPABILITY_CATALOG: dict[str, tuple[str, ...]] = {'K1': ('semantic-lsp-federation',
 ...
 'K4': ('agent-definition-ir',
        ...
        'merge-coordinator',
        'orphan-agent-reaper'),
 'K5': ('independent-advisor-runtime',
