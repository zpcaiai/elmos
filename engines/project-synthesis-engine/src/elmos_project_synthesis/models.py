...
TARGET_PROFILES: dict[str, dict[str, str | int]] = {
    "java": {
        ...
        "toolchain": "OpenJDK 21.0.11 / Maven 3.9.10",
    },
    "python": {
        "framework": "fastapi",
        "runtime": "3.12",
        ...
        "toolchain": "CPython 3.12.12 / uv 0.11.16",
    },
    "csharp": {
    ...
    "typescript": {
        ...
        "source_skill": "PG226",
        "toolchain": "Node.js 26.0.0 / pnpm 10.12.4",
    },
    "go": {
        "framework": "net-http",
        "runtime": "1.25.0",
    ...
    "kotlin": {
        ...
        "directory": "kotlin",
        "source_skill": "PG250",
        "toolchain": "Kotlin 2.2.20 / OpenJDK 21.0.11 / Gradle 8.14.3",
    },
    "php": {
...
P0_EXACT_QUALIFICATION_TOOLCHAINS: dict[str, tuple[dict[str, str], ...]] = {
    ...
    "kotlin": (
        {"component": "Kotlin", "executable": "kotlin-compiler", "version": "2.2.20"},
        {"component": "OpenJDK", "executable": "java", "version": "21.0.11"},
