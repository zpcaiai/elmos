...
"""
    ...
    ] = f"""# AWS Production VPC, EKS Cluster, RDS Aurora PostgreSQL 17, and ElastiCache Redis
...
"""
    ...
    files[
        "deploy/terraform/modules/gcp/main.tf"
    ] = """# GCP Production GKE, Cloud SQL PostgreSQL 16, and Cloud Memorystore Redis
...
"""
    ...
    files[
        "deploy/terraform/modules/azure/main.tf"
    ] = """# Azure Production AKS, Azure Database for PostgreSQL Flexible Server, and Azure Cache for Redis
