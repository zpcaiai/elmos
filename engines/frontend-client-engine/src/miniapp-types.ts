...
export const MINIAPP_PLATFORM_CAPABILITY_OPERATIONS = {
  ...
  uploadFile: "platform.uploadFile",
  downloadFile: "platform.downloadFile",
  ...
  getPrivacySetting: "platform.getPrivacySetting",
  onNeedPrivacyAuthorization: "platform.onNeedPrivacyAuthorization",
  requestPayment: "platform.requestPayment",
  requestSubscribeMessage: "platform.requestSubscribeMessage",
  updateShareMenu: "platform.updateShareMenu",
  getLocation: "platform.getLocation",
  chooseLocation: "platform.chooseLocation",
  startLocationUpdateBackground: "platform.startLocationUpdateBackground",
  createMapContext: "platform.createMapContext",
  chooseMedia: "platform.chooseMedia",
  createLivePlayerContext: "platform.createLivePlayerContext",
  createLivePusherContext: "platform.createLivePusherContext",
  getBackgroundAudioManager: "platform.getBackgroundAudioManager",
  getRecorderManager: "platform.getRecorderManager",
  getFileSystemManager: "platform.getFileSystemManager",
  scanCode: "platform.scanCode",
  createCameraContext: "platform.createCameraContext",
  openBluetoothAdapter: "platform.openBluetoothAdapter",
  startBluetoothDevicesDiscovery: "platform.startBluetoothDevicesDiscovery",
  createBLEConnection: "platform.createBLEConnection",
  readBLECharacteristicValue: "platform.readBLECharacteristicValue",
  writeBLECharacteristicValue: "platform.writeBLECharacteristicValue",
  notifyBLECharacteristicValueChange: "platform.notifyBLECharacteristicValueChange",
  createCanvasContext: "platform.createCanvasContext",
  canvasToTempFilePath: "platform.canvasToTempFilePath",
} as const;
