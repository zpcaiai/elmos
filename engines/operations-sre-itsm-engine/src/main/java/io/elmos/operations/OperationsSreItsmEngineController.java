...
public final class OperationsSreItsmEngineController {
    ...
    @ExceptionHandler(IllegalArgumentException.class) @ResponseStatus(HttpStatus.BAD_REQUEST) Map<String,Object> badRequest(IllegalArgumentException e) { return Map.of("errorCode", "OPERATIONS_REQUEST_REJECTED", "message", e.getMessage(), "retryable", false); }
}
