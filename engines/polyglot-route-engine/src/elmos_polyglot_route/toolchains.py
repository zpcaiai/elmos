...
_HOMEBREW_ROUTE_REFRESHED_HOSTED_PROFILE = replace(
    _HOMEBREW_ROUTE_CURRENT_HOSTED_PROFILE,
...
_HOMEBREW_ROUTE_HOST_PROFILES = (
    ...
    _HOMEBREW_ROUTE_CURRENT_HOSTED_PROFILE,
    _HOMEBREW_ROUTE_REFRESHED_HOSTED_PROFILE,
)
...
_APPLE_ROUTE_REFRESHED_PROFILE = replace(
...
_APPLE_ROUTE_HOST_PROFILES = (
    ...
    _APPLE_ROUTE_CURRENT_PROFILE,
    _APPLE_ROUTE_REFRESHED_PROFILE,
