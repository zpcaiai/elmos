...
class CppAstParser(BaseAstParser):
    ...
    def parse(self, source_code: str) -> UniversalModule:
        ...
        for match in class_head_regex.finditer(source_code):
            ...
            u_class = UniversalClass(name=class_name, super_class=super_class.strip() if super_class else None)
                    ...
                    for param_str in params_str.split(","):
                        ...
                        if len(param_parts) >= 2:
                            ...
                            u_method.params.append(
                                UniversalParam(name=p_name, type_info=self._parse_cpp_type(p_type_str))
                            )
