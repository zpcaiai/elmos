...
_UNIT_ID = re.compile(r"^WU-[0-9]{5}(?:-F[0-9]{3})?$")
...
def build_conversion_report(
    ...
    *,
    ...
    # Derived, never a literal.  This list arrived frozen at the nine-language
    # era and rejected php, kotlin, react and flutter -- every route the
    # matrix gained after it was written.  It is compared against the same
    # surface the discovery report it summarises was produced under.
    languages = set(REPOSITORY_SURFACE_LANGUAGES)
...
def validate_conversion_report(report: dict[str, Any]) -> None:
    ...
    for item in functions:
        ...
        if obligation_id in seen or not re.fullmatch(r"WU-[0-9]{5}(?:-F[0-9]{3})?:FO-[0-9]{3,6}", obligation_id):
