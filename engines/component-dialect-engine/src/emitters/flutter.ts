 ...
 *
 * TARGET-ONLY. The external Dart toolchain owns Flutter source parsing.
 * Generated output can be analyzed when a Flutter project is available, but
 * this engine never treats that static analysis as device/runtime evidence.
 *
...
export function emitFlutter(component: ComponentDef): string {
  ...
  lines.push(`// NOTE: Flutter/Dart analysis and device runtime evidence are external to this engine.`);
  lines.push(`import 'package:flutter/material.dart';`);
  if (JSON.stringify(component).includes('"kind":"numericFunction"')) lines.push(`import 'dart:math' as math;`);
  lines.push("");
