...
from .tools import CancellationToken, ToolGateway
...
class AgentRuntime:
    ...
    def _run_turn(self, request: RuntimeTurnInput, *, now: float | None = None) -> RuntimeTurnResult:
        ...
        try:
            ...
            except Exception as error:  # noqa: BLE001 - provider failure is durably recorded and blocked
        ...
        except Exception as error:  # noqa: BLE001 - runtime failure is durably recorded and blocked
