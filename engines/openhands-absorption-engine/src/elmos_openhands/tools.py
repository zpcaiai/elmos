...
from .models import Action, ActionStatus, ArtifactRef, Identity, Observation, canonical_json
...
class ToolGateway:
    ...
    def execute(
        ...
        *,
        ...
        except Exception as error:  # noqa: BLE001 - executor failure is an observation, not a gateway crash
