...
description: "Implement and verify Batch 37 Skill 1309 for transformation recipe sdk. Use when work requires Transformation Recipe SDK, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Transformation Recipe SDK
...
## Skill 1309: Transformation Recipe SDK
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-transformation-recipe-sdk`.
...
4. Implement the smallest production-shaped capability that exercises `Transformation Recipe SDK` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-transformation-recipe-sdk`
