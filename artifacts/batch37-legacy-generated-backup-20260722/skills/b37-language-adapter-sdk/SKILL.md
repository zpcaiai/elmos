...
description: "Implement and verify Batch 37 Skill 1307 for language adapter sdk. Use when work requires Language Adapter SDK, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Language Adapter SDK
...
## Skill 1307: Language Adapter SDK
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-language-adapter-sdk`.
...
4. Implement the smallest production-shaped capability that exercises `Language Adapter SDK` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-language-adapter-sdk`
