...
description: "Implement and verify Batch 37 Skill 1317 for extension sandbox test harness. Use when work requires Extension Sandbox\u548cTest Harness, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Extension Sandbox和Test Harness
...
## Skill 1317: Extension Sandbox和Test Harness
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-extension-sandbox-test-harness`.
...
4. Implement the smallest production-shaped capability that exercises `Extension Sandbox和Test Harness` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-extension-sandbox-test-harness`
