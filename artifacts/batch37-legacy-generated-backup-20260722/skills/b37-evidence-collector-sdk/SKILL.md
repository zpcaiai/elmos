...
description: "Implement and verify Batch 37 Skill 1312 for evidence collector sdk. Use when work requires Evidence Collector SDK, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
## Skill 1312: Evidence Collector SDK
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-evidence-collector-sdk`.
...
4. Implement the smallest production-shaped capability that exercises `Evidence Collector SDK` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-evidence-collector-sdk`
