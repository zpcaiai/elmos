...
description: "Implement and verify Batch 37 Skill 1306 for extension manifest abi lifecycle. Use when work requires Extension Manifest\u3001ABI\u548c\u751f\u547d\u5468\u671f\u534f\u8bae, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Extension Manifest、ABI和生命周期协议
...
## Skill 1306: Extension Manifest、ABI和生命周期协议
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-extension-manifest-abi-lifecycle`.
...
4. Implement the smallest production-shaped capability that exercises `Extension Manifest、ABI和生命周期协议` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-extension-manifest-abi-lifecycle`
