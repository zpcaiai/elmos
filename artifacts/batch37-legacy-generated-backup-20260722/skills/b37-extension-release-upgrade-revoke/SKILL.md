---
name: b37-extension-release-upgrade-revoke
description: "Implement and verify Batch 37 Skill 1322 for extension release upgrade revoke. Use when work requires \u53d1\u5e03\u3001\u5b89\u88c5\u3001\u5347\u7ea7\u3001\u56de\u6eda\u548c\u64a4\u9500, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-extension-release-upgrade-revoke`.
...
4. Implement the smallest production-shaped capability that exercises `发布、安装、升级、回滚和撤销` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-extension-release-upgrade-revoke`
