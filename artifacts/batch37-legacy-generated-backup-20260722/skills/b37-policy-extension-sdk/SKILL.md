...
description: "Implement and verify Batch 37 Skill 1315 for policy extension sdk. Use when work requires Policy Extension SDK, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
## Skill 1315: Policy Extension SDK
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-policy-extension-sdk`.
...
4. Implement the smallest production-shaped capability that exercises `Policy Extension SDK` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-policy-extension-sdk`
