---
name: b37-extension-local-devkit
description: "Implement and verify Batch 37 Skill 1316 for extension local devkit. Use when work requires \u6269\u5c55\u672c\u5730\u5f00\u53d1\u5de5\u5177\u5305, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-extension-local-devkit`.
...
4. Implement the smallest production-shaped capability that exercises `扩展本地开发工具包` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-extension-local-devkit`
