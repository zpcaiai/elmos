...
description: "Implement and verify Batch 37 Skill 1314 for vertical pack sdk. Use when work requires Vertical Pack SDK, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-vertical-pack-sdk`.
...
4. Implement the smallest production-shaped capability that exercises `Vertical Pack SDK` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-vertical-pack-sdk`
