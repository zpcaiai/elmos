---
name: b37-extension-ecosystem-gate
description: "Implement and verify Batch 37 Skill 1324 for extension ecosystem gate. Use when work requires Batch 37\u6269\u5c55\u751f\u6001\u8d28\u91cf\u95e8\u7981, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-extension-ecosystem-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 37扩展生态质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-extension-ecosystem-gate`
