...
description: "Implement and verify Batch 37 Skill 1313 for runner job sdk. Use when work requires Runner Job SDK, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-runner-job-sdk`.
...
4. Implement the smallest production-shaped capability that exercises `Runner Job SDK` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-runner-job-sdk`
