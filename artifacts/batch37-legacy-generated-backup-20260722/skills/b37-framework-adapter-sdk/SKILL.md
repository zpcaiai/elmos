...
description: "Implement and verify Batch 37 Skill 1308 for framework adapter sdk. Use when work requires Framework Adapter SDK, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
## Skill 1308: Framework Adapter SDK
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-framework-adapter-sdk`.
...
4. Implement the smallest production-shaped capability that exercises `Framework Adapter SDK` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-framework-adapter-sdk`
