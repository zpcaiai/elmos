...
description: "Implement and verify Batch 37 Skill 1311 for comparator normalizer sdk. Use when work requires Comparator\u548cNormalizer SDK, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Comparator和Normalizer SDK
...
## Skill 1311: Comparator和Normalizer SDK
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-comparator-normalizer-sdk`.
...
4. Implement the smallest production-shaped capability that exercises `Comparator和Normalizer SDK` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-comparator-normalizer-sdk`
