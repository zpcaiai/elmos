...
description: "Implement and verify Batch 37 Skill 1305 for extension marketplace factory. Use when work requires \u6269\u5c55\u5e73\u53f0\u548cMarketplace\u5b9e\u65bd\u603b\u7f16\u6392, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 扩展平台和Marketplace实施总编排
...
## Skill 1305: 扩展平台和Marketplace实施总编排
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-extension-marketplace-factory`.
...
4. Implement the smallest production-shaped capability that exercises `扩展平台和Marketplace实施总编排` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-extension-marketplace-factory`
