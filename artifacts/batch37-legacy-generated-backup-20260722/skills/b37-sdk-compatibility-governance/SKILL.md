---
name: b37-sdk-compatibility-governance
description: "Implement and verify Batch 37 Skill 1319 for sdk compatibility governance. Use when work requires SDK\u517c\u5bb9\u3001\u7248\u672c\u548cBreaking Change\u6cbb\u7406, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# SDK兼容、版本和Breaking Change治理
...
## Skill 1319: SDK兼容、版本和Breaking Change治理
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-sdk-compatibility-governance`.
...
4. Implement the smallest production-shaped capability that exercises `SDK兼容、版本和Breaking Change治理` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-sdk-compatibility-governance`
