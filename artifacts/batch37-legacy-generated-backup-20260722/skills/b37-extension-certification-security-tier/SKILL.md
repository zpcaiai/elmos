---
name: b37-extension-certification-security-tier
description: "Implement and verify Batch 37 Skill 1321 for extension certification security tier. Use when work requires \u6280\u672f\u8ba4\u8bc1\u3001\u5b89\u5168\u5ba1\u6838\u548c\u8d28\u91cf\u5206\u7ea7, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-extension-certification-security-tier`.
...
4. Implement the smallest production-shaped capability that exercises `技术认证、安全审核和质量分级` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-extension-certification-security-tier`
