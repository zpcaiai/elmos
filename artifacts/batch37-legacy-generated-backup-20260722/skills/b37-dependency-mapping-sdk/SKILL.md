...
description: "Implement and verify Batch 37 Skill 1310 for dependency mapping sdk. Use when work requires Dependency Mapping SDK, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Dependency Mapping SDK
...
## Skill 1310: Dependency Mapping SDK
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-dependency-mapping-sdk`.
...
4. Implement the smallest production-shaped capability that exercises `Dependency Mapping SDK` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-dependency-mapping-sdk`
