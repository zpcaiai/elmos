---
name: b37-marketplace-license-billing-share
description: "Implement and verify Batch 37 Skill 1323 for marketplace license billing share. Use when work requires Commercial License\u3001\u8ba1\u8d39\u548cRevenue Share, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Commercial License、计费和Revenue Share
...
## Skill 1323: Commercial License、计费和Revenue Share
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b37-marketplace-license-billing-share`.
...
4. Implement the smallest production-shaped capability that exercises `Commercial License、计费和Revenue Share` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b37-marketplace-license-billing-share`
