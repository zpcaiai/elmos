---
name: b36-developer-experience-gate
description: "Implement and verify Batch 36 Skill 1304 for developer experience gate. Use when work requires Batch 36\u5f00\u53d1\u8005\u4f53\u9a8c\u8d28\u91cf\u95e8\u7981, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-developer-experience-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 36开发者体验质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-developer-experience-gate`
