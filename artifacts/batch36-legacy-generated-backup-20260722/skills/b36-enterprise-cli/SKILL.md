...
description: "Implement and verify Batch 36 Skill 1291 for enterprise cli. Use when work requires \u4f01\u4e1a\u7ea7CLI\u548c\u81ea\u52a8\u5316\u811a\u672c\u63a5\u53e3, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-enterprise-cli`.
...
4. Implement the smallest production-shaped capability that exercises `企业级CLI和自动化脚本接口` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-enterprise-cli`
