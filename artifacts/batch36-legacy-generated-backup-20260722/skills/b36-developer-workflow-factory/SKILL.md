...
description: "Implement and verify Batch 36 Skill 1287 for developer workflow factory. Use when work requires Developer Workflow\u548cIDE\u4f53\u9a8c\u603b\u7f16\u6392, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Developer Workflow和IDE体验总编排
...
## Skill 1287: Developer Workflow和IDE体验总编排
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-developer-workflow-factory`.
...
4. Implement the smallest production-shaped capability that exercises `Developer Workflow和IDE体验总编排` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-developer-workflow-factory`
