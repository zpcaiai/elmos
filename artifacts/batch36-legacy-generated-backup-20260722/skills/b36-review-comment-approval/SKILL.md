---
name: b36-review-comment-approval
description: "Implement and verify Batch 36 Skill 1301 for review comment approval. Use when work requires Review\u3001Comment\u548c\u534f\u540c\u5ba1\u6279, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
## Skill 1301: Review、Comment和协同审批
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-review-comment-approval`.
...
4. Implement the smallest production-shaped capability that exercises `Review、Comment和协同审批` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-review-comment-approval`
