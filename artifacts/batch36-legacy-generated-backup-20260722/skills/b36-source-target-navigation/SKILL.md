...
description: "Implement and verify Batch 36 Skill 1294 for source target navigation. Use when work requires Source\u2014Target\u53cc\u5411\u5bfc\u822a, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-source-target-navigation`.
...
4. Implement the smallest production-shaped capability that exercises `Source—Target双向导航` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-source-target-navigation`
