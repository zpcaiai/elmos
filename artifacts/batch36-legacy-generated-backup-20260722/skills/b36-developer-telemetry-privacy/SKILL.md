...
description: "Implement and verify Batch 36 Skill 1303 for developer telemetry privacy. Use when work requires Developer Telemetry\u3001\u9690\u79c1\u548c\u4f53\u9a8c\u5206\u6790, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Developer Telemetry、隐私和体验分析
...
## Skill 1303: Developer Telemetry、隐私和体验分析
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-developer-telemetry-privacy`.
...
4. Implement the smallest production-shaped capability that exercises `Developer Telemetry、隐私和体验分析` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-developer-telemetry-privacy`
