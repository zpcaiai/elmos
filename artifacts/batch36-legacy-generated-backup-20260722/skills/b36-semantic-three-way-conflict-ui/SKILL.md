---
name: b36-semantic-three-way-conflict-ui
description: "Implement and verify Batch 36 Skill 1297 for semantic three way conflict ui. Use when work requires \u8bed\u4e49\u4e09\u65b9\u51b2\u7a81\u89e3\u51b3UI, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-semantic-three-way-conflict-ui`.
...
4. Implement the smallest production-shaped capability that exercises `语义三方冲突解决UI` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-semantic-three-way-conflict-ui`
