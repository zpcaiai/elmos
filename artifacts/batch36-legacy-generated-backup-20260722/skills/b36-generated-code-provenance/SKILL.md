---
name: b36-generated-code-provenance
description: "Implement and verify Batch 36 Skill 1295 for generated code provenance. Use when work requires \u751f\u6210\u4ee3\u7801\u89e3\u91ca\u548cRule Provenance, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 生成代码解释和Rule Provenance
...
## Skill 1295: 生成代码解释和Rule Provenance
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-generated-code-provenance`.
...
4. Implement the smallest production-shaped capability that exercises `生成代码解释和Rule Provenance` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-generated-code-provenance`
