...
description: "Implement and verify Batch 36 Skill 1302 for offline private developer workflow. Use when work requires \u79bb\u7ebf\u548c\u79c1\u6709\u73af\u5883Developer Workflow, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 离线和私有环境Developer Workflow
...
## Skill 1302: 离线和私有环境Developer Workflow
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-offline-private-developer-workflow`.
...
4. Implement the smallest production-shaped capability that exercises `离线和私有环境Developer Workflow` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-offline-private-developer-workflow`
