---
name: b36-protected-region-ownership
description: "Implement and verify Batch 36 Skill 1298 for protected region ownership. Use when work requires Ownership\u3001Protected Region\u548c\u4eba\u5de5\u4ee3\u7801\u7ba1\u7406, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Ownership、Protected Region和人工代码管理
...
## Skill 1298: Ownership、Protected Region和人工代码管理
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-protected-region-ownership`.
...
4. Implement the smallest production-shaped capability that exercises `Ownership、Protected Region和人工代码管理` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-protected-region-ownership`
