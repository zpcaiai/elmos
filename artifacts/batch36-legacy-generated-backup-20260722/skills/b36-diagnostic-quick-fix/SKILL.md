...
description: "Implement and verify Batch 36 Skill 1296 for diagnostic quick fix. Use when work requires Diagnostic Quick Fix\u548c\u5c40\u90e8Repair Action, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Diagnostic Quick Fix和局部Repair Action
...
## Skill 1296: Diagnostic Quick Fix和局部Repair Action
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-diagnostic-quick-fix`.
...
4. Implement the smallest production-shaped capability that exercises `Diagnostic Quick Fix和局部Repair Action` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-diagnostic-quick-fix`
