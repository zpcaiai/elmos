...
description: "Implement and verify Batch 36 Skill 1293 for local migration preview. Use when work requires \u672c\u5730Migration Preview\u548cDry Run, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 本地Migration Preview和Dry Run
...
## Skill 1293: 本地Migration Preview和Dry Run
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-local-migration-preview`.
...
4. Implement the smallest production-shaped capability that exercises `本地Migration Preview和Dry Run` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-local-migration-preview`
