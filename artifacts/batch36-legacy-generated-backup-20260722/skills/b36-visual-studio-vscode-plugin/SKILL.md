---
name: b36-visual-studio-vscode-plugin
description: "Implement and verify Batch 36 Skill 1290 for visual studio vscode plugin. Use when work requires Visual Studio\u548cVS Code\u63d2\u4ef6, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Visual Studio和VS Code插件
...
## Skill 1290: Visual Studio和VS Code插件
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-visual-studio-vscode-plugin`.
...
4. Implement the smallest production-shaped capability that exercises `Visual Studio和VS Code插件` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-visual-studio-vscode-plugin`
