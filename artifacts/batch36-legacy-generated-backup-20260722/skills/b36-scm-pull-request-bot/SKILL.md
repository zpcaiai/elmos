---
name: b36-scm-pull-request-bot
description: "Implement and verify Batch 36 Skill 1292 for scm pull request bot. Use when work requires GitHub\u3001GitLab\u548cBitbucket PR Bot, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# GitHub、GitLab和Bitbucket PR Bot
...
## Skill 1292: GitHub、GitLab和Bitbucket PR Bot
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-scm-pull-request-bot`.
...
4. Implement the smallest production-shaped capability that exercises `GitHub、GitLab和Bitbucket PR Bot` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-scm-pull-request-bot`
