...
description: "Implement and verify Batch 36 Skill 1300 for recipe mapping authoring. Use when work requires Recipe\u548cMapping\u53ef\u89c6\u5316Authoring, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Recipe和Mapping可视化Authoring
...
## Skill 1300: Recipe和Mapping可视化Authoring
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-recipe-mapping-authoring`.
...
4. Implement the smallest production-shaped capability that exercises `Recipe和Mapping可视化Authoring` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-recipe-mapping-authoring`
