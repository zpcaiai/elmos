...
description: "Implement and verify Batch 36 Skill 1289 for intellij plugin. Use when work requires IntelliJ IDEA\u63d2\u4ef6, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b36-intellij-plugin`.
...
4. Implement the smallest production-shaped capability that exercises `IntelliJ IDEA插件` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b36-intellij-plugin`
