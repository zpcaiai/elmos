---
name: b35-verification-profile-oracles
description: "Implement and verify Batch 35 Skill 1266 for verification profile oracles. Use when work requires \u9a8c\u8bc1Profile\u3001\u98ce\u9669\u7b49\u7ea7\u548cOracle\u7ec4\u5408, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# 验证Profile、风险等级和Oracle组合
...
## Skill 1266: 验证Profile、风险等级和Oracle组合
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b35-verification-profile-oracles`.
...
4. Implement the smallest production-shaped capability that exercises `验证Profile、风险等级和Oracle组合` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b35-verification-profile-oracles`
