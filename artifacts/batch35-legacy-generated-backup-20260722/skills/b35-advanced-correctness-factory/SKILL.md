---
name: b35-advanced-correctness-factory
description: "Implement and verify Batch 35 Skill 1265 for advanced correctness factory. Use when work requires \u9ad8\u7ea7\u6b63\u786e\u6027\u9a8c\u8bc1\u603b\u7f16\u6392, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b35-advanced-correctness-factory`.
...
4. Implement the smallest production-shaped capability that exercises `高级正确性验证总编排` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b35-advanced-correctness-factory`
