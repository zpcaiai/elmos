---
name: b35-correctness-certification-gate
description: "Implement and verify Batch 35 Skill 1286 for correctness certification gate. Use when work requires Batch 35\u9ad8\u7ea7\u9a8c\u8bc1\u8d28\u91cf\u95e8\u7981, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b35-correctness-certification-gate`.
...
4. Implement the smallest production-shaped capability that exercises `Batch 35高级验证质量门禁` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b35-correctness-certification-gate`
