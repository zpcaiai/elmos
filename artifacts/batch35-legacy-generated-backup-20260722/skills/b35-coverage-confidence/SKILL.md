---
name: b35-coverage-confidence
description: "Implement and verify Batch 35 Skill 1283 for coverage confidence. Use when work requires \u9a8c\u8bc1\u8986\u76d6\u5ea6\u548c\u7f6e\u4fe1\u533a\u95f4, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b35-coverage-confidence`.
...
4. Implement the smallest production-shaped capability that exercises `验证覆盖度和置信区间` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b35-coverage-confidence`
