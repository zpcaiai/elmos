---
name: b35-oracle-governance-arbitration
description: "Implement and verify Batch 35 Skill 1282 for oracle governance arbitration. Use when work requires Oracle\u6cbb\u7406\u548c\u51b2\u7a81\u88c1\u51b3, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b35-oracle-governance-arbitration`.
...
4. Implement the smallest production-shaped capability that exercises `Oracle治理和冲突裁决` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b35-oracle-governance-arbitration`
