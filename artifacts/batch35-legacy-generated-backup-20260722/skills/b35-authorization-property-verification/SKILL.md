---
name: b35-authorization-property-verification
description: "Implement and verify Batch 35 Skill 1276 for authorization property verification. Use when work requires Security Property\u548cAuthorization\u9a8c\u8bc1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Security Property和Authorization验证
...
## Skill 1276: Security Property和Authorization验证
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b35-authorization-property-verification`.
...
4. Implement the smallest production-shaped capability that exercises `Security Property和Authorization验证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b35-authorization-property-verification`
