---
name: b35-numeric-decimal-float-precision
description: "Implement and verify Batch 35 Skill 1280 for numeric decimal float precision. Use when work requires \u6570\u503c\u3001Decimal\u548c\u6d6e\u70b9\u9ad8\u7cbe\u5ea6\u9a8c\u8bc1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b35-numeric-decimal-float-precision`.
...
4. Implement the smallest production-shaped capability that exercises `数值、Decimal和浮点高精度验证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b35-numeric-decimal-float-precision`
