---
name: b35-race-deadlock-liveness
description: "Implement and verify Batch 35 Skill 1278 for race deadlock liveness. Use when work requires Race\u3001Deadlock\u548cLiveness\u9a8c\u8bc1, typed evidence, negative and holdout validation, and a fail-closed certification decision."
---

# Race、Deadlock和Liveness验证
...
## Skill 1278: Race、Deadlock和Liveness验证
...
1. Inspect the current implementation, runtime facts, policies, incidents, decisions, and prior evidence relevant to `b35-race-deadlock-liveness`.
...
4. Implement the smallest production-shaped capability that exercises `Race、Deadlock和Liveness验证` without bypassing existing control planes.
...
- Capability-specific implementation, tests, run logs, evidence references, and residual-risk records for `b35-race-deadlock-liveness`
