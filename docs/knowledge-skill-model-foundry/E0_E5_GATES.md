...
| E1 | executable unit/contract behavior for the exact handler and environment | only one of the 45 exact local handlers, after successful replay, may qualify locally |
