...
- `meteringReconciliationRate` must satisfy `min 1.0`.
- `budgetGuardrailPassRate` must satisfy `min 1.0`.
- `grossMarginEvidenceCoverageRate` must satisfy `min 0.95`.
