---
name: b104-release-readiness-review
description: "Use when ELMOS must Aggregate engineering, security, legal, operations, support, cost and customer evidence into a decision packet. Triggers: Release Readiness Review, Real World Product Certification Pack, release review, risk register, open exceptions, decision packet."
metadata:
  id: B104-S15
...
# B104-S15 — Release Readiness Review

## Objective

Aggregate engineering, security, legal, operations, support, cost and customer evidence into a decision packet.
...
Use this Skill when the approved task explicitly requires **Release Readiness Review** or when the capability graph selects it as part of a minimal dependency closure.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b104-release-readiness-review/SKILL.md --out /tmp/release_readiness_review.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B104-S15
```
...
- Reject or expose green dashboard hides defect.
- Reject or expose missing legal review.
- Reject or expose risk owner blank.
