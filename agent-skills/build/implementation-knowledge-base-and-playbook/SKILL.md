---
name: implementation-knowledge-base-and-playbook
description: Build or review ELMOS evidence-backed migration knowledge, playbooks, known errors, permissions, anonymization, retrieval, expiry and feedback. Use when turning delivery or support experience into reusable guidance.
---

# Implementation Knowledge Base And Playbook
...
- Assign trust levels; AI output is not automatically evidence-backed.
- Keep organization/project knowledge private and anonymize company, repository, package, business data, endpoints and source before reuse.
- Retrieve by stack, target, fingerprint, project type, version, trust and tenant permission, not keyword alone.
- Require human approval to publish generalized knowledge and revoke stale or unsafe guidance.
...
- Prove cross-tenant private knowledge is not retrievable.
- Require evidence references for EVIDENCE_BACKED status.
- Agents may consume approved knowledge but cannot publish one successful fix as universal truth.
