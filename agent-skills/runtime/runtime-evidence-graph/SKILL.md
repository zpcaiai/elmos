...
description: "Repository-owned bounded wrapper for runtime-evidence-graph; external evidence remains NOT_RUN."
---
...
4. Submit `runtime-evidence-graph` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `0b1282650612266455665d0d2d82e6d1a929203e272a3890c15788f40078b372`
