...
description: "Run FRT-1204 Camera Media and Picker Capability for FRT G12 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1204"
  source_name: "frt-1204-camera-media-and-picker-capability"
  source_sha256: "sha256:f8b9f9c11ce59d81099f6b589b6654b9f4e8dbb62b45f4c4ba3e603a41c2d4b1"
  batch: "G12"
...
- Runtime catalog key: `FRT-1204` / `frt-1204-camera-media-and-picker-capability`.
...
# FRT-1204 — Camera Media and Picker Capability

## Objective

在G12范围内实现 **Camera Media and Picker Capability**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨平台Capability Registry与支持等级; Native Bridge具备Schema、Permission、Timeout和Error Contract; 支付、设备和危险能力使用Server Authority与安全状态机。

## When to Use

- 实现或修改与 **Camera Media and Picker Capability** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1204Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1204EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1204FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1204CertificateFragment`：供G12批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g12/frt-1204-camera-media-and-picker-capability/
packages/runtime/g12/frt-1204-camera-media-and-picker-capability/
services/control-plane/g12/frt-1204-camera-media-and-picker-capability/
apps/web-console/src/features/g12/frt-1204-camera-media-and-picker-capability/
apps/admin-console/src/features/g12/frt-1204-camera-media-and-picker-capability/
tests/g12/frt-1204-camera-media-and-picker-capability/
```
...
```text
POST /v1/skills/frt-1204/runs
GET  /v1/skills/frt-1204/runs/{run_id}
POST /v1/skills/frt-1204/runs/{run_id}/verify
GET  /v1/skills/frt-1204/runs/{run_id}/findings
GET  /v1/skills/frt-1204/runs/{run_id}/evidence
```
