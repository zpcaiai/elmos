...
description: Use this skill when Elmos must perform typed skill contract as part of the 00-foundation-contracts production
...
定义 Skill 的输入、输出、前置条件、后置条件、工具权限、失败语义和副作用契约。
