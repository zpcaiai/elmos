...
description: "Run FRT-2716 Autoscaling Policy Validator for FRT G27 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2716"
  source_name: "frt-2716-autoscaling-policy-validator"
  source_sha256: "sha256:cba58e9b30113dd1aaaf063e46296e0b7b0eccb6688e0a9d0610465fec1a4e31"
  batch: "G27"
...
- Runtime catalog key: `FRT-2716` / `frt-2716-autoscaling-policy-validator`.
...
在G27范围内实现 **Autoscaling Policy Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：业务化Workload Model; 并发线性化点、Race、Lost Update、Idempotency Under Load; Load/Stress/Spike/Soak与Recovery。

## When to Use

- 实现或修改与 **Autoscaling Policy Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2716Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2716EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2716FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2716CertificateFragment`：供G27批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g27/frt-2716-autoscaling-policy-validator/
packages/runtime/g27/frt-2716-autoscaling-policy-validator/
services/control-plane/g27/frt-2716-autoscaling-policy-validator/
apps/web-console/src/features/g27/frt-2716-autoscaling-policy-validator/
apps/admin-console/src/features/g27/frt-2716-autoscaling-policy-validator/
tests/g27/frt-2716-autoscaling-policy-validator/
```
...
```text
POST /v1/skills/frt-2716/runs
GET  /v1/skills/frt-2716/runs/{run_id}
POST /v1/skills/frt-2716/runs/{run_id}/verify
GET  /v1/skills/frt-2716/runs/{run_id}/findings
GET  /v1/skills/frt-2716/runs/{run_id}/evidence
```
