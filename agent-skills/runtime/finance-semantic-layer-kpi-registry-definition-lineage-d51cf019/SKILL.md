...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/finance-semantic-layer-kpi-registry-definition-lineage-d51cf019-baseline.md`.
