...
description: "Run FRT-1902 Lean Specification Generator for FRT G19 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1902"
  source_name: "frt-1902-lean-specification-generator"
  source_sha256: "sha256:19cdbea49dfaeb39d34e670e0ab687c8436f7f5a4d9952314608ffa84ce1f8b6"
  batch: "G19"
...
- Runtime catalog key: `FRT-1902` / `frt-1902-lean-specification-generator`.
...
# FRT-1902 — Lean Specification Generator

## Objective

在G19范围内实现 **Lean Specification Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：从IR、Rule和业务不变量生成Proof Obligation; Leanstral仅提出证明候选，Lean Kernel为可信根; 组合SMT、Model Checking、Symbolic和Differential Evidence。

## When to Use

- 实现或修改与 **Lean Specification Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1902Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1902EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1902FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1902CertificateFragment`：供G19批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g19/frt-1902-lean-specification-generator/
packages/runtime/g19/frt-1902-lean-specification-generator/
services/control-plane/g19/frt-1902-lean-specification-generator/
apps/web-console/src/features/g19/frt-1902-lean-specification-generator/
apps/admin-console/src/features/g19/frt-1902-lean-specification-generator/
tests/g19/frt-1902-lean-specification-generator/
```
...
```text
POST /v1/skills/frt-1902/runs
GET  /v1/skills/frt-1902/runs/{run_id}
POST /v1/skills/frt-1902/runs/{run_id}/verify
GET  /v1/skills/frt-1902/runs/{run_id}/findings
GET  /v1/skills/frt-1902/runs/{run_id}/evidence
```
