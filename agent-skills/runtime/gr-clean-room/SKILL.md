---
name: gr-clean-room
description: 从 frozen snapshot 和空白工作区重新运行并比较语义输出、Gate、时间和成本。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-077
  source_name: gr-clean-room
  source_path: skills/gr-clean-room/SKILL.md
  source_sha256: sha256:2bb5403fd4c1752a9f9354e8bfcce58607b61db7ea4262cf0e6cc537c5eed119
  source_contract_sha256: sha256:ee03a5926899d0628024e71e355d131875682bb8083f6b1820e55b431b1791fe
...
从 frozen snapshot 和空白工作区重新运行并比较语义输出、Gate、时间和成本。

## Scope and capabilities

- No hidden workspace
- Frozen profiles/tools/recipes
- Allowed nondeterminism
- Final behavior equivalence
- Variance report
...
- [ ] 定义 `gr-clean-room` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-clean-room` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：repeat-run-proof.json, variance-report.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：repeat-run-proof.json, variance-report.json。
...
- Machine contract: `references/contract.json` (`sha256:ee03a5926899d0628024e71e355d131875682bb8083f6b1820e55b431b1791fe`).
