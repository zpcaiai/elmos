...
description: "Run FRT-2908 Input Validation and Injection Validator for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2908"
  source_name: "frt-2908-input-validation-and-injection-validator"
  source_sha256: "sha256:9dfba869247e1152de278971c76fc409c5c5c7ef7677758518b5775741a60361"
  batch: "G29"
...
- Runtime catalog key: `FRT-2908` / `frt-2908-input-validation-and-injection-validator`.
...
在G29范围内实现 **Input Validation and Injection Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Input Validation and Injection Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2908Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2908EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2908FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2908CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2908-input-validation-and-injection-validator/
packages/runtime/g29/frt-2908-input-validation-and-injection-validator/
services/control-plane/g29/frt-2908-input-validation-and-injection-validator/
apps/web-console/src/features/g29/frt-2908-input-validation-and-injection-validator/
apps/admin-console/src/features/g29/frt-2908-input-validation-and-injection-validator/
tests/g29/frt-2908-input-validation-and-injection-validator/
```
...
```text
POST /v1/skills/frt-2908/runs
GET  /v1/skills/frt-2908/runs/{run_id}
POST /v1/skills/frt-2908/runs/{run_id}/verify
GET  /v1/skills/frt-2908/runs/{run_id}/findings
GET  /v1/skills/frt-2908/runs/{run_id}/evidence
```
