...
description: "Run FRT-2515 Perceived Performance Validator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2515"
  source_name: "frt-2515-perceived-performance-validator"
  source_sha256: "sha256:93bc7e6ff51dc97aa60316c9894ad5c1e638e61a638ae37c233f0e424501e3c4"
  batch: "G25"
...
- Runtime catalog key: `FRT-2515` / `frt-2515-perceived-performance-validator`.
...
在G25范围内实现 **Perceived Performance Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Perceived Performance Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2515Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2515EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2515FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2515CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2515-perceived-performance-validator/
packages/runtime/g25/frt-2515-perceived-performance-validator/
services/control-plane/g25/frt-2515-perceived-performance-validator/
apps/web-console/src/features/g25/frt-2515-perceived-performance-validator/
apps/admin-console/src/features/g25/frt-2515-perceived-performance-validator/
tests/g25/frt-2515-perceived-performance-validator/
```
...
```text
POST /v1/skills/frt-2515/runs
GET  /v1/skills/frt-2515/runs/{run_id}
POST /v1/skills/frt-2515/runs/{run_id}/verify
GET  /v1/skills/frt-2515/runs/{run_id}/findings
GET  /v1/skills/frt-2515/runs/{run_id}/evidence
```
