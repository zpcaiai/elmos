---
name: inventory-fulfillment-orchestrator
description: "Implement Batch 42B Inventory、Warehouse与Fulfillment Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Item、Inventory、Lot、Serial、Location、Warehouse Task、Allocation、Pick、Pack、Ship、Return与Cycle Count."
---
...
Implement Batch 42B Inventory、Warehouse与Fulfillment Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Item、Inventory、Lot、Serial、Location、Warehouse Task、Allocation、Pick、Pack、Ship、Return与Cycle Count.
...
5. Write unresolved domain assumptions to `docs/implementation/inventory-fulfillment-orchestrator-baseline.md`.
...
```text
inventory_fulfillment_orchestrator_manifest.json
inventory_fulfillment_orchestrator_state.json
inventory_fulfillment_orchestrator_decision.json
inventory_fulfillment_orchestrator_reconciliation.json
inventory_fulfillment_orchestrator_evidence.json
```
