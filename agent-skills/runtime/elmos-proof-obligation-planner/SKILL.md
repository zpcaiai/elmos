...
description: "按业务线、变更影响、风险等级、语言特征和证明预算，把规格分解为可执行、可缓存、可组合的证明义务 DAG。 Use when the task needs the exact Proof Obligation Planner Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-proof-obligation-planner/SKILL.md"
  source_sha256: "sha256:7570e2bb1f3cd80719dd121b21d05e63a5beb1b53265660563eb354acc80b28f"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "core"
  runtime_handler_id: "execute_elmos_proof_obligation_planner"
...
- Exact Skill identity: `elmos-proof-obligation-planner`; exact allowlisted runtime handler: `execute_elmos_proof_obligation_planner`.
- Source identity: `skills/P0/elmos-proof-obligation-planner/SKILL.md` at `sha256:7570e2bb1f3cd80719dd121b21d05e63a5beb1b53265660563eb354acc80b28f` from `elmos-formal-assurance-kernel-v1.0.0`.
...
按业务线、变更影响、风险等级、语言特征和证明预算，把规格分解为可执行、可缓存、可组合的证明义务 DAG。
...
3. Use the repository-owned `execute_elmos_proof_obligation_planner` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["weakest-precondition planning","assume-guarantee decomposition","risk-based proof planning","dependency DAG"]`
- Direct dependencies: `["elmos-formal-spec-ir","elmos-observable-behavior-contract"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-proof-obligation-planner/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
