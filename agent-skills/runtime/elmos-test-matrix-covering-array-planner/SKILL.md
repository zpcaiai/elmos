---
name: elmos-test-matrix-covering-array-planner
description: Select risk-weighted PR, nightly, release and certification matrices across language, framework, database, provider, OS, architecture and deployment dimensions.
version: 4.0.0
...
# Test Matrix Covering Array Planner
...
- **Kernel authorities used:** K1, K4, K6
...
- Enumerate exact matrix dimensions and constraints
- Generate pairwise or higher-strength covering arrays
- Force critical and historically failing combinations
- Separate PR/nightly/release/soak profiles
- Explain every omitted combination
...
- `test-selection-plan.json`
- `covering-array.json`
- `matrix-coverage-report.json`
- `omitted-combination-risk.json`
...
- **coverage percentage hides missing critical tuple** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **invalid combination wastes capacity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **selection biased toward cheap tests** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **new dimension not registered** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **holdout combination leaks into development** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- pairwise matrix
- 3-way critical interaction
- constraint-aware combinations
- changed-route selection
- historical incident inclusion
- full release matrix
