---
name: tst-b78-iac-kubernetes-helm-slightly-strict-suite
description: "Run the slightly strict test suite for Batch 78: HCL Terraform Kubernetes YAML and Helm, covering every source Skill with positive and negative executable cases."
metadata:
  id: TB78
...
---
    # TB78 — Batch 78 HCL Terraform Kubernetes YAML and Helm 略严苛测试套件

    ## Objective

    对 Batch 78 的全部 16 个Source Skills执行可重放的正向、边界、负向、故障、安全和证据完整性验证。范围为：Terraform/OpenTofu、Kubernetes YAML、Helm、GitOps、Policy、Drift 与回滚。
    ...
    |---|---|---|---|
    | PG375 | `b78-iac-kubernetes-profile-detector` | detector | `B78-PG375-RUN, B78-PG375-NEG` |
| PG376 | `b78-terraform-module-scaffolder` | iac | `B78-PG376-RUN, B78-PG376-NEG` |
| PG377 | `b78-terraform-provider-state-manager` | iac | `B78-PG377-RUN, B78-PG377-NEG` |
| PG378 | `b78-terraform-plan-policy-cost-gate` | iac | `B78-PG378-RUN, B78-PG378-NEG` |
| PG379 | `b78-terraform-import-drift-reconciler` | iac | `B78-PG379-RUN, B78-PG379-NEG` |
| PG380 | `b78-terraform-test-validation-harness` | iac | `B78-PG380-RUN, B78-PG380-NEG` |
| PG381 | `b78-kubernetes-workload-manifest-generator` | iac | `B78-PG381-RUN, B78-PG381-NEG` |
| PG382 | `b78-kubernetes-config-secret-policy` | iac | `B78-PG382-RUN, B78-PG382-NEG` |
| PG383 | `b78-kubernetes-network-security-generator` | iac | `B78-PG383-RUN, B78-PG383-NEG` |
| PG384 | `b78-kubernetes-autoscaling-reliability` | native | `B78-PG384-RUN, B78-PG384-NEG` |
| PG385 | `b78-helm-chart-generator` | iac | `B78-PG385-RUN, B78-PG385-NEG` |
| PG386 | `b78-helm-values-schema-manager` | data | `B78-PG386-RUN, B78-PG386-NEG` |
| PG387 | `b78-helm-upgrade-rollback-gate` | iac | `B78-PG387-RUN, B78-PG387-NEG` |
| PG388 | `b78-kubernetes-policy-admission-gate` | iac | `B78-PG388-RUN, B78-PG388-NEG` |
| PG389 | `b78-gitops-release-bundle-generator` | iac | `B78-PG389-RUN, B78-PG389-NEG` |
| PG390 | `b78-iac-kubernetes-helm-certifier` | iac | `B78-PG390-RUN, B78-PG390-NEG` |
...
- `helm template <release> <chart>`
    ...
    - 本Batch全部32项Source-specific Cases进入真实最终状态；
