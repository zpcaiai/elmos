---
name: elmos-sap-business-object-migrator
description: Extract ABAP DDIC/CDS, Open SQL, internal tables, BAPI/RFC/IDoc, enhancements
  and authorization behavior into target domain/integration models.
version: 1.0.0
skill_id: ELMOS-POLY-126
layer: 4gl-transformation
risk: high
readiness: not-run
dependencies:
- elmos-semantic-loss-risk-estimator
triggers:
- Use when implementing or executing `elmos-sap-business-object-migrator`.
- Use when the migration DAG requires `4gl-transformation` capability.
outputs:
- transforms/elmos-sap-business-object-migrator/plan.json
- transforms/elmos-sap-business-object-migrator/semantic-loss.json
- transforms/elmos-sap-business-object-migrator/evidence.json
---

# Sap Business Object Migrator

## Objective

Extract ABAP DDIC/CDS, Open SQL, internal tables, BAPI/RFC/IDoc, enhancements and authorization behavior into target domain/integration models.
