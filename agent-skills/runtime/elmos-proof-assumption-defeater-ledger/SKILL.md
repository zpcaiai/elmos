---
name: elmos-proof-assumption-defeater-ledger
description: Implement and independently certify proof assumption and defeater ledger, including enumerate explicit assumptions, environmental contracts and argument defeaters, link evidence that supports or challenges each assumption and invalidate dependent claims when assumption freshness or truth changes.
version: 4.0.0
...
# Proof Assumption and Defeater Ledger
...
- `ProofAssumptionAndDefeaterLedgerProfile`
- `ProofAssumptionAndDefeaterLedgerRun`
- `ProofAssumptionAndDefeaterLedgerFinding`
- `ProofAssumptionAndDefeaterLedgerDecision`
- `ProofAssumptionAndDefeaterLedgerEvidence`

Required semantic capabilities:

- enumerate explicit assumptions, environmental contracts and argument defeaters
- link evidence that supports or challenges each assumption
- invalidate dependent claims when assumption freshness or truth changes
...
- `artifacts/elmos-proof-assumption-defeater-ledger/profile.yaml`
- `artifacts/elmos-proof-assumption-defeater-ledger/plan.json`
- `artifacts/elmos-proof-assumption-defeater-ledger/result.json`
- `artifacts/elmos-proof-assumption-defeater-ledger/evidence/`
- `artifacts/elmos-proof-assumption-defeater-ledger/assurance-case.json`
...
- **critical assumption remains implicit** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **counterevidence is stored outside assurance case** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **waiver turns false assumption into proof** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: enumerate explicit assumptions, environmental contracts and argument defeaters
- native scenario: link evidence that supports or challenges each assumption
- native scenario: invalidate dependent claims when assumption freshness or truth changes
