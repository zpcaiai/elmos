---
name: b76-make-incremental-dependency-manager
description: "Use when ELMOS must coordinate and control Make Incremental Dependency Manager for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Make Incremental Dependency Manager, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG353
  batch: 76
  version: 1.0.0
...
# PG353 — Make Incremental Dependency Manager

## Objective

Coordinate and control Make Incremental Dependency Manager for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `make-incremental-dependency-manager` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`, `PG352`.
...
- `make_incremental_dependency_manager_plan.json`
- `make_incremental_dependency_manager_artifacts/`
- `make_incremental_dependency_manager_verification.json`
