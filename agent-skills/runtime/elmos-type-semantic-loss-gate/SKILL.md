...
triggers:
  - "Use when implementing or executing `elmos-type-semantic-loss-gate`."
  - "Use when a migration/certification DAG requires `quality-gate` capability."
outputs:
  - "semantic-assurance/elmos-type-semantic-loss-gate/model.json"
  - "semantic-assurance/elmos-type-semantic-loss-gate/evidence.json"
  - "semantic-assurance/elmos-type-semantic-loss-gate/diagnostics.json"
---

# Type Semantic Loss Gate

## Objective

Aggregate type-system obligations and block routes that narrow domains, erase contracts or alter observable type behavior without an approved adaptation.
...
- [ ] critical type loss blocks.
- [ ] explicit adapter/waiver fixture.
- [ ] type coverage denominator.
