---
name: elmos-railway-software-safety-case-profile
description: Implement and independently certify railway software safety case profile, including compile RAMS lifecycle, software safety integrity and independent safety assessment evidence, trace hazards, safety requirements, verification and configuration baselines and verify fail-safe behavior, degraded modes and operational rules.
version: 4.0.0
...
# Railway Software Safety Case Profile
...
- `RailwaySoftwareSafetyCaseProfileProfile`
- `RailwaySoftwareSafetyCaseProfileRun`
- `RailwaySoftwareSafetyCaseProfileFinding`
- `RailwaySoftwareSafetyCaseProfileDecision`
- `RailwaySoftwareSafetyCaseProfileEvidence`

Required semantic capabilities:

- compile RAMS lifecycle, software safety integrity and independent safety assessment evidence
- trace hazards, safety requirements, verification and configuration baselines
- verify fail-safe behavior, degraded modes and operational rules
...
- `artifacts/elmos-railway-software-safety-case-profile/profile.yaml`
- `artifacts/elmos-railway-software-safety-case-profile/plan.json`
- `artifacts/elmos-railway-software-safety-case-profile/result.json`
- `artifacts/elmos-railway-software-safety-case-profile/evidence/`
- `artifacts/elmos-railway-software-safety-case-profile/assurance-case.json`
...
- **safety case reuses evidence from different signaling context** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **independent assessor lacks access to supplier evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **degraded mode is not tested** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile RAMS lifecycle, software safety integrity and independent safety assessment evidence
- native scenario: trace hazards, safety requirements, verification and configuration baselines
- native scenario: verify fail-safe behavior, degraded modes and operational rules
