---
name: elmos-ai-e0-e5-certifier
description: Issue an independent bounded completion decision only when the exact RevisionSet, obligations, evidence freshness,
  side effects and E0–E5 gates satisfy policy.
version: 4.0.0
...
- Evaluate E0-E5 and P05 independently
- Seal exact evidence and assumptions
- Issue bounded certificates or blocked results
- Invalidate and revoke on drift
...
- `elmos-ai-graph-liveness-side-effect-verifier` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
...
- **certificate forgery** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **revision substitution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale evidence reuse** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **waiver hidden** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **agent says done** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- counterexample
- unknown verifier
- AiE0E5Certifier representative end-to-end fixture
