---
name: payroll-workforce-orchestrator
description: "Implement Batch 43C Payroll、Benefits、Time、Attendance与Workforce Planning end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Time Entry、Schedule、Leave、Payroll Input、Payroll Run、Benefit、Deduction、Tax、Position Plan与Labor Cost."
---
...
Implement Batch 43C Payroll、Benefits、Time、Attendance与Workforce Planning end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Time Entry、Schedule、Leave、Payroll Input、Payroll Run、Benefit、Deduction、Tax、Position Plan与Labor Cost.
...
5. Write unresolved domain assumptions to `docs/implementation/payroll-workforce-orchestrator-baseline.md`.
...
```text
payroll_workforce_orchestrator_manifest.json
payroll_workforce_orchestrator_state.json
payroll_workforce_orchestrator_decision.json
payroll_workforce_orchestrator_reconciliation.json
payroll_workforce_orchestrator_evidence.json
```
