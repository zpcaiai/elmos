---
name: transaction-state-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Transaction and State Consistency Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T099"
  source_name: "transaction-state-gate"
  source_sha256: "sha256:43381513a695d65c980046bbd47b6cf5fed256be2c77db951c9aed4d4f89cfe0"
...
# T099 — Transaction and State Consistency Gate

## 1. Objective

Validate commit, rollback, locking, replay, state recovery and consistency boundaries across platforms.
...
- `CASE-0421` [HIGH] Transaction and State Consistency Gate: Representative path
- `CASE-0422` [HIGH] Transaction and State Consistency Gate: Boundary path
- `CASE-0423` [HIGH] Transaction and State Consistency Gate: Invalid or hostile input
- `CASE-0424` [HIGH] Transaction and State Consistency Gate: Injected dependency failure
- `CASE-0425` [CRITICAL] Transaction and State Consistency Gate: Security or safety violation
- `CASE-0426` [HIGH] Transaction and State Consistency Gate: Replay and idempotency
- `CASE-0427` [HIGH] Transaction and State Consistency Gate: Version or environment drift
- `CASE-0428` [MEDIUM] Transaction and State Consistency Gate: Moderate scale
- `CASE-0429` [CRITICAL] Transaction and State Consistency Gate: Evidence tamper
- `CASE-0430` [HIGH] Transaction and State Consistency Gate: Recovery and final evidence
