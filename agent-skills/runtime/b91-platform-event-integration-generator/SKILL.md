---
name: b91-platform-event-integration-generator
description: "Use when ELMOS must run platform event integration generator for Batch 91 Salesforce Apex / SOQL / LWC Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG350"
  source_name: "platform-event-integration-generator"
  source_sha256: "sha256:db7696fc519e03ab4d0b63e40e44060d5cf9adeb8215e6f15e2fff43620d6cb2"
  batch: 91
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 91 Language Pack / source PG350 — Platform Event Integration Generator

## 1. Objective

Generate platform event integration generator within the Salesforce Apex / SOQL / LWC Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Platform Event Integration Generator using the approved enterprise-crm-platform semantic contracts and toolchain versions.
...
- A representative valid salesforce input produces all declared outputs for platform-event-integration-generator.
