---
name: elmos-recipe-license-gate
description: 对 OpenRewrite Apache、Moderne Source Available、专有 Recipe 和 Elmos Native Recipe 做商业使用 Gate。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-007
  source_name: elmos-recipe-license-gate
  source_path: skills/elmos-recipe-license-gate/SKILL.md
  source_sha256: sha256:294b2e7f1bc9803247724893fe55da900ddf1c533e4d787400987fa11a382b25
  source_contract_sha256: sha256:ff404265723f3488b148a9499ba42ca9ec631679e8da6acea90ee3a2687f0127
...
对 OpenRewrite Apache、Moderne Source Available、专有 Recipe 和 Elmos Native Recipe 做商业使用 Gate。
...
- [ ] 定义 `elmos-recipe-license-gate` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `elmos-recipe-license-gate` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：recipe-license-ledger.json, license-decision.json, NOTICE.md。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：recipe-license-ledger.json, license-decision.json, NOTICE.md。
- [ ] 所有 mandatory tests 和 security gates 通过，且无 critical unknown。

## Dependencies

- `elmos-build-buy-partner`
...
- Machine contract: `references/contract.json` (`sha256:ff404265723f3488b148a9499ba42ca9ec631679e8da6acea90ee3a2687f0127`).
