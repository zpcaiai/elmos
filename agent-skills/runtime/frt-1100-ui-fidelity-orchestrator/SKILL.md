...
description: "Run FRT-1100 UI Fidelity Orchestrator for FRT G11 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1100"
  source_name: "frt-1100-ui-fidelity-orchestrator"
  source_sha256: "sha256:c0ef751f061dfcce039302e076b87a71ad47714d2f7d39ed9f54c0cacdcf19fe"
  batch: "G11"
...
- Runtime catalog key: `FRT-1100` / `frt-1100-ui-fidelity-orchestrator`.
...
# FRT-1100 — UI Fidelity Orchestrator

## Objective

在G11范围内实现 **UI Fidelity Orchestrator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：恢复布局约束、Design Token和响应式Size Class; 生成资产、字体、Icon、Theme和动画映射; 保持Locale、Plural、Date/Number和RTL语义。

## When to Use

- 实现或修改与 **UI Fidelity Orchestrator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1100Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1100EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1100FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1100CertificateFragment`：供G11批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g11/frt-1100-ui-fidelity-orchestrator/
packages/runtime/g11/frt-1100-ui-fidelity-orchestrator/
services/control-plane/g11/frt-1100-ui-fidelity-orchestrator/
apps/web-console/src/features/g11/frt-1100-ui-fidelity-orchestrator/
apps/admin-console/src/features/g11/frt-1100-ui-fidelity-orchestrator/
tests/g11/frt-1100-ui-fidelity-orchestrator/
```
...
```text
POST /v1/skills/frt-1100/runs
GET  /v1/skills/frt-1100/runs/{run_id}
POST /v1/skills/frt-1100/runs/{run_id}/verify
GET  /v1/skills/frt-1100/runs/{run_id}/findings
GET  /v1/skills/frt-1100/runs/{run_id}/evidence
```
