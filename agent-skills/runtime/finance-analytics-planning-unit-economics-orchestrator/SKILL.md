---
name: finance-analytics-planning-unit-economics-orchestrator
description: "Implement Batch 39C end to end: finance semantics, recurring revenue, bridges, cohorts, margin, cost allocation, budgeting, forecasting, variance, pricing analytics, profitability, reporting, workflow and release gates."
---
...
Implement Batch 39C end to end: finance semantics, recurring revenue, bridges, cohorts, margin, cost allocation, budgeting, forecasting, variance, pricing analytics, profitability, reporting, workflow and release gates.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/finance-analytics-planning-unit-economics-orchestrator-baseline.md`.
...
```text
finance_analytics_planning_unit_economics_orchestrator_manifest.json
finance_analytics_planning_unit_economics_orchestrator_decision.json
finance_analytics_planning_unit_economics_orchestrator_reconciliation.json
finance_analytics_planning_unit_economics_orchestrator_evidence.json
```
...
```text
domainLifecycleUsesVersionedFacts
providerUnknownResultRequiresReconciliation
