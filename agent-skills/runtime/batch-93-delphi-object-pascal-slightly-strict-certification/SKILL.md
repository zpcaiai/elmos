---
name: batch-93-delphi-object-pascal-slightly-strict-certification
description: "Run the exact ELMOS Batch 81-95 slightly-strict Delphi Object Pascal Modernization Certification tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T093"
  source_name: "batch-93-delphi-object-pascal-slightly-strict-certification"
  source_sha256: "sha256:573156d4abb4b87f0bb8d2b58524a9c20b4ffe205aee10bad7591fc6660d893b"
  source_kind: "batch"
  source_batch: "93"
...
# T093 — Delphi Object Pascal Modernization Certification

## 1. Objective

Slightly strict certification for Batch 93 Delphi Object Pascal Modernization Certification.
...
- `CASE-0313` [CRITICAL] Direct verification: PG367 delphi project discovery and inventory
- `CASE-0314` [HIGH] Direct verification: PG368 object pascal parser and semantic model
- `CASE-0315` [HIGH] Direct verification: PG369 vcl fmx ui modeler
- `CASE-0316` [MEDIUM] Direct verification: PG370 bpl dcp package dependency analyzer
- `CASE-0317` [CRITICAL] Direct verification: PG371 dataset firedac bde data mapper
- `CASE-0318` [HIGH] Direct verification: PG372 delphi com windows api interop analyzer
- `CASE-0319` [HIGH] Direct verification: PG373 delphi to dotnet cpp generator
- `CASE-0320` [MEDIUM] Direct verification: PG374 delphi form to modern ui generator
- `CASE-0321` [CRITICAL] Direct verification: PG375 thread memory lifetime analyzer
- `CASE-0322` [HIGH] Direct verification: PG376 delphi test harness generator
- `CASE-0323` [HIGH] Direct verification: PG377 delphi numerical binary regression verifier
- `CASE-0324` [MEDIUM] Direct verification: PG378 delphi modernization certifier
- `CASE-0325` [CRITICAL] Exercise 32/64-bit pointer arithmetic, Integer/NativeInt and AnsiString/UnicodeString conversion
- `CASE-0326` [HIGH] Validate manual memory, interface reference counting, ownership components and exception cleanup
- `CASE-0327` [HIGH] Compare VCL message dispatch, events, modal forms, data binding and UI-thread affinity
- `CASE-0328` [CRITICAL] Detect BPL/DCP package, runtime package and compiler-version binary incompatibility
- `CASE-0329` [HIGH] Compare BDE/FireDAC datasets, cached updates, transactions, filters and calculated fields
- `CASE-0330` [CRITICAL] Validate COM and Windows API calling conventions, record packing and callback lifetime
- `CASE-0331` [HIGH] Representative certified success path
- `CASE-0332` [HIGH] Boundary and moderate scale
- `CASE-0333` [HIGH] Invalid and conflicting input
- `CASE-0334` [HIGH] Dependency failure and recovery
- `CASE-0335` [CRITICAL] Security and isolation
- `CASE-0336` [HIGH] Replay and idempotency
- `CASE-0337` [HIGH] Toolchain and version drift
- `CASE-0338` [CRITICAL] Evidence tamper and anti-fraud
