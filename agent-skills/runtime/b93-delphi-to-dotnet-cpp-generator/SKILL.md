---
name: b93-delphi-to-dotnet-cpp-generator
description: "Use when ELMOS must run delphi to dotnet cpp generator for Batch 93 Delphi / Object Pascal Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG373"
  source_name: "delphi-to-dotnet-cpp-generator"
  source_sha256: "sha256:c21fa7c29d528426ac90bb6e4dbef97eb1c26abe261616926c4f5f2cc49e4434"
  batch: 93
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 93 Language Pack / source PG373 — Delphi To Dotnet Cpp Generator

## 1. Objective

Generate delphi to dotnet cpp generator within the Delphi / Object Pascal Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Delphi To Dotnet Cpp Generator using the approved windows-industrial-legacy semantic contracts and toolchain versions.
...
- A representative valid delphi-object-pascal input produces all declared outputs for delphi-to-dotnet-cpp-generator.
