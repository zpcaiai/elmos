---
name: financial-billing-commercial-operations-orchestrator
description: "Implement Batch 39A end to end: metering, usage ledger, catalog, pricing, contracts, orders, subscriptions, billing, tax, invoices, AR, credit, collections, revenue recognition, subledgers, commercial operations and release gates."
---
...
Implement Batch 39A end to end: metering, usage ledger, catalog, pricing, contracts, orders, subscriptions, billing, tax, invoices, AR, credit, collections, revenue recognition, subledgers, commercial operations and release gates.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/financial-billing-commercial-operations-orchestrator-baseline.md`.
...
```text
financial_billing_commercial_operations_orchestrator_manifest.json
financial_billing_commercial_operations_orchestrator_decision.json
financial_billing_commercial_operations_orchestrator_reconciliation.json
financial_billing_commercial_operations_orchestrator_evidence.json
```
