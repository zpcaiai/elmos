---
name: github-app-installation-identity-and-permission-governance
description: "Implement GitHub App identity, installation lifecycle, permission minimization, repository selection, suspension, revocation, and audit."
---
...
Implement GitHub App identity, installation lifecycle, permission minimization, repository selection, suspension, revocation, and audit.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-app-installation-identity-and-permission-governance-baseline.md`.
...
```text
github_app_installation_identity_and_permission_governance_manifest.json
github_app_installation_identity_and_permission_governance_decision.json
github_app_installation_identity_and_permission_governance_evidence.json
```
