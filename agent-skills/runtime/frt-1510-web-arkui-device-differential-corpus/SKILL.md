...
description: "Run FRT-1510 Web ArkUI Device Differential Corpus for FRT G15 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1510"
  source_name: "frt-1510-web-arkui-device-differential-corpus"
  source_sha256: "sha256:b9c04379fa79cbabdcac7082615c061f5db0b976089f839b2f7a5936b4c67eb1"
  batch: "G15"
...
- Runtime catalog key: `FRT-1510` / `frt-1510-web-arkui-device-differential-corpus`.
...
# FRT-1510 — Web ArkUI Device Differential Corpus

## Objective

在G15范围内实现 **Web ArkUI Device Differential Corpus**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射ArkUI状态装饰器、Builder、Navigation和生命周期; 处理Web DOM能力与ArkUI Native/Device差异; 生成真机/模拟器和Accessibility验证。

## When to Use

- 实现或修改与 **Web ArkUI Device Differential Corpus** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1510Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1510EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1510FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1510CertificateFragment`：供G15批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g15/frt-1510-web-arkui-device-differential-corpus/
packages/runtime/g15/frt-1510-web-arkui-device-differential-corpus/
services/control-plane/g15/frt-1510-web-arkui-device-differential-corpus/
apps/web-console/src/features/g15/frt-1510-web-arkui-device-differential-corpus/
apps/admin-console/src/features/g15/frt-1510-web-arkui-device-differential-corpus/
tests/g15/frt-1510-web-arkui-device-differential-corpus/
```
...
```text
POST /v1/skills/frt-1510/runs
GET  /v1/skills/frt-1510/runs/{run_id}
POST /v1/skills/frt-1510/runs/{run_id}/verify
GET  /v1/skills/frt-1510/runs/{run_id}/findings
GET  /v1/skills/frt-1510/runs/{run_id}/evidence
```
