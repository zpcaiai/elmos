...
description: "Run FRT-0912 Runtime Semantics Test Generator for FRT G09 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0912"
  source_name: "frt-0912-runtime-semantics-test-generator"
  source_sha256: "sha256:6b0b6a7c53eea3ec03e6cfa168d8912776af602aa5ec6761eff61631a46db314"
  batch: "G09"
...
- Runtime catalog key: `FRT-0912` / `frt-0912-runtime-semantics-test-generator`.
...
# FRT-0912 — Runtime Semantics Test Generator

## Objective

在G09范围内实现 **Runtime Semantics Test Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：区分Local、Server、Global、Persistent和Derived State; 保持Effect触发、Cleanup、Lifecycle和Evaluation Order; 传播Cancellation并防止Stale Result Commit。

## When to Use

- 实现或修改与 **Runtime Semantics Test Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0912Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0912EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0912FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0912CertificateFragment`：供G09批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g09/frt-0912-runtime-semantics-test-generator/
packages/runtime/g09/frt-0912-runtime-semantics-test-generator/
services/control-plane/g09/frt-0912-runtime-semantics-test-generator/
apps/web-console/src/features/g09/frt-0912-runtime-semantics-test-generator/
apps/admin-console/src/features/g09/frt-0912-runtime-semantics-test-generator/
tests/g09/frt-0912-runtime-semantics-test-generator/
```
...
```text
POST /v1/skills/frt-0912/runs
GET  /v1/skills/frt-0912/runs/{run_id}
POST /v1/skills/frt-0912/runs/{run_id}/verify
GET  /v1/skills/frt-0912/runs/{run_id}/findings
GET  /v1/skills/frt-0912/runs/{run_id}/evidence
```
