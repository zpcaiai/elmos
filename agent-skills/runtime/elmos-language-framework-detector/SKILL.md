...
description: "Invoke the bounded repository handler for elmos-language-framework-detector while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P02:language-framework-detector"
  source_name: "elmos-language-framework-detector"
  installed_name: "elmos-language-framework-detector"
  source_logical_path: "02-elmos-repository-intelligence-semantic-ir/skills/language-framework-detector/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/02-elmos-repository-intelligence-semantic-ir/skills/language-framework-detector/SKILL.md.source-data"
  source_materialized_path: "02-elmos-repository-intelligence-semantic-ir/skills/language-framework-detector/SKILL.md.source-data"
  source_sha256: "sha256:15e4bf1ecf7f248364e72b9bb059c8b8d300c9a0b154bea1be1cff56aad8b15c"
...
# elmos-language-framework-detector
...
- This is a deterministic repository wrapper for `02-elmos-repository-intelligence-semantic-ir/skills/language-framework-detector/SKILL.md` at `sha256:15e4bf1ecf7f248364e72b9bb059c8b8d300c9a0b154bea1be1cff56aad8b15c`.
- Its immutable source/runtime identity is `elmos-language-framework-detector`; its active installed identity is `elmos-language-framework-detector`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-language-framework-detector --request <file>
```
