...
description: "Run FRT-1810 Pack Dependency Resolver for FRT G18 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1810"
  source_name: "frt-1810-pack-dependency-resolver"
  source_sha256: "sha256:0daa8216d92b2068bda7d4965e565e11ab167cb11919a0a18ee4e418ff1abf07"
  batch: "G18"
...
- Runtime catalog key: `FRT-1810` / `frt-1810-pack-dependency-resolver`.
...
# FRT-1810 — Pack Dependency Resolver

## Objective

在G18范围内实现 **Pack Dependency Resolver**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：将真实项目差异封装为可组合Overlay而非硬编码核心; Pack声明Provides/Requires/Conflicts/Permissions/Versions; 确定性解析优先级和冲突。

## When to Use

- 实现或修改与 **Pack Dependency Resolver** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1810Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1810EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1810FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1810CertificateFragment`：供G18批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g18/frt-1810-pack-dependency-resolver/
packages/runtime/g18/frt-1810-pack-dependency-resolver/
services/control-plane/g18/frt-1810-pack-dependency-resolver/
apps/web-console/src/features/g18/frt-1810-pack-dependency-resolver/
apps/admin-console/src/features/g18/frt-1810-pack-dependency-resolver/
tests/g18/frt-1810-pack-dependency-resolver/
```
...
```text
POST /v1/skills/frt-1810/runs
GET  /v1/skills/frt-1810/runs/{run_id}
POST /v1/skills/frt-1810/runs/{run_id}/verify
GET  /v1/skills/frt-1810/runs/{run_id}/findings
GET  /v1/skills/frt-1810/runs/{run_id}/evidence
```
