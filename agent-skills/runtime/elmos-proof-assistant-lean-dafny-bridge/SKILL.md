---
name: elmos-proof-assistant-lean-dafny-bridge
description: Generate reviewable theorem/contract skeletons, connect verified lemmas to code artifacts and preserve trusted-kernel and assumption evidence.
version: 4.0.0
...
# Proof Assistant Lean/Dafny Bridge
...
- `ProofAssistantLeanDafnyBridgeProfile`
- `ProofAssistantLeanDafnyBridgePlan`
- `ProofAssistantLeanDafnyBridgeRun`
- `ProofAssistantLeanDafnyBridgeDecision`

Required semantic capabilities:

- emit typed theorem and contract artifacts
- separate generated conjecture from checked proof
- bind source maps and extracted code
- record axioms, admits and trusted base
- recheck after code or toolchain drift
...
- `artifacts/elmos-proof-assistant-lean-dafny-bridge/profile.yaml`
- `artifacts/elmos-proof-assistant-lean-dafny-bridge/plan.json`
- `artifacts/elmos-proof-assistant-lean-dafny-bridge/result.json`
- `artifacts/elmos-proof-assistant-lean-dafny-bridge/evidence/`
...
- **admit hidden as proof** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **theorem proves wrong model** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **extraction changes semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **proof cache reused after assumption change** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **untrusted plugin expands TCB** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: emit typed theorem and contract artifacts
- native scenario: separate generated conjecture from checked proof
- native scenario: bind source maps and extracted code
- native scenario: record axioms, admits and trusted base
- native scenario: recheck after code or toolchain drift
