---
name: evidence-data-quality-source-certification-lineage-and-bb4d5028
description: 评估证据分析源的完整性、唯一性、有效性、一致性、完整参照、及时性、形状、血缘与授权。
metadata:
  elmos_batch: "37C"
  elmos_skill_id: "ANA37C003"
  pack_version: "3.7-complete"
---

# ANA37C003 — Evidence Data Quality、Source Certification、Lineage 与 Reconciliation

## Objective

评估证据分析源的完整性、唯一性、有效性、一致性、完整参照、及时性、形状、血缘与授权。
...
- 为每个Source定义Grain、Owner、Freshness、Known Limitations和Approved Use。
- 检查Artifact/Attestation/Verification关系、Tenant、Timestamp、Duplicate、Volume/Shape Drift。
- 定义 Source Precedence，并保留冲突和决定依据。
- Metric Readiness区分 Ready/Limitations/Partial/Blocked/Unknown。
...
- duplicateArtifactGrainBlocksCertification
- orphanVerificationCreatesIntegrityFinding
- uncertifiedSourceCannotFeedExecutiveMetric
- crossTenantLineageIsRejected
