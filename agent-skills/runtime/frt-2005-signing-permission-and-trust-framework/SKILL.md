...
description: "Run FRT-2005 Signing Permission and Trust Framework for FRT G20 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2005"
  source_name: "frt-2005-signing-permission-and-trust-framework"
  source_sha256: "sha256:eafb24722301b4e86111166680941da6718e585c04762a302e1ae7d7bc5b99af"
  batch: "G20"
...
- Runtime catalog key: `FRT-2005` / `frt-2005-signing-permission-and-trust-framework`.
...
# FRT-2005 — Signing Permission and Trust Framework

## Objective

在G20范围内实现 **Signing Permission and Trust Framework**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：提供Skill SDK、Runtime、Registry和Marketplace; 实现CLI、API、IDE、Web Console和Multi-Tenant Workspace; Durable Workflow与分布式Worker支持暂停、恢复、取消和幂等。

## When to Use

- 实现或修改与 **Signing Permission and Trust Framework** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2005Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2005EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2005FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2005CertificateFragment`：供G20批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g20/frt-2005-signing-permission-and-trust-framework/
packages/runtime/g20/frt-2005-signing-permission-and-trust-framework/
services/control-plane/g20/frt-2005-signing-permission-and-trust-framework/
apps/web-console/src/features/g20/frt-2005-signing-permission-and-trust-framework/
apps/admin-console/src/features/g20/frt-2005-signing-permission-and-trust-framework/
tests/g20/frt-2005-signing-permission-and-trust-framework/
```
...
```text
POST /v1/skills/frt-2005/runs
GET  /v1/skills/frt-2005/runs/{run_id}
POST /v1/skills/frt-2005/runs/{run_id}/verify
GET  /v1/skills/frt-2005/runs/{run_id}/findings
GET  /v1/skills/frt-2005/runs/{run_id}/evidence
```
