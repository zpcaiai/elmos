...
- Invoke this repository Skill as `$pm-b01-competition-positioning`.
- Immutable source identity: `batch-01-competition-positioning` in `precision-migration-b01-44` (B01).
- Runtime adapter: `assessment-and-target-planning`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b01-competition-positioning`.
...
- 当任务涉及 **competitor-capability-radar** 时，调用 `../pm-b01-competitor-capability-radar/SKILL.md`。
- 当任务涉及 **capability-gap-analyzer** 时，调用 `../pm-b01-capability-gap-analyzer/SKILL.md`。
- 当任务涉及 **build-buy-partner-decision** 时，调用 `../pm-b01-build-buy-partner-decision/SKILL.md`。
- 当任务涉及 **platform-commoditization-risk** 时，调用 `../pm-b01-platform-commoditization-risk/SKILL.md`。
- 当任务涉及 **vertical-market-selector** 时，调用 `../pm-b01-vertical-market-selector/SKILL.md`。
- 当任务涉及 **differentiation-strategy-generator** 时，调用 `../pm-b01-differentiation-strategy-generator/SKILL.md`。
