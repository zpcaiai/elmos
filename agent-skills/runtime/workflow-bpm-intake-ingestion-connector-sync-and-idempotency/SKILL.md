---
name: workflow-bpm-intake-ingestion-connector-sync-and-idempotency
description: "Implement Batch 46B Workflow、BPM、Case与Low-code Automation intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work."
---

# Workflow BPM Intake Ingestion Connector Sync And Idempotency

## Objective

Implement Batch 46B Workflow、BPM、Case与Low-code Automation intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work.
...
5. Write unresolved domain assumptions to `docs/implementation/workflow-bpm-intake-ingestion-connector-sync-and-idempotency-baseline.md`.
...
```text
workflow_bpm_intake_ingestion_connector_sync_and_idempotency_manifest.json
workflow_bpm_intake_ingestion_connector_sync_and_idempotency_state.json
workflow_bpm_intake_ingestion_connector_sync_and_idempotency_decision.json
workflow_bpm_intake_ingestion_connector_sync_and_idempotency_reconciliation.json
workflow_bpm_intake_ingestion_connector_sync_and_idempotency_evidence.json
```
