---
name: database-metadata-ingestion
description: Use this skill when Elmos must perform database metadata ingestion as part of the 01-knowledge-ingestion-governance
...
摄取 Schema、Routine、触发器、索引、约束、统计信息和执行计划。
