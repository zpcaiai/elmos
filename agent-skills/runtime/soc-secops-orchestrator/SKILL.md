---
name: soc-secops-orchestrator
description: "Implement Batch 48A SOC、Detection、Response与Threat Intelligence end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Telemetry、Detection Rule、Alert、Case、Incident、Threat Intel、Indicator、Hunt、Response与Lessons Learned."
---

# SOC Secops Orchestrator

## Objective

Implement Batch 48A SOC、Detection、Response与Threat Intelligence end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Telemetry、Detection Rule、Alert、Case、Incident、Threat Intel、Indicator、Hunt、Response与Lessons Learned.
...
5. Write unresolved domain assumptions to `docs/implementation/soc-secops-orchestrator-baseline.md`.
...
```text
soc_secops_orchestrator_manifest.json
soc_secops_orchestrator_state.json
soc_secops_orchestrator_decision.json
soc_secops_orchestrator_reconciliation.json
soc_secops_orchestrator_evidence.json
```
