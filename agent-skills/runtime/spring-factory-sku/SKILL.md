---
name: spring-factory-sku
description: 将已验证 Route 扩展到整个大型仓库或多仓 Campaign。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-083
  source_name: spring-factory-sku
  source_path: skills/spring-factory-sku/SKILL.md
  source_sha256: sha256:99eb74afeb7697e077a7e0b4e0027efaa359f0b50fd5898c87beff748d86ca83
  source_contract_sha256: sha256:962bd909c8614b2838778302043ffcd831bc67508dc3a5e926052a8cebd37cf2
...
# Modernization Factory SKU

## Objective

将已验证 Route 扩展到整个大型仓库或多仓 Campaign。

## Scope and capabilities

- Wave planning
- Shared recipes/intelligence
...
- [ ] 定义 `spring-factory-sku` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-factory-sku` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：factory-campaign.json, wave-proofs, portfolio-dashboard。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：factory-campaign.json, wave-proofs, portfolio-dashboard。
...
- Machine contract: `references/contract.json` (`sha256:962bd909c8614b2838778302043ffcd831bc67508dc3a5e926052a8cebd37cf2`).
