...
5. Write unresolved domain assumptions to `docs/implementation/platform-ecosystem-orchestrator-baseline.md`.
...
```text
platform_ecosystem_orchestrator_manifest.json
platform_ecosystem_orchestrator_state.json
platform_ecosystem_orchestrator_decision.json
platform_ecosystem_orchestrator_reconciliation.json
platform_ecosystem_orchestrator_evidence.json
```
