...
description: "Run FRT-2201 End-to-End Value Stream Compiler for FRT G22 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2201"
  source_name: "frt-2201-end-to-end-value-stream-compiler"
  source_sha256: "sha256:35be3ecb83bf1ecdff8dbcf51165858fe06f504227313b6080961fa5226281fb"
  batch: "G22"
...
- Runtime catalog key: `FRT-2201` / `frt-2201-end-to-end-value-stream-compiler`.
...
在G22范围内实现 **End-to-End Value Stream Compiler**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Value Stream 与业务Outcome建模; 状态机可达性、终态、Timeout、Cancel、Unknown、Recovery完整性; 跨域Saga、幂等、补偿和Reconciliation。

## When to Use

- 实现或修改与 **End-to-End Value Stream Compiler** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2201Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2201EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2201FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2201CertificateFragment`：供G22批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g22/frt-2201-end-to-end-value-stream-compiler/
packages/runtime/g22/frt-2201-end-to-end-value-stream-compiler/
services/control-plane/g22/frt-2201-end-to-end-value-stream-compiler/
apps/web-console/src/features/g22/frt-2201-end-to-end-value-stream-compiler/
apps/admin-console/src/features/g22/frt-2201-end-to-end-value-stream-compiler/
tests/g22/frt-2201-end-to-end-value-stream-compiler/
```
...
```text
POST /v1/skills/frt-2201/runs
GET  /v1/skills/frt-2201/runs/{run_id}
POST /v1/skills/frt-2201/runs/{run_id}/verify
GET  /v1/skills/frt-2201/runs/{run_id}/findings
GET  /v1/skills/frt-2201/runs/{run_id}/evidence
```
