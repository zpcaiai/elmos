...
description: "Run FRT-1611 Web Flutter Route Certification for FRT G16 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1611"
  source_name: "frt-1611-web-flutter-route-certification"
  source_sha256: "sha256:54ac802cb30e76e7cbe23274f6aa6e4a71a025b7a17285061a20ceaebecc2d7f"
  batch: "G16"
...
- Runtime catalog key: `FRT-1611` / `frt-1611-web-flutter-route-certification`.
...
# FRT-1611 — Web Flutter Route Certification

## Objective

在G16范围内实现 **Web Flutter Route Certification**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射DOM/组件到Widget树而非逐元素复制; 处理Key、BuildContext、Controller、State和Navigator; 处理Plugin、Platform Channel、Web/Mobile能力差异。

## When to Use

- 实现或修改与 **Web Flutter Route Certification** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1611Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1611EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1611FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1611CertificateFragment`：供G16批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g16/frt-1611-web-flutter-route-certification/
packages/runtime/g16/frt-1611-web-flutter-route-certification/
services/control-plane/g16/frt-1611-web-flutter-route-certification/
apps/web-console/src/features/g16/frt-1611-web-flutter-route-certification/
apps/admin-console/src/features/g16/frt-1611-web-flutter-route-certification/
tests/g16/frt-1611-web-flutter-route-certification/
```
...
```text
POST /v1/skills/frt-1611/runs
GET  /v1/skills/frt-1611/runs/{run_id}
POST /v1/skills/frt-1611/runs/{run_id}/verify
GET  /v1/skills/frt-1611/runs/{run_id}/findings
GET  /v1/skills/frt-1611/runs/{run_id}/evidence
```
