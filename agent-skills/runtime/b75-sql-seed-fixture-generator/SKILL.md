---
name: b75-sql-seed-fixture-generator
description: "Use when ELMOS must generate runnable and maintainable SQL Seed Fixture Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: SQL Seed Fixture Generator, Batch 75, SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility."
metadata:
  id: PG339
  batch: 75
  version: 1.0.0
...
# PG339 — SQL Seed Fixture Generator

## Objective

Generate runnable and maintainable SQL Seed Fixture Generator for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `sql-seed-fixture-generator` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG338`.
...
- `sql_seed_fixture_generator_plan.json`
- `sql_seed_fixture_generator_artifacts/`
- `sql_seed_fixture_generator_verification.json`
