---
name: workflow-bpm-data-quality-dedup-reconciliation-and-certification
description: "Implement Batch 46B Workflow、BPM、Case与Low-code Automation quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work."
---

# Workflow BPM Data Quality Dedup Reconciliation And Certification

## Objective

Implement Batch 46B Workflow、BPM、Case与Low-code Automation quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work.
...
5. Write unresolved domain assumptions to `docs/implementation/workflow-bpm-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
workflow_bpm_data_quality_dedup_reconciliation_and_certification_manifest.json
workflow_bpm_data_quality_dedup_reconciliation_and_certification_state.json
workflow_bpm_data_quality_dedup_reconciliation_and_certification_decision.json
workflow_bpm_data_quality_dedup_reconciliation_and_certification_reconciliation.json
workflow_bpm_data_quality_dedup_reconciliation_and_certification_evidence.json
```
