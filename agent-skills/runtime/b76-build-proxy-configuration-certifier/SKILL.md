---
name: b76-build-proxy-configuration-certifier
description: "Use when ELMOS must execute and independently verify Build Proxy Configuration Certifier for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Build Proxy Configuration Certifier, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG362
  batch: 76
  version: 1.0.0
...
# PG362 — Build Proxy Configuration Certifier

## Objective

Execute and independently verify Build Proxy Configuration Certifier for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `build-proxy-configuration-certifier` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`, `PG361`.
...
- `build_proxy_configuration_certifier_plan.json`
- `build_proxy_configuration_certifier_artifacts/`
- `build_proxy_configuration_certifier_verification.json`
