...
description: "Run the exact ELMOS Batch 81-95 slightly-strict Semantic Preservation Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T097"
  source_name: "semantic-preservation-gate"
  source_sha256: "sha256:4a5e12395e05f30aa7c40aedb3950500850e6f6e4d21102984a29b35c590d023"
...
# T097 — Semantic Preservation Gate

## 1. Objective

Prove source-to-target behavior for business rules, state machines, error paths, side effects and external contracts.
...
- `CASE-0401` [HIGH] Semantic Preservation Gate: Representative path
- `CASE-0402` [HIGH] Semantic Preservation Gate: Boundary path
- `CASE-0403` [HIGH] Semantic Preservation Gate: Invalid or hostile input
- `CASE-0404` [HIGH] Semantic Preservation Gate: Injected dependency failure
- `CASE-0405` [CRITICAL] Semantic Preservation Gate: Security or safety violation
- `CASE-0406` [HIGH] Semantic Preservation Gate: Replay and idempotency
- `CASE-0407` [HIGH] Semantic Preservation Gate: Version or environment drift
- `CASE-0408` [MEDIUM] Semantic Preservation Gate: Moderate scale
- `CASE-0409` [CRITICAL] Semantic Preservation Gate: Evidence tamper
- `CASE-0410` [HIGH] Semantic Preservation Gate: Recovery and final evidence
