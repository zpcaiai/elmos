---
name: inventory-fulfillment-domain-model-lifecycle-and-state-machine
description: "Implement Batch 42B Inventory、Warehouse与Fulfillment Operations canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Item、Inventory、Lot、Serial、Location、Warehouse Task、Allocation、Pick、Pack、Ship、Return与Cycle Count."
---
...
Implement Batch 42B Inventory、Warehouse与Fulfillment Operations canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Item、Inventory、Lot、Serial、Location、Warehouse Task、Allocation、Pick、Pack、Ship、Return与Cycle Count.
...
5. Write unresolved domain assumptions to `docs/implementation/inventory-fulfillment-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
inventory_fulfillment_domain_model_lifecycle_and_state_machine_manifest.json
inventory_fulfillment_domain_model_lifecycle_and_state_machine_state.json
inventory_fulfillment_domain_model_lifecycle_and_state_machine_decision.json
inventory_fulfillment_domain_model_lifecycle_and_state_machine_reconciliation.json
inventory_fulfillment_domain_model_lifecycle_and_state_machine_evidence.json
```
