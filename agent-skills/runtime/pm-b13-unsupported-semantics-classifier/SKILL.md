...
- Invoke this repository Skill as `$pm-b13-unsupported-semantics-classifier`.
- Immutable source identity: `unsupported-semantics-classifier` in `precision-migration-b01-44` (B13).
- Runtime adapter: `semantic-recovery-and-ir`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b13-unsupported-semantics-classifier`.
