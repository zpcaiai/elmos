...
# Safety Integrity Level Assurance Profile Compiler
...
- `SafetyIntegrityLevelAssuranceProfileCompilerProfile`
- `SafetyIntegrityLevelAssuranceProfileCompilerRun`
- `SafetyIntegrityLevelAssuranceProfileCompilerFinding`
- `SafetyIntegrityLevelAssuranceProfileCompilerDecision`
- `SafetyIntegrityLevelAssuranceProfileCompilerEvidence`

Required semantic capabilities:

- translate hazard, risk reduction, integrity level and lifecycle obligations into project proof obligations
- separate systematic capability from probabilistic hardware failure evidence
- compile independence, verification, configuration and modification controls
...
- `artifacts/elmos-safety-integrity-level-assurance-profile-compiler/profile.yaml`
- `artifacts/elmos-safety-integrity-level-assurance-profile-compiler/plan.json`
- `artifacts/elmos-safety-integrity-level-assurance-profile-compiler/result.json`
- `artifacts/elmos-safety-integrity-level-assurance-profile-compiler/evidence/`
- `artifacts/elmos-safety-integrity-level-assurance-profile-compiler/assurance-case.json`
...
- **SIL label is applied to AI feature without system hazard analysis** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **probabilistic metric substitutes for systematic integrity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **safety function shares uncontrolled common cause** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: translate hazard, risk reduction, integrity level and lifecycle obligations into project proof obligations
- native scenario: separate systematic capability from probabilistic hardware failure evidence
- native scenario: compile independence, verification, configuration and modification controls
