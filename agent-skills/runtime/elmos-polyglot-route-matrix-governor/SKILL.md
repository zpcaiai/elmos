---
name: elmos-polyglot-route-matrix-governor
description: Govern exact source-language, target-language, framework, runtime and toolchain route envelopes without treating an N×N matrix as independently trustworthy translators.
version: 4.0.0
...
# Polyglot Route Matrix Governor
...
- Model routes as frontend + semantic IR + backend + pair overlay
- Track exact language/framework/runtime/toolchain pins
- Classify route maturity and certified envelope
- Compute route risk from semantic gaps and evidence freshness
- Prevent unsupported cells from appearing as supported
...
- `polyglot-route-matrix.yaml`
- `route-support-decisions.json`
- `route-deprecation-ledger.json`
- `route-risk-map.json`
...
- **route capability overclaim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale version envelope** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **pair overlay shadowing core semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsupported cell auto-selection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **route evidence reused across incompatible versions** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- exact route lookup
- unsupported cell blocks
- version drift invalidates route evidence
- pair-overlay precedence
- route deprecation and rollback
- matrix completeness without N×N code duplication
