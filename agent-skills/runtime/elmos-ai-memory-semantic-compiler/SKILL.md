---
name: elmos-ai-memory-semantic-compiler
description: Separate turn, thread, session, user, organization, episodic, semantic, procedural and repository memory with
  lifecycle, privacy and conflict semantics.
version: 4.0.0
...
- Compile typed semantic objects with provenance
- Preserve source maps and identities
- Represent effects, state, protocol and assurance semantics
- Emit semantic gaps instead of guessing
...
- `memory-scope-map.json`
- `retention-policy-input.json`
- `memory-consistency-obligations.json`
...
- **semantic truncation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **source-map spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **gap suppression** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **untrusted runtime evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **schema downgrade** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- AiMemorySemanticCompiler representative end-to-end fixture
