...
description: "Run FRT-2901 Threat Model Generator for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2901"
  source_name: "frt-2901-threat-model-generator"
  source_sha256: "sha256:c21104197c82839a5fc9a589c2b02a6cc75abd4f8fad2a13f64fc615a71937f2"
  batch: "G29"
...
- Runtime catalog key: `FRT-2901` / `frt-2901-threat-model-generator`.
...
在G29范围内实现 **Threat Model Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Threat Model Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2901Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2901EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2901FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2901CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2901-threat-model-generator/
packages/runtime/g29/frt-2901-threat-model-generator/
services/control-plane/g29/frt-2901-threat-model-generator/
apps/web-console/src/features/g29/frt-2901-threat-model-generator/
apps/admin-console/src/features/g29/frt-2901-threat-model-generator/
tests/g29/frt-2901-threat-model-generator/
```
...
```text
POST /v1/skills/frt-2901/runs
GET  /v1/skills/frt-2901/runs/{run_id}
POST /v1/skills/frt-2901/runs/{run_id}/verify
GET  /v1/skills/frt-2901/runs/{run_id}/findings
GET  /v1/skills/frt-2901/runs/{run_id}/evidence
```
