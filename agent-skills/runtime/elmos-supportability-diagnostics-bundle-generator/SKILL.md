---
name: elmos-supportability-diagnostics-bundle-generator
description: Generate privacy-safe self-service diagnostic bundles with versions, health, topology, recent errors and evidence links for customer support.
version: 4.0.0
...
# Supportability and Diagnostics Bundle Generator
...
- **Kernel authorities used:** K1, K2, K5, K6, K7, K8
...
- `SupportabilityAndDiagnosticsBundleGeneratorProfile`
- `SupportabilityAndDiagnosticsBundleGeneratorPlan`
- `SupportabilityAndDiagnosticsBundleGeneratorRun`
- `SupportabilityAndDiagnosticsBundleGeneratorDecision`

Required semantic capabilities:

- collect bounded health and configuration metadata
- redact secrets and tenant content
- include reproducible checks and correlation IDs
- sign and expire support bundles
- verify offline readability and integrity
...
- `elmos-operability-support-readiness-certifier` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.
...
- `artifacts/elmos-supportability-diagnostics-bundle-generator/profile.yaml`
- `artifacts/elmos-supportability-diagnostics-bundle-generator/plan.json`
- `artifacts/elmos-supportability-diagnostics-bundle-generator/result.json`
- `artifacts/elmos-supportability-diagnostics-bundle-generator/evidence/`
...
- **bundle includes secrets** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **support tool gains shell access** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale bundle misleads diagnosis** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **customer cannot revoke share** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **signature omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: collect bounded health and configuration metadata
- native scenario: redact secrets and tenant content
- native scenario: include reproducible checks and correlation IDs
- native scenario: sign and expire support bundles
- native scenario: verify offline readability and integrity
