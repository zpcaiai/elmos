---
name: dependency-build-graph-discovery
description: "Repository-owned bounded wrapper for dependency-build-graph-discovery; external evidence remains NOT_RUN."
---
...
Extract dependency and target graphs from Maven/Gradle/Bazel/Pants/Buck2/npm/pnpm/Cargo/Go/.NET/CMake and normalize them into Build IR.
...
4. Submit `dependency-build-graph-discovery` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `543a79f060c77b68afc537770ba0dc73b758c864ad41d453a3326a4fa06bf759`
