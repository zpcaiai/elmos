---
name: elmos-carbon-energy-efficiency-profiler
description: Measure and optimize energy, accelerator utilization, region/time scheduling and carbon estimates without compromising correctness, privacy or SLA.
version: 4.0.0
...
# Carbon and Energy Efficiency Profiler
...
- `CarbonAndEnergyEfficiencyProfilerProfile`
- `CarbonAndEnergyEfficiencyProfilerPlan`
- `CarbonAndEnergyEfficiencyProfilerRun`
- `CarbonAndEnergyEfficiencyProfilerDecision`

Required semantic capabilities:

- collect workload and hardware energy proxies
- compare model/runtime efficiency per verified task
- schedule flexible work under policy
- report assumptions and regional carbon factors
- gate optimization against quality and residency
...
- `artifacts/elmos-carbon-energy-efficiency-profiler/profile.yaml`
- `artifacts/elmos-carbon-energy-efficiency-profiler/plan.json`
- `artifacts/elmos-carbon-energy-efficiency-profiler/result.json`
- `artifacts/elmos-carbon-energy-efficiency-profiler/evidence/`
...
- **estimated carbon shown as measured** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **green region violates residency** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **quality loss hidden by energy score** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **idle power omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider factor stale** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: collect workload and hardware energy proxies
- native scenario: compare model/runtime efficiency per verified task
- native scenario: schedule flexible work under policy
- native scenario: report assumptions and regional carbon factors
- native scenario: gate optimization against quality and residency
