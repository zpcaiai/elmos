...
description: "Run FRT-2915 Fuzzing and Protocol Abuse Generator for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2915"
  source_name: "frt-2915-fuzzing-and-protocol-abuse-generator"
  source_sha256: "sha256:a2469ea3852a6ca098401caf28f22bcb94516faee56c993c8d6563601c3a9d2d"
  batch: "G29"
...
- Runtime catalog key: `FRT-2915` / `frt-2915-fuzzing-and-protocol-abuse-generator`.
...
在G29范围内实现 **Fuzzing and Protocol Abuse Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Fuzzing and Protocol Abuse Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2915Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2915EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2915FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2915CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2915-fuzzing-and-protocol-abuse-generator/
packages/runtime/g29/frt-2915-fuzzing-and-protocol-abuse-generator/
services/control-plane/g29/frt-2915-fuzzing-and-protocol-abuse-generator/
apps/web-console/src/features/g29/frt-2915-fuzzing-and-protocol-abuse-generator/
apps/admin-console/src/features/g29/frt-2915-fuzzing-and-protocol-abuse-generator/
tests/g29/frt-2915-fuzzing-and-protocol-abuse-generator/
```
...
```text
POST /v1/skills/frt-2915/runs
GET  /v1/skills/frt-2915/runs/{run_id}
POST /v1/skills/frt-2915/runs/{run_id}/verify
GET  /v1/skills/frt-2915/runs/{run_id}/findings
GET  /v1/skills/frt-2915/runs/{run_id}/evidence
```
