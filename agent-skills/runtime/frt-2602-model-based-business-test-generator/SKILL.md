...
description: "Run FRT-2602 Model-Based Business Test Generator for FRT G26 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2602"
  source_name: "frt-2602-model-based-business-test-generator"
  source_sha256: "sha256:ee6a980d145295a33323e8b3e5d7d7b16da4e8d5a74093ae4b259153a34876fb"
  batch: "G26"
...
- Runtime catalog key: `FRT-2602` / `frt-2602-model-based-business-test-generator`.
...
在G26范围内实现 **Model-Based Business Test Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Requirement/Acceptance/State Machine派生Test Obligation; Unit/Component/Contract/Integration/Journey分层协调; Differential、Mutation、Visual/Semantic、Security和Performance Regression。

## When to Use

- 实现或修改与 **Model-Based Business Test Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2602Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2602EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2602FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2602CertificateFragment`：供G26批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g26/frt-2602-model-based-business-test-generator/
packages/runtime/g26/frt-2602-model-based-business-test-generator/
services/control-plane/g26/frt-2602-model-based-business-test-generator/
apps/web-console/src/features/g26/frt-2602-model-based-business-test-generator/
apps/admin-console/src/features/g26/frt-2602-model-based-business-test-generator/
tests/g26/frt-2602-model-based-business-test-generator/
```
...
```text
POST /v1/skills/frt-2602/runs
GET  /v1/skills/frt-2602/runs/{run_id}
POST /v1/skills/frt-2602/runs/{run_id}/verify
GET  /v1/skills/frt-2602/runs/{run_id}/findings
GET  /v1/skills/frt-2602/runs/{run_id}/evidence
```
