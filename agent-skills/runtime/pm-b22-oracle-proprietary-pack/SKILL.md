...
- Invoke this repository Skill as `$pm-b22-oracle-proprietary-pack`.
- Immutable source identity: `batch-22-oracle-proprietary-pack` in `precision-migration-b01-44` (B22).
- Runtime adapter: `database-and-data-route`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b22-oracle-proprietary-pack`.
...
- 当任务涉及 **oracle-plsql-package-and-state** 时，调用 `../pm-b22-oracle-plsql-package-and-state/SKILL.md`。
- 当任务涉及 **oracle-autonomous-transaction** 时，调用 `../pm-b22-oracle-autonomous-transaction/SKILL.md`。
- 当任务涉及 **oracle-sequence** 时，调用 `../pm-b22-oracle-sequence/SKILL.md`。
- 当任务涉及 **oracle-synonym** 时，调用 `../pm-b22-oracle-synonym/SKILL.md`。
- 当任务涉及 **oracle-database-link** 时，调用 `../pm-b22-oracle-database-link/SKILL.md`。
- 当任务涉及 **oracle-materialized-view** 时，调用 `../pm-b22-oracle-materialized-view/SKILL.md`。
- 当任务涉及 **oracle-object-type** 时，调用 `../pm-b22-oracle-object-type/SKILL.md`。
- 当任务涉及 **oracle-collection** 时，调用 `../pm-b22-oracle-collection/SKILL.md`。
- 当任务涉及 **oracle-bulk-collect-forall** 时，调用 `../pm-b22-oracle-bulk-collect-forall/SKILL.md`。
- 当任务涉及 **oracle-hierarchical-query** 时，调用 `../pm-b22-oracle-hierarchical-query/SKILL.md`。
- 当任务涉及 **oracle-flashback** 时，调用 `../pm-b22-oracle-flashback/SKILL.md`。
- 当任务涉及 **oracle-advanced-queue** 时，调用 `../pm-b22-oracle-advanced-queue/SKILL.md`。
- 当任务涉及 **oracle-scheduler** 时，调用 `../pm-b22-oracle-scheduler/SKILL.md`。
- 当任务涉及 **oracle-fine-grained-access-control** 时，调用 `../pm-b22-oracle-fine-grained-access-control/SKILL.md`。
- 当任务涉及 **oracle-null-and-date-semantics** 时，调用 `../pm-b22-oracle-null-and-date-semantics/SKILL.md`。
- 当任务涉及 **oracle-feature-migration-decision** 时，调用 `../pm-b22-oracle-feature-migration-decision/SKILL.md`。
