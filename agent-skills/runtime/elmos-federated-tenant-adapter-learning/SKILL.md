---
name: federated-tenant-adapter-learning
description: Use this skill when Elmos must perform federated tenant adapter learning as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# federated-tenant-adapter-learning

## 能力目标

在不集中原始数据的前提下聚合租户 Adapter 更新并防止反推。
