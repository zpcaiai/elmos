---
name: lastmile-delivery-analytics-kpi-scoring-forecast-and-diagnostics
description: "Implement Batch 51B Warehouse、Last-mile、Delivery与Returns semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return."
---

# Lastmile Delivery Analytics KPI Scoring Forecast And Diagnostics

## Objective

Implement Batch 51B Warehouse、Last-mile、Delivery与Returns semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return.
...
5. Write unresolved domain assumptions to `docs/implementation/lastmile-delivery-analytics-kpi-scoring-forecast-and-diagnostics-baseline.md`.
...
```text
lastmile_delivery_analytics_kpi_scoring_forecast_and_diagnostics_manifest.json
lastmile_delivery_analytics_kpi_scoring_forecast_and_diagnostics_state.json
lastmile_delivery_analytics_kpi_scoring_forecast_and_diagnostics_decision.json
lastmile_delivery_analytics_kpi_scoring_forecast_and_diagnostics_reconciliation.json
lastmile_delivery_analytics_kpi_scoring_forecast_and_diagnostics_evidence.json
```
