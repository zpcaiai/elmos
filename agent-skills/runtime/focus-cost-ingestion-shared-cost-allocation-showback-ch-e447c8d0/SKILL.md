...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/focus-cost-ingestion-shared-cost-allocation-showback-ch-e447c8d0-baseline.md`.
