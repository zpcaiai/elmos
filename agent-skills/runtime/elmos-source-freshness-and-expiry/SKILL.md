---
name: source-freshness-and-expiry
description: Use this skill when Elmos must perform source freshness and expiry as part of the 01-knowledge-ingestion-governance
...
跟踪知识有效期、版本适用范围、失效日期、最后验证时间和刷新 SLA。
