---
name: elmos-knowledge-source-trust-scoring-governor
description: Govern source identity, ownership, editorial quality, freshness, corroboration, conflict and revocation signals without turning heuristic trust into proof.
version: 4.0.0
...
# Knowledge Source Trust Scoring Governor
...
- `KnowledgeSourceTrustScoringGovernorProfile`
- `KnowledgeSourceTrustScoringGovernorPlan`
- `KnowledgeSourceTrustScoringGovernorRun`
- `KnowledgeSourceTrustScoringGovernorDecision`

Required semantic capabilities:

- register source identity and governance metadata
- compute bounded trust signals with explanations
- separate trust, relevance and recency
- propagate revocation and incident history
- require authoritative review for critical domains
...
- `artifacts/elmos-knowledge-source-trust-scoring-governor/profile.yaml`
- `artifacts/elmos-knowledge-source-trust-scoring-governor/plan.json`
- `artifacts/elmos-knowledge-source-trust-scoring-governor/result.json`
- `artifacts/elmos-knowledge-source-trust-scoring-governor/evidence/`
...
- **popular source mistaken for authoritative** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **trust score manipulable by repetition** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **publisher identity spoofed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **bias encoded as trust** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **heuristic score shown as certification** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: register source identity and governance metadata
- native scenario: compute bounded trust signals with explanations
- native scenario: separate trust, relevance and recency
- native scenario: propagate revocation and incident history
- native scenario: require authoritative review for critical domains
