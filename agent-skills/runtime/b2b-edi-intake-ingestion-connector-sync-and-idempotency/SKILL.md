---
name: b2b-edi-intake-ingestion-connector-sync-and-idempotency
description: "Implement Batch 46C B2B、EDI、Partner Network与Managed File Transfer intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Trading Partner、Agreement、EDI Message、Envelope、Mapping、Mailbox、File Transfer、Acknowledgement与Exception."
---

# B2B EDI Intake Ingestion Connector Sync And Idempotency

## Objective

Implement Batch 46C B2B、EDI、Partner Network与Managed File Transfer intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Trading Partner、Agreement、EDI Message、Envelope、Mapping、Mailbox、File Transfer、Acknowledgement与Exception.
...
5. Write unresolved domain assumptions to `docs/implementation/b2b-edi-intake-ingestion-connector-sync-and-idempotency-baseline.md`.
...
```text
b2b_edi_intake_ingestion_connector_sync_and_idempotency_manifest.json
b2b_edi_intake_ingestion_connector_sync_and_idempotency_state.json
b2b_edi_intake_ingestion_connector_sync_and_idempotency_decision.json
b2b_edi_intake_ingestion_connector_sync_and_idempotency_reconciliation.json
b2b_edi_intake_ingestion_connector_sync_and_idempotency_evidence.json
```
