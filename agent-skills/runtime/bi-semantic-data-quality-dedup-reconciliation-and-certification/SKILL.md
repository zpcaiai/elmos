---
name: bi-semantic-data-quality-dedup-reconciliation-and-certification
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
bi_semantic_data_quality_dedup_reconciliation_and_certification_manifest.json
bi_semantic_data_quality_dedup_reconciliation_and_certification_state.json
bi_semantic_data_quality_dedup_reconciliation_and_certification_decision.json
bi_semantic_data_quality_dedup_reconciliation_and_certification_reconciliation.json
bi_semantic_data_quality_dedup_reconciliation_and_certification_evidence.json
```
