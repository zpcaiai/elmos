---
name: elmos-ai-online-shadow-eval-controller
description: Run privacy-safe, no-side-effect production shadow evaluation with paired comparison, promotion thresholds, canary
  control and automatic rollback.
version: 4.0.0
...
# AI Online Shadow Evaluation Controller
...
- `Counterexample`
- `CoverageMap`
- `AIOnlineShadowEvaluationControllerRun`
- `AIOnlineShadowEvaluationControllerDecision`

Required semantic capabilities:

- Deterministic traffic sampling
- No-side-effect shadow isolation
- Paired trace and outcome comparison
- Sequential promotion/canary thresholds
- Privacy filtering and rollback triggers
...
- `shadow-eval-plan.yaml`
- `paired-results.json`
- `promotion-decision.json`
- `shadow-privacy-evidence.json`
...
- **shadow writes production** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **user data repurposing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sample selection bias** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **metric gaming** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **slow cost leak** — must have a preventive control, a detective signal, a negative fixture and a response action.
