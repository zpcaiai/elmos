---
name: elmos-generics-variance-erasure-semantics
description: "Preserve variance, bounds, erasure/reification, wildcards and runtime generic metadata across target systems."
version: 1.0.0
skill_id: ELMOS-POLY-192
...
triggers:
  - "Use when implementing or executing `elmos-generics-variance-erasure-semantics`."
  - "Use when a migration/certification DAG requires `type-semantics` capability."
outputs:
  - "semantic-assurance/elmos-generics-variance-erasure-semantics/model.json"
  - "semantic-assurance/elmos-generics-variance-erasure-semantics/evidence.json"
  - "semantic-assurance/elmos-generics-variance-erasure-semantics/diagnostics.json"
---

# Generics, Variance & Erasure Semantics

## Objective

Preserve variance, bounds, erasure/reification, wildcards and runtime generic metadata across target systems.
...
- [ ] Java wildcard fixture.
- [ ] C# variance fixture.
- [ ] Kotlin reified fixture.
