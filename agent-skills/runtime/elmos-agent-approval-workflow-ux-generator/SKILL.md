---
name: elmos-agent-approval-workflow-ux-generator
description: Generate clear preview, diff, risk, evidence, confirmation, expiry, rejection and recovery interfaces for human-controlled actions.
version: 4.0.0
...
# Agent Approval Workflow UX Generator
...
- `AgentApprovalWorkflowUXGeneratorProfile`
- `AgentApprovalWorkflowUXGeneratorPlan`
- `AgentApprovalWorkflowUXGeneratorRun`
- `AgentApprovalWorkflowUXGeneratorDecision`

Required semantic capabilities:

- compile approval contract to UI states
- display exact action and affected resources
- bind approval digest to tool parameters
- support dual control, timeout and escalation
- test accessibility, comprehension and replay resistance
...
- `artifacts/elmos-agent-approval-workflow-ux-generator/profile.yaml`
- `artifacts/elmos-agent-approval-workflow-ux-generator/plan.json`
- `artifacts/elmos-agent-approval-workflow-ux-generator/result.json`
- `artifacts/elmos-agent-approval-workflow-ux-generator/evidence/`
...
- **approval text differs from action** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dark pattern nudges approval** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **expired approval reused** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **diff omits hidden side effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **mobile UI truncates risk** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile approval contract to UI states
- native scenario: display exact action and affected resources
- native scenario: bind approval digest to tool parameters
- native scenario: support dual control, timeout and escalation
- native scenario: test accessibility, comprehension and replay resistance
