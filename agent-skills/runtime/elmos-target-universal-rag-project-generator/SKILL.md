---
name: elmos-target-universal-rag-project-generator
description: Generate production RAG repositories spanning ingestion, parsing, ACL-aware indexing, hybrid retrieval, reranking,
  grounded answering, administration, evaluation and operations.
version: 4.0.0
...
# TargetUniversalRagProjectGenerator
...
- Generate ingestion, parsing, embedding and indexing services
- Generate dense/sparse/graph retrieval and reranking
- Generate ACL, CDC, tombstone and reindex controls
- Generate grounded answer and citation services
- Generate retrieval and answer evaluation suites
...
- **indirect prompt injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-tenant retrieval** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **citation laundering** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deleted document resurrection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **retrieval cost DoS** — must have a preventive control, a detective signal, a negative fixture and a response action.
