---
name: "elmos-benchmark-corpus"
description: "Invoke the bounded repository handler for elmos-benchmark-corpus while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P07:benchmark-corpus"
  source_name: "elmos-benchmark-corpus"
  installed_name: "elmos-benchmark-corpus"
  source_logical_path: "07-elmos-transformation-learning-evolution/skills/benchmark-corpus/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/07-elmos-transformation-learning-evolution/skills/benchmark-corpus/SKILL.md.source-data"
  source_materialized_path: "07-elmos-transformation-learning-evolution/skills/benchmark-corpus/SKILL.md.source-data"
  source_sha256: "sha256:2209221486dcd9a870db3a7e0162d4014d941fbd7313b0fb630b3591fec8a10b"
...
- This is a deterministic repository wrapper for `07-elmos-transformation-learning-evolution/skills/benchmark-corpus/SKILL.md` at `sha256:2209221486dcd9a870db3a7e0162d4014d941fbd7313b0fb630b3591fec8a10b`.
- Its immutable source/runtime identity is `elmos-benchmark-corpus`; its active installed identity is `elmos-benchmark-corpus`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-benchmark-corpus --request <file>
```
