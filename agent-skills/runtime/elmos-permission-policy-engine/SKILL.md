...
description: "Invoke the bounded repository handler for elmos-permission-policy-engine while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P01:permission-policy-engine"
  source_name: "elmos-permission-policy-engine"
  installed_name: "elmos-permission-policy-engine"
  source_logical_path: "01-elmos-harness-runtime-platform/skills/permission-policy-engine/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/01-elmos-harness-runtime-platform/skills/permission-policy-engine/SKILL.md.source-data"
  source_materialized_path: "01-elmos-harness-runtime-platform/skills/permission-policy-engine/SKILL.md.source-data"
  source_sha256: "sha256:f47b4d3c456eb717a74a2965d50978bfe84a526837c3504a5b29bd53c802acbb"
...
# elmos-permission-policy-engine
...
- This is a deterministic repository wrapper for `01-elmos-harness-runtime-platform/skills/permission-policy-engine/SKILL.md` at `sha256:f47b4d3c456eb717a74a2965d50978bfe84a526837c3504a5b29bd53c802acbb`.
- Its immutable source/runtime identity is `elmos-permission-policy-engine`; its active installed identity is `elmos-permission-policy-engine`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-permission-policy-engine --request <file>
```
