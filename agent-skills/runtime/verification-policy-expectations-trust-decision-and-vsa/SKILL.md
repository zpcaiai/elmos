---
name: verification-policy-expectations-trust-decision-and-vsa
description: 实现 Artifact Verification Policy、Signer/Builder/Subject/SBOM/SLSA Expectations、解释和 VSA。
metadata:
  elmos_batch: "37A"
  elmos_skill_id: "ART37A011"
  pack_version: "3.7-complete"
---

# ART37A011 — Verification Policy、Expectations、Trust Decision 与 VSA

## Objective

实现 Artifact Verification Policy、Signer/Builder/Subject/SBOM/SLSA Expectations、解释和 VSA。
...
- 执行 Digest、Bundle、Signer、Subject、Predicate、Builder、Parameters、Dependencies 与 Policy 全链验证。
- 结果区分 PASSED/FAILED/INCONCLUSIVE/REQUIRES_REVIEW。
- 每项检查输出 Expected、Observed、Evidence、Reason。
- 缓存键包括 Artifact Digest、Policy Digest、Trust Root、Verifier 和 Input Attestations。
...
- validSignatureWrongSubjectFails
- inconclusiveDoesNotPass
- vsaBindsInputAttestations
- verificationCacheInvalidatesOnSignerRevocation
