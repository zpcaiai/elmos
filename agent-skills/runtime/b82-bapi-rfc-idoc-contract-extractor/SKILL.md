---
name: b82-bapi-rfc-idoc-contract-extractor
description: "Use when ELMOS must run bapi rfc idoc contract extractor for Batch 82 SAP ABAP / ABAP Cloud / CDS / RAP Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG238"
  source_name: "bapi-rfc-idoc-contract-extractor"
  source_sha256: "sha256:69ab4ca5fb1a6b39ec41e1dc3d7d62269e5f4c619adc81b08843e7d51ed36623"
  batch: 82
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 82 Language Pack / source PG238 — Bapi Rfc Idoc Contract Extractor

## 1. Objective

Recover and extract bapi rfc idoc contract extractor within the SAP ABAP / ABAP Cloud / CDS / RAP Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Bapi Rfc Idoc Contract Extractor using the approved enterprise-sap semantic contracts and toolchain versions.
...
- A representative valid sap-abap input produces all declared outputs for bapi-rfc-idoc-contract-extractor.
