...
description: "Run FRT-2914 DAST Coordinator for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2914"
  source_name: "frt-2914-dast-coordinator"
  source_sha256: "sha256:2e63b2fcff6ae9aefd272508ba2cdd5072f022106523bff20c8e09afa8308cc4"
  batch: "G29"
...
- Runtime catalog key: `FRT-2914` / `frt-2914-dast-coordinator`.
...
在G29范围内实现 **DAST Coordinator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **DAST Coordinator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2914Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2914EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2914FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2914CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2914-dast-coordinator/
packages/runtime/g29/frt-2914-dast-coordinator/
services/control-plane/g29/frt-2914-dast-coordinator/
apps/web-console/src/features/g29/frt-2914-dast-coordinator/
apps/admin-console/src/features/g29/frt-2914-dast-coordinator/
tests/g29/frt-2914-dast-coordinator/
```
...
```text
POST /v1/skills/frt-2914/runs
GET  /v1/skills/frt-2914/runs/{run_id}
POST /v1/skills/frt-2914/runs/{run_id}/verify
GET  /v1/skills/frt-2914/runs/{run_id}/findings
GET  /v1/skills/frt-2914/runs/{run_id}/evidence
```
