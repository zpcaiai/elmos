---
name: b78-gitops-release-bundle-generator
description: "Use when ELMOS must generate runnable and maintainable Gitops Release Bundle Generator for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Gitops Release Bundle Generator, Batch 78, Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification."
metadata:
  id: PG389
  batch: 78
  version: 1.0.0
...
# PG389 — Gitops Release Bundle Generator

## Objective

Generate runnable and maintainable Gitops Release Bundle Generator for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `gitops-release-bundle-generator` tasks involving Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG374`, `PG388`.
...
- `gitops_release_bundle_generator_plan.json`
- `gitops_release_bundle_generator_artifacts/`
- `gitops_release_bundle_generator_verification.json`
