---
name: tenant-context-propagation-resolution-and-anti-spoofing
description: "Implement authenticated tenant-context resolution and propagation across API, workflow, events, jobs, runners, data stores, and UI without trusting caller-supplied tenant headers."
---
...
Implement authenticated tenant-context resolution and propagation across API, workflow, events, jobs, runners, data stores, and UI without trusting caller-supplied tenant headers.

This Skill belongs to **Batch 34A** and must extend the approved ELMOS domain rather than create parallel Tenant, Identity, Artifact, Policy, Workflow, Audit, Contract or Finding aggregates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/tenant-context-propagation-resolution-and-anti-spoofing-baseline.md`.
...
```text
tenant_context_propagation_resolution_and_anti_spoofing_manifest.json
tenant_context_propagation_resolution_and_anti_spoofing_decision.json
tenant_context_propagation_resolution_and_anti_spoofing_evidence.json
```
