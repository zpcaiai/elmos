...
description: "Run FRT-2302 End-to-End Data Lineage Generator for FRT G23 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2302"
  source_name: "frt-2302-end-to-end-data-lineage-generator"
  source_sha256: "sha256:5e502528315d6a27862ad5a130d8a786fc72ca47d730a88a3afad37c94359374"
  batch: "G23"
...
- Runtime catalog key: `FRT-2302` / `frt-2302-end-to-end-data-lineage-generator`.
...
在G23范围内实现 **End-to-End Data Lineage Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：字段级Data Contract、Authority和Owner; Source-to-Sink与字段级Lineage; Write→Transaction→Outbox→Event→Projection→Cache→Read完整路径。

## When to Use

- 实现或修改与 **End-to-End Data Lineage Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2302Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2302EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2302FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2302CertificateFragment`：供G23批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g23/frt-2302-end-to-end-data-lineage-generator/
packages/runtime/g23/frt-2302-end-to-end-data-lineage-generator/
services/control-plane/g23/frt-2302-end-to-end-data-lineage-generator/
apps/web-console/src/features/g23/frt-2302-end-to-end-data-lineage-generator/
apps/admin-console/src/features/g23/frt-2302-end-to-end-data-lineage-generator/
tests/g23/frt-2302-end-to-end-data-lineage-generator/
```
...
```text
POST /v1/skills/frt-2302/runs
GET  /v1/skills/frt-2302/runs/{run_id}
POST /v1/skills/frt-2302/runs/{run_id}/verify
GET  /v1/skills/frt-2302/runs/{run_id}/findings
GET  /v1/skills/frt-2302/runs/{run_id}/evidence
```
