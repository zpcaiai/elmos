---
name: gitee-enterprise-organization-repository-scm-connector
description: "Implement Gitee public/enterprise organizations, repositories, branches, pull requests, hooks, credentials, API limitations, and compatibility evidence."
---
...
Implement Gitee public/enterprise organizations, repositories, branches, pull requests, hooks, credentials, API limitations, and compatibility evidence.
...
4. Record unresolved provider/version assumptions in `docs/implementation/gitee-enterprise-organization-repository-scm-connector-baseline.md`.
...
```text
gitee_enterprise_organization_repository_scm_connector_manifest.json
gitee_enterprise_organization_repository_scm_connector_decision.json
gitee_enterprise_organization_repository_scm_connector_evidence.json
```
