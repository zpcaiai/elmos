---
name: fine-grained-authorization-engine
description: "Repository-owned bounded wrapper for fine-grained-authorization-engine; external evidence remains NOT_RUN."
---
...
Enforce principal-action-resource-context authorization for tenant/repo/branch/environment/secret/tool access with schema validation.
...
4. Submit `fine-grained-authorization-engine` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `25ee707151ae96dfe67c965b74496df0afef0346bf70eb6a29e6e6c8b4230240`
