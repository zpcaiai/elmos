---
name: b102-metamorphic-property-testing
description: "Use when ELMOS must Generate properties and transformations that reveal defects beyond example-based tests. Triggers: Metamorphic and Property Testing, Semantic Equivalence Lab Pack, property tests, metamorphic relations, generators, shrinking."
metadata:
  id: B102-S13
...
# B102-S13 — Metamorphic and Property Testing

## Objective

Generate properties and transformations that reveal defects beyond example-based tests.
...
Use this Skill when the approved task explicitly requires **Metamorphic and Property Testing** or when the capability graph selects it as part of a minimal dependency closure.
...
- properties owner-reviewed.
- counterexamples retained.
- generator coverage measured.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b102-metamorphic-property-testing/SKILL.md --out /tmp/metamorphic_property_testing.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B102-S13
```
...
- Reject or expose tautological property.
- Reject or expose invalid input dominates.
- Reject or expose counterexample discarded.
