---
name: integration-platform-orchestrator
description: "Implement Batch 46A API、iPaaS、Event Streaming与Integration Platform end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering API、Connector、Event、Topic、Schema、Route、Transformation、Subscription、Gateway与Integration Flow."
---
...
Implement Batch 46A API、iPaaS、Event Streaming与Integration Platform end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering API、Connector、Event、Topic、Schema、Route、Transformation、Subscription、Gateway与Integration Flow.
...
5. Write unresolved domain assumptions to `docs/implementation/integration-platform-orchestrator-baseline.md`.
...
```text
integration_platform_orchestrator_manifest.json
integration_platform_orchestrator_state.json
integration_platform_orchestrator_decision.json
integration_platform_orchestrator_reconciliation.json
integration_platform_orchestrator_evidence.json
```
