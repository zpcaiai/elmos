---
name: b87-windows-interop-regression-verifier
description: "Use when ELMOS must run windows interop regression verifier for Batch 87 VB6 / VBA / VB.NET / Office Automation Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG305"
  source_name: "windows-interop-regression-verifier"
  source_sha256: "sha256:10aeec398650a0cd18211ee8a58f1330ff17cee268d698c627a1d3fed64817e2"
  batch: 87
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 87 Language Pack / source PG305 — Windows Interop Regression Verifier

## 1. Objective

Verify windows interop regression verifier within the VB6 / VBA / VB.NET / Office Automation Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Windows Interop Regression Verifier using the approved windows-legacy semantic contracts and toolchain versions.
...
- A representative valid vb-office input produces all declared outputs for windows-interop-regression-verifier.
