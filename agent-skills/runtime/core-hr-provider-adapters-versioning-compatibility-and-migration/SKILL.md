---
name: core-hr-provider-adapters-versioning-compatibility-and-migration
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle provider adapters, capability discovery, API and schema versions, compatibility, migration and deprecation, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle provider adapters, capability discovery, API and schema versions, compatibility, migration and deprecation, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-provider-adapters-versioning-compatibility-and-migration-baseline.md`.
...
```text
core_hr_provider_adapters_versioning_compatibility_and_migration_manifest.json
core_hr_provider_adapters_versioning_compatibility_and_migration_state.json
core_hr_provider_adapters_versioning_compatibility_and_migration_decision.json
core_hr_provider_adapters_versioning_compatibility_and_migration_reconciliation.json
core_hr_provider_adapters_versioning_compatibility_and_migration_evidence.json
```
