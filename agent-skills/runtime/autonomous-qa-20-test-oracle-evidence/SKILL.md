---
name: "autonomous-qa-20-test-oracle-evidence"
description: "Run 20-test-oracle-evidence through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "20-test-oracle-evidence"
  source_sha256: "sha256:9c817c47f3305be3c520a3db77ab227afbc9aeb35fe8f3fb7cc775ddafbaca67"
  ...
  runtime_skill_key: "20-test-oracle-evidence"
  runtime_handler: "execute_20_test_oracle_evidence"
  runtime_phase: "evidence"
  runtime_mutating: "false"
  runtime_operation: "elmos_autonomous_qa.advanced_skills.verify_evidence"
...
1. Accept only a structured request for the exact Skill key `20-test-oracle-evidence`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_20_test_oracle_evidence` and operation `elmos_autonomous_qa.advanced_skills.verify_evidence`.
...
- Immutable source: `skills/20-test-oracle-evidence/SKILL.md` at `sha256:9c817c47f3305be3c520a3db77ab227afbc9aeb35fe8f3fb7cc775ddafbaca67`.
- Exact runtime phase is `evidence`; mutating declaration is `false`.
