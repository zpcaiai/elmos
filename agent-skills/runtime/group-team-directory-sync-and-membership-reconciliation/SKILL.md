---
name: group-team-directory-sync-and-membership-reconciliation
description: "Implement directory group and team synchronization, authoritative source precedence, membership reconciliation, deprovisioning, conflict handling, and drift detection."
---
...
Implement directory group and team synchronization, authoritative source precedence, membership reconciliation, deprovisioning, conflict handling, and drift detection.
...
4. Record unresolved provider/version assumptions in `docs/implementation/group-team-directory-sync-and-membership-reconciliation-baseline.md`.
...
```text
group_team_directory_sync_and_membership_reconciliation_manifest.json
group_team_directory_sync_and_membership_reconciliation_decision.json
group_team_directory_sync_and_membership_reconciliation_evidence.json
```
