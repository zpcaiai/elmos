---
name: assurance-alert-case-remediation-owner-escalation-and-r-a4dd602f
description: 将Evidence Gap、Expiry、Control Failure、Risk、Audit与Data Quality信号转成有Owner、SLA、整改与复验的Case。
metadata:
  elmos_batch: "37C"
  elmos_skill_id: "ANA37C013"
  pack_version: "3.7-complete"
---

# ANA37C013 — Assurance Alert、Case、Remediation、Owner 与 Reverification

## Objective

将Evidence Gap、Expiry、Control Failure、Risk、Audit与Data Quality信号转成有Owner、SLA、整改与复验的Case。
...
- Alert Dedup Key包含Rule、Scope、Subject、Metric Version、Finding Type和Window。
- Suppression必须有Reason、Scope、Owner、Start/End、Evidence。
- Case Closure仅允许Reverified Resolved、Risk Accepted、False Positive、Superseded。
- Risk Acceptance需要Owner、Compensating Control、Expiry与Review Date。
...
- duplicateAlertCreatesOccurrenceNotNewCase
- remediationCompletionDoesNotCloseWithoutReverification
- expiredRiskAcceptanceCreatesAlert
- caseEscalatesWhenSlaBreached
