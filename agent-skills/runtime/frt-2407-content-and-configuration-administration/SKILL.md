...
description: "Run FRT-2407 Content and Configuration Administration for FRT G24 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2407"
  source_name: "frt-2407-content-and-configuration-administration"
  source_sha256: "sha256:6dcc8584d6279c478b408b264b66c08f36ed08cb8079081f1efadcb562ad5894"
  batch: "G24"
...
- Runtime catalog key: `FRT-2407` / `frt-2407-content-and-configuration-administration`.
...
在G24范围内实现 **Content and Configuration Administration**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Admin Object × Action × Role × Scope × Environment矩阵; 高风险操作Impact Preview、Reason、Approval、Typed Command、Audit; Manual Case、Data Repair、Reconciliation正式后台流程。

## When to Use

- 实现或修改与 **Content and Configuration Administration** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2407Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2407EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2407FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2407CertificateFragment`：供G24批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g24/frt-2407-content-and-configuration-administration/
packages/runtime/g24/frt-2407-content-and-configuration-administration/
services/control-plane/g24/frt-2407-content-and-configuration-administration/
apps/web-console/src/features/g24/frt-2407-content-and-configuration-administration/
apps/admin-console/src/features/g24/frt-2407-content-and-configuration-administration/
tests/g24/frt-2407-content-and-configuration-administration/
```
...
```text
POST /v1/skills/frt-2407/runs
GET  /v1/skills/frt-2407/runs/{run_id}
POST /v1/skills/frt-2407/runs/{run_id}/verify
GET  /v1/skills/frt-2407/runs/{run_id}/findings
GET  /v1/skills/frt-2407/runs/{run_id}/evidence
```
