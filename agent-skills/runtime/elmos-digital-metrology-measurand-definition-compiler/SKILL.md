...
# Digital Metrology and Measurand Definition Compiler
...
- `DigitalMetrologyAndMeasurandDefinitionCompilerProfile`
- `DigitalMetrologyAndMeasurandDefinitionCompilerRun`
- `DigitalMetrologyAndMeasurandDefinitionCompilerFinding`
- `DigitalMetrologyAndMeasurandDefinitionCompilerDecision`
- `DigitalMetrologyAndMeasurandDefinitionCompilerEvidence`

Required semantic capabilities:

- define measurand, measurement procedure, influence quantities and decision context for AI metrics
- separate construct, proxy, observable and computed result
- record units, scales, reference conditions and traceability chain
...
- `artifacts/elmos-digital-metrology-measurand-definition-compiler/profile.yaml`
- `artifacts/elmos-digital-metrology-measurand-definition-compiler/plan.json`
- `artifacts/elmos-digital-metrology-measurand-definition-compiler/result.json`
- `artifacts/elmos-digital-metrology-measurand-definition-compiler/evidence/`
- `artifacts/elmos-digital-metrology-measurand-definition-compiler/assurance-case.json`
...
- **metric name is mistaken for a defined measurand** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **proxy validity is assumed across contexts** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **influence quantity such as prompt order is ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define measurand, measurement procedure, influence quantities and decision context for AI metrics
- native scenario: separate construct, proxy, observable and computed result
- native scenario: record units, scales, reference conditions and traceability chain
