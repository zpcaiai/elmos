---
name: elmos-certificate-drift-revocation-controller
description: Continuously map code, model, data, policy, adapter, database, environment and vulnerability drift to evidence invalidation, certificate narrowing, suspension or revocation.
version: 4.0.0
...
# Certificate Drift and Revocation Controller
...
- Maintain dependency graph from certificate to evidence and inputs
- Classify drift severity and affected claims
- Suspend rapidly on critical uncertainty
- Generate incremental recertification DAG
- Publish revocation and replacement lineage
...
- `certificate-drift-events.jsonl`
- `evidence-invalidation-plan.json`
- `certificate-revocation-record.json`
- `recertification-dag.json`
...
- **drift event lost** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **certificate remains valid after signer revocation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **over-invalidation causes avoidable full rerun** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **under-invalidation leaves stale claim** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **revocation not propagated to admission** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- critical CVE/KEV
- policy change
- certificate suspension/reissue
