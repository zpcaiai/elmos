---
name: sandbox-secret-lease-injection-redaction-and-zeroization
description: "Implement sandbox-scoped secret leases, process-bound delivery, tmpfs/FD helpers, inheritance controls, pre-persistence redaction, revocation, and zeroization evidence."
---
...
Implement sandbox-scoped secret leases, process-bound delivery, tmpfs/FD helpers, inheritance controls, pre-persistence redaction, revocation, and zeroization evidence.
...
4. Record unresolved provider/version assumptions in `docs/implementation/sandbox-secret-lease-injection-redaction-and-zeroization-baseline.md`.
...
```text
sandbox_secret_lease_injection_redaction_and_zeroization_manifest.json
sandbox_secret_lease_injection_redaction_and_zeroization_decision.json
sandbox_secret_lease_injection_redaction_and_zeroization_evidence.json
```
