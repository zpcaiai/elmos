---
name: elmos-coverage-semantic-obligation-mapper
description: Map line, branch, mutation, state, protocol, data, security and scenario coverage to Proof Obligations instead of optimizing a single percentage.
version: 4.0.0
...
# Coverage-to-Semantic-Obligation Mapper
...
- `CoverageToSemanticObligationMapperProfile`
- `CoverageToSemanticObligationMapperPlan`
- `CoverageToSemanticObligationMapperRun`
- `CoverageToSemanticObligationMapperDecision`

Required semantic capabilities:

- link tests to semantic subjects and claims
- measure state/transition and boundary coverage
- track mutation and negative-security coverage
- identify unobservable or untestable obligations
- prevent duplicate tests inflating closure
...
- `artifacts/elmos-coverage-semantic-obligation-mapper/profile.yaml`
- `artifacts/elmos-coverage-semantic-obligation-mapper/plan.json`
- `artifacts/elmos-coverage-semantic-obligation-mapper/result.json`
- `artifacts/elmos-coverage-semantic-obligation-mapper/evidence/`
...
- **line coverage shown as semantic proof** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **test-to-obligation link fabricated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **mutation operators irrelevant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **critical boundary uninstrumented** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **same evidence counted multiple times** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: link tests to semantic subjects and claims
- native scenario: measure state/transition and boundary coverage
- native scenario: track mutation and negative-security coverage
- native scenario: identify unobservable or untestable obligations
- native scenario: prevent duplicate tests inflating closure
