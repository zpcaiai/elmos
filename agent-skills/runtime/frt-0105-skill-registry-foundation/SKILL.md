...
description: "Run FRT-0105 Skill Registry Foundation for FRT G01 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0105"
  source_name: "frt-0105-skill-registry-foundation"
  source_sha256: "sha256:df2a5fc0bab9edd9767d57cf4fcbb99adf3b1bf355a8ee0464f17e902a4b87f5"
  batch: "G01"
...
- Runtime catalog key: `FRT-0105` / `frt-0105-skill-registry-foundation`.
...
# FRT-0105 — Skill Registry Foundation

## Objective

在G01范围内实现 **Skill Registry Foundation**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：定义系统不可妥协语义与风险等级; 建立可扩展Monorepo与稳定模块边界; 统一Skill Manifest、输入输出Schema、权限、版本与证据协议。

## When to Use

- 实现或修改与 **Skill Registry Foundation** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0105Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0105EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0105FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0105CertificateFragment`：供G01批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g01/frt-0105-skill-registry-foundation/
packages/runtime/g01/frt-0105-skill-registry-foundation/
services/control-plane/g01/frt-0105-skill-registry-foundation/
apps/web-console/src/features/g01/frt-0105-skill-registry-foundation/
apps/admin-console/src/features/g01/frt-0105-skill-registry-foundation/
tests/g01/frt-0105-skill-registry-foundation/
```
...
```text
POST /v1/skills/frt-0105/runs
GET  /v1/skills/frt-0105/runs/{run_id}
POST /v1/skills/frt-0105/runs/{run_id}/verify
GET  /v1/skills/frt-0105/runs/{run_id}/findings
GET  /v1/skills/frt-0105/runs/{run_id}/evidence
```
