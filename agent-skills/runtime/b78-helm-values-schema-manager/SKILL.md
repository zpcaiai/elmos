---
name: b78-helm-values-schema-manager
description: "Use when ELMOS must coordinate and control Helm Values Schema Manager for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Helm Values Schema Manager, Batch 78, Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification."
metadata:
  id: PG386
  batch: 78
  version: 1.0.0
...
# PG386 — Helm Values Schema Manager

## Objective

Coordinate and control Helm Values Schema Manager for Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `helm-values-schema-manager` tasks involving Terraform/OpenTofu modules, providers, state, plan/policy/cost, imports and drift, Kubernetes workloads, secrets, networking, autoscaling, Helm charts, admission policy, GitOps, rollback, and certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG374`, `PG385`.
...
- `helm_values_schema_manager_plan.json`
- `helm_values_schema_manager_artifacts/`
- `helm_values_schema_manager_verification.json`
