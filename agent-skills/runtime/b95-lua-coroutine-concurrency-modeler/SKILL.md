---
name: b95-lua-coroutine-concurrency-modeler
description: "Use when ELMOS must run lua coroutine concurrency modeler for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG396"
  source_name: "lua-coroutine-concurrency-modeler"
  source_sha256: "sha256:700e6058240437917b46adccc1e8d395a85bd56d7ad34cd9bd4a186da2f090fb"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG396 — Lua Coroutine Concurrency Modeler

## 1. Objective

Model lua coroutine concurrency modeler within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Lua Coroutine Concurrency Modeler using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-coroutine-concurrency-modeler.
