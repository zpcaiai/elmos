---
name: stored-routine-migration
description: "Repository-owned bounded wrapper for stored-routine-migration; external evidence remains NOT_RUN."
---
...
Translate procedures/functions/triggers/packages and preserve exception, transaction, cursor and procedural semantics.
...
4. Submit `stored-routine-migration` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `c67af697ef5f0df1b4bfafd8c99dfb2d31d3117af8abb500b590b595aed8af53`
