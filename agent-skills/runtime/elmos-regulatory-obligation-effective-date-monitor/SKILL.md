---
name: elmos-regulatory-obligation-effective-date-monitor
description: Track versioned jurisdictional obligations, effective dates, guidance and product scope; trigger human legal review and technical control changes.
version: 4.0.0
...
# Regulatory Obligation and Effective-Date Monitor
...
- `RegulatoryObligationAndEffectiveDateMonitorProfile`
- `RegulatoryObligationAndEffectiveDateMonitorPlan`
- `RegulatoryObligationAndEffectiveDateMonitorRun`
- `RegulatoryObligationAndEffectiveDateMonitorDecision`

Required semantic capabilities:

- maintain authoritative source and jurisdiction registry
- model applicability and effective dates
- diff obligation/control mappings
- open reviewed implementation and evidence changes
- block claims when legal interpretation unresolved
...
- `artifacts/elmos-regulatory-obligation-effective-date-monitor/profile.yaml`
- `artifacts/elmos-regulatory-obligation-effective-date-monitor/plan.json`
- `artifacts/elmos-regulatory-obligation-effective-date-monitor/result.json`
- `artifacts/elmos-regulatory-obligation-effective-date-monitor/evidence/`
...
- **blog treated as authoritative law** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **effective date timezone wrong** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **scope change not propagated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **automatic system gives legal opinion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **obsolete obligation remains active** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: maintain authoritative source and jurisdiction registry
- native scenario: model applicability and effective dates
- native scenario: diff obligation/control mappings
- native scenario: open reviewed implementation and evidence changes
- native scenario: block claims when legal interpretation unresolved
