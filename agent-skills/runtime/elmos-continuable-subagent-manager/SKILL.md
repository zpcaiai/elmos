...
description: "Invoke the bounded repository handler for elmos-continuable-subagent-manager while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P01:continuable-subagent-manager"
  source_name: "elmos-continuable-subagent-manager"
  installed_name: "elmos-continuable-subagent-manager"
  source_logical_path: "01-elmos-harness-runtime-platform/skills/continuable-subagent-manager/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/01-elmos-harness-runtime-platform/skills/continuable-subagent-manager/SKILL.md.source-data"
  source_materialized_path: "01-elmos-harness-runtime-platform/skills/continuable-subagent-manager/SKILL.md.source-data"
  source_sha256: "sha256:0588bbb61ed2e4c8c8451b6ab9647ed248852ccc1d1ab16484e948b99bdcb173"
...
# elmos-continuable-subagent-manager
...
- This is a deterministic repository wrapper for `01-elmos-harness-runtime-platform/skills/continuable-subagent-manager/SKILL.md` at `sha256:0588bbb61ed2e4c8c8451b6ab9647ed248852ccc1d1ab16484e948b99bdcb173`.
- Its immutable source/runtime identity is `elmos-continuable-subagent-manager`; its active installed identity is `elmos-continuable-subagent-manager`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-continuable-subagent-manager --request <file>
```
