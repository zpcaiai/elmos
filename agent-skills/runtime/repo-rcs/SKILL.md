---
name: repo-rcs
description: 计算 100 分 RCS：规模25、模块15、依赖15、语言10、框架10、运行10、测试构建10、遗留5。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-020
  source_name: repo-rcs
  source_path: skills/repo-rcs/SKILL.md
  source_sha256: sha256:ebcdbc0d9a6b9831742b4b0660ac00168e837445b107960c80e08e155f12c31d
  source_contract_sha256: sha256:acec850a45a1f6d91299d41370cf85211a584a2950b6f95b3872cb9714210614
...
计算 100 分 RCS：规模25、模块15、依赖15、语言10、框架10、运行10、测试构建10、遗留5。
...
- [ ] 定义 `repo-rcs` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `repo-rcs` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：rcs-score.json, dimension-breakdown.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：rcs-score.json, dimension-breakdown.json。
...
- Machine contract: `references/contract.json` (`sha256:acec850a45a1f6d91299d41370cf85211a584a2950b6f95b3872cb9714210614`).
