---
name: gross-margin-cogs-contribution-margin-and-cost-classification
description: "Implement revenue and cost classifications, COGS, gross margin, contribution margin, product cost policies, restatements and reconciliations."
---
...
Implement revenue and cost classifications, COGS, gross margin, contribution margin, product cost policies, restatements and reconciliations.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/gross-margin-cogs-contribution-margin-and-cost-classification-baseline.md`.
...
```text
gross_margin_cogs_contribution_margin_and_cost_classification_manifest.json
gross_margin_cogs_contribution_margin_and_cost_classification_decision.json
gross_margin_cogs_contribution_margin_and_cost_classification_reconciliation.json
gross_margin_cogs_contribution_margin_and_cost_classification_evidence.json
```
...
```text
grossMarginUsesCertifiedRevenue
grossAndContributionMarginRemainDistinct
unallocatedCostIsVisible
