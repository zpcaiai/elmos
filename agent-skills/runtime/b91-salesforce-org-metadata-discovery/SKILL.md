---
name: b91-salesforce-org-metadata-discovery
description: "Use when ELMOS must run salesforce org metadata discovery for Batch 91 Salesforce Apex / SOQL / LWC Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG343"
  source_name: "salesforce-org-metadata-discovery"
  source_sha256: "sha256:e676f724a00424c650ba6a99b2bce67c812833ea4d33da47ae9ab8dc27ad3a08"
  batch: 91
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 91 Language Pack / source PG343 — Salesforce Org Metadata Discovery

## 1. Objective

Discover and inventory salesforce org metadata discovery within the Salesforce Apex / SOQL / LWC Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Salesforce Org Metadata Discovery using the approved enterprise-crm-platform semantic contracts and toolchain versions.
...
- A representative valid salesforce input produces all declared outputs for salesforce-org-metadata-discovery.
