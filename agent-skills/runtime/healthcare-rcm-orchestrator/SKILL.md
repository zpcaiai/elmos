---
name: healthcare-rcm-orchestrator
description: "Implement Batch 52C Healthcare Revenue Cycle、Privacy、Safety与Quality end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Coverage、Authorization、Charge、Claim、Remittance、Denial、Payment、Clinical Quality、Safety Event与Privacy Request."
---

# Healthcare Rcm Orchestrator

## Objective

Implement Batch 52C Healthcare Revenue Cycle、Privacy、Safety与Quality end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Coverage、Authorization、Charge、Claim、Remittance、Denial、Payment、Clinical Quality、Safety Event与Privacy Request.
...
5. Write unresolved domain assumptions to `docs/implementation/healthcare-rcm-orchestrator-baseline.md`.
...
```text
healthcare_rcm_orchestrator_manifest.json
healthcare_rcm_orchestrator_state.json
healthcare_rcm_orchestrator_decision.json
healthcare_rcm_orchestrator_reconciliation.json
healthcare_rcm_orchestrator_evidence.json
```
