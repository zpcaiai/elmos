---
name: experience-value-scoring
description: Use this skill when Elmos must perform experience value scoring as part of the 04-memory-experience-flywheel production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# experience-value-scoring

## 能力目标

按正确性、稀缺性、泛化性、证据完整度和训练权利评估经验价值。
