---
name: elmos-contract-smt-symbolic-execution-verifier
description: Verify data, authorization, transformation and routine contracts with SMT and symbolic execution under explicit path and resource bounds.
version: 4.0.0
...
# Contract SMT and Symbolic Execution Verifier
...
- `ContractSMTAndSymbolicExecutionVerifierProfile`
- `ContractSMTAndSymbolicExecutionVerifierPlan`
- `ContractSMTAndSymbolicExecutionVerifierRun`
- `ContractSMTAndSymbolicExecutionVerifierDecision`

Required semantic capabilities:

- encode pre/postconditions and invariants
- symbolically execute critical paths and routines
- solve numeric, null, time and authorization constraints
- report path coverage and unknowns
- validate candidate transformation instances
...
- `artifacts/elmos-contract-smt-symbolic-execution-verifier/profile.yaml`
- `artifacts/elmos-contract-smt-symbolic-execution-verifier/plan.json`
- `artifacts/elmos-contract-smt-symbolic-execution-verifier/result.json`
- `artifacts/elmos-contract-smt-symbolic-execution-verifier/evidence/`
...
- **solver theory mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **path explosion hidden** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **environment call modeled pure** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **undefined behavior assumed away** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **UNKNOWN treated as UNSAT** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: encode pre/postconditions and invariants
- native scenario: symbolically execute critical paths and routines
- native scenario: solve numeric, null, time and authorization constraints
- native scenario: report path coverage and unknowns
- native scenario: validate candidate transformation instances
