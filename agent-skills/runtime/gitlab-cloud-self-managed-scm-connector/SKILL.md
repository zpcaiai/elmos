---
name: gitlab-cloud-self-managed-scm-connector
description: "Implement GitLab.com and Self-Managed groups, projects, repositories, branches, merge requests, hooks, tokens, version discovery, and reconciliation."
---
...
Implement GitLab.com and Self-Managed groups, projects, repositories, branches, merge requests, hooks, tokens, version discovery, and reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/gitlab-cloud-self-managed-scm-connector-baseline.md`.
...
```text
gitlab_cloud_self_managed_scm_connector_manifest.json
gitlab_cloud_self_managed_scm_connector_decision.json
gitlab_cloud_self_managed_scm_connector_evidence.json
```
