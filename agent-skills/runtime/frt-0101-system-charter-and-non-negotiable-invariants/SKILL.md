...
description: "Run FRT-0101 System Charter and Non-Negotiable Invariants for FRT G01 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0101"
  source_name: "frt-0101-system-charter-and-non-negotiable-invariants"
  source_sha256: "sha256:471e9b276ce6f99f3a57e00fc084f7dc0de47ff61abfb7abba09c0f8eb5539ca"
  batch: "G01"
...
- Runtime catalog key: `FRT-0101` / `frt-0101-system-charter-and-non-negotiable-invariants`.
...
# FRT-0101 — System Charter and Non-Negotiable Invariants

## Objective

在G01范围内实现 **System Charter and Non-Negotiable Invariants**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：定义系统不可妥协语义与风险等级; 建立可扩展Monorepo与稳定模块边界; 统一Skill Manifest、输入输出Schema、权限、版本与证据协议。

## When to Use

- 实现或修改与 **System Charter and Non-Negotiable Invariants** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0101Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0101EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0101FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0101CertificateFragment`：供G01批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g01/frt-0101-system-charter-and-non-negotiable-invariants/
packages/runtime/g01/frt-0101-system-charter-and-non-negotiable-invariants/
services/control-plane/g01/frt-0101-system-charter-and-non-negotiable-invariants/
apps/web-console/src/features/g01/frt-0101-system-charter-and-non-negotiable-invariants/
apps/admin-console/src/features/g01/frt-0101-system-charter-and-non-negotiable-invariants/
tests/g01/frt-0101-system-charter-and-non-negotiable-invariants/
```
...
```text
POST /v1/skills/frt-0101/runs
GET  /v1/skills/frt-0101/runs/{run_id}
POST /v1/skills/frt-0101/runs/{run_id}/verify
GET  /v1/skills/frt-0101/runs/{run_id}/findings
GET  /v1/skills/frt-0101/runs/{run_id}/evidence
```
