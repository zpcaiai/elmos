...
description: "Invoke the bounded repository handler for elmos-differential-runtime while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P05:differential-runtime"
  source_name: "elmos-differential-runtime"
  installed_name: "elmos-differential-runtime"
  source_logical_path: "05-elmos-conversion-reliability-verification-harness/skills/differential-runtime/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/05-elmos-conversion-reliability-verification-harness/skills/differential-runtime/SKILL.md.source-data"
  source_materialized_path: "05-elmos-conversion-reliability-verification-harness/skills/differential-runtime/SKILL.md.source-data"
  source_sha256: "sha256:230df790cd920c1e1c733ed2593d922b3849a4308ed95e988b47091a3ee394a7"
...
- This is a deterministic repository wrapper for `05-elmos-conversion-reliability-verification-harness/skills/differential-runtime/SKILL.md` at `sha256:230df790cd920c1e1c733ed2593d922b3849a4308ed95e988b47091a3ee394a7`.
- Its immutable source/runtime identity is `elmos-differential-runtime`; its active installed identity is `elmos-differential-runtime`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-differential-runtime --request <file>
```
