---
name: framework-modernization-router
description: "Repository-owned bounded wrapper for framework-modernization-router; external evidence remains NOT_RUN."
---
...
Plan and execute staged legacy-framework modernization with adapters, strangler phases, compatibility shims and rollback points.
...
4. Submit `framework-modernization-router` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `e6b5358054dba4cc37f3864b6461671ebab108e5a0e4dc113e7ba42d871c9d4e`
