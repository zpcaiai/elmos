---
name: elmos-orm-persistence-ir-compiler
description: Compile ORM mappings, identity generation, cascades, lazy/eager loading, optimistic locking, transactions, native queries and migrations across Java, Python, TypeScript, .NET, Go and Rust.
version: 4.0.0
...
# ORM and Persistence IR Compiler
...
- Detect ORM/provider and exact version
- Recover entity and relationship mappings
- Model fetch/cascade/locking semantics
- Link native SQL and migrations to DB-SIR
- Generate target persistence mappings with explicit gaps
...
- `orm-persistence-ir.json`
- `entity-schema-map.json`
...
- **N+1 behavior changes production load** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cascade semantics widened** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **optimistic lock removed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ID generator collision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **lazy-loading outside transaction** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- SQLAlchemy mapping
- Prisma/TypeORM mapping
- EF Core mapping
- Go/Rust persistence mapping
- native query and transaction boundary
