---
name: test-anti-cheating-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Test Anti-Cheating Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T117"
  source_name: "test-anti-cheating-gate"
  source_sha256: "sha256:be46d7522810a052dedd4cba170af7e68d9529b4225dcdffdfa94539d766c992"
...
# T117 — Test Anti-Cheating Gate

## 1. Objective

Detect deleted tests, weakened assertions, mocked mandatory integrations, hidden skips and manipulated tolerances.
...
- `CASE-0601` [HIGH] Test Anti-Cheating Gate: Representative path
- `CASE-0602` [HIGH] Test Anti-Cheating Gate: Boundary path
- `CASE-0603` [HIGH] Test Anti-Cheating Gate: Invalid or hostile input
- `CASE-0604` [HIGH] Test Anti-Cheating Gate: Injected dependency failure
- `CASE-0605` [CRITICAL] Test Anti-Cheating Gate: Security or safety violation
- `CASE-0606` [HIGH] Test Anti-Cheating Gate: Replay and idempotency
- `CASE-0607` [HIGH] Test Anti-Cheating Gate: Version or environment drift
- `CASE-0608` [MEDIUM] Test Anti-Cheating Gate: Moderate scale
- `CASE-0609` [CRITICAL] Test Anti-Cheating Gate: Evidence tamper
- `CASE-0610` [HIGH] Test Anti-Cheating Gate: Recovery and final evidence
