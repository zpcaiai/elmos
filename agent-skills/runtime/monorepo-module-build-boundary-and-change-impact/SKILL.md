---
name: monorepo-module-build-boundary-and-change-impact
description: "Implement monorepo module discovery, build boundaries, ownership, dependency graphs, affected-set calculation, sparse work units, and validation."
---
...
Implement monorepo module discovery, build boundaries, ownership, dependency graphs, affected-set calculation, sparse work units, and validation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/monorepo-module-build-boundary-and-change-impact-baseline.md`.
...
```text
monorepo_module_build_boundary_and_change_impact_manifest.json
monorepo_module_build_boundary_and_change_impact_decision.json
monorepo_module_build_boundary_and_change_impact_evidence.json
```
