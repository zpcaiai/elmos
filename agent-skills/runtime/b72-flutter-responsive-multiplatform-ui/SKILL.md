...
# PG304 — Flutter Responsive Multiplatform UI
...
Use for `flutter-responsive-multiplatform-ui` tasks involving Flutter/Dart mobile, web, and desktop applications, state, routing, APIs, offline sync, platform channels, responsive UI, accessibility, testing, and release packaging.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG296`, `PG303`.
...
- `flutter_responsive_multiplatform_ui_plan.json`
- `flutter_responsive_multiplatform_ui_artifacts/`
- `flutter_responsive_multiplatform_ui_verification.json`
