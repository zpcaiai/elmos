---
name: chinadb-43-target-tidb
description: "Use when ELMOS must follow the ChinaDB commercial database-migration specification for TiDB Target Adapter. Keep exact directed route and version semantics, require real evidence, and fail closed on unsupported behavior."
metadata:
  source_package: "chinadb-commercial-migration-skills"
  source_version: "1.0.0"
  source_directory: "43-target-tidb"
  source_path: "skills/43-target-tidb/SKILL.md"
  source_sha256: "sha256:dd3071bb2058d94c3d9f83b184ce7412d3554c27c350982d2a8b9999aec69ba5"
...
- Provenance is pinned to `chinadb-commercial-migration-skills` version `1.0.0`, source Skill `43-target-tidb`, and the SHA-256 digest in frontmatter.
