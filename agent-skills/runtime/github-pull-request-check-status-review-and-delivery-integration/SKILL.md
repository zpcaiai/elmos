---
name: github-pull-request-check-status-review-and-delivery-integration
description: "Implement pull requests, reviews, checks, statuses, merge queue, comments, delivery evidence, idempotency, and external-side-effect reconciliation."
---
...
Implement pull requests, reviews, checks, statuses, merge queue, comments, delivery evidence, idempotency, and external-side-effect reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-pull-request-check-status-review-and-delivery-integration-baseline.md`.
...
```text
github_pull_request_check_status_review_and_delivery_integration_manifest.json
github_pull_request_check_status_review_and_delivery_integration_decision.json
github_pull_request_check_status_review_and_delivery_integration_evidence.json
```
