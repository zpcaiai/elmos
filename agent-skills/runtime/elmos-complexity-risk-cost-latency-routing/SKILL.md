---
name: complexity-risk-cost-latency-routing
description: Use this skill when Elmos must perform complexity risk cost latency routing as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
