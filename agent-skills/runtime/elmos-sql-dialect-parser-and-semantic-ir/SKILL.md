---
name: sql-dialect-parser-and-semantic-ir
description: Use this skill when Elmos must perform sql dialect parser and semantic ir as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
解析多数据库 SQL、PL/SQL、T-SQL、PL/pgSQL 和扩展语法。
