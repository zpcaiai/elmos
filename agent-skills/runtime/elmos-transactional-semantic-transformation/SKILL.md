...
description: "Apply stale-safe, rollback-bound semantic transactions."
---
...
Use the exact repository-owned PDHI v1 `K2` boundary for the
...
2. Resolve this Skill through `SKILL_REGISTRY`; resolve capability operations
   only through `CAPABILITY_REGISTRY` and the exact owner `K2`.
...
- Registry identity: `PDHI-V1-003`
- Kind/owner: `kernel` / `K2`
- Source member: `20-transactional-transformation/SKILL.md`
- Source member SHA-256: `sha256:1d9049c5361ed497d001b346b190e2db5e61373ec98fe67d968f851fb39f33be`
- Engine: `engines/proof-driven-harness-intelligence-engine/src/elmos_pdhi/transactions.py`
- Runtime: `elmos_pdhi.transactions.TransactionManager`
- Exact binding registry: `K2_OPERATION_SPECS`
- Source capability occurrences: `20`
