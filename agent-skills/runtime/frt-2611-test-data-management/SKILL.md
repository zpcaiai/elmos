...
description: "Run FRT-2611 Test Data Management for FRT G26 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2611"
  source_name: "frt-2611-test-data-management"
  source_sha256: "sha256:d6aa3fd1eb2ee01d64115f78c21fce29320c6a4b485837133750cf2bbc88ec51"
  batch: "G26"
...
- Runtime catalog key: `FRT-2611` / `frt-2611-test-data-management`.
...
在G26范围内实现 **Test Data Management**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Requirement/Acceptance/State Machine派生Test Obligation; Unit/Component/Contract/Integration/Journey分层协调; Differential、Mutation、Visual/Semantic、Security和Performance Regression。

## When to Use

- 实现或修改与 **Test Data Management** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2611Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2611EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2611FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2611CertificateFragment`：供G26批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g26/frt-2611-test-data-management/
packages/runtime/g26/frt-2611-test-data-management/
services/control-plane/g26/frt-2611-test-data-management/
apps/web-console/src/features/g26/frt-2611-test-data-management/
apps/admin-console/src/features/g26/frt-2611-test-data-management/
tests/g26/frt-2611-test-data-management/
```
...
```text
POST /v1/skills/frt-2611/runs
GET  /v1/skills/frt-2611/runs/{run_id}
POST /v1/skills/frt-2611/runs/{run_id}/verify
GET  /v1/skills/frt-2611/runs/{run_id}/findings
GET  /v1/skills/frt-2611/runs/{run_id}/evidence
```
