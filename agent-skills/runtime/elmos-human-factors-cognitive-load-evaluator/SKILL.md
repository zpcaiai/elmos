---
name: elmos-human-factors-cognitive-load-evaluator
description: Evaluate operator comprehension, interruption, trust calibration, alert fatigue, approval quality and recovery performance for agentic systems.
version: 4.0.0
...
# Human Factors and Cognitive Load Evaluator
...
- `HumanFactorsAndCognitiveLoadEvaluatorProfile`
- `HumanFactorsAndCognitiveLoadEvaluatorPlan`
- `HumanFactorsAndCognitiveLoadEvaluatorRun`
- `HumanFactorsAndCognitiveLoadEvaluatorDecision`

Required semantic capabilities:

- define role-specific usability scenarios
- measure task completion and error recovery
- test uncertainty and automation disclosure
- evaluate alert/approval fatigue
- capture qualitative evidence without overstating generality
...
- `artifacts/elmos-human-factors-cognitive-load-evaluator/profile.yaml`
- `artifacts/elmos-human-factors-cognitive-load-evaluator/plan.json`
- `artifacts/elmos-human-factors-cognitive-load-evaluator/result.json`
- `artifacts/elmos-human-factors-cognitive-load-evaluator/evidence/`
...
- **small sample generalized** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **participants see answer key** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **speed rewarded over safety** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **accessibility population omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **UX score shown as compliance** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define role-specific usability scenarios
- native scenario: measure task completion and error recovery
- native scenario: test uncertainty and automation disclosure
- native scenario: evaluate alert/approval fatigue
- native scenario: capture qualitative evidence without overstating generality
