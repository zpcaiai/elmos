---
name: b83-dynamic-sql-injection-safety-analyzer
description: "Use when ELMOS must run dynamic sql injection safety analyzer for Batch 83 PL/SQL / T-SQL / PL/pgSQL / SQL PL Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG253"
  source_name: "dynamic-sql-injection-safety-analyzer"
  source_sha256: "sha256:c41d933d18c21419461c06353087bdd7139da0ba6ec08bae1d82f9e3a5115a80"
  batch: 83
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 83 Language Pack / source PG253 — Dynamic SQL Injection Safety Analyzer

## 1. Objective

Analyze dynamic sql injection safety analyzer within the PL/SQL / T-SQL / PL/pgSQL / SQL PL Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Dynamic SQL Injection Safety Analyzer using the approved database-programming semantic contracts and toolchain versions.
...
- A representative valid database-procedural input produces all declared outputs for dynamic-sql-injection-safety-analyzer.
