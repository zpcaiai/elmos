---
name: elmos-semantic-loss-risk-estimator
description: Score semantic loss per symbol, module and route, including money, data
  integrity, security, concurrency, numerical, ABI and safety consequences.
version: 1.0.0
skill_id: ELMOS-POLY-082
layer: planning
risk: high
readiness: not-run
dependencies:
- elmos-business-rule-ir-builder
- elmos-transaction-ir-builder
- elmos-record-layout-ir-builder
triggers:
- Use when implementing or executing `elmos-semantic-loss-risk-estimator`.
...
# Semantic Loss Risk Estimator

## Objective

Score semantic loss per symbol, module and route, including money, data integrity, security, concurrency, numerical, ABI and safety consequences.
