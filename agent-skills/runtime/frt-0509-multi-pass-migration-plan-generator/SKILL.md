...
description: "Run FRT-0509 Multi-Pass Migration Plan Generator for FRT G05 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0509"
  source_name: "frt-0509-multi-pass-migration-plan-generator"
  source_sha256: "sha256:680e1037d9691d2c0c2c427a8e20cf70ffa3aa2edc25add11a9e7046ccb4ea2f"
  batch: "G05"
...
- Runtime catalog key: `FRT-0509` / `frt-0509-multi-pass-migration-plan-generator`.
...
# FRT-0509 — Multi-Pass Migration Plan Generator

## Objective

在G05范围内实现 **Multi-Pass Migration Plan Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：比较源语义与目标能力并生成Gap Register; 区分Native、Shim、Product Decision、Manual与Unsupported; 估算正确率、耗时、风险、数据和测试影响。

## When to Use

- 实现或修改与 **Multi-Pass Migration Plan Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0509Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0509EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0509FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0509CertificateFragment`：供G05批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g05/frt-0509-multi-pass-migration-plan-generator/
packages/runtime/g05/frt-0509-multi-pass-migration-plan-generator/
services/control-plane/g05/frt-0509-multi-pass-migration-plan-generator/
apps/web-console/src/features/g05/frt-0509-multi-pass-migration-plan-generator/
apps/admin-console/src/features/g05/frt-0509-multi-pass-migration-plan-generator/
tests/g05/frt-0509-multi-pass-migration-plan-generator/
```
...
```text
POST /v1/skills/frt-0509/runs
GET  /v1/skills/frt-0509/runs/{run_id}
POST /v1/skills/frt-0509/runs/{run_id}/verify
GET  /v1/skills/frt-0509/runs/{run_id}/findings
GET  /v1/skills/frt-0509/runs/{run_id}/evidence
```
