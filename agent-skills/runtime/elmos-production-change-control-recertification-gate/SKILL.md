---
name: elmos-production-change-control-recertification-gate
description: Map code, model, prompt, data, policy, infrastructure and vendor changes to risk, approvals, evidence invalidation and incremental/full recertification.
version: 4.0.0
...
# Production Change-Control and Recertification Gate
...
- `ProductionChangeControlAndRecertificationGateProfile`
- `ProductionChangeControlAndRecertificationGatePlan`
- `ProductionChangeControlAndRecertificationGateRun`
- `ProductionChangeControlAndRecertificationGateDecision`

Required semantic capabilities:

- classify change semantic and operational impact
- compute affected obligations and certificates
- require separation-of-duty approvals
- compile incremental validation DAG
- block deployment until current evidence closes
...
- `elmos-proof-to-validation-dag-compiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-production-change-control-recertification-gate/profile.yaml`
- `artifacts/elmos-production-change-control-recertification-gate/plan.json`
- `artifacts/elmos-production-change-control-recertification-gate/result.json`
- `artifacts/elmos-production-change-control-recertification-gate/evidence/`
...
- **change mislabeled documentation-only** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **model alias change invisible** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **emergency change never reviewed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence reused outside scope** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **approver is change author** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify change semantic and operational impact
- native scenario: compute affected obligations and certificates
- native scenario: require separation-of-duty approvals
- native scenario: compile incremental validation DAG
- native scenario: block deployment until current evidence closes
