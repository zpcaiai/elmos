---
name: cloud-economics-orchestrator
description: "Implement Batch 49C FinOps、Sustainability、Capacity与Cloud Economics end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Cost Record、Commitment、Allocation、Budget、Unit Cost、Carbon Signal、Capacity、Waste、Optimization与Forecast."
---

# Cloud Economics Orchestrator

## Objective

Implement Batch 49C FinOps、Sustainability、Capacity与Cloud Economics end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Cost Record、Commitment、Allocation、Budget、Unit Cost、Carbon Signal、Capacity、Waste、Optimization与Forecast.
...
5. Write unresolved domain assumptions to `docs/implementation/cloud-economics-orchestrator-baseline.md`.
...
```text
cloud_economics_orchestrator_manifest.json
cloud_economics_orchestrator_state.json
cloud_economics_orchestrator_decision.json
cloud_economics_orchestrator_reconciliation.json
cloud_economics_orchestrator_evidence.json
```
