---
name: elmos-machine-verifiable-certificate-profile-compiler
description: Implement and independently certify machine-verifiable certificate profile compiler, including define canonical claims, scope, assurance statuses, limitations, evidence roots, issuer and validity, support deterministic JSON/CBOR representations and cryptographic signatures and publish schema, media type, versioning and verification algorithm.
version: 4.0.0
...
# Machine-Verifiable Certificate Profile Compiler

## Objective

Implement and independently certify machine-verifiable certificate profile compiler, including define canonical claims, scope, assurance statuses, limitations, evidence roots, issuer and validity, support deterministic JSON/CBOR representations and cryptographic signatures and publish schema, media type, versioning and verification algorithm.
...
- `MachineVerifiableCertificateProfileCompilerProfile`
- `MachineVerifiableCertificateProfileCompilerRun`
- `MachineVerifiableCertificateProfileCompilerFinding`
- `MachineVerifiableCertificateProfileCompilerDecision`
- `MachineVerifiableCertificateProfileCompilerEvidence`

Required semantic capabilities:

- define canonical claims, scope, assurance statuses, limitations, evidence roots, issuer and validity
- support deterministic JSON/CBOR representations and cryptographic signatures
- publish schema, media type, versioning and verification algorithm
...
- `artifacts/elmos-machine-verifiable-certificate-profile-compiler/profile.yaml`
- `artifacts/elmos-machine-verifiable-certificate-profile-compiler/plan.json`
- `artifacts/elmos-machine-verifiable-certificate-profile-compiler/result.json`
- `artifacts/elmos-machine-verifiable-certificate-profile-compiler/evidence/`
- `artifacts/elmos-machine-verifiable-certificate-profile-compiler/assurance-case.json`
...
- **human PDF and machine certificate disagree** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **optional field changes claim meaning** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unknown assurance status is accepted** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define canonical claims, scope, assurance statuses, limitations, evidence roots, issuer and validity
- native scenario: support deterministic JSON/CBOR representations and cryptographic signatures
- native scenario: publish schema, media type, versioning and verification algorithm
