...
metadata:
  ...
  source_path: "skills/09-online-code-reader/SKILL.md"
  source_sha256: "sha256:24fe40f689fddf0f10584116684dfebd5570cdfdaff195821ca46470c0003068"
  source_tree_sha256: "sha256:8d63b6f887be74fcfa8bb9b9dc77b2568c50644b619b517e0f4b4a202db9a9ad"
  ...
  runtime_handler_id: "read_revision_slice"
  capability_state: "PARTIAL"
  expected_success_code: "CODE_READER_SLICE_READY"
...
- This installed interface is pinned to `elmos-project-intelligence-skills` `1.1.0`, source `skills/09-online-code-reader/SKILL.md`, and `sha256:24fe40f689fddf0f10584116684dfebd5570cdfdaff195821ca46470c0003068`.
...
- Direct dependencies are `["elmos-repository-ingestion", "elmos-symbol-code-graph"]`. Preserve their direction and explicit unavailable states.
...
- This Skill is bound exactly to repository-owned handler `read_revision_slice` with bounded capability state `PARTIAL`, expected success code `CODE_READER_SLICE_READY`, and local result state `PARTIAL_LOCAL_EXECUTED`. Dispatch is allowlisted; no fallback or name-derived handler exists.
