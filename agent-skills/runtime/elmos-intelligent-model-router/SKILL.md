...
description: "Invoke the bounded repository handler for elmos-intelligent-model-router while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_key: "P06"
  source_name: "elmos-intelligent-model-router"
  installed_name: "elmos-intelligent-model-router"
  source_logical_path: "06-elmos-intelligent-model-router/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/06-elmos-intelligent-model-router/SKILL.md.source-data"
  source_materialized_path: "06-elmos-intelligent-model-router/SKILL.md.source-data"
  source_sha256: "sha256:b5f5662955a094f94cd122d0eb4522d01bd7c06319f359107248d640ccdefcd8"
...
- This is a deterministic repository wrapper for `06-elmos-intelligent-model-router/SKILL.md` at `sha256:b5f5662955a094f94cd122d0eb4522d01bd7c06319f359107248d640ccdefcd8`.
- Its immutable source/runtime identity is `elmos-intelligent-model-router`; its active installed identity is `elmos-intelligent-model-router`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-intelligent-model-router --request <file>
```
