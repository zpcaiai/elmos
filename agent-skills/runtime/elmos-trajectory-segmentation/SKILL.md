---
name: trajectory-segmentation
description: Use this skill when Elmos must perform trajectory segmentation as part of the 04-memory-experience-flywheel production
...
把长轨迹切分为规划、定位、修改、验证、修复和发布等可学习片段。
