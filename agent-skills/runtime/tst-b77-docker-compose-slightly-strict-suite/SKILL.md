---
name: tst-b77-docker-compose-slightly-strict-suite
description: "Run the slightly strict test suite for Batch 77: Dockerfile and Docker Compose, covering every source Skill with positive and negative executable cases."
metadata:
  id: TB77
...
---
    # TB77 — Batch 77 Dockerfile and Docker Compose 略严苛测试套件

    ## Objective

    对 Batch 77 的全部 12 个Source Skills执行可重放的正向、边界、负向、故障、安全和证据完整性验证。范围为：Dockerfile、Compose、Rootless、SBOM、多架构、运行时与供应链。
    ...
    |---|---|---|---|
    | PG363 | `b77-container-project-profile-detector` | detector | `B77-PG363-RUN, B77-PG363-NEG` |
| PG364 | `b77-dockerfile-multistage-generator` | container | `B77-PG364-RUN, B77-PG364-NEG` |
| PG365 | `b77-container-base-image-sbom-policy` | container | `B77-PG365-RUN, B77-PG365-NEG` |
| PG366 | `b77-rootless-container-hardening` | container | `B77-PG366-RUN, B77-PG366-NEG` |
| PG367 | `b77-docker-buildx-multiarch-generator` | container | `B77-PG367-RUN, B77-PG367-NEG` |
| PG368 | `b77-container-health-runtime-contract` | contract | `B77-PG368-RUN, B77-PG368-NEG` |
| PG369 | `b77-compose-service-topology-generator` | container | `B77-PG369-RUN, B77-PG369-NEG` |
| PG370 | `b77-compose-readiness-dependency-manager` | container | `B77-PG370-RUN, B77-PG370-NEG` |
| PG371 | `b77-compose-development-environment` | container | `B77-PG371-RUN, B77-PG371-NEG` |
| PG372 | `b77-compose-production-parity-gate` | container | `B77-PG372-RUN, B77-PG372-NEG` |
| PG373 | `b77-container-image-test-scan-gate` | container | `B77-PG373-RUN, B77-PG373-NEG` |
| PG374 | `b77-container-build-run-certifier` | container | `B77-PG374-RUN, B77-PG374-NEG` |
