---
name: runtime-certification-lab-and-evidence-factory
description: Move ELMOS from static package validation to build, runtime, integration,
  holdout, customer and production certification.
metadata:
  source_package: elmos-codex-skills-batch56a-product-closure
  source_id: CLO56A009
  source_batch: 56A
  source_maturity: reviewed-design
  source_sha256: sha256:578f773bc2c731f1efc2af9dc25a4dd285e1663eb7ccc703f2824106438bcf88
  normalized_namespace: product-closure
---

# Runtime Certification Lab & Evidence Factory

## Objective

Move ELMOS from static package validation to build, runtime, integration, holdout, customer and production certification.
...
1. Create golden repositories, databases and infrastructure.
2. Create independent holdout and adversarial corpora.
3. Provision isolated provider sandboxes.
4. Execute the slightly strict test suite against real implementations.
5. Bind evidence to exact artifact, data, environment and policy versions.
6. Invalidate stale evidence and publish the strongest valid status.

## Required Tests

- `notRunCannotBecomePass`
- `fabricatedEvidenceIsRejected`
- `staleEvidenceInvalidatesCertification`
- `holdoutCorpusIsIndependent`
...
```yaml
skill_id: CLO56A009
skill_name: runtime-certification-lab-and-evidence-factory
