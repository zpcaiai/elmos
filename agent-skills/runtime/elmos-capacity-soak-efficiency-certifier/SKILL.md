---
name: elmos-capacity-soak-efficiency-certifier
description: Certify sustained throughput, concurrency, queue stability, resource leaks, cache behavior, model/provider limits and unit economics at declared capacity.
version: 4.0.0
...
# Capacity, Soak and Efficiency Certifier
...
- Model representative arrival and service distributions
- Run load, stress and long-duration soak
- Detect memory/connection/thread/queue leaks
- Exercise rate limits and provider fallbacks
- Compute cost per successful certified unit
...
- `capacity-certificate.json`
- `soak-results.json`
- `resource-leak-report.json`
- `unit-economics-envelope.json`
...
- **load generator not representative** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **success metric ignores degraded answers** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **leak reset by restart** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cost excludes retries** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **capacity extrapolated beyond test** — must have a preventive control, a detective signal, a negative fixture and a response action.
