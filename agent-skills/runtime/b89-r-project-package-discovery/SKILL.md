---
name: b89-r-project-package-discovery
description: "Use when ELMOS must run r project package discovery for Batch 89 R / Quarto / Shiny / renv Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG319"
  source_name: "r-project-package-discovery"
  source_sha256: "sha256:0edeee637c726962d7c0aa36cb5a3719a43cde12096578946dc4a063ce9dd7ef"
  batch: 89
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 89 Language Pack / source PG319 — R Project Package Discovery

## 1. Objective

Discover and inventory r project package discovery within the R / Quarto / Shiny / renv Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for R Project Package Discovery using the approved data-science semantic contracts and toolchain versions.
...
- A representative valid r-data-science input produces all declared outputs for r-project-package-discovery.
