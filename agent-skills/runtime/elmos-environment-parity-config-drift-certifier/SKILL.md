---
name: elmos-environment-parity-config-drift-certifier
description: Compare development, test, certification and production environments across images, flags, policies, dependencies, data features and managed-service parameters.
version: 4.0.0
...
# Environment Parity and Configuration Drift Certifier
...
- Collect immutable environment snapshots
- Classify material and non-material differences
- Verify feature flag and secret references
- Compare managed service parameters and extensions
- Invalidate certification for material drift
...
- `environment-parity-report.json`
- `configuration-drift-map.json`
- `parity-exceptions.json`
- `environment-recertification-plan.json`
...
- **hidden manual production change** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **secret values copied into report** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **non-material label masks real difference** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **managed provider default changes** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **drift scanner lacks permission** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- test/prod image parity
- database parameter parity
- feature flag parity
- network policy parity
- approved exception
- material drift blocks promotion
