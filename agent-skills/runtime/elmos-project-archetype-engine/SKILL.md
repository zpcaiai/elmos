---
name: "elmos-project-archetype-engine"
description: "Invoke the bounded repository handler for elmos-project-archetype-engine while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P03:project-archetype-engine"
  source_name: "elmos-project-archetype-engine"
  installed_name: "elmos-project-archetype-engine"
  source_logical_path: "03-elmos-project-generation-transformation-engine/skills/project-archetype-engine/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/03-elmos-project-generation-transformation-engine/skills/project-archetype-engine/SKILL.md.source-data"
  source_materialized_path: "03-elmos-project-generation-transformation-engine/skills/project-archetype-engine/SKILL.md.source-data"
  source_sha256: "sha256:322fb55928d43d38f23ce22209a91982cc6fe879fab5fbe9ccd52dad3598b4d3"
...
# elmos-project-archetype-engine
...
- This is a deterministic repository wrapper for `03-elmos-project-generation-transformation-engine/skills/project-archetype-engine/SKILL.md` at `sha256:322fb55928d43d38f23ce22209a91982cc6fe879fab5fbe9ccd52dad3598b4d3`.
- Its immutable source/runtime identity is `elmos-project-archetype-engine`; its active installed identity is `elmos-project-archetype-engine`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-project-archetype-engine --request <file>
```
