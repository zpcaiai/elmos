---
name: elmos-target-pi-package-generator
description: Generate complete Pi packages containing extensions, custom tools, skills, prompt templates, themes, repository
  conventions, RPC/SDK embedding and load tests.
version: 4.0.0
...
- Generate package.json and Pi package layout
- Generate extensions, tools and slash commands
- Generate Skills, prompts and themes
- Generate RPC/SDK embedding modes
- Run package load, session and permission tests
...
- **extension code execution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tool authority amplification** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **session data leak** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **malicious package dependency** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **prompt template injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
