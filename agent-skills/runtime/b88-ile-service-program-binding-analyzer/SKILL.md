---
name: b88-ile-service-program-binding-analyzer
description: "Use when ELMOS must run ile service program binding analyzer for Batch 88 IBM i RPG / CL / DDS / DB2 for i Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG312"
  source_name: "ile-service-program-binding-analyzer"
  source_sha256: "sha256:7918ef156f7c0e2a9e1832d90bd39c621bdaac3ee8066a5654f646c9683ae0ad"
  batch: 88
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 88 Language Pack / source PG312 — Ile Service Program Binding Analyzer

## 1. Objective

Analyze ile service program binding analyzer within the IBM i RPG / CL / DDS / DB2 for i Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Ile Service Program Binding Analyzer using the approved enterprise-ibmi semantic contracts and toolchain versions.
...
- A representative valid ibmi-rpg input produces all declared outputs for ile-service-program-binding-analyzer.
