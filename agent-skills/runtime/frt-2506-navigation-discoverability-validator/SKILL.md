...
description: "Run FRT-2506 Navigation Discoverability Validator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2506"
  source_name: "frt-2506-navigation-discoverability-validator"
  source_sha256: "sha256:1ec9564cc24e22d81a684ef0e0f2adcee4889be29b2c27aa92377d40a1fbc976"
  batch: "G25"
...
- Runtime catalog key: `FRT-2506` / `frt-2506-navigation-discoverability-validator`.
...
在G25范围内实现 **Navigation Discoverability Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Navigation Discoverability Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2506Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2506EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2506FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2506CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2506-navigation-discoverability-validator/
packages/runtime/g25/frt-2506-navigation-discoverability-validator/
services/control-plane/g25/frt-2506-navigation-discoverability-validator/
apps/web-console/src/features/g25/frt-2506-navigation-discoverability-validator/
apps/admin-console/src/features/g25/frt-2506-navigation-discoverability-validator/
tests/g25/frt-2506-navigation-discoverability-validator/
```
...
```text
POST /v1/skills/frt-2506/runs
GET  /v1/skills/frt-2506/runs/{run_id}
POST /v1/skills/frt-2506/runs/{run_id}/verify
GET  /v1/skills/frt-2506/runs/{run_id}/findings
GET  /v1/skills/frt-2506/runs/{run_id}/evidence
```
