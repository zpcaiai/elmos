---
name: b76-nginx-tls-security-rate-limit
description: "Use when ELMOS must implement and validate Nginx TLS Security Rate Limit for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Nginx TLS Security Rate Limit, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG361
  batch: 76
  version: 1.0.0
...
# PG361 — Nginx TLS Security Rate Limit

## Objective

Implement and validate Nginx TLS Security Rate Limit for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `nginx-tls-security-rate-limit` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`, `PG360`.
...
- `nginx_tls_security_rate_limit_plan.json`
- `nginx_tls_security_rate_limit_artifacts/`
- `nginx_tls_security_rate_limit_verification.json`
