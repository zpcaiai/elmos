...
description: "Run FRT-1302 Vue 3 to Vue 2 Route Pack for FRT G13 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1302"
  source_name: "frt-1302-vue-3-to-vue-2-route-pack"
  source_sha256: "sha256:1aaa6b471cd034889988d96737305de3f840107c36393ddd8ecded52e3e8f25d"
  batch: "G13"
...
- Runtime catalog key: `FRT-1302` / `frt-1302-vue-3-to-vue-2-route-pack`.
...
# FRT-1302 — Vue 3 to Vue 2 Route Pack

## Objective

在G13范围内实现 **Vue 3 to Vue 2 Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：六个方向独立声明版本、能力和Known Differences; 处理Options/Composition/Hooks、Router、Store、SFC/JSX差异; 建立直接路径与三角间接路径差分验证。

## When to Use

- 实现或修改与 **Vue 3 to Vue 2 Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1302Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1302EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1302FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1302CertificateFragment`：供G13批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g13/frt-1302-vue-3-to-vue-2-route-pack/
packages/runtime/g13/frt-1302-vue-3-to-vue-2-route-pack/
services/control-plane/g13/frt-1302-vue-3-to-vue-2-route-pack/
apps/web-console/src/features/g13/frt-1302-vue-3-to-vue-2-route-pack/
apps/admin-console/src/features/g13/frt-1302-vue-3-to-vue-2-route-pack/
tests/g13/frt-1302-vue-3-to-vue-2-route-pack/
```
...
```text
POST /v1/skills/frt-1302/runs
GET  /v1/skills/frt-1302/runs/{run_id}
POST /v1/skills/frt-1302/runs/{run_id}/verify
GET  /v1/skills/frt-1302/runs/{run_id}/findings
GET  /v1/skills/frt-1302/runs/{run_id}/evidence
```
