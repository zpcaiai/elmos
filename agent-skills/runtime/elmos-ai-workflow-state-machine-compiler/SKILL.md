---
name: elmos-ai-workflow-state-machine-compiler
description: Compile nodes, edges, branches, loops, joins, interrupts, approvals, retries, compensation, checkpointing and
  liveness constraints into a durable workflow IR.
version: 4.0.0
...
# AIWorkflowStateMachineCompiler
...
- `workflow-ir.json`
- `state-schema.json`
- `liveness-obligations.json`
- `side-effect-ordering.json`
...
- AiWorkflowStateMachineCompiler representative end-to-end fixture
