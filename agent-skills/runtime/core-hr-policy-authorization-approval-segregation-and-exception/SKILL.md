---
name: core-hr-policy-authorization-approval-segregation-and-exception
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle policy controls, authorization, approvals, segregation of duties, delegations, exceptions and expiry, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle policy controls, authorization, approvals, segregation of duties, delegations, exceptions and expiry, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-policy-authorization-approval-segregation-and-exception-baseline.md`.
...
```text
core_hr_policy_authorization_approval_segregation_and_exception_manifest.json
core_hr_policy_authorization_approval_segregation_and_exception_state.json
core_hr_policy_authorization_approval_segregation_and_exception_decision.json
core_hr_policy_authorization_approval_segregation_and_exception_reconciliation.json
core_hr_policy_authorization_approval_segregation_and_exception_evidence.json
```
