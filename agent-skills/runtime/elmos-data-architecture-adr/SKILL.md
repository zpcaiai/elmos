...
- Source group: `database-intelligence`. Dependencies: `["elmos-polyglot-persistence-planner"]`. Triggers: `["完成技术选型", "架构评审", "建立不可变生成基线"]`. Declared outputs: `["ADR-data-architecture.md", "decision-ledger.json", "architecture-baseline.json"]`.
