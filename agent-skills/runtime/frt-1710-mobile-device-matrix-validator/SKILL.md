...
description: "Run FRT-1710 Mobile Device Matrix Validator for FRT G17 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1710"
  source_name: "frt-1710-mobile-device-matrix-validator"
  source_sha256: "sha256:963c9327bf812c65a13798f10f486d20cc4489214a0e81c4ceccb99da5c15fd6"
  batch: "G17"
...
- Runtime catalog key: `FRT-1710` / `frt-1710-mobile-device-matrix-validator`.
...
# FRT-1710 — Mobile Device Matrix Validator

## Objective

在G17范围内实现 **Mobile Device Matrix Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：补齐小程序/ArkUI/Flutter六个方向; 统一移动Navigation、Lifecycle、Permission、Storage和Native能力; 验证直接与间接三角路径。

## When to Use

- 实现或修改与 **Mobile Device Matrix Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1710Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1710EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1710FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1710CertificateFragment`：供G17批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g17/frt-1710-mobile-device-matrix-validator/
packages/runtime/g17/frt-1710-mobile-device-matrix-validator/
services/control-plane/g17/frt-1710-mobile-device-matrix-validator/
apps/web-console/src/features/g17/frt-1710-mobile-device-matrix-validator/
apps/admin-console/src/features/g17/frt-1710-mobile-device-matrix-validator/
tests/g17/frt-1710-mobile-device-matrix-validator/
```
...
```text
POST /v1/skills/frt-1710/runs
GET  /v1/skills/frt-1710/runs/{run_id}
POST /v1/skills/frt-1710/runs/{run_id}/verify
GET  /v1/skills/frt-1710/runs/{run_id}/findings
GET  /v1/skills/frt-1710/runs/{run_id}/evidence
```
