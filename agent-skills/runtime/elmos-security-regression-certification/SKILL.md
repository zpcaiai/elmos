---
name: security-regression-certification
description: Use this skill when Elmos must perform security regression certification as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# security-regression-certification

## 能力目标

验证权限不扩大、输入处理、依赖、秘密、注入和供应链安全。
