---
name: elmos-genai-telemetry-profile-compiler
description: Compile versioned OpenTelemetry/OpenInference-compatible GenAI traces, metrics and logs with privacy, cardinality,
  sampling, cost and evidence-binding rules.
version: 4.0.0
...
# GenAI Telemetry Profile Compiler
...
- `DeploymentUnit`
- `ConformanceRun`
- `GenAITelemetryProfileCompilerRun`
- `GenAITelemetryProfileCompilerDecision`

Required semantic capabilities:

- Versioned semantic convention profile
- Trace/model/tool/retrieval correlation
- PII and secret redaction
- Cardinality and sampling budgets
- Cost, evidence and tenant binding
...
- `semantic-convention-lock.json`
- `redaction-policy.rego`
- `telemetry-conformance.json`
...
- **secret leakage in spans** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tenant trace bleed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cardinality DoS** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **untrusted attribute injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sample bias** — must have a preventive control, a detective signal, a negative fixture and a response action.
