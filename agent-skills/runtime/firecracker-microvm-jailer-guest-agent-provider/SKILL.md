---
name: firecracker-microvm-jailer-guest-agent-provider
description: "Implement Firecracker microVM isolation with Jailer, trusted jail roots, guest artifacts, vsock agent, networking, resources, recovery, and cleanup."
---
...
Implement Firecracker microVM isolation with Jailer, trusted jail roots, guest artifacts, vsock agent, networking, resources, recovery, and cleanup.
...
4. Record unresolved provider/version assumptions in `docs/implementation/firecracker-microvm-jailer-guest-agent-provider-baseline.md`.
...
```text
firecracker_microvm_jailer_guest_agent_provider_manifest.json
firecracker_microvm_jailer_guest_agent_provider_decision.json
firecracker_microvm_jailer_guest_agent_provider_evidence.json
```
