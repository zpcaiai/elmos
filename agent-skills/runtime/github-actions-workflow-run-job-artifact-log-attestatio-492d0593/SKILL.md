---
name: github-actions-workflow-run-job-artifact-log-attestatio-492d0593
description: 接入 Workflow/Run/Attempt/Job/Artifact/Log、Reusable Workflow、OIDC与GitHub Artifact Attestation。
metadata:
  elmos_batch: "37B"
  elmos_skill_id: "EVI37B004"
  pack_version: "3.7-complete"
---

# EVI37B004 — GitHub Actions Workflow、Artifact、Attestation 与 OIDC Connector

## Objective

接入 Workflow/Run/Attempt/Job/Artifact/Log、Reusable Workflow、OIDC与GitHub Artifact Attestation。
...
- 使用明确 API Version 和 GitHub App 最小权限。
- Run Attempt 是稳定身份的一部分，Matrix Jobs 与 Reusable Workflow Lineage 保留。
- 下载 Logs/Artifacts 后安全处理并独立 Hash。
- 验证 OIDC Issuer/Repository/Workflow/Ref/Environment 和 Attestation Subject/Signer/Bundle。
...
- runAttemptIsPartOfStableIdentity
- matrixJobsRemainDistinct
- oidcWrongWorkflowIsRejected
- githubAttestationDoesNotDirectlyCreateElmosPass
