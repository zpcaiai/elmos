...
description: "Run FRT-2613 Environment Parity Validator for FRT G26 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2613"
  source_name: "frt-2613-environment-parity-validator"
  source_sha256: "sha256:9a76793ac296e276bcb75b9b8b58c74f6bffb616d8b6709b83df3fcaca8e92b9"
  batch: "G26"
...
- Runtime catalog key: `FRT-2613` / `frt-2613-environment-parity-validator`.
...
在G26范围内实现 **Environment Parity Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Requirement/Acceptance/State Machine派生Test Obligation; Unit/Component/Contract/Integration/Journey分层协调; Differential、Mutation、Visual/Semantic、Security和Performance Regression。

## When to Use

- 实现或修改与 **Environment Parity Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2613Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2613EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2613FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2613CertificateFragment`：供G26批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g26/frt-2613-environment-parity-validator/
packages/runtime/g26/frt-2613-environment-parity-validator/
services/control-plane/g26/frt-2613-environment-parity-validator/
apps/web-console/src/features/g26/frt-2613-environment-parity-validator/
apps/admin-console/src/features/g26/frt-2613-environment-parity-validator/
tests/g26/frt-2613-environment-parity-validator/
```
...
```text
POST /v1/skills/frt-2613/runs
GET  /v1/skills/frt-2613/runs/{run_id}
POST /v1/skills/frt-2613/runs/{run_id}/verify
GET  /v1/skills/frt-2613/runs/{run_id}/findings
GET  /v1/skills/frt-2613/runs/{run_id}/evidence
```
