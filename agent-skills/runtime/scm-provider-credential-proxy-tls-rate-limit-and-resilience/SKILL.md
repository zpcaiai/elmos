---
name: scm-provider-credential-proxy-tls-rate-limit-and-resilience
description: "Implement shared credential leases, proxy/TLS profiles, custom CAs, DNS, redirects, rate budgets, retries, provider health, and fail-closed behaviour."
---
...
Implement shared credential leases, proxy/TLS profiles, custom CAs, DNS, redirects, rate budgets, retries, provider health, and fail-closed behaviour.
...
4. Record unresolved provider/version assumptions in `docs/implementation/scm-provider-credential-proxy-tls-rate-limit-and-resilience-baseline.md`.
...
```text
scm_provider_credential_proxy_tls_rate_limit_and_resilience_manifest.json
scm_provider_credential_proxy_tls_rate_limit_and_resilience_decision.json
scm_provider_credential_proxy_tls_rate_limit_and_resilience_evidence.json
```
