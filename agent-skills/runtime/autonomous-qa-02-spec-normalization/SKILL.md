---
name: "autonomous-qa-02-spec-normalization"
description: "Run 02-spec-normalization through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "02-spec-normalization"
  source_sha256: "sha256:bc67bdc2a1b35b33fad848b394e7853d039a95a514351f685798981871763c1f"
  source_dependencies: "01-project-context-ingestion"
  ...
  runtime_skill_key: "02-spec-normalization"
  runtime_handler: "execute_02_spec_normalization"
  runtime_phase: "context"
  runtime_mutating: "false"
  runtime_operation: "elmos_autonomous_qa.context_skills.normalize_specification"
...
1. Accept only a structured request for the exact Skill key `02-spec-normalization`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_02_spec_normalization` and operation `elmos_autonomous_qa.context_skills.normalize_specification`.
...
- Immutable source: `skills/02-spec-normalization/SKILL.md` at `sha256:bc67bdc2a1b35b33fad848b394e7853d039a95a514351f685798981871763c1f`.
