---
name: safety-regulatory-boundary-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Safety and Regulatory Boundary Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T114"
  source_name: "safety-regulatory-boundary-gate"
  source_sha256: "sha256:5d58a750eec1eab6a4185d53c5a3f930fa550b32c4f8237206ccf1e2eeab4945"
...
# T114 — Safety and Regulatory Boundary Gate

## 1. Objective

Block unsupported safety, clinical, financial, privacy or regulated claims without independent approval.
...
- `CASE-0571` [HIGH] Safety and Regulatory Boundary Gate: Representative path
- `CASE-0572` [HIGH] Safety and Regulatory Boundary Gate: Boundary path
- `CASE-0573` [HIGH] Safety and Regulatory Boundary Gate: Invalid or hostile input
- `CASE-0574` [HIGH] Safety and Regulatory Boundary Gate: Injected dependency failure
- `CASE-0575` [CRITICAL] Safety and Regulatory Boundary Gate: Security or safety violation
- `CASE-0576` [HIGH] Safety and Regulatory Boundary Gate: Replay and idempotency
- `CASE-0577` [HIGH] Safety and Regulatory Boundary Gate: Version or environment drift
- `CASE-0578` [MEDIUM] Safety and Regulatory Boundary Gate: Moderate scale
- `CASE-0579` [CRITICAL] Safety and Regulatory Boundary Gate: Evidence tamper
- `CASE-0580` [HIGH] Safety and Regulatory Boundary Gate: Recovery and final evidence
