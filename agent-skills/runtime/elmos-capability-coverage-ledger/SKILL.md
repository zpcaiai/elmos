...
description: "Invoke the bounded repository handler for elmos-capability-coverage-ledger while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P05:capability-coverage-ledger"
  source_name: "elmos-capability-coverage-ledger"
  installed_name: "elmos-capability-coverage-ledger"
  source_logical_path: "05-elmos-conversion-reliability-verification-harness/skills/capability-coverage-ledger/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/05-elmos-conversion-reliability-verification-harness/skills/capability-coverage-ledger/SKILL.md.source-data"
  source_materialized_path: "05-elmos-conversion-reliability-verification-harness/skills/capability-coverage-ledger/SKILL.md.source-data"
  source_sha256: "sha256:65b39d93b7c290c6621b5840aed82af5ff24f193769da9c8d5bfb8b0ef40822c"
...
# elmos-capability-coverage-ledger
...
- This is a deterministic repository wrapper for `05-elmos-conversion-reliability-verification-harness/skills/capability-coverage-ledger/SKILL.md` at `sha256:65b39d93b7c290c6621b5840aed82af5ff24f193769da9c8d5bfb8b0ef40822c`.
- Its immutable source/runtime identity is `elmos-capability-coverage-ledger`; its active installed identity is `elmos-capability-coverage-ledger`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-capability-coverage-ledger --request <file>
```
