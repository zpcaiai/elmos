...
description: "Run FRT-2516 Feature Availability and Unsupported-State UX for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2516"
  source_name: "frt-2516-feature-availability-and-unsupported-state-ux"
  source_sha256: "sha256:ea56ac8d91f66a1bd77d9f96f13c7a59cc21309f19f3da44b48bbd08a236adf3"
  batch: "G25"
...
- Runtime catalog key: `FRT-2516` / `frt-2516-feature-availability-and-unsupported-state-ux`.
...
在G25范围内实现 **Feature Availability and Unsupported-State UX**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Feature Availability and Unsupported-State UX** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2516Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2516EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2516FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2516CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2516-feature-availability-and-unsupported-state-ux/
packages/runtime/g25/frt-2516-feature-availability-and-unsupported-state-ux/
services/control-plane/g25/frt-2516-feature-availability-and-unsupported-state-ux/
apps/web-console/src/features/g25/frt-2516-feature-availability-and-unsupported-state-ux/
apps/admin-console/src/features/g25/frt-2516-feature-availability-and-unsupported-state-ux/
tests/g25/frt-2516-feature-availability-and-unsupported-state-ux/
```
...
```text
POST /v1/skills/frt-2516/runs
GET  /v1/skills/frt-2516/runs/{run_id}
POST /v1/skills/frt-2516/runs/{run_id}/verify
GET  /v1/skills/frt-2516/runs/{run_id}/findings
GET  /v1/skills/frt-2516/runs/{run_id}/evidence
```
