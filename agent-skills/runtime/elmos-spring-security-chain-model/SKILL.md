---
name: "elmos-spring-security-chain-model"
description: "把 Filter、Interceptor、Spring Security、CSRF、方法鉴权和错误 dispatch 建模为安全状态机，证明不存在绕过。 Use when the task needs the exact Spring Security Chain Model Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-spring-security-chain-model/SKILL.md"
  source_sha256: "sha256:f9379b735e81724a63c44a92681d12ec84307f3452c51c44a6ab6b9184a96680"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "spring-modernization"
  runtime_handler_id: "execute_elmos_spring_security_chain_model"
...
---
# Spring Security Chain Model

## Repository integration boundary

- Exact Skill identity: `elmos-spring-security-chain-model`; exact allowlisted runtime handler: `execute_elmos_spring_security_chain_model`.
- Source identity: `skills/P0/elmos-spring-security-chain-model/SKILL.md` at `sha256:f9379b735e81724a63c44a92681d12ec84307f3452c51c44a6ab6b9184a96680` from `elmos-formal-assurance-kernel-v1.0.0`.
...
把 Filter、Interceptor、Spring Security、CSRF、方法鉴权和错误 dispatch 建模为安全状态机，证明不存在绕过。
...
3. Use the repository-owned `execute_elmos_spring_security_chain_model` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["state-machine reachability","authorization dominance","noninterference","TLA+/Alloy checking"]`
- Direct dependencies: `["elmos-formal-spec-ir","elmos-proof-obligation-planner","elmos-verifier-portfolio-router"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-spring-security-chain-model/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
