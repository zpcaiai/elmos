---
name: elmos-ai-adversarial-robustness-evasion-poisoning-certifier
description: Implement and independently certify adversarial robustness, evasion and poisoning certifier, including map attacker goals, knowledge, capability and lifecycle stage to test campaigns, evaluate evasion, poisoning, privacy and generative misuse defenses and measure adaptive attack success and residual risk rather than static checklist compliance.
version: 4.0.0
...
# Adversarial Robustness, Evasion and Poisoning Certifier
...
- **Kernel authorities used:** K1, K2, K4, K6, K7, K8
...
- `AdversarialRobustnessEvasionAndPoisoningCertifierProfile`
- `AdversarialRobustnessEvasionAndPoisoningCertifierRun`
- `AdversarialRobustnessEvasionAndPoisoningCertifierFinding`
- `AdversarialRobustnessEvasionAndPoisoningCertifierDecision`
- `AdversarialRobustnessEvasionAndPoisoningCertifierEvidence`

Required semantic capabilities:

- map attacker goals, knowledge, capability and lifecycle stage to test campaigns
- evaluate evasion, poisoning, privacy and generative misuse defenses
- measure adaptive attack success and residual risk rather than static checklist compliance
...
- `elmos-ai-distribution-shift-ood-robustness-certifier`

### External Package Dependencies

- `elmos-adversarial-model-tool-memory-redteam-orchestrator` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-ai-adversarial-robustness-evasion-poisoning-certifier/profile.yaml`
- `artifacts/elmos-ai-adversarial-robustness-evasion-poisoning-certifier/plan.json`
- `artifacts/elmos-ai-adversarial-robustness-evasion-poisoning-certifier/result.json`
- `artifacts/elmos-ai-adversarial-robustness-evasion-poisoning-certifier/evidence/`
- `artifacts/elmos-ai-adversarial-robustness-evasion-poisoning-certifier/assurance-case.json`
...
- **non-adaptive red team understates attack success** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **defense evaluation leaks detection logic** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **poisoning persists in memory after cleanup** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: map attacker goals, knowledge, capability and lifecycle stage to test campaigns
- native scenario: evaluate evasion, poisoning, privacy and generative misuse defenses
- native scenario: measure adaptive attack success and residual risk rather than static checklist compliance
