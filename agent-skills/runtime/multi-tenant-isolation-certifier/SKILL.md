---
name: multi-tenant-isolation-certifier
description: "Repository-owned bounded wrapper for multi-tenant-isolation-certifier; external evidence remains NOT_RUN."
---
...
Continuously verify tenant separation across execution, cache, artifacts, secrets, logs, traces and storage boundaries.
...
4. Submit `multi-tenant-isolation-certifier` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `ee762bb8fe8b96a4fce287f751d9686d5e4629a8b1f5209436d0425360581582`
