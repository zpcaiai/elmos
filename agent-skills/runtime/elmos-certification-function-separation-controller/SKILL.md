---
name: elmos-certification-function-separation-controller
description: Implement and independently certify certification function separation controller, including map selection, evaluation, review, decision, attestation, surveillance and appeal functions to independent identities, enforce no-self-review and no-consultancy conflict rules and verify authorization and segregation of duties at every gate.
version: 4.0.0
...
# Certification Function Separation Controller

## Objective

Implement and independently certify certification function separation controller, including map selection, evaluation, review, decision, attestation, surveillance and appeal functions to independent identities, enforce no-self-review and no-consultancy conflict rules and verify authorization and segregation of duties at every gate.
...
- `CertificationFunctionSeparationControllerProfile`
- `CertificationFunctionSeparationControllerRun`
- `CertificationFunctionSeparationControllerFinding`
- `CertificationFunctionSeparationControllerDecision`
- `CertificationFunctionSeparationControllerEvidence`

Required semantic capabilities:

- map selection, evaluation, review, decision, attestation, surveillance and appeal functions to independent identities
- enforce no-self-review and no-consultancy conflict rules
- verify authorization and segregation of duties at every gate
...
- `artifacts/elmos-certification-function-separation-controller/profile.yaml`
- `artifacts/elmos-certification-function-separation-controller/plan.json`
- `artifacts/elmos-certification-function-separation-controller/result.json`
- `artifacts/elmos-certification-function-separation-controller/evidence/`
- `artifacts/elmos-certification-function-separation-controller/assurance-case.json`
...
- **same agent creates and approves decisive evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **consulting activity compromises certification impartiality** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **emergency override becomes permanent authority** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: map selection, evaluation, review, decision, attestation, surveillance and appeal functions to independent identities
- native scenario: enforce no-self-review and no-consultancy conflict rules
- native scenario: verify authorization and segregation of duties at every gate
