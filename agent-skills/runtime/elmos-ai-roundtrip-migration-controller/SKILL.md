---
name: elmos-ai-roundtrip-migration-controller
description: Control import→AI-SIR→target→re-import round trips and cross-ecosystem migrations while making information loss
  and manual preservation points explicit.
version: 4.0.0
...
# AIRoundtripMigrationController
...
- **Kernel authorities used:** K3, K5, K6, K8
...
- duplicate delivery
- pause resume cancel
- AiRoundtripMigrationController representative end-to-end fixture
