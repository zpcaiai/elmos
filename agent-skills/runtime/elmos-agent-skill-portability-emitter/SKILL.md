...
description: Lower Skill IR into Agent Skills, Codex, Claude Code, Pi, OpenClaw, Gemini CLI, Continue and OpenCode packages
  while preserving semantics and recording every host-specific gap.
version: 4.0.0
...
# Agent Skill Portability Emitter
...
- `DeploymentUnit`
- `ConformanceRun`
- `AgentSkillPortabilityEmitterRun`
- `AgentSkillPortabilityEmitterDecision`

Required semantic capabilities:

- Host profile negotiation
- Deterministic frontmatter and resource emission
- Tool and sandbox policy lowering
- Trigger adaptation without semantic widening
- Cross-host normalized trace comparison
...
- `portable-skill-targets/`
- `host-capability-diff.json`
- `portability-report.json`
- `host-conformance-evidence/`
...
- **silent semantic loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **trigger widening** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **authority amplification** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **host-specific path injection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unreviewed script execution** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- Agent Skills emission
- Codex and Claude load tests
- Pi/OpenClaw package tests
- unsupported host feature block
