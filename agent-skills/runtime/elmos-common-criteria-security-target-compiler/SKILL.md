...
# Common Criteria Security Target Compiler
...
- `CommonCriteriaSecurityTargetCompilerProfile`
- `CommonCriteriaSecurityTargetCompilerRun`
- `CommonCriteriaSecurityTargetCompilerFinding`
- `CommonCriteriaSecurityTargetCompilerDecision`
- `CommonCriteriaSecurityTargetCompilerEvidence`

Required semantic capabilities:

- define target of evaluation, boundary, environment, assets, threats, objectives and security requirements
- map Elmos controls and evidence to functional and assurance components
- maintain rationale, dependencies and exact evaluated configuration
...
- `artifacts/elmos-common-criteria-security-target-compiler/profile.yaml`
- `artifacts/elmos-common-criteria-security-target-compiler/plan.json`
- `artifacts/elmos-common-criteria-security-target-compiler/result.json`
- `artifacts/elmos-common-criteria-security-target-compiler/evidence/`
- `artifacts/elmos-common-criteria-security-target-compiler/assurance-case.json`
...
- **TOE boundary excludes privileged service** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **security objective has no requirement coverage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evaluated configuration differs from deployed system** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define target of evaluation, boundary, environment, assets, threats, objectives and security requirements
- native scenario: map Elmos controls and evidence to functional and assurance components
- native scenario: maintain rationale, dependencies and exact evaluated configuration
