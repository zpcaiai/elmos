---
name: elmos-ai-uncertainty-calibration-selective-prediction-verifier
description: Implement and independently certify uncertainty calibration and selective prediction verifier, including measure probability calibration, confidence reliability and abstention quality, verify risk-coverage curves and decision-aware thresholds and detect overconfidence under shift and adversarial inputs.
version: 4.0.0
...
# Uncertainty Calibration and Selective Prediction Verifier
...
- `UncertaintyCalibrationAndSelectivePredictionVerifierProfile`
- `UncertaintyCalibrationAndSelectivePredictionVerifierRun`
- `UncertaintyCalibrationAndSelectivePredictionVerifierFinding`
- `UncertaintyCalibrationAndSelectivePredictionVerifierDecision`
- `UncertaintyCalibrationAndSelectivePredictionVerifierEvidence`

Required semantic capabilities:

- measure probability calibration, confidence reliability and abstention quality
- verify risk-coverage curves and decision-aware thresholds
- detect overconfidence under shift and adversarial inputs
...
- `elmos-ai-judge-calibration-stochastic-assurance` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-ai-uncertainty-calibration-selective-prediction-verifier/profile.yaml`
- `artifacts/elmos-ai-uncertainty-calibration-selective-prediction-verifier/plan.json`
- `artifacts/elmos-ai-uncertainty-calibration-selective-prediction-verifier/result.json`
- `artifacts/elmos-ai-uncertainty-calibration-selective-prediction-verifier/evidence/`
- `artifacts/elmos-ai-uncertainty-calibration-selective-prediction-verifier/assurance-case.json`
...
- **confidence score is not a probability** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **abstention transfers harm to user without workflow** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **calibration holds only on in-distribution data** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: measure probability calibration, confidence reliability and abstention quality
- native scenario: verify risk-coverage curves and decision-aware thresholds
- native scenario: detect overconfidence under shift and adversarial inputs
