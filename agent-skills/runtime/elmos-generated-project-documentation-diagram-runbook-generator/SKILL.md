---
name: elmos-generated-project-documentation-diagram-runbook-generator
description: Generate evidence-linked architecture, API, data flow, threat, deployment, operations and recovery documentation that updates incrementally.
version: 4.0.0
...
# Generated Project Documentation, Diagram and Runbook Generator

## Objective

Generate evidence-linked architecture, API, data flow, threat, deployment, operations and recovery documentation that updates incrementally.
...
- **Kernel authorities used:** K1, K2, K3, K5, K6
...
- `GeneratedProjectDocumentationDiagramAndRunbookGeneratorProfile`
- `GeneratedProjectDocumentationDiagramAndRunbookGeneratorPlan`
- `GeneratedProjectDocumentationDiagramAndRunbookGeneratorRun`
- `GeneratedProjectDocumentationDiagramAndRunbookGeneratorDecision`

Required semantic capabilities:

- derive docs from canonical IR and evidence
- generate architecture/data/sequence diagrams
- produce operator, recovery and upgrade runbooks
- preserve authored regions across regeneration
- validate links, versions and offline bundle
...
- `elmos-enterprise-assurance-dossier-generator` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `artifacts/elmos-generated-project-documentation-diagram-runbook-generator/profile.yaml`
- `artifacts/elmos-generated-project-documentation-diagram-runbook-generator/plan.json`
- `artifacts/elmos-generated-project-documentation-diagram-runbook-generator/result.json`
- `artifacts/elmos-generated-project-documentation-diagram-runbook-generator/evidence/`
...
- **diagram reflects intended not actual system** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **runbook command unsafe** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **generated docs overwrite human note** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive topology overexposed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **documentation pass treated as implementation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: derive docs from canonical IR and evidence
- native scenario: generate architecture/data/sequence diagrams
- native scenario: produce operator, recovery and upgrade runbooks
- native scenario: preserve authored regions across regeneration
- native scenario: validate links, versions and offline bundle
