---
name: core-hr-automation-copilot-recommendation-and-human-review
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-automation-copilot-recommendation-and-human-review-baseline.md`.
...
```text
core_hr_automation_copilot_recommendation_and_human_review_manifest.json
core_hr_automation_copilot_recommendation_and_human_review_state.json
core_hr_automation_copilot_recommendation_and_human_review_decision.json
core_hr_automation_copilot_recommendation_and_human_review_reconciliation.json
core_hr_automation_copilot_recommendation_and_human_review_evidence.json
```
