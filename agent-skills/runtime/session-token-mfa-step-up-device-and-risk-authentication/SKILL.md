---
name: session-token-mfa-step-up-device-and-risk-authentication
description: "Implement sessions, tokens, MFA, step-up authentication, assurance levels, device/risk context, revocation, renewal, and replay protection."
---
...
Implement sessions, tokens, MFA, step-up authentication, assurance levels, device/risk context, revocation, renewal, and replay protection.
...
4. Record unresolved provider/version assumptions in `docs/implementation/session-token-mfa-step-up-device-and-risk-authentication-baseline.md`.
...
```text
session_token_mfa_step_up_device_and_risk_authentication_manifest.json
session_token_mfa_step_up_device_and_risk_authentication_decision.json
session_token_mfa_step_up_device_and_risk_authentication_evidence.json
```
