---
name: content-knowledge-orchestrator
description: "Implement Batch 54B Enterprise Content、Records、Knowledge与Publishing end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Document、Content Type、Version、Record、Taxonomy、Knowledge Article、Search Index、Publication、Retention与Access."
---

# Content Knowledge Orchestrator

## Objective

Implement Batch 54B Enterprise Content、Records、Knowledge与Publishing end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Document、Content Type、Version、Record、Taxonomy、Knowledge Article、Search Index、Publication、Retention与Access.
...
5. Write unresolved domain assumptions to `docs/implementation/content-knowledge-orchestrator-baseline.md`.
...
```text
content_knowledge_orchestrator_manifest.json
content_knowledge_orchestrator_state.json
content_knowledge_orchestrator_decision.json
content_knowledge_orchestrator_reconciliation.json
content_knowledge_orchestrator_evidence.json
```
