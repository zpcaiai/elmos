---
name: itsm-service-orchestrator
description: "Implement Batch 47A ITSM、Service Catalog、Request、Change与Problem end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Service、Offering、Catalog Item、Request、Incident、Problem、Change、Knowledge、SLA与Approval."
---

# ITSM Service Orchestrator

## Objective

Implement Batch 47A ITSM、Service Catalog、Request、Change与Problem end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Service、Offering、Catalog Item、Request、Incident、Problem、Change、Knowledge、SLA与Approval.
...
5. Write unresolved domain assumptions to `docs/implementation/itsm-service-orchestrator-baseline.md`.
...
```text
itsm_service_orchestrator_manifest.json
itsm_service_orchestrator_state.json
itsm_service_orchestrator_decision.json
itsm_service_orchestrator_reconciliation.json
itsm_service_orchestrator_evidence.json
```
