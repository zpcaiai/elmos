---
name: portfolio-assurance-rollup-risk-appetite-segmentation-a-5d409ca9
description: 实现组织层级、安全Rollup、Critical Visibility、Risk Appetite、可比Cohort和隐私基准。
metadata:
  elmos_batch: "37C"
  elmos_skill_id: "ANA37C010"
  pack_version: "3.7-complete"
---

# ANA37C010 — Portfolio Assurance Rollup、Risk Appetite、Segmentation 与 Benchmarking

## Objective

实现组织层级、安全Rollup、Critical Visibility、Risk Appetite、可比Cohort和隐私基准。
...
- 层级为Enterprise→BU→Product→Program→Project→Repository。
- Ratio使用SUM Numerator/SUM Applicable Denominator；Duration使用Distribution/Percentile。
- Risk使用Exposure+Critical Max+Concentration，且始终显示Critical/Unknown项目。
- Cross-tenant Benchmark需Policy、Minimum Cohort、Suppression和匿名化。
...
- projectPercentagesAreNotDirectlyAveraged
- criticalProjectFailureRemainsVisible
- smallCrossTenantCohortIsSuppressed
- riskAppetiteVersionIsRecorded
