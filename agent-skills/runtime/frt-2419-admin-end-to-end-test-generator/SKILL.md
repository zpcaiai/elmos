...
description: "Run FRT-2419 Admin End-to-End Test Generator for FRT G24 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2419"
  source_name: "frt-2419-admin-end-to-end-test-generator"
  source_sha256: "sha256:c0c67d6b147252b49f1d3d426aca56f9dc0f7ed0d30cf60b0591779ca1fc7fe6"
  batch: "G24"
...
- Runtime catalog key: `FRT-2419` / `frt-2419-admin-end-to-end-test-generator`.
...
在G24范围内实现 **Admin End-to-End Test Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Admin Object × Action × Role × Scope × Environment矩阵; 高风险操作Impact Preview、Reason、Approval、Typed Command、Audit; Manual Case、Data Repair、Reconciliation正式后台流程。

## When to Use

- 实现或修改与 **Admin End-to-End Test Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2419Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2419EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2419FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2419CertificateFragment`：供G24批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g24/frt-2419-admin-end-to-end-test-generator/
packages/runtime/g24/frt-2419-admin-end-to-end-test-generator/
services/control-plane/g24/frt-2419-admin-end-to-end-test-generator/
apps/web-console/src/features/g24/frt-2419-admin-end-to-end-test-generator/
apps/admin-console/src/features/g24/frt-2419-admin-end-to-end-test-generator/
tests/g24/frt-2419-admin-end-to-end-test-generator/
```
...
```text
POST /v1/skills/frt-2419/runs
GET  /v1/skills/frt-2419/runs/{run_id}
POST /v1/skills/frt-2419/runs/{run_id}/verify
GET  /v1/skills/frt-2419/runs/{run_id}/findings
GET  /v1/skills/frt-2419/runs/{run_id}/evidence
```
