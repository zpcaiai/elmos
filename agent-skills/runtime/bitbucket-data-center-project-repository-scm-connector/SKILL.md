---
name: bitbucket-data-center-project-repository-scm-connector
description: "Implement Bitbucket Data Center projects, repositories, pull requests, hooks, personal/access tokens, version compatibility, clustered deployment, and resilience."
---
...
Implement Bitbucket Data Center projects, repositories, pull requests, hooks, personal/access tokens, version compatibility, clustered deployment, and resilience.
...
4. Record unresolved provider/version assumptions in `docs/implementation/bitbucket-data-center-project-repository-scm-connector-baseline.md`.
...
```text
bitbucket_data_center_project_repository_scm_connector_manifest.json
bitbucket_data_center_project_repository_scm_connector_decision.json
bitbucket_data_center_project_repository_scm_connector_evidence.json
```
