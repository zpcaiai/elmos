...
description: "Run FRT-0309 Source Location and Provenance IR for FRT G03 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0309"
  source_name: "frt-0309-source-location-and-provenance-ir"
  source_sha256: "sha256:bac1b44473ca9f4abc321a01932ff5b9fc77486f99c13b27d13c289d51b62fc7"
  batch: "G03"
  source_version: "1.0.0"
  source_risk: "critical-by-default"
  source_certificate_family: "IR"
...
- Runtime catalog key: `FRT-0309` / `frt-0309-source-location-and-provenance-ir`.
...
# FRT-0309 — Source Location and Provenance IR

## Objective

在G03范围内实现 **Source Location and Provenance IR**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨Vue/React/小程序/ArkUI/Flutter的类型和语义中间层; 保留Null、Identity、Effect、Lifecycle、Navigation、Data Authority和UI语义; 每个IR节点绑定Source Range和稳定Semantic ID。

## When to Use

- 实现或修改与 **Source Location and Provenance IR** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0309Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0309EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0309FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0309CertificateFragment`：供G03批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g03/frt-0309-source-location-and-provenance-ir/
packages/runtime/g03/frt-0309-source-location-and-provenance-ir/
services/control-plane/g03/frt-0309-source-location-and-provenance-ir/
apps/web-console/src/features/g03/frt-0309-source-location-and-provenance-ir/
apps/admin-console/src/features/g03/frt-0309-source-location-and-provenance-ir/
tests/g03/frt-0309-source-location-and-provenance-ir/
```
...
```text
POST /v1/skills/frt-0309/runs
GET  /v1/skills/frt-0309/runs/{run_id}
POST /v1/skills/frt-0309/runs/{run_id}/verify
GET  /v1/skills/frt-0309/runs/{run_id}/findings
GET  /v1/skills/frt-0309/runs/{run_id}/evidence
```
