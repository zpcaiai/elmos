...
- Invoke this repository Skill as `$pm-b41-evidence-release-gates`.
- Immutable source identity: `batch-41-evidence-release-gates` in `precision-migration-b01-44` (B41).
- Runtime adapter: `evidence-release-gate`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b41-evidence-release-gates`.
...
- 当任务涉及 **evidence-manifest** 时，调用 `../pm-b41-evidence-manifest/SKILL.md`。
- 当任务涉及 **conversion-provenance** 时，调用 `../pm-b41-conversion-provenance/SKILL.md`。
- 当任务涉及 **rule-proof-certificate** 时，调用 `../pm-b41-rule-proof-certificate/SKILL.md`。
- 当任务涉及 **module-equivalence-certificate** 时，调用 `../pm-b41-module-equivalence-certificate/SKILL.md`。
- 当任务涉及 **runtime-evidence-package** 时，调用 `../pm-b41-runtime-evidence-package/SKILL.md`。
- 当任务涉及 **semantic-loss-report** 时，调用 `../pm-b41-semantic-loss-report/SKILL.md`。
- 当任务涉及 **unresolved-obligation-report** 时，调用 `../pm-b41-unresolved-obligation-report/SKILL.md`。
- 当任务涉及 **release-gate-engine** 时，调用 `../pm-b41-release-gate-engine/SKILL.md`。
- 当任务涉及 **correctness-level-classifier** 时，调用 `../pm-b41-correctness-level-classifier/SKILL.md`。
- 当任务涉及 **certificate-signing** 时，调用 `../pm-b41-certificate-signing/SKILL.md`。
