---
name: gr-event-catalog
description: 定义 intake 到 delivery 的 durable 事件、版本、payload、cursor 和 projection。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-066
  source_name: gr-event-catalog
  source_path: skills/gr-event-catalog/SKILL.md
  source_sha256: sha256:7da0031731de646a575451cccd0b94af12e60a89c87115909b08b10b04d3e892
  source_contract_sha256: sha256:501a6d147f0428b7c057baf70af19aa792906cc819edeabe7cc229459ad934f7
...
定义 intake 到 delivery 的 durable 事件、版本、payload、cursor 和 projection。

## Scope and capabilities

- Durable vs live delta
- Aggregate sequence
- Outbox
...
- [ ] 定义 `gr-event-catalog` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-event-catalog` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：event-catalog.json, event-schemas, projection-map.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：event-catalog.json, event-schemas, projection-map.json。
...
- Machine contract: `references/contract.json` (`sha256:501a6d147f0428b7c057baf70af19aa792906cc819edeabe7cc229459ad934f7`).
