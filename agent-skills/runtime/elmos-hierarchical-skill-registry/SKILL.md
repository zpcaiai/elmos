---
name: hierarchical-skill-registry
description: Use this skill when Elmos must perform hierarchical skill registry as part of the 05-skill-foundry-runtime production
...
提供平台、组织、租户、项目和仓库级 Skill 注册、搜索和优先级覆盖。
