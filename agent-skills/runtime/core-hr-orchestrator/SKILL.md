---
name: core-hr-orchestrator
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-orchestrator-baseline.md`.
...
```text
core_hr_orchestrator_manifest.json
core_hr_orchestrator_state.json
core_hr_orchestrator_decision.json
core_hr_orchestrator_reconciliation.json
core_hr_orchestrator_evidence.json
```
