...
description: "Run FRT-1506 ArkUI to React Route Pack for FRT G15 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1506"
  source_name: "frt-1506-arkui-to-react-route-pack"
  source_sha256: "sha256:9ff4e17eff6369d45d4ae6fef07ccd8fce7b1f541c2e3526cae44fcc01d8acee"
  batch: "G15"
...
- Runtime catalog key: `FRT-1506` / `frt-1506-arkui-to-react-route-pack`.
...
# FRT-1506 — ArkUI to React Route Pack

## Objective

在G15范围内实现 **ArkUI to React Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射ArkUI状态装饰器、Builder、Navigation和生命周期; 处理Web DOM能力与ArkUI Native/Device差异; 生成真机/模拟器和Accessibility验证。

## When to Use

- 实现或修改与 **ArkUI to React Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1506Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1506EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1506FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1506CertificateFragment`：供G15批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g15/frt-1506-arkui-to-react-route-pack/
packages/runtime/g15/frt-1506-arkui-to-react-route-pack/
services/control-plane/g15/frt-1506-arkui-to-react-route-pack/
apps/web-console/src/features/g15/frt-1506-arkui-to-react-route-pack/
apps/admin-console/src/features/g15/frt-1506-arkui-to-react-route-pack/
tests/g15/frt-1506-arkui-to-react-route-pack/
```
...
```text
POST /v1/skills/frt-1506/runs
GET  /v1/skills/frt-1506/runs/{run_id}
POST /v1/skills/frt-1506/runs/{run_id}/verify
GET  /v1/skills/frt-1506/runs/{run_id}/findings
GET  /v1/skills/frt-1506/runs/{run_id}/evidence
```
