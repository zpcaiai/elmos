...
description: "Run FRT-1403 Vue 3 to Mini Program Route Pack for FRT G14 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1403"
  source_name: "frt-1403-vue-3-to-mini-program-route-pack"
  source_sha256: "sha256:c772f8c6d6e3f00fa4c72f473ac5942d1dc4033c267b203f553726706d7f644e"
  batch: "G14"
...
- Runtime catalog key: `FRT-1403` / `frt-1403-vue-3-to-mini-program-route-pack`.
...
# FRT-1403 — Vue 3 to Mini Program Route Pack

## Objective

在G14范围内实现 **Vue 3 to Mini Program Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：处理WXML/WXSS/setData/Page/Component与Web组件模型; 处理分包、基础库、授权、支付、Storage和页面栈限制; Web缺失能力和小程序限制显式Gap/Unsupported。

## When to Use

- 实现或修改与 **Vue 3 to Mini Program Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1403Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1403EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1403FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1403CertificateFragment`：供G14批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g14/frt-1403-vue-3-to-mini-program-route-pack/
packages/runtime/g14/frt-1403-vue-3-to-mini-program-route-pack/
services/control-plane/g14/frt-1403-vue-3-to-mini-program-route-pack/
apps/web-console/src/features/g14/frt-1403-vue-3-to-mini-program-route-pack/
apps/admin-console/src/features/g14/frt-1403-vue-3-to-mini-program-route-pack/
tests/g14/frt-1403-vue-3-to-mini-program-route-pack/
```
...
```text
POST /v1/skills/frt-1403/runs
GET  /v1/skills/frt-1403/runs/{run_id}
POST /v1/skills/frt-1403/runs/{run_id}/verify
GET  /v1/skills/frt-1403/runs/{run_id}/findings
GET  /v1/skills/frt-1403/runs/{run_id}/evidence
```
