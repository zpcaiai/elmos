...
description: "Run FRT-3013 Automated Rollback Generator for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3013"
  source_name: "frt-3013-automated-rollback-generator"
  source_sha256: "sha256:31d606e2110464140d8d1002bc1e7fe84d7d31a5fbb9c93cdf29d42f62e1f08d"
  batch: "G30"
...
- Runtime catalog key: `FRT-3013` / `frt-3013-automated-rollback-generator`.
...
在G30范围内实现 **Automated Rollback Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Automated Rollback Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3013Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3013EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3013FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3013CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3013-automated-rollback-generator/
packages/runtime/g30/frt-3013-automated-rollback-generator/
services/control-plane/g30/frt-3013-automated-rollback-generator/
apps/web-console/src/features/g30/frt-3013-automated-rollback-generator/
apps/admin-console/src/features/g30/frt-3013-automated-rollback-generator/
tests/g30/frt-3013-automated-rollback-generator/
```
...
```text
POST /v1/skills/frt-3013/runs
GET  /v1/skills/frt-3013/runs/{run_id}
POST /v1/skills/frt-3013/runs/{run_id}/verify
GET  /v1/skills/frt-3013/runs/{run_id}/findings
GET  /v1/skills/frt-3013/runs/{run_id}/evidence
```
