---
name: "elmos-legacy-modernization-trace-validator"
description: "对旧系统和 Spring Boot 4 目标系统执行受控双运行，按观察契约比较 HTTP、Session、数据库、消息、外调和异常 Trace。 Use when the task needs the exact Legacy Modernization Trace Validator Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-legacy-modernization-trace-validator/SKILL.md"
  source_sha256: "sha256:b830e36f9a3488c8bbe18e312585dea864d4de0d2827c5f7c7e6f7382b0b763e"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "spring-modernization"
  runtime_handler_id: "execute_elmos_legacy_modernization_trace_validator"
...
---
# Legacy Modernization Trace Validator

## Repository integration boundary

- Exact Skill identity: `elmos-legacy-modernization-trace-validator`; exact allowlisted runtime handler: `execute_elmos_legacy_modernization_trace_validator`.
- Source identity: `skills/P0/elmos-legacy-modernization-trace-validator/SKILL.md` at `sha256:b830e36f9a3488c8bbe18e312585dea864d4de0d2827c5f7c7e6f7382b0b763e` from `elmos-formal-assurance-kernel-v1.0.0`.
...
对旧系统和 Spring Boot 4 目标系统执行受控双运行，按观察契约比较 HTTP、Session、数据库、消息、外调和异常 Trace。
...
3. Use the repository-owned `execute_elmos_legacy_modernization_trace_validator` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["differential execution","trace alignment","causal normalization","refinement checking"]`
- Direct dependencies: `["elmos-observable-behavior-contract","elmos-proof-obligation-planner","elmos-verifier-portfolio-router","elmos-formal-assurance-orchestrator"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-legacy-modernization-trace-validator/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
