...
triggers:
  - "Use when implementing or executing `elmos-reflection-dynamic-dispatch-semantics`."
  - "Use when a migration/certification DAG requires `dynamic-semantics` capability."
outputs:
  - "semantic-assurance/elmos-reflection-dynamic-dispatch-semantics/model.json"
  - "semantic-assurance/elmos-reflection-dynamic-dispatch-semantics/evidence.json"
  - "semantic-assurance/elmos-reflection-dynamic-dispatch-semantics/diagnostics.json"
---

# Reflection & Dynamic Dispatch Semantics

## Objective

Characterize runtime-discovered members, proxy invocation, dynamic method lookup and reflection-visible metadata behavior.
...
- [ ] Spring proxy fixture.
- [ ] C# reflection fixture.
- [ ] PHP magic method fixture.
