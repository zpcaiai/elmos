...
# Test Method Validation and Verification Controller
...
- `TestMethodValidationAndVerificationControllerProfile`
- `TestMethodValidationAndVerificationControllerRun`
- `TestMethodValidationAndVerificationControllerFinding`
- `TestMethodValidationAndVerificationControllerDecision`
- `TestMethodValidationAndVerificationControllerEvidence`

Required semantic capabilities:

- validate laboratory-developed methods for intended use and performance characteristics
- verify standard methods in the local environment before use
- control method changes, deviations, software versions and revalidation
...
- `artifacts/elmos-test-method-validation-verification-controller/profile.yaml`
- `artifacts/elmos-test-method-validation-verification-controller/plan.json`
- `artifacts/elmos-test-method-validation-verification-controller/result.json`
- `artifacts/elmos-test-method-validation-verification-controller/evidence/`
- `artifacts/elmos-test-method-validation-verification-controller/assurance-case.json`
...
- **method is copied from paper without local validation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **minor code change alters test sensitivity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **method deviation is undocumented** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: validate laboratory-developed methods for intended use and performance characteristics
- native scenario: verify standard methods in the local environment before use
- native scenario: control method changes, deviations, software versions and revalidation
