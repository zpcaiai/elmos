...
- Activate when the task requires: route each edit to deterministic AST/LST/structural/security/compiler/LLM transformation engines instead of defaulting to free-form generation.
