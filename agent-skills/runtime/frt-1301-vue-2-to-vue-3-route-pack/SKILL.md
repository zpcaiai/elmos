...
description: "Run FRT-1301 Vue 2 to Vue 3 Route Pack for FRT G13 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1301"
  source_name: "frt-1301-vue-2-to-vue-3-route-pack"
  source_sha256: "sha256:6602d4932de34725e034de70a5f4f3197413b2e8c1b86a474d8f4956f2a567c6"
  batch: "G13"
...
- Runtime catalog key: `FRT-1301` / `frt-1301-vue-2-to-vue-3-route-pack`.
...
# FRT-1301 — Vue 2 to Vue 3 Route Pack

## Objective

在G13范围内实现 **Vue 2 to Vue 3 Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：六个方向独立声明版本、能力和Known Differences; 处理Options/Composition/Hooks、Router、Store、SFC/JSX差异; 建立直接路径与三角间接路径差分验证。

## When to Use

- 实现或修改与 **Vue 2 to Vue 3 Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1301Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1301EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1301FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1301CertificateFragment`：供G13批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g13/frt-1301-vue-2-to-vue-3-route-pack/
packages/runtime/g13/frt-1301-vue-2-to-vue-3-route-pack/
services/control-plane/g13/frt-1301-vue-2-to-vue-3-route-pack/
apps/web-console/src/features/g13/frt-1301-vue-2-to-vue-3-route-pack/
apps/admin-console/src/features/g13/frt-1301-vue-2-to-vue-3-route-pack/
tests/g13/frt-1301-vue-2-to-vue-3-route-pack/
```
...
```text
POST /v1/skills/frt-1301/runs
GET  /v1/skills/frt-1301/runs/{run_id}
POST /v1/skills/frt-1301/runs/{run_id}/verify
GET  /v1/skills/frt-1301/runs/{run_id}/findings
GET  /v1/skills/frt-1301/runs/{run_id}/evidence
```
