---
name: cross-language-interop-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Cross-Language Interoperability Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T115"
  source_name: "cross-language-interop-gate"
  source_sha256: "sha256:1f3481161f89b42dd657d7986377579ffe49c65434fd3ffdd0a234b394ecdd18"
...
# T115 — Cross-Language Interoperability Gate

## 1. Objective

Validate generated Java/.NET/Python/Swift and platform adapters against canonical data and contract semantics.
...
- `CASE-0581` [HIGH] Cross-Language Interoperability Gate: Representative path
- `CASE-0582` [HIGH] Cross-Language Interoperability Gate: Boundary path
- `CASE-0583` [HIGH] Cross-Language Interoperability Gate: Invalid or hostile input
- `CASE-0584` [HIGH] Cross-Language Interoperability Gate: Injected dependency failure
- `CASE-0585` [CRITICAL] Cross-Language Interoperability Gate: Security or safety violation
- `CASE-0586` [HIGH] Cross-Language Interoperability Gate: Replay and idempotency
- `CASE-0587` [HIGH] Cross-Language Interoperability Gate: Version or environment drift
- `CASE-0588` [MEDIUM] Cross-Language Interoperability Gate: Moderate scale
- `CASE-0589` [CRITICAL] Cross-Language Interoperability Gate: Evidence tamper
- `CASE-0590` [HIGH] Cross-Language Interoperability Gate: Recovery and final evidence
