...
description: Use this skill when Elmos must perform label quality and adjudication as part of the 06-dataset-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
