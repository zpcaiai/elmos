...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/payment-security-pci-tokenization-pan-vault-encryption-2b43d393-baseline.md`.
