...
description: "Run FRT-2507 User Guidance and Recovery Generator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2507"
  source_name: "frt-2507-user-guidance-and-recovery-generator"
  source_sha256: "sha256:f6f6ae7210efcf0e0e8fa5013bb4fb0cdab2aceeac7b7916eca0eb42a0ca52d3"
  batch: "G25"
...
- Runtime catalog key: `FRT-2507` / `frt-2507-user-guidance-and-recovery-generator`.
...
在G25范围内实现 **User Guidance and Recovery Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **User Guidance and Recovery Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2507Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2507EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2507FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2507CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2507-user-guidance-and-recovery-generator/
packages/runtime/g25/frt-2507-user-guidance-and-recovery-generator/
services/control-plane/g25/frt-2507-user-guidance-and-recovery-generator/
apps/web-console/src/features/g25/frt-2507-user-guidance-and-recovery-generator/
apps/admin-console/src/features/g25/frt-2507-user-guidance-and-recovery-generator/
tests/g25/frt-2507-user-guidance-and-recovery-generator/
```
...
```text
POST /v1/skills/frt-2507/runs
GET  /v1/skills/frt-2507/runs/{run_id}
POST /v1/skills/frt-2507/runs/{run_id}/verify
GET  /v1/skills/frt-2507/runs/{run_id}/findings
GET  /v1/skills/frt-2507/runs/{run_id}/evidence
```
