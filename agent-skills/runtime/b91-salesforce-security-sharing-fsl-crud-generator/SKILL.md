---
name: b91-salesforce-security-sharing-fsl-crud-generator
description: "Use when ELMOS must run salesforce security sharing fsl crud generator for Batch 91 Salesforce Apex / SOQL / LWC Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG351"
  source_name: "salesforce-security-sharing-fsl-crud-generator"
  source_sha256: "sha256:bdcf5124bd57c16f36e4d3d93712d23a5c564038826e5d01d66256900adde1ca"
  batch: 91
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 91 Language Pack / source PG351 — Salesforce Security Sharing Fsl Crud Generator

## 1. Objective

Generate salesforce security sharing fsl crud generator within the Salesforce Apex / SOQL / LWC Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Salesforce Security Sharing Fsl Crud Generator using the approved enterprise-crm-platform semantic contracts and toolchain versions.
...
- A representative valid salesforce input produces all declared outputs for salesforce-security-sharing-fsl-crud-generator.
