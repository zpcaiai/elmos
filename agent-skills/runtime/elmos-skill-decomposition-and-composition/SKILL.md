---
name: skill-decomposition-and-composition
description: Use this skill when Elmos must perform skill decomposition and composition as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
拆解过大 Skill，组合原子 Skill，并验证数据、权限和失败语义兼容。
