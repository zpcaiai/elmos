---
name: archive-and-folder-ingestion
description: Use this skill when Elmos must perform archive and folder ingestion as part of the 01-knowledge-ingestion-governance
...
安全处理文件夹、zip、tar.gz、嵌套归档、超大文件和损坏归档。
