---
name: elmos-golden-route-priority
description: 把主要工程资源集中到 Spring 大型仓库 Golden Route，避免路线无限横向扩张。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-005
  source_name: elmos-golden-route-priority
  source_path: skills/elmos-golden-route-priority/SKILL.md
  source_sha256: sha256:9a2e07164d00a6423dbd707debc339213b24301f13010b12cccbfe5ca9842567
  source_contract_sha256: sha256:d6a8b062e60262dafea7eab34376aec4539fadbfc265b124a21d3176af1038a2
...
# Golden Route Prioritization

## Objective

把主要工程资源集中到 Spring 大型仓库 Golden Route，避免路线无限横向扩张。
...
- [ ] 定义 `elmos-golden-route-priority` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `elmos-golden-route-priority` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：route-scorecard.json, selected-route.md, deferred-routes.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：route-scorecard.json, selected-route.md, deferred-routes.json。
- [ ] 所有 mandatory tests 和 security gates 通过，且无 critical unknown。

## Dependencies

- `elmos-maturity-l1-l5`
...
- Machine contract: `references/contract.json` (`sha256:d6a8b062e60262dafea7eab34376aec4539fadbfc265b124a21d3176af1038a2`).
