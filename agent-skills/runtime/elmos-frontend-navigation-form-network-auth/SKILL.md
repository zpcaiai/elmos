...
description: Use this skill when Elmos must perform frontend navigation form network auth as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
