...
description: "Run FRT-1809 Industry Pack Framework for FRT G18 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1809"
  source_name: "frt-1809-industry-pack-framework"
  source_sha256: "sha256:86c79cd16a705e4107c5fbbe769234c98b2dd24f70ecfb5de3e361222abc7ad9"
  batch: "G18"
...
- Runtime catalog key: `FRT-1809` / `frt-1809-industry-pack-framework`.
...
# FRT-1809 — Industry Pack Framework

## Objective

在G18范围内实现 **Industry Pack Framework**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：将真实项目差异封装为可组合Overlay而非硬编码核心; Pack声明Provides/Requires/Conflicts/Permissions/Versions; 确定性解析优先级和冲突。

## When to Use

- 实现或修改与 **Industry Pack Framework** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1809Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1809EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1809FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1809CertificateFragment`：供G18批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g18/frt-1809-industry-pack-framework/
packages/runtime/g18/frt-1809-industry-pack-framework/
services/control-plane/g18/frt-1809-industry-pack-framework/
apps/web-console/src/features/g18/frt-1809-industry-pack-framework/
apps/admin-console/src/features/g18/frt-1809-industry-pack-framework/
tests/g18/frt-1809-industry-pack-framework/
```
...
```text
POST /v1/skills/frt-1809/runs
GET  /v1/skills/frt-1809/runs/{run_id}
POST /v1/skills/frt-1809/runs/{run_id}/verify
GET  /v1/skills/frt-1809/runs/{run_id}/findings
GET  /v1/skills/frt-1809/runs/{run_id}/evidence
```
