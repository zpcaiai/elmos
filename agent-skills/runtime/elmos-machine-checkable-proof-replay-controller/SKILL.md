---
name: elmos-machine-checkable-proof-replay-controller
description: Implement and independently certify machine-checkable proof replay controller, including replay theorem, SMT, model-checking and proof-assistant artifacts in clean room, pin solver, library, logic, resource bounds and proof checker digests and classify proof rot, timeout, unsupported and semantic drift.
version: 4.0.0
...
# Machine-Checkable Proof Replay Controller
...
- `MachineCheckableProofReplayControllerProfile`
- `MachineCheckableProofReplayControllerRun`
- `MachineCheckableProofReplayControllerFinding`
- `MachineCheckableProofReplayControllerDecision`
- `MachineCheckableProofReplayControllerEvidence`

Required semantic capabilities:

- replay theorem, SMT, model-checking and proof-assistant artifacts in clean room
- pin solver, library, logic, resource bounds and proof checker digests
- classify proof rot, timeout, unsupported and semantic drift
...
- `elmos-proof-carrying-artifact-compiler`
- `elmos-hermetic-build-environment-attestation-controller`

## Primary Outputs

- `artifacts/elmos-machine-checkable-proof-replay-controller/profile.yaml`
- `artifacts/elmos-machine-checkable-proof-replay-controller/plan.json`
- `artifacts/elmos-machine-checkable-proof-replay-controller/result.json`
- `artifacts/elmos-machine-checkable-proof-replay-controller/evidence/`
- `artifacts/elmos-machine-checkable-proof-replay-controller/assurance-case.json`
...
- **cached proof accepted without replay** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **new solver silently changes result** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **resource timeout is represented as proved** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: replay theorem, SMT, model-checking and proof-assistant artifacts in clean room
- native scenario: pin solver, library, logic, resource bounds and proof checker digests
- native scenario: classify proof rot, timeout, unsupported and semantic drift
