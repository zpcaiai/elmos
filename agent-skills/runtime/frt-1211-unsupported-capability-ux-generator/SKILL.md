...
description: "Run FRT-1211 Unsupported Capability UX Generator for FRT G12 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1211"
  source_name: "frt-1211-unsupported-capability-ux-generator"
  source_sha256: "sha256:e570bf682dd6d4699d0d7687644bbd53d7ac03ce9bcfe4e69c768abb24d929c5"
  batch: "G12"
...
- Runtime catalog key: `FRT-1211` / `frt-1211-unsupported-capability-ux-generator`.
...
# FRT-1211 — Unsupported Capability UX Generator

## Objective

在G12范围内实现 **Unsupported Capability UX Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨平台Capability Registry与支持等级; Native Bridge具备Schema、Permission、Timeout和Error Contract; 支付、设备和危险能力使用Server Authority与安全状态机。

## When to Use

- 实现或修改与 **Unsupported Capability UX Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1211Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1211EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1211FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1211CertificateFragment`：供G12批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g12/frt-1211-unsupported-capability-ux-generator/
packages/runtime/g12/frt-1211-unsupported-capability-ux-generator/
services/control-plane/g12/frt-1211-unsupported-capability-ux-generator/
apps/web-console/src/features/g12/frt-1211-unsupported-capability-ux-generator/
apps/admin-console/src/features/g12/frt-1211-unsupported-capability-ux-generator/
tests/g12/frt-1211-unsupported-capability-ux-generator/
```
...
```text
POST /v1/skills/frt-1211/runs
GET  /v1/skills/frt-1211/runs/{run_id}
POST /v1/skills/frt-1211/runs/{run_id}/verify
GET  /v1/skills/frt-1211/runs/{run_id}/findings
GET  /v1/skills/frt-1211/runs/{run_id}/evidence
```
