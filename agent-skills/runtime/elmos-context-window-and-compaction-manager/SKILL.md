---
name: context-window-and-compaction-manager
description: Use this skill when Elmos must perform context window and compaction manager as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# context-window-and-compaction-manager

## 能力目标

管理上下文预算、压缩、恢复锚点和 Skill/证据保护。
