---
name: b91-apex-test-mutation-generator
description: "Use when ELMOS must run apex test mutation generator for Batch 91 Salesforce Apex / SOQL / LWC Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG353"
  source_name: "apex-test-mutation-generator"
  source_sha256: "sha256:27fb8355bfae780205ca434376f93fcb74015d17f85141e52e4de2b307c1a23e"
  batch: 91
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 91 Language Pack / source PG353 — Apex Test Mutation Generator

## 1. Objective

Generate apex test mutation generator within the Salesforce Apex / SOQL / LWC Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Apex Test Mutation Generator using the approved enterprise-crm-platform semantic contracts and toolchain versions.
...
- A representative valid salesforce input produces all declared outputs for apex-test-mutation-generator.
