---
name: elmos-ada-spark-to-rust-golden-route
description: 'Execute the reference route: Ada/SPARK to Rust for safety-oriented native
  modernization.'
version: 1.0.0
skill_id: ELMOS-POLY-146
...
triggers:
- Use when implementing or executing `elmos-ada-spark-to-rust-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-ada-spark-to-rust-golden-route/run.json
- routes/elmos-ada-spark-to-rust-golden-route/migration-plan.json
- routes/elmos-ada-spark-to-rust-golden-route/evidence/
---

# Ada Spark To Rust Golden Route

## Objective

Execute the reference route: Ada/SPARK to Rust for safety-oriented native modernization.
...
- Source: `ada-spark`
- Target: `rust`
- Intent: Ada/SPARK to Rust for safety-oriented native modernization
