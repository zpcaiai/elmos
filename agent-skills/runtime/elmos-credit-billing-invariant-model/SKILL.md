---
name: "elmos-credit-billing-invariant-model"
description: "证明预充 token/credit 的预留、消费、退款、收入确认和事件去重在并发与故障下保持守恒。 Use when the task needs the exact Credit and Billing Invariant Model Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-credit-billing-invariant-model/SKILL.md"
  source_sha256: "sha256:bbdad573a9d6f5391f21183266d17ea3bbcce48a991a354c0428dc5f6a4bf220"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "platform"
  runtime_handler_id: "execute_elmos_credit_billing_invariant_model"
...
- Exact Skill identity: `elmos-credit-billing-invariant-model`; exact allowlisted runtime handler: `execute_elmos_credit_billing_invariant_model`.
- Source identity: `skills/P0/elmos-credit-billing-invariant-model/SKILL.md` at `sha256:bbdad573a9d6f5391f21183266d17ea3bbcce48a991a354c0428dc5f6a4bf220` from `elmos-formal-assurance-kernel-v1.0.0`.
...
3. Use the repository-owned `execute_elmos_credit_billing_invariant_model` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["conservation invariants","idempotent ledger model","serializability refinement"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-credit-billing-invariant-model/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
