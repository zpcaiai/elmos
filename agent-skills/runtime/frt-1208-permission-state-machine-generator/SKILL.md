...
description: "Run FRT-1208 Permission State Machine Generator for FRT G12 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1208"
  source_name: "frt-1208-permission-state-machine-generator"
  source_sha256: "sha256:5e6438e8638eac1a380c3c2433ea1e5e002fdcf14e2c3fa21404e7d3d2a82222"
  batch: "G12"
...
- Runtime catalog key: `FRT-1208` / `frt-1208-permission-state-machine-generator`.
...
# FRT-1208 — Permission State Machine Generator

## Objective

在G12范围内实现 **Permission State Machine Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨平台Capability Registry与支持等级; Native Bridge具备Schema、Permission、Timeout和Error Contract; 支付、设备和危险能力使用Server Authority与安全状态机。

## When to Use

- 实现或修改与 **Permission State Machine Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1208Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1208EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1208FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1208CertificateFragment`：供G12批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g12/frt-1208-permission-state-machine-generator/
packages/runtime/g12/frt-1208-permission-state-machine-generator/
services/control-plane/g12/frt-1208-permission-state-machine-generator/
apps/web-console/src/features/g12/frt-1208-permission-state-machine-generator/
apps/admin-console/src/features/g12/frt-1208-permission-state-machine-generator/
tests/g12/frt-1208-permission-state-machine-generator/
```
...
```text
POST /v1/skills/frt-1208/runs
GET  /v1/skills/frt-1208/runs/{run_id}
POST /v1/skills/frt-1208/runs/{run_id}/verify
GET  /v1/skills/frt-1208/runs/{run_id}/findings
GET  /v1/skills/frt-1208/runs/{run_id}/evidence
```
