---
name: "elmos-generated-workflow-model-checker"
description: "把订单、支付、任务、审批、补偿、重试和取消工作流转换为 TLA+/状态机并检查安全与活性。 Use when the task needs the exact Generated Workflow Model Checker Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-generated-workflow-model-checker/SKILL.md"
  source_sha256: "sha256:3670427897703d978903155d1144985892b0eb4215df6757932b2f652a33cf35"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "project-generation"
  runtime_handler_id: "execute_elmos_generated_workflow_model_checker"
...
---
# Generated Workflow Model Checker

## Repository integration boundary

- Exact Skill identity: `elmos-generated-workflow-model-checker`; exact allowlisted runtime handler: `execute_elmos_generated_workflow_model_checker`.
- Source identity: `skills/P0/elmos-generated-workflow-model-checker/SKILL.md` at `sha256:3670427897703d978903155d1144985892b0eb4215df6757932b2f652a33cf35` from `elmos-formal-assurance-kernel-v1.0.0`.
...
把订单、支付、任务、审批、补偿、重试和取消工作流转换为 TLA+/状态机并检查安全与活性。
...
3. Use the repository-owned `execute_elmos_generated_workflow_model_checker` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["TLA+ model checking","symbolic model checking","state refinement","fairness assumptions"]`
- Direct dependencies: `["elmos-proof-obligation-planner","elmos-verifier-portfolio-router","elmos-requirement-to-formal-spec"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-generated-workflow-model-checker/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
