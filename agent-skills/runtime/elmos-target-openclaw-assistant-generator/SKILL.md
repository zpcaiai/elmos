---
name: elmos-target-openclaw-assistant-generator
description: Generate isolated OpenClaw gateway/workspace configurations, agents, skills, plugins, channels, sandbox policies,
  pairing, service and recovery assets.
version: 4.0.0
...
# TargetOpenclawAssistantGenerator
...
- Generate gateway, workspace and assistant configuration
- Generate Skills, Plugins and channels
- Configure pairing and per-tenant isolation
- Generate sandbox, daemon and backup/restore controls
- Run gateway validation and plugin/Skill load tests
...
- **in-process plugin compromise** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **channel sender spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **pairing takeover** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **workspace prompt poisoning** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared gateway tenant bleed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- Skill load
- plugin manifest and allowlist
- channel pairing
- sandbox deny by default
- daemon restart
- backup/restore
- per-tenant gateway isolation
- plugin revocation
