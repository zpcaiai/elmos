---
name: b86-co-simulation-orchestrator
description: "Use when ELMOS must run co simulation orchestrator for Batch 86 Modelica / FMI / FMU Digital Twin Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG290"
  source_name: "co-simulation-orchestrator"
  source_sha256: "sha256:f88273c8ced25b8d7f9c15c60b1d7e029c24a542f232fa4034f4a26735a267e4"
  batch: 86
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 86 Language Pack / source PG290 — Co Simulation Orchestrator

## 1. Objective

Generate co simulation orchestrator within the Modelica / FMI / FMU Digital Twin Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Co Simulation Orchestrator using the approved physical-modeling semantic contracts and toolchain versions.
...
- A representative valid modelica-fmi input produces all declared outputs for co-simulation-orchestrator.
