---
name: tst-b66-typescript-javascript-slightly-strict-suite
description: "Run the slightly strict test suite for Batch 66: TypeScript and JavaScript, covering every source Skill with positive and negative executable cases."
metadata:
  id: TB66
...
---
    # TB66 — Batch 66 TypeScript and JavaScript 略严苛测试套件

    ## Objective

    对 Batch 66 的全部 12 个Source Skills执行可重放的正向、边界、负向、故障、安全和证据完整性验证。范围为：TypeScript/JavaScript、Node.js、Next.js、React、Vue、数据访问、契约与测试。
    ...
    |---|---|---|---|
    | PG223 | `b66-typescript-project-profile-detector` | detector | `B66-PG223-RUN, B66-PG223-NEG` |
| PG224 | `b66-node-runtime-lockfile-reproducer` | reproducer | `B66-PG224-RUN, B66-PG224-NEG` |
| PG225 | `b66-typescript-monorepo-scaffolder` | generator | `B66-PG225-RUN, B66-PG225-NEG` |
| PG226 | `b66-nestjs-fastify-api-generator` | generator | `B66-PG226-RUN, B66-PG226-NEG` |
| PG227 | `b66-nextjs-fullstack-generator` | ui | `B66-PG227-RUN, B66-PG227-NEG` |
| PG228 | `b66-react-vite-spa-generator` | ui | `B66-PG228-RUN, B66-PG228-NEG` |
| PG229 | `b66-vue-nuxt-app-generator` | ui | `B66-PG229-RUN, B66-PG229-NEG` |
| PG230 | `b66-node-worker-cli-generator` | generator | `B66-PG230-RUN, B66-PG230-NEG` |
| PG231 | `b66-typescript-data-access-generator` | data | `B66-PG231-RUN, B66-PG231-NEG` |
| PG232 | `b66-typescript-contract-client-generator` | contract | `B66-PG232-RUN, B66-PG232-NEG` |
| PG233 | `b66-typescript-test-harness-generator` | test | `B66-PG233-RUN, B66-PG233-NEG` |
| PG234 | `b66-node-build-run-repair-certifier` | build | `B66-PG234-RUN, B66-PG234-NEG` |
