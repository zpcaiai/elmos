...
description: "Run FRT-1006 Network Client Generator for FRT G10 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1006"
  source_name: "frt-1006-network-client-generator"
  source_sha256: "sha256:028293387e13b191f5a6e862b6b9f5a9387b4ab08bf81201c0fffaf9511b0fa2"
  batch: "G10"
...
- Runtime catalog key: `FRT-1006` / `frt-1006-network-client-generator`.
...
# FRT-1006 — Network Client Generator

## Objective

在G10范围内实现 **Network Client Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：保持Route、History、Guard和Deep Link语义; 表单Validation、错误、草稿和提交幂等完整; API、Event、Storage和Realtime边界显式。

## When to Use

- 实现或修改与 **Network Client Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1006Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1006EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1006FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1006CertificateFragment`：供G10批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g10/frt-1006-network-client-generator/
packages/runtime/g10/frt-1006-network-client-generator/
services/control-plane/g10/frt-1006-network-client-generator/
apps/web-console/src/features/g10/frt-1006-network-client-generator/
apps/admin-console/src/features/g10/frt-1006-network-client-generator/
tests/g10/frt-1006-network-client-generator/
```
...
```text
POST /v1/skills/frt-1006/runs
GET  /v1/skills/frt-1006/runs/{run_id}
POST /v1/skills/frt-1006/runs/{run_id}/verify
GET  /v1/skills/frt-1006/runs/{run_id}/findings
GET  /v1/skills/frt-1006/runs/{run_id}/evidence
```
