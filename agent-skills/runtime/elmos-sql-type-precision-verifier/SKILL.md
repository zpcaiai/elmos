---
name: "elmos-sql-type-precision-verifier"
description: "证明数值范围/Scale、字符集、Collation、时间、JSON、二进制和布尔映射不会丢失业务语义。 Use when the task needs the exact SQL Type and Precision Verifier Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-sql-type-precision-verifier/SKILL.md"
  source_sha256: "sha256:a01cc35a8c47c8067595a789edafc1fac8e7e96ac9860f3cbc40eb21cd66748a"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "sql-conversion"
  runtime_handler_id: "execute_elmos_sql_type_precision_verifier"
...
---
# SQL Type and Precision Verifier

## Repository integration boundary

- Exact Skill identity: `elmos-sql-type-precision-verifier`; exact allowlisted runtime handler: `execute_elmos_sql_type_precision_verifier`.
- Source identity: `skills/P0/elmos-sql-type-precision-verifier/SKILL.md` at `sha256:a01cc35a8c47c8067595a789edafc1fac8e7e96ac9860f3cbc40eb21cd66748a` from `elmos-formal-assurance-kernel-v1.0.0`.
...
证明数值范围/Scale、字符集、Collation、时间、JSON、二进制和布尔映射不会丢失业务语义。
...
3. Use the repository-owned `execute_elmos_sql_type_precision_verifier` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["range proofs","rounding semantics","encoding equivalence","type refinement"]`
- Direct dependencies: `["elmos-proof-obligation-planner","elmos-verifier-portfolio-router","elmos-sql-semantic-ir"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-sql-type-precision-verifier/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
