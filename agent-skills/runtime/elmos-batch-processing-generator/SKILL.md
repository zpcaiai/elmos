...
metadata:
  ...
  repository_handler_id: "handle_elmos_batch_processing_generator"
...
- Source group: `bigdata-core`. Dependencies: `["elmos-bigdata-pattern-selector", "elmos-ingestion-connector-planner", "elmos-database-schema-physical-design"]`. Triggers: `["离线数仓或历史重算", "生成批处理代码", "替换遗留 MapReduce"]`. Declared outputs: `["pipelines/batch/", "batch-dag.json", "incremental-strategy.md", "batch-tests/"]`. Stable task IDs: `["BATCH-001", "BATCH-002", "BATCH-003", "BATCH-004", "BATCH-005", "BATCH-006", "BATCH-007", "BATCH-008", "BATCH-009", "BATCH-010", "BATCH-011", "BATCH-012"]`.
- This normalized Skill is installed and invocable. The repository binds `handle_elmos_batch_processing_generator` in `engines/database-bigdata-engine/src/elmos_database_bigdata/handlers/bigdata_core.py` as a bounded plan-skeleton entry point; the reviewed code declares no database, provider, network, deployment, benchmark, mutation, or certification operation.
