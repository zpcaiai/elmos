...
description: "Run FRT-1914 Proof Carrying Pack for FRT G19 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1914"
  source_name: "frt-1914-proof-carrying-pack"
  source_sha256: "sha256:ead07b06f5023226a6e58dc8d24890950d5bdba47c36847ed265ef44f4acaf7f"
  batch: "G19"
...
- Runtime catalog key: `FRT-1914` / `frt-1914-proof-carrying-pack`.
...
# FRT-1914 — Proof Carrying Pack

## Objective

在G19范围内实现 **Proof Carrying Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：从IR、Rule和业务不变量生成Proof Obligation; Leanstral仅提出证明候选，Lean Kernel为可信根; 组合SMT、Model Checking、Symbolic和Differential Evidence。

## When to Use

- 实现或修改与 **Proof Carrying Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1914Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1914EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1914FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1914CertificateFragment`：供G19批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g19/frt-1914-proof-carrying-pack/
packages/runtime/g19/frt-1914-proof-carrying-pack/
services/control-plane/g19/frt-1914-proof-carrying-pack/
apps/web-console/src/features/g19/frt-1914-proof-carrying-pack/
apps/admin-console/src/features/g19/frt-1914-proof-carrying-pack/
tests/g19/frt-1914-proof-carrying-pack/
```
...
```text
POST /v1/skills/frt-1914/runs
GET  /v1/skills/frt-1914/runs/{run_id}
POST /v1/skills/frt-1914/runs/{run_id}/verify
GET  /v1/skills/frt-1914/runs/{run_id}/findings
GET  /v1/skills/frt-1914/runs/{run_id}/evidence
```
