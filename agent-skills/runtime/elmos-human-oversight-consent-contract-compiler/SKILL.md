---
name: elmos-human-oversight-consent-contract-compiler
description: Compile auditable human oversight contracts for high-risk decisions, dual control, consent scope, approval TTL,
  escalation, revocation and parameter binding.
version: 4.0.0
...
# Human Oversight and Consent Contract Compiler
...
- `Approval`
- `ResidualRisk`
- `HumanOversightAndConsentContractCompilerRun`
- `HumanOversightAndConsentContractCompilerDecision`

Required semantic capabilities:

- Risk-tiered approval policy
- Four-eyes and role separation
- Approval evidence and exact parameter binding
- TTL, escalation, delegation and revocation
- Replay-resistant approval lifecycle
...
- `oversight-contracts/`
- `approval-state-machine.json`
- `consent-evidence.json`
- `oversight-gap-ledger.json`
...
- **approval replay** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **bait-and-switch parameters** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **approver impersonation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **consent scope ambiguity** — must have a preventive control, a detective signal, a negative fixture and a response action.
