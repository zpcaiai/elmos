...
description: "Invoke the bounded repository handler for elmos-implementation-dag-planner while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P03:implementation-dag-planner"
  source_name: "elmos-implementation-dag-planner"
  installed_name: "elmos-implementation-dag-planner"
  source_logical_path: "03-elmos-project-generation-transformation-engine/skills/implementation-dag-planner/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/03-elmos-project-generation-transformation-engine/skills/implementation-dag-planner/SKILL.md.source-data"
  source_materialized_path: "03-elmos-project-generation-transformation-engine/skills/implementation-dag-planner/SKILL.md.source-data"
  source_sha256: "sha256:36b49f5b6f63eec816879e58a0de5d2ad5b5fbb6f6c1c9136d95150ea47bffdb"
...
# elmos-implementation-dag-planner
...
- This is a deterministic repository wrapper for `03-elmos-project-generation-transformation-engine/skills/implementation-dag-planner/SKILL.md` at `sha256:36b49f5b6f63eec816879e58a0de5d2ad5b5fbb6f6c1c9136d95150ea47bffdb`.
- Its immutable source/runtime identity is `elmos-implementation-dag-planner`; its active installed identity is `elmos-implementation-dag-planner`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-implementation-dag-planner --request <file>
```
