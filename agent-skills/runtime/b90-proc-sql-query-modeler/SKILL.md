---
name: b90-proc-sql-query-modeler
description: "Use when ELMOS must run proc sql query modeler for Batch 90 SAS / Macro / PROC SQL / Viya Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG334"
  source_name: "proc-sql-query-modeler"
  source_sha256: "sha256:3816cee9203e8f93e4f4b5b3fb3dcfdfba4500bc9e120543a33936a5d3db1873"
  batch: 90
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 90 Language Pack / source PG334 — Proc SQL Query Modeler

## 1. Objective

Model proc sql query modeler within the SAS / Macro / PROC SQL / Viya Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Proc SQL Query Modeler using the approved enterprise-analytics semantic contracts and toolchain versions.
...
- A representative valid sas-modernization input produces all declared outputs for proc-sql-query-modeler.
