...
description: "Run FRT-2013 Model Router and Cost Governor for FRT G20 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2013"
  source_name: "frt-2013-model-router-and-cost-governor"
  source_sha256: "sha256:0126f91ce44e908f32eaec4b2680726e9d1d699a13e28b2c927c117b9429a14d"
  batch: "G20"
...
- Runtime catalog key: `FRT-2013` / `frt-2013-model-router-and-cost-governor`.
...
# FRT-2013 — Model Router and Cost Governor

## Objective

在G20范围内实现 **Model Router and Cost Governor**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：提供Skill SDK、Runtime、Registry和Marketplace; 实现CLI、API、IDE、Web Console和Multi-Tenant Workspace; Durable Workflow与分布式Worker支持暂停、恢复、取消和幂等。

## When to Use

- 实现或修改与 **Model Router and Cost Governor** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2013Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2013EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2013FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2013CertificateFragment`：供G20批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g20/frt-2013-model-router-and-cost-governor/
packages/runtime/g20/frt-2013-model-router-and-cost-governor/
services/control-plane/g20/frt-2013-model-router-and-cost-governor/
apps/web-console/src/features/g20/frt-2013-model-router-and-cost-governor/
apps/admin-console/src/features/g20/frt-2013-model-router-and-cost-governor/
tests/g20/frt-2013-model-router-and-cost-governor/
```
...
```text
POST /v1/skills/frt-2013/runs
GET  /v1/skills/frt-2013/runs/{run_id}
POST /v1/skills/frt-2013/runs/{run_id}/verify
GET  /v1/skills/frt-2013/runs/{run_id}/findings
GET  /v1/skills/frt-2013/runs/{run_id}/evidence
```
