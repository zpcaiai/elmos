---
name: exception-waiver-risk-acceptance-compensating-control-and-expiry
description: "Implement policy exceptions, control waivers, risk acceptances, exact scopes, compensating controls, non-waivable policies, approvals, usage, expiry, renewal, and revocation."
---
...
Implement policy exceptions, control waivers, risk acceptances, exact scopes, compensating controls, non-waivable policies, approvals, usage, expiry, renewal, and revocation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/exception-waiver-risk-acceptance-compensating-control-and-expiry-baseline.md`.
...
```text
exception_waiver_risk_acceptance_compensating_control_and_expiry_manifest.json
exception_waiver_risk_acceptance_compensating_control_and_expiry_decision.json
exception_waiver_risk_acceptance_compensating_control_and_expiry_evidence.json
```
