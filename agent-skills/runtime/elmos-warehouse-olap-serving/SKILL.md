...
- Source group: `bigdata-core`. Dependencies: `["elmos-bigdata-pattern-selector", "elmos-lakehouse-generator", "elmos-polyglot-persistence-planner"]`. Triggers: `["BI/即席/实时大屏", "选择实时 OLAP/云数仓", "湖仓查询服务"]`. Declared outputs: `["analytics-serving/", "olap-model.json", "materialization-plan.md", "query-slo.json"]`.
