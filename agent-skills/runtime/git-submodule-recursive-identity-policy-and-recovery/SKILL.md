---
name: git-submodule-recursive-identity-policy-and-recovery
description: "Implement Git submodule identity, URL rewriting, recursive resolution, credential separation, pinned commits, cycles, missing commits, and recovery."
---
...
Implement Git submodule identity, URL rewriting, recursive resolution, credential separation, pinned commits, cycles, missing commits, and recovery.
...
4. Record unresolved provider/version assumptions in `docs/implementation/git-submodule-recursive-identity-policy-and-recovery-baseline.md`.
...
```text
git_submodule_recursive_identity_policy_and_recovery_manifest.json
git_submodule_recursive_identity_policy_and_recovery_decision.json
git_submodule_recursive_identity_policy_and_recovery_evidence.json
```
