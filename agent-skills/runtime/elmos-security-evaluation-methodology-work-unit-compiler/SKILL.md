...
# Security Evaluation Methodology Work-Unit Compiler
...
- `SecurityEvaluationMethodologyWorkUnitCompilerProfile`
- `SecurityEvaluationMethodologyWorkUnitCompilerRun`
- `SecurityEvaluationMethodologyWorkUnitCompilerFinding`
- `SecurityEvaluationMethodologyWorkUnitCompilerDecision`
- `SecurityEvaluationMethodologyWorkUnitCompilerEvidence`

Required semantic capabilities:

- compile evaluator actions, inputs, verdict criteria and evidence for each assurance work unit
- ensure evaluation depth and rigor are reproducible across evaluators
- record sampling, dependencies, deviations and reviewer approval
...
- `elmos-common-criteria-evaluation-assurance-level-planner`

## Primary Outputs

- `artifacts/elmos-security-evaluation-methodology-work-unit-compiler/profile.yaml`
- `artifacts/elmos-security-evaluation-methodology-work-unit-compiler/plan.json`
- `artifacts/elmos-security-evaluation-methodology-work-unit-compiler/result.json`
- `artifacts/elmos-security-evaluation-methodology-work-unit-compiler/evidence/`
- `artifacts/elmos-security-evaluation-methodology-work-unit-compiler/assurance-case.json`
...
- **work unit reduced to checklist tick** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evaluator action has no objective verdict rule** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence sample excludes complex module** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile evaluator actions, inputs, verdict criteria and evidence for each assurance work unit
- native scenario: ensure evaluation depth and rigor are reproducible across evaluators
- native scenario: record sampling, dependencies, deviations and reviewer approval
