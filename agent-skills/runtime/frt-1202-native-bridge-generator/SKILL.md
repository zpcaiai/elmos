...
description: "Run FRT-1202 Native Bridge Generator for FRT G12 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1202"
  source_name: "frt-1202-native-bridge-generator"
  source_sha256: "sha256:86b983a05705377131415367bed0acc2607380f23bc55fc109be43b73e995cb0"
  batch: "G12"
...
- Runtime catalog key: `FRT-1202` / `frt-1202-native-bridge-generator`.
...
# FRT-1202 — Native Bridge Generator

## Objective

在G12范围内实现 **Native Bridge Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨平台Capability Registry与支持等级; Native Bridge具备Schema、Permission、Timeout和Error Contract; 支付、设备和危险能力使用Server Authority与安全状态机。

## When to Use

- 实现或修改与 **Native Bridge Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1202Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1202EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1202FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1202CertificateFragment`：供G12批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g12/frt-1202-native-bridge-generator/
packages/runtime/g12/frt-1202-native-bridge-generator/
services/control-plane/g12/frt-1202-native-bridge-generator/
apps/web-console/src/features/g12/frt-1202-native-bridge-generator/
apps/admin-console/src/features/g12/frt-1202-native-bridge-generator/
tests/g12/frt-1202-native-bridge-generator/
```
...
```text
POST /v1/skills/frt-1202/runs
GET  /v1/skills/frt-1202/runs/{run_id}
POST /v1/skills/frt-1202/runs/{run_id}/verify
GET  /v1/skills/frt-1202/runs/{run_id}/findings
GET  /v1/skills/frt-1202/runs/{run_id}/evidence
```
