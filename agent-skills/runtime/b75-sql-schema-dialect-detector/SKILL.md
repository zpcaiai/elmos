...
# PG335 — SQL Schema Dialect Detector

## Objective

Implement and validate SQL Schema Dialect Detector for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `sql-schema-dialect-detector` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`.
...
- `sql_schema_dialect_detector_plan.json`
- `sql_schema_dialect_detector_artifacts/`
- `sql_schema_dialect_detector_verification.json`
