---
name: "elmos-effect-exception-trace-refinement"
description: "证明文件、网络、数据库、消息、日志和异常的可观察 Trace 顺序、数量、参数和补偿关系保持。 Use when the task needs the exact Effect and Exception Trace Refinement Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-effect-exception-trace-refinement/SKILL.md"
  source_sha256: "sha256:535520245a93558fe5e74950cd7aa4a9c643470a42ff371de189f8f1e6a2778a"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "cross-language"
  runtime_handler_id: "execute_elmos_effect_exception_trace_refinement"
...
---
# Effect and Exception Trace Refinement

## Repository integration boundary

- Exact Skill identity: `elmos-effect-exception-trace-refinement`; exact allowlisted runtime handler: `execute_elmos_effect_exception_trace_refinement`.
- Source identity: `skills/P0/elmos-effect-exception-trace-refinement/SKILL.md` at `sha256:535520245a93558fe5e74950cd7aa4a9c643470a42ff371de189f8f1e6a2778a` from `elmos-formal-assurance-kernel-v1.0.0`.
...
证明文件、网络、数据库、消息、日志和异常的可观察 Trace 顺序、数量、参数和补偿关系保持。
...
3. Use the repository-owned `execute_elmos_effect_exception_trace_refinement` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["effect systems","trace inclusion","exception sum types","causal alignment"]`
- Direct dependencies: `["elmos-observable-behavior-contract","elmos-semantic-ir-formal-semantics","elmos-cross-language-product-program"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-effect-exception-trace-refinement/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
