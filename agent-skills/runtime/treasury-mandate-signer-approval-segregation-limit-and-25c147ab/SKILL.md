...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/treasury-mandate-signer-approval-segregation-limit-and-25c147ab-baseline.md`.
