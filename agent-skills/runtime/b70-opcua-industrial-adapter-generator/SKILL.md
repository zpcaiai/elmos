...
# PG280 — OPC UA Industrial Adapter Generator

## Objective

Generate runnable and maintainable OPC UA Industrial Adapter Generator for C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `opcua-industrial-adapter-generator` tasks involving C/C++, compilers, CMake, ABI, FFI, memory and concurrency safety, ROS 2, OPC UA, embedded targets, Qt HMI, sanitizers, and fuzzing.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG270`, `PG279`.
...
- `opcua_industrial_adapter_generator_plan.json`
- `opcua_industrial_adapter_generator_artifacts/`
- `opcua_industrial_adapter_generator_verification.json`
