---
name: b56-composite-application-data-infrastructure-cutover-journey
description: Implement coordinated application, database, messaging, infrastructure
  and security modernization as one dependency-aware composite change set and cutover
  journey.
metadata:
  source_package: elmos-codex-skills-batch56-product-closure
  source_id: C56-06
  source_name: composite-application-data-infrastructure-cutover-journey
  source_batch: '56'
  source_maturity: reviewed-implementation-guidance
  source_sha256: sha256:1ed349b7032c793c5c1ff0663213753f6f04195aa30d29e4a5c4a47ac807278f
...
- Source identity remains `C56-06` / `composite-application-data-infrastructure-cutover-journey`; the installed alias only resolves naming constraints.
