...
description: "Run FRT-3018 Continuous Verification Scheduler for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3018"
  source_name: "frt-3018-continuous-verification-scheduler"
  source_sha256: "sha256:3e567a9d8d7b0401012b3db0b3254829b915ee8870a942d7ce2a1fb0bca8b8a5"
  batch: "G30"
...
- Runtime catalog key: `FRT-3018` / `frt-3018-continuous-verification-scheduler`.
...
在G30范围内实现 **Continuous Verification Scheduler**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Continuous Verification Scheduler** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3018Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3018EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3018FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3018CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3018-continuous-verification-scheduler/
packages/runtime/g30/frt-3018-continuous-verification-scheduler/
services/control-plane/g30/frt-3018-continuous-verification-scheduler/
apps/web-console/src/features/g30/frt-3018-continuous-verification-scheduler/
apps/admin-console/src/features/g30/frt-3018-continuous-verification-scheduler/
tests/g30/frt-3018-continuous-verification-scheduler/
```
...
```text
POST /v1/skills/frt-3018/runs
GET  /v1/skills/frt-3018/runs/{run_id}
POST /v1/skills/frt-3018/runs/{run_id}/verify
GET  /v1/skills/frt-3018/runs/{run_id}/findings
GET  /v1/skills/frt-3018/runs/{run_id}/evidence
```
