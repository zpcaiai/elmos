---
name: elmos-security-incident-psirt-disclosure-controller
description: Coordinate vulnerability intake, triage, embargo, remediation, customer notification, advisory publication, CVE/VEX updates and post-incident evidence.
version: 4.0.0
...
# Security Incident, PSIRT and Disclosure Controller
...
- **Kernel authorities used:** K1, K2, K7, K8
...
- `SecurityIncidentPSIRTAndDisclosureControllerRun`
- `SecurityIncidentPSIRTAndDisclosureControllerDecision`
- `EvidenceArtifact`
- `ProofResult`

Required semantic capabilities:

- Provide authenticated confidential reporting and duplicate correlation
- Separate severity, exploitability, product scope and disclosure decision
- Coordinate fix, backport, release, revocation and customer mitigation
- Publish machine-readable advisory and update SBOM/VEX
- Preserve evidence while respecting reporter and customer confidentiality
...
- `elmos-ai-incident-kill-switch-controller` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
- `elmos-ai-system-model-card-generator` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
...
- **reporter identity leaked** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **embargo broken** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **affected versions misstated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **notification selectively omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fix released without certificate impact** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- valid vulnerability intake
- duplicate report
- embargoed remediation
- customer notification
- advisory and VEX update
