---
name: tst-b68-kotlin-jvm-android-slightly-strict-suite
description: "Run the slightly strict test suite for Batch 68: Kotlin JVM Android and Multiplatform, covering every source Skill with positive and negative executable cases."
metadata:
  id: TB68
...
---
    # TB68 — Batch 68 Kotlin JVM Android and Multiplatform 略严苛测试套件

    ## Objective

    对 Batch 68 的全部 12 个Source Skills执行可重放的正向、边界、负向、故障、安全和证据完整性验证。范围为：Kotlin JVM、Spring、Ktor、协程、Android Compose 与 KMP。
    ...
    |---|---|---|---|
    | PG247 | `b68-kotlin-project-profile-detector` | detector | `B68-PG247-RUN, B68-PG247-NEG` |
| PG248 | `b68-gradle-kotlin-build-reproducer` | reproducer | `B68-PG248-RUN, B68-PG248-NEG` |
| PG249 | `b68-spring-kotlin-service-generator` | generator | `B68-PG249-RUN, B68-PG249-NEG` |
| PG250 | `b68-ktor-service-generator` | generator | `B68-PG250-RUN, B68-PG250-NEG` |
| PG251 | `b68-kotlin-coroutine-structured-concurrency` | concurrency | `B68-PG251-RUN, B68-PG251-NEG` |
| PG252 | `b68-kotlin-data-access-generator` | data | `B68-PG252-RUN, B68-PG252-NEG` |
| PG253 | `b68-java-kotlin-interop-manager` | generator | `B68-PG253-RUN, B68-PG253-NEG` |
| PG254 | `b68-kotlin-contract-client-generator` | contract | `B68-PG254-RUN, B68-PG254-NEG` |
| PG255 | `b68-android-compose-application-generator` | ui | `B68-PG255-RUN, B68-PG255-NEG` |
| PG256 | `b68-kotlin-multiplatform-library-generator` | generator | `B68-PG256-RUN, B68-PG256-NEG` |
| PG257 | `b68-kotlin-test-harness-generator` | test | `B68-PG257-RUN, B68-PG257-NEG` |
| PG258 | `b68-kotlin-build-run-repair-certifier` | build | `B68-PG258-RUN, B68-PG258-NEG` |
