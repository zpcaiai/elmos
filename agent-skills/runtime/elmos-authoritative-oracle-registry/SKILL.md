---
name: elmos-authoritative-oracle-registry
description: Register compiler, protocol, database, contract, property, runtime and human authorities with independence, scope, confidence, freshness and conflict rules.
version: 4.0.0
...
- Classify authoritative versus advisory oracles
- Bind oracle to subject, claim and version
- Enforce producer/verifier separation
- Resolve conflicting oracles without majority guessing
- Expire stale or revoked oracle evidence
...
- `oracle-registry.yaml`
- `oracle-scope-map.json`
- `oracle-conflict-ledger.json`
- `oracle-freshness-report.json`
...
- **LLM judge promoted as authority** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **source and target share same defect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **oracle scope too broad** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **human approval forged** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale oracle version** — must have a preventive control, a detective signal, a negative fixture and a response action.
