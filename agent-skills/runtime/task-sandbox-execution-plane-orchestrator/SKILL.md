---
name: task-sandbox-execution-plane-orchestrator
description: "Implement Batch 36B end to end: provider-neutral sandbox contracts, rootless OCI, gVisor, Kata, Firecracker, filesystem, network, secrets, syscalls, resources, malicious repositories, cleanup, and gates."
---
...
Implement Batch 36B end to end: provider-neutral sandbox contracts, rootless OCI, gVisor, Kata, Firecracker, filesystem, network, secrets, syscalls, resources, malicious repositories, cleanup, and gates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/task-sandbox-execution-plane-orchestrator-baseline.md`.
...
```text
task_sandbox_execution_plane_orchestrator_manifest.json
task_sandbox_execution_plane_orchestrator_decision.json
task_sandbox_execution_plane_orchestrator_evidence.json
```
