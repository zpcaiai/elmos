---
name: cloud-platform-observability-sla-cockpit-alerting-and-operations
description: "Implement Batch 49A Cloud Platform Engineering、Landing Zones与Developer Platform telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Cloud Account、Subscription、Landing Zone、Project、Environment、Template、Policy、Developer Portal与Golden Path."
---

# Cloud Platform Observability SLA Cockpit Alerting And Operations

## Objective

Implement Batch 49A Cloud Platform Engineering、Landing Zones与Developer Platform telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Cloud Account、Subscription、Landing Zone、Project、Environment、Template、Policy、Developer Portal与Golden Path.
...
5. Write unresolved domain assumptions to `docs/implementation/cloud-platform-observability-sla-cockpit-alerting-and-operations-baseline.md`.
...
```text
cloud_platform_observability_sla_cockpit_alerting_and_operations_manifest.json
cloud_platform_observability_sla_cockpit_alerting_and_operations_state.json
cloud_platform_observability_sla_cockpit_alerting_and_operations_decision.json
cloud_platform_observability_sla_cockpit_alerting_and_operations_reconciliation.json
cloud_platform_observability_sla_cockpit_alerting_and_operations_evidence.json
```
