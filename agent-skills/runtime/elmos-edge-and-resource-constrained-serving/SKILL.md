---
name: edge-and-resource-constrained-serving
description: Use this skill when Elmos must perform edge and resource constrained serving as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# edge-and-resource-constrained-serving

## 能力目标

对小模型、量化、CPU/NPU 和边缘设备进行适配与能力降级。
