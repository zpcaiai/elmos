...
description: "Invoke the bounded repository handler for elmos-harness-runtime-platform while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_key: "P01"
  source_name: "elmos-harness-runtime-platform"
  installed_name: "elmos-harness-runtime-platform"
  source_logical_path: "01-elmos-harness-runtime-platform/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/01-elmos-harness-runtime-platform/SKILL.md.source-data"
  source_materialized_path: "01-elmos-harness-runtime-platform/SKILL.md.source-data"
  source_sha256: "sha256:6d970bb318f9cbe2c672b1aff243633e317060db92d2818c0a85290e3b14c41b"
...
- This is a deterministic repository wrapper for `01-elmos-harness-runtime-platform/SKILL.md` at `sha256:6d970bb318f9cbe2c672b1aff243633e317060db92d2818c0a85290e3b14c41b`.
- Its immutable source/runtime identity is `elmos-harness-runtime-platform`; its active installed identity is `elmos-harness-runtime-platform`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-harness-runtime-platform --request <file>
```
