---
name: responsible-ai-orchestrator
description: "Implement Batch 45C Responsible AI、Safety、Governance与Compliance end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval."
---
...
Implement Batch 45C Responsible AI、Safety、Governance与Compliance end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval.
...
5. Write unresolved domain assumptions to `docs/implementation/responsible-ai-orchestrator-baseline.md`.
...
```text
responsible_ai_orchestrator_manifest.json
responsible_ai_orchestrator_state.json
responsible_ai_orchestrator_decision.json
responsible_ai_orchestrator_reconciliation.json
responsible_ai_orchestrator_evidence.json
```
