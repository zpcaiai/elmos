---
name: pm-b42-migration-wave-planner
description: "按依赖、风险、价值、团队和维护窗口组织迁移波次. Precision Migration B42 contract; use for this exact assessment, transformation, validation, repair, evidence, or cutover scope."
---
...
按依赖、风险、价值、团队和维护窗口组织迁移波次。

本 Skill 属于精密语言转换系统。它必须以**可执行证据**为准，不得用模型自评、源码相似度或“能编译”替代语义与行为验证。

## Use when

- 当前任务直接涉及 `migration-wave-planner` 所描述的能力。
...
1. 汇总证据与未解决项
2. 执行本 Skill 的核心职责：按依赖、风险、价值、团队和维护窗口组织迁移波次。
3. 执行硬性发布门禁
4. 影子/Canary/渐进切换
5. 监控并自动回滚
6. 沉淀反例、规则和企业交付能力
