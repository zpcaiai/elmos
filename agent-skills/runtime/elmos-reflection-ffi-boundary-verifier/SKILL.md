---
name: "elmos-reflection-ffi-boundary-verifier"
description: "对反射、动态加载、native/FFI、宏生成和外部运行时建立闭世界清单、契约桩和运行时监控边界。 Use when the task needs the exact Reflection and FFI Boundary Verifier Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P2/elmos-reflection-ffi-boundary-verifier/SKILL.md"
  source_sha256: "sha256:3c627a621f0859c6abdba348e90ca695df37f96a6daeba6ae9adef7ab6740b4a"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P2"
  domain: "cross-language"
  runtime_handler_id: "execute_elmos_reflection_ffi_boundary_verifier"
...
---
# Reflection and FFI Boundary Verifier

## Repository integration boundary

- Exact Skill identity: `elmos-reflection-ffi-boundary-verifier`; exact allowlisted runtime handler: `execute_elmos_reflection_ffi_boundary_verifier`.
- Source identity: `skills/P2/elmos-reflection-ffi-boundary-verifier/SKILL.md` at `sha256:3c627a621f0859c6abdba348e90ca695df37f96a6daeba6ae9adef7ab6740b4a` from `elmos-formal-assurance-kernel-v1.0.0`.
...
对反射、动态加载、native/FFI、宏生成和外部运行时建立闭世界清单、契约桩和运行时监控边界。
...
3. Use the repository-owned `execute_elmos_reflection_ffi_boundary_verifier` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["closed-world enumeration","contract stubs","runtime attestation","boundary monitoring"]`
- Direct dependencies: `["elmos-assumption-ledger","elmos-trusted-computing-base-registry","elmos-language-semantic-profile","elmos-semantic-ir-formal-semantics"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P2/elmos-reflection-ffi-boundary-verifier/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
