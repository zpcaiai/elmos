...
description: "Run FRT-1213 Platform Capability Certification for FRT G12 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1213"
  source_name: "frt-1213-platform-capability-certification"
  source_sha256: "sha256:94a246c0d9b2da7d7dbf628086c0c7101dab3f5de3ddcf40d0e1aadb493ad231"
  batch: "G12"
...
- Runtime catalog key: `FRT-1213` / `frt-1213-platform-capability-certification`.
...
# FRT-1213 — Platform Capability Certification

## Objective

在G12范围内实现 **Platform Capability Certification**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨平台Capability Registry与支持等级; Native Bridge具备Schema、Permission、Timeout和Error Contract; 支付、设备和危险能力使用Server Authority与安全状态机。

## When to Use

- 实现或修改与 **Platform Capability Certification** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1213Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1213EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1213FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1213CertificateFragment`：供G12批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g12/frt-1213-platform-capability-certification/
packages/runtime/g12/frt-1213-platform-capability-certification/
services/control-plane/g12/frt-1213-platform-capability-certification/
apps/web-console/src/features/g12/frt-1213-platform-capability-certification/
apps/admin-console/src/features/g12/frt-1213-platform-capability-certification/
tests/g12/frt-1213-platform-capability-certification/
```
...
```text
POST /v1/skills/frt-1213/runs
GET  /v1/skills/frt-1213/runs/{run_id}
POST /v1/skills/frt-1213/runs/{run_id}/verify
GET  /v1/skills/frt-1213/runs/{run_id}/findings
GET  /v1/skills/frt-1213/runs/{run_id}/evidence
```
