---
name: human-edit-causal-attribution
description: Use this skill when Elmos must perform human edit causal attribution as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# human-edit-causal-attribution

## 能力目标

判断人工修改是修错、补需求、偏好、环境差异还是格式调整。
