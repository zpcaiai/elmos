...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/product-catalog-price-book-plan-rate-card-entitlement-d-3b2357f2-baseline.md`.
