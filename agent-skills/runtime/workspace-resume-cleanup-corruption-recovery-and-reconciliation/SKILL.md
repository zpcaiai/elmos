---
name: workspace-resume-cleanup-corruption-recovery-and-reconciliation
description: "Implement workspace checkpoints, interrupted clone/fetch recovery, lock handling, corruption detection, cleanup, orphan scanning, and reconciliation."
---
...
Implement workspace checkpoints, interrupted clone/fetch recovery, lock handling, corruption detection, cleanup, orphan scanning, and reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/workspace-resume-cleanup-corruption-recovery-and-reconciliation-baseline.md`.
...
```text
workspace_resume_cleanup_corruption_recovery_and_reconciliation_manifest.json
workspace_resume_cleanup_corruption_recovery_and_reconciliation_decision.json
workspace_resume_cleanup_corruption_recovery_and_reconciliation_evidence.json
```
