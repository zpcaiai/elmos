---
name: citation-and-source-binding
description: Use this skill when Elmos must perform citation and source binding as part of the 03-retrieval-context-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# citation-and-source-binding

## 能力目标

让每个关键事实、建议和变换都绑定来源对象、版本和位置。
