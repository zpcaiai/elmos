---
name: object-lock-retention-legal-hold-records-management-and-6b853d65
description: 实现精确对象版本 Retention、Governance/Compliance Lock、Legal Hold 与 Disposition。
metadata:
  elmos_batch: "37A"
  elmos_skill_id: "ART37A012"
  pack_version: "3.7-complete"
---

# ART37A012 — Object Lock、Retention、Legal Hold 与 Records Disposition

## Objective

实现精确对象版本 Retention、Governance/Compliance Lock、Legal Hold 与 Disposition。
...
- 发现 Provider Versioning/Object Lock/Legal Hold 能力。
- Governance Bypass 需 JIT/审批；Compliance 不提供提前删除路径。
- Retention Expiry 进入 Disposition Review，而非自动删除。
- 删除前检查 Attestation、Pack、Verification、Audit、Incident 与 Hold 引用。
...
- retentionBindsExactObjectVersion
- complianceRetentionCannotBeShortened
- legalHoldIsIndependentOfRetentionDate
- deletionCreatesReceiptAndTombstone
