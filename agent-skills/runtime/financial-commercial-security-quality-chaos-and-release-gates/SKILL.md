---
name: financial-commercial-security-quality-chaos-and-release-gates
description: "Implement financial invariants, property tests, billing simulations, tax and eInvoice conformance, journal balancing, close tests, provider chaos, security, privacy, scale and mandatory release gates."
---
...
Implement financial invariants, property tests, billing simulations, tax and eInvoice conformance, journal balancing, close tests, provider chaos, security, privacy, scale and mandatory release gates.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/financial-commercial-security-quality-chaos-and-release-gates-baseline.md`.
...
```text
financial_commercial_security_quality_chaos_and_release_gates_manifest.json
financial_commercial_security_quality_chaos_and_release_gates_decision.json
financial_commercial_security_quality_chaos_and_release_gates_reconciliation.json
financial_commercial_security_quality_chaos_and_release_gates_evidence.json
```
...
prohibitedAuthenticationDataIsNotStored
secretIsRedactedBeforePersistence
