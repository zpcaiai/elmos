...
description: "Run FRT-2102 Business Capability Map Generator for FRT G21 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2102"
  source_name: "frt-2102-business-capability-map-generator"
  source_sha256: "sha256:004fbd93365513f0056bfd2d6b014497f07519e0671f5528bb1c42df55647bee"
  batch: "G21"
...
- Runtime catalog key: `FRT-2102` / `frt-2102-business-capability-map-generator`.
...
在G21范围内实现 **Business Capability Map Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：统一 Product Closure Graph; Requirement、Capability、Journey、Command、API、Data、Permission、Test、Monitoring、Runbook、Certificate 双向追踪; 孤儿 UI/API/Command/Event/Data Write 检测。

## When to Use

- 实现或修改与 **Business Capability Map Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2102Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2102EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2102FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2102CertificateFragment`：供G21批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g21/frt-2102-business-capability-map-generator/
packages/runtime/g21/frt-2102-business-capability-map-generator/
services/control-plane/g21/frt-2102-business-capability-map-generator/
apps/web-console/src/features/g21/frt-2102-business-capability-map-generator/
apps/admin-console/src/features/g21/frt-2102-business-capability-map-generator/
tests/g21/frt-2102-business-capability-map-generator/
```
...
```text
POST /v1/skills/frt-2102/runs
GET  /v1/skills/frt-2102/runs/{run_id}
POST /v1/skills/frt-2102/runs/{run_id}/verify
GET  /v1/skills/frt-2102/runs/{run_id}/findings
GET  /v1/skills/frt-2102/runs/{run_id}/evidence
```
