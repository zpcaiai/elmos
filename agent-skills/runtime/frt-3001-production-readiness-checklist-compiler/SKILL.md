...
description: "Run FRT-3001 Production Readiness Checklist Compiler for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3001"
  source_name: "frt-3001-production-readiness-checklist-compiler"
  source_sha256: "sha256:93a98bd430eccf1482a564ad076965a1c1c9606d5f90c3c2153fcb83c7a14721"
  batch: "G30"
...
- Runtime catalog key: `FRT-3001` / `frt-3001-production-readiness-checklist-compiler`.
...
在G30范围内实现 **Production Readiness Checklist Compiler**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Production Readiness Checklist Compiler** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3001Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3001EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3001FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3001CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3001-production-readiness-checklist-compiler/
packages/runtime/g30/frt-3001-production-readiness-checklist-compiler/
services/control-plane/g30/frt-3001-production-readiness-checklist-compiler/
apps/web-console/src/features/g30/frt-3001-production-readiness-checklist-compiler/
apps/admin-console/src/features/g30/frt-3001-production-readiness-checklist-compiler/
tests/g30/frt-3001-production-readiness-checklist-compiler/
```
...
```text
POST /v1/skills/frt-3001/runs
GET  /v1/skills/frt-3001/runs/{run_id}
POST /v1/skills/frt-3001/runs/{run_id}/verify
GET  /v1/skills/frt-3001/runs/{run_id}/findings
GET  /v1/skills/frt-3001/runs/{run_id}/evidence
```
