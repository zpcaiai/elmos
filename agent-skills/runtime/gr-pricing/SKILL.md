---
name: gr-pricing
description: 按 SKU、ERSS、RCS、迁移面、验证深度、部署/SLA、许可和风险计算报价。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-084
  source_name: gr-pricing
  source_path: skills/gr-pricing/SKILL.md
  source_sha256: sha256:5ede33dea6c7f28e625209a331d70d77561e9bab0357b9ca6fd65b651b0e555b
  source_contract_sha256: sha256:7ecc07d71afab86a4f69e141503db628957809dec09d620738b26f8163a6235a
...
按 SKU、ERSS、RCS、迁移面、验证深度、部署/SLA、许可和风险计算报价。
...
- [ ] 定义 `gr-pricing` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-pricing` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：pricing-quote.json, sensitivity.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：pricing-quote.json, sensitivity.json。
...
- Machine contract: `references/contract.json` (`sha256:7ecc07d71afab86a4f69e141503db628957809dec09d620738b26f8163a6235a`).
