---
name: control-catalog-oscal-mapping-assessment-and-continuous-43b7e09f
description: 实现Control Catalog/Profile/Mapping、Responsibility、Assessment、Evidence、Continuous Monitor与POA&M。
metadata:
  elmos_batch: "37C"
  elmos_skill_id: "ANA37C006"
  pack_version: "3.7-complete"
---

# ANA37C006 — Control Catalog、OSCAL Mapping、Assessment 与 Continuous Monitoring

## Objective

实现Control Catalog/Profile/Mapping、Responsibility、Assessment、Evidence、Continuous Monitor与POA&M。
...
- 支持 OSCAL Catalog/Profile/Component Definition/SSP/Assessment Plan/Results/POA&M/Mapping。
- Mapping状态区分Partial/Related/Superset/Subset/Conflict/Unreviewed，不等同Equivalent。
- Assessment Method保存 Examine/Interview/Test/Automated Observation。
- Continuous Monitor只产生System Observation，不替代独立审计。
...
- oscal122SchemaIsValidated
- controlMappingDoesNotImplyEquivalence
- evidencePresenceAloneDoesNotSatisfyControl
- poamOpenItemAffectsAssurance
