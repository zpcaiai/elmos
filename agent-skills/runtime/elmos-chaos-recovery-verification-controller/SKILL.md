---
name: elmos-chaos-recovery-verification-controller
description: Inject worker, process, network, storage, provider, database and region failures and verify checkpoint, fencing, reconciliation, RTO/RPO and safe degradation.
version: 4.0.0
...
# Chaos and Recovery Verification Controller
...
- Generate failure campaigns from architecture graph
- Inject faults at deterministic checkpoints
- Verify lease/fencing and idempotency
- Measure RTO/RPO and data loss
- Block on unknown side effects or silent degradation
...
- `unreconciled-side-effects.json`
...
- **chaos affects unrelated tenant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fault not actually injected** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **automatic retry duplicates write** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **RTO measured from wrong point** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **recovery test skips data reconciliation** — must have a preventive control, a detective signal, a negative fixture and a response action.
