---
name: elmos-public-sector-high-impact-ai-assurance-profile
description: Implement and independently certify public-sector high-impact ai assurance profile, including compile rights, due process, transparency, records, accessibility and procurement controls, require human review, contestability and public impact evidence for high-impact decisions and support audit, disclosure, incident and vendor accountability.
version: 4.0.0
...
# Public-Sector High-Impact AI Assurance Profile

## Objective

Implement and independently certify public-sector high-impact ai assurance profile, including compile rights, due process, transparency, records, accessibility and procurement controls, require human review, contestability and public impact evidence for high-impact decisions and support audit, disclosure, incident and vendor accountability.
...
- `PublicSectorHighImpactAIAssuranceProfileProfile`
- `PublicSectorHighImpactAIAssuranceProfileRun`
- `PublicSectorHighImpactAIAssuranceProfileFinding`
- `PublicSectorHighImpactAIAssuranceProfileDecision`
- `PublicSectorHighImpactAIAssuranceProfileEvidence`

Required semantic capabilities:

- compile rights, due process, transparency, records, accessibility and procurement controls
- require human review, contestability and public impact evidence for high-impact decisions
- support audit, disclosure, incident and vendor accountability
...
- `artifacts/elmos-public-sector-high-impact-ai-assurance-profile/profile.yaml`
- `artifacts/elmos-public-sector-high-impact-ai-assurance-profile/plan.json`
- `artifacts/elmos-public-sector-high-impact-ai-assurance-profile/result.json`
- `artifacts/elmos-public-sector-high-impact-ai-assurance-profile/evidence/`
- `artifacts/elmos-public-sector-high-impact-ai-assurance-profile/assurance-case.json`
...
- **vendor secrecy prevents due process** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **automation replaces legally required official decision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **public notice omits known limitation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile rights, due process, transparency, records, accessibility and procurement controls
- native scenario: require human review, contestability and public impact evidence for high-impact decisions
- native scenario: support audit, disclosure, incident and vendor accountability
