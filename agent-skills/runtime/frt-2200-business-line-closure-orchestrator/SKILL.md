...
description: "Run FRT-2200 Business Line Closure Orchestrator for FRT G22 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2200"
  source_name: "frt-2200-business-line-closure-orchestrator"
  source_sha256: "sha256:b8181a2988f7b8062f71969ef2e388363b3d8744b0d7b5c2c20e186d4874afe6"
  batch: "G22"
...
- Runtime catalog key: `FRT-2200` / `frt-2200-business-line-closure-orchestrator`.
...
在G22范围内实现 **Business Line Closure Orchestrator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Value Stream 与业务Outcome建模; 状态机可达性、终态、Timeout、Cancel、Unknown、Recovery完整性; 跨域Saga、幂等、补偿和Reconciliation。

## When to Use

- 实现或修改与 **Business Line Closure Orchestrator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2200Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2200EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2200FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2200CertificateFragment`：供G22批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g22/frt-2200-business-line-closure-orchestrator/
packages/runtime/g22/frt-2200-business-line-closure-orchestrator/
services/control-plane/g22/frt-2200-business-line-closure-orchestrator/
apps/web-console/src/features/g22/frt-2200-business-line-closure-orchestrator/
apps/admin-console/src/features/g22/frt-2200-business-line-closure-orchestrator/
tests/g22/frt-2200-business-line-closure-orchestrator/
```
...
```text
POST /v1/skills/frt-2200/runs
GET  /v1/skills/frt-2200/runs/{run_id}
POST /v1/skills/frt-2200/runs/{run_id}/verify
GET  /v1/skills/frt-2200/runs/{run_id}/findings
GET  /v1/skills/frt-2200/runs/{run_id}/evidence
```
