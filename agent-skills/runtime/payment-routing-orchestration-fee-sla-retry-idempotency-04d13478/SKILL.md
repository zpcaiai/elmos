...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/payment-routing-orchestration-fee-sla-retry-idempotency-04d13478-baseline.md`.
