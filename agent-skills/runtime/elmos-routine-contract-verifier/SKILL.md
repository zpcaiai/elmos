---
name: "elmos-routine-contract-verifier"
description: "把存储过程/函数编译为 CFG/SSA 和数据库状态转换，证明前置、后置、修改集、异常、事务与终止性。 Use when the task needs the exact SQL Routine Contract Verifier Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-routine-contract-verifier/SKILL.md"
  source_sha256: "sha256:140db422273432cf11504b39698f68efe099988ecfd17e17b8e6934066a5ce27"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "sql-conversion"
  runtime_handler_id: "execute_elmos_routine_contract_verifier"
...
---
# SQL Routine Contract Verifier

## Repository integration boundary

- Exact Skill identity: `elmos-routine-contract-verifier`; exact allowlisted runtime handler: `execute_elmos_routine_contract_verifier`.
- Source identity: `skills/P0/elmos-routine-contract-verifier/SKILL.md` at `sha256:140db422273432cf11504b39698f68efe099988ecfd17e17b8e6934066a5ce27` from `elmos-formal-assurance-kernel-v1.0.0`.
...
把存储过程/函数编译为 CFG/SSA 和数据库状态转换，证明前置、后置、修改集、异常、事务与终止性。
...
3. Use the repository-owned `execute_elmos_routine_contract_verifier` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["Hoare logic","Boogie VC generation","symbolic execution","loop invariants"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-routine-contract-verifier/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
