...
description: Use this skill when Elmos must perform cross source entity resolution as part of the 02-repository-semantic-intelligence
...
合并文档、代码、数据库、Issue 和运行数据中的同一实体并保留别名。
