---
name: workflow-bpm-domain-model-lifecycle-and-state-machine
description: "Implement Batch 46B Workflow、BPM、Case与Low-code Automation canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work."
---

# Workflow BPM Domain Model Lifecycle And State Machine

## Objective

Implement Batch 46B Workflow、BPM、Case与Low-code Automation canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work.
...
5. Write unresolved domain assumptions to `docs/implementation/workflow-bpm-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
workflow_bpm_domain_model_lifecycle_and_state_machine_manifest.json
workflow_bpm_domain_model_lifecycle_and_state_machine_state.json
workflow_bpm_domain_model_lifecycle_and_state_machine_decision.json
workflow_bpm_domain_model_lifecycle_and_state_machine_reconciliation.json
workflow_bpm_domain_model_lifecycle_and_state_machine_evidence.json
```
