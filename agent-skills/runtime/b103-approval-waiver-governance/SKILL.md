---
name: b103-approval-waiver-governance
description: "Use when ELMOS must Govern approvals and tightly bounded expiring waivers with separation of duties and non-waivable P0 rules. Triggers: Approval and Waiver Governance, Evidence and Certification Fabric Pack, approvals, waivers, expiry, separation of duties."
metadata:
  id: B103-S08
...
# B103-S08 — Approval and Waiver Governance

## Objective

Govern approvals and tightly bounded expiring waivers with separation of duties and non-waivable P0 rules.
...
Use this Skill when the approved task explicitly requires **Approval and Waiver Governance** or when the capability graph selects it as part of a minimal dependency closure.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b103-approval-waiver-governance/SKILL.md --out /tmp/approval_waiver_governance.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B103-S08
```
...
- Reject or expose self-waiver.
- Reject or expose scope wildcard.
- Reject or expose expired waiver accepted.
