---
name: b77-dockerfile-multistage-generator
description: "Use when ELMOS must generate runnable and maintainable Dockerfile Multistage Generator for Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Dockerfile Multistage Generator, Batch 77, Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification."
metadata:
  id: PG364
  batch: 77
  version: 1.0.0
...
# PG364 — Dockerfile Multistage Generator

## Objective

Generate runnable and maintainable Dockerfile Multistage Generator for Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `dockerfile-multistage-generator` tasks involving Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG362`, `PG363`.
...
- `dockerfile_multistage_generator_plan.json`
- `dockerfile_multistage_generator_artifacts/`
- `dockerfile_multistage_generator_verification.json`
...
- Pin base images by digest policy.
- Use minimal non-root runtime stages where feasible.
- Test signal handling, health, shutdown, and final-image scans.
