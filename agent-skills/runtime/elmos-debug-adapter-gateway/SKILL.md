...
metadata:
  ...
  source_path: "skills/44-debug-adapter-gateway/SKILL.md"
  source_sha256: "sha256:758ab6e0316cfcd67beb156d2bbed63852a9e040d14ce1f1485da42832dcd1a7"
  source_tree_sha256: "sha256:ab4476a5810bb843b64dbf29cbd12e57c3bfead22f171139da139042adb9169e"
  ...
  runtime_handler_id: "negotiate_debug_adapter"
  capability_state: "PARTIAL"
  expected_success_code: "DEBUG_CAPABILITIES_NEGOTIATED"
...
- This installed interface is pinned to `elmos-project-intelligence-skills` `1.1.0`, source `skills/44-debug-adapter-gateway/SKILL.md`, and `sha256:758ab6e0316cfcd67beb156d2bbed63852a9e040d14ce1f1485da42832dcd1a7`.
...
- Direct dependencies are `["elmos-reference-architecture", "elmos-multilanguage-parsing", "elmos-observability-slo"]`. Preserve their direction and explicit unavailable states.
...
- This Skill is bound exactly to repository-owned handler `negotiate_debug_adapter` with bounded capability state `PARTIAL`, expected success code `DEBUG_CAPABILITIES_NEGOTIATED`, and local result state `PARTIAL_LOCAL_EXECUTED`. Dispatch is allowlisted; no fallback or name-derived handler exists.
