---
name: elmos-enterprise-identity-sso-scim-generator
description: Generate OIDC/SAML SSO, SCIM lifecycle, group/role mapping, session, MFA, service identity and break-glass integration.
version: 4.0.0
...
# Enterprise Identity, SSO and SCIM Generator
...
- `EnterpriseIdentitySSOAndSCIMGeneratorProfile`
- `EnterpriseIdentitySSOAndSCIMGeneratorPlan`
- `EnterpriseIdentitySSOAndSCIMGeneratorRun`
- `EnterpriseIdentitySSOAndSCIMGeneratorDecision`

Required semantic capabilities:

- integrate identity provider metadata and key rotation
- map users/groups to tenant roles and policies
- provision/deprovision through SCIM
- enforce session/MFA and step-up
- test orphaned access and emergency recovery
...
- `artifacts/elmos-enterprise-identity-sso-scim-generator/profile.yaml`
- `artifacts/elmos-enterprise-identity-sso-scim-generator/plan.json`
- `artifacts/elmos-enterprise-identity-sso-scim-generator/result.json`
- `artifacts/elmos-enterprise-identity-sso-scim-generator/evidence/`
...
- **deprovisioning delayed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **group mapping grants admin** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **IdP metadata spoofed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **service identity confused with human** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **break-glass bypass permanent** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: integrate identity provider metadata and key rotation
- native scenario: map users/groups to tenant roles and policies
- native scenario: provision/deprovision through SCIM
- native scenario: enforce session/MFA and step-up
- native scenario: test orphaned access and emergency recovery
