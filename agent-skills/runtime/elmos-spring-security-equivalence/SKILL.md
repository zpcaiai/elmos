---
name: spring-security-equivalence
description: Use this skill when Elmos must perform spring security equivalence as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# spring-security-equivalence

## 能力目标

保持认证、授权、CSRF、Session Fixation、密码和方法级安全。
