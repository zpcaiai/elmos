...
metadata:
  ...
  repository_handler_id: "handle_elmos_bigdata_project_orchestrator"
  repository_handler_path: "engines/database-bigdata-engine/src/elmos_database_bigdata/handlers/orchestration.py"
