...
description: "Run FRT-2513 Responsive and Adaptive Acceptance for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2513"
  source_name: "frt-2513-responsive-and-adaptive-acceptance"
  source_sha256: "sha256:13879f41d7471b9a61a0a8e58abe82b99464439fe310940a321a62a3e761bb1f"
  batch: "G25"
...
- Runtime catalog key: `FRT-2513` / `frt-2513-responsive-and-adaptive-acceptance`.
...
在G25范围内实现 **Responsive and Adaptive Acceptance**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Responsive and Adaptive Acceptance** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2513Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2513EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2513FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2513CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2513-responsive-and-adaptive-acceptance/
packages/runtime/g25/frt-2513-responsive-and-adaptive-acceptance/
services/control-plane/g25/frt-2513-responsive-and-adaptive-acceptance/
apps/web-console/src/features/g25/frt-2513-responsive-and-adaptive-acceptance/
apps/admin-console/src/features/g25/frt-2513-responsive-and-adaptive-acceptance/
tests/g25/frt-2513-responsive-and-adaptive-acceptance/
```
...
```text
POST /v1/skills/frt-2513/runs
GET  /v1/skills/frt-2513/runs/{run_id}
POST /v1/skills/frt-2513/runs/{run_id}/verify
GET  /v1/skills/frt-2513/runs/{run_id}/findings
GET  /v1/skills/frt-2513/runs/{run_id}/evidence
```
