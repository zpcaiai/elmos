...
# Cryptographic Algorithm Test-Vector Certifier
...
- `CryptographicAlgorithmTestVectorCertifierProfile`
- `CryptographicAlgorithmTestVectorCertifierRun`
- `CryptographicAlgorithmTestVectorCertifierFinding`
- `CryptographicAlgorithmTestVectorCertifierDecision`
- `CryptographicAlgorithmTestVectorCertifierEvidence`

Required semantic capabilities:

- execute known-answer, Monte Carlo, negative and edge test vectors against exact implementation
- bind algorithm, parameter set, implementation and platform digests
- export ACVP-compatible evidence where authorized
...
- `elmos-cryptographic-module-validation-readiness-governor`

## Primary Outputs

- `artifacts/elmos-cryptographic-algorithm-test-vector-certifier/profile.yaml`
- `artifacts/elmos-cryptographic-algorithm-test-vector-certifier/plan.json`
- `artifacts/elmos-cryptographic-algorithm-test-vector-certifier/result.json`
- `artifacts/elmos-cryptographic-algorithm-test-vector-certifier/evidence/`
- `artifacts/elmos-cryptographic-algorithm-test-vector-certifier/assurance-case.json`
...
- **test vector parser accepts malformed response** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **different binary is deployed after testing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **algorithm mode alias maps to non-approved primitive** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: execute known-answer, Monte Carlo, negative and edge test vectors against exact implementation
- native scenario: bind algorithm, parameter set, implementation and platform digests
- native scenario: export ACVP-compatible evidence where authorized
