---
name: elmos-certification-body-financial-liability-risk-governor
description: Implement and independently certify certification body financial and liability risk governor, including assess financial stability, liability, insurance and revenue concentration threats to impartial operation, separate sales incentives from technical decisions and maintain contingency for certificate records, appeals and surveillance continuity.
version: 4.0.0
...
# Certification Body Financial and Liability Risk Governor
...
- `CertificationBodyFinancialAndLiabilityRiskGovernorProfile`
- `CertificationBodyFinancialAndLiabilityRiskGovernorRun`
- `CertificationBodyFinancialAndLiabilityRiskGovernorFinding`
- `CertificationBodyFinancialAndLiabilityRiskGovernorDecision`
- `CertificationBodyFinancialAndLiabilityRiskGovernorEvidence`

Required semantic capabilities:

- assess financial stability, liability, insurance and revenue concentration threats to impartial operation
- separate sales incentives from technical decisions
- maintain contingency for certificate records, appeals and surveillance continuity
...
- `artifacts/elmos-certification-body-financial-liability-risk-governor/profile.yaml`
- `artifacts/elmos-certification-body-financial-liability-risk-governor/plan.json`
- `artifacts/elmos-certification-body-financial-liability-risk-governor/result.json`
- `artifacts/elmos-certification-body-financial-liability-risk-governor/evidence/`
- `artifacts/elmos-certification-body-financial-liability-risk-governor/assurance-case.json`
...
- **customer loss threatens adverse decision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **insurance exclusion hides high-risk sector** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **business failure makes certificate status unavailable** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: assess financial stability, liability, insurance and revenue concentration threats to impartial operation
- native scenario: separate sales incentives from technical decisions
- native scenario: maintain contingency for certificate records, appeals and surveillance continuity
