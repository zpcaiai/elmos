...
description: "Run FRT-2004 Pack Marketplace for FRT G20 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2004"
  source_name: "frt-2004-pack-marketplace"
  source_sha256: "sha256:35124c2d17518aba41b1595064c94739f78e76a1dd9a1483d6bf288a4c9c444d"
  batch: "G20"
...
- Runtime catalog key: `FRT-2004` / `frt-2004-pack-marketplace`.
...
# FRT-2004 — Pack Marketplace

## Objective

在G20范围内实现 **Pack Marketplace**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：提供Skill SDK、Runtime、Registry和Marketplace; 实现CLI、API、IDE、Web Console和Multi-Tenant Workspace; Durable Workflow与分布式Worker支持暂停、恢复、取消和幂等。

## When to Use

- 实现或修改与 **Pack Marketplace** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2004Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2004EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2004FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2004CertificateFragment`：供G20批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g20/frt-2004-pack-marketplace/
packages/runtime/g20/frt-2004-pack-marketplace/
services/control-plane/g20/frt-2004-pack-marketplace/
apps/web-console/src/features/g20/frt-2004-pack-marketplace/
apps/admin-console/src/features/g20/frt-2004-pack-marketplace/
tests/g20/frt-2004-pack-marketplace/
```
...
```text
POST /v1/skills/frt-2004/runs
GET  /v1/skills/frt-2004/runs/{run_id}
POST /v1/skills/frt-2004/runs/{run_id}/verify
GET  /v1/skills/frt-2004/runs/{run_id}/findings
GET  /v1/skills/frt-2004/runs/{run_id}/evidence
```
