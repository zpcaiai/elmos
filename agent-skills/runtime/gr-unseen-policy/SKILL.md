---
name: gr-unseen-policy
description: 定义首次接触、无仓库专用预处理、无 holdout 泄漏和家族独立性。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-074
  source_name: gr-unseen-policy
  source_path: skills/gr-unseen-policy/SKILL.md
  source_sha256: sha256:0aa727de228a955c253b276e8a0e0c7479210896e8339d78ae5feaace0e4681e
  source_contract_sha256: sha256:5b75584e9f511495ca92017e759a911cd9f92561ac68caffe31ca07152c8b987
...
# Unseen Repository Policy

## Objective

定义首次接触、无仓库专用预处理、无 holdout 泄漏和家族独立性。

## Scope and capabilities

- Rule creation timestamp
- Repository family fingerprint
- Access audit
- Allowed general recipes
- Independent review
...
- unseen-declaration.json
- eligibility-audit.json
...
- [ ] 定义 `gr-unseen-policy` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-unseen-policy` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：unseen-declaration.json, eligibility-audit.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：unseen-declaration.json, eligibility-audit.json。
...
- Machine contract: `references/contract.json` (`sha256:5b75584e9f511495ca92017e759a911cd9f92561ac68caffe31ca07152c8b987`).
