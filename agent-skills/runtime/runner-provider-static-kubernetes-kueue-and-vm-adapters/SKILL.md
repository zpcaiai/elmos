---
name: runner-provider-static-kubernetes-kueue-and-vm-adapters
description: "Implement provider-neutral runner adapters for static hosts, Kubernetes Jobs, Kueue, VMs, private clouds, and provider reconciliation."
---
...
Implement provider-neutral runner adapters for static hosts, Kubernetes Jobs, Kueue, VMs, private clouds, and provider reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-provider-static-kubernetes-kueue-and-vm-adapters-baseline.md`.
...
```text
runner_provider_static_kubernetes_kueue_and_vm_adapters_manifest.json
runner_provider_static_kubernetes_kueue_and_vm_adapters_decision.json
runner_provider_static_kubernetes_kueue_and_vm_adapters_evidence.json
```
