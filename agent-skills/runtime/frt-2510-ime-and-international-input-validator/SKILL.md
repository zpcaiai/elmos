...
description: "Run FRT-2510 IME and International Input Validator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2510"
  source_name: "frt-2510-ime-and-international-input-validator"
  source_sha256: "sha256:50db834f8c2dfb405917ded6fcf34db28b5d4828af94e623e07f498dd8788d21"
  batch: "G25"
...
- Runtime catalog key: `FRT-2510` / `frt-2510-ime-and-international-input-validator`.
...
在G25范围内实现 **IME and International Input Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **IME and International Input Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2510Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2510EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2510FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2510CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2510-ime-and-international-input-validator/
packages/runtime/g25/frt-2510-ime-and-international-input-validator/
services/control-plane/g25/frt-2510-ime-and-international-input-validator/
apps/web-console/src/features/g25/frt-2510-ime-and-international-input-validator/
apps/admin-console/src/features/g25/frt-2510-ime-and-international-input-validator/
tests/g25/frt-2510-ime-and-international-input-validator/
```
...
```text
POST /v1/skills/frt-2510/runs
GET  /v1/skills/frt-2510/runs/{run_id}
POST /v1/skills/frt-2510/runs/{run_id}/verify
GET  /v1/skills/frt-2510/runs/{run_id}/findings
GET  /v1/skills/frt-2510/runs/{run_id}/evidence
```
