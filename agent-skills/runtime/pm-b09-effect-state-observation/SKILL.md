...
- Invoke this repository Skill as `$pm-b09-effect-state-observation`.
- Immutable source identity: `batch-09-effect-state-observation` in `precision-migration-b01-44` (B09).
- Runtime adapter: `semantic-recovery-and-ir`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b09-effect-state-observation`.
...
- 当任务涉及 **effect-system** 时，调用 `../pm-b09-effect-system/SKILL.md`。
- 当任务涉及 **database-effect-model** 时，调用 `../pm-b09-database-effect-model/SKILL.md`。
- 当任务涉及 **message-effect-model** 时，调用 `../pm-b09-message-effect-model/SKILL.md`。
- 当任务涉及 **external-call-effect-model** 时，调用 `../pm-b09-external-call-effect-model/SKILL.md`。
- 当任务涉及 **resource-lifecycle-model** 时，调用 `../pm-b09-resource-lifecycle-model/SKILL.md`。
- 当任务涉及 **transaction-effect-model** 时，调用 `../pm-b09-transaction-effect-model/SKILL.md`。
- 当任务涉及 **async-cancellation-model** 时，调用 `../pm-b09-async-cancellation-model/SKILL.md`。
- 当任务涉及 **business-state-machine-ir** 时，调用 `../pm-b09-business-state-machine-ir/SKILL.md`。
- 当任务涉及 **ui-state-machine-ir** 时，调用 `../pm-b09-ui-state-machine-ir/SKILL.md`。
- 当任务涉及 **protocol-and-workflow-ir** 时，调用 `../pm-b09-protocol-and-workflow-ir/SKILL.md`。
- 当任务涉及 **observable-behavior-ir** 时，调用 `../pm-b09-observable-behavior-ir/SKILL.md`。
- 当任务涉及 **semantic-loss-ledger** 时，调用 `../pm-b09-semantic-loss-ledger/SKILL.md`。
