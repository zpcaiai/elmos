...
description: "Run FRT-1609 Flutter Plugin and Platform Channel Mapper for FRT G16 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1609"
  source_name: "frt-1609-flutter-plugin-and-platform-channel-mapper"
  source_sha256: "sha256:5478efd80c28694f7b3ab8f9ba441d42fedd9f5706a794cc7b633a72c1804969"
  batch: "G16"
...
- Runtime catalog key: `FRT-1609` / `frt-1609-flutter-plugin-and-platform-channel-mapper`.
...
# FRT-1609 — Flutter Plugin and Platform Channel Mapper

## Objective

在G16范围内实现 **Flutter Plugin and Platform Channel Mapper**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射DOM/组件到Widget树而非逐元素复制; 处理Key、BuildContext、Controller、State和Navigator; 处理Plugin、Platform Channel、Web/Mobile能力差异。

## When to Use

- 实现或修改与 **Flutter Plugin and Platform Channel Mapper** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1609Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1609EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1609FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1609CertificateFragment`：供G16批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g16/frt-1609-flutter-plugin-and-platform-channel-mapper/
packages/runtime/g16/frt-1609-flutter-plugin-and-platform-channel-mapper/
services/control-plane/g16/frt-1609-flutter-plugin-and-platform-channel-mapper/
apps/web-console/src/features/g16/frt-1609-flutter-plugin-and-platform-channel-mapper/
apps/admin-console/src/features/g16/frt-1609-flutter-plugin-and-platform-channel-mapper/
tests/g16/frt-1609-flutter-plugin-and-platform-channel-mapper/
```
...
```text
POST /v1/skills/frt-1609/runs
GET  /v1/skills/frt-1609/runs/{run_id}
POST /v1/skills/frt-1609/runs/{run_id}/verify
GET  /v1/skills/frt-1609/runs/{run_id}/findings
GET  /v1/skills/frt-1609/runs/{run_id}/evidence
```
