...
description: "Run FRT-2919 Security Incident Response Generator for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2919"
  source_name: "frt-2919-security-incident-response-generator"
  source_sha256: "sha256:8a48eca0d0a32f183e503849e6df2aa16438821edcfb14570d5fa11c62fdd474"
  batch: "G29"
...
- Runtime catalog key: `FRT-2919` / `frt-2919-security-incident-response-generator`.
...
在G29范围内实现 **Security Incident Response Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Security Incident Response Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2919Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2919EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2919FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2919CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2919-security-incident-response-generator/
packages/runtime/g29/frt-2919-security-incident-response-generator/
services/control-plane/g29/frt-2919-security-incident-response-generator/
apps/web-console/src/features/g29/frt-2919-security-incident-response-generator/
apps/admin-console/src/features/g29/frt-2919-security-incident-response-generator/
tests/g29/frt-2919-security-incident-response-generator/
```
...
```text
POST /v1/skills/frt-2919/runs
GET  /v1/skills/frt-2919/runs/{run_id}
POST /v1/skills/frt-2919/runs/{run_id}/verify
GET  /v1/skills/frt-2919/runs/{run_id}/findings
GET  /v1/skills/frt-2919/runs/{run_id}/evidence
```
