...
description: "Run FRT-3023 Production Incident Learning Pack for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3023"
  source_name: "frt-3023-production-incident-learning-pack"
  source_sha256: "sha256:a493b278872c5adccacf1529fec70c801d7b0ee76879778e2f2ed2a77711956e"
  batch: "G30"
...
- Runtime catalog key: `FRT-3023` / `frt-3023-production-incident-learning-pack`.
...
在G30范围内实现 **Production Incident Learning Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Production Incident Learning Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3023Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3023EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3023FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3023CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3023-production-incident-learning-pack/
packages/runtime/g30/frt-3023-production-incident-learning-pack/
services/control-plane/g30/frt-3023-production-incident-learning-pack/
apps/web-console/src/features/g30/frt-3023-production-incident-learning-pack/
apps/admin-console/src/features/g30/frt-3023-production-incident-learning-pack/
tests/g30/frt-3023-production-incident-learning-pack/
```
...
```text
POST /v1/skills/frt-3023/runs
GET  /v1/skills/frt-3023/runs/{run_id}
POST /v1/skills/frt-3023/runs/{run_id}/verify
GET  /v1/skills/frt-3023/runs/{run_id}/findings
GET  /v1/skills/frt-3023/runs/{run_id}/evidence
```
