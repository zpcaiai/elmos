...
description: "Repository-owned bounded wrapper for model-tool-skill-router; external evidence remains NOT_RUN."
---
...
4. Submit `model-tool-skill-router` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `dbf558738a5d1b5cbc64bb198bda0275af0c6180bd32e8f6c03b52026d01c4dd`
