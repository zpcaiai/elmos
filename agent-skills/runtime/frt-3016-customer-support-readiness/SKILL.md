...
description: "Run FRT-3016 Customer Support Readiness for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3016"
  source_name: "frt-3016-customer-support-readiness"
  source_sha256: "sha256:3a67e9268d3f84908ff603238ce694e352acf961224f9e7a03dbfe48939a6012"
  batch: "G30"
...
- Runtime catalog key: `FRT-3016` / `frt-3016-customer-support-readiness`.
...
在G30范围内实现 **Customer Support Readiness**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Customer Support Readiness** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3016Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3016EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3016FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3016CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3016-customer-support-readiness/
packages/runtime/g30/frt-3016-customer-support-readiness/
services/control-plane/g30/frt-3016-customer-support-readiness/
apps/web-console/src/features/g30/frt-3016-customer-support-readiness/
apps/admin-console/src/features/g30/frt-3016-customer-support-readiness/
tests/g30/frt-3016-customer-support-readiness/
```
...
```text
POST /v1/skills/frt-3016/runs
GET  /v1/skills/frt-3016/runs/{run_id}
POST /v1/skills/frt-3016/runs/{run_id}/verify
GET  /v1/skills/frt-3016/runs/{run_id}/findings
GET  /v1/skills/frt-3016/runs/{run_id}/evidence
```
