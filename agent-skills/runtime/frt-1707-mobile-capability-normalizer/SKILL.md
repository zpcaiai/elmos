...
description: "Run FRT-1707 Mobile Capability Normalizer for FRT G17 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1707"
  source_name: "frt-1707-mobile-capability-normalizer"
  source_sha256: "sha256:07d0e91b6eb73dc8968e673780ee1d2105a0a3fa47b08da3196b95e162fcbffc"
  batch: "G17"
...
- Runtime catalog key: `FRT-1707` / `frt-1707-mobile-capability-normalizer`.
...
# FRT-1707 — Mobile Capability Normalizer

## Objective

在G17范围内实现 **Mobile Capability Normalizer**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：补齐小程序/ArkUI/Flutter六个方向; 统一移动Navigation、Lifecycle、Permission、Storage和Native能力; 验证直接与间接三角路径。

## When to Use

- 实现或修改与 **Mobile Capability Normalizer** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1707Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1707EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1707FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1707CertificateFragment`：供G17批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g17/frt-1707-mobile-capability-normalizer/
packages/runtime/g17/frt-1707-mobile-capability-normalizer/
services/control-plane/g17/frt-1707-mobile-capability-normalizer/
apps/web-console/src/features/g17/frt-1707-mobile-capability-normalizer/
apps/admin-console/src/features/g17/frt-1707-mobile-capability-normalizer/
tests/g17/frt-1707-mobile-capability-normalizer/
```
...
```text
POST /v1/skills/frt-1707/runs
GET  /v1/skills/frt-1707/runs/{run_id}
POST /v1/skills/frt-1707/runs/{run_id}/verify
GET  /v1/skills/frt-1707/runs/{run_id}/findings
GET  /v1/skills/frt-1707/runs/{run_id}/evidence
```
