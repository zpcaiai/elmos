---
name: china-ai-data-compliance-profile
description: Use this skill when Elmos must perform china ai data compliance profile as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# china-ai-data-compliance-profile

## 能力目标

维护中国网络、数据、个人信息、生成式 AI 备案/登记和标识要求映射。
