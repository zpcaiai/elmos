...
description: "统一表示 Bag/Set、NULL 三值逻辑、Join、聚合、窗口、排序、DML、事务、异常、Routine 和 Trigger 语义。 Use when the task needs the exact SQL Semantic IR Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-sql-semantic-ir/SKILL.md"
  source_sha256: "sha256:f2d74c49544512e988d564bba4c987093b6bd539362b71881af39e86c6968fdf"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "sql-conversion"
  runtime_handler_id: "execute_elmos_sql_semantic_ir"
...
- Exact Skill identity: `elmos-sql-semantic-ir`; exact allowlisted runtime handler: `execute_elmos_sql_semantic_ir`.
- Source identity: `skills/P0/elmos-sql-semantic-ir/SKILL.md` at `sha256:f2d74c49544512e988d564bba4c987093b6bd539362b71881af39e86c6968fdf` from `elmos-formal-assurance-kernel-v1.0.0`.
...
统一表示 Bag/Set、NULL 三值逻辑、Join、聚合、窗口、排序、DML、事务、异常、Routine 和 Trigger 语义。
...
3. Use the repository-owned `execute_elmos_sql_semantic_ir` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["denotational SQL semantics","bag relational algebra","three-valued logic","state transition IR"]`
- Direct dependencies: `["elmos-formal-spec-ir","elmos-language-semantic-profile"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-sql-semantic-ir/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
