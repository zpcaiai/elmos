---
name: elmos-prompt-skill-adapter-canary-promotion-governor
description: Stage behavioral configuration changes through offline, shadow, canary and broad rollout with exact version, metrics and rollback.
version: 4.0.0
...
# Prompt, Skill and Adapter Canary Promotion Governor
...
- `PromptSkillAndAdapterCanaryPromotionGovernorProfile`
- `PromptSkillAndAdapterCanaryPromotionGovernorPlan`
- `PromptSkillAndAdapterCanaryPromotionGovernorRun`
- `PromptSkillAndAdapterCanaryPromotionGovernorDecision`

Required semantic capabilities:

- freeze candidate prompt/skill/adapter bundle
- run holdout and negative activation tests
- shadow without side effects
- canary by tenant/risk cohort
- promote or rollback with evidence invalidation
...
- `artifacts/elmos-prompt-skill-adapter-canary-promotion-governor/profile.yaml`
- `artifacts/elmos-prompt-skill-adapter-canary-promotion-governor/plan.json`
- `artifacts/elmos-prompt-skill-adapter-canary-promotion-governor/result.json`
- `artifacts/elmos-prompt-skill-adapter-canary-promotion-governor/evidence/`
...
- **candidate and control share cache** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **canary cohort not representative** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **side effect leaks from shadow** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback does not restore memory** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **metric lag hides harm** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: freeze candidate prompt/skill/adapter bundle
- native scenario: run holdout and negative activation tests
- native scenario: shadow without side effects
- native scenario: canary by tenant/risk cohort
- native scenario: promote or rollback with evidence invalidation
