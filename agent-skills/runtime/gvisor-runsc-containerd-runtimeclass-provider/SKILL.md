---
name: gvisor-runsc-containerd-runtimeclass-provider
description: "Implement gVisor runsc through containerd/Kubernetes RuntimeClass, pinned artifacts, host-side runtime verification, compatibility, cancellation, and cleanup."
---
...
Implement gVisor runsc through containerd/Kubernetes RuntimeClass, pinned artifacts, host-side runtime verification, compatibility, cancellation, and cleanup.
...
4. Record unresolved provider/version assumptions in `docs/implementation/gvisor-runsc-containerd-runtimeclass-provider-baseline.md`.
...
```text
gvisor_runsc_containerd_runtimeclass_provider_manifest.json
gvisor_runsc_containerd_runtimeclass_provider_decision.json
gvisor_runsc_containerd_runtimeclass_provider_evidence.json
```
