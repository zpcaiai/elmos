---
name: elmos-sustainable-ai-energy-carbon-efficiency-certifier
description: Measure and certify energy, accelerator utilization, embodied/operational carbon assumptions and efficiency trade-offs without weakening required quality, safety or resilience.
version: 4.0.0
...
# Sustainable AI Energy and Carbon Efficiency Certifier
...
- **Kernel authorities used:** K1, K6, K7, K8
...
- `SustainableAIEnergyAndCarbonEfficiencyCertifierProfile`
- `SustainableAIEnergyAndCarbonEfficiencyCertifierPlan`
- `SustainableAIEnergyAndCarbonEfficiencyCertifierRun`
- `SustainableAIEnergyAndCarbonEfficiencyCertifierDecision`

Required semantic capabilities:

- measure energy per accepted task and per model phase
- bind region electricity and carbon-factor assumptions
- compare batching, quantization, cache and hardware alternatives
- apply quality, safety and SLO floors
- emit bounded sustainability claims with uncertainty
...
- `elmos-carbon-energy-efficiency-profiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
- `elmos-model-serving-runtime-profile-compiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-sustainable-ai-energy-carbon-efficiency-certifier/profile.yaml`
- `artifacts/elmos-sustainable-ai-energy-carbon-efficiency-certifier/plan.json`
- `artifacts/elmos-sustainable-ai-energy-carbon-efficiency-certifier/result.json`
- `artifacts/elmos-sustainable-ai-energy-carbon-efficiency-certifier/evidence/`
...
- **carbon factor outdated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **quality loss hidden by efficiency score** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **idle infrastructure omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **renewable attribute double-counted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tenant workload attribution incorrect** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: measure energy per accepted task and per model phase
- native scenario: bind region electricity and carbon-factor assumptions
- native scenario: compare batching, quantization, cache and hardware alternatives
- native scenario: apply quality, safety and SLO floors
- native scenario: emit bounded sustainability claims with uncertainty
