---
name: b81-ims-vsam-db2-data-adapter
description: "Use when ELMOS must run ims vsam db2 data adapter for Batch 81 COBOL / JCL / REXX / CICS / IMS Mainframe Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG228"
  source_name: "ims-vsam-db2-data-adapter"
  source_sha256: "sha256:f9baba0d910651cdac0c811e3ac507ea7c847a355e447acc678dd5342c5396f1"
  batch: 81
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 81 Language Pack / source PG228 — Ims Vsam DB2 Data Adapter

## 1. Objective

Adapt ims vsam db2 data adapter within the COBOL / JCL / REXX / CICS / IMS Mainframe Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Ims Vsam DB2 Data Adapter using the approved enterprise-mainframe semantic contracts and toolchain versions.
...
- A representative valid cobol-mainframe input produces all declared outputs for ims-vsam-db2-data-adapter.
