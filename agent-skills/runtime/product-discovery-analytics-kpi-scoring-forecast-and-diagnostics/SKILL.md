---
name: product-discovery-analytics-kpi-scoring-forecast-and-diagnostics
description: "Implement Batch 41B Product Discovery、Feedback与Research Operations semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Idea、Feedback、Interview、Research、Problem、Hypothesis、Requirement、Prototype、Evidence与Discovery Decision."
---
...
Implement Batch 41B Product Discovery、Feedback与Research Operations semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Idea、Feedback、Interview、Research、Problem、Hypothesis、Requirement、Prototype、Evidence与Discovery Decision.
...
5. Write unresolved domain assumptions to `docs/implementation/product-discovery-analytics-kpi-scoring-forecast-and-diagnostics-baseline.md`.
...
```text
product_discovery_analytics_kpi_scoring_forecast_and_diagnostics_manifest.json
product_discovery_analytics_kpi_scoring_forecast_and_diagnostics_state.json
product_discovery_analytics_kpi_scoring_forecast_and_diagnostics_decision.json
product_discovery_analytics_kpi_scoring_forecast_and_diagnostics_reconciliation.json
product_discovery_analytics_kpi_scoring_forecast_and_diagnostics_evidence.json
```
