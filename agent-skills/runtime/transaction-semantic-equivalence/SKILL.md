---
name: transaction-semantic-equivalence
description: "Repository-owned bounded wrapper for transaction-semantic-equivalence; external evidence remains NOT_RUN."
---
...
Verify isolation, locking, retries, autocommit, savepoints and error behavior across source/target database engines.
...
4. Submit `transaction-semantic-equivalence` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `4add5d3ef4f17f506180c98f9e31861b7235371187566cfa5fef878148ca0cc2`
