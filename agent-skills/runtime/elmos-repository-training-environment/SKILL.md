---
name: repository-training-environment
description: Use this skill when Elmos must perform repository training environment as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
把仓库、构建工具、依赖、服务、数据和测试封装为可重置训练环境。
