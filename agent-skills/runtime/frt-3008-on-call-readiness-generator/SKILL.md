...
description: "Run FRT-3008 On-Call Readiness Generator for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3008"
  source_name: "frt-3008-on-call-readiness-generator"
  source_sha256: "sha256:ec197aa33a78fdeb2c1d7724363e3070a80ca47ab1cc42951e9760345c16bf0a"
  batch: "G30"
...
- Runtime catalog key: `FRT-3008` / `frt-3008-on-call-readiness-generator`.
...
在G30范围内实现 **On-Call Readiness Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **On-Call Readiness Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3008Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3008EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3008FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3008CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3008-on-call-readiness-generator/
packages/runtime/g30/frt-3008-on-call-readiness-generator/
services/control-plane/g30/frt-3008-on-call-readiness-generator/
apps/web-console/src/features/g30/frt-3008-on-call-readiness-generator/
apps/admin-console/src/features/g30/frt-3008-on-call-readiness-generator/
tests/g30/frt-3008-on-call-readiness-generator/
```
...
```text
POST /v1/skills/frt-3008/runs
GET  /v1/skills/frt-3008/runs/{run_id}
POST /v1/skills/frt-3008/runs/{run_id}/verify
GET  /v1/skills/frt-3008/runs/{run_id}/findings
GET  /v1/skills/frt-3008/runs/{run_id}/evidence
```
