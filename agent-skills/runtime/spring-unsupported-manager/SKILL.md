---
name: spring-unsupported-manager
description: 管理反射、字节码、自定义 ClassLoader、私有框架、EJB/JNI 等未认证语义。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-015
  source_name: spring-unsupported-manager
  source_path: skills/spring-unsupported-manager/SKILL.md
  source_sha256: sha256:6f7215b4834363fbc5bc5351190b29c326873169a2059fcf1f1de0b49964dcaf
  source_contract_sha256: sha256:327e6c2a45db6e9d12d757b530c010a55bd842fd6edf54c97c42449e2d559d46
...
# Unsupported Semantics Manager

## Objective

管理反射、字节码、自定义 ClassLoader、私有框架、EJB/JNI 等未认证语义。

## Scope and capabilities

- retain/sidecar/strangler/manual/custom pack
- P0 unknown 阻断
...
- [ ] 定义 `spring-unsupported-manager` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-unsupported-manager` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：unsupported-register.json, treatment-plan.json, risk-acceptance.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：unsupported-register.json, treatment-plan.json, risk-acceptance.json。
...
- Machine contract: `references/contract.json` (`sha256:327e6c2a45db6e9d12d757b530c010a55bd842fd6edf54c97c42449e2d559d46`).
