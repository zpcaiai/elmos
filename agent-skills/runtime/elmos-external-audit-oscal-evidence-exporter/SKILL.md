---
name: elmos-external-audit-oscal-evidence-exporter
description: Export scoped controls, implementations, assessment plans, results, findings, POA&M and evidence references in OSCAL-compatible and auditor-friendly packages.
version: 4.0.0
...
# External Audit and OSCAL Evidence Exporter
...
- Map Elmos controls and evidence to machine-readable profiles
- Generate assessment plan and result artifacts
- Preserve evidence references without copying secrets
- Support auditor sampling and query traceability
- Record findings and remediation plans
...
- `control-assessment-results.json`
- `auditor-review-package.zip`
...
- **control crosswalk overstates equivalence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive evidence embedded in export** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **finding omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **auditor receives stale package** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **export implies third-party certification** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- OSCAL catalog/profile export
- system implementation export
- assessment plan/result
- finding and POA&M
- redacted evidence link
- auditor sample reproducibility
