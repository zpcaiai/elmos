...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/pricing-analytics-packaging-discount-waterfall-elastici-96176e3c-baseline.md`.
