...
description: "Run FRT-1408 Mini Program Route Form and Storage Mapper for FRT G14 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1408"
  source_name: "frt-1408-mini-program-route-form-and-storage-mapper"
  source_sha256: "sha256:975ff35b405884bc67de8cb4188cfd683fb70e1fe533f7020e459354d3423a0d"
  batch: "G14"
...
- Runtime catalog key: `FRT-1408` / `frt-1408-mini-program-route-form-and-storage-mapper`.
...
# FRT-1408 — Mini Program Route Form and Storage Mapper

## Objective

在G14范围内实现 **Mini Program Route Form and Storage Mapper**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：处理WXML/WXSS/setData/Page/Component与Web组件模型; 处理分包、基础库、授权、支付、Storage和页面栈限制; Web缺失能力和小程序限制显式Gap/Unsupported。

## When to Use

- 实现或修改与 **Mini Program Route Form and Storage Mapper** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1408Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1408EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1408FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1408CertificateFragment`：供G14批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g14/frt-1408-mini-program-route-form-and-storage-mapper/
packages/runtime/g14/frt-1408-mini-program-route-form-and-storage-mapper/
services/control-plane/g14/frt-1408-mini-program-route-form-and-storage-mapper/
apps/web-console/src/features/g14/frt-1408-mini-program-route-form-and-storage-mapper/
apps/admin-console/src/features/g14/frt-1408-mini-program-route-form-and-storage-mapper/
tests/g14/frt-1408-mini-program-route-form-and-storage-mapper/
```
...
```text
POST /v1/skills/frt-1408/runs
GET  /v1/skills/frt-1408/runs/{run_id}
POST /v1/skills/frt-1408/runs/{run_id}/verify
GET  /v1/skills/frt-1408/runs/{run_id}/findings
GET  /v1/skills/frt-1408/runs/{run_id}/evidence
```
