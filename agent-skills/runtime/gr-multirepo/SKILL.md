---
name: gr-multirepo
description: 跨仓管理共享 API、数据库、库版本、依赖顺序、发布波次和回滚。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-090
  source_name: gr-multirepo
  source_path: skills/gr-multirepo/SKILL.md
  source_sha256: sha256:231a389001a782a1ed7ccc4945b71ac4d25c78440ff40e5819b0875ba7c39bf2
  source_contract_sha256: sha256:34bc84455fa244cd7baf5f67fffabad41a66a4c9e13c2cbf77406bc2dcc7cea2
...
跨仓管理共享 API、数据库、库版本、依赖顺序、发布波次和回滚。
...
- [ ] 定义 `gr-multirepo` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-multirepo` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：campaign-dag.json, wave-plans, portfolio-proofs。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：campaign-dag.json, wave-plans, portfolio-proofs。
...
- Machine contract: `references/contract.json` (`sha256:34bc84455fa244cd7baf5f67fffabad41a66a4c9e13c2cbf77406bc2dcc7cea2`).
