...
description: "Run FRT-2208 Business Audit Trail Generator for FRT G22 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2208"
  source_name: "frt-2208-business-audit-trail-generator"
  source_sha256: "sha256:a29425484ba9dc809310877f2dd0cc9bf9c4660f9eb703de11b4bf98cfe0a2d7"
  batch: "G22"
...
- Runtime catalog key: `FRT-2208` / `frt-2208-business-audit-trail-generator`.
...
在G22范围内实现 **Business Audit Trail Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Value Stream 与业务Outcome建模; 状态机可达性、终态、Timeout、Cancel、Unknown、Recovery完整性; 跨域Saga、幂等、补偿和Reconciliation。

## When to Use

- 实现或修改与 **Business Audit Trail Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2208Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2208EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2208FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2208CertificateFragment`：供G22批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g22/frt-2208-business-audit-trail-generator/
packages/runtime/g22/frt-2208-business-audit-trail-generator/
services/control-plane/g22/frt-2208-business-audit-trail-generator/
apps/web-console/src/features/g22/frt-2208-business-audit-trail-generator/
apps/admin-console/src/features/g22/frt-2208-business-audit-trail-generator/
tests/g22/frt-2208-business-audit-trail-generator/
```
...
```text
POST /v1/skills/frt-2208/runs
GET  /v1/skills/frt-2208/runs/{run_id}
POST /v1/skills/frt-2208/runs/{run_id}/verify
GET  /v1/skills/frt-2208/runs/{run_id}/findings
GET  /v1/skills/frt-2208/runs/{run_id}/evidence
```
