...
- Invoke this repository Skill as `$pm-precision-migration-orchestrator`.
- Immutable source identity: `precision-migration-orchestrator` in `precision-migration-b01-44` (global).
- Runtime adapter: `precision-migration-orchestrator`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-precision-migration-orchestrator`.
