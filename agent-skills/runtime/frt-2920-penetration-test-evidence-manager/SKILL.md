...
description: "Run FRT-2920 Penetration Test Evidence Manager for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2920"
  source_name: "frt-2920-penetration-test-evidence-manager"
  source_sha256: "sha256:806f5f2a68afb09fd8c5c929d5180c34bcd326c0dd53807d11974b9fe4e9dd57"
  batch: "G29"
...
- Runtime catalog key: `FRT-2920` / `frt-2920-penetration-test-evidence-manager`.
...
在G29范围内实现 **Penetration Test Evidence Manager**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Penetration Test Evidence Manager** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2920Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2920EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2920FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2920CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2920-penetration-test-evidence-manager/
packages/runtime/g29/frt-2920-penetration-test-evidence-manager/
services/control-plane/g29/frt-2920-penetration-test-evidence-manager/
apps/web-console/src/features/g29/frt-2920-penetration-test-evidence-manager/
apps/admin-console/src/features/g29/frt-2920-penetration-test-evidence-manager/
tests/g29/frt-2920-penetration-test-evidence-manager/
```
...
```text
POST /v1/skills/frt-2920/runs
GET  /v1/skills/frt-2920/runs/{run_id}
POST /v1/skills/frt-2920/runs/{run_id}/verify
GET  /v1/skills/frt-2920/runs/{run_id}/findings
GET  /v1/skills/frt-2920/runs/{run_id}/evidence
```
