...
# PG332 — Powershell Secret Signing Policy

## Objective

Enforce and test Powershell Secret Signing Policy for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `powershell-secret-signing-policy` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`, `PG331`.
...
- `powershell_secret_signing_policy_plan.json`
- `powershell_secret_signing_policy_artifacts/`
- `powershell_secret_signing_policy_verification.json`
