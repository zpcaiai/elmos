...
description: "Run FRT-1712 Thirty-Path Coverage Registry for FRT G17 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1712"
  source_name: "frt-1712-thirty-path-coverage-registry"
  source_sha256: "sha256:bf1e6af71047de482bedd384b77498223630dec1c0d5317c8681fce6551d3d6d"
  batch: "G17"
...
- Runtime catalog key: `FRT-1712` / `frt-1712-thirty-path-coverage-registry`.
...
# FRT-1712 — Thirty-Path Coverage Registry

## Objective

在G17范围内实现 **Thirty-Path Coverage Registry**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：补齐小程序/ArkUI/Flutter六个方向; 统一移动Navigation、Lifecycle、Permission、Storage和Native能力; 验证直接与间接三角路径。

## When to Use

- 实现或修改与 **Thirty-Path Coverage Registry** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1712Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1712EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1712FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1712CertificateFragment`：供G17批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g17/frt-1712-thirty-path-coverage-registry/
packages/runtime/g17/frt-1712-thirty-path-coverage-registry/
services/control-plane/g17/frt-1712-thirty-path-coverage-registry/
apps/web-console/src/features/g17/frt-1712-thirty-path-coverage-registry/
apps/admin-console/src/features/g17/frt-1712-thirty-path-coverage-registry/
tests/g17/frt-1712-thirty-path-coverage-registry/
```
...
```text
POST /v1/skills/frt-1712/runs
GET  /v1/skills/frt-1712/runs/{run_id}
POST /v1/skills/frt-1712/runs/{run_id}/verify
GET  /v1/skills/frt-1712/runs/{run_id}/findings
GET  /v1/skills/frt-1712/runs/{run_id}/evidence
```
