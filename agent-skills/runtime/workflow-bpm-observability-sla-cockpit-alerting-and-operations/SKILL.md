---
name: workflow-bpm-observability-sla-cockpit-alerting-and-operations
description: "Implement Batch 46B Workflow、BPM、Case与Low-code Automation telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work."
---

# Workflow BPM Observability SLA Cockpit Alerting And Operations

## Objective

Implement Batch 46B Workflow、BPM、Case与Low-code Automation telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Process、Task、Case、Form、Rule、SLA、Assignment、Decision、Automation与Human Work.
...
5. Write unresolved domain assumptions to `docs/implementation/workflow-bpm-observability-sla-cockpit-alerting-and-operations-baseline.md`.
...
```text
workflow_bpm_observability_sla_cockpit_alerting_and_operations_manifest.json
workflow_bpm_observability_sla_cockpit_alerting_and_operations_state.json
workflow_bpm_observability_sla_cockpit_alerting_and_operations_decision.json
workflow_bpm_observability_sla_cockpit_alerting_and_operations_reconciliation.json
workflow_bpm_observability_sla_cockpit_alerting_and_operations_evidence.json
```
