---
name: core-hr-case-investigation-remediation-and-closure
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle case intake, triage, investigation, findings, remediation, reverification and governed closure, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle case intake, triage, investigation, findings, remediation, reverification and governed closure, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-case-investigation-remediation-and-closure-baseline.md`.
...
```text
core_hr_case_investigation_remediation_and_closure_manifest.json
core_hr_case_investigation_remediation_and_closure_state.json
core_hr_case_investigation_remediation_and_closure_decision.json
core_hr_case_investigation_remediation_and_closure_reconciliation.json
core_hr_case_investigation_remediation_and_closure_evidence.json
```
