---
name: parser-roundtrip-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Parser and Round-trip Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T096"
  source_name: "parser-roundtrip-gate"
  source_sha256: "sha256:a2a0a160134b45ae9ac249c6efdd193ba91a484dd88b51749c7bb2e1e04cbeb0"
...
# T096 — Parser and Round-trip Gate

## 1. Objective

Parse, serialize and reparse representative source artifacts without losing semantics, identifiers, comments required for review, or platform metadata.
...
- `CASE-0391` [HIGH] Parser and Round-trip Gate: Representative path
- `CASE-0392` [HIGH] Parser and Round-trip Gate: Boundary path
- `CASE-0393` [HIGH] Parser and Round-trip Gate: Invalid or hostile input
- `CASE-0394` [HIGH] Parser and Round-trip Gate: Injected dependency failure
- `CASE-0395` [CRITICAL] Parser and Round-trip Gate: Security or safety violation
- `CASE-0396` [HIGH] Parser and Round-trip Gate: Replay and idempotency
- `CASE-0397` [HIGH] Parser and Round-trip Gate: Version or environment drift
- `CASE-0398` [MEDIUM] Parser and Round-trip Gate: Moderate scale
- `CASE-0399` [CRITICAL] Parser and Round-trip Gate: Evidence tamper
- `CASE-0400` [HIGH] Parser and Round-trip Gate: Recovery and final evidence
