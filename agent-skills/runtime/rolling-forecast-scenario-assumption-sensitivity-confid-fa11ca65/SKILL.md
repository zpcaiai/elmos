...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/rolling-forecast-scenario-assumption-sensitivity-confid-fa11ca65-baseline.md`.
