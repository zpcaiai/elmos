...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/psp-bank-payment-rail-connector-capability-authenticati-a7678f08-baseline.md`.
