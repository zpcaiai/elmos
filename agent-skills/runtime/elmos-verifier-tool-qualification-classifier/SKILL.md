...
# Verifier Tool Qualification Classifier
...
- `VerifierToolQualificationClassifierProfile`
- `VerifierToolQualificationClassifierRun`
- `VerifierToolQualificationClassifierFinding`
- `VerifierToolQualificationClassifierDecision`
- `VerifierToolQualificationClassifierEvidence`

Required semantic capabilities:

- classify tools by potential to introduce or fail to detect errors and by verification credit claimed
- derive qualification level, operational requirements and independent checks
- prevent unqualified generators, analyzers or LLM judges from reducing assurance obligations
...
- `elmos-formal-method-selection-router` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-verifier-tool-qualification-classifier/profile.yaml`
- `artifacts/elmos-verifier-tool-qualification-classifier/plan.json`
- `artifacts/elmos-verifier-tool-qualification-classifier/result.json`
- `artifacts/elmos-verifier-tool-qualification-classifier/evidence/`
- `artifacts/elmos-verifier-tool-qualification-classifier/assurance-case.json`
...
- **tool confidence is based on vendor reputation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **verification tool failure can create false pass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tool mode differs from qualified configuration** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify tools by potential to introduce or fail to detect errors and by verification credit claimed
- native scenario: derive qualification level, operational requirements and independent checks
- native scenario: prevent unqualified generators, analyzers or LLM judges from reducing assurance obligations
