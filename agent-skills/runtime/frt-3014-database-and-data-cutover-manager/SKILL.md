...
description: "Run FRT-3014 Database and Data Cutover Manager for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3014"
  source_name: "frt-3014-database-and-data-cutover-manager"
  source_sha256: "sha256:cf3ba172662b94b02f901317834c3771b180af95e1d8b67be23915723fe72d19"
  batch: "G30"
...
- Runtime catalog key: `FRT-3014` / `frt-3014-database-and-data-cutover-manager`.
...
在G30范围内实现 **Database and Data Cutover Manager**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Database and Data Cutover Manager** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3014Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3014EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3014FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3014CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3014-database-and-data-cutover-manager/
packages/runtime/g30/frt-3014-database-and-data-cutover-manager/
services/control-plane/g30/frt-3014-database-and-data-cutover-manager/
apps/web-console/src/features/g30/frt-3014-database-and-data-cutover-manager/
apps/admin-console/src/features/g30/frt-3014-database-and-data-cutover-manager/
tests/g30/frt-3014-database-and-data-cutover-manager/
```
...
```text
POST /v1/skills/frt-3014/runs
GET  /v1/skills/frt-3014/runs/{run_id}
POST /v1/skills/frt-3014/runs/{run_id}/verify
GET  /v1/skills/frt-3014/runs/{run_id}/findings
GET  /v1/skills/frt-3014/runs/{run_id}/evidence
```
