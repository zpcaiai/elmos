---
name: human-escalation-and-repair-workbench
description: Prepare an auditable human decision package for blocked or exhausted repairs. Use for critical risk, legal ambiguity, no provider, no progress, oscillation or max attempts.
---

# Human Escalation And Repair Workbench
...
Require task, failure history, providers attempted, patches, validations, budget usage, risks and exact blocking reason.

## Workflow

1. Validate schema version, stable identities, immutable hashes and policy prerequisites.
2. Deduplicate evidence; explain what changed and why automation stopped; present explicit approve-scope, choose-next-action and residual-risk decisions without auto-applying anything.
...
human-escalation.json and review workbench read model.

## Fail-closed rules

Never hide failed attempts, suggest acceptance without evidence or resume automatically after escalation.
