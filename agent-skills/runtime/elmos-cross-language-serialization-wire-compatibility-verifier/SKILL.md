---
name: elmos-cross-language-serialization-wire-compatibility-verifier
description: Preserve JSON, Protobuf, Avro, MessagePack and custom wire contracts across language generators, including defaults, unknown fields, precision, ordering and schema evolution.
version: 4.0.0
...
# Cross-Language Serialization and Wire Compatibility Verifier
...
- `CrossLanguageSerializationAndWireCompatibilityVerifierProfile`
- `CrossLanguageSerializationAndWireCompatibilityVerifierPlan`
- `CrossLanguageSerializationAndWireCompatibilityVerifierRun`
- `CrossLanguageSerializationAndWireCompatibilityVerifierDecision`

Required semantic capabilities:

- generate multi-language round-trip fixtures
- verify unknown-field and default semantics
- compare decimal, timestamp and binary encodings
- check canonicalization and signature stability
- certify backward and forward compatibility
...
- `artifacts/elmos-cross-language-serialization-wire-compatibility-verifier/profile.yaml`
- `artifacts/elmos-cross-language-serialization-wire-compatibility-verifier/plan.json`
- `artifacts/elmos-cross-language-serialization-wire-compatibility-verifier/result.json`
- `artifacts/elmos-cross-language-serialization-wire-compatibility-verifier/evidence/`
...
- **silent field truncation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **numeric precision loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unknown fields discarded** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **canonical bytes change signatures** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **language library defaults diverge** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: generate multi-language round-trip fixtures
- native scenario: verify unknown-field and default semantics
- native scenario: compare decimal, timestamp and binary encodings
- native scenario: check canonicalization and signature stability
- native scenario: certify backward and forward compatibility
