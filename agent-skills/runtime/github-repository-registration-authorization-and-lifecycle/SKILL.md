---
name: github-repository-registration-authorization-and-lifecycle
description: "Implement repository registration, tenant authorization, installation binding, activation, suspension, transfer, archival, deletion, and reconciliation."
---
...
Implement repository registration, tenant authorization, installation binding, activation, suspension, transfer, archival, deletion, and reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-repository-registration-authorization-and-lifecycle-baseline.md`.
...
```text
github_repository_registration_authorization_and_lifecycle_manifest.json
github_repository_registration_authorization_and_lifecycle_decision.json
github_repository_registration_authorization_and_lifecycle_evidence.json
```
