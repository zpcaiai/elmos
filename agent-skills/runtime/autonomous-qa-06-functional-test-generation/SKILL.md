---
name: "autonomous-qa-06-functional-test-generation"
description: "Run 06-functional-test-generation through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "06-functional-test-generation"
  source_sha256: "sha256:d1325205b11bfb17ca290b212a0781bec9ce66c8558614ee04b88517c78073eb"
  ...
  runtime_skill_key: "06-functional-test-generation"
  runtime_handler: "execute_06_functional_test_generation"
  runtime_phase: "generation"
  runtime_mutating: "false"
  runtime_operation: "elmos_autonomous_qa.generators.generate_functional_tests"
...
1. Accept only a structured request for the exact Skill key `06-functional-test-generation`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_06_functional_test_generation` and operation `elmos_autonomous_qa.generators.generate_functional_tests`.
...
- Immutable source: `skills/06-functional-test-generation/SKILL.md` at `sha256:d1325205b11bfb17ca290b212a0781bec9ce66c8558614ee04b88517c78073eb`.
