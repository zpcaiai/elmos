...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/billing-finance-reconciliation-period-close-audit-evide-13e9caf7-baseline.md`.
