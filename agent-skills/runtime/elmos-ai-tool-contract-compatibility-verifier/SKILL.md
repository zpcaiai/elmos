---
name: elmos-ai-tool-contract-compatibility-verifier
description: Verify schema, semantics, effects, idempotency, authorization and error compatibility as tools and MCP/OpenAPI
  providers evolve.
version: 4.0.0
...
# AI Tool Contract Compatibility Verifier
...
- `DeploymentUnit`
- `ConformanceRun`
- `AIToolContractCompatibilityVerifierRun`
- `AIToolContractCompatibilityVerifierDecision`

Required semantic capabilities:

- Input/output schema compatibility
- Effect and idempotency preservation
- Authorization and approval compatibility
- Error/timeout/retry semantics
- Dual-run and cutover verification
...
- `tool-contract-graph.json`
- `tool-compatibility-report.json`
- `tool-migration-adapters/`
- `tool-cutover-decision.json`
...
- **tool swap changes side effects** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **authorization downgrade** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **schema coercion hides error** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **retry duplication** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider error misclassification** — must have a preventive control, a detective signal, a negative fixture and a response action.
