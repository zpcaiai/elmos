---
name: runner-capability-discovery-attestation-and-trust
description: "Implement runner capability discovery, evidence, attestation, freshness, trust levels, compatibility, quarantine, and anti-self-assertion controls."
---
...
Implement runner capability discovery, evidence, attestation, freshness, trust levels, compatibility, quarantine, and anti-self-assertion controls.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-capability-discovery-attestation-and-trust-baseline.md`.
...
```text
runner_capability_discovery_attestation_and_trust_manifest.json
runner_capability_discovery_attestation_and_trust_decision.json
runner_capability_discovery_attestation_and_trust_evidence.json
```
