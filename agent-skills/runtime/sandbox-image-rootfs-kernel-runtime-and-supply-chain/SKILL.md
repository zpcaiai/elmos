---
name: sandbox-image-rootfs-kernel-runtime-and-supply-chain
description: "Implement sandbox image, rootfs, kernel, initrd, firmware, runtime and guest-agent catalogs with digests, signatures, provenance, SBOM, scans, and revocation."
---
...
Implement sandbox image, rootfs, kernel, initrd, firmware, runtime and guest-agent catalogs with digests, signatures, provenance, SBOM, scans, and revocation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/sandbox-image-rootfs-kernel-runtime-and-supply-chain-baseline.md`.
...
```text
sandbox_image_rootfs_kernel_runtime_and_supply_chain_manifest.json
sandbox_image_rootfs_kernel_runtime_and_supply_chain_decision.json
sandbox_image_rootfs_kernel_runtime_and_supply_chain_evidence.json
```
