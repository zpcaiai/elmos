---
name: b95-lua-game-embedded-scripting-profile
description: "Use when ELMOS must run lua game embedded scripting profile for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG398"
  source_name: "lua-game-embedded-scripting-profile"
  source_sha256: "sha256:9b905722384ee2f82443a893eba9c3aefd222d38372ec883fd83566e12f6afde"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG398 — Lua Game Embedded Scripting Profile

## 1. Objective

Define a certified profile for lua game embedded scripting profile within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Lua Game Embedded Scripting Profile using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-game-embedded-scripting-profile.
