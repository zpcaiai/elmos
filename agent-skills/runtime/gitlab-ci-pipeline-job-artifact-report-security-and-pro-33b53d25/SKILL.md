---
name: gitlab-ci-pipeline-job-artifact-report-security-and-pro-33b53d25
description: 接入 GitLab Pipeline/Job/Retry/Bridge/Parent-Child/Multi-project、Artifact、Trace、报告与SBOM。
metadata:
  elmos_batch: "37B"
  elmos_skill_id: "EVI37B005"
  pack_version: "3.7-complete"
---

# EVI37B005 — GitLab CI Pipeline、Job、Artifact、Security 与 Provenance Connector

## Objective

接入 GitLab Pipeline/Job/Retry/Bridge/Parent-Child/Multi-project、Artifact、Trace、报告与SBOM。
...
- 支持 JUnit/Coverage/Code Quality/SAST/Dependency/Container/Secret/DAST/Fuzz/CycloneDX 报告。
- Job/Pipeline 状态与 Report Presence 独立建模。
- Artifact Redirect 必须重新验证目标 Host，下载后重算 SHA-256。
- Retry 建立 RETRY_OF，Parent/Child 与 Multi-project 建立 Lineage。
...
- retriedJobRemainsDistinct
- failedJobCanStillProvideReport
- successfulPipelineMissingRequiredReportIsIncomplete
- parentChildPipelineRelationshipIsPreserved
