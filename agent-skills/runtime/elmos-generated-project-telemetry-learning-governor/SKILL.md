---
name: elmos-generated-project-telemetry-learning-governor
description: Use privacy-governed production telemetry to improve templates, routes and tests while preserving tenant boundaries, consent and independent validation.
version: 4.0.0
...
# Generated Project Telemetry Learning Governor
...
- `GeneratedProjectTelemetryLearningGovernorProfile`
- `GeneratedProjectTelemetryLearningGovernorPlan`
- `GeneratedProjectTelemetryLearningGovernorRun`
- `GeneratedProjectTelemetryLearningGovernorDecision`

Required semantic capabilities:

- define allowed learning signals and purpose
- aggregate and de-identify across approved scope
- detect failure and performance patterns
- propose template/test improvements
- require holdout and canary before promotion
...
- `artifacts/elmos-generated-project-telemetry-learning-governor/profile.yaml`
- `artifacts/elmos-generated-project-telemetry-learning-governor/plan.json`
- `artifacts/elmos-generated-project-telemetry-learning-governor/result.json`
- `artifacts/elmos-generated-project-telemetry-learning-governor/evidence/`
...
- **customer data used without consent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **aggregation re-identifiable** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **telemetry bias favors large tenant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **learning signal rewards unsafe shortcut** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **raw prompt retained** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define allowed learning signals and purpose
- native scenario: aggregate and de-identify across approved scope
- native scenario: detect failure and performance patterns
- native scenario: propose template/test improvements
- native scenario: require holdout and canary before promotion
