---
name: elmos-document-record-control-certification-governor
description: Implement and independently certify certification document and record control governor, including control approval, issue, revision, access, retention, legal hold and disposition, distinguish normative controlled documents from informative guidance and preserve audit trail and superseded versions needed to reproduce decisions.
version: 4.0.0
...
# Certification Document and Record Control Governor
...
- `CertificationDocumentAndRecordControlGovernorProfile`
- `CertificationDocumentAndRecordControlGovernorRun`
- `CertificationDocumentAndRecordControlGovernorFinding`
- `CertificationDocumentAndRecordControlGovernorDecision`
- `CertificationDocumentAndRecordControlGovernorEvidence`

Required semantic capabilities:

- control approval, issue, revision, access, retention, legal hold and disposition
- distinguish normative controlled documents from informative guidance
- preserve audit trail and superseded versions needed to reproduce decisions
...
- `elmos-internal-audit-management-review-compiler`
- `elmos-evidence-worm-merkle-sealer`

## Primary Outputs

- `artifacts/elmos-document-record-control-certification-governor/profile.yaml`
- `artifacts/elmos-document-record-control-certification-governor/plan.json`
- `artifacts/elmos-document-record-control-certification-governor/result.json`
- `artifacts/elmos-document-record-control-certification-governor/evidence/`
- `artifacts/elmos-document-record-control-certification-governor/assurance-case.json`
...
- **obsolete criterion is used in evaluation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **record retention ends before certificate liability** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **editable document is accepted as immutable evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: control approval, issue, revision, access, retention, legal hold and disposition
- native scenario: distinguish normative controlled documents from informative guidance
- native scenario: preserve audit trail and superseded versions needed to reproduce decisions
