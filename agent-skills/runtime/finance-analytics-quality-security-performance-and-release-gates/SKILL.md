---
name: finance-analytics-quality-security-performance-and-release-gates
description: "Implement metric, bridge, cohort, margin, allocation, planning, forecast, variance, pricing, profitability, cockpit, security and performance release tests."
---
...
Implement metric, bridge, cohort, margin, allocation, planning, forecast, variance, pricing, profitability, cockpit, security and performance release tests.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/finance-analytics-quality-security-performance-and-release-gates-baseline.md`.
...
```text
finance_analytics_quality_security_performance_and_release_gates_manifest.json
finance_analytics_quality_security_performance_and_release_gates_decision.json
finance_analytics_quality_security_performance_and_release_gates_reconciliation.json
finance_analytics_quality_security_performance_and_release_gates_evidence.json
```
