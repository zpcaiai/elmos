...
description: "Run FRT-1504 ArkUI to Vue 3 Route Pack for FRT G15 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1504"
  source_name: "frt-1504-arkui-to-vue-3-route-pack"
  source_sha256: "sha256:0192d642373865e70e9d88e84f242e0e856ecb2f373104b509753054090c75db"
  batch: "G15"
...
- Runtime catalog key: `FRT-1504` / `frt-1504-arkui-to-vue-3-route-pack`.
...
# FRT-1504 — ArkUI to Vue 3 Route Pack

## Objective

在G15范围内实现 **ArkUI to Vue 3 Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射ArkUI状态装饰器、Builder、Navigation和生命周期; 处理Web DOM能力与ArkUI Native/Device差异; 生成真机/模拟器和Accessibility验证。

## When to Use

- 实现或修改与 **ArkUI to Vue 3 Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1504Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1504EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1504FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1504CertificateFragment`：供G15批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g15/frt-1504-arkui-to-vue-3-route-pack/
packages/runtime/g15/frt-1504-arkui-to-vue-3-route-pack/
services/control-plane/g15/frt-1504-arkui-to-vue-3-route-pack/
apps/web-console/src/features/g15/frt-1504-arkui-to-vue-3-route-pack/
apps/admin-console/src/features/g15/frt-1504-arkui-to-vue-3-route-pack/
tests/g15/frt-1504-arkui-to-vue-3-route-pack/
```
...
```text
POST /v1/skills/frt-1504/runs
GET  /v1/skills/frt-1504/runs/{run_id}
POST /v1/skills/frt-1504/runs/{run_id}/verify
GET  /v1/skills/frt-1504/runs/{run_id}/findings
GET  /v1/skills/frt-1504/runs/{run_id}/evidence
```
