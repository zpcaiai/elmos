...
- Invoke this repository Skill as `$pm-b12-lossless-semantic-transformation`.
- Immutable source identity: `batch-12-lossless-semantic-transformation` in `precision-migration-b01-44` (B12).
- Runtime adapter: `semantic-recovery-and-ir`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b12-lossless-semantic-transformation`.
...
- 当任务涉及 **lossless-source-tree** 时，调用 `../pm-b12-lossless-source-tree/SKILL.md`。
- 当任务涉及 **type-attributed-tree** 时，调用 `../pm-b12-type-attributed-tree/SKILL.md`。
- 当任务涉及 **comment-and-format-preservation** 时，调用 `../pm-b12-comment-and-format-preservation/SKILL.md`。
- 当任务涉及 **symbol-safe-renaming** 时，调用 `../pm-b12-symbol-safe-renaming/SKILL.md`。
- 当任务涉及 **import-and-namespace-rewriter** 时，调用 `../pm-b12-import-and-namespace-rewriter/SKILL.md`。
- 当任务涉及 **minimal-change-generator** 时，调用 `../pm-b12-minimal-change-generator/SKILL.md`。
- 当任务涉及 **source-location-mapper** 时，调用 `../pm-b12-source-location-mapper/SKILL.md`。
- 当任务涉及 **semantic-diff-generator** 时，调用 `../pm-b12-semantic-diff-generator/SKILL.md`。
- 当任务涉及 **transformation-result-set** 时，调用 `../pm-b12-transformation-result-set/SKILL.md`。
- 当任务涉及 **rollback-patch-generator** 时，调用 `../pm-b12-rollback-patch-generator/SKILL.md`。
