...
metadata:
  ...
  repository_handler_id: "handle_elmos_bigdata_test_validation"
...
- Source group: `bigdata-core`. Dependencies: `["elmos-batch-processing-generator", "elmos-stream-processing-generator", "elmos-lakehouse-generator", "elmos-warehouse-olap-serving", "elmos-data-quality-observability", "elmos-bigdata-infra-deployment", "elmos-bigdata-security-governance"]`. Triggers: `["代码已生成", "迁移/替换", "生产认证前"]`. Declared outputs: `["tests/", "test-matrix.json", "validation-report.md", "defect-ledger.json"]`. Stable task IDs: `["TEST-001", "TEST-002", "TEST-003", "TEST-004", "TEST-005", "TEST-006", "TEST-007", "TEST-008", "TEST-009", "TEST-010", "TEST-011", "TEST-012"]`.
- This normalized Skill is installed and invocable. The repository binds `handle_elmos_bigdata_test_validation` in `engines/database-bigdata-engine/src/elmos_database_bigdata/handlers/bigdata_core.py` as a bounded plan-skeleton entry point; the reviewed code declares no database, provider, network, deployment, benchmark, mutation, or certification operation.
