...
- Invoke this repository Skill as `$pm-b16-backend-direction-packs`.
- Immutable source identity: `batch-16-backend-direction-packs` in `precision-migration-b01-44` (B16).
- Runtime adapter: `directed-backend-route`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b16-backend-direction-packs`.
...
- 当任务涉及 **java-to-csharp-direction-pack** 时，调用 `../pm-b16-java-to-csharp-direction-pack/SKILL.md`。
- 当任务涉及 **java-to-go-direction-pack** 时，调用 `../pm-b16-java-to-go-direction-pack/SKILL.md`。
- 当任务涉及 **java-to-rust-direction-pack** 时，调用 `../pm-b16-java-to-rust-direction-pack/SKILL.md`。
- 当任务涉及 **java-to-python-direction-pack** 时，调用 `../pm-b16-java-to-python-direction-pack/SKILL.md`。
- 当任务涉及 **java-to-typescript-direction-pack** 时，调用 `../pm-b16-java-to-typescript-direction-pack/SKILL.md`。
- 当任务涉及 **csharp-to-java-direction-pack** 时，调用 `../pm-b16-csharp-to-java-direction-pack/SKILL.md`。
- 当任务涉及 **csharp-to-go-direction-pack** 时，调用 `../pm-b16-csharp-to-go-direction-pack/SKILL.md`。
- 当任务涉及 **csharp-to-rust-direction-pack** 时，调用 `../pm-b16-csharp-to-rust-direction-pack/SKILL.md`。
- 当任务涉及 **csharp-to-python-direction-pack** 时，调用 `../pm-b16-csharp-to-python-direction-pack/SKILL.md`。
- 当任务涉及 **csharp-to-typescript-direction-pack** 时，调用 `../pm-b16-csharp-to-typescript-direction-pack/SKILL.md`。
- 当任务涉及 **go-to-java-direction-pack** 时，调用 `../pm-b16-go-to-java-direction-pack/SKILL.md`。
- 当任务涉及 **go-to-csharp-direction-pack** 时，调用 `../pm-b16-go-to-csharp-direction-pack/SKILL.md`。
- 当任务涉及 **go-to-rust-direction-pack** 时，调用 `../pm-b16-go-to-rust-direction-pack/SKILL.md`。
- 当任务涉及 **go-to-python-direction-pack** 时，调用 `../pm-b16-go-to-python-direction-pack/SKILL.md`。
- 当任务涉及 **go-to-typescript-direction-pack** 时，调用 `../pm-b16-go-to-typescript-direction-pack/SKILL.md`。
- 当任务涉及 **rust-to-java-direction-pack** 时，调用 `../pm-b16-rust-to-java-direction-pack/SKILL.md`。
- 当任务涉及 **rust-to-csharp-direction-pack** 时，调用 `../pm-b16-rust-to-csharp-direction-pack/SKILL.md`。
- 当任务涉及 **rust-to-go-direction-pack** 时，调用 `../pm-b16-rust-to-go-direction-pack/SKILL.md`。
- 当任务涉及 **rust-to-python-direction-pack** 时，调用 `../pm-b16-rust-to-python-direction-pack/SKILL.md`。
- 当任务涉及 **rust-to-typescript-direction-pack** 时，调用 `../pm-b16-rust-to-typescript-direction-pack/SKILL.md`。
- 当任务涉及 **python-to-java-direction-pack** 时，调用 `../pm-b16-python-to-java-direction-pack/SKILL.md`。
- 当任务涉及 **python-to-csharp-direction-pack** 时，调用 `../pm-b16-python-to-csharp-direction-pack/SKILL.md`。
- 当任务涉及 **python-to-go-direction-pack** 时，调用 `../pm-b16-python-to-go-direction-pack/SKILL.md`。
- 当任务涉及 **python-to-rust-direction-pack** 时，调用 `../pm-b16-python-to-rust-direction-pack/SKILL.md`。
- 当任务涉及 **python-to-typescript-direction-pack** 时，调用 `../pm-b16-python-to-typescript-direction-pack/SKILL.md`。
- 当任务涉及 **typescript-to-java-direction-pack** 时，调用 `../pm-b16-typescript-to-java-direction-pack/SKILL.md`。
- 当任务涉及 **typescript-to-csharp-direction-pack** 时，调用 `../pm-b16-typescript-to-csharp-direction-pack/SKILL.md`。
- 当任务涉及 **typescript-to-go-direction-pack** 时，调用 `../pm-b16-typescript-to-go-direction-pack/SKILL.md`。
- 当任务涉及 **typescript-to-rust-direction-pack** 时，调用 `../pm-b16-typescript-to-rust-direction-pack/SKILL.md`。
- 当任务涉及 **typescript-to-python-direction-pack** 时，调用 `../pm-b16-typescript-to-python-direction-pack/SKILL.md`。
