...
# Hardware Root of Trust and Measured Boot Verifier
...
- `HardwareRootOfTrustAndMeasuredBootVerifierProfile`
- `HardwareRootOfTrustAndMeasuredBootVerifierRun`
- `HardwareRootOfTrustAndMeasuredBootVerifierFinding`
- `HardwareRootOfTrustAndMeasuredBootVerifierDecision`
- `HardwareRootOfTrustAndMeasuredBootVerifierEvidence`

Required semantic capabilities:

- verify TPM, DICE or platform root measurements from firmware through workload
- compare measurements with signed reference values and configuration
- bind workload identity, artifact digest and policy decision to boot evidence
...
- `artifacts/elmos-hardware-root-of-trust-measured-boot-verifier/profile.yaml`
- `artifacts/elmos-hardware-root-of-trust-measured-boot-verifier/plan.json`
- `artifacts/elmos-hardware-root-of-trust-measured-boot-verifier/result.json`
- `artifacts/elmos-hardware-root-of-trust-measured-boot-verifier/evidence/`
- `artifacts/elmos-hardware-root-of-trust-measured-boot-verifier/assurance-case.json`
...
- **measurement chain skips mutable boot component** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **golden value is unsigned** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **attestation belongs to different workload instance** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: verify TPM, DICE or platform root measurements from firmware through workload
- native scenario: compare measurements with signed reference values and configuration
- native scenario: bind workload identity, artifact digest and policy decision to boot evidence
