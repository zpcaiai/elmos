...
description: Use this skill when Elmos must perform structured output enforcement as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
使用 JSON Schema、语法约束和修复策略保证输出可被程序消费。
