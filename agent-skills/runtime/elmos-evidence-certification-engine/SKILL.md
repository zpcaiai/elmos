---
name: "elmos-evidence-certification-engine"
description: "Invoke the bounded repository handler for elmos-evidence-certification-engine while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P05:evidence-certification-engine"
  source_name: "elmos-evidence-certification-engine"
  installed_name: "elmos-evidence-certification-engine"
  source_logical_path: "05-elmos-conversion-reliability-verification-harness/skills/evidence-certification-engine/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/05-elmos-conversion-reliability-verification-harness/skills/evidence-certification-engine/SKILL.md.source-data"
  source_materialized_path: "05-elmos-conversion-reliability-verification-harness/skills/evidence-certification-engine/SKILL.md.source-data"
  source_sha256: "sha256:f9ebde0a617457b613621cc440ea7517c2691caaae62cd7aba9f779806db2f1c"
...
# elmos-evidence-certification-engine
...
- This is a deterministic repository wrapper for `05-elmos-conversion-reliability-verification-harness/skills/evidence-certification-engine/SKILL.md` at `sha256:f9ebde0a617457b613621cc440ea7517c2691caaae62cd7aba9f779806db2f1c`.
- Its immutable source/runtime identity is `elmos-evidence-certification-engine`; its active installed identity is `elmos-evidence-certification-engine`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-evidence-certification-engine --request <file>
```
