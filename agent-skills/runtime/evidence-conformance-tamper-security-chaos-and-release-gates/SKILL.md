---
name: evidence-conformance-tamper-security-chaos-and-release-gates
description: 实现标准一致性、篡改、信任、Retention、Offline、Privacy、Scale 与DR发布门禁。
metadata:
  elmos_batch: "37A"
  elmos_skill_id: "ART37A016"
  pack_version: "3.7-complete"
---

# ART37A016 — Conformance、Tamper、Security、Chaos 与 Release Gates

## Objective

实现标准一致性、篡改、信任、Retention、Offline、Privacy、Scale 与DR发布门禁。
...
- operations.evidence_conformance_runs
- operations.evidence_tamper_runs
- operations.evidence_scale_runs
- operations.evidence_release_gate_runs
...
- 覆盖 in-toto/DSSE/Sigstore/SLSA/SPDX/CycloneDX/OCI 标准 Fixtures。
- 篡改 Content、Subject、Predicate、Signature、Timestamp、SBOM、VSA、Pack Item。
- 测试 Signer/Builder/Trust Root 撤销、Object Store 双写故障、图丢失与离线无网验证。
- 生成 build/evidence/artifact-provenance-evidence-fabric-gate.json。
...
- artifactImmutabilityGatePasses
- tamperedManifestFails
- offlinePackNetworkDisabledPasses
- artifactRestoreGatePasses
