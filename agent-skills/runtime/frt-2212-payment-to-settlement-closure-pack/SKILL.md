...
description: "Run FRT-2212 Payment-to-Settlement Closure Pack for FRT G22 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2212"
  source_name: "frt-2212-payment-to-settlement-closure-pack"
  source_sha256: "sha256:4279c857338e94041f1371328372bbca28c7210972aa7e1601485b5fdcefad36"
  batch: "G22"
...
- Runtime catalog key: `FRT-2212` / `frt-2212-payment-to-settlement-closure-pack`.
...
在G22范围内实现 **Payment-to-Settlement Closure Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Value Stream 与业务Outcome建模; 状态机可达性、终态、Timeout、Cancel、Unknown、Recovery完整性; 跨域Saga、幂等、补偿和Reconciliation。

## When to Use

- 实现或修改与 **Payment-to-Settlement Closure Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2212Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2212EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2212FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2212CertificateFragment`：供G22批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g22/frt-2212-payment-to-settlement-closure-pack/
packages/runtime/g22/frt-2212-payment-to-settlement-closure-pack/
services/control-plane/g22/frt-2212-payment-to-settlement-closure-pack/
apps/web-console/src/features/g22/frt-2212-payment-to-settlement-closure-pack/
apps/admin-console/src/features/g22/frt-2212-payment-to-settlement-closure-pack/
tests/g22/frt-2212-payment-to-settlement-closure-pack/
```
...
```text
POST /v1/skills/frt-2212/runs
GET  /v1/skills/frt-2212/runs/{run_id}
POST /v1/skills/frt-2212/runs/{run_id}/verify
GET  /v1/skills/frt-2212/runs/{run_id}/findings
GET  /v1/skills/frt-2212/runs/{run_id}/evidence
```
