...
description: "Run FRT-1113 UI Fidelity Certification for FRT G11 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1113"
  source_name: "frt-1113-ui-fidelity-certification"
  source_sha256: "sha256:16e4d5e10c2f36f7d44959525eedac2c1ecf5ec37b6e30b47531d82c8b722bc5"
  batch: "G11"
...
- Runtime catalog key: `FRT-1113` / `frt-1113-ui-fidelity-certification`.
...
# FRT-1113 — UI Fidelity Certification

## Objective

在G11范围内实现 **UI Fidelity Certification**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：恢复布局约束、Design Token和响应式Size Class; 生成资产、字体、Icon、Theme和动画映射; 保持Locale、Plural、Date/Number和RTL语义。

## When to Use

- 实现或修改与 **UI Fidelity Certification** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1113Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1113EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1113FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1113CertificateFragment`：供G11批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g11/frt-1113-ui-fidelity-certification/
packages/runtime/g11/frt-1113-ui-fidelity-certification/
services/control-plane/g11/frt-1113-ui-fidelity-certification/
apps/web-console/src/features/g11/frt-1113-ui-fidelity-certification/
apps/admin-console/src/features/g11/frt-1113-ui-fidelity-certification/
tests/g11/frt-1113-ui-fidelity-certification/
```
...
```text
POST /v1/skills/frt-1113/runs
GET  /v1/skills/frt-1113/runs/{run_id}
POST /v1/skills/frt-1113/runs/{run_id}/verify
GET  /v1/skills/frt-1113/runs/{run_id}/findings
GET  /v1/skills/frt-1113/runs/{run_id}/evidence
```
