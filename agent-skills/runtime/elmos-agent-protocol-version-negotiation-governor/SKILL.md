---
name: elmos-agent-protocol-version-negotiation-governor
description: Govern exact MCP, A2A, ACP and UI protocol versions, extensions, downgrade, deprecation and evidence invalidation.
version: 4.0.0
...
# Agent Protocol Version Negotiation Governor
...
- `AgentProtocolVersionNegotiationGovernorProfile`
- `AgentProtocolVersionNegotiationGovernorPlan`
- `AgentProtocolVersionNegotiationGovernorRun`
- `AgentProtocolVersionNegotiationGovernorDecision`

Required semantic capabilities:

- discover peer versions and extensions
- select compatible profile with no silent downgrade
- record unsupported/deprecated capabilities
- test mixed-version rollout and fallback
- invalidate evidence after protocol change
...
- `artifacts/elmos-agent-protocol-version-negotiation-governor/profile.yaml`
- `artifacts/elmos-agent-protocol-version-negotiation-governor/plan.json`
- `artifacts/elmos-agent-protocol-version-negotiation-governor/result.json`
- `artifacts/elmos-agent-protocol-version-negotiation-governor/evidence/`
...
- **downgrade strips security feature** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **latest alias unpinned** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **extension collision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **peer lies about capability** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deprecated version remains certified** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: discover peer versions and extensions
- native scenario: select compatible profile with no silent downgrade
- native scenario: record unsupported/deprecated capabilities
- native scenario: test mixed-version rollout and fallback
- native scenario: invalidate evidence after protocol change
