---
name: elmos-ai-evaluation-power-sample-size-planner
description: Implement and independently certify ai evaluation power and sample-size planner, including plan sample size for minimum relevant effect, variance, confidence and subgroup coverage, account for clustered, repeated and adaptive measurements and report underpowered claims as bounded or indeterminate.
version: 4.0.0
...
# AI Evaluation Power and Sample-Size Planner
...
- `AIEvaluationPowerAndSampleSizePlannerProfile`
- `AIEvaluationPowerAndSampleSizePlannerRun`
- `AIEvaluationPowerAndSampleSizePlannerFinding`
- `AIEvaluationPowerAndSampleSizePlannerDecision`
- `AIEvaluationPowerAndSampleSizePlannerEvidence`

Required semantic capabilities:

- plan sample size for minimum relevant effect, variance, confidence and subgroup coverage
- account for clustered, repeated and adaptive measurements
- report underpowered claims as bounded or indeterminate
...
- `elmos-performance-statistical-gate` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-ai-evaluation-power-sample-size-planner/profile.yaml`
- `artifacts/elmos-ai-evaluation-power-sample-size-planner/plan.json`
- `artifacts/elmos-ai-evaluation-power-sample-size-planner/result.json`
- `artifacts/elmos-ai-evaluation-power-sample-size-planner/evidence/`
- `artifacts/elmos-ai-evaluation-power-sample-size-planner/assurance-case.json`
...
- **test is designed only after observed effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **subgroup power is ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **adaptive stopping inflates false positives** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: plan sample size for minimum relevant effect, variance, confidence and subgroup coverage
- native scenario: account for clustered, repeated and adaptive measurements
- native scenario: report underpowered claims as bounded or indeterminate
