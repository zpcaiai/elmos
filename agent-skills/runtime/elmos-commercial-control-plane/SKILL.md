---
name: "elmos-commercial-control-plane"
description: "Invoke the bounded repository handler for elmos-commercial-control-plane while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P00:commercial-control-plane"
  source_name: "elmos-commercial-control-plane"
  installed_name: "elmos-commercial-control-plane"
  source_logical_path: "00-elmos-software-factory-master/skills/commercial-control-plane/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/00-elmos-software-factory-master/skills/commercial-control-plane/SKILL.md.source-data"
  source_materialized_path: "00-elmos-software-factory-master/skills/commercial-control-plane/SKILL.md.source-data"
  source_sha256: "sha256:56c6137bf10adeee8fa76368fd64a5f39db8ff3902f645e77851c6fd0c7732ba"
...
# elmos-commercial-control-plane
...
- This is a deterministic repository wrapper for `00-elmos-software-factory-master/skills/commercial-control-plane/SKILL.md` at `sha256:56c6137bf10adeee8fa76368fd64a5f39db8ff3902f645e77851c6fd0c7732ba`.
- Its immutable source/runtime identity is `elmos-commercial-control-plane`; its active installed identity is `elmos-commercial-control-plane`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-commercial-control-plane --request <file>
```
