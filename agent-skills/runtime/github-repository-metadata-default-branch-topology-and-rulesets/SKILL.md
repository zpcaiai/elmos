---
name: github-repository-metadata-default-branch-topology-and-rulesets
description: "Implement repository metadata, visibility, default branch, branch topology, rulesets, protection, merge settings, CODEOWNERS, and policy snapshots."
---
...
Implement repository metadata, visibility, default branch, branch topology, rulesets, protection, merge settings, CODEOWNERS, and policy snapshots.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-repository-metadata-default-branch-topology-and-rulesets-baseline.md`.
...
```text
github_repository_metadata_default_branch_topology_and_rulesets_manifest.json
github_repository_metadata_default_branch_topology_and_rulesets_decision.json
github_repository_metadata_default_branch_topology_and_rulesets_evidence.json
```
