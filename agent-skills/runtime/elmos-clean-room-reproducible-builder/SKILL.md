---
name: elmos-clean-room-reproducible-builder
description: Rebuild release candidates in an isolated certification environment from frozen source, lockfiles and declared inputs, producing independent artifact and provenance evidence.
version: 4.0.0
...
# Clean-Room Reproducible Builder
...
- Use fresh isolated builder identity and workspace
- Fetch only declared content-addressed inputs
- Capture complete source/build provenance
- Compare independently rebuilt artifacts
- Block unexplained binary differences
...
- `elmos-ai-revision-set-freezer` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `clean-room-artifacts/`
- `reproducible-build-report.json`
- `independent-build-provenance.json`
- `build-difference-analysis.json`
...
- **generator supplies prebuilt hidden input** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **build network fetch unrecorded** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **timestamp/path nondeterminism accepted blindly** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **certification builder shares credentials** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **artifact substitution after rebuild** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- offline/hermetic rebuild
- source provenance verification
- dependency lock enforcement
- binary reproducibility
- builder compromise simulation
- unexplained difference blocks
