...
description: Use this skill when Elmos must perform release bundle contract as part of the 00-foundation-contracts production
...
把模型、Adapter、Skill 集、知识快照、工具链、策略和评测基线绑定为不可变发布单元。
