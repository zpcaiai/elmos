---
name: b95-lua-parser-and-semantic-model
description: "Use when ELMOS must run lua parser and semantic model for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG392"
  source_name: "lua-parser-and-semantic-model"
  source_sha256: "sha256:36f4f39b27e6fb37dd70677231536e4d0d21de641fd659c9c0186bd64b7d6fa6"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG392 — Lua Parser And Semantic Model

## 1. Objective

Parse and semantically index lua parser and semantic model within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Lua Parser And Semantic Model using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-parser-and-semantic-model.
