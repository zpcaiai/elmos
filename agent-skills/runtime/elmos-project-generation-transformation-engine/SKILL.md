...
description: "Invoke the bounded repository handler for elmos-project-generation-transformation-engine while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_key: "P03"
  source_name: "elmos-project-generation-transformation-engine"
  installed_name: "elmos-project-generation-transformation-engine"
  source_logical_path: "03-elmos-project-generation-transformation-engine/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/03-elmos-project-generation-transformation-engine/SKILL.md.source-data"
  source_materialized_path: "03-elmos-project-generation-transformation-engine/SKILL.md.source-data"
  source_sha256: "sha256:e92588936329d029231d30801b89f9797a8c44d34f91355aa84b96929043cfbc"
...
- This is a deterministic repository wrapper for `03-elmos-project-generation-transformation-engine/SKILL.md` at `sha256:e92588936329d029231d30801b89f9797a8c44d34f91355aa84b96929043cfbc`.
- Its immutable source/runtime identity is `elmos-project-generation-transformation-engine`; its active installed identity is `elmos-project-generation-transformation-engine`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-project-generation-transformation-engine --request <file>
```
