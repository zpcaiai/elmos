...
description: Use this skill when Elmos must perform support diagnostic bundle as part of the 13-commercial-multitenant-platform
...
在不泄露客户秘密的前提下导出版本、Trace、错误、依赖和健康信息。
