---
name: b102-human-oracle-approval
description: "Use when ELMOS must Capture expert judgments for irreducible semantics with exact scope, evidence and separation of duties. Triggers: Human Oracle and Approval, Semantic Equivalence Lab Pack, human review, approval, scope, rationale."
metadata:
  id: B102-S14
...
# B102-S14 — Human Oracle and Approval

## Objective

Capture expert judgments for irreducible semantics with exact scope, evidence and separation of duties.
...
Use this Skill when the approved task explicitly requires **Human Oracle and Approval** or when the capability graph selects it as part of a minimal dependency closure.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b102-human-oracle-approval/SKILL.md --out /tmp/human_oracle_approval.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B102-S14
```
...
- Reject or expose rubber stamp.
- Reject or expose evidence unavailable to reviewer.
