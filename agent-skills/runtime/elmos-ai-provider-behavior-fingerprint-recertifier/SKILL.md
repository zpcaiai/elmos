---
name: elmos-ai-provider-behavior-fingerprint-recertifier
description: Fingerprint model/provider behavior with versioned probes and invalidate evidence when tool calling, schema compliance,
  safety, latency or accounting drifts.
version: 4.0.0
...
# AI Provider Behavior Fingerprint Recertifier
...
- **Kernel authorities used:** K2, K6, K7, K8
...
- `Counterexample`
- `CoverageMap`
- `AIProviderBehaviorFingerprintRecertifierRun`
- `AIProviderBehaviorFingerprintRecertifierDecision`

Required semantic capabilities:

- Resolved model/version and region capture
- Tool-call and structured-output probes
- Safety/refusal/cache/accounting fingerprint
- Distributional drift thresholds
- Evidence invalidation and recertification workflow
...
- `elmos-ai-compatibility-drift-monitor` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `provider-fingerprint.json`
- `behavior-drift-report.json`
- `evidence-invalidation.json`
- `recertification-decision.json`
...
- **alias silently retargeted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider region drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hidden policy change** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cache semantic change** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale certificate reuse** — must have a preventive control, a detective signal, a negative fixture and a response action.
