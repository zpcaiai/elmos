---
name: elmos-reference-dataset-material-producer-governor
description: Implement and independently certify reference dataset and digital reference material producer governor, including produce characterized reference datasets, prompts, traces and expected outputs with homogeneity and stability evidence, assign property values, uncertainties, provenance and intended-use limits and control distribution, storage, versioning and commutability.
version: 4.0.0
...
# Reference Dataset and Digital Reference Material Producer Governor

## Objective

Implement and independently certify reference dataset and digital reference material producer governor, including produce characterized reference datasets, prompts, traces and expected outputs with homogeneity and stability evidence, assign property values, uncertainties, provenance and intended-use limits and control distribution, storage, versioning and commutability.
...
- `ReferenceDatasetAndDigitalReferenceMaterialProducerGovernorProfile`
- `ReferenceDatasetAndDigitalReferenceMaterialProducerGovernorRun`
- `ReferenceDatasetAndDigitalReferenceMaterialProducerGovernorFinding`
- `ReferenceDatasetAndDigitalReferenceMaterialProducerGovernorDecision`
- `ReferenceDatasetAndDigitalReferenceMaterialProducerGovernorEvidence`

Required semantic capabilities:

- produce characterized reference datasets, prompts, traces and expected outputs with homogeneity and stability evidence
- assign property values, uncertainties, provenance and intended-use limits
- control distribution, storage, versioning and commutability
...
- `elmos-digital-metrology-measurand-definition-compiler`

### External Package Dependencies

- `elmos-ai-eval-dataset-governor` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-reference-dataset-material-producer-governor/profile.yaml`
- `artifacts/elmos-reference-dataset-material-producer-governor/plan.json`
- `artifacts/elmos-reference-dataset-material-producer-governor/result.json`
- `artifacts/elmos-reference-dataset-material-producer-governor/evidence/`
- `artifacts/elmos-reference-dataset-material-producer-governor/assurance-case.json`
...
- **reference set is contaminated by target model** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **expected label lacks uncertainty or adjudication** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **reference artifact changes after distribution** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: produce characterized reference datasets, prompts, traces and expected outputs with homogeneity and stability evidence
- native scenario: assign property values, uncertainties, provenance and intended-use limits
- native scenario: control distribution, storage, versioning and commutability
