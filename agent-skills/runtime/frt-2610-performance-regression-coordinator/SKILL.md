...
description: "Run FRT-2610 Performance Regression Coordinator for FRT G26 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2610"
  source_name: "frt-2610-performance-regression-coordinator"
  source_sha256: "sha256:81240d635a3a63b3e4ed3dc2320de40c78bf8c85198caebaaa53cbb6f0c96465"
  batch: "G26"
...
- Runtime catalog key: `FRT-2610` / `frt-2610-performance-regression-coordinator`.
...
在G26范围内实现 **Performance Regression Coordinator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Requirement/Acceptance/State Machine派生Test Obligation; Unit/Component/Contract/Integration/Journey分层协调; Differential、Mutation、Visual/Semantic、Security和Performance Regression。

## When to Use

- 实现或修改与 **Performance Regression Coordinator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2610Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2610EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2610FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2610CertificateFragment`：供G26批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g26/frt-2610-performance-regression-coordinator/
packages/runtime/g26/frt-2610-performance-regression-coordinator/
services/control-plane/g26/frt-2610-performance-regression-coordinator/
apps/web-console/src/features/g26/frt-2610-performance-regression-coordinator/
apps/admin-console/src/features/g26/frt-2610-performance-regression-coordinator/
tests/g26/frt-2610-performance-regression-coordinator/
```
...
```text
POST /v1/skills/frt-2610/runs
GET  /v1/skills/frt-2610/runs/{run_id}
POST /v1/skills/frt-2610/runs/{run_id}/verify
GET  /v1/skills/frt-2610/runs/{run_id}/findings
GET  /v1/skills/frt-2610/runs/{run_id}/evidence
```
