---
name: lastmile-delivery-domain-model-lifecycle-and-state-machine
description: "Implement Batch 51B Warehouse、Last-mile、Delivery与Returns canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return."
---

# Lastmile Delivery Domain Model Lifecycle And State Machine

## Objective

Implement Batch 51B Warehouse、Last-mile、Delivery与Returns canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Order、Shipment、Parcel、Wave、Pick、Pack、Carrier、Delivery Attempt、Proof of Delivery与Return.
...
5. Write unresolved domain assumptions to `docs/implementation/lastmile-delivery-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
lastmile_delivery_domain_model_lifecycle_and_state_machine_manifest.json
lastmile_delivery_domain_model_lifecycle_and_state_machine_state.json
lastmile_delivery_domain_model_lifecycle_and_state_machine_decision.json
lastmile_delivery_domain_model_lifecycle_and_state_machine_reconciliation.json
lastmile_delivery_domain_model_lifecycle_and_state_machine_evidence.json
```
