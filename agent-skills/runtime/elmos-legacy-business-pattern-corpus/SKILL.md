---
name: elmos-legacy-business-pattern-corpus
description: "Curate realistic batch, transaction, screen, record, report, decimal and procedural patterns from COBOL/RPG/PL/I/4GL estates."
version: 1.0.0
skill_id: ELMOS-POLY-256
layer: corpus
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-legacy-business-pattern-corpus`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-legacy-business-pattern-corpus/model.json"
  - "semantic-assurance/elmos-legacy-business-pattern-corpus/evidence.json"
  - "semantic-assurance/elmos-legacy-business-pattern-corpus/diagnostics.json"
---

# Legacy Business Pattern Corpus

## Objective

Curate realistic batch, transaction, screen, record, report, decimal and procedural patterns from COBOL/RPG/PL/I/4GL estates.
...
- [ ] COBOL batch fixture.
- [ ] RPG indicator/DDS fixture.
- [ ] PowerBuilder DataWindow fixture.
