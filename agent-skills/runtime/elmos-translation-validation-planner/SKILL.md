...
triggers:
  - "Use when implementing or executing `elmos-translation-validation-planner`."
  - "Use when a migration/certification DAG requires `formal-assurance` capability."
outputs:
  - "semantic-assurance/elmos-translation-validation-planner/model.json"
  - "semantic-assurance/elmos-translation-validation-planner/evidence.json"
  - "semantic-assurance/elmos-translation-validation-planner/diagnostics.json"
---

# Translation Validation Planner

## Objective

Select per-function/module/route validation strategies such as refinement checking, symbolic execution, BMC or runtime differential evidence.
...
- [ ] LLVM-lowerable function plan.
- [ ] stateful service plan.
- [ ] unsupported proof path falls back safely.
