---
name: procurement-s2p-orchestrator
description: "Implement Batch 42A Source-to-Pay、Procurement与Supplier Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Supplier、Sourcing、RFX、Bid、Purchase Requisition、Purchase Order、Receipt、Invoice Match、Contract与Supplier Risk."
---
...
Implement Batch 42A Source-to-Pay、Procurement与Supplier Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Supplier、Sourcing、RFX、Bid、Purchase Requisition、Purchase Order、Receipt、Invoice Match、Contract与Supplier Risk.
...
5. Write unresolved domain assumptions to `docs/implementation/procurement-s2p-orchestrator-baseline.md`.
...
```text
procurement_s2p_orchestrator_manifest.json
procurement_s2p_orchestrator_state.json
procurement_s2p_orchestrator_decision.json
procurement_s2p_orchestrator_reconciliation.json
procurement_s2p_orchestrator_evidence.json
```
