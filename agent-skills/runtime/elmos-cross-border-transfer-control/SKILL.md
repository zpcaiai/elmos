...
description: Use this skill when Elmos must perform cross border transfer control as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
