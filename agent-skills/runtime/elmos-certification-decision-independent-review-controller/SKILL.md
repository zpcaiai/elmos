---
name: elmos-certification-decision-independent-review-controller
description: Implement and independently certify independent review and certification decision controller, including verify evidence completeness and conformity before decision, require decision maker independence from evaluation and remediation and produce reasoned sign, deny, suspend or scope-reduce decision.
version: 4.0.0
...
# Independent Review and Certification Decision Controller

## Objective

Implement and independently certify independent review and certification decision controller, including verify evidence completeness and conformity before decision, require decision maker independence from evaluation and remediation and produce reasoned sign, deny, suspend or scope-reduce decision.
...
- **Kernel authorities used:** K1, K6, K8
...
- `IndependentReviewAndCertificationDecisionControllerProfile`
- `IndependentReviewAndCertificationDecisionControllerRun`
- `IndependentReviewAndCertificationDecisionControllerFinding`
- `IndependentReviewAndCertificationDecisionControllerDecision`
- `IndependentReviewAndCertificationDecisionControllerEvidence`

Required semantic capabilities:

- verify evidence completeness and conformity before decision
- require decision maker independence from evaluation and remediation
- produce reasoned sign, deny, suspend or scope-reduce decision
...
- `artifacts/elmos-certification-decision-independent-review-controller/profile.yaml`
- `artifacts/elmos-certification-decision-independent-review-controller/plan.json`
- `artifacts/elmos-certification-decision-independent-review-controller/result.json`
- `artifacts/elmos-certification-decision-independent-review-controller/evidence/`
- `artifacts/elmos-certification-decision-independent-review-controller/assurance-case.json`
...
- **review checks file presence instead of technical adequacy** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **decision maker can modify evaluator findings** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **commercial deadline overrides critical nonconformity** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: verify evidence completeness and conformity before decision
- native scenario: require decision maker independence from evaluation and remediation
- native scenario: produce reasoned sign, deny, suspend or scope-reduce decision
