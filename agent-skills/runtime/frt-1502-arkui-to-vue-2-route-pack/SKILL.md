...
description: "Run FRT-1502 ArkUI to Vue 2 Route Pack for FRT G15 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1502"
  source_name: "frt-1502-arkui-to-vue-2-route-pack"
  source_sha256: "sha256:ddda5c0dd44ce3c5e54c9071ba4a2d0de5287318dd4e430d7cba6a1c93e60998"
  batch: "G15"
...
- Runtime catalog key: `FRT-1502` / `frt-1502-arkui-to-vue-2-route-pack`.
...
# FRT-1502 — ArkUI to Vue 2 Route Pack

## Objective

在G15范围内实现 **ArkUI to Vue 2 Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射ArkUI状态装饰器、Builder、Navigation和生命周期; 处理Web DOM能力与ArkUI Native/Device差异; 生成真机/模拟器和Accessibility验证。

## When to Use

- 实现或修改与 **ArkUI to Vue 2 Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1502Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1502EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1502FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1502CertificateFragment`：供G15批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g15/frt-1502-arkui-to-vue-2-route-pack/
packages/runtime/g15/frt-1502-arkui-to-vue-2-route-pack/
services/control-plane/g15/frt-1502-arkui-to-vue-2-route-pack/
apps/web-console/src/features/g15/frt-1502-arkui-to-vue-2-route-pack/
apps/admin-console/src/features/g15/frt-1502-arkui-to-vue-2-route-pack/
tests/g15/frt-1502-arkui-to-vue-2-route-pack/
```
...
```text
POST /v1/skills/frt-1502/runs
GET  /v1/skills/frt-1502/runs/{run_id}
POST /v1/skills/frt-1502/runs/{run_id}/verify
GET  /v1/skills/frt-1502/runs/{run_id}/findings
GET  /v1/skills/frt-1502/runs/{run_id}/evidence
```
