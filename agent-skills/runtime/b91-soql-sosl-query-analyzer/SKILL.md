---
name: b91-soql-sosl-query-analyzer
description: "Use when ELMOS must run soql sosl query analyzer for Batch 91 Salesforce Apex / SOQL / LWC Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG345"
  source_name: "soql-sosl-query-analyzer"
  source_sha256: "sha256:b68ff73549fb645ca1492c410c35ab4f34e998b9880bf264c585f871bf505de0"
  batch: 91
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 91 Language Pack / source PG345 — Soql Sosl Query Analyzer

## 1. Objective

Analyze soql sosl query analyzer within the Salesforce Apex / SOQL / LWC Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Soql Sosl Query Analyzer using the approved enterprise-crm-platform semantic contracts and toolchain versions.
...
- A representative valid salesforce input produces all declared outputs for soql-sosl-query-analyzer.
