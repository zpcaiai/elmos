...
description: "Run FRT-2715 Capacity Planning Generator for FRT G27 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2715"
  source_name: "frt-2715-capacity-planning-generator"
  source_sha256: "sha256:b99ea9e9c5f459cd737877f3e0ddae666e61f6ed0dec24d03211e196527edb32"
  batch: "G27"
...
- Runtime catalog key: `FRT-2715` / `frt-2715-capacity-planning-generator`.
...
在G27范围内实现 **Capacity Planning Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：业务化Workload Model; 并发线性化点、Race、Lost Update、Idempotency Under Load; Load/Stress/Spike/Soak与Recovery。

## When to Use

- 实现或修改与 **Capacity Planning Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2715Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2715EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2715FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2715CertificateFragment`：供G27批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g27/frt-2715-capacity-planning-generator/
packages/runtime/g27/frt-2715-capacity-planning-generator/
services/control-plane/g27/frt-2715-capacity-planning-generator/
apps/web-console/src/features/g27/frt-2715-capacity-planning-generator/
apps/admin-console/src/features/g27/frt-2715-capacity-planning-generator/
tests/g27/frt-2715-capacity-planning-generator/
```
...
```text
POST /v1/skills/frt-2715/runs
GET  /v1/skills/frt-2715/runs/{run_id}
POST /v1/skills/frt-2715/runs/{run_id}/verify
GET  /v1/skills/frt-2715/runs/{run_id}/findings
GET  /v1/skills/frt-2715/runs/{run_id}/evidence
```
