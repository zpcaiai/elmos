---
name: "elmos-cross-language-product-program"
description: "把源函数与目标函数组合为单一关系程序，自动证明相同输入关系下的输出、异常、Heap 与效应关系。 Use when the task needs the exact Cross-language Product Program Verifier Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-cross-language-product-program/SKILL.md"
  source_sha256: "sha256:f15c5c936e6889a806e7a74bff03b2a563ce839ff78ff83e6ccab95d747e436b"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "cross-language"
  runtime_handler_id: "execute_elmos_cross_language_product_program"
...
---
# Cross-language Product Program Verifier

## Repository integration boundary

- Exact Skill identity: `elmos-cross-language-product-program`; exact allowlisted runtime handler: `execute_elmos_cross_language_product_program`.
- Source identity: `skills/P0/elmos-cross-language-product-program/SKILL.md` at `sha256:f15c5c936e6889a806e7a74bff03b2a563ce839ff78ff83e6ccab95d747e436b` from `elmos-formal-assurance-kernel-v1.0.0`.
...
把源函数与目标函数组合为单一关系程序，自动证明相同输入关系下的输出、异常、Heap 与效应关系。
...
3. Use the repository-owned `execute_elmos_cross_language_product_program` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["product programs","self-composition","relational invariants","symbolic execution"]`
- Direct dependencies: `["elmos-observable-behavior-contract","elmos-proof-obligation-planner","elmos-verifier-portfolio-router","elmos-semantic-ir-formal-semantics"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-cross-language-product-program/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
