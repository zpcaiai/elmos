---
name: sandbox-domain-contract-profile-policy-and-lifecycle
description: "Implement sandbox contracts, isolation tiers, profiles, policy compiler, typed commands/mounts/networks/secrets/resources, provider selection, lifecycle, APIs, and audit."
---
...
Implement sandbox contracts, isolation tiers, profiles, policy compiler, typed commands/mounts/networks/secrets/resources, provider selection, lifecycle, APIs, and audit.
...
4. Record unresolved provider/version assumptions in `docs/implementation/sandbox-domain-contract-profile-policy-and-lifecycle-baseline.md`.
...
```text
sandbox_domain_contract_profile_policy_and_lifecycle_manifest.json
sandbox_domain_contract_profile_policy_and_lifecycle_decision.json
sandbox_domain_contract_profile_policy_and_lifecycle_evidence.json
```
