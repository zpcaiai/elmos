---
name: b94-phoenix-liveview-api-generator
description: "Use when ELMOS must run phoenix liveview api generator for Batch 94 Erlang / Elixir / Gleam BEAM Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG388"
  source_name: "phoenix-liveview-api-generator"
  source_sha256: "sha256:f854d0d1287afb0188b05d9b7979d37124efc96fa1cc036d81cdb7b1ce52b384"
  batch: 94
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 94 Language Pack / source PG388 — Phoenix Liveview API Generator

## 1. Objective

Generate phoenix liveview api generator within the Erlang / Elixir / Gleam BEAM Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Phoenix Liveview API Generator using the approved fault-tolerant-runtime semantic contracts and toolchain versions.
...
- A representative valid beam-erlang-elixir-gleam input produces all declared outputs for phoenix-liveview-api-generator.
