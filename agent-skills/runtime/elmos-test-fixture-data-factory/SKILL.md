---
name: elmos-test-fixture-data-factory
description: Generate deterministic, privacy-safe, versioned fixtures and edge corpora with referential integrity, data distributions, provenance and deletion rules.
version: 4.0.0
...
- **Kernel authorities used:** K2, K5, K6, K7
...
- Generate schema-valid deterministic data
- Preserve business invariants and referential integrity
- Include boundary and adversarial distributions
- De-identify or synthesize sensitive data
- Version and garbage-collect fixtures safely
...
- **production PII copied to test** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fixture generator violates invariant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **random seed not recorded** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **test data too clean** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-tenant fixture reuse** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- fixture deletion and retention
