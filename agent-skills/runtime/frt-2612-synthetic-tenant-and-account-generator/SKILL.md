...
description: "Run FRT-2612 Synthetic Tenant and Account Generator for FRT G26 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2612"
  source_name: "frt-2612-synthetic-tenant-and-account-generator"
  source_sha256: "sha256:5799c7b3a01308640347d43b4fabf97b5fc2b1502d48c5d2b6afc051a74e9be2"
  batch: "G26"
...
- Runtime catalog key: `FRT-2612` / `frt-2612-synthetic-tenant-and-account-generator`.
...
在G26范围内实现 **Synthetic Tenant and Account Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Requirement/Acceptance/State Machine派生Test Obligation; Unit/Component/Contract/Integration/Journey分层协调; Differential、Mutation、Visual/Semantic、Security和Performance Regression。

## When to Use

- 实现或修改与 **Synthetic Tenant and Account Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2612Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2612EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2612FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2612CertificateFragment`：供G26批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g26/frt-2612-synthetic-tenant-and-account-generator/
packages/runtime/g26/frt-2612-synthetic-tenant-and-account-generator/
services/control-plane/g26/frt-2612-synthetic-tenant-and-account-generator/
apps/web-console/src/features/g26/frt-2612-synthetic-tenant-and-account-generator/
apps/admin-console/src/features/g26/frt-2612-synthetic-tenant-and-account-generator/
tests/g26/frt-2612-synthetic-tenant-and-account-generator/
```
...
```text
POST /v1/skills/frt-2612/runs
GET  /v1/skills/frt-2612/runs/{run_id}
POST /v1/skills/frt-2612/runs/{run_id}/verify
GET  /v1/skills/frt-2612/runs/{run_id}/findings
GET  /v1/skills/frt-2612/runs/{run_id}/evidence
```
