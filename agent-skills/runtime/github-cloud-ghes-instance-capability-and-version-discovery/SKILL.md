---
name: github-cloud-ghes-instance-capability-and-version-discovery
description: "Implement GitHub Cloud/GHES instance registration, version and API discovery, feature/plan capability snapshots, TLS/proxy, and compatibility status."
---
...
Implement GitHub Cloud/GHES instance registration, version and API discovery, feature/plan capability snapshots, TLS/proxy, and compatibility status.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-cloud-ghes-instance-capability-and-version-discovery-baseline.md`.
...
```text
github_cloud_ghes_instance_capability_and_version_discovery_manifest.json
github_cloud_ghes_instance_capability_and_version_discovery_decision.json
github_cloud_ghes_instance_capability_and_version_discovery_evidence.json
```
