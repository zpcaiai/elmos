---
name: "elmos-spring-transaction-refinement"
description: "证明旧事务边界、传播、隔离、回滚规则、重试与 outbox 行为在 Spring Boot 4 中被精化。 Use when the task needs the exact Spring Transaction Refinement Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-spring-transaction-refinement/SKILL.md"
  source_sha256: "sha256:5716ba750ba65474c03d95a7a3dea2ebc285e7b6426fcab7163985fa5e312f2f"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "spring-modernization"
  runtime_handler_id: "execute_elmos_spring_transaction_refinement"
...
---
# Spring Transaction Refinement

## Repository integration boundary

- Exact Skill identity: `elmos-spring-transaction-refinement`; exact allowlisted runtime handler: `execute_elmos_spring_transaction_refinement`.
- Source identity: `skills/P0/elmos-spring-transaction-refinement/SKILL.md` at `sha256:5716ba750ba65474c03d95a7a3dea2ebc285e7b6426fcab7163985fa5e312f2f` from `elmos-formal-assurance-kernel-v1.0.0`.
...
证明旧事务边界、传播、隔离、回滚规则、重试与 outbox 行为在 Spring Boot 4 中被精化。
...
3. Use the repository-owned `execute_elmos_spring_transaction_refinement` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["trace refinement","transaction state machines","simulation","invariant model checking"]`
- Direct dependencies: `["elmos-formal-spec-ir","elmos-observable-behavior-contract","elmos-proof-obligation-planner","elmos-verifier-portfolio-router"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-spring-transaction-refinement/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
