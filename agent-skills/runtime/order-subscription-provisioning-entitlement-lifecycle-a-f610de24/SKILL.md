...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/order-subscription-provisioning-entitlement-lifecycle-a-f610de24-baseline.md`.
