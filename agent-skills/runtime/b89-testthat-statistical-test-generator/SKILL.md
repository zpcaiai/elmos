---
name: b89-testthat-statistical-test-generator
description: "Use when ELMOS must run testthat statistical test generator for Batch 89 R / Quarto / Shiny / renv Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG328"
  source_name: "testthat-statistical-test-generator"
  source_sha256: "sha256:a3412be69870e50fa47d07a45aac62918ee52c1da365a82a095261625d5ab4f9"
  batch: 89
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 89 Language Pack / source PG328 — Testthat Statistical Test Generator

## 1. Objective

Generate testthat statistical test generator within the R / Quarto / Shiny / renv Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Testthat Statistical Test Generator using the approved data-science semantic contracts and toolchain versions.
...
- A representative valid r-data-science input produces all declared outputs for testthat-statistical-test-generator.
