---
name: elmos-ai-conformal-coverage-certifier
description: Implement and independently certify conformal coverage certifier, including construct prediction sets or intervals with declared exchangeability assumptions, measure marginal and subgroup conditional coverage and monitor coverage degradation and recalibrate under drift.
version: 4.0.0
...
- `ConformalCoverageCertifierProfile`
- `ConformalCoverageCertifierRun`
- `ConformalCoverageCertifierFinding`
- `ConformalCoverageCertifierDecision`
- `ConformalCoverageCertifierEvidence`

Required semantic capabilities:

- construct prediction sets or intervals with declared exchangeability assumptions
- measure marginal and subgroup conditional coverage
- monitor coverage degradation and recalibrate under drift
...
- `artifacts/elmos-ai-conformal-coverage-certifier/profile.yaml`
- `artifacts/elmos-ai-conformal-coverage-certifier/plan.json`
- `artifacts/elmos-ai-conformal-coverage-certifier/result.json`
- `artifacts/elmos-ai-conformal-coverage-certifier/evidence/`
- `artifacts/elmos-ai-conformal-coverage-certifier/assurance-case.json`
...
- **exchangeability assumption is violated** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **marginal coverage hides subgroup undercoverage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **adaptive reuse of calibration set invalidates guarantee** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: construct prediction sets or intervals with declared exchangeability assumptions
- native scenario: measure marginal and subgroup conditional coverage
- native scenario: monitor coverage degradation and recalibrate under drift
