...
# Accredited-Once Accepted-Everywhere Evidence Packager
...
- `AccreditedOnceAcceptedEverywhereEvidencePackagerProfile`
- `AccreditedOnceAcceptedEverywhereEvidencePackagerRun`
- `AccreditedOnceAcceptedEverywhereEvidencePackagerFinding`
- `AccreditedOnceAcceptedEverywhereEvidencePackagerDecision`
- `AccreditedOnceAcceptedEverywhereEvidencePackagerEvidence`

Required semantic capabilities:

- assemble accreditation chain, scope, report/certificate, method, uncertainty and status evidence
- generate verifier instructions for regulators and procurement teams
- clearly separate internationally recognized result from local legal acceptance
...
- `artifacts/elmos-accredited-once-accepted-everywhere-evidence-packager/profile.yaml`
- `artifacts/elmos-accredited-once-accepted-everywhere-evidence-packager/plan.json`
- `artifacts/elmos-accredited-once-accepted-everywhere-evidence-packager/result.json`
- `artifacts/elmos-accredited-once-accepted-everywhere-evidence-packager/evidence/`
- `artifacts/elmos-accredited-once-accepted-everywhere-evidence-packager/assurance-case.json`
...
- **marketing slogan is used without scope check** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **accreditation body chain cannot be verified** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **supporting report is altered after certificate** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: assemble accreditation chain, scope, report/certificate, method, uncertainty and status evidence
- native scenario: generate verifier instructions for regulators and procurement teams
- native scenario: clearly separate internationally recognized result from local legal acceptance
