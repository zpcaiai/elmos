---
name: anti-pattern-and-guardrail-miner
description: Use this skill when Elmos must perform anti pattern and guardrail miner as part of the 05-skill-foundry-runtime production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# anti-pattern-and-guardrail-miner

## 能力目标

把重复错误、绕过行为和风险操作沉淀为禁止规则与防护 Skill。
