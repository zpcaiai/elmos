---
name: evaluation-contract-and-scorecard
description: Use this skill when Elmos must perform evaluation contract and scorecard as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# evaluation-contract-and-scorecard

## 能力目标

在实现前定义必须通过的结果、过程、风格、效率、安全和证据指标。
