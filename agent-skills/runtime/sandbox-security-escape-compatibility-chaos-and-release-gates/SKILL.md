---
name: sandbox-security-escape-compatibility-chaos-and-release-gates
description: "Implement provider TCK, filesystem/network/secret/syscall/resource escape tests, malicious repositories, compatibility, chaos cleanup, performance, and release gates."
---
...
Implement provider TCK, filesystem/network/secret/syscall/resource escape tests, malicious repositories, compatibility, chaos cleanup, performance, and release gates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/sandbox-security-escape-compatibility-chaos-and-release-gates-baseline.md`.
...
```text
sandbox_security_escape_compatibility_chaos_and_release_gates_manifest.json
sandbox_security_escape_compatibility_chaos_and_release_gates_decision.json
sandbox_security_escape_compatibility_chaos_and_release_gates_evidence.json
```
