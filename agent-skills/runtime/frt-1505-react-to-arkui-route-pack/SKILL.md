...
description: "Run FRT-1505 React to ArkUI Route Pack for FRT G15 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1505"
  source_name: "frt-1505-react-to-arkui-route-pack"
  source_sha256: "sha256:b173ceee004f6c957cb25e97597f2fc1fbf00f87fc8289e647905ec3189e8543"
  batch: "G15"
...
- Runtime catalog key: `FRT-1505` / `frt-1505-react-to-arkui-route-pack`.
...
# FRT-1505 — React to ArkUI Route Pack

## Objective

在G15范围内实现 **React to ArkUI Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射ArkUI状态装饰器、Builder、Navigation和生命周期; 处理Web DOM能力与ArkUI Native/Device差异; 生成真机/模拟器和Accessibility验证。

## When to Use

- 实现或修改与 **React to ArkUI Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1505Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1505EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1505FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1505CertificateFragment`：供G15批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g15/frt-1505-react-to-arkui-route-pack/
packages/runtime/g15/frt-1505-react-to-arkui-route-pack/
services/control-plane/g15/frt-1505-react-to-arkui-route-pack/
apps/web-console/src/features/g15/frt-1505-react-to-arkui-route-pack/
apps/admin-console/src/features/g15/frt-1505-react-to-arkui-route-pack/
tests/g15/frt-1505-react-to-arkui-route-pack/
```
...
```text
POST /v1/skills/frt-1505/runs
GET  /v1/skills/frt-1505/runs/{run_id}
POST /v1/skills/frt-1505/runs/{run_id}/verify
GET  /v1/skills/frt-1505/runs/{run_id}/findings
GET  /v1/skills/frt-1505/runs/{run_id}/evidence
```
