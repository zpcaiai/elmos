---
name: b101-java8-21-modernization-recipe
description: "Use when ELMOS must Apply deterministic language, dependency, module and runtime upgrades with compatibility obligations. Triggers: Java 8 to 21 Modernization Recipe, Three Golden Route Packs, Java 8 to 21, dependency upgrade, removed APIs, runtime flags."
metadata:
  id: B101-S03
...
# B101-S03 — Java 8 to 21 Modernization Recipe

## Objective

Apply deterministic language, dependency, module and runtime upgrades with compatibility obligations.
...
Use this Skill when the approved task explicitly requires **Java 8 to 21 Modernization Recipe** or when the capability graph selects it as part of a minimal dependency closure.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b101-java8-21-modernization-recipe/SKILL.md --out /tmp/java8_21_modernization_recipe.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B101-S03
```
...
- Reject or expose preview feature without approval.
- Reject or expose silent reflection break.
- Reject or expose TLS downgrade.
