...
description: "Run FRT-0811 Component Test Generator for FRT G08 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0811"
  source_name: "frt-0811-component-test-generator"
  source_sha256: "sha256:fa01e9157c8fc03f4ee33a049f0e76e6b9e0e8c2a80ee8544d627862ff69292a"
  batch: "G08"
...
- Runtime catalog key: `FRT-0811` / `frt-0811-component-test-generator`.
...
# FRT-0811 — Component Test Generator

## Objective

在G08范围内实现 **Component Test Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：保持Props默认值、事件时机、Slot/Children/Builder结构; 保持Key、Ref、Widget Identity和状态保留语义; 正确降低Hooks、Composable、Context和局部状态。

## When to Use

- 实现或修改与 **Component Test Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0811Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0811EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0811FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0811CertificateFragment`：供G08批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g08/frt-0811-component-test-generator/
packages/runtime/g08/frt-0811-component-test-generator/
services/control-plane/g08/frt-0811-component-test-generator/
apps/web-console/src/features/g08/frt-0811-component-test-generator/
apps/admin-console/src/features/g08/frt-0811-component-test-generator/
tests/g08/frt-0811-component-test-generator/
```
...
```text
POST /v1/skills/frt-0811/runs
GET  /v1/skills/frt-0811/runs/{run_id}
POST /v1/skills/frt-0811/runs/{run_id}/verify
GET  /v1/skills/frt-0811/runs/{run_id}/findings
GET  /v1/skills/frt-0811/runs/{run_id}/evidence
```
