...
metadata:
  ...
  source_sha256: "sha256:bc675a48000d7d2b499036842e38488a28d30dedf9e3322aad8b4eefb9561444"
...
This installed Skill is a repository-owned dispatch interface for `elmos-router-industrial`.
...
1. Accept structured requests for exact Skill key `elmos-router-industrial`.
2. Dispatch only through `engines/router-industrial-engine/src/elmos_router_industrial/skill_runtime.py` / `dispatch_skill` to `execute_elmos_router_industrial`.
