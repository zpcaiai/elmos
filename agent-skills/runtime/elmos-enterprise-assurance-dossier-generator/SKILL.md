---
name: elmos-enterprise-assurance-dossier-generator
description: Generate an evidence-backed, redacted and versioned customer procurement dossier covering architecture, security, privacy, AI governance, quality, resilience, supply chain and certification status.
version: 4.0.0
...
# Enterprise Assurance Dossier Generator
...
- `EnterpriseAssuranceDossierGeneratorRun`
- `EnterpriseAssuranceDossierGeneratorDecision`
- `EvidenceArtifact`
- `ProofResult`

Required semantic capabilities:

- Generate audience- and tenant-authorized evidence views
- Answer questionnaires from source evidence with confidence and freshness
- Include architecture, data flow, subprocessor, incident, DR, accessibility and supply-chain sections
- Expose certificate scope, waivers, limitations and expiry
- Route legal, contractual and organizational assertions to authorized humans
...
- `security-questionnaire-evidence-map.json`
- `customer-control-matrix.json`
- `dossier-gap-register.json`
...
- **marketing answer without evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive architecture over-disclosed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale questionnaire reused** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **legal assertion auto-approved** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **waiver omitted from dossier** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- privacy and subprocessor section
- AI governance section
- DR and support section
