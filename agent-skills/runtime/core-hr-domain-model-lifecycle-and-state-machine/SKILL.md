---
name: core-hr-domain-model-lifecycle-and-state-machine
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
core_hr_domain_model_lifecycle_and_state_machine_manifest.json
core_hr_domain_model_lifecycle_and_state_machine_state.json
core_hr_domain_model_lifecycle_and_state_machine_decision.json
core_hr_domain_model_lifecycle_and_state_machine_reconciliation.json
core_hr_domain_model_lifecycle_and_state_machine_evidence.json
```
