...
# PG334 — Cross Shell Automation Certifier

## Objective

Execute and independently verify Cross Shell Automation Certifier for Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `cross-shell-automation-certifier` tasks involving Bash/POSIX shell and PowerShell scripts, modules, error handling, arguments, processes, remoting, secrets, signing, linting, and tests.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG320`, `PG333`.
...
- `cross_shell_automation_certifier_plan.json`
- `cross_shell_automation_certifier_artifacts/`
- `cross_shell_automation_certifier_verification.json`
