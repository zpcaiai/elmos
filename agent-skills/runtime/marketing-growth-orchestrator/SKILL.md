---
name: marketing-growth-orchestrator
description: "Implement Batch 40B Marketing、Growth与Customer Engagement end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Campaign、Audience、Journey、Attribution、Experiment、Content、Lifecycle Messaging、Consent Activation与Marketing Operations."
---
...
Implement Batch 40B Marketing、Growth与Customer Engagement end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Campaign、Audience、Journey、Attribution、Experiment、Content、Lifecycle Messaging、Consent Activation与Marketing Operations.
...
5. Write unresolved domain assumptions to `docs/implementation/marketing-growth-orchestrator-baseline.md`.
...
```text
marketing_growth_orchestrator_manifest.json
marketing_growth_orchestrator_state.json
marketing_growth_orchestrator_decision.json
marketing_growth_orchestrator_reconciliation.json
marketing_growth_orchestrator_evidence.json
```
