---
name: b88-ibmi-integration-adapter
description: "Use when ELMOS must run ibmi integration adapter for Batch 88 IBM i RPG / CL / DDS / DB2 for i Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG316"
  source_name: "ibmi-integration-adapter"
  source_sha256: "sha256:6d8fd0d96b38b60f857e619433f08ee4c1f425c2bb84ab0ba055808e73704716"
  batch: 88
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 88 Language Pack / source PG316 — Ibmi Integration Adapter

## 1. Objective

Adapt ibmi integration adapter within the IBM i RPG / CL / DDS / DB2 for i Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Ibmi Integration Adapter using the approved enterprise-ibmi semantic contracts and toolchain versions.
...
- A representative valid ibmi-rpg input produces all declared outputs for ibmi-integration-adapter.
