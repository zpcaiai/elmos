...
description: "Invoke the bounded repository handler for elmos-privacy-data-policy-broker while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P06:privacy-data-policy-broker"
  source_name: "elmos-privacy-data-policy-broker"
  installed_name: "elmos-privacy-data-policy-broker"
  source_logical_path: "06-elmos-intelligent-model-router/skills/privacy-data-policy-broker/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/06-elmos-intelligent-model-router/skills/privacy-data-policy-broker/SKILL.md.source-data"
  source_materialized_path: "06-elmos-intelligent-model-router/skills/privacy-data-policy-broker/SKILL.md.source-data"
  source_sha256: "sha256:97b8ef8ea8deaec8c13b7d9aad686e73f6788369cbdebfa478b16ebac02506e5"
...
# elmos-privacy-data-policy-broker
...
- This is a deterministic repository wrapper for `06-elmos-intelligent-model-router/skills/privacy-data-policy-broker/SKILL.md` at `sha256:97b8ef8ea8deaec8c13b7d9aad686e73f6788369cbdebfa478b16ebac02506e5`.
- Its immutable source/runtime identity is `elmos-privacy-data-policy-broker`; its active installed identity is `elmos-privacy-data-policy-broker`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-privacy-data-policy-broker --request <file>
```
