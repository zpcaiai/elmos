...
description: "Run FRT-1900 Proof Assurance Orchestrator for FRT G19 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1900"
  source_name: "frt-1900-proof-assurance-orchestrator"
  source_sha256: "sha256:c824ee59fafcd259c977d86623d3f001c9045e35a522cccedc7c8c2ecf46587d"
  batch: "G19"
...
- Runtime catalog key: `FRT-1900` / `frt-1900-proof-assurance-orchestrator`.
...
# FRT-1900 — Proof Assurance Orchestrator

## Objective

在G19范围内实现 **Proof Assurance Orchestrator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：从IR、Rule和业务不变量生成Proof Obligation; Leanstral仅提出证明候选，Lean Kernel为可信根; 组合SMT、Model Checking、Symbolic和Differential Evidence。

## When to Use

- 实现或修改与 **Proof Assurance Orchestrator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1900Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1900EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1900FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1900CertificateFragment`：供G19批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g19/frt-1900-proof-assurance-orchestrator/
packages/runtime/g19/frt-1900-proof-assurance-orchestrator/
services/control-plane/g19/frt-1900-proof-assurance-orchestrator/
apps/web-console/src/features/g19/frt-1900-proof-assurance-orchestrator/
apps/admin-console/src/features/g19/frt-1900-proof-assurance-orchestrator/
tests/g19/frt-1900-proof-assurance-orchestrator/
```
...
```text
POST /v1/skills/frt-1900/runs
GET  /v1/skills/frt-1900/runs/{run_id}
POST /v1/skills/frt-1900/runs/{run_id}/verify
GET  /v1/skills/frt-1900/runs/{run_id}/findings
GET  /v1/skills/frt-1900/runs/{run_id}/evidence
```
