...
description: "Use this repository-owned Repository Semantic Compiler Kernel wrapper for exact K3 proof-driven harness work with fail-closed evidence boundaries."
---
...
- Registry identity: `ELMOS-V3-003`
- Kind/owner: `kernel` / `K3`
- Source member: `skills/P0/elmos-repository-semantic-compiler-kernel/SKILL.md`
- Source member SHA-256: `affe6f3814ca1ca26a602c347a804d72dab9bc71df7baeae0e6d80000c27d9f3`
