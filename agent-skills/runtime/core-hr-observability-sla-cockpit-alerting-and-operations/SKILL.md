---
name: core-hr-observability-sla-cockpit-alerting-and-operations
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle telemetry, SLAs, operational dashboards, alerting, workload management, actions and operator evidence, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-observability-sla-cockpit-alerting-and-operations-baseline.md`.
...
```text
core_hr_observability_sla_cockpit_alerting_and_operations_manifest.json
core_hr_observability_sla_cockpit_alerting_and_operations_state.json
core_hr_observability_sla_cockpit_alerting_and_operations_decision.json
core_hr_observability_sla_cockpit_alerting_and_operations_reconciliation.json
core_hr_observability_sla_cockpit_alerting_and_operations_evidence.json
```
