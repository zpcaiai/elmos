---
name: b88-ibmi-cutover-certifier
description: "Use when ELMOS must run ibmi cutover certifier for Batch 88 IBM i RPG / CL / DDS / DB2 for i Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG318"
  source_name: "ibmi-cutover-certifier"
  source_sha256: "sha256:44f6ce05c36e289737a6af026069f63ca71a64b343224669cae80e719ccdaec7"
  batch: 88
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 88 Language Pack / source PG318 — Ibmi Cutover Certifier

## 1. Objective

Certify ibmi cutover certifier within the IBM i RPG / CL / DDS / DB2 for i Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Ibmi Cutover Certifier using the approved enterprise-ibmi semantic contracts and toolchain versions.
...
- A representative valid ibmi-rpg input produces all declared outputs for ibmi-cutover-certifier.
