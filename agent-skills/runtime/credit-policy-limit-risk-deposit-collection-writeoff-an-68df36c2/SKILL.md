...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/credit-policy-limit-risk-deposit-collection-writeoff-an-68df36c2-baseline.md`.
