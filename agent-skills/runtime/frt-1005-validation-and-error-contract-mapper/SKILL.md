...
description: "Run FRT-1005 Validation and Error Contract Mapper for FRT G10 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1005"
  source_name: "frt-1005-validation-and-error-contract-mapper"
  source_sha256: "sha256:9f86335c2cb1fab509167615a08f0732c9dd0c726164183138ee2846d85b6d37"
  batch: "G10"
...
- Runtime catalog key: `FRT-1005` / `frt-1005-validation-and-error-contract-mapper`.
...
# FRT-1005 — Validation and Error Contract Mapper

## Objective

在G10范围内实现 **Validation and Error Contract Mapper**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：保持Route、History、Guard和Deep Link语义; 表单Validation、错误、草稿和提交幂等完整; API、Event、Storage和Realtime边界显式。

## When to Use

- 实现或修改与 **Validation and Error Contract Mapper** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1005Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1005EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1005FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1005CertificateFragment`：供G10批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g10/frt-1005-validation-and-error-contract-mapper/
packages/runtime/g10/frt-1005-validation-and-error-contract-mapper/
services/control-plane/g10/frt-1005-validation-and-error-contract-mapper/
apps/web-console/src/features/g10/frt-1005-validation-and-error-contract-mapper/
apps/admin-console/src/features/g10/frt-1005-validation-and-error-contract-mapper/
tests/g10/frt-1005-validation-and-error-contract-mapper/
```
...
```text
POST /v1/skills/frt-1005/runs
GET  /v1/skills/frt-1005/runs/{run_id}
POST /v1/skills/frt-1005/runs/{run_id}/verify
GET  /v1/skills/frt-1005/runs/{run_id}/findings
GET  /v1/skills/frt-1005/runs/{run_id}/evidence
```
