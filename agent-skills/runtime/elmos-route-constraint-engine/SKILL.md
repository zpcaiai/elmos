---
name: "elmos-route-constraint-engine"
description: "Invoke the bounded repository handler for elmos-route-constraint-engine while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P06:route-constraint-engine"
  source_name: "elmos-route-constraint-engine"
  installed_name: "elmos-route-constraint-engine"
  source_logical_path: "06-elmos-intelligent-model-router/skills/route-constraint-engine/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/06-elmos-intelligent-model-router/skills/route-constraint-engine/SKILL.md.source-data"
  source_materialized_path: "06-elmos-intelligent-model-router/skills/route-constraint-engine/SKILL.md.source-data"
  source_sha256: "sha256:a366397dd11bba53bef514f4875c25c8d87b4ce47b27b797d6063da61fc791cd"
...
- This is a deterministic repository wrapper for `06-elmos-intelligent-model-router/skills/route-constraint-engine/SKILL.md` at `sha256:a366397dd11bba53bef514f4875c25c8d87b4ce47b27b797d6063da61fc791cd`.
- Its immutable source/runtime identity is `elmos-route-constraint-engine`; its active installed identity is `elmos-route-constraint-engine`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-route-constraint-engine --request <file>
```
