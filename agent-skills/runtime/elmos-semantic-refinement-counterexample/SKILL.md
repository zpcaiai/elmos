...
triggers:
  - "Use when implementing or executing `elmos-semantic-refinement-counterexample`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-semantic-refinement-counterexample/model.json"
  - "semantic-assurance/elmos-semantic-refinement-counterexample/evidence.json"
  - "semantic-assurance/elmos-semantic-refinement-counterexample/diagnostics.json"
---

# Semantic Refinement & Counterexample Engine

## Objective

Judge target behavior as equality/refinement under the declared relation and emit minimal counterexamples for violations.
...
- **allowed refinement.**
- **undefined/source behavior domain.**
- **counterexample witness.**
- **relation-specific verdict.**
...
- [ ] target stricter accepted refinement fixture.
- [ ] extra behavior violation.
