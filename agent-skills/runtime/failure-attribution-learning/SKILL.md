---
name: failure-attribution-learning
description: "Repository-owned bounded wrapper for failure-attribution-learning; external evidence remains NOT_RUN."
---
...
Attribute failures to planning, context, rule, skill, model, tool, environment, dependency or verification gaps and propose bounded fixes.
...
4. Submit `failure-attribution-learning` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `23579a9ee567b1d1d89337af056035a8d6602e070a10edcdd209b183e390466d`
