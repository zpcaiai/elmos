...
# Conformity Assessment Impartiality Risk Governor
...
- `ConformityAssessmentImpartialityRiskGovernorProfile`
- `ConformityAssessmentImpartialityRiskGovernorRun`
- `ConformityAssessmentImpartialityRiskGovernorFinding`
- `ConformityAssessmentImpartialityRiskGovernorDecision`
- `ConformityAssessmentImpartialityRiskGovernorEvidence`

Required semantic capabilities:

- maintain financial, organizational, personal, model-provider and customer conflict-of-interest register
- score impartiality threats and required safeguards before assignment
- operate independent impartiality committee review for systemic conflicts
...
- `artifacts/elmos-conformity-assessment-impartiality-risk-governor/profile.yaml`
- `artifacts/elmos-conformity-assessment-impartiality-risk-governor/plan.json`
- `artifacts/elmos-conformity-assessment-impartiality-risk-governor/result.json`
- `artifacts/elmos-conformity-assessment-impartiality-risk-governor/evidence/`
- `artifacts/elmos-conformity-assessment-impartiality-risk-governor/assurance-case.json`
...
- **revenue concentration biases certification decisions** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared model or dataset creates hidden common-mode bias** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **conflict disclosure is accepted without effective safeguard** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: maintain financial, organizational, personal, model-provider and customer conflict-of-interest register
- native scenario: score impartiality threats and required safeguards before assignment
- native scenario: operate independent impartiality committee review for systemic conflicts
