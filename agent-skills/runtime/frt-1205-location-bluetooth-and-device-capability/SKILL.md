...
description: "Run FRT-1205 Location Bluetooth and Device Capability for FRT G12 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1205"
  source_name: "frt-1205-location-bluetooth-and-device-capability"
  source_sha256: "sha256:3e2a43620c450edccf613a8d9a8e0c191d04f673337e14fb1d9948ed624b5de3"
  batch: "G12"
  source_version: "1.0.0"
  source_risk: "critical-by-default"
  source_certificate_family: "CP"
...
- Runtime catalog key: `FRT-1205` / `frt-1205-location-bluetooth-and-device-capability`.
...
# FRT-1205 — Location Bluetooth and Device Capability

## Objective

在G12范围内实现 **Location Bluetooth and Device Capability**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨平台Capability Registry与支持等级; Native Bridge具备Schema、Permission、Timeout和Error Contract; 支付、设备和危险能力使用Server Authority与安全状态机。

## When to Use

- 实现或修改与 **Location Bluetooth and Device Capability** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1205Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1205EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1205FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1205CertificateFragment`：供G12批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g12/frt-1205-location-bluetooth-and-device-capability/
packages/runtime/g12/frt-1205-location-bluetooth-and-device-capability/
services/control-plane/g12/frt-1205-location-bluetooth-and-device-capability/
apps/web-console/src/features/g12/frt-1205-location-bluetooth-and-device-capability/
apps/admin-console/src/features/g12/frt-1205-location-bluetooth-and-device-capability/
tests/g12/frt-1205-location-bluetooth-and-device-capability/
```
...
```text
POST /v1/skills/frt-1205/runs
GET  /v1/skills/frt-1205/runs/{run_id}
POST /v1/skills/frt-1205/runs/{run_id}/verify
GET  /v1/skills/frt-1205/runs/{run_id}/findings
GET  /v1/skills/frt-1205/runs/{run_id}/evidence
```
