---
name: elmos-data-retention-archive-tiering-controller
description: Compile retention, legal hold, hot/warm/cold tiering, archive verification and deletion propagation across databases, object stores, indexes, caches and backups.
version: 4.0.0
...
# Data Retention, Archive and Tiering Controller
...
- `DataRetentionArchiveAndTieringControllerProfile`
- `DataRetentionArchiveAndTieringControllerPlan`
- `DataRetentionArchiveAndTieringControllerRun`
- `DataRetentionArchiveAndTieringControllerDecision`

Required semantic capabilities:

- translate policy into store-specific lifecycle rules
- verify archive readability and integrity
- propagate holds and deletion tombstones
- prevent tiering from breaking query contracts
- record disposal evidence and exceptions
...
- `artifacts/elmos-data-retention-archive-tiering-controller/profile.yaml`
- `artifacts/elmos-data-retention-archive-tiering-controller/plan.json`
- `artifacts/elmos-data-retention-archive-tiering-controller/result.json`
- `artifacts/elmos-data-retention-archive-tiering-controller/evidence/`
...
- **archive unreadable** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **legal hold bypassed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deletion misses derived index** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **tier transition changes latency SLO** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **retention clock starts from wrong event** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: translate policy into store-specific lifecycle rules
- native scenario: verify archive readability and integrity
- native scenario: propagate holds and deletion tombstones
- native scenario: prevent tiering from breaking query contracts
- native scenario: record disposal evidence and exceptions
