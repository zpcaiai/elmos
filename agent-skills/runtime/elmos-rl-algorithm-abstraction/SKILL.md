---
name: rl-algorithm-abstraction
description: Use this skill when Elmos must perform rl algorithm abstraction as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
支持 GRPO、RLOO、PPO、离线 RL 等算法并保持环境与奖励接口稳定。
