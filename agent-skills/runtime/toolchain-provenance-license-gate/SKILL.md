---
name: toolchain-provenance-license-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Toolchain Provenance and License Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T103"
  source_name: "toolchain-provenance-license-gate"
  source_sha256: "sha256:acde1a772364957104d6476303d26e61bb1da5e171aef7a9cde51a691f9c2e0a"
...
# T103 — Toolchain Provenance and License Gate

## 1. Objective

Validate compilers, vendor tools, packages, images, plugins, licenses, signatures and reproducible acquisition.
...
- `CASE-0461` [HIGH] Toolchain Provenance and License Gate: Representative path
- `CASE-0462` [HIGH] Toolchain Provenance and License Gate: Boundary path
- `CASE-0463` [HIGH] Toolchain Provenance and License Gate: Invalid or hostile input
- `CASE-0464` [HIGH] Toolchain Provenance and License Gate: Injected dependency failure
- `CASE-0465` [CRITICAL] Toolchain Provenance and License Gate: Security or safety violation
- `CASE-0466` [HIGH] Toolchain Provenance and License Gate: Replay and idempotency
- `CASE-0467` [HIGH] Toolchain Provenance and License Gate: Version or environment drift
- `CASE-0468` [MEDIUM] Toolchain Provenance and License Gate: Moderate scale
- `CASE-0469` [CRITICAL] Toolchain Provenance and License Gate: Evidence tamper
- `CASE-0470` [HIGH] Toolchain Provenance and License Gate: Recovery and final evidence
