...
description: "Run FRT-0710 Deterministic Repair Loop for FRT G07 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0710"
  source_name: "frt-0710-deterministic-repair-loop"
  source_sha256: "sha256:605405f2f863b0e9a9dc5f603fb19a5e7825e0705b5dde205f938d8b0ad9d41a"
  batch: "G07"
...
- Runtime catalog key: `FRT-0710` / `frt-0710-deterministic-repair-loop`.
...
# FRT-0710 — Deterministic Repair Loop

## Objective

在G07范围内实现 **Deterministic Repair Loop**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Typed IR经规则Pass降低到目标原生AST; Gap生成Typed Hole而非空实现; Format/Analyze/Build驱动有界确定性修复。

## When to Use

- 实现或修改与 **Deterministic Repair Loop** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0710Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0710EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0710FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0710CertificateFragment`：供G07批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g07/frt-0710-deterministic-repair-loop/
packages/runtime/g07/frt-0710-deterministic-repair-loop/
services/control-plane/g07/frt-0710-deterministic-repair-loop/
apps/web-console/src/features/g07/frt-0710-deterministic-repair-loop/
apps/admin-console/src/features/g07/frt-0710-deterministic-repair-loop/
tests/g07/frt-0710-deterministic-repair-loop/
```
...
```text
POST /v1/skills/frt-0710/runs
GET  /v1/skills/frt-0710/runs/{run_id}
POST /v1/skills/frt-0710/runs/{run_id}/verify
GET  /v1/skills/frt-0710/runs/{run_id}/findings
GET  /v1/skills/frt-0710/runs/{run_id}/evidence
```
