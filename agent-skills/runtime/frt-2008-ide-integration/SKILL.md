...
description: "Run FRT-2008 IDE Integration for FRT G20 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2008"
  source_name: "frt-2008-ide-integration"
  source_sha256: "sha256:da94b70fc6426a6d1e78bb184e32f5a0e116e7ac5b0f8c1cc2f20c5953d758f6"
  batch: "G20"
...
- Runtime catalog key: `FRT-2008` / `frt-2008-ide-integration`.
...
# FRT-2008 — IDE Integration

## Objective

在G20范围内实现 **IDE Integration**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：提供Skill SDK、Runtime、Registry和Marketplace; 实现CLI、API、IDE、Web Console和Multi-Tenant Workspace; Durable Workflow与分布式Worker支持暂停、恢复、取消和幂等。

## When to Use

- 实现或修改与 **IDE Integration** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2008Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2008EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2008FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2008CertificateFragment`：供G20批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g20/frt-2008-ide-integration/
packages/runtime/g20/frt-2008-ide-integration/
services/control-plane/g20/frt-2008-ide-integration/
apps/web-console/src/features/g20/frt-2008-ide-integration/
apps/admin-console/src/features/g20/frt-2008-ide-integration/
tests/g20/frt-2008-ide-integration/
```
...
```text
POST /v1/skills/frt-2008/runs
GET  /v1/skills/frt-2008/runs/{run_id}
POST /v1/skills/frt-2008/runs/{run_id}/verify
GET  /v1/skills/frt-2008/runs/{run_id}/findings
GET  /v1/skills/frt-2008/runs/{run_id}/evidence
```
