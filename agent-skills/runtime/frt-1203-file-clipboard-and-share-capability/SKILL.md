...
description: "Run FRT-1203 File Clipboard and Share Capability for FRT G12 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1203"
  source_name: "frt-1203-file-clipboard-and-share-capability"
  source_sha256: "sha256:a7693b63e286a028b027792d28f5a3cded923b63770d11eedf19a6b281cdbdd7"
  batch: "G12"
...
- Runtime catalog key: `FRT-1203` / `frt-1203-file-clipboard-and-share-capability`.
...
# FRT-1203 — File Clipboard and Share Capability

## Objective

在G12范围内实现 **File Clipboard and Share Capability**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨平台Capability Registry与支持等级; Native Bridge具备Schema、Permission、Timeout和Error Contract; 支付、设备和危险能力使用Server Authority与安全状态机。

## When to Use

- 实现或修改与 **File Clipboard and Share Capability** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1203Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1203EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1203FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1203CertificateFragment`：供G12批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g12/frt-1203-file-clipboard-and-share-capability/
packages/runtime/g12/frt-1203-file-clipboard-and-share-capability/
services/control-plane/g12/frt-1203-file-clipboard-and-share-capability/
apps/web-console/src/features/g12/frt-1203-file-clipboard-and-share-capability/
apps/admin-console/src/features/g12/frt-1203-file-clipboard-and-share-capability/
tests/g12/frt-1203-file-clipboard-and-share-capability/
```
...
```text
POST /v1/skills/frt-1203/runs
GET  /v1/skills/frt-1203/runs/{run_id}
POST /v1/skills/frt-1203/runs/{run_id}/verify
GET  /v1/skills/frt-1203/runs/{run_id}/findings
GET  /v1/skills/frt-1203/runs/{run_id}/evidence
```
