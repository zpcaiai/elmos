---
name: sandbox-filesystem-mount-path-device-proc-and-sys-isolation
description: "Implement secure filesystem layout, race-resistant path resolution, mounts, overlays, proc/sys/dev minimization, archive extraction, quotas, and output collection."
---
...
Implement secure filesystem layout, race-resistant path resolution, mounts, overlays, proc/sys/dev minimization, archive extraction, quotas, and output collection.
...
4. Record unresolved provider/version assumptions in `docs/implementation/sandbox-filesystem-mount-path-device-proc-and-sys-isolation-baseline.md`.
...
```text
sandbox_filesystem_mount_path_device_proc_and_sys_isolation_manifest.json
sandbox_filesystem_mount_path_device_proc_and_sys_isolation_decision.json
sandbox_filesystem_mount_path_device_proc_and_sys_isolation_evidence.json
```
