...
# Certificate Public Directory and Transparency Controller
...
- `CertificatePublicDirectoryAndTransparencyControllerProfile`
- `CertificatePublicDirectoryAndTransparencyControllerRun`
- `CertificatePublicDirectoryAndTransparencyControllerFinding`
- `CertificatePublicDirectoryAndTransparencyControllerDecision`
- `CertificatePublicDirectoryAndTransparencyControllerEvidence`

Required semantic capabilities:

- publish searchable certificate metadata, scope, status, limitations and verification instructions
- protect confidential evidence while enabling public reliance
- append issuance, update, suspension and revocation to transparency log
...
- `artifacts/elmos-certificate-public-directory-transparency-controller/profile.yaml`
- `artifacts/elmos-certificate-public-directory-transparency-controller/plan.json`
- `artifacts/elmos-certificate-public-directory-transparency-controller/result.json`
- `artifacts/elmos-certificate-public-directory-transparency-controller/evidence/`
- `artifacts/elmos-certificate-public-directory-transparency-controller/assurance-case.json`
...
- **directory omits scope limitation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **search index lags revocation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **public metadata enables sensitive customer inference** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: publish searchable certificate metadata, scope, status, limitations and verification instructions
- native scenario: protect confidential evidence while enabling public reliance
- native scenario: append issuance, update, suspension and revocation to transparency log
