...
- Source group: `bigdata-templates`. Dependencies: `["elmos-bigdata-project-orchestrator"]`. Triggers: `["离线数仓", "经营分析/BI", "日批或小时批"]`. Declared outputs: `["template-plan.json", "generated-project/"]`.
