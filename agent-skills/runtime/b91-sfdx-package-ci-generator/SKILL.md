---
name: b91-sfdx-package-ci-generator
description: "Use when ELMOS must run sfdx package ci generator for Batch 91 Salesforce Apex / SOQL / LWC Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG352"
  source_name: "sfdx-package-ci-generator"
  source_sha256: "sha256:8b3df05046da3b0324a663a4ccb2918598079cd13c66e9aee30391353030a5d2"
  batch: 91
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 91 Language Pack / source PG352 — Sfdx Package Ci Generator

## 1. Objective

Generate sfdx package ci generator within the Salesforce Apex / SOQL / LWC Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Sfdx Package Ci Generator using the approved enterprise-crm-platform semantic contracts and toolchain versions.
...
- A representative valid salesforce input produces all declared outputs for sfdx-package-ci-generator.
