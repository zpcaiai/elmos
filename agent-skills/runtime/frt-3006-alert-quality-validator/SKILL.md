...
description: "Run FRT-3006 Alert Quality Validator for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3006"
  source_name: "frt-3006-alert-quality-validator"
  source_sha256: "sha256:8271cdf03bcf3b03b3cb61f3fead4263aea448f76261720cac616147d53b7247"
  batch: "G30"
...
- Runtime catalog key: `FRT-3006` / `frt-3006-alert-quality-validator`.
...
在G30范围内实现 **Alert Quality Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Alert Quality Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3006Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3006EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3006FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3006CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3006-alert-quality-validator/
packages/runtime/g30/frt-3006-alert-quality-validator/
services/control-plane/g30/frt-3006-alert-quality-validator/
apps/web-console/src/features/g30/frt-3006-alert-quality-validator/
apps/admin-console/src/features/g30/frt-3006-alert-quality-validator/
tests/g30/frt-3006-alert-quality-validator/
```
...
```text
POST /v1/skills/frt-3006/runs
GET  /v1/skills/frt-3006/runs/{run_id}
POST /v1/skills/frt-3006/runs/{run_id}/verify
GET  /v1/skills/frt-3006/runs/{run_id}/findings
GET  /v1/skills/frt-3006/runs/{run_id}/evidence
```
