...
metadata:
  ...
  repository_handler_id: "handle_elmos_database_mcda_ranker"
...
- Source group: `database-intelligence`. Dependencies: `["elmos-database-constraint-filter"]`. Triggers: `["多个可行候选", "需要解释推荐", "调整性能/成本/运维偏好"]`. Declared outputs: `["candidate-ranking.json", "pareto-frontier.json", "sensitivity-report.md"]`. Stable task IDs: `["RANK-001", "RANK-002", "RANK-003", "RANK-004", "RANK-005", "RANK-006", "RANK-007", "RANK-008", "RANK-009", "RANK-010", "RANK-011", "RANK-012"]`.
- This normalized Skill is installed and invocable. The repository binds `handle_elmos_database_mcda_ranker` in `engines/database-bigdata-engine/src/elmos_database_bigdata/handlers/database_intelligence.py` as a bounded plan-skeleton entry point; the reviewed code declares no database, provider, network, deployment, benchmark, mutation, or certification operation.
