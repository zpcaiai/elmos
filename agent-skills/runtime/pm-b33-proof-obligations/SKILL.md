...
- Invoke this repository Skill as `$pm-b33-proof-obligations`.
- Immutable source identity: `batch-33-proof-obligations` in `precision-migration-b01-44` (B33).
- Runtime adapter: `formal-and-advanced-verification`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b33-proof-obligations`.
...
- 当任务涉及 **type-preservation-obligation** 时，调用 `../pm-b33-type-preservation-obligation/SKILL.md`。
- 当任务涉及 **numeric-semantics-obligation** 时，调用 `../pm-b33-numeric-semantics-obligation/SKILL.md`。
- 当任务涉及 **nullability-preservation-obligation** 时，调用 `../pm-b33-nullability-preservation-obligation/SKILL.md`。
- 当任务涉及 **effect-preservation-obligation** 时，调用 `../pm-b33-effect-preservation-obligation/SKILL.md`。
- 当任务涉及 **state-refinement-obligation** 时，调用 `../pm-b33-state-refinement-obligation/SKILL.md`。
- 当任务涉及 **pure-function-equivalence-obligation** 时，调用 `../pm-b33-pure-function-equivalence-obligation/SKILL.md`。
- 当任务涉及 **serializer-roundtrip-obligation** 时，调用 `../pm-b33-serializer-roundtrip-obligation/SKILL.md`。
- 当任务涉及 **permission-non-expansion-obligation** 时，调用 `../pm-b33-permission-non-expansion-obligation/SKILL.md`。
- 当任务涉及 **transaction-invariant-obligation** 时，调用 `../pm-b33-transaction-invariant-obligation/SKILL.md`。
- 当任务涉及 **trace-refinement-obligation** 时，调用 `../pm-b33-trace-refinement-obligation/SKILL.md`。
