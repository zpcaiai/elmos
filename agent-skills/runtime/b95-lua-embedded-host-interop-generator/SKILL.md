---
name: b95-lua-embedded-host-interop-generator
description: "Use when ELMOS must run lua embedded host interop generator for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG394"
  source_name: "lua-embedded-host-interop-generator"
  source_sha256: "sha256:4c8c87dd5c174bf280926a64f3e8c3bfd5b04c71b764448c305a4b818020e02f"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG394 — Lua Embedded Host Interop Generator

## 1. Objective

Generate lua embedded host interop generator within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Lua Embedded Host Interop Generator using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-embedded-host-interop-generator.
