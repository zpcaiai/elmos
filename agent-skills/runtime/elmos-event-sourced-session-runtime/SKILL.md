---
name: "elmos-event-sourced-session-runtime"
description: "Invoke the bounded repository handler for elmos-event-sourced-session-runtime while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P01:event-sourced-session-runtime"
  source_name: "elmos-event-sourced-session-runtime"
  installed_name: "elmos-event-sourced-session-runtime"
  source_logical_path: "01-elmos-harness-runtime-platform/skills/event-sourced-session-runtime/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/01-elmos-harness-runtime-platform/skills/event-sourced-session-runtime/SKILL.md.source-data"
  source_materialized_path: "01-elmos-harness-runtime-platform/skills/event-sourced-session-runtime/SKILL.md.source-data"
  source_sha256: "sha256:1a48bd868e94b00d8bc647526ec5ae840b6989b3e85749e95cef2faf4efeb023"
...
# elmos-event-sourced-session-runtime
...
- This is a deterministic repository wrapper for `01-elmos-harness-runtime-platform/skills/event-sourced-session-runtime/SKILL.md` at `sha256:1a48bd868e94b00d8bc647526ec5ae840b6989b3e85749e95cef2faf4efeb023`.
- Its immutable source/runtime identity is `elmos-event-sourced-session-runtime`; its active installed identity is `elmos-event-sourced-session-runtime`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-event-sourced-session-runtime --request <file>
```
