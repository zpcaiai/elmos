...
description: "Run FRT-0706 Deterministic Naming and File Allocation for FRT G07 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0706"
  source_name: "frt-0706-deterministic-naming-and-file-allocation"
  source_sha256: "sha256:c47daed7578504d90c96950289c43c847479ba34d25415887baa9a336a057b13"
  batch: "G07"
...
- Runtime catalog key: `FRT-0706` / `frt-0706-deterministic-naming-and-file-allocation`.
...
# FRT-0706 — Deterministic Naming and File Allocation

## Objective

在G07范围内实现 **Deterministic Naming and File Allocation**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Typed IR经规则Pass降低到目标原生AST; Gap生成Typed Hole而非空实现; Format/Analyze/Build驱动有界确定性修复。

## When to Use

- 实现或修改与 **Deterministic Naming and File Allocation** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0706Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0706EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0706FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0706CertificateFragment`：供G07批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g07/frt-0706-deterministic-naming-and-file-allocation/
packages/runtime/g07/frt-0706-deterministic-naming-and-file-allocation/
services/control-plane/g07/frt-0706-deterministic-naming-and-file-allocation/
apps/web-console/src/features/g07/frt-0706-deterministic-naming-and-file-allocation/
apps/admin-console/src/features/g07/frt-0706-deterministic-naming-and-file-allocation/
tests/g07/frt-0706-deterministic-naming-and-file-allocation/
```
...
```text
POST /v1/skills/frt-0706/runs
GET  /v1/skills/frt-0706/runs/{run_id}
POST /v1/skills/frt-0706/runs/{run_id}/verify
GET  /v1/skills/frt-0706/runs/{run_id}/findings
GET  /v1/skills/frt-0706/runs/{run_id}/evidence
```
