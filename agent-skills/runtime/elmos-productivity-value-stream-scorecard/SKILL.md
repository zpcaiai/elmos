---
name: elmos-productivity-value-stream-scorecard
description: Measure Elmos commercial productivity through delivery throughput, instability, rework, verified automation yield, machine wall-clock, cost and developer experience rather than token volume.
version: 4.0.0
...
# Productivity and Value-Stream Scorecard
...
- Measure change lead time and deployment frequency
- Measure failed deployment recovery, change failure and rework
- Track verified autonomous work versus human correction
- Report machine wall-clock and total cost separately
- Use statistical/customer context instead of universal ranking
...
- `elmos-ai-observability-finops-generator` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `productivity-scorecard.json`
- `value-stream-map.json`
- `automation-yield-report.json`
- `productivity-confidence-report.json`
...
- **token usage treated as productivity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **vanity output count** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **human cleanup omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **team comparison without context** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **automation shifts defects downstream** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- verified automation yield
- developer satisfaction guardrail
