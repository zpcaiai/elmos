...
description: "Run FRT-2502 User Journey Usability Validator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2502"
  source_name: "frt-2502-user-journey-usability-validator"
  source_sha256: "sha256:1de24909a20c1fed93dc133278fed7f28d75ec6634d9010e7543a44082e9c0ee"
  batch: "G25"
...
- Runtime catalog key: `FRT-2502` / `frt-2502-user-journey-usability-validator`.
...
在G25范围内实现 **User Journey Usability Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **User Journey Usability Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2502Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2502EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2502FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2502CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2502-user-journey-usability-validator/
packages/runtime/g25/frt-2502-user-journey-usability-validator/
services/control-plane/g25/frt-2502-user-journey-usability-validator/
apps/web-console/src/features/g25/frt-2502-user-journey-usability-validator/
apps/admin-console/src/features/g25/frt-2502-user-journey-usability-validator/
tests/g25/frt-2502-user-journey-usability-validator/
```
...
```text
POST /v1/skills/frt-2502/runs
GET  /v1/skills/frt-2502/runs/{run_id}
POST /v1/skills/frt-2502/runs/{run_id}/verify
GET  /v1/skills/frt-2502/runs/{run_id}/findings
GET  /v1/skills/frt-2502/runs/{run_id}/evidence
```
