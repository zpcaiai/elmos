---
name: preference-optimization-orchestrator
description: Use this skill when Elmos must perform preference optimization orchestrator as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# preference-optimization-orchestrator

## 能力目标

支持 DPO、KTO、ORPO、SimPO 等策略并依据数据与目标选择。
