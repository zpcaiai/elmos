---
name: decision-trace-and-accountability
description: Use this skill when Elmos must perform decision trace and accountability as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# decision-trace-and-accountability

## 能力目标

记录谁在何时基于什么证据批准、拒绝、豁免或回滚。
