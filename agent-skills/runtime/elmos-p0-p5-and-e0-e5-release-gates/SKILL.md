...
description: Use this skill when Elmos must perform p0 p5 and e0 e5 release gates as part of the 16-self-evolution-release-engineering production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
