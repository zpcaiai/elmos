...
description: "Invoke the bounded repository handler for elmos-provenance-confidence-engine while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P02:provenance-confidence-engine"
  source_name: "elmos-provenance-confidence-engine"
  installed_name: "elmos-provenance-confidence-engine"
  source_logical_path: "02-elmos-repository-intelligence-semantic-ir/skills/provenance-confidence-engine/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/02-elmos-repository-intelligence-semantic-ir/skills/provenance-confidence-engine/SKILL.md.source-data"
  source_materialized_path: "02-elmos-repository-intelligence-semantic-ir/skills/provenance-confidence-engine/SKILL.md.source-data"
  source_sha256: "sha256:e7d0a45c36739ea8970cbfe5cd047178ea6ab2c3a105e224171d03b954e617ba"
...
# elmos-provenance-confidence-engine
...
- This is a deterministic repository wrapper for `02-elmos-repository-intelligence-semantic-ir/skills/provenance-confidence-engine/SKILL.md` at `sha256:e7d0a45c36739ea8970cbfe5cd047178ea6ab2c3a105e224171d03b954e617ba`.
- Its immutable source/runtime identity is `elmos-provenance-confidence-engine`; its active installed identity is `elmos-provenance-confidence-engine`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-provenance-confidence-engine --request <file>
```
