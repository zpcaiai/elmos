---
name: b90-sas-to-python-r-sql-generator
description: "Use when ELMOS must run sas to python r sql generator for Batch 90 SAS / Macro / PROC SQL / Viya Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG337"
  source_name: "sas-to-python-r-sql-generator"
  source_sha256: "sha256:3e1a4b96290b6dda860835e123935b23408709a09f3c0e996fa88a7b31abff24"
  batch: 90
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 90 Language Pack / source PG337 — Sas To Python R SQL Generator
