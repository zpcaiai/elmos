...
description: "Invoke the bounded repository handler for elmos-contract-integration-pipeline while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P05:contract-integration-pipeline"
  source_name: "elmos-contract-integration-pipeline"
  installed_name: "elmos-contract-integration-pipeline"
  source_logical_path: "05-elmos-conversion-reliability-verification-harness/skills/contract-integration-pipeline/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/05-elmos-conversion-reliability-verification-harness/skills/contract-integration-pipeline/SKILL.md.source-data"
  source_materialized_path: "05-elmos-conversion-reliability-verification-harness/skills/contract-integration-pipeline/SKILL.md.source-data"
  source_sha256: "sha256:ed1ad0983b445a0bda647867ca16d0e88f2e69f5d097a534cbd77d7413325e80"
...
# elmos-contract-integration-pipeline
...
- This is a deterministic repository wrapper for `05-elmos-conversion-reliability-verification-harness/skills/contract-integration-pipeline/SKILL.md` at `sha256:ed1ad0983b445a0bda647867ca16d0e88f2e69f5d097a534cbd77d7413325e80`.
- Its immutable source/runtime identity is `elmos-contract-integration-pipeline`; its active installed identity is `elmos-contract-integration-pipeline`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-contract-integration-pipeline --request <file>
```
