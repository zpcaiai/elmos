...
description: "Invoke the bounded repository handler for elmos-repository-intelligence-semantic-ir while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_key: "P02"
  source_name: "elmos-repository-intelligence-semantic-ir"
  installed_name: "elmos-repository-intelligence-semantic-ir"
  source_logical_path: "02-elmos-repository-intelligence-semantic-ir/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/02-elmos-repository-intelligence-semantic-ir/SKILL.md.source-data"
  source_materialized_path: "02-elmos-repository-intelligence-semantic-ir/SKILL.md.source-data"
  source_sha256: "sha256:4c34ab4f4517dc7a240007e6f660968625e6257b10a3c8830079f46bf5bd81f9"
...
- This is a deterministic repository wrapper for `02-elmos-repository-intelligence-semantic-ir/SKILL.md` at `sha256:4c34ab4f4517dc7a240007e6f660968625e6257b10a3c8830079f46bf5bd81f9`.
- Its immutable source/runtime identity is `elmos-repository-intelligence-semantic-ir`; its active installed identity is `elmos-repository-intelligence-semantic-ir`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-repository-intelligence-semantic-ir --request <file>
```
