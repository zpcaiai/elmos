---
name: legacy-web-51-struts1-to-springmvc-generator
description: "Repository-owned exact runtime interface for Struts 1→Spring MVC 生成器; bounded semantic analysis and evidence generation for Java legacy web modernization."
metadata:
  source_package: elmos.java-legacy-web.repository-modernization
  source_version: 1.0.0
  source_id: 51-struts1-to-springmvc-generator
  source_digest: sha256:2718d34e6b350c23828e1531a5d01e43a1d5d91db59d878d5da37912a041e3e1
  phase: transformation
  runtime_state: CODE_COMPLETE_LOCAL
  capability_state: LOCAL_EXECUTED
  operation_code: STRUTS1_TARGET_GENERATED
  runtime_handler_id: legacy-web-handler:51-struts1-to-springmvc-generator
---
