...
description: "Run FRT-1012 Permission and Capability Mapper for FRT G10 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1012"
  source_name: "frt-1012-permission-and-capability-mapper"
  source_sha256: "sha256:2b1b54104d91f22ed965a60feb3315e10baa5aed07f2bedbb8e11fbb1dc0fa4d"
  batch: "G10"
...
- Runtime catalog key: `FRT-1012` / `frt-1012-permission-and-capability-mapper`.
...
# FRT-1012 — Permission and Capability Mapper

## Objective

在G10范围内实现 **Permission and Capability Mapper**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：保持Route、History、Guard和Deep Link语义; 表单Validation、错误、草稿和提交幂等完整; API、Event、Storage和Realtime边界显式。

## When to Use

- 实现或修改与 **Permission and Capability Mapper** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1012Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1012EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1012FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1012CertificateFragment`：供G10批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g10/frt-1012-permission-and-capability-mapper/
packages/runtime/g10/frt-1012-permission-and-capability-mapper/
services/control-plane/g10/frt-1012-permission-and-capability-mapper/
apps/web-console/src/features/g10/frt-1012-permission-and-capability-mapper/
apps/admin-console/src/features/g10/frt-1012-permission-and-capability-mapper/
tests/g10/frt-1012-permission-and-capability-mapper/
```
...
```text
POST /v1/skills/frt-1012/runs
GET  /v1/skills/frt-1012/runs/{run_id}
POST /v1/skills/frt-1012/runs/{run_id}/verify
GET  /v1/skills/frt-1012/runs/{run_id}/findings
GET  /v1/skills/frt-1012/runs/{run_id}/evidence
```
