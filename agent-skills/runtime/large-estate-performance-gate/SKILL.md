---
name: large-estate-performance-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Large Estate Performance Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T108"
  source_name: "large-estate-performance-gate"
  source_sha256: "sha256:2895549f5d4a72c33e03229f241d82952656a3d7bd7166bb9e3129653f7f69f5"
...
# T108 — Large Estate Performance Gate

## 1. Objective

Test large repositories, models, schemas and dependency graphs under declared latency, memory, token and cost limits.
...
- `CASE-0511` [HIGH] Large Estate Performance Gate: Representative path
- `CASE-0512` [HIGH] Large Estate Performance Gate: Boundary path
- `CASE-0513` [HIGH] Large Estate Performance Gate: Invalid or hostile input
- `CASE-0514` [HIGH] Large Estate Performance Gate: Injected dependency failure
- `CASE-0515` [CRITICAL] Large Estate Performance Gate: Security or safety violation
- `CASE-0516` [HIGH] Large Estate Performance Gate: Replay and idempotency
- `CASE-0517` [HIGH] Large Estate Performance Gate: Version or environment drift
- `CASE-0518` [MEDIUM] Large Estate Performance Gate: Moderate scale
- `CASE-0519` [CRITICAL] Large Estate Performance Gate: Evidence tamper
- `CASE-0520` [HIGH] Large Estate Performance Gate: Recovery and final evidence
