---
name: core-hr-audit-evidence-records-retention-and-legal-hold
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle audit events, immutable evidence, records classes, retention, legal hold, exports and disposition, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle audit events, immutable evidence, records classes, retention, legal hold, exports and disposition, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-audit-evidence-records-retention-and-legal-hold-baseline.md`.
...
```text
core_hr_audit_evidence_records_retention_and_legal_hold_manifest.json
core_hr_audit_evidence_records_retention_and_legal_hold_state.json
core_hr_audit_evidence_records_retention_and_legal_hold_decision.json
core_hr_audit_evidence_records_retention_and_legal_hold_reconciliation.json
core_hr_audit_evidence_records_retention_and_legal_hold_evidence.json
```
