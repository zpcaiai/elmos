...
description: "Run FRT-1503 Vue 3 to ArkUI Route Pack for FRT G15 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1503"
  source_name: "frt-1503-vue-3-to-arkui-route-pack"
  source_sha256: "sha256:34078eddaea3dada2bf6e6ecc3f99f17e01fc4a8411d29cb9b2fbe73fed82f90"
  batch: "G15"
...
- Runtime catalog key: `FRT-1503` / `frt-1503-vue-3-to-arkui-route-pack`.
...
# FRT-1503 — Vue 3 to ArkUI Route Pack

## Objective

在G15范围内实现 **Vue 3 to ArkUI Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射ArkUI状态装饰器、Builder、Navigation和生命周期; 处理Web DOM能力与ArkUI Native/Device差异; 生成真机/模拟器和Accessibility验证。

## When to Use

- 实现或修改与 **Vue 3 to ArkUI Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1503Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1503EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1503FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1503CertificateFragment`：供G15批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g15/frt-1503-vue-3-to-arkui-route-pack/
packages/runtime/g15/frt-1503-vue-3-to-arkui-route-pack/
services/control-plane/g15/frt-1503-vue-3-to-arkui-route-pack/
apps/web-console/src/features/g15/frt-1503-vue-3-to-arkui-route-pack/
apps/admin-console/src/features/g15/frt-1503-vue-3-to-arkui-route-pack/
tests/g15/frt-1503-vue-3-to-arkui-route-pack/
```
...
```text
POST /v1/skills/frt-1503/runs
GET  /v1/skills/frt-1503/runs/{run_id}
POST /v1/skills/frt-1503/runs/{run_id}/verify
GET  /v1/skills/frt-1503/runs/{run_id}/findings
GET  /v1/skills/frt-1503/runs/{run_id}/evidence
```
