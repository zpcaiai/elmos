...
description: "Run FRT-2110 Release Scope Closure Manager for FRT G21 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2110"
  source_name: "frt-2110-release-scope-closure-manager"
  source_sha256: "sha256:64277794b3900bfa46f23018604ae726b9b6fe264d06c61da7bcb79e85893cea"
  batch: "G21"
...
- Runtime catalog key: `FRT-2110` / `frt-2110-release-scope-closure-manager`.
...
在G21范围内实现 **Release Scope Closure Manager**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：统一 Product Closure Graph; Requirement、Capability、Journey、Command、API、Data、Permission、Test、Monitoring、Runbook、Certificate 双向追踪; 孤儿 UI/API/Command/Event/Data Write 检测。

## When to Use

- 实现或修改与 **Release Scope Closure Manager** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2110Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2110EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2110FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2110CertificateFragment`：供G21批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g21/frt-2110-release-scope-closure-manager/
packages/runtime/g21/frt-2110-release-scope-closure-manager/
services/control-plane/g21/frt-2110-release-scope-closure-manager/
apps/web-console/src/features/g21/frt-2110-release-scope-closure-manager/
apps/admin-console/src/features/g21/frt-2110-release-scope-closure-manager/
tests/g21/frt-2110-release-scope-closure-manager/
```
...
```text
POST /v1/skills/frt-2110/runs
GET  /v1/skills/frt-2110/runs/{run_id}
POST /v1/skills/frt-2110/runs/{run_id}/verify
GET  /v1/skills/frt-2110/runs/{run_id}/findings
GET  /v1/skills/frt-2110/runs/{run_id}/evidence
```
