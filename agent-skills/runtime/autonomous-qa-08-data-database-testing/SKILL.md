---
name: "autonomous-qa-08-data-database-testing"
description: "Run 08-data-database-testing through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "08-data-database-testing"
  source_sha256: "sha256:1311b3feb07fe71b605496c746e2facbd552e937a77c87cd48b13069e2a38300"
  ...
  runtime_skill_key: "08-data-database-testing"
  runtime_handler: "execute_08_data_database_testing"
  runtime_phase: "generation"
  runtime_mutating: "false"
  runtime_operation: "elmos_autonomous_qa.generators.plan_database_tests"
...
1. Accept only a structured request for the exact Skill key `08-data-database-testing`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_08_data_database_testing` and operation `elmos_autonomous_qa.generators.plan_database_tests`.
...
- Immutable source: `skills/08-data-database-testing/SKILL.md` at `sha256:1311b3feb07fe71b605496c746e2facbd552e937a77c87cd48b13069e2a38300`.
