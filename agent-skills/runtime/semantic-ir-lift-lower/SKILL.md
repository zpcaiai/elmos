---
name: semantic-ir-lift-lower
description: "Repository-owned bounded wrapper for semantic-ir-lift-lower; external evidence remains NOT_RUN."
---
...
Lift source/framework/database constructs into Semantic IR and lower them to target languages/frameworks with explicit loss and assumption tracking.
...
4. Submit `semantic-ir-lift-lower` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `6b5e4c8f7a369f689bd86660820d56335d3c7b2664dad6051cc8b18ba49fc7f5`
