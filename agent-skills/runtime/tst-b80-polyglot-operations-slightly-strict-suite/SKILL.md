---
name: tst-b80-polyglot-operations-slightly-strict-suite
description: "Run the slightly strict test suite for Batch 80: Polyglot Project Operations and Certification, covering every source Skill with positive and negative executable cases."
metadata:
  id: TB80
...
---
    # TB80 — Batch 80 Polyglot Project Operations and Certification 略严苛测试套件

    ## Objective

    对 Batch 80 的全部 12 个Source Skills执行可重放的正向、边界、负向、故障、安全和证据完整性验证。范围为：多语言资产图、构建编排、契约同步、环境一致性、供应链、修复与认证。
    ...
    |---|---|---|---|
    | PG406 | `b80-polyglot-engineering-asset-graph` | detector | `B80-PG406-RUN, B80-PG406-NEG` |
| PG407 | `b80-cross-language-build-orchestrator` | build | `B80-PG407-RUN, B80-PG407-NEG` |
| PG408 | `b80-cross-contract-schema-synchronizer` | contract | `B80-PG408-RUN, B80-PG408-NEG` |
| PG409 | `b80-environment-parity-drift-detector` | detector | `B80-PG409-RUN, B80-PG409-NEG` |
| PG410 | `b80-polyglot-secret-identity-policy` | security | `B80-PG410-RUN, B80-PG410-NEG` |
| PG411 | `b80-software-supply-chain-provenance-orchestrator` | security | `B80-PG411-RUN, B80-PG411-NEG` |
| PG412 | `b80-local-ci-runtime-reproducer` | reproducer | `B80-PG412-RUN, B80-PG412-NEG` |
| PG413 | `b80-runtime-smoke-journey-orchestrator` | generator | `B80-PG413-RUN, B80-PG413-NEG` |
| PG414 | `b80-cross-layer-failure-diagnosis-repair` | generator | `B80-PG414-RUN, B80-PG414-NEG` |
| PG415 | `b80-project-performance-cost-budget-gate` | certifier | `B80-PG415-RUN, B80-PG415-NEG` |
| PG416 | `b80-project-migration-compatibility-gate` | data | `B80-PG416-RUN, B80-PG416-NEG` |
| PG417 | `b80-project-operations-certification` | certifier | `B80-PG417-RUN, B80-PG417-NEG` |
