...
description: "Run FRT-1913 Counterexample Guided Repair for FRT G19 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1913"
  source_name: "frt-1913-counterexample-guided-repair"
  source_sha256: "sha256:8ca91e2ae212fe454992a1c2984f7b692264b83a4afe917989b39f6b5a8d227e"
  batch: "G19"
...
- Runtime catalog key: `FRT-1913` / `frt-1913-counterexample-guided-repair`.
...
# FRT-1913 — Counterexample Guided Repair

## Objective

在G19范围内实现 **Counterexample Guided Repair**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：从IR、Rule和业务不变量生成Proof Obligation; Leanstral仅提出证明候选，Lean Kernel为可信根; 组合SMT、Model Checking、Symbolic和Differential Evidence。

## When to Use

- 实现或修改与 **Counterexample Guided Repair** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1913Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1913EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1913FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1913CertificateFragment`：供G19批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g19/frt-1913-counterexample-guided-repair/
packages/runtime/g19/frt-1913-counterexample-guided-repair/
services/control-plane/g19/frt-1913-counterexample-guided-repair/
apps/web-console/src/features/g19/frt-1913-counterexample-guided-repair/
apps/admin-console/src/features/g19/frt-1913-counterexample-guided-repair/
tests/g19/frt-1913-counterexample-guided-repair/
```
...
```text
POST /v1/skills/frt-1913/runs
GET  /v1/skills/frt-1913/runs/{run_id}
POST /v1/skills/frt-1913/runs/{run_id}/verify
GET  /v1/skills/frt-1913/runs/{run_id}/findings
GET  /v1/skills/frt-1913/runs/{run_id}/evidence
```
