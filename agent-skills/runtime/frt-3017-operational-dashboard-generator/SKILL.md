...
description: "Run FRT-3017 Operational Dashboard Generator for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3017"
  source_name: "frt-3017-operational-dashboard-generator"
  source_sha256: "sha256:4a40419f1b9e014687acf7a0332a2bafb127d3d2986ccd3d78b87c395a575b6e"
  batch: "G30"
...
- Runtime catalog key: `FRT-3017` / `frt-3017-operational-dashboard-generator`.
...
在G30范围内实现 **Operational Dashboard Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Operational Dashboard Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3017Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3017EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3017FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3017CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3017-operational-dashboard-generator/
packages/runtime/g30/frt-3017-operational-dashboard-generator/
services/control-plane/g30/frt-3017-operational-dashboard-generator/
apps/web-console/src/features/g30/frt-3017-operational-dashboard-generator/
apps/admin-console/src/features/g30/frt-3017-operational-dashboard-generator/
tests/g30/frt-3017-operational-dashboard-generator/
```
...
```text
POST /v1/skills/frt-3017/runs
GET  /v1/skills/frt-3017/runs/{run_id}
POST /v1/skills/frt-3017/runs/{run_id}/verify
GET  /v1/skills/frt-3017/runs/{run_id}/findings
GET  /v1/skills/frt-3017/runs/{run_id}/evidence
```
