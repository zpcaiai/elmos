---
name: runner-drain-maintenance-autoscaling-failover-and-upgrade
description: "Implement drain, maintenance, autoscaling, scale-down safety, failover, canary upgrades, rollback, task preservation, and operational evidence."
---
...
Implement drain, maintenance, autoscaling, scale-down safety, failover, canary upgrades, rollback, task preservation, and operational evidence.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-drain-maintenance-autoscaling-failover-and-upgrade-baseline.md`.
...
```text
runner_drain_maintenance_autoscaling_failover_and_upgrade_manifest.json
runner_drain_maintenance_autoscaling_failover_and_upgrade_decision.json
runner_drain_maintenance_autoscaling_failover_and_upgrade_evidence.json
```
