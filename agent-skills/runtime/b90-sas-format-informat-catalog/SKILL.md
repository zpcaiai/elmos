---
name: b90-sas-format-informat-catalog
description: "Use when ELMOS must run sas format informat catalog for Batch 90 SAS / Macro / PROC SQL / Viya Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG335"
  source_name: "sas-format-informat-catalog"
  source_sha256: "sha256:5cb4fe27102ee6b3b1b48d2b9c1eed9663291dc8aa0ea311d47265d989ec4ae5"
  batch: 90
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 90 Language Pack / source PG335 — Sas Format Informat Catalog

## 1. Objective

Generate sas format informat catalog within the SAS / Macro / PROC SQL / Viya Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Sas Format Informat Catalog using the approved enterprise-analytics semantic contracts and toolchain versions.
...
- A representative valid sas-modernization input produces all declared outputs for sas-format-informat-catalog.
