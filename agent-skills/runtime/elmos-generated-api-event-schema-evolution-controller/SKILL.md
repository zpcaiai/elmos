---
name: elmos-generated-api-event-schema-evolution-controller
description: Govern versioning and compatibility for generated REST, GraphQL, gRPC, event and tool contracts across regeneration, migration and rolling deployment.
version: 4.0.0
...
# Generated API and Event Schema Evolution Controller
...
- `GeneratedAPIAndEventSchemaEvolutionControllerProfile`
- `GeneratedAPIAndEventSchemaEvolutionControllerPlan`
- `GeneratedAPIAndEventSchemaEvolutionControllerRun`
- `GeneratedAPIAndEventSchemaEvolutionControllerDecision`

Required semantic capabilities:

- classify breaking and non-breaking changes
- generate compatibility adapters and deprecation windows
- verify mixed-version rolling deployments
- bind consumer impact to repository graph
- coordinate rollback and schema registry state
...
- `artifacts/elmos-generated-api-event-schema-evolution-controller/profile.yaml`
- `artifacts/elmos-generated-api-event-schema-evolution-controller/plan.json`
- `artifacts/elmos-generated-api-event-schema-evolution-controller/result.json`
- `artifacts/elmos-generated-api-event-schema-evolution-controller/evidence/`
...
- **breaking change misclassified** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **consumer inventory incomplete** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **adapter hides semantic loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deprecation removed early** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback cannot read new payload** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify breaking and non-breaking changes
- native scenario: generate compatibility adapters and deprecation windows
- native scenario: verify mixed-version rolling deployments
- native scenario: bind consumer impact to repository graph
- native scenario: coordinate rollback and schema registry state
