---
name: elmos-abl-openedge-to-java-golden-route
description: 'Execute the reference route: OpenEdge ABL/PASOE to Java/Spring.'
version: 1.0.0
skill_id: ELMOS-POLY-143
...
triggers:
- Use when implementing or executing `elmos-abl-openedge-to-java-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-abl-openedge-to-java-golden-route/run.json
- routes/elmos-abl-openedge-to-java-golden-route/migration-plan.json
- routes/elmos-abl-openedge-to-java-golden-route/evidence/
---

# Abl Openedge To Java Golden Route

## Objective

Execute the reference route: OpenEdge ABL/PASOE to Java/Spring.
...
- Source: `abl`
- Target: `java`
- Intent: OpenEdge ABL/PASOE to Java/Spring
