---
name: elmos-ai-golden-route-managed-runtime
description: Certify portability from framework-native projects to a selected managed agent cloud with identity, observability,
  rollback and tested exit strategy.
version: 4.0.0
...
# Golden Route: Managed Agent Runtime
...
- `GoldenRouteManagedAgentRuntimeRun`
- `GoldenRouteManagedAgentRuntimeDecision`

Required semantic capabilities:

- Source framework import and AI-SIR recovery
- Managed target negotiation
- Identity/network/deployment generation
- Native load/scale/observability tests
- Export, rollback and exit drill
...
- `golden-routes/managed-runtime/evidence/`
- `managed-runtime-certificate.json`
- `portability-diff.json`
- `exit-drill-report.json`
...
- **managed platform lock-in** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **privilege overgrant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evidence owned by vendor** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **state export incomplete** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rollback unavailable** — must have a preventive control, a detective signal, a negative fixture and a response action.
