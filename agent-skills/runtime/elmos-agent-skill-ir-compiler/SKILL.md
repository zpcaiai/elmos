---
name: elmos-agent-skill-ir-compiler
description: Compile portable Agent Skill packages into a host-neutral semantic IR covering trigger intent, instructions,
  tools, resources, authority, tests, evidence and version constraints.
version: 4.0.0
...
- **Kernel authorities used:** K1, K3, K5, K6
...
- `DeploymentUnit`
- `ConformanceRun`
- `AgentSkillIRCompilerRun`
- `AgentSkillIRCompilerDecision`

Required semantic capabilities:

- Parse SKILL.md frontmatter and Markdown instruction graph
- Resolve scripts/references/assets without path escape
- Normalize trigger, tool, environment and output contracts
- Preserve source locations and package hashes
- Emit unsupported host semantics as explicit obligations
...
- `skill-ir.json`
- `skill-resource-graph.json`
- `skill-authority-contract.json`
- `skill-loss-register.json`
...
- **instruction smuggling** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hidden executable resource** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **path traversal** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **overbroad tool request** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **ambiguous trigger semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- valid skill package round trip
- malformed frontmatter rejection
- resource path traversal rejection
- tool authority extraction
- lossless instruction/source-map test
