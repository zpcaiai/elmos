...
description: "Run FRT-1918 Formal Assurance Certification for FRT G19 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1918"
  source_name: "frt-1918-formal-assurance-certification"
  source_sha256: "sha256:1935c51c60cdc8f50b7d65534c0e61c2bfa6042519dbfc16089886273b3b8e8a"
  batch: "G19"
...
- Runtime catalog key: `FRT-1918` / `frt-1918-formal-assurance-certification`.
...
# FRT-1918 — Formal Assurance Certification

## Objective

在G19范围内实现 **Formal Assurance Certification**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：从IR、Rule和业务不变量生成Proof Obligation; Leanstral仅提出证明候选，Lean Kernel为可信根; 组合SMT、Model Checking、Symbolic和Differential Evidence。

## When to Use

- 实现或修改与 **Formal Assurance Certification** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1918Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1918EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1918FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1918CertificateFragment`：供G19批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g19/frt-1918-formal-assurance-certification/
packages/runtime/g19/frt-1918-formal-assurance-certification/
services/control-plane/g19/frt-1918-formal-assurance-certification/
apps/web-console/src/features/g19/frt-1918-formal-assurance-certification/
apps/admin-console/src/features/g19/frt-1918-formal-assurance-certification/
tests/g19/frt-1918-formal-assurance-certification/
```
...
```text
POST /v1/skills/frt-1918/runs
GET  /v1/skills/frt-1918/runs/{run_id}
POST /v1/skills/frt-1918/runs/{run_id}/verify
GET  /v1/skills/frt-1918/runs/{run_id}/findings
GET  /v1/skills/frt-1918/runs/{run_id}/evidence
```
