---
name: elmos-template-marketplace-package-lifecycle-governor
description: Govern reusable templates, Skills, adapters and archetypes through publisher identity, compatibility, signing, review, distribution, update and revocation.
version: 4.0.0
...
# Template Marketplace and Package Lifecycle Governor
...
- `TemplateMarketplaceAndPackageLifecycleGovernorProfile`
- `TemplateMarketplaceAndPackageLifecycleGovernorPlan`
- `TemplateMarketplaceAndPackageLifecycleGovernorRun`
- `TemplateMarketplaceAndPackageLifecycleGovernorDecision`

Required semantic capabilities:

- register package identity and capabilities
- verify signatures, provenance and licenses
- run compatibility and malicious-package tests
- stage rollout and tenant policy filtering
- revoke and replace compromised packages
...
- `elmos-agent-skill-mcp-supply-chain-certifier` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `artifacts/elmos-template-marketplace-package-lifecycle-governor/profile.yaml`
- `artifacts/elmos-template-marketplace-package-lifecycle-governor/plan.json`
- `artifacts/elmos-template-marketplace-package-lifecycle-governor/result.json`
- `artifacts/elmos-template-marketplace-package-lifecycle-governor/evidence/`
...
- **typosquatted template** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **publisher takeover** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **revoked package remains cached** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **template requests excess authority** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **compatibility overclaim** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: register package identity and capabilities
- native scenario: verify signatures, provenance and licenses
- native scenario: run compatibility and malicious-package tests
- native scenario: stage rollout and tenant policy filtering
- native scenario: revoke and replace compromised packages
