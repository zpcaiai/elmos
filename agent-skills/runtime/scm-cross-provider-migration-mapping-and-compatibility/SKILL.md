---
name: scm-cross-provider-migration-mapping-and-compatibility
description: "Implement cross-provider identity mappings, repository transfer plans, branch/PR metadata compatibility, permission gaps, migration evidence, and rollback."
---
...
Implement cross-provider identity mappings, repository transfer plans, branch/PR metadata compatibility, permission gaps, migration evidence, and rollback.
...
4. Record unresolved provider/version assumptions in `docs/implementation/scm-cross-provider-migration-mapping-and-compatibility-baseline.md`.
...
```text
scm_cross_provider_migration_mapping_and_compatibility_manifest.json
scm_cross_provider_migration_mapping_and_compatibility_decision.json
scm_cross_provider_migration_mapping_and_compatibility_evidence.json
```
