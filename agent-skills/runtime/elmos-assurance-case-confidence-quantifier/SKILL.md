---
name: elmos-assurance-case-confidence-quantifier
description: Implement and independently certify assurance case confidence quantifier, including score evidence relevance, sufficiency, independence, diversity, freshness and uncertainty, propagate confidence and unresolved defeaters through claim argument graph and prevent numeric confidence from replacing hard critical gates.
version: 4.0.0
...
# Assurance Case Confidence Quantifier
...
- `AssuranceCaseConfidenceQuantifierProfile`
- `AssuranceCaseConfidenceQuantifierRun`
- `AssuranceCaseConfidenceQuantifierFinding`
- `AssuranceCaseConfidenceQuantifierDecision`
- `AssuranceCaseConfidenceQuantifierEvidence`

Required semantic capabilities:

- score evidence relevance, sufficiency, independence, diversity, freshness and uncertainty
- propagate confidence and unresolved defeaters through claim argument graph
- prevent numeric confidence from replacing hard critical gates
...
- `artifacts/elmos-assurance-case-confidence-quantifier/profile.yaml`
- `artifacts/elmos-assurance-case-confidence-quantifier/plan.json`
- `artifacts/elmos-assurance-case-confidence-quantifier/result.json`
- `artifacts/elmos-assurance-case-confidence-quantifier/evidence/`
- `artifacts/elmos-assurance-case-confidence-quantifier/assurance-case.json`
...
- **arbitrary confidence number creates false precision** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **correlated evidence is counted multiple times** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **high aggregate score masks critical refutation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: score evidence relevance, sufficiency, independence, diversity, freshness and uncertainty
- native scenario: propagate confidence and unresolved defeaters through claim argument graph
- native scenario: prevent numeric confidence from replacing hard critical gates
