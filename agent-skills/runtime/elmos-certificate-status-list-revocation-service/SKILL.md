---
name: elmos-certificate-status-list-revocation-service
description: Implement and independently certify certificate status list and revocation service, including publish privacy-preserving active, suspended, withdrawn, expired and superseded status, support offline cache, freshness, stapling and emergency revocation and bind reason, effective time, affected scope and replacement certificate.
version: 4.0.0
...
# Certificate Status List and Revocation Service
...
- `CertificateStatusListAndRevocationServiceProfile`
- `CertificateStatusListAndRevocationServiceRun`
- `CertificateStatusListAndRevocationServiceFinding`
- `CertificateStatusListAndRevocationServiceDecision`
- `CertificateStatusListAndRevocationServiceEvidence`

Required semantic capabilities:

- publish privacy-preserving active, suspended, withdrawn, expired and superseded status
- support offline cache, freshness, stapling and emergency revocation
- bind reason, effective time, affected scope and replacement certificate
...
- `elmos-machine-verifiable-certificate-profile-compiler`
- `elmos-certificate-drift-revocation-controller`

## Primary Outputs

- `artifacts/elmos-certificate-status-list-revocation-service/profile.yaml`
- `artifacts/elmos-certificate-status-list-revocation-service/plan.json`
- `artifacts/elmos-certificate-status-list-revocation-service/result.json`
- `artifacts/elmos-certificate-status-list-revocation-service/evidence/`
- `artifacts/elmos-certificate-status-list-revocation-service/assurance-case.json`
...
- **status endpoint outage causes fail-open** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **revocation leaks customer activity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **partial scope revocation invalidates whole product incorrectly** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: publish privacy-preserving active, suspended, withdrawn, expired and superseded status
- native scenario: support offline cache, freshness, stapling and emergency revocation
- native scenario: bind reason, effective time, affected scope and replacement certificate
