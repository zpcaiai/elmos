---
name: sandbox-cgroup-resource-time-io-oom-and-abuse-control
description: "Implement cgroup v2 CPU, memory, swap, PID, IO, disk, inode, file-descriptor, log, network and time limits with OOM-group and abuse tests."
---
...
Implement cgroup v2 CPU, memory, swap, PID, IO, disk, inode, file-descriptor, log, network and time limits with OOM-group and abuse tests.
...
4. Record unresolved provider/version assumptions in `docs/implementation/sandbox-cgroup-resource-time-io-oom-and-abuse-control-baseline.md`.
...
```text
sandbox_cgroup_resource_time_io_oom_and_abuse_control_manifest.json
sandbox_cgroup_resource_time_io_oom_and_abuse_control_decision.json
sandbox_cgroup_resource_time_io_oom_and_abuse_control_evidence.json
```
