...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/contract-asset-liability-deferred-revenue-unbilled-ar-a-92997cb5-baseline.md`.
