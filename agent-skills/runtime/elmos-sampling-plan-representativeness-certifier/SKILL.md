---
name: elmos-sampling-plan-representativeness-certifier
description: Implement and independently certify sampling plan and representativeness certifier, including define sampling frame, inclusion probabilities, strata and coverage targets, quantify selection, nonresponse, temporal and survivorship bias and verify sample supports the scope of inference claimed.
version: 4.0.0
...
# Sampling Plan and Representativeness Certifier
...
- `SamplingPlanAndRepresentativenessCertifierProfile`
- `SamplingPlanAndRepresentativenessCertifierRun`
- `SamplingPlanAndRepresentativenessCertifierFinding`
- `SamplingPlanAndRepresentativenessCertifierDecision`
- `SamplingPlanAndRepresentativenessCertifierEvidence`

Required semantic capabilities:

- define sampling frame, inclusion probabilities, strata and coverage targets
- quantify selection, nonresponse, temporal and survivorship bias
- verify sample supports the scope of inference claimed
...
- `artifacts/elmos-sampling-plan-representativeness-certifier/profile.yaml`
- `artifacts/elmos-sampling-plan-representativeness-certifier/plan.json`
- `artifacts/elmos-sampling-plan-representativeness-certifier/result.json`
- `artifacts/elmos-sampling-plan-representativeness-certifier/evidence/`
- `artifacts/elmos-sampling-plan-representativeness-certifier/assurance-case.json`
...
- **convenience sample is generalized to production population** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rare subgroup is absent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **time-window sampling misses drift regime** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define sampling frame, inclusion probabilities, strata and coverage targets
- native scenario: quantify selection, nonresponse, temporal and survivorship bias
- native scenario: verify sample supports the scope of inference claimed
