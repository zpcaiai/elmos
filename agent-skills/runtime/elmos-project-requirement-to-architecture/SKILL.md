---
name: project-requirement-to-architecture
description: Use this skill when Elmos must perform project requirement to architecture as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# project-requirement-to-architecture

## 能力目标

从需求生成边界、模块、ADR、数据流、部署和非功能约束。
