---
name: responsible-ai-audit-evidence-records-retention-and-legal-hold
description: "Implement Batch 45C Responsible AI、Safety、Governance与Compliance audit events, immutable evidence, records classes, retention, legal hold, exports and disposition, covering AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval."
---
...
Implement Batch 45C Responsible AI、Safety、Governance与Compliance audit events, immutable evidence, records classes, retention, legal hold, exports and disposition, covering AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval.
...
5. Write unresolved domain assumptions to `docs/implementation/responsible-ai-audit-evidence-records-retention-and-legal-hold-baseline.md`.
...
```text
responsible_ai_audit_evidence_records_retention_and_legal_hold_manifest.json
responsible_ai_audit_evidence_records_retention_and_legal_hold_state.json
responsible_ai_audit_evidence_records_retention_and_legal_hold_decision.json
responsible_ai_audit_evidence_records_retention_and_legal_hold_reconciliation.json
responsible_ai_audit_evidence_records_retention_and_legal_hold_evidence.json
```
