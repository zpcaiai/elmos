---
name: policy-simulation-and-impact
description: Use this skill when Elmos must perform policy simulation and impact as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
