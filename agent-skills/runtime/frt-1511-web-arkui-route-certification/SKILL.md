...
description: "Run FRT-1511 Web ArkUI Route Certification for FRT G15 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1511"
  source_name: "frt-1511-web-arkui-route-certification"
  source_sha256: "sha256:b95b6d3d31e52933d4b12dd8d7755ecb0ce0d8253de19f8898f00f7fb697c482"
  batch: "G15"
...
- Runtime catalog key: `FRT-1511` / `frt-1511-web-arkui-route-certification`.
...
# FRT-1511 — Web ArkUI Route Certification

## Objective

在G15范围内实现 **Web ArkUI Route Certification**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射ArkUI状态装饰器、Builder、Navigation和生命周期; 处理Web DOM能力与ArkUI Native/Device差异; 生成真机/模拟器和Accessibility验证。

## When to Use

- 实现或修改与 **Web ArkUI Route Certification** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1511Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1511EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1511FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1511CertificateFragment`：供G15批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g15/frt-1511-web-arkui-route-certification/
packages/runtime/g15/frt-1511-web-arkui-route-certification/
services/control-plane/g15/frt-1511-web-arkui-route-certification/
apps/web-console/src/features/g15/frt-1511-web-arkui-route-certification/
apps/admin-console/src/features/g15/frt-1511-web-arkui-route-certification/
tests/g15/frt-1511-web-arkui-route-certification/
```
...
```text
POST /v1/skills/frt-1511/runs
GET  /v1/skills/frt-1511/runs/{run_id}
POST /v1/skills/frt-1511/runs/{run_id}/verify
GET  /v1/skills/frt-1511/runs/{run_id}/findings
GET  /v1/skills/frt-1511/runs/{run_id}/evidence
```
