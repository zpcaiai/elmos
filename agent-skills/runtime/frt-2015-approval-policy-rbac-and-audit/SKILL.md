...
description: "Run FRT-2015 Approval Policy RBAC and Audit for FRT G20 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2015"
  source_name: "frt-2015-approval-policy-rbac-and-audit"
  source_sha256: "sha256:274668faf743b42fc9a964aa55b1b2b184aa447be9982f6ce2eded4d2ec2dce6"
  batch: "G20"
...
- Runtime catalog key: `FRT-2015` / `frt-2015-approval-policy-rbac-and-audit`.
...
# FRT-2015 — Approval Policy RBAC and Audit

## Objective

在G20范围内实现 **Approval Policy RBAC and Audit**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：提供Skill SDK、Runtime、Registry和Marketplace; 实现CLI、API、IDE、Web Console和Multi-Tenant Workspace; Durable Workflow与分布式Worker支持暂停、恢复、取消和幂等。

## When to Use

- 实现或修改与 **Approval Policy RBAC and Audit** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2015Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2015EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2015FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2015CertificateFragment`：供G20批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g20/frt-2015-approval-policy-rbac-and-audit/
packages/runtime/g20/frt-2015-approval-policy-rbac-and-audit/
services/control-plane/g20/frt-2015-approval-policy-rbac-and-audit/
apps/web-console/src/features/g20/frt-2015-approval-policy-rbac-and-audit/
apps/admin-console/src/features/g20/frt-2015-approval-policy-rbac-and-audit/
tests/g20/frt-2015-approval-policy-rbac-and-audit/
```
...
```text
POST /v1/skills/frt-2015/runs
GET  /v1/skills/frt-2015/runs/{run_id}
POST /v1/skills/frt-2015/runs/{run_id}/verify
GET  /v1/skills/frt-2015/runs/{run_id}/findings
GET  /v1/skills/frt-2015/runs/{run_id}/evidence
```
