---
name: utility-customer-orchestrator
description: "Implement Batch 53A Utility Metering、Billing、Outage与Customer Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Service Point、Meter、Reading、Tariff、Usage、Bill、Payment、Outage、Customer Request与Field Order."
---

# Utility Customer Orchestrator

## Objective

Implement Batch 53A Utility Metering、Billing、Outage与Customer Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Service Point、Meter、Reading、Tariff、Usage、Bill、Payment、Outage、Customer Request与Field Order.
...
5. Write unresolved domain assumptions to `docs/implementation/utility-customer-orchestrator-baseline.md`.
...
```text
utility_customer_orchestrator_manifest.json
utility_customer_orchestrator_state.json
utility_customer_orchestrator_decision.json
utility_customer_orchestrator_reconciliation.json
utility_customer_orchestrator_evidence.json
```
