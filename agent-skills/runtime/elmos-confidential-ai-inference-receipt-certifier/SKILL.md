...
# Confidential AI Inference Receipt Certifier
...
- `ConfidentialAIInferenceReceiptCertifierProfile`
- `ConfidentialAIInferenceReceiptCertifierRun`
- `ConfidentialAIInferenceReceiptCertifierFinding`
- `ConfidentialAIInferenceReceiptCertifierDecision`
- `ConfidentialAIInferenceReceiptCertifierEvidence`

Required semantic capabilities:

- issue signed receipt binding model, code, policy, input commitment, output commitment and trusted execution evidence
- prove inference occurred in approved confidential environment without exposing protected content
- verify receipt replay, privacy and cross-provider portability
...
- `elmos-confidential-computing-attestation-controller` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-confidential-ai-inference-receipt-certifier/profile.yaml`
- `artifacts/elmos-confidential-ai-inference-receipt-certifier/plan.json`
- `artifacts/elmos-confidential-ai-inference-receipt-certifier/result.json`
- `artifacts/elmos-confidential-ai-inference-receipt-certifier/evidence/`
- `artifacts/elmos-confidential-ai-inference-receipt-certifier/assurance-case.json`
...
- **receipt does not bind actual model weights** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **host can substitute output after enclave inference** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **input commitment enables sensitive-data guessing** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: issue signed receipt binding model, code, policy, input commitment, output commitment and trusted execution evidence
- native scenario: prove inference occurred in approved confidential environment without exposing protected content
- native scenario: verify receipt replay, privacy and cross-provider portability
