...
description: "Run FRT-0707 Typed Hole and Gap Emitter for FRT G07 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0707"
  source_name: "frt-0707-typed-hole-and-gap-emitter"
  source_sha256: "sha256:f1302308d19b7123e3656be07042abe73be4f412e2c5d7a51e69e79b660bd0e9"
  batch: "G07"
...
- Runtime catalog key: `FRT-0707` / `frt-0707-typed-hole-and-gap-emitter`.
...
# FRT-0707 — Typed Hole and Gap Emitter

## Objective

在G07范围内实现 **Typed Hole and Gap Emitter**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Typed IR经规则Pass降低到目标原生AST; Gap生成Typed Hole而非空实现; Format/Analyze/Build驱动有界确定性修复。

## When to Use

- 实现或修改与 **Typed Hole and Gap Emitter** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0707Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0707EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0707FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0707CertificateFragment`：供G07批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g07/frt-0707-typed-hole-and-gap-emitter/
packages/runtime/g07/frt-0707-typed-hole-and-gap-emitter/
services/control-plane/g07/frt-0707-typed-hole-and-gap-emitter/
apps/web-console/src/features/g07/frt-0707-typed-hole-and-gap-emitter/
apps/admin-console/src/features/g07/frt-0707-typed-hole-and-gap-emitter/
tests/g07/frt-0707-typed-hole-and-gap-emitter/
```
...
```text
POST /v1/skills/frt-0707/runs
GET  /v1/skills/frt-0707/runs/{run_id}
POST /v1/skills/frt-0707/runs/{run_id}/verify
GET  /v1/skills/frt-0707/runs/{run_id}/findings
GET  /v1/skills/frt-0707/runs/{run_id}/evidence
```
