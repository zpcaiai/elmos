---
name: elmos-conformity-decision-guard-band-controller
description: Implement and independently certify conformity decision rule and guard-band controller, including compile acceptance limits, guard bands and consumer/producer risk, apply pass, fail, indeterminate and retest decisions consistently and bind decision rule to contract before measurement is observed.
version: 4.0.0
...
# Conformity Decision Rule and Guard-Band Controller
...
- `ConformityDecisionRuleAndGuardBandControllerProfile`
- `ConformityDecisionRuleAndGuardBandControllerRun`
- `ConformityDecisionRuleAndGuardBandControllerFinding`
- `ConformityDecisionRuleAndGuardBandControllerDecision`
- `ConformityDecisionRuleAndGuardBandControllerEvidence`

Required semantic capabilities:

- compile acceptance limits, guard bands and consumer/producer risk
- apply pass, fail, indeterminate and retest decisions consistently
- bind decision rule to contract before measurement is observed
...
- `artifacts/elmos-conformity-decision-guard-band-controller/profile.yaml`
- `artifacts/elmos-conformity-decision-guard-band-controller/plan.json`
- `artifacts/elmos-conformity-decision-guard-band-controller/result.json`
- `artifacts/elmos-conformity-decision-guard-band-controller/evidence/`
- `artifacts/elmos-conformity-decision-guard-band-controller/assurance-case.json`
...
- **decision threshold is moved after seeing result** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **uncertainty is ignored near limit** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **binary pass hides indeterminate risk** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile acceptance limits, guard bands and consumer/producer risk
- native scenario: apply pass, fail, indeterminate and retest decisions consistently
- native scenario: bind decision rule to contract before measurement is observed
