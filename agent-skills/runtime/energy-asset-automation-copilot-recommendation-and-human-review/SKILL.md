---
name: energy-asset-automation-copilot-recommendation-and-human-review
description: "Implement Batch 53C Energy Asset、Field Service、Reliability与Sustainability typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Asset、Inspection、Work Order、Crew、Permit、Outage、Reliability Metric、Emission、Maintenance与Safety Case."
---

# Energy Asset Automation Copilot Recommendation And Human Review

## Objective

Implement Batch 53C Energy Asset、Field Service、Reliability与Sustainability typed automation, copilots, recommendations, source grounding, confidence, human review and no-direct-approval controls, covering Asset、Inspection、Work Order、Crew、Permit、Outage、Reliability Metric、Emission、Maintenance与Safety Case.
...
5. Write unresolved domain assumptions to `docs/implementation/energy-asset-automation-copilot-recommendation-and-human-review-baseline.md`.
...
```text
energy_asset_automation_copilot_recommendation_and_human_review_manifest.json
energy_asset_automation_copilot_recommendation_and_human_review_state.json
energy_asset_automation_copilot_recommendation_and_human_review_decision.json
energy_asset_automation_copilot_recommendation_and_human_review_reconciliation.json
energy_asset_automation_copilot_recommendation_and_human_review_evidence.json
```
