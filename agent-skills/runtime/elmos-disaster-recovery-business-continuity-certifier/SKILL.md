---
name: elmos-disaster-recovery-business-continuity-certifier
description: Certify backup, restore, regional failover, dependency loss, key recovery, evidence continuity and documented RTO/RPO under business continuity scenarios.
version: 4.0.0
...
# Disaster Recovery and Business Continuity Certifier
...
- Map critical services and recovery priorities
- Validate backups and cryptographic key recovery
- Run region/dependency loss exercises
- Measure RTO/RPO from declared points
- Reconcile data, side effects and evidence after restore
...
- `elmos-chaos-recovery-verification-controller` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `dr-certificate.json`
- `business-impact-analysis.json`
- `recovery-runbook.yaml`
- `restore-reconciliation-report.json`
...
- **RPO excludes event backlog** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **signing key unrecoverable** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **failover violates residency** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **restore replays external side effects** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- region failover
- event bus recovery
- KMS/signer continuity
- customer VPC disconnection
