...
description: "Invoke the bounded repository handler for elmos-sandbox-runtime while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P01:sandbox-runtime"
  source_name: "elmos-sandbox-runtime"
  installed_name: "elmos-sandbox-runtime"
  source_logical_path: "01-elmos-harness-runtime-platform/skills/sandbox-runtime/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/01-elmos-harness-runtime-platform/skills/sandbox-runtime/SKILL.md.source-data"
  source_materialized_path: "01-elmos-harness-runtime-platform/skills/sandbox-runtime/SKILL.md.source-data"
  source_sha256: "sha256:b14e893026d31674356053b7b5e53f0d9b00f2c986d7cf469c793444f10c9347"
...
- This is a deterministic repository wrapper for `01-elmos-harness-runtime-platform/skills/sandbox-runtime/SKILL.md` at `sha256:b14e893026d31674356053b7b5e53f0d9b00f2c986d7cf469c793444f10c9347`.
- Its immutable source/runtime identity is `elmos-sandbox-runtime`; its active installed identity is `elmos-sandbox-runtime`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-sandbox-runtime --request <file>
```
