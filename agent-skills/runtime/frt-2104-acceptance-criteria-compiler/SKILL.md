...
description: "Run FRT-2104 Acceptance Criteria Compiler for FRT G21 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2104"
  source_name: "frt-2104-acceptance-criteria-compiler"
  source_sha256: "sha256:b8d0dc05689b8244a697df9782916ea37dc02ebaf132d684aa2ea0ab7ab66ab2"
  batch: "G21"
...
- Runtime catalog key: `FRT-2104` / `frt-2104-acceptance-criteria-compiler`.
...
在G21范围内实现 **Acceptance Criteria Compiler**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：统一 Product Closure Graph; Requirement、Capability、Journey、Command、API、Data、Permission、Test、Monitoring、Runbook、Certificate 双向追踪; 孤儿 UI/API/Command/Event/Data Write 检测。

## When to Use

- 实现或修改与 **Acceptance Criteria Compiler** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2104Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2104EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2104FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2104CertificateFragment`：供G21批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g21/frt-2104-acceptance-criteria-compiler/
packages/runtime/g21/frt-2104-acceptance-criteria-compiler/
services/control-plane/g21/frt-2104-acceptance-criteria-compiler/
apps/web-console/src/features/g21/frt-2104-acceptance-criteria-compiler/
apps/admin-console/src/features/g21/frt-2104-acceptance-criteria-compiler/
tests/g21/frt-2104-acceptance-criteria-compiler/
```
...
```text
POST /v1/skills/frt-2104/runs
GET  /v1/skills/frt-2104/runs/{run_id}
POST /v1/skills/frt-2104/runs/{run_id}/verify
GET  /v1/skills/frt-2104/runs/{run_id}/findings
GET  /v1/skills/frt-2104/runs/{run_id}/evidence
```
