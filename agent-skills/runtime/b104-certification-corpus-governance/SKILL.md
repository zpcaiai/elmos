---
name: b104-certification-corpus-governance
description: "Use when ELMOS must Govern representative public, synthetic and customer-approved repositories with licensing, privacy and contamination controls. Triggers: Certification Corpus Governance, Real World Product Certification Pack, corpus registry, licensing, privacy, holdout."
metadata:
  id: B104-S01
...
# B104-S01 — Certification Corpus Governance

## Objective

Govern representative public, synthetic and customer-approved repositories with licensing, privacy and contamination controls.
...
Use this Skill when the approved task explicitly requires **Certification Corpus Governance** or when the capability graph selects it as part of a minimal dependency closure.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b104-certification-corpus-governance/SKILL.md --out /tmp/certification_corpus_governance.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B104-S01
```
...
- Reject or expose training leakage.
- Reject or expose license unknown.
- Reject or expose customer code copied.
