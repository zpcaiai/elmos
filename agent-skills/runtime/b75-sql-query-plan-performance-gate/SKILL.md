---
name: b75-sql-query-plan-performance-gate
description: "Use when ELMOS must enforce and test SQL Query Plan Performance Gate for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: SQL Query Plan Performance Gate, Batch 75, SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility."
metadata:
  id: PG340
  batch: 75
  version: 1.0.0
...
# PG340 — SQL Query Plan Performance Gate

## Objective

Enforce and test SQL Query Plan Performance Gate for SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `sql-query-plan-performance-gate` tasks involving SQL migrations, queries, transactions, fixtures, performance and security plus OpenAPI, Protocol Buffers, GraphQL, code generation, and compatibility.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG334`, `PG339`.
...
- `sql_query_plan_performance_gate_plan.json`
- `sql_query_plan_performance_gate_artifacts/`
- `sql_query_plan_performance_gate_verification.json`
