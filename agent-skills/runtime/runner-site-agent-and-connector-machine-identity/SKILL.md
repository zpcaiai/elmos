---
name: runner-site-agent-and-connector-machine-identity
description: "Implement machine identities for runners, sites, agents, connectors, schedulers, providers, and service accounts with scoped trust and compromise recovery."
---
...
Implement machine identities for runners, sites, agents, connectors, schedulers, providers, and service accounts with scoped trust and compromise recovery.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-site-agent-and-connector-machine-identity-baseline.md`.
...
```text
runner_site_agent_and_connector_machine_identity_manifest.json
runner_site_agent_and_connector_machine_identity_decision.json
runner_site_agent_and_connector_machine_identity_evidence.json
```
