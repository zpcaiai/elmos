...
description: "Run FRT-2900 Security Assurance Orchestrator for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2900"
  source_name: "frt-2900-security-assurance-orchestrator"
  source_sha256: "sha256:90dc7d9a7bc3956741438794cc09b4afb81070e939b164ab7d946549f0c1af93"
  batch: "G29"
...
- Runtime catalog key: `FRT-2900` / `frt-2900-security-assurance-orchestrator`.
...
在G29范围内实现 **Security Assurance Orchestrator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Security Assurance Orchestrator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2900Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2900EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2900FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2900CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2900-security-assurance-orchestrator/
packages/runtime/g29/frt-2900-security-assurance-orchestrator/
services/control-plane/g29/frt-2900-security-assurance-orchestrator/
apps/web-console/src/features/g29/frt-2900-security-assurance-orchestrator/
apps/admin-console/src/features/g29/frt-2900-security-assurance-orchestrator/
tests/g29/frt-2900-security-assurance-orchestrator/
```
...
```text
POST /v1/skills/frt-2900/runs
GET  /v1/skills/frt-2900/runs/{run_id}
POST /v1/skills/frt-2900/runs/{run_id}/verify
GET  /v1/skills/frt-2900/runs/{run_id}/findings
GET  /v1/skills/frt-2900/runs/{run_id}/evidence
```
