---
name: bi-semantic-analytics-kpi-scoring-forecast-and-diagnostics
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence semantic metrics, scoring, forecasting, trend, anomaly, diagnostics, confidence and explainability, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-analytics-kpi-scoring-forecast-and-diagnostics-baseline.md`.
...
```text
bi_semantic_analytics_kpi_scoring_forecast_and_diagnostics_manifest.json
bi_semantic_analytics_kpi_scoring_forecast_and_diagnostics_state.json
bi_semantic_analytics_kpi_scoring_forecast_and_diagnostics_decision.json
bi_semantic_analytics_kpi_scoring_forecast_and_diagnostics_reconciliation.json
bi_semantic_analytics_kpi_scoring_forecast_and_diagnostics_evidence.json
```
