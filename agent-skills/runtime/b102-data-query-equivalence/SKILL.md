---
name: b102-data-query-equivalence
description: "Use when ELMOS must Compare schema, constraints, data transformations, query results, ordering, precision and null semantics. Triggers: Data and Query Equivalence, Semantic Equivalence Lab Pack, data schema, queries, precision, nulls."
metadata:
  id: B102-S06
...
# B102-S06 — Data and Query Equivalence

## Objective

Compare schema, constraints, data transformations, query results, ordering, precision and null semantics.
...
Use this Skill when the approved task explicitly requires **Data and Query Equivalence** or when the capability graph selects it as part of a minimal dependency closure.
...
- precision exact or approved tolerance.
- ordering rules explicit.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b102-data-query-equivalence/SKILL.md --out /tmp/data_query_equivalence.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B102-S06
```
...
- Reject or expose sampling hides defect.
- Reject or expose timezone drift.
- Reject or expose collation ignored.
