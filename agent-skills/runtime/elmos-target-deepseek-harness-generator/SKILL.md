---
name: elmos-target-deepseek-harness-generator
description: Generate Cordis-based plugins, services, events, lifecycle effects, bundles, profiles and patch layers with hot-unload
  and authority conformance tests.
version: 4.0.0
...
# TargetDeepseekHarnessGenerator
...
- Generate Everything-is-a-Plugin components
- Generate typed services/events and lifecycle cleanup
- Generate bundles, profiles and ordered patches
- Generate headless/web compositions
- Run hot reload, unload and patch conflict tests
...
- **plugin lifecycle leak** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **patch precedence attack** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **service capability spoofing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **hot-reload duplicate effect** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **bundle dependency confusion** — must have a preventive control, a detective signal, a negative fixture and a response action.
