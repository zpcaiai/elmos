---
name: tenant-aware-postgresql-rls-ownership-and-runtime-roles
description: "Implement tenant-aware PostgreSQL RLS, FORCE RLS, owner/runtime/migration roles, tenant foreign keys, session context, connection-pool safety, and isolation tests."
---
...
Implement tenant-aware PostgreSQL RLS, FORCE RLS, owner/runtime/migration roles, tenant foreign keys, session context, connection-pool safety, and isolation tests.
...
4. Record unresolved provider/version assumptions in `docs/implementation/tenant-aware-postgresql-rls-ownership-and-runtime-roles-baseline.md`.
...
```text
tenant_aware_postgresql_rls_ownership_and_runtime_roles_manifest.json
tenant_aware_postgresql_rls_ownership_and_runtime_roles_decision.json
tenant_aware_postgresql_rls_ownership_and_runtime_roles_evidence.json
```
