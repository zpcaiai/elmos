...
description: "Run FRT-2718 Performance Budget Governor for FRT G27 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2718"
  source_name: "frt-2718-performance-budget-governor"
  source_sha256: "sha256:90e233683d83284ab2eabce1eff617b39ed45a29eed3a8b06cd216f1fb1a492e"
  batch: "G27"
...
- Runtime catalog key: `FRT-2718` / `frt-2718-performance-budget-governor`.
...
在G27范围内实现 **Performance Budget Governor**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：业务化Workload Model; 并发线性化点、Race、Lost Update、Idempotency Under Load; Load/Stress/Spike/Soak与Recovery。

## When to Use

- 实现或修改与 **Performance Budget Governor** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2718Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2718EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2718FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2718CertificateFragment`：供G27批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g27/frt-2718-performance-budget-governor/
packages/runtime/g27/frt-2718-performance-budget-governor/
services/control-plane/g27/frt-2718-performance-budget-governor/
apps/web-console/src/features/g27/frt-2718-performance-budget-governor/
apps/admin-console/src/features/g27/frt-2718-performance-budget-governor/
tests/g27/frt-2718-performance-budget-governor/
```
...
```text
POST /v1/skills/frt-2718/runs
GET  /v1/skills/frt-2718/runs/{run_id}
POST /v1/skills/frt-2718/runs/{run_id}/verify
GET  /v1/skills/frt-2718/runs/{run_id}/findings
GET  /v1/skills/frt-2718/runs/{run_id}/evidence
```
