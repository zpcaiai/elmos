---
name: elmos-ai-bom-provenance-generator
description: Generate a signed AI BOM covering models, datasets, prompts, Skills, tools, MCP servers, adapters, libraries,
  images, policies and evidence lineage.
version: 4.0.0
...
# AI Bill of Materials and Provenance Generator
...
- `Approval`
- `ResidualRisk`
- `AIBillOfMaterialsAndProvenanceGeneratorRun`
- `AIBillOfMaterialsAndProvenanceGeneratorDecision`

Required semantic capabilities:

- AI-specific component inventory
- Digest and publisher identity binding
- Dependency and transitive service graph
- License/residency/risk annotations
- Signed provenance and drift invalidation
...
- **undeclared model/provider** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dataset provenance loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **SBOM evasion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **signature substitution** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale component risk** — must have a preventive control, a detective signal, a negative fixture and a response action.
