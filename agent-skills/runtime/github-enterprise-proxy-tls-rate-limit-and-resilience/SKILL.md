---
name: github-enterprise-proxy-tls-rate-limit-and-resilience
description: "Implement enterprise proxy, custom CA, TLS verification, DNS, redirect, API version, rate limits, retry, circuit breaking, and provider outage behaviour."
---
...
Implement enterprise proxy, custom CA, TLS verification, DNS, redirect, API version, rate limits, retry, circuit breaking, and provider outage behaviour.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-enterprise-proxy-tls-rate-limit-and-resilience-baseline.md`.
...
```text
github_enterprise_proxy_tls_rate_limit_and_resilience_manifest.json
github_enterprise_proxy_tls_rate_limit_and_resilience_decision.json
github_enterprise_proxy_tls_rate_limit_and_resilience_evidence.json
```
