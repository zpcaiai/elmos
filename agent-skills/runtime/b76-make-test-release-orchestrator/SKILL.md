---
name: b76-make-test-release-orchestrator
description: "Use when ELMOS must coordinate and control Make Test Release Orchestrator for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Make Test Release Orchestrator, Batch 76, Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification."
metadata:
  id: PG354
  batch: 76
  version: 1.0.0
...
# PG354 — Make Test Release Orchestrator

## Objective

Coordinate and control Make Test Release Orchestrator for Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `make-test-release-orchestrator` tasks involving Makefile and CMake build graphs plus Nginx reverse proxy, TLS, rate limiting, routing, and configuration certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG350`, `PG353`.
...
- `make_test_release_orchestrator_plan.json`
- `make_test_release_orchestrator_artifacts/`
- `make_test_release_orchestrator_verification.json`
