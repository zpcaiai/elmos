---
name: fleet-transport-orchestrator
description: "Implement Batch 51A Transportation、Fleet、Dispatch与Route Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Vehicle、Driver、Trip、Route、Stop、Load、Dispatch、Telematics、Fuel与Maintenance."
---

# Fleet Transport Orchestrator

## Objective

Implement Batch 51A Transportation、Fleet、Dispatch与Route Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Vehicle、Driver、Trip、Route、Stop、Load、Dispatch、Telematics、Fuel与Maintenance.
...
5. Write unresolved domain assumptions to `docs/implementation/fleet-transport-orchestrator-baseline.md`.
...
```text
fleet_transport_orchestrator_manifest.json
fleet_transport_orchestrator_state.json
fleet_transport_orchestrator_decision.json
fleet_transport_orchestrator_reconciliation.json
fleet_transport_orchestrator_evidence.json
```
