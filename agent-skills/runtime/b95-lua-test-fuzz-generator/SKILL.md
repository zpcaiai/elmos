---
name: b95-lua-test-fuzz-generator
description: "Use when ELMOS must run lua test fuzz generator for Batch 95 Lua / OpenResty / Embedded Scripting Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG400"
  source_name: "lua-test-fuzz-generator"
  source_sha256: "sha256:2e78119108ec4591e6fcd1428d9c65daa0f7abeae890f6f14e6b5fe211372f63"
  batch: 95
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 95 Language Pack / source PG400 — Lua Test Fuzz Generator

## 1. Objective

Generate lua test fuzz generator within the Lua / OpenResty / Embedded Scripting Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Lua Test Fuzz Generator using the approved embedded-scripting-gateway semantic contracts and toolchain versions.
...
- A representative valid lua-openresty input produces all declared outputs for lua-test-fuzz-generator.
