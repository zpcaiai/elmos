...
triggers:
  - "Use when implementing or executing `elmos-corpus-drift-freshness-manager`."
  - "Use when a migration/certification DAG requires `corpus` capability."
outputs:
  - "semantic-assurance/elmos-corpus-drift-freshness-manager/model.json"
  - "semantic-assurance/elmos-corpus-drift-freshness-manager/evidence.json"
  - "semantic-assurance/elmos-corpus-drift-freshness-manager/diagnostics.json"
---

# Corpus Drift & Freshness Manager

## Objective

Detect stale toolchain/spec/framework fixtures and schedule recertification when source standards, compilers or dependencies change.
...
- [ ] compiler upgrade invalidates evidence.
- [ ] spec edition drift.
- [ ] unchanged fixture hash stable.
