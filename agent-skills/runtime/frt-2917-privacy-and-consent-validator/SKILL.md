...
description: "Run FRT-2917 Privacy and Consent Validator for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2917"
  source_name: "frt-2917-privacy-and-consent-validator"
  source_sha256: "sha256:8ccfbe7c609331e06a472ca96ddbd7c6346323677a315cc359651d9d18e249d7"
  batch: "G29"
...
- Runtime catalog key: `FRT-2917` / `frt-2917-privacy-and-consent-validator`.
...
在G29范围内实现 **Privacy and Consent Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Privacy and Consent Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2917Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2917EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2917FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2917CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2917-privacy-and-consent-validator/
packages/runtime/g29/frt-2917-privacy-and-consent-validator/
services/control-plane/g29/frt-2917-privacy-and-consent-validator/
apps/web-console/src/features/g29/frt-2917-privacy-and-consent-validator/
apps/admin-console/src/features/g29/frt-2917-privacy-and-consent-validator/
tests/g29/frt-2917-privacy-and-consent-validator/
```
...
```text
POST /v1/skills/frt-2917/runs
GET  /v1/skills/frt-2917/runs/{run_id}
POST /v1/skills/frt-2917/runs/{run_id}/verify
GET  /v1/skills/frt-2917/runs/{run_id}/findings
GET  /v1/skills/frt-2917/runs/{run_id}/evidence
```
