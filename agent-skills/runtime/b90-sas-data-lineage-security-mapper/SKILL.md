---
name: b90-sas-data-lineage-security-mapper
description: "Use when ELMOS must run sas data lineage security mapper for Batch 90 SAS / Macro / PROC SQL / Viya Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG340"
  source_name: "sas-data-lineage-security-mapper"
  source_sha256: "sha256:681c424c6cb882041eb2333da1d2ba66670db220ad32b33a683dfdaf2d357440"
  batch: 90
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 90 Language Pack / source PG340 — Sas Data Lineage Security Mapper

## 1. Objective

Map sas data lineage security mapper within the SAS / Macro / PROC SQL / Viya Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Sas Data Lineage Security Mapper using the approved enterprise-analytics semantic contracts and toolchain versions.
...
- A representative valid sas-modernization input produces all declared outputs for sas-data-lineage-security-mapper.
