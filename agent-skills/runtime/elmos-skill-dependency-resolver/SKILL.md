...
description: Use this skill when Elmos must perform skill dependency resolver as part of the 05-skill-foundry-runtime production
...
解析 Skill、工具、模型、环境和 Schema 依赖，生成可重复执行闭包。
