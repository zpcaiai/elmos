...
description: "Run FRT-2918 Retention and Deletion Compliance for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2918"
  source_name: "frt-2918-retention-and-deletion-compliance"
  source_sha256: "sha256:ee48edb0476ddfee284cc808071dc8175b95b23035366568800f4015b3b28d5d"
  batch: "G29"
...
- Runtime catalog key: `FRT-2918` / `frt-2918-retention-and-deletion-compliance`.
...
在G29范围内实现 **Retention and Deletion Compliance**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Retention and Deletion Compliance** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2918Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2918EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2918FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2918CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2918-retention-and-deletion-compliance/
packages/runtime/g29/frt-2918-retention-and-deletion-compliance/
services/control-plane/g29/frt-2918-retention-and-deletion-compliance/
apps/web-console/src/features/g29/frt-2918-retention-and-deletion-compliance/
apps/admin-console/src/features/g29/frt-2918-retention-and-deletion-compliance/
tests/g29/frt-2918-retention-and-deletion-compliance/
```
...
```text
POST /v1/skills/frt-2918/runs
GET  /v1/skills/frt-2918/runs/{run_id}
POST /v1/skills/frt-2918/runs/{run_id}/verify
GET  /v1/skills/frt-2918/runs/{run_id}/findings
GET  /v1/skills/frt-2918/runs/{run_id}/evidence
```
