---
name: runner-execution-operations-orchestrator
description: "Implement Batch 36C end to end: checkpoints, artifact/log streams, durable site queues, offline operation, site autonomy, HA, cache warming, transfer QoS, fleet scale, retention, and gates."
---
...
Implement Batch 36C end to end: checkpoints, artifact/log streams, durable site queues, offline operation, site autonomy, HA, cache warming, transfer QoS, fleet scale, retention, and gates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-execution-operations-orchestrator-baseline.md`.
...
```text
runner_execution_operations_orchestrator_manifest.json
runner_execution_operations_orchestrator_decision.json
runner_execution_operations_orchestrator_evidence.json
```
