...
# Audit Duration, Sampling and Risk Planner
...
- `AuditDurationSamplingAndRiskPlannerProfile`
- `AuditDurationSamplingAndRiskPlannerRun`
- `AuditDurationSamplingAndRiskPlannerFinding`
- `AuditDurationSamplingAndRiskPlannerDecision`
- `AuditDurationSamplingAndRiskPlannerEvidence`

Required semantic capabilities:

- estimate effort from scope, complexity, sites, shifts, providers, change rate and risk
- design representative sample of repositories, deployments, evidence and personnel
- document reductions, additions and residual sampling risk
...
- `artifacts/elmos-audit-duration-sampling-risk-planner/profile.yaml`
- `artifacts/elmos-audit-duration-sampling-risk-planner/plan.json`
- `artifacts/elmos-audit-duration-sampling-risk-planner/result.json`
- `artifacts/elmos-audit-duration-sampling-risk-planner/evidence/`
- `artifacts/elmos-audit-duration-sampling-risk-planner/assurance-case.json`
...
- **audit duration is fixed regardless of complexity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sample excludes outsourced provider** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **remote evidence is accepted without authenticity check** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: estimate effort from scope, complexity, sites, shifts, providers, change rate and risk
- native scenario: design representative sample of repositories, deployments, evidence and personnel
- native scenario: document reductions, additions and residual sampling risk
