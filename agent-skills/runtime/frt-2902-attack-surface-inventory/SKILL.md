...
description: "Run FRT-2902 Attack Surface Inventory for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2902"
  source_name: "frt-2902-attack-surface-inventory"
  source_sha256: "sha256:6e35dbd376b63875203b298a8a7483c0cd0ae3ff594403bbcab352c58cbbd7bc"
  batch: "G29"
...
- Runtime catalog key: `FRT-2902` / `frt-2902-attack-surface-inventory`.
...
在G29范围内实现 **Attack Surface Inventory**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Attack Surface Inventory** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2902Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2902EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2902FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2902CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2902-attack-surface-inventory/
packages/runtime/g29/frt-2902-attack-surface-inventory/
services/control-plane/g29/frt-2902-attack-surface-inventory/
apps/web-console/src/features/g29/frt-2902-attack-surface-inventory/
apps/admin-console/src/features/g29/frt-2902-attack-surface-inventory/
tests/g29/frt-2902-attack-surface-inventory/
```
...
```text
POST /v1/skills/frt-2902/runs
GET  /v1/skills/frt-2902/runs/{run_id}
POST /v1/skills/frt-2902/runs/{run_id}/verify
GET  /v1/skills/frt-2902/runs/{run_id}/findings
GET  /v1/skills/frt-2902/runs/{run_id}/evidence
```
