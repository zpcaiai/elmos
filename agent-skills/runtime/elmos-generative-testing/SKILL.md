---
name: "elmos-generative-testing"
description: "Invoke the bounded repository handler for elmos-generative-testing while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P05:generative-testing"
  source_name: "elmos-generative-testing"
  installed_name: "elmos-generative-testing"
  source_logical_path: "05-elmos-conversion-reliability-verification-harness/skills/generative-testing/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/05-elmos-conversion-reliability-verification-harness/skills/generative-testing/SKILL.md.source-data"
  source_materialized_path: "05-elmos-conversion-reliability-verification-harness/skills/generative-testing/SKILL.md.source-data"
  source_sha256: "sha256:4176eb88c1f7ac4d4328c882841cbec583c60aa045ae85a4b0ea81fb8ca58685"
...
- This is a deterministic repository wrapper for `05-elmos-conversion-reliability-verification-harness/skills/generative-testing/SKILL.md` at `sha256:4176eb88c1f7ac4d4328c882841cbec583c60aa045ae85a4b0ea81fb8ca58685`.
- Its immutable source/runtime identity is `elmos-generative-testing`; its active installed identity is `elmos-generative-testing`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-generative-testing --request <file>
```
