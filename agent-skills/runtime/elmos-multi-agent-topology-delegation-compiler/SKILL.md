---
name: elmos-multi-agent-topology-delegation-compiler
description: Compile supervisor, peer, hierarchy, market and graph topologies with explicit responsibilities, delegation authority,
  state ownership and termination contracts.
version: 4.0.0
...
# Multi-Agent Topology and Delegation Compiler
...
- **Kernel authorities used:** K1, K3, K4, K7
...
- `DeploymentUnit`
- `ConformanceRun`
- `MultiAgentTopologyAndDelegationCompilerRun`
- `MultiAgentTopologyAndDelegationCompilerDecision`

Required semantic capabilities:

- Agent roles and responsibility matrix
- Delegation depth and authority attenuation
- Shared/private state ownership
- Handoff and completion responsibility
- Topology-specific termination criteria
...
- `multi-agent-topology.json`
- `delegation-policy.rego`
- `state-ownership-map.json`
- `termination-contract.json`
...
- **authority expands through delegation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **agent impersonation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **orphaned responsibility** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **shared state race** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **infinite handoff** — must have a preventive control, a detective signal, a negative fixture and a response action.
