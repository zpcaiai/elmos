---
name: b2b-edi-orchestrator
description: "Implement Batch 46C B2B、EDI、Partner Network与Managed File Transfer end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Trading Partner、Agreement、EDI Message、Envelope、Mapping、Mailbox、File Transfer、Acknowledgement与Exception."
---

# B2B EDI Orchestrator

## Objective

Implement Batch 46C B2B、EDI、Partner Network与Managed File Transfer end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Trading Partner、Agreement、EDI Message、Envelope、Mapping、Mailbox、File Transfer、Acknowledgement与Exception.
...
5. Write unresolved domain assumptions to `docs/implementation/b2b-edi-orchestrator-baseline.md`.
...
```text
b2b_edi_orchestrator_manifest.json
b2b_edi_orchestrator_state.json
b2b_edi_orchestrator_decision.json
b2b_edi_orchestrator_reconciliation.json
b2b_edi_orchestrator_evidence.json
```
