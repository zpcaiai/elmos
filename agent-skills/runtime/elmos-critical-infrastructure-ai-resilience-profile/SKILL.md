---
name: elmos-critical-infrastructure-ai-resilience-profile
description: Implement and independently certify critical infrastructure ai resilience profile, including map essential function, dependencies, cascading failure and minimum service objectives, verify manual fallback, isolated operation, supply-chain resilience and recovery and exercise cyber-physical, provider, power, network and regional failure scenarios.
version: 4.0.0
...
# Critical Infrastructure AI Resilience Profile
...
- `CriticalInfrastructureAIResilienceProfileProfile`
- `CriticalInfrastructureAIResilienceProfileRun`
- `CriticalInfrastructureAIResilienceProfileFinding`
- `CriticalInfrastructureAIResilienceProfileDecision`
- `CriticalInfrastructureAIResilienceProfileEvidence`

Required semantic capabilities:

- map essential function, dependencies, cascading failure and minimum service objectives
- verify manual fallback, isolated operation, supply-chain resilience and recovery
- exercise cyber-physical, provider, power, network and regional failure scenarios
...
- `elmos-ai-controllability-override-fail-safe-certifier`

## Primary Outputs

- `artifacts/elmos-critical-infrastructure-ai-resilience-profile/profile.yaml`
- `artifacts/elmos-critical-infrastructure-ai-resilience-profile/plan.json`
- `artifacts/elmos-critical-infrastructure-ai-resilience-profile/result.json`
- `artifacts/elmos-critical-infrastructure-ai-resilience-profile/evidence/`
- `artifacts/elmos-critical-infrastructure-ai-resilience-profile/assurance-case.json`
...
- **single model provider becomes critical dependency** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **manual fallback is unpracticed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **AI failure cascades across sectors** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: map essential function, dependencies, cascading failure and minimum service objectives
- native scenario: verify manual fallback, isolated operation, supply-chain resilience and recovery
- native scenario: exercise cyber-physical, provider, power, network and regional failure scenarios
