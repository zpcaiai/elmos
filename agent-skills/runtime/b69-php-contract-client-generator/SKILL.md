...
# PG267 — Php Contract Client Generator

## Objective

Generate runnable and maintainable Php Contract Client Generator for PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `php-contract-client-generator` tasks involving PHP, Composer, Laravel, Symfony, modular monoliths, persistence, queues, WordPress/WooCommerce, testing, modernization, and deployment.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG258`, `PG266`.
...
- `php_contract_client_generator_plan.json`
- `php_contract_client_generator_artifacts/`
- `php_contract_client_generator_verification.json`
