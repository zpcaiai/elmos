...
description: "Run FRT-1309 Web Differential Corpus for FRT G13 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1309"
  source_name: "frt-1309-web-differential-corpus"
  source_sha256: "sha256:cf2e7b427b1759bb27da5a04d55064add8152035948cfc2ddff93a87430e2235"
  batch: "G13"
...
- Runtime catalog key: `FRT-1309` / `frt-1309-web-differential-corpus`.
...
# FRT-1309 — Web Differential Corpus

## Objective

在G13范围内实现 **Web Differential Corpus**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：六个方向独立声明版本、能力和Known Differences; 处理Options/Composition/Hooks、Router、Store、SFC/JSX差异; 建立直接路径与三角间接路径差分验证。

## When to Use

- 实现或修改与 **Web Differential Corpus** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1309Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1309EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1309FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1309CertificateFragment`：供G13批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g13/frt-1309-web-differential-corpus/
packages/runtime/g13/frt-1309-web-differential-corpus/
services/control-plane/g13/frt-1309-web-differential-corpus/
apps/web-console/src/features/g13/frt-1309-web-differential-corpus/
apps/admin-console/src/features/g13/frt-1309-web-differential-corpus/
tests/g13/frt-1309-web-differential-corpus/
```
...
```text
POST /v1/skills/frt-1309/runs
GET  /v1/skills/frt-1309/runs/{run_id}
POST /v1/skills/frt-1309/runs/{run_id}/verify
GET  /v1/skills/frt-1309/runs/{run_id}/findings
GET  /v1/skills/frt-1309/runs/{run_id}/evidence
```
