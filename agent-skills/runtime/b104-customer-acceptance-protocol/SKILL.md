---
name: b104-customer-acceptance-protocol
description: "Use when ELMOS must Run customer-observed functional, behavioral, security, performance and operational acceptance. Triggers: Customer Acceptance Protocol, Real World Product Certification Pack, acceptance tests, customer signoff, defect severity, limitations."
metadata:
  id: B104-S11
...
# B104-S11 — Customer Acceptance Protocol

## Objective

Run customer-observed functional, behavioral, security, performance and operational acceptance.
...
Use this Skill when the approved task explicitly requires **Customer Acceptance Protocol** or when the capability graph selects it as part of a minimal dependency closure.
...
- critical journeys customer-approved.
- open defects explicit.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b104-customer-acceptance-protocol/SKILL.md --out /tmp/customer_acceptance_protocol.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B104-S11
```
...
- Reject or expose demo signoff.
- Reject or expose limitations omitted.
- Reject or expose vendor self-signs.
