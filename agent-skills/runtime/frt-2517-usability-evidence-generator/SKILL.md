...
description: "Run FRT-2517 Usability Evidence Generator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2517"
  source_name: "frt-2517-usability-evidence-generator"
  source_sha256: "sha256:48c083b1d3d7bd124ebdb3b9882a654eef806c44c105d413016440ccd1a4dfbd"
  batch: "G25"
...
- Runtime catalog key: `FRT-2517` / `frt-2517-usability-evidence-generator`.
...
在G25范围内实现 **Usability Evidence Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Usability Evidence Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2517Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2517EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2517FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2517CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2517-usability-evidence-generator/
packages/runtime/g25/frt-2517-usability-evidence-generator/
services/control-plane/g25/frt-2517-usability-evidence-generator/
apps/web-console/src/features/g25/frt-2517-usability-evidence-generator/
apps/admin-console/src/features/g25/frt-2517-usability-evidence-generator/
tests/g25/frt-2517-usability-evidence-generator/
```
...
```text
POST /v1/skills/frt-2517/runs
GET  /v1/skills/frt-2517/runs/{run_id}
POST /v1/skills/frt-2517/runs/{run_id}/verify
GET  /v1/skills/frt-2517/runs/{run_id}/findings
GET  /v1/skills/frt-2517/runs/{run_id}/evidence
```
