...
description: "Run FRT-1310 Web Route Certification for FRT G13 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1310"
  source_name: "frt-1310-web-route-certification"
  source_sha256: "sha256:3094744d01742f25662de7d8362c2db147a1698933ace41e98009235153c9bf0"
  batch: "G13"
...
- Runtime catalog key: `FRT-1310` / `frt-1310-web-route-certification`.
...
# FRT-1310 — Web Route Certification

## Objective

在G13范围内实现 **Web Route Certification**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：六个方向独立声明版本、能力和Known Differences; 处理Options/Composition/Hooks、Router、Store、SFC/JSX差异; 建立直接路径与三角间接路径差分验证。

## When to Use

- 实现或修改与 **Web Route Certification** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1310Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1310EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1310FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1310CertificateFragment`：供G13批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g13/frt-1310-web-route-certification/
packages/runtime/g13/frt-1310-web-route-certification/
services/control-plane/g13/frt-1310-web-route-certification/
apps/web-console/src/features/g13/frt-1310-web-route-certification/
apps/admin-console/src/features/g13/frt-1310-web-route-certification/
tests/g13/frt-1310-web-route-certification/
```
...
```text
POST /v1/skills/frt-1310/runs
GET  /v1/skills/frt-1310/runs/{run_id}
POST /v1/skills/frt-1310/runs/{run_id}/verify
GET  /v1/skills/frt-1310/runs/{run_id}/findings
GET  /v1/skills/frt-1310/runs/{run_id}/evidence
```
