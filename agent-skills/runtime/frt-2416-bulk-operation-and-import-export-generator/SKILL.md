...
description: "Run FRT-2416 Bulk Operation and Import-Export Generator for FRT G24 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2416"
  source_name: "frt-2416-bulk-operation-and-import-export-generator"
  source_sha256: "sha256:e31637cb9b191bb5ae3f6c2ec244543be590618f40bdcf0bcb178148034fb805"
  batch: "G24"
...
- Runtime catalog key: `FRT-2416` / `frt-2416-bulk-operation-and-import-export-generator`.
...
在G24范围内实现 **Bulk Operation and Import-Export Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Admin Object × Action × Role × Scope × Environment矩阵; 高风险操作Impact Preview、Reason、Approval、Typed Command、Audit; Manual Case、Data Repair、Reconciliation正式后台流程。

## When to Use

- 实现或修改与 **Bulk Operation and Import-Export Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2416Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2416EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2416FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2416CertificateFragment`：供G24批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g24/frt-2416-bulk-operation-and-import-export-generator/
packages/runtime/g24/frt-2416-bulk-operation-and-import-export-generator/
services/control-plane/g24/frt-2416-bulk-operation-and-import-export-generator/
apps/web-console/src/features/g24/frt-2416-bulk-operation-and-import-export-generator/
apps/admin-console/src/features/g24/frt-2416-bulk-operation-and-import-export-generator/
tests/g24/frt-2416-bulk-operation-and-import-export-generator/
```
...
```text
POST /v1/skills/frt-2416/runs
GET  /v1/skills/frt-2416/runs/{run_id}
POST /v1/skills/frt-2416/runs/{run_id}/verify
GET  /v1/skills/frt-2416/runs/{run_id}/findings
GET  /v1/skills/frt-2416/runs/{run_id}/evidence
```
