---
name: shadow-canary-ab-and-rollback
description: Use this skill when Elmos must perform shadow canary ab and rollback as part of the 10-serving-routing-inference production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# shadow-canary-ab-and-rollback

## 能力目标

执行影子、流量拆分、自动门控和发布组合整体回滚。
