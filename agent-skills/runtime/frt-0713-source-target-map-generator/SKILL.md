...
description: "Run FRT-0713 Source Target Map Generator for FRT G07 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0713"
  source_name: "frt-0713-source-target-map-generator"
  source_sha256: "sha256:eab9ef5007a2e4833bf70020891e64bb148135866d50b380ec181060fdfcee8b"
  batch: "G07"
...
- Runtime catalog key: `FRT-0713` / `frt-0713-source-target-map-generator`.
...
# FRT-0713 — Source Target Map Generator

## Objective

在G07范围内实现 **Source Target Map Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Typed IR经规则Pass降低到目标原生AST; Gap生成Typed Hole而非空实现; Format/Analyze/Build驱动有界确定性修复。

## When to Use

- 实现或修改与 **Source Target Map Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0713Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0713EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0713FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0713CertificateFragment`：供G07批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g07/frt-0713-source-target-map-generator/
packages/runtime/g07/frt-0713-source-target-map-generator/
services/control-plane/g07/frt-0713-source-target-map-generator/
apps/web-console/src/features/g07/frt-0713-source-target-map-generator/
apps/admin-console/src/features/g07/frt-0713-source-target-map-generator/
tests/g07/frt-0713-source-target-map-generator/
```
...
```text
POST /v1/skills/frt-0713/runs
GET  /v1/skills/frt-0713/runs/{run_id}
POST /v1/skills/frt-0713/runs/{run_id}/verify
GET  /v1/skills/frt-0713/runs/{run_id}/findings
GET  /v1/skills/frt-0713/runs/{run_id}/evidence
```
