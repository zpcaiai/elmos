---
name: rootless-oci-container-userns-idmapped-mount-provider
description: "Implement a rootless OCI provider with user namespaces, UID/GID ranges, idmapped mounts, read-only rootfs, capabilities, seccomp, cgroups, and evidence."
---
...
Implement a rootless OCI provider with user namespaces, UID/GID ranges, idmapped mounts, read-only rootfs, capabilities, seccomp, cgroups, and evidence.
...
4. Record unresolved provider/version assumptions in `docs/implementation/rootless-oci-container-userns-idmapped-mount-provider-baseline.md`.
...
```text
rootless_oci_container_userns_idmapped_mount_provider_manifest.json
rootless_oci_container_userns_idmapped_mount_provider_decision.json
rootless_oci_container_userns_idmapped_mount_provider_evidence.json
```
