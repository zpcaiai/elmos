...
description: "Run FRT-0306 Data Network and Storage IR for FRT G03 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0306"
  source_name: "frt-0306-data-network-and-storage-ir"
  source_sha256: "sha256:7168828a196cee2598c100c8f5bb9dbeef2a1f1669085bd877f32af588f04cab"
  batch: "G03"
...
- Runtime catalog key: `FRT-0306` / `frt-0306-data-network-and-storage-ir`.
...
# FRT-0306 — Data Network and Storage IR

## Objective

在G03范围内实现 **Data Network and Storage IR**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨Vue/React/小程序/ArkUI/Flutter的类型和语义中间层; 保留Null、Identity、Effect、Lifecycle、Navigation、Data Authority和UI语义; 每个IR节点绑定Source Range和稳定Semantic ID。

## When to Use

- 实现或修改与 **Data Network and Storage IR** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0306Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0306EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0306FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0306CertificateFragment`：供G03批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g03/frt-0306-data-network-and-storage-ir/
packages/runtime/g03/frt-0306-data-network-and-storage-ir/
services/control-plane/g03/frt-0306-data-network-and-storage-ir/
apps/web-console/src/features/g03/frt-0306-data-network-and-storage-ir/
apps/admin-console/src/features/g03/frt-0306-data-network-and-storage-ir/
tests/g03/frt-0306-data-network-and-storage-ir/
```
...
```text
POST /v1/skills/frt-0306/runs
GET  /v1/skills/frt-0306/runs/{run_id}
POST /v1/skills/frt-0306/runs/{run_id}/verify
GET  /v1/skills/frt-0306/runs/{run_id}/findings
GET  /v1/skills/frt-0306/runs/{run_id}/evidence
```
