...
description: "Run FRT-1111 Visual Regression Generator for FRT G11 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1111"
  source_name: "frt-1111-visual-regression-generator"
  source_sha256: "sha256:cbc51bfd161cfb440007c79735b04ac6aebfc567c94fcd6b8e2fcd35d4e3aa97"
  batch: "G11"
...
- Runtime catalog key: `FRT-1111` / `frt-1111-visual-regression-generator`.
...
# FRT-1111 — Visual Regression Generator

## Objective

在G11范围内实现 **Visual Regression Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：恢复布局约束、Design Token和响应式Size Class; 生成资产、字体、Icon、Theme和动画映射; 保持Locale、Plural、Date/Number和RTL语义。

## When to Use

- 实现或修改与 **Visual Regression Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1111Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1111EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1111FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1111CertificateFragment`：供G11批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g11/frt-1111-visual-regression-generator/
packages/runtime/g11/frt-1111-visual-regression-generator/
services/control-plane/g11/frt-1111-visual-regression-generator/
apps/web-console/src/features/g11/frt-1111-visual-regression-generator/
apps/admin-console/src/features/g11/frt-1111-visual-regression-generator/
tests/g11/frt-1111-visual-regression-generator/
```
...
```text
POST /v1/skills/frt-1111/runs
GET  /v1/skills/frt-1111/runs/{run_id}
POST /v1/skills/frt-1111/runs/{run_id}/verify
GET  /v1/skills/frt-1111/runs/{run_id}/findings
GET  /v1/skills/frt-1111/runs/{run_id}/evidence
```
