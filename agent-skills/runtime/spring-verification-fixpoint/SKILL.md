---
name: spring-verification-fixpoint
description: 在验证失败与 Recipe/Agent Repair 之间循环，直到 mandatory fail/unknown 为零或明确 blocked。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-063
  source_name: spring-verification-fixpoint
  source_path: skills/spring-verification-fixpoint/SKILL.md
  source_sha256: sha256:08a2d245d0c133a805ec319fbde70141c3fc02281144b55e713c6ea6806789b2
  source_contract_sha256: sha256:175476176eec0d86fe86c271f48ab565c4413ae1fe353af2561e17bfc8fad4f7
...
在验证失败与 Recipe/Agent Repair 之间循环，直到 mandatory fail/unknown 为零或明确 blocked。
...
- Affected-first+periodic full suite
...
- [ ] 定义 `spring-verification-fixpoint` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-verification-fixpoint` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：fixpoint-state.json, repair-cycles.json, remaining-issues.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：fixpoint-state.json, repair-cycles.json, remaining-issues.json。
...
- Machine contract: `references/contract.json` (`sha256:175476176eec0d86fe86c271f48ab565c4413ae1fe353af2561e17bfc8fad4f7`).
