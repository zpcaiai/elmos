...
description: Use this skill when Elmos must perform sql json spatial fulltext special types as part of the 15-domain-engineering-packs
...
- 业务线：`sql-database-conversion`；包：`15-domain-engineering-packs`。
