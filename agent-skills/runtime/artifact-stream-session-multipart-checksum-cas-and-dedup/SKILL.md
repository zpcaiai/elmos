---
name: artifact-stream-session-multipart-checksum-cas-and-dedup
description: "Implement resumable artifact upload/download sessions, multipart checksums, final digests, staging, CAS, tenant-safe deduplication, encryption, commit reconciliation, and cleanup."
---
...
Implement resumable artifact upload/download sessions, multipart checksums, final digests, staging, CAS, tenant-safe deduplication, encryption, commit reconciliation, and cleanup.
...
4. Record unresolved provider/version assumptions in `docs/implementation/artifact-stream-session-multipart-checksum-cas-and-dedup-baseline.md`.
...
```text
artifact_stream_session_multipart_checksum_cas_and_dedup_manifest.json
artifact_stream_session_multipart_checksum_cas_and_dedup_decision.json
artifact_stream_session_multipart_checksum_cas_and_dedup_evidence.json
```
