---
name: iso42001-ai-management-profile
description: Use this skill when Elmos must perform iso42001 ai management profile as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# iso42001-ai-management-profile

## 能力目标

建立 AI 管理体系所需的职责、风险、数据、监控和持续改进证据。
