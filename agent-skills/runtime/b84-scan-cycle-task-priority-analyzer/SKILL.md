---
name: b84-scan-cycle-task-priority-analyzer
description: "Use when ELMOS must run scan cycle task priority analyzer for Batch 84 IEC 61131-3 PLC Languages Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG263"
  source_name: "scan-cycle-task-priority-analyzer"
  source_sha256: "sha256:b6401fc65a0931569f434adcd30b4728f540ba7ebc6630fe37ee2b0cc70522bd"
  batch: 84
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 84 Language Pack / source PG263 — Scan Cycle Task Priority Analyzer

## 1. Objective

Analyze scan cycle task priority analyzer within the IEC 61131-3 PLC Languages Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Scan Cycle Task Priority Analyzer using the approved industrial-control semantic contracts and toolchain versions.
...
- A representative valid iec61131-plc input produces all declared outputs for scan-cycle-task-priority-analyzer.
