---
name: elmos-ieee754-floating-point-semantics
description: "Preserve NaN, infinities, signed zero, rounding, fused operations, extended precision and tolerance policies."
version: 1.0.0
skill_id: ELMOS-POLY-225
layer: numeric-semantics
risk: critical
readiness: not-run
dependencies:
  - "elmos-numeric-type-range-overflow"
triggers:
  - "Use when implementing or executing `elmos-ieee754-floating-point-semantics`."
  - "Use when a migration/certification DAG requires `numeric-semantics` capability."
outputs:
  - "semantic-assurance/elmos-ieee754-floating-point-semantics/model.json"
  - "semantic-assurance/elmos-ieee754-floating-point-semantics/evidence.json"
  - "semantic-assurance/elmos-ieee754-floating-point-semantics/diagnostics.json"
---
...
Preserve NaN, infinities, signed zero, rounding, fused operations, extended precision and tolerance policies.
...
- **NaN payload/comparison.**
- **signed zero.**
- **rounding mode.**
- **FMA/extended precision.**
...
- [ ] NaN/signed-zero fixture.
- [ ] catastrophic cancellation fixture.
- [ ] FMA difference classified.
