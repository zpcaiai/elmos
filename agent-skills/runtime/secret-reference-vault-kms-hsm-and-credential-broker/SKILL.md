---
name: secret-reference-vault-kms-hsm-and-credential-broker
description: "Implement secret references, Vault/KMS/HSM provider contracts, credential brokering, encryption domains, policy checks, audit, and provider failover."
---
...
Implement secret references, Vault/KMS/HSM provider contracts, credential brokering, encryption domains, policy checks, audit, and provider failover.
...
4. Record unresolved provider/version assumptions in `docs/implementation/secret-reference-vault-kms-hsm-and-credential-broker-baseline.md`.
...
```text
secret_reference_vault_kms_hsm_and_credential_broker_manifest.json
secret_reference_vault_kms_hsm_and_credential_broker_decision.json
secret_reference_vault_kms_hsm_and_credential_broker_evidence.json
```
