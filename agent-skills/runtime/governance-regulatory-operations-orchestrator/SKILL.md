---
name: governance-regulatory-operations-orchestrator
description: "Implement Batch 38C end to end: obligations, applicability, cross-border matrices, calendars, RACI, filings, notifications, training, board governance, examinations, cases, records, adapters, cockpits, and gates."
---
...
Implement Batch 38C end to end: obligations, applicability, cross-border matrices, calendars, RACI, filings, notifications, training, board governance, examinations, cases, records, adapters, cockpits, and gates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/governance-regulatory-operations-orchestrator-baseline.md`.
...
```text
governance_regulatory_operations_orchestrator_manifest.json
governance_regulatory_operations_orchestrator_decision.json
governance_regulatory_operations_orchestrator_evidence.json
```
