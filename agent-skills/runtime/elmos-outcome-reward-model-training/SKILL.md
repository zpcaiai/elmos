---
name: outcome-reward-model-training
description: Use this skill when Elmos must perform outcome reward model training as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# outcome-reward-model-training

## 能力目标

训练基于最终结果和证据的奖励模型，并校准跨任务泛化。
