---
name: elmos-rag-corpus-connector-cdc-governor
description: Generate reliable corpus connectors with snapshots, change data capture, resumable sync, deduplication, ordering,
  tombstones and reindex governance.
version: 4.0.0
...
# RAG Corpus Connector and CDC Governor
...
- `DeploymentUnit`
- `ConformanceRun`
- `RAGCorpusConnectorAndCDCGovernorRun`
- `RAGCorpusConnectorAndCDCGovernorDecision`

Required semantic capabilities:

- Snapshot plus CDC handoff
- Idempotent event ordering and deduplication
- Connector checkpoint/replay
- Tombstone and reindex lifecycle
...
- **missed update window** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **duplicate indexing** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **source deletion ignored** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **connector credential leak** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-source identity collision** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- initial snapshot
- concurrent CDC handoff
- duplicate/out-of-order event
- crash resume
- delete propagation
- full reindex reconciliation
