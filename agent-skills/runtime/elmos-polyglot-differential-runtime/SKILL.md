---
name: elmos-polyglot-differential-runtime
description: Execute source and target systems under the same scenarios and compare normalized API, state, trace, tool, data, timing and side-effect semantics.
version: 4.0.0
...
- Launch source and target in isolated equivalent environments
- Normalize nondeterminism without erasing semantics
- Compare outputs, state, calls and side effects
- Apply typed tolerances and partial-order trace comparison
- Minimize and attribute mismatches
...
- `polyglot-differential-results.json`
- `mismatch-clusters.json`
- `normalized-runtime-traces/`
...
- **normalizer masks real mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **source and target share faulty oracle** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **side effect executed twice** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **environment asymmetry** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **timing tolerance hides liveness failure** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- API result equivalence
- exception/error equivalence
- tool-call partial order
- database state equivalence
