---
name: grid-dispatch-orchestrator
description: "Implement Batch 53B Grid、DER、VPP、Microgrid与Market Dispatch end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Grid Node、DER、Battery、Forecast、Bid、Schedule、Dispatch、Constraint、Settlement与Control Signal."
---

# Grid Dispatch Orchestrator

## Objective

Implement Batch 53B Grid、DER、VPP、Microgrid与Market Dispatch end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Grid Node、DER、Battery、Forecast、Bid、Schedule、Dispatch、Constraint、Settlement与Control Signal.
...
5. Write unresolved domain assumptions to `docs/implementation/grid-dispatch-orchestrator-baseline.md`.
...
```text
grid_dispatch_orchestrator_manifest.json
grid_dispatch_orchestrator_state.json
grid_dispatch_orchestrator_decision.json
grid_dispatch_orchestrator_reconciliation.json
grid_dispatch_orchestrator_evidence.json
```
