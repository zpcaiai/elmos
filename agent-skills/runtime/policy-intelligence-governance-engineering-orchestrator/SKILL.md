---
name: policy-intelligence-governance-engineering-orchestrator
description: "Implement Batch 38B end to end: policy sources, Policy IR, ontology/graph, NLP extraction, compilers, conflict analysis, mining, explanations, Copilot, regulatory impact, review, operations, evaluation, and gates."
---
...
Implement Batch 38B end to end: policy sources, Policy IR, ontology/graph, NLP extraction, compilers, conflict analysis, mining, explanations, Copilot, regulatory impact, review, operations, evaluation, and gates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/policy-intelligence-governance-engineering-orchestrator-baseline.md`.
...
```text
policy_intelligence_governance_engineering_orchestrator_manifest.json
policy_intelligence_governance_engineering_orchestrator_decision.json
policy_intelligence_governance_engineering_orchestrator_evidence.json
```
