...
description: "Run FRT-1708 Mobile Navigation and Lifecycle Mapper for FRT G17 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1708"
  source_name: "frt-1708-mobile-navigation-and-lifecycle-mapper"
  source_sha256: "sha256:e167b7370bab0dbcbd61b57cc179c2c198aec5b1547b3b7235f9fcb5d4be8524"
  batch: "G17"
...
- Runtime catalog key: `FRT-1708` / `frt-1708-mobile-navigation-and-lifecycle-mapper`.
...
# FRT-1708 — Mobile Navigation and Lifecycle Mapper

## Objective

在G17范围内实现 **Mobile Navigation and Lifecycle Mapper**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：补齐小程序/ArkUI/Flutter六个方向; 统一移动Navigation、Lifecycle、Permission、Storage和Native能力; 验证直接与间接三角路径。

## When to Use

- 实现或修改与 **Mobile Navigation and Lifecycle Mapper** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1708Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1708EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1708FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1708CertificateFragment`：供G17批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g17/frt-1708-mobile-navigation-and-lifecycle-mapper/
packages/runtime/g17/frt-1708-mobile-navigation-and-lifecycle-mapper/
services/control-plane/g17/frt-1708-mobile-navigation-and-lifecycle-mapper/
apps/web-console/src/features/g17/frt-1708-mobile-navigation-and-lifecycle-mapper/
apps/admin-console/src/features/g17/frt-1708-mobile-navigation-and-lifecycle-mapper/
tests/g17/frt-1708-mobile-navigation-and-lifecycle-mapper/
```
...
```text
POST /v1/skills/frt-1708/runs
GET  /v1/skills/frt-1708/runs/{run_id}
POST /v1/skills/frt-1708/runs/{run_id}/verify
GET  /v1/skills/frt-1708/runs/{run_id}/findings
GET  /v1/skills/frt-1708/runs/{run_id}/evidence
```
