---
name: gr-audit-retention
description: 管理源码、模型上下文、日志、Evidence、账单与 Proof 的访问、保留、删除和 Legal Hold。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-072
  source_name: gr-audit-retention
  source_path: skills/gr-audit-retention/SKILL.md
  source_sha256: sha256:7b6c78cda640923459648685a76a305d2c211dcc19b8063ea316bf4ebffe75e5
  source_contract_sha256: sha256:c334428c7f39622e450ddef756f6e2b7558deb8e7b90158298453d125c362494
...
管理源码、模型上下文、日志、Evidence、账单与 Proof 的访问、保留、删除和 Legal Hold。

## Scope and capabilities

- Data classification
- RBAC/audit
- Lifecycle/deletion proof
- Redacted views
- Model data policy
...
- [ ] 定义 `gr-audit-retention` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-audit-retention` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：retention-policy.yaml, audit-report.json, deletion-certificate.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：retention-policy.yaml, audit-report.json, deletion-certificate.json。
...
- Machine contract: `references/contract.json` (`sha256:c334428c7f39622e450ddef756f6e2b7558deb8e7b90158298453d125c362494`).
