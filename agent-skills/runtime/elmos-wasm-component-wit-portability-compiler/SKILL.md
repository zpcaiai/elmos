---
name: elmos-wasm-component-wit-portability-compiler
description: Compile polyglot components, worlds, interfaces, resources, ownership and canonical ABI contracts into portable WebAssembly Component Model artifacts with native round-trip evidence.
version: 4.0.0
...
# WebAssembly Component and WIT Portability Compiler
...
- **Kernel authorities used:** K2, K3, K5, K6, K7, K8
...
- `WebAssemblyComponentAndWITPortabilityCompilerProfile`
- `WebAssemblyComponentAndWITPortabilityCompilerPlan`
- `WebAssemblyComponentAndWITPortabilityCompilerRun`
- `WebAssemblyComponentAndWITPortabilityCompilerDecision`

Required semantic capabilities:

- compile WIT worlds, interfaces and resource ownership
- lower language types through canonical ABI mappings
- generate component composition and version contracts
- verify cross-language component round trips
- certify host/guest rollback and unsupported-feature blocking
...
- `elmos-ffi-abi-native-boundary-certifier` from `elmos-functional-assurance-certification-skills` — optional companion; required only for E4/E5/P05 certification.

## Primary Outputs

- `artifacts/elmos-wasm-component-wit-portability-compiler/profile.yaml`
- `artifacts/elmos-wasm-component-wit-portability-compiler/plan.json`
- `artifacts/elmos-wasm-component-wit-portability-compiler/result.json`
- `artifacts/elmos-wasm-component-wit-portability-compiler/evidence/`
...
- **canonical ABI mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **resource handle lifetime leak** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **component version drift** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **host capability overgrant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unsupported interface silently shimmed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile WIT worlds, interfaces and resource ownership
- native scenario: lower language types through canonical ABI mappings
- native scenario: generate component composition and version contracts
- native scenario: verify cross-language component round trips
- native scenario: certify host/guest rollback and unsupported-feature blocking
