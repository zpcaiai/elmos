---
name: fault-injection-chaos-execution
description: "Repository-owned bounded wrapper for fault-injection-chaos-execution; external evidence remains NOT_RUN."
---
...
Inject latency, process death, network faults, DB failover, duplicate messages and partial outages to validate migration resilience.
...
4. Submit `fault-injection-chaos-execution` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `1731930a75da6cbbb005788af44e6afbfe835b91be0082420c59496c26f3467d`
