---
name: gr-customer-data-ip
description: 定义源码、Patch、模型上下文、Recipe 学习、遥测、保留和知识产权边界。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-086
  source_name: gr-customer-data-ip
  source_path: skills/gr-customer-data-ip/SKILL.md
  source_sha256: sha256:a78177e2b971658bda25bf3cc208ea945b3d261480d45d116dcd653ca20416d7
  source_contract_sha256: sha256:e59d2e766f79103b23ecb64bee92d962196cac3fd828313e153d58d59026b5be
...
# Customer Data & IP Policy

## Objective

定义源码、Patch、模型上下文、Recipe 学习、遥测、保留和知识产权边界。

## Scope and capabilities

- BYOK/ZDR/private deployment
- Residency
- Cross-customer learning consent
...
- [ ] 定义 `gr-customer-data-ip` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-customer-data-ip` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：data-policy.json, model-routing-policy.json, ip-decision.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：data-policy.json, model-routing-policy.json, ip-decision.json。
...
- Machine contract: `references/contract.json` (`sha256:e59d2e766f79103b23ecb64bee92d962196cac3fd828313e153d58d59026b5be`).
