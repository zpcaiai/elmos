...
triggers:
  - "Use when implementing or executing `elmos-collection-order-mutability-semantics`."
  - "Use when a migration/certification DAG requires `type-semantics` capability."
outputs:
  - "semantic-assurance/elmos-collection-order-mutability-semantics/model.json"
  - "semantic-assurance/elmos-collection-order-mutability-semantics/evidence.json"
  - "semantic-assurance/elmos-collection-order-mutability-semantics/diagnostics.json"
---

# Collection Ordering & Mutability Semantics

## Objective

Preserve sequence/set/map ordering, equality, hashing, mutability, aliasing and iteration guarantees.
...
- **iteration order.**
- **hash/equality contracts.**
- **persistent vs mutable collections.**
