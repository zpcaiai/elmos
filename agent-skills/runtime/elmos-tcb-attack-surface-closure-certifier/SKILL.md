---
name: elmos-tcb-attack-surface-closure-certifier
description: Implement and independently certify trusted computing base attack-surface closure certifier, including enumerate compilers, runtimes, kernels, firmware, libraries, models, checkers and human decisions in TCB, map attack surface, privilege and evidence dependence and require compensating verification or scope limitation for unverifiable TCB components.
version: 4.0.0
...
# Trusted Computing Base Attack-Surface Closure Certifier

## Objective

Implement and independently certify trusted computing base attack-surface closure certifier, including enumerate compilers, runtimes, kernels, firmware, libraries, models, checkers and human decisions in TCB, map attack surface, privilege and evidence dependence and require compensating verification or scope limitation for unverifiable TCB components.
...
- `TrustedComputingBaseAttackSurfaceClosureCertifierProfile`
- `TrustedComputingBaseAttackSurfaceClosureCertifierRun`
- `TrustedComputingBaseAttackSurfaceClosureCertifierFinding`
- `TrustedComputingBaseAttackSurfaceClosureCertifierDecision`
- `TrustedComputingBaseAttackSurfaceClosureCertifierEvidence`

Required semantic capabilities:

- enumerate compilers, runtimes, kernels, firmware, libraries, models, checkers and human decisions in TCB
- map attack surface, privilege and evidence dependence
- require compensating verification or scope limitation for unverifiable TCB components
...
- `elmos-proof-assumption-defeater-ledger`

## Primary Outputs

- `artifacts/elmos-tcb-attack-surface-closure-certifier/profile.yaml`
- `artifacts/elmos-tcb-attack-surface-closure-certifier/plan.json`
- `artifacts/elmos-tcb-attack-surface-closure-certifier/result.json`
- `artifacts/elmos-tcb-attack-surface-closure-certifier/evidence/`
- `artifacts/elmos-tcb-attack-surface-closure-certifier/assurance-case.json`
...
- **model provider is excluded from TCB despite authoritative output** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **firmware measurement is absent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **human label adjudication has no competence control** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: enumerate compilers, runtimes, kernels, firmware, libraries, models, checkers and human decisions in TCB
- native scenario: map attack surface, privilege and evidence dependence
- native scenario: require compensating verification or scope limitation for unverifiable TCB components
