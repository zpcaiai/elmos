---
name: elmos-eval-observability-platform-integrator
description: Integrate MLflow, Phoenix, LangSmith and OpenInference-compatible systems while retaining Elmos evidence, tenant,
  privacy and completion authority.
version: 4.0.0
...
# Evaluation and Observability Platform Integrator
...
- `DeploymentUnit`
- `ConformanceRun`
- `EvaluationAndObservabilityPlatformIntegratorRun`
- `EvaluationAndObservabilityPlatformIntegratorDecision`

Required semantic capabilities:

- Bidirectional trace/dataset mapping
- Platform capability negotiation
- Tenant and privacy filtering
- Experiment/evaluation synchronization
- Export and vendor-exit validation
...
- `trace-field-mapping.json`
- `evaluation-sync-report.json`
- `platform-exit-plan.yaml`
...
- **external platform becomes truth source** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **trace data leakage** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **schema truncation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **vendor lock-in** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evaluation result tampering** — must have a preventive control, a detective signal, a negative fixture and a response action.
