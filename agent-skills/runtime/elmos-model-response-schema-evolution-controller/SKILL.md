---
name: elmos-model-response-schema-evolution-controller
description: Manage backward/forward compatibility of model response and tool argument schemas across model, provider and
  framework upgrades.
version: 4.0.0
...
# Model Response Schema Evolution Controller
...
- `DeploymentUnit`
- `ConformanceRun`
- `ModelResponseSchemaEvolutionControllerRun`
- `ModelResponseSchemaEvolutionControllerDecision`

Required semantic capabilities:

- Schema version graph
- Producer/consumer compatibility analysis
- Transitional adapters and dual parsing
- Canary and rollback plan
- Old-schema retirement evidence
...
- `schema-version-graph.json`
- `compatibility-report.json`
- `migration-adapters/`
- `schema-cutover-plan.yaml`
...
- **silent breaking response** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **parser differential** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **schema downgrade attack** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **adapter ambiguity** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **premature old-schema removal** — must have a preventive control, a detective signal, a negative fixture and a response action.
