...
description: "Run FRT-1509 ArkUI Native Capability Mapper for FRT G15 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1509"
  source_name: "frt-1509-arkui-native-capability-mapper"
  source_sha256: "sha256:dee8674e5df510878c3c25a6ea51b00e5fc96f50ef7fd5eb4de25884ba589168"
  batch: "G15"
...
- Runtime catalog key: `FRT-1509` / `frt-1509-arkui-native-capability-mapper`.
...
# FRT-1509 — ArkUI Native Capability Mapper

## Objective

在G15范围内实现 **ArkUI Native Capability Mapper**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射ArkUI状态装饰器、Builder、Navigation和生命周期; 处理Web DOM能力与ArkUI Native/Device差异; 生成真机/模拟器和Accessibility验证。

## When to Use

- 实现或修改与 **ArkUI Native Capability Mapper** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1509Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1509EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1509FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1509CertificateFragment`：供G15批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g15/frt-1509-arkui-native-capability-mapper/
packages/runtime/g15/frt-1509-arkui-native-capability-mapper/
services/control-plane/g15/frt-1509-arkui-native-capability-mapper/
apps/web-console/src/features/g15/frt-1509-arkui-native-capability-mapper/
apps/admin-console/src/features/g15/frt-1509-arkui-native-capability-mapper/
tests/g15/frt-1509-arkui-native-capability-mapper/
```
...
```text
POST /v1/skills/frt-1509/runs
GET  /v1/skills/frt-1509/runs/{run_id}
POST /v1/skills/frt-1509/runs/{run_id}/verify
GET  /v1/skills/frt-1509/runs/{run_id}/findings
GET  /v1/skills/frt-1509/runs/{run_id}/evidence
```
