---
name: b67-go-module-workspace-reproducer
description: "Use when ELMOS must reproduce deterministically Go Module Workspace Reproducer for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Go Module Workspace Reproducer, Batch 67, Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation."
metadata:
  id: PG236
  batch: 67
  version: 1.0.0
...
# PG236 — Go Module Workspace Reproducer

## Objective

Reproduce deterministically Go Module Workspace Reproducer for Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `go-module-workspace-reproducer` tasks involving Go modules, HTTP/gRPC services, CLI tools, workers, concurrency, operators, MCP servers, tests, and cross-compilation.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG234`, `PG235`.
...
- `go_module_workspace_reproducer_plan.json`
- `go_module_workspace_reproducer_artifacts/`
- `go_module_workspace_reproducer_verification.json`
