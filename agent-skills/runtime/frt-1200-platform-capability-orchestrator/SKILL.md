...
description: "Run FRT-1200 Platform Capability Orchestrator for FRT G12 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1200"
  source_name: "frt-1200-platform-capability-orchestrator"
  source_sha256: "sha256:cd8801b3ff5f4ec56a26c97012b62d7886ff86d72028ff81555fff765e90bd03"
  batch: "G12"
...
- Runtime catalog key: `FRT-1200` / `frt-1200-platform-capability-orchestrator`.
...
# FRT-1200 — Platform Capability Orchestrator

## Objective

在G12范围内实现 **Platform Capability Orchestrator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨平台Capability Registry与支持等级; Native Bridge具备Schema、Permission、Timeout和Error Contract; 支付、设备和危险能力使用Server Authority与安全状态机。

## When to Use

- 实现或修改与 **Platform Capability Orchestrator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1200Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1200EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1200FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1200CertificateFragment`：供G12批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g12/frt-1200-platform-capability-orchestrator/
packages/runtime/g12/frt-1200-platform-capability-orchestrator/
services/control-plane/g12/frt-1200-platform-capability-orchestrator/
apps/web-console/src/features/g12/frt-1200-platform-capability-orchestrator/
apps/admin-console/src/features/g12/frt-1200-platform-capability-orchestrator/
tests/g12/frt-1200-platform-capability-orchestrator/
```
...
```text
POST /v1/skills/frt-1200/runs
GET  /v1/skills/frt-1200/runs/{run_id}
POST /v1/skills/frt-1200/runs/{run_id}/verify
GET  /v1/skills/frt-1200/runs/{run_id}/findings
GET  /v1/skills/frt-1200/runs/{run_id}/evidence
```
