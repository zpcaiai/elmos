---
name: elmos-cross-language-memory-model
description: "Represent happens-before, visibility, atomicity and data-race legality for Java/.NET/C++/Rust/Swift and other concurrency models."
version: 1.0.0
skill_id: ELMOS-POLY-215
...
triggers:
  - "Use when implementing or executing `elmos-cross-language-memory-model`."
  - "Use when a migration/certification DAG requires `runtime-semantics` capability."
outputs:
  - "semantic-assurance/elmos-cross-language-memory-model/model.json"
  - "semantic-assurance/elmos-cross-language-memory-model/evidence.json"
  - "semantic-assurance/elmos-cross-language-memory-model/diagnostics.json"
---

# Cross-Language Memory Model

## Objective

Represent happens-before, visibility, atomicity and data-race legality for Java/.NET/C++/Rust/Swift and other concurrency models.
...
- [ ] message-passing litmus fixture.
- [ ] double-checked locking fixture.
- [ ] data-race target rejection.
