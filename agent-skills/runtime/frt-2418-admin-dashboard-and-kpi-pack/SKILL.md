...
description: "Run FRT-2418 Admin Dashboard and KPI Pack for FRT G24 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2418"
  source_name: "frt-2418-admin-dashboard-and-kpi-pack"
  source_sha256: "sha256:b6381a5567c9b351a762c61c26afc87c3f35b11a3d0d1dcbcc9f9fc6b76f9431"
  batch: "G24"
...
- Runtime catalog key: `FRT-2418` / `frt-2418-admin-dashboard-and-kpi-pack`.
...
在G24范围内实现 **Admin Dashboard and KPI Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Admin Object × Action × Role × Scope × Environment矩阵; 高风险操作Impact Preview、Reason、Approval、Typed Command、Audit; Manual Case、Data Repair、Reconciliation正式后台流程。

## When to Use

- 实现或修改与 **Admin Dashboard and KPI Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2418Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2418EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2418FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2418CertificateFragment`：供G24批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g24/frt-2418-admin-dashboard-and-kpi-pack/
packages/runtime/g24/frt-2418-admin-dashboard-and-kpi-pack/
services/control-plane/g24/frt-2418-admin-dashboard-and-kpi-pack/
apps/web-console/src/features/g24/frt-2418-admin-dashboard-and-kpi-pack/
apps/admin-console/src/features/g24/frt-2418-admin-dashboard-and-kpi-pack/
tests/g24/frt-2418-admin-dashboard-and-kpi-pack/
```
...
```text
POST /v1/skills/frt-2418/runs
GET  /v1/skills/frt-2418/runs/{run_id}
POST /v1/skills/frt-2418/runs/{run_id}/verify
GET  /v1/skills/frt-2418/runs/{run_id}/findings
GET  /v1/skills/frt-2418/runs/{run_id}/evidence
```
