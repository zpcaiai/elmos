---
name: elmos-build-buy-partner
description: 确定自研、集成、购买商业授权和客户侧执行的能力边界。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-003
  source_name: elmos-build-buy-partner
  source_path: skills/elmos-build-buy-partner/SKILL.md
  source_sha256: sha256:540636c295ca69db9e95740a8936718c4bb49ffde1d808f7d6469e4c29295576
  source_contract_sha256: sha256:26128215d5a020dc1b10a3f948ef0f35418d3a9d2642378607a7fc777ec81f15
...
确定自研、集成、购买商业授权和客户侧执行的能力边界。

## Scope and capabilities

- 关键护城河不外包
- 上游能力通过 SPI/Adapter 接入
- 计算 TCO、退出成本和许可风险
- 每项外部能力有 fallback
...
- [ ] 定义 `elmos-build-buy-partner` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `elmos-build-buy-partner` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：build-buy-partner.json, adapter-boundaries.md, vendor-exit-plan.md。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：build-buy-partner.json, adapter-boundaries.md, vendor-exit-plan.md。
- [ ] 所有 mandatory tests 和 security gates 通过，且无 critical unknown。

## Dependencies

- `elmos-competitive-positioning`
...
- Machine contract: `references/contract.json` (`sha256:26128215d5a020dc1b10a3f948ef0f35418d3a9d2642378607a7fc777ec81f15`).
