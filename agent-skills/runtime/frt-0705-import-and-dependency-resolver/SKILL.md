...
description: "Run FRT-0705 Import and Dependency Resolver for FRT G07 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0705"
  source_name: "frt-0705-import-and-dependency-resolver"
  source_sha256: "sha256:04e803af671f8ac1b09ba09d11a823648a26e2e31b7edc268f85154f33af73e4"
  batch: "G07"
...
- Runtime catalog key: `FRT-0705` / `frt-0705-import-and-dependency-resolver`.
...
# FRT-0705 — Import and Dependency Resolver

## Objective

在G07范围内实现 **Import and Dependency Resolver**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Typed IR经规则Pass降低到目标原生AST; Gap生成Typed Hole而非空实现; Format/Analyze/Build驱动有界确定性修复。

## When to Use

- 实现或修改与 **Import and Dependency Resolver** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0705Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0705EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0705FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0705CertificateFragment`：供G07批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g07/frt-0705-import-and-dependency-resolver/
packages/runtime/g07/frt-0705-import-and-dependency-resolver/
services/control-plane/g07/frt-0705-import-and-dependency-resolver/
apps/web-console/src/features/g07/frt-0705-import-and-dependency-resolver/
apps/admin-console/src/features/g07/frt-0705-import-and-dependency-resolver/
tests/g07/frt-0705-import-and-dependency-resolver/
```
...
```text
POST /v1/skills/frt-0705/runs
GET  /v1/skills/frt-0705/runs/{run_id}
POST /v1/skills/frt-0705/runs/{run_id}/verify
GET  /v1/skills/frt-0705/runs/{run_id}/findings
GET  /v1/skills/frt-0705/runs/{run_id}/evidence
```
