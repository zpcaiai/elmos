...
triggers:
  - "Use when implementing or executing `elmos-abi-calling-convention-semantics`."
  - "Use when a migration/certification DAG requires `abi-semantics` capability."
outputs:
  - "semantic-assurance/elmos-abi-calling-convention-semantics/model.json"
  - "semantic-assurance/elmos-abi-calling-convention-semantics/evidence.json"
  - "semantic-assurance/elmos-abi-calling-convention-semantics/diagnostics.json"
---

# ABI & Calling Convention Semantics

## Objective

Capture platform ABI, calling convention, register/stack classification, symbol mangling and exception ABI obligations.
