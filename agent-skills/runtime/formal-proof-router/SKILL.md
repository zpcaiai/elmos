...
- Activate when the task requires: route high-risk invariants to model checking, SMT/theorem proving or lightweight formal models instead of applying formal methods indiscriminately.
