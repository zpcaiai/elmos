---
name: repo-origin-classifier
description: 识别 first-party、generated、vendored、fork copy、fixture、sample 与 build output。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-018
  source_name: repo-origin-classifier
  source_path: skills/repo-origin-classifier/SKILL.md
  source_sha256: sha256:be6269106c21bf9e32cb31515719871d4db4ed2e56b1893b833d552ce4bcfba7
  source_contract_sha256: sha256:b5a5479130960b839ab853450929fd77f5ff13325094662d509cc0c272bced2b
...
# File Origin Classifier

## Objective

识别 first-party、generated、vendored、fork copy、fixture、sample 与 build output。
...
- file-origin-map.json
- duplicate-family-map.json
...
- [ ] 定义 `repo-origin-classifier` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `repo-origin-classifier` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：file-origin-map.json, duplicate-family-map.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：file-origin-map.json, duplicate-family-map.json。
...
- Machine contract: `references/contract.json` (`sha256:b5a5479130960b839ab853450929fd77f5ff13325094662d509cc0c272bced2b`).
