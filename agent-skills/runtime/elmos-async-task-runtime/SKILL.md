---
name: "elmos-async-task-runtime"
description: "Invoke the bounded repository handler for elmos-async-task-runtime while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P01:async-task-runtime"
  source_name: "elmos-async-task-runtime"
  installed_name: "elmos-async-task-runtime"
  source_logical_path: "01-elmos-harness-runtime-platform/skills/async-task-runtime/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/01-elmos-harness-runtime-platform/skills/async-task-runtime/SKILL.md.source-data"
  source_materialized_path: "01-elmos-harness-runtime-platform/skills/async-task-runtime/SKILL.md.source-data"
  source_sha256: "sha256:7c19228ed91dc27f8aef5c860926e9e0c091f79b7187920f33a33bb1c27544df"
...
- This is a deterministic repository wrapper for `01-elmos-harness-runtime-platform/skills/async-task-runtime/SKILL.md` at `sha256:7c19228ed91dc27f8aef5c860926e9e0c091f79b7187920f33a33bb1c27544df`.
- Its immutable source/runtime identity is `elmos-async-task-runtime`; its active installed identity is `elmos-async-task-runtime`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-async-task-runtime --request <file>
```
