...
description: "Run FRT-2504 Form and Validation Usability Validator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2504"
  source_name: "frt-2504-form-and-validation-usability-validator"
  source_sha256: "sha256:fe0541bda3142f2959c196614a3bbae829a778115246b352ecb94090f518cb6a"
  batch: "G25"
...
- Runtime catalog key: `FRT-2504` / `frt-2504-form-and-validation-usability-validator`.
...
在G25范围内实现 **Form and Validation Usability Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Form and Validation Usability Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2504Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2504EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2504FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2504CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2504-form-and-validation-usability-validator/
packages/runtime/g25/frt-2504-form-and-validation-usability-validator/
services/control-plane/g25/frt-2504-form-and-validation-usability-validator/
apps/web-console/src/features/g25/frt-2504-form-and-validation-usability-validator/
apps/admin-console/src/features/g25/frt-2504-form-and-validation-usability-validator/
tests/g25/frt-2504-form-and-validation-usability-validator/
```
...
```text
POST /v1/skills/frt-2504/runs
GET  /v1/skills/frt-2504/runs/{run_id}
POST /v1/skills/frt-2504/runs/{run_id}/verify
GET  /v1/skills/frt-2504/runs/{run_id}/findings
GET  /v1/skills/frt-2504/runs/{run_id}/evidence
```
