---
name: extension-sdk-and-codegen
description: Use this skill when Elmos must perform extension sdk and codegen as part of the 00-foundation-contracts production
...
提供新增知识连接器、Skill、验证器、训练器和部署适配器的 SDK 与脚手架。
