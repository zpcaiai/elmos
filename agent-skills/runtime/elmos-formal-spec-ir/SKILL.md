---
name: "elmos-formal-spec-ir"
description: "把自然语言、代码、架构、工作流和数据库约束统一编译为可版本化、可寻址、可生成证明义务的形式规格中间表示。 Use when the task needs the exact Formal Specification IR Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-formal-spec-ir/SKILL.md"
  source_sha256: "sha256:484d2d53a944f4bdf2a5e02404e738ea5bcaff9377805b0fc46c5064877e602b"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "core"
  runtime_handler_id: "execute_elmos_formal_spec_ir"
...
---
# Formal Specification IR

## Repository integration boundary

- Exact Skill identity: `elmos-formal-spec-ir`; exact allowlisted runtime handler: `execute_elmos_formal_spec_ir`.
- Source identity: `skills/P0/elmos-formal-spec-ir/SKILL.md` at `sha256:484d2d53a944f4bdf2a5e02404e738ea5bcaff9377805b0fc46c5064877e602b` from `elmos-formal-assurance-kernel-v1.0.0`.
...
把自然语言、代码、架构、工作流和数据库约束统一编译为可版本化、可寻址、可生成证明义务的形式规格中间表示。
...
3. Use the repository-owned `execute_elmos_formal_spec_ir` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["typed first-order logic","relational contracts","LTL/CTL property fragments","source-location preserving IR"]`
- Direct dependencies: `[]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-formal-spec-ir/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
