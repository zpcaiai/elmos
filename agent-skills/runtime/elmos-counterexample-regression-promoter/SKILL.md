---
name: elmos-counterexample-regression-promoter
description: Promote minimized verifier, fuzz, differential, security and production incident counterexamples into governed permanent regression assets and rule-improvement candidates.
version: 4.0.0
...
# Counterexample Regression Promoter
...
- **Kernel authorities used:** K4, K5, K6, K8
...
- Deduplicate and minimize failures
- Attach requirement, cause and version lineage
- Create stable fixtures and assertions
- Route recurring failures to deterministic rule improvements
- Prevent contaminated holdouts from entering training
...
- `regression-promotion-decisions.json`
- `regression-corpus/`
- `rule-improvement-candidates.json`
- `counterexample-lineage.json`
...
- **counterexample loses triggering condition** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **private customer data enters shared corpus** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **wrong root cause creates brittle test** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **duplicate regressions inflate metrics** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fixed-version case blocks unrelated versions** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- fuzz failure promotion
- differential mismatch promotion
- security incident promotion
- deduplication
- version-scoped regression
- holdout contamination denial
