---
name: elmos-ai-synthetic-test-simulation-generator
description: Generate privacy-safe synthetic scenarios, tool simulators, user personas and fault environments with measurable
  realism and coverage limits.
version: 4.0.0
...
# AI Synthetic Test and Simulation Generator
...
- **Kernel authorities used:** K4, K5, K6
...
- `Counterexample`
- `CoverageMap`
- `AISyntheticTestAndSimulationGeneratorRun`
- `AISyntheticTestAndSimulationGeneratorDecision`

Required semantic capabilities:

- Scenario grammar and constraint generation
- Tool/environment simulation
- Rare/failure/adversarial case synthesis
- Privacy and memorization checks
- Realism and coverage comparison to holdout
...
- `synthetic-scenarios.jsonl`
- `tool-simulators/`
- `realism-evaluation.json`
- `synthetic-coverage-ledger.json`
...
- **memorized personal data** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **synthetic bias amplification** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **unrealistic easy benchmark** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **simulator hides integration bug** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **coverage overclaim** — must have a preventive control, a detective signal, a negative fixture and a response action.
