---
name: agent-evidence-evaluation
description: "Repository-owned bounded wrapper for agent-evidence-evaluation; external evidence remains NOT_RUN."
---
...
Evaluate trajectories, responses, retrieval, tool use and outcomes against versioned datasets and production-grade evaluators.
...
4. Submit `agent-evidence-evaluation` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `1c35cbda4317ef37058e9abd5f6aff22c9bfdb48dcd9c733dbbafbca2611c4cc`
