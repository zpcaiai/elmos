---
name: differential-runtime-verification
description: "Repository-owned bounded wrapper for differential-runtime-verification; external evidence remains NOT_RUN."
---
...
Run old/new implementations on identical scenarios and compare outputs, state transitions, side effects and temporal behavior.
...
4. Submit `differential-runtime-verification` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `feccd47763bbe7b1d3c3043dc416606a43c32852ab588149b370a9e0e52cbebd`
