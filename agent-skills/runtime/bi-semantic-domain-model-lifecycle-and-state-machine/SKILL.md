---
name: bi-semantic-domain-model-lifecycle-and-state-machine
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
bi_semantic_domain_model_lifecycle_and_state_machine_manifest.json
bi_semantic_domain_model_lifecycle_and_state_machine_state.json
bi_semantic_domain_model_lifecycle_and_state_machine_decision.json
bi_semantic_domain_model_lifecycle_and_state_machine_reconciliation.json
bi_semantic_domain_model_lifecycle_and_state_machine_evidence.json
```
