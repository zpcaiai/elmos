---
name: elmos-semantic-mutation-testing
description: "Inject behavior-changing mutations into conversion rules/targets and verify that equivalence tests and oracles reliably kill them."
version: 1.0.0
skill_id: ELMOS-POLY-295
layer: test-strength
risk: critical
readiness: not-run
dependencies:
...
triggers:
  - "Use when implementing or executing `elmos-semantic-mutation-testing`."
  - "Use when a migration/certification DAG requires `test-strength` capability."
outputs:
  - "semantic-assurance/elmos-semantic-mutation-testing/model.json"
  - "semantic-assurance/elmos-semantic-mutation-testing/evidence.json"
  - "semantic-assurance/elmos-semantic-mutation-testing/diagnostics.json"
---
...
Inject behavior-changing mutations into conversion rules/targets and verify that equivalence tests and oracles reliably kill them.
...
- **rule mutations.**
- **target semantic mutations.**
- **oracle sensitivity.**
- **mutation score by obligation.**
...
- [ ] null-handling mutant.
- [ ] transaction-boundary mutant.
- [ ] surviving critical mutant blocks certification.
