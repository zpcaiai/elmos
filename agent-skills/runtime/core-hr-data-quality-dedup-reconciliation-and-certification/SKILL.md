---
name: core-hr-data-quality-dedup-reconciliation-and-certification
description: "Implement Batch 43A Core HR、Organization与Employee Lifecycle quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record."
---
...
Implement Batch 43A Core HR、Organization与Employee Lifecycle quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Worker、Employment、Position、Organization、Manager、Job、Location、Lifecycle、Case与Employee Record.
...
5. Write unresolved domain assumptions to `docs/implementation/core-hr-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
core_hr_data_quality_dedup_reconciliation_and_certification_manifest.json
core_hr_data_quality_dedup_reconciliation_and_certification_state.json
core_hr_data_quality_dedup_reconciliation_and_certification_decision.json
core_hr_data_quality_dedup_reconciliation_and_certification_reconciliation.json
core_hr_data_quality_dedup_reconciliation_and_certification_evidence.json
```
