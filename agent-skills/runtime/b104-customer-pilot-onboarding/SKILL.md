---
name: b104-customer-pilot-onboarding
description: "Use when ELMOS must Onboard pilots with repository access, privacy, route fit, success criteria, support and exit plans. Triggers: Customer Pilot Onboarding, Real World Product Certification Pack, pilot onboarding, data agreement, success criteria, exit."
metadata:
  id: B104-S10
...
# B104-S10 — Customer Pilot Onboarding

## Objective

Onboard pilots with repository access, privacy, route fit, success criteria, support and exit plans.
...
Use this Skill when the approved task explicitly requires **Customer Pilot Onboarding** or when the capability graph selects it as part of a minimal dependency closure.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b104-customer-pilot-onboarding/SKILL.md --out /tmp/customer_pilot_onboarding.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B104-S10
```
...
- Reject or expose open-ended pilot.
- Reject or expose production credentials.
- Reject or expose success criteria after results.
