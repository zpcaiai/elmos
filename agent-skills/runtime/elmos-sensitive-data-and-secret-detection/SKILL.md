...
description: Use this skill when Elmos must perform sensitive data and secret detection as part of the 01-knowledge-ingestion-governance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
