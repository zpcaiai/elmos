...
- Source group: `bigdata-core`. Dependencies: `["elmos-bigdata-pattern-selector", "elmos-polyglot-persistence-planner", "elmos-database-capability-registry"]`. Triggers: `["数据不能集中", "跨源即席", "Data Fabric 或迁移过渡"]`. Declared outputs: `["federation-topology.md", "connector-catalog.json", "pushdown-policy.json", "fabric-services.md"]`.
