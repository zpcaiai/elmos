---
name: b66-typescript-project-profile-detector
description: "Use when ELMOS must inspect and model TypeScript Project Profile Detector for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: TypeScript Project Profile Detector, Batch 66, TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests."
metadata:
  id: PG223
  batch: 66
  version: 1.0.0
  ...
  category: "TypeScript and JavaScript Project Pack"
---

# PG223 — TypeScript Project Profile Detector

## Objective

Inspect and model TypeScript Project Profile Detector for TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `typescript-project-profile-detector` tasks involving TypeScript/JavaScript full-stack, Node.js, React, Vue, Nuxt, Next.js, workers, data access, contracts, and tests.
...
- Inspect source markers such as `package.json`, `tsconfig.json`, `pnpm-lock.yaml`, `package-lock.json`, `yarn.lock`, `vite.config.*`, `next.config.*` and resolve effective includes, generated files, workspaces, modules, targets, and entrypoints.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG222`.
...
- `typescript_project_profile_detector.json`
- `typescript_project_profile_detector_artifacts/`
- `typescript_project_profile_detector_verification.json`
...
- Preferred tools: `node`, `corepack`, `pnpm/npm/yarn`, `tsc`, `eslint`, `vitest/jest`, `playwright`. Record alternate tools, versions, and rationale.
...
- Record Node/package-manager/workspace versions.
- Prevent secrets from crossing server/client bundles.
- Test typecheck, lint, unit, browser, build, and runtime paths.
