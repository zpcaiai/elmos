...
# Hybrid Signature and Certificate Transition Governor
...
- `HybridSignatureAndCertificateTransitionGovernorProfile`
- `HybridSignatureAndCertificateTransitionGovernorRun`
- `HybridSignatureAndCertificateTransitionGovernorFinding`
- `HybridSignatureAndCertificateTransitionGovernorDecision`
- `HybridSignatureAndCertificateTransitionGovernorEvidence`

Required semantic capabilities:

- design dual or composite signature profiles for evidence and certificates
- manage trust anchors, algorithm identifiers, size limits and verifier compatibility
- migrate transparency logs, timestamping and revocation without breaking relying parties
...
- `elmos-post-quantum-cryptographic-agility-controller`
- `elmos-certification-key-ceremony-hsm-controller`

## Primary Outputs

- `artifacts/elmos-hybrid-signature-certificate-transition-governor/profile.yaml`
- `artifacts/elmos-hybrid-signature-certificate-transition-governor/plan.json`
- `artifacts/elmos-hybrid-signature-certificate-transition-governor/result.json`
- `artifacts/elmos-hybrid-signature-certificate-transition-governor/evidence/`
- `artifacts/elmos-hybrid-signature-certificate-transition-governor/assurance-case.json`
...
- **one signature is not actually verified** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **legacy verifier misparses composite structure** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **transition creates ambiguous validity semantics** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: design dual or composite signature profiles for evidence and certificates
- native scenario: manage trust anchors, algorithm identifiers, size limits and verifier compatibility
- native scenario: migrate transparency logs, timestamping and revocation without breaking relying parties
