---
name: smt-and-model-checking-adapter
description: Use this skill when Elmos must perform smt and model checking adapter as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# smt-and-model-checking-adapter

## 能力目标

把可表达约束交给 SMT、模型检查器或符号执行工具。
