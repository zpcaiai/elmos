...
description: "Run FRT-2512 Browser and Device Compatibility Matrix for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2512"
  source_name: "frt-2512-browser-and-device-compatibility-matrix"
  source_sha256: "sha256:ff47264fd041e5bfe74d2d46c3c3b65f1067494f35f78f2409485ae3ade95158"
  batch: "G25"
...
- Runtime catalog key: `FRT-2512` / `frt-2512-browser-and-device-compatibility-matrix`.
...
在G25范围内实现 **Browser and Device Compatibility Matrix**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Browser and Device Compatibility Matrix** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2512Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2512EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2512FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2512CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2512-browser-and-device-compatibility-matrix/
packages/runtime/g25/frt-2512-browser-and-device-compatibility-matrix/
services/control-plane/g25/frt-2512-browser-and-device-compatibility-matrix/
apps/web-console/src/features/g25/frt-2512-browser-and-device-compatibility-matrix/
apps/admin-console/src/features/g25/frt-2512-browser-and-device-compatibility-matrix/
tests/g25/frt-2512-browser-and-device-compatibility-matrix/
```
...
```text
POST /v1/skills/frt-2512/runs
GET  /v1/skills/frt-2512/runs/{run_id}
POST /v1/skills/frt-2512/runs/{run_id}/verify
GET  /v1/skills/frt-2512/runs/{run_id}/findings
GET  /v1/skills/frt-2512/runs/{run_id}/evidence
```
