...
description: Use this skill when Elmos must perform multi teacher distillation as part of the 07-private-model-foundry production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
