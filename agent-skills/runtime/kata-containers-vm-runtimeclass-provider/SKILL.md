---
name: kata-containers-vm-runtimeclass-provider
description: "Implement Kata Containers VM-backed isolation, RuntimeClass, hypervisor profiles, guest kernel/rootfs/agent governance, policy, network, and cleanup."
---
...
Implement Kata Containers VM-backed isolation, RuntimeClass, hypervisor profiles, guest kernel/rootfs/agent governance, policy, network, and cleanup.
...
4. Record unresolved provider/version assumptions in `docs/implementation/kata-containers-vm-runtimeclass-provider-baseline.md`.
...
```text
kata_containers_vm_runtimeclass_provider_manifest.json
kata_containers_vm_runtimeclass_provider_decision.json
kata_containers_vm_runtimeclass_provider_evidence.json
```
