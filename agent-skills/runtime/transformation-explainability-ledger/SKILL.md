---
name: transformation-explainability-ledger
description: "Repository-owned bounded wrapper for transformation-explainability-ledger; external evidence remains NOT_RUN."
---
...
Record why every rule/edit was selected, the source evidence used, assumptions made, validation results and rollback mapping.
...
4. Submit `transformation-explainability-ledger` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `0a4a53a10382e7de996f13f2e02035e1f0c3e1c1570e4934ad0f7e7a1fdff0e8`
