---
name: tst-b70-native-industrial-slightly-strict-suite
description: "Run the slightly strict test suite for Batch 70: C C++ Industrial and Native, covering every source Skill with positive and negative executable cases."
metadata:
  id: TB70
...
---
    # TB70 — Batch 70 C C++ Industrial and Native 略严苛测试套件

    ## Objective

    对 Batch 70 的全部 14 个Source Skills执行可重放的正向、边界、负向、故障、安全和证据完整性验证。范围为：C/C++、CMake、ABI/FFI、内存、实时并发、ROS 2、OPC UA、Qt 与嵌入式。
    ...
    |---|---|---|---|
    | PG271 | `b70-native-project-profile-detector` | detector | `B70-PG271-RUN, B70-PG271-NEG` |
| PG272 | `b70-native-toolchain-compiler-matrix` | native | `B70-PG272-RUN, B70-PG272-NEG` |
| PG273 | `b70-cmake-native-project-generator` | native | `B70-PG273-RUN, B70-PG273-NEG` |
| PG274 | `b70-modern-cpp-library-service-generator` | native | `B70-PG274-RUN, B70-PG274-NEG` |
| PG275 | `b70-c-api-abi-contract-manager` | contract | `B70-PG275-RUN, B70-PG275-NEG` |
| PG276 | `b70-native-ffi-binding-generator` | native | `B70-PG276-RUN, B70-PG276-NEG` |
| PG277 | `b70-native-memory-lifetime-safety` | native | `B70-PG277-RUN, B70-PG277-NEG` |
| PG278 | `b70-native-concurrency-realtime-safety` | concurrency | `B70-PG278-RUN, B70-PG278-NEG` |
| PG279 | `b70-ros2-node-project-generator` | native | `B70-PG279-RUN, B70-PG279-NEG` |
| PG280 | `b70-opcua-industrial-adapter-generator` | native | `B70-PG280-RUN, B70-PG280-NEG` |
| PG281 | `b70-embedded-crosscompile-project-generator` | native | `B70-PG281-RUN, B70-PG281-NEG` |
| PG282 | `b70-qt-industrial-hmi-generator` | ui | `B70-PG282-RUN, B70-PG282-NEG` |
| PG283 | `b70-native-sanitizer-fuzz-static-analysis` | native | `B70-PG283-RUN, B70-PG283-NEG` |
| PG284 | `b70-native-build-run-certifier` | native | `B70-PG284-RUN, B70-PG284-NEG` |
