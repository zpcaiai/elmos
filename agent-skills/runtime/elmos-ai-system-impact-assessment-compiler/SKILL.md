---
name: elmos-ai-system-impact-assessment-compiler
description: Compile lifecycle impact assessments covering affected people, rights, safety, accessibility, environment, misuse, distributional effects and mitigation ownership.
version: 4.0.0
...
# AI System Impact Assessment Compiler
...
- Identify affected stakeholders and impact pathways
- Evaluate severity, likelihood, reversibility and distribution
- Bind technical/organizational mitigations and monitoring
- Require independent/human review for material impacts
...
- `ai-impact-assessment.json`
- `stakeholder-impact-map.json`
- `impact-mitigation-plan.json`
- `impact-review-record.json`
...
- **stakeholder group omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **benefit claimed without evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **rare severe impact averaged away** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **mitigation owner absent** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **assessment copied across different deployments** — must have a preventive control, a detective signal, a negative fixture and a response action.
