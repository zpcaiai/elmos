---
name: bi-semantic-orchestrator
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-orchestrator-baseline.md`.
...
```text
bi_semantic_orchestrator_manifest.json
bi_semantic_orchestrator_state.json
bi_semantic_orchestrator_decision.json
bi_semantic_orchestrator_reconciliation.json
bi_semantic_orchestrator_evidence.json
```
