---
name: treasury-bank-account-liquidity-pooling-sweep-limit-and-funding
description: "Implement treasury bank-account inventory, balance positions, liquidity, cash pooling, sweeps, buffers, facilities, funding, limits and intercompany movements."
---
...
Implement treasury bank-account inventory, balance positions, liquidity, cash pooling, sweeps, buffers, facilities, funding, limits and intercompany movements.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/treasury-bank-account-liquidity-pooling-sweep-limit-and-funding-baseline.md`.
...
```text
treasury_bank_account_liquidity_pooling_sweep_limit_and_funding_manifest.json
treasury_bank_account_liquidity_pooling_sweep_limit_and_funding_decision.json
treasury_bank_account_liquidity_pooling_sweep_limit_and_funding_reconciliation.json
treasury_bank_account_liquidity_pooling_sweep_limit_and_funding_evidence.json
```
