---
name: github-commit-ref-tag-branch-and-compare-synchronization
description: "Implement commit, ref, branch, tag, compare, history, force-push detection, shallow-boundary handling, and immutable synchronization."
---
...
Implement commit, ref, branch, tag, compare, history, force-push detection, shallow-boundary handling, and immutable synchronization.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-commit-ref-tag-branch-and-compare-synchronization-baseline.md`.
...
```text
github_commit_ref_tag_branch_and_compare_synchronization_manifest.json
github_commit_ref_tag_branch_and_compare_synchronization_decision.json
github_commit_ref_tag_branch_and_compare_synchronization_evidence.json
```
