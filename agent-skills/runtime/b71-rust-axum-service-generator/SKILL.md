---
name: b71-rust-axum-service-generator
description: "Use when ELMOS must generate runnable and maintainable Rust Axum Service Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Rust Axum Service Generator, Batch 71, Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases."
metadata:
  id: PG287
  batch: 71
  version: 1.0.0
...
# PG287 — Rust Axum Service Generator

## Objective

Generate runnable and maintainable Rust Axum Service Generator for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `rust-axum-service-generator` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`, `PG286`.
...
- `rust_axum_service_generator_plan.json`
- `rust_axum_service_generator_artifacts/`
- `rust_axum_service_generator_verification.json`
