...
metadata:
  ...
  source_id: "22-defect-triage-rca"
  source_sha256: "sha256:adc27f99a34c307632b22e732fe3fcb86a082b12cdb28ed2a9ea4008283166fb"
  source_dependencies: "20-test-oracle-evidence,21-flaky-test-control"
  ...
  runtime_skill_key: "22-defect-triage-rca"
  runtime_handler: "execute_22_defect_triage_rca"
...
1. Accept only a structured request for the exact Skill key `22-defect-triage-rca`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_22_defect_triage_rca` and operation `elmos_autonomous_qa.advanced_skills.triage_defects`.
...
- Immutable source: `skills/22-defect-triage-rca/SKILL.md` at `sha256:adc27f99a34c307632b22e732fe3fcb86a082b12cdb28ed2a9ea4008283166fb`.
