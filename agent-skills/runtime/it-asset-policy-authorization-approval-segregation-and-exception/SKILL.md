---
name: it-asset-policy-authorization-approval-segregation-and-exception
description: "Implement Batch 47C IT Asset、CMDB、Endpoint、Software与License Operations policy controls, authorization, approvals, segregation of duties, delegations, exceptions and expiry, covering Asset、Configuration Item、Relationship、Endpoint、Software Installation、License、Warranty、Lifecycle与Discovery."
---

# It Asset Policy Authorization Approval Segregation And Exception

## Objective

Implement Batch 47C IT Asset、CMDB、Endpoint、Software与License Operations policy controls, authorization, approvals, segregation of duties, delegations, exceptions and expiry, covering Asset、Configuration Item、Relationship、Endpoint、Software Installation、License、Warranty、Lifecycle与Discovery.
...
5. Write unresolved domain assumptions to `docs/implementation/it-asset-policy-authorization-approval-segregation-and-exception-baseline.md`.
...
```text
it_asset_policy_authorization_approval_segregation_and_exception_manifest.json
it_asset_policy_authorization_approval_segregation_and_exception_state.json
it_asset_policy_authorization_approval_segregation_and_exception_decision.json
it_asset_policy_authorization_approval_segregation_and_exception_reconciliation.json
it_asset_policy_authorization_approval_segregation_and_exception_evidence.json
```
