---
name: recipe-marketplace
description: 建立可发现、分层分类、可版本化的确定性变换市场。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: FOUNDATION-03-recipe-marketplace
  source_name: recipe-marketplace
  source_path: skills/recipe-marketplace/SKILL.md
  source_sha256: sha256:87c4fc2c640a2707eecf7fc2b77e332096e2232dfbbde13931b22c06d0aac95e
  source_contract_sha256: sha256:bd245ed7d128c8dd8df6e9d86835b344f9251c67d8eb085266173a69fe38fa0b
...
建立可发现、分层分类、可版本化的确定性变换市场。

## Use when

在 Elmos 需要实现或升级 **Recipe Marketplace** 相关能力时使用；它不是仅供解释的提示词，而是实现、测试与验收契约。

## Capabilities to implement

- 按 ecosystem/package/name/category 建立目录
- 支持版本无关 catalog 与 resolved/requested version
- Recipe 可出现在多个分类而保持唯一身份
- 未知 metadata 保留以支持向前兼容
...
- [ ] 定义 `recipe-marketplace` 的 public interface、input/output/error schemas。
- [ ] 建立 `recipe-marketplace` 的 capability/feature flags 与版本字段。
...
- [ ] 至少覆盖并验收：按 ecosystem/package/name/category 建立目录；以及 支持版本无关 catalog 与 resolved/requested version。
...
- Machine contract: `references/contract.json` (`sha256:bd245ed7d128c8dd8df6e9d86835b344f9251c67d8eb085266173a69fe38fa0b`).
