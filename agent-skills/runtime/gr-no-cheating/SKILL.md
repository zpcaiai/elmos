---
name: gr-no-cheating
description: 自动阻止 generated/vendor 灌水、fork 重复、删失败分母、跳测试、人工预改和伪完成。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-075
  source_name: gr-no-cheating
  source_path: skills/gr-no-cheating/SKILL.md
  source_sha256: sha256:72ea3ff50c028ff8116d96bf65d43e33a678e19b5f75c5cd478aae757fd3cab9
  source_contract_sha256: sha256:3ee4d81cbe1fc1b60859e9aac69a614a79e593eada8e9693ecab1b0694895515
...
# No-Cheating Validator

## Objective

自动阻止 generated/vendor 灌水、fork 重复、删失败分母、跳测试、人工预改和伪完成。
...
- [ ] 定义 `gr-no-cheating` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `gr-no-cheating` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：benchmark-validation.json, disqualifications.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：benchmark-validation.json, disqualifications.json。
...
- Machine contract: `references/contract.json` (`sha256:3ee4d81cbe1fc1b60859e9aac69a614a79e593eada8e9693ecab1b0694895515`).
