---
name: method-and-test-quality-index
description: 为方法复杂度、职责、测试映射和 flaky 风险建立结构化索引。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: FOUNDATION-05-method-and-test-quality-index
  source_name: method-and-test-quality-index
  source_path: skills/method-and-test-quality-index/SKILL.md
  source_sha256: sha256:967c04b0a708be0eb362797d93ac0c70123ddee39540d721330051846d58c207
  source_contract_sha256: sha256:a6ebf16df2f9b3a9e7f46703d797e9833020d8605bf9c47149433c426325a65a
...
# Method & Test Quality Index

## Goal

为方法复杂度、职责、测试映射和 flaky 风险建立结构化索引。

## Use when

在 Elmos 需要实现或升级 **Method & Test Quality Index** 相关能力时使用；它不是仅供解释的提示词，而是实现、测试与验收契约。

## Capabilities to implement

- 方法描述、复杂度、依赖、测试映射可查询
- 识别高复杂度/低覆盖/脆弱测试热点
- 迁移优先级结合业务 blast radius
- 变换后比较质量指标是否恶化
...
- [ ] 定义 `method-and-test-quality-index` 的 public interface、input/output/error schemas。
- [ ] 建立 `method-and-test-quality-index` 的 capability/feature flags 与版本字段。
...
- [ ] 至少覆盖并验收：方法描述、复杂度、依赖、测试映射可查询；以及 识别高复杂度/低覆盖/脆弱测试热点。
...
- Machine contract: `references/contract.json` (`sha256:a6ebf16df2f9b3a9e7f46703d797e9833020d8605bf9c47149433c426325a65a`).
