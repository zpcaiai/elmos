...
description: "Run FRT-2907 API Security Validator for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2907"
  source_name: "frt-2907-api-security-validator"
  source_sha256: "sha256:55f5c03775d3b43ff8221a0903c17c588ce804c80de451e4e16c3f2502259e09"
  batch: "G29"
...
- Runtime catalog key: `FRT-2907` / `frt-2907-api-security-validator`.
...
在G29范围内实现 **API Security Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **API Security Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2907Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2907EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2907FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2907CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2907-api-security-validator/
packages/runtime/g29/frt-2907-api-security-validator/
services/control-plane/g29/frt-2907-api-security-validator/
apps/web-console/src/features/g29/frt-2907-api-security-validator/
apps/admin-console/src/features/g29/frt-2907-api-security-validator/
tests/g29/frt-2907-api-security-validator/
```
...
```text
POST /v1/skills/frt-2907/runs
GET  /v1/skills/frt-2907/runs/{run_id}
POST /v1/skills/frt-2907/runs/{run_id}/verify
GET  /v1/skills/frt-2907/runs/{run_id}/findings
GET  /v1/skills/frt-2907/runs/{run_id}/evidence
```
