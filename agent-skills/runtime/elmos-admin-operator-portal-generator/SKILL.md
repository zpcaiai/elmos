---
name: elmos-admin-operator-portal-generator
description: Generate tenant administration, run control, approvals, evidence, cost, incident and certification views with least privilege and auditability.
version: 4.0.0
...
# Admin and Operator Portal Generator
...
- `AdminAndOperatorPortalGeneratorProfile`
- `AdminAndOperatorPortalGeneratorPlan`
- `AdminAndOperatorPortalGeneratorRun`
- `AdminAndOperatorPortalGeneratorDecision`

Required semantic capabilities:

- generate role-scoped navigation and APIs
- surface run, proof, cost and certificate state
- implement approval, kill switch and recovery actions
- support audit export and tenant support boundaries
- test accessibility, security and stale-state handling
...
- `artifacts/elmos-admin-operator-portal-generator/profile.yaml`
- `artifacts/elmos-admin-operator-portal-generator/plan.json`
- `artifacts/elmos-admin-operator-portal-generator/result.json`
- `artifacts/elmos-admin-operator-portal-generator/evidence/`
...
- **UI shows stale completion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **operator action lacks confirmation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-tenant search** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive evidence downloadable** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **portal role mapping diverges API** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: generate role-scoped navigation and APIs
- native scenario: surface run, proof, cost and certificate state
- native scenario: implement approval, kill switch and recovery actions
- native scenario: support audit export and tenant support boundaries
- native scenario: test accessibility, security and stale-state handling
