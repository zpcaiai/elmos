...
description: "Invoke the bounded repository handler for elmos-evidence-corpus while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P07:evidence-corpus"
  source_name: "elmos-evidence-corpus"
  installed_name: "elmos-evidence-corpus"
  source_logical_path: "07-elmos-transformation-learning-evolution/skills/evidence-corpus/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/07-elmos-transformation-learning-evolution/skills/evidence-corpus/SKILL.md.source-data"
  source_materialized_path: "07-elmos-transformation-learning-evolution/skills/evidence-corpus/SKILL.md.source-data"
  source_sha256: "sha256:ac5d5db526d00a5446a469fe8edef76c041a1adc2b1407d585b84fbb73800aea"
...
- This is a deterministic repository wrapper for `07-elmos-transformation-learning-evolution/skills/evidence-corpus/SKILL.md` at `sha256:ac5d5db526d00a5446a469fe8edef76c041a1adc2b1407d585b84fbb73800aea`.
- Its immutable source/runtime identity is `elmos-evidence-corpus`; its active installed identity is `elmos-evidence-corpus`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-evidence-corpus --request <file>
```
