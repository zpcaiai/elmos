---
name: runner-fleet-domain-pool-topology-and-lifecycle
description: "Implement runner, site, fleet and pool domains, topology, membership, lifecycle, states, ownership, trust boundaries, and reconciliation."
---
...
Implement runner, site, fleet and pool domains, topology, membership, lifecycle, states, ownership, trust boundaries, and reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-fleet-domain-pool-topology-and-lifecycle-baseline.md`.
...
```text
runner_fleet_domain_pool_topology_and_lifecycle_manifest.json
runner_fleet_domain_pool_topology_and_lifecycle_decision.json
runner_fleet_domain_pool_topology_and_lifecycle_evidence.json
```
