...
description: Use this skill when Elmos must perform data usage consent contract as part of the 00-foundation-contracts production
...
约束数据可否检索、记录、标注、训练、跨租户聚合、导出、删除和保留。
