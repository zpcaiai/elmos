---
name: "autonomous-qa-30-checkpoint-resume-idempotency"
description: "Run 30-checkpoint-resume-idempotency through its exact repository-owned Autonomous QA handler."
metadata:
  source_package: "elmos-autonomous-qa-self-healing-skills"
  source_package_id: "elmos.autonomous-qa-self-healing"
  source_version: "1.1.0"
  source_id: "30-checkpoint-resume-idempotency"
  source_sha256: "sha256:9fa88c4d40e693f51b6096fc4a90e0ddd8dacbe7dfd5a6b30e8b4dca0c7d9a76"
  source_dependencies: "00-qa-control-plane,19-distributed-test-execution"
  ...
  runtime_skill_key: "30-checkpoint-resume-idempotency"
  runtime_handler: "execute_30_checkpoint_resume_idempotency"
  runtime_phase: "control"
  runtime_mutating: "true"
  runtime_operation: "elmos_autonomous_qa.advanced_skills.create_checkpoint"
...
1. Accept only a structured request for the exact Skill key `30-checkpoint-resume-idempotency`.
2. Dispatch only through `engines/autonomous-qa-engine/src/elmos_autonomous_qa/skill_runtime.py` / `dispatch_skill` to handler `execute_30_checkpoint_resume_idempotency` and operation `elmos_autonomous_qa.advanced_skills.create_checkpoint`.
...
- Immutable source: `skills/30-checkpoint-resume-idempotency/SKILL.md` at `sha256:9fa88c4d40e693f51b6096fc4a90e0ddd8dacbe7dfd5a6b30e8b4dca0c7d9a76`.
- Exact runtime phase is `control`; mutating declaration is `true`.
