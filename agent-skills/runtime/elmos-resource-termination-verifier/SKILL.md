---
name: "elmos-resource-termination-verifier"
description: "验证 Agent 循环、自动修复、递归转换、图遍历、批处理和重试受终止度量与资源预算约束。 Use when the task needs the exact Resource and Termination Verifier Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-resource-termination-verifier/SKILL.md"
  source_sha256: "sha256:f8e1ba84dfc7154dd6ef9f61db287960be7ce4031815a566743455ba852db061"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "project-generation"
  runtime_handler_id: "execute_elmos_resource_termination_verifier"
...
---
# Resource and Termination Verifier

## Repository integration boundary

- Exact Skill identity: `elmos-resource-termination-verifier`; exact allowlisted runtime handler: `execute_elmos_resource_termination_verifier`.
- Source identity: `skills/P0/elmos-resource-termination-verifier/SKILL.md` at `sha256:f8e1ba84dfc7154dd6ef9f61db287960be7ce4031815a566743455ba852db061` from `elmos-formal-assurance-kernel-v1.0.0`.
...
验证 Agent 循环、自动修复、递归转换、图遍历、批处理和重试受终止度量与资源预算约束。
...
3. Use the repository-owned `execute_elmos_resource_termination_verifier` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["ranking functions","abstract interpretation","amortized resource contracts","bounded loops"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-resource-termination-verifier/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
