---
name: benchmark-and-baseline-registry
description: Use this skill when Elmos must perform benchmark and baseline registry as part of the 09-evaluation-proof-certification production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
