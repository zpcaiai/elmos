...
description: "Run FRT-3002 Service Catalog Generator for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3002"
  source_name: "frt-3002-service-catalog-generator"
  source_sha256: "sha256:d791ec1e675f524576e816892c994668e74017981210160d9a44bfa71a172488"
  batch: "G30"
...
- Runtime catalog key: `FRT-3002` / `frt-3002-service-catalog-generator`.
...
在G30范围内实现 **Service Catalog Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Service Catalog Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3002Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3002EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3002FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3002CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3002-service-catalog-generator/
packages/runtime/g30/frt-3002-service-catalog-generator/
services/control-plane/g30/frt-3002-service-catalog-generator/
apps/web-console/src/features/g30/frt-3002-service-catalog-generator/
apps/admin-console/src/features/g30/frt-3002-service-catalog-generator/
tests/g30/frt-3002-service-catalog-generator/
```
...
```text
POST /v1/skills/frt-3002/runs
GET  /v1/skills/frt-3002/runs/{run_id}
POST /v1/skills/frt-3002/runs/{run_id}/verify
GET  /v1/skills/frt-3002/runs/{run_id}/findings
GET  /v1/skills/frt-3002/runs/{run_id}/evidence
```
