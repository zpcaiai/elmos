...
description: "Run FRT-2508 Accessibility Acceptance Suite for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2508"
  source_name: "frt-2508-accessibility-acceptance-suite"
  source_sha256: "sha256:e58ae000bf98c48fcfc304cf0685ec01af91b45a3cc938745064b9088880e68d"
  batch: "G25"
...
- Runtime catalog key: `FRT-2508` / `frt-2508-accessibility-acceptance-suite`.
...
在G25范围内实现 **Accessibility Acceptance Suite**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Accessibility Acceptance Suite** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2508Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2508EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2508FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2508CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2508-accessibility-acceptance-suite/
packages/runtime/g25/frt-2508-accessibility-acceptance-suite/
services/control-plane/g25/frt-2508-accessibility-acceptance-suite/
apps/web-console/src/features/g25/frt-2508-accessibility-acceptance-suite/
apps/admin-console/src/features/g25/frt-2508-accessibility-acceptance-suite/
tests/g25/frt-2508-accessibility-acceptance-suite/
```
...
```text
POST /v1/skills/frt-2508/runs
GET  /v1/skills/frt-2508/runs/{run_id}
POST /v1/skills/frt-2508/runs/{run_id}/verify
GET  /v1/skills/frt-2508/runs/{run_id}/findings
GET  /v1/skills/frt-2508/runs/{run_id}/evidence
```
