---
name: elmos-billing-quota-entitlement-generator
description: Generate prepaid/usage/project billing, entitlement, quota, reservation, settlement and dispute evidence from machine usage ledgers.
version: 4.0.0
...
# Billing, Quota and Entitlement Generator
...
- `BillingQuotaAndEntitlementGeneratorProfile`
- `BillingQuotaAndEntitlementGeneratorPlan`
- `BillingQuotaAndEntitlementGeneratorRun`
- `BillingQuotaAndEntitlementGeneratorDecision`

Required semantic capabilities:

- compile product plans and entitlements
- reserve and enforce concurrent/task/token budgets
- meter immutable usage and provider costs
- settle, refund and reconcile transactions
- expose customer usage and dispute evidence
...
- `artifacts/elmos-billing-quota-entitlement-generator/profile.yaml`
- `artifacts/elmos-billing-quota-entitlement-generator/plan.json`
- `artifacts/elmos-billing-quota-entitlement-generator/result.json`
- `artifacts/elmos-billing-quota-entitlement-generator/evidence/`
...
- **positive/negative amount convention reversed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **usage duplicated on retry** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **quota race allows overspend** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **refund not linked to original charge** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **billing evidence editable** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile product plans and entitlements
- native scenario: reserve and enforce concurrent/task/token budgets
- native scenario: meter immutable usage and provider costs
- native scenario: settle, refund and reconcile transactions
- native scenario: expose customer usage and dispute evidence
