---
name: b80-cross-language-build-orchestrator
description: "Use when ELMOS must coordinate and control Cross Language Build Orchestrator for cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Cross Language Build Orchestrator, Batch 80, cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification."
metadata:
  id: PG407
  batch: 80
  version: 1.0.0
...
# PG407 — Cross Language Build Orchestrator

## Objective

Coordinate and control Cross Language Build Orchestrator for cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `cross-language-build-orchestrator` tasks involving cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG405`, `PG406`.
...
- `cross_language_build_orchestrator_plan.json`
- `cross_language_build_orchestrator_artifacts/`
- `cross_language_build_orchestrator_verification.json`
