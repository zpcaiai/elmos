...
description: "Invoke the bounded repository handler for elmos-verification-planner while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P05:verification-planner"
  source_name: "elmos-verification-planner"
  installed_name: "elmos-verification-planner"
  source_logical_path: "05-elmos-conversion-reliability-verification-harness/skills/verification-planner/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/05-elmos-conversion-reliability-verification-harness/skills/verification-planner/SKILL.md.source-data"
  source_materialized_path: "05-elmos-conversion-reliability-verification-harness/skills/verification-planner/SKILL.md.source-data"
  source_sha256: "sha256:df79d52c279101d8510b3209699f10b0ee5b58fe4afb10fe4fabb2a28ccc40f7"
...
- This is a deterministic repository wrapper for `05-elmos-conversion-reliability-verification-harness/skills/verification-planner/SKILL.md` at `sha256:df79d52c279101d8510b3209699f10b0ee5b58fe4afb10fe4fabb2a28ccc40f7`.
- Its immutable source/runtime identity is `elmos-verification-planner`; its active installed identity is `elmos-verification-planner`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-verification-planner --request <file>
```
