---
name: "elmos-assumption-ledger"
description: "集中登记证明依赖的环境、数据库、编译器、运行时、外部 API、闭世界和数值假设，并在假设漂移时使证据失效。 Use when the task needs the exact Assumption Ledger Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-assumption-ledger/SKILL.md"
  source_sha256: "sha256:ee553107827932edaf1dc4b82172e7ce40184bef3ecbdebb17d5cd1ae8f662a0"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "core"
  runtime_handler_id: "execute_elmos_assumption_ledger"
...
- Exact Skill identity: `elmos-assumption-ledger`; exact allowlisted runtime handler: `execute_elmos_assumption_ledger`.
- Source identity: `skills/P0/elmos-assumption-ledger/SKILL.md` at `sha256:ee553107827932edaf1dc4b82172e7ce40184bef3ecbdebb17d5cd1ae8f662a0` from `elmos-formal-assurance-kernel-v1.0.0`.
...
集中登记证明依赖的环境、数据库、编译器、运行时、外部 API、闭世界和数值假设，并在假设漂移时使证据失效。
...
3. Use the repository-owned `execute_elmos_assumption_ledger` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["assumption contracts","dependency fingerprinting","runtime monitors","risk acceptance"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-assumption-ledger/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
