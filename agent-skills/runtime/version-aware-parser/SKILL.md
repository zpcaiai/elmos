---
name: version-aware-parser
description: 按 Java/语言版本、语法特性和项目工具链选择兼容解析环境。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: FOUNDATION-01-version-aware-parser
  source_name: version-aware-parser
  source_path: skills/version-aware-parser/SKILL.md
  source_sha256: sha256:b7994f5d2297d24f98b93046694bc4cad86ec99ed6a483849c294c85dc326e7f
  source_contract_sha256: sha256:01839811d710e9410ee76a183d3a0269d0d45a10ca910d121a060bbbe1bf186a
...
按 Java/语言版本、语法特性和项目工具链选择兼容解析环境。

## Use when

在 Elmos 需要实现或升级 **Version-aware Parser** 相关能力时使用；它不是仅供解释的提示词，而是实现、测试与验收契约。

## Capabilities to implement

- 识别 language level、编译目标和实验语法
- 支持同语言多 parser 版本并存
- 变换前验证目标版本是否能表达新语法
- 版本升级 Recipe 与 parser 升级解耦
...
- [ ] 定义 `version-aware-parser` 的 public interface、input/output/error schemas。
- [ ] 建立 `version-aware-parser` 的 capability/feature flags 与版本字段。
...
- [ ] 至少覆盖并验收：识别 language level、编译目标和实验语法；以及 支持同语言多 parser 版本并存。
...
- Machine contract: `references/contract.json` (`sha256:01839811d710e9410ee76a183d3a0269d0d45a10ca910d121a060bbbe1bf186a`).
