...
description: "Run FRT-0714 Code Generation Certification for FRT G07 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0714"
  source_name: "frt-0714-code-generation-certification"
  source_sha256: "sha256:6867d945fad66d7fe1610cc334aca42d44a263e5e584f37fecd7e3c965b4e58c"
  batch: "G07"
...
- Runtime catalog key: `FRT-0714` / `frt-0714-code-generation-certification`.
...
# FRT-0714 — Code Generation Certification

## Objective

在G07范围内实现 **Code Generation Certification**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Typed IR经规则Pass降低到目标原生AST; Gap生成Typed Hole而非空实现; Format/Analyze/Build驱动有界确定性修复。

## When to Use

- 实现或修改与 **Code Generation Certification** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0714Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0714EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0714FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0714CertificateFragment`：供G07批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g07/frt-0714-code-generation-certification/
packages/runtime/g07/frt-0714-code-generation-certification/
services/control-plane/g07/frt-0714-code-generation-certification/
apps/web-console/src/features/g07/frt-0714-code-generation-certification/
apps/admin-console/src/features/g07/frt-0714-code-generation-certification/
tests/g07/frt-0714-code-generation-certification/
```
...
```text
POST /v1/skills/frt-0714/runs
GET  /v1/skills/frt-0714/runs/{run_id}
POST /v1/skills/frt-0714/runs/{run_id}/verify
GET  /v1/skills/frt-0714/runs/{run_id}/findings
GET  /v1/skills/frt-0714/runs/{run_id}/evidence
```
