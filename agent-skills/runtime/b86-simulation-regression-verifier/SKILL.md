---
name: b86-simulation-regression-verifier
description: "Use when ELMOS must run simulation regression verifier for Batch 86 Modelica / FMI / FMU Digital Twin Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG292"
  source_name: "simulation-regression-verifier"
  source_sha256: "sha256:1bc99dbbb461e41728021e261feafbd3f5ddccbc4a79b7024a61b9543bc5c720"
  batch: 86
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 86 Language Pack / source PG292 — Simulation Regression Verifier

## 1. Objective

Verify simulation regression verifier within the Modelica / FMI / FMU Digital Twin Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Simulation Regression Verifier using the approved physical-modeling semantic contracts and toolchain versions.
...
- A representative valid modelica-fmi input produces all declared outputs for simulation-regression-verifier.
