...
description: "Run FRT-1610 Web Flutter Differential Corpus for FRT G16 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1610"
  source_name: "frt-1610-web-flutter-differential-corpus"
  source_sha256: "sha256:dc057b2a463b646fc07f537204f38817e6b2c2d35a12e76c99f297e0c2a74f2a"
  batch: "G16"
...
- Runtime catalog key: `FRT-1610` / `frt-1610-web-flutter-differential-corpus`.
...
# FRT-1610 — Web Flutter Differential Corpus

## Objective

在G16范围内实现 **Web Flutter Differential Corpus**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射DOM/组件到Widget树而非逐元素复制; 处理Key、BuildContext、Controller、State和Navigator; 处理Plugin、Platform Channel、Web/Mobile能力差异。

## When to Use

- 实现或修改与 **Web Flutter Differential Corpus** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1610Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1610EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1610FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1610CertificateFragment`：供G16批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g16/frt-1610-web-flutter-differential-corpus/
packages/runtime/g16/frt-1610-web-flutter-differential-corpus/
services/control-plane/g16/frt-1610-web-flutter-differential-corpus/
apps/web-console/src/features/g16/frt-1610-web-flutter-differential-corpus/
apps/admin-console/src/features/g16/frt-1610-web-flutter-differential-corpus/
tests/g16/frt-1610-web-flutter-differential-corpus/
```
...
```text
POST /v1/skills/frt-1610/runs
GET  /v1/skills/frt-1610/runs/{run_id}
POST /v1/skills/frt-1610/runs/{run_id}/verify
GET  /v1/skills/frt-1610/runs/{run_id}/findings
GET  /v1/skills/frt-1610/runs/{run_id}/evidence
```
