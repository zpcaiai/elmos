...
description: Use this skill when Elmos must perform semantic ir reconciliation as part of the 02-repository-semantic-intelligence
...
将多解析器、多语言和多来源结果收敛为可追溯、带置信度的统一 Semantic IR。
