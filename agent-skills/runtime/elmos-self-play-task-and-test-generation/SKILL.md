---
name: self-play-task-and-test-generation
description: Use this skill when Elmos must perform self play task and test generation as part of the 08-agentic-training-rl production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# self-play-task-and-test-generation

## 能力目标

让任务生成器、Coder 和 Tester 协同产生更难且可验证的课程。
