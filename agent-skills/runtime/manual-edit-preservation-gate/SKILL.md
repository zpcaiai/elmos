---
name: manual-edit-preservation-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Manual Edit Preservation Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T107"
  source_name: "manual-edit-preservation-gate"
  source_sha256: "sha256:77e72eb1ad3ea603c604564b16109aee9b02301db40403ea565e1a2f0fdfd482"
...
# T107 — Manual Edit Preservation Gate

## 1. Objective

Regenerate after protected and user-owned changes; prohibit overwrite or silent semantic loss.
...
- `CASE-0501` [HIGH] Manual Edit Preservation Gate: Representative path
- `CASE-0502` [HIGH] Manual Edit Preservation Gate: Boundary path
- `CASE-0503` [HIGH] Manual Edit Preservation Gate: Invalid or hostile input
- `CASE-0504` [HIGH] Manual Edit Preservation Gate: Injected dependency failure
- `CASE-0505` [CRITICAL] Manual Edit Preservation Gate: Security or safety violation
- `CASE-0506` [HIGH] Manual Edit Preservation Gate: Replay and idempotency
- `CASE-0507` [HIGH] Manual Edit Preservation Gate: Version or environment drift
- `CASE-0508` [MEDIUM] Manual Edit Preservation Gate: Moderate scale
- `CASE-0509` [CRITICAL] Manual Edit Preservation Gate: Evidence tamper
- `CASE-0510` [HIGH] Manual Edit Preservation Gate: Recovery and final evidence
