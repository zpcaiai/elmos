---
name: elmos-polyglot-route-certifier
description: Issue bounded route certificates only after exact frontend, backend, framework bridge, native build, differential, security, recovery, upgrade and rollback evidence closes required obligations.
version: 4.0.0
...
- `RouteClaim`
- `RouteEvidenceSet`
- `RouteRevocationTrigger`

Required semantic capabilities:

- Bind certificate to exact route envelope and RevisionSet
- Require independent native and differential evidence
- Record bounded semantics and allowed deltas
- Set expiry and drift triggers
- Refuse matrix-wide claims from a single route
...
- `elmos-polyglot-differential-runtime` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
- `elmos-polyglot-upgrade-controller` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `polyglot-route-certificate.json`
- `polyglot-certification-report.md`
- `route-residual-risk.json`
- `route-recertification-triggers.json`
...
- **certificate generalized beyond tested route** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **self-certification by emitter** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **bounded result shown as universal** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale differential evidence** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **allowed delta omitted from customer report** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- certificate exact-version binding
- critical gap blocks
- three-repeat Golden Route
- holdout scenario
