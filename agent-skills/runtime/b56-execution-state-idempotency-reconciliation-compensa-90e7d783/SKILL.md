---
name: b56-execution-state-idempotency-reconciliation-compensa-90e7d783
description: Standardize durable execution states, leases, retries, cancellation,
  unknown results, reconciliation, compensation, replay and partial-success handling.
metadata:
  source_package: elmos-codex-skills-batch56-product-closure
  source_id: C56-09
  source_name: execution-state-idempotency-reconciliation-compensation-and-replay
  source_batch: '56'
  source_maturity: reviewed-implementation-guidance
  source_sha256: sha256:e414506aa33b374a4c258f74742466998f210d6619a18bd2a78e764f15b12795
  normalized_namespace: product-batch56-reviewed-guidance
  activation_default: inactive
  readiness_authority: product-batch56a
---

# Execution State Idempotency Reconciliation Compensation And Replay


## Objective
Standardize durable execution states, leases, retries, cancellation, unknown results, reconciliation, compensation, replay and partial-success handling.
...
- Source identity remains `C56-09` / `execution-state-idempotency-reconciliation-compensation-and-replay`; the installed alias only resolves naming constraints.
