# miniapp-state-event-lifecycle-converter — 执行契约

## 调用边界

- 阶段：`planning`
- 任务 ID：MAPP-017, MAPP-018
- 上游技能：miniapp-semantic-ir, miniapp-component-mapping-engine
...
```json
{
  "artifact_id": "miniapp-state-event-lifecycle-converter:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "miniapp-state-event-lifecycle-converter",
  "task_id": "MAPP-017",
  "status": "passed"
}
```
...
```json
{
  "skill": "miniapp-state-event-lifecycle-converter",
  "task_ids": ["MAPP-017", "MAPP-018"],
  "status": "passed",
  "artifacts": [],
  "gate_results": [],
  "next_skills": []
