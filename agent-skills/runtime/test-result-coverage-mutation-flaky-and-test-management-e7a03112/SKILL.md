---
name: test-result-coverage-mutation-flaky-and-test-management-e7a03112
description: 归一JUnit/TestNG/NUnit/pytest/TRX、Coverage、Mutation、Rerun、Flaky与附件。
metadata:
  elmos_batch: "37B"
  elmos_skill_id: "EVI37B009"
  pack_version: "3.7-complete"
---

# EVI37B009 — Test、Coverage、Mutation、Flaky 与 Test Management Normalizer

## Objective

归一JUnit/TestNG/NUnit/pytest/TRX、Coverage、Mutation、Rerun、Flaky与附件。
...
- 保留 Discovered/Executed/Passed/Failed/Errored/Skipped/Aborted/Disabled/Unknown。
- Parameterized Invocation 与 Rerun Attempt 不丢失。
- Coverage 保存 Numerator、Denominator、Scope、New Code/Overall、Commit 和 Tool。
- Flaky 仅在输入、Commit、环境可比且结果变化时判定。
...
- missingReportIsNotZeroTests
- rerunPassDoesNotEraseInitialFailure
- coverageStoresNumeratorAndDenominator
- flakyRequiresComparableAttempts
