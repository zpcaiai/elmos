...
# PG368 — Container Health Runtime Contract
...
Use for `container-health-runtime-contract` tasks involving Dockerfiles, multi-stage and multi-architecture images, rootless hardening, SBOMs, health contracts, Compose topology, readiness, development, parity, scanning, and runtime certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG362`, `PG367`.
...
- `container_health_runtime_contract_plan.json`
- `container_health_runtime_contract_artifacts/`
- `container_health_runtime_contract_verification.json`
