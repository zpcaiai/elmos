...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/cash-forecast-scenario-variance-confidence-and-liquidit-0f01ed8f-baseline.md`.
