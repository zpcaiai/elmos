...
description: "Run FRT-1212 Platform Safety Validator for FRT G12 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1212"
  source_name: "frt-1212-platform-safety-validator"
  source_sha256: "sha256:23353a17afb194c46f269c0b48ce3b8a42bb8e8e066f8b27eb60562caa23f7d0"
  batch: "G12"
...
- Runtime catalog key: `FRT-1212` / `frt-1212-platform-safety-validator`.
...
# FRT-1212 — Platform Safety Validator

## Objective

在G12范围内实现 **Platform Safety Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：建立跨平台Capability Registry与支持等级; Native Bridge具备Schema、Permission、Timeout和Error Contract; 支付、设备和危险能力使用Server Authority与安全状态机。

## When to Use

- 实现或修改与 **Platform Safety Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1212Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1212EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1212FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1212CertificateFragment`：供G12批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g12/frt-1212-platform-safety-validator/
packages/runtime/g12/frt-1212-platform-safety-validator/
services/control-plane/g12/frt-1212-platform-safety-validator/
apps/web-console/src/features/g12/frt-1212-platform-safety-validator/
apps/admin-console/src/features/g12/frt-1212-platform-safety-validator/
tests/g12/frt-1212-platform-safety-validator/
```
...
```text
POST /v1/skills/frt-1212/runs
GET  /v1/skills/frt-1212/runs/{run_id}
POST /v1/skills/frt-1212/runs/{run_id}/verify
GET  /v1/skills/frt-1212/runs/{run_id}/findings
GET  /v1/skills/frt-1212/runs/{run_id}/evidence
```
