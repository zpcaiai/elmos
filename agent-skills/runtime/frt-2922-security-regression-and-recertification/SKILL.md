...
description: "Run FRT-2922 Security Regression and Recertification for FRT G29 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2922"
  source_name: "frt-2922-security-regression-and-recertification"
  source_sha256: "sha256:fb3cdaed97ce3cf9b4792e8dec0574dfaa64f7fa56751a6ae3bf10f23f4e60e7"
  batch: "G29"
...
- Runtime catalog key: `FRT-2922` / `frt-2922-security-regression-and-recertification`.
...
在G29范围内实现 **Security Regression and Recertification**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Asset、Threat、Trust Boundary、Attack Surface; Authentication、Authorization、Object/Field Scope、Tenant Isolation; Session/Token、API、Input、File、SSRF/XSS/Command/Prompt Injection。

## When to Use

- 实现或修改与 **Security Regression and Recertification** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2922Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2922EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2922FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2922CertificateFragment`：供G29批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g29/frt-2922-security-regression-and-recertification/
packages/runtime/g29/frt-2922-security-regression-and-recertification/
services/control-plane/g29/frt-2922-security-regression-and-recertification/
apps/web-console/src/features/g29/frt-2922-security-regression-and-recertification/
apps/admin-console/src/features/g29/frt-2922-security-regression-and-recertification/
tests/g29/frt-2922-security-regression-and-recertification/
```
...
```text
POST /v1/skills/frt-2922/runs
GET  /v1/skills/frt-2922/runs/{run_id}
POST /v1/skills/frt-2922/runs/{run_id}/verify
GET  /v1/skills/frt-2922/runs/{run_id}/findings
GET  /v1/skills/frt-2922/runs/{run_id}/evidence
```
