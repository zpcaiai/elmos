---
name: workload-identity-spiffe-spire-mtls-and-service-authentication
description: "Implement workload identity, SPIFFE/SPIRE-compatible identities, mTLS, trust bundles, service authentication, rotation, attestation, and workload authorization."
---
...
Implement workload identity, SPIFFE/SPIRE-compatible identities, mTLS, trust bundles, service authentication, rotation, attestation, and workload authorization.
...
4. Record unresolved provider/version assumptions in `docs/implementation/workload-identity-spiffe-spire-mtls-and-service-authentication-baseline.md`.
...
```text
workload_identity_spiffe_spire_mtls_and_service_authentication_manifest.json
workload_identity_spiffe_spire_mtls_and_service_authentication_decision.json
workload_identity_spiffe_spire_mtls_and_service_authentication_evidence.json
```
