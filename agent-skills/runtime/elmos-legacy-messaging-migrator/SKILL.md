---
name: elmos-legacy-messaging-migrator
description: Map MQ, CICS/IMS messaging, SAP IDoc/RFC/BAPI and file-based interchange
  to modern messaging/API contracts with delivery guarantees.
version: 1.0.0
skill_id: ELMOS-POLY-116
...
triggers:
- Use when implementing or executing `elmos-legacy-messaging-migrator`.
- Use when the migration DAG requires `integration-transformation` capability.
outputs:
- transforms/elmos-legacy-messaging-migrator/plan.json
- transforms/elmos-legacy-messaging-migrator/semantic-loss.json
- transforms/elmos-legacy-messaging-migrator/evidence.json
---

# Legacy Messaging Migrator

## Objective

Map MQ, CICS/IMS messaging, SAP IDoc/RFC/BAPI and file-based interchange to modern messaging/API contracts with delivery guarantees.
