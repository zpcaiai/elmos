...
- Invoke this repository Skill as `$pm-b39-database-generator`.
- Immutable source identity: `database-generator` in `precision-migration-b01-44` (B39).
- Runtime adapter: `skill-and-project-synthesis`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b39-database-generator`.
