...
description: "Run FRT-1901 Proof Obligation IR for FRT G19 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1901"
  source_name: "frt-1901-proof-obligation-ir"
  source_sha256: "sha256:563c5d670fc60ed673f7a642b7b5f659d017ab1a1801417ae4f08b0b0b31a13e"
  batch: "G19"
...
- Runtime catalog key: `FRT-1901` / `frt-1901-proof-obligation-ir`.
...
# FRT-1901 — Proof Obligation IR

## Objective

在G19范围内实现 **Proof Obligation IR**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：从IR、Rule和业务不变量生成Proof Obligation; Leanstral仅提出证明候选，Lean Kernel为可信根; 组合SMT、Model Checking、Symbolic和Differential Evidence。

## When to Use

- 实现或修改与 **Proof Obligation IR** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1901Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1901EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1901FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1901CertificateFragment`：供G19批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g19/frt-1901-proof-obligation-ir/
packages/runtime/g19/frt-1901-proof-obligation-ir/
services/control-plane/g19/frt-1901-proof-obligation-ir/
apps/web-console/src/features/g19/frt-1901-proof-obligation-ir/
apps/admin-console/src/features/g19/frt-1901-proof-obligation-ir/
tests/g19/frt-1901-proof-obligation-ir/
```
...
```text
POST /v1/skills/frt-1901/runs
GET  /v1/skills/frt-1901/runs/{run_id}
POST /v1/skills/frt-1901/runs/{run_id}/verify
GET  /v1/skills/frt-1901/runs/{run_id}/findings
GET  /v1/skills/frt-1901/runs/{run_id}/evidence
```
