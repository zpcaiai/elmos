---
name: "elmos-counterexample-to-test"
description: "把 SMT 模型、TLA+ Trace、Alloy Instance、SQL 反例数据库和符号执行路径最小化并生成多语言回归测试。 Use when the task needs the exact Counterexample-to-Test Compiler Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-counterexample-to-test/SKILL.md"
  source_sha256: "sha256:73c64195cb779616c20415b3751734e212b721ca0e506cc6593aad2ff984fca8"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "platform"
  runtime_handler_id: "execute_elmos_counterexample_to_test"
...
---
# Counterexample-to-Test Compiler

## Repository integration boundary

- Exact Skill identity: `elmos-counterexample-to-test`; exact allowlisted runtime handler: `execute_elmos_counterexample_to_test`.
- Source identity: `skills/P0/elmos-counterexample-to-test/SKILL.md` at `sha256:73c64195cb779616c20415b3751734e212b721ca0e506cc6593aad2ff984fca8` from `elmos-formal-assurance-kernel-v1.0.0`.
...
把 SMT 模型、TLA+ Trace、Alloy Instance、SQL 反例数据库和符号执行路径最小化并生成多语言回归测试。
...
3. Use the repository-owned `execute_elmos_counterexample_to_test` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["counterexample minimization","trace concretization","fixture synthesis","test deduplication"]`
- Direct dependencies: `["elmos-proof-obligation-planner","elmos-proof-status-policy","elmos-verifier-portfolio-router","elmos-formal-assurance-orchestrator"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-counterexample-to-test/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
