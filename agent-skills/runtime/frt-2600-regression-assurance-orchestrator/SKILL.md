...
description: "Run FRT-2600 Regression Assurance Orchestrator for FRT G26 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2600"
  source_name: "frt-2600-regression-assurance-orchestrator"
  source_sha256: "sha256:842bbc8240b228b174dc9c776a90e334e415c65131e6f539bab58fb0f85b24ca"
  batch: "G26"
...
- Runtime catalog key: `FRT-2600` / `frt-2600-regression-assurance-orchestrator`.
...
在G26范围内实现 **Regression Assurance Orchestrator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Requirement/Acceptance/State Machine派生Test Obligation; Unit/Component/Contract/Integration/Journey分层协调; Differential、Mutation、Visual/Semantic、Security和Performance Regression。

## When to Use

- 实现或修改与 **Regression Assurance Orchestrator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2600Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2600EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2600FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2600CertificateFragment`：供G26批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g26/frt-2600-regression-assurance-orchestrator/
packages/runtime/g26/frt-2600-regression-assurance-orchestrator/
services/control-plane/g26/frt-2600-regression-assurance-orchestrator/
apps/web-console/src/features/g26/frt-2600-regression-assurance-orchestrator/
apps/admin-console/src/features/g26/frt-2600-regression-assurance-orchestrator/
tests/g26/frt-2600-regression-assurance-orchestrator/
```
...
```text
POST /v1/skills/frt-2600/runs
GET  /v1/skills/frt-2600/runs/{run_id}
POST /v1/skills/frt-2600/runs/{run_id}/verify
GET  /v1/skills/frt-2600/runs/{run_id}/findings
GET  /v1/skills/frt-2600/runs/{run_id}/evidence
```
