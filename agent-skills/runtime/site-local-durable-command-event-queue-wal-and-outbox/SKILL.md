---
name: site-local-durable-command-event-queue-wal-and-outbox
description: "Implement a site-local durable inbox/outbox and event journal with SQLite WAL or approved broker, signatures, sequence, dedup, retries, dead letters, encryption, and integrity."
---
...
Implement a site-local durable inbox/outbox and event journal with SQLite WAL or approved broker, signatures, sequence, dedup, retries, dead letters, encryption, and integrity.
...
4. Record unresolved provider/version assumptions in `docs/implementation/site-local-durable-command-event-queue-wal-and-outbox-baseline.md`.
...
```text
site_local_durable_command_event_queue_wal_and_outbox_manifest.json
site_local_durable_command_event_queue_wal_and_outbox_decision.json
site_local_durable_command_event_queue_wal_and_outbox_evidence.json
```
