...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/revenue-recognition-ifrs15-asc606-performance-obligatio-223bb13a-baseline.md`.
