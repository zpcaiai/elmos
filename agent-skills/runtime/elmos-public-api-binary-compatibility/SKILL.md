...
triggers:
  - "Use when implementing or executing `elmos-public-api-binary-compatibility`."
  - "Use when a migration/certification DAG requires `compatibility` capability."
outputs:
  - "semantic-assurance/elmos-public-api-binary-compatibility/model.json"
  - "semantic-assurance/elmos-public-api-binary-compatibility/evidence.json"
  - "semantic-assurance/elmos-public-api-binary-compatibility/diagnostics.json"
---

# Public API & Binary Compatibility Analyzer

## Objective

Compare source and target public API surfaces, ABI/binary compatibility where relevant, and consumer-visible type semantics.
