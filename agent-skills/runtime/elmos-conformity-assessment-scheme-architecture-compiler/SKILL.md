...
# Conformity Assessment Scheme Architecture Compiler
...
- `ConformityAssessmentSchemeArchitectureCompilerProfile`
- `ConformityAssessmentSchemeArchitectureCompilerRun`
- `ConformityAssessmentSchemeArchitectureCompilerFinding`
- `ConformityAssessmentSchemeArchitectureCompilerDecision`
- `ConformityAssessmentSchemeArchitectureCompilerEvidence`

Required semantic capabilities:

- select product, process, service, inspection, testing, validation or management-system conformity mode
- compile scheme functions for selection, determination, review, decision, attestation and surveillance
- define scheme owner, applicant, evaluator, certifier, accreditation and relying-party roles
...
- `artifacts/elmos-conformity-assessment-scheme-architecture-compiler/profile.yaml`
- `artifacts/elmos-conformity-assessment-scheme-architecture-compiler/plan.json`
- `artifacts/elmos-conformity-assessment-scheme-architecture-compiler/result.json`
- `artifacts/elmos-conformity-assessment-scheme-architecture-compiler/evidence/`
- `artifacts/elmos-conformity-assessment-scheme-architecture-compiler/assurance-case.json`
...
- **scheme type does not match the claim being certified** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **determination activity is omitted or replaced by self-declaration** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **scheme owner silently changes decision rules after evaluation** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: select product, process, service, inspection, testing, validation or management-system conformity mode
- native scenario: compile scheme functions for selection, determination, review, decision, attestation and surveillance
- native scenario: define scheme owner, applicant, evaluator, certifier, accreditation and relying-party roles
