---
name: dataset-quarantine-management
description: Use this skill when Elmos must perform dataset quarantine management as part of the 06-dataset-foundry production
...
隔离许可证不明、PII、密钥、污染、注入、低质量和结果不确定样本。
