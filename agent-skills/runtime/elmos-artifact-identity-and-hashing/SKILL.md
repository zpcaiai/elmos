...
description: Use this skill when Elmos must perform artifact identity and hashing as part of the 00-foundation-contracts production
...
为知识对象、数据集、模型、Adapter、Skill、工具镜像和证据生成不可歧义的内容身份与哈希。
