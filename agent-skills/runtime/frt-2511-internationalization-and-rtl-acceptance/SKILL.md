...
description: "Run FRT-2511 Internationalization and RTL Acceptance for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2511"
  source_name: "frt-2511-internationalization-and-rtl-acceptance"
  source_sha256: "sha256:a03948e20e3eb2bb5ed59c9567dc3023e8193d1efea6646683345502ef7bc1e6"
  batch: "G25"
...
- Runtime catalog key: `FRT-2511` / `frt-2511-internationalization-and-rtl-acceptance`.
...
在G25范围内实现 **Internationalization and RTL Acceptance**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Internationalization and RTL Acceptance** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2511Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2511EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2511FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2511CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2511-internationalization-and-rtl-acceptance/
packages/runtime/g25/frt-2511-internationalization-and-rtl-acceptance/
services/control-plane/g25/frt-2511-internationalization-and-rtl-acceptance/
apps/web-console/src/features/g25/frt-2511-internationalization-and-rtl-acceptance/
apps/admin-console/src/features/g25/frt-2511-internationalization-and-rtl-acceptance/
tests/g25/frt-2511-internationalization-and-rtl-acceptance/
```
...
```text
POST /v1/skills/frt-2511/runs
GET  /v1/skills/frt-2511/runs/{run_id}
POST /v1/skills/frt-2511/runs/{run_id}/verify
GET  /v1/skills/frt-2511/runs/{run_id}/findings
GET  /v1/skills/frt-2511/runs/{run_id}/evidence
```
