...
triggers:
  - "Use when implementing or executing `elmos-observable-behavior-specification`."
  - "Use when a migration/certification DAG requires `behavior-oracle` capability."
outputs:
  - "semantic-assurance/elmos-observable-behavior-specification/model.json"
  - "semantic-assurance/elmos-observable-behavior-specification/evidence.json"
  - "semantic-assurance/elmos-observable-behavior-specification/diagnostics.json"
---
...
Define route-specific observables and comparison relations so equivalence means the same externally relevant behavior, not identical implementation.
...
- **state changes.**
- **I/O/events.**
- **timing/order where contractual.**
...
- [ ] pure function observable fixture.
- [ ] transactional service fixture.
- [ ] non-observable internal difference.
