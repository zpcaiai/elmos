...
description: "Run FRT-2315 Migration Data Verification Generator for FRT G23 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2315"
  source_name: "frt-2315-migration-data-verification-generator"
  source_sha256: "sha256:28fa3507535eafa9f86390399a17d6366960ebcfe9847b00bc34988951aeef06"
  batch: "G23"
...
- Runtime catalog key: `FRT-2315` / `frt-2315-migration-data-verification-generator`.
...
在G23范围内实现 **Migration Data Verification Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：字段级Data Contract、Authority和Owner; Source-to-Sink与字段级Lineage; Write→Transaction→Outbox→Event→Projection→Cache→Read完整路径。

## When to Use

- 实现或修改与 **Migration Data Verification Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2315Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2315EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2315FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2315CertificateFragment`：供G23批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g23/frt-2315-migration-data-verification-generator/
packages/runtime/g23/frt-2315-migration-data-verification-generator/
services/control-plane/g23/frt-2315-migration-data-verification-generator/
apps/web-console/src/features/g23/frt-2315-migration-data-verification-generator/
apps/admin-console/src/features/g23/frt-2315-migration-data-verification-generator/
tests/g23/frt-2315-migration-data-verification-generator/
```
...
```text
POST /v1/skills/frt-2315/runs
GET  /v1/skills/frt-2315/runs/{run_id}
POST /v1/skills/frt-2315/runs/{run_id}/verify
GET  /v1/skills/frt-2315/runs/{run_id}/findings
GET  /v1/skills/frt-2315/runs/{run_id}/evidence
```
