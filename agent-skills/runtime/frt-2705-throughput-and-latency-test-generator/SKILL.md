...
description: "Run FRT-2705 Throughput and Latency Test Generator for FRT G27 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2705"
  source_name: "frt-2705-throughput-and-latency-test-generator"
  source_sha256: "sha256:f673f9d4d7d44aa2e24653aefaf82c35d64a977f4639227af4d4a9136f6f66c3"
  batch: "G27"
...
- Runtime catalog key: `FRT-2705` / `frt-2705-throughput-and-latency-test-generator`.
...
在G27范围内实现 **Throughput and Latency Test Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：业务化Workload Model; 并发线性化点、Race、Lost Update、Idempotency Under Load; Load/Stress/Spike/Soak与Recovery。

## When to Use

- 实现或修改与 **Throughput and Latency Test Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2705Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2705EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2705FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2705CertificateFragment`：供G27批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g27/frt-2705-throughput-and-latency-test-generator/
packages/runtime/g27/frt-2705-throughput-and-latency-test-generator/
services/control-plane/g27/frt-2705-throughput-and-latency-test-generator/
apps/web-console/src/features/g27/frt-2705-throughput-and-latency-test-generator/
apps/admin-console/src/features/g27/frt-2705-throughput-and-latency-test-generator/
tests/g27/frt-2705-throughput-and-latency-test-generator/
```
...
```text
POST /v1/skills/frt-2705/runs
GET  /v1/skills/frt-2705/runs/{run_id}
POST /v1/skills/frt-2705/runs/{run_id}/verify
GET  /v1/skills/frt-2705/runs/{run_id}/findings
GET  /v1/skills/frt-2705/runs/{run_id}/evidence
```
