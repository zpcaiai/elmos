...
description: "Run FRT-2306 Event Ordering and Deduplication Generator for FRT G23 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2306"
  source_name: "frt-2306-event-ordering-and-deduplication-generator"
  source_sha256: "sha256:ccb16f2d25d619f9d07e0e6e580f2aab42c2532ce8d2a8cec423915add662585"
  batch: "G23"
...
- Runtime catalog key: `FRT-2306` / `frt-2306-event-ordering-and-deduplication-generator`.
...
在G23范围内实现 **Event Ordering and Deduplication Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：字段级Data Contract、Authority和Owner; Source-to-Sink与字段级Lineage; Write→Transaction→Outbox→Event→Projection→Cache→Read完整路径。

## When to Use

- 实现或修改与 **Event Ordering and Deduplication Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2306Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2306EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2306FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2306CertificateFragment`：供G23批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g23/frt-2306-event-ordering-and-deduplication-generator/
packages/runtime/g23/frt-2306-event-ordering-and-deduplication-generator/
services/control-plane/g23/frt-2306-event-ordering-and-deduplication-generator/
apps/web-console/src/features/g23/frt-2306-event-ordering-and-deduplication-generator/
apps/admin-console/src/features/g23/frt-2306-event-ordering-and-deduplication-generator/
tests/g23/frt-2306-event-ordering-and-deduplication-generator/
```
...
```text
POST /v1/skills/frt-2306/runs
GET  /v1/skills/frt-2306/runs/{run_id}
POST /v1/skills/frt-2306/runs/{run_id}/verify
GET  /v1/skills/frt-2306/runs/{run_id}/findings
GET  /v1/skills/frt-2306/runs/{run_id}/evidence
```
