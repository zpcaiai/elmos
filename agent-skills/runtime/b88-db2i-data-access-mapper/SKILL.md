---
name: b88-db2i-data-access-mapper
description: "Use when ELMOS must run db2i data access mapper for Batch 88 IBM i RPG / CL / DDS / DB2 for i Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG311"
  source_name: "db2i-data-access-mapper"
  source_sha256: "sha256:84687c6d1a3fad8e80cbf74ae7cbffa032fbec7ac7e895726bfb1e4a9aa01708"
  batch: 88
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 88 Language Pack / source PG311 — Db2i Data Access Mapper

## 1. Objective

Map db2i data access mapper within the IBM i RPG / CL / DDS / DB2 for i Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Db2i Data Access Mapper using the approved enterprise-ibmi semantic contracts and toolchain versions.
...
- A representative valid ibmi-rpg input produces all declared outputs for db2i-data-access-mapper.
