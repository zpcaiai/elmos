---
name: "elmos-task-dag-orchestrator"
description: "Invoke the bounded repository handler for elmos-task-dag-orchestrator while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P04:task-dag-orchestrator"
  source_name: "elmos-task-dag-orchestrator"
  installed_name: "elmos-task-dag-orchestrator"
  source_logical_path: "04-elmos-agent-orchestration-software-factory/skills/task-dag-orchestrator/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/04-elmos-agent-orchestration-software-factory/skills/task-dag-orchestrator/SKILL.md.source-data"
  source_materialized_path: "04-elmos-agent-orchestration-software-factory/skills/task-dag-orchestrator/SKILL.md.source-data"
  source_sha256: "sha256:b0f133c48bbc55002fee4c65b1be1f0879ab74fa43bb51ac119a839fd1814ccf"
...
- This is a deterministic repository wrapper for `04-elmos-agent-orchestration-software-factory/skills/task-dag-orchestrator/SKILL.md` at `sha256:b0f133c48bbc55002fee4c65b1be1f0879ab74fa43bb51ac119a839fd1814ccf`.
- Its immutable source/runtime identity is `elmos-task-dag-orchestrator`; its active installed identity is `elmos-task-dag-orchestrator`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-task-dag-orchestrator --request <file>
```
