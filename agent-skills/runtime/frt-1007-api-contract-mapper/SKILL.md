...
description: "Run FRT-1007 API Contract Mapper for FRT G10 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1007"
  source_name: "frt-1007-api-contract-mapper"
  source_sha256: "sha256:754eb25b653d887b25130614dc33119c59565f3a96c92aa6c870a57583afd0b7"
  batch: "G10"
...
- Runtime catalog key: `FRT-1007` / `frt-1007-api-contract-mapper`.
...
# FRT-1007 — API Contract Mapper

## Objective

在G10范围内实现 **API Contract Mapper**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：保持Route、History、Guard和Deep Link语义; 表单Validation、错误、草稿和提交幂等完整; API、Event、Storage和Realtime边界显式。

## When to Use

- 实现或修改与 **API Contract Mapper** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1007Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1007EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1007FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1007CertificateFragment`：供G10批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g10/frt-1007-api-contract-mapper/
packages/runtime/g10/frt-1007-api-contract-mapper/
services/control-plane/g10/frt-1007-api-contract-mapper/
apps/web-console/src/features/g10/frt-1007-api-contract-mapper/
apps/admin-console/src/features/g10/frt-1007-api-contract-mapper/
tests/g10/frt-1007-api-contract-mapper/
```
...
```text
POST /v1/skills/frt-1007/runs
GET  /v1/skills/frt-1007/runs/{run_id}
POST /v1/skills/frt-1007/runs/{run_id}/verify
GET  /v1/skills/frt-1007/runs/{run_id}/findings
GET  /v1/skills/frt-1007/runs/{run_id}/evidence
```
