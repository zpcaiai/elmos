---
name: elmos-explainability-decision-recourse-generator
description: Generate bounded explanations, evidence links, uncertainty, counterfactuals and appeal/recourse paths for AI-assisted decisions.
version: 4.0.0
...
# Explainability, Decision and Recourse Generator
...
- `ExplainabilityDecisionAndRecourseGeneratorProfile`
- `ExplainabilityDecisionAndRecourseGeneratorPlan`
- `ExplainabilityDecisionAndRecourseGeneratorRun`
- `ExplainabilityDecisionAndRecourseGeneratorDecision`

Required semantic capabilities:

- classify decision and explanation audience
- trace inputs, policies, tools and evidence
- generate faithful bounded explanation
- offer authorized correction and appeal paths
- test consistency, privacy and non-deception
...
- `artifacts/elmos-explainability-decision-recourse-generator/profile.yaml`
- `artifacts/elmos-explainability-decision-recourse-generator/plan.json`
- `artifacts/elmos-explainability-decision-recourse-generator/result.json`
- `artifacts/elmos-explainability-decision-recourse-generator/evidence/`
...
- **plausible but unfaithful explanation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **counterfactual impossible** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **sensitive feature disclosed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **recourse promises unsupported outcome** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **explanation changes across identical decision** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: classify decision and explanation audience
- native scenario: trace inputs, policies, tools and evidence
- native scenario: generate faithful bounded explanation
- native scenario: offer authorized correction and appeal paths
- native scenario: test consistency, privacy and non-deception
