---
name: b81-cobol-to-java-dotnet-generator
description: "Use when ELMOS must run cobol to java dotnet generator for Batch 81 COBOL / JCL / REXX / CICS / IMS Mainframe Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG231"
  source_name: "cobol-to-java-dotnet-generator"
  source_sha256: "sha256:585d5da144623afa830cba4c3c67a705a5a087290f206c1e31cbe6620cfb3f27"
  batch: 81
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 81 Language Pack / source PG231 — Cobol To Java Dotnet Generator

## 1. Objective

Generate cobol to java dotnet generator within the COBOL / JCL / REXX / CICS / IMS Mainframe Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Cobol To Java Dotnet Generator using the approved enterprise-mainframe semantic contracts and toolchain versions.
...
- A representative valid cobol-mainframe input produces all declared outputs for cobol-to-java-dotnet-generator.
