...
description: "Run FRT-1601 Vue 2 to Flutter Route Pack for FRT G16 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1601"
  source_name: "frt-1601-vue-2-to-flutter-route-pack"
  source_sha256: "sha256:37c78af10329faf7c6473f88fa43331fcfb8fd4e3edbca66bf0f00857dc52b0e"
  batch: "G16"
...
- Runtime catalog key: `FRT-1601` / `frt-1601-vue-2-to-flutter-route-pack`.
...
# FRT-1601 — Vue 2 to Flutter Route Pack

## Objective

在G16范围内实现 **Vue 2 to Flutter Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射DOM/组件到Widget树而非逐元素复制; 处理Key、BuildContext、Controller、State和Navigator; 处理Plugin、Platform Channel、Web/Mobile能力差异。

## When to Use

- 实现或修改与 **Vue 2 to Flutter Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1601Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1601EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1601FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1601CertificateFragment`：供G16批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g16/frt-1601-vue-2-to-flutter-route-pack/
packages/runtime/g16/frt-1601-vue-2-to-flutter-route-pack/
services/control-plane/g16/frt-1601-vue-2-to-flutter-route-pack/
apps/web-console/src/features/g16/frt-1601-vue-2-to-flutter-route-pack/
apps/admin-console/src/features/g16/frt-1601-vue-2-to-flutter-route-pack/
tests/g16/frt-1601-vue-2-to-flutter-route-pack/
```
...
```text
POST /v1/skills/frt-1601/runs
GET  /v1/skills/frt-1601/runs/{run_id}
POST /v1/skills/frt-1601/runs/{run_id}/verify
GET  /v1/skills/frt-1601/runs/{run_id}/findings
GET  /v1/skills/frt-1601/runs/{run_id}/evidence
```
