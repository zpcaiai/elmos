...
description: "Run FRT-2417 Admin Search and Advanced Filtering for FRT G24 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2417"
  source_name: "frt-2417-admin-search-and-advanced-filtering"
  source_sha256: "sha256:8868719367538b87166832003f4b013a9ae4719cbfef250d80ae3e28f4edb0c5"
  batch: "G24"
...
- Runtime catalog key: `FRT-2417` / `frt-2417-admin-search-and-advanced-filtering`.
...
在G24范围内实现 **Admin Search and Advanced Filtering**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Admin Object × Action × Role × Scope × Environment矩阵; 高风险操作Impact Preview、Reason、Approval、Typed Command、Audit; Manual Case、Data Repair、Reconciliation正式后台流程。

## When to Use

- 实现或修改与 **Admin Search and Advanced Filtering** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2417Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2417EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2417FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2417CertificateFragment`：供G24批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g24/frt-2417-admin-search-and-advanced-filtering/
packages/runtime/g24/frt-2417-admin-search-and-advanced-filtering/
services/control-plane/g24/frt-2417-admin-search-and-advanced-filtering/
apps/web-console/src/features/g24/frt-2417-admin-search-and-advanced-filtering/
apps/admin-console/src/features/g24/frt-2417-admin-search-and-advanced-filtering/
tests/g24/frt-2417-admin-search-and-advanced-filtering/
```
...
```text
POST /v1/skills/frt-2417/runs
GET  /v1/skills/frt-2417/runs/{run_id}
POST /v1/skills/frt-2417/runs/{run_id}/verify
GET  /v1/skills/frt-2417/runs/{run_id}/findings
GET  /v1/skills/frt-2417/runs/{run_id}/evidence
```
