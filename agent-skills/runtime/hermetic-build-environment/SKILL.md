...
## Objective
Build and test inside declared environments with controlled toolchains, dependencies, network and filesystem inputs.
...
- Activate when the task requires: build and test inside declared environments with controlled toolchains, dependencies, network and filesystem inputs.
