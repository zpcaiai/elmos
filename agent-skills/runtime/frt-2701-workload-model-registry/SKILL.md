...
description: "Run FRT-2701 Workload Model Registry for FRT G27 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2701"
  source_name: "frt-2701-workload-model-registry"
  source_sha256: "sha256:da51b7f71469e700270d60c517acebdc50ff23761fca619739b0935ee5161d55"
  batch: "G27"
...
- Runtime catalog key: `FRT-2701` / `frt-2701-workload-model-registry`.
...
在G27范围内实现 **Workload Model Registry**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：业务化Workload Model; 并发线性化点、Race、Lost Update、Idempotency Under Load; Load/Stress/Spike/Soak与Recovery。

## When to Use

- 实现或修改与 **Workload Model Registry** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2701Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2701EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2701FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2701CertificateFragment`：供G27批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g27/frt-2701-workload-model-registry/
packages/runtime/g27/frt-2701-workload-model-registry/
services/control-plane/g27/frt-2701-workload-model-registry/
apps/web-console/src/features/g27/frt-2701-workload-model-registry/
apps/admin-console/src/features/g27/frt-2701-workload-model-registry/
tests/g27/frt-2701-workload-model-registry/
```
...
```text
POST /v1/skills/frt-2701/runs
GET  /v1/skills/frt-2701/runs/{run_id}
POST /v1/skills/frt-2701/runs/{run_id}/verify
GET  /v1/skills/frt-2701/runs/{run_id}/findings
GET  /v1/skills/frt-2701/runs/{run_id}/evidence
```
