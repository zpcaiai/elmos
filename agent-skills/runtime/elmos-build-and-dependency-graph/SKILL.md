---
name: build-and-dependency-graph
description: Use this skill when Elmos must perform build and dependency graph as part of the 02-repository-semantic-intelligence
...
解析构建模块、依赖、插件、Profile、代码生成和包解析结果。
