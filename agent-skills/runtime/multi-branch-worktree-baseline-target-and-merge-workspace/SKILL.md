---
name: multi-branch-worktree-baseline-target-and-merge-workspace
description: "Implement isolated worktrees for baseline, target, repair, merge, and comparison branches with conflict handling and cleanup."
---
...
Implement isolated worktrees for baseline, target, repair, merge, and comparison branches with conflict handling and cleanup.
...
4. Record unresolved provider/version assumptions in `docs/implementation/multi-branch-worktree-baseline-target-and-merge-workspace-baseline.md`.
...
```text
multi_branch_worktree_baseline_target_and_merge_workspace_manifest.json
multi_branch_worktree_baseline_target_and_merge_workspace_decision.json
multi_branch_worktree_baseline_target_and_merge_workspace_evidence.json
```
