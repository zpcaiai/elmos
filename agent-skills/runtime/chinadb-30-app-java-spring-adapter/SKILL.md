---
name: chinadb-30-app-java-spring-adapter
description: "Use when ELMOS must follow the ChinaDB commercial database-migration specification for Java / Spring Database Refactor Adapter. Keep exact directed route and version semantics, require real evidence, and fail closed on unsupported behavior."
metadata:
  source_package: "chinadb-commercial-migration-skills"
  source_version: "1.0.0"
  source_directory: "30-app-java-spring-adapter"
  source_path: "skills/30-app-java-spring-adapter/SKILL.md"
  source_sha256: "sha256:8df9426efcdbe73b376a8ab1cafd38e72146a5e8af1485e457914ee65f4f62e6"
...
- Provenance is pinned to `chinadb-commercial-migration-skills` version `1.0.0`, source Skill `30-app-java-spring-adapter`, and the SHA-256 digest in frontmatter.
