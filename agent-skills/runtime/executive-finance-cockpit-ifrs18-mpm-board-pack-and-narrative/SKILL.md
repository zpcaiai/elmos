---
name: executive-finance-cockpit-ifrs18-mpm-board-pack-and-narrative
description: "Implement executive finance dashboards, IFRS 18 management-performance-measure governance, board packs, metric reconciliation, drivers, risks and evidence-backed narratives."
---
...
Implement executive finance dashboards, IFRS 18 management-performance-measure governance, board packs, metric reconciliation, drivers, risks and evidence-backed narratives.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/executive-finance-cockpit-ifrs18-mpm-board-pack-and-narrative-baseline.md`.
...
```text
executive_finance_cockpit_ifrs18_mpm_board_pack_and_narrative_manifest.json
executive_finance_cockpit_ifrs18_mpm_board_pack_and_narrative_decision.json
executive_finance_cockpit_ifrs18_mpm_board_pack_and_narrative_reconciliation.json
executive_finance_cockpit_ifrs18_mpm_board_pack_and_narrative_evidence.json
```
...
```text
executiveMetricUsesCertifiedSnapshot
asOfAndPeriodStatusAreVisible
boardPackIsImmutable
