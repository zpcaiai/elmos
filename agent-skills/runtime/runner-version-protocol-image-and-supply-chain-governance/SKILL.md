---
name: runner-version-protocol-image-and-supply-chain-governance
description: "Implement runner protocol, release, binary/image, signature, SBOM, provenance, compatibility, rollout, revocation, and supply-chain governance."
---
...
Implement runner protocol, release, binary/image, signature, SBOM, provenance, compatibility, rollout, revocation, and supply-chain governance.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-version-protocol-image-and-supply-chain-governance-baseline.md`.
...
```text
runner_version_protocol_image_and_supply_chain_governance_manifest.json
runner_version_protocol_image_and_supply_chain_governance_decision.json
runner_version_protocol_image_and_supply_chain_governance_evidence.json
```
