---
name: elmos-medical-device-ai-software-lifecycle-risk-profile
description: Implement and independently certify medical device ai software lifecycle and risk profile, including compile software lifecycle, clinical risk, usability, cybersecurity and post-market obligations, trace intended use, patient population, clinical performance and change protocol and verify data representativeness, human factors and adverse-event monitoring.
version: 4.0.0
...
# Medical Device AI Software Lifecycle and Risk Profile
...
- **Kernel authorities used:** K1, K2, K3, K6, K7, K8
...
- `MedicalDeviceAISoftwareLifecycleAndRiskProfileProfile`
- `MedicalDeviceAISoftwareLifecycleAndRiskProfileRun`
- `MedicalDeviceAISoftwareLifecycleAndRiskProfileFinding`
- `MedicalDeviceAISoftwareLifecycleAndRiskProfileDecision`
- `MedicalDeviceAISoftwareLifecycleAndRiskProfileEvidence`

Required semantic capabilities:

- compile software lifecycle, clinical risk, usability, cybersecurity and post-market obligations
- trace intended use, patient population, clinical performance and change protocol
- verify data representativeness, human factors and adverse-event monitoring
...
- `elmos-ai-system-impact-assessment-compiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
- `elmos-ai-data-contract-quality-governor` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.

## Primary Outputs

- `artifacts/elmos-medical-device-ai-software-lifecycle-risk-profile/profile.yaml`
- `artifacts/elmos-medical-device-ai-software-lifecycle-risk-profile/plan.json`
- `artifacts/elmos-medical-device-ai-software-lifecycle-risk-profile/result.json`
- `artifacts/elmos-medical-device-ai-software-lifecycle-risk-profile/evidence/`
- `artifacts/elmos-medical-device-ai-software-lifecycle-risk-profile/assurance-case.json`
...
- **research benchmark is presented as clinical validation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **population shift harms underrepresented patients** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **model update bypasses change control** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile software lifecycle, clinical risk, usability, cybersecurity and post-market obligations
- native scenario: trace intended use, patient population, clinical performance and change protocol
- native scenario: verify data representativeness, human factors and adverse-event monitoring
