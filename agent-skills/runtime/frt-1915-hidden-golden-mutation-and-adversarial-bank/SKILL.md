...
description: "Run FRT-1915 Hidden Golden Mutation and Adversarial Bank for FRT G19 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1915"
  source_name: "frt-1915-hidden-golden-mutation-and-adversarial-bank"
  source_sha256: "sha256:4416454c868136bfed2ddb5bc93fc6421a458af4514159f2b4b92493f9e9065c"
  batch: "G19"
...
- Runtime catalog key: `FRT-1915` / `frt-1915-hidden-golden-mutation-and-adversarial-bank`.
...
# FRT-1915 — Hidden Golden Mutation and Adversarial Bank

## Objective

在G19范围内实现 **Hidden Golden Mutation and Adversarial Bank**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：从IR、Rule和业务不变量生成Proof Obligation; Leanstral仅提出证明候选，Lean Kernel为可信根; 组合SMT、Model Checking、Symbolic和Differential Evidence。

## When to Use

- 实现或修改与 **Hidden Golden Mutation and Adversarial Bank** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1915Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1915EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1915FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1915CertificateFragment`：供G19批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g19/frt-1915-hidden-golden-mutation-and-adversarial-bank/
packages/runtime/g19/frt-1915-hidden-golden-mutation-and-adversarial-bank/
services/control-plane/g19/frt-1915-hidden-golden-mutation-and-adversarial-bank/
apps/web-console/src/features/g19/frt-1915-hidden-golden-mutation-and-adversarial-bank/
apps/admin-console/src/features/g19/frt-1915-hidden-golden-mutation-and-adversarial-bank/
tests/g19/frt-1915-hidden-golden-mutation-and-adversarial-bank/
```
...
```text
POST /v1/skills/frt-1915/runs
GET  /v1/skills/frt-1915/runs/{run_id}
POST /v1/skills/frt-1915/runs/{run_id}/verify
GET  /v1/skills/frt-1915/runs/{run_id}/findings
GET  /v1/skills/frt-1915/runs/{run_id}/evidence
```
