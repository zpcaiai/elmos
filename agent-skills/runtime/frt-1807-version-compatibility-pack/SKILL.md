...
description: "Run FRT-1807 Version Compatibility Pack for FRT G18 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1807"
  source_name: "frt-1807-version-compatibility-pack"
  source_sha256: "sha256:171f6afc3f8d54c44b815a4d30d2db513be864902ea03a2443a7e78697a59ff8"
  batch: "G18"
...
- Runtime catalog key: `FRT-1807` / `frt-1807-version-compatibility-pack`.
...
# FRT-1807 — Version Compatibility Pack

## Objective

在G18范围内实现 **Version Compatibility Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：将真实项目差异封装为可组合Overlay而非硬编码核心; Pack声明Provides/Requires/Conflicts/Permissions/Versions; 确定性解析优先级和冲突。

## When to Use

- 实现或修改与 **Version Compatibility Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1807Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1807EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1807FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1807CertificateFragment`：供G18批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g18/frt-1807-version-compatibility-pack/
packages/runtime/g18/frt-1807-version-compatibility-pack/
services/control-plane/g18/frt-1807-version-compatibility-pack/
apps/web-console/src/features/g18/frt-1807-version-compatibility-pack/
apps/admin-console/src/features/g18/frt-1807-version-compatibility-pack/
tests/g18/frt-1807-version-compatibility-pack/
```
...
```text
POST /v1/skills/frt-1807/runs
GET  /v1/skills/frt-1807/runs/{run_id}
POST /v1/skills/frt-1807/runs/{run_id}/verify
GET  /v1/skills/frt-1807/runs/{run_id}/findings
GET  /v1/skills/frt-1807/runs/{run_id}/evidence
```
