...
description: "Run FRT-2619 Regression Evidence Certificate for FRT G26 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2619"
  source_name: "frt-2619-regression-evidence-certificate"
  source_sha256: "sha256:ae0ebb87ebfa1732a305ba6ae23f343485dd003ffd0a0a4d1980d678c3855d4d"
  batch: "G26"
...
- Runtime catalog key: `FRT-2619` / `frt-2619-regression-evidence-certificate`.
...
在G26范围内实现 **Regression Evidence Certificate**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Requirement/Acceptance/State Machine派生Test Obligation; Unit/Component/Contract/Integration/Journey分层协调; Differential、Mutation、Visual/Semantic、Security和Performance Regression。

## When to Use

- 实现或修改与 **Regression Evidence Certificate** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2619Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2619EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2619FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2619CertificateFragment`：供G26批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g26/frt-2619-regression-evidence-certificate/
packages/runtime/g26/frt-2619-regression-evidence-certificate/
services/control-plane/g26/frt-2619-regression-evidence-certificate/
apps/web-console/src/features/g26/frt-2619-regression-evidence-certificate/
apps/admin-console/src/features/g26/frt-2619-regression-evidence-certificate/
tests/g26/frt-2619-regression-evidence-certificate/
```
...
```text
POST /v1/skills/frt-2619/runs
GET  /v1/skills/frt-2619/runs/{run_id}
POST /v1/skills/frt-2619/runs/{run_id}/verify
GET  /v1/skills/frt-2619/runs/{run_id}/findings
GET  /v1/skills/frt-2619/runs/{run_id}/evidence
```
