...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/payment-treasury-operations-cockpit-position-reconcilia-eb2c94f7-baseline.md`.
