...
description: "Run FRT-2604 API and Event Contract Test Coordinator for FRT G26 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2604"
  source_name: "frt-2604-api-and-event-contract-test-coordinator"
  source_sha256: "sha256:71087963b0f6e695e2a7164a90f1136154d9a695e7cecfa3d1587eb6ec77f2c1"
  batch: "G26"
...
- Runtime catalog key: `FRT-2604` / `frt-2604-api-and-event-contract-test-coordinator`.
...
在G26范围内实现 **API and Event Contract Test Coordinator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Requirement/Acceptance/State Machine派生Test Obligation; Unit/Component/Contract/Integration/Journey分层协调; Differential、Mutation、Visual/Semantic、Security和Performance Regression。

## When to Use

- 实现或修改与 **API and Event Contract Test Coordinator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2604Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2604EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2604FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2604CertificateFragment`：供G26批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g26/frt-2604-api-and-event-contract-test-coordinator/
packages/runtime/g26/frt-2604-api-and-event-contract-test-coordinator/
services/control-plane/g26/frt-2604-api-and-event-contract-test-coordinator/
apps/web-console/src/features/g26/frt-2604-api-and-event-contract-test-coordinator/
apps/admin-console/src/features/g26/frt-2604-api-and-event-contract-test-coordinator/
tests/g26/frt-2604-api-and-event-contract-test-coordinator/
```
...
```text
POST /v1/skills/frt-2604/runs
GET  /v1/skills/frt-2604/runs/{run_id}
POST /v1/skills/frt-2604/runs/{run_id}/verify
GET  /v1/skills/frt-2604/runs/{run_id}/findings
GET  /v1/skills/frt-2604/runs/{run_id}/evidence
```
