---
name: "elmos-schema-losslessness-proof"
description: "证明表拆分、合并、重命名、编码与数据搬迁保持键、函数依赖、约束和所需信息。 Use when the task needs the exact Schema Losslessness Proof Formal Assurance handler and its fail-closed evidence boundary."
license: "Proprietary-Elmos"
metadata:
  source_package: "elmos-formal-assurance-kernel-v1.0.0"
  source_version: "1.0.0"
  source_path: "skills/P0/elmos-schema-losslessness-proof/SKILL.md"
  source_sha256: "sha256:f6c215d9cdefdf5ec0c4995ac6477a763c76dbc8df0ea8a7b10a31bdeafaf7f9"
  source_tree_sha256: "sha256:3674ece422d24bb7764d3693e4cfb58c03c1c8a8f37def8ef316a8394cc95552"
  priority: "P0"
  domain: "sql-conversion"
  runtime_handler_id: "execute_elmos_schema_losslessness_proof"
...
---
# Schema Losslessness Proof

## Repository integration boundary

- Exact Skill identity: `elmos-schema-losslessness-proof`; exact allowlisted runtime handler: `execute_elmos_schema_losslessness_proof`.
- Source identity: `skills/P0/elmos-schema-losslessness-proof/SKILL.md` at `sha256:f6c215d9cdefdf5ec0c4995ac6477a763c76dbc8df0ea8a7b10a31bdeafaf7f9` from `elmos-formal-assurance-kernel-v1.0.0`.
...
证明表拆分、合并、重命名、编码与数据搬迁保持键、函数依赖、约束和所需信息。
...
3. Use the repository-owned `execute_elmos_schema_losslessness_proof` path; do not substitute a generic dispatcher, regex-only approximation, weakened property, permissive type or fabricated provider result.
...
- Capabilities: `["lossless join","dependency preservation","round-trip laws","relational refinement"]`
- Direct dependencies: `["elmos-formal-spec-ir","elmos-proof-obligation-planner","elmos-verifier-portfolio-router","elmos-sql-semantic-ir"]`
...
Consult `skills/elmos-formal-assurance-kernel-v1.0.0/skills/P0/elmos-schema-losslessness-proof/SKILL.md` plus the sibling `manifest.yaml`, `acceptance.yaml`, `implementation.yaml` and `runbook.md` only as digest-bound declarative requirements. This wrapper does not import their imperative authority.
