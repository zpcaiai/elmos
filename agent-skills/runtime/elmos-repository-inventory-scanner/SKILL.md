---
name: "elmos-repository-inventory-scanner"
description: "Invoke the bounded repository handler for elmos-repository-inventory-scanner while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P02:repository-inventory-scanner"
  source_name: "elmos-repository-inventory-scanner"
  installed_name: "elmos-repository-inventory-scanner"
  source_logical_path: "02-elmos-repository-intelligence-semantic-ir/skills/repository-inventory-scanner/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/02-elmos-repository-intelligence-semantic-ir/skills/repository-inventory-scanner/SKILL.md.source-data"
  source_materialized_path: "02-elmos-repository-intelligence-semantic-ir/skills/repository-inventory-scanner/SKILL.md.source-data"
  source_sha256: "sha256:dabb9ddc882de66307d4a71c27146f5674e2b305c4d9ee5487e0048edfab7113"
...
# elmos-repository-inventory-scanner
...
- This is a deterministic repository wrapper for `02-elmos-repository-intelligence-semantic-ir/skills/repository-inventory-scanner/SKILL.md` at `sha256:dabb9ddc882de66307d4a71c27146f5674e2b305c4d9ee5487e0048edfab7113`.
- Its immutable source/runtime identity is `elmos-repository-inventory-scanner`; its active installed identity is `elmos-repository-inventory-scanner`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-repository-inventory-scanner --request <file>
```
