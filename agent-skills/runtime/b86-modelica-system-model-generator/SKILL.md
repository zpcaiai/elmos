---
name: b86-modelica-system-model-generator
description: "Use when ELMOS must run modelica system model generator for Batch 86 Modelica / FMI / FMU Digital Twin Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG288"
  source_name: "modelica-system-model-generator"
  source_sha256: "sha256:349a75da99c81635208cab1691696631a84e3b2b0e41701d169c6a7a7fd68618"
  batch: 86
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 86 Language Pack / source PG288 — Modelica System Model Generator

## 1. Objective

Model modelica system model generator within the Modelica / FMI / FMU Digital Twin Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Modelica System Model Generator using the approved physical-modeling semantic contracts and toolchain versions.
...
- A representative valid modelica-fmi input produces all declared outputs for modelica-system-model-generator.
