...
description: "Run FRT-0601 Vue 2 Architecture Synthesizer for FRT G06 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0601"
  source_name: "frt-0601-vue-2-architecture-synthesizer"
  source_sha256: "sha256:8956c765085ff523938e3fb77a1cc5401eb7f20e48a34d1fc4d1e51ae977bc95"
  batch: "G06"
...
- Runtime catalog key: `FRT-0601` / `frt-0601-vue-2-architecture-synthesizer`.
...
# FRT-0601 — Vue 2 Architecture Synthesizer

## Objective

在G06范围内实现 **Vue 2 Architecture Synthesizer**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：按目标生态生成模块、路由、状态、DI、配置和Build边界; 禁止机械复制源目录结构; 锁定目标版本、依赖和工具链。

## When to Use

- 实现或修改与 **Vue 2 Architecture Synthesizer** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0601Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0601EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0601FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0601CertificateFragment`：供G06批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g06/frt-0601-vue-2-architecture-synthesizer/
packages/runtime/g06/frt-0601-vue-2-architecture-synthesizer/
services/control-plane/g06/frt-0601-vue-2-architecture-synthesizer/
apps/web-console/src/features/g06/frt-0601-vue-2-architecture-synthesizer/
apps/admin-console/src/features/g06/frt-0601-vue-2-architecture-synthesizer/
tests/g06/frt-0601-vue-2-architecture-synthesizer/
```
...
```text
POST /v1/skills/frt-0601/runs
GET  /v1/skills/frt-0601/runs/{run_id}
POST /v1/skills/frt-0601/runs/{run_id}/verify
GET  /v1/skills/frt-0601/runs/{run_id}/findings
GET  /v1/skills/frt-0601/runs/{run_id}/evidence
```
