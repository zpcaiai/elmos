...
triggers:
  - "Use when implementing or executing `elmos-side-effect-footprint-model`."
  - "Use when a migration/certification DAG requires `effect-semantics` capability."
outputs:
  - "semantic-assurance/elmos-side-effect-footprint-model/model.json"
  - "semantic-assurance/elmos-side-effect-footprint-model/evidence.json"
  - "semantic-assurance/elmos-side-effect-footprint-model/diagnostics.json"
---

# Side-Effect Footprint Model

## Objective

Classify reads/writes to memory, DB, files, network, queues, clocks, environment and external systems per operation.
...
- [ ] pure/effectful function fixture.
- [ ] DB+message dual-write fixture.
- [ ] hidden global write fixture.
