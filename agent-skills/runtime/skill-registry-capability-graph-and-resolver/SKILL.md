---
name: skill-registry-capability-graph-and-resolver
description: Replace flat exposure of 1,554 Skills with governed capability routing,
  conflict detection, lifecycle and bounded activation.
metadata:
  source_package: elmos-codex-skills-batch56a-product-closure
  source_id: CLO56A003
  source_batch: 56A
  source_maturity: reviewed-design
  source_sha256: sha256:916c86536e8eb585188d0e5c0e3efffbcbab82e510c21d762ea58d4e9a7f5dbb
  normalized_namespace: product-closure
---

# Skill Registry, Capability Graph & Resolver

## Objective

Replace flat exposure of 1,554 Skills with governed capability routing, conflict detection, lifecycle and bounded activation.
...
1. Import Skill frontmatter and manifests.
2. Normalize owner, version, maturity, capabilities, requirements and conflicts.
3. Build dependency and supersession graphs.
4. Score candidates for the current task.
5. Enforce active-Skill and context-token budgets.
6. Emit an explainable activation decision.

## Required Tests

- `resolverSelectsMinimalCapabilityCover`
- `conflictingSkillsCannotActivateTogether`
- `deprecatedSkillLosesToSupportedSuccessor`
- `activationRespectsTokenBudget`
...
```yaml
skill_id: CLO56A003
skill_name: skill-registry-capability-graph-and-resolver
