---
name: b71-rust-supply-chain-policy
description: "Use when ELMOS must enforce and test Rust Supply Chain Policy for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Rust Supply Chain Policy, Batch 71, Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases."
metadata:
  id: PG293
  batch: 71
  version: 1.0.0
...
# PG293 — Rust Supply Chain Policy

## Objective

Enforce and test Rust Supply Chain Policy for Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases, preserving ownership, compatibility, security, reproducibility, and evidence boundaries.
...
Use for `rust-supply-chain-policy` tasks involving Rust Cargo workspaces, Axum/Actix services, CLI tools, Tokio workers, Serde contracts, FFI/WASM, unsafe review, supply-chain policy, fuzzing, and releases.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG284`, `PG292`.
...
- `rust_supply_chain_policy_plan.json`
- `rust_supply_chain_policy_artifacts/`
- `rust_supply_chain_policy_verification.json`
