---
name: legacy-web-32-behavioral-contract-and-sequence-mining
description: "Repository-owned exact runtime interface for 行为契约与请求序列挖掘; bounded semantic analysis and evidence generation for Java legacy web modernization."
metadata:
  source_package: elmos.java-legacy-web.repository-modernization
  source_version: 1.0.0
  source_id: 32-behavioral-contract-and-sequence-mining
  source_digest: sha256:67933e23b640e5387858ea08df3848834e6d3f0ad2b3a034b57314f8c44a29a0
  phase: semantic-model
  runtime_state: CODE_COMPLETE_LOCAL
  capability_state: LOCAL_EXECUTED
  operation_code: BEHAVIOR_CONTRACTS_MINED
  runtime_handler_id: legacy-web-handler:32-behavioral-contract-and-sequence-mining
---
