---
name: elmos-rag-acl-freshness-deletion-verifier
description: Prove that retrieval observes point-in-time authorization, freshness limits, retention and verified deletion
  across all indexes, caches and memories.
version: 4.0.0
...
# RAG ACL, Freshness and Deletion Verifier
...
- `DeploymentUnit`
- `ConformanceRun`
- `RAGACLFreshnessAndDeletionVerifierRun`
- `RAGACLFreshnessAndDeletionVerifierDecision`

Required semantic capabilities:

- Document/segment ACL propagation
- Point-in-time authorization check
- Freshness watermark and stale-answer policy
- Deletion across dense/sparse/graph/cache/memory
- Residual copy and backup accounting
...
- `acl-retrieval-results.json`
- `freshness-sla-report.json`
- `deletion-proof.json`
- `residual-copy-ledger.json`
...
- **ACL metadata bypass** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **stale authorization cache** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **deleted chunk citation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **backup resurrection** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-tenant graph edge** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- revoked access immediate denial
- freshness watermark
