...
description: "Run FRT-2501 Task Completion Test Generator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2501"
  source_name: "frt-2501-task-completion-test-generator"
  source_sha256: "sha256:8dab7438b8031ae81d983730030d60ef5911a5152aa3bf77203103378610e046"
  batch: "G25"
...
- Runtime catalog key: `FRT-2501` / `frt-2501-task-completion-test-generator`.
...
在G25范围内实现 **Task Completion Test Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Task Completion Test Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2501Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2501EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2501FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2501CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2501-task-completion-test-generator/
packages/runtime/g25/frt-2501-task-completion-test-generator/
services/control-plane/g25/frt-2501-task-completion-test-generator/
apps/web-console/src/features/g25/frt-2501-task-completion-test-generator/
apps/admin-console/src/features/g25/frt-2501-task-completion-test-generator/
tests/g25/frt-2501-task-completion-test-generator/
```
...
```text
POST /v1/skills/frt-2501/runs
GET  /v1/skills/frt-2501/runs/{run_id}
POST /v1/skills/frt-2501/runs/{run_id}/verify
GET  /v1/skills/frt-2501/runs/{run_id}/findings
GET  /v1/skills/frt-2501/runs/{run_id}/evidence
```
