---
name: agentic-runtime-domain-model-lifecycle-and-state-machine
description: "Implement Batch 45B Agentic AI Runtime、Orchestration、Memory、Tools与Evals canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Agent、Workflow、Tool、Memory、Context、Plan、Execution、Guardrail、Evaluation与Human Handoff."
---
...
Implement Batch 45B Agentic AI Runtime、Orchestration、Memory、Tools与Evals canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Agent、Workflow、Tool、Memory、Context、Plan、Execution、Guardrail、Evaluation与Human Handoff.
...
5. Write unresolved domain assumptions to `docs/implementation/agentic-runtime-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
agentic_runtime_domain_model_lifecycle_and_state_machine_manifest.json
agentic_runtime_domain_model_lifecycle_and_state_machine_state.json
agentic_runtime_domain_model_lifecycle_and_state_machine_decision.json
agentic_runtime_domain_model_lifecycle_and_state_machine_reconciliation.json
agentic_runtime_domain_model_lifecycle_and_state_machine_evidence.json
```
