---
name: github-credential-lease-clone-fetch-push-and-revocation
description: "Implement short-lived installation credential leases for clone, fetch, compare, push, PR, and checks with purpose scopes and revocation."
---
...
Implement short-lived installation credential leases for clone, fetch, compare, push, PR, and checks with purpose scopes and revocation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-credential-lease-clone-fetch-push-and-revocation-baseline.md`.
...
```text
github_credential_lease_clone_fetch_push_and_revocation_manifest.json
github_credential_lease_clone_fetch_push_and_revocation_decision.json
github_credential_lease_clone_fetch_push_and_revocation_evidence.json
```
