---
name: reviewer-calibration-and-gold-check
description: Use this skill when Elmos must perform reviewer calibration and gold check as part of the 14-human-governance-operations production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# reviewer-calibration-and-gold-check

## 能力目标

通过标准样本、盲测和一致性指标校准审阅质量。
