...
description: "Run FRT-2607 Mutation Test Coordinator for FRT G26 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2607"
  source_name: "frt-2607-mutation-test-coordinator"
  source_sha256: "sha256:2c7e6b7b5b57e9ab3e1a1e12ec846bd3338f691cf9e1154ba62ac09fb13a106a"
  batch: "G26"
...
- Runtime catalog key: `FRT-2607` / `frt-2607-mutation-test-coordinator`.
...
在G26范围内实现 **Mutation Test Coordinator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Requirement/Acceptance/State Machine派生Test Obligation; Unit/Component/Contract/Integration/Journey分层协调; Differential、Mutation、Visual/Semantic、Security和Performance Regression。

## When to Use

- 实现或修改与 **Mutation Test Coordinator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2607Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2607EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2607FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2607CertificateFragment`：供G26批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g26/frt-2607-mutation-test-coordinator/
packages/runtime/g26/frt-2607-mutation-test-coordinator/
services/control-plane/g26/frt-2607-mutation-test-coordinator/
apps/web-console/src/features/g26/frt-2607-mutation-test-coordinator/
apps/admin-console/src/features/g26/frt-2607-mutation-test-coordinator/
tests/g26/frt-2607-mutation-test-coordinator/
```
...
```text
POST /v1/skills/frt-2607/runs
GET  /v1/skills/frt-2607/runs/{run_id}
POST /v1/skills/frt-2607/runs/{run_id}/verify
GET  /v1/skills/frt-2607/runs/{run_id}/findings
GET  /v1/skills/frt-2607/runs/{run_id}/evidence
```
