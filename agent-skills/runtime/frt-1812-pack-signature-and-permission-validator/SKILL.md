...
description: "Run FRT-1812 Pack Signature and Permission Validator for FRT G18 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1812"
  source_name: "frt-1812-pack-signature-and-permission-validator"
  source_sha256: "sha256:db8c6f9f585b78bbec68bdf3476885933b6c65d467b1da27c0d46ce71e7a8116"
  batch: "G18"
...
- Runtime catalog key: `FRT-1812` / `frt-1812-pack-signature-and-permission-validator`.
...
# FRT-1812 — Pack Signature and Permission Validator

## Objective

在G18范围内实现 **Pack Signature and Permission Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：将真实项目差异封装为可组合Overlay而非硬编码核心; Pack声明Provides/Requires/Conflicts/Permissions/Versions; 确定性解析优先级和冲突。

## When to Use

- 实现或修改与 **Pack Signature and Permission Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1812Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1812EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1812FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1812CertificateFragment`：供G18批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g18/frt-1812-pack-signature-and-permission-validator/
packages/runtime/g18/frt-1812-pack-signature-and-permission-validator/
services/control-plane/g18/frt-1812-pack-signature-and-permission-validator/
apps/web-console/src/features/g18/frt-1812-pack-signature-and-permission-validator/
apps/admin-console/src/features/g18/frt-1812-pack-signature-and-permission-validator/
tests/g18/frt-1812-pack-signature-and-permission-validator/
```
...
```text
POST /v1/skills/frt-1812/runs
GET  /v1/skills/frt-1812/runs/{run_id}
POST /v1/skills/frt-1812/runs/{run_id}/verify
GET  /v1/skills/frt-1812/runs/{run_id}/findings
GET  /v1/skills/frt-1812/runs/{run_id}/evidence
```
