---
name: execution-operations-cockpit-slo-capacity-forecast-and-runbooks
description: "Implement site/fleet operations dashboards, stream health, offline readiness, SLOs, error budgets, capacity forecasts, typed JIT actions, incidents, and runbooks."
---
...
Implement site/fleet operations dashboards, stream health, offline readiness, SLOs, error budgets, capacity forecasts, typed JIT actions, incidents, and runbooks.
...
4. Record unresolved provider/version assumptions in `docs/implementation/execution-operations-cockpit-slo-capacity-forecast-and-runbooks-baseline.md`.
...
```text
execution_operations_cockpit_slo_capacity_forecast_and_runbooks_manifest.json
execution_operations_cockpit_slo_capacity_forecast_and_runbooks_decision.json
execution_operations_cockpit_slo_capacity_forecast_and_runbooks_evidence.json
```
