---
name: data-migration-lineage-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Data Migration and Lineage Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T116"
  source_name: "data-migration-lineage-gate"
  source_sha256: "sha256:14ced9190bfbfd69e13b73b5af28be6ac9d4c37c19ca2a9c7286da1a40a11679"
...
# T116 — Data Migration and Lineage Gate

## 1. Objective

Verify complete, reversible where possible, reconciled and lineage-preserving data movement.
...
- `CASE-0591` [HIGH] Data Migration and Lineage Gate: Representative path
- `CASE-0592` [HIGH] Data Migration and Lineage Gate: Boundary path
- `CASE-0593` [HIGH] Data Migration and Lineage Gate: Invalid or hostile input
- `CASE-0594` [HIGH] Data Migration and Lineage Gate: Injected dependency failure
- `CASE-0595` [CRITICAL] Data Migration and Lineage Gate: Security or safety violation
- `CASE-0596` [HIGH] Data Migration and Lineage Gate: Replay and idempotency
- `CASE-0597` [HIGH] Data Migration and Lineage Gate: Version or environment drift
- `CASE-0598` [MEDIUM] Data Migration and Lineage Gate: Moderate scale
- `CASE-0599` [CRITICAL] Data Migration and Lineage Gate: Evidence tamper
- `CASE-0600` [HIGH] Data Migration and Lineage Gate: Recovery and final evidence
