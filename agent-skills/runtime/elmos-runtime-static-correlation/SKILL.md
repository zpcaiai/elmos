...
description: Use this skill when Elmos must perform runtime static correlation as part of the 02-repository-semantic-intelligence
...
把生产 Trace、SQL、异常和性能热点映射回静态语义实体。
