...
description: "Run FRT-1706 Flutter to ArkUI Route Pack for FRT G17 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1706"
  source_name: "frt-1706-flutter-to-arkui-route-pack"
  source_sha256: "sha256:43d39d9dfe23c8b54d4d70bf649fd5b15f7e1dc42e3b5f1aedf91dfea53e7486"
  batch: "G17"
...
- Runtime catalog key: `FRT-1706` / `frt-1706-flutter-to-arkui-route-pack`.
...
# FRT-1706 — Flutter to ArkUI Route Pack

## Objective

在G17范围内实现 **Flutter to ArkUI Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：补齐小程序/ArkUI/Flutter六个方向; 统一移动Navigation、Lifecycle、Permission、Storage和Native能力; 验证直接与间接三角路径。

## When to Use

- 实现或修改与 **Flutter to ArkUI Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1706Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1706EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1706FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1706CertificateFragment`：供G17批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g17/frt-1706-flutter-to-arkui-route-pack/
packages/runtime/g17/frt-1706-flutter-to-arkui-route-pack/
services/control-plane/g17/frt-1706-flutter-to-arkui-route-pack/
apps/web-console/src/features/g17/frt-1706-flutter-to-arkui-route-pack/
apps/admin-console/src/features/g17/frt-1706-flutter-to-arkui-route-pack/
tests/g17/frt-1706-flutter-to-arkui-route-pack/
```
...
```text
POST /v1/skills/frt-1706/runs
GET  /v1/skills/frt-1706/runs/{run_id}
POST /v1/skills/frt-1706/runs/{run_id}/verify
GET  /v1/skills/frt-1706/runs/{run_id}/findings
GET  /v1/skills/frt-1706/runs/{run_id}/evidence
```
