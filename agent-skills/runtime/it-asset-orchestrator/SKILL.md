---
name: it-asset-orchestrator
description: "Implement Batch 47C IT Asset、CMDB、Endpoint、Software与License Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Asset、Configuration Item、Relationship、Endpoint、Software Installation、License、Warranty、Lifecycle与Discovery."
---

# It Asset Orchestrator

## Objective

Implement Batch 47C IT Asset、CMDB、Endpoint、Software与License Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Asset、Configuration Item、Relationship、Endpoint、Software Installation、License、Warranty、Lifecycle与Discovery.
...
5. Write unresolved domain assumptions to `docs/implementation/it-asset-orchestrator-baseline.md`.
...
```text
it_asset_orchestrator_manifest.json
it_asset_orchestrator_state.json
it_asset_orchestrator_decision.json
it_asset_orchestrator_reconciliation.json
it_asset_orchestrator_evidence.json
```
