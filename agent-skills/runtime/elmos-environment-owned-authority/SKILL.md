---
name: environment-owned-authority
description: Use this skill when Elmos must perform environment owned authority as part of the 11-security-privacy-compliance production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
权限归属于实际执行环境而非 Thread 全局状态，恢复后仍保持原始边界。
