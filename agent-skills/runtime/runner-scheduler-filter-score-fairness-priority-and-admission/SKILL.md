---
name: runner-scheduler-filter-score-fairness-priority-and-admission
description: "Implement deterministic scheduler filtering, scoring, priorities, fairness, quotas, starvation prevention, admission, simulation, and explanations."
---
...
Implement deterministic scheduler filtering, scoring, priorities, fairness, quotas, starvation prevention, admission, simulation, and explanations.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-scheduler-filter-score-fairness-priority-and-admission-baseline.md`.
...
```text
runner_scheduler_filter_score_fairness_priority_and_admission_manifest.json
runner_scheduler_filter_score_fairness_priority_and_admission_decision.json
runner_scheduler_filter_score_fairness_priority_and_admission_evidence.json
```
