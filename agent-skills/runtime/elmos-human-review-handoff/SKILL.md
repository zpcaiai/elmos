...
description: "Invoke the bounded repository handler for elmos-human-review-handoff while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P04:human-review-handoff"
  source_name: "elmos-human-review-handoff"
  installed_name: "elmos-human-review-handoff"
  source_logical_path: "04-elmos-agent-orchestration-software-factory/skills/human-review-handoff/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/04-elmos-agent-orchestration-software-factory/skills/human-review-handoff/SKILL.md.source-data"
  source_materialized_path: "04-elmos-agent-orchestration-software-factory/skills/human-review-handoff/SKILL.md.source-data"
  source_sha256: "sha256:78c490c127e0bf81e3fece9c0c598bfe027695e21beb4abfe67b0ea596667b54"
...
- This is a deterministic repository wrapper for `04-elmos-agent-orchestration-software-factory/skills/human-review-handoff/SKILL.md` at `sha256:78c490c127e0bf81e3fece9c0c598bfe027695e21beb4abfe67b0ea596667b54`.
- Its immutable source/runtime identity is `elmos-human-review-handoff`; its active installed identity is `elmos-human-review-handoff`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-human-review-handoff --request <file>
```
