...
description: Use this skill when Elmos must perform domain proof and certification pack as part of the 15-domain-engineering-packs
...
- 业务线：`evaluation-certification`；包：`15-domain-engineering-packs`。
