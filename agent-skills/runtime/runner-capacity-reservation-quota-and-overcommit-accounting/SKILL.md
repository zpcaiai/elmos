---
name: runner-capacity-reservation-quota-and-overcommit-accounting
description: "Implement multidimensional runner capacity, reservations, quotas, budgets, overcommit policies, accounting, release, and capacity reconciliation."
---
...
Implement multidimensional runner capacity, reservations, quotas, budgets, overcommit policies, accounting, release, and capacity reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/runner-capacity-reservation-quota-and-overcommit-accounting-baseline.md`.
...
```text
runner_capacity_reservation_quota_and_overcommit_accounting_manifest.json
runner_capacity_reservation_quota_and_overcommit_accounting_decision.json
runner_capacity_reservation_quota_and_overcommit_accounting_evidence.json
```
