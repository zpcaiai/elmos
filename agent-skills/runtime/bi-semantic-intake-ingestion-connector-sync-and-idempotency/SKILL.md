---
name: bi-semantic-intake-ingestion-connector-sync-and-idempotency
description: "Implement Batch 44B BI、Semantic Metrics与Decision Intelligence intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics."
---
...
Implement Batch 44B BI、Semantic Metrics与Decision Intelligence intake, source ingestion, connector contracts, synchronization, idempotency, watermarks and backfill, covering Semantic Model、Metric、Dimension、Dashboard、Report、Query、Alert、Decision、Narrative与Self-service Analytics.
...
5. Write unresolved domain assumptions to `docs/implementation/bi-semantic-intake-ingestion-connector-sync-and-idempotency-baseline.md`.
...
```text
bi_semantic_intake_ingestion_connector_sync_and_idempotency_manifest.json
bi_semantic_intake_ingestion_connector_sync_and_idempotency_state.json
bi_semantic_intake_ingestion_connector_sync_and_idempotency_decision.json
bi_semantic_intake_ingestion_connector_sync_and_idempotency_reconciliation.json
bi_semantic_intake_ingestion_connector_sync_and_idempotency_evidence.json
```
