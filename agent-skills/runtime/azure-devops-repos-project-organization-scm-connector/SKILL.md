---
name: azure-devops-repos-project-organization-scm-connector
description: "Implement Azure DevOps organizations, projects, Git repositories, refs, pull requests, policies, service identities, API versions, and reconciliation."
---
...
Implement Azure DevOps organizations, projects, Git repositories, refs, pull requests, policies, service identities, API versions, and reconciliation.
...
4. Record unresolved provider/version assumptions in `docs/implementation/azure-devops-repos-project-organization-scm-connector-baseline.md`.
...
```text
azure_devops_repos_project_organization_scm_connector_manifest.json
azure_devops_repos_project_organization_scm_connector_decision.json
azure_devops_repos_project_organization_scm_connector_evidence.json
```
