---
name: elmos-root-cause-effectiveness-verification-governor
description: Implement and independently certify root cause and corrective-action effectiveness governor, including evaluate causal analysis quality and alternative hypotheses, test corrective action under original and adjacent failure scenarios and monitor recurrence and unintended effects before final closure.
version: 4.0.0
...
# Root Cause and Corrective-Action Effectiveness Governor

## Objective

Implement and independently certify root cause and corrective-action effectiveness governor, including evaluate causal analysis quality and alternative hypotheses, test corrective action under original and adjacent failure scenarios and monitor recurrence and unintended effects before final closure.
...
- `RootCauseAndCorrectiveActionEffectivenessGovernorProfile`
- `RootCauseAndCorrectiveActionEffectivenessGovernorRun`
- `RootCauseAndCorrectiveActionEffectivenessGovernorFinding`
- `RootCauseAndCorrectiveActionEffectivenessGovernorDecision`
- `RootCauseAndCorrectiveActionEffectivenessGovernorEvidence`

Required semantic capabilities:

- evaluate causal analysis quality and alternative hypotheses
- test corrective action under original and adjacent failure scenarios
- monitor recurrence and unintended effects before final closure
...
- `elmos-nonconformity-corrective-action-capa-controller`

## Primary Outputs

- `artifacts/elmos-root-cause-effectiveness-verification-governor/profile.yaml`
- `artifacts/elmos-root-cause-effectiveness-verification-governor/plan.json`
- `artifacts/elmos-root-cause-effectiveness-verification-governor/result.json`
- `artifacts/elmos-root-cause-effectiveness-verification-governor/evidence/`
- `artifacts/elmos-root-cause-effectiveness-verification-governor/assurance-case.json`
...
- **five-whys stops at human error** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **fix passes exact regression but not causal class** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **effectiveness review occurs too soon** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: evaluate causal analysis quality and alternative hypotheses
- native scenario: test corrective action under original and adjacent failure scenarios
- native scenario: monitor recurrence and unintended effects before final closure
