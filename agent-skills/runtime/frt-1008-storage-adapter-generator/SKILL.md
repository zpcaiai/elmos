...
description: "Run FRT-1008 Storage Adapter Generator for FRT G10 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1008"
  source_name: "frt-1008-storage-adapter-generator"
  source_sha256: "sha256:d53c1893d976cb0336aa9682ff79d745c75f56f5cd5208d4c6e2320e21836821"
  batch: "G10"
...
- Runtime catalog key: `FRT-1008` / `frt-1008-storage-adapter-generator`.
...
# FRT-1008 — Storage Adapter Generator

## Objective

在G10范围内实现 **Storage Adapter Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：保持Route、History、Guard和Deep Link语义; 表单Validation、错误、草稿和提交幂等完整; API、Event、Storage和Realtime边界显式。

## When to Use

- 实现或修改与 **Storage Adapter Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1008Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1008EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1008FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1008CertificateFragment`：供G10批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g10/frt-1008-storage-adapter-generator/
packages/runtime/g10/frt-1008-storage-adapter-generator/
services/control-plane/g10/frt-1008-storage-adapter-generator/
apps/web-console/src/features/g10/frt-1008-storage-adapter-generator/
apps/admin-console/src/features/g10/frt-1008-storage-adapter-generator/
tests/g10/frt-1008-storage-adapter-generator/
```
...
```text
POST /v1/skills/frt-1008/runs
GET  /v1/skills/frt-1008/runs/{run_id}
POST /v1/skills/frt-1008/runs/{run_id}/verify
GET  /v1/skills/frt-1008/runs/{run_id}/findings
GET  /v1/skills/frt-1008/runs/{run_id}/evidence
```
