---
name: scm-webhook-polling-watermark-backfill-and-reconciliation
description: "Implement a shared webhook, polling, cursor, watermark, backfill, deduplication, replay, and reconciliation layer across SCM providers."
---
...
Implement a shared webhook, polling, cursor, watermark, backfill, deduplication, replay, and reconciliation layer across SCM providers.
...
4. Record unresolved provider/version assumptions in `docs/implementation/scm-webhook-polling-watermark-backfill-and-reconciliation-baseline.md`.
...
```text
scm_webhook_polling_watermark_backfill_and_reconciliation_manifest.json
scm_webhook_polling_watermark_backfill_and_reconciliation_decision.json
scm_webhook_polling_watermark_backfill_and_reconciliation_evidence.json
```
