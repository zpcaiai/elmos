...
description: "Invoke the bounded repository handler for elmos-long-context-completeness-auditor while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P06:long-context-completeness-auditor"
  source_name: "elmos-long-context-completeness-auditor"
  installed_name: "elmos-long-context-completeness-auditor"
  source_logical_path: "06-elmos-intelligent-model-router/skills/long-context-completeness-auditor/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/06-elmos-intelligent-model-router/skills/long-context-completeness-auditor/SKILL.md.source-data"
  source_materialized_path: "06-elmos-intelligent-model-router/skills/long-context-completeness-auditor/SKILL.md.source-data"
  source_sha256: "sha256:654a2e8a3b43615f6724fd3b2564952dbe4edea4b7adb26bee2eef676515755b"
...
# elmos-long-context-completeness-auditor
...
- This is a deterministic repository wrapper for `06-elmos-intelligent-model-router/skills/long-context-completeness-auditor/SKILL.md` at `sha256:654a2e8a3b43615f6724fd3b2564952dbe4edea4b7adb26bee2eef676515755b`.
- Its immutable source/runtime identity is `elmos-long-context-completeness-auditor`; its active installed identity is `elmos-long-context-completeness-auditor`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-long-context-completeness-auditor --request <file>
```
