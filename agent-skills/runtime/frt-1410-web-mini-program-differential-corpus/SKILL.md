...
description: "Run FRT-1410 Web Mini Program Differential Corpus for FRT G14 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1410"
  source_name: "frt-1410-web-mini-program-differential-corpus"
  source_sha256: "sha256:964f49b6487533b5dc405861859da8422824303c8086e62b7a7ecb37e2da22d5"
  batch: "G14"
...
- Runtime catalog key: `FRT-1410` / `frt-1410-web-mini-program-differential-corpus`.
...
# FRT-1410 — Web Mini Program Differential Corpus

## Objective

在G14范围内实现 **Web Mini Program Differential Corpus**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：处理WXML/WXSS/setData/Page/Component与Web组件模型; 处理分包、基础库、授权、支付、Storage和页面栈限制; Web缺失能力和小程序限制显式Gap/Unsupported。

## When to Use

- 实现或修改与 **Web Mini Program Differential Corpus** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1410Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1410EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1410FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1410CertificateFragment`：供G14批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g14/frt-1410-web-mini-program-differential-corpus/
packages/runtime/g14/frt-1410-web-mini-program-differential-corpus/
services/control-plane/g14/frt-1410-web-mini-program-differential-corpus/
apps/web-console/src/features/g14/frt-1410-web-mini-program-differential-corpus/
apps/admin-console/src/features/g14/frt-1410-web-mini-program-differential-corpus/
tests/g14/frt-1410-web-mini-program-differential-corpus/
```
...
```text
POST /v1/skills/frt-1410/runs
GET  /v1/skills/frt-1410/runs/{run_id}
POST /v1/skills/frt-1410/runs/{run_id}/verify
GET  /v1/skills/frt-1410/runs/{run_id}/findings
GET  /v1/skills/frt-1410/runs/{run_id}/evidence
```
