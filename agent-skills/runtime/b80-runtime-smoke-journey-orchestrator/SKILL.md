---
name: b80-runtime-smoke-journey-orchestrator
description: "Use when ELMOS must coordinate and control Runtime Smoke Journey Orchestrator for cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification, preserving ownership, compatibility, security, reproducibility, and evidence boundaries. Triggers: Runtime Smoke Journey Orchestrator, Batch 80, cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification."
metadata:
  id: PG413
  batch: 80
  version: 1.0.0
...
# PG413 — Runtime Smoke Journey Orchestrator
...
Use for `runtime-smoke-journey-orchestrator` tasks involving cross-language asset graphs, build orchestration, contract synchronization, environment parity, identity, provenance, local CI reproduction, runtime journeys, repair, performance budgets, migration compatibility, and final certification.
...
Upstream dependencies: `PG183`, `PG184`, `PG185`, `PG191`, `PG405`, `PG412`.
...
- `runtime_smoke_journey_orchestrator_plan.json`
- `runtime_smoke_journey_orchestrator_artifacts/`
- `runtime_smoke_journey_orchestrator_verification.json`
