...
description: "Run FRT-0712 Incremental Regeneration and Three-Way Merge for FRT G07 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0712"
  source_name: "frt-0712-incremental-regeneration-and-three-way-merge"
  source_sha256: "sha256:cb02e691c62a306aaa756198e55958178ea335bf14a47471367c62f514449329"
  batch: "G07"
...
- Runtime catalog key: `FRT-0712` / `frt-0712-incremental-regeneration-and-three-way-merge`.
...
# FRT-0712 — Incremental Regeneration and Three-Way Merge

## Objective

在G07范围内实现 **Incremental Regeneration and Three-Way Merge**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Typed IR经规则Pass降低到目标原生AST; Gap生成Typed Hole而非空实现; Format/Analyze/Build驱动有界确定性修复。

## When to Use

- 实现或修改与 **Incremental Regeneration and Three-Way Merge** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0712Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0712EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0712FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0712CertificateFragment`：供G07批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g07/frt-0712-incremental-regeneration-and-three-way-merge/
packages/runtime/g07/frt-0712-incremental-regeneration-and-three-way-merge/
services/control-plane/g07/frt-0712-incremental-regeneration-and-three-way-merge/
apps/web-console/src/features/g07/frt-0712-incremental-regeneration-and-three-way-merge/
apps/admin-console/src/features/g07/frt-0712-incremental-regeneration-and-three-way-merge/
tests/g07/frt-0712-incremental-regeneration-and-three-way-merge/
```
...
```text
POST /v1/skills/frt-0712/runs
GET  /v1/skills/frt-0712/runs/{run_id}
POST /v1/skills/frt-0712/runs/{run_id}/verify
GET  /v1/skills/frt-0712/runs/{run_id}/findings
GET  /v1/skills/frt-0712/runs/{run_id}/evidence
```
