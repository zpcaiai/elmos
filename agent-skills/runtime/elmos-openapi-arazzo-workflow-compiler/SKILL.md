---
name: elmos-openapi-arazzo-workflow-compiler
description: Compile API operations, links, callbacks, security, examples and multi-step workflows into exact OpenAPI and Arazzo contracts with executable client/server conformance.
version: 4.0.0
...
# OpenAPI and Arazzo Workflow Compiler
...
- `OpenAPIAndArazzoWorkflowCompilerProfile`
- `OpenAPIAndArazzoWorkflowCompilerPlan`
- `OpenAPIAndArazzoWorkflowCompilerRun`
- `OpenAPIAndArazzoWorkflowCompilerDecision`

Required semantic capabilities:

- emit OpenAPI 3.2 operation and schema contracts
- emit Arazzo 1.1 multi-step workflows
- bind authentication, callbacks and runtime expressions
- generate positive and negative workflow fixtures
- verify mixed-version clients, servers and rollback
...
- `artifacts/elmos-openapi-arazzo-workflow-compiler/profile.yaml`
- `artifacts/elmos-openapi-arazzo-workflow-compiler/plan.json`
- `artifacts/elmos-openapi-arazzo-workflow-compiler/result.json`
- `artifacts/elmos-openapi-arazzo-workflow-compiler/evidence/`
...
- **workflow references nonexistent operation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **runtime expression leaks secret** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **security requirement lost in SDK** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **callback side effect not reconciled** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **breaking workflow change misclassified** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: emit OpenAPI 3.2 operation and schema contracts
- native scenario: emit Arazzo 1.1 multi-step workflows
- native scenario: bind authentication, callbacks and runtime expressions
- native scenario: generate positive and negative workflow fixtures
- native scenario: verify mixed-version clients, servers and rollback
