...
description: "Run FRT-2509 Keyboard, Pointer, Touch and Gesture Matrix for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2509"
  source_name: "frt-2509-keyboard-pointer-touch-and-gesture-matrix"
  source_sha256: "sha256:9a06d8ff3535c3a96af9e95511e7cf88f912676f36cfd07b41fc000882e5cdfa"
  batch: "G25"
...
- Runtime catalog key: `FRT-2509` / `frt-2509-keyboard-pointer-touch-and-gesture-matrix`.
...
在G25范围内实现 **Keyboard, Pointer, Touch and Gesture Matrix**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Keyboard, Pointer, Touch and Gesture Matrix** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2509Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2509EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2509FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2509CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2509-keyboard-pointer-touch-and-gesture-matrix/
packages/runtime/g25/frt-2509-keyboard-pointer-touch-and-gesture-matrix/
services/control-plane/g25/frt-2509-keyboard-pointer-touch-and-gesture-matrix/
apps/web-console/src/features/g25/frt-2509-keyboard-pointer-touch-and-gesture-matrix/
apps/admin-console/src/features/g25/frt-2509-keyboard-pointer-touch-and-gesture-matrix/
tests/g25/frt-2509-keyboard-pointer-touch-and-gesture-matrix/
```
...
```text
POST /v1/skills/frt-2509/runs
GET  /v1/skills/frt-2509/runs/{run_id}
POST /v1/skills/frt-2509/runs/{run_id}/verify
GET  /v1/skills/frt-2509/runs/{run_id}/findings
GET  /v1/skills/frt-2509/runs/{run_id}/evidence
```
