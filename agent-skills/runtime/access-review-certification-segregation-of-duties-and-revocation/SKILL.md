---
name: access-review-certification-segregation-of-duties-and-revocation
description: "Implement periodic access reviews, certification, segregation-of-duties analysis, orphan access detection, reviewer workflows, revocation, and immutable evidence."
---
...
Implement periodic access reviews, certification, segregation-of-duties analysis, orphan access detection, reviewer workflows, revocation, and immutable evidence.

This Skill belongs to **Batch 34B** and must extend the approved ELMOS domain rather than create parallel Tenant, Identity, Artifact, Policy, Workflow, Audit, Contract or Finding aggregates.
...
4. Record unresolved provider/version assumptions in `docs/implementation/access-review-certification-segregation-of-duties-and-revocation-baseline.md`.
...
```text
access_review_certification_segregation_of_duties_and_revocation_manifest.json
access_review_certification_segregation_of_duties_and_revocation_decision.json
access_review_certification_segregation_of_duties_and_revocation_evidence.json
```
...
- Treat tenant and identity facts as security boundaries.
- Use default deny and verified context; never trust caller-selected tenant.
- Use immutable grants/leases and auditable revocation.
- Preserve cross-tenant isolation in data, cache, events, workflows and artifacts.
