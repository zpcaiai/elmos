...
- Activate when the task requires: exploit content-addressed caching, target-level parallelism and remote execution while preserving tenant isolation and evidence integrity.
