...
- Invoke this repository Skill as `$pm-b10-backend-frontend-semantic-ir`.
- Immutable source identity: `batch-10-backend-frontend-semantic-ir` in `precision-migration-b01-44` (B10).
- Runtime adapter: `semantic-recovery-and-ir`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b10-backend-frontend-semantic-ir`.
...
- 当任务涉及 **backend-application-ir** 时，调用 `../pm-b10-backend-application-ir/SKILL.md`。
- 当任务涉及 **controller-endpoint-ir** 时，调用 `../pm-b10-controller-endpoint-ir/SKILL.md`。
- 当任务涉及 **domain-and-service-ir** 时，调用 `../pm-b10-domain-and-service-ir/SKILL.md`。
- 当任务涉及 **repository-and-orm-ir** 时，调用 `../pm-b10-repository-and-orm-ir/SKILL.md`。
- 当任务涉及 **dependency-injection-ir** 时，调用 `../pm-b10-dependency-injection-ir/SKILL.md`。
- 当任务涉及 **message-consumer-ir** 时，调用 `../pm-b10-message-consumer-ir/SKILL.md`。
- 当任务涉及 **scheduled-job-ir** 时，调用 `../pm-b10-scheduled-job-ir/SKILL.md`。
- 当任务涉及 **frontend-component-ir** 时，调用 `../pm-b10-frontend-component-ir/SKILL.md`。
- 当任务涉及 **ui-layout-constraint-ir** 时，调用 `../pm-b10-ui-layout-constraint-ir/SKILL.md`。
- 当任务涉及 **event-and-lifecycle-ir** 时，调用 `../pm-b10-event-and-lifecycle-ir/SKILL.md`。
- 当任务涉及 **route-navigation-ir** 时，调用 `../pm-b10-route-navigation-ir/SKILL.md`。
- 当任务涉及 **platform-capability-ir** 时，调用 `../pm-b10-platform-capability-ir/SKILL.md`。
