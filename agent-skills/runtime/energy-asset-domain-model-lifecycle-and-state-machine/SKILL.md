---
name: energy-asset-domain-model-lifecycle-and-state-machine
description: "Implement Batch 53C Energy Asset、Field Service、Reliability与Sustainability canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Asset、Inspection、Work Order、Crew、Permit、Outage、Reliability Metric、Emission、Maintenance与Safety Case."
---

# Energy Asset Domain Model Lifecycle And State Machine

## Objective

Implement Batch 53C Energy Asset、Field Service、Reliability与Sustainability canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Asset、Inspection、Work Order、Crew、Permit、Outage、Reliability Metric、Emission、Maintenance与Safety Case.
...
5. Write unresolved domain assumptions to `docs/implementation/energy-asset-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
energy_asset_domain_model_lifecycle_and_state_machine_manifest.json
energy_asset_domain_model_lifecycle_and_state_machine_state.json
energy_asset_domain_model_lifecycle_and_state_machine_decision.json
energy_asset_domain_model_lifecycle_and_state_machine_reconciliation.json
energy_asset_domain_model_lifecycle_and_state_machine_evidence.json
```
