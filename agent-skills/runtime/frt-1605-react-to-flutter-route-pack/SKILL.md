...
description: "Run FRT-1605 React to Flutter Route Pack for FRT G16 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1605"
  source_name: "frt-1605-react-to-flutter-route-pack"
  source_sha256: "sha256:38240b688effe716ea31fbeec2441ac3937dc86ca0a8c92299d7b055f38857e3"
  batch: "G16"
...
- Runtime catalog key: `FRT-1605` / `frt-1605-react-to-flutter-route-pack`.
...
# FRT-1605 — React to Flutter Route Pack

## Objective

在G16范围内实现 **React to Flutter Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射DOM/组件到Widget树而非逐元素复制; 处理Key、BuildContext、Controller、State和Navigator; 处理Plugin、Platform Channel、Web/Mobile能力差异。

## When to Use

- 实现或修改与 **React to Flutter Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1605Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1605EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1605FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1605CertificateFragment`：供G16批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g16/frt-1605-react-to-flutter-route-pack/
packages/runtime/g16/frt-1605-react-to-flutter-route-pack/
services/control-plane/g16/frt-1605-react-to-flutter-route-pack/
apps/web-console/src/features/g16/frt-1605-react-to-flutter-route-pack/
apps/admin-console/src/features/g16/frt-1605-react-to-flutter-route-pack/
tests/g16/frt-1605-react-to-flutter-route-pack/
```
...
```text
POST /v1/skills/frt-1605/runs
GET  /v1/skills/frt-1605/runs/{run_id}
POST /v1/skills/frt-1605/runs/{run_id}/verify
GET  /v1/skills/frt-1605/runs/{run_id}/findings
GET  /v1/skills/frt-1605/runs/{run_id}/evidence
```
