...
description: "Run the exact ELMOS Batch 81-95 slightly-strict Evidence Integrity Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T110"
  source_name: "evidence-integrity-gate"
  source_sha256: "sha256:2ec16d97862c3d3cdfff13e1e76f12380e8f52e0d8436ffa415fddf11a629a99"
...
# T110 — Evidence Integrity Gate

## 1. Objective

Detect missing, selectively omitted, reordered or tampered build, simulation, migration and approval evidence.
...
- `CASE-0531` [HIGH] Evidence Integrity Gate: Representative path
- `CASE-0532` [HIGH] Evidence Integrity Gate: Boundary path
- `CASE-0533` [HIGH] Evidence Integrity Gate: Invalid or hostile input
- `CASE-0534` [HIGH] Evidence Integrity Gate: Injected dependency failure
- `CASE-0535` [CRITICAL] Evidence Integrity Gate: Security or safety violation
- `CASE-0536` [HIGH] Evidence Integrity Gate: Replay and idempotency
- `CASE-0537` [HIGH] Evidence Integrity Gate: Version or environment drift
- `CASE-0538` [MEDIUM] Evidence Integrity Gate: Moderate scale
- `CASE-0539` [CRITICAL] Evidence Integrity Gate: Evidence tamper
- `CASE-0540` [HIGH] Evidence Integrity Gate: Recovery and final evidence
