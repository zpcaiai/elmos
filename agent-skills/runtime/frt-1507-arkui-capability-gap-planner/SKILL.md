...
description: "Run FRT-1507 ArkUI Capability Gap Planner for FRT G15 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1507"
  source_name: "frt-1507-arkui-capability-gap-planner"
  source_sha256: "sha256:562662fe1c0b7100c57ece55316c7992285065864b41ad8bcb3772f6da379a1e"
  batch: "G15"
...
- Runtime catalog key: `FRT-1507` / `frt-1507-arkui-capability-gap-planner`.
...
# FRT-1507 — ArkUI Capability Gap Planner

## Objective

在G15范围内实现 **ArkUI Capability Gap Planner**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：映射ArkUI状态装饰器、Builder、Navigation和生命周期; 处理Web DOM能力与ArkUI Native/Device差异; 生成真机/模拟器和Accessibility验证。

## When to Use

- 实现或修改与 **ArkUI Capability Gap Planner** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1507Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1507EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1507FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1507CertificateFragment`：供G15批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g15/frt-1507-arkui-capability-gap-planner/
packages/runtime/g15/frt-1507-arkui-capability-gap-planner/
services/control-plane/g15/frt-1507-arkui-capability-gap-planner/
apps/web-console/src/features/g15/frt-1507-arkui-capability-gap-planner/
apps/admin-console/src/features/g15/frt-1507-arkui-capability-gap-planner/
tests/g15/frt-1507-arkui-capability-gap-planner/
```
...
```text
POST /v1/skills/frt-1507/runs
GET  /v1/skills/frt-1507/runs/{run_id}
POST /v1/skills/frt-1507/runs/{run_id}/verify
GET  /v1/skills/frt-1507/runs/{run_id}/findings
GET  /v1/skills/frt-1507/runs/{run_id}/evidence
```
