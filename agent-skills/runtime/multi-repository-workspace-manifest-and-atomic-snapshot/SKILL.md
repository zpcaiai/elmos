---
name: multi-repository-workspace-manifest-and-atomic-snapshot
description: "Implement multi-repository workspace manifests, exact commits, atomic snapshot consistency, dependency ordering, partial failure handling, and resume."
---
...
Implement multi-repository workspace manifests, exact commits, atomic snapshot consistency, dependency ordering, partial failure handling, and resume.
...
4. Record unresolved provider/version assumptions in `docs/implementation/multi-repository-workspace-manifest-and-atomic-snapshot-baseline.md`.
...
```text
multi_repository_workspace_manifest_and_atomic_snapshot_manifest.json
multi_repository_workspace_manifest_and_atomic_snapshot_decision.json
multi_repository_workspace_manifest_and_atomic_snapshot_evidence.json
```
