---
name: b93-bpl-dcp-package-dependency-analyzer
description: "Use when ELMOS must run bpl dcp package dependency analyzer for Batch 93 Delphi / Object Pascal Modernization Pack. Preserve native semantics, safety boundaries, ownership, traceability, and fail-closed evidence; require real vendor toolchain execution for runtime claims."
metadata:
  source_package: "elmos-language-packs-batch81-95-complete"
  source_id: "PG370"
  source_name: "bpl-dcp-package-dependency-analyzer"
  source_sha256: "sha256:08d6f3b6d489584ee2577479f1a378009467150e8d87f78e165b11975f4ec6d0"
  batch: 93
  source_engine: "elmos.language-packs"
  source_status: "proposed"
  normalized_namespace: "language-pack"
---
# Batch 93 Language Pack / source PG370 — Bpl Dcp Package Dependency Analyzer

## 1. Objective

Analyze bpl dcp package dependency analyzer within the Delphi / Object Pascal Modernization Pack, preserving platform semantics, traceability, security, and reproducible evidence.
...
2. Process the relevant artifacts for Bpl Dcp Package Dependency Analyzer using the approved windows-industrial-legacy semantic contracts and toolchain versions.
...
- A representative valid delphi-object-pascal input produces all declared outputs for bpl-dcp-package-dependency-analyzer.
