---
name: github-scm-connector-orchestrator
description: "Implement GitHub Cloud and GHES repository connection, synchronization, credential, event, branch, pull-request, delivery, compatibility, and release-gate workflows."
---
...
Implement GitHub Cloud and GHES repository connection, synchronization, credential, event, branch, pull-request, delivery, compatibility, and release-gate workflows.
...
4. Record unresolved provider/version assumptions in `docs/implementation/github-scm-connector-orchestrator-baseline.md`.
...
```text
github_scm_connector_orchestrator_manifest.json
github_scm_connector_orchestrator_decision.json
github_scm_connector_orchestrator_evidence.json
```
