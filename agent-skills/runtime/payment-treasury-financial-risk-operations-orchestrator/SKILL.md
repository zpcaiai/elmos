---
name: payment-treasury-financial-risk-operations-orchestrator
description: "Implement Batch 39B end to end: payment facts, PSP and bank connectors, routing, virtual accounts, cash application, refunds, chargebacks, statements, FX, liquidity, cash forecasting, fraud, treasury controls, operations and release gates."
---
...
Implement Batch 39B end to end: payment facts, PSP and bank connectors, routing, virtual accounts, cash application, refunds, chargebacks, statements, FX, liquidity, cash forecasting, fraud, treasury controls, operations and release gates.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/payment-treasury-financial-risk-operations-orchestrator-baseline.md`.
...
```text
payment_treasury_financial_risk_operations_orchestrator_manifest.json
payment_treasury_financial_risk_operations_orchestrator_decision.json
payment_treasury_financial_risk_operations_orchestrator_reconciliation.json
payment_treasury_financial_risk_operations_orchestrator_evidence.json
```
