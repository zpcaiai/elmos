---
name: globalization-access-orchestrator
description: "Implement Batch 55A Globalization、Localization、Accessibility与Regional Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Locale、Language、Translation、Terminology、Content Variant、Regional Rule、Accessibility Requirement、Test与Exception."
---

# Globalization Access Orchestrator

## Objective

Implement Batch 55A Globalization、Localization、Accessibility与Regional Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Locale、Language、Translation、Terminology、Content Variant、Regional Rule、Accessibility Requirement、Test与Exception.
...
5. Write unresolved domain assumptions to `docs/implementation/globalization-access-orchestrator-baseline.md`.
...
```text
globalization_access_orchestrator_manifest.json
globalization_access_orchestrator_state.json
globalization_access_orchestrator_decision.json
globalization_access_orchestrator_reconciliation.json
globalization_access_orchestrator_evidence.json
```
