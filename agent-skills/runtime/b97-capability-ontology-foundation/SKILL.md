---
name: b97-capability-ontology-foundation
description: "Use when ELMOS must Define the canonical ELMOS capability vocabulary, hierarchy, boundaries and relation types used by every product line. Triggers: Capability Ontology Foundation, Canonical Capability Graph Consolidation Pack, capability taxonomy, relation vocabulary, bounded contexts, semantic definitions."
metadata:
  id: B97-S02
...
# B97-S02 — Capability Ontology Foundation

## Objective

Define the canonical ELMOS capability vocabulary, hierarchy, boundaries and relation types used by every product line.
...
Use this Skill when the approved task explicitly requires **Capability Ontology Foundation** or when the capability graph selects it as part of a minimal dependency closure.
...
```bash
python3 scripts/compile_skill_contract.py agent-skills/runtime/b97-capability-ontology-foundation/SKILL.md --out /tmp/capability_ontology_foundation.contract.json
```

```bash
python3 scripts/run_certification_gate.py --package . --scope B97-S02
```
...
- Reject or expose synonym collision.
- Reject or expose overloaded capability names.
- Reject or expose undefined relation types.
