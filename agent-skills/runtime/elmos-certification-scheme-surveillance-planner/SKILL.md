---
name: elmos-certification-scheme-surveillance-planner
description: Implement and independently certify certification scheme surveillance planner, including design periodic, event-driven, remote and on-site surveillance mix, select surveillance samples from change, incident, usage and risk signals and reassess continuing conformity without repeating irrelevant work.
version: 4.0.0
...
# Certification Scheme Surveillance Planner
...
- `CertificationSchemeSurveillancePlannerProfile`
- `CertificationSchemeSurveillancePlannerRun`
- `CertificationSchemeSurveillancePlannerFinding`
- `CertificationSchemeSurveillancePlannerDecision`
- `CertificationSchemeSurveillancePlannerEvidence`

Required semantic capabilities:

- design periodic, event-driven, remote and on-site surveillance mix
- select surveillance samples from change, incident, usage and risk signals
- reassess continuing conformity without repeating irrelevant work
...
- `elmos-certification-scheme-ownership-governor`
- `elmos-certificate-drift-revocation-controller`

## Primary Outputs

- `artifacts/elmos-certification-scheme-surveillance-planner/profile.yaml`
- `artifacts/elmos-certification-scheme-surveillance-planner/plan.json`
- `artifacts/elmos-certification-scheme-surveillance-planner/result.json`
- `artifacts/elmos-certification-scheme-surveillance-planner/evidence/`
- `artifacts/elmos-certification-scheme-surveillance-planner/assurance-case.json`
...
- **surveillance cadence ignores high-risk change rate** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider drift is not sampled** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **surveillance is announced so only staged evidence is observed** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: design periodic, event-driven, remote and on-site surveillance mix
- native scenario: select surveillance samples from change, incident, usage and risk signals
- native scenario: reassess continuing conformity without repeating irrelevant work
