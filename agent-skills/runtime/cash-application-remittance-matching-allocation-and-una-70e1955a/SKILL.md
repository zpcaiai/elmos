...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/cash-application-remittance-matching-allocation-and-una-70e1955a-baseline.md`.
