...
description: "Run FRT-2209 Business Journey Replay Generator for FRT G22 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2209"
  source_name: "frt-2209-business-journey-replay-generator"
  source_sha256: "sha256:c4caed5c13fb1030f077b5db09a78f09531ca7b8da25f966a461b42c2633defb"
  batch: "G22"
...
- Runtime catalog key: `FRT-2209` / `frt-2209-business-journey-replay-generator`.
...
在G22范围内实现 **Business Journey Replay Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Value Stream 与业务Outcome建模; 状态机可达性、终态、Timeout、Cancel、Unknown、Recovery完整性; 跨域Saga、幂等、补偿和Reconciliation。

## When to Use

- 实现或修改与 **Business Journey Replay Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2209Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2209EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2209FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2209CertificateFragment`：供G22批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g22/frt-2209-business-journey-replay-generator/
packages/runtime/g22/frt-2209-business-journey-replay-generator/
services/control-plane/g22/frt-2209-business-journey-replay-generator/
apps/web-console/src/features/g22/frt-2209-business-journey-replay-generator/
apps/admin-console/src/features/g22/frt-2209-business-journey-replay-generator/
tests/g22/frt-2209-business-journey-replay-generator/
```
...
```text
POST /v1/skills/frt-2209/runs
GET  /v1/skills/frt-2209/runs/{run_id}
POST /v1/skills/frt-2209/runs/{run_id}/verify
GET  /v1/skills/frt-2209/runs/{run_id}/findings
GET  /v1/skills/frt-2209/runs/{run_id}/evidence
```
