---
name: elmos-agent-arena-route-model-evaluator
description: Run controlled multi-agent/model/route competitions on hidden tasks using independent oracles, cost, safety and reproducibility evidence.
version: 4.0.0
...
# Agent Arena Route and Model Evaluator
...
- `AgentArenaRouteAndModelEvaluatorProfile`
- `AgentArenaRouteAndModelEvaluatorPlan`
- `AgentArenaRouteAndModelEvaluatorRun`
- `AgentArenaRouteAndModelEvaluatorDecision`

Required semantic capabilities:

- define blinded competitors and resource budgets
- execute repeated hidden task trials
- score correctness, safety, cost and latency
- estimate uncertainty and task-conditioned fit
- update route registry without global winner claims
...
- `artifacts/elmos-agent-arena-route-model-evaluator/profile.yaml`
- `artifacts/elmos-agent-arena-route-model-evaluator/plan.json`
- `artifacts/elmos-agent-arena-route-model-evaluator/result.json`
- `artifacts/elmos-agent-arena-route-model-evaluator/evidence/`
...
- **competitor gets different tools** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **benchmark leaked** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **judge favors style** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cost budget unequal** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **arena score becomes production certificate** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: define blinded competitors and resource budgets
- native scenario: execute repeated hidden task trials
- native scenario: score correctness, safety, cost and latency
- native scenario: estimate uncertainty and task-conditioned fit
- native scenario: update route registry without global winner claims
