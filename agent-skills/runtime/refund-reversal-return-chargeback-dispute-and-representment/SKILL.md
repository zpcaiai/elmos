---
name: refund-reversal-return-chargeback-dispute-and-representment
description: "Implement refunds, payment reversals, bank returns, card chargebacks, disputes, evidence, representment, financial postings and duplicate-loss controls."
---
...
Implement refunds, payment reversals, bank returns, card chargebacks, disputes, evidence, representment, financial postings and duplicate-loss controls.
...
4. Write unresolved accounting, tax, payment-provider, banking, metric or planning assumptions to `docs/implementation/refund-reversal-return-chargeback-dispute-and-representment-baseline.md`.
...
```text
refund_reversal_return_chargeback_dispute_and_representment_manifest.json
refund_reversal_return_chargeback_dispute_and_representment_decision.json
refund_reversal_return_chargeback_dispute_and_representment_reconciliation.json
refund_reversal_return_chargeback_dispute_and_representment_evidence.json
```
