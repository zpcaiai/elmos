---
name: failure-recovery-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Failure Recovery Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T109"
  source_name: "failure-recovery-gate"
  source_sha256: "sha256:595d79983821ff2bdf06e65d1c1a2554dbd404a66ae4afcd766bda3c337c005d"
...
# T109 — Failure Recovery Gate

## 1. Objective

Interrupt tools, vendor runtimes, networks, storage and agents; resume without duplication or evidence loss.
...
- `CASE-0521` [HIGH] Failure Recovery Gate: Representative path
- `CASE-0522` [HIGH] Failure Recovery Gate: Boundary path
- `CASE-0523` [HIGH] Failure Recovery Gate: Invalid or hostile input
- `CASE-0524` [HIGH] Failure Recovery Gate: Injected dependency failure
- `CASE-0525` [CRITICAL] Failure Recovery Gate: Security or safety violation
- `CASE-0526` [HIGH] Failure Recovery Gate: Replay and idempotency
- `CASE-0527` [HIGH] Failure Recovery Gate: Version or environment drift
- `CASE-0528` [MEDIUM] Failure Recovery Gate: Moderate scale
- `CASE-0529` [CRITICAL] Failure Recovery Gate: Evidence tamper
- `CASE-0530` [HIGH] Failure Recovery Gate: Recovery and final evidence
