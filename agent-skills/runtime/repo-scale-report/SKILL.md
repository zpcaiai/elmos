---
name: repo-scale-report
description: 生成技术、销售、报价和客户版本的一致仓库规模复杂度报告。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-024
  source_name: repo-scale-report
  source_path: skills/repo-scale-report/SKILL.md
  source_sha256: sha256:0ae29d528b641884dc509f39b18e10ac6af2b6a4f4771eacc34341b4cc197c42
  source_contract_sha256: sha256:99f6346d7c65babae738e2c6b585a0d7be4a76a717449a64d0a48b8a9d233113
...
# Repository Scale Report

## Objective

生成技术、销售、报价和客户版本的一致仓库规模复杂度报告。

## Scope and capabilities

- 事实一致性
- unknown/provisional 标记
- 受众脱敏
- Evidence 引用
...
- repository-scale-report.md
- repository-scale-report.json
...
- [ ] 定义 `repo-scale-report` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `repo-scale-report` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：repository-scale-report.md, repository-scale-report.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：repository-scale-report.md, repository-scale-report.json。
...
- Machine contract: `references/contract.json` (`sha256:99f6346d7c65babae738e2c6b585a0d7be4a76a717449a64d0a48b8a9d233113`).
