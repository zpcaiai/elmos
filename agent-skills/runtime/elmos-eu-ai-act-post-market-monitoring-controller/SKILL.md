---
name: elmos-eu-ai-act-post-market-monitoring-controller
description: Generate risk-based post-market monitoring, logging, feedback, incident, corrective action and evidence workflows for applicable AI systems.
version: 4.0.0
...
# EU AI Act Post-Market Monitoring Controller
...
- `EUAIActPostMarketMonitoringControllerProfile`
- `EUAIActPostMarketMonitoringControllerPlan`
- `EUAIActPostMarketMonitoringControllerRun`
- `EUAIActPostMarketMonitoringControllerDecision`

Required semantic capabilities:

- compile applicable monitoring plan and metrics
- collect performance, risk and complaint signals
- triage serious and systemic issues
- manage corrective action and change control
- produce reviewable evidence and unresolved legal decisions
...
- `artifacts/elmos-eu-ai-act-post-market-monitoring-controller/profile.yaml`
- `artifacts/elmos-eu-ai-act-post-market-monitoring-controller/plan.json`
- `artifacts/elmos-eu-ai-act-post-market-monitoring-controller/result.json`
- `artifacts/elmos-eu-ai-act-post-market-monitoring-controller/evidence/`
...
- **system risk class assumed** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **monitoring captures excessive personal data** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **incident threshold misapplied** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **corrective action not recertified** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **technical report presented as legal compliance** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile applicable monitoring plan and metrics
- native scenario: collect performance, risk and complaint signals
- native scenario: triage serious and systemic issues
- native scenario: manage corrective action and change control
- native scenario: produce reviewable evidence and unresolved legal decisions
