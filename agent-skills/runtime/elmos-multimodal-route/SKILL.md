---
name: "elmos-multimodal-route"
description: "Invoke the bounded repository handler for elmos-multimodal-route while preserving its immutable source and fail-closed evidence boundary."
metadata:
  ...
  source_role: "child"
  source_key: "P06:multimodal-route"
  source_name: "elmos-multimodal-route"
  installed_name: "elmos-multimodal-route"
  source_logical_path: "06-elmos-intelligent-model-router/skills/multimodal-route/SKILL.md"
  source_path: "skills/elmos-7plus1-commercial-skills-v1.0.0/06-elmos-intelligent-model-router/skills/multimodal-route/SKILL.md.source-data"
  source_materialized_path: "06-elmos-intelligent-model-router/skills/multimodal-route/SKILL.md.source-data"
  source_sha256: "sha256:10549090792ad77fae107c9edf7d65db61ca85ead5c6b67a73cb129369ed8294"
...
- This is a deterministic repository wrapper for `06-elmos-intelligent-model-router/skills/multimodal-route/SKILL.md` at `sha256:10549090792ad77fae107c9edf7d65db61ca85ead5c6b67a73cb129369ed8294`.
- Its immutable source/runtime identity is `elmos-multimodal-route`; its active installed identity is `elmos-multimodal-route`.
...
```bash
PYTHONPATH=engines/software-factory-engine/src python3 -m elmos_software_factory execute --skill elmos-multimodal-route --request <file>
```
