...
description: "Run FRT-1402 Mini Program to Vue 2 Route Pack for FRT G14 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1402"
  source_name: "frt-1402-mini-program-to-vue-2-route-pack"
  source_sha256: "sha256:aa8b7b8381e8a4fb93cd7c4c44fc88377563d78d3d3263ce6e02c1c89aa76378"
  batch: "G14"
...
- Runtime catalog key: `FRT-1402` / `frt-1402-mini-program-to-vue-2-route-pack`.
...
# FRT-1402 — Mini Program to Vue 2 Route Pack

## Objective

在G14范围内实现 **Mini Program to Vue 2 Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：处理WXML/WXSS/setData/Page/Component与Web组件模型; 处理分包、基础库、授权、支付、Storage和页面栈限制; Web缺失能力和小程序限制显式Gap/Unsupported。

## When to Use

- 实现或修改与 **Mini Program to Vue 2 Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1402Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1402EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1402FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1402CertificateFragment`：供G14批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g14/frt-1402-mini-program-to-vue-2-route-pack/
packages/runtime/g14/frt-1402-mini-program-to-vue-2-route-pack/
services/control-plane/g14/frt-1402-mini-program-to-vue-2-route-pack/
apps/web-console/src/features/g14/frt-1402-mini-program-to-vue-2-route-pack/
apps/admin-console/src/features/g14/frt-1402-mini-program-to-vue-2-route-pack/
tests/g14/frt-1402-mini-program-to-vue-2-route-pack/
```
...
```text
POST /v1/skills/frt-1402/runs
GET  /v1/skills/frt-1402/runs/{run_id}
POST /v1/skills/frt-1402/runs/{run_id}/verify
GET  /v1/skills/frt-1402/runs/{run_id}/findings
GET  /v1/skills/frt-1402/runs/{run_id}/evidence
```
