---
name: elmos-nominal-structural-subtyping-mapper
description: "Preserve inheritance, interfaces, protocols, duck typing and structural compatibility across different target type systems."
version: 1.0.0
skill_id: ELMOS-POLY-186
...
triggers:
  - "Use when implementing or executing `elmos-nominal-structural-subtyping-mapper`."
  - "Use when a migration/certification DAG requires `type-semantics` capability."
outputs:
  - "semantic-assurance/elmos-nominal-structural-subtyping-mapper/model.json"
  - "semantic-assurance/elmos-nominal-structural-subtyping-mapper/evidence.json"
  - "semantic-assurance/elmos-nominal-structural-subtyping-mapper/diagnostics.json"
---

# Nominal & Structural Subtyping Mapper

## Objective

Preserve inheritance, interfaces, protocols, duck typing and structural compatibility across different target type systems.
...
- [ ] Java interface↔TS structural fixture.
- [ ] multiple inheritance fixture.
