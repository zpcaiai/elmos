...
description: "Repository-owned bounded wrapper for data-migration-reconciliation; external evidence remains NOT_RUN."
---
...
Validate row counts, keys, aggregates, referential integrity, sampling hashes and business invariants after data migration.
...
4. Submit `data-migration-reconciliation` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `27bed1d7da660d607c1a7b4385930baf45f1faaaaa5a1b95030e0ed8e39bfd10`
