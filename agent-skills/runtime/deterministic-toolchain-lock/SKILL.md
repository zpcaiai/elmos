---
name: deterministic-toolchain-lock
description: "Repository-owned bounded wrapper for deterministic-toolchain-lock; external evidence remains NOT_RUN."
---
...
Lock compiler, runtime, package manager, SDK, system library, container and skill versions for replayable transformations.
...
4. Submit `deterministic-toolchain-lock` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `772de86234490abada6a379eab83052131b22ba40eb7b7941456918208e3fdc9`
