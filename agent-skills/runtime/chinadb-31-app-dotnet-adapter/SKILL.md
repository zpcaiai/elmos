---
name: chinadb-31-app-dotnet-adapter
description: "Use when ELMOS must follow the ChinaDB commercial database-migration specification for .NET Database Refactor Adapter. Keep exact directed route and version semantics, require real evidence, and fail closed on unsupported behavior."
metadata:
  source_package: "chinadb-commercial-migration-skills"
  source_version: "1.0.0"
  source_directory: "31-app-dotnet-adapter"
  source_path: "skills/31-app-dotnet-adapter/SKILL.md"
  source_sha256: "sha256:f84503f8ea49d461ea1a7430e106d0d374ee6fddedad78e9b9cd12b7ff17d2dc"
...
- Provenance is pinned to `chinadb-commercial-migration-skills` version `1.0.0`, source Skill `31-app-dotnet-adapter`, and the SHA-256 digest in frontmatter.
