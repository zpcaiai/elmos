---
name: elmos-c-to-rust-golden-route
description: 'Execute the reference route: C native/embedded modules to Rust with
  memory-safety proof obligations.'
version: 1.0.0
skill_id: ELMOS-POLY-144
...
triggers:
- Use when implementing or executing `elmos-c-to-rust-golden-route`.
- Use when the migration DAG requires `route-execution` capability.
outputs:
- routes/elmos-c-to-rust-golden-route/run.json
- routes/elmos-c-to-rust-golden-route/migration-plan.json
- routes/elmos-c-to-rust-golden-route/evidence/
---

# C To Rust Golden Route

## Objective

Execute the reference route: C native/embedded modules to Rust with memory-safety proof obligations.
...
- Source: `c`
- Target: `rust`
- Intent: C native/embedded modules to Rust with memory-safety proof obligations
