---
name: responsible-ai-domain-model-lifecycle-and-state-machine
description: "Implement Batch 45C Responsible AI、Safety、Governance与Compliance canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval."
---
...
Implement Batch 45C Responsible AI、Safety、Governance与Compliance canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering AI Use Case、Risk Classification、Model Card、Dataset Card、Safety Test、Bias、Transparency、Incident与Approval.
...
5. Write unresolved domain assumptions to `docs/implementation/responsible-ai-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
responsible_ai_domain_model_lifecycle_and_state_machine_manifest.json
responsible_ai_domain_model_lifecycle_and_state_machine_state.json
responsible_ai_domain_model_lifecycle_and_state_machine_decision.json
responsible_ai_domain_model_lifecycle_and_state_machine_reconciliation.json
responsible_ai_domain_model_lifecycle_and_state_machine_evidence.json
```
