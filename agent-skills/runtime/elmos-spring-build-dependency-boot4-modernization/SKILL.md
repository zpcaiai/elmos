---
name: spring-build-dependency-boot4-modernization
description: Use this skill when Elmos must perform spring build dependency boot4 modernization as part of the 15-domain-engineering-packs production workflow, with typed contracts, policy enforcement, evidence capture, and rollback.
...
# spring-build-dependency-boot4-modernization

## 能力目标

升级构建、依赖、Jakarta 命名空间、容器和 Spring Boot 4 配置。
