---
name: site-local-coordinator-leader-election-runner-gateway-and-ha
description: "Implement the site coordinator, runner gateway, durable leader election, site epochs, local inventory, assignment delivery, split-brain prevention, failover, and HA modes."
---
...
Implement the site coordinator, runner gateway, durable leader election, site epochs, local inventory, assignment delivery, split-brain prevention, failover, and HA modes.
...
4. Record unresolved provider/version assumptions in `docs/implementation/site-local-coordinator-leader-election-runner-gateway-and-ha-baseline.md`.
...
```text
site_local_coordinator_leader_election_runner_gateway_and_ha_manifest.json
site_local_coordinator_leader_election_runner_gateway_and_ha_decision.json
site_local_coordinator_leader_election_runner_gateway_and_ha_evidence.json
```
