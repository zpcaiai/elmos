...
# AI TEVV Program Architecture Compiler
...
- `AITEVVProgramArchitectureCompilerProfile`
- `AITEVVProgramArchitectureCompilerRun`
- `AITEVVProgramArchitectureCompilerFinding`
- `AITEVVProgramArchitectureCompilerDecision`
- `AITEVVProgramArchitectureCompilerEvidence`

Required semantic capabilities:

- compile context, stakeholders, claims, metrics, test levels and evidence into an end-to-end TEVV program
- separate technical performance, sociotechnical impact and operational outcome evaluation
- define independent challenge, holdout, monitoring and recertification phases
...
- `artifacts/elmos-ai-tevv-program-architecture-compiler/profile.yaml`
- `artifacts/elmos-ai-tevv-program-architecture-compiler/plan.json`
- `artifacts/elmos-ai-tevv-program-architecture-compiler/result.json`
- `artifacts/elmos-ai-tevv-program-architecture-compiler/evidence/`
- `artifacts/elmos-ai-tevv-program-architecture-compiler/assurance-case.json`
...
- **benchmark score substitutes for real-world outcome** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **TEVV scope omits affected stakeholders** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **evaluation designer knows hidden holdout** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: compile context, stakeholders, claims, metrics, test levels and evidence into an end-to-end TEVV program
- native scenario: separate technical performance, sociotechnical impact and operational outcome evaluation
- native scenario: define independent challenge, holdout, monitoring and recertification phases
