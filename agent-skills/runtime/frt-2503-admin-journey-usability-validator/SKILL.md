...
description: "Run FRT-2503 Admin Journey Usability Validator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2503"
  source_name: "frt-2503-admin-journey-usability-validator"
  source_sha256: "sha256:1ef93b857d0d0bd304ceeb01fa57e40ddb9816ddfad2713ae4922bf0fcac5624"
  batch: "G25"
...
- Runtime catalog key: `FRT-2503` / `frt-2503-admin-journey-usability-validator`.
...
在G25范围内实现 **Admin Journey Usability Validator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Admin Journey Usability Validator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2503Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2503EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2503FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2503CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2503-admin-journey-usability-validator/
packages/runtime/g25/frt-2503-admin-journey-usability-validator/
services/control-plane/g25/frt-2503-admin-journey-usability-validator/
apps/web-console/src/features/g25/frt-2503-admin-journey-usability-validator/
apps/admin-console/src/features/g25/frt-2503-admin-journey-usability-validator/
tests/g25/frt-2503-admin-journey-usability-validator/
```
...
```text
POST /v1/skills/frt-2503/runs
GET  /v1/skills/frt-2503/runs/{run_id}
POST /v1/skills/frt-2503/runs/{run_id}/verify
GET  /v1/skills/frt-2503/runs/{run_id}/findings
GET  /v1/skills/frt-2503/runs/{run_id}/evidence
```
