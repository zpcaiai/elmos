...
description: "Run FRT-1909 Noninterference Proof Generator for FRT G19 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1909"
  source_name: "frt-1909-noninterference-proof-generator"
  source_sha256: "sha256:1d1281ef4a595d56533d940400b0b37286b5ef77ddcbb296c4a8898c10361f49"
  batch: "G19"
...
- Runtime catalog key: `FRT-1909` / `frt-1909-noninterference-proof-generator`.
...
# FRT-1909 — Noninterference Proof Generator

## Objective

在G19范围内实现 **Noninterference Proof Generator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：从IR、Rule和业务不变量生成Proof Obligation; Leanstral仅提出证明候选，Lean Kernel为可信根; 组合SMT、Model Checking、Symbolic和Differential Evidence。

## When to Use

- 实现或修改与 **Noninterference Proof Generator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1909Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1909EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1909FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1909CertificateFragment`：供G19批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g19/frt-1909-noninterference-proof-generator/
packages/runtime/g19/frt-1909-noninterference-proof-generator/
services/control-plane/g19/frt-1909-noninterference-proof-generator/
apps/web-console/src/features/g19/frt-1909-noninterference-proof-generator/
apps/admin-console/src/features/g19/frt-1909-noninterference-proof-generator/
tests/g19/frt-1909-noninterference-proof-generator/
```
...
```text
POST /v1/skills/frt-1909/runs
GET  /v1/skills/frt-1909/runs/{run_id}
POST /v1/skills/frt-1909/runs/{run_id}/verify
GET  /v1/skills/frt-1909/runs/{run_id}/findings
GET  /v1/skills/frt-1909/runs/{run_id}/evidence
```
