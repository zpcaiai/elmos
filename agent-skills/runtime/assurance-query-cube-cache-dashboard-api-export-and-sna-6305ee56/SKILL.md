---
name: assurance-query-cube-cache-dashboard-api-export-and-sna-6305ee56
description: 建立分析事实/维度、Materialized Aggregate、Semantic Query、Tenant-safe Cache、Filter、Export与签名Snapshot。
metadata:
  elmos_batch: "37C"
  elmos_skill_id: "ANA37C014"
  pack_version: "3.7-complete"
---

# ANA37C014 — Assurance Query、Cube、Cache、Dashboard API、Export 与 Snapshot

## Objective

建立分析事实/维度、Materialized Aggregate、Semantic Query、Tenant-safe Cache、Filter、Export与签名Snapshot。
...
- Cockpit只查询注册Metric，不提供任意SQL端点。
- Cache Key包含Tenant、Authorization Version、Metric Version、Scope、Filters、As-of、Source Snapshot、Quality Policy。
- Refresh支持Event-driven/Incremental/Scheduled/Full/Restatement。
- Published Snapshot保存Profile、Metric Snapshots、Filters、As-of、Latest Complete Data、Quality与Signature。
...
- cockpitCannotRunArbitrarySql
- cacheKeyIncludesAuthorizationVersion
- restatementInvalidatesAffectedCache
- publishedSnapshotIsSigned
