...
description: "Run FRT-0708 Formatter Linter and Analyzer Integration for FRT G07 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-0708"
  source_name: "frt-0708-formatter-linter-and-analyzer-integration"
  source_sha256: "sha256:faff3ac2623000f739d166dd1e8d6ca5c7c27ebb0bbf2f40872e670181f97539"
  batch: "G07"
...
- Runtime catalog key: `FRT-0708` / `frt-0708-formatter-linter-and-analyzer-integration`.
...
# FRT-0708 — Formatter Linter and Analyzer Integration

## Objective

在G07范围内实现 **Formatter Linter and Analyzer Integration**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Typed IR经规则Pass降低到目标原生AST; Gap生成Typed Hole而非空实现; Format/Analyze/Build驱动有界确定性修复。

## When to Use

- 实现或修改与 **Formatter Linter and Analyzer Integration** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-0708Result`：版本化、带状态和诊断的结构化结果。
- `FRT-0708EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-0708FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-0708CertificateFragment`：供G07批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g07/frt-0708-formatter-linter-and-analyzer-integration/
packages/runtime/g07/frt-0708-formatter-linter-and-analyzer-integration/
services/control-plane/g07/frt-0708-formatter-linter-and-analyzer-integration/
apps/web-console/src/features/g07/frt-0708-formatter-linter-and-analyzer-integration/
apps/admin-console/src/features/g07/frt-0708-formatter-linter-and-analyzer-integration/
tests/g07/frt-0708-formatter-linter-and-analyzer-integration/
```
...
```text
POST /v1/skills/frt-0708/runs
GET  /v1/skills/frt-0708/runs/{run_id}
POST /v1/skills/frt-0708/runs/{run_id}/verify
GET  /v1/skills/frt-0708/runs/{run_id}/findings
GET  /v1/skills/frt-0708/runs/{run_id}/evidence
```
