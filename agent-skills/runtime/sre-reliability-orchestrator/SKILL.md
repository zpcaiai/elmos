---
name: sre-reliability-orchestrator
description: "Implement Batch 47B SRE、Observability、Incident与Reliability Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Service、SLI、SLO、Error Budget、Telemetry、Alert、Incident、Runbook、Capacity与Reliability Review."
---
...
Implement Batch 47B SRE、Observability、Incident与Reliability Operations end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Service、SLI、SLO、Error Budget、Telemetry、Alert、Incident、Runbook、Capacity与Reliability Review.
...
5. Write unresolved domain assumptions to `docs/implementation/sre-reliability-orchestrator-baseline.md`.
...
```text
sre_reliability_orchestrator_manifest.json
sre_reliability_orchestrator_state.json
sre_reliability_orchestrator_decision.json
sre_reliability_orchestrator_reconciliation.json
sre_reliability_orchestrator_evidence.json
```
