---
name: elmos-managed-agent-cloud-deployment-generator
description: Generate portable deployments to AWS, Google, Microsoft and Databricks managed agent runtimes with identity,
  network, observability, evidence and exit plans.
version: 4.0.0
...
# Managed Agent Cloud Deployment Generator
...
- `DeploymentUnit`
- `ConformanceRun`
- `ManagedAgentCloudDeploymentGeneratorRun`
- `ManagedAgentCloudDeploymentGeneratorDecision`

Required semantic capabilities:

- Managed runtime capability negotiation
- IaC and workload identity generation
- Private networking and data residency
- Native health/trace/cost integration
- Export, rollback and vendor-exit validation
...
- `cloud-capability-diff.json`
- `deployment-evidence/`
- `cloud-exit-plan.yaml`
...
- **vendor lock-in hidden** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cloud privilege overgrant** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-region data movement** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **provider-specific state loss** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **non-portable completion claim** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- AWS target plan
- Google target plan
- Microsoft target plan
- Databricks target plan
- identity/network denial
- export and rollback
