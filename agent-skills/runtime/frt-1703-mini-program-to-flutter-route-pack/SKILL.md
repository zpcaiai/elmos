...
description: "Run FRT-1703 Mini Program to Flutter Route Pack for FRT G17 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-1703"
  source_name: "frt-1703-mini-program-to-flutter-route-pack"
  source_sha256: "sha256:a46ca527f03ba5b7b3407eed5613445e1c9b32fd036f2e694b5dc008d3036eb1"
  batch: "G17"
...
- Runtime catalog key: `FRT-1703` / `frt-1703-mini-program-to-flutter-route-pack`.
...
# FRT-1703 — Mini Program to Flutter Route Pack

## Objective

在G17范围内实现 **Mini Program to Flutter Route Pack**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：补齐小程序/ArkUI/Flutter六个方向; 统一移动Navigation、Lifecycle、Permission、Storage和Native能力; 验证直接与间接三角路径。

## When to Use

- 实现或修改与 **Mini Program to Flutter Route Pack** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-1703Result`：版本化、带状态和诊断的结构化结果。
- `FRT-1703EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-1703FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-1703CertificateFragment`：供G17批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g17/frt-1703-mini-program-to-flutter-route-pack/
packages/runtime/g17/frt-1703-mini-program-to-flutter-route-pack/
services/control-plane/g17/frt-1703-mini-program-to-flutter-route-pack/
apps/web-console/src/features/g17/frt-1703-mini-program-to-flutter-route-pack/
apps/admin-console/src/features/g17/frt-1703-mini-program-to-flutter-route-pack/
tests/g17/frt-1703-mini-program-to-flutter-route-pack/
```
...
```text
POST /v1/skills/frt-1703/runs
GET  /v1/skills/frt-1703/runs/{run_id}
POST /v1/skills/frt-1703/runs/{run_id}/verify
GET  /v1/skills/frt-1703/runs/{run_id}/findings
GET  /v1/skills/frt-1703/runs/{run_id}/evidence
```
