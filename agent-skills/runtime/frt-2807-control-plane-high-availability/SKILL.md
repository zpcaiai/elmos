...
description: "Run FRT-2807 Control Plane High Availability for FRT G28 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2807"
  source_name: "frt-2807-control-plane-high-availability"
  source_sha256: "sha256:49b8646c3a7292c4a81d4f31ccec93247d6881eb7ebafd69451f0312606decef"
  batch: "G28"
...
- Runtime catalog key: `FRT-2807` / `frt-2807-control-plane-high-availability`.
...
在G28范围内实现 **Control Plane High Availability**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Dependency Failure Model与Common Cause分析; 端到端Deadline、Retry Budget、Circuit Breaker、Bulkhead; Queue Durability、Replay、Stateful Failover、Fence Token。

## When to Use

- 实现或修改与 **Control Plane High Availability** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2807Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2807EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2807FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2807CertificateFragment`：供G28批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g28/frt-2807-control-plane-high-availability/
packages/runtime/g28/frt-2807-control-plane-high-availability/
services/control-plane/g28/frt-2807-control-plane-high-availability/
apps/web-console/src/features/g28/frt-2807-control-plane-high-availability/
apps/admin-console/src/features/g28/frt-2807-control-plane-high-availability/
tests/g28/frt-2807-control-plane-high-availability/
```
...
```text
POST /v1/skills/frt-2807/runs
GET  /v1/skills/frt-2807/runs/{run_id}
POST /v1/skills/frt-2807/runs/{run_id}/verify
GET  /v1/skills/frt-2807/runs/{run_id}/findings
GET  /v1/skills/frt-2807/runs/{run_id}/evidence
```
