---
name: ml-platform-data-quality-dedup-reconciliation-and-certification
description: "Implement Batch 45A ML Platform、Feature Store、Training、Registry与Serving quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Dataset、Feature、Experiment、Training Run、Model、Registry、Deployment、Endpoint、Drift与Retraining."
---
...
Implement Batch 45A ML Platform、Feature Store、Training、Registry与Serving quality rules, duplicate detection, completeness, reconciliation, certification and repair evidence, covering Dataset、Feature、Experiment、Training Run、Model、Registry、Deployment、Endpoint、Drift与Retraining.
...
5. Write unresolved domain assumptions to `docs/implementation/ml-platform-data-quality-dedup-reconciliation-and-certification-baseline.md`.
...
```text
ml_platform_data_quality_dedup_reconciliation_and_certification_manifest.json
ml_platform_data_quality_dedup_reconciliation_and_certification_state.json
ml_platform_data_quality_dedup_reconciliation_and_certification_decision.json
ml_platform_data_quality_dedup_reconciliation_and_certification_reconciliation.json
ml_platform_data_quality_dedup_reconciliation_and_certification_evidence.json
```
