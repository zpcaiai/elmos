---
name: manufacturing-quality-orchestrator
description: "Implement Batch 50C Quality、Traceability、Industrial Safety与Supplier Quality end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Specification、Inspection、Nonconformance、CAPA、Lot Genealogy、Recall、Safety Permit、Supplier Defect与Audit."
---

# Manufacturing Quality Orchestrator

## Objective

Implement Batch 50C Quality、Traceability、Industrial Safety与Supplier Quality end-to-end architecture, sequencing, dependency management, implementation workflow and completion gates, covering Specification、Inspection、Nonconformance、CAPA、Lot Genealogy、Recall、Safety Permit、Supplier Defect与Audit.
...
5. Write unresolved domain assumptions to `docs/implementation/manufacturing-quality-orchestrator-baseline.md`.
...
```text
manufacturing_quality_orchestrator_manifest.json
manufacturing_quality_orchestrator_state.json
manufacturing_quality_orchestrator_decision.json
manufacturing_quality_orchestrator_reconciliation.json
manufacturing_quality_orchestrator_evidence.json
```
