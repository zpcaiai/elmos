---
name: ingestion-quarantine-gate
description: Use this skill when Elmos must perform ingestion quarantine gate as part of the 01-knowledge-ingestion-governance
...
对来源不明、许可不清、解析失败、污染或恶意内容执行隔离与复核。
