...
description: "Repository-owned bounded wrapper for contract-compatibility-verification; external evidence remains NOT_RUN."
---
...
4. Submit `contract-compatibility-verification` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `5229ddfa967e53686c97f75a3fd784cc055811641b49cc28ef868187d7d316b5`
