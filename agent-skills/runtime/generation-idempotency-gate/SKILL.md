---
name: generation-idempotency-gate
description: "Run the exact ELMOS Batch 81-95 slightly-strict Generation Idempotency Gate tests with fail-closed native evidence. Use when validating the assigned Language Pack scope."
metadata:
  source_package: "elmos-batch81-95-slightly-strict-test-skills"
  source_id: "T106"
  source_name: "generation-idempotency-gate"
  source_sha256: "sha256:368e4dbaa403acd14beb53bf6a34e5d632b5cb336955fc37e3d6afb2eea8e474"
...
# T106 — Generation Idempotency Gate

## 1. Objective

Repeat generation with identical inputs and require no semantic diff or unstable identifiers.
...
- `CASE-0491` [HIGH] Generation Idempotency Gate: Representative path
- `CASE-0492` [HIGH] Generation Idempotency Gate: Boundary path
- `CASE-0493` [HIGH] Generation Idempotency Gate: Invalid or hostile input
- `CASE-0494` [HIGH] Generation Idempotency Gate: Injected dependency failure
- `CASE-0495` [CRITICAL] Generation Idempotency Gate: Security or safety violation
- `CASE-0496` [HIGH] Generation Idempotency Gate: Replay and idempotency
- `CASE-0497` [HIGH] Generation Idempotency Gate: Version or environment drift
- `CASE-0498` [MEDIUM] Generation Idempotency Gate: Moderate scale
- `CASE-0499` [CRITICAL] Generation Idempotency Gate: Evidence tamper
- `CASE-0500` [HIGH] Generation Idempotency Gate: Recovery and final evidence
