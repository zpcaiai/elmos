---
name: golden-route-corpus-manager
description: "Repository-owned bounded wrapper for golden-route-corpus-manager; external evidence remains NOT_RUN."
---
...
Maintain real open/commercial fixtures, expected outputs, adversarial mutations and E0-E5 evidence for each high-value migration route.
...
4. Submit `golden-route-corpus-manager` through the authenticated public `CommercialCapabilityExpansionService.execute` surface; exact handler resolution is private runtime state.
...
- Source member SHA-256: `ae95d28e87dec3767a245c1e0abddfc2a23401e215d1ea27506075d0a73955b6`
