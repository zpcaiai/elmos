...
description: Use this skill when Elmos must perform tenancy scope contract as part of the 00-foundation-contracts production
...
明确平台、组织、租户、项目、仓库、分支、任务和用户各级数据与能力作用域。
