...
# Cross-Border Certificate Acceptance Planner
...
- `CrossBorderCertificateAcceptancePlannerProfile`
- `CrossBorderCertificateAcceptancePlannerRun`
- `CrossBorderCertificateAcceptancePlannerFinding`
- `CrossBorderCertificateAcceptancePlannerDecision`
- `CrossBorderCertificateAcceptancePlannerEvidence`

Required semantic capabilities:

- combine mutual recognition, local regulation, market authorization and customer contract
- identify supplemental tests, translations, local representatives and data restrictions
- produce jurisdiction-specific acceptance dossier without legal overclaim
...
- `elmos-mutual-recognition-arrangement-scope-resolver`
...
- `artifacts/elmos-certificate-cross-border-jurisdiction-acceptance-planner/profile.yaml`
- `artifacts/elmos-certificate-cross-border-jurisdiction-acceptance-planner/plan.json`
- `artifacts/elmos-certificate-cross-border-jurisdiction-acceptance-planner/result.json`
- `artifacts/elmos-certificate-cross-border-jurisdiction-acceptance-planner/evidence/`
- `artifacts/elmos-certificate-cross-border-jurisdiction-acceptance-planner/assurance-case.json`
...
- **technical recognition is mistaken for regulatory approval** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **local language limitation omitted** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **cross-border data transfer violates policy** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- native scenario: combine mutual recognition, local regulation, market authorization and customer contract
- native scenario: identify supplemental tests, translations, local representatives and data restrictions
- native scenario: produce jurisdiction-specific acceptance dossier without legal overclaim
