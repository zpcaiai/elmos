---
name: legacy-web-23-jsp-taglib-and-view-semantics
description: "Repository-owned exact runtime interface for JSP、Taglib 与视图语义恢复; bounded semantic analysis and evidence generation for Java legacy web modernization."
metadata:
  source_package: elmos.java-legacy-web.repository-modernization
  source_version: 1.0.0
  source_id: 23-jsp-taglib-and-view-semantics
  source_digest: sha256:e1a2eb91210f09e8dc7f73fa83474274c440aea8a23fc4c2ef6011b4d1b32b16
  phase: semantic-recovery
  runtime_state: CODE_COMPLETE_LOCAL
  capability_state: LOCAL_EXECUTED
  operation_code: VIEW_SEMANTICS_RECOVERED
  runtime_handler_id: legacy-web-handler:23-jsp-taglib-and-view-semantics
---
