# xiaohongshu-miniapp-codegen — 执行契约

## 调用边界

- 阶段：`target-codegen`
- 任务 ID：MAPP-026
- 上游技能：miniapp-component-mapping-engine, miniapp-state-event-lifecycle-converter, miniapp-style-layout-converter, miniapp-third-party-dependency-migrator
...
```json
{
  "artifact_id": "xiaohongshu-miniapp-codegen:example",
  "path": "relative/path",
  "sha256": "<64-hex>",
  "schema": "schemas/<name>.schema.json",
  "producer": "xiaohongshu-miniapp-codegen",
  "task_id": "MAPP-026",
  "status": "passed"
}
```
...
```json
{
  "skill": "xiaohongshu-miniapp-codegen",
  "task_ids": ["MAPP-026"],
  "status": "passed",
  "artifacts": [],
  "gate_results": [],
