...
description: Use this skill when Elmos must perform architecture recovery as part of the 02-repository-semantic-intelligence
...
从代码、构建、部署和运行证据恢复模块边界、层次、领域和依赖违规。
