...
description: Plan, execute, pause, resume, aggregate and certify ETGB runs across all four Elmos business lines. Repository-owned ETGB execution is available through the local runtime; external production evidence remains explicit.
metadata:
