---
name: unified-scm-provider-contract-capability-and-error-model
description: "Implement provider-neutral SCM connector contracts, stable identifiers, capabilities, pagination, credentials, normalized errors, lifecycle, and connector TCK."
---
...
Implement provider-neutral SCM connector contracts, stable identifiers, capabilities, pagination, credentials, normalized errors, lifecycle, and connector TCK.
...
4. Record unresolved provider/version assumptions in `docs/implementation/unified-scm-provider-contract-capability-and-error-model-baseline.md`.
...
```text
unified_scm_provider_contract_capability_and_error_model_manifest.json
unified_scm_provider_contract_capability_and_error_model_decision.json
unified_scm_provider_contract_capability_and_error_model_evidence.json
```
