...
description: "Run FRT-2500 Functional Usability Orchestrator for FRT G25 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-2500"
  source_name: "frt-2500-functional-usability-orchestrator"
  source_sha256: "sha256:9a52af402c508ab233d83b7237c4d46dd4b7edd5458d0d50cb6abe9c88b8eccc"
  batch: "G25"
...
- Runtime catalog key: `FRT-2500` / `frt-2500-functional-usability-orchestrator`.
...
在G25范围内实现 **Functional Usability Orchestrator**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：Actor/Goal驱动Task Contract与Completion Oracle; Loading/Empty/Error/Retry/Unsupported完整状态矩阵; Form Validation、Data Preservation、Single Flight。

## When to Use

- 实现或修改与 **Functional Usability Orchestrator** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-2500Result`：版本化、带状态和诊断的结构化结果。
- `FRT-2500EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-2500FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-2500CertificateFragment`：供G25批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g25/frt-2500-functional-usability-orchestrator/
packages/runtime/g25/frt-2500-functional-usability-orchestrator/
services/control-plane/g25/frt-2500-functional-usability-orchestrator/
apps/web-console/src/features/g25/frt-2500-functional-usability-orchestrator/
apps/admin-console/src/features/g25/frt-2500-functional-usability-orchestrator/
tests/g25/frt-2500-functional-usability-orchestrator/
```
...
```text
POST /v1/skills/frt-2500/runs
GET  /v1/skills/frt-2500/runs/{run_id}
POST /v1/skills/frt-2500/runs/{run_id}/verify
GET  /v1/skills/frt-2500/runs/{run_id}/findings
GET  /v1/skills/frt-2500/runs/{run_id}/evidence
```
