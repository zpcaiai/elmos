---
name: runtime-trace-ingestion
description: Use this skill when Elmos must perform runtime trace ingestion as part of the 01-knowledge-ingestion-governance
...
接入 Trace、Metric、Log、Profile、SQL 与消息链路，并与静态代码实体关联。
