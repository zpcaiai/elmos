---
name: elmos-agent-skill-mcp-supply-chain-certifier
description: Certify Skills, plugins and MCP servers with publisher identity, signatures, SBOM/AIBOM, reproducible builds,
  permission diffs and static/dynamic behavior evidence.
version: 4.0.0
...
# Agent Skill and MCP Supply Chain Certifier
...
- `Approval`
- `ResidualRisk`
- `AgentSkillAndMCPSupplyChainCertifierRun`
- `AgentSkillAndMCPSupplyChainCertifierDecision`

Required semantic capabilities:

- Publisher and package identity
- Dependency and resource inventory
- Reproducible build and provenance
- Install/update permission diff
- Static and sandboxed dynamic behavior analysis
...
- `elmos-agent-skill-ir-compiler` from `elmos-ai-capability-enhancement-skills` — required base evidence producer.
...
- **malicious package update** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **publisher impersonation** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **dependency confusion** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **manifest/behavior mismatch** — must have a preventive control, a detective signal, a negative fixture and a response action.
- **signature rollback** — must have a preventive control, a detective signal, a negative fixture and a response action.
...
- signed trusted package
- unsigned package block
- typosquat fixture
- hidden script detection
- permission expansion block
- reproducible build
