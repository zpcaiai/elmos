---
name: spring-context-slicer
description: 从 Graph、源码、配置、测试和决策中选取完成单个修复所需最小上下文。 Use for this exact ELMOS Spring Golden Route v2 contract; imported specifications are not runtime or certification evidence.
...
metadata:
  ...
  source_id: ELMOS-GR-051
  source_name: spring-context-slicer
  source_path: skills/spring-context-slicer/SKILL.md
  source_sha256: sha256:2c19f3ba9223680a8e841b7e1032eeae73ee5201729cabd5f466439a25cd22af
  source_contract_sha256: sha256:3eecb01d69cc866ad51690fc86f7431245dbb8b66fc62ae91d61113c52676068
...
# Semantic Context Slicer

## Objective

从 Graph、源码、配置、测试和决策中选取完成单个修复所需最小上下文。

## Scope and capabilities

- Symbol neighborhood
- Transaction/security/side-effect 扩展
- Token estimate
- Completeness audit
- Context fingerprint/cache
...
- [ ] 定义 `spring-context-slicer` 的 public interface、输入/输出/Error Schema 和版本策略。
- [ ] 实现 `spring-context-slicer` 的 production adapter/service，不把业务状态只保存在 Prompt 或内存对象中。
...
- [ ] 至少生成：context-slice.json, included-sources.json, token-estimate.json。
...
- [ ] 本 Skill 的 required outputs 均由真实目标仓库执行产生：context-slice.json, included-sources.json, token-estimate.json。
...
- Machine contract: `references/contract.json` (`sha256:3eecb01d69cc866ad51690fc86f7431245dbb8b66fc62ae91d61113c52676068`).
