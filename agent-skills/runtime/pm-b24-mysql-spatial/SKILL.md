...
- Invoke this repository Skill as `$pm-b24-mysql-spatial`.
- Immutable source identity: `mysql-spatial` in `precision-migration-b01-44` (B24).
- Runtime adapter: `database-and-data-route`; binding state: `DECLARED`.
- Resolve and plan with `python3 scripts/precision_migration/runtime.py plan --skill pm-b24-mysql-spatial`.
...
1. 盘点对象与专有能力
2. 执行本 Skill 的核心职责：迁移空间类型、SRID、函数、索引和坐标语义。
