---
name: clinical-ops-domain-model-lifecycle-and-state-machine
description: "Implement Batch 52A Clinical Operations、Patient Flow与Care Coordination canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Patient、Encounter、Appointment、Bed、Care Plan、Task、Referral、Observation、Discharge与Care Team."
---

# Clinical Ops Domain Model Lifecycle And State Machine

## Objective

Implement Batch 52A Clinical Operations、Patient Flow与Care Coordination canonical domain objects, aggregates, identities, effective dating, lifecycle states and invariants, covering Patient、Encounter、Appointment、Bed、Care Plan、Task、Referral、Observation、Discharge与Care Team.
...
5. Write unresolved domain assumptions to `docs/implementation/clinical-ops-domain-model-lifecycle-and-state-machine-baseline.md`.
...
```text
clinical_ops_domain_model_lifecycle_and_state_machine_manifest.json
clinical_ops_domain_model_lifecycle_and_state_machine_state.json
clinical_ops_domain_model_lifecycle_and_state_machine_decision.json
clinical_ops_domain_model_lifecycle_and_state_machine_reconciliation.json
clinical_ops_domain_model_lifecycle_and_state_machine_evidence.json
```
