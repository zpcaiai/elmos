...
description: "Run FRT-3020 Continuous Performance Recertification for FRT G30 with typed frontend contracts, tenant scope, immutable evidence, and fail-closed certification boundaries."
metadata:
  source_package: "FRT_G01_G30_Complete_Skills_Pack"
  source_skill_id: "FRT-3020"
  source_name: "frt-3020-continuous-performance-recertification"
  source_sha256: "sha256:65a67a70d122070387448c26b821af3635b94d5ca8b25c2f116a642e91924b17"
  batch: "G30"
...
- Runtime catalog key: `FRT-3020` / `frt-3020-continuous-performance-recertification`.
...
在G30范围内实现 **Continuous Performance Recertification**，并确保其结果可以被后续Batch、测试、管理端和证书系统稳定消费。该Skill服务于：九类Certificate聚合与唯一Production Authority; Service Catalog、Owner、Tier、Dependency; SLI/SLO、Business SLI、Error Budget和Burn Rate。

## When to Use

- 实现或修改与 **Continuous Performance Recertification** 对应的Contract、Runtime、API、UI、测试或证据链时。
...
- `FRT-3020Result`：版本化、带状态和诊断的结构化结果。
- `FRT-3020EvidenceBundle`：输入、执行、测试、Finding和输出Digest。
- `FRT-3020FindingSet`：error、warning、gap、manual-decision与blocker。
- `FRT-3020CertificateFragment`：供G30批次证书聚合，不得自行宣告全批通过。

## Required Implementation Surfaces

```text
packages/contracts/g30/frt-3020-continuous-performance-recertification/
packages/runtime/g30/frt-3020-continuous-performance-recertification/
services/control-plane/g30/frt-3020-continuous-performance-recertification/
apps/web-console/src/features/g30/frt-3020-continuous-performance-recertification/
apps/admin-console/src/features/g30/frt-3020-continuous-performance-recertification/
tests/g30/frt-3020-continuous-performance-recertification/
```
...
```text
POST /v1/skills/frt-3020/runs
GET  /v1/skills/frt-3020/runs/{run_id}
POST /v1/skills/frt-3020/runs/{run_id}/verify
GET  /v1/skills/frt-3020/runs/{run_id}/findings
GET  /v1/skills/frt-3020/runs/{run_id}/evidence
```
