---
name: correlation-and-distributed-trace-propagation-validator
description: "Use when Batch 10 must validate correlation and trace context across synchronous, asynchronous and retry paths."
---

# Correlation And Distributed Trace Propagation Validator
...
2. Validate correlation and trace context across synchronous, asynchronous and retry paths.
...
- Block on tenant leakage, broken critical trace, context collision or fabricated spans.
...
Produce end-to-end propagation matrix and broken-link evidence. Bind every object to the immutable artifact and authority evidence. The strongest possible Batch 10 claim is eligibility for progressive delivery; always keep `production_ready=false` and `eligible_for_cutover=false`.
