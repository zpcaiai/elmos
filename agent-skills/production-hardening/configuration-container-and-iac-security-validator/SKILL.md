---
name: configuration-container-and-iac-security-validator
description: "Use when Batch 10 must validate configuration, container and infrastructure-as-code security controls."
---

# Configuration Container And Iac Security Validator
...
2. Validate configuration, container and infrastructure-as-code security controls.
...
- Block on mutable images, privileged execution, critical misconfiguration or production credential.
...
Produce fixed-digest, least-privilege and hardened configuration evidence. Bind every object to the immutable artifact and authority evidence. The strongest possible Batch 10 claim is eligibility for progressive delivery; always keep `production_ready=false` and `eligible_for_cutover=false`.
