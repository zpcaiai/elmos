---
name: data-protection-cryptography-and-privacy-validator
description: "Use when Batch 10 must validate data classification, encryption, key use, retention, redaction and privacy controls."
---

# Data Protection Cryptography And Privacy Validator
...
2. Validate data classification, encryption, key use, retention, redaction and privacy controls.
...
- Block on weak cryptography, exposed sensitive data, uncontrolled retention or production key access.
...
Produce data-flow control decisions and evidence-linked residual risks. Bind every object to the immutable artifact and authority evidence. The strongest possible Batch 10 claim is eligibility for progressive delivery; always keep `production_ready=false` and `eligible_for_cutover=false`.
