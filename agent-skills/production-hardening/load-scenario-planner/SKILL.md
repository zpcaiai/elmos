---
name: load-scenario-planner
description: "Use when Batch 10 must turn risk profiles and workload models into bounded normal, peak, burst, stress, spike, soak and recovery scenarios."
---

# Load Scenario Planner
...
2. Turn risk profiles and workload models into bounded normal, peak, burst, stress, spike, soak and recovery scenarios.
...
- Block on a production dependency, missing kill switch or scenario beyond the approved risk envelope.
...
Produce artifact-bound scenario definitions with timeouts, abort criteria and expected evidence. Bind every object to the immutable artifact and authority evidence. The strongest possible Batch 10 claim is eligibility for progressive delivery; always keep `production_ready=false` and `eligible_for_cutover=false`.
