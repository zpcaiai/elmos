---
name: capacity-and-headroom-planner
description: "Use when Batch 10 must derive service capacity, safe operating points and peak headroom from calibrated evidence."
---

# Capacity And Headroom Planner
...
2. Derive service capacity, safe operating points and peak headroom from calibrated evidence.
...
- Block on headroom below policy, extrapolation without evidence or ignored downstream limits.
...
Produce capacity limits, bottlenecks and risk-tier headroom calculations. Bind every object to the immutable artifact and authority evidence. The strongest possible Batch 10 claim is eligibility for progressive delivery; always keep `production_ready=false` and `eligible_for_cutover=false`.
