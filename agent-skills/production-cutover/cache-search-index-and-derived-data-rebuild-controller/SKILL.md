---
name: cache-search-index-and-derived-data-rebuild-controller
description: "Use when Batch 11 must rebuild and atomically switch caches, indexes, views and other derived data."
---

# Cache Search Index And Derived Data Rebuild Controller
...
2. Rebuild and atomically switch caches, indexes, views and other derived data.
...
- Block on derived data treated as truth, tenant key collision, database overload or early old-index deletion.
...
Produce versioned rebuild, dual-query, warmup and alias-swap evidence. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
