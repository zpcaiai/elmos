---
name: legacy-dependency-client-and-integration-cleanup
description: "Use when Batch 11 must close legacy clients, SDKs, DNS, routes, direct database users, webhooks, ETL and partner integrations."
---

# Legacy Dependency Client And Integration Cleanup
...
2. Close legacy clients, SDKs, DNS, routes, direct database users, webhooks, ETL and partner integrations.
...
- Block on configuration-only deletion, unknown live caller, unrevoked database account or unconfirmed partner.
...
Produce actual-flow rescans and owner-approved dependency closure evidence. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
