---
name: file-and-object-storage-migration-controller
description: "Use when Batch 11 must migrate files and objects with hashes, versions, metadata, ACL, encryption, retention and references."
---

# File And Object Storage Migration Controller
...
2. Migrate files and objects with hashes, versions, metadata, ACL, encryption, retention and references.
...
- Block on hash mismatch, missing object, ACL regression, Legal Hold deletion or incomplete multipart copy.
...
Produce object ledger with hash, size, permission, tombstone and reference verification. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
