---
name: production-cutover-orchestrator
description: "Use when Batch 11 must coordinate the full PCCM sequence from Batch 10 admission through data migration, traffic transfer, Hypercare and closure."
---
...
2. Coordinate the full PCCM sequence from Batch 10 admission through data migration, traffic transfer, Hypercare and closure.
...
- Block on phase skipping, unfixed artifacts, ambiguous truth or an unauthorized production action.
...
Produce an auditable cutover run, phase timeline, Authority work queue and final handoff. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
