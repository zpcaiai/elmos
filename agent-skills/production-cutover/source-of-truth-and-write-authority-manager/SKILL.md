---
name: source-of-truth-and-write-authority-manager
description: "Use when Batch 11 must manage the versioned authoritative writer and reader for every aggregate and segment."
---

# Source Of Truth And Write Authority Manager
...
2. Manage the versioned authoritative writer and reader for every aggregate and segment.
...
- Block on dual primary, client-selected writer, stale local authority or entry-point bypass.
...
Produce atomic Authority Registry evidence consumed by all production entry points. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
