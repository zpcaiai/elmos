---
name: migration-wave-and-business-segmentation-planner
description: "Use when Batch 11 must plan reversible migration Waves by business capability, tenant, region, endpoint, data partition and risk."
---

# Migration Wave And Business Segmentation Planner
...
2. Plan reversible migration Waves by business capability, tenant, region, endpoint, data partition and risk.
...
- Block on random stateful routing, uncovered scope, high-risk first Wave or an ownerless segment.
...
Produce ordered Wave plans with stable cohort keys, owners and independent gates. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
