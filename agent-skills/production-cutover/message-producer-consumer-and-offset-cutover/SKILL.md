---
name: message-producer-consumer-and-offset-cutover
description: "Use when Batch 11 must migrate producers, consumers, groups, partitions, offsets, schemas and DLQs."
---

# Message Producer Consumer And Offset Cutover
...
2. Migrate producers, consumers, groups, partitions, offsets, schemas and DLQs.
...
- Block on guessed offset, dual real side effects, lost DLQ, schema break or unprocessed in-flight message.
...
Produce recorded final offset, handoff, lag and duplicate/loss verification. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
