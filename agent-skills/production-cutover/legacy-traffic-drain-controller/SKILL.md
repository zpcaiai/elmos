---
name: legacy-traffic-drain-controller
description: "Use when Batch 11 must stop new legacy traffic and safely drain requests, connections, consumers, jobs, transactions and callbacks."
---

# Legacy Traffic Drain Controller
...
2. Stop new legacy traffic and safely drain requests, connections, consumers, jobs, transactions and callbacks.
...
- Block on killed transaction, hidden write, undrained connection, active consumer/job or partner callback.
...
Produce zero-business-traffic and zero-in-flight evidence with timeout handling. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
