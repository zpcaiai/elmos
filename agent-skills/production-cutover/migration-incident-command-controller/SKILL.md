---
name: migration-incident-command-controller
description: "Use when Batch 11 must coordinate migration incidents with one commander, truth state, timeline, user impact and decision points."
---

# Migration Incident Command Controller
...
2. Coordinate migration incidents with one commander, truth state, timeline, user impact and decision points.
...
- Block on uncoordinated changes, destructive cleanup, lost positions or continued expansion during SEV0.
...
Produce severity, phase, Authority, evidence-preserving actions and post-incident obligations. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
