---
name: infrastructure-license-and-cost-cleanup
description: "Use when Batch 11 must close legacy compute, storage, network, monitoring, licenses, contracts and residual charges."
---

# Infrastructure License And Cost Cleanup
...
2. Close legacy compute, storage, network, monitoring, licenses, contracts and residual charges.
...
- Block on early rollback-capacity deletion, hidden renewal, unknown charge or unverified savings.
...
Produce CMDB-linked asset closure and real-bill cost evidence. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
