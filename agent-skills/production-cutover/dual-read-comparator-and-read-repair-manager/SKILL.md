---
name: dual-read-comparator-and-read-repair-manager
description: "Use when Batch 11 must compare existence, version, fields, order, pagination, authorization, freshness and tenancy."
---

# Dual Read Comparator And Read Repair Manager
...
2. Compare existence, version, fields, order, pagination, authorization, freshness and tenancy.
...
- Block on ignored permission difference, repair from non-authority, ambiguous version or hidden CDC failure.
...
Produce classified read differences and authority-safe repair evidence. Bind it to the source/target artifacts, phase, Wave, segment, Authority, production window and approvals. Only the final conformance controller may declare completion, and only from C-G evidence.
