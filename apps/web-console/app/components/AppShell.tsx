      ...
      <div className="content-shell">
        <header className="topbar">
          ...
          <div className="topbar-actions">
            ...
            <button className="icon-button" aria-label={english ? "Reload current page (clears unsaved input)" : "重新载入当前页面（会清除未保存输入）"} onClick={reloadPage}><Icon name="refresh" size={18} /></button>
