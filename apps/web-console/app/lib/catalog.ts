...
export const migrationCapabilities: MigrationCapability[] = [
  ...
  { id: "M31", batch: 31, title: "数据库与数据平台", domain: "Database & data", description: "类型、约束、SQL、ETL 与逐项对账的精确迁移；ChinaDB 扩展已登记 13 个国产目标的本地查询适配器，仅在显式兼容模式下发射 SQL，实库执行与认证保持 NOT_RUN。", skillCount: 69, schemaCount: 9, gateCommand: "scripts/batch31/run_database_gate.py", status: "READY", icon: "database", accent: "violet" },
