...
const extensions: Array<{
  ...
  { name: "ChinaDB Commercial Migration", publisher: "ELMOS First-party", type: "SQL 转换增强", description: "登记 47 项可调用迁移功能、13 个国产目标与 78 条规划路线；无精确版本、能力快照或验证适配器时失败关闭。", version: "1.0.0", compatibility: "Batch 31 · SPEC_ONLY", status: "EXPERIMENTAL", icon: "database" },
